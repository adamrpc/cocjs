...
angular.module( 'cocjs' ).factory( 'SeductiveArmor', function( ArmorLib, kFLAGS, Minotaur, MinotaurMob, Combat, Armor, PerkLib, EngineCore, CoC ) {
	...
	SeductiveArmor.prototype.useText = function() {
		if( !CoC.getInstance().scenes.ceraphFollowerScene.ceraphIsFollower() ) {
			...
			EngineCore.outputText( 'As you\'re trying to put on the armor, Ceraph appears from nowhere, apologizing profusely and stopping you before you can slide the last strap into place.  "<i>Please don\'t put that on, ' + CoC.getInstance().player.mf( 'Master', 'Mistress' ) + '.  I trapped that armor to pierce new fetishes the unwary so that I could add them to my harem.  I\'d hate to garner your anger.</i>"  She wrings her hands nervously.  "<i>If you\'ll hand it here, I\'ll get rid of it for you. Noone would buy it anyway.</i>"' );
