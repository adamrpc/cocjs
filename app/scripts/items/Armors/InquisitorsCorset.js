...
angular.module( 'cocjs' ).factory( 'InquisitorsCorset', function( Armor, PerkLib, EngineCore, CoC ) {
	...
	InquisitorsCorset.prototype.playerEquip = function() {
		while( CoC.getInstance().player.findPerk( PerkLib.BloodMage ) >= 0 ) {
			CoC.getInstance().player.removePerk( PerkLib.BloodMage );
		}
		while( CoC.getInstance().player.findPerk( PerkLib.SluttySeduction ) >= 0 ) {
			CoC.getInstance().player.removePerk( PerkLib.SluttySeduction );
		}
		CoC.getInstance().player.createPerk( PerkLib.BloodMage, 0, 0, 0, 0 );
		CoC.getInstance().player.createPerk( PerkLib.SluttySeduction, 10, 0, 0, 0 );
