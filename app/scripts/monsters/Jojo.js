...
angular.module( 'cocjs' ).factory( 'Jojo', function( SceneLib, $log, EventParser, CoC, Monster, Utils, AppearanceDefs, Combat, EngineCore ) {
	function Jojo() {
		this.init(this, arguments);
	}
	angular.extend(Jojo.prototype, Monster.prototype);
	...
	Jojo.prototype.performCombatAction = function() {
		if( SceneLib.jojoScene.monk > 1 && Utils.rand( 2 ) === 0 ) {
			this.selfCorruption();
