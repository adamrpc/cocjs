...
angular.module( 'cocjs' ).factory( 'FemaleSpiderMorph', function( SceneLib, AbstractSpiderMorph, AppearanceDefs, WeightedDrop, ConsumableLib, UseableLib, Appearance, MainView, EngineCore, Monster, Utils, StatusAffects ) {
