...
angular.module( 'cocjs' ).factory( 'DemonPack', function( $log, CoC, Monster, Utils, StatusAffects, Appearance, AppearanceDefs, CockTypesEnum, WeightedDrop, ConsumableLib, Combat, EngineCore, Descriptors ) {
	var DemonPack = angular.copy( Monster );
