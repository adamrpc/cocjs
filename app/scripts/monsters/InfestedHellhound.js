...
angular.module( 'cocjs' ).factory( 'InfestedHellhound', function( SceneLib, $log, CoC, EngineCore, Monster, Utils, Descriptors, CoC_Settings, HellHound, WeightedDrop, AppearanceDefs, StatusAffects, Combat, ConsumableLib ) {
