...
angular.module( 'cocjs' ).factory( 'Harpy', function( $log, MainView, SceneLib, CoC, kFLAGS, EngineCore, Monster, ArmorLib, Utils, AppearanceDefs, StatusAffects, Appearance, ChainedDrop, ConsumableLib ) {
	...
	Harpy.prototype.outputPlayerDodged = function( ) {
		MainView.outputText( 'With another deranged cry the harpy dives at you, swinging her razor-sharp talons through the air with the grace of a ballerina. Your quick reflexes allow you to dodge every vicious slash she makes at you.\n', false );
	};
	Harpy.prototype.outputAttack = function( damage ) {
		if( damage <= 0 ) {
			...
			MainView.outputText( 'The harpy surges forward, bringing her razor-sharp claws down on you, tearing at all the exposed flesh she can reach! (' + damage + ')', false );
		}
	};
