...
angular.module( 'cocjs' ).factory( 'Parser', function($log, CoC, kFLAGS, Showdown) {
	function Parser() {
	...
	Parser.singleArgConverters = {
		...
		"ass"						: function() { return CoC.getInstance().buttDescript();},
		"asshole"					: function() { return CoC.getInstance().assholeDescript(); },
		"balls"						: function() { return CoC.getInstance().ballsDescriptLight(); },
		"boyfriend"					: function() { return CoC.getInstance().player.mf("boyfriend", "girlfriend"); },
		"butt"						: function() { return CoC.getInstance().buttDescript();},
		"butthole"					: function() { return CoC.getInstance().assholeDescript();},
		"chest"						: function() { return CoC.getInstance().chestDesc(); },
		"clit"						: function() { return CoC.getInstance().clitDescript(); },
		...
		"cunt"						: function() { return CoC.getInstance().vaginaDescript(); },
		...
		"hair"						: function() { return CoC.getInstance().hairDescript(); },
		"hairorfur"					: function() { return CoC.getInstance().hairOrFur(); },
		...
		"hips"						: function() { return CoC.getInstance().hipDescript();},
		...
		"nipple"					: function() { return CoC.getInstance().nippleDescript(0);},
		"nipples"					: function() { return CoC.getInstance().nippleDescript(0) + "s";},
		"onecock"					: function() { return CoC.getInstance().player.oMultiCockDesc();},
		"pg"						: function() { return "\n\n";},
		"pussy"						: function() { return CoC.getInstance().vaginaDescript(); },
		"race"						: function() { return CoC.getInstance().player.race(); },
		"sack"						: function() { return CoC.getInstance().sackDescript(); },
		...
		"teasetext"					: function() { return CoC.getInstance().teaseText(); },
		"tongue"					: function() { return CoC.getInstance().tongueDescript(); },
		"vag"						: function() { return CoC.getInstance().vaginaDescript(); },
		"vagina"					: function() { return CoC.getInstance().vaginaDescript(); },
		"vagorass"					: function() { return (CoC.getInstance().player.hasVagina() ? CoC.getInstance().vaginaDescript() : CoC.getInstance().assholeDescript()); },
		...
		"wings"						: function() { return CoC.getInstance().wingsDescript(); },
		"tail"						: function() { return CoC.getInstance().tailDescript(); },
		"onetail"					: function() { return CoC.getInstance().oneTailDescript(); }
	};
	...
	Parser.conditionalOptions = {
		...
		"hour"				: function() {return  CoC.getInstance().model.time.hours;},
		"days"				: function() {return  CoC.getInstance().model.time.days;},
