...
angular.module('cocjs').factory('UseableLib', function (CoC, SimpleUseable) {
	return {
		...
		GLDSTAT : new SimpleUseable('GldStat', 'GldStat', 'a golden statue', 600, 'An intricate golden idol of an androgynous humanoid figure with nine long tails.  It probably had some spiritual significance to its owner.', '', CoC.getInstance().scenes.kitsuneScene.kitsuneStatue),
