...
angular.module( 'cocjs' ).run( function( SceneLib, Descriptors, kFLAGS, CoC, EngineCore, Utils, MainView, StatusAffects ) {
	...
	Gargoyle.prototype.returnToCathedral = function( woken ) {
		...
		if( CoC.time.hours <= 9 || CoC.time.hours >= 18 || woken ) {
			if( !woken ) {
				...
				EngineCore.outputText( ' light streaming in from the broken windows, you see ' + CoC.flags[ kFLAGS.GAR_NAME ] + ' poking around some of the rubble, slowly but surely making efforts to repair the damage done to the Cathedral.  Seeing you, however, she immediately drops what she was doing and ' );
	...
	Gargoyle.prototype.gargoyleCoochiiGetsPlowed = function() {
		...
		if( this.gargoyleConfidence() >= 70 ) {
			EngineCore.outputText( '  Before you can stand, though, ' + CoC.flags[ kFLAGS.GAR_NAME ] + ' hugs her arms tightly around you pulling you down on top of her and mashing your face between her soft tits.' );
		}
	...
	Gargoyle.prototype.titFuckTheGargoyle = function() {
		...
		if( this.gargoyleConfidence() >= 70 ) {
			EngineCore.outputText( ', and to your surprise, so does ' + CoC.flags[ kFLAGS.GAR_NAME ] + '' );
		}
		EngineCore.outputText( '.' );
	...
	Gargoyle.prototype.ritualGargoyle = function() {
		...
		//[b]Ritual (Any after First)[/b];
			...
			EngineCore.outputText( 'You walk to the church\'s alter, shortly followed by ' + CoC.flags[ kFLAGS.GAR_NAME ] + '.  You ask her if she\'s still able to perform the church\'s Rituals, to which she replies "<i>Of course, Master.  Do you have need of one?</i>"' );
		}
	...
	Gargoyle.prototype.banishmentGargoyleRitual = function() {
		...
		EngineCore.outputText( ' been absorbed and purged by the rod, which ' + CoC.flags[ kFLAGS.GAR_NAME ] + ' proceeds to chuck out a window.  Hopefully she has more, in case you ever get ' );
		if( CoC.player.findStatusAffect( StatusAffects.Exgartuan ) >= 0 ) {
	...
	Gargoyle.prototype.gargoyleKinkyRituals = function() {
		...
		//(While Confidence 70+);
			...
			EngineCore.outputText( 'You walk to the church\'s alter, shortly followed by ' + CoC.flags[ kFLAGS.GAR_NAME ] + '.  You tell her you need one of her holy rituals, but that you\'d prefer to have some fun as well.  Grinning, she says, "<i>It would be my pleasure, my Master. What shall we do?</i>"' );
		}
		//(Display Options: [Body] [Mind] [Banish (only with Exgartuan or Worms)] and [Leave]);
		EngineCore.menu();
	...
	Gargoyle.prototype.kinkyBodyRitual = function() {
		...
		EngineCore.outputText( '.  She breaks the kiss and steps back, laying on one last time – CRACK! with the crop, stinging you again with an intense mix of pain and pleasure.  Gasping and panting from stimulation, you nearly collapse when ' + CoC.flags[ kFLAGS.GAR_NAME ] + ' unbinds you, though she\'s quick to catch you before you fall.' );
	...
	Gargoyle.prototype.banishPervRitual = function() {
		...
		EngineCore.outputText( '.  She gives you an understanding nod and tells you to strip.  As you do so, she dips beneath the altar, reappearing with a silver, blue-rune covered rod nestled into what looks like a leather thong.  ' + CoC.flags[ kFLAGS.GAR_NAME ] + ' slips the thong on, letting a slight gasp escape her lips as the inner end of the rod enters her.' );
		...
		EngineCore.outputText( '  ' + CoC.flags[ kFLAGS.GAR_NAME ] + ' begins to fuck you in earnest, hammering your [asshole] with the strap-on until you\'re both panting and gasping, nearly overwhelmed by sensation.' );
		//(If PC has Exgartuan: ;
		if( CoC.player.findStatusAffect( StatusAffects.Exgartuan ) >= 0 ) {
	...
	Gargoyle.prototype.gargoyleHistoryC = function() {
		...
		//(If PC has Marble as a follower);
			...
			EngineCore.outputText( 'You ask ' + CoC.flags[ kFLAGS.GAR_NAME ] + ' to tell you a little bit about the world of Mareth.  Giving it a few moments of quiet thought, she answers do not have any experience outside of the church grounds, Master, but I remember the words of the last Master, and the parishioners before her.  I believe there is a lake not far from here.  Beyond that, the world has a vast expanse of plains and woodlands, broken up by a great mountain range – strange monsters live there, but worst of all are savage bull-like beasts called Minotaurs.  And the cow-girls... Lacta-Bovines, I think they\'re called, who\'re just as nasty.</i>"' );
	...
	Gargoyle.prototype.garNameA = function() {
		...
		if( this.gargoyleConfidence() <= 69 ) {
			...
			EngineCore.outputText( 'After what she did to me, I never thought I\'d enjoy sex again.</i>"  With a loving smile, ' + CoC.flags[ kFLAGS.GAR_NAME ] + ' takes your hand in hers and brushes it against her cheek.  "<i>But for you, Master, I think I could make an exception.</i>"' );
		}
