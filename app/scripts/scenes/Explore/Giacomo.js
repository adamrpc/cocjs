...
angular.module( 'cocjs' ).run( function( MainView, SceneLib, $rootScope, Descriptors, CoC, kFLAGS, Utils, StatusAffects, EngineCore, ConsumableLib ) {
	...
	Giacomo.prototype.potionMenu = function() {
		...
		EngineCore.choices( 'Vitality T.', this.pitchVitailtyTincture, 'Scholars T.', this.pitchScholarsTea,
			'Cerulean P.', (CoC.player.gender !== 2 ? this.pitchCeruleanPotion : null), '', null, 'Back', this.giacomoEncounter );
		EngineCore.statScreenRefresh();
	};
	Giacomo.prototype.bookMenu = function() {
		...
		EngineCore.choices( 'Dangerous Plants', this.pitchDangerousPlantsBook, 'Traveler\'s Guide', this.pitchTravellersGuide, 'Hentai Comic', this.pitchHentaiComic,
			'Yoga Guide', (CoC.flags[ kFLAGS.COTTON_UNUSUAL_YOGA_BOOK_TRACKER ] > 0 ? this.pitchYogaGuide : null), 'Back', this.giacomoEncounter );
		EngineCore.statScreenRefresh();
	};
