...
angular.module( 'cocjs' ).run( function( MainView, SceneLib, CoC, kFLAGS, EngineCore, ConsumableLib, PerkLib, StatusAffects, ArmorLib, WeaponLib, Utils ) {
	...
	FollowerInteractions.prototype.amilyMeetsPureJojo = function() {
		...
		EngineCore.outputText( 'Amily appears to have located Jojo, and the two of them are actually hugging!  The smaller female mouse is crying, and Jojo looks a little misty-eyed as well.  They break apart as you approach; when out of the blue, Amily socks Jojo with a right hook!  He stumbles back, rubbing at his jaw as she yells, "<i>That\'s for not coming back to the village and finding me!  Oh sure, you could fight demons in the forest for years, but Marae forbid you come back to look for survivors!</i>"\n\n', false );
		EngineCore.outputText( 'Jojo colors, turning redder than you\'ve ever seen him.  He tries to explain himself, "<i>I\'m sorry... there were so many, and I dared not return.  If they had caught me-</i>" but stops and shudders with barely expressed fear.\n\n', false );
		EngineCore.outputText( 'Amily sighs and hugs him again, "<i>You\'re a pansy. You know that Jojo?  But I\'m glad ' + CoC.player.short + ' reunited us so that we could meet again.</i>"\n\n', false );
	...
	FollowerInteractions.prototype.amilyIsPissedAtYouForRuiningJojo = function() {
		...
		EngineCore.outputText( 'Amily screams, "<i>Don\'t even try to lie!  I met him before you did this to him, and HE TOLD ME IT WAS YOU before he passed out!  We... we have to fix him.  I don\'t know why you would do something like this, but he- he\'s broken.  Utterly.  Please.  Find some pure honey and we can fix him!</i>"\n\n' );
		EngineCore.outputText( '(You\'re at a crossroads. You can help Amily purify Jojo, but the mouse will likely never give you a chance to corrupt him again.  Alternatively, you could tell the bitch off and keep your favorite fuck-pet.)' );
		//[Fix him] [Fuck off]
	...
	FollowerInteractions.prototype.tellAmilyToFuckOffRuinedJojo = function() {
		...
		if( CoC.player.inte >= 45 ) {
			EngineCore.outputText( '  Goblin ale and lust drafts might do the trick.' );
		}
		//Follower off
	...
	FollowerInteractions.prototype.agreeToHelpAmilyFixJojo = function() {
		...
		if( CoC.player.cor < 33 ) {
			...
			EngineCore.outputText( 'unsure if you\'re making the right choice.' );
		} else {
			EngineCore.outputText( 'wondering if this will wind up as an empty promise to placate the angry mouse-cunt.' );
		}
		EngineCore.outputText( '  You say, "<i>All right, when I find some pure-honey I\'ll bring it to you so we can fix him, okay?  I don\'t know what came over me; the corruption of this place just... got to me.  Let\'s fix him together.</i>"\n\n' );
		EngineCore.outputText( 'She tearfully nods and promises, "<i>Just don\'t expect anything from me until this is taken care of.</i>"\n\n' );
		//(-5 cor
	...
	FollowerInteractions.prototype.fixJojoOOOOHYEEEEAHSNAPINTOASLIMJIM = function() {
		EngineCore.outputText( '', true );
		EngineCore.outputText( '"<i>You brought it!  Yes!</i>" cheers Amily.  She reaches into your pouches and pulls out the bottle of pure honey and takes off for the woods.  You\'re forced to chase after her, and by the time you catch up, she\'s already hit Jojo with a knock-out dart.  The corrupted mouse is still hard and dripping with spunk, even while unconscious.  Amily moans, "<i>You poor dear... here, drink up.  This will help make you better.</i>"\n\n', false );
		//She noms your honey
		CoC.player.consumeItem( ConsumableLib.PURHONY );
		EngineCore.outputText( 'She only gives him a few sips before she turns back to you and says, "<i>This is going to take me a few hours.  It would be best if you weren\'t here when he wakes up.  I doubt he\'ll want anything to do with you after this.  I\'ll give him directions to find our children.  I\'m sure they\'ll be able to help him recover the rest of the way.</i>"\n\n', false );
		EngineCore.outputText( 'You nod and leave, ', false );
		if( CoC.player.cor > 66 ) {
			EngineCore.outputText( 'already regretting your choice', false );
		} else if( CoC.player.cor > 33 ) {
			EngineCore.outputText( 'a little confused by the whole situation', false );
		} else {
			EngineCore.outputText( 'glad the damage you did to Jojo wasn\'t permanent', false );
		}
	...
	FollowerInteractions.prototype.amilyDiscoversJojoWithTentaclesAndShitOhBoy = function() {
		...
		if( CoC.player.cor > 66 ) {
			...
			//Follower off
			CoC.flags[ kFLAGS.AMILY_FOLLOWER ] = 0;
			EngineCore.outputText( 'No doubt she ran back to the ruins.  Perhaps you could gather some appropriate drugs to teach her a lesson?', false );
			if( CoC.player.inte >= 45 ) {
				EngineCore.outputText( '  Goblin ale and lust drafts might do the trick.', false );
			}
			//Follower off
			CoC.flags[ kFLAGS.AMILY_FOLLOWER ] = 0;
			CoC.flags[ kFLAGS.AMILY_CORRUPT_FLIPOUT ] = 1;
	...
	FollowerInteractions.prototype.stopJojoDeathInTheNameOfLove = function() {
		...
		if( CoC.player.inte < 40 ) {
			//(NOT SMART)
			EngineCore.outputText( 'Stop, think about this.  We can\'t do this, can we?</i>"   She answers, "<i>We do what we must,</i>" and pulls her dagger.  You can\'t watch the grisly deed and avert your eyes.  She slits the once-pious monk\'s throat and it\'s done.  The two of you build a cairn of rocks over the mouse\'s body, as fitting a burial as you\'re able to provide for him.' );
			//(-80 lust)
		...
		//(SMART)
			...
			EngineCore.outputText( 'Amily, this is wrong.  He may be corrupted, but we don\'t need to kill helpless innocents, no matter how horny they may be.  Yes he\'s corrupted beyond redemption, but his body and mind aren\'t geared towards spreading that corruption.  The mouse isn\'t a threat to anyone.</i>"\n\n' );
			EngineCore.outputText( 'She slowly nods and pulls her hand away from her dagger.  Amily answers, "<i>You\'re right, as usual.  I\'ll leave him be, but if you ever do something like this again, I\'m gone.</i>"\n\n' );
			//(+1 int)
	...
	FollowerInteractions.prototype.AmilyIntroducesSelfToRathazul = function() {
		...
		EngineCore.outputText( 'Amily is here with the elderly rodent alchemist and carrying on a rather deep conversation.  They have not noticed you yet, and the two are currently discussing the medicinal properties of the various herbs and materials in Mareth.  Amily pays rapt attention as the old rat concludes his lecture on the effects of imp grass.  She thanks him, "<i>I really appreciate this, Rathazul.  I know our tribes never saw eye to eye, but you\'ve done a lot.  My father was an alchemist like you, and I know he\'d be happy to know someone like you was continuing to teach me the craft.</i>"\n\n', false );
		EngineCore.outputText( 'The wise rat strokes his frazzled whiskers as he listens, clearly pleased with the younger rodent\'s words.  "<i>The pleasure is mine.  It\'s not often I find such a rapt and attentive listener,</i>" he replies.\n\n', false );
		EngineCore.outputText( 'Amily gives him a friendly hug and turns to leave.  She squeaks in surprise when she sees you and stamps over to demand, "<i>How long have you been there?</i>"\n\n', false );
		EngineCore.outputText( 'You stutter for a second until she kisses you on the lips and laughs, "<i>It\'s ok, we were just wrapping up the lesson.  Go on, I\'m sure you have something important to see to with Rathazul!</i>"\n\n', false );
	...
	FollowerInteractions.prototype.amilyIngredientDelivery = function() {
		EngineCore.outputText( '', true );
		EngineCore.outputText( 'As you make your way to Rathazul\'s lab, a ', false );
		if( CoC.flags[ kFLAGS.AMILY_NOT_FURRY ] === 1 ) {
			EngineCore.outputText( 'big-eared blur whizzes past you', false );
		} else {
			EngineCore.outputText( 'blur of fur whizzes past you', false );
		}
		EngineCore.outputText( '.  Amily sprints into the rat\'s lab with an armful of flowers, plants, and other ingredients.  Rathazul says, "<i>Thank you, child - these will be a huge help.  It is fortunate you knew where to find some of these.  Purchasing them is difficult and expensive.</i>"\n\n', false );
		EngineCore.outputText( 'Amily bobs her head happily as Rathazul reaches into his robes and says, "<i>Here is the payment, as promised,</i>" and hands her an old alchemical text.  She squeals happily and runs past you, her tail curling about your waist for the briefest moment before she\'s gone.\n\n', false );
		//[To rathazul, +4 lust]
	...
	FollowerInteractions.prototype.rathazulFreaksOverJojo = function() {
		...
		EngineCore.outputText( '(He is mine, I can handle it, or he\'s harmless?)' );
	...
	FollowerInteractions.prototype.beAPimpMarbleLovesIt = function() {
		EngineCore.outputText( '', true );
		//Pimp (B1)
		EngineCore.outputText( 'You look at both of them in the eyes in turn before replying, "<i>Come on girls, there is plenty of me to go around!</i>"  ', false );
		//Can go to B2 if the PC is addicted to Marble, otherwise B3
		//Pimp -> PC is addicted (B2)
		if( CoC.player.findPerk( PerkLib.MarblesMilk ) >= 0 ) {
			EngineCore.outputText( 'Marble blinks before saying "<i>' + CoC.player.short + ', try again, I know you\'re better than that.</i>"  You blink in response and wonder yourself what possessed you to say that.\n\n', false );
	...
	FollowerInteractions.prototype.jokeAboutPimpularness = function() {
		EngineCore.outputText( '', true );
		EngineCore.outputText( 'You assure them that you thought a joke might help them calm down.  The two of them seem to disagree with you on that sentiment, but wait for you to say something else.', false );
		//Player chooses stay silent (A1) or explain (C1)
		EngineCore.choices( 'StaySilent', this, this.marbleIsPissyAndYourTooDumbToTalk, 'Explain', this, this.LucyYouGotSomeSplainingToDo, '', null, null, '', null, null, '', null, null );
	};
	FollowerInteractions.prototype.LucyYouGotSomeSplainingToDo = function() {
		EngineCore.outputText( '', true );
		//Explain (C1)
		EngineCore.outputText( 'You spend some time trying to explain to the two of them why you never told either of them about each other.  ', false );
		...
		EngineCore.outputText( 'After a while it becomes apparent to both yourself and the others that you have no idea what you\'re talking about.  Marble then says to you, "<i>Well, do you have anything else to say?</i>" At this point it probably isn\'t possible to say something to make both of them happy, will you stay silent or turn on one of them to try and keep the other?\n\n', false );
		if( CoC.player.findPerk( PerkLib.MarblesMilk ) >= 0 ) {
			EngineCore.outputText( 'Since you need Marble\'s milk to live, there\'s no way you can blame her.  It would be tantamount to suicide.', false );
			blameMarble = null;
		}
	...
	FollowerInteractions.prototype.askAboutAmily = function() {
		...
		EngineCore.outputText( 'To a mixture of confusion and relief, you realize they aren\'t the sounds of violence.\n\n', false );
		EngineCore.outputText( '"<i>Mmm... yeah, you\'re *burp* great at this!</i>" you hear Urta groan, laboriously.\n\n', false );
		EngineCore.outputText( 'This is met with a chittering squeal you distinctly recognize as Amily\'s.  "<i>Oooohhh... I see why ' + CoC.player.short + ' - yeah, gimme all you got! - fell for you!</i>"\n\n', false );
	...
	FollowerInteractions.prototype.cheatingSloots = function() {
		EngineCore.outputText( '', true );
		EngineCore.outputText( 'You kick open the door and roar, "<i>What the fuck is this!?</i>"  Both Amily and Urta turn to you and look at you with puzzled expressions before the severity of the situation seeps into their alcohol-fuzzed consciousnesses.  Almost simultaneously, they yell, "<i>' + CoC.player.short + '!</i>" and stumble apart drunkenly, leaking each other\'s slime all over the floor.  Urta slurs, "<i>We didn\'t mean to... it jusht... happened...</i>"\n\n', false );
		EngineCore.outputText( 'You growl and turn to Amily, who quietly squeaks, "<i>I thought... I thought if I knew her better *hic* I could find a way to save what we had... *burp* I am REALLLY out of it, but I thought... ya know, if I was willing to sleep with her too that we could all be happy together.</i>"\n\n', false );
		EngineCore.outputText( 'Well, the mouse may have a point.  You could let them get to know each other and perhaps turn this into a threesome down the road, or you could put a firm end to it right now.  There\'s a pretty good chance putting your boot down on this might piss off one of them.', false );
		//[Let Them Be] [End It]
	...
	FollowerInteractions.prototype.beADickToAmily = function() {
		EngineCore.outputText( '', true );
		EngineCore.outputText( 'With a wicked, shit-eating grin, you tease Amily about falling into the trap she set for you.  Her expression hardens, winces breaking her frown as her hangover thrums every time you laugh.\n\n', false );
		EngineCore.outputText( '"<i>F-fuck you, ' + CoC.player.short + ',</i>" she finally rejoins.  "<i>You did the same damn thing.</i>"\n\n', false );
		EngineCore.outputText( 'You tell her that\'s <b>exactly</b> why you\'re laughing; she may act pure and monogamous, a perfect little wife, but her legs spread open just the same as every other whore\'s when confronted with a hard and ready cock like Urta\'s.\n\n', false );
		EngineCore.outputText( '"<i>That\'s bullshit!</i>" she fumes, jumping to her feet with a hand to her head.  "<i>I don\'t have to take that from you, asshole!  Did you maybe stop and think that I fell for Urta because she\'s humble and kind and tried to understand my feelings?  When I went to her over this she was nothing but patient with me, even as I raged at her!  She even forgave <b>you</b> for keeping me a secret, and Marae-knows what a piece of crap <b>you</b> are!  You know what?  I\'m glad I did it all.  Because now I know I have somewhere else I can go to see another decent person.  I\'m leaving you.</i>"\n\n', false );
		EngineCore.outputText( 'With that, Amily grabs her gear closest to hand and pushes past you with the best flounce she can manage, heading toward the desert.', false );
	...
	FollowerInteractions.prototype.amilyUrtaSex = function() {
		...
		EngineCore.outputText( '', true );
		EngineCore.outputText( 'With a knowing smirk, you ask how Amily would feel about going to see Urta and maybe having a little fun with her.  The mouse-girl flushes with embarrassment, but you can see the eagerness in her body language.  "<i>Okay, sure; I kind of like going to the city... besides, between you and me?  I think Urta needs all the friends she can get... never thought I\'d feel sorry for a hermaphrodite.</i>"  She mumbles this last part to herself, but you can still hear her.', false );
		if( CoC.player.cor > 50 && CoC.flags[ kFLAGS.AMILY_WANG_LENGTH ] > 0 ) {
			EngineCore.outputText( '  Privately, you note that it\'s bullshit; she\'s nothing <b>but</b> self-pity.', false );
		}
		EngineCore.outputText( '\n\n', false );
		EngineCore.outputText( 'With a gesture, the two of you set off.  As soon as you pass through the gates, you head towards the Wet Bitch.  Sure enough, Urta is at her usual table, and she smiles in delight to see you.  "<i>' + CoC.player.short + ', Amily, hello!</i>"  You take seats at the same table, as she ', false );
		...
		EngineCore.outputText( '.\n\n', false );
		EngineCore.outputText( 'Amily smiles shyly at the fox, but clearly can\'t bring herself to say why you\'re here.  So, you decide to take matters into your own hands.  Smiling knowingly, you reach a hand under the table to caress Urta\'s excited erection.  "<i>I was thinking we could take this little pony for a ride.  What do you think?</i>" you ask playfully.\n\n', false );
		EngineCore.outputText( 'Urta\'s face lights up in hungry delight and she promptly gets up and hurries off to one of the backrooms.  Amily also arises, face red with shame, and quickly follows her, with you bringing up the rear.\n\n', false );
		EngineCore.outputText( 'Once the three of you are in a empty room, you lock the door behind you as Urta and Amily both strip down, eyeing each other and you with equal attention.  "<i>So... are you going to partake?  Or just watch?</i>" Amily asks, hesitantly.', false );
	...
	FollowerInteractions.prototype.amilyUrtaSexWatch = function() {
		EngineCore.outputText( '', true );
		EngineCore.outputText( 'You tell the two that, this time, you\'re content to just watch.  You head over to one end of the couch and sit down, leaning back and waiting for them to begin.\n\n', false );
		EngineCore.outputText( 'Urta takes a deep breath, and then exhales it slowly.  "<i>I\'m not really used to doing this with an audience... but it might be fun to give it a try,</i>" she declares.  You can see her erection isn\'t shrinking at the prospect.\n\n', false );
		EngineCore.outputText( '"<i>I\'m... not sure of how we\'ll do this,</i>" Amily says, hesitant despite the gathering moisture in her nether lips.\n\n', false );
		...
		EngineCore.outputText( '.  Straddling Urta and aligning the heavy horse-cock with her moist snatch, Amily teases, "<i>Ready for this, foxy?</i>"  Her eyes dart towards you for a split second.\n\n', false );
		EngineCore.outputText( 'You just smile gently and watch Urta, who swallows hard, tongue lolling out with anticipation before she remembers herself.  "<i>Anytime, little mouse; if you can handle all of this.</i>"  She\'s obviously trying to be bold about this - maybe your presence is unnerving her more than you thought.\n\n', false );
		EngineCore.outputText( 'Amily spares you another quick glance and lets gravity do its work, spearing herself on Urta\'s equine dick; she squeaks in pleasure and pain at the sudden intrusion.  Urta lets out a soft whine of delight, all attention lost from you and focused on the womanly folds now gripping her shaft.  "<i>Are you all right?</i>" she asks, a worried look eclipsing any show of pleasure.\n\n', false );
		EngineCore.outputText( '"<i>Y-Yeah, just give me a second to get adjusted,</i>" Amily replies, bending over to support herself on the floor, bringing her panting lips dangerously close to Urta\'s own.  Too close, evidently, as Urta can\'t resist kissing her rodent lover when she does so.  Amily kisses her back, rubbing their breasts together as they begin to make out; Amily\'s hips begin slowly moving up and down Urta\'s shaft, settling in a slow rhythm.  It doesn\'t take long for the room to be filled with muffled squeaks and moans, as well as the noise of the wet grinding of cock and pussy.\n\n', false );
		EngineCore.outputText( 'Urta huffs and growls, easily getting into the spirit of things as she thrusts her long, girthy shaft into the rodent\'s surprisingly stretchable cunny.  Well, now you have a good idea why the demons would want to enslave her people, if she\'s typical of their ability to handle large insertions...\n\n', false );
		EngineCore.outputText( 'Amily breaks the kiss and reaches towards the ceiling, voicing her pleasure as she meets each and every one of Urta\'s thrusts. Her gaze turns to you and she looks at you with pure, undiluted lust; the idea of putting on a show for you bringing her to a whole new level of pleasure; the mouse-girl obviously has an exhibitionist streak!  Urta\'s tongue lolls out and she starts to whine and pant.  You can tell it\'s not going to be long before she cums...\n\n', false );
		EngineCore.outputText( 'Amily squeaks and moans, her stretched pussy clamping down as she impales herself fully on  Urta\'s invading shaft.  Urta can\'t take it any more; she actually barks with joy as her apple-sized nuts visibly clench, unleashing a cumsplosion into your rodent lover\'s waiting womb.\n\n', false );
		EngineCore.outputText( 'Amily does her best to milk Urta for all she\'s worth, even as her belly bloats with the volume of the vixen\'s spunk. Urta, in return, tries to give Amily everything she has, her hands clasping onto Amily\'s inflating belly and cradling it as if it were swollen with the lonely prick-vixen\'s children.  But, even Urta has her limits and, soon enough, the last jet of spunk splashes into Amily\'s depths, Urta\'s cock going flaccid as she spends her arousal into her lover.\n\n', false );
