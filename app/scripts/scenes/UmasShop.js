...
angular.module('cocjs').factory('UmasShop', function ($log, CoC, EngineCore, kFLAGS, StatusAffects, PerkLib, Utils) {
	...
	UmasShop.prototype.firstVisitPart2 = function() {
		EngineCore.clearOutput();
		EngineCore.outputText('Loppe bounces up towards the tall equine and they embrace in a friendly hug.  "<i>Hi, mom!</i>"  Uma laughs softly . "<i>Hello my little horsey hopper.  Who is this?</i>" she asks, looking at you.\n\n');
		...
		EngineCore.outputText('Loppe looks at you with disdain, then adds, "<i>Yes, [he]\'s a friend alright.</i>"  Loppe clears her throat.  "<i>Mom, I would like to introduce you to [name], my [boyfriend].</i>"\n\n');
		...
		EngineCore.outputText('Uma looks between the two of you with interest.  "<i>[Boyfriend] huh?  So it\'s you whom I have to thank for the broken springs in Loppe\'s bed?</i>" Uma says with a smile, offering you a hand.\n\n');
		EngineCore.outputText('You give her a winning smile back and accept it, wondering if you should prepare yourself for a macho-type squeezing match.  Even as you shake her hand, you apologize, telling her it wasn\'t your intention to make Loppe\'s bed need replacement springs.\n\n');
		EngineCore.outputText('Loppe and Uma look at each other and then they both burst out laughing.  "<i>Oh, sugar... you\'re so silly,</i>" Loppe says.  "<i>[name], I learned a long time ago that Loppe\'s beds must be both battle and waterproof.  So, her bed is custom made; you could have an army of minotaurs stomp through and it wouldn\'t even bend.</i>" Uma says with a grin.\n\n');
		EngineCore.outputText('You give them your best confused expression, realising that Uma and her daughter must have similar tastes in humor; she was evidently joking with you.\n\n');
		EngineCore.outputText('Uma is the first to break the awkwardness.  "<i>Well then, care to give me the details?  How did you two meet?  When did you start fooling around?  Has my daughter worked so hard you had to seek a healer yet?</i>"\n\n');
		EngineCore.outputText('Loppe holds your hand and the two of you begin detailing how you met....\n\n');
		EngineCore.menu();
		EngineCore.addButton(0, 'Next', this.firstVisitPart3);
	};
	/**
	...
	UmasShop.prototype.firstVisitPart3 = function() {
		...
		EngineCore.outputText('"<i>Yeah, she is nice, she\'s just a little... quirky sometimes,</i>" Loppe agrees.  "<i>And I think she likes you too, sugar; nice work.</i>"  She grins, patting you on the shoulder.\n\n');
		EngineCore.outputText('You tell her that you\'re glad, but you have other things to do, so you\'ll catch her some other time. "<i>Alright sugar, see you around,</i>" Loppe announces as she turns and walks away, back in the direction of her home, leaving you to start heading back to what passes for yours in this world.\n\n');
		EngineCore.outputText('<b>Uma\'s Clinic is now available from the Tel\'Adre shops menu!</b>');
		// Flag the shop visit
	...
	UmasShop.prototype.enterClinic = function(returnedTo) {
		...
		if (!returnedTo) {
			...
			if (CoC.getInstance().player.femininity >= UmasShop.UMA_CONSIDER_PC_FEM) {
	...
	UmasShop.prototype.buildCoreMenu = function(noSex) {
		if (noSex) {
			EngineCore.outputText('You sigh softly, but accept Uma\'s sexuality is the way it is and apologize for the problem.\n\n');
		...
		EngineCore.menu();
		EngineCore.addButton(0, 'Massage', this.massageMenu);
		EngineCore.addButton(1, 'Acupunct.', this.acupunctureMenu);
		EngineCore.addButton(2, 'Talk', this.talkMenu);
		if (!noSex) {
			EngineCore.addButton(3, 'Sex', this.sexMenu);
		}
		//addButton(4, 'Train Loppe', this.trainLoppe); // Unfinished in the doc
		EngineCore.addButton(9, 'Leave', CoC.getInstance().telAdre.telAdreMenu);
	};
	/**
	 * MASSAGEU
	 */
	...
	UmasShop.prototype.massageMenu = function() {
		...
		EngineCore.outputText('"Your libido getting you down?  Find that it\'s just too easy for you to get turned on?  This special massage will help make you too relaxed to get horny for a few hours," reads the first one.\n\n');
		EngineCore.outputText('The second one, on the other hand, states, "Want to get into the mood for some special fun, but finding it a challenge?  This special massage will get you primed and ready for some sweet, sweet loving."\n\n');
		EngineCore.outputText('"Feel good and look better with this special modelling massage; the boys, girls and herms will be drooling over you while it lasts," reads the third; you\'re not surprised that most of treatments seem to have some sexual benefit.\n\n');
		EngineCore.outputText('"Muscles sore and aching?  Weary down to your bones?  A nice relaxing massage can alleviate your pain and fatigue, and help you unwind more effectively," is how the fourth option describes itself.\n\n');
		EngineCore.outputText('Finally, the last message in the catalogue reads, "Need a little more power?  Going to have a fight on your hands soon?  With the special arts of do-in, we can boost your muscles and let you deliver a real knock-out punch - it doesn\'t last forever, so be careful!"\n\n');
		EngineCore.outputText('You contemplate your choices carefully.');
		EngineCore.menu();
		EngineCore.addButton(0, 'Relief', this.massageRelief);
		EngineCore.addButton(1, 'Lust', this.massageLust);
		EngineCore.addButton(2, 'Modelling', this.massageModelling);
		EngineCore.addButton(3, 'Relaxation', this.massageRelaxation);
		EngineCore.addButton(4, 'Power', this.massagePower);
		EngineCore.addButton(9, 'No Thanks', this.massageNope);
	};
	/**
	...
	UmasShop.prototype.massageNope = function() {
		...
		EngineCore.menu();
		EngineCore.addButton(0, 'Next', this.enterClinic, true);
	};
	/**
	...
	UmasShop.prototype.massageRelief = function() {
		...
		EngineCore.outputText('"<i>I see... come along then,</i>" Uma replies, motioning for you to follow.  You nod and promptly do as she asks.');
	...
	UmasShop.prototype.massageLust = function() {
		...
		EngineCore.outputText('Uma gasps in mock hurt.  "<i>Are you doubting my skills, dear?  Of course I can help you!  Follow me.</i>" Uma replies, motioning for you to follow her, and you trail along behind the mare masseur.\n\n');
	...
	UmasShop.prototype.massageModelling = function() {
		...
		EngineCore.outputText('You thank her for the professional opinion, and indicate she should lead the way.\n\n');
	...
	UmasShop.prototype.massageRelaxation = function() {
		...
		EngineCore.outputText('"<i>Very well... don\'t want you too burned out to deal my little Loppe afterwards.  Follow me.</i>"  Uma motions for you to follow her, and you trail after her, looking forward to your treatment.\n\n');
	...
	UmasShop.prototype.massagePower = function() {
		...
		EngineCore.outputText('"<i>Now, now, dear.  There\'s no need to be so dramatic... but I\'m worried about what you intend to do?  I have heard of, and even seen, some of the dangers that are out there, beyond the walls of this city.  Shouldn\'t you just come live with us, instead?  I\'d hate to have anything happen to you, and Loppe would be crushed...</i>"\n\n');
		EngineCore.outputText('You tell her that you appreciate your sentiment, and you have no intention of hurting Loppe, but you have a mission and you are sworn to complete it; the demons must fall, and you won\'t stop until they have been defeated.');
		EngineCore.outputText('"<i>I understand.  In that case, follow me,</i>" Uma replies, motioning for you to follow her.  You let her lead the way and follow close behind.\n\n');
	...
	UmasShop.prototype.massageMain = function(selectedMassage) {
		...
		EngineCore.menu();
		EngineCore.addButton(0, 'Next', this.massageCommence, selectedMassage);
	};
	/**
	...
	UmasShop.prototype.massageCommence = function(selectedMassage) {
		...
		} else if (CoC.getInstance().player.femininity >= UmasShop.UMA_CONSIDER_PC_AND) {
	...
	UmasShop.prototype.applyMassageBonus = function(selectedMassage) {
		if (selectedMassage < 0 || selectedMassage > 4) {
			...
			if (selectedMassage === UmasShop.MASSAGE_RELIEF) {
				EngineCore.outputText('<b>You feel so relaxed and mellow... you don\'t think you\'ll be able to get in the mood for sex while you feel this blissed out.</b> ' + UmasShop.MASSAGE_RELIEF_BONUS_TEXT);
				bonusValue = UmasShop.MASSAGE_RELIEF_BONUS;
			} else if (selectedMassage === UmasShop.MASSAGE_LUST) {
				EngineCore.outputText('<b>You feel so... wired! Your skin tingles with the slightest breeze, your heart races in your chest, and you lick your lips with eager nervousness.  You wanna fuck something so badly!</b> ' + UmasShop.MASSAGE_LUST_BONUS_TEXT);
				bonusValue = UmasShop.MASSAGE_LUST_BONUS;
			} else if (selectedMassage === UmasShop.MASSAGE_MODELLING) {
				EngineCore.outputText('<b>You feel sexier; you don\'t know if the massage has actually affected your looks, but you definitely have the confidence to strut your stuff!</b> ' + UmasShop.MASSAGE_MODELLING_BONUS_TEXT);
				bonusValue = UmasShop.MASSAGE_MODELLING_BONUS;
			} else if (selectedMassage === UmasShop.MASSAGE_RELAXATION) {
				EngineCore.outputText('<b>Your aches and pains have vanished, and you feel so relaxed and rested.  That really did the trick in curing what ails you.</b> ' + UmasShop.MASSAGE_RELAXATION_BONUS_TEXT);
				bonusValue = UmasShop.MASSAGE_RELAXATION_BONUS;
			} else if (selectedMassage === UmasShop.MASSAGE_POWER) {
				EngineCore.outputText('<b>Your muscles tingle and burn with energy; you feel like you could knock out a minotaur in one punch!</b> ' + UmasShop.MASSAGE_POWER_BONUS_TEXT);
	...
	UmasShop.prototype.acupunctureMenu = function() {
		...
		if (this.hasNeedleworkPerk()) {
			...
			EngineCore.outputText('You tell her that you understand what she\'s saying, and consider the decision carefully.  You ask her how difficult she estimates the process would be, given the past sessions you have endured.\n\n');
			EngineCore.outputText('The mare takes a moment to inspect you carefully, seeming to look through rather than at you.  "<i>This could be quite a challenge, even for my skills... but, seeing as you\'re my little hoppers special someone, just for you I will have to ask for ' + String(sessionCost) + ' gems.  That\'s half the price of what I\'d usually charge for work this difficult.</i>"\n\n');
			EngineCore.menu();
			EngineCore.addButton(0, 'Undo', this.needleworkSession, UmasShop.NEEDLEWORK_UNDO);
		} else {
			EngineCore.outputText('"<i>Are you sure, dear?  While the effects of a Do-in massage will fade eventually, acupuncture is fairly... permanent.  Though I can only give you the effects of one type of needlework at a time...</i>"\n\n');
			EngineCore.outputText('You tell her that you understand what she\'s saying, and thank her for warning you. You ask her what kinds of effects you can expect from her needlework and how much it\'s going to cost you.\n\n');
			EngineCore.outputText('"<i>Well, fine.  So long as you\'re sure.  Normally, I would just show you a catalog, but I suppose you\'d prefer needlework that can be used for combat, yes?</i>"\n\n');
			EngineCore.outputText('You tell her that would probably be most useful to you, yes.\n\n');
			EngineCore.outputText('"<i>Keep in mind that while they have beneficial effects, due to the disruption they cause within the chi flow inside your body... they also come with some drawbacks.  That said, there are a few types of needlework that you might find useful...</i>"  She takes a deep breath, clearly running through a mental checklist, and then begins to speak.\n\n');
			...
			EngineCore.outputText('"<i>I understand that lust plays an important part in fighting, so I could make you more resistant to the advances of the creatures outside the city, as well as augment your ability to, well, entice them.  However this comes with a cost, you will constantly need to have sex, or your chi flow will begin to burn up, increasing your sensitivity as well as your libido.</i>"\n\n');
			EngineCore.outputText('"<i>If you are uncertain of your toughness, your ability to resist the damage inflicted upon you by the creatures that prowl the wilderness, I can bolster that.  However, modifying the chi flow in such a manner causes your limbs to lose some of their power; you will be slower, and find it harder to escape from enemies that even your newfound resilience cannot protect you against.</i>"\n\n');
			EngineCore.outputText('"<i>One of my special needleworks favored by mages will redirect chi from your muscles to your mind; your blows will be weaker, but your spells will be far more potent.</i>"\n\n');
			EngineCore.outputText('"<i>Finally, I can use my needles to rearrange your chi flow and optimise your offense; your blows will be far more powerful, but your natural defense will be impaired, making you more vulnerable to strikes by the enemy.</i>"\n\n');
			EngineCore.outputText('The mare tries to remember any other types of needlework that might be useful to you, but ultimately, she can\'t think of anything else.  "<i>That\'s all you might use, I think...</i>"  She then pauses.  "<i>As for a price, given you\'re my little Loppe\'s special someone, shall we say ' + String(sessionCost) + ' gems?  That\'s half-price of what I\'d usually charge.</i>"\n\n');
			EngineCore.menu();
			EngineCore.addButton(0, 'Speed', this.needleworkSession, UmasShop.NEEDLEWORK_SPEED);
			EngineCore.addButton(1, 'Lust', this.needleworkSession, UmasShop.NEEDLEWORK_LUST);
			EngineCore.addButton(2, 'Defense', this.needleworkSession, UmasShop.NEEDLEWORK_DEFENSE);
			EngineCore.addButton(3, 'Magic', this.needleworkSession, UmasShop.NEEDLEWORK_MAGIC);
			EngineCore.addButton(4, 'Attack', this.needleworkSession, UmasShop.NEEDLEWORK_ATTACK);
		}
		...
		if (this.hasNeedleworkPerk()) {
			EngineCore.outputText('considering Uma\'s information.\n\n');
		} else {
			EngineCore.outputText('wondering what you should choose...\n\n');
		}
	};
	/**
	...
	UmasShop.prototype.talkMenu = function() {
		...
		EngineCore.menu();
		EngineCore.addButton(0, 'Job', this.talkJob);
		EngineCore.addButton(1, 'Sexuality', this.talkSexuality);
		EngineCore.addButton(2, 'Loppe', this.talkLoppe);
		EngineCore.addButton(3, 'Loppe\'s Dad', this.talkLoppesDad);
		EngineCore.addButton(9, 'Back', this.enterClinic, true);
	};
	/**
	 * Talk Job
	 * Edit Status: 95%
	...
	UmasShop.prototype.talkJob = function() {
		...
		EngineCore.outputText('So, Uma manipulates the energy inside of people for a living?  But why would anyone want her to do that?  You ask this to the mare, hoping for clarification.\n\n');
		EngineCore.outputText('"<i>Manipulating the chi inside someone can have various beneficial effects, such as improving strength, altering sexual drive, getting rid of pains, alleviating mood swings... basically anything you can imagine has a relationship, no matter how detached, to chi.</i>"\n\n');
		EngineCore.outputText('You nod your head in understanding; that makes sense.  So, what\'s the difference between the massages - do-in, she called them? - and acupuncture?  Don\'t they both do the same thing?\n\n');
		EngineCore.outputText('Uma smiles and shakes her head.  "<i>No, dear.  Do-in adjusts the flow of chi, such as increasing output in certain areas, or reducing them.  Picture this; your chi flows like a river, by enlarging or shrinking the stream, the river\'s strength will either increase or diminish, correct?  This is what Do-in does, it never cuts the flow of the river, just... adjusts it.</i>"\n\n');
		EngineCore.outputText('You tell her that\'s correct, and you understand the analogy. So, how does acupuncture differ in its effects?\n\n');
		EngineCore.outputText('"<i>During acupuncture I pierce key spots in your body with needles; these are much more complicated than Do-in, despite do-in not being simple to begin with.  Basically, using the previous analogy, acupuncture obstructs the flow of the river, so that it can flow elsewhere, or flow differently.  The effects of Do-in are just temporary, which means that given enough time, the river will return to normal, but acupuncture... that is permanent, dear.  Once a new pathway has been made for the flow of chi inside your body, it\'s there to stay... though with some work it might just be possible to remove the effects...</i>"  Uma rubs her chin in thought.\n\n');
		EngineCore.outputText('You nod your head thoughtfully, digesting what you have been told.\n\n');
	...
	UmasShop.prototype.talkLoppeAttitudes = function() {
		EngineCore.outputText('"<i>What do you think of Loppe?  How she acts?  Looks?  Behaves?</i>"  Uma asks with a smile.\n\n');
		EngineCore.outputText('You\'re not quite sure what Uma\'s getting at and tell her as much, but finally declare that you\'d probably call her girly.  A little on the tomboyish side, but, given she\'s a herm that only seems reasonable; it\'s hard to say what gender traits would be best for a person who is functionally both male and female.\n\n');
		EngineCore.outputText('"<i>That\'s true, but what you probably don\'t know is Loppe was a lot more troublesome when she was just a little hopper.  She was a lot more boyish, and if anyone called her a girl she\'d happily start an all out brawl at a moments notice.</i>"\n\n');
		EngineCore.outputText('You think it over and note that makes sense; when she was that age, well, she\'d hardly have been able to really tell the difference between the genders, and it\'s not like she would have had any problems convincing the boys she was one of them, right?\n\n');
		EngineCore.outputText('"<i>Yes, especially since she was flat-chested back then... but she was quite a handful. The eldar would call for me regularly to discuss my little hoppers behaviour. I guess she was kind of a bully, so I had to discipline her many times.</i>"\n\n');
		EngineCore.outputText('You note that\'s more of a surprise to you than Loppe being a tomboy; she\'s always so sweet and kindly when you\'re around her.  You can\'t deny that she\'s a little on the horny side, but still, she\'s a nice person.\n\n');
		EngineCore.outputText('"<i>That\'s because she underwent a very radical change when she finally hit puberty.  Most children get a little rebellious, but not my Loppe, oh no.  If anything she became obedient, almost to a fault. In fact... for a while I thought she was actually sick or worried about something.  But she assured me she was just tired of sitting through my scoldings, and didn\'t see a reason to challenge me anymore.  It was kind of cute too, she started asking me all kinds of questions, especially why she had both genders.</i>"\n\n');
		EngineCore.outputText('You note that it must have been a troubling time in her life; you remember going through puberty, and you can\'t imagine how hard it must have been to go through the hassles of things like the first period <i>and</i> uncontrollable erections simultaneously.  Though being the mother to a herm in puberty can\'t have been a picnic either...\n\n');
		...
		EngineCore.outputText('Slips up?\n\n');
		EngineCore.outputText('"<i>Sometimes she\'ll let loose the foulest belches in public, or... </i>readjust<i> herself in public</i>" replies Uma, her hand cupping an imaginary bulge at her crotch.  "<i>She does things that a lady wouldn\'t let herself get caught dead doing when she forgets about her desire to appear lady-like.</i>"\n\n'); // Changed this line pretty significantly, might wanna compare it etc
		EngineCore.outputText('Well, you can\'t say you\'ve ever caught her doing anything like that... except for her tendency to wrestle you into bed, or having to nurse a very noticable erection in public, you joke.  You really can\'t see Loppe as the type to burp at all, though you admit she\'s a bit more a glutton than you would have expected such a dainty-looking lady like her to be.\n\n');
		EngineCore.outputText('"<i>Oh, but she of course you wouldn\'t catch her doing any of that, she\'s extra careful around you... believe me, I\'ve seen her when she gets home after a date with you.  She\'s at least twice as tired as she usually is, no doubt due to keeping her boyish tendencies in check.</i>"\n\n');
		EngineCore.outputText('You wonder if maybe you should tell her that she doesn\'t have to try so hard to impress you; you want to be able to say you like her for who she is, the real her, not some act she forces herself to go through.  You don\'t realize you\'ve been musing aloud until Uma responds.\n\n');
		EngineCore.outputText('"<i>Dear, that wouldn\'t help at all.  She wouldn\'t be with you if she thought you would leave her if she was rude, but she owes it to herself to act like a proper lady around you.  So the best you can do is pretend to buy into her act.</i>"\n\n');
	...
	UmasShop.prototype.talkLoppeCarrotIncident = function() {
		EngineCore.outputText('"<i>Tell me, [name].  Did you know rabbits love carrots?</i>"  Uma asks with a smirk.\n\n');
		EngineCore.outputText('You tell her that\'s what people say, back in the village you come from.  But, then again, you smirk, they also say that horses love carrots too, and you verbally recount an incident in which a mare broke out of her pen and ate so many carrots from one of the village fields she was heartily sick.  You ask jokingly if Uma shares any favorite dishes with her daughter?\n\n');
		EngineCore.outputText('"<i>Of course I do.  I happen to have a soft spot for carrot cake myself... but that\'s not why I asked.  As you know, my daughter is part equine and part leporid, so as you can imagine she loves carrots, right?</i>"\n\n');
		EngineCore.outputText('You nod, proclaiming that it\'s a little cliché.  So, why is Uma talking about vegetables?\n\n');
		EngineCore.outputText('Uma grins mischievously at you.  "<i>Did you know my little Loppe loves carrots so, so much... that she tried to have sex with one?</i>"\n\n');
		EngineCore.outputText('...Okay, that\'s a story that you feel you need to hear, and you tell this to the dirty old mare who calls herself Loppe\'s mother.\n\n');
		EngineCore.outputText('Uma smiles knowingly. "<i>I thought that might pique your interest.  Well... Loppe was in a experimentative mood, and I\'m pretty good at hiding my toys, so she couldn\'t find anything to sate her curiosity.  That is until she found a piece of carrot, and let\'s just say it had a pretty familiar shape... you know what I\'m getting at?</i>"\n\n');
		EngineCore.outputText('You can\'t resist the wry grin; did she really...?\n\n');
		EngineCore.outputText('Uma nods.  "<i>And I caught her going at it too.  Silly little Loppe, she thought she could hide the facts from her mother...</i>"  Uma shakes her head in mock disapproval.  "<i>She slipped the carrot out of herself as fast as she could manage and pretended she was just having a snack in the tub.  Judging by the look on her face when she took a bite, I could easily see she wasn\'t used to taste of carrot with her own... sauce...</i>"  Uma chuckles to herself.\n\n');
		EngineCore.outputText('You ask in disbelief if Uma actually made her daughter eat her own carrot dildo?\n\n');
		EngineCore.outputText('Uma shakes her head.  "<i>No no, of course not.  But back then Loppe wasn\'t so open about her sexuality either, and she had to make me buy into her argument.  Of course... I let her get away with it, but I laughed once I was sure she was out of earshot.</i>"  Uma smiles, recalling the event.\n\n');
		EngineCore.outputText('You chuckle and suggest that Loppe probably never used carrots in that fashion again?\n\n');
		EngineCore.outputText('Uma smirks.  "<i>Well, on certain lonely nights I did see a few carrots going missing from our stash...</i>"\n\n');
		EngineCore.outputText('You can\'t resist a laugh, and tell Uma that you\'re grateful for her sharing such an intimate story about her daughter with you.  Isn\'t she a little worried you might tease Loppe about it, though?\n\n');
		EngineCore.outputText('Uma grins mischievously.  "<i>Dear... I\'m counting on it.  Maybe she\'ll learn to leave my carrots alone so I can actually have a midnight snack for once.  Make sure you tell me how she reacted afterwards, okay?</i>"\n\n');
		EngineCore.outputText('You tell her that you make no promises and then excuse yourself; the chat was lovely, but you have to be moving on now.\n\n');
		EngineCore.outputText('"<i>Okay, see you around [name].</i>" Uma waves you goodbye.');
	...
	UmasShop.prototype.talkLoppePuberty = function() {
		EngineCore.outputText('"<i>By now, you must know about Loppe\'s stamina, right?  And that her cum production is also... quite elevated too, no?</i>"  Uma asks, smiling.\n\n');
		EngineCore.outputText('You can\'t resist a wry grin as you comment that you might be familiar with what Uma is talking about, yes.\n\n');
		EngineCore.outputText('"<i>But, did you know it caused her no end of problems when she was younger?</i>"\n\n');
		EngineCore.outputText('You blink in surprise; you could have sworn Loppe told you that her "stamina" was the result of that demon\'s curse, and you pass this on to Uma.\n\n');
		EngineCore.outputText('"<i>Make no mistake, dear.  It was one of the effects of the curse... but little Loppe\'s always been a bundle of insatiable energy.</i>"  Uma smiles.\n\n');
		EngineCore.outputText('Be that as it may, surely her massive "discharges" owe more to magic than nature, you protest?\n\n');
		EngineCore.outputText('"<i>I\'m afraid not... or at least not entirely.  When she was younger Loppe often would suffer... accidents, due to her cum production.</i>"\n\n');
		EngineCore.outputText('Accidents, you ask?  Then the mental image hits you, and you muse aloud on a sort of combination of accidental erections and the ejaculate-equivalent of poor bladder control.\n\n');
		EngineCore.outputText('"<i>Yes, she would spontaneously cum all over her lower garments.  Mind you, it wasn\'t an orgasm per se... more like a slowish unstoppable leak.  Other kids used to call her Furutama due to her problems.  But I took care of that.</i>"  Uma chuckles to herself.\n\n');
		EngineCore.outputText('You note that it must have something of a trial for both Loppe and her mother.  Morbidly curious, you ask how Uma took care of Loppe\'s little leaking problem.\n\n');
		EngineCore.outputText('"<i>Morning drainings, dear.</i>"\n\n');
		EngineCore.outputText('Drainings? You repeat in a puzzled tone of voice.\n\n');
		EngineCore.outputText('"<i>Yes.  Before Loppe went out for the day, I would help her relieve the tension in her undeveloped balls.  Nowadays she can handle her heightened production just fine, but back then her balls weren\'t that big, so she couldn\'t stand her own body\'s metabolism.</i>"\n\n');
		EngineCore.outputText('You can\'t resist chuckling and declaring Loppe must have enjoyed that.\n\n');
		EngineCore.outputText('"<i>Not so much, as a matter of fact.  I mean, how would you feel if your mother had to give you a handjob every morning so you wouldn\'t soil your pants.  Sure, my little trotting hopper did try to do it herself, but she lacked the technique to fully drain herself... which still resulted in messy underwear. And as if doing it every morning wasn\'t enough, she had to do it at night too... or she\'d wake up in a messy bed too.</i>"\n\n');
		...
		EngineCore.outputText('So, she\'s not denying she\'s a pervert and proud of it?\n\n');
		EngineCore.outputText('"<i>Pervert?  Yes, though I fail to see what is so wrong with liking sex.  You only get to live once, dear... might as well as make the best with what you have, no?  But old... never call me old!  If anything I\'m still in my prime!  Or you don\'t think I\'m good-looking enough, by any chance?  Be careful with what you say though, dear.  I don\'t mean to threaten you, but I do know all pressure points in the body... any body...</i>"  Uma glares at you, waiting for you to utter the right answer.\n\n');
		EngineCore.outputText('You tell her that, yes, she\'s definitely a real silver fox - or silver mare, or whatever the term is for an attractive older woman.  Why, you can only hope Loppe takes after her mother when it comes to keeping her looks as she ages.\n\n');
		EngineCore.outputText('"<i>Good answer.</i>"  Uma snorts.\n\n');
		EngineCore.outputText('So, Uma really thinks dealing with Loppe\'s puberty wasn\'t so bad, you ask?  If Loppe\'s father had stayed, would she have been willing to go through it again with her next daughter?  And would she have been so cheerful if her rabbit lover had given her a bellyful of twins or triplets instead of just one lonely little Loppe kit?\n\n');
		EngineCore.outputText('Uma looks distant for a moment, but quickly focuses back on you.  "<i>Dear, when you\'ve been through what I have, you learn not to dwell on what could have been... and instead focus on what is and its blessings.  I\'m very fond of Loppe and I wouldn\'t mind if she had brothers or sisters.  Usa-chan might have disappeared, but her parting gift wasn\'t so bad, I think.  She left me with a bundle of hope I named Loppe, and I\'m thankful for having my little laquine in my life.</i>"\n\n');
		EngineCore.outputText('You apologize for sticking your foot in your mouth, and tell Uma you\'ve clearly kept her talking long enough.\n\n');
		EngineCore.outputText('"<i>Oh, it\'s always a pleasure to talk to my little Loppe\'s [boyfriend].</i>"  Uma smiles at you happily.  "<i>Though call me old again and I\'ll make your life a living hell.</i>"  She adds, still smiling happily.\n\n');
		EngineCore.outputText('You get your things and get ready to leave - before you can bring yourself to go, however, you can\'t resist asking; Uma said the other kids in the village where Loppe grew called her "<i>Furutama</i>". What does that mean?\n\n');
		EngineCore.outputText('"<i>It means full balls, dear.</i>"  Uma states matter of factly.\n\n');
		EngineCore.outputText('You blink in shock, then stifle a laugh.  Yeah, that sounds like Loppe, alright.  You shake your head with a smile, thank Uma for talking to you, and then head off again.\n\n');
		this.talkLoppeJoiner();
	};
	/**
	...
	UmasShop.prototype.talkLoppesFirstGirl = function() {
		EngineCore.outputText('"<i>Oh, I know what would be a great story...</i>"  Uma smirks at you.  "<i>How would you like to hear about my little laquine\'s first time with a girl?</i>"\n\n');
		EngineCore.outputText('You give it a moments thought, and tell the mare that would be nice; you\'re curious about just what Loppe\'s dating life was like before you met her.  Oh, she talks a bold game, but you\'re not entirely certain she\'s being honest with you...\n\n');
		EngineCore.outputText('"<i>Very well, please make yourself comfortable, it\'s a bit of a long story.</i>" Uma suggests, motioning at a nearby chair and taking a seat herself.\n\n');
		EngineCore.outputText('You follow her instructions, wondering just what kind of doozy the mare has to share with you this time.\n\n');
		EngineCore.outputText('"<i>Back in our old village, there was a prostitute that went by name of Puffy Lips... but we just called her Puff.  Loppe had just blossomed into a beautiful young lady, so it\'s no surprise she drew plenty of stares when she walked around the streets-</i>"');
		EngineCore.outputText('Wait, her mother actually named her Puffy Lips?  Seriously?  You interject.\n\n');
		EngineCore.outputText('Uma chuckles.  "<i>Of course not, dear.  This was just her street name... though her last name was Kuchibiru, which means lips...</i>"\n\n');
		EngineCore.outputText('You shake your head, not sure you want to ask why she\'d use such a street name.  You tell the mare to continue; she was saying that Loppe had been blossoming into a pretty young herm who caught the eyes of many in the village?\n\n');
		EngineCore.outputText('"<i>Yes.  One day, I had my little Loppe take a request to the local carpenter, which happens to be close to where Puff used to... hunt.</i>"\n\n');
		EngineCore.menu();
		EngineCore.addButton(0, 'Next', this.talkLoppesFirstGirlPart2);
	};
	UmasShop.prototype.talkLoppesFirstGirlPart2 = function() {
		...
		EngineCore.outputText('Loppe hummed to herself as she made her way through a familiar, but seldom visited, part of town where the local carpenter made his trade.  Mom had warned her to be wary of strangers, since this side of the town was full of people with questionable interests... or so said mom.  Thus far she hadn\'t seen a single weird individual.  Most people she passed by seemed to be busy with their own tasks; fishermen carrying buckets of fish to sell on the main street; mailmen busy with deliveries and the occasional street performer buying make-up for their street shows.  Along the way, Loppe stopped by a bakery to eye what tasty delicacies they had to offer.\n\n');
		EngineCore.outputText('"<i>Can I help you, dear?</i>"  The cat behind the counter asked.\n\n'); 
		EngineCore.outputText('"<i>Oh, umm, no thanks miss, just browsing, that\'s all.</i>"  Loppe smiled.\n\n');
		EngineCore.outputText('The elderly cat smiled and replied, "<i>Aren\'t you a cute little thing?  If you see anything you\'d like, don\'t hesitate to call.</i>"\n\n');
		EngineCore.outputText('Loppe nodded and continued to browse... until her eyes set upon a wonderful sight; a slice of carrot cake, fresh from the oven.  Being part rabbit and part horse, two species known to love carrots, Loppe\'s mouth instantly watered. She eagerly looked into her small purse, but she only had a few gems, not nearly enough to buy the cake.  Loppe sighed, well... best not dwell... maybe when she made it home her mother would be willing to reward her with some gems for her service?\n\n');
		EngineCore.outputText('With that in mind, Loppe made her way towards the carpenter...\n\n');
		EngineCore.outputText('Puff was on the prowl, trained eyes of a master quickly scanning the crowd for any potential customer. Heck, she\'d settle for just a tryst.  She was getting so desperate for a quick shag she might seriously contemplate working for free.  But everyone seemed to be so busy, no one even turned their heads to look at her. The only one not busy was that young bunny browsing the cake shop...\n\n');
		EngineCore.outputText('Puff sighed.  Yep, ol\' thrusty was going to see some action today.  She was about to turn and head home when a sudden gust of wind hit her right in the face with a stray piece of paper.  Struggling to remove the offending litter with a growl, she saw... it was as if Marae herself had answered her pleas.  Fourteen inches of equine deliciousness, with a pair of heavy, cum churning balls swinging under it, it was enough to make her lick her lips with a wolfish smile, and who was it attached to?  Slowly looking up - what the? - That was the young bunny girl she saw browsing the bakery earlier! The young bunny quickly used her hands to push her short robes down and hide her package, looking left and right to see if anyone had spotted her, then sighing with relief. That must have been embarrassing... But luckily someone did spot her!\n\n');
		EngineCore.outputText('Somehow, then and there, Puff just knew she had to have that young bunny over for lunch. Taking a quick look at her pocket mirror to see if she was presentable enough she cleared her throat and struck the sexiest pose she could muster whilst leaning against the wall to the carpentry.\n\n');
		EngineCore.outputText('When Loppe approached the carpentry, written request in hand, a melodic, feminine voice called,  "<i>Hey, bunny-girl!</i>"\n\n');
		EngineCore.menu();
		EngineCore.addButton(0, 'Next', this.talkLoppesFirstGirlPart3);
	};
	UmasShop.prototype.talkLoppesFirstGirlPart3 = function() {
		...
		EngineCore.outputText('"<i>I-I\'m fine.</i>"  Loppe squeaked, unable to look the wolfess in the eye and, indeed, trying to avoid looking at her at all, lest she be drawn to the she-wolf\'s gorgeous, big, beautiful, soft, wondrous breasts...\n\n');
		EngineCore.outputText('"<i>Aww... don\'t be like that.  You can tell Puff all about your problems, dear.  Unless your problems have something to do with this?</i>"  She opened her own robes, displaying the pair of orbs sitting upon her chest, nipples erect and pointing accusingly at Loppe.\n\n');
		EngineCore.outputText('"<i>I-I-I...</i>"  Loppe stammered, the laquine trailing off as her eyes glued to the massive orbs that transfixed her, like a mouse caught under the eyes of an owl.  One of her more recent dreams came to mind, and unthinkingly her fingers flexed, itching to squeeze and caress those beautiful boobs.\n\n');
		EngineCore.outputText('"<i>You know... I was looking at you browsing the bakery earlier and I couldn\'t help but notice what a pretty friend you have...</i>"  The wolfess teased with a smile.\n\n');
		EngineCore.outputText('Loppe blinks her eyes in confusion.  "<i>Friend?</i>"  She repeated softly.\n\n');
		EngineCore.outputText('The slutty wolfess grins seductively before reaching towards the Laquine\'s groin and gently feeling her up.  "<i>This friend, I mean.</i>" Loppe squeaks in shock, hardly daring to breathe thanks to the wolfess\' surprising actions.  "<i>You should let him out once in a while.  It can\'t be good for you to keep him cooped up for so long, dear.</i>"  Licking her lips and sucking on her index finger absent-mindedly, Puff adds.  "<i>If you want... I\'d be happy to show you why I\'m called Puffy Lips.</i>"\n\n');
		EngineCore.outputText('Forcefully, Loppe leaped away, blushing like mad.  "<i>I\'m sorry, Ms Puff, but I\'ve got to deliver an erection - I mean, a request from my mom and then get back home, right away!</i>"\n\n');
		EngineCore.outputText('Puff clicks her tongue.  "<i>Oh, surely you can spare a few minutes with little me?  I promise I don\'t bite... much.  Plus your friend down there looks like he really needs it.  How about it?  Just pay me a few coins and I\'ll give you the time of the day.</i>"  She winks.\n\n');
		EngineCore.outputText('"<i>P-pay you? I don\'t even have the money to pay for a piece of carrot cake!</i>"  Loppe stammered, taking several steps back, powerful lapine legs already flexing in anticipation of making a dash for the carpentry before things got really embarrassing.\n\n');
		EngineCore.outputText('Shit!  If she didn\'t do something quickly, Puff was going to lose that nice horse-cock of a girl and have to resort to ol\' thrusty!  "<i>W-Wait!</i>"  She yelled before the laquine could bolt away.\n\n');
		EngineCore.outputText('"<i>W-what?</i>"  Loppe asks, still ready to flee, but too curious - and, despite herself, turned on - to resist.  "<i>Tell you what, it turns out today is really slow... so let\'s make a deal. You come with me and let me take a closer look at your friend, and I\'ll let you do whatever you want with these.</i>"  She gently lifts her boobs.  "<i>For F-R-E-E.</i>"  She smiles.\n\n');
		EngineCore.outputText('Loppe just stood there, poleaxed... She had the nagging worry that, if she did this, her mother would be so mad with her.  But, at the same time, this was Puffy Lips, the she-wolf who haunted her most erotic dreams.  What to do...\n\n');
		EngineCore.outputText('Realizing that Loppe still wasn\'t convinced she hurriedly added, "<i>Okay... let\'s sweeten the deal... come with me and I\'ll even buy you a slice of carrot cake. What do you say?</i>"  Puff looked at her expectantly,  tail wagging worriedly behind her.\n\n');
		EngineCore.outputText('A free live reenactment of her wet dreams with a sexy she-wolf, plus free carrot cake!?  Loppe made the only answer she could.  "<i>Okay.  But I absolutely have to do this job for my mom first - she\'ll be so mad if I don\'t get it done.</i>"  She declared.  Grinning wolfishly Puff replied,  "<i>Fine, go ahead, I\'m not going anywhere... but do hurry, hmm?  And what should I call you, cutie?</i>"\n\n');
		EngineCore.outputText('"<i>...Loppe. My name\'s Loppe Kemono.</i>"  The laquine answered.  "<i>Good... I\'ll remember that.  So hurry along with your task, Loppe, and when you\'re done go to my place, over there.</i>"  She points towards a small house a little ways away.  Slowly approaching the laquine, she whispers in her ears.  "<i>I\'ll be waiting...</i>"  With that the wolfess sashays away to her home.\n\n');
		EngineCore.outputText('Swallowing nervously, heart pounding like a drum, Loppe does her best to not watch Puff go - she\'s already hard enough, after all.  Long minutes pass as she tries to quell her raging erection, and then finally she remembers what she\'s supposed to be doing and heads to the carpentry store.\n\n');
		...
		EngineCore.menu();
		EngineCore.addButton(0, 'Next', this.talkLoppesFirstGirlPart4);
	};
	UmasShop.prototype.talkLoppesFirstGirlPart4 = function() {
		...
		EngineCore.outputText('Loppe swallows hard, at once loving and hating the foot-long cock already beginning to form itself into a tell-tale bulge in her dress, eyes fixed on the scantily clad form of her soon-to-be lover.  She greedily drinks in the sight of the wolfess\' plump, kissable, cock-sucking lips framing her gorgeous face, her beautiful orange eyes hooded in sultry anticipation.  Down her gaze sweeps, over the mighty swell of Puff\'s bosom, the great mammary orbs covered in her beautiful coffee-cream fur, past her breeder\'s hips and oh-so-fuckable ass to the swollen, greedy, fem-slime-seeping netherlips from which the whore takes her street name.  Loppe\'s nose twitches, eagerly drinking in the heady, intoxicating scent of Puff\'s arousal until she feels drunk on smell alone.\n\n');
		EngineCore.outputText('"<i>See something you like?</i>"  Puff asks, grinning seductively.  "<i>I can tell you want me, that longing gaze of yours... bet you caught a whiff of my scent, no?  Bet that bulge hidden under your clothes is bothering you too, no?  Want to touch me?  Want some S-E-X?  Maybe see why I\'m called Puffy Lips?</i>"  Puff teases the young laquine, trying to entice some courage into the nervous Loppe.\n\n');
		EngineCore.outputText('Mindlessly, Loppe shrugs off her dress, letting it fall abandoned to the floor.  Cock thrusting before her like a spear, the rabbit-horse herm strides towards the wolfess with an incongruously predatory air.  Her only thought in mind was to bury her shaft into Puff\'s waiting hole.\n\n');
		EngineCore.outputText('"<i>Oh, is that for me?  Lovely!  I love it!  I want to take it for a test drive right now!</i>"  The wolfess giggles, falling back onto her bed and spreading her legs wide to allow the laquine\'s throbbing member easy access to her own plump, well-used vagina.\n\n');
		EngineCore.outputText('With a mighty spring of her powerful rabbit legs, Loppe pounces bodily upon the wolfess, kissing her so fiercely she might as well be biting her in spirit.  With the clumsiness of an eager virgin, she grinds her cock into Puff\'s muff, too impatient and unsure of herself to properly slot herself into place.\n\n');
		EngineCore.outputText('Puff, being an experienced lover, takes hold of Loppe\'s rock-hard horse-prick and gives it a squeeze, drawing an excited gasp from the eager laquine.  "<i>This looks painful... better do something about it!</i>" Puff teases, aligning the shaft with her own throbbing pussy.\n\n');
		EngineCore.outputText('"<i>P-please!</i>" Loppe begs, grinding and thrusting herself into the she-wolf\'s hand.  All sanity is gone; all that remains is the need to fuck and breed, to strip herself of her masculine virginity at last.  Puff simply releases the laquine\'s member and grins at her.  "<i>No one is stopping you dear, all you gotta do is hit the right spot!</i>"\n\n');
		EngineCore.outputText('With a groan, Loppe immediately thrusts herself home, sinking herself to the hilt in one brutal thrust.  "<i>Ow!  Not so rough!</i>"  Puff protests.\n\n');
		EngineCore.outputText('"<i>Sorry...</i>"  Loppe moans, shuddering at the strange, new, absolutely wonderful experience of being surrounded by the she-wolf\'s warm, wet cunt.\n\n');
		EngineCore.outputText('"<i>It\'s okay... I\'m fine... feeling good?</i>"\n\n');
		EngineCore.outputText('"<i>Yesss.</i>" Loppe hisses.\n\n');
		EngineCore.outputText('"<i>Good.</i>"  Reaching behind Loppe to gently brush at her equine tail and grab her hips, Puff continues to instruct Loppe on the finer points the female anatomy.  "<i>Now thrust your hips like this... right there,</i>"  She says, gently pulling the young laquine towards her.\n\n');
		EngineCore.outputText('The laquine gives herself over to the ministrations of her more experienced lover, anxious to learn how to make this feel even better than it already is, tongue lolling out in bliss.  "<i>This... this is incredible, Puff!</i>" She gasps.\n\n');
		EngineCore.outputText('The wolfess giggles.  "<i>Careful Loppe, don\'t want to shoot too soon, do you?</i>"\n\n');
		...
		EngineCore.outputText('"<i>Still hard?  Well, I guess that can be expected since you\'re young, no problem.  Puff knows how to deal with your kind.</i>"  She gives Loppe a grin that can only be described as... wolfish.\n\n');
		EngineCore.outputText('Loppe grins back at her, just as wolfishly, eyes burning with lust.  "<i>You mean it?  I can go again?</i>" \n\n');
		EngineCore.outputText('"<i>Of course you can girl.  You\'re not satisfied yet, are you?  I sure ain\'t... we can keep going until you\'re completely sated.  Now start fucking me!</i>"  Puff begins bucking against Loppe, eager to get her started once more.\n\n');
		EngineCore.outputText('Loppe squeals, and then she starts to thrust back and forth herself, eagerly pistoning herself into Puff\'s pussy once more.  "<i>So, we get to do this until I\'m too tired to cum anymore, right?</i>" She giggles with anticipation.  "<i>Goody!  This is a lot more fun than using my hand... maybe I\'ll be done in an hour this time, instead of an hour and a half!</i>"\n\n');
		EngineCore.outputText('At this Puff\'s ears suddenly perk up as she looks at Loppe, startled.  "<i>Oh!  Wait - Ah - Did I hear you right? - Oh, yes - An hour and a half?</i>"\n\n');
		EngineCore.outputText('"<i>Yeah, that\'s about normal for me to use up all the cum in my balls.  My horse half gives me balls with lots of room in them, rabbit half lets them fill up faster.</i>" Loppe grunts, continuing to thrust into the she-wolf even as she talks. \n\n');
		EngineCore.outputText('Puff starts having second thoughts about this arrangement.  "<i>Err, maybe we shouldn\'t go at it that long - Ahh - it might not be healthy.</i>"\n\n');
		EngineCore.outputText('"<i>What? But you promised!</i>" Loppe pleads, eyes widened to make herself more appealing.  "<i>Plus, weren\'t you \'going to fuck me until you ran my balls dry\'?</i>"  She quotes the wolfess jokingly.  "<i>I thought you took pride in being a - Yesss - a whore, and never left a customer unsatisfied.</i>"  Loppe continues to tease.\n\n');
		EngineCore.outputText('"<i>That sounded like a challenge... okay!  You\'re on bunny-girl!</i>"  Puff replies with a grin.\n\n');
		EngineCore.menu();
		EngineCore.addButton(0, 'Next', this.talkLoppesFirstGirlPart5);
	};
	UmasShop.prototype.talkLoppesFirstGirlPart5 = function() {
		...
		EngineCore.outputText('"<i>You... That was incredible, Puff.  Thanks.</i>"  The laquine give a peck on the comatose she-wolf\'s cheek.  "<i>Sorry, but I really have to get back now.</i>"  She says, redressing herself and making her way home.\n\n');
		EngineCore.outputText('As she began heading merrily home, the laquine whistled with glee; she just got laid!  And by the utterly gorgeous Puffy Lips, no less!  Nothing could ruin her day now... at least, not until she took a look at the sun...\n\n');
		EngineCore.outputText('"<i>Oh crap!  Mom\'s gonna kill me for staying out this late!</i>"  The half-breed wailed, clasping her head in anguish.  She promptly began sprinting home at full speed, desperate to get there as quickly as possible and assuage the full fury of a mother whose daughter is out past her bedtime.\n\n');
		EngineCore.menu();
		EngineCore.addButton(0, 'Next', this.talkLoppesFirstGirlPart6);
	};
	UmasShop.prototype.talkLoppesFirstGirlPart6 = function() {
		...
		EngineCore.outputText('Having done it with her for real meant the dreams were no longer as interesting? You suggest.\n\n');
		EngineCore.outputText('"<i>I don\'t really know... perhaps that is what happened, or maybe finding out what happened to Puff is what put her off.  I can\'t tell.</i>"\n\n');
		EngineCore.outputText('What happened to Puff? You repeat, warily.  So, something happened between them?\n\n');
		EngineCore.outputText('"<i>No, nothing happened between them.  Puff wasn\'t the type of person to take a girlfriend or have anything to do with anyone... she\'s always been a free spirit in that regard.  I mean, she wasn\'t the only prostitute around, she was just the most notorious one.  Being a nymphomaniac had a hand in that, I suppose. But back to the question at hand.  Several days after Loppe\'s little tryst with Puffy Lips I heard an interesting bit of gossip from a client.  I heard Puff had joined the local convent.</i>"  Uma grins.\n\n');
		EngineCore.outputText('You can only blink at that and flatly ask why; as startling as it probably was the first time around, you would have thought someone like Puff would, after she had recovered, jump at the chance to keep Loppe as her permanent personal fuck-toy.\n\n');
		EngineCore.outputText('Uma chuckled to herself.  "<i>Apparently Puff was cured of her nymphomania, so she no longer cared that much about sex.  She became a real upstanding citizen too, doing charity, caring for the orphaned children, basically she became an exemplary nun.  I guess having sex with my little Loppe was too much for her... serves her right for trying to seduce my little hopper!</i>"\n\n');
		EngineCore.outputText('You can only shake your head and tell her that you find that hard to believe.  After all, you and Loppe are still going out, and you\'ve had sex more than once, haven\'t you?  But, regardless, you can\'t help but feel sorry for Loppe; that must have been a real kick to the ego.\n\n');
		EngineCore.outputText('"<i>To be honest, I don\'t think she minded it too much... from what I hear Puff still had a tryst or two, even while in the convent... then again this could all be just rumors... I never did have the chance to talk her after the event.  Apparently she left on a mission a few months after joining...</i>"  Taking a deep breath, Uma smiles at you.  "<i>Tell me something, [name].  Does Loppe tire you out?  In sex I mean?</i>"\n\n');
		EngineCore.outputText('You admit that Loppe is a handful and a half.  Still, not enough to make you go celibate, certainly.  You ask why Uma is asking.\n\n');
		EngineCore.outputText('Uma smiles.  "<i>And that, my dear, is why you\'re special.  You\'re the first person who can actually handle Loppe.  Usually she wears out her partners so much that they need a few days to recover, but she tells me that all you need is a little rest and you\'re already good to go.</i>"\n\n');
		EngineCore.outputText('You admit it can\'t be that hard, surely?  You\'re not even from this world, you should be worse at it than the natives like Loppe herself are.\n\n');
	...
	UmasShop.prototype.talkLoppesFirstBoyfriend = function() {
		EngineCore.outputText('"<i>How about I tell you about Loppe\'s first boyfriend?</i>"  Uma suggests.\n\n');
		EngineCore.outputText('You tell Uma that it sounds like an interesting story, and you kindly ask her to proceed.\n\n');
		EngineCore.outputText('"<i>Okay.  This happened a while after my little Loppe blossomed into pretty young lady.  She used to go to an art school, where she learned how to dance, and one of her colleagues was a black cat boy by the name of Hyou.  He was very handsome.  He had green eyes that resembled polished gems, his black fur was always well kept and on top of all that he was nice, someone pleasant to be around.  He was Loppe\'s senior and was the first person to greet her when she started attending the school.</i>"\n\n');
		EngineCore.outputText('You can\'t resist joking that, if you didn\'t know about Uma\'s tastes in lovers, hearing her talking about him in such glowing praises would make you half expect the reason they broke up to be because Loppe found him fucking her mother one day.\n\n');
		EngineCore.outputText('"<i>Don\'t be silly, dear.  If you knew him as well as I do, you\'d know there is absolutely no way there could ever be anything between us.</i>"\n\n');
		EngineCore.outputText('You ask her exactly what she means, feeling she\'s talking about more than sexual incompatibilities here.\n\n');
		EngineCore.outputText('"<i>If you really want to know, you\'ll just have to listen to my story.</i>"  Uma smiles.\n\n');
		EngineCore.outputText('You laugh softly and promise to shut up and listen.\n\n');
		EngineCore.outputText('"<i>Very well.  He was always surrounded by girls, it\'s tough to find someone as good looking and as nice as he was, and initially Loppe wasn\'t very close to him at all... that came later, when my little Loppe was having troubles keeping up with the class.  Turns out Loppe had absolutely no talent when it comes to dancing, but since she was so determined to become a good dancer, Hyou offered to tutor her.</i>"\n\n');
		EngineCore.outputText('You note with admiration that Loppe must have worked hard; she dances so wonderfully now, you\'d hardly believe it was entirely hard work instead of at least a little natural talent for it.\n\n');
		EngineCore.outputText('"<i>Back then, there weren\'t many people who knew about Loppe\'s extra appendage, so they all just assumed she was a girl.  Hyou was the same, but...</i>"\n\n');
		EngineCore.outputText('You ask how that could have happened, given the mentions Uma and Loppe have both made of her gender posing... difficulties during puberty.  Did Uma and Loppe end up moving to a new village where they didn\'t know about Loppe\'s dual-gendered nature?\n\n');
		EngineCore.outputText('"<i>If you know the right people, changing your gender is not so difficult, dear.  People just assumed she paid a visit to the local shaman. She is not ashamed of her gender, but it\'s not something you should freely advertise everywhere you go either.</i>"\n\n');
		EngineCore.outputText('Ah, you reply.  So that\'s it, you note to yourself; her accidents happened before she grew her boobs and female curves, resulting in them believing she was a boy who changed himself into a girl, rather than having been boy and girl at the same time all along.\n\n');
		...
		EngineCore.outputText('You smile and note that\'s one odd way to get into a girl\'s good books.\n\n');
		EngineCore.outputText('"<i>Anyway, Loppe had always admired him and his feline grace while dancing, and after the incident, she was thrilled to know that Hyou hadn\'t spoken a single word about Loppe\'s gender to her classmates. Or anyone else for that matter. In fact, they just became closer.  Hyou continued to tutor Loppe, and slowly she got better and better, until one day Hyou surprised her with a request. Do you know what he asked?</i>"  Uma asks, clapping her hands together lightly.\n\n');
		EngineCore.outputText('He asked her if they could make love?  You suggest.\n\n');
		EngineCore.outputText('"<i>No, silly.  He asked her out.</i>"\n\n');
		EngineCore.outputText('Well, that\'s a surprise, you say; you didn\'t think people still took it that slow in Mareth.\n\n');
		EngineCore.outputText('"<i>Not everyone is crazy about getting into each other\'s pants all the time dear</i>" Uma scolds you.  "<i>If we did that all the time we wouldn\'t have to do anything but sleep with each other all the time, you know?</i>"\n\n'); // I dont even know.
		EngineCore.outputText('You apologize; there\'s so many monsters out in the wilderness who do think precisely that way that it\'s hard to remember there are still normal people, sometimes.\n\n');
		EngineCore.outputText('"<i>It wasn\'t always like this, back then we were just simple people trying to live simple lives.</i>"\n\n');
		EngineCore.outputText('You admit that, and tell her to continue.\n\n');
		EngineCore.outputText('"<i>So they started dating.  And as is normal for a young couple, one day, after they had come back from a nice dinner, he suggested that he wanted to see Loppe naked.</i>"\n\n');
		EngineCore.menu();
		EngineCore.addButton(0, 'Next', this.talkLoppesFirstBoyfriendPart2);
	};
	UmasShop.prototype.talkLoppesFirstBoyfriendPart2 = function() {
		...
		EngineCore.outputText('Hyou smiles and closes the distance between them, gently hugging Loppe and pulling her into a tender kiss.  Once they break he whispers in her ear, "<i>I know what you\'re hiding in there... and I really want to see it again... won\'t you show it to me again?  Please? Purrrrrty please?</i>"\n\n');
		EngineCore.outputText('Blushing through her fur, Loppe nods her head. "<i>O-okay.  Just remember, you asked for it.</i>" She warns him weakly.  Taking a few steps back, literal ponytail swishing gently on her rump, she slips out of her shorts, letting them slide down her legs and onto the floor, and then lifts her shirt for added measure.  "<i>There.  Can you see it now?</i>"  She asks, trying to be bold, but unable to look the cat in the eye or keep herself from blushing.\n\n');
		EngineCore.outputText('"<i>Not quite... but let me help you.</i>"  He boldly reaches forward and gives Loppe\'s equine-prick a few strokes, coaxing it into a full blown hard-on.\n\n');
		EngineCore.outputText('The rabbit-horse moans softly as it swells to all fourteen inches of mottled pink horse-dick, jutting erect and proud, defiant of its mistress.\n\n');
		EngineCore.outputText('"<i>Now, that\'s better</i>" Hyou says, circling Loppe to examine her from every angle.  "<i>Hmm... yes.  Truly beautiful</i>"  He comments, purring softly.\n\n');
		EngineCore.outputText('The bunny-pony blushes and wriggles.  "<i>Y-you know, it\'s really weird you telling me that?</i>" She protests in a half-hearted fashion.  "<i>But... If I gotta show you mine, then you gotta show me yours!</i>" She says, trying to sound more confident than she really is.\n\n');
		EngineCore.outputText('Hyou chuckles.  "<i>I thought you were never going to ask!</i>"  He slowly strips himself, dancing and prancing as he removes each piece of his garments until, with a flourish, he finally peels off his underwear and carelessly disposes of it, tossing it away.  "<i>And this is my birthday suit.</i>"  He grins.\n\n');
		EngineCore.outputText('Loppe\'s eyes lock onto his nakedness like a starving wolf onto a bloody steak, greedily drinking in the sight of him, particularly focusing with eagerness on his jutting, spiky-looking cat-dick.\n\n');
		EngineCore.outputText('Hyou looks between his erect kitty-prick and Loppe\'s own horse-cock, noting the obvious difference in size.  "<i>Well well... not only are you taller than I am, you\'re also bigger in that department too.  I guess it\'s to be expected, I am competing with a horse-bunny after all.</i>"  He winks at Loppe.\n\n');
		EngineCore.outputText('The aforementioned "<i>horse-bunny</i>" blinks in confusion, then realizes that the shaft she\'s been staring at is anywhere from one-third to one-half the length of her own, and she claps her hands over her mouth aghast.  "<i>Hyou, I\'m sorry, I...</i>"  She begins, half-expecting a rejection.\n\n');
		EngineCore.outputText('"<i>Sorry for what?</i>"  Hyou interjects.  "<i>I knew what I was getting into when we started dating.  Relax Loppe.  When I said you were beautiful, I meant all of you, even this hefty pony you carry between your legs.</i>"  He grins happily.\n\n');
		EngineCore.outputText('Loppe smiles softly.  "<i>You are such a flatterer, you know that?  But, enough with the foreplay - when do we get to the real action?</i>" She mock-whines.\n\n');
		EngineCore.outputText('"<i>Action?</i>"  Hyou asks in mock confusion.  "<i>Whatever do you mean bun?</i>"\n\n');
		EngineCore.outputText('Loppe pouts for a moment, feigning displeasure.  "<i>Are you taking me to bed, or am I going to have to push you into it?</i>"  She laughs, giving a playful growl to underscore that her confidence is up and she\'s ready to fuck.\n\n');
		EngineCore.outputText('"<i>Only if you can catch me.</i>"  Hyou raspberries Loppe, getting ready to avoid his girlfriend\'s lusty advances...\n\n');
		EngineCore.outputText('With the best growl she can manage, the horse-dicked rabbit hops through the air to snatch her feline boyfriend, but he jumps away with a laugh.  Gracefully he dances around and around the bedroom, the increasingly frustrated rabbit trying to cut him off.  Finally, with one perfectly timed leap, she slams into him and knocks him over onto the bed with a mutual \'whoof!\' of startled shock.  Belly to belly they catch their breath, and then Loppe rises back up, completing the pinning maneuver.  "<i>Haha, caught you!</i>"  Loppe taunts, then blinks in surprise; what\'s that funny-nice feeling?  Rearing back, she looks down at their two bellies, seeing their mutual erections rubbing their sensitive flesh against each other, a sight which makes her blush.  "<i>S-sorry, Hyou, I didn\'t mean to...</i>"  \n\n');
		EngineCore.outputText('"<i>Don\'t worry about that, I don\'t mind.  So, you managed to catch me... what do you intend to do with me now?  Hmm?</i>"  Hyou asks, ears twitching cutely.\n\n');
		EngineCore.menu();
		EngineCore.addButton(0, 'Next', this.talkLoppesFirstBoyfriendPart3);
	};
	UmasShop.prototype.talkLoppesFirstBoyfriendPart3 = function() {
		...
		EngineCore.outputText('Hyou laughs.  "<i>Okay, okay.  I\'m sorry, couldn\'t resist it!  You look so cute when you\'re frustrated!  Alright then, I\'ll hold still...</i>"  He says, gently guiding the tip of his feline-cock towards Loppe\'s drooling pussy.  "<i>There, I\'m even helping this time.</i>"\n\n');
		EngineCore.outputText('"<i>If I could reach you from this position, I\'d kiss you.</i>" Loppe proclaims happily.  Her tail swishes across the cat\'s belly with anticipation, while the rest of her holds still, ready to be penetrated.\n\n');
		EngineCore.outputText('"<i>Just sit down and I\'ll slip right in!</i>" \n\n');
		EngineCore.outputText('Loppe needs no further instructions and promptly flops down; luckily for her, the active lifestyle of a rabbit-horse hybrid resulted in the accidental loss of her hymen years ago.  That doesn\'t keep her from squealing in pleasured shock as she envelops her lover\'s cock in one swift motion.  She sits there, feeling the strange yet wonderful sensation inside her belly from her partner\'s cock, doing her best to squeeze and grip the intruding appendage with her pussy, like feeling it with her hands.\n\n'); // PAGING FENOXO -- I don\'t even know what to do with this. It\'s still akward, but better than it was.
		EngineCore.outputText('Hyou purr-moans, hands moving to hold Loppe\'s hips steady.  "<i>You know, as good as your pussy feels, unless you start moving nothing\'s going to happen, right?</i>"\n\n');
		EngineCore.outputText('Wordlessly the laquine nods and begins to rise up and down, moaning and hissing as she truly loses her feminine virginity, riding her feline lover clumsily, but enthusiastically.  "<i>This, oh... this feels so good, Hyou!</i>"\n\n');
		EngineCore.outputText('The feline moans.  "<i>Yeah!  So good.</i>"\n\n');
		EngineCore.outputText('Addled as she is by pleasure, Loppe can still hear the reaction.  "<i>Hey, what\'s wrong?  Aren\'t you enjoying this?  I know I am!</i>"\n\n');
		EngineCore.outputText('"<i>No!  I mean yes!  Of course I\'m enjoying it... wow this feels great!</i>"  He says, trying to save face.\n\n');
		EngineCore.outputText('"<i>Well, you don\'t sound too happy, what\'s wrong?  You just not like this position?</i>"  Loppe asks, trying to be understanding.\n\n');
		EngineCore.outputText('"<i>I\'m sorry Loppe... I don\'t know what\'s gotten into me... it does feel nice, but I\'m just not feeling... y\'know.  Maybe it is the position... try turning around?</i>"  He suggests.\n\n');
		EngineCore.outputText('With a moan as the action stretches her in just the right way, the laquine awkwardly spins around, leaving her pre-dribbling dick and balls slapping against her feline lover and her breasts positioned right in front of his eyes.  "<i>I\'ll try not to give you a facial when we really get going, okay?</i>"  She promises.\n\n');
		EngineCore.outputText('Hyou\'s shaft throbs, dribbling pre within the laquine\'s depths.  "<i>Oh yesss</i>" Hyou purrs.  "<i>Now that\'s a sight I can appreciate, and personally?  I don\'t mind if you do give me a facial... but I appreciate the consideration, now get moving girl!</i>"  Hyou says, excitedly.\n\n');
		EngineCore.outputText('Excited, Loppe resumes her bouncing, unthinkingly rubbing her cock against her lover\'s belly and shivering at the extra friction on its engorged, sensitive surface.  "<i>Ah, Hyou, you feel so good inside of me!</i>"  She whimpers.\n\n');
		EngineCore.outputText('Hyou moans and groans, eyes glued to Loppe\'s bouncing shaft.  "<i>Yeah!  It feels great!  Slap my belly with that big pony of yours!</i>"\n\n');
		EngineCore.outputText('"<i>K-kuh!-kinky b-buh-boy!</i>" Loppe groans, reaching out and grabbing his head and pulling him into an embrace, coincidentally planting his face right amongst her breasts even as she continues to grind her cock into his belly.\n\n');
		EngineCore.outputText('"<i>Oh babe!  You\'re so sexy! I knew I picked a winner when I first saw you. Ah! Almost there!</i>"  He yowls, bucking against Loppe.  "<i>Damn that horse-cock of yours!  Bouncing around!  Slapping my belly!  Teasing me!  Ah!  So hot!</i>" \n\n');
		EngineCore.outputText('A distant part of Loppe\'s mind catches these words and files them away with suspicion.  The rest of it is too busy melting at the sensations of losing her female virginity.  She continues to eagerly buck and thrust and impale herself, anxious in pushing on to her first <i>real</i> climax as a woman.\n\n');
		EngineCore.outputText('Hyou yowls one last time and bucks against Loppe, his claws digging into her hips as his eyes cross, looking straight at a dollop of pre that seems to have formed on the flared tip of Loppe\'s member.  Finally, he relaxes and lets his orgasm overtake him, spewing rope after rope of cum inside Loppe\'s eager pussy.\n\n');
		EngineCore.outputText('The laquine moans in pleasure at the sudden sensation of being filled... then blinks in surprise as she feels the cat-prick inside her needy pussy going soft.  "<i>What\'s wrong?  What happened?</i>" She asks, baffled; she tries to ride the limp dick a little more, but it\'s futile.\n\n');
		EngineCore.menu();
		EngineCore.addButton(0, 'Next', this.talkLoppesFirstBoyfriendPart4);
	};
	UmasShop.prototype.talkLoppesFirstBoyfriendPart4 = function() {
		...
		EngineCore.outputText('"<i>That\'s normal, isn\'t it?  I mean, I can go for three times that long before I\'m sated</i>" Loppe asks, nervously.\n\n');
		EngineCore.outputText('Hyou rises his head.  "<i>Normal?  I came once and am already spent... you are kidding right?</i>"  He asks, laughing nervously at the frustrated laquine.\n\n');
		EngineCore.outputText('"<i>So what am I going to do?  I haven\'t even cum once yet!</i>" She whines.\n\n');
		EngineCore.outputText('Sighing, Hyou looks at Loppe\'s cock, then back at Loppe... he smiles.  "<i>Tell you what.  Since you let me fill you, and I just can\'t get another erection for a while... how about I let you fill me instead?  Would you like that?</i>"\n\n');
		EngineCore.outputText('"<i>B-But I wanted to be fucked like a girl! Besides, you\'re a boy, I can\'t fuck you with a cock.</i>"  The laquine whimpers.\n\n');
		EngineCore.outputText('Figuring it\'s pointless to argue with Loppe in her current state, he takes Loppe\'s cock in his hands and bends over to give it a lick; a task that proves easy, given his feline flexibility.\n\n');
		EngineCore.outputText('Loppe moans and shudders, wriggling with pleasure as a spurt of pre oozes from her flared tip to splatter onto her feline lover\'s face.\n\n');
		EngineCore.outputText('Hyou smiles and slurps the top of Loppe\'s equine member into his mouth, sucking on it like a lollipop.\n\n');
		EngineCore.outputText('Mouth opening and closing wordlessly like a fish, the laquine\'s eyes roll in her head as she is overwhelmed by the delicate touches to her sensetive shaft.\n\n');
		EngineCore.outputText('Finally, with one last slurp he lets go of Loppe\'s cock and, smiling, asks,  "<i>You sure you don\'t want to take me instead?</i>"\n\n');
		EngineCore.outputText('"<i>I - okay... but, how do I do that?</i>"  The bewildered bunny asks. "<i>You don\'t have a pussy, unless you\'ve been hiding something from me, and I don\'t want to just have you suck and lick on me; that\'s no fun for you, then.</i>" She notes.\n\n');
		EngineCore.outputText('"<i>Silly girl,</i>" he remarks.  "<i>Mind getting off me for an instant?</i>" he asks, innocently.\n\n');
		EngineCore.outputText('Confused, the laquine pulls herself off of her lover, allowing his cum-slick cock to wetly slurp its way out of her.  She scoots over to the side of the bed, wondering what he has in mind.\n\n');
		EngineCore.outputText('Hyou rolls around on his belly, lifting his tail and presenting his ass to Loppe, then casually reaches back and spreads his cheeks apart, giving Loppe a first-hand view of his, yet unused, little rosebud.  "<i>See?  I got a hole too!</i>"  He grins.\n\n');
		EngineCore.outputText('Ordinarily, Loppe would have protested against the idea of fucking anyone, boy or girl or herm, up the ass.  However, ordinarily, Loppe would not have been as horny as she was, and she promptly leaps up behind him, rubbing her long cock between the spread cheeks of his ass.  However, she holds back from actually penetrating.  "<i>Hyou? P...Please?</i>"  Loppe meekly suggests, looking at him with big doe eyes.  "<i>Promise me you\'ll take turns at filling my pussy, too?</i>"\n\n');
		EngineCore.outputText('Moaning and purring demurely, Hyou replies,  "<i>S-Sure.  Now jam that wonderful pony of yours in!</i>"  He says, overwhelmed with lust.\n\n');
		EngineCore.outputText('Licking her lips in anticipation of finally being sated, the young laquine begins slowly pushing her cock against the tightness of her lover\'s virginal ass...\n\n');
		EngineCore.outputText('Hyou yowls in a mixture of pain and pleasure.  "<i>Mrrrow!  That feels great!  Ha... Loppe, babe!  Your cock feels amazing!</i>"  He bucks back taking in even more of Loppe inside.\n\n');
		EngineCore.outputText('"<i>Excited, are we?  Well, just don\'t hurt yourself - I\'m not exactly teeny-tiny here!</i>" Loppe giggles, too caught up in the sensations of the cat-morph\'s hot, tight little anus wrapping itself slowly around her shaft to be suspicious of his reactions.\n\n');
		EngineCore.outputText('"<i>Don\'t care!  Ah, Marae!  S-Shit, getting hard again!</i>"\n\n');
		...
		EngineCore.outputText('<b>One very long, messy, multi-orgasmic bout of sex later...</b>\n\n');
		EngineCore.outputText('Hyou purrs, licking at his cum-caked arms, happily.  His belly is distended with the massive amount of laquine-cum sloshing about inside.  "<i>Wow.  I have to say Loppe, you\'re one of a kind.  Best sex ever!</i>"  He sighs, continuing to lick at his arms.  "<i>Sorry for only getting your female half once.  I swear I don\'t know what\'s wrong with me... but it just felt so good when you started fucking me with that wonderful, big, horse-cock of yours, that I just lost it... sorry.</i>"\n\n');
		...
		EngineCore.menu();
		EngineCore.addButton(0, 'Next', this.talkLoppesFirstBoyfriendPart5);
	};
	UmasShop.prototype.talkLoppesFirstBoyfriendPart5 = function() {
		...
		EngineCore.outputText('A gay man and a gay woman; the very opposite of compatibilities.  So, you ask, raising an eyebrow for emphasis; in denial, or just didn\'t realize it until that first night?\n\n');
		EngineCore.outputText('"<i>He never really fancied any girls before my Loppe, though he was friends with plenty of them, and I know for a fact he used to get plenty of love letters too.  So I would bet on him not knowing it.  Plus it was kinda unexpected, you know?  He was the son of village\'s most renowned hunter, a well-known womanizer</i>"  Uma chuckles.  "<i>I suppose he really didn\'t take after his father.</i>"\n\n');
		EngineCore.outputText('Same attitude, different sex on the receiving end, you suggest?\n\n');
		EngineCore.outputText('"<i>After that night, yes.  He came out to Loppe too.  She took it nicely, I think.  They continued to date for a while, though Loppe often had to coax him into using her pussy too, if I remember what my little ears heard right.</i>"  She flicks her ears for emphasis.  "<i>Those coaxings would involve the ravishing of Hyou\'s ass via horse-cock.</i>"\n\n');
		EngineCore.outputText('You comment you\'re surprised Loppe took it so well; for most girls, hearing they "<i>turned a boy gay by having sex with him</i>" would be a major wound to their self-esteem.\n\n');
		EngineCore.outputText('"<i>Loppe didn\'t turn him gay though, come on.  Everything about that boy pointed towards this outcome, he was a petite cat boy who liked dancing and didn\'t hang out with guys.  Preferring instead to hang out with girls, and I mean that as friends, not lovers.  Not many were surprised when he came out, save for a few of the more naive girls.  Plenty of tears were shed... Loppe was fine though, she had a cute boyfriend.  Unfortunately it was not meant to be,</i>"\n\n');
		EngineCore.outputText('He found a guy he liked better and broke up with her as a result?  You suggest casually.\n\n');
		EngineCore.outputText('Uma shakes her head.  "<i>No.  Actually they broke up because he couldn\'t keep up with Loppe\'s stamina... it was either break up with her or give up dancing. And walking.</i>"\n\n');
		EngineCore.outputText('You heave a sigh; a somewhat sad outcome, you must concede, but inevitable, you suppose. A truly bisexual herm and a homosexual male probably weren\'t really that comfortable with each other in a relationship anyway.  You note Loppe was probably happy, deep down, to call an end to it.\n\n');
		EngineCore.outputText('"<i>To be quite honest, there wasn\'t any bitterness in their breaking up.  And they formed a pretty cute couple too, and for a while they were satisfied with each other.  But Loppe unfortunately was wearing the poor boy down, he was the one falling behind in dancing class after that.</i>"  Uma sighs.  "<i>In fact... it was Loppe who suggested they break up.  They carried on as good friends though, and Hyou said he would support Loppe all the way if she found someone she liked and that was able to keep up with her.</i>"\n\n');
		EngineCore.outputText('You tell her that turn of events doesn\'t surprise you; Loppe\'s got a good heart under her breasts.  And quite a fire in her loins, too, but, hey, nobody\'s perfect.\n\n');
	...
	UmasShop.prototype.talkLoppesDad = function() {
		...
		EngineCore.outputText('Uma nods.  "<i>She was the love of my life.  Unfortunately, it wasn\'t meant to be.  She left even before I found out I was pregnant with my little Loppe. Still... I enjoyed my time with her, and if we met again, I would love to spend more time with her.</i>"  Uma smiles, though you detect a hint of sadness in her equine features.\n\n');
		EngineCore.outputText('You ask who \'Usagi\' was, as a person?  You know she was a herm bunny-morph and that she fathered Loppe, but how did she and Uma meet, and take their relationship that far?\n\n');
		EngineCore.outputText('Uma smiles and looks to the distance.  "<i>Usa-chan was a wandering warrior, always honorable and true, her skill with a sword was nothing short of amazing.  I don\'t think there\'s a single person alive able to match her.  She lived by the sword, back then, always challenging other warriors to hone her skill and travelling from village to village to find better, stronger, opponents.</i>"  Uma sighs.\n\n');
		EngineCore.outputText('"<i>When I met her, she was just passing through our village, and had been suffering from chronic pain in her neck, so she came to me to request my services and, well, it was love at first sight.  After our session, she asked me out of a date and I accepted.  There wasn\'t a single night we didn\'t go out and make love under the stars.  But unfortunately Usa-chan left after a week.  She left me a note apologizing for her departure and said that she couldn\'t stay, lest she mellow and lose her edge as a warrior.  And that was the last I saw of her.</i>"  Uma sighs again.\n\n');
		EngineCore.outputText('So, you\'re guessing Uma found out Usagi had left her a little going-away present some time after the rabbit warrior had left, you suggest?\n\n');
		EngineCore.outputText('"<i>Yes.  My morning sickness didn\'t start until a fortnight after Usagi had moved on.  Jolted the sadness right out of me too.  I hadn\'t even opened my clinic in those two weeks, and my friends were very worried. Loppe was just what I needed to pick up the pieces of my broken heart.</i>"  She smiles, a motherly smile that makes her look absolutely stunning.\n\n');
		EngineCore.outputText('You ask if Uma ever tried to send a message after Usagi, let her know about her fatherhood?\n\n');
		EngineCore.outputText('"<i>I did ask the travellers that passed through about news regarding Usa-chan, but it was rare to ever find any who had heard of her.  Nevertheless I asked everyone that, should they meet Usa-chan, to tell her to return so we could live together as a family... but eventually we had to evacuate the village, so I\'m not sure she even got my message, and I couldn\'t keep waiting for her.</i>"\n\n');
		EngineCore.outputText('You quietly thank Uma for sharing such intimate details of her life, and politely excuse yourself to leave.\n\n');
		EngineCore.outputText('"<i>I still love her, you know.</i>"  The mare declares in a conversational tone.  "<i>I miss her so badly and I want her to come back to me; I dabble in dalliances, to fill the void, but I know they\'ll never really replace her.</i>"\n\n');
	...
	UmasShop.prototype.sexMenu = function() {
		...
		if (CoC.getInstance().player.femininity >= UmasShop.UMA_CONSIDER_PC_FEM) {
			...
			if (CoC.getInstance().player.gender === 1) // Femboys
			{
			...
			} else if (CoC.getInstance().player.gender === 2) // Chicks
			{
			...
			} else if (CoC.getInstance().player.gender === 3) // Dickchicks
			{
			...
			if (CoC.getInstance().player.gender === 1) // No sexytimes for manns
			{
		...
		{
			EngineCore.outputText('"<i>Sorry [name],  but you\'re just too manly for my tastes,</i>" Uma apologizes.\n\n');
			this.buildCoreMenu(true);
			return;
		}
		// If we made it this far, we\'ve passed all of Uma\'s preference checks
		EngineCore.outputText('You step through into Uma\'s office, noting a surprisingly comfortable looking flat table-bed, just waiting for you and Uma to have a little fun.\n\n');
		EngineCore.outputText('"<i>Now here\'s a few \'special services\' I can provide you with.  So, which will it be?</i>"\n\n');
		this.buildSexMenu();
	};
	UmasShop.prototype.buildSexMenu = function() {
		...
		if (CoC.getInstance().player.gender >= 2 && CoC.getInstance().player.lowerBody !== 4) // Vaginas & not centaurs
		{
		...
		EngineCore.addButton(9, 'Back', this.buildCoreMenu);
	};
	/**
	* Erotic Massage
	* Edit Status: FUCK ALL
	*/
	UmasShop.prototype.sexEroticMassage = function() {
		...
		if (CoC.getInstance().urta.urtaLove()) {
	...
	UmasShop.prototype.sexGetFingered = function() {
		...
		EngineCore.outputText('Once settled and comfortable, you ask what to do next.\n\n');
		...
		if (CoC.getInstance().player.hasVagina()) {
			...
			EngineCore.outputText('Slowly she spreads your folds open, massaging your labia and gathering moisture from your [vagina].\n\n');
		} else {
			EngineCore.outputText('.\n\n');
		}
		...
		if (CoC.getInstance().player.hasVirginVagina()) {
			...
			EngineCore.outputText('"<i>Oh, but this is where you\'re mistaken my dear.  Loppe is pretty bad and I should know.  She got that from me,</i>" the mare laughs lightly, adding another finger to massage your opening.\n\n');
			EngineCore.outputText('You moan loudly, wriggling in your seat to allow Uma better access to your more sensitive spots.  Mmm, she\'s good at this...\n\n');
			EngineCore.outputText('"<i>Thanks dear, but we are just about to get started with the real thing,</i>" she replies with a chuckle.  Uma begins massaging your inner walls while she roams your insides, trying to find something.\n\n'); 
			EngineCore.outputText('You quickly realize what the mare is searching for, her expertise in matters of pleasure clear as your G-Spot is teased, crying out in delight as she sends the most delicious wave of pleasure rippling through your loins, doing your best to squeeze her fingers with your experienced but still-tight cunt.\n\n');
			EngineCore.outputText('"<i>Aha!  Found it!</i>" the mare says with delight, "<i>Now I can finally get started on removing all of this bad tension you\'ve been accumulating, dear.</i>"  She starts pumping her fingers inside you, making sure to tease your G-Spot with careful touches at every pump.\n\n');
			EngineCore.outputText('You gasp and moan as the mare masseur\'s expert fingers tease you in all the right ways, slightly bucking in place to properly enjoy your finger-fucking, that oh-so-familiar and wonderful tightness building up in your belly before, with a cry of lust, you give in and ride the resultant crescendo of orgasm.  You give yourself over to the bliss of cumming into Uma\'s hand, slumping down in relaxed stupor after you finish emptying yourself.\n\n');
			EngineCore.outputText('Removing her hand from your privates, the mare lifts her wet hand to her face and begins licking it clean.  "<i>Hmm, I see that my daughter is right to call you sugar.  You really are sweet,</i>" she chuckles.  "<i>So how\'d you like your... massage?</i>"\n\n');
			...
			EngineCore.outputText('"<i>Still feels like I have some room to work with here, so how about another one?</i>" the mare states, even as she adds another finger to the ones already inside you.  "<i>If we continue down this road I might just be able to squeeze a hand down there, you don\'t mind do you, dear?</i>"\n\n');
			EngineCore.outputText('Mmm, the more the merrier you unthinkingly reply.  You didn\'t get this stretched out by not liking to be filled, after all.\n\n');
			EngineCore.outputText('"<i>Good, I\'ll see if I can\'t accommodate you later, but for now there\'s something I\'m looking for,</i>"  She begins moving her fingers inside of you, feeling around your rippling walls, looking for that special spot within you.\n\n');
			EngineCore.outputText('It\'s not easy for her, you\'re looser than most, but you enjoy her efforts all the same, playfully teasing and encouraging her as she strokes and fondles and fiddles.  Finally, almost by accident, her finger brushes up against that part you love so much and you moan your delight, letting her know she\'s hit the jackpot.\n\n');
			EngineCore.outputText('"<i>Hmm, that took longer than usual, but I see I still have the touch.  Now to make this as good as possible for my future daughter-in-law,</i>" Uma teases you, adding her last finger to your [vagina], shoving her entire hand inside.  She massages your innards as she begins pumping her hand, touching, massaging, teasing and squelching.  Every time that wonder hand of hers drives itself inside you, you feel jolts of electricity run up along your body as each finger of hers takes a turn dancing, teasing and pinching that special spot within your treasure.\n\n');
			EngineCore.outputText('It\'s a little different to being filled with cock, but it\'s not a bad substitute either, and you do your best to wring as much pleasure from it as you can.  It still takes a little longer to build up that delicious pressure inside of you before, with a cry of lust fulfilled, you cum, soaking your lap and Uma\'s alike with your climax.\n\n');
	...
	UmasShop.prototype.sexHandjob = function() {
		...
		EngineCore.outputText('and gather your [armorname] up in your arms as you do so. Walking over to the cupboard, you find a couple of folded towels and ample space to store your clothes, which is exactly what you do.\n\n');
		EngineCore.outputText('"<i>Be a dear and store mine too, please,</i>"  Uma asks, handing her folded clothes to you.  You nod your head and place them in the cupboard like she asked, then walk over to the table and sit down, ready to begin.\n\n');
		EngineCore.outputText('Uma takes a seat beside you and smiles gently at you.  "<i>Tell me, dear, how have you been?</i>"\n\n');
		EngineCore.outputText('You think it over and tell her that, all things considered, surprisingly well.  After all, you jest, you\'re still free and not some demon\'s toy.  "<i>That\'s good, I\'ve been meaning to have a chat with you, maybe get to know you a little better while I\'m at it, but the main question is Loppe.  What\'s your opinion on my little Loppe?  Did I do a good job?</i>"  Uma asks, a questing hand rubbing along your thigh to gently touch your [cock].  "<i>And don\'t think I\'m forgetting about our business here either, dear.</i>"\n\n');
		EngineCore.outputText('What does she mean by a good job, you ask, shivering at the gently stroking fingers on your steadily stiffening shaft.  "<i>You know, how she behaves out there?  Is she being nice?  Has she made any passes at inappropriate times?  Is she carrying herself like a lady ought to?</i>" the mare questions, continuing to stroke your shaft, sometimes rubbing at your [cockHead biggest] with practiced motions, always pushing the right button to send shudders of pleasure running through you.\n\n');
		EngineCore.outputText('You moan, then shake your head and try to answer.  You can\'t really say if Loppe is carrying herself like a lady ought to, because you\'re not sure what Uma defines as a lady or how that applies to a hermaphrodite.  But she is definitely being very nice to you - no making passes unless you imply you\'re interested first.  "<i>That\'s good - by the way, does this feel good?</i>"  Uma asks, lavishing your [cockHead biggest] with more of her attention.\n\n');
		EngineCore.outputText('Yes, yes it does, you moan, shivering your seat and unable to resist trying to hump the masseur\'s hand that is caressing you so erotically.\n\n');
		EngineCore.outputText('"<i>Focus dear, I\'m trying to strike a conversation here,</i>" Uma chuckles.  You manage to gasp an apology, but refrain from pointing out that her masterful touch on your burgeoning shaft is rather distracting.\n\n');
		EngineCore.outputText('"<i>What about the sex though?  How are things?  And let\'s not restrict this topic to my little Loppe only.  What I\'m interested in is you.  Have you been taking care of your needs properly?  Speaking of needs, how big are your needs?  Hmm?</i>" the mature mare asks as she adds another hand to your [cock], focusing on both massaging your shaft as well as your [cockHead biggest].  You gasp and groan, but can\'t think of anything coherent to say through the pleasure crowding your brain.\n\n');
		EngineCore.outputText('"<i>Come on, dear.  Talk to me.</i>" Uma presses, even as her hands redouble their efforts at pleasuring you.  Between moans you manage to protest that she\'s making it awfully hard for you to do so, a glow of pride in you for actually being coherent rather than babbling madly.\n\n');
		...
		} else if (CoC.getInstance().player.cumQ() <= 500) { // Medium CumQ
		...
		} else if (CoC.getInstance().player.cumQ() <= 1000) { // High CumQ
		...
		} else if (CoC.getInstance().player.cumQ() <= 2500) { // VHigh CumQ
	...
	UmasShop.prototype.sexGetABJFromDisMilfyLesboSlut = function() {
		...
		if(CoC.getInstance().flags[kFLAGS.PC_FETISH] >= 1) {
			...
			EngineCore.outputText(', gathering your clothes up in your arms as you do so.');
		}
		EngineCore.outputText('  Walking over to the cupboard, you find a couple of folded towels and ample space to stow your clothes.');
		...
		EngineCore.outputText('.  She holds you like that, letting you feel her hot breath wash over the [skinFurScales] of your crotch.  Her tongue wags back and forth underneath you, slipping and sliding against you. Inside her mouth, your ' + CoC.getInstance().cockDescript(x) + ' twitches and jumps in her maw.  Beads of pre-cum are beading and dripping out onto her busy organ.');
		...
		if(CoC.getInstance().player.cockTotal() > 1) {
			...
			EngineCore.outputText(', and soon you are dribbling and dripping from all of your ' + CoC.getInstance().player.multiCockDescriptLight() + '.');
		}
		...
		if(CoC.getInstance().flags[kFLAGS.UMA_TIMES_SUCKED_YOU] < 5) {
			...
			if(CoC.getInstance().player.cumQ() <= 25) {
				...
				if(CoC.getInstance().player.cumQ() >= 1000) {
					...
					EngineCore.outputText(' of semen you\'ve produced.');
				}
			...
			if(CoC.getInstance().player.cockTotal() > 1) {
				...
				EngineCore.outputText(' aren\'t anywhere near as thick.');
			}
		}
		//epilogue
		//Came on her face
	...
	UmasShop.prototype.sexEatHerOut = function() {
		...
		EngineCore.outputText('With a gentle smile and a seductive wiggle, she gently rubs her sweet cunt.  "<i>Go on, dear,</i>" she urges you on letting out a girly giggle immediately afterwards. \n\n');
		EngineCore.outputText('You promptly bury your face between her firm thighs, licking around her labia, tasting her juices, before you slowly part her nethers with the tip of your tongue.\n\n');
		...
		EngineCore.outputText('"<i>Mmm oh yes dear, yes, that feels good.  It\'s been awhile since someone would do that for me...</i>"  She croons in her pleasure.\n\n');
