...
angular.module( 'cocjs' ).run( function( MainView, SceneLib, $rootScope, $log, CoC, kFLAGS, Utils, StatusAffects, PregnancyStore, EngineCore, AppearanceDefs, ImageManager, Descriptors, DemonPack, Combat, TentacleBeast, Minotaur, Gnoll, PerkLib ) {
	...
	AntsScene.prototype.firstAntColonyEncounter = function() {
		...
		MainView.outputText( 'While traversing an unfamiliar part of this desert wasteland, ' );
		if( CoC.player.cor > 75 && CoC.player.lust > 50 ) {
			MainView.outputText( ' looking for something to slake your unquenchable lusts, ' );
		}
		MainView.outputText( 'you come across an abandoned merchant\'s cart.  The cart looks eerily disheveled, with a majority of its contents strewn about the sand.  Whoever or whatever deserted this thing did so in a hurry, and for seemingly no reason. Curious, you decide to inspect it for anything worthwhile.' );
		...
		//[Keep Hidden]
		//[Play Hero]
		EngineCore.choices( 'Play Hero', this, this.playHero, 'Keep Hidden', this, this.keepHidden, '', null, null, '', null, null, '', null, null );
	};
	//►[Keep Hidden]
	AntsScene.prototype.keepHidden = function() {
		...
		//►(If Over 41 - Male)
			...
			MainView.outputText( ImageManager.showImage( 'ants-desert-male-firstencounter' ) );
			MainView.outputText( 'You know exactly what\'s going to happen once the demons \'subdue\' their prey.  The growing throbbing in your loins begs for release, and you quickly and quietly take off your ' + CoC.player.armorName + ', making sure the demons don\'t notice you.  You might as well watch the show as you\'re not gonna be able to leave unnoticed until the demons are done anyways.' );
			...
			if( CoC.player.cocks[ x ].cockLength >= 20 ) {
				MainView.outputText( '  Licking the head of your [cock ' + (x + 1) + '] in anticipation of what\'s to come only adds to your growing lust.' );
			}//If player cock size tiny:
			else if( CoC.player.cockArea( x ) < 6 ) {
				MainView.outputText( '  Though your cock isn\'t the most impressive, it\'s \'got it where it counts\' and you intend to make the most of it.  You lovingly tease yourself until you\'re fully erect; running your fingers down the ridge causes a bead of pre-cum to form on your tip.' );
			}//If player cock size normal:
			else if( CoC.player.cockArea( x ) < 12 ) {
				MainView.outputText( '  You hold your cock like the hilt of a sword and start to pump your shaft slowly.  Your breathing becomes heavier and labored, as you stroke yourself with mounting passion.' );
			}//If player cock size large:
			else if( CoC.player.cockArea( x ) < 30 ) {
				MainView.outputText( '  The fear of having your cock give away your position quickly passes through your mind, but it\'s too late now.  The only way out of this is to cum, so you might as well enjoy it.  You firmly grasp your cock and start jacking off, hoping that you\'ll finish sooner rather than later.' );
			}//If player cock size MASSIVE:
			else {
				MainView.outputText( '  The towering meat log jutting from your crotch gives away your \'hiding\' spot, but the demons don\'t seem to mind, as they\'re too busy with their new toy.  You doubt even if they did care that any of them would be able to satisfy you. You wrap your arms around your fully erect cock and start to pump, hoping to release your load soon.' );
			}
			...
			if( CoC.player.cumQ() < 100 ) {
				MainView.outputText( 'sizable' );
			} else if( CoC.player.cumQ() < 1000 ) {
				MainView.outputText( 'huge' );
			} else if( CoC.player.cumQ() < 10000 ) {
				MainView.outputText( 'massive' );
			} else {
				MainView.outputText( 'titanic' );
			}
			MainView.outputText( ' load.  Once you can refocus your eyes, you see the hermaphrodite pull out, and as it does a burst of cum sprays out of the ant-morph\'s vagina as her stomach deflates slightly.  She\'s been filled with so much corrupt seed that it\'s stretched her belly to the point it resembles a third-trimester pregnancy.' );
		...
		//►If Over 41 - Female
			...
			MainView.outputText( ImageManager.showImage( 'ants-desert-female-firstencounter' ) );
			MainView.outputText( 'Watching from your hiding spot, you consider what\'s going to happen and feel your pussy immediately moisten.  Your practiced hands move with deftness, slipping into your [armor].' );
			...
			if( CoC.player.lactationQ() > 100 ) {
				MainView.outputText( '  You feel your warm milk flow out of your hardened arola, as your body begs to release its sweet nectar.' );
			}
			//If PC has dick(s):
			if( CoC.player.hasCock() ) {
				MainView.outputText( '  Feeling [eachCock] throb between your legs, you run one of your hands down your chest and start to stroke lovingly.' );
			}
	...
	AntsScene.prototype.enterTheColony = function() {
		...
		if( CoC.player.cor < 40 ) {
			MainView.outputText( '"<i>\'Champion\', you\'ve been sent to this land to resist the demons and your efforts thus far, insignificant though they be, have not escaped my gaze.  ' );
		} else {
			MainView.outputText( '"<i>Despite your obvious taint, you seem to have retained your valor as the \'Champion\' you proclaim yourself to be, and not as a rutting beast.  Something to be admired, for sure.  ' );
		}
		MainView.outputText( 'In saving my daughter, Phylla...</i>"  She pauses and gestures, and the four-armed girl you saved from the demon horde walks slowly and shyly out of a nearby tunnel to stand next to her mother.  \'Phylla\' looks very embarrassed and is blushing deeply, avoiding eye contact from both of you by looking at the ground as Queen Chylla continues her dry monologue.  "<i>... you have been chosen to become her potential...\'mate\'; much to my dismay.</i>"  Wait, mate?  "<i>My daughter has shown me how you saved her from the demons that inhabit this land.  Perhaps you were just lucky and caught them with their cocks in their hands while her back was turned?</i>"' );
	...
	AntsScene.prototype.antColonyChallenge = function() {
		...
		if( CoC.flags[ kFLAGS.MET_ANT_ARENA ] === 0 ) {
			...
			MainView.outputText( '  After a moment he looks down and scribbles something on his chart.' );
			MainView.outputText( '\n\n"<i>So, we\'re ready to start when you are.</i>"' );
			CoC.flags[ kFLAGS.MET_ANT_ARENA ]++;
		}
		//Introduction Subsequent Times
		else {
			MainView.outputText( 'Your feet bring you back to the ant colony and the guard motions you down the only lit tunnel once more.  You enter the colosseum, and as you step out into the cavern, you are greeted, again, by a thin male ant-morph holding a clipboard.  He looks up at you.' );
		...
		//[Fight] [Leave]
		EngineCore.choices( 'Fight', this, this.antColiseumFight, '', null, null, '', null, null, '', null, null, 'Leave', this, this.leaveAntColony );
	};
	//►[Leave]
	AntsScene.prototype.leaveAntColony = function() {
		MainView.clearOutput();
		MainView.outputText( 'Deciding to better prepare yourself first, you inform the thin fight manager that you will return later.  You leave the colony, heading back to camp.' );
		EngineCore.doNext( SceneLib.camp, SceneLib.camp.returnToCampUseOneHour );
	};
	AntsScene.prototype.antColiseumFight = function() {
		...
		//►[Fight #3]
			...
			if( CoC.flags[ kFLAGS.MET_ANT_ARENA_GNOLL ] === 0 ) {
				MainView.outputText( 'With due ceremony, the manager leads you down to one of the staging areas for the arena.  You watch through the bars as the stadium fills far past capacity.  There must be a thousand ants here... maybe even the whole colony.  Gazing out into the crowd, you pick out the royal seating and in it, Princess Phylla.  The princess is in much finer attire than you\'re used to seeing - her chest is actually covered by a fine red and blue dress and her hair is combed, framing her face nicely.  Her mother is nowhere to be seen, and you can tell that Phylla is taking full advantage.  She waves and cheers for you just like the crowd is and, perhaps by her orchestration, you hear the crowd pick up a chant in your name.  Seeing Phylla chant with them makes you feel invigorated.  As the gates raise, you charge out into the center of the arena, roaring your finest battle cry; your opponent is taken somewhat aback but finds resolve and braces for your charge.' );
			}//►(Gnoll - Intro Repeat - for people that lost once)
			else {
				MainView.outputText( 'You move through the network of tunnels and caves and come to the colosseum once more.  You are greeted by the event manager and he ushers you down to one of the staging areas for the arena.  The noise intensifies as the colosseum fills to the brim with spectators; Phylla herself is up in her box waving to you.  You look across the arena floor and the gnoll at the other side of the arena seems just as excited to fight as you are.  The gates open and you charge each other!' );
			}
	...
	AntsScene.prototype.phyllaTentaclePCLoss = function() {
		MainView.clearOutput();
		MainView.outputText( 'After your defeat in the arena, you set off to leave but are stopped.  Princess Phylla is standing with a troupe of armed guards by the exit, holding a vial of clear liquid.  She doesn\'t look like she wants to give it to you but she extends it to you all the same.' );
	...
	AntsScene.prototype.phyllaPCLostToMino = function() {
		MainView.outputText( 'After your staggering defeat and subsequent humiliation in the arena two guards approach you as you try to leave.  One of them holds out a small vial.  Princess Phylla is off in the corner of the room crying, and you try to move closer to her but one of the guards steps in front of you.  "<i>Drink!</i>" he commands, uncorking the vial.' );
	...
	AntsScene.prototype.phyllaPCBeatsGnoll = function() {
		...
		//►(Gnoll - Win Repeat) Standard Gnoll Win Scene. +
			...
			MainView.outputText( 'This isn\'t the first time you\'ve accomplished this, but it still brings the crowd to their feet.  You simply stand in the center of the arena, taking it all in.  Phylla makes her way to you, blushing as the rowdy audience follows her with catcalls and demands for her to give her champion a kiss.  She tends to you as always and, when she\'s done, takes your hand in hers and looks at you expectantly.  You smile at her, brushing the hair from her face with your other hand; she colors deeply at the contact as two guards appear to lead you both off.  Having no more reason to stay, you allow your guide to return you to the surface.' );
		}
		//(+1 Win Score)
		CoC.flags[ kFLAGS.ANT_ARENA_WINS ]++;
		Combat.cleanupAfterCombat();
	...
	AntsScene.prototype.antastrophyBadEnd = function() {
		MainView.clearOutput();
		MainView.outputText( 'As you go to leave the arena queen Chylla and four bodyguards approach you.' );
	...
	AntsScene.prototype.antGirlGoodEnd = function() {
		...
		if( CoC.player.hasVagina() ) {
			EngineCore.addButton( 1, 'Use Vagina', this, this.femalePhyllaFirstFuckGooooo );
		}
	};
	//►Male Continuation
	AntsScene.prototype.gigititigitigitigitigityAntGirl = function() {
		MainView.clearOutput();
		MainView.outputText( 'Sporting a painfully obvious tent, your body betrays its desire for sexual gratification and it causes Phylla to smile with interest.  "<i>I-I didn\'t think I had that ability to... to...  I mean I\'m not like you, so I thought...</i>" she begins, but trails off as she takes in the rough, obscured shape given off by your bulge.' );
		...
		if( CoC.player.cockArea( x ) >= 72 ) {
			...
			if( CoC.player.tentacleCocks() > 0 ) {
				...
				MainView.outputText( ' forward and wrap them tightly around Phylla, taking her hand and tugging her in close.' );
			}
			...
			MainView.outputText( ' from around her and hang it in front of her face, grinning your antics on your face as Phylla stares at ' );
			if( CoC.player.cockTotal() === 1 ) {
				MainView.outputText( 'it' );
			} else {
				MainView.outputText( 'them' );
			}
			MainView.outputText( ', slightly intimidated.' );
		...
		//If PC has dick(s) that won't fit: Jump to - Cunnilingus Scene Continuation
			...
			EngineCore.addButton( 0, 'Next', this, this.cuntmuffinLingusPhyllaDickBig );
		}
	};
	AntsScene.prototype.malePhyllaContinuation = function( x ) {
		MainView.clearOutput();
		MainView.outputText( 'Phylla stares down at your ' + Descriptors.multiCockDescriptLight() + ' and starts nervously rubbing her hands together.  "<i>It\'s my first time... I mean, I hope it isn\'t going to be bad for you...</i>" she says, before trailing off; uncertain of her sexual prowess.' );
		...
		//PC is goo morph:
		if( CoC.player.isGoo() ) {
			MainView.outputText( ', leaving traces of your slimy lust along her body for her to wear, allowing your detached bits of mass to ignite her sexual fires' );
		}
		MainView.outputText( '.' );
		...
		if( CoC.player.cor < 75 ) {
			...
			EngineCore.addButton( 0, 'Next', this, this.phyllaCorruptMascEnding );
		}
	};
	//PURE ENDING!
	AntsScene.prototype.phyllaFirstTimePureBabiesFuckEnding = function() {
		...
		if( CoC.player.cumQ() < 50 ) {
			MainView.outputText( 'thin' );
		} else if( CoC.player.cumQ() < 500 ) {
			MainView.outputText( 'hefty' );
		} else {
			MainView.outputText( 'thick' );
		}
		MainView.outputText( ' ejaculate far into her womb.  Phylla responses in kind, working her hips and squeezing your body with her legs in an almost milking fashion, trying to draw as much seed as she can into her womb.' );
		...
		if( CoC.player.cumQ() >= 100 && CoC.player.cumQ() < 1000 ) {
			MainView.outputText( '  Truly amazing considering how much your loads usually contain.  You think you see a little bulge in her stomach that wasn\'t there before.' );
		}//If cum milliliters over 1000:
		else if( CoC.player.cumQ() >= 1000 ) {
			MainView.outputText( '  As you look down at her nethers your mind struggles to understand just how she could... then looking up her body, you see.  Her belly is bloated with your sperm, almost to the point of already looking pregnant.' );
		}
		...
		if( CoC.player.canOvipositSpider() ) {
			...
			if( CoC.player.inte / 20 + Utils.rand( 20 ) + 1 < 16 ) {
				...
				if( this.pregnancy.isPregnant ) {
					MainView.outputText( '  I just can\'t hold anything else inside me. I\'m sorry! Please don\'t be mad... I mean I will!  Just a-after... this batch...' );
				}
			...
			//Persuasion success:
			{
				...
				if( CoC.player.cor >= 75 ) {
					MainView.outputText( '  Little does poor Phylla know, you\'re going to just use her as a baby maker to ease the tension of your own sacks.' );
				}
	...
	AntsScene.prototype.phyllaCorruptMascEnding = function() {
		MainView.clearOutput();
		MainView.outputText( 'For a few moments longer, you pump yourself hard against her rump in an attempt to "break" your new fucktoy in.  Once you\'re satisfied that she will be able to handle what is to come, you take to sliding yourself along against her fuckhole as you grab her by the hair.  The backside of her abdomen grinds along your ' );
		if( CoC.player.tallness >= 72 ) {
			MainView.outputText( 'chest' );
		} else {
			MainView.outputText( 'belly' );
		}
		MainView.outputText( ', but it will only serve to help you.  You will need a brace for what you\'re about to pull and her rigid abdomen will do just fine.  Phylla makes a confused noise, glancing over her shoulder with a look of concern growing on her face.' );
		...
		if( y >= 0 ) {
			...
			if( CoC.player.cockTotal() > 2 ) {
				MainView.outputText( 'one of your free cocks' );
			} else {
				MainView.outputText( 'your free cock' );
			}
			MainView.outputText( ' against her tight ass. Feeling this new intruder, she turns back to you.' );
		...
		if( CoC.player.cockTotal() > 1 ) {
			MainView.outputText( 's twitch, ' );
		} else {
			MainView.outputText( ' twitches, ' );
		}
		MainView.outputText( 'ushering forth your corrupted seed into her womb' );
		if( y >= 0 ) {
			MainView.outputText( ' and her ass.' );
		} else {
			MainView.outputText( ', and onto the bedspread below.' );
		}
		MainView.outputText( '  As her pulsing cunt works to suck the semen out of your ' );
		if( CoC.player.balls > 0 ) {
			MainView.outputText( 'balls' );
		} else {
			MainView.outputText( 'shaft' );
		}
		MainView.outputText( ', Phylla retaliates with her own orgasm, flooding your groin with her sticky girl cum.  You glance down to your joined nethers and find a massive amount of Phylla\'s cum has pooled around your knees and more seems to be flowing every second.  Clearly, she\'s a squirter.' );
	...
	AntsScene.prototype.cuntmuffinLingusPhyllaDickBig = function() {
		MainView.clearOutput();
		MainView.outputText( 'Sadly, as you gaze down at your ' + Descriptors.multiCockDescriptLight() + ', you realize that trying to penetrate Phylla with your freakishly large prick' );
		if( CoC.player.cockTotal() > 1 ) {
			MainView.outputText( 's' );
		}
		MainView.outputText( ' isn\'t going to work.  Phylla\'s eyes begin to tear up as she also comes to the realization that her first time is a non-starter.' );
		...
		if( CoC.player.longestCockLength() < 69 ) {
			MainView.outputText( 'angle your hips so that ' );
			if( CoC.player.cockTotal() === 1 ) {
				MainView.outputText( 'it points' );
			} else {
				MainView.outputText( 'they point' );
			}
			MainView.outputText( ' at the ceiling, placing them out of the way for what you have in mind.' );
		}
		//Dick size Over 70 inches::
			...
			MainView.outputText( ' aimed out the doorway.' );
		}
		MainView.outputText( '  You wickedly beckon Phylla over to you with a hooked finger.  Phylla looks at you quizzically for a moment before it dawns on her.  Her eyes widen and cooing she scrambles over to you.' );
		...
		if( CoC.player.cockTotal() === 1 ) {
			MainView.outputText( ' switches and bobs' );
		} else {
			MainView.outputText( 's switch and bob' );
		}
		MainView.outputText( ', loudly brushing against the ' );
		if( CoC.player.longestCockLength() < 69 ) {
			MainView.outputText( 'ceiling' );
		} else {
			MainView.outputText( 'wall in the hallway' );
		}
		MainView.outputText( '.' );
		...
		if( CoC.player.tongueType === AppearanceDefs.TONUGE_SNAKE ) {
			MainView.outputText( '  You run the split of your forked mouth muscle from the tip of her clit to the base.  As your textured feeler makes its way down, you wrap around the rest of her long clitorus, like a boa constrictor.  Once your split reaches the hood of her clit you roll and flick the tip of your tongue rapidly.  Pulling at your hair she gasps for breath in between teeth grinding moans.' );
		}
		...
		MainView.outputText( ' and pants heavily, having just gone through the equivalent of an orgasm triathlon.  As you sigh, you can hear her giggle in what sounds like disbelief.  "<i>Heh... I didn\'t think I had it in me to do... that,</i>" she coos, staring mischievously up at you.  "<i>Just... could you shrink ' );
		if( CoC.player.cockTotal() === 1 ) {
			MainView.outputText( 'this monster' );
		} else {
			MainView.outputText( 'these monsters' );
		}
		MainView.outputText( ' down?  I mean, I\'m not complaining!  But I... just... I mean... you... inside me,</i>" she shyly remarks, obviously wanting something more... traditional.' );
	...
	AntsScene.prototype.femalePhyllaFirstFuckGooooo = function() {
		MainView.clearOutput();
		MainView.outputText( 'Eager to get to some good old fashion fun, you direct your thoughts to Phylla, telling her to \'remove her clothing\'.  After all of the pieces of her royal attire are removed, she closes in and rubs her naked body against yours.  Her fingers move fluidly as she slowly traces her ever hardening nipples along your chest and along the ridges of your back, sending a sensual chill up and down your spine.  Your ' + Descriptors.nippleDescript( 0 ) + 's harden in response, and with surprising speed she shifts her body downward and locks her mouth around your nipple, firmly suckling at your hardened areola.' );
		//If PC Lactating:
	...
	AntsScene.prototype.femalePhyllaFirstTimePlusCock = function() {
		...
		MainView.outputText( ' has taken' );
		MainView.outputText( ' hold of ' );
		//One dick only:
		if( CoC.player.cockTotal() === 1 ) {
			MainView.outputText( 'your ' + Descriptors.cockDescript( 0 ) + '.' );
		} else {
			MainView.outputText( 'your ' + Descriptors.cockDescript( 0 ) + ' leaving the lucky member to bask in affectionate glory as the rest of your manhood laments being left out.  "<i>Don\'t worry, I have four hands...</i>" Phylla coos as she works your shaft.' );
		}
		...
		if( CoC.player.smallestCockArea() > this.phyllaCapacity() ) {
			...
			if( CoC.player.isTaur() ) {
				MainView.outputText( 'Seeing your impending predicament, Phylla quickly scrambles with all four of her arms to collect a bunch of cushions.  She stacks them in a makeshift \'resting place\' and helps you into a comfortable position as your cocks precede to grow uncontrollably.' );
			}//Drider body:
			else if( CoC.player.isDrider() ) {
				MainView.outputText( 'Phylla immediately realizes this, and flips you over so that you are resting on your head and neck, ducking in past your ' + Descriptors.multiCockDescriptLight() + ' and coming to rest on the border between your spider carapace and soft clit.' );
			}//Goo body:
			else if( CoC.player.isGoo() ) {
				MainView.outputText( 'Phylla immediately realizes this, and flips you over so that you are resting on your head and neck, and she works her way through your goopy mass, connecting her clit with yours in little time or effort. "<i>This is a little weird... but I like it...</i>" she flirts. Hardening your mass slightly, you snugly secure Phylla against your body, telling her that things "might" get rough.' );
			}//Human/Harpy/Naga legs:
			else {
				MainView.outputText( 'Phylla immediately realizes this, and flips you over so that you are resting on your head and neck, and curls your [legs] towards her.' );
			}
			MainView.outputText( '  Your ' + Descriptors.multiCockDescriptLight() + ' now resting comfortably out of the open room, Phylla positions herself to scissor your pussy.' );
		...
		//If PC has an appropriately sized dick(s):
			...
			if( CoC.player.tentacleCocks() > 0 ) {
				...
				MainView.outputText( 'your tentacle dick' );
				if( CoC.player.tentacleCocks() > 1 ) {
					MainView.outputText( 's' );
				}
				MainView.outputText( '.  Clearly she\'s never seen anything like it before as she doesn\'t know what to do.  Laughing, you tell Phylla she doesn\'t need to do anything except hold still.  You snake your tentacle cock' );
				if( CoC.player.tentacleCocks() > 1 ) {
					MainView.outputText( 's' );
				}
				MainView.outputText( ' up her body, making sure to caress her most tender places on their way.  She screams out loudly in shock only to realize what happened when she looks down.  "<i>God, you scared me!</i>" she yells, embarrassed that she got frightened half to death by your dick' );
				if( CoC.player.tentacleCocks() > 1 ) {
					MainView.outputText( 's' );
				}
				MainView.outputText( '.  Laughing at her display, you motion to your prick' );
				if( CoC.player.tentacleCocks() > 1 ) {
					MainView.outputText( 's and wiggle them ' );
				} else {
					MainView.outputText( ' and wiggle it ' );
				}
				MainView.outputText( 'in front of her, like a worm to a bird in her face.  "<i>Aw, does someone need some attention?</i>" Phylla teases, taking ' );
				//PC has:
				//one tentacle dick:
				if( CoC.player.tentacleCocks() === 1 ) {
					MainView.outputText( 'your cock into her mouth as she continues to rock her hips into yours.' );
				}//two:
				else if( CoC.player.tentacleCocks() === 2 ) {
					MainView.outputText( 'your cocks into her mouth and between her breasts as she continues to rock her hips into yours.' );
				} else {
					MainView.outputText( 'your cocks into her mouth, between her breasts, and along her body.  The ones on her body tightly wrap around her insectile joints, using her muscular curves to get you off.' );
				}
				...
				if( CoC.player.cockTotal() === 2 && (CoC.player.cockArea( CoC.player.smallestCockIndex2() ) + CoC.player.cockArea( CoC.player.smallestCockIndex() ) <= this.phyllaCapacity()) ) {
					MainView.outputText( 'two of your ' + Descriptors.multiCockDescriptLight() + ', stroking them apologetically as she scissors you.  You feel her almost insatiable appetite for all parts of your body.  You feel Phylla\'s mind slowly becoming lost in pleasure.' );
					...
					MainView.outputText( 'your ' + Descriptors.cockDescript( CoC.player.smallestCockIndex() ) + ', stroking it apologetically as she scissors you.  You feel her almost insatiable appetite for all parts of your body.  You feel Phylla\'s mind slowly becoming lost in pleasure.' );
				}//PC only has a dick(s) that('s) (are) more than 4 inches in width:
				else {
					MainView.outputText( 'your ' + Descriptors.cockDescript( CoC.player.smallestCockIndex() ) + ', but she simply can\'t fit any number of her hands around the entirety of your glans; instead, she takes to caressing the head of your ' + Descriptors.cockDescript( CoC.player.biggestCockIndex() ) + '.' );
				}
	...
	AntsScene.prototype.getAntWaifuYoShit = function() {
		MainView.clearOutput();
		MainView.outputText( 'You smile at her and tell her you would love for her to join you at your camp.  Her face brightens like the sun and she quickly gathers the very few possessions she owns - mostly clothing, the pillows, and some jewelry.  Together you promptly leave the colony and head back to camp.' );
	...
	AntsScene.prototype.bumpIntoTheAntColonyAfterStayHomePhylla = function() {
		MainView.clearOutput();
		MainView.outputText( 'You make your way down a strangely familiar path that leads to Phylla\'s room.  Her head quickly snaps around upon seeing your shadow in her doorway.' );
	...
	AntsScene.prototype.introductionToPhyllaFollower = function() {
		...
		if( CoC.flags[ kFLAGS.PHYLLA_EGG_LAYING ] === 0 ) {
			EngineCore.addButton( 2, 'Lay Eggs', this, this.phyllaLaysEggsToggle );
		} else {
			EngineCore.addButton( 2, 'No Eggs', this, this.phyllaLaysEggsToggle );
		}
		if( CoC.flags[ kFLAGS.ANT_KIDS ] > 0 ) {
			EngineCore.addButton( 3, 'Children', this, this.phyllasKidsChildren );
		}
		EngineCore.addButton( 4, 'Appearance', this, this.phyllaPearance );
		EngineCore.addButton( 5, 'Find Gems', this, this.phyllaDigsForGems );
		EngineCore.addButton( 9, 'Back', SceneLib.camp, SceneLib.camp.campLoversMenu );
	...
	AntsScene.prototype.phyllaSexMenu = function() {
		...
		if( CoC.player.hasCock() ) {
			...
			//"<i>Use Dick</i>"
			EngineCore.addButton( 1, 'Fuck Her', this, this.dickPhylla );
			//[While Giving Birth]
			...
			if( CoC.flags[ kFLAGS.PHYLLA_EGG_LAYING ] > 0 && CoC.flags[ kFLAGS.ANT_KIDS ] >= 10 ) {
				EngineCore.addButton( 1, 'Fuck Her', this, this.dudesFuckEggLayingBitches );
			}
			if( CoC.flags[ kFLAGS.ANT_KIDS ] > 10 && CoC.player.cor >= 75 ) {
				EngineCore.addButton( 3, 'Orgy (Male)', this, this.orgyWithDatColonyCorruptDudes );
			}
		}
		//Straight Sex (Lesbian/Fisting) - Written
		if( CoC.player.hasVagina() ) {
			EngineCore.addButton( 2, 'Lesbian Sex', this, this.lesbianFisting );
			//While Giving Birth (Female) - Written
			if( CoC.flags[ kFLAGS.PHYLLA_EGG_LAYING ] > 0 && CoC.flags[ kFLAGS.ANT_KIDS ] >= 10 ) {
				EngineCore.addButton( 2, 'Lesbian Sex', this, this.birfingSexWithAntsForDasLadies );
			}
			//Orgy w/ Colony (Female)
			//You tell Phylla you're interested in 'inspecting' your children.
			if( CoC.flags[ kFLAGS.ANT_KIDS ] > 10 && CoC.player.cor >= 75 ) {
				EngineCore.addButton( 4, 'Orgy (Female)', this, this.antColonyOrgy4Ladies );
			}
		}
		//Drider/Bee impregnation scene for Phylla (universal unless otherwise specified, which will include varied intros and stuff.
		//Sex > [Egg Phylla]
		if( CoC.player.canOvipositSpider() ) {
			EngineCore.addButton( 5, 'Oviposit', this, this.eggDatBitch );
		}
	...
	AntsScene.prototype.phyllaTalkChoices = function() {
		...
		EngineCore.addButton( 2, 'Her Life', this, this.phyllasLifePastAndFuture );
		EngineCore.addButton( 9, 'Back', this, this.introductionToPhyllaFollower );
	};
	//►[Talk]
	//..(Ant Morph History)
	AntsScene.prototype.talkAboutAntHistory = function() {
		...
		MainView.outputText( 'You relax on one of the many available pillows and ask Phylla about her race\'s history. She pulls a pillow up next to yours and cuddles in.  "<i>It\'s not a very happy story, are you sure you want to hear it?</i>" You nod and move your hand to hold one of hers.' );
	...
	AntsScene.prototype.talkAboutAntMatingAndRituals = function() {
		MainView.clearOutput();
		MainView.outputText( 'You\'ve always wondered how Phylla can project thoughts and images of her life into your mind. Seeing as how she\'s not busy, you ask her about it.  She tilts her head, trying to think of a way to explain it.  You can see this is taking some thought as she stays silent for almost a minute.' );
		...
		//If corruption more than 60:
			...
			if( CoC.player.cor >= 80 ) {
				...
				if( CoC.flags[ kFLAGS.PHYLLA_EGG_LAYING ] > 0 ) {
					MainView.outputText( ', sending jets of milk shooting out onto the floor' );
				}
				MainView.outputText( '.  With a loud moan she orgasms, covering her smaller two forearms, her inner thighs, and the floor below her in thick, sweet-smelling, girl cum.' );
	...
	AntsScene.prototype.phyllasLifePastAndFuture = function() {
		...
		if( SceneLib.izmaScene.izmaFollower() && CoC.flags[ kFLAGS.PHYLLA_IZMA_TALK ] === 0 ) {
			...
			MainView.outputText( 'Phylla seems to be a little distant today as you sit down to talk.  You point it out to her and she cautiously asks about Izma.' );
			...
			MainView.outputText( 'You take a seat on one of the many fluffy cushions in her room and she proceeds to cuddle in close, pressing her head against your chest and wrapping her abdomen around you.  She then looks up at you and asks what\'s on your mind.' );
	...
	AntsScene.prototype.phyllaBeeeJays = function() {
		...
		//Subsequent Blowjobs:
			...
			MainView.outputText( 'Approaching Phylla, you cross your arms and lean against the wall of her bedchamber while sporting a tell-tale tent in your pants.  Phylla stares down at your bulge and picks up immediately on your intentions.' );
			MainView.outputText( '\n\n"<i>Y-You gonna ask me nicely, or let your penis' );
			if( CoC.player.cockTotal() > 1 ) {
				MainView.outputText( 'es' );
			}
			MainView.outputText( ' do all the convincing?</i>"  She teases.  Shrugging, you inform her that whatever works for her works for you.' );
		}
		//Continued...
		//If Phylla is not Laying Eggs:
		if( CoC.flags[ kFLAGS.PHYLLA_EGG_LAYING ] === 0 ) {
		...
		if( CoC.player.cockArea( x ) < 60 ) {
			...
			MainView.outputText( 'bobbing up' );
			//Dick size less than 5 inches:
			if( CoC.player.cocks[ x ].cockLength < 5 ) {
				MainView.outputText( ' "tall" and proud, rock hard and ready for action.' );
			} else {
				MainView.outputText( ' tall and proud, rock hard and ready for action.' );
			}
		} else {
			...
			if( CoC.flags[ kFLAGS.PHYLLA_BLOWJOBS ] === 1 ) {
				...
				MainView.outputText( ' from your pants, but apparently doesn\'t realize just how big ' );
				if( CoC.player.cockTotal() === 1 ) {
					MainView.outputText( 'this' );
				} else {
					MainView.outputText( 'these' );
				}
				MainView.outputText( ' battering ram' );
				if( CoC.player.cockTotal() > 1 ) {
					MainView.outputText( 's' );
				}
				MainView.outputText( ' can get.  Chuckling at her ignorance, you tell Phylla she\'d better back up.  Phylla rolls her eyes and looks up at you, giving you an unamused look.' );
				...
				MainView.outputText( ' up to a full raging erection, achieving your maximum state of "<i>readiness</i>" in no time at all.' );
			...
			//Dick size more than 60 inches (subsequent blowjobs):
				...
				if( CoC.flags[ kFLAGS.PHYLLA_BLOWJOBS ] === 2 ) {
					MainView.outputText( 'last time' );
				} else {
					MainView.outputText( 'our first time' );
				}
				MainView.outputText( '.  I\'ll help to free ' );
				if( CoC.player.cockTotal() === 1 ) {
					MainView.outputText( 'that monster' );
				} else {
					MainView.outputText( 'those monsters' );
				}
				MainView.outputText( ', but p-please be careful about my valuables.</i>"  Phylla asks nervously.' );
				...
				MainView.outputText( ' freed once more, ready and raring to "re-acquaint" with Phylla.  Taking the hint, Phylla closes in and takes the ' );
				//Dick size less than 16 inches:
				if( CoC.player.cocks[ x ].cockLength < 16 ) {
					MainView.outputText( 'base' );
				} else {
					MainView.outputText( 'middle' );
				}
				MainView.outputText( ' of your shaft against her tongue.  You hear a mix of a giggle and hum as she drags her tongue towards the head of your ' + Descriptors.cockDescript( x ) + '.  Phylla teases your shaft as she reaches the peak and suckles at your urethral opening.  You feel her drawing up as much pre-cum as she can and lapping it up like she\'s dying of thirst.  She continues this for a bit, until it becomes apparent that she\'s either not too sure of what else to do, or that she\'s never heard of how to properly fellate someone.' );
		...
		if( CoC.player.cor < 75 ) {
			...
			EngineCore.addButton( 0, 'Next', this, this.corruptPhyllaEndings );
		}
	};
	//Pure BJ:
	AntsScene.prototype.purePhyllaBJOver = function() {
		MainView.clearOutput();
		var x = CoC.player.smallestCockIndex();
		MainView.outputText( 'You quickly and softly tell her to calm down, she needn\'t worry; you\'ll be more than happy to help her learn how as surely as she would help you if your situations were reversed.  At the mention of counter positions she nods cheerfully.' );
		...
		MainView.outputText( 'Taking your directions, Phylla takes the head of your cock along the top of her wet and humid tongue, leisurely batting around before trapping it with her lips.' );
		...
		if( CoC.player.cockTotal() > 1 ) {
			...
			if( CoC.player.cockTotal() === 2 ) {
				MainView.outputText( 'your other dick' );
			} else {
				MainView.outputText( 'the rest of your dicks' );
			}
			MainView.outputText( '; if she would be "<i>so kind.</i>" With gusto, her four hands shoot up and take your ' );
			if( CoC.player.cockTotal() === 2 ) {
				MainView.outputText( 'cocks into their firm grips' );
			} else {
				MainView.outputText( 'cock into their firm grips' );
			}
			MainView.outputText( '.  Phylla mumbles something but absentmindedly realizes she still has your cock in her mouth and gives up on whatever it was she was trying to say.' );
		}
		//Vagina:
		if( CoC.player.hasVagina() ) {
	...
	AntsScene.prototype.surePhyllaLetsFuck = function() {
		MainView.clearOutput();
		var x = CoC.player.smallestCockIndex();
		MainView.outputText( '"<i>We\'ll have to... kiss...  I mean, I can still taste you... inside my mouth...  I could go wash or... ah~!</i>" You cut her off by pulling her mouth on to yours.' );
	...
	AntsScene.prototype.nopeNotOnMouthOrWhateverFuckThisNoise = function() {
		MainView.clearOutput();
		MainView.outputText( 'You pass on her offer, not wanting to know what THAT sensation' );
		//If PC can't Autofellatio:
		if( !CoC.player.canAutoFellate() ) {
			MainView.outputText( ' or anything like it would feel like.' );
		} else {
			MainView.outputText( ' feels like with Phylla\'s mind linked to your own.' );
		}
	...
	AntsScene.prototype.pureBJEnding = function( linked ) {
		...
		if( linked !== undefined && !linked ) {
			...
			MainView.outputText( 'leading to you jesting through the link and calling her a damn dirty cheater.' );
		}
		if( CoC.flags[ kFLAGS.TIMES_LINKED_BJ_SUCK ] > 0 ) {
			MainView.outputText( '  You can feel her relying less and less on the link with every subsequent time; there\'s no doubt in your mind that she will no longer "<i>cheat</i>" her way into making you cum before you know it.' );
		}
		var x = CoC.player.smallestCockIndex();
		...
		MainView.outputText( ' strands of cum hang wildly between her lips and your prick.' );
		//If cum volume over 1000ml
		if( CoC.player.cumQ() > 1000 ) {
			MainView.outputText( '  Though she might have a mouthful, you\'re not finished yet!  You continue to unload the remainder of your hot load on her breasts and stomach.' );
		}
		if( CoC.player.cockTotal() > 1 ) {
			//If multi cock
			MainView.outputText( '  Your other cock' );
			if( CoC.player.cockTotal() > 2 ) {
				MainView.outputText( 's shower' );
			} else {
				MainView.outputText( ' showers' );
			}
			MainView.outputText( ' her hands and body in your white goo as she continues to pump ' );
			if( CoC.player.cockTotal() === 2 ) {
				MainView.outputText( 'on each of ' );
			}
			MainView.outputText( 'them lovingly.' );
		}
		MainView.outputText( '\n\nWith a heavy sigh, and significantly lighter ' );
		if( CoC.player.balls > 0 ) {
			MainView.outputText( 'balls' );
		} else {
			MainView.outputText( 'in the pelvis' );
		}
		MainView.outputText( ', you rub Phylla\'s hair playfully' );
		if( CoC.flags[ kFLAGS.PHYLLA_BLOWJOBS ] !== 1 ) {
			MainView.outputText( '.' );
		}//If first time:
		else {
			MainView.outputText( ' and congratulate her on her first time.' );
		}
	...
	AntsScene.prototype.corruptPhyllaEndings = function() {
		MainView.clearOutput();
		var x = CoC.player.smallestCockIndex();
		MainView.outputText( '"<i>A slut that can\'t suck a dick... how can this get any worse?</i>"  You ponder to yourself while rubbing your nasal bridge. You tell the innocent little ant that she\'ll learn how to suck a mean cock, even if it kills her.  You\'re knee deep at this point - might as well turn her into something salvageable.  Commanding her attention, you lift her face up and hover your ' + Descriptors.cockDescript( x ) + ' close to her lips, smothering her lips with your precum.  She attempts to turn away but you react before she can.  Holding her head in place you comment on how this is what you want from her.' );
		...
		//If first time:
		if( CoC.flags[ kFLAGS.PHYLLA_BLOWJOBS ] === 1 ) {
			MainView.outputText( 'achieved the desired effect.' );
		}//Every other time:
		else {
			MainView.outputText( 'improved since the last time.' );
		}
		...
		if( CoC.player.cockTotal() > 1 ) {
			...
			MainView.outputText( ' if she would be "<i>so kind</i>".  With gusto, her four hands shoot up and take your cocks into their firm grips.  Phylla mumbles something but absentmindedly realizes she still has your cock in her mouth and gives up on whatever it was she was trying to say.' );
		}
		//Vagina:
		if( CoC.player.hasVagina() ) {
			MainView.outputText( '\n\nYou ask Phylla if she can take care of your womanhood while she\'s at it.  Phylla moves one of her small arms in between your legs and rubs against your ' + Descriptors.clitDescript() + '.  She caresses your labia in between her fingers before inserting them inside of you.  Phylla begins working her wrist diligently in conjunction with her head bobbing.' );
		...
		if( CoC.player.cumQ() < 10 ) {
			...
			MainView.outputText( 'respectable' );
		} else {
			MainView.outputText( 'massive' );
		}
		MainView.outputText( ' facial, covering her petite features in cum.' );
		...
		if( EngineCore.silly() ) {
			...
			MainView.outputText( '.  Somehow, you succeed your fortitude roll and remain conscious without passing out even after plummeting to the ground from sheer exhaustion.  You and Phylla can\'t help but slowly drift off to sleep in a pool of your cum to dream about the bizarre pleasures you two have indulged in.' );
		}
	...
	AntsScene.prototype.dickPhylla = function() {
		...
		if( CoC.flags[ kFLAGS.PHYLLA_FUCKS ] >= 3 ) {
			MainView.outputText( ' she asks playfully, knowing full well that that\'s what you came here for.' );
		}//(First time)
		else if( CoC.flags[ kFLAGS.PHYLLA_FUCKS ] === 0 ) {
			MainView.outputText( ' You nod quickly.' );
		}
		//(Subsequent fucks)
		...
		MainView.outputText( 'in her sexual liquids.' );
	...
	AntsScene.prototype.dudesFuckEggLayingBitches = function() {
		MainView.clearOutput();
		MainView.outputText( 'Phylla looks completely taken aback when you suggest you want to have sex with her.  Obviously self conscious about how she looks right now, she covers her enlarged breasts with all four of her hands as she sits back in her seat.' );
		...
		if( CoC.player.cor < 50 ) {
			MainView.outputText( 'don\'t care how she looks right now. Besides, some creatures around here appreciate a little carnal love; it helps with the birthing process.' );
		}//If Corruption is more than 50:
		else {
			MainView.outputText( 'could care less for her pathetic attempts at concealing her pregnant form; you\'re horny, and she\'s going to put out, regardless of her insecurities.' );
		}
		MainView.outputText( '\n\nYou walk over to her and ' );
		if( CoC.player.cor < 50 ) {
			MainView.outputText( 'lovingly' );
		} else {
			MainView.outputText( 'apathetically' );
		}
		MainView.outputText( ' pull her hands away from her breasts.  She resists you at first, but once she sees there\'s no stopping you she shyly resigns herself to you.' );
		...
		//(If PC has balls:
		if( CoC.player.balls > 0 ) {
			MainView.outputText( ' your balls slap against the smoothness of her pelvis.' );
		} else {
			MainView.outputText( ' your knees grind along the edge of her makeshift throne.' );
		}
	...
	AntsScene.prototype.birfingSexWithAntsForDasLadies = function() {
		MainView.clearOutput();
		MainView.outputText( 'Phylla looks completely taken aback when you suggest that you want to have sex with her.  You can tell she is self conscious about the way she looks right now by the way she covers her enlarged breasts with all four of her hands as she sits back in her seat.' );
		...
		if( CoC.player.isNaga() ) {
			MainView.outputText( '  You slither almost whorishly with a slow, measured wriggle,' );
		} else {
			MainView.outputText( '  You walk almost whorishly with a slow, sensual gait,' );
		}
		MainView.outputText( ' allowing her to see the sensual swivel of your ' + Descriptors.buttDescript() + ' from left to right and back again as you visibly entice Phylla\'s mind to lustful thoughts.  Once you\'re facing Phylla once again, you see her lower two hands are still covering her breasts and the upper two are gripping the stone chair she sits in.' );
		...
		if( CoC.player.cor <= 50 ) {
			MainView.outputText( '  You probe her mind and are almost taken aback."<i>NO!  Just please keep going!</i>"  You hear her voice ring out in your head.' );
		}
		...
		if( CoC.player.cockTotal() > 0 && CoC.player.cockThatFits( 42 ) >= 0 ) {
			...
			if( CoC.player.cockTotal() === 1 ) {
				...
				MainView.outputText( 'as many as you can' );
			}
			MainView.outputText( ' as fiercely as your body will let you.' );
		}
		...
		if( CoC.player.cockTotal() > 0 && CoC.player.cockThatFits( 42 ) >= 0 ) {
			...
			MainView.outputText( 'your ' + Descriptors.multiCockDescriptLight() + ' into her mouth and mashes ' );
			if( CoC.player.cockThatFits2( 42 ) >= 0 ) {
				MainView.outputText( 'them' );
			} else {
				MainView.outputText( 'it' );
			}
			MainView.outputText( ' against the back of her throat.  Unable to contain the pleasure from this, you howl and blow your hot load into her throat.' );
		} else if( CoC.player.hasCock() ) {
		...
		if( CoC.player.biggestCockArea() >= 500 ) {
			...
			MainView.outputText( '.  With a heavy heave, you feel the hot and sticky ejaculate launch from your dick, hitting the interior decorations as you do so; what exactly you hit, you can\'t say... but you\'ll likely be tripping over your mess on the way out.' );
		}
	...
	AntsScene.prototype.orgyWithDatColonyCorruptDudes = function() {
		...
		MainView.clearOutput();
		MainView.outputText( 'You tell Phylla to call in your strongest and most virile children for \'inspection.\'' );
		//First Time:
		...
		if( CoC.flags[ kFLAGS.PHYLLA_EGG_LAYING ] > 0 ) {
			MainView.outputText( 'large, lactating ' );
		} else {
			MainView.outputText( 'small ' );
		}
		MainView.outputText( 'orbs.' );
		...
		if( CoC.player.cockTotal() > 1 && CoC.player.cockTotal() <= 3 ) {
			...
			MainView.outputText( ' getting sucked off by two of your children, who themselves are being sucked off.' );
		}
		...
		MainView.outputText( ' sucked, stroked, inserted, and finally orgasming so many times that you lose track. Hours pass and you eventually pass out sitting atop Phylla\'s throne watching the writhing mass before you.' );
	...
	AntsScene.prototype.antColonyOrgy4Ladies = function() {
		...
		if( CoC.flags[ kFLAGS.TIMES_CORRUPT_FEMALE_ANT_ORGY ] === 1 ) {
			MainView.outputText( 'She gives you a confused look, but does as you command. Tilting her head back and closing her eyes you watch as she silently \'communicates\' to her children.' );
		...
		if( CoC.player.isBiped() ) {
			MainView.outputText( '  Setting one foot on his shoulder, you present your [vagina] to him.' );
		} else {
			MainView.outputText( ' Now at the perfect height, you present your [vagina] to him.' );
		}
		...
		if( CoC.player.isBiped() ) {
			MainView.outputText( ' from between your legs.' );
		} else {
			MainView.outputText( ' from your cunt.' );
		}
		MainView.outputText( '  You beckon him to follow you as you strut over to where Phylla is.' );
		...
		if( CoC.player.hasCock() ) {
			MainView.outputText( '  You feel hands run up and down your shaft' );
			if( CoC.player.cockTotal() > 1 ) {
				MainView.outputText( 's' );
			}
			MainView.outputText( ', causing you to spurt bursts of pre all over the floor.' );
		}
		...
		//If PC has dick(s):
		if( CoC.player.hasCock() ) {
			MainView.outputText( '  Not forgetting you have \'other needs\' the ant mounting you reaches down with his larger arms and grabs hold of [eachCock].  Keeping his smaller arms on your hips to keep stable with each thrust, he pumps vigorously at your cock' );
			if( CoC.player.cockTotal() > 1 ) {
				MainView.outputText( 's' );
			}
			MainView.outputText( '.' );
		...
		if( CoC.player.cockTotal() > 0 ) {
			...
			MainView.outputText( '.  You feel your load' );
			if( CoC.player.cockTotal() > 1 ) {
				MainView.outputText( 's' );
			}
			MainView.outputText( ' splash into your [chest] and chest as ' );
			if( CoC.player.cockTotal() === 1 ) {
				MainView.outputText( 'it' );
			} else {
				MainView.outputText( 'they' );
			}
			MainView.outputText( ' unload.' );
		}
	...
	AntsScene.prototype.phyllaLaysEggsToggle = function() {
		...
		if( CoC.flags[ kFLAGS.PHYLLA_EGG_LAYING ] === 0 ) {
			...
			MainView.outputText( 'Phylla seems confused as to what you\'re thinking as you gaze deeply into her eyes.  You gather all four of her hands between the two of yours and tell her that children are wanted.  Not just one or two; you want as many as she can muster.' );
			//If you've talked to her about history:
			if( CoC.flags[ kFLAGS.TALKED_WITH_PHYLLA_ABOUT_HISTORY ] > 0 ) {
				MainView.outputText( '  You tell her you want a colony like those she spoke of in the times before the corruption.' );
			}
		...
		//(Stop Laying Eggs)
			...
			MainView.outputText( 'You sigh to yourself; you never really wanted this conversation but you knew it might happen someday.  You make a stern face and put a determined fatherly tone in your voice.  Phylla immediately senses you mean business and you have her full attention.  You try to tell her as gently as possible that you don\'t think it is safe for her to keep having children.' );
	...
	AntsScene.prototype.lickThatAntButt = function() {
		MainView.clearOutput();
		MainView.outputText( 'You tilt your head slightly.  You thought she said she could start to lay any time after the first time you had sex with her.' );
	...
	AntsScene.prototype.dontLickAntButt = function() {
		...
		if( CoC.flags[ kFLAGS.ANT_KIDS ] > 1 ) {
			MainView.outputText( '; the children can tend to the eggs and I can really use the rest' );
		}
		MainView.outputText( '.  You should get back to your duties...  B-but I wouldn\'t mind if you came back later...</i>"' );
	...
	AntsScene.prototype.phyllaLaysSomeDriderEggs = function() {
		...
		if( CoC.player.cor < 75 ) {
			...
			if( CoC.flags[ kFLAGS.PHYLLA_EGG_LAYING ] > 0 ) {
				MainView.outputText( 'both eggs are just fine on their own' );
			} else {
				MainView.outputText( 'the egg is just fine on its own' );
			}
			MainView.outputText( ', you redirect your focus to helping Phylla through the labor.  Each subsequent egg that finds its way to freedom causes Phylla\'s once pain filled screams to turn into pleasurable moans of euphoric delight as her pussy becomes overwhelmed by the stimulation of each of your eggs working their way out.  At long last, the final egg slithers out of her vagina and lands gently on the bedding.  Her ordeal over, Phylla breathes a long sigh of relief.' );
			//First Time:
			if( CoC.flags[ kFLAGS.PHYLLA_TIMES_DRIDER_EGG_LAYED ] === 0 ) {
	...
	AntsScene.prototype.driderDoublePhllaMount = function() {
		MainView.clearOutput();
		MainView.outputText( 'No longer able to control yourself, you rip free of your [armor] and charge up to Phylla\'s bed, catching her by surprise as she looks up at you.  With a seductive smile, you pin her down and slather your ovipositor against her fuck hole.' );
	...
	AntsScene.prototype.phyllaDigsForGems = function() {
		...
		if( CoC.flags[ kFLAGS.PHYLLA_GEMS_HUNTED_TODAY ] === 0 && Utils.rand( 20 ) + kidsMod > 10 ) {
			...
			//If Phylla IS NOT Laying Eggs
			if( CoC.flags[ kFLAGS.PHYLLA_EGG_LAYING ] === 0 ) {
				MainView.outputText( 'You ask Phylla is she\'s found any gems while digging out her colony.  She nods happily and runs over to a small stone chest and rifles though it.  After a moment, she runs back over to you and holds up all four of her hands.' );
		...
		//Failure
			...
			MainView.outputText( 'You ask Phylla if she\'s found any more gems while digging.  "<i>No, I\'m sorry.  I haven\'t.  Not since the last time you asked.  I\'ll do better!  I mean, I know you like them.  They\'re rare... even down here.  I\'ll do better...</i>"' );
			//If corruption is less  than 50
			if( CoC.player.cor < 50 ) {
	...
	AntsScene.prototype.eggDatBitch = function() {
		...
		//PC is a Female/Herm Drider:
		if( CoC.player.canOvipositSpider() ) {
			MainView.outputText( 'While Phylla appears to be sexually sated, the heaviness in your spider abdomen begs for release.\n\n' );
		}
		//First Time:
		if( CoC.flags[ kFLAGS.TIMES_EGG_IMPREGNATING_PHYLLA ] === 0 ) {
			MainView.outputText( 'Turning to Phylla, you tell her that you can help to make her wishes of being a brood-mother come true.  She looks at you a bit taken back, as if what you already did wasn\'t enough already.' );
		...
		//Subsequent Times:
			...
			MainView.outputText( 'You give Phylla a knowing look then glance back at your swollen spider abdomen.  Playfully you thrust your ovipositor at her.  Phylla giggles a little, knowing what you want to do to her.' );
		}
