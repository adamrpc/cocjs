...
angular.module( 'cocjs' ).run( function( SceneLib, MainView, CoC, Utils, StatusAffects, EngineCore, AppearanceDefs, Descriptors, Combat, PerkLib, Naga, Appearance ) {
	...
	NagaScene.prototype.nagaEncounter = function() {
		...
		if( CoC.player.lowerBody === AppearanceDefs.LOWER_BODY_TYPE_NAGA ) {
			...
			if( CoC.player.statusAffectv2( StatusAffects.Naga ) === 0 ) {
				...
				MainView.outputText( 'You wander into the desert, noting how good the sand feels on your underbelly compared to rocks and dirt. You are wondering to yourself if maybe it wouldn\'t be a bad idea to come out here more often when you spot something moving a little farther ahead of you.\n\n', false );
			...
			if( CoC.player.gender === 1 || (CoC.player.gender === 3 && Utils.rand( 2 ) === 0) ) {
				...
				if( CoC.player.cockArea( 0 ) > 35 ) {
					MainView.outputText( 'The kiss continues as both of your bodies rub together sensually, your tails continuing to wrap around one another. There is a pulsing in your ' + Descriptors.cockDescript( 0 ) + ' as it starts to grow hard against the naga\'s soft belly. Feeling this, the naga gently pulls away, slowly letting your tongue out of her mouth as she does so. Her hands make their way over your shoulders, down your abs, and stop at your ' + Descriptors.multiCockDescriptLight() + '.\n\n', false );
					MainView.outputText( '"<i>You\'re quite the big boy, aren\'t you?</i>" she says as she wraps both of her hands around your now throbbing ' + Descriptors.cockDescript( 0 ) + '. She starts to slide her hands up and down your length. Sticking out her tongue, she wraps it around the tip and licks at the pre that is starting to leak out.\n\n', false );
					MainView.outputText( 'A hiss of pleasure escapes your lips as the naga strokes and licks at your ' + Descriptors.cockDescript( 0 ) + ', her talented fingers and tongue bringing you into a further state of arousal. The naga stops her caressing and brings your ' + Descriptors.cockDescript( 0 ) + ' to her chest, pressing her breasts around it. She slowly starts to slide her body up and down your shaft, using her tongue to bring some of your pre and lubricate her body. Once she is satisfied with her body\'s slickness, she quickens her pace.\n\n', false );
					MainView.outputText( 'You moan in pleasure as the naga takes the tip of your member into her mouth and starts to suck. You can feel her deft tongue licking every inch of your cock head.\n\n', false );
					MainView.outputText( 'At your limit, you let out a yell as you cum into her mouth. ', false );
					//[lots of jizz]
					if( CoC.player.cumQ() > 250 ) {
						MainView.outputText( 'Her cheeks bulge with the volume and she struggles to swallow as much of it as she can. ', false );
					}
					//[JIZZOFTHEGODS]
					if( CoC.player.cumQ() > 1000 ) {
						MainView.outputText( 'Her cheeks bulge out with the sheer volume of your cum and she is forced to release you from her mouth to avoid drowning in your seed. ', false );
					}
					MainView.outputText( 'You collapse onto the sand and lay there, basking in the warm glow of your orgasm. The naga slides onto your chest and gives you a kiss. "<i>I rather enjoyed that,</i>" she hisses into your ear, "<i>We should do this more often.</i>"\n\n', false );
					MainView.outputText( 'She gives you one last kiss before slithering off into the desert. You watch as she leaves and blow her a kiss goodbye before she disappears from your sight.\n\n', false );
				}
				//[Cock isn't too big]
				else {
					MainView.outputText( 'The kiss continues and both of your bodies rub together sensually, your tails continuing to wrap around one another. There is a pulsing in your ' + Descriptors.multiCockDescriptLight() + ' as ', false );
					if( CoC.player.cockTotal() === 1 ) {
						MainView.outputText( 'it starts ', false );
					} else {
						MainView.outputText( 'they start ', false );
					}
					MainView.outputText( 'to grow hard against the naga\'s soft belly. Feeling this, the naga gently pulls away, slowly letting your tongue out of her mouth as she does so. Her hands make their way over your shoulders, down your abs, and stop at your ' + Descriptors.multiCockDescriptLight() + '.\n\n', false );
					//[player has one dick]
					if( CoC.player.totalCocks() === 1 ) {
						MainView.outputText( 'Gently she starts to stroke the length of your ' + Descriptors.cockDescript( 0 ) + ' with one hand while circling the tip with the other. ', false );
					}
					//[player has two dicks]
					if( CoC.player.totalCocks() === 2 ) {
						MainView.outputText( 'She takes one in each of her hands and gently strokes them up and down. Every few seconds she stops at the tip to rub her palms over them. ', false );
					}
					//[player has three or more dicks]
					if( CoC.player.totalCocks() >= 3 ) {
						MainView.outputText( 'She takes one in each hand, stroking them slowly and making sure to pay attention to the tip. Every so often she switches to a different dick to make sure that each and every one of your throbbing cocks has some love given to them. ', false );
					}
					MainView.outputText( 'A hiss of pleasure escapes your lips as the naga strokes your ' + Descriptors.multiCockDescriptLight() + ', her talented fingers bringing you further into a state of arousal. She stops her caress and brings her hand to a scaly covering at her crotch, spreading it wide to reveal her soft pussy.\n\n', false );
					//[player has one dick]
					if( CoC.player.totalCocks() === 1 ) {
						MainView.outputText( 'She carefully lines it up with your member and starts to tease the tip before gently inserting the first few inches. ', false );
					}
					//[player has two dicks]
					if( CoC.player.totalCocks() === 2 ) {
						MainView.outputText( 'She carefully lines it up with both of your members and starts to tease their tips before gently inserting the first few inches. ', false );
					}
					//[player has three or more dicks]
					if( CoC.player.totalCocks() >= 3 ) {
						MainView.outputText( 'She carefully lines it up with one of your members and starts to tease the tip before gently inserting the first few inches. ', false );
					}
					MainView.outputText( 'She pulls her hips back slightly before pushing them back down, swallowing a bit more of you into her.  As she pulls back the second time, she shifts her arms to rest on your shoulders and grips your back tightly as she pushes you deeper inside of her.\n\n', false );
					MainView.outputText( 'Every thrust brings you deeper inside of her pussy, its soft walls massaging you. It seems like her pussy managed to swallow your entire cock in no time at all. The naga pauses for a moment, your hips pressed together, panting. You shift your arms up a little higher to rest at her waist and lower your head to nuzzle at her neck. The naga leans her head into yours and wraps one of her arms around your head. Once more she pulls back her hips before thrusting them back onto your cock. No longer is she slowly bringing you inside her, now she thrusts herself onto you, going faster and faster. Your tails tighten around each other as you reach climax. A sudden yell escapes your throat as you cum inside of her, your tail squeezing hard enough to crush a lesser being. The naga shudders in your grip as she reaches her own climax. ', false );
					//[lots of jizz]
					if( CoC.player.cumQ() > 250 ) {
						MainView.outputText( 'You quickly fill her with your seed to the point where she overflows, leaving her pussy dripping with semen afterwards.', false );
					}//[JIZZ, JIZZ EVERYWHERE]
					else if( CoC.player.cumQ() > 1000 ) {
						MainView.outputText( 'Her stomach quickly swells from the sheer volume of seed pumped into her. The sperm that her womb is unable to hold starts to gush out from her stuffed cunt.', false );
					}
			...
			//Genderleast
				...
				MainView.outputText( 'The naga looks down and suddenly giggles at your stark lack of fun-bits. You turn away in embarrassment and start to head back to your camp.\n\n', false );
				MainView.outputText( '"<i>Wait,</i>" the naga reaches out and places a hand on your shoulder. "<i>I didn\'t mean to insult you. I\'ve never seen anyone else quite like you.</i>" She slides her hand down your body. "<i>I wonder if you can show me just what a body like yours can do.</i>"\n\n', false );
				MainView.outputText( 'Enjoying this new shift in the conversation, you coil around her and position your head over the scaly covering over her pussy. A soft hiss escapes the naga as you slide your tongue into her, twirling it around to caress every inch of her. Her hands make their way to your head and press you deeper into her.\n\n', false );
				//(If tongue is forked)
				//9999 - BLAH!
				if( 1 === 0 ) {
					MainView.outputText( 'You move your tongue faster and deeper into her pussy, your forked tongue reaching deeper than any human tongue ever could.  ', false );
				}//(Otherwise)
				else {
					MainView.outputText( 'You move your tongue faster and faster into her pussy, reaching as far in as you possibly can.  ', false );
				}
				MainView.outputText( 'The naga grips your head tightly to her and suddenly thrusts her hips in orgasm, her girl cum coating your tongue and mouth.\n\n', false );
				MainView.outputText( 'You uncoil yourself and slowly gather your things, the naga lying on the sand panting.\n\n', false );
				MainView.outputText( '"<i>We should do this more often,</i>" she says before you head off.\n\n', false );
			}
			MainView.outputText( 'You think it would be a very good idea to come to the desert more often.', false );
	...
	NagaScene.prototype.gooNagaRape = function() {
		MainView.outputText( '', true );
		CoC.player.orgasm();
		MainView.outputText( 'You look over at the prone form of the naga lying in the sand, her ', false );
		if( CoC.monster.HP < 0 ) {
			MainView.outputText( 'weak ', false );
		} else {
			MainView.outputText( 'flushed ', false );
		}
		MainView.outputText( 'form only serving to arouse you further. You slide over to her, your gooey lower half leaving a wet trail behind you. As you stand over the defeated form of the snake woman, an idea pops into your head, ', false );
		if( CoC.player.cor > 50 ) {
			//(if corrupt male)
			if( CoC.player.gender === 1 ) {
				MainView.outputText( 'your ' + Descriptors.cockDescript( 0 ) + ' growing harder at the thought.', false );
			}
			//(if corrupt female)
			else if( CoC.player.gender === 2 ) {
				MainView.outputText( 'your cunt grows moist at the thought.', false );
			} else if( CoC.player.gender === 3 ) {
				MainView.outputText( 'your cock twitches and your pussy becomes moist from the thought.', false );
			} else {
				MainView.outputText( 'you feel a tingle at your groin from the thought.', false );
			}
		}
		//(if not corrupt)
		else {
			MainView.outputText( 'the thought is almost too horrible to consider, but still...', false );
		}
		MainView.outputText( '  You slide your gooey form over her body, resting at her crotch. She tries to push you off, but you easily resist her.\n\n', false );
		MainView.outputText( 'Looking down, you see a scale covered slit at her crotch. Bringing a hand down to it, you stroke it gently and feel the naga twitch beneath you. You slowly open the slit to reveal the moist folds of her pussy. You start to tease her by stroking her netherlips, the naga moaning in response. You gradually slide your fingers in, moving them inside of her to see just how far her lips can spread. The naga continues to pant and moan under your touch, her tail thrashing in the sand.\n\n', false );
		MainView.outputText( 'You decide that you\'ve played with her enough and withdraw your hand, now wet with her juices, from her pussy. A hiss escapes the naga\'s lips and she tries to bring your hand back to her needy cunt. You pull your hand out of her grip and instead shift your gooey form over her lips and start to push some of your lower half into her. She starts to coo as you shove the first few inches in, her hips thrusting into the air. You continue to push more of your slimy form into her, sliding deeper and deeper into her as her walls convulse around you.\n\n', false );
		MainView.outputText( 'Soon you feel yourself hit a wall as your body hits the opening of the naga\'s cervix. A stray thought crosses your mind as you think that maybe this is far enough, ', false );
		//(if corrupt)
		if( CoC.player.cor > 50 ) {
			MainView.outputText( 'but immediately after, you decide that this is going to be too much fun to not push on.', false );
		}//(if not corrupt)
		else {
			MainView.outputText( 'but a nagging voice at the back of your head urges you to push further.', false );
		}
		MainView.outputText( 'You grab the naga\'s shoulders and thrust yourself down, HARD. The naga screams as you push past her cervix and fill her womb with your gooey form. Her entire body writhes as you push more of yourself into her womb, her stomach starting to bulge out at the sheer amount filling her. The screams of the naga intensify as you push more and more of yourself into her, her stomach swelling enough to look pregnant. You finally stop pushing into her, almost your entire lower half inside of the naga.\n\n', false );

		MainView.outputText( 'You pause for a moment, enjoying the sensation of filling someone up with your body, surprised at just how good it feels. Grabbing the naga\'s hips you slowly push yourself in and out of her now full pussy, ', false );
		//(if male)
		if( CoC.player.totalCocks() > 0 ) {
			if( CoC.player.cockTotal() === 1 ) {
				MainView.outputText( 'your ' + Descriptors.cockDescript( 0 ), false );
			} else {
				MainView.outputText( 'one of your ' + Descriptors.multiCockDescriptLight(), false );
			}
			MainView.outputText( ' hitting the naga\'s pleasure buzzer with each downward thrust.', false );
		}
		//(if female)
		else if( CoC.player.gender === 2 ) {
			MainView.outputText( 'your clit rubbing against the naga\'s pleasure buzzer with each downward thrust.', false );
		}
		//(if herm)
		else if( CoC.player.gender === 3 ) {
			if( CoC.player.cockTotal() === 1 ) {
			...
			MainView.outputText( ' and clit rubbing against the naga\'s pleasure buzzer with each downward thrust.', false );
		}
		//(if genderless)
		else {
			MainView.outputText( 'your bare crotch hitting the naga\'s pleasure buzzer with each downward thrust.', false );
		}
		MainView.outputText( '\n\nYou continue to relentlessly push yourself into the naga, stretching her wide.  ', false );
		//(if male)
		if( CoC.player.gender === 1 ) {
			MainView.outputText( 'You let out a yell as ', false );
			//(normal)
			if( CoC.player.cumQ() < 250 ) {
				MainView.outputText( 'you come all over the naga\'s stomach.', false );
			} else if( CoC.player.cumQ() < 1000 ) {
				MainView.outputText( 'you come all over the naga\'s face and stomach.', false );
			}//(if THE LEVEYS HAVE BROKE RUN FOR THE HILLS)
			else {
				MainView.outputText( 'you come violently, covering the naga in a layer of your sperm.', false );
			}
		}
		//(if female)
		else if( CoC.player.gender === 2 ) {
			MainView.outputText( 'You shriek in delight as wave after wave of orgasms rush over you', false );
			//(if squirter)
			if( CoC.player.vaginas[ 0 ].vaginalWetness === AppearanceDefs.VAGINA_WETNESS_SLAVERING ) {
				MainView.outputText( ', your girlcum gushing out and pooling on the stomach of the naga', false );
			}
			MainView.outputText( '.', false );
		}
		//(if herm)
		if( CoC.player.gender === 3 ) {
			MainView.outputText( 'You scream in ecstasy as you hit your peak, your girlcum ', false );
			if( CoC.player.vaginas[ 0 ].vaginalWetness < AppearanceDefs.VAGINA_WETNESS_SLAVERING ) {
				MainView.outputText( 'leaking out', false );
			} else {
				MainView.outputText( 'gushing out to form a pool on the naga\'s stomach', false );
			}
			MainView.outputText( ' and your ' + Descriptors.multiCockDescriptLight(), false );
			//(normal)
			if( CoC.player.cumQ() < 250 ) {
				MainView.outputText( ' spurting onto her stomach as well.', false );
			}//(lots of jizz)
			else if( CoC.player.cumQ() < 1000 ) {
				MainView.outputText( ' spurting onto her stomach and face.', false );
			} else {
				MainView.outputText( ' completely covering the naga in a layer of your spooge.', false );
			}
		}
		//(if genderless)
	...
	NagaScene.prototype.nagaVictoryMale = function() {
		...
		if( CoC.player.totalCocks() > 0 ) {
			...
			if( CoC.player.lowerBody === AppearanceDefs.LOWER_BODY_TYPE_CENTAUR ) {
				...
				//[normal cum load]
				if( CoC.player.cumQ() < 250 ) {
					MainView.outputText( 'you cum inside of her, ', false );
				}//[extra cum]
				else if( CoC.player.cumQ() < 1000 ) {
					MainView.outputText( 'you fill her insides with huge spurts of cum, ', false );
				}//[SUPER CUM]
				else {
					MainView.outputText( 'you explode with huge fountains of cum spurting from your ' + Descriptors.cockDescript( 0 ) + ', gushing out from where the two of you are joined to rain on the sands below, ', false );
				}
				MainView.outputText( 'as she squeezes you tightly in a climax of her own that steals your breath away.\n\n', false );
				MainView.outputText( 'Exhausted from her gymnastics, the naga slowly unwinds from you and lies on the sand, cum dripping from her pussy onto the dry desert beneath her.\n\n', false );
			}
			//Uncorrupted  
			else if( CoC.player.cor < 50 ) {
				MainView.outputText( 'You almost feel pity as you behold the defeated creature lying before you, but your growing arousal pushes the thought from your mind. Leaning forward to get a closer look, your thoughts wander, and you find yourself wondering what her flexible body could do. Unable to contain your lust, you remove your ' + CoC.player.armorName + ' and slowly lay on top of her, moving your hands across her scaly form in search of her pussy. As you rub your hands across the underside of her scaly belly, you notice that she is beginning to blush and moan softly. She is visibly trying to hold the feelings back, but whatever it is you\'re doing to her is definitely making that difficult. For the moment, you decide to abandon the search, content with simply running your hands along her tail\'s soft underside and watching her face as she tries in vain to hold her passion back. As you run your fingers up the center of her tail\'s underside, you notice a strange bump just a few inches below where her skin and scales meet. On further inspection, you realize that this is the thing you have been searching for - her warm, wet lovehole. Your touches seem to have had an effect on her; she is already rather moist, ready to take your ' + Descriptors.cockDescript( 0 ) + '. You gingerly slide one of your fingers inside her, feeling for depth as well as for wetness. The naga coos softly, unable to withhold her moans.\n\n', false );
				MainView.outputText( 'You slowly begin moving your fingers in and out of her wet snatch, petting her underbelly with your free hand. You can tell that she is still tense; the look on her face is a mix of passion and fear. She struggles weakly, terrified as you place your warm ' + Descriptors.cockDescript( 0 ) + ' against her belly. You feel her grow still as your length rubs against her. You look deeply into her amber eyes as you wrap your arms around her, and after a moment\'s hesitation, kiss her passionately. Surprised at your own decision, your mind quickly conjures an image of her biting you. Instead, she relaxes in your arms and returns the kiss, abandoning herself to your will.\n\n', false );
				//[if cock fits]
				if( CoC.player.cockArea( 0 ) <= CoC.monster.vaginalCapacity() ) {
					MainView.outputText( 'Chills run down your spine as her delicate forked tongue tangles with your own, and you gently press the tip of your ' + Descriptors.cockDescript( 0 ) + ' against her moist pussy-lips. Her tail slowly wraps around your legs as she moans in a soft and mildly hissing voice. You sink your engorged member into her depths, pausing for a moment to let her adapt to your presence, before pumping away and kissing her passionately as you both get caught up in the wonderful sensations of your entwined bodies. Her tight passage massages your length, and her scaly body rubbing on your skin only encourages you to go further while you rock back and forth in her embrace. You gradually increase your pace, hearing her moans become louder as she moves her hips in time with yours. Your fingers dig into her smooth backside as you continue thrusting into her, pleasure building for what seems like a wonderful eternity. You finally reach your limit, thrusting frantically until you climax, ', false );
					//[normal cum load]
					if( CoC.player.cumQ() < 250 ) {
						MainView.outputText( 'shooting thick ropes of sperm deep inside her as the both of you wail with excitement.', false );
					}//[lots of cum]
					else if( CoC.player.cumQ() < 500 ) {
						MainView.outputText( 'pumping large amounts of cum deep inside her as both your voices rise in screams of pleasure.', false );
					}//[Spermageddon]
					else {
						MainView.outputText( 'your ' + Descriptors.cockDescript( 0 ) + ' erupting, blasting a violent torrent of semen deep inside her petite frame, filling her up completely as both your voices rise in screams of pleasure.', false );
					}
				}
				//[If cock too large]
				else {
					MainView.outputText( 'You draw away from her lips and return to your upright posture. Relaxed as she is, the naga looks nervously at your ' + Descriptors.cockDescript( 0 ) + ', fully aware that it won\'t fit inside her small body. This occurs to you as well, and you begin to formulate a different plan. You move up onto her body so that you\'re straddling her stomach, fitting your ' + Descriptors.cockDescript( 0 ) + ' neatly between her small C-cup breasts. You gently coax her hands to her breasts, and she begins to comprehend your intentions. She begins to squeeze your ' + Descriptors.cockDescript( 0 ) + ' between her two warm mounds of flesh, doing her best to keep it snugly between them. Of her own accord, the naga begins to run her tongue across the ' + CoC.player.cockHead() + ', obviously understanding what you want. She looks up at you with an unsure look, as if asking whether or not she is doing it right. You nod to her, and that\'s all the encouragement she needs. She begins to stroke your ' + Descriptors.cockDescript( 0 ) + ' with her breasts as if it came naturally to her, covering as much of your ' + CoC.player.cockHead() + ' as she can with her warm and trembling mouth.\n\n', false );
					MainView.outputText( 'You lean back and sigh with pleasure as the naga\'s movements become bolder and bolder, fitting just a little bit more in her mouth here, or squeezing her breasts tighter there. It\'s not long before you are panting and slightly thrusting your hips in time to her strokes. As she quickens her pace, you cannot hold yourself back any longer. You begin to cum without much warning, ', false );
					//[normal cum load]
					if( CoC.player.cumQ() < 250 ) {
						MainView.outputText( 'filling her mouth with your warm seed.', false );
					}//[lots of cum]
					else if( CoC.player.cumQ() < 500 ) {
						MainView.outputText( 'pumping her mouth full of your sticky seed, some of which she is forced to swallow to avoid choking.', false );
					}//[Oh God, it just keeps coming out, help me!]
					else {
						MainView.outputText( 'easily flooding her mouth with your seed. Your seed gushes from her nose, with still more rushing down her throat. She gags and chokes a bit, a large amount of your seed leaking out onto her chest.', false );
					}
					MainView.outputText( '  The naga removes your ' + Descriptors.cockDescript( 0 ) + ' from her mouth', false );
					//[lots of cum OR more]
					if( CoC.player.cumQ() > 500 ) {
						MainView.outputText( ', the last sticky blasts of your semen splashing across her face,', false );
					}
					MainView.outputText( ' and looks to you for instruction. You simply nod and she understands, ', false );
					//[normal cum load]
					if( CoC.player.cumQ() < 250 ) {
						MainView.outputText( ' gulping down the warm sperm in her mouth.', false );
					}//[lots of cum OR more]
					else {
						MainView.outputText( ' doing the best she can to swallow her mouthful of cum.', false );
					}
				}
			...
			//Corrupted (event raises fatigue by 20)
				...
				if( CoC.player.cumQ() > 250 ) {
					MainView.outputText( '  Your spooge explodes from the naga\'s abused cunt, flooding the desert sands as you black out.\n\n', false );
				} else {
					MainView.outputText( '\n\n', false );
				}
				MainView.outputText( 'When you awaken, the naga is long gone. All that remains of your encounter is a depression in the landscape', false );
				//[lots of jizz]
				if( CoC.player.cumQ() > 250 ) {
					MainView.outputText( ' with traces of semen in it', false );
				}//[if OMGWTFBBQGALLONSOFCUM]
				else if( CoC.player.cumQ() > 2000 ) {
					MainView.outputText( ' that\'s filled with your thick seed', false );
				}
				MainView.outputText( '.\n\n', false );
				MainView.outputText( 'As you retrieve your clothes, you notice red marks around your chest and arms. It seems that while the naga did have the opportunity to kill you while you were unconscious, she preferred to keep you alive.\n\n', false );
			}
		}
		MainView.outputText( 'You think it would be a very good idea to come to the desert more often.', false );
		CoC.player.orgasm();
	...
	NagaScene.prototype.nagaVictoryGenderless = function() {
		...
		if( CoC.player.lowerBody === AppearanceDefs.LOWER_BODY_TYPE_CENTAUR ) {
			...
			MainView.outputText( 'You speed up your licking and thrust your tongue deeper into her, her walls now slick. She presses your face deep into her pussy as her hips buck in orgasm.\n\n', false );
			MainView.outputText( 'The tail of the naga slides out of you as she lies back in the sand of the desert, exhausted from her orgasm. You stand up and gather your things, thinking that maybe it wouldn\'t be too bad of an idea to come back.\n\n', false );
		}
		//a)Uncorrupted
		else if( CoC.player.cor < 50 ) {
			MainView.outputText( 'You look down at the collapsed naga, feeling the blood pounding hotly through your veins. You stand above her fallen form and start to take off your pants when you remember that you have nothing down there. A soft curse escapes your lips; this will make things much more difficult, but there WILL be sex one way or another.\n\n', false );
			MainView.outputText( 'You straddle the naga, placing your bare, featureless crotch against the slit of her vagina. Slowly you rock your hips back and forth against her, drawing out a gasp of pleasure from her. Leaning over her you start to massage her breasts.\n\n', false );
			MainView.outputText( 'The naga\'s pussy starts to grow slick with her juices as you speed up your rocking. Her tail starts to curl around you, slowly inserting it into your ass as you continue to rock against her. You speed up your grinding, going faster and faster until a scream of pleasure erupts from the naga as she bucks her hips in orgasm.\n\n', false );
			MainView.outputText( 'You stand up over her, your crotch now wet from her girl cum. You pick up your things and put your clothes back on, leaving the naga lying there in bliss.\n\n', false );
		}
		//b)Corrupted
		else {
			if( !CoC.player.findStatusAffect( StatusAffects.MeanToNaga ) ) {
	...
	NagaScene.prototype.nagaFUCKSJOOOOOO = function() {
		...
		//too)
			...
			if( CoC.player.cockArea( 0 ) <= CoC.monster.vaginalCapacity() ) {
				...
				if( CoC.player.cumQ() < 250 ) {
					...
					MainView.outputText( 'erupts', false );
				}
				MainView.outputText( ' into her body. She ', false );
				//(Normal)
				if( CoC.player.cumQ() < 250 ) {
					MainView.outputText( 'moans and pants', false );
				}//(Lots of cum)
				else if( CoC.player.cumQ() < 1000 ) {
					MainView.outputText( 'squeals with joy', false );
				}//(It's gonna take weeks to clean this up!)
				else {
					MainView.outputText( 'screams in delight', false );
				}
				MainView.outputText( ' as your hot, gooey sperm ', false );
				//(Normal)
				if( CoC.player.cumQ() < 250 ) {
					MainView.outputText( 'coats her womb.', false );
				}//(Lots of cum)
				else if( CoC.player.cumQ() < 1000 ) {
					MainView.outputText( 'completely fills her.', false );
				}//(Indonesia called, they're flooded again)
				else {
					MainView.outputText( 'absolutely engorges her, with the excess spurting out in torrents from her pussy.', false );
				}
			}
			//(Cock too big)
			else {
				...
				if( CoC.player.balls > 0 ) {
					MainView.outputText( 'She shifts one of her hands down from your ' + Descriptors.cockDescript( 0 ) + ', to your ' + Descriptors.ballsDescriptLight() + ', cupping them in her slick palm.  ', false );
				}
				...
				//(Normal)
				if( CoC.player.cumQ() < 250 ) {
					MainView.outputText( 'The naga manages to hold the warm cum within her mouth, only causing her cheeks to bulge a little.', false );
				}//(Lots of cum)
				else if( CoC.player.cumQ() < 1000 ) {
					MainView.outputText( 'The naga\'s cheeks balloon as her mouth is filled with your hot, gooey sperm, forced to swallow some of it as her cheeks reach their full capacity.', false );
				}//(Cumception, we need to go deeper)
				else {
					MainView.outputText( 'Hot semen blasts from the naga\'s nose as her mouth is completely filled in seconds. Much of your warm cum is forced down her throat and into her stomach, causing it to distend slightly within her thin frame.', false );
				}
				...
				if( CoC.player.findStatusAffect( StatusAffects.MeanToNaga ) ) {
					...
					MainView.outputText( 'You end up enjoying the whole thing. She then gets back up and leave you there, not without looking back. You stay there, lying on the sand for a few moments before you doze off in a nap.  After you wake, you finally decide to head back to your camp.', false );
				}
			}
		}
		//b) female //http://nekomimichan.org/mg/src/12844585127.jpg
			...
			MainView.outputText( 'The naga slowly approaches you with a smile of delight, devouring you with her eyes like the helpless morsel you are. When she\'s close enough, she slides her tail under you and brings you closer to her. As she hisses in your ear, a chill goes down your spine don\'t understand a word she is saying, but you can tell just by the variations that this lovely lady won\'t be going easy on you, ', false );
			//(if corrupted)
			if( CoC.player.cor > 50 ) {
				MainView.outputText( 'and the sheer thought of it is making you wet already.  ', false );
			}
			//(if uncorrupted)
			else {
				MainView.outputText( 'and while you know you probably won\'t like it, your ' + Descriptors.vaginaDescript( 0 ) + ' says otherwise.  ', false );
			}
			MainView.outputText( 'Now astride the base of her tail and facing towards her, your eyes are drawn to the place on her scaly pelvis where a vagina should be. With one hand the naga begins gently caressing her nether regions, which begin to swell in her excitement into the outlines of a recognizable reptilian vulva. Her expectations are perfectly clear ', false );
			//(If defeated by lust)
			if( CoC.player.lust > 99 ) {
				MainView.outputText( 'and you can feel the need to have sex with her burn inside you. You quickly strip yourself of your ' + CoC.player.armorName + ' and throw yourself on her awaiting pussy.', false );
			}
			//(If defeated by KO)
			else {
				MainView.outputText( 'and you\'re too weak to resist anyway; you might as well just comply. You attempt to remove your ' + CoC.player.armorName + ' before the naga grabs you in pity and decides to help you with it. Now naked,  she lays you down on her tail and you let her guide you to her awaiting pussy.', false );
			}
			MainView.outputText( '  Without any further complaints, you pull her lips apart and start licking. The creature lets out a sigh of pleasure as you move your tongue around the outside of her netherlips.\n\n', false );
			MainView.outputText( 'Slowly you move your tongue around her folds, hearing her soft moans of arousal. Bringing your lips to the bottom of her slit, you gently kiss at it, carefully working your way up to the top. You pause a moment once at the top to plant a gentle kiss on her love button and feel her twitch slightly before you make your way back down to her glistening cunt and lick at the moisture, savoring its taste.\n\n', false );
			MainView.outputText( 'You continue your loving assault on her love canal as the naga\'s moans gradually become louder. Her hands make their way to your head and she curls her fingers through your ' + Descriptors.hairDescript() + ' to get a better grip on your head as you bring your mouth up to her pleasure buzzer. You give one final, slow lick up the length of her pussy and twirl your tongue around her now engorged clit. The naga involuntarily bucks her hips into your face as you start to suck on her pleasure buzzer. As you continue to play with her clit, she begins to lose control, grinding her soaking pussy against your face, and vice-versa. She forces herself onto you so hard, it becomes hard to breathe, and the warm juices of her excited love-slit coat your face. ', false );
			//(If you are a naughty girl)
			if( CoC.player.cor > 80 ) {
				MainView.outputText( 'You attempt to bite at her clit, in an attempt to have her let off a bit, but instead of causing her to pull away, it drives her over the edge, sending her into a crushing climax. She squeals and her hips begin to buck with more ferocity than ever before. Her warm reptilian love juices fill your mouth and splash across your face and upper body, and she hisses something, which you can only assume is encouragement.', false );
			}
			//(If you are a good girl)
			else {
				MainView.outputText( 'You attempt to pull away from her hot snatch, pulling your mouth from her swollen clit. She overpowers you, pulling your face back down upon her lovebuzzer. The feeling of your warm, wet lips as they rub against her clit is apparently just enough for her as it pushes her past her limit, sending her into a passionate orgasm.', false );
			}
			MainView.outputText( '  You finally pull away from her as her body is wracked with powerful contractions, wiping the excess ladycum from your face.\n\n', false );
			...
			if( CoC.player.cor > 50 ) {
				MainView.outputText( 'You close your eyes, and imagine that the tail is just another big cock to be sucked. You begin to suck at the tip, as well as run your tongue up and down along its length.  ', false );
			}
			//(If you are a good girl)
			else {
				MainView.outputText( 'You do your best to follow the naga\'s example, but you are not sure why she is doing it.  ', false );
			}
			MainView.outputText( 'Eventually, it appears that the naga is satisfied, and she stops, nudging you to do so as well.\n\n', false );
			MainView.outputText( 'Then the naga lies flat on the sandy ground, pulling your body down onto on hers, face up, with your head resting between her soft breasts. She reaches around your body, placing her hands on your own ' + Appearance.biggestBreastSizeDescript() + ' gently holding you in place as her tail moves closer to your ' + Descriptors.vaginaDescript( 0 ) + '. As she begins to rub her presently-slick tail against your slit, the scaly tip brushes your ' + Descriptors.clitDescript() + ' and you moan with passion in response.  There is no holding it back; this feeling is one of the best you have experienced. Her tail continues to flick and rub your ' + Descriptors.clitDescript() + ' as you begin to buck your hips gently. The naga pokes and rubs at your ' + Descriptors.clitDescript() + ' for some time, eventually driving you to the first of many coming orgasms. After your breath has become even again and your muscles have become relaxed, the naga resumes her advances. She begins to rub the tip of her tail up and down along your ' + Descriptors.vaginaDescript( 0 ) + ', and you finally understand her intentions.\n\n', false );
			...
			if( CoC.player.biggestLactation() > 1 ) {
				MainView.outputText( '  Your warm milk is leaking from your ' + Descriptors.nippleDescript( 0 ) + ' the entire time, coating your ' + CoC.player.skinDesc + ' and soaking her hands. At one point, she withdraws a hand and licks the milk from it. You can only assume that she liked it, as she begins to focus even more on your breasts.', false );
			}
			MainView.outputText( '\n\n', false );
			MainView.outputText( 'The naga lifts you from her body with her tail, placing you onto the warm sand where she had been laying. She moves her own body above yours, her tail buried deep inside your ' + Descriptors.vaginaDescript( 0 ) + ' the entire time. She holds you in place with one hand, her other hand moving to resume playing with your ' + Appearance.biggestBreastSizeDescript() + '. She moves her head in, her hot breath washing over your other breast, and looks up into your eyes for a moment. She smiles, giggles, and then wraps her mouth around your ' + Descriptors.nippleDescript( 0 ) + ', letting her slender tongue tickle your sensitive skin there.', false );
			//(If fuckable nipples)
			if( CoC.player.hasFuckableNipples() ) {
				MainView.outputText( 'It isn\'t long before she decides to take it one step further, pushing her tongue inside your ' + Descriptors.nippleDescript( 0 ) + ' and wriggling it around inside. Meanwhile, her other hand begins to work its way into your other ' + Descriptors.nippleDescript( 0 ) + ', finger-fucking it for all it\'s worth.', false );
			}
			//(If lactating)
			if( CoC.player.biggestLactation() > 1 ) {
			...
			MainView.outputText( '\n\n', false );
			MainView.outputText( 'All this time, her tail has been working its way slowly inside you, stretching you farther with every thrust. As you open your mouth to let out another passionate wail, she moves in, pushing her lips over yours and kissing you passionately', false );
			//(If lactating)
			if( CoC.player.biggestLactation() > 1 ) {
				MainView.outputText( ', sharing with you some of your delicious milk', false );
			}
			MainView.outputText( '.', false );
			//(If pregnant)
		...
		//d) genderless
			...
			MainView.outputText( 'A grin stretches across the naga\'s face as she slithers over to your collapsed form. She coils her tail tightly around your prone form, squeezing hard enough to make it difficult to breathe. She brings her hand down to the crotch of your ' + CoC.player.armorName + ' and a look of confusion crosses her face before she realizes that there is nothing down there.\n\n', false );
			MainView.outputText( 'After a moment of chuckling, the naga brings your face down to a scaly covering at her crotch and opens it to reveal her awaiting netherlips. ', false );
			//(If player not corrupted)
			if( CoC.player.cor < 50 ) {
				MainView.outputText( 'You try to turn your head away, but she forcefully shoves it down into her soft folds.  ', false );
			}//if player is corrupted)
			else {
				MainView.outputText( 'You eagerly bring your mouth to her glistening pussy. ', false );
			}
			MainView.outputText( 'You start to work your tongue around her awaiting clit, the naga moaning at the pleasure. You continue your assault on her pleasure button as her pussy begins to glisten with moisture. You move your tongue to her soft netherlips, licking softly at the moisture that coats them, enjoying the moans of pleasure that erupt from the naga. The naga\'s hips start to twitch as you bring your tongue up the length of her glistening slit, stopping at the top to suck gently at her clit.\n\n', false );
			MainView.outputText( 'Her tail starts to squeeze you even tighter and you start having trouble breathing, causing you to pull your head back. The naga looks down at you, begging you to continue until she realizes what she was doing all along. Slowly, she unwraps you, giving you some time to catch your breath before finishing the job.\n\n', false );
	...
	NagaScene.prototype.nagaRapeChoice = function() {
		if( CoC.monster.HP < 1 ) {
			MainView.outputText( 'You\'ve defeated the naga!  ', true );
		} else {
			MainView.outputText( 'The naga writhes in the sand, masturbating feverishly!  She\'s completely forgotten about fighting you.  ', true );
		}
		var eggs = null;
	...
	NagaScene.prototype.nagaPlayerConstrict = function() {
		...
		if( Utils.rand( CoC.player.spe + 40 ) > CoC.monster.spe ) {
			...
			//(Otherwise)
				...
				MainView.outputText( 'You launch yourself at ' + CoC.monster.a + CoC.monster.short + ' and wrap yourself around ' + CoC.monster.pronoun2 + '. You squeeze ' + CoC.monster.pronoun2 + ' tightly and hear ' + CoC.monster.pronoun2 + ' cry out in pain.', false );
			}
	...
	NagaScene.prototype.naggaSqueeze = function() {
		MainView.outputText( '', true );
		//Squeeze -
		MainView.outputText( 'Your coils wrap tighter around your prey, leaving ' + CoC.monster.pronoun2 + ' short of breath. You can feel it in your tail as ' + CoC.monster.pronoun3 + ' struggles are briefly intensified.', false );
		CoC.monster.HP -= CoC.monster.eMaxHP() * (0.10 + Utils.rand( 15 ) / 100);
		//Enemy faints -
		if( CoC.monster.HP < 1 ) {
			MainView.outputText( 'You can feel ' + CoC.monster.a + CoC.monster.short + '\'s life signs beginning to fade, and before you crush all the life from ' + CoC.monster.pronoun2 + ', you let go, dropping ' + CoC.monster.pronoun2 + ' to the floor, unconscious but alive.  In no time, ' + CoC.monster.pronoun3 + '\'s eyelids begin fluttering, and you\'ve no doubt they\'ll regain consciousness soon.  ', false );
			if( CoC.monster.short === 'demons' ) {
	...
	NagaScene.prototype.naggaTease = function() {
		...
		//(Otherwise)
			...
			if( CoC.monster.short === 'demons' ) {
				MainView.outputText( 'As you stimulate one of their brethren, the other demons can\'t help but to feel more aroused by this sight, all wishing to touch and feel the contact of your smooth, scaly body.', false );
			} else if( CoC.monster.short === 'slime' ) {
				MainView.outputText( 'You attempt to stimulate the slime despite its lack of any sex organs. Somehow, it works!', false );
			}
			//Normal cases for other monsters
			else {
				if( CoC.monster.gender === 1 ) {
					MainView.outputText( 'Your nimble tail begins to gently stroke his ' + CoC.monster.cockDescriptShort( 0 ) + ', and you can see it on his face as he tries to hold back the fact that it feels good.', false );
				}
				if( CoC.monster.gender === 2 ) {
					MainView.outputText( 'Your nimble tail manages to work its way between her legs, grinding your tail\'s scaly skin against her clit. She appears to enjoy it, but it is obvious she is trying to hide it from you.', false );
				}
				if( CoC.monster.gender === 3 ) {
					MainView.outputText( 'Your nimble tail manages to work its way between ' + CoC.monster.pronoun3 + ' legs, gaining access to both sets of genitals. As your rough, scaly skin rubs past ' + CoC.monster.pronoun3 + ' clit, your tail gently begins to stroke ' + CoC.monster.pronoun3 + ' cock. The repressed expression on ' + CoC.monster.pronoun3 + ' face betrays ' + CoC.monster.pronoun3 + ' own enjoyment of this kind of treatment.', false );
				}
			}
			//Land the hit!
	...
	NagaScene.prototype.eggUpANagaSpiderLike = function() {
		...
		if( CoC.player.gender > 0 ) {
			...
			MainView.outputText( ' raining down on the prone naga' );
		}
		MainView.outputText( '.  You crumple into a heap on top of your reptilian lover, unconscious before you hit the sand.  Her eyes drift closed as well, as she coils around you, settling in for a well-deserved rest.' );
	...
	NagaScene.prototype.beePositANagaPlease = function() {
		...
		MainView.outputText( ' you relax against her, two bodies twined into one passionate shape.  The naga\'s tail circles one of your [legs] and your abdomen affectionately, and your ovipositor suddenly thickens, stretched a bit wider at the base as your first egg drops into the chute.  The scaly seductress wiggles a little at this, but her sultry gaze leaves no doubt as to her enjoyment of it.  You flex muscles you don\'t truly understand and force another egg in behind the first... and a third... and a fourth.' );
		...
		if( CoC.player.hasCock() ) {
			MainView.outputText( '  [EachCock] erupts to splatter her with white' );
		}
		...
		if( CoC.player.hasVagina() ) {
			MainView.outputText( 'our [vagina] ' );
			if( CoC.player.wetness() < 3 ) {
				MainView.outputText( 'drools' );
			} else if( CoC.player.wetness() < 5 ) {
				MainView.outputText( 'gushes' );
			} else {
				MainView.outputText( 'splatters' );
			}
			MainView.outputText( ' clear femcum over the Naga\'s tight belly' );
			if( CoC.player.hasCock() ) {
				MainView.outputText( ' as well' );
			}
		}
		if( CoC.player.gender > 0 ) {
			MainView.outputText( '.' );
		...
		if( CoC.player.eggs() > 30 ) {
			MainView.outputText( ' from the outside at least.  You stuffed her so full that she looks positively pregnant, bulging to a picture of utter fertility' );
		}
		MainView.outputText( '.  She idly runs her hands across her body, pinching her nipples and gasping in delight.  Your venom is clearly keeping her quite aroused, even with such a powerful orgasm.  After such a workout, you feel like you might have a little bit of venom left, so you give the new ' );
		if( CoC.player.fertilizedEggs() === 0 ) {
			MainView.outputText( 'egg-bearer' );
		} else {
			MainView.outputText( 'mother' );
		}
		MainView.outputText( ' a parting sting.  Her moans of excitement jump an octave, and you listen to them with a happy, almost gloating smile while you get dressed.' );
