...
angular.module( 'cocjs' ).run( function( SceneLib, CoC, Utils, StatusAffects, EngineCore, AppearanceDefs, Descriptors, FetishZealot, Combat ) {
	...
	FetishZealotScene.prototype.zealotLossRape = function() {
		...
		EngineCore.outputText( '"<i>Ok,</i>"  you say nervously, "<i>I can give you a lesson on pleasing ' + CoC.player.mf( 'men', 'women' ) + '.</i>"  He jumps up excitedly and runs around to the other side of the desk saying "<i>Ok, what do I have to do?</i>"  Feeling a bit put on the spot, you stop for a moment to take in the situation.  ', false );
	...
	FetishZealotScene.prototype.zealotWinRape = function() {
		...
		if( CoC.player.cockTotal() > 0 && (CoC.player.gender !== 3 || Utils.rand( 2 ) === 0) ) {
			...
			EngineCore.outputText( 'Your lusts sated for now, you rise up off of him and put your ' + CoC.player.armorName + ' back on.  You decide to leave him lying there, still doubled over in pain from the damage you did to his balls.\n\n', false );
		}
		//If player has a vagina, again, if both, chose one at random
			...
			EngineCore.outputText( 'Your lusts sated for now, you rise up off of him and put your ' + CoC.player.armorName + ' back on.  You decide to leave him lying there, still coughing from the blow to his stomach.  ', false );
