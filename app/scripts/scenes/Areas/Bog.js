...
angular.module( 'cocjs' ).run( function( CoC, Utils, EngineCore, kFLAGS, OnLoadVariables ) {
	function Bog() {
	}
	...
	Bog.prototype.exploreBog = function() {
		...
		if( (CoC.getInstance().scenes.fera.isHalloween() && (OnLoadVariables.date.fullYear > CoC.getInstance().flags[ kFLAGS.TREACLE_MINE_YEAR_DONE ]) && CoC.getInstance().flags[ kFLAGS.BOG_EXPLORED ] % 4 === 0) && (CoC.getInstance().flags[ kFLAGS.PHOUKA_LORE ] > 0) ) {
