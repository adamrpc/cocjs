...
angular.module( 'cocjs' ).run( function( SceneLib, EngineCore, CoC, kFLAGS, Combat, Utils, AppearanceDefs, StatusAffects, Izumi, CockTypesEnum, MainView ) {
	...
	IzumiScene.prototype.enterFirstTime = function() {
		...
		if( CoC.player.tallness >= 108 ) {
			...
			// Low strength variant
				...
				EngineCore.outputText( 'Putting your shoulder to the stone, you push with all your might, trying to roll it out of the way.  It resists, but you are determined, your [feet] scrabbling against loose rocks and gravel, trying to find the purchase you need to move the boulder.\n\n' );
			}
			// Shared
			...
			if( CoC.player.hornType !== AppearanceDefs.HORNS_COW_MINOTAUR ) {
				...
				if( this.actsLikeACow() === true ) {
					EngineCore.outputText( '  Or at least, ones without the temperament to match the... physique, ' );
				}
			}
			EngineCore.outputText( 'if you follow?</i>”\n\n' );
			EngineCore.outputText( 'She turns and heads back into the cave, quickly disappearing into the gloom, the strange woman motioning you to follower her inside with a wave.  You creep slowly into the darkness after her, your sight gradually adapting to the darkness.\n\n' );
		}
		// 'short' variant
		else {
	...
	IzumiScene.prototype.dontSmokeThePipe = function() {
		EngineCore.clearOutput();
		EngineCore.outputText( 'You do your best to politely refuse the pipe, explaining your unwillingness to eat, drink, chew, chug or otherwise consume various items you’ve come across during your travels, having witnessed some of the effects first-hand.\n\n' );
	...
	IzumiScene.prototype.smokeJoins = function() {
		...
		if( CoC.player.tallness < 108 ) {
			...
			EngineCore.outputText( '“<i>You’re pretty impressive, you know?  You’ve even gotten me a little homesick, coming in here looking like that.  How cruel. How cruel....</i>”  She presses a finger to her lips, thoughtfully.  Then she smiles, taking you by the hand and drawing you into the cave. “<i>I know!</i>” She says in a sing-song voice.  “<i>Since you came stomping around here so rudely, it’s only right that I get to discipline you, right?  So, in return for me letting you leave... I get to do whatever I want to you in the meantime.</i>”\n\n' );
		}
	...
	IzumiScene.prototype.surrenderSmallCock = function() {
		...
		EngineCore.outputText( ' a feeling that is only compounded by the burning sense of shame you feel as she jacks you off with a measly two fingers.\n\n' );
	...
	IzumiScene.prototype.surrenderMediumCock = function() {
		...
		if( CoC.player.hasVagina() ) {
			...
			EngineCore.outputText( ' in lust-fueled harmony with your cock.' );
		} else {
			EngineCore.outputText( '.' );
		}
	...
	IzumiScene.prototype.surrenderMediumCockObey = function() {
		...
		EngineCore.outputText( 'ou manage to relax and simply wait passively for Izumi to resume her handjob.\n\n' );
	...
	IzumiScene.prototype.surrenderMediumCockRefuse = function() {
		EngineCore.outputText( 'Sick of Izumi and the strange, uncomfortable feelings the Oni keeps forcing you to experience, you defy her command.  Instead, you thrust more vigorously into the air, turning this way and that, trying to force some form of stimulation from the hand mercilessly gripping your member.\n\n' );
		EngineCore.outputText( '“<i>Fine.</i>”  Izumi says, apparently unconcerned.  “<i>Go ahead and try.  It won’t do you any good.</i>”\n\n' );
		EngineCore.outputText( 'Ignoring her, you continue thrusting, twisting and turning, but always Izumi follows you effortlessly, thwarting every twist and turn you make in a desperate attempt to fuck her hand.  Finally, after an eternity of painful stalemate, you give in, collapsing to the ground, momentarily exhausted.\n\n' );
	...
	IzumiScene.prototype.surrenderOhGodTheFemaleSurrenderContentIsFuckingHugeSendHelp = function() {
		...
		if( CoC.flags[ kFLAGS.IZUMI_TIMES_SUBMITTED ] === 0 ) {
			...
			if( CoC.player.biggestTitSize() >= 15 ) {
				...
				// High(er) corruption
					...
					EngineCore.outputText( 'You smile and nod proudly as Izumi examines your breasts, experiencing a giddy little thrill at the feeling of her soft palms rolling across your endowments.  She bites her bottom lip, glaring intently at you, and you return her gaze with amused indifference.  Although the Oni woman’s palms are surprisingly soft, her treatment of your breasts is not - she practically mauls you, squeezing, groping, even pinching the soft flesh. The rough treatment is deliciously arousing, and you can’t help but let out a few soft moans at being manhandled so forcefully - much to Izumi’s obvious annoyance.\n\n' );
					EngineCore.outputText( '“<i>Let me guess, you intentionally made them grow this big?</i>”  She scowls.  She reaches out and pinches one of your nipples between her thumb and forefinger, causing you to let out another excited little groan.\n\n' );
					EngineCore.outputText( 'You respond with a shrug, teasingly, not entirely wanting Izumi’s abuse to stop.  Izumi’s frown deepens and she tweaks your nipple, twisting it painfully to the side, eliciting another gasp from you.\n\n' );

				}
				EngineCore.outputText( '“<i>How shameless.</i>”  She grumbles, returning her gaze to your bust.  “<i>How utterly shameless....</i>”\n\n' );
			}
		} else {
		...
		// Taur variant
			...
			EngineCore.outputText( 'Izumi shifts herself around to casually lay along the length of your lower body, using  her grip on your wrists to jerk you backward once more, forcing you to arch your back and thrust your [fullchest] out for easier inspection.  You gasp in surprise as you feel her free hand reach around to grope at your breasts, squeezing and massaging them experimentally.  Despite yourself you can’t help but let out a yelp as she squeezes a [nipple] between thumb and forefinger.\n\n' );
			EngineCore.outputText( 'As you squirm under Izumi’s body, it begins to dawn on you that you’re not getting away from this.  Your resistance begins to lessen until eventually you begin to relax, finally admitting to yourself that this really doesn’t feel half bad....\n\n' );
		}
	...
	IzumiScene.prototype.surrenderFemaleNonExhibitionVariant = function() {
		...
		// C-Cup+
			...
			EngineCore.outputText( ' your [legs] to trail ever-so-softly over your nethers, a feather-light touch clearly designed to leave you wanting more.\n\n' );
	...
	IzumiScene.prototype.surrenderFemaleLookitYouTheCenterOfAttentionYouSlut = function() {
		...
		EngineCore.outputText( '-fuck, tears of exertion streaming down your face.  “<i>Tongue his balls, then you get to come up for air,</i>” she commands, and you comply.  A few seconds later, you’re rewarded with the distinct hot, gloopy sensation of the imp blowing his load into your throat - and, much to your lust-addled surprise, a quick shoulder-squeeze from Izumi.  “<i>Sorry if I’m being a little rough, ' + this.heightDesc() + '. Just playing the part, you know?</i>”  She whispers, reassuringly.\n\n' );
		EngineCore.outputText( 'The imp pulls himself free of your mouth, staggering away to the safety of the rocks.  More importantly however, you realize that the ring of spectators has begun to close in, apparently satisfied that they’re no longer confined to just spectating.\n\n' );
		EngineCore.outputText( '“<i>Hope you’re ready for round two.</i>” Izumi mutters.  You can’t help but nod, smiling hungrily as you eye the approaching crowd.\n\n' );
		EngineCore.outputText( 'An hour later, after having licked, sucked, deepthroated and fucked your way through an endless parade of harpies, goblins and imps, the crowd finally disperses.  Of course by that point, you’re barely aware of it, having lost track of pretty much everything aside from the ‘client’ currently employing your services some time ago in a haze of wanton sluttery.  Izumi swims blearily into focus, shaking her head in amusement.\n\n' );
	...
	IzumiScene.prototype.lossSceneLeave = function() {
		EngineCore.clearOutput();
		EngineCore.outputText( 'You rise and make your excuses, and to her credit Izumi takes your refusal in stride; already seeming to have cheered up a little after her earlier outburst.  As you exit the cave, she raises a hand in farewell.\n\n' );
		EngineCore.outputText( '“<i>Feel free to come back if you want me to clean your clock again, yeah?</i>”  She calls after you with a grin.  You shake your head ruefully as you make your way down the mountain and back to your camp.  Overall, that could have gone better, but it could have gone a lot worse, too.\n\n' );
		EngineCore.menu();
	...
	IzumiScene.prototype.deathBySnuSnuIMeanGiantOniTits = function() {
		...
		EngineCore.outputText( 'The two of you remain there in this strange half-standing, half-fucking position for what feels like the best part of an hour as you grind and groan, suckle and slurp.  If just rubbing away at her from the outside feels this good, how much better must it feel to actually feel [oneCock] inside her, part of you wonders... and then another quieter, darker part of you wonders if it wouldn’t be so much hotter if you never found out.\n\n' );
	...
	IzumiScene.prototype.fuckhugeOniWantsYourBabiesOrSomeShit = function() {
		...
		EngineCore.outputText( ' into her twitching pussy.\n\n' );
	...
	IzumiScene.prototype.noDickNoVagNoService = function() {
		...
		EngineCore.outputText( '.\n\n' );
		EngineCore.outputText( '“<i>Well, ' + this.heightDesc() + ', you really are weird... no dick </i>or<i> pussy.  I, err...</i>”  She says, the confusion caused your evident lack of equipment spreading across her face.  “<i>I gotta say, I’m fresh out of ideas over here.</i>”\n\n' );
		EngineCore.outputText( 'She gently lowers you toward the floor, and releases her grip on your ankles.  “I-I guess you can go, yeah?” She says, motioning toward the entrance to her cave.  Paying you no mind, she heads off toward her tent, clearly no longer interested in you.\n\n' );
		Combat.cleanupAfterCombat();
	};
	...
	IzumiScene.prototype.touchThatFluffyHorn = function() {
		...
		if( CoC.flags[ kFLAGS.SILLY_MODE_ENABLE_FLAG ] === true ) {
			...
			EngineCore.outputText( 'You dart forwards, hoping to catch Izumi off-guard while she’s still distracted, but as soon as you get close those crazed, staring eyes lock onto yours – and before you can react, her arm lunges out in an uppercutting grab, her fist latching around your throat and wrenching you from the floor.  You lash out, swinging at Izumi’s face, but you can’t concentrate while being held off the floor by your neck!  In desperation, you make a grab for the one thing you can think of to try steadying yourself to brace for a strike – the bright red curve of Izumi’s horn.  As soon as your fingers wrap around it, however, Izumi’s brutal, victorious expression changes.\n\n' );
			EngineCore.outputText( 'Specifically, it gets a whole lot redder.\n\n' );
			EngineCore.outputText( 'Izumi blinks, once, twice, as the hair-raising aura dissipates almost immediately.\n\n' );
			EngineCore.outputText( '“Um,” she says, surprisingly quietly given her formerly berserk appearance.  “C-Could you please let go of that?” she asks, slowly sinking to her knees.  Your feet touch solid ground again, Izumi’s hand still wrapped limply around your neck, apparently forgotten.\n\n' );
			EngineCore.outputText( '“<i>Really.  Um.  Please let go.</i>”  She says, swallowing hard and staring at nothing.  Given her sudden change of attitude, you can’t help but wonder if your grip on the horn is somehow responsible.  After all, maybe you’ve seized on the source of all her magical strength, or something?  You have no idea, so you decide to simply ask.  “<i>No.  Um.  No... It’s just, um.  T-That isn’t something you should touch.  So, y-you’ll let go now, right?</i>”  Izumi stammers.  You stare at her, fascinated by her complete change of personality; gone is the confident, domineering Oni you originally met.  Instead, Izumi, kneels nervously before you, staring intently into space and trying her level best not to move.  Interesting....\n\n' );
			EngineCore.outputText( 'Experimentally, you roll your thumb over the rocky surface of the horn.  Instantly, Izumi <i>visibly</i> flinches, her eyes widening in surprise and shock.  “<i>Hey,</i>” she says, simply, her voice wavering.  “<i>Hey,</i>” she repeats. “<i>Come on now.  Enough is enough, right?</i>”\n\n' );
		}
		// Super awesome Gedan edit mode!
			...
			// I assume LustMax is always presumed to be 100?
			{
				...
				EngineCore.outputText( '[teaseText]' );
				EngineCore.outputText( 'Izumi pays your attempts to distract her no mind, focused entirely on her strange ritual. You slink forwards, hoping that something a little more... hands on might do the trick. But ' );
			} else {
			...
			if( CoC.player.spe >= 90 ) {
				...
				EngineCore.outputText( 'trying to force her gaze toward your ‘assets.’\n\n' );
			} else {
				EngineCore.outputText( 'You lash out, swinging at Izumi’s face, but you can’t concentrate while being held off the floor by your neck!  In desperation, you make a grab for the one thing you can think of to try steadying yourself to brace for a strike - the bright red curve of Izumi’s horn.\n\n' );
			}
			...
			if( CoC.player.spe < 90 || CoC.player.str < 90 ) {
				...
				EngineCore.outputText( '“<i>C-Could you please let go of that?</i>”' );
			}
			EngineCore.outputText( ' she says, swallowing hard and staring at nothing.  Given her sudden change of attitude, you can’t help but wonder if your grip on the horn is somehow responsible.  “<i>T-That isn’t something you should touch.  So, y-you’ll let go now, right?</i>”  Izumi stammers.  You stare at her, fascinated by her complete change of personality; gone is the confident, domineering Oni you originally met.  Instead, Izumi, kneels nervously before you, staring intently into space and trying her level best not to move.\n\n' );
			EngineCore.outputText( 'Experimentally, you roll your thumb over the rocky surface of the horn.  Instantly, Izumi <i>visibly</i> flinches, her eyes widening in surprise and shock.  “<i>Hey,</i>” She says, simply, her voice wavering. “<i>Hey,</i>” She repeats. “<i>Come on now. Enough is enough, right?</i>”\n\n' );
		}
	...
	IzumiScene.prototype.letGoAndFuck = function() {
		...
		EngineCore.outputText( '.\n\n' );
		EngineCore.outputText( 'Your roving hands locate one already hardening nipple and bring it up to your mouth. Izumi lets out a hiss as you latch onto her breast, sucking and licking away at the stiffening flesh with abandon.\n\n' );
		EngineCore.outputText( '“<i>Hey,</i>” she groans quietly.  “<i>I’ve got two, you know?</i>”  She pulls her kimono aside, a blush beginning to spread across the broad plain of her features as she awkwardly presents her other breast to you. You can’t help but smirk a little as you change position slightly to suckle and grope at the new arrival instead, much to Izumi’s clear enjoyment.\n\n' );
		EngineCore.outputText( 'Suddenly painfully aware of the rising sensation in your crotch, you detach yourself from Izumi’s boobs in order to undo the rest of her kimono, pulling it aside to hang there limply as you inspect Izumi’s body.  You lean back into her, planting a kiss on her stomach - clearly not what Izumi expected as, somewhat cutely, she actually flinches at the sensation - before gliding a hand down between her legs.  To your surprise, she’s actually already wet; although you do find yourself wondering if it’s from your expert manipulation or the fight beforehand....\n\n' );
		EngineCore.outputText( '“<i>Hey, hold it a sec,</i>”  Izumi pipes up suddenly.  “<i>Let’s try it like this, since I don’t really wanna do it standing up...</i>”  She detaches from you, backing away in order to take a seat with her back resting against one of the cave walls.  Satisfied that her new position is comfortable, she turns to you, locking you with a gaze that can only be described as ‘come hither’.  Spreading her legs shamelessly wide, she displays herself to you alluringly, beckoning with one finger.\n\n' );
		EngineCore.outputText( '“<i>Well?  Come on already,</i>” she says, smirking lasciviously.  “<i>You wanted to do me, right? Well then, you’d better hurry up and get started before I get embarrassed...</i>”\n\n' );
	...
	IzumiScene.prototype.gonnaGetMeSomeRevengeButtsexin = function() {
		...
		if( CoC.player.biggestCockLength() <= 4 ) {
			...
			EngineCore.outputText( '<i>Smack!</i>  Izumi’s head jerks around, her expression thunderous, as the open palm slap hammers home onto her rump.\n\n' );
			EngineCore.outputText( '“<i>What the </i>hell<i> do you think you’re doing, kid?!</i>”  She bellows.  You grin happily at her, glad you’ve finally gotten her attention.\n\n' );
			EngineCore.outputText( '“<i>Tell me how big it is.</i>”  You command.\n\n' );
			EngineCore.outputText( '“<i>Wha-</i>”  Izumi opens her mouth to object, but is cut off by another blistering slap to the rump.  She winces in pain, then roars in outrage.  “<i>Why, you little piece of-</i>”  Another slap hammers home, cutting her off again.  “<i>Fine! Fine, I’ll- Fine.</i>”  She repeats, apparently more to calm herself down than to reassure you.  There’s a long, awkward pause as she glares off into the gloom of the cave.  You raise your hand again, threateningly, and she grimaces before finally responding.\n\n' );
			EngineCore.outputText( '“<i>It’s big,</i>” she spits.\n\n' );
			EngineCore.outputText( '“<i>How big?</i>” you ask, feeling pleased with yourself.\n\n' );
			EngineCore.outputText( '“<i>Fuck, I don’t-</i>”  You raise an eyebrow, your hand still raised threateningly above her reddening rump.  She glares at it for a moment.  “<i>Fine. I get it, already. It’s.. Really big, okay?  Huge.  Massive.</i>”  She growls.\n\n' );
			EngineCore.outputText( '“<i>Keep going.</i>”  You say, lowering your hand to caress her cheeks as you begin to thrust once again.\n\n' );
	...
	IzumiScene.prototype.tentacruelRevengeFux = function() {
		EngineCore.clearOutput();
		EngineCore.outputText( 'You release your grip on Izumi’s horn, but only to reach down to remove your [armor].  As you open your clothing and unveil yourself, your [multicockdescriptlight] arch themselves like some kind of deadly snakes preparing to strike.  Izumi slips backwards in surprise, falling onto her rump.\n\n' );
		EngineCore.outputText( '“<i>H-Hey,</i>” She stammers, staring at your writhing crotch in a mixture of revulsion and fascination.  “<i>W-Why didn’t you leave some dicks for the rest of the class?!  Uh..</i>” If that was an attempt to distract you, it was sadly pointless.  Izumi yelps in what seems like actual fright as your tentacles surge forwards, snatching at her arms and legs, plunging down her neckline and <i>pulling</i>, causing her kimono to slip open and freeing her bountiful bust. \n\n' );
		EngineCore.outputText( '“<i>You’re weird!  You’re really weird!</i>” She yells, a note of panic entering her voice as she strains against your rampaging organs.  For a moment, you’re a bit worried she might actually break free of the tentacles wrapping her up - which would be, at the very least, <i>extremely painful</i> - but then you deploy your coup de grace maneuver. One of your prehensile tentacle-dicks slithers up Izumi’s grimacing face, rears back, then wraps itself completely around her horn in one seamless motion.\n\n' );
		EngineCore.outputText( 'Izumi stiffens instantly, her eyes going wide and staring into nothing as she lets out a quiet, strangled squeak.  You can’t help but leer a little at the sight of the enormous woman, muscles quivering, completely at the mercy of your tender, tentacled ministrations.  You resolve to take your time a little and enjoy the sensation, as apparently so long as you keep your grip on Izumi’s horn, you have what can only be described as a captive audience.  And <i>speaking of</i> that horn....\n\n' );
		EngineCore.outputText( 'Izumi’s eyes roll back into their sockets and she grits her teeth, grunting as your prehensile member flexes, tightening and loosening rhythmically around her horn.  It’s amazing, you think, how quickly Izumi’s attitude changed once you grabbed it.  The confident, domineering woman is completely gone, and instead she shivers nervously in your grip like a virgin on her wedding night.  Apparently, it’s an incredibly sensitive organ, a suspicion that is confirmed when you slowly begin to roll the tentacle wrapped around the horn up and down its length, causing Izumi to immediately let out a startled “Ah!” and flinch again at the sensation, straining against her bonds.\n\n' );
		EngineCore.outputText( 'With a quick lurch, you pull Izumi’s legs up and apart, exposing her crotch and the vast expanse of her thighs to boot.  She wears no underwear, but frankly you’d probably be more surprised if she did.  She pants and grunts before you, the sweat from her body gleaming in the firelight with her unfastened kimono hanging dangerously from her breasts.  You lean in between her thighs as though to inspect her, causing her to suddenly flush crimson.  Or perhaps that was the sensation of another of your tentacled appendages slipping under the silky folds of her kimono to repeatedly flick at her nipple, already hardened by your treatment of her horn?  You may never know.\n\n' );
		EngineCore.outputText( '“<i>H-Hey!</i>”  Izumi suddenly pipes up, her voice filled with forced joviality.  She winces as you look up, the motion causing the tentacle wrapped around her horn to squirm and twist. “<i>I-I’ve got a great idea!  How about we call this one a draw?</i>”  You stare at her in disbelief, so she continues.  “<i>You did p-pretty damn good, so- Ah!  Uh, so how’s about you and me forget all about this and we just go make out in my tent?  H-How’s that sound?  I’ll even let you be on top!  How about it?!</i>”  There’s a distinct note of desperation in her voice by this point....\n\n' );
		EngineCore.outputText( 'You have to admit though, the idea of fucking Izumi does have a certain appeal right now...  so you decide to do it.  Izumi’s eyes widen in realization as you flex your remaining appendages threateningly in preparation for the festivities, and she opens her mouth to object - something you put a stop to almost immediately.  She briefly goes slightly cross-eyed as you ram one of your plethora of cocks into her mouth, scowling in outrage at the oral invader.  For a moment you think she’s going to bite, but a swift squeeze from the tentacle still holding fast to her horn soon quells any thoughts of rebellion.\n\n' );
	...
	IzumiScene.prototype.sayThatsAPrettyFaceBeAShameIfSomebodyJizzedAllOverIt = function() {
		EngineCore.clearOutput();
		EngineCore.outputText( 'An evil idea begins to form inside your head.  You give Izumi’s horn a quick yank, causing her to yelp out loud, flinching massively.\n\n' );
		EngineCore.outputText( 'You direct her to kneel down with a growl.  Izumi opens her mouth to argue, then thinks better of it.  “<i>Okay! Okay, look, I’m cooperating.  Ha ha, you sure showed me, boy is my face re-Oh.</i>” She stops, eyes widening a little as you use your free hand to pull out [oneCock], stroking it towards hardness mere inches from her face.  She stares, mesmerized, as your hand rolls up and down your stiffening erection right in front of her.  \n\n' );
		...
		EngineCore.outputText( '“<i>Suck it!</i>” you command, as Izumi stares up at you with a pleading expression, tears beginning to form in the corners of her eyes due to lack of oxygen - or possibly just the rough treatment of her hyper-sensitive horn.  She lets out another whimper as you squeeze it, showing her what happens when she’s too slow, then she finally begins to work you over in earnest.\n\n' );
		EngineCore.outputText( 'Her mouth latches onto you like a vacuum, sucking on your [cockHead biggest] so strongly it makes your knees weak, her tongue performing bizarre oral gymnastics around your cock.  You can only grunt in surprised appreciation; whatever else you might think about her, Izumi is <i>good</i> at this.  Or maybe she’s just desperate, trying to force you to cum as quickly as possible so that you’ll release her precious horn?  That seems distinctly possible, so you decide to take steps to counter it.\n\n' );
		EngineCore.outputText( 'Yanking forwards on Izumi’s horn again, you pull her bodily down your length until you’re buried to the [sheath], swallowed up completely into Izumi’s tingling-hot mouth, her nose pressed up against your stomach.  She lets out another strangled, slightly frustrated cry, staring up at you in confusion.\n\n' );
		EngineCore.outputText( 'You order her to stop, and you can see the confusion bloom in her eyes.\n\n' );
		EngineCore.outputText( 'Izumi’s oral assault on your cock falters, awaiting your next move.  You simply stand there for a while, enjoying the feeling of having the brash Oni woman completely at your mercy...  and of course, forcing her to think about her situation as well.  How helpless she is, the thick meat filling her throat, her nose pressed deep in against you, every breath filling her lungs with your thick scent.  Idly, you begin to roll her head this way and that, using the poor Oni’s horn as a sort of joystick as you tilt her unresisting head to look at one side, then the other.\n\n' );
	...
	IzumiScene.prototype.tribThatRockyHornGirl = function() {
		...
		EngineCore.outputText( ' your attention to her horn.  Still though, there’s something missing; as fun as it is molesting and toying with the oversized lout currently protesting her innocence while buried up to the knuckle in her own cunt, you’re not quite feeling it enough to get off yourself.  Clearly, that has to change.\n\n' );
		EngineCore.outputText( 'Experimentally, you shift position, leaning back to expose more of your crotch to the wonderful warm, bumpy sensations running through it, supporting your weight with one arm wrapped around the long-suffering Oni’s horn.  That’s <i>much</i> better you think, as you rock bodily back and forth, running yourself across the entire rugged length of the curved protrusion, biting your lip as an errant crag scrapes deliciously across your [clit]. The act sends a searing shiver down your spine, along with a growing, scandalous desire to revisit the sensation.  \n\n' );
		EngineCore.outputText( 'With increasing urgency, you frig yourself in earnest on Izumi’s horn, her muted sounds of protest rising in pitch and desperation along with the power of your strokes.  You sense her hips rising behind you as she begins to lose her inhibitions once again in the face of your unflinching assault, slapping away shamelessly at her pussy - which, by the sounds of it, must be absolutely dripping wet by now - two enormous fingers ramming themselves repeatedly home with brutal force.\n\n' );
		EngineCore.outputText( 'The thought of the once proud Oni now being reduced to such desperate and wanton masturbation by the idea of being made into your toy makes you want to laugh again, but more than that, it’s somehow incredibly arousing.  You’re not sure which you’d prefer more; to find out that she has a hidden submissive streak and that she’s totally into this kind of thing... or that she <i>isn’t.</i>\n\n' );
		EngineCore.outputText( 'Regardless, any further experimentation will have to wait, as before you know it your orgasm is upon you.  Clutching at Izumi’s horn, you ram yourself home one final time, almost as though punishing your wanton pussy by slamming it against the hard surface.  Beneath you, Izumi bucks and jerks, letting out a high and surprisingly girlish wail as you orgasm around her horn, your juices splattering down to cover her face, her horn, your increasingly numb-feeling hand....\n\n' );
		EngineCore.outputText( 'With a final thump, Izumi’s hips drop back down to the ground, her arms flopping uselessly to her side.  After a moment or two of mutual, panting recover, you unsteadily step off of her and scratch at your head, as the aftermath of your orgasm begins to subside.  For her part, Izumi lays flat on her back, unmoving, her eyes glassy and unfocused, breathing as though she had just run a marathon.  Between her legs, you can dimly make out an unmistakable damp streak, glistening across the cave floor in the darkness.  You smirk at the sight, deciding to add one final little insult to the proceedings.\n\n' );
		EngineCore.outputText( '“<i>You came, didn’t you?</i>” You ask, sweetly.  Izumi trembles a little, her eyes rolling over to you.  She seems to be having trouble focusing.\n\n' );
