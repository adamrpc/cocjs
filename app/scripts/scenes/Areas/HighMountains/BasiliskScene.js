...
angular.module( 'cocjs' ).run( function( SceneLib, EngineCore, CoC, kFLAGS, Basilisk, Combat, Descriptors, StatusAffects, PerkLib, PregnancyStore, Utils, AppearanceDefs, MainView ) {
	...
	BasiliskScene.prototype.defeatBasiliskAndAnal = function() {
		...
		if( CoC.player.hasCock() ) {
			...
			if( CoC.player.cocks[ x ].cockLength <= 13 ) {
				...
				EngineCore.outputText( 'gripping its hips and pushing as much of your huge, bulging cock into it as you can, its stomach bulging as you reach a glorious, skin tingling peak.', false );
			}
	...
	BasiliskScene.prototype.basiliskAdvantageHarpy = function() {
		...
		//Genderless:
			...
			EngineCore.outputText( 'You feel something build at the back of your mind.  Involuntary sensations prickle your skin as, once again, the intermittent mental backwash that the basilisk\'s hypnosis has forced upon your mind hits you.  Memory after memory of sexually-charged encounters, daydreams or fantasies crowd your consciousness.  It is made worse, much worse by the pheromones the harpy has pushed into your mouth; your body rides the chemical glow at the same time as imaginings of soft skin, tight muscle and musk overload your senses.  The denial the petrification has forced upon you is becoming unbearable.\n\n', false );
			...
			EngineCore.outputText( 'The harpy manages to cum twice on your hand, gobbling with excitement as she spatters your arm with her juices.  During this time you are forced to ride the potent cocktail of hypnotic sexual compulsion and the harpy\'s golden lipstick again and again, until you feel you would have collapsed in a pool of steaming sex long ago if your knees would only allow it.  Once she is finished with you the harpy clambers down, taking care to wipe her leaking twat on your naked front as she does so, before flapping off with a winsome smirk, entirely ignoring your own plight.\n\n', false );
			EngineCore.outputText( 'After another ten or twenty minutes of being forced to stand still and savor your own shameful memories, you find with great relief you can begin to move your fingers again.  Eventually with some effort you manage to work power into each corner of your body and finally shake free of the basilisk\'s curse; quickly, you redress before anything else finds you and, still reeking of harpy sex, you begin to make your way back down the mountain.  You think woozily that maybe you should consider yourself lucky that nothing actually fucked you whilst you were in your helpless state, but your body thinks the exact opposite, and you really, really need to get back to camp and sort yourself out.', false );
			EngineCore.dynStats( 'lus=', 100 );
		}
	};
	...
	BasiliskScene.prototype.basiliskAdvantageGoblin = function() {
		...
		if( CoC.player.hasCock() ) {
			...
			if( CoC.player.cockArea( x ) >= 60 ) {
				...
				EngineCore.outputText( 'Her wet warmth swallows more and more of your member until, with a satisfied sigh, her plump thighs bump into your crotch.  With your sensitised cock you can feel every inch of her, and when she starts to slide up and down the sucking, kneading sensation is unbearable.', false );
			}
		...
		//Unsexed:
			...
			if( CoC.player.analCapacity() < 60 ) {
				...
				EngineCore.outputText( '  Your well-worn ass is a perfect fit for the giant cock and accepts it eagerly, every bit as welcoming as a moist vagina.  As the minotaur rubs against your tender inner walls he grunts and beads more of his drugged pre-cum, turning your hole into a helplessly wet, clenching ass cunt.', false );
			}
	...
	BasiliskScene.prototype.driderPCEggLaysBasilisk = function() {
		...
		EngineCore.outputText( ', the basilisk is still striving to meet your eyes with its own.  Clenching your teeth, you avert your eyes and stomp forward blindly, colliding roughly with the spined lizard, knocking him flat on his back on the rocky ground.' );
		...
		if( EngineCore.silly() ) {
			EngineCore.outputText( 'Pinning him between a rock and a hardening place, ' );
		}
