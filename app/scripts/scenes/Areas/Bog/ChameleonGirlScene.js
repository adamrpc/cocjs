...
angular.module( 'cocjs' ).run( function( MainView, SceneLib, CoC, kFLAGS, Utils, EngineCore, ChameleonGirl, Descriptors, ConsumableLib ) {
	...
	ChameleonGirlScene.prototype.loseToChameleonGirl = function() {
		...
		//Lose by HP
			...
			MainView.outputText( 'Too weak to keep fighting, you stagger back and fall to your knees.' );
		}
	...
	ChameleonGirlScene.prototype.loseToChameleonWithCockAnBallsAnCunt = function() {
		...
		if( CoC.player.cockArea( x ) < 40 ) {
			MainView.outputText( ' and occasionally lifting it to take the shaft between two dexterous toes and work it more delicately' );
		}
		MainView.outputText( '.  She blushes as she watches your breaths turn to pants from the pleasure.' );
	...
	ChameleonGirlScene.prototype.dudesLoseToChamChams = function() {
		...
		if( CoC.player.lust > 99 ) {
			...
			MainView.outputText( 'battered' );
		}
		MainView.outputText( ' to even rip the makeshift binding.' );
		...
		if( CoC.player.cumQ() > 500 ) {
			MainView.outputText( ', filling her with so much cum that it leaks out of her and drips to the water below' );
		}
		MainView.outputText( '.  The chameleon girl\'s pace slows once again, and both of your breaths come in deeply as you each recover from orgasm.  She sucks her hanging tongue most of the way back into her mouth, grimacing as she wipes some mud from it.' );
	...
	ChameleonGirlScene.prototype.defeatChameleonGirl = function() {
		...
		if( CoC.monster.lust > 99 ) {
			...
			if( CoC.player.lust >= 33 ) {
				MainView.outputText( '  Do you help the horny girl to get you both off?  Or maybe you could punish her bad attitude with something from your bag...' );
			}
		}
		//-Win by HP
		else {
			MainView.outputText( 'Too weak to continue fighting, the chameleon girl drops to her knees, exhausted.  Her skin returns to its usual ' + CoC.monster.skinTone + ', unable to maintain the camouflage.' );
			if( CoC.player.lust >= 33 ) {
				MainView.outputText( '  Do you use the girl in her weakened state to get yourself off?  Or maybe you could punish her bad attitude with an item from your bags...' );
			}
		}
	...
	ChameleonGirlScene.prototype.fuckDatChameleonAsACoolGuyGirlHerm = function() {
		...
		if( CoC.player.cor < 50 ) {
			MainView.outputText( 'and guiltily ' );
		}
	...
	ChameleonGirlScene.prototype.manFucksChameleonWithBiggishWang = function() {
		...
		if( CoC.monster.lust > 99 ) {
			MainView.outputText( 'her masturbating even more furiously than before at the thought of having your cock.' );
		}
		...
		if( CoC.player.balls > 0 ) {
			MainView.outputText( 'your ' + Descriptors.ballsDescriptLight() + ' clench and ' );
		}
		MainView.outputText( 'the semen erupts from the end of your ' + Descriptors.cockDescript( x ) + ' spilling out hot spunk over her folded tongue.  She gasps audibly and arches her back as the thick ropes of your jizz coat her tongue, shoving her long fingers as far as she possibly can into her dripping pussy, and flashes so brightly pink she nearly glows.' );
		if( CoC.player.cumQ() > 750 ) {
			MainView.outputText( '  The torrent of cum bursting from your cock just doesn\'t stop, and her eyes roll back into her head as your semen coats her face and runs off her tongue, drenching her breasts and belly in white.  Her head falls back and her tongue goes limp as she\'s sent into ecstasy by the flood.' );
		}
		...
		if( CoC.player.cumQ() > 750 ) {
			MainView.outputText( '  Even the murky water around her is turned white as the pools of your cum on her body run off into it.' );
		}
	...
	ChameleonGirlScene.prototype.femaleHasWinSexWithChamCham = function() {
		...
		MainView.outputText( '.  You look her up and down, following the smooth curves of her thin body with your eyes.  Squatting down beside her, you take her weak body by the shoulders in one arm and trail your fingertips lightly up her torso with the other, feeling the soft skin of her belly.' );
		if( CoC.monster.lust > 99 ) {
			MainView.outputText( '  She coos lustily at the sensation.' );
		} else {
			MainView.outputText( '  Her eyes widen, and she looks from your hand to your face and back again.' );
		}
		MainView.outputText( '  When your hand reaches the silk cloth covering her chest, you pull it off with a light tug and cast it off to the side.  You cup her small breast in your palm, and as you squeeze it her skin tone changes perceptibly, flashing to a much brighter shade of the colors it was.' );
		MainView.outputText( '\n\nCurious, you take her nipple between your index finger and thumb, pinching and twisting and pulling on it, eliciting a series of sharp gasps and squeals.  She arches her back into your supporting arm and her skin flashes wildly, long stripes of color shifting across her body with your every tweak.  You find her complete inability to hide what she\'s feeling amusing, but you\'re much too turned on to just sit there and play with her.  Releasing her breast, you take her arm and guide her hand to your own slick cunt.  She gets the idea and begins to work her fingers lightly in and out of your wet folds.  You squeeze her close and breathe in deep, enjoying the sensation of her long fingers plunging in and out of your ' + Descriptors.vaginaDescript( 0 ) + '.  It feels so good to have her touching you, and as you bask in the pleasure you lose your balance.  The two of you topple over backwards, landing in the shallow water with a splash.  Unsure what to do, the chameleon girl freezes up and looks almost apologetically into your eyes.  You laugh quietly at her confusion and guide her fingers back into motion with your hand.' );
		MainView.outputText( '\n\nNot ' );
		if( CoC.player.cor < 50 ) {
			MainView.outputText( 'one to be selfish' );
		...
		if( CoC.player.cor < 50 ) {
			MainView.outputText( 'and somewhat guiltily ' );
		}
	...
	ChameleonGirlScene.prototype.giveTheChameleonASuccubiMilk = function() {
		...
		if( CoC.player.hasLongTail() > 0 ) {
			MainView.outputText( ' with your tail,' );
		} else {
			MainView.outputText( ' by straddling her,' );
		}
		MainView.outputText( ' your cock aimed for her pillowy tits.  She pushes and squirms beneath you, but cannot get enough leverage to move you.  You take her breasts in your hands and shimmy up her torso towards them, squeezing them around your ' + Descriptors.cockDescript( x ) + '.' );
