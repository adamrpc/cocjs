...
angular.module( 'cocjs' ).run( function( SceneLib, $log, kFLAGS, ConsumableLib, CoC, Utils, StatusAffects, EngineCore, AppearanceDefs, CockTypesEnum, PerkLib ) {
		...
		if( !waited ) {
			...
			if( CoC.player.cor >= 40 ) {
				if( CoC.player.hasCock() && !CoC.player.hasVagina() ) {
					...
					EngineCore.outputText( '  Your asshole twitches in response, aching to be filled.' );
				}
			}
			EngineCore.outputText( '\n\n' );
		}
		EngineCore.outputText( 'But before the dogs move, the curtain of fog parts, and a figure on horseback rides into view.  The hounds go silent, as the tall figure pulls back his hood to look at you.\n\n' );
		EngineCore.outputText( 'He is tall, easily seven feet, and made more imposing by the massive, golden antlers arching upward from either side of his head.  He is clearly not human, and more closely resembles a black stag, sitting upright, watching you with the same piercing red eyes as the hounds.  His short, black fur rustles in a wind that is not there, his ears twitching in time to the beating of your heart.\n\n' );
		EngineCore.outputText( 'Most of his body is covered with fine clothing.  A cloak of dark green, decorated with complex patterns of gold, drapes over a hunting outfit of black leather.  One arm holds the reins of his mount, but the other, wearing a heavy leather hunting glove, grips a thick cane of shiny, black wood.  His legs taper down into slim, graceful hooves, and they touch down silently on the mossy ground as he dismounts.\n\n' );
		EngineCore.outputText( '“<i>I am the Erlking, Master of the Wild Hunt,</i>” he says in a deep, hollow voice. “<i>and you... you are a very unusual [race].  My hounds can scent it on you.</i>” He gestures toward the stock-still hounds surrounding you. \n\n' );
		EngineCore.outputText( 'His gaze runs up and down your form, and despite yourself, you shiver at his attention.\n\n' );
		if( waited ) {
			//[If Stand Your Ground Selected]
			EngineCore.outputText( '“<i>You’re a brave one, aren’t you?  Standing your ground in the face of the Wild Hunt?  I applaud your audacity.  I’m going to enjoy hunting you....</i>”\n\n' );
		} else {
			//[If Run Selected]
			EngineCore.outputText( '“<i>I’m afraid you’re going to have to learn to run faster if you hope to elude me in the future.  I do hope you won’t bore me.</i>”\n\n' );
		}
		EngineCore.outputText( 'Before you can say another word, the fog closes in, leaving nothing but the red glow from the eyes of the Erlking and his Hounds.  One by one, they vanish, the Erlking’s last, leaving you alone in the darkness, the mist, and the cold.\n\n' );
	...
	ErlKingScene.prototype.repeatWildHuntEscaped = function() {
		...
		EngineCore.outputText( 'It looks like you’re in the clear... for now.\n\n' );
		EngineCore.fatigue( 10 );
		if( Utils.rand( 5 ) === 0 ) {
			if( Utils.rand( 2 ) === 0 ) {
	...
	ErlKingScene.prototype.repeatWildHuntCaught = function( pScore ) {
		...
		EngineCore.outputText( 'You run through the woods, heart pounding so hard you feel it might leap out of your throat.  Despite your best efforts, though, the fog still closes in.  With it comes the sound of the hounds, running alongside you, hidden in the thick haze. \n\n' );
		EngineCore.outputText( 'With the Hounds on your right, you juke left, nearly running into a tree, but stumble past it, only to hear the Hounds again on your left.  You turn right, still running, unable to shake the feeling that you’re being driven, but too panicked to figure a way out. \n\n' );
	...
	ErlKingScene.prototype.repeatWildHuntGivenToTheHounds = function() {
		EngineCore.outputText( '“<i>How disappointing,</i>” drips the refined voice of the Erlking.  His horse’s hooves thud softly on the ground as he walks below you.  The cane at his side clicks against the forest floor with every other step.  You have just enough wherewithal to understand his words as your fingers grip the net.\n\n' );
		EngineCore.outputText( '“<i>This was but a few minutes’ diversion.  I had been hoping for more of a challenge,</i>” he says, the red glow in his eyes dimming.  “<i>You’re not particularly good at this, are you?</i>” he says, sighing.  His long face looks almost wistful.\n\n' );
		EngineCore.outputText( '“<i>Perhaps next time,</i>” he sighs.  He turns, his dark cloak flaring.  Is it your imagination or do his golden antlers seem a bit more dull?\n\n' );
		EngineCore.outputText( 'You allow yourself a brief moment of relief as he turns his attention from you.\n\n' );
		EngineCore.outputText( '“<i>But it would be wrong to not reward my Hounds for a job well done.</i>”  His cane flashes with golden light as he slashes it against the support rope.\n\n' );
	...
	ErlKingScene.prototype.repeatWildHuntAWinnerIsYou = function() {
		...
		EngineCore.outputText( '“<i>A spirited chase,</i>” he says, his black-gloved hands still chipping a sharp staccato through the cold air.  “<i>I have not had such fun in ages.</i>” The clearing is awash with a dim glow - it seems the Erlking’s golden antlers are lit with their own inner fire.\n\n' );
		EngineCore.outputText( '“<i>And so, my hind, my prey, you have a choice,</i>” he says, his refined tones ringing through the air.  Through the net you can see the fog receding from the forest floor.  You take a few experimental breaths, and feel your head begin to clear.  \n\n' );
		EngineCore.outputText( 'He grasps the rope holding you up, and with strength surprising for his slim frame, lowers you down to the forest floor.  “<i>You have my thanks for a grand hunt,</i>” he says as, hand-over-hand, you are returned to the ground.	\n\n' );
		EngineCore.outputText( 'As you touch down on the moss, the net falls away from you, and the Erlking offers you a hand up.  “<i>I’d like to offer you something.</i>”\n\n' );
		EngineCore.outputText( 'You look up to see the slim, elegant form of the Erlking looking down at you.  Under his hunting gear, you can see the outline of a thick, equine cock, complete with triple prepuce rings straining against the black leathers.\n\n' );
		EngineCore.outputText( 'A reward for all this trouble would definitely be welcome, and as much as you would appreciate a gift, you’d even welcome the opportunity to unwind after the exertion of the hunt.  \n\n' );
		EngineCore.outputText( 'You pause for a moment to consider his words and realize he might be offering you more. If you’re feeling brave, you could ask for him to stop the hunt once and for all.  Or, if the hunt has finally broken your will, you might just submit to the huntsman forever.\n\n' );
		EngineCore.outputText( 'Even with so many of these thoughts crowding your mind, there’s still a tiny spark of resentment burning.  You could rush him and turn the tables on this cocky asshole.\n\n' );
	...
	ErlKingScene.prototype.stopTheMadness = function() {
		...
		EngineCore.outputText( '“<i>Stop?</i>” he asks, the red light in his eyes dimming.\n\n' );
		EngineCore.outputText( 'Narrowing your eyes, you begin to tell him exactly how fed up you are with this never-ending hunt.\n\n' );
	...
	ErlKingScene.prototype.surrenderToTheHounds = function() {
		...
		EngineCore.outputText( 'You whimper and groan in absolute bliss, and begin bucking without meaning to.  You want to stay still and submissive for the Master, but your body has other ideas.  You whine, wriggling and writhing against the Master’s hand.  He grunts, hand moving faster and faster, squeezing tighter around your doggie cock.\n\n' );
	...
	ErlKingScene.prototype.predatoryPrey = function() {
		...
		if( !CoC.player.isTaur() ) {
			if( CoC.player.hasVagina() && !CoC.player.hasCock() ) {
				...
				EngineCore.outputText( 'You wrap your arms around him, clinging to him as he shifts his grip, holding you up as you quake with aftershocks of pleasure.  One arm holds you up, close to his now-sticky, muscular chest, his other gloved hand still slowly stroking your cock, as the fog rolls in.\n\n' );
				EngineCore.outputText( 'You feel drowsy as the air thickens with chill fog, though the Erlking’s body keeps you warm.  Despite your best efforts, you find yourself drifting to sleep in his arms. \n\n' );
				EngineCore.outputText( 'You wake up an hour later, head spinning, feeling slightly tougher for all of the... exercise.\n\n' );
			}
		} else {
			...
			if( CoC.player.hasVagina() && !CoC.player.hasCock() ) {
				...
				EngineCore.outputText( 'With a moan, you cum, hugging the tree with all your might, thrusting back with your hindquarters.  With gentlemanly demeanor, the Erlking continues pumping his thick cock in and out of you until your orgasm recedes.  He then cums himself, filling your insides with his hot spunk. \n\n' );
				...
				EngineCore.outputText( 'The Erlking responds by stroking you faster, his hand tightening, increasing the tingling pleasure from the cream.  You groan, gripping the tree trunk, rubbing your chest against it for extra stimulation, the rough bark scratching harshly against your [nipples].  \n\n' );
				EngineCore.outputText( 'The Erlking gives a final, tight squeeze, a fingertip pressed against the tip of your cock.  You moan, cumming in his hand, your cum jetting against his fingertips, spraying, hose-like, against the mossy forest floor.  \n\n' );
				EngineCore.outputText( 'You pant, exhausted, and you feel a damp cloth against your softening cock.  He wasn’t kidding about taking care of his mounts - the Erlking is cleaning you off.  He wipes your cock clean, even catching stray drops that spattered your underside.  The huntsman is thorough, and you yawn softly, dozing under his careful ministrations.  \n\n' );
				EngineCore.outputText( 'Sleepily, you’re only half aware as he guides you down to a grassy patch, where you quickly fall asleep.  You wake up an hour later in the clearing.  The Erlking is gone and but your cock gives a twitch as you remember his touch.  You shakily climb to your feet, making your way back to camp.\n\n' );
			}
		}
	...
	ErlKingScene.prototype.howDareYou = function() {
		...
		EngineCore.outputText( 'You sneer and stalk forward, another well-placed shove to his shoulders knocking him from his feet.  He drops to his knees with a groan.  At the edge of the clearing, the Hounds sit silently, awaiting the outcome of the confrontation.\n\n' );
		...
		if( CoC.player.hasVagina() && !CoC.player.hasCock() ) {
			...
			EngineCore.outputText( '“<i>Deeper!</i>” you command.  You feel his tongue explore deeper into your wet snatch, and you guide his wet deer nose to rub against your clit. \n\n' );
			EngineCore.outputText( '“<i>Not a king anymore, are you?</i>” you growl, smiling.  “<i>You’re more like a Princess now.  A slutty, little Princess,</i>” you grin.  You see a tremble run down his chest and front, his cock straining against his tight leathers.  “<i>Eat my pussy, Princess,</i>” you order.\n\n' );
			EngineCore.outputText( 'Your princess moans, shuddering and submissive, shoving his flat tongue into your pussy.  It might be a trick of the light, but you swear his fur just got a little lighter.  His hips writhe, drawing attention to how slim and girlish they really are.  He’s obviously responding very well to the abuse.\n\n' );
			...
			EngineCore.outputText( 'What the Erlking lacks in skill, he makes up for in enthusiasm, licking and sucking noisily at your cock.  When the huntsman has sufficiently lubed up your cock you shove back on his antlers, pushing his mouth from your [cock].  The force of the impact breaks his golden horns, and they come free in your hands.  The Erlking whimpers, hornless, looking up at you, reaching for your cock.\n\n' );
			EngineCore.outputText( '“<i>On all fours, slut,</i>” you smirk, shoving the huntsman back.  You throw his horns to the side as he stumbles to the mossy ground, visibly weakened without his cane.  Somehow, you don’t think it’s only the loss of his cane making him so submissive.  He looks more like a doe now with his horns gone.\n\n' );
			EngineCore.outputText( 'The Erlking turns over on all fours, his cloak riding up over his shoulders.  Just above his taut buttocks is a tufted deer tail.  You smirk, grabbing the fluffy tail with one hand, and shoving down his leather pants around his knees.  He looks back over his shoulder at you.  The red light has gone out of his eyes, leaving them as wide, doe-brown eyes.  Heavy lashes blink hopefully at you as you spread his white-furred rump.\n\n' );
			EngineCore.outputText( '“<i>Not a king anymore, are you?</i>” you growl, smiling.  “<i>You’re more like a Princess now.  A slutty, little Princess,</i>” you grin.  You see a tremble run down his back, and his soft, fluffy tail twitches in your hand.  “<i>Say it,</i>” you order.\n\n' );
			EngineCore.outputText( '“<i>I... I’m a Princess,</i>” he mutters, his voice noticeably higher.  You smile, wondering what else the loss of his cane will do to your princess.\n\n' );
			EngineCore.outputText( '“<i>Good girl,</i>” you coo, pressing your [cock] against his pucker.  The new princess moans, shuddering  as you do, shoving his ass back against you.\n\n' );
			EngineCore.outputText( 'You push into him, and he moans, tossing his head back.  He’s ridiculously tight, but hungry for it.  As you begin fucking him, his voice grows higher and higher, much more girly than his earlier, thundering boom.  Thrust after thrust, you push into his supple ass.  It might be a trick of the light as the last tendrils of mist fade away, but it seems like his fur is less dark than before.\n\n' );
			EngineCore.outputText( 'He shivers below you, tensing, as he grinds his hips back against you on every downstroke.  He bucks and moans, and you hear a splashing noise from beneath him.  From the looks of the sticky white pool growing, the slut is shooting his load HARD.\n\n' );
			EngineCore.outputText( 'The sight of his total submission turns you on so much that you shudder, cumming deep inside his ass, filling him up with your hot, sticky seed.  As you grip his ass, you pant, driving in as deep as possible, marking him as your bitch forever.\n\n' );
			EngineCore.outputText( 'He moans, slumping down, cheek to the ground, and you bend over him, grinding his face to the ground.\n\n' );
			EngineCore.outputText( '“<i>Dirty little slut,</i>” you growl.  “<i>Did you like that?</i>”\n\n' );
			EngineCore.outputText( '“<i>Y-yes...</i>” purrs the once-Lord.  “<i>I... I loved it...</i>” He shudders again, and you notice that the lighter fur is no illusion.  Your new doe princess is no longer midnight black, but a sandy-tan, and still slowly lightening.\n\n' );
	...
	ErlKingScene.prototype.encounterPrincessGwynn = function() {
		...
		if( selector === 0 ) {
			EngineCore.outputText( 'The Princess’s pink fur is slathered in smears of saps and juices, and angry red stings pepper her body.  It’s very obvious that she’s fallen prey to the roaming tentacle monsters that haunt the forests.\n\n' );
		} else if( selector === 1 ) {
			EngineCore.outputText( 'The Princess winces as low branches drag across her ass, and you can see angry red claw marks criss-crossing her pert ass.  It seems she’s run afoul of Akbal, the feline lord of the Deepwoods.\n\n' );
		} else if( selector === 2 ) {
			EngineCore.outputText( 'The Princess coughs, a trickle of cum running down her lips and chin.  You see bruises on her throat and chin, and tiny claw marks across her body.  It looks like she was caught by a roving gang of imps.\n\n' );
		} else if( selector === 3 ) {
			EngineCore.outputText( 'The Princess’ pink fur is stained with multicolored blotches, and she sways a little bit, apparently woozy.  Goblin attacks can leave a person that way for quite some time.\n\n' );
		} else if( selector === 4 ) {
			EngineCore.outputText( 'The Princess’ neck and wrists bear bruises, as if someone had bound her up roughly and repeatedly.\n\n' );
		} else if( selector === 5 ) {
			EngineCore.outputText( 'As she turns to squeeze between two trees, you see that the Princess has numerous claw marks up and down her back.  It looks like, since her transformation, her Hounds have turned on her.\n\n' );
		}
	...
	ErlKingScene.prototype.gwynnSucksDicks = function() {
		...
		EngineCore.outputText( 'The vibration of her chirpy voice and pressure of her lips around your cock soon push you over the edge, and with a relaxed shudder, you cum in her mouth.  She takes the first jet down her throat, then pulls her mouth from your dick with a satisfied gasp, taking the next jet across her face.\n\n' );
		EngineCore.outputText( '“<i>Oooooo...</i>” she moans, shivering in delight, her tongue lapping at the dripping cum, her fingers delicately wiping the thick spooge from her cheeks and depositing it in her mouth.  You notice that she’s shoved two of her slim fingers up her cute, perky ass as she slurps away at your spilled seed.\n\n' );
		EngineCore.outputText( 'Satisfied, you pat her head, ruffling her short, pink hair, leaving her happy and smiling.\n\n' );
	...
	ErlKingScene.prototype.gwynnGetsDickmilked = function() {
		...
		EngineCore.outputText( '“<i>Master, I have lube in my bag... if you’d like to use it, that is,</i>” she says shyly, reaching into her purse and offering you a small, pink bottle.  You realized that this purse used to be one of her saddlebags.  As you uncork the bottle and pour out a liberal amount of lube over her massive, flat-headed equine cock, you idly wonder if she used to carry lube as the Erlking.\n\n' );
		EngineCore.outputText( 'You begin stroking her thick cock, feeling her pulse through it as it throbs under your fingers.  You squeeze it roughly, drawing a squeal from Princess Gwynn as she bites her bottom lip.  Unsure of what to do with her hands, she runs them through her own hair, looking up at the canopy from under heavy lids.  Her long lashes flutter as she pants shallowly.\n\n' );
		EngineCore.outputText( 'Faster and faster you pump her, until her breath comes in shallow gasps and her body trembles at the edge of orgasm.  You’re immediately seized by a wicked idea, and with your free hand, you pull her tail up, raising her ass in the air.  She squeaks in pain but you’re not done yet.  You curl her whole lower body over, and aim her heavy cock at her face.\n\n' );
		EngineCore.outputText( '“<i>Oh, nuh-nooo...</i>” she gasps, her knees now planted on either side of her head.\n\n' );
		EngineCore.outputText( '“<i>Oh, yes,</i>” you coo wickedly, shoving the lithe doe’s cock into her own mouth.  She blathers a muffled protest before you give her tufted tail another sharp tug, drawing out her orgasm..\n\n' );
		EngineCore.outputText( 'Her cock spurts into her own mouth, immediately ballooning out her cheeks.  Her eyes roll back in her head as she gurgles around her cock.  Slightly-pink, raspberry-scented cum spills out from her pouty lips, as she coughs and nearly chokes on her own cum.  \n\n' );
		EngineCore.outputText( 'You drop her tail, letting it thump to the ground, her hooves digging tiny furrows in the dirt as her cock arcs out a trail of thick spooge down her flat chest.  She moans, pink spooge drooling out from her mouth.  You watch, both amused and surprised, as her first act upon regaining her senses is to begin scooping up her own cum and licking it off her fingers.\n\n' );
		EngineCore.outputText( 'Satisfied that she’ll be fine, you stand up, leaving the slutty doe to clean herself up.\n\n' );
		//[Lust +20, Libido +2]
