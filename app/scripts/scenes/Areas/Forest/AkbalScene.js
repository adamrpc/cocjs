...
angular.module( 'cocjs' ).run( function( SceneLib, CoC, Utils, StatusAffects, EngineCore, AppearanceDefs, Descriptors, EventParser, PregnancyStore, kFLAGS, Combat, PerkLib, ImageManager, Akbal, CockTypesEnum ) {
	...
	AkbalScene.prototype.akbalDefeated = function( hpVictory ) {
		CoC.getInstance().flags[ kFLAGS.AKBAL_SUBMISSION_STATE ] = 1;
		if( hpVictory )
		//[General Victory]
		{
			//[Common chance of dropping 'Incubus Draft', 'Smart Tea' or 'Pipe']
			EngineCore.outputText( 'Akbal falls to the ground in a beaten bloody heap.', true );
		} else //[Victory via Lust]
		{
			EngineCore.outputText( 'Akbal falls to the ground, unable to go on. Yet a growl still rumbles in his chest, and you quickly recognize the submissive gesture when he bows his head, his cat belly hugging the ground.  His body begins shifting, and soon he has a vaguely humanoid form. You assume this is the form he uses for sex, as his lust is out of control.\n\n', true );
			if( CoC.getInstance().player.lust >= 33 && CoC.getInstance().player.gender > 0 ) {
				EngineCore.outputText( 'You walk around Akbal\'s beaten and lust crazed form with a smile on your face. The demon\'s growl continues as he awaits your judgment.', false );
				var vagoo = null;
				var vagooLick = null;
				var buttFuck = null;
				var bikiniTits = null;
				...
				if( CoC.getInstance().player.hasVagina() && CoC.getInstance().player.biggestTitSize() >= 4 && CoC.getInstance().player.armor.lustyMaidenPaizuri ) {
					bikiniTits = CoC.getInstance().player.armor.lustyMaidenPaizuri;
				}
				...
				//Rape / Don't Rape
				EngineCore.choices( 'Butt-fuck', buttFuck, 'Take Vaginally', vagoo, 'Force Lick', vagooLick, 'B.Titfuck', bikiniTits, 'Leave', Combat.cleanupAfterCombat );
				return;
			}
		}
	...
	AkbalScene.prototype.akbalWon = function( hpVictory, pcCameWorms ) {
		CoC.getInstance().flags[ kFLAGS.AKBAL_SUBMISSION_STATE ] = -1;
		CoC.getInstance().flags[ kFLAGS.AKBAL_BITCH_Q ] = 0;
		EngineCore.outputText( '', true );
		if( pcCameWorms ) {
			EngineCore.outputText( '\n\nYour foe doesn\'t seem disgusted enough to leave...' );
			EngineCore.doNext( this.loseToAckballllllz );
		} else if( hpVictory ) {
			EngineCore.outputText( 'The intense pain causes you to black out. The last thing you see is Akbal standing over you on his two hind legs, his massive cock ominously swinging between them as he watches you lose consciousness.\n\n', false );
		} else {
			this.loseToAckballllllz();
		}
	};
	//Victory/Defeat Scenes
	AkbalScene.prototype.rapeAkbalForcedFemaleOral = function() {
		CoC.getInstance().flags[ kFLAGS.AKBAL_BITCH_Q ]++;
		EngineCore.outputText( '', true );
		//Naga RAPPUUUUUU
		if( CoC.getInstance().player.isNaga() ) {
			EngineCore.outputText( ImageManager.showImage( 'akbal-deepwoods-naga-forcedfemaleoral' ) );
			EngineCore.outputText( 'You slither around the demon cat\'s form, wrapping him up until a scared whimper rises from his chest.  You continue to tighten your coils around Akbal until he\'s gasping for breath.  You ask him if he\'s going to be a good little demon for you.  He nods.\n\n', false );
			...
			EngineCore.outputText( 'Your eyes widen as you see several wicked looking barbs around his pre-pumping slit.  Instead of trying to deal with this massive phallus that looks like it was made to punish sinners you slither around to the front of the creature.\n\n', false );
			EngineCore.outputText( 'Your scent causes the growl ripping out of Akbal\'s chest to quiver.  You lay before him, reaching up to smash his furry lips into your ' + Descriptors.vaginaDescript( 0 ) + '.  The demon, unable to escape his debilitating arousal, begins to lap at your ' + Descriptors.vaginaDescript( 0 ) + '.  He shoves his face against your ' + Descriptors.vaginaDescript( 0 ) + ' twisting his lips and drilling his tongue into you, mercilessly attacking your ' + Descriptors.clitDescript() + ' as you scream, howl and cringe in ecstasy.\n\n', false );
			EngineCore.outputText( 'He begins to lift up, probably to get into position above you and sake his lust, but you force his face back down into your ' + Descriptors.vaginaDescript( 0 ) + '.  After dropping a line about how he has to make your cum or get his head ripped off Akbal whines, obviously distressed at not being able to slip his aching member into your ' + Descriptors.vaginaDescript( 0 ) + '.\n\n', false );
			EngineCore.outputText( 'With a sadistic laugh you ride out your orgasm until you\'re reduced to a shuddering heap on the floor.  After you\'ve recovered you gather your ' + CoC.getInstance().player.armorName + ', leaving Akbal in a groaning mess behind you.  He howls as he claws the ground, his barbed cock still rock hard beneath him.  Just as you begin to leave you notice a group of imps watching you and the jaguar demon, their cocks out and leaking as their jagged teeth spread into feral grins.  You even spy a few goblins mixed in the crowd, each twirling a bottle of liquid and playing with her snatch.\n\n', false );
		...
		//Centaur RAPPUUUUU
			...
			EngineCore.outputText( ImageManager.showImage( 'akbal-deepwoods-taur-forcedfemaleoral' ) );
			EngineCore.outputText( 'You roughly grab the scruff of the demon\'s neck, aiming a gut crushing blow to his stomach and causing him to call out in pain.\n\n', false );
			EngineCore.outputText( '"<i>Who\'s gonna submit now... bitch?</i>"\n\n', false );
			EngineCore.outputText( 'Akbal snarls as you shove him back first onto the forest ground.  You look down at him, fully prepared to have your way with his demon dick.  What you see causes your ' + Descriptors.vaginaDescript( 0 ) + ' to flinch at the thought of what would have happened if you had lost and the demon had used that on you.\n\n', false );
			EngineCore.outputText( 'The head of the massive dick sitting between Akbal\'s thighs is covered in a dozen tiny barbs that look like they were created to punish sinners.\n\n', false );
			EngineCore.outputText( 'You walk around the creature, irritated at the fact that you can\'t squat on that crazily large demon cat dick.  Once you\'re on the other side of him you sit your hind quarters on his face.\n\n', false );
			EngineCore.outputText( 'Akbal gives a muffled scream at first but soon he gets the message. His tongue slithers into your ' + Descriptors.vaginaDescript( 0 ) + '.  You lift yourself a little; well... you lean forward a bit to let the demon actually breath.  This proves to be the right choice as Akbal is ravenous for your ' + Descriptors.vaginaDescript( 0 ) + '.\n\n', false );
			EngineCore.outputText( 'He drills his tonuge into you, mercilessly attacking your ' + Descriptors.clitDescript() + ' as you scream, howl and cringe in ecstasy.  He begins to lift up, probably to get the weight of your body off of the rest of his face, but you grab his tender furry balls in your hand and he stops before you\'re forced to do something drastic.\n\n', false );
			EngineCore.outputText( 'After dropping a line about how he has to make you cum or get his head ripped off Akbal whines, obviously distressed at not being able to slip his aching member into your ' + Descriptors.vaginaDescript( 0 ) + '.\n\n', false );
			EngineCore.outputText( 'With a sadistic laugh you ride out your orgasm until you\'re reduced to a shuddering heap.  After you\'ve recovered you stand and gather your ' + CoC.getInstance().player.armorName + ', leaving Akbal in a groaning mess behind you.  He howls as he claws the ground, his barbed cock still rock hard beneath him.  Just as you begin to leave you notice a group of imps watching you and the jaguar demon, their cocks out and leaking as their jagged teeth spread into feral grins.  You even spy a few goblins mixed in the crowd, each twirling a bottle of liquid and playing with her snatch.\n\n', false );
			EngineCore.outputText( 'As you leave Akbal snarls as the creatures that once feared him use his overtly aroused state to get revenge on the "god" of the terrestrial fire.  Even after you\'ve reached the edge of the forest the wails of the jaguar demon can still be heard but just barely over the high pitched laughter of the demon imps and goblin females.', false );
		}
		//Everybody else
		else {
			EngineCore.outputText( ImageManager.showImage( 'akbal-deepwoods-forcedfemaleoral' ) );
			EngineCore.outputText( 'You roughly grab the scruff of the demon\'s neck and give a gut-crushing blow to his stomach, causing him to call out in pain.', false );
			EngineCore.outputText( '\n\n"<i>Who\'s gonna submit now, bitch?</i>"\n\n', false );
			EngineCore.outputText( 'Akbal grunts as you smash his face into the ground.  At your command he raises his hind quarters, allowing you a perfect view of his low-hanging balls and sheath.  You reach around his fuzzy orbs and pull his swollen cock back until the jaguar demon\'s 15-inch pecker is visible.\n\n', false );
			EngineCore.outputText( 'Your eyes widen when you see several wicked-looking barbs around his pre-pumping cockhead.  Instead of trying to deal with this massive phallus that looks like it was made to punish sinners, you walk around to the front of the creature.\n\n', false );
			EngineCore.outputText( 'Your scent causes Akbal\'s growling to quiver.  You lay down before him, grabbing his head and smashing his furry lips into your ' + Descriptors.vaginaDescript( 0 ) + '.  The demon, unable to escape his debilitating arousal, begins to lap at your ' + Descriptors.vaginaDescript( 0 ) + '.  He twists his lips and drills his tongue into you, mercilessly attacking your ' + Descriptors.clitDescript() + ', and you scream, howl and cringe in ecstasy.  He begins to lift up, probably to get into position above you, but you force his face back down into your ' + Descriptors.vaginaDescript( 0 ) + '.  After dropping a line about how he has to make your cum or get his head ripped off, Akbal whines, obviously distressed at not being able to slip his aching member into your ' + Descriptors.vaginaDescript( 0 ) + '.\n\n', false );
			EngineCore.outputText( 'With a sadistic laugh you ride out your orgasm until you\'re reduced to a shuddering heap on the floor.  After you\'ve recovered, you stand and gather your ' + CoC.getInstance().player.armorName + ', leaving Akbal in a groaning mess behind you.  He howls as he claws the ground, his barbed cock still rock hard beneath him.  As you walk away, you notice a group of imps watching you and the jaguar demon with their cocks out and leaking, their jagged teeth spread into feral grins.  You even spy a few goblins mixed in the crowd, and each is twirling a bottle of liquid while playing with her snatches.\n\n', false );
			EngineCore.outputText( 'Akbal snarls as you leave, the creatures that once feared him using his aroused state to get revenge on the \'god\' of the terrestrial fire.  Even after you\'ve reached the edge of the forest, the jaguar demon\'s pained howls can still be heard – though, just barely over the high-pitched laughter of the demon imps and the cackling of the goblin females.', false );
		}
		//END CENTAUR STUFF
	...
	AkbalScene.prototype.rapeAkbal = function() {
		CoC.getInstance().flags[ kFLAGS.AKBAL_BITCH_Q ]++;
		var primary = CoC.getInstance().player.cockThatFits( 50 );
		if( primary < 0 ) {
			primary = 0;
		}
		EngineCore.outputText( '', true );
		...
		if( CoC.getInstance().player.lowerBody === AppearanceDefs.LOWER_BODY_TYPE_NAGA ) {
			...
			if( CoC.getInstance().player.totalCocks() > 0 ) {
				EngineCore.outputText( ImageManager.showImage( 'akbal-deepwoods-male-naga-rapeakbal' ) );
				//(Sm Penis: 7 inches or less)
				if( CoC.getInstance().player.cocks[ primary ].cockLength <= 7 ) {
					EngineCore.outputText( 'As you uncoil you can\'t help but bump into the slimy leaking faucet Akbal calls his dick.  At your command he raises his hind quarters, giving you a perfect view of his tight pucker.  From the looks of it nothing has ever even touched the tightly sealed rim.  First you poke it with your finger, causing Akbal to flinch at the sensation.  Taking your ' + Descriptors.cockDescript( primary ) + ' in hand you shove in without hesitation or mercy.  The virginally-tight hole clamps shut and Akbal hisses in pain as you force him open.  In no time at all you\'re sawing your ' + Descriptors.cockDescript( primary ) + ' in and out of the demon\'s virginally-tight hole, relishing in the way it quivers and squirms around your embedded ' + Descriptors.cockDescript( primary ) + '.\n\n', false );
				}
				//(Md Penis: 8-12 inches)
				else if( CoC.getInstance().player.cocks[ primary ].cockLength <= 12 ) {
					EngineCore.outputText( 'As you uncoil you can\'t help but bump into the slimy leaking faucet Akbal calls his dick.  At your command he raises his hind quarters, giving you a perfect view of his tight pucker.  From the looks of it nothing has ever even touched the tightly sealed rim.  A light tap of your finger causes the tiny hole to constrict in fear as Akbal\'s entire body flinches away from you.  You grab your ' + Descriptors.cockDescript( primary ) + ' with a cruel smile.\n\n', false );
					EngineCore.outputText( 'As you shove your ' + Descriptors.cockDescript( primary ) + ' into his tight pucker you are not surprised to find your ' + Descriptors.cockDescript( primary ) + ' barely able to breach the tightly sealed walls.  Grunting with effort you slowly inch forward, Akbal howling and squirming beneath you as he is taken without regard for his own pleasure.\n\n', false );
					EngineCore.outputText( 'After a dozen achingly slow thrusts Akbal\'s asshole begins to loosen and you begin to saw your ' + Descriptors.cockDescript( primary ) + ' in and out of his pucker with force as the demon cat\'s howls range from pained to pleased.\n\n', false );
				}
				//(Lg Penis: 13 inches and up)
				else {
					EngineCore.outputText( 'As you uncoil you can\'t help but bump into the slimy leaking faucet Akbal calls his dick.  At your command he raises his hind quarters, giving you a perfect view of his tight pucker.  A short glance tells you your ' + Descriptors.cockDescript( primary ) + ' won\'t fit... but since when has that stopped you from trying?\n\n', false );
					EngineCore.outputText( 'When you slide a single finger against his virginally-tight hole Akbal flinches, the already tight hole clamping shut in fear.\n\n', false );
					EngineCore.outputText( 'You twist Akbal\'s tail into your fist and laugh as a scared whimper rises out of the jaguar demon\'s throat.  You begin to push your huge cock in with one hand as your other pulls Akbal\'s tail.  The creature wines and howls as you invade its clenching sphincter, forcibly stretching its tight pink hole to a dangerous degree with your ' + Descriptors.cockDescript( primary ) + '.  All too soon you are halted, barely able to fit more than a foot of your huge cock into Akbal\'s virginally-tight hole.  Deciding that\'s good enough you pull out and push forward, meeting the same resistance as before.\n\n', false );
					EngineCore.outputText( 'After hours of resistance and howling, Akbal\'s body shudders as his asshole relaxes due to complete exhaustion.  Battling with your tremendous cock seems to have made him almost pass out and he no longer has the energy to resist you.  The jaguar demon\'s body flinches with your every thrust as you begin to pound him raw, without lube and without mercy.\n\n', false );
				}
				//(transition)
				EngineCore.outputText( 'You rape the jaguar demon\'s tight hole with steadily mounting force, your ' + Descriptors.hipDescript() + ' smashing into his body with freight train force and causing him to cry out.  Despite this his 15 inch swollen sex organ pumps pre beneath him, letting you know that his pain is mixed with plenty of unwilling pleasure.\n\n', false );
				//(With Fertility/Lots of Jizz Perk)
				if( CoC.getInstance().player.cumQ() > 1000 ) {
					EngineCore.outputText( 'The crushing tightness of Akbal\'s quivering hole pushes you over the edge and with a titanic howl you begin hosing down his insides.  The jaguar demon erupts as well, his body convulsing in time with your still thrusting ' + Descriptors.cockDescript( 0 ) + '.\n\n', false );
				...
				//(without perk)
					...
					EngineCore.outputText( 'The crushing tightness of Akbal\'s quivering hole pushes you over the edge and with a titanic howl you begin hosing down his insides. Beneath you Akbal\'s own orgasm erupts and the jaguar demon goes limp as you continue to pound him through his orgasm.  When you pull out you aim a slap at Akbal\'s now very tender ass, making him yelp as your unexpected blow connects.\n\n', false );
				}
				//(Ending)
				EngineCore.outputText( 'As you stand you gather your ' + CoC.getInstance().player.armorName + ' and turn to leave the weakened demon behind you.  Just as you begin to walk away you notice a group of imps watching you and the jaguar demon, their cocks out and leaking.  Mixed in with the crowd are several goblins, each with a vial of liquid and a malicious grin.\n\n', false );
			...
			//(If the player has a vagina)
				...
				EngineCore.outputText( ImageManager.showImage( 'akbal-deepwoods-female-naga-rapeakbal' ) );
				EngineCore.outputText( 'As you uncoil you can\'t help but bump into the slimy leaking faucet Akbal calls his dick.  At your command he raises his hind quarters, allowing you a perfect view of his low hanging balls and sheath.  You reach around his fuzzy orbs and pull his swollen cock back until the jaguar demon\'s 15 inch pecker is visible.\n\n', false );
				EngineCore.outputText( 'Your eyes widen as you see several wicked looking barbs around his pre-pumping slit.  Instead of trying to deal with this massive phallus that looks like it was made to punish sinners you slither around to the front of the creature.\n\n', false );
				EngineCore.outputText( 'Your scent causes the growl ripping out of Akbal\'s chest to quiver.  You lay before him, reaching up to smash his furry lips into your ' + Descriptors.vaginaDescript( 0 ) + '.  The demon, unable to escape his debilitating arousal, begins to lap at your ' + Descriptors.vaginaDescript( 0 ) + '.  He shoves his face against your ' + Descriptors.vaginaDescript( 0 ) + ' twisting his lips and drilling his tongue into you, mercilessly attacking your ' + Descriptors.clitDescript() + ' as you scream, howl and cringe in ecstasy.\n\n', false );
				EngineCore.outputText( 'He begins to lift up, probably to get into position above you and sake his lust, but you force his face back down into your ' + Descriptors.vaginaDescript( 0 ) + '.  After dropping a line about how he has to make your cum or get his head ripped off Akbal whines, obviously distressed at not being able to slip his aching member into your ' + Descriptors.vaginaDescript( 0 ) + '.\n\n', false );
		...
		//Centaur RAPPUUUUU
			...
			//(If player has a dick)
			if( CoC.getInstance().player.totalCocks() > 0 ) {
				EngineCore.outputText( ImageManager.showImage( 'akbal-deepwoods-male-taur-rapeakbal' ) );
				//(Sm Penis: 7 inches or less)
				if( CoC.getInstance().player.cocks[ primary ].cockLength <= 7 ) {
					EngineCore.outputText( 'Akbal snarls pitifully as you shove him stomach down against a log.  Your ' + Descriptors.cockDescript( primary ) + ' leaks at the thought of bringing this "god" down a notch .  At your command he arches his back and lifts his tail, giving you a perfect view of his tight pucker.  From the looks of it nothing has ever even touched the tightly sealed rim.  As you lightly tap it with your finger it flinches, becoming even tighter as Akbal\'s body jerks away in fear.\n\n', false );
					EngineCore.outputText( 'You rear up, standing on two legs for a moment before your hooves fall to the ground, Akbal\'s head between your front legs with his hair tickling your belly.  You give a few experimental thrusts.  The first one causes your ' + Descriptors.cockDescript( primary ) + ' to slide up Akbal\'s upturned cheeks, making him cringe.  The second one, however, catches.\n\n', false );
					EngineCore.outputText( 'The virginally-tight hole clamps shut and Akbal hisses in pain as you force him open.  In no time at all you\'re sawing your ' + Descriptors.cockDescript( primary ) + ' in and out of the demon\'s virginally-tight hole, relishing in the way it quivers and squirms around your embedded ' + Descriptors.cockDescript( primary ) + '.  The sounds coming from Akbal\'s throat are varied but include many unwillingly pleased groans.  He\'s obviously liking this more  than he\'s willing to admit.\n\n', false );
				}
				//(Md Penis: 8-12 inches)
				else if( CoC.getInstance().player.cocks[ primary ].cockLength <= 12 ) {
					EngineCore.outputText( 'Akbal snarls pitifully as you shove him stomach down against a log.  Your ' + Descriptors.cockDescript( primary ) + ' leaks at the thought of bringing this "god" down a notch.  At your command he arches his back and lifts his tail, giving you a perfect view of his tight pucker.  From the looks of it nothing has ever even touched the tightly sealed rim.  As you lightly tap it with your finger it flinches, becoming even tighter as Akbal\'s body jerks away in fear.\n\n', false );
					EngineCore.outputText( 'You rear up, standing on two legs for a moment before your hooves fall to the ground, Akbal\'s head between your legs tickling your belly.  You give a few experimental thrusts.  The first one causes your ' + Descriptors.cockDescript( primary ) + ' to slide up Akbal\'s upturned cheeks, making him cringe.  The second one, however, catches.\n\n', false );
					EngineCore.outputText( 'As you shove your ' + Descriptors.cockDescript( primary ) + ' forward into his virginally-tight pucker you are not surprised to find your ' + Descriptors.cockDescript( primary ) + ' barely able to breach the tightly sealed walls.  Grunting with effort you slowly inch forward, Akbal howling and squirming beneath you as he is taken without regard for his own pleasure.\n\n', false );
					EngineCore.outputText( 'After a dozen achingly slow thrusts Akbal\'s asshole begins to loosen and you begin to saw your ' + Descriptors.cockDescript( primary ) + ' in and out of his pucker.  The demon cat\'s howls range from pained to pleased, obviously enjoying his butt rape more than he is willing to admit.\n\n', false );
				}
				//(Lg Penis: 13 inches and up)
				else {
					EngineCore.outputText( 'Akbal snarls pitifully as you shove him stomach down against a log. Your ' + Descriptors.cockDescript( primary ) + ' leaks at the thought of bringing this "god" down a notch .  At your command he arches his back and lifts his tail, giving you a perfect view of his tight pucker.  From the looks of it nothing has ever even touched the tightly sealed rim.  As you lightly tap it with your finger it flinches, becoming even tighter as Akbal\'s body jerks away in fear.  There\'s no way in hell your ' + Descriptors.cockDescript( primary ) + ' can fit inside something so incredibly tight but... since when has that stopped you?\n\n', false );
					EngineCore.outputText( 'You rear up, standing on two legs for a moment before your hooves fall to the ground, Akbal\'s head between your legs, his hair tickling your belly.  You give a few experimental thrusts.  The first one causes your ' + Descriptors.cockDescript( primary ) + ' to slide up Akbal\'s upturned cheeks, making him cringe.  The second one, however, catches.\n\n', false );
					EngineCore.outputText( 'The demon wines and wraps his arms around your front legs, pulling himself away from the burning pressure of your ' + Descriptors.cockDescript( primary ) + '.  His voice breaks as you invade his clenching sphincter, forcibly stretching Akbal\'s tight pink hole to a dangerous degree.  All too soon you are halted, barely able to fit more than a foot of your huge cock into Akbal\'s virginally-tight hole.  Deciding that\'s good enough you pull out and push forward, meeting the same resistance as before.\n\n', false );
					EngineCore.outputText( 'You grin as you realize that this may take a while...\n\n', false );
					EngineCore.outputText( 'After hours of resistance and howling, Akbal\'s body shudders as his asshole relaxes due to complete exhaustion.  Battling with your tremendous cock seems to have made him almost pass out and he no longer has the energy to resist you.  The jaguar demon\'s body flinches with your every thrust as you begin to pound him raw, without lube and without mercy.\n\n', false );
				}
				//(transition)
				EngineCore.outputText( 'You rape the jaguar demon\'s tight hole with steadily mounting force, your trunk smashing into his cringing body with freight train force and causing him to cry out in times with your grunts.  Despite this his 15 inch swollen sex organ pumps pre beneath him, letting you know that his pain is mixed with plenty of unwilling pleasure.\n\n', false );
				//(With Fertility/Lots of Jizz Perk)
				if( CoC.getInstance().player.cumQ() > 1000 ) {
					EngineCore.outputText( 'The crushing tightness of Akbal\'s quivering hole pushes you over the edge and with a titanic howl you begin hosing down his insides.  Akbal\'s suddenly clenching sphincter lets you know he has reached his orgasm as well.  ', false );
					EngineCore.outputText( 'You continue to slide your still swollen sex organ inside his quivering hole as you pump massive tons of liquid into the false god\'s stomach and bowels.  Beneath the two of you his belly begins to bulge as he is filled to a dangerous degree.  ', false );
					EngineCore.outputText( 'Once your massive orgasm subsides you pull out, releasing a gargantuan deluge of your thick spunk that rolls down his legs and creates a large puddle in the forest floor.  Akbal heaves a relieved sigh, obviously happy you are finally done raping him.\n\n', false );
				}
				//(without perk)
				else {
					EngineCore.outputText( 'The crushing tightness of Akbal\'s quivering hole pushes you over the edge and with a titanic howl you begin hosing down his insides.  Akbal\'s suddenly clenching sphincter lets you know he has reached his orgasm as well.  The jaguar demon\'s body goes limp as you continue to pound him through his orgasm.  When you pull out you aim a slap at Akbal\'s now very tender ass, making him yelp as your unexpected blow connects.\n\n', false );
				}
				//(Ending)
				EngineCore.outputText( 'As you stand you gather your ' + CoC.getInstance().player.armorName + ' and turn to leave the weakened demon behind you.  Just as you begin to walk away you notice a group of imps watching you and the jaguar demon, their cocks out and leaking.  Mixed in with the crowd are several goblins, each with a vial of liquid and a malicious grin.\n\n', false );
			...
			//(If the player has a vagina)
				...
				EngineCore.outputText( ImageManager.showImage( 'akbal-deepwoods-female-taur-rapeakbal' ) );
				EngineCore.outputText( 'Akbal snarls as you shove him back first onto the forest ground.  You look down at him, fully prepared to have your way with his demon dick.  What you see causes your ' + Descriptors.vaginaDescript( 0 ) + ' to flinch at the thought of what would have happened if you had lost and the demon had used that on you.\n\n', false );
				EngineCore.outputText( 'The head of the massive dick sitting between Akbal\'s thighs is covered in a dozen tiny barbs that look like they were created to punish sinners.\n\n', false );
				EngineCore.outputText( 'You walk around the creature, irritated at the fact that you can\'t squat on that crazily large demon cat dick.  Once you\'re on the other side of him you sit your hind quarters on his face.\n\n', false );
				EngineCore.outputText( 'Akbal gives a muffled scream at first but soon he gets the message. His tongue slithers into your ' + Descriptors.vaginaDescript( 0 ) + '.  You lift yourself a little; well... you lean forward a bit to let the demon actually breath.  This proves to be the right choice as Akbal is ravenous for your ' + Descriptors.vaginaDescript( 0 ) + '.\n\n', false );
		...
		//[Player has a dick]
		if( CoC.getInstance().player.totalCocks() > 0 ) {
			EngineCore.outputText( ImageManager.showImage( 'akbal-deepwoods-male-rapeakbal' ) );
			EngineCore.outputText( 'Akbal grunts as you smash his face into the ground.  At your command he raises his hind quarters, allowing you a perfect view of his tight pucker.  From the looks of it, his tightly sealed rim would look at home on a virgin.\n\n', false );
			//[Small penis (7 inches or less)]
			if( CoC.getInstance().player.cockArea( 0 ) < 13 ) {
				EngineCore.outputText( 'You first poke it with your finger, causing Akbal to flinch at the sensation.  Taking your ' + Descriptors.cockDescript( 0 ) + ' in hand, you shove it in without hesitation or mercy.  The virgin-like hole clamps shut and Akbal hisses in pain as you force him open.  In no time at all you\'re sawing your ' + Descriptors.cockDescript( 0 ) + ' in and out of the demon\'s tight hole, relishing in the way it quivers and squirms around your embedded ' + Descriptors.cockDescript( 0 ) + '.\n\n', false );
			}
			//[Medium penis (8-12 inches)]
			else if( CoC.getInstance().player.cockArea( 0 ) < 25 ) {
				EngineCore.outputText( 'A light tap of your finger causes the tiny hole to constrict and Akbal\'s entire body flinches in fear.  You grab your ' + Descriptors.cockDescript( 0 ) + ' with a cruel smile.  As you shove yourself into his tight pucker, you aren\'t surprised to find that your ' + Descriptors.cockDescript( 0 ) + ' is barely able to breach the tightly sealed walls.  Grunting with effort you slowly inch forward, Akbal howling and squirming beneath you as he is taken without regard for his own pleasure.\n\n', false );
				EngineCore.outputText( 'After a dozen achingly slow thrusts, Akbal\'s asshole begins to loosen and you start sawing your ' + Descriptors.cockDescript( 0 ) + ' in and out of his pucker with force. The demon cat\'s howls fluctuate between yelps of pain and moans of pleasure.\n\n', false );
			}
			//[Large penis (13 inches and up)]
			else {
				EngineCore.outputText( 'A single look tells you your ' + Descriptors.cockDescript( 0 ) + ' won\'t fit... but since when has that stopped you from trying?  You slide a single finger against the virginally-tight hole and Akbal flinches. His already tight hole clamps shut in fear, as if doing so will somehow stop the inevitable intrusion.\n\n', false );
				EngineCore.outputText( 'You twist Akbal\'s tail into your fist and laugh as a scared whimper escapes from the jaguar demon\'s throat.  You begin to push your ' + Descriptors.cockDescript( 0 ) + ' in with one hand as you pull Akbal\'s tail with the other.  The demon whines and howls as you invade his clenching sphincter, forcibly stretching the tight pink hole to a dangerous degree.  You are halted all too soon, barely able to fit more than a foot of your ' + Descriptors.cockDescript( 0 ) + ' into Akbal\'s virginally-tight hole.  Deciding that\'s good enough, you pull out before pushing forward again, meeting the same resistance as before.\n\n', false );
				EngineCore.outputText( 'After what seems like hours of resistance and howling, Akbal\'s body shudders and his asshole relaxes from complete exhaustion.  Battling with your ' + Descriptors.cockDescript( 0 ) + ' seems to have nearly made him pass out, and he no longer has the energy to resist you.  The jaguar demon\'s body flinches with your every thrust as you pound him raw – without lube, and without mercy.\n\n', false );
			}
			EngineCore.outputText( 'You rape the jaguar demon\'s tight hole with steadily mounting force, your ' + Descriptors.hipDescript() + ' smashing into his body with freight-train force, and causing him to cry out.  Despite this, his 15-inch swollen sex organ is pumping out pre beneath him, letting you know that his pain is mixed with plenty of unwilling pleasure.\n\n', false );
			EngineCore.outputText( 'The crushing tightness of Akbal\'s quivering hole pushes you over the edge, and with a titanic howl you unleash your load inside him.  Akbal\'s suddenly clenching sphincter lets you know that he has reached his orgasm as well.\n\n', false );
			//[With Fertility/Lots of Jizz Perk]
			if( CoC.getInstance().player.cumQ() > 1000 ) {
				EngineCore.outputText( 'You continue to slide your still-swollen ' + Descriptors.cockDescript( 0 ) + ' inside his quivering hole as you pump massive tons of liquid into the false god\'s stomach and bowels.  Beneath the two of you, his belly begins to bulge as he is filled to a dangerous degree.\n\n', false );
				EngineCore.outputText( 'Once your massive orgasm subsides you pull out, releasing a gargantuan deluge of your thick spunk that rolls down his legs, creating a large puddle in the forest floor.  Akbal heaves a relieved sigh, obviously glad that you are finally done raping him.\n\n', false );
			}
			//[Without Fertility/Lots of Jizz Perk]
			else {
				EngineCore.outputText( 'The jaguar demon\'s body goes limp as you continue to pound him through his orgasm.  When you finally pull out, you aim a slap at Akbal\'s now very tender ass and make him yelp when your unexpected blow connects.\n\n', false );
			}
			EngineCore.outputText( 'Standing up, you gather your ' + CoC.getInstance().player.armorName + ' and turn to leave the weakened demon behind you.  As you walk away, you notice a group of imps watching you and the jaguar demon with their cocks out and leaking.  Mixed in with the crowd are several goblins, each with a vial of liquid and a malicious grin.\n\n', false );
		...
		//[Player has a vagina]
			...
			EngineCore.outputText( ImageManager.showImage( 'akbal-deepwoods-female-rapeakbal' ) );
			EngineCore.outputText( 'Akbal grunts as you smash his face into the ground.  At your command he raises his hind quarters, allowing you a perfect view of his low-hanging balls and sheath.  You reach around his fuzzy orbs and pull his swollen cock back until the jaguar demon\'s 15-inch pecker is visible.\n\n', false );
			EngineCore.outputText( 'Your eyes widen when you see several wicked-looking barbs around his pre-pumping cockhead.  Instead of trying to deal with this massive phallus that looks like it was made to punish sinners, you walk around to the front of the creature.\n\n', false );
			EngineCore.outputText( 'Your scent causes Akbal\'s growling to quiver.  You lay down before him, grabbing his head and smashing his furry lips into your ' + Descriptors.vaginaDescript( 0 ) + '.  The demon, unable to escape his debilitating arousal, begins to lap at your ' + Descriptors.vaginaDescript( 0 ) + '.  He twists his lips and drills his tongue into you, mercilessly attacking your ' + Descriptors.clitDescript() + ', and you scream, howl and cringe in ecstasy.  He begins to lift up, probably to get into position above you, but you force his face back down into your ' + Descriptors.vaginaDescript( 0 ) + '.  After dropping a line about how he has to make your cum or get his head ripped off, Akbal whines, obviously distressed at not being able to slip his aching member into your ' + Descriptors.vaginaDescript( 0 ) + '.\n\n', false );
			EngineCore.outputText( 'With a sadistic laugh you ride out your orgasm until you\'re reduced to a shuddering heap on the floor.  After you\'ve recovered, you stand and gather your ' + CoC.getInstance().player.armorName + ', leaving Akbal in a groaning mess behind you.  He howls as he claws the ground, his barbed cock still rock hard beneath him.  As you walk away, you notice a group of imps watching you and the jaguar demon with their cocks out and leaking, their jagged teeth spread into feral grins.  You even spy a few goblins mixed in the crowd, and each is twirling a bottle of liquid while playing with their snatches.\n\n', false );
			EngineCore.outputText( 'Akbal snarls as you leave, the creatures that once feared him using his aroused state to get revenge on the \'god\' of the terrestrial fire.  Even after you\'ve reached the edge of the forest, the jaguar demon\'s pained howls can still be heard – though, just barely over the high-pitched laughter of the demon imps and the cackling of the goblin females.', false );
		}
		CoC.getInstance().player.orgasm();
		EngineCore.dynStats( 'cor', 1 );
	...
	AkbalScene.prototype.girlsRapeAkbal = function() {
		CoC.getInstance().flags[ kFLAGS.AKBAL_BITCH_Q ]++;
		EngineCore.outputText( '', true );
		EngineCore.outputText( 'You smirk to yourself quietly as the so called "God of Terrestrial Fire" lays in a twitching heap on the ground, his flesh squirming as he shifts into his more humanoid form. Removing your ' + CoC.getInstance().player.armorName + ', your hand lowers to your feminine slit, pondering how to make use of him.\n\n', false );
		//{If Centaur}
		EngineCore.outputText( ImageManager.showImage( 'akbal-deepwoods-female-bindakbal' ) );
		if( CoC.getInstance().player.isTaur() ) {
			EngineCore.outputText( 'Already you can see the trouble of trying to accommodate someone with your body type, but as they said in your village, "<i>where there\'s a will, there\'s a way</i>". Grabbing some of the vines from the nearby trees, you approach the nearly comatose Akbal and sling him over your back, grinning as you work through the details in your mind.\n\n', false );
			EngineCore.outputText( 'Before the feline demon can recover and protest, you bind his arms to the end of the longest vines, throwing them over some of the stronger branches to make a makeshift pulley system. Hauling him up against the bark of the tree, he stirs slightly, but is still unable to work up the strength to fight back. Making the most of the time you figure you have left before he fully awakens, you bind his feet near the base of the tree, effectively turning him into a mounted toy for you to impale your ' + Descriptors.vaginaDescript() + ' upon.\n\n', false );
			EngineCore.outputText( 'With his arms and legs bound, you take the time to examine your prize, reaching forward to stroke his full, baseball sized sack and swinging barbed shaft. It looks that despite the fact that you beat him into submission, the demon isn\'t totally opposed to the idea as he stirs to life in your hand, throbbing slightly. The jaguar starts to open his emerald eyes and glares at you, but nonetheless tries to push his hips forward, giving a snarl of annoyance when he can\'t work get proper leverage on the tree thanks to your binding.\n\n', false );
			EngineCore.outputText( 'Keeping the vines holding his arms up in hand, you slowly turn around and lift your tail, allowing your sopping mare cunt to wink at Akbal', false );
			if( CoC.getInstance().player.hasCock() ) {
				EngineCore.outputText( ' ' + Descriptors.sMultiCockDesc() + ' hanging beneath, twitching in anticipation', false );
			}
			EngineCore.outputText( '. With a smirk at the helpless Gods expense, you take a step back, lining up before pushing yourself against him roughly, shoving his barbed feline shaft deeply into you.', false );
		}
		//{If Pussy is <loose}
		else if( CoC.getInstance().player.vaginalCapacity() < CoC.getInstance().monster.cockArea( 0 ) ) {
			EngineCore.outputText( 'Rolling him over onto his back with your foot, you tsk in annoyance, knowing that you won\'t be able to fit his large kitty-cock between your legs without some considerable pain, and you don\'t really trust the demon to let his mouth, with all those oh-so-sharp teeth, near your most sensitive areas. Thankfully, another option is available, currently twitching around your feet.\n\n', false );
			EngineCore.outputText( 'Reaching down, you grab his flicking tail, ignoring his feline yowl of discomfort, stroking the spotted, silky smooth fur with a few fingers, the sensation creating shivers of lust up your spine. Already ImageManager bloom in your mind, creating all kinds of acts you could use this appendage for and plucking the most prominent one from your mind, you grab the demon cat by the scruff of his neck, ', false );
			//({If strength >60}
			if( CoC.getInstance().player.str > 60 ) {
				EngineCore.outputText( 'hauling him towards a tree like a newborn kitten', false );
			} else {
				EngineCore.outputText( 'dragging him towards the nearest tree', false );
			}
			EngineCore.outputText( ' and forcing him to lean back against it.\n\n', false );
			EngineCore.outputText( 'Gripping his tail once more, you grab him by the fur of his head and yank him down to meet the tip, pressing insistently against his lips. Even in his weakened state Akbal refuses until you happen to glance down between his legs. It seems like the demon is more turned on by you taking charge than he would like to admit.  ', false );
			//({if Naga}
			if( CoC.getInstance().player.isNaga() ) {
				EngineCore.outputText( 'You curl the tip of your tail around his length, catching the barbs lightly on your scales and squeezing, coaxing a low yowl of pleasure which you hurriedly make use of, ', false );
			}//{If Goo}
			else if( CoC.getInstance().player.isGoo() ) {
				EngineCore.outputText( 'You focus, extending a small part of your liquid-like body, enveloping his feline meat in yourself, careful to avoid the tip. The sensation of damp warmth around his feline member is too much, making him open his mouth in a silent moan which you hastily use, ', false );
			} else {
				EngineCore.outputText( 'Lifting up your ' + CoC.getInstance().player.leg() + ', you firmly place the sole of your foot against his barbed flesh, pressing it against his stomach, forcing the jaguar to let out a low moan which you quickly take advantage of, ', false );
			}
			EngineCore.outputText( 'stuffing his own tail into his maw.  As he tries to push his tail back out, you remove your ' + CoC.getInstance().player.foot() + ' pointedly, staring down at the demon. Lifting his hips back up weakly towards you, he meekly begins to suckle on his own appendage, closing his vibrant emerald eyes as you return your attention to his shaft.\n\n', false );
		}
		//{If Pussy >= Loose}
		else {
			EngineCore.outputText( 'You grin as you flip him over onto his back, staring down at his breeding tool between his legs, firmly erect as it rests on his rather full set of balls. Quite clearly, this "<i>God</i>" hasn\'t had much action for quite some time, hence his aggressive nature towards you. You finger yourself slightly as you examine his feline shaft, coated with layers of barbs that look as though they would be quite painful. Leaning down, you run your fingers over them, smirking as they bend slightly. They may not be enough to harm you, but sex would definitely be unpleasant... unless you happened to have a source of suitable lube nearby.\n\n', false );
			EngineCore.outputText( 'Remembering the cats back home', false );
			//({If player has the flexibility Perk}
			if( CoC.getInstance().player.findPerk( PerkLib.Flexibility ) >= 0 ) {
				EngineCore.outputText( ' and your own experience with such matters', false );
			}
			EngineCore.outputText( ', you figure you have a pretty good idea where a reliable source of lube could be. You grin as you grab the demon cat by the scruff of his neck, ', false );
			//({If strength >60}
			if( CoC.getInstance().player.str > 60 ) {
				EngineCore.outputText( 'hauling him towards a tree like a newborn kitten', false );
			} else {
			...
			EngineCore.outputText( ' and forcing him to lean back against it.\n\n', false );
			EngineCore.outputText( 'In his dazed state, Akbal offers little resistance when you position him against the tree. That changes however, when you grab the hair of his head and push him down towards his own straining cock. Angry whispers flit at the edge of your mind, easily brushed aside as you reach down and squeeze the demon\'s cheeks, forcing his mouth to open. Quickly, you plug his maw with his own shaft, holding his head down, forcing him to coat his meat with his own saliva.  ', false );
			//{If Corruption <30}
			if( CoC.getInstance().player.cor < 33 ) {
				EngineCore.outputText( 'In a brief moment of pity you reach down, stroking Akbal\'s strained balls as he suckles, feeling them quiver as he noisily slurps and drools.', false );
			} else {
				EngineCore.outputText( 'You smirk, grabbing his full sack almost roughly, shaking them as he stares at you with his emerald eyes, although with rage or lust you can\'t quite tell.', false );
			}
			EngineCore.outputText( '\n\n', false );
			EngineCore.outputText( 'Finally, you judge that he\'s done enough, allowing him to lift his head back up with a splutter, although considering the flowing pre around his tip and over his lips, the experience was hardly a painful one. He glares at you with his burning green eyes as you ', false );
			//({if Player is naga}
			if( CoC.getInstance().player.isNaga() ) {
				EngineCore.outputText( 'rear up, supporting your weight on your own tail as your hands explore down below, finding your puffed up slit and slowly parting them with a pair of fingers, allowing your scent and dampness to coat the jaguar\'s snout.', false );
			} else if( CoC.getInstance().player.isGoo() ) {
				EngineCore.outputText( 'reach out, your liquid-like body coating his legs and holding them open, your hands reaching down to play with your damp, open fuck hole, chuckling as he tries to feign disinterest despite the obvious throbbing of his sack.', false );
			} else {
				EngineCore.outputText( ' begin to stand over him, spreading your legs to reveal your damp, open pussy, his expression turning comically from rage to confusion to one of sheer lust, the feline licking his lips despite his own flavor on them.', false );
			}
			EngineCore.outputText( '\n\n', false );
			EngineCore.outputText( 'Judging by the shudder of longing that runs through his body, it\'s clear that he\'s more turned on by your actions than he would have liked. Using your lower body to pin his legs down, you grab his arms as you sink down, moaning more for his benefit as you brush the tip of his slick member against your entrance.', false );
		}
		EngineCore.dynStats( 'lus', 50 );
		//-Page Turn-
		EngineCore.doNext( this.girlsRapeAkbalPart2 );
	};
	AkbalScene.prototype.girlsRapeAkbalPart2 = function() {
		EngineCore.outputText( '', true );
		EngineCore.hideUpDown();
		//Centaur
		EngineCore.outputText( ImageManager.showImage( 'akbal-deepwoods-female-taur-bindakbal' ) );
		if( CoC.getInstance().player.isTaur() ) {
			EngineCore.outputText( 'You moan deeply as the thick shaft spreads your lips wide, throbbing against your clit as the barbs shudder against your inner walls, pushing your rump firmly against his lower abdomen as you squirm, leaking over his waist', false );
			if( CoC.getInstance().player.hasCock() ) {
				EngineCore.outputText( ', ' + Descriptors.sMultiCockDesc() + ' swinging back and forth, occasionally bumping into his bound legs', false );
			}
			EngineCore.outputText( '. The demon groans, clenching his eyes shut as he refuses to like the treatment you\'re forcing on him, but his body betrays him as a liar as his felinehood thickens and lengthens, more than eager to stuff your box full. It\'s with no small shiver of delight when you drink in his moans of longing as you pull back to the very tip of his cock.\n\n', false );
			//({If Corruption > 30}
			if( CoC.getInstance().player.cor > 33 ) {
				EngineCore.outputText( 'If you weren\'t so eager on using him to get off, you might have considered teasing him like that then leaving him bound to the tree.  ', false );
			}
			EngineCore.outputText( 'Quickly, you settle into a rhythm of rocking back and forth, the tree creaking as you throw your weight against it with every plunge down, the cat behind you reduced to a mewling, begging kitten, trying in vain to thrust into your sopping cunt.\n\n', false );
			EngineCore.outputText( 'You continue like this for the better part of an hour, his barbs raking your insides and sending constant shivers through your body, but you just can\'t seem to get off on your bounces alone. Without really thinking it through, you release the vines holding Akbal\'s arms up to grope your own ' + Descriptors.chestDesc() + ', fondling yourself roughly.\n\n', false );
			EngineCore.outputText( 'Thankfully, Akbal is just as desperate to get off as you as he makes use of his new found freedom, one hand clutching the base of your tail, the other grabbing your flank with a clawed paw. Immediately he snarls, shoving his feline dong deep into you, a much better sensation then when you were merely rocking on him, your mare cunt squirting and clenching around him, trying to milk his seed', false );
			if( CoC.getInstance().player.hasCock() ) {
				EngineCore.outputText( ', while your cock slaps at your stomach, pre flying from the tip to coat your lower body and the earth below', false );
			}
			EngineCore.outputText( '. He buries himself deep over and over, his fat, swollen balls slapping against you, feeling oddly natural', false );
			if( CoC.getInstance().player.balls > 0 ) {
				EngineCore.outputText( ', your own swaying back to meet him', false );
				//({If >=Grapefruit}
				if( CoC.getInstance().player.ballSize >= 12 ) {
					EngineCore.outputText( ' dwarfing him despite his pent up lusts', false );
				}
			}
			EngineCore.outputText( ', coaxing moans and groans of sheer pleasure to mingle with his snarls and purrs of enjoyment.\n\n', false );
			EngineCore.outputText( 'In the end the jaguar finishes first, roaring his pleasure to the trees as he squirts his kitten-cream into your cunt, filling you up. If you were in any state to guess, you could probably imagine the cat filling up your womb as well judging by the swelling of your lower body, causing a flash of concern, wondering if the feline could possibly impregnate your womb. He\'s not finished however, as he continues to thrust through his release, pulling you higher and higher into orgasmic bliss as you finally release in tandem with his fifth orgasm. Your ' + Descriptors.vaginaDescript() + ' clenches tightly over him, coating his waist in fem juices as you milk him', false );
			if( CoC.getInstance().player.hasCock() ) {
				EngineCore.outputText( ' as ' + Descriptors.sMultiCockDesc() + ' twitch and let loose, spraying the ground with your seed', false );
			}
			EngineCore.outputText( '.\n\n', false );
			EngineCore.outputText( 'Your body trembles as the demon sags down onto your lower back, clutching your equine hips lightly, as you want nothing more but to simply sag down with him, his weight oddly comfortable on your back. Shaking your head to clear it, you begin to turn round, careful not to dislodge Akbal from his obviously comfortable position as you feel him slowly start to shift back into his quadruped form, his dripping shaft slipping out of your pussy with an obscene slurping noise. Lowering your tail, you let the demon slip off, fumbling with the vines around his feet, releasing him as he sprawls on the ground in pure contentment. As you straighten up and start to head back to camp, you realize you feel the same way; perfectly content. Maybe it wouldn\'t be a bad idea to look out for the God in the future...', false );
			//Imp pregnancy
			//Preggers chance!
		...
		//TOIGHT
			...
			//-Page Turn-
			EngineCore.outputText( 'Judging the silky fur to be slick enough, you yank out the tail from his mouth, pulling it towards your ' + Descriptors.vaginaDescript() + ' lips, teasing your folds with the tip before guiding him in. Taking the hint, the feline squirms his tail, pushing into you as he lifts his hips up once more, purring lightly as he presses himself against your ' + CoC.getInstance().player.foot() + '.  His cock is already leaking pre from the tip.  You gasp loudly as his fur bristles inside you, his saliva making your womanhood quiver in need as you feel him slip deeper, coiling and twisting. Making sure not to neglect the feline, you', false );
			//({If Naga}
			if( CoC.getInstance().player.isNaga() ) {
				EngineCore.outputText( ' squeeze his meat tighter, moving your coils up and down his feline prick while using the very tip of your tail to tease and poke his urethra, coating it in his pre', false );
			}
			//({If Goo} else if (CoC.getInstance().player.isGoo())
			EngineCore.outputText( ' squirm and writhe over the base of his feline shaft, vibrating your liquid-like appendage like a living sex toy, causing his balls to jiggle slightly', false );
			//({If Bipedal} else 					EngineCore.outputText(' press his shaft firmer against his stomach, slowly slipping the sole of your foot up and down his length, coaxing out small yowls and purrs of pleasure', false);
			EngineCore.outputText( ' as silent payment for the pleasure he\'s flooding your pussy with.\n\n', false );
			...
			if( CoC.getInstance().player.hasCock() ) {
				EngineCore.outputText( ' as ' + Descriptors.sMultiCockDesc() + ' offers up its bounty, spasming and adding to the mess', false );
			}
			EngineCore.outputText( '. The added heat and wetness of your orgasm sets him over the edge as he gives a roar loud enough to shake the trees, his thick, barbed shaft squirting hard, arcing his back as his seed splats onto the leaves of the tree above, falling down as a perverse rain over the pair of you.\n\n', false );
			EngineCore.outputText( 'Your ' + Descriptors.chestDesc() + ' chest heaves as you struggle to gulp air, ' + CoC.getInstance().player.legs() + ' quivering from the sheer power of the orgasm the cat\'s tail gave you.  ', false );
			//({if cum volume > normal}
			if( CoC.getInstance().player.cumQ() > 500 ) {
				EngineCore.outputText( 'His entire waist is coated in your juices, the once proud cat sitting in a pool of your leavings, with a contented grin on his face, like the cat that caught the canary', false );
			}
			//({If cum volume low/normal} else 					EngineCore.outputText('He sits, dazed as your cum covers his groin, his meat still shiny from the torrent you dropped down upon it. Nevertheless, his face is twisted into a purr', false);
			EngineCore.outputText( ' as he sags against the tree trunk, overwhelmed by the pleasure. With a satisfied grin of your own, you pick up your ' + CoC.getInstance().player.armorName + ' and head out. Perhaps you should look out for the "<i>God of Terrestrial fire</i>" again sometime...', false );
		...
		//Loose
			...
			EngineCore.outputText( 'You groan loudly as Akbal\'s impressive shaft stretches your pussy wide, instantly thankful that you had the idea to lube him up beforehand. Your less-than-willing partner adds his own groan to yours, the twitching of his meat signalling that he\'s not quite to opposed to the idea as he makes out. Maybe he\'s got a thing about dominance, from either angle. Nevertheless, you continue to push down until your hips reach his with a light bump. The sensation of his immense cock filling you up causes you to shudder, before leaning into the demon, pressing your ' + Descriptors.chestDesc() + ' against his, revealing in his silky fur stroking multiple parts of your body all at once. The yowling male takes off, ducking his head to lick and nip at your ' + Descriptors.nippleDescript( 0 ) + 's', false );
			//({If Lactating}
			if( CoC.getInstance().player.biggestLactation() >= 1 ) {
				EngineCore.outputText( ', adding a purr of pleasant surprise as he locks his lips around one nipple, drawing out mouthfuls of your sweet milk before gulping it down.  The sheer taboo of feeding a demon your milk sends shivers down your spine', false );
			}
			EngineCore.outputText( '.\n\n', false );
			EngineCore.outputText( 'As you lift yourself off, your head begins to swim as his previously unnoticed barbs rake along your inner walls, tugging, catching and massaging from the inside as they start to vibrate, causing you to ', false );
			//({if Naga}
			if( CoC.getInstance().player.isNaga() ) {
				EngineCore.outputText( 'wrap your coils around him and the tree, adding leverage to your plunges down', false );
			}
			//({If Goo} else if (CoC.getInstance().player.isGoo())
			EngineCore.outputText( 'encase yourself around his hips and groin, your entire lower body writhing and squirming around his shaft', false );
			//({If Bipedal} else 					EngineCore.outputText('lock your legs around his torso, bouncing upon him with greater force', false);
			EngineCore.outputText( '.  As your mouth hangs open, the demon lunges forward, pressing his own snout against your ' + CoC.getInstance().player.face() + '. You can still taste the traces of his own pre on his lips and tongue, furthering your lust as you use his groin roughly, impaling yourself hard enough to leave bruises on the pair of you, while he uses his tail to ', false );
			//({if herm}
			if( CoC.getInstance().player.cockTotal() === 1 ) {
				EngineCore.outputText( 'wrap around your own straining shaft, the fur enhancing the effects of his pumps', false );
			}
			//({If more than 1 cock} else if (CoC.getInstance().player.cockTotal() > 1)
			EngineCore.outputText( 'wrap around each of your throbbing malehoods with difficulty, teasing them with his bristled fur', false );
			//({If female} else 					EngineCore.outputText('stroke and tickle your ass and lower back', false);
			EngineCore.outputText( '.\n\n', false );
			EngineCore.outputText( 'You\'re not sure how long you sit there, bouncing roughly on the feline demon\'s cock, his eyes clenched tightly shut as he revels in the feeling of your warm damp pussy and your ' + Descriptors.buttDescript() + ' grinding against his swollen sack. Eventually, his combined efforts of mouth, shaft and tail force you over the edge, your hungry pussy lips clenching tightly over him, rhythmically squeezing as you attempt to milk his shaft', false );
			//({if Herm}
			if( CoC.getInstance().player.hasCock() ) {
				EngineCore.outputText( ' as ' + Descriptors.sMultiCockDesc() + '  twitches and strains, ready to blow', false );
			}
			EngineCore.outputText( ', and he certainly doesn\'t disappoint. With a roar loud enough to shake the trees, he erupts violently within your passage, his hot, steaming, fertile seed pouring into your depths', false );
			//({if Herm}
			if( CoC.getInstance().player.cockTotal() === 1 ) {
				EngineCore.outputText( ', setting your own malehood off in sympathy, squirting thick cream over his chest', false );
			} else if( CoC.getInstance().player.cockTotal() > 1 ) {
				EngineCore.outputText( ' setting each of your malenesses surging, splattering the feline with your seed', false );
			}
			EngineCore.outputText( ', his face twisted into a snarl of pleasure and satisfaction.\n\n', false );
			EngineCore.outputText( 'You slowly come down from your orgasmic high, struggling to remove yourself from the demon\'s lap and heading unsteadily towards your ' + CoC.getInstance().player.armorName + ' as fresh feline seed pours down your body, wincing at the slight bruising to your womanhood. Rubbing a hand over your stomach, you start to wonder if perhaps it was a touch risky to allow a demon to shoot his seed into your womb. However, despite the mild throbbing, you feel refreshed and oddly strengthened by Akbal\'s potent seed, glancing over your shoulder to see the once proud god reveling in his own release. Perhaps it wouldn\'t be a bad idea to seek him out some other time...', false );
			CoC.getInstance().player.orgasm();
			EngineCore.dynStats( 'cor', 1 );
			//Imp pregnancy
			//Preggers chance!
	...
	AkbalScene.prototype.loseToAckballllllz = function() {
		...
		if( CoC.getInstance().player.lowerBody !== AppearanceDefs.LOWER_BODY_TYPE_CENTAUR ) {
			EngineCore.outputText( ImageManager.showImage( 'akbal-deepwoods-losslust-analed' ) );
			EngineCore.outputText( 'You fall to your knees and begin to feverishly masturbate.  Akbal rises onto his two hind legs, his body shifting into a more humanoid form as he stands.  His long cock swings ominously between his legs as he walks towards you.  The first thing he does is pull his massive 15-inch cock to your lips, slapping the shaft against your chin.\n\n', false );
			EngineCore.outputText( 'Like a whore in heat, you open your mouth and lewdly lick the jaguar demon\'s cock head, feeling odd barbs rub against your tongue.  Your mouth opens wide, but can\'t even get past the head before the sheer girth of Akbal\'s massive sex organ halts its advance.  Akbal is content to let you orally fumble with the head for only a few moments before he pushes down onto your back. His claws tickle your thighs as he forces your ' + CoC.getInstance().player.legs() + ' up over your head, bringing your ' + Descriptors.assholeDescript() + ' into plain view.\n\n', false );
			EngineCore.outputText( '"<i>Defiance repaid,</i>" is all you hear from the chorus of voices in your head as Akbal displays his massive length to you.  Your eyes widen in horror, counting a dozen wicked-looking barbs on the head of his overtly thick and over-sized cock.\n\n', false );
		}
		//Centaurs R SPECIALZ
		else if( CoC.getInstance().player.lowerBody === AppearanceDefs.LOWER_BODY_TYPE_CENTAUR ) {
			EngineCore.outputText( ImageManager.showImage( 'akbal-deepwoods-losslust-taur-analed' ) );
			EngineCore.outputText( 'You stumble like a drunken pony as your lust goes into the red zone and you know in the pit of your stomach that you are at this wicked demon\'s mercy.\n\n', false );
			EngineCore.outputText( 'Akbal rises onto his two hind legs, his body becoming more humanoid as he does. His long, semi-erect cock swings ominously his legs as he walks towards you.\n\n', false );
			EngineCore.outputText( '"<i>Defiance repaid,</i>" is all you hear from the chorus of voices in your head as Akbal displays his massive length to you. Your eyes widen in horror as you count a dozen wicked looking barbs on the head of his overtly thick, gargantuan cock.\n\n', false );
			//(Small/Virgin Pucker)
			if( CoC.getInstance().player.ass.analLooseness < 3 ) {
				EngineCore.outputText( 'Akbal begins to push into you, the barbs on his massive head causing you to howl as your ' + Descriptors.assholeDescript() + ' is forcibly stretched. His jaguar claws grab your sides as he uses your body as leverage to force his demonic erection into you.\n\n', false );
				EngineCore.outputText( 'When Akbal shoves forward the strain makes you feel as though you are going to pass out; the pain from his spiked sex organ is just enough to leave you conscious. He begins to withdraw and you realize he\'s not even forcing half the length of that swollen sex organ into your ' + Descriptors.assholeDescript() + '.\n\n', false );
				EngineCore.outputText( 'After hours of Akbal\'s long cat dick being slowly forced into your ' + Descriptors.assholeDescript() + ' your body gives out and you become too exhausted from the strain to even lift your arms. With a triumphant growl Akbal thrusts forward, his cock head spikes burying themselves into you but, without your resistance, they seem to vibrate inside you like twelve little beads massaging your innards. The sudden change makes you croon as you paw the ground with your hooves, suddenly desperate for more.', false );
			}
			//(Medium Pucker)
			else if( CoC.getInstance().player.ass.analLooseness < 5 ) {
				EngineCore.outputText( 'Akbal begins to push into you, the barbs on his massive cock head causing you to wince as you are forcibly stretched. Without warning he forces the entirety of his massive length into you with a snarl. The initial incursion makes you grind your teeth as that spiked rod invades your ' + Descriptors.assholeDescript() + '.  You widen your stance in an attempt to lessen the sudden slicing pressure created by the barbed cock head. The moment you do the barbs start to vibrate, beginning to feel more like humming sex beads than the wicked looking battering ram you know is inside you. You can\'t suppress the sudden sounds coming from your throat and exclaiming your ecstasy to your rapist.', false );
			}
			//(Gapping Pucker)
			//[hp heals 50% after this if that's ok with
			//you Fen]
			else {
				EngineCore.outputText( 'Akbal begins to push into you, the barbs on his massive cock head causing you to wince. He bottoms out instantly and you hear a pleased purr behind you. As he begins to pump his blood engorged sex organ in and out of your ' + Descriptors.assholeDescript() + ' with steadily mounting force you can\'t help but wonder why the barbs aren\'t causing you pain. You release a groan as those very barbs start to vibrate and begin feeling more like humming sex beads than punishing spikes.\n\n', false );
				EngineCore.outputText( 'Akbal snarls as he slams his hips into you, obviously happy that you\'re able to take his massive length. The demon appears to forget he\'s raping you and begins licking the back of your horse-like bottom half, sending shivers throughout your entire body as he roughly fucks you while painting your back with his saliva.', false );
			}
			CoC.getInstance().player.buttChange( new Akbal().cockArea( 0 ), true );
			EngineCore.outputText( '\n\n', false );
			//(Ending)
			EngineCore.outputText( 'The entire length of Akbal\'s embedded cock begins to hum inside you, causing you to cry out as he picks up the pace. His every thrust is a hammer-like thump against your hungry cheeks. Without warning his thrusts become sloppy and you feel his giant tool swelling inside you, stretching you out even more.\n\n', false );
			EngineCore.outputText( 'Suddenly Akbal roars as he reaches his climax. You feel his giant cock hosing down your insides, filling you with his corrupted demon seed as he rides out his orgasm. His hips never stop. You feel your own orgasm rising to the surface only to suddenly fizzle out and you realize the corrupted seed inside you is actually stopping you from reaching climax. Akbal, however, sprays his spunk into your ' + Descriptors.assholeDescript() + ' again and again and never slows for a moment. Soon your stomach is obscenely swollen and you even taste cat jizz in your throat. Yet Akbal just keeps going, brutally fucking your helpless body and denying you release.\n\n', false );
			EngineCore.outputText( 'After hours of being his toy you pass out, never having reached your own orgasm.', false );
			EngineCore.dynStats( 'lust+', 10 + CoC.getInstance().player.lib / 10, 'cor+', 5 + Utils.rand( 10 ) );
			return;
			//Centaur over
		}
		if( CoC.getInstance().player.ass.analLooseness < 3 )
		//[Small/virgin pucker]
		{
			EngineCore.outputText( 'Akbal begins to push into you, the barbs on his massive cockhead causing you to howl as your ' + Descriptors.assholeDescript() + ' is forcibly stretched.  His jaguar claws grab your shoulders, and he uses your body as leverage to force his demonic erection into you.\n\n', false );
			EngineCore.outputText( 'The strain from Akbal\'s shoving makes you feel like you\'re going to pass out, yet the pain from his spiked sex organ keeps you conscious. After a while, you realize he\'s not even fucking you with his entire length; his swollen member is slowly forcing less than half its massive length into your ' + Descriptors.assholeDescript() + '.\n\n', false );
			EngineCore.outputText( 'After what seems like hours of Akbal\'s long cat dick being slowly forced into your ' + Descriptors.assholeDescript() + ', your body finally gives out. You\'ve become so exhausted from the strain that you can barely even lift your arms.  With a triumphant growl Akbal thrusts forward, his cockhead spikes burying themselves into you.  Without your resistance, they seem to vibrate inside you like twelve little beads, massaging your innards.  The sudden change makes you croon as you widen your ' + CoC.getInstance().player.legs() + ', suddenly desperate for more.', false );
		} else if( CoC.getInstance().player.ass.analLooseness < 5 ) //[Medium pucker]
		{
			EngineCore.outputText( 'Akbal begins to push into you, the barbs on his massive cockhead causing you to wince as are forcibly stretched.  Without warning, he forces the entirety of his massive length into you in with a snarl.  You almost pass out just from the initial incursion, but as he saws his length in and out, your body reacts of its own accord. You widen your ' + CoC.getInstance().player.legs() + ' in an attempt to lessen the sudden slicing pressure created by the barbed cock head.  The moment you stop resisting, the barbs start to vibrate; they start to feel more like humming sex beads than the wicked-looking barbs you know are inside you.  You can\'t suppress the shuddering and groaning coming from your body as you are hit with a tidal wave of ecstasy.', false );
		}
		//[Gaping pucker]
		else {
			EngineCore.outputText( 'Akbal begins to push into you, the barbs on his massive cockhead causing you to wince.  He bottoms out near-instantly, and he looks up at you with a feral grin.  Akbal begins to pump his engorged sex organ in and out of your ' + Descriptors.assholeDescript() + ' with a steadily mounting force.  You release a groan as the barbs covering Akbal\'s long cat-dick start to vibrate and begin to feel more like humming sex beads than anything else.  You widen your ' + CoC.getInstance().player.legs() + ' in response and Akbal snarls as he slams his hips into you, obviously happy that you\'re able to take his massive length.  The demon seems to forget that he\'s raping you; he starts giving your neck licks that send shivers throughout your entire body as he roughly fucks you into the forest floor.', false );
		}
		CoC.getInstance().player.buttChange( new Akbal().cockArea( 0 ), true );
		EngineCore.outputText( '\n\n', false );
		EngineCore.outputText( 'Akbal\'s embedded cock begins to hum inside you, causing you to cry out as he picks up the pace.  His every thrust is a hammer-like thump against your spread ' + CoC.getInstance().player.legs() + '.  Suddenly his thrusts become sloppy, and you feel his giant tool swelling inside you, stretching you out even more.  Akbal roars as he reaches his climax, and you feel his giant cock hosing down your insides, filling you with his corrupted demon seed as he rides out his orgasm.  His hips never stop.  You feel your own orgasm rising to the surface, only to suddenly fizzle out.  It is with horror that you realize that the corrupted seed inside you is actually stopping you from reaching climax.  Akbal, however, sprays his spunk into your ' + Descriptors.assholeDescript() + ' again and again, not slowing for even a moment.  Soon your stomach is obscenely swollen, and you even taste cat jizz in your throat.  Yet Akbal just keeps going, brutally fucking you into the ground.\n\n', false );
		EngineCore.outputText( 'After hours of being his toy you finally pass out, never having reached your own orgasm.', false );
		EngineCore.dynStats( 'lust+', 10 + CoC.getInstance().player.lib / 10, 'cor+', 5 + Utils.rand( 10 ) );
	};
	...
	AkbalScene.prototype.supahAkabalEdition = function() {
		...
		CoC.getInstance().monster.createCock();
		CoC.getInstance().monster.cocks[ 0 ].cockLength = 15;
		CoC.getInstance().monster.cocks[ 0 ].cockThickness = 2.5;
		CoC.getInstance().monster.cocks[ 0 ].cockType = CockTypesEnum.HUMAN;
		if( CoC.getInstance().flags[ kFLAGS.AKBAL_BITCH_Q ] >= 2 ) {
			this.akbitchEncounter();
			return;
		}
		if( CoC.getInstance().flags[ kFLAGS.AKBAL_SUBMISSION_STATE ] === 2 ) {
			this.repeatAkbalPostSubmission();
			return;
		}
		if( CoC.getInstance().flags[ kFLAGS.AKBAL_SUBMISSION_STATE ] === 1 ) {
	...
	AkbalScene.prototype.ackbalRepeatAfterWin = function() {
		EngineCore.spriteSelect( 2 );
		EngineCore.outputText( '', true );
		EngineCore.outputText( 'As you walk through the forest, you hear a snarl and look up just in time to dodge a surprise attack by the jaguar demon, Akbal.  Your ', false );
		if( CoC.getInstance().player.lowerBody === AppearanceDefs.LOWER_BODY_TYPE_CENTAUR ) {
			EngineCore.outputText( 'equine leap places you a good distance away from him.  Do you fight or flee?\n\n', false );
		} else {
	...
	AkbalScene.prototype.startuAkabalFightomon = function() {
		EngineCore.spriteSelect( 2 );
		EngineCore.outputText( '', true );
		EngineCore.outputText( 'You ready your ' + CoC.getInstance().player.weaponName + ' and prepare to battle the demon jaguar.', false );
		//[battle ensues]
		Combat.startCombat( new Akbal() );
		CoC.getInstance().flags[ kFLAGS.PLAYER_RESISTED_AKBAL ]++;
	};
	//[Submit]
	AkbalScene.prototype.akbalSubmit = function() {
		EngineCore.spriteSelect( 2 );
		CoC.getInstance().player.slimeFeed();
		CoC.getInstance().flags[ kFLAGS.AKBAL_SUBMISSION_COUNTER ]++;
		CoC.getInstance().flags[ kFLAGS.AKBAL_SUBMISSION_STATE ] = 2;
		CoC.getInstance().flags[ kFLAGS.AKBAL_BITCH_Q ] = -1;
		//Big booty special
		if( CoC.getInstance().flags[ kFLAGS.AKBAL_SUBMISSION_COUNTER ] > 5 && CoC.getInstance().flags[ kFLAGS.PLAYER_RESISTED_AKBAL ] < 2 && CoC.getInstance().player.buttRating >= 13 && CoC.getInstance().player.tone < 80 ) {
		...
		if( CoC.getInstance().player.lowerBody === AppearanceDefs.LOWER_BODY_TYPE_NAGA ) {
			EngineCore.outputText( ImageManager.showImage( 'akbal-deepwoods-naga-sumbitanal' ) );
			EngineCore.outputText( 'After a few moments of thinking you nod to Akbal and the masculine voice in your head commands you to disrobe. You take off your ' + CoC.getInstance().player.armorName + ', setting it aside moments before the demon is upon you.\n\n', false );
			EngineCore.outputText( 'Akbal pushes you face first into the ground and places his forward paws on your back, pinning your chest against the ground. He removes the paw and you attempt to reposition yourself only to have your body pushed back down, a silent command for you to stay in this position.  You can\'t help but squirm a little as your bottom half is bunched up under your abdomen, putting your ' + Descriptors.buttDescript() + ' in the air.\n\n', false );
			EngineCore.outputText( 'His paws slide to your waist, melting into hands along the way. You look from beneath your arm and watch as Akbal\'s body changes, becoming more humanoid.  Once his transformation is complete he gets on his knees behind you and roughly pulls your upturned bottom half back.  When he shoves his face into your ' + Descriptors.buttDescript() + ' you flinch at the sudden and inexplicably erotic feeling.\n\n', false );
			EngineCore.outputText( 'He works his slippery wet tongue into your ' + Descriptors.assholeDescript() + ', greedily lapping at your exposed backside as if it were a quickly-melting ice cream cone. The sensation causes you to groan as you push back against the tongue, suddenly lost in ecstasy. A part of your long tail wraps around his waist, holding him there as you revel in the sensation of being rimmed by a pro.  You even arch your back, allowing his long, thick jaguar tongue to penetrate deeper into your ' + Descriptors.assholeDescript() + '. You feel his saliva, thick and warm like melted candy, sliding inside of you and coating your insides.\n\n', false );
			//(transition)
			EngineCore.outputText( 'A sudden warmth heats your innards, making you shiver in ecstasy.  Akbal takes a moment to uncoil your bottom half from around his chest before he rises to mount you. A single paw shoves your lifted chest and face back into the dirt, causing cold earth to cling to your body as Akbal gets into position above you.\n\n', false );
			//(Small/Virgin Pucker)
			if( CoC.getInstance().player.ass.analLooseness < 3 ) {
				EngineCore.outputText( 'You feel him poking around your ' + Descriptors.assholeDescript() + ' and quickly realize his member is not only insanely large but its head is covered in a dozen tiny barbs. You grit your teeth, expecting pain and yet, thanks to the weird saliva he slathered your innards with, there is none as his gargantuan member forcibly widens your ' + Descriptors.assholeDescript() + '.\n\n', false );
			...
			//(Medium Pucker)
				...
				EngineCore.outputText( 'You feel him poking around your ' + Descriptors.assholeDescript() + ' and quickly realize his member is not only quite large but covered in almost a dozen tiny barbs. Yet, thanks to the weird spit he slathered your innards with, there is none as his gargantuan member forcibly widens your ' + Descriptors.assholeDescript() + '.\n\n', false );
				EngineCore.outputText( 'Akbal\'s titanic member stretches your ' + Descriptors.assholeDescript() + ' and makes you groan beneath him, reveling in the slick heat and fullness of your bowels. His saliva heats up, creating a steamy,pleasurable warmth inside your body. As he begins to pump his huge sex organ in and out of you the barbs covering his head begin to vibrate and hit your body with tidal waves of unbearable pleasure, feeling more like vibrating sex beads than punishing spikes. Your body begins to act of its own accord, your ' + Descriptors.buttDescript() + ' grinding against his thrusts as his large sex pump slides in with his trunk slamming into your ' + Descriptors.buttDescript() + ' in rhythmic, echoing claps.', false );
			}
			//(Gapping Pucker - Akbal's dick = 15 inches)
			else {
				EngineCore.outputText( 'You feel him poking around your ' + Descriptors.assholeDescript() + ' and quickly realize his member is not only quite large but covered in almost a dozen tiny barbs. When Akbal begins to penetrate you he is surprised when his trunk suddenly slams into your ' + Descriptors.buttDescript() + ', the sudden invasion causing you to croon.\n\n', false );
				EngineCore.outputText( 'The weird spit he slathered your insides with begins to heat up instantly and the barbs covering his cock head start vibrating. The sensation of the vibrating barbs is like a dozen small slimy sex beads spinning and shaking as they are pushed inside you. Akbal wastes no time and begins forcibly fucking your ' + Descriptors.assholeDescript() + ' with reckless abandon, his every brutal thrust causing your body to slide forward through the dirt. You try to meet his deep thrusts but the jaguar fucks you with speed and force befitting a cheetah and the constantly vibrating barbs make your body shiver with each hammer blow to your insides.', false );
			}
			CoC.getInstance().player.buttChange( CoC.getInstance().monster.cockArea( 0 ), true );
			EngineCore.outputText( '\n\n', false );
			//(ending)
			EngineCore.outputText( 'Akbal works his hips fast, piston-pumping his long demon-cat dick in and out of your ' + Descriptors.assholeDescript() + '. Your voice rises and falls with his frantic thrusts. Your body is racked by orgasm after orgasm and soon you\'re lying on your chest and knees in a pool of your own love juices.\n\n', false );
			EngineCore.outputText( 'Akbal releases a harsh growl and you feel the large feline member twitching and swelling inside you. A growl sounds in your own chest as the hot, corrupted seed of the demon cat shoots into you. Despite having reached his climax the jaguar\'s piston-pumping doesn\'t slow until he\'s erupted no less than six times, masterfully working your hole the entire time.\n\n', false );
			EngineCore.outputText( 'After his last massive eruption you feel the jaguar demon pull out, releasing even more of his copious loads from your happy hole in an oddly satisfying cascade of thick white cream that rushes like a waterfall down your body.\n\n', false );
			EngineCore.outputText( 'The jaguar demon no longer seems to mind your presence in his territory as he drapes his tired body over yours and the two of you fall into a sex-induced coma.', false );
			//[+ 4-12 Corruption]
			EngineCore.dynStats( 'cor', 4 + Utils.rand( 8 ) );
			//[+ 1-2 Speed]
		...
		if( CoC.getInstance().player.lowerBody === AppearanceDefs.LOWER_BODY_TYPE_CENTAUR ) {
			EngineCore.outputText( ImageManager.showImage( 'akbal-deepwoods-taur-sumbitanal' ) );
			EngineCore.outputText( 'After a few moments of thinking you nod to Akbal.  The deep voice in your head commands you to disrobe.  You take off your ' + CoC.getInstance().player.armorName + ', setting it aside while mentally preparing yourself for whatever this demon has in mind.\n\n', false );
			EngineCore.outputText( 'You watch with fascination as Akbal rises onto his hind legs, his body melting into a more humanoid form.  His long, demonic cat-dick is already rock-hard and jutting out of his sheath.  He walks past your top half, moving around your body while sliding his hand across your haunch.  His hands are oddly warm.', false );
			//(if centaur player has a tail)
			if( CoC.getInstance().player.tailType > AppearanceDefs.TAIL_TYPE_NONE ) {
				EngineCore.outputText( '  As he makes his way to your hind quarters he grabs you by the tail, pulling it up and out the way with a feral, jaguar grin.  His free hand slides a finger across your ' + Descriptors.assholeDescript() + ' making you paw the ground with your hooves.', false );
			}//(No tail)
			else {
				EngineCore.outputText( '  As he makes his way to your hind quarters he grabs your ' + Descriptors.buttDescript() + ', groping the mass of flesh with one hand and sliding a finger across your exposed ' + Descriptors.assholeDescript() + ', making you paw the ground with your hooves.', false );
			}
			EngineCore.outputText( '\n\n', false );
			//(Transition)
			EngineCore.outputText( 'The jaguar demon begins pushing you forward with his powerful hips, his demon-cat-dick sliding up the crevice of your ' + Descriptors.buttDescript() + '.  He steers you towards a tree, forcing you chest-first against the rough bark.\n\n', false );
			EngineCore.outputText( 'Looking back you watch Akbal bend low, losing sight of the jaguar demon as he disappears behind you.  For a moment you wonder what he\'s doing but soon you feel him shove his face into your ' + Descriptors.buttDescript() + ' with a snarl.  He begins working his slippery wet tongue into your ' + Descriptors.assholeDescript() + ', greedily lapping at your exposed backside as if it were a quickly-melting ice cream cone.  The sensation causes you to groan and grind against the tongue, suddenly lost in ecstasy.  You are surprised at the strength in the demon\'s neck as he smashes your body against the tree with nothing but his mouth.  You feel his saliva, thick and warm like melted candy, sliding inside of you and coating your insides.', false );
			//(If Player has Vagina)
			if( CoC.getInstance().player.hasVagina() ) {
				EngineCore.outputText( '  Akbal slurps his way down to your ' + Descriptors.vaginaDescript( 0 ) + ' twisting his face and drilling his tongue into you, mercilessly attacking your ' + Descriptors.clitDescript() + ' as you scream, howl, and cringe in ecstasy.  He then uses his lips to gently suck your ' + Descriptors.clitDescript() + ' into his mouth and twirl his tongue on it, making your grind your swollen sex against his jaguar lips.', false );
			}
			//(If Player has balls)
			if( CoC.getInstance().player.balls > 0 ) {
				EngineCore.outputText( '  Akbal slurps his way down to your ' + Descriptors.sackDescript() + ' where he slathers his thick, heated saliva over your orbs, making you groan as your sensitive ' + Descriptors.ballsDescriptLight() + ' are teased and gently juggled by Akbal\'s masterful tongue.  He sucks both orbs into his mouth.  The sensation sends your eyes to the back of your skull and makes your entire body shiver.', false );
			}
			//(transition)
			EngineCore.outputText( '  Once his oral machinations are finished a sudden warmth heats your innards, making you shiver in ecstasy as the demon rises to mount you.\n\n', false );
			//(Small/Virgin Pucker)
			//[Small/virgin pucker]
			if( CoC.getInstance().player.ass.analLooseness < 3 ) {
				EngineCore.outputText( 'You feel him poking around your ' + Descriptors.assholeDescript() + ' and quickly realize his member is not only insanely large but its head is covered in a dozen tiny barbs.  You grit your teeth, expecting pain and yet, thanks to the weird saliva he slathered your innards with, there is none as his gargantuan member forcibly widens your ' + Descriptors.assholeDescript() + '.\n\n', false );
			...
			//(Medium Pucker)
				...
				EngineCore.outputText( 'You feel him poking around your ' + Descriptors.assholeDescript() + ' and quickly realize his member is not only quite large but covered in almost a dozen tiny barbs.  Yet,  thanks to the weird spit he slathered your innards with, there is none as his gargantuan member forcibly widens your ' + Descriptors.assholeDescript() + '.\n\n', false );
				EngineCore.outputText( 'Akbal\'s titanic member stretches your ' + Descriptors.assholeDescript() + ' and makes you groan and claw at the tree he has you pressed against, reveling in the slick heat and fullness of your bowels.  His saliva heats up, creating a steamy yet pleasurable warmth inside your body.  As he begins to pump his huge sex organ in and out of you the barbs covering his head begin to vibrate and hit your body with tidal waves of unbearable pleasure, feeling more like vibrating sex beads than punishing spikes.  You lean back into his thrusts as his trunk begins slamming into your ' + Descriptors.buttDescript() + ' in rhythmic claps that echo throughout the forest.', false );
			}
			//(Gapping Pucker - Remember Akbal's dick is 15 inches)
			else {
				EngineCore.outputText( 'You feel him poking around your ' + Descriptors.assholeDescript() + ' and quickly realize his member is not only quite large but covered in almost a dozen tiny barbs.  When Akbal begins to penetrate you he groans in surprise as his large dick sinks into your ' + Descriptors.buttDescript() + ' easily, the sudden invasion causing you to croon.\n\n', false );
				EngineCore.outputText( 'The weird spit he slathered your insides with begins to heat up instantly and the barbs covering his cock head start vibrating.  The sensation is like a dozen small slimy sex beads spinning and shaking as they are pushed inside you.  Akbal wastes no time and begins forcibly fucking your ' + Descriptors.assholeDescript() + ' with reckless abandon, his every brutal thrust causing the tree you\'re shoved up against to shake back and forth.  You try to meet his deep thrusts but the jaguar fucks you with speed and force befitting a cheetah and the constantly vibrating barbs make your body shiver with each hammer blow to your insides.', false );
			}
			CoC.getInstance().player.buttChange( CoC.getInstance().monster.cockArea( 0 ), true );
			EngineCore.outputText( '\n\n', false );
			//(ending)
			EngineCore.outputText( 'Akbal works his hips fast, piston-pumping his long demon-cat dick in and out of your ' + Descriptors.assholeDescript() + '.  Your body is racked by orgasm after orgasm and soon the ground beneath your pawing hooves is covered in a thick layer of your own love juices.  Then Akbal releases a harsh growl and you feel the large feline member twitching and swelling inside you.  A growl sounds in your own chest as the hot, corrupted seed of the demon cat shoots into you.  The feeling of the hot, wet warmth being fucked deeper into you is so close to supreme bliss you can scarcely tell the difference.\n\n', false );
			EngineCore.outputText( 'After a few moments you realize Akbal isn\'t slowing down.  His piston pumping hips drive right through his orgasm and never stop slamming into your ' + Descriptors.buttDescript() + '.  He continues until he\'s erupted no less than eight times, masterfully working your hole the entire time.\n\n', false );
			EngineCore.outputText( 'After his last massive eruption you feel the jaguar demon pull out, releasing even more of his copious load from your happy hole in an oddly satisfying cascade of thick white cream that rushes like a waterfall down your legs', false );
			if( CoC.getInstance().player.totalCocks() > 0 ) {
				EngineCore.outputText( ' to join your own', false );
			}
			EngineCore.outputText( '.\n\n', false );
			EngineCore.outputText( 'You close your eyes, willingly falling into a sex induced sleep.', false );
			//[+ 4-12 Corruption]
			EngineCore.dynStats( 'cor', 4 + Utils.rand( 8 ) );
			//[+ 1-2 Speed]
			EngineCore.dynStats( 'spe', 1 + Utils.rand( 2 ) );
		...
		EngineCore.outputText( 'After thinking for a minute, you nod to Akbal.  The deep voice in your head commands you to disrobe.  You obediently take off your ' + CoC.getInstance().player.armorName + ' and set it aside just before the demon is upon you.\n\n', false );
		EngineCore.outputText( 'Akbal pushes you face-first into the ground and places his forward paws on your back, pinning your chest against the ground.  He removes them after a few seconds and you attempt to reposition yourself, only for you to be pushed back down again silent yet forceful command for you to stay in this position.\n\n', false );
		EngineCore.outputText( 'His paws slide to your waist, changing into hands along the way.  You look back and watch as his body starts morphing into a more humanoid shape, his muscles shifting themselves beneath his skin as his body changes to something better suited to dominate you.\n\n', false );
		EngineCore.outputText( 'He suddenly yanks your upturned bottom half toward himself and shoves his face into your ' + Descriptors.buttDescript() + '.  His slippery wet tongue begins to work its way into your ' + Descriptors.assholeDescript() + ', greedily lapping at your exposed backside as though it were a quickly-melting ice cream cone.  The sensation causes you to groan and grind against the tongue, quickly losing yourself into ecstasy.  You spread your ' + CoC.getInstance().player.legs() + ' and arch your back, allowing his long and thick jaguar tongue to drill deeper into your ' + Descriptors.assholeDescript() + '.  You feel his thick and warm saliva sliding into you and coating your insides.\n\n', false );
		//[Player has a vagina]
		if( CoC.getInstance().player.hasVagina() ) {
			EngineCore.outputText( 'Akbal slurps his way down to your ' + Descriptors.vaginaDescript( 0 ) + ', twisting his face and drilling his tongue into you, mercilessly attacking your ' + Descriptors.clitDescript() + ' as you scream, howl and cringe from the stimulation.  He then gently sucks your ' + Descriptors.clitDescript() + ' into his mouth and twirls his tongue around it, making you grind your swollen sex against his jaguar lips.  ', false );
		}
		//[Player has balls]
		else if( CoC.getInstance().player.balls > 0 ) {
			EngineCore.outputText( 'Akbal slurps his way down to your ' + Descriptors.sackDescript() + ', slathering his heated saliva over your orbs and making you groan as your sensitive ' + Descriptors.ballsDescriptLight() + ' are teased and gently juggled by Akbal\'s masterful tongue.  Your body continually twitches with pleasure from the sensations.  ', false );
		}
		EngineCore.outputText( 'His oral ministrations end when a sudden warmth heats your innards, and you shiver in ecstasy as the demon rises to mount you.  A single paw-like hand shoves your lifted chest and face back into the dirt, causing cold earth to cling to your face as Akbal gets into position above you.\n\n', false );
		EngineCore.outputText( 'You feel him poking around your ' + Descriptors.assholeDescript() + ', learning quickly that not only is his member insanely large, but its head is covered in dozens of tiny barbs.  ', false );
		//[Small/virgin pucker]
		if( CoC.getInstance().player.ass.analLooseness < 3 ) {
			EngineCore.outputText( 'You grit your teeth, expecting pain. However, thanks to the weird saliva he slathered your innards with, you feel none as his gargantuan member forcibly widens your ' + Descriptors.assholeDescript() + '.', false );
			CoC.getInstance().player.buttChange( CoC.getInstance().monster.cockArea( 0 ), true );
			EngineCore.outputText( '\n\n', false );
			EngineCore.outputText( 'Being stretched by Akbal\'s long and slick member makes you shudder. The weird spit even begins to heat up, creating a steamy warmth inside you as Akbal\'s equally hot member stretches you out, your body spasming slightly in response.  After a few slow and shallow strokes, you can feel the barbs begin to vibrate.  The sudden motion sends your body into convulsions, the wicked-looking barbs acting more like humming sex beads than barbs.  When Akbal picks up the pace, you can only grit your teeth harder as you\'re stretched more and more beyond your natural limits.\n\n', false );
		}
		//[Medium Pucker]
		else if( CoC.getInstance().player.ass.analLooseness < 5 ) {
			EngineCore.outputText( 'Thanks to the weird saliva he slathered your innards with, you feel no pain as his gargantuan member forcibly widens your ' + Descriptors.assholeDescript() + '.', false );
			CoC.getInstance().player.buttChange( CoC.getInstance().monster.cockArea( 0 ), true );
			EngineCore.outputText( '\n\n', false );
			EngineCore.outputText( 'Akbal\'s titanic member stretching your ' + Descriptors.assholeDescript() + ' makes you groan beneath him, reveling in the slick heat and the fullness of your bowels.  His saliva heats up, creating a steamy and pleasurable warmth inside your body.  As he begins to pump his huge member in and out of you, the barbs covering his head begin to vibrate.  Your body is hit with waves of unbearable pleasure, the wicked-looking barbs acting more like humming sex beads than barbs.  Your body begins to act of its own accord; your ' + Descriptors.buttDescript() + ' grinds against his thrusts as his large sex slides in, his trunk slamming into your ' + Descriptors.buttDescript() + ' with rhythmic claps that echo throughout the forest.\n\n', false );
		}
		//[Gapping Pucker - Remember Akbal's dick is 15 inches]
		else {
			EngineCore.outputText( 'As Akbal begins to penetrate you, he groans in surprise at how easily his large dick sinks into your ' + Descriptors.buttDescript() + ', and the sudden invasion causes you to croon.\n\n', false );
			EngineCore.outputText( 'The weird spit he slathered your insides with instantly heats up, and the barbs covering his cock head suddenly start vibrating.  The vibrating barbs feel like slimy sex beads, spinning and shaking as they are pushed inside you.  Akbal wastes no time and begins forcibly fucking your ' + Descriptors.assholeDescript() + ' with reckless abandon, his every brutal thrust causing your body to slide forward through the dirt.  You try to meet his deep thrusts, but the jaguar is fucking you with speed and force befitting a cheetah. The constantly vibrating barbs make your body shiver with each hammering blow to your insides.\n\n', false );
		}
		EngineCore.outputText( 'Akbal works his hips fast, piston-pumping his long demon cat-dick in and out of your ' + Descriptors.assholeDescript() + '.  The rampant babbling coming from your mouth breaks with his every thrust, and your body is racked by orgasm after orgasm. You\'re soon on your chest and knees ', false );
		if( CoC.getInstance().player.hasVagina() || CoC.getInstance().player.totalCocks() > 0 ) {
			EngineCore.outputText( 'in a pool of your own love juices', false );
		} else {
			EngineCore.outputText( 'in sexual bliss', false );
		}
		EngineCore.outputText( '.\n\n', false );
		EngineCore.outputText( 'Akbal releases a harsh growl and you feel his large feline member twitch and swell inside you.  You let out a growl of your own as the hot, corrupted seed of the demon cat shoots into you.  Feeling the hot, wet warmth being fucked deeper into you is so close to supreme bliss that you can scarcely tell the difference.\n\n', false );
		EngineCore.outputText( 'After the sensation begins to settle, you realize Akbal isn\'t slowing down.  His hips carry on with their pistoning right through his orgasm and continually slam into your ' + Descriptors.buttDescript() + '.  He persists until he\'s erupted no less than eight times, masterfully working your hole the entire time.\n\n', false );
		EngineCore.outputText( 'After his final massive eruption, the jaguar demon pulls out. His copious load is released from your happy hole in an oddly satisfying cascade of thick white cream, rushing like a waterfall down your ' + CoC.getInstance().player.legs() + '.\n\n', false );
		EngineCore.outputText( 'The jaguar demon no longer seems to mind your presence in his territory as he drapes his body over yours, and the two of you fall into a sex-induced sleep.', false );
		//[+ 4-12 Corruption]
		EngineCore.dynStats( 'cor', 4 + Utils.rand( 8 ) );
		//[+ 1-2 Speed]
		EngineCore.dynStats( 'spe', 1 + Utils.rand( 2 ) );
	...
	AkbalScene.prototype.akbalSubmissionFollowup = function() {
		EngineCore.spriteSelect( 2 );
		EngineCore.outputText( '', true );
		if( CoC.getInstance().flags[ kFLAGS.AKBAL_SUBMISSION_COUNTER ] < 4 ) {
		...
		else if( CoC.getInstance().flags[ kFLAGS.PLAYER_RESISTED_AKBAL ] === 0 && CoC.getInstance().flags[ kFLAGS.AKBAL_SUBMISSION_COUNTER ] >= 8 && CoC.getInstance().player.cor > 80 ) {
			if( CoC.getInstance().player.cor < 80 || CoC.getInstance().player.findPerk( PerkLib.FireLord ) >= 0 ) {
				EngineCore.outputText( 'You awake in your camp feeling dangerous, powerful and fiercely satisfied.', false );
			} else {
				EngineCore.outputText( 'You open your eyes and almost yell in surprise when you see Akbal\'s emerald eyes looking into yours.  You are still in the forest and his lithe jaguar body is still over you; you quickly realize he hasn\'t moved you, as you\'re still resting in a puddle of mixed sex juices.\n\n', false );
				EngineCore.outputText( '"<i>You are a loyal pet,</i>" Akbal says as he stands. The compliment makes you smile, but it quickly fades into a look of fear when he suddenly releases a bone-chilling roar right in your face.  Green flames begin to pour from his open maw, and you scream as you flail your hands in a pointless attempt to block the fire.\n\n', false );
				EngineCore.outputText( 'After a moment of horror, you realize you aren\'t burning.  You can feel the emerald flames inside your lungs, glowing with a palpable warmth.  Akbal snaps his teeth together, a feral grin on his face as he halts the torrent of flame.\n\n', false );
				EngineCore.outputText( 'You can feel Akbal\'s demonic presence inside your lungs, slowly building up until it finally explodes out of your open mouth in a titanic roar, accompanied with a jet of emerald flame.\n\n', false );
				EngineCore.outputText( '(You are now capable of breathing Akbal\'s fire.)', false );
				//['LOTF' or 'Terrestrial Fire Lord' appears as perk]
				//[Gain 'Terrestrial Fire' in Specials]
				CoC.getInstance().player.createPerk( PerkLib.FireLord, 0, 0, 0, 0 );
			}
		}
		//[After 4th submission if corruption is greater than 40%]
		else if( CoC.getInstance().player.findPerk( PerkLib.Whispered ) < 0 && CoC.getInstance().player.cor >= 40 ) {
			EngineCore.outputText( 'You awake in your camp with Akbal standing over you, the chorus of voices in your head reaching the apex of an agonizingly beautiful song, and then falling silent.  When you rise, Akbal licks your face before turning away and sprinting into the forest.\n\n', false );
			if( CoC.getInstance().player.findPerk( PerkLib.Whispered ) < 0 ) {
				EngineCore.outputText( '(You are now Whispered.)', false );
				CoC.getInstance().player.createPerk( PerkLib.Whispered, 0, 0, 0, 0 );
	...
	AkbalScene.prototype.akbalBigButtSubmit = function() {
		...
		EngineCore.outputText( '.  You cannot help but squirm from the attention, feeling the slippery-hot length of his muscle probing your sensitive ring.  In its wake, the panther\'s flexible tongue leaves behind copious amounts of his slick saliva that makes your skin tingle pleasantly.  You don\'t have long to wonder at this as he broadens his roving attentions to slather each of your cheeks with love, licking and lapping over your ' + CoC.getInstance().player.skinFurScales() + ' in what could only be described as worship.  A tremor of gleeful pride works through your mind - your master approves of his servant\'s body!' );
		...
		if( CoC.getInstance().player.hasCock() ) {
			EngineCore.outputText( '  Bobbing beneath you, [eachCock] makes no secret of how much you\'re enjoying this, with thin drops of pre-cum dangling precariously below.' );
		} else if( CoC.getInstance().player.hasVagina() ) {
			EngineCore.outputText( '  Your vulva have long since grown bigger and puffier, visibly aroused and glistening with the moisture of your lust.' );
		}
		...
		if( CoC.getInstance().player.hasCock() ) {
			EngineCore.outputText( '  [EachCock] is drooling freely by this point, and though Akbal doesn\'t bother to touch, the feeling of his warm pole inside you seems to reach all the way to your [cockHead].' );
		} else if( CoC.getInstance().player.hasVagina() ) {
			EngineCore.outputText( '  Your [vagina] is dripping freely by this point, and though Akbal doesn\'t bother with it, the feelings radiating from his warm pole seem to reach all the way through your pulsing pussy to your [clit], rigid and soaked as it is.' );
		}
		EngineCore.outputText( '  Suddenly, that blessed tool departs from your over-sensitive innards, only to return a moment later, plunged back in with a firm, measured stroke.   You squeal as another precision stroke of the demonic jaguar shaft bottoms out into your [asshole] once more, the thrust teasing an orgasm from your pleasure wracked body' );
		if( CoC.getInstance().player.hasCock() ) {
			EngineCore.outputText( ', your [cock] freely unleashing its load into the mud beneath you and tainting the ground with your wasted cum' );
			if( CoC.getInstance().player.cumQ() >= 500 ) {
				EngineCore.outputText( ' as it puddles around you' );
				if( CoC.getInstance().player.cumQ() >= 1000 ) {
					if( CoC.getInstance().player.cumQ() < 3000 ) {
						EngineCore.outputText( ' into a small lake' );
					} else {
						EngineCore.outputText( ' into a deep, slimy morass' );
					}
				}
			}
		} else if( CoC.getInstance().player.hasVagina() ) {
			...
			EngineCore.outputText( 'into the dirt until it stinks of your pussy' );
		}
		EngineCore.outputText( '.' );
		...
		if( CoC.getInstance().player.hasCock() ) {
			EngineCore.outputText( ', barely noticing when a fresh wave of your own spunk slops into your mouth' );
		}
		EngineCore.outputText( '.  You cum and cum, caught up in the rush of taking in Akbal\'s seed.  It seems to fill your body and soul, flooding anus and mind with hot, corrupted bliss.  Twice... thrice... four times... he just keeps firing more thick seed into you.  The fifth blast has you feeling full of it.  The sixth makes your gut distend slightly.  The seventh bloats you further and squirts from your [asshole] to soak butt and crotch-fur alike.  The eight is the largest and last, flooding you completely with your lord\'s essence.  It inflates your belly into a rounded sperm tank.  When he pulls back, a river of it washes out, and you cum again.' );
		EngineCore.outputText( '\n\nSated, you\'re lifted up and moved to a ' );
		if( CoC.getInstance().player.hasCock() && CoC.getInstance().player.cumQ() >= 1000 ) {
			EngineCore.outputText( 'dry, ' );
		}
		EngineCore.outputText( 'comfortable place.  Akbal wraps his arms around you, though one steals a quick squeeze of your [butt].  Invigorated by this, he docks his cat-cock back inside your spunk-oozing asshole to plug it and snuggles up to you.  You fall asleep like that, dreaming of him taking you again and again.' );
		if( CoC.getInstance().player.buttRating < 20 ) {
			EngineCore.outputText( '  Tingling in your sleep, your [butt] bulges slightly as it grows bigger, changed by Akbal\'s saliva to serve him even more capably.' );
			CoC.getInstance().player.buttRating++;
		} else if( CoC.getInstance().player.tone > 30 ) {
			EngineCore.outputText( '  Tingling in your sleep, your [butt] jiggles slightly as it softens along with the rest of your body, changed by Akbal\'s saliva to be a softer, more pleasant fuck.' );
			CoC.getInstance().player.modTone( 30, 5 );
		}
		CoC.getInstance().player.orgasm();
	...
	AkbalScene.prototype.akbitchEncounter = function() {
		...
		if( CoC.getInstance().player.cor < 40 || CoC.getInstance().player.lust < 33 ) {
			this.akbitchNoThnx( false );
		}//{corruption > 40}
		else {
			EngineCore.outputText( '\n\nDo you take advantage of him again?' );
			EngineCore.menu();
			EngineCore.addButton( 1, 'No', this.akbitchNoThnx );
			EngineCore.addButton( 0, 'Yes', this.takeAdvantageOfAkbitch );
		}
	};
	AkbalScene.prototype.akbitchNoThnx = function( clear ) {
		...
		EngineCore.outputText( 'You turn back, allowing the demon to finish cleaning himself and thankful he didn’t ambush you this time.' );
	...
	AkbalScene.prototype.takeAdvantageOfAkbitch = function() {
		...
		CoC.getInstance().flags[ kFLAGS.AKBAL_TIMES_BITCHED ]++;
		EngineCore.menu();
		EngineCore.addButton( 0, 'Normal', this.basicAkbitchScene );
		//AMB Strength Scene
		//70+
		if( CoC.getInstance().player.str >= 70 ) {
			EngineCore.addButton( 1, 'Strong', this.akbitchHighStrengthVariant );
		}
		//AMB Speed Scene
		//70
		if( CoC.getInstance().player.spe >= 70 ) {
			EngineCore.addButton( 2, 'Fast', this.akbalBitchSpeed );
		}
		//AMB Toughness Scene
		//70
		if( CoC.getInstance().player.tou >= 70 ) {
			EngineCore.addButton( 3, 'Toughness', this.akbitchToughness );
		}
	};
	...
	AkbalScene.prototype.basicAkbitchScene = function() {
		...
		if( CoC.getInstance().flags[ kFLAGS.AKBAL_TIMES_BITCHED ] === 1 ) {
		...
		EngineCore.outputText( 'e lifts his tail, giving you a perfect view of his entire package, from his self-lubing sphincter to his full balls, and rock-hard, demon-cat dick.  Through lust, his will has been broken, and now he is yours.' );
		EngineCore.outputText( '\n\nWhat will you do with him?' );
		EngineCore.menu();
		if( CoC.getInstance().player.hasCock() ) {
			EngineCore.addButton( 0, 'Fuck Him', this.buttFuckbuttFuckbuttFuckAkbal );
		}
		EngineCore.addButton( 1, 'Ride Him', this.topAkbitchFromDaBottom );
	};
	...
	AkbalScene.prototype.buttFuckbuttFuckbuttFuckAkbal = function() {
		...
		//[if (hasCock = true)]
		if( CoC.getInstance().player.hasCock() ) {
			EngineCore.outputText( 'You widen your stance as you sink into the demon’s moist depths with a grin.' );
		}
		if( CoC.getInstance().player.cockTotal() > 1 ) {
			EngineCore.outputText( '  You widen your stance and look down, choosing the biggest among [eachCock].' );
		}
		EngineCore.outputText( '  You lift your [cock biggest] into position, and with a grin, you begin to push into the demon’s moist depths.' );
		var x = CoC.getInstance().player.biggestCockIndex();
		//{if penis < 7 inches}
		if( CoC.getInstance().player.cocks[ x ].cockLength < 7 ) {
		...
		//{If penis = 7in-12in} else if (CoC.getInstance().player.cocks[x].cockLength < 12)
	...
	AkbalScene.prototype.fuckAkbitchsButt = function() {
		...
		if( CoC.getInstance().player.cor < 90 ) {
			EngineCore.outputText( 'You hold the demon’s make-shift collar, letting him ride out his orgasm as he cries out in pure ecstasy, reveling in the satisfaction of knowing you have made him your bitch.' );
		} else {
			EngineCore.outputText( 'You pound your bitch’s quivering rectum, reveling in the pulsating pressure as Akbal roars beneath you, a sound of mixed pain and ecstasy as you decimate his clenching hole with brutal thrusts.' );
		}
		...
		//{if player has horse cock} else if (CoC.getInstance().player.cocks[x].cockType === CockTypesEnum.HORSE)
		...
		//{if player has tentacle dick} else if (CoC.getInstance().player.cocks[x].cockType === CockTypesEnum.TENTACLE)
		...
		//{if player has cat dick} else if (CoC.getInstance().player.cocks[x].cockType === CockTypesEnum.CAT)
	...
	AkbalScene.prototype.topAkbitchFromDaBottom = function() {
		...
		EngineCore.menu();
		EngineCore.addButton( 0, 'Next', this.topAkbitchFromBottomDuex );
	};
	AkbalScene.prototype.topAkbitchFromBottomDuex = function() {
		...
		if( (!CoC.getInstance().player.hasVagina() && CoC.getInstance().player.ass.analLooseness < 2) || (CoC.getInstance().player.hasVagina() && CoC.getInstance().player.looseness() <= 2) ) {
		...
		//{medium vag/ass} else if ((!CoC.getInstance().player.hasVagina() && CoC.getInstance().player.ass.analLooseness < 4) || (CoC.getInstance().player.hasVagina() && CoC.getInstance().player.looseness() < 4))
		...
		if( CoC.getInstance().player.hasCock() ) {
			...
			EngineCore.outputText( 'your sex organ' );
			if( CoC.getInstance().player.hasVagina() ) {
				EngineCore.outputText( 's climax at once' );
			} else {
				EngineCore.outputText( ' climaxes' );
			}
			EngineCore.outputText( '.  Your [vagOrAss] spasms around the demon’s embedded cock as [eachCock] paints his chest and face with a generous coating of baby batter.  Your orgasm rages on, covering the demon cat in your sex fluids, matting his fur and darkening it with more seed than you ever thought possible.' );
		}
		//[if (hasCock = false)
		else {
	...
	AkbalScene.prototype.akbitchHighStrengthVariant = function() {
		...
		if( CoC.getInstance().player.hasCock() ) {
			...
			//{if CockLength is between 7 and 12} else if (CoC.getInstance().player.cocks[x].cockLength < 12)
			...
			EngineCore.outputText( ' titanic orgasm onto your [fullChest].' );
			//{corruption < 90}
			if( CoC.getInstance().player.cor < 90 ) {
			...
			//{if player has horse dick} else if (CoC.getInstance().player.cocks[x].cockType === CockTypesEnum.HORSE)
			...
			//{if player has dragon dick} else if (CoC.getInstance().player.cocks[x].cockType === CockTypesEnum.DRAGON)
			...
			//{If player has Lizard dick} else if (CoC.getInstance().player.cocks[x].cockType === CockTypesEnum.LIZARD)
			...
			if( CoC.getInstance().player.hasVagina() ) {
				EngineCore.outputText( 'nether lips' );
			} else {
				EngineCore.outputText( 'entrance' );
			}
			EngineCore.outputText( ' with his hot saliva you flinch.  A jolt, like lightning, shoots through your body and causes you to smash yourself into his face.  His long, thick tongue is hot bliss, teasing and pleasing you like a pro.  He uses his black lips to tease your ' );
			if( CoC.getInstance().player.hasVagina() ) {
				EngineCore.outputText( 'clit' );
			} else {
				EngineCore.outputText( 'prostate' );
			}
			EngineCore.outputText( ' and drills his long tongue into you, carrying that euphoria inducing spit into your [vagOrAss] over and over.  Your body grinds against the sensation as the good little bitch’s saliva drenches your [vagOrAss] until it’s dripping with a combination of your sex and his spit.  Here you keep him until the teasing pleasure is so intense you’re fit to burst.' );
			...
			//{medium vagorAss}
			if( (!CoC.getInstance().player.hasVagina() && CoC.getInstance().player.ass.analLooseness < 4) || (CoC.getInstance().player.hasVagina() && CoC.getInstance().player.looseness() < 4) ) {
			...
			//[if (hasCock = true) "<i>
			if( CoC.getInstance().player.hasCock() ) {
				EngineCore.outputText( '  [EachCock] swells and explodes, shooting cream all over Akbal’s thighs, chest and face as you unload thick white rope after rope.' );
			}
			CoC.getInstance().player.orgasm();
			EngineCore.dynStats( 'cor', 3 );
			if( CoC.getInstance().player.hasVagina() ) {
	...
	AkbalScene.prototype.akbalBitchSpeed = function() {
		...
		//[if (hasCock = true)]
		if( CoC.getInstance().player.hasCock() ) {
			EngineCore.outputText( ImageManager.showImage( 'akbal-deepwoods-male-highspeed' ) );
			...
			if( CoC.getInstance().player.cocks[ x ].cockLength < 7 ) {
				...
				//[if (hasBalls = false)
				if( CoC.getInstance().player.balls === 0 ) {
					EngineCore.outputText( '  Your [cock biggest] drips gobs of his slick lube down the lower half of your body.' );
				} else {
					EngineCore.outputText( '  Your [cock biggest] drips gobs of his slick lube down your [sack] and the insides of your legs.' );
				}
				EngineCore.outputText( '  With clenched teeth you spur yourself to fuck the demon even faster, reaching your top speed.' );
			}
		...
		//[if (hasVagina = true)
			...
			EngineCore.outputText( ImageManager.showImage( 'akbal-deepwoods-female-highspeed' ) );
			...
			EngineCore.outputText( ' with his long tongue, you begin to shiver.  Then you remember what it is you wanted to do.  Before he makes you cum, you shove his face away from you, pushing him onto his back with his cock once again standing tall.  Unable to contain yourself and draw this out any longer, you straddle the more than willing Jaguar demon and lower yourself onto his twitching erection without a second thought.' );
			//{tight/virgin vagorass}
			if( (!CoC.getInstance().player.hasVagina() && CoC.getInstance().player.ass.analLooseness < 2) || (CoC.getInstance().player.hasVagina() && CoC.getInstance().player.looseness() <= 2) ) {
			...
			//{medium vagorass}
			else if( (!CoC.getInstance().player.hasVagina() && CoC.getInstance().player.ass.analLooseness < 4) || (CoC.getInstance().player.hasVagina() && CoC.getInstance().player.looseness() < 4) ) {
			...
			//{gaped vagorass}
				...
				EngineCore.outputText( ' touched the fluid-soaked demon dick, a tidal wave of pure euphoria cascaded through your entire being.  As if the chemical reaction wasn’t enough, the barbs on Akbal’s dick begin to vibrate, tickling and teasing your [vagOrAss].\n\nYou know what to do with a dick that feels that good plant your feet and begin bouncing up and down that ecstasy-inducing dick with all of your strength.  Soon you’re bouncing so fast your body meeting his sounds more like applause than two frisky partners going at it.  You can see the demon’s tongue as it rolls out of his mouth and his eyes as they roll to the back of his head.' );
			}
			if( CoC.getInstance().player.hasVagina() ) {
				CoC.getInstance().player.cuntChange( 16, true, true, false );
			} else {
	...
	AkbalScene.prototype.akbitchToughness = function() {
		...
		if( CoC.getInstance().player.hasCock() ) {
			EngineCore.outputText( '[eachCock] twitches and begins spilling pre in preparation for what is to come.  Y' );
		} else {
			EngineCore.outputText( 'y' );
		}
		EngineCore.outputText( 'ou can’t help but rub your [nipple] a little as the demon looks up at you with equal parts fear and defiance while trying to hide how hot you’re making him with a rumbling growl.  What a proud little bitch.' );
		...
		//[if (hasCock = true)]
		if( CoC.getInstance().player.hasCock() ) {
			EngineCore.outputText( ImageManager.showImage( 'akbal-deepwoods-male-hightoughness' ) );
			...
			//{cockLength between 7 and 12} else if (CoC.getInstance().player.cocks[x].cockLength < 12)
			...
			EngineCore.outputText( ' blast of corrupted seed.' );
			//{corruption < 90}
			if( CoC.getInstance().player.cor < 90 ) {
		...
		//{female/genderless}
			...
			EngineCore.outputText( ' with his long tongue.  Your body convulses slightly as you maintain a tight grip on the collar, keeping his face buried under the weight of your [vagOrAss] as that wonderful tongue sends you to paradise.' );
			...
			if( CoC.getInstance().player.thickness <= 33 ) {
				EngineCore.outputText( 'slim' );
			} else if( CoC.getInstance().player.thickness <= 66 ) {
				EngineCore.outputText( 'muscular' );
			} else {
				EngineCore.outputText( 'voluptuous' );
			}
			EngineCore.outputText( ' body until he reaches your [fullChest].  After a second of feeling around he finds your [nipples].' );
			//[if (hasNippleCunts = False)]
			if( !CoC.getInstance().player.hasFuckableNipples() ) {
				EngineCore.outputText( '\n\nThe demon gently teases your erect [nipples] with his hands before rubbing your [fullChest] in large circular motions.  The feeling of his soft fur gliding across your ' + CoC.getInstance().player.skinFurScales() + ' in combination with his mouth and tongue attacking your [vagOrAss] is making your body convulse.' );
			} else {
			...
			//[if (hasCock = True)
			if( CoC.getInstance().player.hasCock() ) {
				EngineCore.outputText( '  [EachCock] erupts at the same time, painting Akbal’s chest with white goo.  As each orgasm overtakes you, you are reduced to a quivering mess.  Say what you want about the little bitch, but his dick is like no other.' );
			}
			EngineCore.outputText( '  As your orgasm subsides you allow the demon to grind his still erect dick around inside you for a moment. Without needing to threaten him again you rise, sending a cascade of spooge down your legs and onto Akbal’s lap.' );
