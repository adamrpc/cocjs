...
angular.module( 'cocjs' ).run( function( MainView, SceneLib, CoC, Utils, StatusAffects, EngineCore, AppearanceDefs, Descriptors, EventParser, PregnancyStore, kFLAGS, Combat, PerkLib, ImageManager, Akbal, CockTypesEnum ) {
	function AkbalScene() {
	}
	...
	AkbalScene.prototype.rapeAkbalForcedFemaleOral = function() {
		...
		if( CoC.player.isNaga() ) {
			...
			EngineCore.outputText( 'With a sadistic laugh you ride out your orgasm until you\'re reduced to a shuddering heap on the floor.  After you\'ve recovered you gather your ' + CoC.player.armorName + ', leaving Akbal in a groaning mess behind you.  He howls as he claws the ground, his barbed cock still rock hard beneath him.  Just as you begin to leave you notice a group of imps watching you and the jaguar demon, their cocks out and leaking as their jagged teeth spread into feral grins.  You even spy a few goblins mixed in the crowd, each twirling a bottle of liquid and playing with her snatch.\n\n', false );
		...
		//Centaur RAPPUUUUU
			...
			EngineCore.outputText( 'With a sadistic laugh you ride out your orgasm until you\'re reduced to a shuddering heap.  After you\'ve recovered you stand and gather your ' + CoC.player.armorName + ', leaving Akbal in a groaning mess behind you.  He howls as he claws the ground, his barbed cock still rock hard beneath him.  Just as you begin to leave you notice a group of imps watching you and the jaguar demon, their cocks out and leaking as their jagged teeth spread into feral grins.  You even spy a few goblins mixed in the crowd, each twirling a bottle of liquid and playing with her snatch.\n\n', false );
			EngineCore.outputText( 'As you leave Akbal snarls as the creatures that once feared him use his overtly aroused state to get revenge on the "god" of the terrestrial fire.  Even after you\'ve reached the edge of the forest the wails of the jaguar demon can still be heard but just barely over the high pitched laughter of the demon imps and goblin females.', false );
		}
		//Everybody else
		else {
			...
			EngineCore.outputText( 'With a sadistic laugh you ride out your orgasm until you\'re reduced to a shuddering heap on the floor.  After you\'ve recovered, you stand and gather your ' + CoC.player.armorName + ', leaving Akbal in a groaning mess behind you.  He howls as he claws the ground, his barbed cock still rock hard beneath him.  As you walk away, you notice a group of imps watching you and the jaguar demon with their cocks out and leaking, their jagged teeth spread into feral grins.  You even spy a few goblins mixed in the crowd, and each is twirling a bottle of liquid while playing with her snatches.\n\n', false );
	...
	AkbalScene.prototype.rapeAkbal = function() {
		...
		if( CoC.player.totalCocks() > 0 ) {
			...
			EngineCore.outputText( 'Standing up, you gather your ' + CoC.player.armorName + ' and turn to leave the weakened demon behind you.  As you walk away, you notice a group of imps watching you and the jaguar demon with their cocks out and leaking.  Mixed in with the crowd are several goblins, each with a vial of liquid and a malicious grin.\n\n', false );
		...
		//[Player has a vagina]
			...
			EngineCore.outputText( 'Your eyes widen when you see several wicked-looking barbs around his pre-pumping cockhead.  Instead of trying to deal with this massive phallus that looks like it was made to punish sinners, you walk around to the front of the creature.\n\n', false );
			EngineCore.outputText( 'Your scent causes Akbal\'s growling to quiver.  You lay down before him, grabbing his head and smashing his furry lips into your ' + Descriptors.vaginaDescript( 0 ) + '.  The demon, unable to escape his debilitating arousal, begins to lap at your ' + Descriptors.vaginaDescript( 0 ) + '.  He twists his lips and drills his tongue into you, mercilessly attacking your ' + Descriptors.clitDescript() + ', and you scream, howl and cringe in ecstasy.  He begins to lift up, probably to get into position above you, but you force his face back down into your ' + Descriptors.vaginaDescript( 0 ) + '.  After dropping a line about how he has to make your cum or get his head ripped off, Akbal whines, obviously distressed at not being able to slip his aching member into your ' + Descriptors.vaginaDescript( 0 ) + '.\n\n', false );
			EngineCore.outputText( 'With a sadistic laugh you ride out your orgasm until you\'re reduced to a shuddering heap on the floor.  After you\'ve recovered, you stand and gather your ' + CoC.player.armorName + ', leaving Akbal in a groaning mess behind you.  He howls as he claws the ground, his barbed cock still rock hard beneath him.  As you walk away, you notice a group of imps watching you and the jaguar demon with their cocks out and leaking, their jagged teeth spread into feral grins.  You even spy a few goblins mixed in the crowd, and each is twirling a bottle of liquid while playing with their snatches.\n\n', false );
			EngineCore.outputText( 'Akbal snarls as you leave, the creatures that once feared him using his aroused state to get revenge on the \'god\' of the terrestrial fire.  Even after you\'ve reached the edge of the forest, the jaguar demon\'s pained howls can still be heard – though, just barely over the high-pitched laughter of the demon imps and the cackling of the goblin females.', false );
		}
		CoC.player.orgasm();
		EngineCore.dynStats( 'cor', 1 );
	...
	AkbalScene.prototype.girlsRapeAkbal = function() {
		CoC.flags[ kFLAGS.AKBAL_BITCH_Q ]++;
		EngineCore.outputText( '', true );
		EngineCore.outputText( 'You smirk to yourself quietly as the so called "God of Terrestrial Fire" lays in a twitching heap on the ground, his flesh squirming as he shifts into his more humanoid form. Removing your ' + CoC.player.armorName + ', your hand lowers to your feminine slit, pondering how to make use of him.\n\n', false );
		//{If Centaur}
		...
		//{If Pussy is <loose}
			...
			if( CoC.player.isNaga() ) {
				...
				EngineCore.outputText( 'Lifting up your ' + CoC.player.leg() + ', you firmly place the sole of your foot against his barbed flesh, pressing it against his stomach, forcing the jaguar to let out a low moan which you quickly take advantage of, ', false );
			}
			EngineCore.outputText( 'stuffing his own tail into his maw.  As he tries to push his tail back out, you remove your ' + CoC.player.foot() + ' pointedly, staring down at the demon. Lifting his hips back up weakly towards you, he meekly begins to suckle on his own appendage, closing his vibrant emerald eyes as you return your attention to his shaft.\n\n', false );
		}
		//{If Pussy >= Loose}
		else {
	...
	AkbalScene.prototype.girlsRapeAkbalPart2 = function() {
		...
		//TOIGHT
			...
			//({If Herm}
			if( CoC.player.hasCock() ) {
				EngineCore.outputText( ' while you stroke ' + CoC.player.oMultiCockDesc() + ' in time with his thrusts', false );
			}
			...
			if( CoC.player.gender === 3 ) {
				EngineCore.outputText( 'stroking ' + CoC.player.oMultiCockDesc() + ' roughly, ', false );
			}
			...
			EngineCore.outputText( 'Your ' + Descriptors.chestDesc() + ' chest heaves as you struggle to gulp air, ' + CoC.player.legs() + ' quivering from the sheer power of the orgasm the cat\'s tail gave you.  ', false );
			...
			EngineCore.outputText( ' as he sags against the tree trunk, overwhelmed by the pleasure. With a satisfied grin of your own, you pick up your ' + CoC.player.armorName + ' and head out. Perhaps you should look out for the "<i>God of Terrestrial fire</i>" again sometime...', false );
	...
	AkbalScene.prototype.akbalDeny = function() {
		EngineCore.spriteSelect( 2 );
		EngineCore.outputText( '', true );
		EngineCore.outputText( 'You shake your head and rub the lust-filled jaguar behind the ear as you tell him you\'re busy.  The demon\'s eyes roll, and he licks your ' + CoC.player.leg() + ' before his eyes find an imp in the trees above the two of you.\n\n', false );
	...
	AkbalScene.prototype.startuAkabalFightomon = function() {
		EngineCore.spriteSelect( 2 );
		EngineCore.outputText( '', true );
		EngineCore.outputText( 'You ready your ' + CoC.player.weaponName + ' and prepare to battle the demon jaguar.', false );
		//[battle ensues]
	...
	AkbalScene.prototype.akbalSubmit = function() {
		...
		if( CoC.player.lowerBody === AppearanceDefs.LOWER_BODY_TYPE_NAGA ) {
			...
			EngineCore.outputText( 'After a few moments of thinking you nod to Akbal and the masculine voice in your head commands you to disrobe. You take off your ' + CoC.player.armorName + ', setting it aside moments before the demon is upon you.\n\n', false );
		...
		if( CoC.player.lowerBody === AppearanceDefs.LOWER_BODY_TYPE_CENTAUR ) {
			...
			EngineCore.outputText( 'After a few moments of thinking you nod to Akbal.  The deep voice in your head commands you to disrobe.  You take off your ' + CoC.player.armorName + ', setting it aside while mentally preparing yourself for whatever this demon has in mind.\n\n', false );
		...
		EngineCore.outputText( 'After thinking for a minute, you nod to Akbal.  The deep voice in your head commands you to disrobe.  You obediently take off your ' + CoC.player.armorName + ' and set it aside just before the demon is upon you.\n\n', false );
		...
		EngineCore.outputText( 'He suddenly yanks your upturned bottom half toward himself and shoves his face into your ' + Descriptors.buttDescript() + '.  His slippery wet tongue begins to work its way into your ' + Descriptors.assholeDescript() + ', greedily lapping at your exposed backside as though it were a quickly-melting ice cream cone.  The sensation causes you to groan and grind against the tongue, quickly losing yourself into ecstasy.  You spread your ' + CoC.player.legs() + ' and arch your back, allowing his long and thick jaguar tongue to drill deeper into your ' + Descriptors.assholeDescript() + '.  You feel his thick and warm saliva sliding into you and coating your insides.\n\n', false );
		//[Player has a vagina]
		if( CoC.player.hasVagina() ) {
		...
		EngineCore.outputText( 'After his final massive eruption, the jaguar demon pulls out. His copious load is released from your happy hole in an oddly satisfying cascade of thick white cream, rushing like a waterfall down your ' + CoC.player.legs() + '.\n\n', false );
