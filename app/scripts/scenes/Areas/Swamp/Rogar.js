...
angular.module( 'cocjs' ).run( function( SceneLib, kFLAGS, AppearanceDefs, StatusAffects, CockTypesEnum, PerkLib, ConsumableLib, CoC, EngineCore, Descriptors ) {
		...
		//Not sure what determines this yet;
			...
			//((androgynous or masculine and breasts <= A-cup));
				...
				if( CoC.flags[ kFLAGS.ROGAR_DIRT ] === 2 ) {
					EngineCore.outputText( '"<i>' + CoC.player.short + ', y\'all took off on me real quick like,</i>" he says through a snicker.  The joke falls flat and the orc seems to blush lime green as you stare at him uncomprehendingly.  He rubs the back of his neck with a hand before continuing.  "<i>Sorry about that.  I was plumb tuckered out afterwards.</i>"\n\n', false );
				}
		...
		if( CoC.flags[ kFLAGS.ROGAR_PHASE ] === 0 ) {
			...
			//((If libido is 50 or more));
				...
				if( CoC.player.hasVagina() ) {
					...
					EngineCore.outputText( '  Even your ' + CoC.player.feet() + ' and fingers curl as you smell the sweat and musk of Ro\'gar\'s closeness, the animalistic scent arousing you.', false );
	...
	Rogar.prototype.rogarThirdPhase = function() {
		...
		//((androgynous or masculine and breasts <= A-cup));
			...
			//else if Ro'roh Raggy < 1 and player height < 5 feet);
				...
				EngineCore.outputText( 'you gently tug on the figure\'s cloak, mentioning aloud that it seemed to have held up all right with your sewing job.  The figure\'s back straightens sharply and a deep snicker is heard.  "<i>Ya did a mighty fine job, ' + CoC.player.short + '.  Been waitin\' for ya.</i>"  Ro\'gar turns and grins at you.\n\n', false );
			}
			//((Paths combine here));
	...
	Rogar.prototype.rogarPhaseFour = function() {
		...
		//(andro or masculine with tits <= A);
			...
			EngineCore.outputText( 'Ro\'gar is tipping his drink back when he catches sight of you, and waves you over.  "<i>Ah, good ta see ya, ' + CoC.player.short + '!', false );
			//[(Ro'roh Raggy = 1);
			if( CoC.flags[ kFLAGS.ROGAR_WARNING ] === 1 ) {
	...
	Rogar.prototype.loseButtGinity = function() {
		...
		if( CoC.player.ass.analLooseness === 0 ) {
			...
			EngineCore.outputText( '  Fingers and ' + CoC.player.feet() + ' curl in pleasure as your previously untouched boycunt is forced open by Ro\'gar\'s steady coaxing.', false );
		...
		//(([Get Anal] Scenario 1b: Get fucked (normal)));
			...
			if( (CoC.player.thickness >= 75 && CoC.player.tone < 33) || CoC.player.tone >= 75 ) {
				...
				//[(if player has toes);
				EngineCore.outputText( '  You curl your fingers and ' + CoC.player.feet() + ' in ecstasy as Ro\'gar drives you over the edge.', false );
	...
	Rogar.prototype.kinkyWithDaOrc = function() {
		...
		EngineCore.outputText( 'at Ro\'gar, you only see his lust-ridden face dipping down to kiss at your lips.  His tusks press against your cheeks with a demanding snarl and his tongue into your mouth; your ' + Descriptors.buttDescript() + ' receives a smack, forcing you to yelp.  His tongue quickly invades, and his free hand unfastens your ' + CoC.player.armorName + ' to strip you forcefully.  Rough, calloused fingers dance over your body and fasten onto your ' + Descriptors.nippleDescript( 0 ) + 's, coaxing moans from your throat with each pinch.  Your pleased noises are muffled by Ro\'gar\'s mouth, his tongue and lips hushing each whimper and gasp you breathe.  A bare, firm chest presses against your exposed back, and you pant as the heat from his body burns against you, only intensified by the thin layer of oil on his skin.  Ro\'gar\'s blue eyes watch you like a predator as your face flushes.  He breaks the kiss and cups his hands under your chin to hold your face in place.  "<i>Such a perdy face yer makin\', ' + CoC.player.short + '.  Yer lookin\' at me like a proper slut, an\' it\'s makin\' me hard seein\' ya so needy to be bred.</i>"  He growls in his throat as his mouth nips over your neck, leaving red marks along your skin where his tusks rub against you.  You can feel the oil and sweat smearing over your back, and your senses go wild.  The room is soon filled with your needy whimpers as ' + Descriptors.sMultiCockDesc() + ' oozes and throbs against the sheets, making the fabric damp with your lust.\n\n', false );
		...
		if( CoC.player.ass.analLooseness < 3 ) {
			EngineCore.outputText( '"<i>Tarnation, ' + CoC.player.short + '.  You\'re so tight...</i>"\n\n', false );
		...
		EngineCore.outputText( '  Fingers and ' + CoC.player.feet() + ' curl in pleasure as your boycunt is forced open by Ro\'gar\'s steady coaxing.', false );
	...
	Rogar.prototype.rubdubWithDaOrcWithoutDucky = function() {
		...
		EngineCore.outputText( '"<i>I purchased these oils to relax my muscles after spending so much time in the gym.</i>" Your orc lover motions to a few bottle of oils on his night stand. "<i>How about you give me a hand... or two.</i>" Ro\'gar grins at you, his eyebrows twitching suggestively. You need no further provocation as you strip from your ' + CoC.player.armorName + ', you let it fall into a pile on the floor as you make for the bottle. Ro\'gar grins and rolls onto his stomach.\n\n', false );
