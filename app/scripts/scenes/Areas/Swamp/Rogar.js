...
angular.module( 'cocjs' ).run( function( SceneLib, MainView, kFLAGS, AppearanceDefs, StatusAffects, CockTypesEnum, PerkLib, ConsumableLib, CoC, EngineCore, Descriptors ) {
	function Rogar() {
	}
	...
	/*Ro'gar encounter in the swamp; Ro'gar phase flag = 0 (edited)
	 ...
	 [No Thanks]
	 (([Get Anal], Scenario 1a up the buttcherry (buttvirgins only)))
	 (([Get Anal] Scenario 1b fucked (normal)))
	 ((Scenario 2, [Give Anal] Ro'gar))
	 ((Scenario 3, [Drink! (sorta)] with Bro Brew(Requires one bro brew per visit, uses it and turns player into a Bro)))
	 ((Scenario 4, [Frot]))*/
	...
	//Dirt Mc Girt flag: state 0 - CoC.player has not had the opportunity to tongue-bathe Ro'; 1 - CoC.player gently turned down the chance to bathe him; 2 - CoC.player bathed Ro';
	...
	Rogar.prototype.encounterRogarSwamp = function() {
		MainView.outputText( '', true );
		MainView.spriteSelect( 86 );
		if( CoC.flags[ kFLAGS.ROGAR_PHASE ] === 0 ) {
		...
		//((Ro'gar phase = 1)) (edited);
			...
			MainView.outputText( 'With map in hand you wander the swamp for some time, squinting at the rough scrawls Ro\'gar had scribed for you.  You can\'t help but stop and scratch your head as you begin to wonder if you are hopelessly lost.\n\n', false );
			...
			//((androgynous or masculine and breasts <= A-cup, libido less than 50));
				...
				if( CoC.player.inte < 30 ) {
					MainView.outputText( 'leftovers from that fight in the swamp still linger on his body.', false );
				} else {
					MainView.outputText( 'it makes you wonder what Ro\'gar was up to.', false );
				}
				MainView.outputText( '  Ro\'gar follows your gaze, then his eyes glint oddly as he snickers.  "<i>Care ta... return the favor?</i>"  He slyly winks at you, eyes flicking from you to the bucket and back again.', false );
				//goto sexy choices;
			}
			...
			//((androgynous or masculine and breasts <= A-cup));
				...
				//(if player has been to Tel'Adre);
					...
					//(if Dirt Mc Girt = 2) ;
						...
						MainView.outputText( 'As you exit the door you suddenly feel a strong grip on your wrist, making you turn around.', false );
						//(if player height is shorter than 4 feet) ;
						if( CoC.player.tallness < 48 ) {
							MainView.outputText( '  Hands hook under your armpits to lift you up gently.', false );
						}
						//(if player height is taller than 7 feet);
						if( CoC.player.tallness >= 84 ) {
							MainView.outputText( '  A hand on your shoulder tugs you to lower your head.', false );
						}
						MainView.outputText( '  Lips press to yours and you taste Ro\'gar\'s long, orcish tongue flicking out, trying to coax its way into your mouth.  With a faint moan you open wide, locking tongues with him as your eyes close in bliss.  You wrap your arms around the orc\'s neck in embrace, your hands curling around to hold him near.  His own strong hands carefully settle at your ' + Descriptors.hipDescript() + ' roughly clenching down as his fingertips press over your ' + Descriptors.buttDescript() + '.  The two tongues wrestle in your mouth before Ro\'gar slowly pulls away.  "<i>Thanks fer everythin\', ' + CoC.player.short + '.  Y\'all take care.  I\'ll be keepin\' my eyes peeled for ya.</i>"  With his usual toothy grin he waves you off.\n\n', false );
						MainView.outputText( 'You wander toward your camp through the swamp, making it there without any problems beside the heat in your loins.', false );
	...
	//((No));
	Rogar.prototype.dontWaitForRogar = function() {
		MainView.outputText( '', true );
		MainView.spriteSelect( 86 );
		MainView.outputText( 'Time passes with no sign of Ro\'gar.  You decide it would be a waste of time to sit and wait for him, and head off in hopes of finding something interesting.\n\n', false );
		MainView.outputText( 'Instead, you find only more mud.  You return to camp.', false );
		//<set Crying Game = 1>;
	...
	Rogar.prototype.waitForChunkyOrcLoe = function() {
		...
		MainView.spriteSelect( 86 );
		if( CoC.flags[ kFLAGS.ROGAR_PHASE ] === 0 ) {
			MainView.outputText( 'It feels like several hours pass with no sign of Ro\'gar, but you decide to wait and use what little cloth you have to clean yourself off.  Eventually you hear the slow trod of heavy footsteps as Ro\'gar comes into view with a smile on his face and a bucket and towel in his hands.  He sets the steaming bucket down as he draws near.  "<i>Here ya go!</i>" he says with a grunt, dipping the towel in the bucket.  He rubs your body with the towel to wipe away the mud for you, seeming not to realize - or perhaps, not minding - the intimacy of the gesture.\n\n', false );
			//((If libido is less than 50));
			if( CoC.player.lib < 50 ) {
				MainView.outputText( 'The hulking orc is surprisingly gentle as he cleans you like a young child.  The warm waters and careful touch soothe your tired muscles.  Your skin becomes textured with goose bumps as the tickles of droplets roll down your body and the filth is washed down to the waters below.  You find yourself sighing in relaxation from the treatment.  A smile curls your lips as you look down at Ro\'gar, and he returns the pleased look with a toothy smirk.\n\n', false );
			}
			//((If libido is 50 or more));
			else {
				MainView.outputText( '  Something about the burly orc rubbing you down with warm water excites you.', false );
				if( CoC.player.hasVagina() ) {
					MainView.outputText( '  Your ' + Descriptors.vaginaDescript( 0 ) + ' starts to quiver as the warm water rolls over its lips, moistening in excitement as your skin is rubbed over by strong hands.  Your chest heaves as it relaxes to his touch, your ' + Descriptors.nippleDescript( 0 ) + 's becoming stiff under his rubbing.', false );
					MainView.outputText( '  Even your ' + CoC.player.feet() + ' and fingers curl as you smell the sweat and musk of Ro\'gar\'s closeness, the animalistic scent arousing you.', false );
				} else if( CoC.player.hasCock() ) {
					MainView.outputText( '  ' + Descriptors.SMultiCockDesc() + ' stirs to life, making it obvious how much you are enjoying the rub down, then begins to drool with lust.  Through lidded eyes you faintly make out Ro\'gar\'s toothy smirk becoming a hungry grin.', false );
				}
				EngineCore.dynStats( 'lus', 5 + CoC.player.lib / 20 + CoC.player.sens / 20 );
				MainView.outputText( '\n\n', false );
			}
			MainView.outputText( '"<i>Clean as a whistle.</i>"  Ro\'gar chuckles as he drops the towel in the bucket with a splash.  His face beams with pride at his work, chest puffing out as he looks you over.  He eyes you up and down again, and your curious look just makes him snicker.  "<i>Don\'t meet too many friendly folk \'round here, but it would be nice to have a ' + CoC.player.mf( 'feller', 'lass' ) + ' to talk with.</i>"  After a few moments of awkward rummaging through his pocket he pulls out a scrunched up piece of paper and hands it to you.  "<i>This\'s so you can find me.</i>"  Ro\'gar grins from ear to pointy ear.  You unfold the paper, and see a crudely drawn map that vaguely explains how to get to Ro\'gar\'s hut.  You wonder if making this map was why he took so long.  "<i>Y\'all take care now, y\'hear!</i>" he hollers, turning summarily and walking away, waving over his shoulder at you as he tromps through his natural habitat.  You wander back to your camp, wondering if you should see him again.\n\n', false );
			MainView.outputText( '<b>You can now find Ro\'gar\'s hut when wandering the swamp occasionally!</b>', false );
	...
	Rogar.prototype.okayBroLetsHaveAGayCarwash = function() {
		...
		MainView.outputText( ' aches, each step of the way rubbing the sensitive', false );
		if( CoC.player.gender > 0 ) {
			MainView.outputText( ', drooling', false );
		}
		MainView.outputText( ' parts against the fabric of your clothes.\n\n', false );
	...
	Rogar.prototype.rogarThirdPhase = function() {
		MainView.outputText( '', true );
		MainView.spriteSelect( 86 );
		...
		if( (CoC.player.biggestTitSize() >= 2) ) {
			if( CoC.flags[ kFLAGS.ROGAR_WARNING ] === 0 ) {
				MainView.outputText( 'Judging the patron\'s figure based on how imposingly filled out the cloak is, he or she is clearly very muscled.  You spy a green hand reach for a can and a spark of recognition hits you.  You\'re completely unsure how to break the ice, but tug on the hem of the cloak.  The figure turns toward you, and you\'re greeted with the green, toothy smile of Ro\'gar, the orc from the swamp!  "<i>H\'lo, ' + CoC.player.short + '!  I\'m s\'rprised to see ya here...</i>"\n\n', false );
				MainView.outputText( 'You greet him warmly, but he seems a bit nervous around you.  "<i>Well... after all ya tol\' me about yer adventures, I, ah, thought I\'d hit the road m\'self.  An\' so ya find me here.  Good ta see ya again, but I\'m just finishin\' up my drink afore I head on out.</i>"  With this, he tips back the contents of his can and flashes you his standard grin, then departs.  He seemed a bit uneasy around you.', false );
				//set Ro'roh Raggy flag to 1;
				CoC.flags[ kFLAGS.ROGAR_WARNING ] = 1;
			}
			//(high fem or breasts >=B-cup and Ro'roh Raggy =1);
			else {
				MainView.outputText( 'Ro\'gar the orc is here drinking again, but as you catch his eye, a pained expression flashes across his face.  It\'s clear he doesn\'t relish the prospect of talking to you right now, but knowing him, he\'s too polite to say so.  The wind spills from your sails and your icebreaker slips from your mind - answering him with a simple glance of resignation is the most you can manage.  He gives you a weak smile and returns to his drink.\n\n', false );
			}
			//return to bar menu;
		...
		//((androgynous or masculine and breasts <= A-cup));
			...
			//(else if Dirt Mc Girt = 1);
				...
				MainView.outputText( 'Ro\'gar gives a satisfied huff, relaxing his body as he takes another drink from his can.  "<i>You been nothin\' but good ta me ever since I met ya, ' + CoC.player.short + '.  I do ya one favor and you been a real friend ever since.</i>"  Ro\'gar\'s tone grows lower and more serious as a calloused finger rubs over his damp can.  You rest your arms against the polished wood of the bar as you listen.  "<i>Yer special ta me,</i>" he mutters quietly, just loud enough for you to hear him.  You smile warmly and rest a hand against his arm, coaxing him to turn his head to look at you.  "<i>Here, I got ya sumthin.</i>" Ro\'gar digs through his pants pocket and pulls out a tin can.  Tugging your hand closer, he puts it in your palm and grins widely at you.  "<i>It\'s what I\'m drinking now.</i>"  He taps his can.  "<i>One\'ve my favorites.  Thanks, ' + CoC.player.short + '.  You kin drink with me any time.</i>"  The pair of you spend some time together at the bar, drinking and laughing as you empty mugs.  Eventually you part ways and wander back into the city.\n\n', false );
				//set Ro'gar phase = 4 and Ro'roh Raggy = 0, Acquire 1x Bro Brew;
				CoC.flags[ kFLAGS.ROGAR_PHASE ] = 4;
				CoC.flags[ kFLAGS.ROGAR_WARNING ] = 0;
				SceneLib.inventory.takeItem( ConsumableLib.BROBREW, SceneLib.camp.returnToCampUseOneHour );
			}
			//(else if Dirt Mc Girt = 2);
			else {
				MainView.outputText( 'Your heart flutters as you realize he is still only wearing the ragged shorts beneath his hooded cloak, and your eyes rake over his musculature as he models.  "<i>How\'s about you an\' I go visit the baths sometime?</i>"  Ro\'gar asks coyly, relaxing his body as he takes another drink.  "<i>You been nothin\' but good ta me ever since I met ya, ' + CoC.player.short + '.  I do ya one favor and you been a real friend ever since.</i>"  Ro\'gar\'s tone grows lower and more serious as a calloused finger rubs over his damp can.  You rest your arms against the polished wood of the bar as you listen.  "<i>Yer special ta me.</i>" he mutters quietly, just loud enough for you to hear him.  You smile warmly and rest a hand against his arm, coaxing him to turn his head to look at you.  His tongue slides over his lips as he gives you a seductive stare, with his hand reaching between your legs.', false );
				//[(female or unsexed);
				if( CoC.player.gender === 2 || CoC.player.gender === 0 ) {
					MainView.outputText( '  It stops on your bare mons, and Ro\'gar\'s eyes widen.  "<i>Wh-wha... there\'s nothin\' here!</i>"  You color and nod.  His mouth hangs open for a long minute, then he masters himself.  "<i>Well... I, uh, guess it was good t\' see ya again...</i>" he stammers.  "<i>Hey, I\'m sure you\'ve got things to be doin\' so I won\'t hold you up.</i>"  As you attempt to protest, he chugs his drink and makes a show of slamming the can down, noisily and forcefully, on the bar.  Nodding at you, he pulls the cloak over his head and leaves the bar.  Apparently it was quite a shock to him.  You wonder if he\'ll avoid you from now on...', false );
					CoC.flags[ kFLAGS.ROGAR_DISABLED ] = 1;
					EngineCore.doNext( SceneLib.camp, SceneLib.camp.returnToCampUseOneHour );
				} else {
					MainView.outputText( '  ' + Descriptors.SMultiCockDesc() + ' gets a caress from him as he explores, arousing it to mild stiffness.  "<i>' + CoC.player.short + ',</i>" he grunts.  "<i>Ah hope ah\'ll be seein\' more of ya.</i>"  Ro\'gar breaks the contact and tips back the remains of his drink while you ', false );
					if( CoC.player.cor < 50 ) {
						MainView.outputText( 'blush', false );
					} else {
						MainView.outputText( 'fantasize about those strong hands touching every part of you', false );
					}
					MainView.outputText( '.  I drink here whenever I\'m not werkin\' out or on a job.  I\'ll be waitin\' for you.</i>"  He lowers his eyelids suggestively at you, then gets up; you smile dumbly as he leaves the bar, watching him go with a blush in your cheeks', false );
					//[(If player has a tail);
					if( CoC.player.hasLongTail() > 0 && CoC.player.isNaga() ) {
						MainView.outputText( ', and you feel your tail flicking rapidly in excitement', false );
					}
					MainView.outputText( '.\n\n', false );
	...
	Rogar.prototype.rogarPhaseFour = function() {
		...
		//(high fem or breasts >=B-cup and Ro'roh Raggy =1);
			...
			MainView.outputText( 'Ro\'gar the orc is here drinking again, but as you catch his eye, a pained expression flashes across his face as he looks over your form.  It\'s clear he doesn\'t relish the prospect of talking to you right now, but knowing him, he\'s too polite to say so.  The wind spills from your sails and your icebreaker slips from your mind - answering him with a simple glance of resignation is the most you can manage.  He gives you a weak smile and returns to his drink.', false );
			//return to bar menu;
			EngineCore.doNext( SceneLib.telAdre, SceneLib.telAdre.barTelAdre );
		}
		//(andro or masculine with tits <= A);
		else {
			MainView.outputText( 'Ro\'gar is tipping his drink back when he catches sight of you, and waves you over.  "<i>Ah, good ta see ya, ' + CoC.player.short + '!', false );
			//[(Ro'roh Raggy = 1);
			if( CoC.flags[ kFLAGS.ROGAR_WARNING ] === 1 ) {
				MainView.outputText( 'Yer lookin\' much better today; ya been workin\' out?</i>"  You smile at the compliment, and ', false );
			} else {
				MainView.outputText( '</i>"  You ', false );
			}
			MainView.outputText( 'wave the bartender over for another round.  "<i>So,</i>" he begins once you\'ve finished your drinks and she\'s out of earshot, "<i>I was wonderin\' if ya would like to hang out at my place later?  It ain\'t much, but it\'d be a lot more... private... than here.</i>"  He colors slightly and waggles an eyebrow at you, then slides a hand into your groin.', false );
			//[(if F or U);
			if( CoC.player.gender === 2 || CoC.player.gender === 0 ) {
				MainView.outputText( '  It reaches the center without interruption, and Ro\'gar colors deeper.  "<i>Uh... ferget it,</i>" he mumbles.  "<i>Didn\'t mean ta be indecent with you or anythin\', miss.</i>"  He nods to you and quickly departs before you can recover from the surprise.', false );
				EngineCore.doNext( SceneLib.camp, SceneLib.camp.returnToCampUseOneHour );
			} else {
				MainView.outputText( '  ' + Descriptors.SMultiCockDesc() + ' trembles under his strong touch, as he increases the pressure and looks into your eyes meaningfully.  ', false );
				//[(if Dirt Mc Gurt flag = 1);
				if( CoC.flags[ kFLAGS.ROGAR_DIRT ] === 1 ) {
					MainView.outputText( '</i>"I know ya probably ain\'t ever imagined hangin\' out with a feller like me, but... I could really use the company tonight.</i>"  ', false );
				}
				MainView.outputText( 'He\'s clearly in the mood for some fun; do you want to head back to his place and do something?', false );
	...
	Rogar.prototype.rogarFuckMenu = function() {
		MainView.spriteSelect( 86 );
		var getAnal = null;
		var giveAnal = null;
		var frot = null;
		...
		var getTied = null;
		var rubdub = null;
		if( CoC.player.hasItem( ConsumableLib.BROBREW ) ) {
	...
	Rogar.prototype.loseButtGinity = function() {
		...
		if( CoC.player.ass.analLooseness === 0 ) {
			...
			MainView.outputText( '"<i>So fuckin\' tight...</i>" Ro\'gar snarls as he nears his limit.  "<i>Time fer yer first proper breedin\', boy!</i>"  His voice makes his chest rumble as he pants hot breath that caresses your face.  The sound of smacking skin rings in your ears, and you briefly note that your ' + Descriptors.buttDescript() + ' feels red and sore from Ro\'gar\'s hips beating against them before closing your eyes to another pleasurable thrust.  With a harsh snarl his jaw bites down on your shoulder possessively as his swollen sack tightens.  Soon your lower body is flooded with a warmth you\'ve never felt before.  Ro\'gar\'s seed fills you completely as the musky load coats and stains your once-pure hole.  A pressure builds within you, the wet spunk spurting from your rim to drip down your upturned ass cheeks.  Ro\'gar\'s huffs exit through his clenched teeth as he rides out his orgasm, pumping into you a few more times until he\'s deposited every last drop from his heavy balls.\n\n', false );
			MainView.outputText( 'With a sigh of exhaustion his jaw unlatches from your shoulder and he lies on the bed next to you.  The pair of you take a moment to catch your breath.  The only sounds you hear are the sounds of labored exhalation until Ro\'gar sits up.  You hear a clicking nearby and you raise your head to see Ro\'gar drinking from a tin can.  Sitting up yourself causes Ro\'gar turn to meet your gaze.  "<i>You don\'t hafta say anything.  I tend ta get carried away with these kinds\'a things.  Hearing \'bout yer virgin ass...  Hoo-wee!</i>"  He gives a nervous chuckle as you answer with a tired grin.  He unties your hands and takes another sip of his drink.  "<i>So uh... did ya-</i>"  The question is interrupted as you peck an affectionate kiss against his tusk, then his lips.  "<i>Right,</i>" he laughs and then rubs the back of his neck with a hand.  "<i>No need for mushy talk then.  You hafta go.  Don\'t worry, I understand.</i>" Ro\'gar helps you get up and round up your gear, so hastily scattered in his fervor.  He follows you to the door.  "<i>Take care now, y\'hear?  And, ' + CoC.player.short + '... come see me soon, alright?</i>"  Ro\'gar smiles from the door and waves a hand, watching you leave.  You wander back into the city exhausted.\n\n', false );
			//<Lust sated, slimefeed>;
		}
		//(([Get Anal] Scenario 1b: Get fucked (normal)));
		else {
			MainView.outputText( 'You nod eagerly, and the orc rewards you with another caress.  "<i>Well then... let\'s head on out,</i>" he says.  The two of you walk down the desert city\'s streets until you reach a discrete, out-of-the-way building labeled \'Steel Hogan Apartments\'.  "<i>S\'about time you came home with me, ' + CoC.player.short + '.</i>"  He pushes the door open and steps inside, disappearing down a hallway.  "<i>How\'s about you come siddown?</i>" he calls, and you follow the sound of his voice.  One of his large hands rests against his leg, which parts from the other to draw your gaze between them.  The orc is already bereft of his tiny shorts, his nude body nestled in a couch and beckoning you over.  His exposed member hangs limp over his impressive sack.  You press your lips together in thought, feeling warmth grow in your loins.\n\n', false );
			MainView.outputText( 'You can\'t help but feel hesitant as you draw near, but your lusts aren\'t willing to refuse the offer. You sit astride Ro\'gar\'s leg, with your thighs clasping the mighty muscle that makes up his.  Ro\'gar snakes an arm around your waist and tugs you closer, pressing you against his chest.  "<i>That\'s a good boy.  Now how\'s about a kiss?</i>"  He chuckles as he reaches a hand under your chin, tilting your face to meet his.', false );
			if( CoC.player.tallness >= 84 ) {
				MainView.outputText( '  You lean down as Ro\'gar tilts up, your lips connecting with his, both mouths open to let tongues wrestle.', false );
			}
			//(If player height is less than 7 feet);
			if( CoC.player.tallness < 84 ) {
				MainView.outputText( '  You lean up into Ro\'gar\'s mouth, his hand caressing your cheek.', false );
			}
			MainView.outputText( '  You can feel his demanding tongue pressing into your mouth and coaxing moans from the wanton entrance.  His hand slides down your waist to cup your ' + Descriptors.buttDescript() + ' in his strong grip.  Ro\'gar breaks the kiss with a devious grin.  "<i>Let\'s get you out of these clothes.</i>"  His voice rumbles deep in his chest, the resonations vibrating against your skin.  He takes the initiative and pulls off your garments, leaving you completely nude in his lap.  One of the orc\'s hands wanders over your body, playing with your nipples while the other slides down toward your ' + Descriptors.multiCockDescriptLight() + '.  Ro\'gar\'s head nestles in the nape of your neck, gently nipping at your skin and reddening it with a slight sting.  Where he nibbles he quickly follows with a tender lap of warm tongue over the abused flesh, bringing slight shudders through your body as his smooth tusks rub over you.\n\n', false );
			MainView.outputText( 'You are left panting for breath from Ro\'gar\'s continued teasing, your skin on fire from every touch as his thin oil smears over it.  You spread your legs lewdly on Ro\'gar\'s lap, blood rushing south as you feel yourself stiffen and throb - though you aren\'t the only one sporting wood, as you soon feel Ro\'gar\'s hot manhood pressed up to your side.  He groans into your shoulder, bucking his hips to hump your flesh.  Pre-cum dribbles from Ro\'gar\'s swollen cockhead and smears you in his need.  "<i>Come here,</i>" he whispers directly into your ear.  His hands grip your bottom as he pulls you closer to face him.  Your chest presses to his as you straddle Ro\'gar\'s hips.  Ro\'gar\'s throbbing ten inches of man meat tucks between the cheeks of your ' + Descriptors.buttDescript() + '. He gives you a playful wink, bucking his hips to bounce you in his lap.  The feeling of his hot, thick length rubbing over your ' + Descriptors.assholeDescript() + '  and wetting it with copious pre makes you gasp like a bitch in heat.  The dripping orc spooge snakes down in between your cheeks, and you feel your body shudder with anticipation; Ro\'gar lets the liquid pour over his own hard-on.  "<i>My favorite boy ready for the ride of his life?</i>"  He grins impishly as he grips the head of his thick, uncut orc cock and pushes it against your boy cunt.  A gasp of pleasure escapes your lips and your hands clasp onto Ro\'gar\'s shoulders, wriggling your ' + Descriptors.buttDescript() + ' over the green mile.\n\n', false );
			MainView.outputText( 'With a buck of Ro\'gar\'s hips his slick cockhead slips into your ' + Descriptors.assholeDescript() + '.  Your lips part wide, letting out a sharp gasp as he nestles within you.  "<i>Git ridin\', boy!</i>" he barks, with a hard smack against your ' + Descriptors.buttDescript() + '.  You yelp at the rough treatment, easing yourself down slowly to slide Ro\'gar\'s stiff flesh further into you, and feel yourself growing hard as the throbbing manhood stretches you open.  ' + Descriptors.SMultiCockDesc() + ' swells with blood as it brushes against Ro\'gar\'s stomach, and the sensitive urethra picks up a thin layer of his slime from his skin, making you burn with sensitivity.  Your hips shift into Ro\'gar\'s body more, rubbing your ' + Descriptors.multiCockDescriptLight() + ' tightly against him.', false );
			if( CoC.player.cockTotal() > 1 ) {
				MainView.outputText( 'Lines of pre-cum are drawn with your erections, adulterating the sweat and oil on Ro\'gar\'s body as you bob your hips along Ro\'gar\'s mast.   ', false );
			}
			MainView.outputText( 'Your spunk dribbles over Ro\'gar\'s green skin and collects in his navel as his mouth attacks your neck with an assault of nips and licks, each nibble rubbing his tusks over your sensitized skin.  Hands roughly grip your ' + Descriptors.buttDescript() + ', spreading your cheeks apart manually and kneading the flesh like dough.  He coaxes you to move faster with demanding nudges of your hips, growling deeply with each thrust of his cock inside you.  Hot fluid sticks to your inner walls, arousal making you buck your hips helplessly as you become more and more sensitive with each thrust.  You\'re soon bouncing up and down on Ro\'gar\'s prick, and to further your wild ride, Ro\'gar begins bucking his hips up to meet your ' + Descriptors.buttDescript() + '.\n\n', false );
			//[(If player is fat or has very defined muscles);
			if( (CoC.player.thickness >= 75 && CoC.player.tone < 33) || CoC.player.tone >= 75 ) {
				MainView.outputText( 'Riding Ro\'gar\'s stiff manhood as fast as you can muster, you drive the orc man wild with need.  His thick girth stretches your ' + Descriptors.assholeDescript() + ' wide around it, making you a wonderful sleeve for his orc cock.  He hilts within you, and you cry out in pleasure as his cockhead rams your prostate.  Ro\'gar wrests control from you as he hears you cry out like a bitch in heat.  His strong hands at your ' + Descriptors.hipDescript() + ' hold you in place as he pounds your ' + Descriptors.assholeDescript() + ', ramming against you with brutal force and making you moan loud enough that your voice grows a little hoarse.  ' + Descriptors.SMultiCockDesc() + ' twitches from the abuse to your trigger', false );
				if( CoC.player.balls > 0 ) {
					MainView.outputText( ' and your ' + Descriptors.ballsDescriptLight() + ' clench tight as you feel your limit reached', false );
				}
				MainView.outputText( '.', false );
				//[(if player has toes);
				MainView.outputText( '  You curl your fingers and ' + CoC.player.feet() + ' in ecstasy as Ro\'gar drives you over the edge.', false );
				MainView.outputText( '  Your bucks become ragged, and the orc takes over as ' + Descriptors.sMultiCockDesc() + ' jerks and spasms, shooting out countless ropes of sticky spunk onto the glistening green skin, painting the orc white with your lust.  With a low, deep, tone, Ro\'gar groans out as you feel his warmth overtake your lower body, flooding you full of his fertile man cream.  Ro\'gar continues to fuck you with decreasing vigor, slowing to a stop as his spent cock pops from your drooling pucker.  His spunk floods out of your filled boycunt, the spooge running down Ro\'gar\'s half-hard cock to drip onto the floor lewdly.\n\n', false );
			}
			//(else);
			else {
				MainView.outputText( '"<i>Enough horsin\' around.</i>"  Ro\'gar snarls as his arms quickly yank back, sneaking under your legs and hoisting you up as he gets to his feet.  You grip Ro\'gar\'s shoulders tight as he lifts you with a strained grunt.  You delight with sharp little moans as he begins to fuck you skyward, bouncing you off of his hips with each slam of his cock into you.  Slowly Ro\'gar steps towards a wall, taking his time to be sure not to drop you, and you soon feel the cool surface pressed to your back.  Caught between a cock and a hard place, you stare into Ro\'gar\'s predatory gaze as he holds you hoisted in the air and pinned, making you feel vulnerable.  The orc takes advantage of you and begins to abuse your ' + Descriptors.assholeDescript() + ', making your head tilt back to moan out helplessly.', false );
				MainView.outputText( '  ' + Descriptors.SMultiCockDesc() + ' lays out over your chest, dribbling pre-cum on your skin as you make a mess of your torso in lust.', false );
				//[(if player has tail) ;
				if( CoC.player.hasLongTail() > 0 || CoC.player.isNaga() ) {
					MainView.outputText( '  Your tail flicks helplessly below you, urgently wrapping around Ro\'gar\'s thigh and trying to pull him deeper into you.', false );
				}
				MainView.outputText( '  You cry out as Ro\'gar finds your sweet spot.  "<i>Now I got yer button, boy,</i>" he snickers, wearing his usual predatory grin, the sharp, jagged teeth on full display as you shudder from the relentless pounding against your ' + Descriptors.buttDescript() + '.  The sound of flesh smacking flesh is loud in your ears as you squirm from Ro\'gar\'s cock.  Each thrust drives you mad with pleasure, your mind in a lust-induced haze as your prostate is prodded and poked.', false );
				//[(If player has balls) ;
				if( CoC.player.balls > 0 ) {
					MainView.outputText( '  You feel your ' + Descriptors.ballsDescriptLight() + ' pull up tight in your sack as your labored breath comes out in pants.', false );
				}
				MainView.outputText( '  Ro\'gar continues his savage thrusts, impaling you fully on his length; soon you cry out in ecstasy as his urgent pounding brings you to climax, spraying yourself with your own thick spunk.  Your chest is quickly coated in ropes of your own cum, glazing your torso like a delectable treat to be licked off.   Your orgasm spurs him onward, and Ro\'gar crushes you between himself and the wall with each powerful thrust.  A maddened hiss sounds as he breathes through his clenched teeth, impaling you with a few sharp smacks of hips against ass, and snarls issue from the orc as you are suddenly flooded with cum.  He seems to ejaculate for an eternity, each urgent thrust pumping another bucket of jizz into your ass. Your stomach distends as cum begins to overflow and run from your ass to drip from the orc\'s bouncing, fat balls and make a puddle on the floor.  You moan in exhaustion as he plants his seed inside you.\n\n', false );
			}
			//((Paths combine here));
			MainView.outputText( 'With exhausted panting the only sound from both Ro\'gar and yourself, you take a few moments to catch your breath.  Ro\'gar affectionately nuzzles you before letting you get to your feet, holding you until he\'s sure you can stand easily.  The pair of you share a knowing look and Ro\'gar grins at you.  "<i>You\'re amazin\', ' + CoC.player.short + '.  You\'re welcome anytime ya like.</i>"  He gives you a tender embrace as you collect your things and walk on wobbly legs toward the door, still feeling cum running down your legs beneath your garments.  The orc sees you off with a wave and a toothy grin.\n\n', false );
			//<Lust sated, slimefeed>;
		}
		CoC.player.orgasm();
	...
	Rogar.prototype.fuckRogarsButtPussyBoyCuntManMoundSissySlitQueerQuim = function() {
		...
		if( CoC.player.cor > 70 && CoC.player.hasVagina() ) {
			MainView.outputText( 'Ro\'gar flicks his tongue toward your ' + Descriptors.multiCockDescriptLight() + ', but you have a better idea and nudge him lower to guide him to your ' + Descriptors.vaginaDescript() + '.  His eyes look up at you in confusion.  You can tell he\'d rather not have his face buried there by the way he moves his mouth away, but you urge him on; telling him to get licking, you push your hips down over his face.  With his head caught between your legs and the bed his mouth presses to your ' + Descriptors.vaginaDescript( 0 ) + 'without a choice.  His whimpers of displeasure bring a grin to your face as you rub over his mouth with your netherlips.  He reluctantly flicks his tongue out to lap over your mound.  You shiver at the attention, growing moist and slick as you drip over Ro\'gar\'s mouth.  The orc gives a whine of disgust as you rudely force him to pleasure your pussy, and you let out a loud moan as his unwilling licks turn you on; excited, you stroke your ' + Descriptors.cockDescript( 0 ) + '.  Ro\'gar focuses his attention on that instead, watching you grow stiff and swollen, his eyes following your pumping hand.  You generously rub the slick, drooling pre-cum over ' + Descriptors.sMultiCockDesc() + ', your vaginal walls clenching around his tongue as you pleasure yourself, working the goo over your flesh with your hand.  You look down and grin devilishly at him.\n\n', false );
		}//(If player doesn't have vagina but has 70+ corruption);
		else if( CoC.player.cor > 70 ) {
			MainView.outputText( 'Ro\'gar flicks his tongue over your ' + Descriptors.multiCockDescriptLight() + ', but you have a better idea and nudge him lower to guide him to your ' + Descriptors.assholeDescript() + ' 0.  With a lusty growl Ro\'gar attacks your pucker, tongue swirling over the surface and coaxing a pleased moan from your lips.  You grow stiff with arousal, bringing a hand down your shaft to answer your burning lust with a few teasing strokes.  You smear the pre-cum pouring out of your ' + Descriptors.multiCockDescriptLight() + ' into an even coating of spunk as you work your hand.  Ro\'gar looks over at the pumping hand and soon becomes distracted from his work, his tongue pressed lazily against your ' + Descriptors.assholeDescript() + '.  You look down and grin devilishly at him.\n\n', false );
		}

		MainView.outputText( 'Pulling back off of Ro\'gar\'s face, you feel your entire body twitch in anticipation.  You press your ' + Descriptors.hipDescript() + ' against his muscled ass, lining your aroused member up against his tight rear while your hands grope over the firm muscled cheeks, spreading them apart eagerly.\n\n', false );
		//[((If biggest cock is less than 4 inches));
		if( CoC.player.longestCockLength() < 4 ) {
			MainView.outputText( '"<i>Yer serious?</i>" Ro\'gar asks with a quirked eyebrow.  You blink as he suddenly gets up to stare you in the eyes.  "<i>Not to be rude, ' + CoC.player.short + ', but I ain\'t gonna feel nothin\'.</i>"  You can\'t help but feel a little offended, saying something about motions of large bodies of water.  Ro\'gar doesn\'t seem convinced as he buries his forehead in a palm.  "<i>Listen, this ain\'t a really good time for this.  I\'m already losin\' my mojo.  You come back another time, okay?</i>"  With that, you are ushered out as politely as possible.  You can\'t help but feel a little embarrassed as you walk the city streets like this is some sort of walk of shame.', false );
			EngineCore.doNext( SceneLib.camp, SceneLib.camp.returnToCampUseOneHour );
			return;		//end if too small
		}
		//((else If smallest cock is over 18 inches));
		else if( CoC.player.shortestCockLength() > 18 ) {
			MainView.outputText( '"<i>E-easy there...</i>" Ro\'gar actually stutters, looking at you with concern.  You are impossibly huge for him, and despite your titanic head rubbing pre-cum over Ro\'gar\'s green hole it just won\'t fit.  You let out an annoyed grumble and begin to rub your length over Ro\'gar\'s body and orc cock.  With lustful grunts Ro\'gar bucks his hips into your ' + Descriptors.multiCockDescriptLight() + ', grinding the stiff masts together as they leak and drool over one another.\n\n', false );
			//[(If multiple cock);
			if( CoC.player.cockTotal() > 1 ) {
				MainView.outputText( Descriptors.SMultiCockDesc() + ' grinds over every inch of Ro\'gar\'s front, and his dark olive skin soaks in your glistening fluids.  Ro\'gar\'s length is lost in the forest of your meat.  With his green monster assaulted by multiple angles and dwarfed in size he whimpers softly.  "<i>Ain\'t never felt nothin\' like this.  Almost like fuckin\' a dick.</i>"', false );
			}//(else If single cock);
			else {
				MainView.outputText( 'Your ' + Descriptors.multiCockDescriptLight() + ' bucks against Ro\'gar\'s orcish pride.  The pair of hard cocks press tightly together as you dwarf Ro\'gar in size.  You hump his orc sex with your ' + Descriptors.multiCockDescriptLight() + ' and grunt in strain; your hands reach down to grip the pair of manhoods tightly, jerking them fast with squeezed pumps.', false );
			}
			//(If player has balls) ;
			if( CoC.player.balls > 0 ) {
				MainView.outputText( '  Ro\'gar squirms under you, his chest heaving with labored breath while his musky scrotum presses against your own.', false );
			}
			MainView.outputText( '  He reaches down, sweaty palm wrapping around his meaty length and roughly choking it, then strokes along his orchood hastily as he groans out, spunk spilling over ' + Descriptors.sMultiCockDesc() + ' and leaving it sopping wet with hot seed.  Your own hands rub Ro\'gar\'s strong smelling sperm over yourself, coating your ' + Descriptors.multiCockDescriptLight() + ' in his lust.  The sight of the heaving orc beneath you drives you over the edge,and your pent-up load splatters over Ro\'gar\'s sweaty body and covers the orc in your thick volleys of cum.', false );
			MainView.outputText( '\n\n', false );
		}
		//((If cock is between 18 and 4 inches));
		else {
			MainView.outputText( '"<i>E-easy there.</i>"  Ro\'gar actually stutters, looking at you with concern. Your lips curl into a devious grin as you roughly press into Ro\'gar\'s puckered hole.  You slide in with an abrupt grunt, ignoring Ro\'gar\'s yelps of pain at the sudden entry and reasoning that it couldn\'t have hurt too much, judging by how your ' + Descriptors.cockDescript( 0 ) + ' was literally coated in pre-cum.  But still, you find it amusing to push the orc\'s button and make him squirm for once.  Slipping in further, you bury yourself in Ro\'gar\'s hole until he groans out and prematurely spurts more orc cum onto his stomach.', false );
			//[(If using feline cock);
			if( CoC.player.cocks[ 0 ].cockType === CockTypesEnum.CAT ) {
				MainView.outputText( '  You grind around in his green pucker, the barbs working over Ro\'gar\'s inner walls.  "<i>W-what in tarnation?</i>" Ro\'gar grunts as you watch him squirm under you.  You buck your hips, digging deeper into orcflesh with each thrust, his muscled ass tensing with each slam of your hips.', false );
			}
			//(If horse cock);
			else if( CoC.player.cocks[ 0 ].cockType === CockTypesEnum.HORSE ) {
				MainView.outputText( '  The flared head of your ' + Descriptors.cockDescript( 0 ) + ' nestles in Ro\'gar\'s hole.  His breath quickens as you push in, the girthy, flared head stretching Ro\'gar\'s insides impossibly.  You simply thrust and buck you way deeper within the green pucker to force more of your lengthy shaft past that olive rosebud each time.\n\n', false );
			}
			//(If dog cock);
			else if( CoC.player.hasKnot( 0 ) ) {
				MainView.outputText( '  Your pointed tip slips in easily and you begin to plunge into Ro\'gar\'s depths, and the burly orc gives satisfied grunts as his strong hand reaches down to touch himself.  You begin to fill his orc hole, the pre-slicked cock working as a lubing tool as you begin to build a nice rhythm within Ro\'gar.  Your knot bulges as your climax approaches and begins to ram into Ro\'gar\'s green pucker, the tight ring unable to allow entry as you swell bigger and bigger.', false );
			}//(If other cock);
			else {
				MainView.outputText( '  Breaking Ro\'gar\'s orc hole open, you thrust deep within his hot, tight depths.  The burly orc pants with heated breaths, humid air fluttering out of his tusked mouth.  His musclegut heaves, each breath punctuating the thrusts of your hips.  You plow his ass roughly, pulling out until only the head remains inside him before plunging back in further than before.  Ro\'gar grunts low in his chest with each bit of progress made, his strong, calloused hand stroking his drooling cock.  "<i>Mmmf, ' + CoC.player.short + ',</i>" he groans as you finally hilt yourself within him.', false );
			}
			//end racialdicks, still inside right fit path;
			MainView.outputText( '\n\nYou grip his hips and begin a steady pace, slapping flesh loudly against his muscled ass.  His thick, powerful legs twitch in the air as you pound into his orcish hole, and the orc\'s toes curl visibly with each brutal thrust you make into him.  You groan as his musk makes your ' + Descriptors.multiCockDescriptLight() + ' throb all the more within him.  To further his humiliation, you whisper in his pointed ear how good he feels wrapped around your length.  He blushes a lime green before you make him groan out your name with a rough smack over his ass.', false );
			if( CoC.player.cockTotal() > 2 ) {
				MainView.outputText( '  Your other cocks grind over that firm orc rump, drooling over his skin and making his rear glisten with your sex.', false );
			} else if( CoC.player.cockTotal() > 1 ) {
				MainView.outputText( '  Your other cock grinds over that firm orc rump, drooling over his skin and making his rear glisten with your sex.', false );
			}
			MainView.outputText( 'You decide to see how loud you can make him moan and begin ramming deep within him.  The thrusts slam hard enough to make Ro\'gar\'s back arch, your bulbous cockhead prodding his buried prostate with each hilt.  His big hand beats furiously at his massive orc cock, strained groans bellowing out loudly as his heavy sack clenches tight against the base of his green rod.  Orc spunk flies out over his chest, hitting his chin and splattering over his heaving pecs.  His cum collects between his bulging muscles and splashes over his head.  Ro\'gar\'s anal walls clench down tight around you as you pick up the pace of your brutal fuck; your ' + Descriptors.cockDescript( 0 ) + ' is milked hard as you feel your climax rapidly approaching.  Sweat drips from your body onto Ro\'gar\'s skin, and you finally feel yourself hit the edge.  With a burst of ecstasy you hilt completely within your orc fuck toy.', false );
			//[(If dog cock);
			if( CoC.player.hasKnot( 0 ) ) {
				MainView.outputText( '  Your knot forces past Ro\'gar\'s tight, anal ring to pulse inside him, joining the pair of you together.', false );
			}
			//[(if player has balls);
			if( CoC.player.balls > 0 ) {
				MainView.outputText( '  With short jerks of your hips, you begin to unload your pent up orbs into the orc\'s innards.', false );
			}
			MainView.outputText( '  Wave after wave of thick seed spills from your cock into Ro\'gar as his head falls back at the blissful sensation.', false );
			//[(if multiple cock);
			if( CoC.player.cockTotal() > 1 ) {
				MainView.outputText( '  The other meat rubbing over his olive skin outside adds to the coating of spunk, making a giant mess of Ro\'gar\'s body.  In seconds he resembles a well-paid whore beneath your ' + Descriptors.multiCockDescriptLight() + '.', false );
			}
			MainView.outputText( '\n\n', false );
		}
		//end right fit path;
		//((Combine too big, and right size paths));
		MainView.outputText( 'Ro\'gar\'s cum-coated body lies panting under you.  You slowly soften and lay limp against his olive skin, then pull away and clean yourself off.  Ro\'gar stirs slowly, only rising to a seated position by the time you are dressed.  "<i>That was really... something.  I don\'t really know what got inta ya, ' + CoC.player.short + ', but ya really know how ta surprise a feller.</i>"  With a sly smirk you intone that he had it coming and finish putting on your clothes, then walk over to smack Ro\'gar\'s cum-covered ass with your hand.  The giant orc looks stunned a moment before giving a playful grin.  "<i>Frisky, aren\'t\'cha?</i>"  He snickers low in his rumbling chest, then gets up to wave you off, but you\'re already out the door and heading back into the city with a spritely skip added to your step.', false );
		//<Lust sated>;
		CoC.player.orgasm();
	...
	Rogar.prototype.rogarIsDumb = function() {
		MainView.outputText( '', true );
		MainView.spriteSelect( 86 );
		MainView.outputText( 'You relinquish the can with a smile, slyly telling Ro\'gar he can have it, then put your hands behind your back innocently.  He narrows his eyes, then shifts them to the can.  After a careful inspection, he thrusts the can toward you.  "<i>Don\'t want it.  Ya probably put bimbo liqueur in it or somethin\', ya sneaky devil.</i>"\n\n', false );
		MainView.outputText( 'The playful mood broken, you hang out for a while and shoot the breeze, then head back.', false );
		//end;
		EngineCore.doNext( SceneLib.camp, SceneLib.camp.returnToCampUseOneHour );
	};
	//[Fukkin' Grab It!];
	Rogar.prototype.takeDatBroBrewFromDaBigMeanOlOrc = function() {
		...
		if( CoC.player.findPerk( PerkLib.BroBody ) < 0 ) {
			...
			if( CoC.player.biggestTitSize() >= 1 ) {
				if( CoC.player.breastRows.length > 1 ) {
					while( CoC.player.breastRows.length > 1 ) {
			...
			if( CoC.player.hasCock() ) {
				if( CoC.player.cocks[ 0 ].cockLength < 10 ) {
					if( CoC.player.cocks[ 0 ].cockThickness < 2.75 ) {
			...
			if( CoC.player.femininity > 0 ) {
				CoC.player.modFem( 0, 100 );
			}
			//max tone.  Thickness + 50;
			if( CoC.player.tone < 100 ) {
				CoC.player.modTone( 100, 100 );
			}
			if( CoC.player.thickness < 100 ) {
				CoC.player.modThickness( 100, 50 );
			}
		...
		if( changed ) {
			MainView.outputText( '  You realize you look much stronger, bigger, and sexier', false );
			//(if dick grew);
			if( cocked ) {
				MainView.outputText( ', and you smile to yourself as your now-larger endowment rubs against garments not suited to it', false );
			}
			MainView.outputText( '.  Who needs book smarts anyway?  Nerds.', false );
			//lose lust, gain bro traits, slimefeed;
			CoC.player.createPerk( PerkLib.BroBrains, 0, 0, 0, 0 );
			CoC.player.createPerk( PerkLib.BroBody, 0, 0, 0, 0 );
	...
	Rogar.prototype.frotWithRogar = function() {
		...
		MainView.outputText( '', true );
		MainView.spriteSelect( 86 );
		MainView.outputText( 'You allow yourself to be led into Ro\'gar\'s apartment and look around the modestly furnished lounge. Ro\'gar seats himself in a cushioned chair.  "<i>Thanks fer comin\'.  I missed ya.</i>"  He snickers, and you draw closer. His calloused hand reaches down to cup your ' + Descriptors.buttDescript() + '.  He smirks at you, the frisky orc chuckling deeply and firmly squeezing.  You retaliate with a hard smack against Ro\'gar\'s muscled rump.  He growls low, answering the challenge and crashing his lips into your own.  Muffled grunts and groans issue from both of you as you undress each other.  Soon you are standing in the nude and Ro\'gar\'s hefty cock presses against your ' + Descriptors.multiCockDescriptLight() + '.\n\n', false );
		//(If multiple cocks);
		if( CoC.player.cockTotal() > 1 ) {
			MainView.outputText( 'Feeling your lengths stiffen against Ro\'gar\'s hard green monster, you buck against Ro\'gar\'s hard need, enveloping it in your cocks and coaxing a lewd groan from the orc.  Ro\'gar growls as he feels his orc length surrounded, his green member being slathered with your pre-cum from multiple directions.  His arms wrap around you as he fucks your ' + Descriptors.multiCockDescriptLight() + ', grinding his orc cock between all your lengths; he presses his tusks against your neck and suckles, teeth grating the flesh while his tongue passes over the indentations they leave behind.  Ro\'gar backs you up and you feel a hard wall behind you.  His oil-coated body rubs over your own, smearing onto your chest, arms, and hips.  Your hands grip tightly to Ro\'gar\'s back as you grind into him with your ' + Descriptors.multiCockDescriptLight() + '.  Ro\'gar reaches his hand down, wrapping his fingers around his length and the nearest cock to it, then strokes them slowly.  Hot breath washes over your face as he stares deep into your eyes, the deep blue pools hazed with lust as you fuck against each other\'s loins.  Your two bodies mingle with sweat and pre-cum, and soon your groins are sticky and glazed.  You fuck your cocks together, the strong scent of man musk filling your nose and sending a shudder down your spine and a thrill through your groin.  Ro\'gar suddenly moans, his orc cock caught between your ' + Descriptors.multiCockDescriptLight() + ' as he unloads over your chest.  His heavy sack clenches tight beneath his cock as he spills his thick seed onto you, coating you in his countless ropes.  The heat warms your skin as you reach your limit; each of your ' + Descriptors.multiCockDescriptLight() + ' twitches, hot and sticky spunk splashing over Ro\'gar\'s olive skin.\n\n', false );
		}
		//(If single cock);
		else {
			MainView.outputText( 'Your cock presses tight against Ro\'gar\'s fat orc cock. He growls low as he grinds himself over you, his thick, globbing pre-cum drooling onto your ' + Descriptors.multiCockDescriptLight() + '.  Muffled groans escape Ro\'gar\'s mouth as you kiss him roughly, tongues locked all the while in writhing combat.  ', false );
			//[(If player has balls);
			if( CoC.player.balls > 0 ) {
				MainView.outputText( 'Your ' + Descriptors.ballsDescriptLight() + ' slap audibly against Ro\'gar\'s heavy green sack.  ', false );
			}
			MainView.outputText( 'Each thrust is slicker and better than the last as your cockheads drip out copious amounts of pre-cum over each other\'s lengths, the two manhoods slick and bucking toward the other in hard, bestial rut.  Ro\'gar backs you up and you feel a hard wall behind you.  His oily body rubs over your own, smearing onto your chest, arms, and hips, and your hands grip tightly to Ro\'gar\'s back as you grind into the orc.  Ro\'gar reaches his hand down, wrapping his fingers around his length and yours.  He strokes along them with his rough, calloused hand, and hot breath washes over your face as he stares deep into your eyes.  The deep blue pools are hazed with lust as you fuck against each other\'s loins.  Your two bodies mingle with sweat and pre-cum, and soon your groins are sticky and glazed.  You fuck your cocks together, the strong scent of man musk filling your nose.  Ro\'gar suddenly moans, his orc cock caught against you as he unloads over your chest.  His heavy sack clenches tight beneath his cock as he spills his thick seed, coating you in his countless ropes of jizz.  The heat warms your skin as you reach your limit; your ' + Descriptors.multiCockDescriptLight() + ' twitches and hot and sticky spunk splashes over Ro\'gar\'s olive skin.\n\n', false );
		}
		//(( Paths combine here));
	...
	Rogar.prototype.kinkyWithDaOrc = function() {
		...
		MainView.outputText( 'over the threshold, and then look around the apartment.  He points out the small kitchen area and then, rather sheepishly, the bedroom.  You\'re examining it when something catches your eye...\n\n', false );
		MainView.outputText( 'You bend over the bed to grip a small bottle lying in the soft fabric of the sheets.  Turning it over, you tilt your head as you read the label.  It\'s... a bottle of lubricant.  Suddenly, there is a loud thud behind you and the bottle drops from your hand as your torso is pressed into the cushioned surface of the bed.  Something presses into your back.  "<i>Gotcha...</i>" the familiar voice snickers in your ear.  Ro\'gar\'s head leans over your shoulder and a long, orcish tongue licks your cheek.  "<i>Was waitin\' for this...</i>" he purrs; the resonance of his voice rumbles against your ear.  Ro\'gar chuckles and grips around your wrists.  "<i>Now that yer here, it\'s time ta break in this here new bed with sumthin\' I\'ve been cravin\' since I washed ya down in that swamp, boy.</i>"  Ro\'gar\'s tone suddenly takes a demanding, hissing tone.  His tongue flicks over your ear as he speaks.  Your skin begins to grow goosebumps as shivers crawl down your spine.\n\n', false );
		MainView.outputText( 'He yanks your wrists behind your back, ignoring your faint gasps.  With a rustle of cloth, your wrists are bound together behind your back tightly; your fingers feel over the bonds but you struggle against them in vain.  Looking over your shoulder in ', false );
		if( CoC.player.lib < 33 ) {
			MainView.outputText( 'feigned confusion ', false );
		} else if( CoC.player.lib > 66 ) {
			MainView.outputText( 'clear lust ', false );
		}
		MainView.outputText( 'at Ro\'gar, you only see his lust-ridden face dipping down to kiss at your lips.  His tusks press against your cheeks with a demanding snarl and his tongue into your mouth; your ' + Descriptors.buttDescript() + ' receives a smack, forcing you to yelp.  His tongue quickly invades, and his free hand unfastens your ' + CoC.player.armorName + ' to strip you forcefully.  Rough, calloused fingers dance over your body and fasten onto your ' + Descriptors.nippleDescript( 0 ) + 's, coaxing moans from your throat with each pinch.  Your pleased noises are muffled by Ro\'gar\'s mouth, his tongue and lips hushing each whimper and gasp you breathe.  A bare, firm chest presses against your exposed back, and you pant as the heat from his body burns against you, only intensified by the thin layer of oil on his skin.  Ro\'gar\'s blue eyes watch you like a predator as your face flushes.  He breaks the kiss and cups his hands under your chin to hold your face in place.  "<i>Such a perdy face yer makin\', ' + CoC.player.short + '.  Yer lookin\' at me like a proper slut, an\' it\'s makin\' me hard seein\' ya so needy to be bred.</i>"  He growls in his throat as his mouth nips over your neck, leaving red marks along your skin where his tusks rub against you.  You can feel the oil and sweat smearing over your back, and your senses go wild.  The room is soon filled with your needy whimpers as ' + Descriptors.sMultiCockDesc() + ' oozes and throbs against the sheets, making the fabric damp with your lust.\n\n', false );
		...
		if( CoC.player.ass.analLooseness < 3 ) {
			MainView.outputText( ' with some resistance, but the relentless finger rubs over your walls as he begins to pull your rim open, forcing another finger inside and making you bite your lip from the stinging sensation.  Working the pair of fingers together inside of you, he slowly moves them apart and stretches your hole wide.', false );
		} else if( CoC.player.ass.analLooseness < 5 ) {
			MainView.outputText( ' and rubs over your walls as he pulls your rim open, forcing another finger inside and making you moan like a bitch in heat.  Working the pair of fingers together inside of you, he slowly moves them apart and stretches your hole wide.', false );
		}
		MainView.outputText( '  Fingers and ' + CoC.player.feet() + ' curl in pleasure as your boycunt is forced open by Ro\'gar\'s steady coaxing.', false );
		...
		if( CoC.player.ass.analLooseness < 3 ) {
			MainView.outputText( 'the tight hole.  Your teeth clench as he stretches you wide around his length, though he continues without hesitation, and finally you cry out with the sting of the bulbous head squeezing into your tiny hole, though it falls on deaf ears as Ro\'gar merely groans at your tightness.', false );
		} else if( CoC.player.ass.analLooseness < 5 ) {
			MainView.outputText( 'your well-used hole. You moan with need as he stretches you wide around his length, continuing without hesitation until he\'s inside.', false );
		}
		CoC.player.buttChange( 25, true, true, false );
		...
		MainView.outputText( 'You can\'t help but focus on the wonderful feeling of Ro\'gar\'s cock throbbing within you.  Maybe this is where you belong?  With your ass impaled on Ro\'gar\'s massive tool?  You moan loudly as Ro\'gar picks up the pace, hips ramming into you with enough force to shift your body over the sheets.  He really starts to pound your hole with huffed grunts and groans as he hilts in you; his cockhead prods your prostate with each thrust, causing you to cry out as electric shocks shoot up your spine.  Every nerve in your body lights up like a Christmas tree and make your entire body squirm with pleasure.  You feel spurts of cum begin to leak from your ' + Descriptors.multiCockDescriptLight() + ' and glaze your belly with pre-cum.', false );
		if( CoC.player.hasLongTail() > 0 || CoC.player.isNaga() ) {
			MainView.outputText( '  Your tail, still gripping Ro\'gar\'s arm, squeezes tight.', false );
		}
		//(If player has balls) ;
	...
	Rogar.prototype.rubdubWithDaOrcWithoutDucky = function() {
		...
		MainView.outputText( '', true );
		MainView.spriteSelect( 86 );
		MainView.outputText( 'By the time you reach Ro\'gar he has already reached his bedroom, his shorts on the floor. You eye over his olive green skin, all of it laid bare before you including his limp orc cock hanging over his hefty nutsack.\n\n', false );
		MainView.outputText( '"<i>I purchased these oils to relax my muscles after spending so much time in the gym.</i>" Your orc lover motions to a few bottle of oils on his night stand. "<i>How about you give me a hand... or two.</i>" Ro\'gar grins at you, his eyebrows twitching suggestively. You need no further provocation as you strip from your ' + CoC.player.armorName + ', you let it fall into a pile on the floor as you make for the bottle. Ro\'gar grins and rolls onto his stomach.\n\n', false );
		MainView.outputText( 'The bottles pop open easily and you pour a generous amount over your hand, you spill even more over Ro\'gar back. He gasps feeling the cool liquid crawl down the spine of his back. Though it\'s not long after you warm his skin with your hands. Your fingers spread and smear the oils over his damp skin. You crawl up and straddle Ro\'gar\'s hips, sitting on his muscled ass as you begin to rub the oils in.\n\n', false );
		MainView.outputText( 'Ro\'gar\'s skin under your fingertips feels stiff, his muscles resisting your insistent touches. Slowly you can feel them relax, they smooth out and grow warm under your palms. It\'s not long until Ro\'gar is purring loud enough for you to hear. With a pleased growl Ro\'gar shifts under your body briefly before letting you continue.\n\n', false );
		MainView.outputText( '"<i>That\'s the spot.</i>" Ro\'gar grunts as you work your thumbs over a certain spot near his shoulders. You curve your fingers around his broad shoulder and gently pull the muscles to stretch away from the neck. Ro\'gar\'s mouth bellows a moan as his head falls to the sheets. The oils mixing with the strange liquid secreted from the orc\'s skin making a curious concoction. You can feel your hands feeling so warm and soothed, the muscles in your hands relaxed and comforted. As you look along Ro\'gar glistening back you wonder how it would feel to have such a large area affected by the slurry.\n\n', false );
		MainView.outputText( 'You ask Ro\'gar to flip over as you get off of his hips to get more oils. By the time you turn around your orc lover has already laid out on his back. Your eyes take in the sight of your muscled lover laid out for you, his muscled limbs bulging in anticipation, his swollen cock growing larger before your eyes. He grins at you as you pour oils over his chest, the cool liquid making him shiver as it drips down along his center. The clear oil crawling in between his pectorals, down his treasure trail and dipping into his navel before filling the gaps in his abdominals.\n\n', false );
		MainView.outputText( 'Without any hesitation you straddle the orc\'s hips again, his engorged orc cock brushing against the bare skin of your ' + Descriptors.buttDescript() + '. Your hands get to work smearing the relaxing oil over Ro\'gar\'s body. The orc stares at you with a lurid gaze as you massage his bulging pectorals, teasing his darkened nipples with your fingers. You grin feeling Ro\'gar\'s thick cock pressing more against your ' + Descriptors.buttDescript() + ' as his chest rumbles under your hands.\n\n', false );
		MainView.outputText( '"<i>You\'re good at this ' + CoC.player.short + ', have you done this before?</i>" Ro\'gar purrs as you work over his abdominals, tracing over every gap with your fingertips, the oils glistening over your lover\'s body. Ro\'gar\'s hips buck gently, bumping your ' + Descriptors.buttDescript() + ' with his throbbing cock with a chuckle, his mouth curls into a coy smile. You watch as Ro\'gar reaches his arms back, resting his head on his hands as he bares his underarm and pits.\n\n', false );
