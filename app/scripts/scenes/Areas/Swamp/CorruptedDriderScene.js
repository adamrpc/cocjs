...
angular.module( 'cocjs' ).run( function( SceneLib, MainView, CorruptedDrider, AppearanceDefs, UseableLib, StatusAffects, Appearance, Utils, PregnancyStore, kFLAGS, Combat, CoC, EngineCore, Descriptors ) {
	...
	CorruptedDriderScene.prototype.driderEncounter = function() {
		...
		//repeat intro:;
			...
			MainView.outputText( 'Spinning again, you lose your patience and loudly demand your ambusher present itself.  A soft tug on your ', false );
			if( CoC.player.tailType > AppearanceDefs.TAIL_TYPE_NONE ) {
				MainView.outputText( 'tail ', false );
			} else {
				MainView.outputText( 'hair ', false );
			}
			MainView.outputText( 'pulls you back halfway, but as you open your mouth to yell, the ground gives a quiet thump.  Just barely in your periphery, you see a white apparition with a yawning mouth stretching out to bite, and your reflexes take over, dropping your weight and rolling you away from it.\n\n', false );
			MainView.outputText( '"<i>Clever little pet,</i>" the phantom spits, resolving into the shape of a drider as your eyes focus and your adrenaline haze clears.  Raising a cupped hand to her ghoulishly grinning mouth, she laughs into it; a minute shivering in the air reveals the taut threads of silk attached to her finger.  The vibrations travel down them, shaking several silk-tied leaves and producing the raspy, laughing audience from before.  "<i>It\'d be so much easier on you if you\'d just walked into the trap, sweetness.</i>"\n\n', false );
	...
	CorruptedDriderScene.prototype.defeatDriderIntro = function() {
		...
		if( CoC.monster.HP < 1 ) {
			MainView.outputText( 'to try to continue the fight, her movements slowed by pain and weakness.', false );
		} else {
			MainView.outputText( 'to masturbate her swollen pussy-lips and the thick, juicy demon-cock that\'s sprouted in place of her clit.  She\'s so focused on getting off that she utterly gives up on the idea of fighting back, let alone dominating you as she seemed to plan originally.', false );
		}
		MainView.outputText( '  The spider-herm lies in a miserable, defeated heap.', false );
	...
	CorruptedDriderScene.prototype.winDriderPCDickInSpiderCunt = function() {
		...
		if( CoC.player.cor > 80 && CoC.player.lib > 50 ) {
			MainView.outputText( 'Of course it\'s the truth, the cunt\'s clearly got a good grasp on the obvious. Unwilling to lose your grip on dominance, however, you try to keep struggling to get the upper hand.\n\n', false );
		} else {
			MainView.outputText( 'No, that\'s not right.  You\'re not some rutting beast, you\'re the champion.  Sure, you\'ve got your ' + Descriptors.cockDescript( x ) + ' locked hilt-deep inside her squirming slit, but that doesn\'t mean you\'re some kind of ' + CoC.player.mf( 'stud', 'slut' ) + ' who jumps on a cunt without a second thought, does it?  You blink your eyes while you try to think.  She does have a point though, if you hadn\'t been in such a hurry for some sex, you wouldn\'t be sagging into her tits and feeling so awfully relaxed.\n\n', false );
		}

		MainView.outputText( 'The drider croons, "<i>Come on, don\'t delude yourself.  If you weren\'t such a dominating, rape-hungry beast you wouldn\'t be nuzzling against my tits and giving me little nods of agreement.  Honestly, how could you ever think of yourself as anything different when your brain just does whatever your dick tells it to?  You just got off and might have even knocked me up, but your penis is even harder than before.</i>"\n\n', false );
		if( CoC.player.cor > 80 && CoC.player.lib > 50 ) {
			MainView.outputText( 'You grumble out a denial.  You\'re not dumb, you just like to take charge and fuck. There\'s no reason to resist jumping on a nice wet pussy and making it squirt while you pack it full... but you can\'t quite get your limbs to move.\n\n', false );
		} else {
			MainView.outputText( 'You mumble out a denial.  You\'re not a beast... you just like to take charge and fuck.  It\'s just so hard to resist jumping on a nice wet pussy and making it squirt while you pack it full... no!  That\'s not what...\n\n', false );
		}

		MainView.outputText( '"<i>Oooh, are you leaking out more pre-cum already?  You\'re insatiable!  I bet you start thinking about your next fuck before you even finish getting off, don\'t you?  You can deny it all you want, but I felt your dick puff up a little bit more as soon as I said it.  No matter what you think, your cock is a dumb, happy little tattle-tale that always tells the girls exactly what you\'re thinking.</i>"', false );
		if( CoC.player.statusAffectv1( StatusAffects.Exgartuan ) === 1 ) {
			MainView.outputText( '  Exgartuan mumbles telepathicaly, "<i>Fuck yes I do, but I wanna see how this plays out.</i>"', false );
		}
		MainView.outputText( '  She adds, "<i>Face the music - there\'s nothing you love more than defeating someone and letting your dick tell you what to do.  You dumb... domineering... beast...</i>"\n\n', false );
		MainView.outputText( 'Gods!  It\'s getting so hard to think with that tight cunt clutching at your cock and the soft, feminine enunciations constantly interrupting your thoughts.  How can she concentrate with the stink of sex hanging so thick in the air?  Your ' + Descriptors.cockDescript( x ) + ' is so horny, why aren\'t you fucking her yet?  You shudder weakly and remember ', false );
		if( CoC.player.cor > 80 && CoC.player.lib > 50 ) {
			MainView.outputText( 'that it\'s because of her own venom paralyzing your muscles so effectively.\n\n', false );
		} else {
			MainView.outputText( 'there was something wrong about what she was saying... something important.\n\n', false );
		}

		MainView.outputText( 'The drider pauses to gaze into your eyes with all four of hers.  She runs a hand through your hair while making gentle shushing noises at you before she resumes her diatribe.  "<i>There there, I know how eager you are to fuck me into my place.  I\'m just another wanton harlot waiting to be forced on her back and turned into a fresh cock-sleeve for you, aren\'t I?  You recognize the absolute truth of my words.  Every time I talk you can feel the words bouncing around inside that empty head of yours.</i>"\n\n', false );
		MainView.outputText( 'You nod, actually moving your head against her pillowy breasts as you feel your strength starting to return.  Why is she wasting so much time telling you things you already know?  This bitch\'s cunt is like a white-hot furnace of lust, and your cock is so tired of having to sit still.  You can\'t wait to recover from the venom and fuck her so hard she\'ll black out from the ensuing orgasm.  Then you\'ll fuck her a few more times until your cock finally gets tired of her sloppy, cream-pied pussy.\n\n', false );
		MainView.outputText( '"<i>Oooh, that dick is just getting harder and harder isn\'t it?  I bet it feels like it\'s about to burst and cum, even though you\'re not able to punish me like you want to yet.  Maybe you secretly get turned on by being denied?  Oh!  I just felt your dick jump!  So you want to go around, letting your dick tell you to dominate every horny cunt you see, but the thing that turns you on more than anything else is having a woman turn the tables on you, isn\'t it?</i>"\n\n', false );
		MainView.outputText( 'You moan, "<i>N-no...</i>" but a small burst of pre-cum chooses that moment to erupt from your ' + Descriptors.cockDescript( x ) + ', still nestled inside the squirming spider-cunt.  It feels heavenly, and while you try to struggle in your weakened state, the warm embrace of her pussy\'s many cock-milking folds is turning your penis into a cum-drooling behemoth on the edge of exploding.  Oh gods, is she going to do it?  Damn, you want to put her in her place, but you\'re so weak right now.  Even worse, her pussy has you so close, so very close.\n\n', false );
		MainView.outputText( 'The chitinous, oh-so-right bitch pulls your head up to gaze deeply into her eyes.  "<i>You have a horny, naughty cock, and you always listen to it.  This rebellious member gets you into so much trouble, but you\'ll never stop listening to it.  You\'ll keep chasing every wet pussy you see, because you\'re just a horny animal.  A rutting, horny animal.  But I know your secret.  Your dick really wants a girl to turn the tables on you, paralyze you, and tease your cock mercilessly.  It feels so good to let me touch your body, stroke it, tease it, and squeeze it.  You won\'t even fight any more.  My pussy has your cock so close, so very close, and you\'re going to cum when I tell you.  You\'ll blow your load on command for me, my servile, secretly submissive mount.</i>"\n\n', false );
		MainView.outputText( 'A plaintive whining, almost exactly like that of an animal, vocalizes subconsciously.  Your ' + Descriptors.cockDescript( x ) + ' feels afire, constantly leaking pre-cum while you\'re held immobile in your spidery mistress\' arms; you lick your lips and start to beg, mumbling out your desire to cum for her, anything for her, so long as she lets your dick orgasm again and again.  You want to climax so bad, but you want her to control your cock so much more.  It\'s always getting you in trouble, and it feels so good to let her use you as her cum-drooling mount.\n\n', false );
		MainView.outputText( 'The spider-woman giggles and surprises you by kissing you on the lips, holding you against her while her narrow tongue smears her venom all over your lips and tongue, staining them purple.  You exhale happily through your nose, feeling perfectly, utterly relaxed and yet aroused beyond any reasonable measure.  The squeezing caresses around your dick keep you happily squirting heavy dollops of pre-cum.  You\'ve no doubt it must look like some kind of over-stuffed sausage by this point, bloated beyond reason.\n\n', false );
		MainView.outputText( 'When she pulls away, her face is covered in a huge blush, and she\'s panting out loud and interrupting her words with quiet moans as she talks, "<i>That\'s a good ' + CoC.player.mf( 'boy', 'girl' ) + '.  Even though you\'re a stupid pussy-slave, bound to let your cock lead you into every hungry snatch you see, you know how to obey a smarter woman\'s cunt, don\'t you?  Let me hear you beg like the animal you are.  Whine for mistress while her cunt fucks your dick, show me with every fiber of your being how much you love to submit, to obey, and to beg to be allowed to cum.</i>"\n\n', false );
		MainView.outputText( 'She lets your head hang limply, and all you can do is whine, and try to look up at her with the most pathetic expression in your eyes.  You\'re beaten - she\'s so much smarter than you and she\'s got you by your dick.  Why didn\'t you think?  ', false );
		if( CoC.player.cor > 80 && CoC.player.lib > 50 ) {
			MainView.outputText( 'Gods it was a bad idea not to bind her lips... ', false );
		} else {
			MainView.outputText( 'Gods this was a bad idea... ', false );
		}
		MainView.outputText( 'still, at least she\'s controlling your rebellious dick, teaching the little prick a lesson while letting you feel so good.\n\n', false );
		MainView.outputText( 'The drider moans louder and responds, "<i>Yes, oooh, good ' + CoC.player.mf( 'boy', 'girl' ) + '.  You\'re so hard, so very hard.  You\'re oozing out cum even though you\'re not allowed to fuck me, and you love it.  I bet you don\'t even mind not getting to orgasm - so long as you\'re helpless and hilt-deep in a cunt, you\'re happy, aren\'t you?  Oohhh, I\'m gonna... gonna... cum soon.  Luckily for you, I want you to squirt inside me.  I want that cock creaming my pussy as soon as I... ohhhh... so good... s-soon as I command it...  You\'ll do that for me, won\'t you?  You\'ll obey me completely, utterly, and pump every drop of your jism into my soon-to-be-pregnant pussy, right?</i>"\n\n', false );
		MainView.outputText( 'You mewl out an affirmation, forgetting how to speak with all the venom pumping through you and the mind-crushing levels of arousal pouring out of your ' + Descriptors.cockDescript( x ) + '.\n\n', false );
		MainView.outputText( 'The spider-woman shudders from head to all eight of her \'toes\', her four eyelids closing while her mouth gasps out, "<i>Cum for me.</i>"\n\n', false );
		MainView.outputText( 'The first spurt of pent-up seed splatters the spider\'s womb before you even realize she gave you permission, painting the squirming walls white.  You growl and cum, releasing spurt after spurt of spunk while her pussy seems to drink it all down', false );
		if( CoC.player.cumQ() > 1000 ) {
			MainView.outputText( ', even though you\'ve packed it full once already', false );
		}
		MainView.outputText( '.  Her legs skitter and tremble, her pussy convulses, and your dick gets the squeezing, sucking orgasm of a lifetime.  It feels like you\'re pumping out two or three orgasms worth of spooge, each dick-stretching explosion of cream dilating your slit almost painfully wide.', false );
		if( CoC.player.cumQ() > 1000 ) {
			MainView.outputText( '  The stuff dribbles out around your tool along with a mix of girl-lube, too much even for her prodigious pussy to contain.', false );
			if( CoC.player.cumQ() > 2000 ) {
				MainView.outputText( '  The flow thickens into a river, and soon the puddle of cum looks more like a pond, turning the dirt into a soup of muddy cum.', false );
			}
		}
		MainView.outputText( '\n\n', false );
		MainView.outputText( 'While it seems to go on and on, your orgasm eventually ends, leaving you to hang limp while your still-hard dick is massaged by a much wetter spider-cunt.  The ' + CoC.monster.hairColor + '-haired beauty dreamily says, "<i>Mmmm... good job, pet.  Now, let that nice hard dick do the thinking for you and keep fucking my hot cunt until it goes dry.  Maybe a few hours after you finish, you\'ll be able to remember that you used to be a ' + CoC.player.mf( 'man', 'woman' ) + ' before you became my livestock.</i>"\n\n', false );
		MainView.outputText( 'The blissful arachnid rolls onto her side with you still locked inside her and falls asleep, her ' + CoC.monster.hairColor + ' tresses ', false );
		if( CoC.player.cumQ() <= 1000 ) {
			MainView.outputText( 'splayed across the ground', false );
		} else {
			MainView.outputText( 'soaking in the white puddle of spooge', false );
		}
		MainView.outputText( '.  Even unconscious, her vagina continues its rhythmic contractions around your cock, working you towards another burst of orgasmic pleasure while you wait for your strength to come back...\n\n', false );
		//[NEXT];
	...
	CorruptedDriderScene.prototype.winDriderPCDickInSpiderCunt2 = function() {
		...
		MainView.outputText( 'A low growl rips through your throat as you pull back and plaster her face white, coating the caked-on residue of a few previous loads with fresh moisture.  You shift position and force your ' + Descriptors.cockDescript( x ) + ' between her two pairs of breasts, sandwiching it in there for the titty-fuck of a lifetime.  Pistoning back and forth, humping the glorious orbs relentlessly, you give yourself over completely to your sore dick, letting your world dissolve into the feelings of each of the spider-woman\'s orifices around your member.\n\n', false );
		MainView.outputText( '<b>Even later...</b>\n', false );
		MainView.outputText( 'You collapse into the dirt, not even caring that it stinks of dried cum and girl-jizz.  You\'ve completely emptied out every speck of sperm from your ' + Descriptors.ballsDescriptLight() + ', and you even kept going for a while after that.  It wasn\'t until ' + Descriptors.sMultiCockDesc() + ' went soft at last that you found enough peace to lie down.  ', false );
		if( CoC.player.cor > 80 && CoC.player.lib > 50 ) {
			MainView.outputText( 'The longer you sit there, the more your strength returns to you, and the more the submissiveness placed into you by her venom recedes. Still, you\'ve tired yourself out too much to leave at the moment.', false );
		} else {
			MainView.outputText( 'The longer you sit there, the more you remember of yourself, and the more you forget the animal, the rut-beast that the spider-woman placed inside you.', false );
		}
		MainView.outputText( '  You shiver and wrap your arms around her, snuggling against her while a primal, buried part of your brain insists that she\'s YOURS.  You fall asleep like that, resting dreamlessly even through your mate\'s waking and departure.', false );
	...
	CorruptedDriderScene.prototype.victoryVSDriderRideOviVaginal = function() {
		...
		if( CoC.monster.HP < 1 ) {
			MainView.outputText( 'hate', false );
		} else {
	...
	CorruptedDriderScene.prototype.victoryVSDriderRideOviAnal = function() {
		...
		MainView.outputText( 'You lean over and grab it in your hands, letting it pulse and squirm in response to your touches.  The copious slime it\'s covered in lets your fingers easily slide down its length.  Each stroke of the odd, feminine member elicits a pleasured groan from your defeated opponent, and you quickly surmise that she must like this just as much as you do using your own genitals.  Pumping and stroking it, you watch with perverse fascination as the ridges grow firmer, hardening in your hand.  A viscous green slime bubbles out of the wide slot at its tip as the spider-girl\'s moans reach a crescendo.  It\'s as lubricated as it\'s going to get.\n\n', false );
		MainView.outputText( 'Climbing over the drider\'s bulbous body, you bend over to present your ' + Descriptors.assDescript() + ' to the twitching ovipositor, beckoning her to slide inside your twitching ' + Descriptors.assholeDescript() + ' as you stand atop its owner.  The sprawled-out spider looks up past all of her body to watch you, leaving you waiting.  Nothing happens at first.  You\'re just there, ass in the air and waiting to be violated, encouraging it on your own terms, but she doesn\'t do anything at all.  She simply watches you.  It isn\'t until a scowl of irritation makes its way across your face that she acts.\n\n', false );
		MainView.outputText( 'The ovipositor lurches over, bending and flexing to reach up to your exposed hole, barely touching you while it explores your cheeks.   You pant and grab your ' + Descriptors.buttDescript() + ', pulling yourself wide to expose the clenching, dark circle that is your pucker.  It rubs across your hand before finally finding its way into your anal cleavage, ridges sliding between your backside and flopping against your ring while it blindly tries to get adjusted.  The moist, dripping slime it exudes quickly turns your ass into a green-glazed slip-\'n-slide.  A sudden shock of sensation alerts you that yes, the ovipositor has finally found your asshole.\n\n', false );
		MainView.outputText( 'The tentacle-like tube prods forward, leaking ooze inside you as the first ring contracts to squeeze inside you.  You gasp when it pops into place, barely adjusting before the next ridge slides into the slightly-loosened sphincter.', false );
		CoC.player.buttChange( 30, true, true, false );
		MainView.outputText( '  Each segment somehow feels larger than the one preceding it, though it seems impossible given how widely stretched you feel by the time the fourth is inside you.', false );
		if( CoC.player.hasCock() ) {
			MainView.outputText( '  The warm organ brushes past your prostate, the slippery caress making ' + Descriptors.sMultiCockDesc() + ' dribble a ', false );
			if( CoC.player.cumQ() < 500 ) {
				MainView.outputText( 'drop', false );
			} else {
				MainView.outputText( 'stream', false );
			}
			MainView.outputText( ' of pre-cum down its length.', false );
		}
		if( CoC.player.hasVagina() ) {
			MainView.outputText( '  Your ' + Descriptors.vaginaDescript( 0 ) + ' quivers', false );
			if( CoC.player.wetness() >= 3 ) {
				MainView.outputText( ' and drips', false );
			}
			MainView.outputText( ' sympathetically with the sensation, and your ' + Descriptors.clitDescript() + ' peeks from the wet lips.', false );
		}
		MainView.outputText( '  Yet you are not denied the anal pleasure you crave, as the widening bands now filling you are each pushing out harder than the one before.  At the stimulation, her own demonic clit swells as if posessed, nodulates, and hardens into dick form, poking up from her pussy and drooling a slime of pre-cum onto her abdomen.  The second ring rolls over your anal g-spot and you gasp, nearly losing your grip.  The third knocks your ' + CoC.player.legs() + ' out from under you, and you collapse atop your partner, squeezing oozing dick', false );
		if( CoC.player.hasCock() ) {
			MainView.outputText( 's', false );
		}
		MainView.outputText( ' between you', false );
		if( CoC.player.clitLength >= 4 && CoC.player.hasVagina() ) {
			MainView.outputText( ', and pressing your monster chick-stick into it; the gooey heat sends a tingle of shock up your spine and your pussy convulses', false );
		}
		MainView.outputText( '.', false );
		CoC.player.buttChange( 50, true, true, false );
		MainView.outputText( '\n\n', false );
		MainView.outputText( 'Shivering, you glance back up at the defeated woman; she has a passionate, prideful look plastered on her face, though it seems to waver each time another inch of ovipositor pushes past your stretched-out ring.\n\n', false );
		//([not mans];
		if( !CoC.player.hasCock() ) {
			MainView.outputText( '"<i>I never would\'ve thought you were an anal-pregnancy slut,</i>" hisses the spider in pleasure, flexing her organ harder while it curls through your guts, so deep inside you that you wonder how much further she can go.', false );
		} else {
			MainView.outputText( '"<i>Just because I have an exoskeleton doesn\'t mean I can\'t feel you dripping on me.  I thought I was the corrupt bitch here, but you... you take the cake.</i>"', false );
		}
		MainView.outputText( '\n\n', false );
		MainView.outputText( 'With a final hard shove, the last few segments pop inside you', false );
		if( CoC.player.hasCock() ) {
			MainView.outputText( ', nearly crushing your prostate from the tight squeeze', false );
		}
		MainView.outputText( '.  ', false );
		if( !CoC.player.hasCock() && CoC.player.hasVagina() ) {
			MainView.outputText( 'You gasp and dribble a few strands of girl-goo, the contractions of your achingly empty pussy intensifying.  ', false );
		}
		if( CoC.player.hasCock() ) {
			MainView.outputText( 'You gasp and squirt a few weak ropes of cum, having a miniature orgasm on the spot.  ', false );
		}
		MainView.outputText( 'Writhing happily, you sigh ', false );
		if( CoC.player.hasCock() ) {
			MainView.outputText( 'while your ' + Descriptors.multiCockDescriptLight() + ' dribbles white, wasted goo onto the black and ' + CoC.monster.hairColor + ' striped carapace below', false );
		} else if( CoC.player.hasVagina() ) {
			MainView.outputText( 'while your ' + Descriptors.vaginaDescript( 0 ) + ' dribbles fem-slime onto the black and ' + CoC.monster.hairColor + ' striped carapace below', false );
		} else {
			MainView.outputText( 'while your fingers tweak your ' + Descriptors.nippleDescript( 0 ) + 's and your starved sphincter sucks at its slimy, squirming stuffing', false );
		}
		MainView.outputText( '.  Without warning, the ovipositor dilates, pulling your ' + Descriptors.assholeDescript() + ' even wider.  An explosion of warmth goes off in your guts, and you realize that your term as an incubator has begun with a sense of perverse delight.\n\n', false );
		MainView.outputText( 'The large, round egg pushes its way up your butt, squeezes past your ring', false );
		if( CoC.player.hasCock() ) {
			MainView.outputText( ' and your prostate', false );
		}
		MainView.outputText( ', and travels deep inside you, bulging your belly the slightest bit once it\'s deposited.  With a groan of deep satisfaction, you start humping the fluid-slicked chitin beneath you, barely registering the long, seemingly unending series of eggs that infiltrate your ass', false );
		if( CoC.player.hasCock() ) {
			MainView.outputText( ' and milk your prostate as they push past', false );
		}
		MainView.outputText( '.\n\n', false );
		MainView.outputText( 'The stream of slime only spreads as the stimulation of the sliding spheres slewing into your sphincter sets off', false );
		if( CoC.player.gender > 0 ) {
			MainView.outputText( ', simultaneously, ', false );
			if( CoC.player.hasCock() ) {
				MainView.outputText( 'a storm of semen-squirting spurts from your shaft', false );
				if( CoC.player.cockTotal() > 1 ) {
					MainView.outputText( 's', false );
				}
			} else if( CoC.player.hasVagina() ) {
				MainView.outputText( 'a siege of spray-scattering spasms from your snatch', false );
			}
			MainView.outputText( ' and', false );
		}
		MainView.outputText( ' squirts of slippery spooge from her shuddering spunk-stick.  While you shriek, squirm and shiver shamelessly, you see the spider-slut suspended in the same, similarly a slave to the sensation of shoving and slamming her stalk into your straining sacrum and stuffing you with her strange spawn.\n\n', false );
		MainView.outputText( 'Gradually, you\'re lifted off the carapace by your inflating abdomen.  Your belly gurgles, making you burp as you\'re filled with enough eggs to make you feel uncomfortable and compressed.  The ' + CoC.player.skinFurScales() + ' of your stomach is drum-tight by the time you slide off the wilting ovipositor, and the bottom portion of it is soaked in the last of your partner\'s orgasm.  You look positively pregnant as you stagger upright and make for your garments, trying to ignore the exhausted drider\'s jibes.\n\n', false );
		MainView.outputText( 'By the time you finish getting dressed, she\'s fallen into a fitful slumber.  What an ordeal!', false );
		//GET KNOCKED UP;
	...
	CorruptedDriderScene.prototype.victoryVSDriderStickDickInSpinneret = function() {
		...
		if( CoC.player.balls > 0 ) {
			MainView.outputText( ', even giggling a little as your ' + Descriptors.ballsDescriptLight() + ' slap against her nose', false );
		}
		MainView.outputText( '.\n\n', false );
		MainView.outputText( 'Her tongue idly licks and teases your ' + Descriptors.cockDescript( x ) + ', each passionate thrust jiggling her hefty tits.  It\'s not long before your limit is reached.  Planting a hand on each side of her head, you slam your groin into her chin.  She gurgles in pleasure from your continuing rough treatment, and her pleasured sounds only increase when your first load is shot down her throat.', false );
		if( CoC.player.cumQ() < 50 ) {
			MainView.outputText( '  She easily keeps in rhythm with your spurts.', false );
		} else if( CoC.player.cumQ() < 350 ) {
			MainView.outputText( '  She sputters a bit from the amount of semen, but she catches up well enough.', false );
		} else if( CoC.player.cumQ() < 1000 ) {
			MainView.outputText( '  She\'s hard-pressed to swallow enough of your seed before another waves washes in.', false );
		} else {
			MainView.outputText( '  Her throat bulges from the sheer amount of cum you deposit into her mouth, and she nearly chokes as she attempts to swallow all of it.', false );
		}
		if( CoC.player.cockTotal() > 1 ) {
			MainView.outputText( '  Your other ', false );
			if( CoC.player.cockTotal() > 2 ) {
				MainView.outputText( 'cocks give ', false );
			} else {
				MainView.outputText( 'cock gives ', false );
			}
			MainView.outputText( 'you a picture-in-picture view of what\'s happening inside, launching identical strokes all over her face.  She\'s in for a stinging surprise if she opens her eyes quickly when she wakes.', false );
		}
		MainView.outputText( '\n\n', false );
	...
	CorruptedDriderScene.prototype.loseVSDriderGetAnalledOvi = function() {
		...
		MainView.outputText( 'You grunt, too exhausted to move any further.  She chuckles at your disinterest, bending down to rest her thick member in between your cheeks and slowly grind along the cleft of your ass.  You feel the tiny nubs of her demonic cock rub along your eager asshole, pre-cum lubricating your hot entrance as she moans in unrequited pleasure.  Gritting your teeth, you force yourself to ', false );
		if( CoC.player.HP < 1 ) {
			MainView.outputText( 'relax in order to reduce the discomfort', false );
		} else {
			MainView.outputText( 'calm your racing thoughts and resist showing how eager you are', false );
		}
		MainView.outputText( ' as she begins to enter inside of you.\n\n', false );
		MainView.outputText( 'Inch by inch, the bumps and curves of her nine-inch demonic dick massage your puckered hole as she plunges further in, working slowly to savor the feeling of being inside of you.  With a hearty grunt she fails to control her lust, driving in at full force and filling you with her corrupted member.', false );
		CoC.player.buttChange( CoC.monster.cockArea( 0 ), true, true, false );
		MainView.outputText( '\n\n', false );
		MainView.outputText( '"<i>Ungh, if I knew your ass was this eager to s-swallow my cock I wouldn\'t have wasted my time tying you up...</i>"  She gasps, clearly the more impassioned of the two of you as she manages to bottom out inside of your ' + Descriptors.buttDescript() + '.  You have very little time to regain your breath as the horny drider-woman begins to thrust in and out of your ' + Descriptors.assholeDescript() + ' with fevered abandon, tongue lolling out of her open mouth while you\'re forced to bounce against her crotch, your ', false );
		if( CoC.player.balls > 0 ) {
	...
	CorruptedDriderScene.prototype.birthSpiderEggsFromAnusITSBLEEDINGYAYYYYY = function() {
		...
		MainView.outputText( '\n\n', false );
		MainView.outputText( 'You shift position slightly, if only to get more comfortable, and relax as the eggs work their way through your guts.  With each egg\'s passage, your sphincter seems to be looser, more pliant, and more sensitive.  You blush and squeeze, hurrying the process to make yourself feel even better, and egg after egg splats wetly into the growing pile, each one slick and soaked in slime.  One after another, the heavy orbs exit your body, until the last one is sliding out of your rectum and you\'re having a strange anal orgasm that feels as relaxing as it is pleasant.\n\n', false );
		MainView.outputText( 'Clenching and relaxing, your slime-dripping asshole slowly narrows, gaping less visibly while you shudder and sigh, so happy and blissful that you don\'t even care about the crackling egg-shells hatching beneath you.  ', false );
		if( CoC.player.hasCock() ) {
			MainView.outputText( Descriptors.SMultiCockDesc() + ' stays limp, but drools a heavy flow of semen, puddling up a nice thick batch of your pleasure alongside your goo-pile.  ', false );
		}
		if( CoC.player.hasVagina() ) {
			MainView.outputText( 'Your pussy clenches and ', false );
			if( CoC.player.wetness() < 3 ) {
				MainView.outputText( 'drips', false );
			} else if( CoC.player.wetness() < 4 ) {
				MainView.outputText( 'dribbles', false );
			} else if( CoC.player.wetness() < 5 ) {
				MainView.outputText( 'gives a tiny squirt', false );
			} else {
				MainView.outputText( 'gushes a river of lady-spunk', false );
			}
			MainView.outputText( ' into the dirt, getting off along with your ' + Descriptors.assholeDescript() + '.  ', false );
		}
		MainView.outputText( 'Once you come down from your high, you roll to the side and watch the tiny driders clambering out of their egg shells.\n\n', false );
		MainView.outputText( 'Your newborn children glance at you, chittering happily before they scurry off in the direction of the swamp.\n', false );
		CoC.player.orgasm();
	};
	...
	CorruptedDriderScene.prototype.driderPregVagBirth = function() {
		...
		MainView.outputText( '\n\n', false );
		MainView.outputText( 'After what seems like hours, you have lost count of the eggs pushed out.  ', false );
		if( CoC.player.isNaga() ) {
			MainView.outputText( 'At last, when no more eggs seem to be coming, you flop over onto your back, careful not to crush any of your dormant offspring.', false );
		} else {
			MainView.outputText( 'Looking between your legs you can see another slick, green egg slide from your body to join the sizable pile behind you.  At last, when no more seem to be following it, you flop over onto your back, careful not to crush any of your dormant offspring.', false );
		}
		...
		if( CoC.player.eyeType !== AppearanceDefs.EYES_FOUR_SPIDER_EYES ) {
			MainView.outputText( '  Suddenly she flops forward, leaning against your eyebrows and causing you to cross your eyes in an attempt to focus on her.  She seems confused by the way your eyes are different to hers.', false );
		}
		if( CoC.player.isNaga() ) {
			MainView.outputText( '  A few baby driders crawl ponderously across your scaled tail.  You give your tail a little wiggle and suddenly they go wild crawling around it and letting out the faintest, cute little squeals.', false );
		} else {
			MainView.outputText( '  A few baby driders sit on each of your legs, facing each other.  Some gesture and squeak at each other in wonder while others pull faces.', false );
		}
		MainView.outputText( '\n\n', false );
		MainView.outputText( 'Nearby, two more of your little girls are in a stand-off, as each skitters back and forth in front of the other, ready to charge.  Suddenly one leaps forward and grabs the other before attempting to bite her arm.  Of course the attack is completely harmless - they are still much too young to have grown their fangs.  The other then turns the tables on her sister by grappling her sister to the ground, and soon, they\'re both letting out tiny giggles.\n\n', false );
		MainView.outputText( 'You lie back and your exhaustion finally begins to get the better of you when combined with the contentment from seeing your babies enjoying themselves.  Your eyelids begin to droop, and before you know it, you\'ve slipped into unconsciousness.  You awaken later on, a sticky feeling between your legs to go with your wet pussy', false );
		if( CoC.player.hasCock() ) {
			MainView.outputText( ' and raging hard on', false );
		}
		MainView.outputText( '.  After remembering where you are, the next thing you notice is the absence of your drider children.  Only a pile of empty, broken egg shells and some messy webbing in the trees remain.  As you stand up and prepare to move on, the sun reflecting off something in the corner of your eye catches your attention.\n\n', false );
		MainView.outputText( 'Between two nearby trees is a large spider web.  While not out of the ordinary, when the sunlight hits it at a certain angle the gossamer strands spell out a simple message YOU MOMMY.</i>"', false );
		CoC.player.orgasm();
	};
	...
	CorruptedDriderScene.prototype.driderVagSmartFuck = function() {
		...
		var y = x + 1;
		MainView.outputText( 'You keep your distance from the downed spidermorph, still wary of her dripping, toxin-coated lips despite her weakened state and your own rising desire to breed her.  Trailing your eyes over her sweaty, splayed body you feel a familiar rush below the belt, your hardening [cock ' + y + '] pressing against the inside of your [armor] as her breasts rise and fall seductively with each panting breath.  Desire threatens to overpower your caution as your gaze lingers on the vulnerable woman before you, her netherlips ' );
		if( CoC.monster.HP < 1 ) {
			MainView.outputText( 'parted slightly and glistening with beads of sweat from the adrenaline of battle.' );
		} else {
			MainView.outputText( 'stuffed with her fingers, femcum streaming down the front of her spider-half as she desperately plays with herself.' );
		}
		MainView.outputText( '  The need to bury your aching length inside that puffy snatch is almost unbearable, but you don\'t want to risk exposing yourself to any of her tricks, especially considering how close you\'d be to her mouth as you take her.  Racking your brain for a solution, the mass of webbing that covers the canopy around this area catches your eye.' );
		if( CoC.player.tailType === AppearanceDefs.TAIL_TYPE_SPIDER_ADBOMEN ) {
			...
			if( CoC.player.isDrider() ) {
				...
				MainView.outputText( 'saunter' );
			}
			MainView.outputText( ' over to the collapsed drider.' );
	...
	CorruptedDriderScene.prototype.driderTiedUpPartTwo = function( useItem ) {
		...
		if( !useItem ) {
			MainView.outputText( 'Shifting yourself, you withdraw your hand from her quivering slit, reaching back to collect another handful of stretchy silk.' );
		} else {
			MainView.outputText( 'Reaching back into your pack, you grab the remainder of the bundle of silk that you tied the girl\'s hands with.  Looking over the mass of white-grey strands, you smile as you see that there seems to be more than enough left for what you have in mind.' );
		}
	...
	CorruptedDriderScene.prototype.driderTiedUpPartFour = function() {
		...
		//(if (30 =< corruption < 70);
			...
			MainView.outputText( 'You make sure she\'s comfortable before checking her for anything that could help your quest.  She stirs slightly as your hands caress her, eyes fluttering drunkenly as she tries to focus on you.  Something in the way her eyes bore into you fills you with a sense of shame at having taken advantage of her and you quickly sever her bonds, reasoning that she\'ll still be too weak to try anything.' );
