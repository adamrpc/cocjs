	...
	InfestedHellhoundScene.prototype.infestedHellhoundLossRape = function() {
		...
		if( CoC.player.totalCocks() > 0 && CoC.player.findStatusAffect( StatusAffects.Infested ) >= 0 ) {
			...
			if( CoC.player.lust > 99 ) {
				...
				EngineCore.outputText( 'you remove your ' + CoC.player.armorName + ' and roll onto your back, exposing your vulnerable groin to the beast.\n\n', false );
			}
			//(HP)
			else {
				EngineCore.outputText( 'Too wounded to stand, you drop down to all fours in order to keep yourself off the ground.   Too late you realize your mistake – the snarling beast is behind you and its razor-sharp teeth easily sink into your ' + CoC.player.armorName + ' before tearing away the offending armor, exposing your ' + Descriptors.assDescript() + ' and ' + Descriptors.multiCockDescriptLight() + '.  A cold mountain breeze blows across your now-exposed ' + CoC.player.skinDesc + ', reminding you just how utterly vulnerable you are to the alien lusts of this symbiotic monstrosity. With a brutal lunge it knocks you off your ' + CoC.player.feet() + ' and onto your back.\n\n', false );
			}
		...
		//[PLAYER'S COCKS ARE BIG ENOUGH TO BE INFECTED]
			...
			//(HP)
				...
				EngineCore.outputText( 'Too wounded to stand, you drop down to all fours in order to keep yourself off the ground.   Too late you realize your mistake – the snarling beast is behind you and its razor-shark teeth easily sink into your ' + CoC.player.armorName + ' before tearing it off, exposing your ' + Descriptors.assDescript() + ' and ' + Descriptors.multiCockDescriptLight() + '.  A cold mountain breeze blows across your now exposed ' + CoC.player.skinDesc + ', reminding you just how utterly vulnerable you are to the alien lusts of this symbiotic monstrosity.  With a brutal lunge it knocks you off your ' + CoC.player.feet() + ' and onto your back.\n\n', false );
			}
		...
		//[HAS PUSSY AND NO DICK BIG ENOUGH TO BE INFECTED]
			...
			if( CoC.player.lust > 99 ) {
				...
				EngineCore.outputText( 'you remove your ' + CoC.player.armorName + ' and drop to all fours, mimicking what you think a dog would do.\n\n', false );
			}
			//(HP)
			else {
				EngineCore.outputText( 'Too wounded to stand, you drop down to all fours in order to keep yourself off the ground.   Too late you realize your mistake – the snarling beast is behind you and its razor-shark teeth easily sink into your ' + CoC.player.armorName + ' before tearing it off, exposing your ' + Descriptors.assDescript() + ' and ' + Descriptors.vaginaDescript( 0 ) + '.  A cold mountain breeze blows across your now exposed ' + CoC.player.skinDesc + ', reminding you just how utterly exposed you are to the alien lusts of this symbiotic monstrosity.\n\n', false );
			}
		...
		//[GENDERLESS OR MALE WITH DICK TOO SMALL]
			...
			if( CoC.player.lust > 99 ) {
				...
				EngineCore.outputText( 'you remove your ' + CoC.player.armorName + ' and drop to your elbows, mimicking what you think a dog would do.\n\n', false );
			}
			//(HP)
			else {
				EngineCore.outputText( 'Too wounded to stand, you drop down to on your elbows in order to keep yourself off the ground.   Too late you realize your mistake – the snarling beast is behind you and its razor-shark teeth easily sink into your ' + CoC.player.armorName + ' before tearing it off, exposing your ' + Descriptors.assDescript() + '.  A cold mountain breeze blows across your now exposed ' + CoC.player.skinDesc + ', reminding you just how utterly exposed you are to the alien lusts of this symbiotic monstrosity.\n\n', false );
			}
			EngineCore.outputText( 'The hell-hound rises up, looking nearly humanoid in shape for a moment before it drops down, planting its paws on your shoulders.  ', false );
