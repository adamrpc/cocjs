...
angular.module( 'cocjs' ).run( function( Mutations, StatusAffects, PregnancyStore, Descriptors, Utils, CockTypesEnum, CoC_Settings, PerkLib, OnLoadVariables, AppearanceDefs, kFLAGS, CoC, EngineCore ) {
	...
	Pregnancy.prototype.updatePregnancy = function() {
		...
		if( (CoC.getInstance().player.pregnancyIncubation <= 0 && CoC.getInstance().player.buttPregnancyIncubation <= 0) ||
			(CoC.getInstance().player.pregnancyType === 0 && CoC.getInstance().player.buttPregnancyType === 0) ) {
			return false;
		}
		//Cancel Heat;
		if( CoC.getInstance().player.inHeat ) {
			...
			EngineCore.dynStats( 'lib', -CoC.getInstance().player.statusAffectv2( StatusAffects.Heat ) );
			if( CoC.getInstance().player.lib < 10 ) {
				CoC.getInstance().player.lib = 10;
			}
			EngineCore.statScreenRefresh();
			CoC.getInstance().player.removeStatusAffect( StatusAffects.Heat );
			displayedUpdate = true;
		}
		if( CoC.getInstance().player.pregnancyIncubation === 1 ) {
			if( CoC.getInstance().player.fertility < 15 ) {
				CoC.getInstance().player.fertility++;
			}
			if( CoC.getInstance().player.fertility < 25 ) {
				CoC.getInstance().player.fertility++;
			}
			if( CoC.getInstance().player.fertility < 40 ) {
				CoC.getInstance().player.fertility++;
			}
			if( CoC.getInstance().player.findStatusAffect( StatusAffects.Birthed ) < 0 ) {
				CoC.getInstance().player.createStatusAffect( StatusAffects.Birthed, 1, 0, 0, 0 );
			} else {
				CoC.getInstance().player.addStatusValue( StatusAffects.Birthed, 1, 1 );
				if( CoC.getInstance().player.findPerk( PerkLib.BroodMother ) < 0 && CoC.getInstance().player.statusAffectv1( StatusAffects.Birthed ) >= 10 ) {
		...
		if( CoC.getInstance().player.pregnancyIncubation > 0 && CoC.getInstance().player.pregnancyIncubation < 2 ) {
			CoC.getInstance().player.knockUpForce( CoC.getInstance().player.pregnancyType, 1 );
		}
		...
		if( CoC.getInstance().player.pregnancyIncubation > 1 ) {
			...
			if( CoC.getInstance().player.pregnancyType === PregnancyStore.PREGNANCY_COTTON ) {
				if( CoC.getInstance().player.pregnancyIncubation === 320 ) {
					...
					displayedUpdate = true;
				} else if( CoC.getInstance().player.pregnancyIncubation === 280 ) {
					...
					displayedUpdate = true;
				} else if( CoC.getInstance().player.pregnancyIncubation === 225 ) {
					...
					displayedUpdate = true;
				} else if( CoC.getInstance().player.pregnancyIncubation === 165 ) {
					...
					displayedUpdate = true;
				} else if( CoC.getInstance().player.pregnancyIncubation === 105 ) {
					...
					displayedUpdate = true;
				} else if( CoC.getInstance().player.pregnancyIncubation === 80 ) {
					...
					displayedUpdate = true;
				} else if( CoC.getInstance().player.pregnancyIncubation === 50 ) {
				...
				//Tits;
				if( CoC.getInstance().player.pregnancyIncubation === 32 || CoC.getInstance().player.pregnancyIncubation === 64 || CoC.getInstance().player.pregnancyIncubation === 85 || CoC.getInstance().player.pregnancyIncubation === 150 ) {
					displayedUpdate = true;
					//Increase lactation!;
					if( CoC.getInstance().player.biggestTitSize() >= 3 && CoC.getInstance().player.mostBreastsPerRow() > 1 && CoC.getInstance().player.biggestLactation() >= 1 && CoC.getInstance().player.biggestLactation() < 2 ) {
					...
					if( CoC.getInstance().player.biggestTitSize() >= 3 && CoC.getInstance().player.mostBreastsPerRow() > 1 && CoC.getInstance().player.biggestLactation() > 0 && CoC.getInstance().player.biggestLactation() < 1 ) {
						EngineCore.outputText( '\nDrops of breastmilk escape your nipples as your body prepares for the coming birth.\n', false );
						CoC.getInstance().player.boostLactation( 0.5 );
					}
					//Lactate if large && not lactating;
					if( CoC.getInstance().player.biggestTitSize() >= 3 && CoC.getInstance().player.mostBreastsPerRow() > 1 && CoC.getInstance().player.biggestLactation() === 0 ) {
						EngineCore.outputText( '\n<b>You realize your breasts feel full, and occasionally lactate</b>.  It must be due to the pregnancy.\n', false );
						CoC.getInstance().player.boostLactation( 1 );
					}
					//Enlarge if too small for lactation;
					if( CoC.getInstance().player.biggestTitSize() === 2 && CoC.getInstance().player.mostBreastsPerRow() > 1 ) {
						EngineCore.outputText( '\n<b>Your breasts have swollen to C-cups,</b> in light of your coming pregnancy.\n', false );
						CoC.getInstance().player.growTits( 1, 1, false, 3 );
					}
					//Enlarge if really small!;
					if( CoC.getInstance().player.biggestTitSize() === 1 && CoC.getInstance().player.mostBreastsPerRow() > 1 ) {
			...
			//Imp Pregnancy!;
			if( CoC.getInstance().player.pregnancyType === PregnancyStore.PREGNANCY_IMP ) {
				...
				if( CoC.getInstance().player.pregnancyIncubation === 216 ) {
					...
					if( CoC.getInstance().player.cor >= 40 && CoC.getInstance().player.cor < 75 ) {
			...
			//Centaur Pregnancy!;
			if( CoC.getInstance().player.pregnancyType === PregnancyStore.PREGNANCY_CENTAUR || CoC.getInstance().player.pregnancyType === PregnancyStore.PREGNANCY_KELT ) {
				if( CoC.getInstance().player.pregnancyIncubation === 350 ) {
			...
			//Bunny tf preggoz;
			if( CoC.getInstance().player.pregnancyType === PregnancyStore.PREGNANCY_BUNNY ) {
				if( CoC.getInstance().player.pregnancyIncubation === 800 ) {
					EngineCore.outputText( '\nYour womb gurgles strangely.\n', false );
					displayedUpdate = true;
				}
				if( CoC.getInstance().player.pregnancyIncubation === 785 ) {
					//EngineCore.outputText('\n<b>An unexpected change occurs, no doubt brought on by the bunny\'s eggs inside you!</b>', false);;
					Mutations.neonPinkEgg( true, CoC.getInstance().player );
					EngineCore.outputText( '\n', false );
					displayedUpdate = true;
				}
				if( CoC.getInstance().player.pregnancyIncubation === 776 ) {
					EngineCore.outputText( '\nYour womb feels full and bloated.\n', false );
					displayedUpdate = true;
				}
				if( CoC.getInstance().player.pregnancyIncubation === 765 ) {
					//EngineCore.outputText('\n<b>An unexpected change occurs, no doubt brought on by the bunny\'s eggs inside you!</b>', false);;
					Mutations.neonPinkEgg( true, CoC.getInstance().player );
					EngineCore.outputText( '\n', false );
					displayedUpdate = true;
				}
				if( CoC.getInstance().player.pregnancyIncubation <= 745 && CoC.getInstance().player.pregnancyIncubation > 400 ) {
				...
				if( CoC.getInstance().player.pregnancyIncubation === 198 ) {
					EngineCore.outputText( '\n<b>You realize your belly has gotten slightly larger.  Maybe there\'s some truth to what the bunny-girl said.</b>\n', false );
					displayedUpdate = true;
				}
				if( CoC.getInstance().player.pregnancyIncubation === 178 ) {
					EngineCore.outputText( '\n<b>Your belly is getting more noticably distended.   You are probably pregnant.</b>\n', false );
					displayedUpdate = true;
				}
				if( CoC.getInstance().player.pregnancyIncubation === 156 ) {
					EngineCore.outputText( '\n<b>The unmistakable bulge of pregnancy is visible in your tummy.  ', false );
					if( CoC.getInstance().player.cor < 40 ) {
						EngineCore.outputText( 'You are distressed by your unwanted pregnancy, and your inability to force this thing out of you.</b>', false );
					}
				...
				if( CoC.getInstance().player.pregnancyIncubation === 140 ) {
			...
			//Marblz Pregnancy!;
			if( CoC.getInstance().player.pregnancyType === PregnancyStore.PREGNANCY_MARBLE ) {
				if( CoC.getInstance().player.pregnancyIncubation === 336 ) {
					EngineCore.outputText( '\n<b>You realize your belly has gotten slightly larger.  Maybe you need to cut back on the strange food.</b>\n', false );
					displayedUpdate = true;
				}
				...
				if( CoC.getInstance().player.pregnancyIncubation === 32 || CoC.getInstance().player.pregnancyIncubation === 150 ) {
					//Increase lactation!;
					if( CoC.getInstance().player.biggestTitSize() >= 3 && CoC.getInstance().player.mostBreastsPerRow() > 1 && CoC.getInstance().player.biggestLactation() >= 1 && CoC.getInstance().player.biggestLactation() < 2 ) {
						EngineCore.outputText( '\nYour breasts feel swollen with all the extra milk they\'re accumulating.  You wonder just what kind of creature they\'re getting ready to feed.\n', false );
						CoC.getInstance().player.boostLactation( 0.5 );
				...
				if( CoC.getInstance().player.pregnancyIncubation === 85 ) {
					...
					if( CoC.getInstance().player.biggestTitSize() <= 0 ) {
						...
						CoC.getInstance().player.breastRows[ 0 ].breastRating++;
					} else {
					...
					if( CoC.getInstance().player.biggestLactation() < 1 ) {
						...
						CoC.getInstance().player.boostLactation( CoC.getInstance().player.breastRows.length * 0.25 );
					}
					EngineCore.outputText( '</b>\n', false );
				}
			}
			//Jojo Pregnancy!;
			if( CoC.getInstance().player.pregnancyType === PregnancyStore.PREGNANCY_MOUSE || CoC.getInstance().player.pregnancyType === PregnancyStore.PREGNANCY_JOJO ) {
				if( CoC.getInstance().player.pregnancyIncubation === 336 ) {
					EngineCore.outputText( '\n<b>You realize your belly has gotten slightly larger.  Maybe you need to cut back on the strange food.</b>\n', false );
					displayedUpdate = true;
				}
			...
			//Shark Pregnancy!;
			if( CoC.getInstance().player.pregnancyType === PregnancyStore.PREGNANCY_IZMA ) {
				if( CoC.getInstance().player.pregnancyIncubation === 275 ) {
					if( CoC.getInstance().flags[ kFLAGS.UNKNOWN_FLAG_NUMBER_00238 ] === 1 ) {
						EngineCore.outputText( '\n<b>You wake up feeling kind of nauseous.  Izma insists that you stay in bed and won\'t hear a word otherwise, tending to you in your sickened state.  When you finally feel better, she helps you up.  "<i>You know, ' + CoC.getInstance().player.short + '... I think you might be pregnant.</i>" Izma says, sounding very pleased at the idea. You have to admit, you do seem to have gained some weight...</b>\n', false );
					} else {
			...
			//SPOIDAH Pregnancy!;
			if( CoC.getInstance().player.pregnancyType === PregnancyStore.PREGNANCY_SPIDER || CoC.getInstance().player.pregnancyType === PregnancyStore.PREGNANCY_DRIDER_EGGS ) {
				if( CoC.getInstance().player.pregnancyIncubation === 399 ) {
				...
				if( CoC.getInstance().player.pregnancyIncubation === 250 ) {
					...
					if( CoC.getInstance().player.thickness > 60 && CoC.getInstance().player.tone < 40 ) {
				...
				if( CoC.getInstance().player.pregnancyIncubation === 180 ) {
					...
					if( CoC.getInstance().player.pregnancyType === PregnancyStore.PREGNANCY_SPIDER ) {
			...
			//Goo Pregnancy!;
			if( CoC.getInstance().player.pregnancyType === PregnancyStore.PREGNANCY_GOO_GIRL ) {
				if( CoC.getInstance().player.pregnancyIncubation === 72 ) {
				...
				if( CoC.getInstance().player.pregnancyIncubation === 32 || CoC.getInstance().player.pregnancyIncubation === 64 || CoC.getInstance().player.pregnancyIncubation === 82 || CoC.getInstance().player.pregnancyIncubation === 16 ) {
					//Increase lactation!;
					if( CoC.getInstance().player.biggestTitSize() >= 3 && CoC.getInstance().player.mostBreastsPerRow() > 1 && CoC.getInstance().player.biggestLactation() >= 1 && CoC.getInstance().player.biggestLactation() < 2 ) {
						EngineCore.outputText( '\nYour breasts feel swollen with all the extra milk they\'re accumulating.\n', false );
						CoC.getInstance().player.boostLactation( 0.5 );
			...
			if( CoC.getInstance().player.pregnancyType === PregnancyStore.PREGNANCY_EMBER ) {
				//Pregnancy notes: Egg Laying ;
				if( CoC.getInstance().flags[ kFLAGS.EMBER_OVIPOSITION ] > 0 ) {
					if( CoC.getInstance().player.pregnancyIncubation === 330 ) {
					...
					if( CoC.getInstance().player.pregnancyIncubation === 30 ) {
						pregText = 'You rub your hands over your ripe belly, lost in the sensations of motherhood.  ';
						EngineCore.dynStats( 'sen', 5, 'lus', (5 + CoC.getInstance().player.sens / 20) );
						//If Corruption < 40;
						if( CoC.getInstance().player.cor < 40 ) {
			...
			//Pregnancy 4 Satyrs;
			if( CoC.getInstance().player.pregnancyType === PregnancyStore.PREGNANCY_SATYR ) {
				//Stage 1: ;
				if( CoC.getInstance().player.pregnancyIncubation === 150 ) {
				...
				//Stage 2: ;
				if( CoC.getInstance().player.pregnancyIncubation === 125 ) {
				...
				//Stage 4: ;
				if( CoC.getInstance().player.pregnancyIncubation === 75 ) {
			...
			//BASILISK Pregnancy!;
			if( CoC.getInstance().player.pregnancyType === PregnancyStore.PREGNANCY_BASILISK || CoC.getInstance().player.pregnancyType === PregnancyStore.PREGNANCY_BENOIT ) {
				if( CoC.getInstance().player.pregnancyIncubation === 185 ) {
					EngineCore.outputText( '\n<b>Your belly grumbles as if empty, even though you ate not long ago.  Perhaps with all the exercise you\'re getting you just need to eat a little bit more.</b>\n', false );
					displayedUpdate = true;
				}
				if( CoC.getInstance().player.pregnancyIncubation === 160 ) {
					EngineCore.outputText( '\n<b>Your belly looks a little pudgy', false );
					if( CoC.getInstance().player.thickness > 60 && CoC.getInstance().player.tone < 40 ) {
						EngineCore.outputText( ' even for you', false );
					}
				...
				if( CoC.getInstance().player.pregnancyIncubation === 110 ) {
					EngineCore.outputText( '\n<b>Your belly has gotten nice and big, perhaps as big as you remember the bellies of the pregnant women back home being.  The elders always did insist on everyone doing their part to keep the population high enough to sustain the loss of a champion every year.  You give yourself a little hug, getting a surge of happiness from your hormone-addled body.  Pregnancy sure is great!</b>\n', false );
					displayedUpdate = true;
				}
				if( CoC.getInstance().player.pregnancyIncubation === 72 ) {
			...
			//Anemone Pregnancy;
			if( CoC.getInstance().player.pregnancyType === PregnancyStore.PREGNANCY_ANEMONE ) {
				if( CoC.getInstance().player.pregnancyIncubation === 240 ) {
					EngineCore.outputText( '\n<b>You feel something shifting and moving inside you.  You start to think you might be pregnant.</b>\n', false );
					displayedUpdate = true;
				}
				if( CoC.getInstance().player.pregnancyIncubation === 210 ) {
				...
				if( CoC.getInstance().player.pregnancyIncubation === 154 ) {
				...
				if( CoC.getInstance().player.pregnancyIncubation === 72 ) {
					...
					EngineCore.outputText( '\n', false );
					EngineCore.dynStats( 'spe', -3, 'lib', 1, 'sen', 1, 'lus', (5 + CoC.getInstance().player.lib / 20) );
					displayedUpdate = true;
				}
				if( CoC.getInstance().player.pregnancyIncubation === 48 ) {
					EngineCore.outputText( '\n<b>You rub your hands over your bulging belly, lost in the sensations of motherhood.  ', false );
					...
					EngineCore.dynStats( 'spe', -1, 'lib', 1, 'sen', 1, 'lus', (10 + CoC.getInstance().player.lib / 20) );
					displayedUpdate = true;
				}
			}
			//Hellhound Pregnancy!;
			if( CoC.getInstance().player.pregnancyType === PregnancyStore.PREGNANCY_HELL_HOUND ) {
				if( CoC.getInstance().player.pregnancyIncubation === 290 ) {
					EngineCore.outputText( '\n<b>You realize your belly has gotten slightly larger.  Maybe you need to cut back on the strange food.</b>\n', false );
					displayedUpdate = true;
				}
				if( CoC.getInstance().player.pregnancyIncubation === 240 ) {
			...
			//Frog Eggs;
			else if( CoC.getInstance().player.pregnancyType === PregnancyStore.PREGNANCY_FROG_GIRL ) {
				if( CoC.getInstance().player.pregnancyIncubation === 8 ) {
					//Egg Maturing;
					if( CoC.getInstance().player.hasVagina() ) {
		...
		if( CoC.getInstance().player.buttPregnancyIncubation > 1 ) {
			if( CoC.getInstance().player.buttPregnancyType === PregnancyStore.PREGNANCY_FROG_GIRL ) {
				if( CoC.getInstance().player.buttPregnancyIncubation === 8 ) {
					//Egg Maturing;
					...
					//[cock:;
						...
						EngineCore.outputText( '  Splashing against the underside of your ' + CoC.getInstance().player.multiCockDescriptLight() + ', the slime leaves a warm, oozy sensation that makes you just want to rub [eachCock] over and over and over again.' );
					}//genderless: ;
					else {
			...
			//Pregnancy 4 Satyrs;
			if( CoC.getInstance().player.buttPregnancyType === PregnancyStore.PREGNANCY_SATYR ) {
				//Stage 1: ;
				if( CoC.getInstance().player.buttPregnancyIncubation === 150 ) {
					EngineCore.outputText( '\n<b>You find that you\'re feeling quite sluggish these days; you just don\'t have as much energy as you used to.  You\'re also putting on weight.</b>\n' );
					displayedUpdate = true;
				}
				//Stage 2: ;
				if( CoC.getInstance().player.buttPregnancyIncubation === 125 ) {
					EngineCore.outputText( '\n<b>Your belly is getting bigger and bigger.  Maybe your recent urges are to blame for this development?</b>\n' );
					displayedUpdate = true;
				}
				//Stage 3: ;
				if( CoC.getInstance().player.buttPregnancyIncubation === 100 ) {
					EngineCore.outputText( '\n<b>You can feel the strangest fluttering sensations in your distended belly; it must be a pregnancy.  You should eat more and drink plenty of wine so your baby can grow properly.  Wait, wine...?</b>\n' );
					displayedUpdate = true;
				}
				//Stage 4: ;
				if( CoC.getInstance().player.buttPregnancyIncubation === 75 ) {
					EngineCore.outputText( '\n<b>Sometimes you feel a bump in your pregnant belly.  You wonder if it\'s your baby complaining about your moving about.</b>\n' );
					displayedUpdate = true;
				}
				//Stage 5: ;
				if( CoC.getInstance().player.buttPregnancyIncubation === 50 ) {
					EngineCore.outputText( '\n<b>With your bloating gut, you are loathe to exert yourself in any meaningful manner; you feel horny and hungry all the time...</b>\n' );
					displayedUpdate = true;
					//temp min lust up +5;
				}
				//Stage 6: ;
				if( CoC.getInstance().player.buttPregnancyIncubation === 30 ) {
					EngineCore.outputText( '\n<b>The baby you\'re carrying constantly kicks your belly in demand for food and wine, and you feel sluggish and horny.  You can\'t wait to birth this little one so you can finally rest for a while.</b>\n' );
					displayedUpdate = true;
					//temp min lust up addl +5;
				}
			...
			if( CoC.getInstance().player.buttPregnancyType === PregnancyStore.PREGNANCY_DRIDER_EGGS ) {
				if( CoC.getInstance().player.buttPregnancyIncubation === 199 ) {
				...
				if( CoC.getInstance().player.buttPregnancyIncubation === 180 ) {
				...
				if( CoC.getInstance().player.buttPregnancyIncubation === 120 ) {
					EngineCore.outputText( '\n<b>Your belly is bulging from the size of the eggs growing inside you and gurgling just about any time you walk.  Green goo runs down your ' + CoC.getInstance().player.legs() + ' frequently, drooling out of your pregnant asshole.</b>\n', false );
					displayedUpdate = true;
				}
				if( CoC.getInstance().player.buttPregnancyIncubation === 72 ) {
			...
			if( CoC.getInstance().player.buttPregnancyType === PregnancyStore.PREGNANCY_BEE_EGGS ) {
				if( CoC.getInstance().player.buttPregnancyIncubation === 36 ) {
					EngineCore.outputText( '<b>\nYou feel bloated, your bowels shifting uncomfortably from time to time.</b>\n', false );
					displayedUpdate = true;
				}
				if( CoC.getInstance().player.buttPregnancyIncubation === 20 ) {
					...
					if( CoC.getInstance().player.cockTotal() === 1 ) {
						...
						if( CoC.getInstance().player.normalCocks() === 0 && CoC.getInstance().player.dogCocks() === 0 && CoC.getInstance().player.horseCocks() === 0 ) {
					...
					if( CoC.getInstance().player.cockTotal() > 1 ) {
						EngineCore.outputText( 'groin.  Your ' + CoC.getInstance().player.multiCockDescriptLight() + ' fill and grow with every lungful of the stuff you breathe in.  You suck in great lungfuls of the tainted air, desperate for more, your cocks twitching and dripping with need.  ', false );
					}
			...
			if( CoC.getInstance().player.buttPregnancyType === PregnancyStore.PREGNANCY_SANDTRAP || CoC.getInstance().player.buttPregnancyType === PregnancyStore.PREGNANCY_SANDTRAP_FERTILE ) {
				if( CoC.getInstance().player.buttPregnancyIncubation === 36 ) {
					//(Eggs take 2-3 days to lay);
					EngineCore.outputText( '<b>\nYour bowels make a strange gurgling noise and shift uneasily.  You feel ' );
					if( CoC.getInstance().player.buttPregnancyType === PregnancyStore.PREGNANCY_SANDTRAP_FERTILE ) {
			...
			if( CoC.getInstance().player.buttPregnancyType === PregnancyStore.PREGNANCY_BUNNY ) {
				if( CoC.getInstance().player.buttPregnancyIncubation === 800 ) {
					EngineCore.outputText( '\nYour gut gurgles strangely.\n', false );
					displayedUpdate = true;
				}
				if( CoC.getInstance().player.buttPregnancyIncubation === 785 ) {
					Mutations.neonPinkEgg( true, CoC.getInstance().player );
					EngineCore.outputText( '\n', false );
					displayedUpdate = true;
				}
				if( CoC.getInstance().player.buttPregnancyIncubation === 776 ) {
					EngineCore.outputText( '\nYour gut feels full and bloated.\n', false );
					displayedUpdate = true;
				}
				if( CoC.getInstance().player.buttPregnancyIncubation === 765 ) {
					Mutations.neonPinkEgg( true, CoC.getInstance().player );
					EngineCore.outputText( '\n', false );
					displayedUpdate = true;
				}
				if( CoC.getInstance().player.buttPregnancyIncubation === 745 ) {
		...
		if( CoC.getInstance().player.buttPregnancyIncubation === 1 && CoC.getInstance().player.buttPregnancyType === PregnancyStore.PREGNANCY_BEE_EGGS ) {
			EngineCore.outputText( '\n', false );
			...
			if( CoC.getInstance().player.averageLactation() >= 1 && CoC.getInstance().player.biggestTitSize() > 2 ) {
			...
			if( CoC.getInstance().player.cor >= 35 && CoC.getInstance().player.cor < 65 ) {
			...
			if( CoC.getInstance().player.cor >= 65 && CoC.getInstance().player.cor < 90 ) {
			...
			if( CoC.getInstance().player.buttChange( 20, true ) ) {
				EngineCore.outputText( '\n', false );
			}
			if( CoC.getInstance().player.buttRating < 17 ) {
				//Guaranteed increase up to level 10;
		...
		if( CoC.getInstance().player.pregnancyType === PregnancyStore.PREGNANCY_BENOIT && CoC.getInstance().player.pregnancyIncubation <= 2 ) {
			if( CoC.getInstance().time.hours !== 5 && CoC.getInstance().time.hours !== 6 ) {
				CoC.getInstance().player.knockUpForce( CoC.getInstance().player.pregnancyType, 3 ); //Make sure eggs are only birthed early in the morning
			} else {
				CoC.getInstance().player.knockUpForce(); //Clear Pregnancy
				displayedUpdate = true;
		...
		//BASILISK BIRF;
		//Bunbun birfs;
		if( CoC.getInstance().player.pregnancyType === PregnancyStore.PREGNANCY_BUNNY && CoC.getInstance().player.pregnancyIncubation === 1 ) {
			EngineCore.outputText( '\n', false );
			displayedUpdate = true;
			if( CoC.getInstance().player.vaginas.length === 0 ) {
			...
			//Boost capacity;
			if( CoC.getInstance().player.vaginalCapacity() < 300 ) {
				...
				CoC.getInstance().player.addStatusValue( StatusAffects.BonusVCapacity, 1, 10 );
			}
			CoC.getInstance().player.knockUpForce(); //Clear Pregnancy
			CoC.getInstance().player.orgasm();
		...
		//Anemone birfs;
		//Anemone Pregnancy;
		if( CoC.getInstance().player.pregnancyType === PregnancyStore.PREGNANCY_ANEMONE && CoC.getInstance().player.pregnancyIncubation === 1 ) {
			EngineCore.outputText( '\n', false );
			displayedUpdate = true;
			if( CoC.getInstance().player.vaginas.length === 0 ) {
				EngineCore.outputText( 'You feel a terrible pressure in your groin... then an incredible pain accompanied by the rending of flesh.  You look down and behold a vagina.  ', false );
			...
			EngineCore.outputText( 'Your ' + CoC.getInstance().player.armorName + ' feels damp around the groin and you reach down to check the area.  The  ' + Descriptors.vaginaDescript( 0 ) + ' you feel is dilated and slick with unusual wetness; your water must have broken!\n\n', false );
			...
			if( CoC.getInstance().flags[ kFLAGS.ANEMONE_KID ] > 0 ) {
				...
				CoC.getInstance().player.cuntChange( 20, true, true, false );
				EngineCore.outputText( '\n' );
				CoC.getInstance().player.createStatusAffect( StatusAffects.CampAnemoneTrigger, 0, 0, 0, 0 );
				CoC.getInstance().player.knockUpForce(); //Clear Pregnancy
				return true;
			}
			//[(if pc has 0-9 existing cocks);
			else if( CoC.getInstance().player.cockTotal() < 10 ) {
				...
				//[(if cocks);
				if( CoC.getInstance().player.cockTotal() > 0 ) {
					EngineCore.outputText( ' below your ' + CoC.getInstance().player.multiCockDescriptLight(), false );
				}
				...
				//[(dick slot 1 exists);
				if( CoC.getInstance().player.cockTotal() > 0 ) {
					EngineCore.outputText( '  The tentacles writhe around, rubbing against your ' + CoC.getInstance().player.multiCockDescriptLight(), false );
				}//(doesn't exist);
				else {
					EngineCore.outputText( '  The tentacles curl inwards, rubbing on the head of your new blue pecker', false );
				}
				CoC.getInstance().player.createCock( (4 + Utils.rand( 3 )), 1.2 );
				CoC.getInstance().player.cocks[ CoC.getInstance().player.cockTotal() - 1 ].cockType = CockTypesEnum.ANEMONE;
				EngineCore.outputText( ' and you quickly become fully erect from the aphrodisiac they inject.  Over and over the tentacles caress ' + CoC.getInstance().player.sMultiCockDesc() + ' sensually, leaving behind a tingling trail of vibrant pleasure', false );
				//[(if no dick1 and no balls);
				if( CoC.getInstance().player.totalCocks() === 1 && CoC.getInstance().player.balls === 0 ) {
				...
				//[(dick1 exists);
				if( CoC.getInstance().player.cockTotal() > 1 ) {
					EngineCore.outputText( ', followed in short order by white squirts from ' + CoC.getInstance().player.sMultiCockDesc() + ' remaining', false );
				}
			...
			//[(if PC has 10 existing cocks) && no kid;
				...
				if( CoC.getInstance().player.findStatusAffect( StatusAffects.AnemoneArousal ) < 0 ) {
					CoC.getInstance().player.createStatusAffect( StatusAffects.AnemoneArousal, 0, 0, 0, 0 );
				}
			}
			CoC.getInstance().player.knockUpForce(); //Clear Pregnancy
		...
		if( CoC.getInstance().player.pregnancyIncubation === 1 && CoC.getInstance().player.pregnancyType === PregnancyStore.PREGNANCY_IMP ) {
			EngineCore.outputText( '\n', false );
			//Add imp birth status - used to control frequency of night imp gangbag;
			if( CoC.getInstance().player.findStatusAffect( StatusAffects.BirthedImps ) >= 0 ) {
				CoC.getInstance().player.addStatusValue( StatusAffects.BirthedImps, 1, 1 );
			} else {
				CoC.getInstance().player.createStatusAffect( StatusAffects.BirthedImps, 1, 0, 0, 0 );
			}
			if( CoC.getInstance().player.vaginas.length === 0 ) {
				EngineCore.outputText( 'You feel a terrible pressure in your groin... then an incredible pain accompanied by the rending of flesh.  You look down and behold a vagina.  ', false );
				CoC.getInstance().player.createVagina();
			...
			if( CoC.getInstance().player.vaginas[ 0 ].vaginalLooseness === AppearanceDefs.VAGINA_LOOSENESS_TIGHT ) {
				CoC.getInstance().player.vaginas[ 0 ].vaginalLooseness++;
			}
			//50% chance;
			if( CoC.getInstance().player.vaginas[ 0 ].vaginalLooseness < AppearanceDefs.VAGINA_LOOSENESS_GAPING_WIDE && Utils.rand( 2 ) === 0 ) {
				CoC.getInstance().player.vaginas[ 0 ].vaginalLooseness++;
			...
			if( CoC.getInstance().player.averageLactation() > 0 && CoC.getInstance().player.averageLactation() < 5 ) {
				EngineCore.outputText( '  Your breasts won\'t seem to stop dribbling milk, lactating more heavily than before.', false );
				CoC.getInstance().player.boostLactation( 0.5 );
			}
			//Lactate if large && not lactating;
			if( CoC.getInstance().player.biggestTitSize() >= 3 && CoC.getInstance().player.mostBreastsPerRow() > 1 && CoC.getInstance().player.averageLactation() === 0 ) {
			...
			if( CoC.getInstance().player.buttRating < 10 && Utils.rand( 2 ) === 0 ) {
				CoC.getInstance().player.buttRating++;
				EngineCore.outputText( '\n\nYou notice your ' + Descriptors.buttDescript() + ' feeling larger and plumper after the ordeal.', false );
			} else if( CoC.getInstance().player.hipRating < 10 ) {
				CoC.getInstance().player.hipRating++;
				EngineCore.outputText( '\n\nAfter the birth your ' + CoC.getInstance().player.armorName + ' fits a bit more snugly about your ' + Descriptors.hipDescript() + '.', false );
			}
			EngineCore.outputText( '\n', false );
			displayedUpdate = true;
		}
		//Give birth if it's time (to a cowgirl!);
		if( CoC.getInstance().player.pregnancyIncubation === 1 && CoC.getInstance().player.pregnancyType === PregnancyStore.PREGNANCY_MARBLE ) {
			CoC.getInstance().player.knockUpForce(); //Clear Pregnancy
			CoC.getInstance().player.boostLactation( 0.01 );
			if( CoC.getInstance().player.vaginas.length === 0 ) {
			...
			if( CoC.getInstance().flags[ kFLAGS.MARBLE_NURSERY_CONSTRUCTION ] < 100 ) {
				...
				EngineCore.outputText( 'You push and heave with all your might, little else going through your mind. You somehow register when the head comes out, and soon the shoulders along with the rest of the body follow.  You lean back and pant for a while before feeling a pair of hands grab a hold of you. They slowly and clumsily feel up your body before finding your ' + CoC.getInstance().player.chestDesc() + ' and a mouth quickly closes down on a ' + Descriptors.nippleDescript( 0 ) + '.  You sigh softly, and drift off to sleep.', false );
				CoC.getInstance().player.cuntChange( 20, true, true, false );
				...
				//it's a boy!;
				{
					...
					if( CoC.getInstance().player.hipRating < 10 ) {
						CoC.getInstance().player.hipRating++;
						EngineCore.outputText( 'After the birth your ' + CoC.getInstance().player.armorName + ' fits a bit more snugly about your ' + Descriptors.hipDescript() + '.', false );
					}
					...
					CoC.getInstance().flags[ kFLAGS.MARBLE_BOYS ]++; //increase the number of male kids with Marble
				} else {
					// end of new content
				}
				//it's a girl!;
		...
		if( CoC.getInstance().player.pregnancyIncubation === 1 && CoC.getInstance().player.pregnancyType === PregnancyStore.PREGNANCY_MINOTAUR ) {
			if( CoC.getInstance().player.vaginas.length === 0 ) {
			...
			CoC.getInstance().player.cuntChange( 120, true, true, false );
			if( CoC.getInstance().player.vaginas[ 0 ].vaginalWetness === AppearanceDefs.VAGINA_WETNESS_DRY ) {
				CoC.getInstance().player.vaginas[ 0 ].vaginalWetness++;
			}
			if( CoC.getInstance().player.gender === 1 ) {
			...
			if( CoC.getInstance().player.buttRating < 12 && Utils.rand( 2 ) === 0 ) {
				CoC.getInstance().player.buttRating++;
				EngineCore.outputText( '\n\nYou notice your ' + Descriptors.buttDescript() + ' feeling larger and plumper after the ordeal.', false );
			} else if( CoC.getInstance().player.hipRating < 15 ) {
				CoC.getInstance().player.hipRating++;
				EngineCore.outputText( '\n\nAfter the birth your ' + CoC.getInstance().player.armorName + ' fits a bit more snugly about your ' + Descriptors.hipDescript() + '.', false );
			}
			CoC.getInstance().player.knockUpForce(); //Clear Pregnancy
			...
			if( CoC.getInstance().flags[ kFLAGS.UNKNOWN_FLAG_NUMBER_00328 ] === 0 ) {
				CoC.getInstance().flags[ kFLAGS.UNKNOWN_FLAG_NUMBER_00328 ] = 150;
			}
		}
		//Amily failsafe - converts PC with pure babies to mouse babies if Amily is corrupted;
		if( CoC.getInstance().player.pregnancyIncubation === 1 && CoC.getInstance().player.pregnancyType === PregnancyStore.PREGNANCY_AMILY ) {
			if( CoC.getInstance().flags[ kFLAGS.AMILY_FOLLOWER ] === 2 || CoC.getInstance().flags[ kFLAGS.UNKNOWN_FLAG_NUMBER_00170 ] > 0 ) {
		...
		if( CoC.getInstance().player.pregnancyIncubation === 1 && CoC.getInstance().player.pregnancyType === PregnancyStore.PREGNANCY_AMILY ) {
			if( CoC.getInstance().flags[ kFLAGS.AMILY_VISITING_URTA ] === 1 || CoC.getInstance().flags[ kFLAGS.AMILY_VISITING_URTA ] === 2 ) {
				CoC.getInstance().player.knockUpForce( PregnancyStore.PREGNANCY_MOUSE, CoC.getInstance().player.pregnancyIncubation );
			}
		}
		...
		if( CoC.getInstance().player.pregnancyIncubation === 1 && (CoC.getInstance().player.pregnancyType === PregnancyStore.PREGNANCY_MOUSE || CoC.getInstance().player.pregnancyType === PregnancyStore.PREGNANCY_JOJO) ) {
			CoC.getInstance().player.boostLactation( 0.01 );
			...
			displayedUpdate = true;
			//Butt increase;
			if( CoC.getInstance().player.buttRating < 14 && Utils.rand( 2 ) === 0 ) {
				if( CoC.getInstance().player.buttRating < 10 ) {
					CoC.getInstance().player.buttRating++;
					EngineCore.outputText( '\n\nYou notice your ' + Descriptors.buttDescript() + ' feeling larger and plumper after the ordeal.', false );
				}
				//Big butts grow slower!;
				else if( CoC.getInstance().player.buttRating < 14 && Utils.rand( 2 ) === 0 ) {
					CoC.getInstance().player.buttRating++;
					EngineCore.outputText( '\n\nYou notice your ' + Descriptors.buttDescript() + ' feeling larger and plumper after the ordeal.', false );
				}
			}
		...
		//Centaur Baby!;
		if( CoC.getInstance().player.pregnancyIncubation === 1 && (CoC.getInstance().player.pregnancyType === PregnancyStore.PREGNANCY_CENTAUR || CoC.getInstance().player.pregnancyType === PregnancyStore.PREGNANCY_KELT) ) {
			...
			CoC.getInstance().player.cuntChange( 100, true );
			if( CoC.getInstance().player.vaginas[ 0 ].vaginalWetness === AppearanceDefs.VAGINA_WETNESS_DRY ) {
				CoC.getInstance().player.vaginas[ 0 ].vaginalWetness++;
			}
			if( CoC.getInstance().player.gender === 1 ) {
		...
		if( CoC.getInstance().player.pregnancyIncubation === 1 && CoC.getInstance().player.pregnancyType === PregnancyStore.PREGNANCY_HELL_HOUND ) {
		...
		if( CoC.getInstance().player.pregnancyType === PregnancyStore.PREGNANCY_OVIELIXIR_EGGS && CoC.getInstance().player.pregnancyIncubation > 0 ) {
			...
			if( CoC.getInstance().player.pregnancyIncubation === 1 ) {
				...
				//Small egg scenes;
				if( CoC.getInstance().player.statusAffectv2( StatusAffects.Eggs ) === 0 ) {
					//light quantity;
					if( CoC.getInstance().player.statusAffectv3( StatusAffects.Eggs ) < 10 ) {
					...
					//High quantity;
						...
						if( CoC.getInstance().player.clitLength > 2 && CoC.getInstance().player.clitLength <= 5 ) {
				...
				//Large egg scene;
					...
					EngineCore.outputText( 'A sudden shift in the weight of your pregnant belly staggers you, dropping you to your knees.  You realize something is about to be birthed, and you shed your ' + CoC.getInstance().player.armorName + ' before it can be ruined by what\'s coming.  A contraction pushes violently through your midsection, ', false );
					if( CoC.getInstance().player.vaginas[ 0 ].vaginalLooseness < AppearanceDefs.VAGINA_LOOSENESS_LOOSE ) {
						EngineCore.outputText( 'stretching your tight cunt painfully, the lips opening wide ', false );
					}
					if( CoC.getInstance().player.vaginas[ 0 ].vaginalLooseness >= AppearanceDefs.VAGINA_LOOSENESS_LOOSE && CoC.getInstance().player.vaginas[ 0 ].vaginalLooseness <= AppearanceDefs.VAGINA_LOOSENESS_GAPING_WIDE ) {
					...
					if( CoC.getInstance().player.statusAffectv3( StatusAffects.Eggs ) >= 11 ) {
				...
				if( CoC.getInstance().player.findStatusAffect( StatusAffects.AteEgg ) >= 0 ) {
				...
				CoC.getInstance().player.createStatusAffect( StatusAffects.LootEgg, 0, 0, 0, 0 );
				displayedUpdate = true;
				CoC.getInstance().player.knockUpForce(); //Clear Pregnancy
			}
		}
	...
	Pregnancy.prototype.eggDescript = function( plural ) {
		var descript = '';
		if( CoC.getInstance().player.findStatusAffect( StatusAffects.Eggs ) >= 0 ) {
			descript += Utils.num2Text( CoC.getInstance().player.statusAffectv3( StatusAffects.Eggs ) ) + ' ';
			//size descriptor;
			if( CoC.getInstance().player.statusAffectv2( StatusAffects.Eggs ) === 1 ) {
				descript += 'large ';
			}
			/*color descriptor
			 ...
			 5 - rubbery black -
			 */
			if( CoC.getInstance().player.statusAffectv1( StatusAffects.Eggs ) === 0 ) {
				descript += 'brown ';
			}
			if( CoC.getInstance().player.statusAffectv1( StatusAffects.Eggs ) === 1 ) {
				descript += 'purple ';
			}
			if( CoC.getInstance().player.statusAffectv1( StatusAffects.Eggs ) === 2 ) {
				descript += 'blue ';
			}
			if( CoC.getInstance().player.statusAffectv1( StatusAffects.Eggs ) === 3 ) {
				descript += 'pink ';
			}
			if( CoC.getInstance().player.statusAffectv1( StatusAffects.Eggs ) === 4 ) {
				descript += 'white ';
			}
			if( CoC.getInstance().player.statusAffectv1( StatusAffects.Eggs ) === 5 ) {
