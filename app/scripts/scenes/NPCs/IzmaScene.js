...
angular.module( 'cocjs' ).run( function( MainView, SceneLib, $log, PregnancyStore, Izma, ConsumableLib, WeaponLib, PerkLib, Descriptors, AppearanceDefs, Appearance, CockTypesEnum, $rootScope, CoC, kFLAGS, Utils, StatusAffects, EngineCore, Combat ) {
	...
	IzmaScene.prototype.meetIzmaAtLake = function() {
		...
		//(after 4+ encounters) (Izmacounter >= 5);
			...
			if( CoC.flags[ kFLAGS.UNKNOWN_FLAG_NUMBER_00238 ] === -1 ) {
				...
				EngineCore.outputText( '"<i>' + CoC.player.short + '! It\'s so good to see you!</i>" she greets, both of you exchanging a quick hug. She sits on a rock beside her trunk, grinning from ear to ear. "<i>So, what do you want to do today?  Have you thought about bringing your beta with you?</i>"\n\n', false );
			...
			//Normal;
				...
				EngineCore.outputText( 'Izma sees you coming from a long way off and waves you over.  "<i>Hey, ' + CoC.player.short + '!  Come by to chat, or did you want to borrow a book?  Or... did you want to help me with my \'problem\'?  I\'m afraid it\'s becoming rather chronic lately,</i>" she says, grinning, as she uncrosses her legs and a bulge lifts the front of her skirt.\n\n', false );
				//[Trade] [Talk] [Sex] [Fight] [Leave];
				EngineCore.choices( 'Borrow', this, this.tradeWithFuckingSharkBitches, 'Fight', this, this.fightSharkCunt, 'Talk', this, this.talkToASharkCoochie, 'Sex', this, this.chooseYourIzmaWeapon, 'Leave', this, this.leaveSumSharkPussyOnTheBeach );
			}
		}
	...
	IzmaScene.prototype.loseToIzma = function() {
		...
		if( CoC.player.gender <= 2 ) {
			...
			if( CoC.flags[ kFLAGS.IZMA_TIMES_FOUGHT_AND_WON ] >= -2 ) {
				EngineCore.outputText( 'With some reluctance, but driven by your promise, you remove pieces of your ' + CoC.player.armorName + ' until you stand naked before the hungrily ogling tigershark.', false );
			}
		...
		//Loss Scene- Herm ;
			...
			EngineCore.outputText( 'As you collapse in defeat, you\'re aware of the pretty tigershark stalking around you and removing her clothing.  She grabs hard on your ' + CoC.player.armorName + ' and undresses you with minimal effort, revealing your ', false );
			...
			EngineCore.outputText( ' toward your face, stroking you to your own climax.  Jets of your own cum splatter across your face and body as you writhe, protesting. "<i>Tch, you really thought I\'d let you cum on ME?  Maybe if you actually managed to beat me I\'d give you the honor,</i>" Izma says, pulling free with a loud *SCHLICK* sound.  She releases your ' + CoC.player.feet() + ', allowing your ' + Descriptors.buttDescript() + ' to hit the sand with a plop, and gets to work redressing while you lie still.' );
	...
	IzmaScene.prototype.victoryPenisIzma = function() {
		...
		if( CoC.player.gender === 1 ) {
			...
			EngineCore.outputText( '  You sigh happily and push back from her, weakly getting back on your ' + CoC.player.feet() + ' and redressing. Izma scrambles to her chest and takes out some sort of leaf, then eats it.\n\n', false );
		}
		//(Herm);
		else {
			EngineCore.outputText( 'After a lengthy fuck, you grunt loudly as your ' + Descriptors.cockDescript( cockIndex ) + ' swells, blasting streamers of jizz into Izma\'s womb', false );
			...
			EngineCore.outputText( '  You sigh happily and push back from her, weakly getting to your ' + CoC.player.feet() + '.  You\'re not done yet though, not fully.\n\n', false );
	...
	IzmaScene.prototype.nonFightIzmaSmexPAINUS = function() {
		...
		//[(big/mega skeet);
		if( CoC.player.cumQ() >= 500 ) {
			EngineCore.outputText( 'You continue to shoot off stroke after stroke long after her mouth has filled up and she\'s pulled away.  "<i>For the love of Marae, ' + CoC.player.short + ', I can\'t swallow all that!</i>"  ', false );
		}
	...
	IzmaScene.prototype.nonFightIzmaSmexCUNTPUSSYSNATCHQUIM = function() {
		...
		EngineCore.outputText( 'You nod and remove your ' + CoC.player.armorName + ', not doing it with quite as much showmanship as Izma herself.  You expose your ' + Descriptors.allBreastsDescript() + ' to the air; your ' + Descriptors.nippleDescript( 0 ) + 's grow stiff from the breeze.  The bottom half of your clothing comes off, exposing your ' + Descriptors.vaginaDescript( 0 ), false );
		if( CoC.player.hasCock() ) {
	...
	IzmaScene.prototype.acceptIzmaAsYourBitch = function() {
		...
		if( CoC.flags[ kFLAGS.UNKNOWN_FLAG_NUMBER_00236 ] === 0 && CoC.flags[ kFLAGS.AMILY_FOLLOWER ] === 1 ) {
			...
			EngineCore.outputText( 'Izma tilts her head to the side and adjusts her spectacles to get a better look at Amily.  "<i>Well, I\'m a tigershark actually,</i>" she says flatly.  "<i>I\'m also ' + CoC.player.short + '\'s beta.  Who\'re you?  Oh!  You\'re one of those mouse people, right?</i>"\n\n', false );
	...
	IzmaScene.prototype.newAmilyMeetsIzma = function() {
		EngineCore.spriteSelect( 32 );
		EngineCore.outputText( '', true );
		EngineCore.outputText( 'You and Amily seem to talk non-stop on the way back, both excited at the prospect of living together.  Then she realizes you\'re not alone, once she sees Izma seated on her trunk, and looks puzzled. "<i>' + CoC.player.short + '... there\'s a shark-girl in your camp!</i>" she hisses, looking ready to fight or flee if the situation warrants.\n\n', false );
		...
		EngineCore.outputText( 'Amily just looks at her quizzically.  "<i>Yes, I am a mouse.</i>"  Her voice is ringing with a tone that just screams \'isn\'t it obvious?\'.  "<i>What was that about being ' + CoC.player.short + '\'s beta?  What\'s a beta?</i>"  You give a nervous chuckle and try your best to explain the past between you and Izma; what she is, your various sparring matches, and how she eventually submitted fully to you after several victories, declaring you as her alpha.\n\n', false );
		EngineCore.outputText( 'After that you turn to Izma and explain your past with Amily, the tales of her ruined village, how you grew to love her, and how you fathered many children with her to kickstart the population of untainted mouse-morphs.  Izma takes a breath and looks enthralled by your story.  "<i>That\'s incredible; amazingly noble, both of you.</i>"\n\n', false );
	...
	IzmaScene.prototype.izmaLakeSexAsEquals = function() {
		...
		if( CoC.player.gender === 0 ) {
			EngineCore.outputText( 'Izma looks you over, and then shakes her head sadly. "<i>I\'m sorry, ' + CoC.player.short + ', but... you still don\'t really have anything for me to play with.  If you want us to do it as equals, you\'ll need to grow a cock or a pussy.  How about you have one of us take charge, instead?</i>"\n\n', false );
			//[dom/sub]);
	...
	IzmaScene.prototype.izmaLakeDominate = function() {
		...
		if( CoC.player.hasCock() && (CoC.player.gender === 1 || Utils.rand( 2 ) === 0) ) {
			EngineCore.outputText( 'You remove your ' + CoC.player.armorName + ' and spread Izma\'s legs wide, ' + Descriptors.sMultiCockDesc() + ' almost painfully erect as you lift her quartet of balls up to look at her glistening womanhood.\n\n', false );
		...
		//[Female];
			...
			EngineCore.outputText( 'You strip off your ' + CoC.player.armorName + ' and spread Izma\'s legs wide, licking your lips at the sight of her throbbing erection and meaty quads.  You give Izma\'s massive cock a few test strokes, earning some pleasured groans from the tiger shark.\n\n', false );
			EngineCore.outputText( 'Deciding you\'ve had enough foreplay, you mount her and slide down her cock.', false );
	...
	IzmaScene.prototype.izmaLakeDominateContinueVanilla = function( vanilla ) {
		...
		if( CoC.player.gender === 1 ) {
			...
			EngineCore.outputText( '  You sigh happily and push back from her, weakly getting to your ' + CoC.player.feet() + ' and redressing. Izma scrambles to her chest and takes out some sort of leaf, then eats it.', false );
		}
		//(Herm);
		else {
			EngineCore.outputText( 'After a lengthy fuck, you grunt loudly as your ' + Descriptors.cockDescript( cockIndex ) + ' swells, blasting streamers of jizz into Izma\'s womb', false );
	...
	IzmaScene.prototype.submitToLakeIzma = function() {
		...
		//(herm);
			...
			EngineCore.outputText( '\n\n', false );
			EngineCore.outputText( 'Seemingly done appraising you, Izma roughly grabs your ' + CoC.player.feet() + ' and pulls your rear upwards, forcing your weight onto your spine and making you cry out from the uncomfortable position.  She doesn\'t waste time on foreplay, simply deciding to bury her cock into you slowly, inch by painstaking inch until she\'s pushing against the entrance to your womb.', false );
			CoC.player.cuntChange( 30, true, true, false );
			EngineCore.outputText( '\n\n', false );
			...
			if( CoC.player.pregnancyIncubation === 0 ) {
				EngineCore.outputText( 'releases your ' + CoC.player.feet() + ', allowing your ' + Descriptors.buttDescript() + ' to hit the sand with a plop, and gets to work redressing while you lie still.  She returns with an anti-this.pregnancy herb in her hands, and then flips a leaf into her mouth. Before you can wonder why she did that, she bends down and kisses you fiercely, her tongue pushing it past your lips and down your throat.', false );
		...
		if( CoC.flags[ kFLAGS.FOLLOWER_AT_FARM_IZMA ] === 0 ) {
			...
			switch( this.pregnancy.event ) {
				case 2:
					...
					break;
				case 3:
					EngineCore.outputText( 'Izma comes up to you, looking concerned.  "<i>' + CoC.player.short + ', do you think I\'ve gained weight?</i>" she asks.  Looking at her, particularly at the stomach she\'s holding her hands over, you have to confess that it is starting to bulge out in a noticeable paunch.  At her crestfallen look, you suggest that maybe she\'s pregnant.  At that, she looks delighted.  "<i>You really think so?</i>" she asks, hopefully.  You assure her that you\'re certain of it; after all, she\'s very good at watching her weight.  Pleased, she kisses you and then heads off for a swim.', false );
					break;
				case 4:
	...
	IzmaScene.prototype.followerIzmaMountsPC = function( lastHalf ) {
		...
		if( !lastHalf ) {
			...
			EngineCore.outputText( 'With a smirk, you make a show of removing your ' + CoC.player.armorName + ' and settling yourself down on your back, ' + Descriptors.sMultiCockDesc() + ' pointing into the air excitedly.  You give Izma a coy look and tell her that you\'re thinking of letting her have control this time... if she thinks she can dominate with her pussy' );
			if( CoC.flags[ kFLAGS.IZMA_NO_COCK ] === 0 ) {
			...
			if( CoC.flags[ kFLAGS.IZMA_NO_COCK ] === 0 ) {
				EngineCore.outputText( '  Your stomach starts to feel wet, and as you look down you realize her pre is starting to soak into your ' + CoC.player.skinFurScales() + '.\n\n', false );
			} else {
				EngineCore.outputText( '  Your stomach starts to feel wet, and as you look down you realize her feminine lubricant is starting to soak into your ' + CoC.player.skinFurScales() + '.\n\n', false );
			}
	...
	IzmaScene.prototype.followerIzmaTakesItInPooper = function() {
		...
		if( CoC.player.hasCock() ) {
			...
			//[If dick0 >16];
				...
				EngineCore.outputText( '"<i>Oh fuck,</i>" she says, her eyes filling with lust as she sees your cock extending well past her own.  She tilts forward and rubs the base of her cock hard against the base of your ' + Appearance.cockNoun( CoC.player.cocks[ 0 ].cockType ) + ', jerking the both of you off together.  You moan helplessly when she stops, and she sighs, "<i>It feels so good to be alpha over a powerful cock like yours.</i>"', false );
			}
			EngineCore.outputText( '\n\n', false );
		}
	...
	IzmaScene.prototype.followerIzmaTakesItInVagoo = function() {
		...
		EngineCore.outputText( '', true );
		EngineCore.outputText( 'Admiring the view of the tigershark\'s ornamented crotch, you lower the bottoms of your ' + CoC.player.armorName + ' and reveal the base of your ' + Descriptors.multiCockDescriptLight() + ', something that instantly draws Izma\'s eyes.  You ask how she\'d like her alpha to tend to her oft-neglected pussy.  Izma smiles eagerly and spreads her legs' );
		if( CoC.flags[ kFLAGS.IZMA_NO_COCK ] === 0 ) {
		...
		EngineCore.outputText( '  You shed your own ' + CoC.player.armorName + ' and strike a pose for her. Izma watches you closely for a few moments, before growling, "<i>Oh stop toying around and fuck me already!</i>" She gives a gasp and covers her mouth. "<i>O-oh, sorry... I was out of line talking to my Alpha like that!</i>"\n\n', false );
		...
		EngineCore.outputText( 'Izma continues to moan and groan loudly, and starts to mash her own hips against yours, trying to work in as many inches of your ' + Appearance.cockNoun( CoC.player.cocks[ 0 ].cockType ) + ' as she can.  ' );
		if( CoC.flags[ kFLAGS.IZMA_NO_COCK ] === 0 ) {
	...
	IzmaScene.prototype.pcPopsOutASharkTot = function() {
		...
		if( CoC.flags[ kFLAGS.UNKNOWN_FLAG_NUMBER_00238 ] !== 1 ) {
			...
			EngineCore.outputText( '\n\n', false );
			EngineCore.outputText( 'Finally, she\'s out; you quiver weakly as she crawls over to you and it takes all your effort to lift your ' + CoC.player.armorName + ' and expose your ' + Descriptors.nippleDescript( 0 ) + 's to her.  As she sucks greedily at them, the haze begins to clear from your vision.  For the first time, you can actually make out distinct features on your new daughter; she\'s a ', false );
			if( Utils.rand( 100 ) <= 59 ) {
				EngineCore.outputText( 'shark-girl', false );
			...
			EngineCore.outputText( 'You cry out as the first wrenching labor pain begins in earnest, unthinkingly hoping for somebody to come and help you.  To your relief, Izma comes running over to you from out of the gloom.  "<i>' + CoC.player.short + '!  You\'ve gone into labor?</i>" she asks; something of a stupid question, but she\'s evidently as off-guard as you are.\n\n', false );
	...
	IzmaScene.prototype.izmaKidsPlaytime = function() {
		...
		if( CoC.flags[ kFLAGS.IZMA_CHILDREN_SHARKGIRLS ] > 0 ) {
			if( CoC.flags[ kFLAGS.IZMA_CHILDREN_SHARKGIRLS ] === 1 ) {
				...
				EngineCore.outputText( Utils.num2Text( CoC.flags[ kFLAGS.IZMA_CHILDREN_SHARKGIRLS ] ) + ' shark-girls', false );
			}
			if( CoC.flags[ kFLAGS.IZMA_CHILDREN_TIGERSHARKS ] > 0 ) {
				EngineCore.outputText( ' and ', false );
			}
		...
		if( CoC.flags[ kFLAGS.IZMA_CHILDREN_TIGERSHARKS ] > 0 ) {
			if( CoC.flags[ kFLAGS.IZMA_CHILDREN_TIGERSHARKS ] === 1 ) {
				...
				EngineCore.outputText( Utils.num2Text( CoC.flags[ kFLAGS.IZMA_CHILDREN_TIGERSHARKS ] ) + ' tigersharks', false );
			}
		}
	...
	IzmaScene.prototype.inCampRideIzmasDickDongTheWitchIsDead = function() {
		...
		EngineCore.outputText( 'Slowly and sensuously you remove your ' + CoC.player.armorName + ', exulting in the way Izma hungrily drinks in every inch of exposed ' + CoC.player.skinFurScales() + '.  Her eyes devour your ' + Descriptors.allBreastsDescript() + ', then slide eagerly down to your crotch to feast upon', false );
		if( CoC.player.hasCock() ) {
		...
		if( CoC.player.hasCock() ) {
			EngineCore.outputText( '  Your ' + Appearance.cockNoun( CoC.player.cocks[ 0 ].cockType ) + ' rubs against her shaft, sending delicious sparks surging through you.', false );
		}
	...
	IzmaScene.prototype.internalIzmaAnalCumShot = function() {
		...
		if( CoC.player.cockThatFits2( 65 ) >= 0 ) {
			EngineCore.outputText( '  The feelers in her pussy glide along the glans of your ' + Descriptors.cockDescript( CoC.player.cockThatFits2( 65 ) ) + ', driving your dick\'s unconscious efforts to inseminate her into overdrive as you feel each subsequent stream of semen increase in velocity.' );
		}
	};
	...
	IzmaScene.prototype.izmaDomsLatexyPartI = function() {
		...
		EngineCore.outputText( '  A particularly powerful thrust inside herself has ' + CoC.flags[ kFLAGS.GOO_NAME ] + ' whining, her eyelids fluttering closed as she cries, "<i>Oh, [name]!</i>"' );
		...
		if( SceneLib.latexGirl.gooObedience() / 5 + SceneLib.latexGirl.gooFluid() / 5 + Utils.rand( 20 ) < 10 ) {
			EngineCore.outputText( '' + CoC.flags[ kFLAGS.GOO_NAME ] + ' grows and sucks harder, cheeks hollowed with suckling hunger.  You can see them stretch and go even more concave with rhythmic pulsations, vacuum-tight around the orange shaft.  Izma moans and tries to pull out, but she barely manages to extract an inch before her whole length is noisily pulled back in.  The shark-girl tries to pry the slutty, hungry little goo off of herself again and again, but each time, all she winds up doing is getting sensuously devoured again and again.  ' + CoC.flags[ kFLAGS.GOO_NAME ] + ' gives her four balls another appreciative squeeze, and Izma\'s eyes suddenly roll back, helpless again the hungry sluts impressive oral talents.' );
		...
		//OBEDIENCE SUCCESS;
			...
			EngineCore.outputText( '' + CoC.flags[ kFLAGS.GOO_NAME ] + ' obediently relaxes, allowing the herm to take more effective control of the situation.  "<i>Atta girl,</i>" Izma comments as she extracts herself from the hungry, sucking mouth-hole, her dick shining with a fresh, wet, latex sheath.  "<i>Ass up, slut.  You\'re getting fed via suppository today!</i>"' );
	...
	IzmaScene.prototype.stopIzmaLatexy = function() {
		EngineCore.clearOutput();
		EngineCore.outputText( 'You step into the middle of it before it can progress any farther.  ' + CoC.flags[ kFLAGS.GOO_NAME ] + ' is yours, and Izma is not to play at being a mistress to YOUR pet.' );
	...
	IzmaScene.prototype.izmaLatexyToggle = function() {
		...
		if( CoC.flags[ kFLAGS.IZMA_X_LATEXY_DISABLED ] === 0 ) {
			EngineCore.outputText( 'You tell Izma you don\'t want her feeding ' + CoC.flags[ kFLAGS.GOO_NAME ] + ' any more.' );
			...
			EngineCore.outputText( 'You tell Izma that you\'ve changed your mind, and she can keep ' + CoC.flags[ kFLAGS.GOO_NAME ] + ' fluid topped off.  The shark-girl hugs you with a predatory grin splitting her face.  "<i>I can\'t wait.</i>"' );
