...
angular.module( 'cocjs' ).run( function( MainView, SceneLib, $log, PregnancyStore, Izma, ConsumableLib, WeaponLib, PerkLib, Descriptors, AppearanceDefs, Appearance, CockTypesEnum, $rootScope, CoC, kFLAGS, Utils, StatusAffects, EngineCore, Combat ) {
	...
	IzmaScene.prototype.timeChange = function() {
		...
		$log.debug( '\nIzma time change is ' + CoC.time.hours + ', incubation: ' + this.pregnancy.incubation + ', event: ' + this.pregnancy.event );
		if( CoC.flags[ kFLAGS.IZMA_TIME_TILL_NEW_BOOK_AVAILABLE ] > 0 ) {
			CoC.flags[ kFLAGS.IZMA_TIME_TILL_NEW_BOOK_AVAILABLE ]--; //BOOKURYUUUU COUNTAH For IZMA
		}
		if( this.izmaFollower() && CoC.flags[ kFLAGS.IZMA_NO_COCK ] === 0 && CoC.flags[ kFLAGS.TIMES_IZMA_DOMMED_LATEXY ] > 0 && SceneLib.latexGirl.latexGooFollower() && CoC.flags[ kFLAGS.IZMA_X_LATEXY_DISABLED ] === 0 ) {
			CoC.flags[ kFLAGS.GOO_FLUID_AMOUNT ] = 100;
		}
		if( CoC.time.hours > 23 && CoC.flags[ kFLAGS.UNKNOWN_FLAG_NUMBER_00246 ] > 0 ) {
			CoC.flags[ kFLAGS.UNKNOWN_FLAG_NUMBER_00246 ] = 0;
		}
		return false;
	};
	IzmaScene.prototype.timeChangeLarge = function() {
		if( this.checkedIzmaSophie++ === 0 && SceneLib.sophieBimbo.bimboSophie() && CoC.flags[ kFLAGS.FOLLOWER_AT_FARM_SOPHIE ] === 0 && this.izmaFollower() && CoC.flags[ kFLAGS.FOLLOWER_AT_FARM_IZMA ] === 0 && CoC.flags[ kFLAGS.IZMA_NO_COCK ] === 0 && ((CoC.flags[ kFLAGS.TIMES_SOPHIE_AND_IZMA_FUCKED ] === 0 && Utils.rand( 10 ) === 0) || CoC.flags[ kFLAGS.TOLD_SOPHIE_TO_IZMA ] === 1) ) {
			CoC.flags[ kFLAGS.TOLD_SOPHIE_TO_IZMA ] = 0;
			SceneLib.sophieBimbo.sophieAndIzmaPlay();
			return true;
		}
		if( this.checkedIzmaLatexy++ === 0 && this.izmaFollower() && CoC.flags[ kFLAGS.FOLLOWER_AT_FARM_IZMA ] === 0 && CoC.flags[ kFLAGS.IZMA_NO_COCK ] === 0 && SceneLib.latexGirl.latexGooFollower() && CoC.flags[ kFLAGS.FOLLOWER_AT_FARM_LATEXY ] === 0 && CoC.flags[ kFLAGS.TIMES_IZMA_DOMMED_LATEXY ] === 0 && Utils.rand( 10 ) === 0 ) {
			this.izmaDomsLatexy();
			return true;
		}
		return false;
	...
	IzmaScene.prototype.meetIzmaAtLake = function() {
		...
		//(Izmacounter= 1);
			...
			if( CoC.player.statusAffectv1( StatusAffects.TelAdre ) >= 1 ) {
				MainView.outputText( 'outside the safety of Tel\'Adre', false );
			} else {
				MainView.outputText( 'since you arrived', false );
			}
			MainView.outputText( '.  Perhaps imagining you a kindred spirit, she presses the topic.  "<i>I could let you borrow some... for a small usage fee. And you\'d stay in sight, of course.</i>"  You contrive to look hurt.  "<i>Nothing personal, but I\'d like to expand my collection, not reduce it,</i>" she adds.  Still... an appealing offer.  You could do with as much knowledge as you can get.\n\n', false );
			MainView.outputText( 'You nod in agreement, earning a smile from Izma.  You chat for another short while before you part ways, heading back to your camp.', false );
			//(Izmacounter +1);
			CoC.flags[ kFLAGS.UNKNOWN_FLAG_NUMBER_00230 ]++;
			EngineCore.doNext( SceneLib.camp, SceneLib.camp.returnToCampUseOneHour );
		}
		//[Next 2 encounters with Izma] (Izmacounter = 2 or 3);
		else if( CoC.flags[ kFLAGS.UNKNOWN_FLAG_NUMBER_00230 ] < 4 ) {
			MainView.outputText( 'Your exploration of the lakeshore has brought you back to Izma\'s campsite.  The tigershark is happy to see you, but you can\'t help but feel she\'s a little distracted with something; she\'s constantly playing around with her skirt and grinding her fangs.\n\n', false );
			MainView.outputText( '"<i>So, what can I interest you in?</i>" she asks.\n\n', false );
			//[Trade] [Talk] [Leave] - has special text;
			EngineCore.choices( 'Borrow', this, this.tradeWithFuckingSharkBitches, 'Talk', this, this.talkToASharkCoochie, '', null, null, '', null, null, 'Leave', this, this.leaveSumSharkPussyOnTheBeach );
		}
		//-----------------------------------------;
		//[After 3 encounters] (Izmacounter = 4);
		else if( CoC.flags[ kFLAGS.UNKNOWN_FLAG_NUMBER_00230 ] === 4 ) {
			MainView.outputText( 'Your exploration of the lakeshore has brought you to Izma\'s tiny camp once again.  You greet each other normally, but you can\'t help but notice Izma seems even more distracted than normal.  "<i>Hey, uh... we\'re friends, right?</i>" Izma asks eventually, winning a nod from you.  The tigershark has given you some good company, which you find a rarity in this world.  "<i>Good, good.  I, uh, have this \'problem\' and I need a friend to help me out with it.</i>"  At first you surmise she\'s referring to some sort of errand too far from the lake to do on her own, but once she pulls her grass skirt open you understand full well what her \'problem\' is.\n\n', false );
			MainView.outputText( 'A fifteen-inch-long, semi-erect shaft flops free from Izma\'s skirt, with a quartet of baseball-sized gonads swinging beneath it.  It seems roughly like a human\'s in appearance, though the red skin does make for a noticeable difference.  How Izma was hiding that is beyond you.  You can only guess at its girth once it\'s fully erect...\n\n', false );
			MainView.outputText( '"<i>Don\'t get the wrong idea here, I\'m not gonna jump you or anything, I\'m just offering.  I mean I could easily catch myself another shark girl or a cultist if I wanted to.  Just... offering, is all,</i>" Izma says, looking skyward and avoiding eye contact.\n\n', false );
			MainView.outputText( 'You roll the idea around in your head for a few seconds before asking just what\'s in it for you.  Izma smiles, happy to see you\'re at least pondering the offer.  "<i>I can pay you,</i>" she says proudly, earning a raised eyebrow from you.  Izma rummages around her oak chest, pulling out something that looks like a shark tooth.  One thing that catches your eye is the strange purple glow it\'s giving off.\n\n', false );
		...
		//(after 4+ encounters) (Izmacounter >= 5);
			...
			if( CoC.flags[ kFLAGS.UNKNOWN_FLAG_NUMBER_00238 ] === -1 ) {
				...
				MainView.outputText( '"<i>' + CoC.player.short + '! It\'s so good to see you!</i>" she greets, both of you exchanging a quick hug. She sits on a rock beside her trunk, grinning from ear to ear. "<i>So, what do you want to do today?  Have you thought about bringing your beta with you?</i>"\n\n', false );
				//[Shop] [Sex] [Talk] [Camp] [Leave];
				EngineCore.choices( 'Borrow', this, this.tradeWithFuckingSharkBitches, 'Camp', this, this.acceptIzmaAsYourBitch, 'Talk', this, this.talkToASharkCoochie, 'Sex', this, this.izmaLakeTurnedDownCampSex, 'Leave', this, this.leaveSumSharkPussyOnTheBeach );
				//[Shop];
			...
			//[After 5 consecutive wins against Izma] (encountered with Izmafight >= 5);
			else if( CoC.flags[ kFLAGS.IZMA_TIMES_FOUGHT_AND_WON ] >= 6 && CoC.flags[ kFLAGS.UNKNOWN_FLAG_NUMBER_00238 ] === 0 ) {
				MainView.outputText( 'You walk the lakeshore, hoping to encounter the slutty shark Izma again, and you set your sights on her makeshift camp soon enough.  From what you can see, the girl is looking out from the lakeshore as if in deep thought.  As you draw closer, you see that her hands are constantly fidgeting on her lap, a telltale sign of her nerves.  Now, just what could be on her mind that has her so riled up?\n\n', false );
				MainView.outputText( 'You step on a brittle shell as you advance and it crunches loudly beneath your feet, drawing Izma\'s attention.  She looks at you and her mood seems to instantly brighten, though her hands are still fidgeting nervously.  Smirking, you hold up a hand as a greeting and ask what\'s up.\n\n', false );
				...
				MainView.outputText( '"<i>And... if -if you want a mate... um, I could come with you... if that\'s okay with you?</i>"  She stares at the sand and blushes.  "<i>O-otherwise, I\'ll just  stay here... and not bother you.</i>"  It seems you\'ve been presented with a choice; you could either accept Izma as a mate, or turn her down and let her remain at the lake. What do you do?\n\n', false );
				//[Accept][Stay];
				EngineCore.choices( 'Accept', this, this.acceptIzmaAsYourBitch, 'Stay', this, this.IzmaStayAtTheLakeBitch, '', null, null, '', null, null, '', null, null );
			}
			//Normal;
			else {
				MainView.outputText( 'Izma sees you coming from a long way off and waves you over.  "<i>Hey, ' + CoC.player.short + '!  Come by to chat, or did you want to borrow a book?  Or... did you want to help me with my \'problem\'?  I\'m afraid it\'s becoming rather chronic lately,</i>" she says, grinning, as she uncrosses her legs and a bulge lifts the front of her skirt.\n\n', false );
				//[Trade] [Talk] [Sex] [Fight] [Leave];
				EngineCore.choices( 'Borrow', this, this.tradeWithFuckingSharkBitches, 'Fight', this, this.fightSharkCunt, 'Talk', this, this.talkToASharkCoochie, 'Sex', this, this.chooseYourIzmaWeapon, 'Leave', this, this.leaveSumSharkPussyOnTheBeach );
			}
		}
	...
	IzmaScene.prototype.tradeWithFuckingSharkBitches = function() {
		...
		if( CoC.flags[ kFLAGS.UNKNOWN_FLAG_NUMBER_00238 ] <= 0 ) {
			EngineCore.choices( 'C.Manual', this, this.readSharkCuntManual,
				'E.Guide', this, this.sharkEdgingGuideLOL,
				'Porn', this, this.sharkgirlPronz, '', null, null, 'Back', this, this.meetIzmaAtLake );
		} else {
			EngineCore.choices( 'C.Manual', this, this.readSharkCuntManual,
				'E.Guide', this, this.sharkEdgingGuideLOL,
				'Porn', this, this.sharkgirlPronz, '', null, null, 'Back', this, this.izmaFollowerMenu );
		}
	};
	//[C.Manual];
	IzmaScene.prototype.readSharkCuntManual = function() {
		...
		if( CoC.player.gems < 20 ) {
			...
			EngineCore.doNext( this, this.tradeWithFuckingSharkBitches );
		}
		//[Yes/No];
		else {
			EngineCore.doYesNo( this, this.readSharkCuntManual2, this, this.tradeWithFuckingSharkBitches );
		}
	};
	IzmaScene.prototype.readSharkCuntManual2 = function() {
		...
		if( choice === 0 ) {
			MainView.outputText( 'You learn a few new guarding stances that seem rather promising.', false );
			//(+2 Toughness);
			EngineCore.dynStats( 'tou', 2 );
		} else if( choice === 1 ) {
			MainView.outputText( 'After a quick skim you reach the end of the book. You don\'t learn any new fighting moves, but the refresher on the overall mechanics and flow of combat and strategy helped.', false );
			//(+2 Intelligence);
			EngineCore.dynStats( 'int', 2 );
		} else {
			MainView.outputText( 'Your read-through of the manual has given you insight into how to put more of your weight behind your strikes without leaving yourself open.  Very useful.', false );
			//(+2 Strength);
		...
		if( CoC.flags[ kFLAGS.UNKNOWN_FLAG_NUMBER_00238 ] !== 1 ) {
			MainView.outputText( 'head back to your camp.', false );
		} else {
			MainView.outputText( 'leave the shark-girl to her books.', false );
		}
		//(Izmacounter +1);
		CoC.flags[ kFLAGS.UNKNOWN_FLAG_NUMBER_00230 ]++;
		EngineCore.doNext( SceneLib.camp, SceneLib.camp.returnToCampUseOneHour );
	...
	IzmaScene.prototype.sharkEdgingGuideLOL = function() {
		...
		if( CoC.player.gems < 25 ) {
			MainView.outputText( '\n\n<b>You haven\'t got that much.</b>', false );
			EngineCore.doNext( this, this.tradeWithFuckingSharkBitches );
		}
		//[Yes/No];
		else {
			EngineCore.doYesNo( this, this.readSharkEdgingGuideLOL, this, this.tradeWithFuckingSharkBitches );
		}
	};
	IzmaScene.prototype.readSharkEdgingGuideLOL = function() {
		...
		MainView.statsView.show();
		MainView.outputText( '', true );
		MainView.outputText( 'You hand Izma the gems she asked for and then pick up a copy.  Izma takes a moment to count the gems, while you sit down near her.\n\n', false );
		MainView.outputText( 'You peruse the strange book in an attempt to refine your manners, though you\'re almost offended by the stereotypes depicted within.  Still, the book has some good ideas on how to maintain chastity and decorum in the face of lewd advances.\n\n', false );
		//(-2 Libido, -2 Corruption);
		EngineCore.dynStats( 'lib', -2, 'cor', -2 );
		MainView.outputText( 'After reading through the frilly book you give it back to Izma who delicately places it back in the trunk.  You say your goodbyes and then ', false );
		if( CoC.flags[ kFLAGS.UNKNOWN_FLAG_NUMBER_00238 ] !== 1 ) {
			MainView.outputText( 'head back to your camp.', false );
		} else {
			MainView.outputText( 'leave the shark-girl to her books.', false );
	...
	IzmaScene.prototype.sharkgirlPronz = function() {
		...
		//[Yes/No];
			...
			EngineCore.doYesNo( this, this.readSharkgirlPornzYouFuckingPervertAsshole, this, this.tradeWithFuckingSharkBitches );
		}
	};
	IzmaScene.prototype.readSharkgirlPornzYouFuckingPervertAsshole = function() {
		...
		MainView.statsView.show();
		MainView.outputText( '', true );
		MainView.outputText( 'Izma colors brightly as you flamboyantly produce the requested gems and present them to her, but dutifully hands over the bound illustrations.  While she fumbles with the gems you move down a few feet to examine the pornographic material.\n\n', false );
		MainView.outputText( 'You wet your lips as you flick through the pages of the book and admire the rather... detailed illustrations inside.  A bee-girl getting gangbanged by imps, a minotaur getting sucked off by a pair of goblins... the artist certainly has a dirty mind.  As you flip the pages you notice the air around you heating up a bit; you attribute this to weather until you finish and close the book... only to discover that Izma had been standing behind you for some time, \'reading\' over your shoulder.', false );
		//(+2! Libido and lust gain);
		EngineCore.dynStats( 'lib', 2, 'lus', (20 + CoC.player.lib / 10) );
		//(0-30 Corruption);
		if( CoC.player.cor < 33 ) {
			MainView.outputText( '  You give a bit of a start.  "<i>S-sorry,</i>" she says.  At a loss for words, you hand her the porn and make a hasty retreat', false );
			if( CoC.flags[ kFLAGS.UNKNOWN_FLAG_NUMBER_00238 ] !== 1 ) {
				MainView.outputText( ' back to your camp', false );
			}
			MainView.outputText( '.', false );
		}
		//(31-69 Corruption);
		else if( CoC.player.cor < 66 ) {
			MainView.outputText( '  You smile at her and pass her the book, with a heavy-lidded glance and a quip about how it wasn\'t a bad read but the real deal is much better.  She blushes a bit and claps her knees together.  Thanking Izma for the read, ', false );
			if( CoC.flags[ kFLAGS.UNKNOWN_FLAG_NUMBER_00238 ] !== 1 ) {
				MainView.outputText( 'you head back to camp.', false );
			} else {
				MainView.outputText( 'you turn back to the center of your camp.', false );
			}
		}
		//(70+ corruption);
		else {
			MainView.outputText( '  You nonchalantly glance at Izma, and mention that it doesn\'t really compare to your own fantasies and experiences.  With that, you hold the closed book out and tuck it neatly into the cleavage of her breasts!  Keeping your hand on it, you quirk an eyebrow at her; she shivers, colors deeply, and turns around, snatching the book from you.  "<i>You... perv,</i>" she teases back.  "<i>Why don\'t you write a book yourself then?</i>" As you go to leave, you notice her grass skirt has shifted to the front and lies taut against the contours of her butt.  Too tempting!  You plant an open-palmed smack on it and take off running as she shouts after you.', false );
		}
		//(Izmacounter +1);
		CoC.flags[ kFLAGS.UNKNOWN_FLAG_NUMBER_00230 ]++;
		EngineCore.doNext( SceneLib.camp, SceneLib.camp.returnToCampUseOneHour );
	...
	IzmaScene.prototype.talkToASharkCoochie = function() {
		...
		if( CoC.flags[ kFLAGS.UNKNOWN_FLAG_NUMBER_00232 ] === 0 ) {
			...
			if( CoC.player.findStatusAffect( StatusAffects.DungeonShutDown ) < 0 ) {
				...
				MainView.outputText( 'You smile, and detail just what that factory is and what you went on to do in this factory.', false );
			}
		}
	...
	IzmaScene.prototype.fightSharkCunt = function() {
		...
		//(Izmacounter +1);
		CoC.flags[ kFLAGS.UNKNOWN_FLAG_NUMBER_00230 ]++;
		MainView.outputText( 'Izma smiles widely and retrieves a pair of hooked metal gauntlets from her chest, donning them and clenching her fist a few times.  ', false );
		//(If Izmafight = 0) ;
		if( CoC.flags[ kFLAGS.IZMA_TIMES_FOUGHT_AND_WON ] === 0 ) {
			MainView.outputText( '"<i>All right, show me just what a Champion can do!</i>" she says, entering a fighting stance.', false );
		}
		//(If Izmafight = 1-2) ;
		else if( CoC.flags[ kFLAGS.IZMA_TIMES_FOUGHT_AND_WON ] > 0 && CoC.flags[ kFLAGS.IZMA_TIMES_FOUGHT_AND_WON ] <= 2 ) {
			MainView.outputText( 'Izma\'s eyes narrow at you, and she assumes a fighting stance.  "<i>You won\'t get so lucky this time.</i>"', false );
		}
		//(If Izmafight = 3+);
		else if( CoC.flags[ kFLAGS.IZMA_TIMES_FOUGHT_AND_WON ] > 2 ) {
			MainView.outputText( 'Izma seems uncertain with herself as she prepares for battle. "<i>Go a little easier on me this time... please?</i>"', false );
		}
		//(If Izmafight = -1 or -2 );
		else if( CoC.flags[ kFLAGS.IZMA_TIMES_FOUGHT_AND_WON ] < 0 && CoC.flags[ kFLAGS.IZMA_TIMES_FOUGHT_AND_WON ] >= -2 ) {
			MainView.outputText( '"<i>Hm, really?  Well, maybe you\'ll get lucky this time,</i>" she mocks, gesturing at you to strike first.', false );
		}
		//(If Izmafight = -3 to -4);
		else {
	...
	IzmaScene.prototype.defeatIzma = function() {
		...
		//(Izmafight = 0) ;
		if( CoC.flags[ kFLAGS.IZMA_TIMES_FOUGHT_AND_WON ] <= 0 ) {
			MainView.outputText( 'Izma falls back into the sand, her ', false );
			if( CoC.monster.HP < 1 ) {
				MainView.outputText( 'injuries', false );
			} else {
				MainView.outputText( 'lust', false );
			}
			MainView.outputText( ' preventing her from fighting on.  She growls at you in annoyance, "<i>Fine.  You win... this time.</i>"\n\n', false );
		} else if( CoC.flags[ kFLAGS.IZMA_TIMES_FOUGHT_AND_WON ] > 0 ) {
			//(Izmafight = 1 or 2) ;
			if( CoC.flags[ kFLAGS.IZMA_TIMES_FOUGHT_AND_WON ] < 3 ) {
				MainView.outputText( 'Having incapacitated Izma through ', false );
				if( CoC.monster.HP < 1 ) {
					MainView.outputText( 'physical', false );
				} else {
					MainView.outputText( 'sexual', false );
				}
				MainView.outputText( ' prowess, you stand over the defeated tigershark.  "<i>Okay, okay!  You win!  Geez... let\'s get on with it, I feel like I\'m gonna go crazy.</i>"  She begins removing her clothing.\n\n', false );
			}
			//(Izmafight = 3+) ;
			else {
				MainView.outputText( 'Izma falls into the sand in an exaggerated fashion.  "<i>Oh no!  I seem to have lost!  Please don\'t ravish me again!</i>" she proclaims loudly as she undresses, her bad acting almost making you laugh your ass off.\n\n', false );
			}
		}
		MainView.outputText( 'Which part of your body will you claim her with?', false );
		var penis = null;
		...
		EngineCore.choices( 'Use Penis', this, penis, 'Use Vagina', this, vag, 'Use Ass', this, this.takeItInZeButtVictoryLikeFromIzma, '', null, null, 'Leave', this, this.leaveIzmaVictoryTease );
	};
	...
	IzmaScene.prototype.IzmaWins = function() {
		...
		//(without worms);
			...
			//(Izmafight =0);
			if( CoC.flags[ kFLAGS.IZMA_TIMES_FOUGHT_AND_WON ] >= 0 ) {
				MainView.outputText( 'Izma chuckles slightly as she prowls around your defeated form.  "<i>Well, as far as things around here stand, you made for a decent fight.  Still no match for me, though.</i>"', false );
			}
			//(Izmafight = -1 or -2) ;
			else if( CoC.flags[ kFLAGS.IZMA_TIMES_FOUGHT_AND_WON ] >= -2 ) {
				MainView.outputText( '"<i>Ya know, just because we\'re friends doesn\'t mean you need to hold back... you were holding back, right?</i>" Izma asks, placing her hands on her hips.', false );
			}
			//(Izmafight = -3 or -4) ;
			else {
				MainView.outputText( 'Izma sighs and shakes her head at you, letting a foot rest on your stomach  "<i>You\'re doing this on purpose, aren\'t you?  Hm, fine.  If you love my cock so much, I think you\'d make for a decent mate...</i>"', false );
			}
			//TO THE SECKS!;
			EngineCore.doNext( this, this.loseToIzma );
		}
	};
	//M/F/U Loss starter:;
	IzmaScene.prototype.loseToIzma = function() {
		...
		if( CoC.flags[ kFLAGS.IZMA_TIMES_FOUGHT_AND_WON ] <= -5 ) {
		...
		if( CoC.player.gender <= 2 ) {
			...
			if( CoC.player.HP < 1 ) {
				MainView.outputText( 'One of Izma\'s metal-clad fists cracks hard against your stomach, sending you crashing onto the sandy earth - you aren\'t seriously hurt, but you\'re too weak to continue fighting, and Izma knows it.\n\n', false );
				MainView.outputText( 'She grins at you, a rather fierce expression given she\'s still got her shark-teeth out, but her tone is gentle enough.  "<i>Hah! Looks like I win this round, kid!  Now, I believe there\'s something you owe me, and I intend to have it...</i>"\n\n', false );
			}
			//(If player is raised to 100 Lust:) ;
			else {
				MainView.outputText( 'Your legs buckle, and your mind fogs with arousal; you are too turned on to continue fighting and collapse bonelessly into a shivering heap.\n\n', false );
				MainView.outputText( 'Izma shakes her head, grinning wryly.  "<i>Looks like somebody needs to get more discipline before they try a sex-off.</i>"\n\n', false );
			}
			MainView.outputText( '"<i>All right; time to hold up your end,</i>" she notes.  The double entendre is lost on your fuddled mind.  Her tone is conversational, but her grin is wicked, and she is slipping out of her grass skirt as hastily as she can, given the care she needs to take it off without damaging it.  After all, skirts that can so easily conceal the iron-hard foot-and-a-quarter-long erection she is sporting require considerable skill to make, especially if they must also conceal two pairs of baseball-sized nuts, so swollen and heavy with cum that you think you can hear them slosh softly from where you have fallen.  "<i>We agreed to do it shark style; you lost, so that means I\'m in charge.  Get undressed and show me that cute little ', false );
			if( CoC.player.hasVagina() ) {
				MainView.outputText( 'cunt', false );
			} else {
				MainView.outputText( 'pucker', false );
			}
			MainView.outputText( ' of yours!</i>"  ', false );
			//[(If Izmafight is -1 or -2);
			if( CoC.flags[ kFLAGS.IZMA_TIMES_FOUGHT_AND_WON ] >= -2 ) {
				MainView.outputText( 'With some reluctance, but driven by your promise, you remove pieces of your ' + CoC.player.armorName + ' until you stand naked before the hungrily ogling tigershark.', false );
			}
			//(If Izmafight is -3 or less);
			else {
				MainView.outputText( 'You are already undressed before Izma has finished speaking.  The tigershark is clearly surprised, and, to be honest, a part of you is surprised too... but it\'s drowned out by the need to give yourself over to Izma\'s lusts.', false );
			}
			MainView.outputText( '\n\n', false );
			MainView.outputText( 'Your \'cute little ', false );
			if( CoC.player.hasVagina() ) {
				MainView.outputText( 'cunt', false );
			} else {
				MainView.outputText( 'pucker', false );
			}
			MainView.outputText( '\' clenches tight in ', false );
			if( CoC.player.HP < 1 ) {
				MainView.outputText( 'fear', false );
			} else {
				MainView.outputText( 'anticipation', false );
			}
			MainView.outputText( ' at the thought of something that huge forcing its way into it... but you did make a promise and you are ', false );
			if( CoC.player.HP < 1 ) {
				MainView.outputText( 'too weak to resist', false );
			} else {
				MainView.outputText( 'feeling very horny', false );
			}
			MainView.outputText( ', so you comply.  You remove the last bits of your ' + CoC.player.armorName + ', and position yourself on the ground, your ' + Descriptors.buttDescript() + ' facing towards Izma.  You can hear her stalking across the sand toward you, but it still sends tingles up your spine when her hands - now free of her metal gauntlets - fall onto your ' + Descriptors.assDescript() + '.\n\n', false );
			MainView.outputText( '"<i>Ooh, looking good from this angle.  I\'m going to enjoy taking you like this... after all, if you want to be on top, then you gotta fight for it.</i>"\n\n', false );
			MainView.outputText( 'You feel a sudden, hot liquid sensation in between your buttocks, and you squeak in shock - it\'s almost like somebody has tipped hot lava onto your backside.  When you look over your shoulder, though, your limited span of vision confirms what the sensation of something large with a rounded, narrow tip pressing against your pucker suggests; there\'s nothing there but Izma\'s huge, pre-cum dripping cock.\n\n', false );
		}
		//Male/Unsexed loss:;
		if( CoC.player.gender <= 1 ) {
			//[(If player has tight butthole:);
			if( CoC.player.analCapacity() < 26 ) {
				MainView.outputText( 'You can\'t help but yell in pain at the sudden sensation of something so huge forcing its way into your ' + Descriptors.assholeDescript() + '.', false );
				...
				//(If Izmafight <= -4);
				if( CoC.flags[ kFLAGS.IZMA_TIMES_FOUGHT_AND_WON ] <= -4 ) {
					MainView.outputText( '  You find yourself pushing back to speed up the process, desperate for Izma to fill you again.', false );
				}
			...
			//(If player has middling anus:) ;
				...
				MainView.outputText( 'You can feel every inch of her cock as it sinks steadily into your anus, swelling into your guts as inexorably as the flood tide.\n\n', false );
				MainView.outputText( '"<i>Ahhhh... now that\'s a nice little hole!  Did you lose on purpose?</i>" she asks, and you can hear the grin in her voice.', false );
				//(If the player has lost 4+ times)  ;
				if( CoC.flags[ kFLAGS.IZMA_TIMES_FOUGHT_AND_WON ] <= -4 ) {
					MainView.outputText( '  You find yourself wondering that as well...', false );
				}
				CoC.player.buttChange( CoC.monster.cockArea( 0 ), true, true, false );
			}
			//(If player has a loosey goosey:);
			else {
				MainView.outputText( 'Izma\'s cock may be fairly impressive, but you\'ve taken bigger in your time, and it shows; Izma\'s first experimental thrust sees her sink up to the hilt into your bowels, and you moan with the pleasure of being filled again even as her four balls slap against your ' + Descriptors.buttDescript() + '.\n\n', false );
				MainView.outputText( '"<i>The heck!?  What kind of monsters have you been running into?</i>" she wonders aloud.', false );
			}
		...
		//Female Loss:;
			...
			//(If player has ordinary, everyday cunt:);
				...
				MainView.outputText( 'You can feel every inch of her cock as it sinks steadily into your ' + Descriptors.vaginaDescript( 0 ) + ', filling your moist folds as inexorably as the rising tide.\n\n', false );
				MainView.outputText( '"<i>Ahhhh~  Now that\'s a nice little hole!  Did you lose on purpose?</i>" she asks, and you can hear the grin in her voice.', false );
				//(If the player has lost 4+ times)  ;
				if( CoC.flags[ kFLAGS.IZMA_TIMES_FOUGHT_AND_WON ] <= -4 ) {
					MainView.outputText( '  You find yourself wondering that as well...', false );
			...
			//(If player is loose:);
				...
				MainView.outputText( 'Izma\'s cock may be fairly impressive, but you\'ve taken bigger in your time, and it shows; Izma\'s first experimental thrust sees her sink up to the hilt into your crotch, and you moan with the pleasure of being filled again even as her four balls slap against your taint.\n\n', false );
				MainView.outputText( '"<i>The heck!?  What kind of monsters have you been running into?</i>" she wonders aloud.', false );
			}
			...
			MainView.outputText( 'You groan as well, your own orgasm coating the sands beneath you with girly fluids as Izma\'s cum boils into your womb.  Hot and slick, it surges and flows into you, pumping and pumping into your depths. Your belly grows as the great wave of tigershark cum reaches your stomach and fills it to the brim, and then it begins to stretch further.  Your limbs fail you and you fall face-first onto the sand in your pleasure, too consumed by sensation to even notice your stomach puffing out firm and hard against the earth.\n\n', false );
			MainView.outputText( 'Finally, Izma stops, panting hard for breath as her cock softens and is pulled free from your ravaged cunt, a steady trickle of hot cum pouring out in its wake.  As she recovers, so too do you, rolling over so that you can see her, your midriff swollen into a small but undeniable gut from all the cum she has poured into you.  She looks at you, undeniably pleased by what she sees.\n\n', false );
			MainView.outputText( '"<i>That\'s how shark people have sex,</i>" she tells you.  "<i>Of course, it\'s different if you\'re the one who won... but you\'ll need to come back again and beat me if you want to see what that\'s like.</i>"  She leans down and gives you a small peck on the lips, then drops the tigershark tooth beside you.' );
			if( CoC.player.pregnancyIncubation === 0 || CoC.player.pregnancyIncubation > 180 ) {
				MainView.outputText( '  From her oak chest she fetches an odd leaf, which she pushes past your lips.  "<i>Birth control herbs.  No way I\'m giving kids to someone who\'s not my mate,</i>" Izma says, making sure you swallow the plant before diving into the water, most likely to clean herself off.\n\n', false );
			}

			MainView.outputText( 'You remain where you are, waiting for the strength to flow into your limbs and for some of the abundance of sexual fluids to vacate your ' + Descriptors.vaginaDescript( 0 ) + ' before you dress yourself and leave.  You had no idea that Izma could take charge in such a fierce manner... but, at the same time, you find yourself actually liking it.  A part of you wonders if you could see her that way again...', false );
			//(Izmafight minus 1);
			CoC.flags[ kFLAGS.IZMA_TIMES_FOUGHT_AND_WON ]--;
		}
		//Loss Scene- Herm ;
			...
			//(If player is raised to 100 Lust:) ;
				...
				MainView.outputText( 'Your legs buckle, and your mind fogs with arousal; you are too turned on to continue fighting and collapse bonelessly into an aroused heap.\n\n', false );
				MainView.outputText( 'Izma shakes her head, grinning wryly.  "<i>Looks like somebody needs to get more discipline before they try a sex-off.</i>"\n\n', false );
			}
			MainView.outputText( 'As you collapse in defeat, you\'re aware of the pretty tigershark stalking around you and removing her clothing.  She grabs hard on your ' + CoC.player.armorName + ' and undresses you with minimal effort, revealing your ', false );
			if( CoC.player.lust < 40 ) {
				MainView.outputText( 'limp cock and barely-engorged cunt', false );
			} else if( CoC.player.lust < 70 ) {
				MainView.outputText( 'turgid erection and moist cunt', false );
			} else {
				MainView.outputText( 'throbbing erection and slavering cunt.', false );
			}
			MainView.outputText( '\n\n', false );
			MainView.outputText( '"<i>Dirty little minx, ain\'t ya?  You wanted this, didn\'t you...</i>" Izma teases, shoving two fingers into your moist nether-lips, to test the waters.  The peneration of your needy cunt does serve to make you whimper softly, almost begging to just be filled.  ', false );
			//(Tight/Virgin vagina);
			if( CoC.player.vaginalCapacity() < 26 ) {
				MainView.outputText( '"<i>My oh my, quite a tight little slit you got back here. Not for long...</i>" Izma says, her fingers roaming around within your cunt.', false );
			}
			//(If player has ordinary, everyday cunt:);
			else if( CoC.player.vaginalCapacity() < 60 ) {
				MainView.outputText( 'Izma giggles slightly from just how easy it is to move around your moist folds.  "<i>Well, this\'ll make things slightly easier for you I suppose.</i>"', false );
			} else {
				MainView.outputText( 'Izma\'s eyes widen as her entire hand seems to slip into your cavernous vagina. "<i>Holy shit... what\'s been up here?</i>" she mumbles, laughing nervously in amazement.', false );
			}
			MainView.outputText( '\n\n', false );
			MainView.outputText( 'Pulling her fingers free, Izma quickly flips your nude body over, leaving you on your back and staring up at her.  Izma\'s hands are resting on her hips and she seems to be puffing her large chest out proudly. Her foot-long cock is fully erect, hot beads of pre-cum occasionally dripping onto the sands.  She takes the time to examine your own cock, grinning with her fangs bared.  "<i>Let\'s see what you\'ve got, weakling.</i>"  ', false );
			var x = CoC.player.biggestCockIndex();
			//(1-10 inch penis);
			if( CoC.player.cocks[ x ].cockLength <= 10 ) {
				MainView.outputText( 'Izma manages to supress a snort of laughter at the sight of your cock.  "<i>Um... wow?  It\'s simply... heh, huge...</i>"', false );
			}
			//(10-19 inches);
			else if( CoC.player.cocks[ x ].cockLength <= 19 ) {
				MainView.outputText( '"<i>Not bad, I\'m actually impressed,</i>" Izma says, nodding slightly in approval.', false );
			}
			//(20+ inches);
			else {
				MainView.outputText( 'Izma gives a low whistle at the sight of your ' + Descriptors.cockDescript( x ) + '.  "<i>Now THAT\'S a cock.  Looks like you\'ve got a third leg down there!</i>"', false );
			}

			MainView.outputText( '\n\nSeemingly done appraising you, Izma roughly grabs your ' + CoC.player.feet() + ' and pulls your rear upwards, forcing your weight onto your spine and making you cry out from the uncomfortable position.  She doesn\'t waste time on foreplay, simply deciding to bury her cock into you slowly, inch by painstaking inch until she\'s pushing against the entrance to your womb.', false );
			CoC.player.cuntChange( CoC.monster.cockArea( 0 ), true, true, false );
			MainView.outputText( '\n\n', false );
			MainView.outputText( 'She starts thrusting in and out of you, gradually increasing the speed and force, her hot pre-cum and your feminine juices acting like a lubricant to make things easier.  "<i>Ahh~  You\'re a lovely cock-sleeve... you like being treated like this, don\'t ya, weakling?</i>" Izma taunts, slamming in and out of your ' + Descriptors.vaginaDescript( 0 ) + '.', false );
			//(If Izmafight <= -4) ;
			if( CoC.flags[ kFLAGS.IZMA_TIMES_FOUGHT_AND_WON ] <= -4 ) {
				MainView.outputText( '  You\'re not even really ashamed to admit that such is the case anymore.', false );
			}
			MainView.outputText( '\n\n', false );
			MainView.outputText( 'Every thrust pushes you deeper into the sands, and eventually you find yourself pumping your hips upward against Izma\'s own, eager to pleasure her and yourself.  Izma seems to notice this and laughs loudly.  "<i>Oh?  You really like being dominated?  Ha, I thought as much.</i>"  She continues to taunt you as she pounds into you, her balls smacking against you every time.  Your mind is too clouded with lust to hear even half of what she says.  Right now all you care about is getting off.\n\n', false );
			MainView.outputText( 'Within minutes, Izma gives one final, powerful thrust and roars loudly, cum pumping into your womb and spraying out onto the sands.  ' + Descriptors.SMultiCockDesc() + ' twitches and pulses, ready to blow.  Izma quickly takes hold and points ', false );
			if( CoC.player.cockTotal() === 1 ) {
				MainView.outputText( 'it', false );
			} else {
				MainView.outputText( 'them', false );
			}
			MainView.outputText( ' toward your face, stroking you to your own climax.  Jets of your own cum splatter across your face and body as you writhe, protesting. "<i>Tch, you really thought I\'d let you cum on ME?  Maybe if you actually managed to beat me I\'d give you the honor,</i>" Izma says, pulling free with a loud *SCHLICK* sound.  She releases your ' + CoC.player.feet() + ', allowing your ' + Descriptors.buttDescript() + ' to hit the sand with a plop, and gets to work redressing while you lie still.' );
			if( CoC.player.pregnancyIncubation === 0 || CoC.player.pregnancyIncubation > 150 ) {
				MainView.outputText( '  Moving over to her oak chest, she returns with a strange leaf in her hands, which she pushes past your lips.\n\n', false );
				MainView.outputText( '"<i>Anti-this.pregnancy herb.  Can\'t have someone bearing my litter if they\'re not my mate, can I?</i>"  Izma explains, moving over to the shoreline.  ' );
			} else {
				MainView.outputText( '\n\n' );
			}
			MainView.outputText( 'She gives you a wink and tosses the promised tooth at your feet before diving into the water, presumably to clean herself off.  Several minutes later, you wash up as well and stagger back to camp, sore from the ordeal.  Izma sure can be rough when she wants.  A part of you wonders if you could see her that way again...', false );
			//(Izmafight minus 1;
			CoC.flags[ kFLAGS.IZMA_TIMES_FOUGHT_AND_WON ]--;
		}
		CoC.player.orgasm();
		...
		//zmafight -1: ;
		if( CoC.flags[ kFLAGS.IZMA_TIMES_FOUGHT_AND_WON ] >= -1 ) {
			MainView.outputText( '  You realize what you\'re thinking and shudder, forcing the submission-tinged desires down. Where did they come from, anyway?', false );
		}
		//Izmafight -2: ;
		else if( CoC.flags[ kFLAGS.IZMA_TIMES_FOUGHT_AND_WON ] >= -2 ) {
			MainView.outputText( '  Though you manage to force them away, the dreams of submitting to Izma are starting to haunt you, their power and seductive allure growing. But, still, you can control them.', false );
		}
		//Izmafight -3: ;
		else if( CoC.flags[ kFLAGS.IZMA_TIMES_FOUGHT_AND_WON ] >= -3 ) {
			MainView.outputText( '  You hum idly to yourself and enjoy the mental visions for a while, then, with some reluctance, you push them aside. Still, you\'re sure you can bring them out again when you want to enjoy them.', false );
		}
		//Izmafight -4: ;
		else if( CoC.flags[ kFLAGS.IZMA_TIMES_FOUGHT_AND_WON ] >= -4 ) {
			MainView.outputText( '  You have only the vaguest thought that maybe you shouldn\'t be thinking about Izma in that way, but it\'s so tempting to just immerse yourself in the sexiness of having a hot herm shark-girl dominate you so thoroughly. After all, it\'s not as if there\'s any harm in doing so, is there?', false );
		}
		//Izmafight -5: ;
		else {
			MainView.outputText( '  You embrace the dreams fully, desperate to cling to them as long as you can. It\'s getting so hard to care about your former mission anymore; why fight the demons when you can just give it up and surrender yourself to Izma? Yes... such a strong, powerful, worthy alpha she is; Izma is all you need. Let her take control of your life, why don\'t you?', false );
		}
	...
	IzmaScene.prototype.finalIzmaSubmission = function() {
		MainView.outputText( '', true );
		MainView.outputText( 'You collapse onto your hands and knees, defeated by Izma once again.  You feel you may not have fought as hard as you could have though, out of a deep-rooted desire for Izma to dominate you again.\n\n', false );
		MainView.outputText( 'Izma sniggers as she advances on you, happy to oblige your desire, casually undoing your ' + CoC.player.armorName + ' after scattering her own clothing to the rocks.  "<i>Aw, was that all? Honestly...</i>" she mocks, walking behind you, "<i>you\'re quite the little bitch, aren\'t ya?  You just love submitting to Izma, don\'tcha?</i>"  You whimper slightly and nod your head in response.  As Izma leans into your back, her rock-hard nipples and cock press into your ', false );
		if( !CoC.player.isTaur() ) {
			MainView.outputText( 'spine', false );
		} else {
			MainView.outputText( 'flank', false );
		}
		MainView.outputText( '.\n\n', false );
		MainView.outputText( 'Some of Izma\'s hot pre-cum dribbles out onto your back and runs down to your ' + Descriptors.assDescript() + '.  It causes your eyes to roll back in your head; you can only imagine the taste of her salty pre running down your throat.  Izma snickers, aware of her hold over you, before tightening her grip.', false );
		if( CoC.player.hasCock() || CoC.player.hasVagina() ) {
			MainView.outputText( '  The tight embrace makes ', false );
			if( CoC.player.hasCock() ) {
				MainView.outputText( Descriptors.sMultiCockDesc() + ' stiffen', false );
				if( CoC.player.hasVagina() ) {
					MainView.outputText( ' and ', false );
				}
			}
			if( CoC.player.hasVagina() ) {
				MainView.outputText( 'your ' + Descriptors.vaginaDescript( 0 ) + ' moisten considerably', false );
			}
		}
		MainView.outputText( '.\n\n', false );
		MainView.outputText( '"<i>Beg,</i>" she orders, licking your neck and collarbone, giving off a few growls and purrs as she goes.  "<i>Wh-what?</i>" you manage to reply, lost in your anticipation.  "<i>You heard me,</i>" she replies sternly, grinding her throbbing cock, now erect and well over sixteen inches, against your back.  It seems like giving free rein to her dominating instincts is making her harder than you\'ve ever felt.  You moan loudly from the sensation.  "<i>Please fuck me!  Please, Izma, mistress, I need your cock!</i>" you cry, not caring if anything is nearby to hear you.  Izma chuckles in response before pulling you in and roughly kissing you, her long tongue curling around your own.  She continues to tongue-fuck you until you nearly run out of breath, and you feel like Izma could make you orgasm from this alone.\n\n', false );
		MainView.outputText( 'She keeps you held in place as she positions the tip of her cock against your ' + Descriptors.assholeDescript() + '.  With no warning, she forces her meat-pole into you, making you squeal in delight from the familiar heat of her cock.  ', false );
		CoC.player.buttChange( CoC.monster.cockArea( 0 ), true, false, true );
		MainView.outputText( 'She keeps forcing her way in your backdoor, inch after inch, and you only feel weaker against Izma the further in she goes.  Eventually she manages to bury her entire dick into your pucker, sighing in delight as her meaty quads press against your ' + Descriptors.buttDescript() + '.\n\n', false );
		MainView.outputText( 'She pulls back out, and for a moment you feel a bit of trepidation at the absence of her cock, before crying out as she again goes balls-deep into your backside.  She continues to thrust and grind into you, giving a few animalistic snarls of pleasure.  You manage to glance back, only to notice how completely the bookworm has turned into some sort of proud wild woman.  It suits her; she\'s proven that she\'s so much stronger than you, after all.  So strong, so in control, so powerful... it feels right to be like this, underneath Izma as she asserts her position over you.\n\n', false );
	...
	IzmaScene.prototype.victoryPenisIzma = function() {
		MainView.outputText( '', true );
		var cockIndex = CoC.player.cockThatFits( CoC.monster.vaginalCapacity() );
		if( cockIndex < 0 ) {
			cockIndex = 0;
		}
		MainView.outputText( 'You watch the defeated tigershark closely and a grin forms on your face.  You touch a hand to her forehead and push her onto her back with minimal effort, slipping her clothing off.  She hardly lacks the strength to stop you, but she knows full well what the terms of the battle were, so she\'s not going to go back on her word.  You remove your ' + CoC.player.armorName + ' and spread Izma\'s legs wide, ' + Descriptors.sMultiCockDesc() + ' almost painfully erect as you lift her quartet of balls up to look at her glistening womanhood.\n\n', false );
		MainView.outputText( 'Not wanting to waste any time on foreplay, you push your ' + Descriptors.cockDescript( cockIndex ) + ' into Izma\'s slit as far as you can manage, making Izma gasp sharply and writhe against you.  You snicker and start thrusting into her, the odd little tendrils inside her cunt teasing and massaging your cock.  The walls themselves are so tight and smooth that her pussy conforms to you like a glove.  It almost feels like Izma\'s snatch was made just for you.', false );
		//[(If Izmafight = 3+);
		if( CoC.flags[ kFLAGS.IZMA_TIMES_FOUGHT_AND_WON ] >= 3 ) {
			MainView.outputText( '  Hell, maybe it was made for you, given just how eager Izma seems to be whenever she sees you.  It\'s like she loses to you on purpose.', false );
		}
		MainView.outputText( '\n\n', false );
		MainView.outputText( 'You start to pick up speed as you mash your hips against Izma\'s own, earning moans from the pretty tigershark which only seem to get louder with every subsequent thrust.  Izma quickly starts to return the gesture, moving her hips up to meet your own thrusts every time.  It\'s while she\'s doing this that you notice her throbbingly erect cock wobbling around.\n\n', false );
		MainView.outputText( 'Deciding that it\'d be rude not to, and because you want to see just how loud you can make Izma moan, you grab hold of her raging erection and start jerking her off while you pound into her.  The move seems to surprise Izma, and she starts moaning and screaming in pleasure.  The double stimulation you\'re pulling off pushes Izma past her limit very quickly, and she starts shooting thick jets of spunk into the air, which begin to rain down on her face and breasts.  Her vaginal walls clamp down on your ' + Appearance.cockNoun( CoC.player.cocks[ cockIndex ].cockType ) + ' almost painfully as the orgasm wracks her female genitalia too.\n\n', false );
		MainView.outputText( 'Izma starts panting and gasping for breath after the intense release, but immediately starts groaning when she realizes you are not done.  You giggle and release her softening erection, placing both hands on her thighs as you start to redouble your efforts at fucking her.  You push Izma deeper and deeper into the sands with each thrust, and despite her exhaustion Izma gives a few soft pleasured moans.\n\n', false );
		//[(Male);
		if( CoC.player.gender === 1 ) {
			MainView.outputText( 'After a lengthy fuck, you grunt loudly as your ' + Descriptors.cockDescript( cockIndex ) + ' swells, blasting streamers of jizz into Izma\'s womb', false );
			//[(multi) ;
			if( CoC.player.cockTotal() > 1 ) {
				MainView.outputText( ' and onto her groin', false );
			}
			MainView.outputText( ', causing Izma to cry out loudly.', false );
			//[(big skeet);
			if( CoC.player.cumQ() >= 500 ) {
				MainView.outputText( '  Her belly swells as you empty your impressive load into her', false );
				if( CoC.player.cumQ() >= 1500 ) {
					MainView.outputText( '.  Eventually it can swell no more and each new squirt forces cum out from her stuffed pussy, trickling past her asshole', false );
				}
				MainView.outputText( '.', false );
			}
			MainView.outputText( '  You sigh happily and push back from her, weakly getting back on your ' + CoC.player.feet() + ' and redressing. Izma scrambles to her chest and takes out some sort of leaf, then eats it.\n\n', false );
		}
		//(Herm);
		else {
			MainView.outputText( 'After a lengthy fuck, you grunt loudly as your ' + Descriptors.cockDescript( cockIndex ) + ' swells, blasting streamers of jizz into Izma\'s womb', false );
			...
			MainView.outputText( '  You sigh happily and push back from her, weakly getting to your ' + CoC.player.feet() + '.  You\'re not done yet though, not fully.\n\n', false );
			MainView.outputText( 'Izma gasps again as you plant your ' + Descriptors.vaginaDescript( 0 ) + ' onto her face, grinding against the angular features and moaning loudly as her obliging tongue darts past your lips.  You could really get used to this feeling.  You ride her face for another few minutes before an orgasm rocks your female parts, splattering girlcum onto Izma\'s face.  You sigh happily and weakly get to your feet, redressing.  You see Izma fishing something from her storage chest - a plant of some sort - and munching it down.\n\n', false );
		}
		CoC.player.orgasm();
		//[(if Izmafight <=4);
	...
	IzmaScene.prototype.useVagooOnIzmaWin = function() {
		MainView.outputText( '', true );
		MainView.outputText( 'You watch the defeated tigershark closely and a grin forms on your face.  You touch a hand to her forehead and push her onto her back with minimal effort, slipping her clothing off.  She lacks the strength to stop you, but she knows full well what the terms of the battle were, so she\'s not going to go back on her word.  You strip off your ' + CoC.player.armorName + ' and spread Izma\'s legs wide, licking your lips at the sight of her throbbing erection and meaty quads.  You give Izma\'s massive cock a few test strokes, earning some pleasured groans from the tiger shark.\n\n', false );
		MainView.outputText( 'Deciding you\'ve had enough foreplay, you mount her and slide down her cock.', false );
		CoC.player.cuntChange( CoC.monster.cockArea( 0 ), true, true, false );
		MainView.outputText( '  You start grinding and gyrating atop her, ', false );
		//[(taur);
		if( CoC.player.isTaur() ) {
			MainView.outputText( 'your weight pinning her to the sand and preventing her from taking control.', false );
		}//(non-taur and height > 4') ;
		else if( CoC.player.tallness > 48 ) {
			MainView.outputText( 'and pin her hands above her head to stop her from trying to change the position. Her heaving breasts rub against your ' + Descriptors.allBreastsDescript() + ' as you ride her in this posture.  She needs to know who\'s in charge here, after all.', false );
		}
		//(non-taur and height <= 4');
		else {
			MainView.outputText( 'but small as you are, you can\'t stop her as she reaches up and grabs onto your ' + Descriptors.buttDescript() + ', then begins bouncing you like a goblin cocksleeve.', false );
		}
		MainView.outputText( '\n\n', false );
		MainView.outputText( 'Izma seems to do her best, moving and jerking her cock up as much as she can, earning gasps of pleasure from you.', false );
		//[(no-taur);
		if( !CoC.player.isTaur() ) {
			MainView.outputText( '  To reward your eager partner for her efforts you reach back with one free hand to massage and grope at her testes.  Izma bites her lip and starts growling loudly, pushing her hips up as far as possible, eager to cum for you.  You decide to return the favor, mashing your pussy down with increasing speed.', false );
		}
		MainView.outputText( '\n\n', false );
		MainView.outputText( 'After a few more minutes of vigorous fucking, Izma grunts and roars in an animalistic fashion as she orgasms, jets of hot musky spunk pumping into your depths.  You cry out in pleasure, your inner walls clamping down on her cock and milking every available drop of jizz she has.  After a while you manage to recover and stumble onto your feet.  "<i>Hey, wait a sec,</i>" Izma says weakly as you start to leave.  She goes to her storage chest and retrieves a crumpled leaf, then holds it out to you with a smile.  "<i>Here, take this.  It\'s an anti-this.pregnancy herb.</i>" Do you take it?', false );
		CoC.player.slimeFeed();
		CoC.player.orgasm();
		//[yes/no];
		EngineCore.doYesNo( this, this.eatIzmasLeafAfterRapinHer, this, this.dontEatIzamsLeafAfterRape );
	};
	//[Yes];
	IzmaScene.prototype.eatIzmasLeafAfterRapinHer = function() {
		MainView.outputText( '', true );
		MainView.outputText( 'You accept the leaf gingerly and eat it.  Izma smiles.', false );
		//Set loot;
		CoC.flags[ kFLAGS.BONUS_ITEM_AFTER_COMBAT_ID ] = ConsumableLib.TSTOOTH.id;
		//[(if Izmafight <=4) ;
		if( CoC.flags[ kFLAGS.IZMA_TIMES_FOUGHT_AND_WON ] <= 4 || CoC.flags[ kFLAGS.UNKNOWN_FLAG_NUMBER_00235 ] > 0 ) {
	...
	IzmaScene.prototype.dontEatIzamsLeafAfterRape = function() {
		MainView.outputText( '', true );
		MainView.outputText( 'You rankle at the offered herb and give her a haughty glare.  "<i>You\'re going to tell ME what to do? Me, your proven superior?</i>"\n\n', false );
	...
	IzmaScene.prototype.takeItInZeButtVictoryLikeFromIzma = function() {
		MainView.outputText( '', true );
		CoC.player.slimeFeed();
		MainView.outputText( 'You smirk as Izma slumps down, unable to fight against you anymore.\n\n', false );
		MainView.outputText( 'You push her onto her back and see her inhuman dong flop free from her skirt.  Seems the combat turned the little shark on.  Well, \'little\' is hardly the right word to describe any aspect of her, especially when she has a 15-inch rock-hard erection waving over her.  It actually brings a dopey grin to your face.  Well, you earned a reward, so you might as well take it.\n\n', false );
		MainView.outputText( 'You lean down and start licking and suckling the tip of her monster dick, slurping up her hot pre and lubricating the tip of her raging boner.  She moans and jerks at your touch, writhing around and loving the sensation of submissiveness.  The feeling of having her under your power manages to bring a smile to your own face.\n\n', false );
		MainView.outputText( 'Gradually you start to suck more and more of her cock, inch after inch moving down your throat.  You gag lightly as you finally reach the base of her cock, before pulling it out.  She whines weakly and looks at you pitifully, wondering why you\'re teasing her.  You remove your ' + CoC.player.armorName + ' before turning to show her your ' + Descriptors.buttDescript() + ', and a small smile spreads over her angular face as she realizes what you have planned.  You plant your hands on your backside and pull your cheeks wide, before starting to slide onto her well-lubed pecker.\n\n', false );
		MainView.outputText( 'She grunts and huffs as you slide down, and you too feel a strain from her iron-hard dick despite the various fluids lubricating it.  But gradually pain turns to pleasure and you\'re both moaning loudly and calling each other\'s names as you ride her.', false );
		CoC.player.buttChange( CoC.monster.cockArea( 0 ), true, true, false );
		MainView.outputText( '\n\n', false );
		MainView.outputText( 'The shark grits her teeth and gives a roar as she cums, blowing a massive, hot load straight up your ' + Descriptors.assholeDescript() + ', bloating you slightly as she empties her quads inside you.  Your muscles twitch and contract, and you can swear you see stars as she ejaculates.  It takes you a while to catch your breath as you slide off her slowly softening meat pole and crawl onto the sand.\n\n', false );
		CoC.player.orgasm();
		//[(if Izmafight <=4);
		if( CoC.flags[ kFLAGS.IZMA_TIMES_FOUGHT_AND_WON ] <= 4 || CoC.flags[ kFLAGS.UNKNOWN_FLAG_NUMBER_00235 ] > 0 ) {
			MainView.outputText( 'You say your goodbyes to the pretty tigershark and leave once she hands you your tooth-shaped reward.', false );
	...
	IzmaScene.prototype.victorzChoice = function() {
		MainView.outputText( 'Izma looks at you, panting from the sex.  "<i>S-so... that was good... want your reward now?</i>" she asks, holding the tigershark tooth out to you.  You stare at it, thinking.  Do you want another one of those, or do you want something else?', false );
		//[Tooth][Gloves];
		EngineCore.choices( 'Tooth', this, this.chooseIzmaTooth, 'Gloves', this, this.chooseIzmaGloves, '', null, null, '', null, null, '', null, null );
	};
	//[Tooth];
	...
	IzmaScene.prototype.chooseIzmaGloves = function() {
		MainView.outputText( '', true );
		MainView.outputText( 'You look her dead in the eye and say, in a flat monotone, "<i>I want your gloves.</i>"\n\n', false );
		MainView.outputText( '"<i>W-what?</i>" she asks, dazed.  You point at the hooked gauntlets, currently laying discarded on the beach after the sex.  "<i>But that\'s my weapon!  I need it to-</i>"\n\n', false );
		MainView.outputText( 'You cut her off with an airy wave of your hand.  "<i>S\'cuse me, but who\'s the boss here?  Pick up those gloves and give them to me graciously, little girl.</i>"  She should be taking it as a compliment that someone above her would deign to use her weapon, a thought which you manage to convey to her by means of your no-nonsense stare.\n\n', false );
		MainView.outputText( 'Meekly, she picks up the gloves and hands them to you.', false );
	...
	IzmaScene.prototype.chooseYourIzmaWeapon = function() {
		if( CoC.player.gender === 0 ) {
			...
			MainView.outputText( 'Which of your genitals will you focus on?', true );
			EngineCore.choices( 'Male', this, this.nonFightIzmaSmexPAINUS, 'Female', this, this.nonFightIzmaSmexCUNTPUSSYSNATCHQUIM, '', null, null, '', null, null, '', null, null );
		}
	};
	...
	IzmaScene.prototype.nonFightIzmaSmexPAINUS = function() {
		...
		//Single Normal dicks;
		if( CoC.player.cockTotal() === 1 && CoC.player.cocks[ 0 ].cockType.Index < 9 ) {
			//[Human dick in slot 0];
			if( CoC.player.cocks[ 0 ].cockType === CockTypesEnum.HUMAN ) {
				MainView.outputText( 'Izma seems surprised to see your genitalia is similar to hers.  "<i>Huh. Thought that every land-dweller usually bumbled into a dick transformation around here.</i>"', false );
			}
			//[Horse cock in slot 0] ;
			else if( CoC.player.cocks[ 0 ].cockType === CockTypesEnum.HORSE ) {
				MainView.outputText( 'Seeing your ' + Descriptors.cockDescript( 0 ) + ' causes Izma to lick her lips slowly. "<i>Well... Equinum is pretty popular, isn\'t it?</i>"', false );
			}
			//[Dog cock];
			else if( CoC.player.hasKnot( 0 ) ) {
				MainView.outputText( 'Izma stares intently at your ' + Descriptors.cockDescript( 0 ) + ', as if trying to make up her mind about it. "<i>Well, it is a rather cute look. Just be careful with the knot, will ya?</i>"', false );
			}//[Tentacle] ;
			else if( CoC.player.cocks[ 0 ].cockType === CockTypesEnum.TENTACLE ) {
				MainView.outputText( 'A puzzled look plays across Izma\'s face as she stares at your ' + Descriptors.cockDescript( 0 ) + '.  "<i>Wow... I\'ve read a lot about the corrupt plants.  Didn\'t think people could wind up like that.</i>"', false );
			}
			//[Demon Dick] ;
			else if( CoC.player.cocks[ 0 ].cockType === CockTypesEnum.DEMON ) {
				MainView.outputText( 'Izma looks shocked as she lays eyes on your perverted pecker, having never seen anything quite like it before. "<i>Um... that looks... awkward. Like having a truncheon between your legs.</i>"', false );
			}
			//[cat dork] ;
			else if( CoC.player.cocks[ 0 ].cockType === CockTypesEnum.CAT ) {
				MainView.outputText( 'She glances at your barbed pecker and winces.  "<i>You ate the fruit around here, didn\'t you?  One of my friends did that, too.</i>"', false );
			}
			//[lizardick];
			else if( CoC.player.cocks[ 0 ].cockType === CockTypesEnum.LIZARD ) {
				MainView.outputText( 'Her eyes goggle as you reveal a bulbous purple pecker.  "<i>Oh wow.  Do you have a green one too?</i>"', false );
			}
			//[Captain Nemo] ;
			else if( CoC.player.cocks[ 0 ].cockType === CockTypesEnum.ANEMONE ) {
				MainView.outputText( 'She grimaces as you unveil a ' + Descriptors.cockDescript( 0 ) + '.  "<i>God, not one of those.  You wind up hornier after cumming than you were before you started touching it.</i>"', false );
			}
			//[Kangaroo Jack] ;
			else if( CoC.player.cocks[ 0 ].cockType === CockTypesEnum.KANGAROO ) {
				MainView.outputText( 'She looks on blankly as you reveal your sheath, then gives a start as your ' + Descriptors.cockDescript( 0 ) + ' slides out of it after a few strokes.  "<i>Woah... it\'s so... thin and pointy.</i>"', false );
			}
		}
		//Multi or weird new shit.;
		else {
			MainView.outputText( 'Her eyes bug out as you reveal ' + Descriptors.sMultiCockDesc() + '.  "<i>Woah, jeez, look at that one... oh man, and that one\'s... daaamn.</i>"', false );
		}
		MainView.outputText( '\n\n', false );
		//[If the player is masculine but has B-cups or larger];
		if( CoC.player.mf( 'm', 'f' ) === 'm' && CoC.player.biggestTitSize() >= 2 ) {
			MainView.outputText( 'The fact that you have breasts seems to confuse Izma quite a bit as well, causing her to tilt her head.  "<i>You\'re a guy... with boobs.  Did you honestly think they were necessary, or did you just want something to play with?</i>"', false );
			//[If player is lactating] ;
			if( CoC.player.biggestLactation() >= 2 ) {
				MainView.outputText( '  Catching sight of some milk oozing from your nipples makes Izma step back slightly.  "<i>You\'re lactating too?!  Man, there are way too many things that are weird about this...</i>"  Still, you doubt Izma is as turned off as she acts, what with the raging erection between her legs.', false );
			}
			MainView.outputText( '\n\n', false );
		}
		MainView.outputText( 'Once you\'re done appraising each other, you ask Izma just how she wants to do this.  Izma scratches the back of her neck in thought, before bringing up an idea.  "<i>What if you lie on your back, and I blow you while you blow me?</i>"  You\'re a little uncomfortable with the prospect, causing Izma to fold her arms.  "<i>Fair\'s fair. I\'m not gonna cum with you just staring at it, and we certainly can\'t assfuck each other at the same time.</i>"\n\n', false );
		//[(If tentacle in slot 0);
		if( CoC.player.cocks[ 0 ].cockType === CockTypesEnum.TENTACLE ) {
			MainView.outputText( '"<i>Well, actually...</i>" you begin, flexing your cock-tentacle.  She cuts you off with a glare.  ', false );
		}
		//(other slot 0);
		else {
			MainView.outputText( 'You go to protest further, but stop when she gives you a glare.  ', false );
		}
		MainView.outputText( 'You\'re already too horny to back out now, though.  Sighing in annoyance, you flop back onto the sands and motion at Izma to join you.  Izma nods and smiles, making her way over to you and swinging her hips from side to side as if to tease you further, before positioning her head at your groin and rubbing her own groin against your head.  "<i>Alright, let\'s do this,</i>" Izma says bluntly, wasting no time gorging herself on your ' + Appearance.cockNoun( CoC.player.cocks[ 0 ].cockType ) + ', wrapping her tongue around it and fellating like a pro.  You gasp slightly at the expert treatment, and decide your previous protests were pointless if you\'re gonna get this kind of pleasure from the deal.\n\n', false );
		MainView.outputText( 'You wrap your lips around Izma\'s own massive erection, sucking and gagging on her more-than-footlong cock as she jerks and twists her hips around.  Her muffled moans seem to assure you that you\'re doing a great job, and Izma responds by increasing the speed of her head-bobbing.  Your vision is a little obscured by Izma\'s quartet of balls repeatedly bumping against your forehead and the bridge of your nose, but if anything this serves to arouse you further.\n\n', false );
		MainView.outputText( 'In an effort to further pleasure your tigershark partner, you occasionally reach up to fondle her swollen sack and finger her tight, damp cunt.  Izma gasps sharply and shudders from the pleasure you\'re giving her.  As if to reward you for your efforts, Izma picks up more speed with her sucking, drenching every inch of your ' + Descriptors.cockDescript( 0 ) + ' with her saliva, and as you\'re so eager for her magic tongue you start thrusting your hips up to reach as far into her mouth as you can.\n\n', false );
		MainView.outputText( 'Eventually, the two of you manage to bring each other to a powerful simultaneous orgasm, Izma\'s hot cum shoots down your eager throat, and you yourself fire loads into Izma\'s cheeks', false );
		if( CoC.player.cockTotal() > 1 ) {
			MainView.outputText( ' and hair', false );
		}
		MainView.outputText( '.  ', false );
		//[(big/mega skeet);
		if( CoC.player.cumQ() >= 500 ) {
			MainView.outputText( 'You continue to shoot off stroke after stroke long after her mouth has filled up and she\'s pulled away.  "<i>For the love of Marae, ' + CoC.player.short + ', I can\'t swallow all that!</i>"  ', false );
		}
		MainView.outputText( 'The two of you roll away from each other, and while you catch your breath you\'re surprised at the strong taste of Izma\'s cum.  You don\'t think you\'d mind getting another load of that wonderful spunk in your stomach...\n\n', false );
		MainView.outputText( '"<i>Thanks for that...</i>" Izma whispers, stumbling onto her feet and retrieving her clothing.  "<i>Feel free to come back for some more... or maybe we could do something a little more intense, if you want.</i>" A bashful smile spreads across her face.  It\'s a little hard to tell with her skin color, but you can almost see a blush.  You smile at Izma and nod, before gathering your own gear and setting off for camp, your tongue constantly darting around your mouth in search of any remainders of Izma\'s seed.\n\n', false );
		//(lust -100, gain 1 t-shark toof, Izmacounter+1);
		CoC.player.slimeFeed();
		CoC.flags[ kFLAGS.UNKNOWN_FLAG_NUMBER_00230 ]++;
		CoC.player.orgasm();
		SceneLib.inventory.takeItem( ConsumableLib.TSTOOTH, SceneLib.camp.returnToCampUseOneHour );
	};
	...
	IzmaScene.prototype.nonFightIzmaSmexASS = function() {
		...
		if( CoC.player.inte >= 50 ) {
			MainView.outputText( 'You stop a moment as a realization occurs to you.  "<i>Wouldn\'t you be getting just as much pleasure if I was on top?</i>" you ask.\n\n', false );
			MainView.outputText( 'Izma rolls her eyes.  "<i>I\'ve dominated with my holes before.  You ride \'em hard enough, they don\'t feel as much pleasure.  Now, fuck off.</i>"\n\n', false );
		}
		EngineCore.doNext( SceneLib.camp, SceneLib.camp.returnToCampUseOneHour );
	};
	...
	IzmaScene.prototype.nonFightIzmaSmexCUNTPUSSYSNATCHQUIM = function() {
		...
		MainView.outputText( 'You nod and remove your ' + CoC.player.armorName + ', not doing it with quite as much showmanship as Izma herself.  You expose your ' + Descriptors.allBreastsDescript() + ' to the air; your ' + Descriptors.nippleDescript( 0 ) + 's grow stiff from the breeze.  The bottom half of your clothing comes off, exposing your ' + Descriptors.vaginaDescript( 0 ), false );
		if( CoC.player.hasCock() ) {
			MainView.outputText( ' and ' + Descriptors.multiCockDescriptLight(), false );
		}
		MainView.outputText( ' to the happy tigershark.  "<i>Not bad, if you don\'t mind me saying so,</i>" Izma remarks, moving toward you and placing a hand on your shoulder.  "<i>Okay, so here\'s how we\'re gonna do this...</i>" she begins, her hot erection poking you eagerly in the crotch.  "<i>We won\'t be mating in the conventional sense, just working to get each other off, with our mouths,</i>" she explains, showing you that her fangs are retracted just to reassure you.\n\n', false );
		MainView.outputText( 'You nod in agreement and watch Izma move onto the sands, before positioning your crotch over her face and putting your mouth just over her stiff cock.  Izma wastes no time, moving her face up and burying it into your cunt, her tongue probing your depths.  The sudden intrusion makes you gasp loudly, but \'fair\'s fair\' as Izma says, and you respond by taking the head of her cock into your mouth.\n\n', false );
		MainView.outputText( 'You get to work licking and sucking the tip, strands of saliva linking your mouth to the hot organ every time you come up for air.  Izma doubles her licking speed and clamps her hands on your ' + Descriptors.buttDescript() + ', earning a gasp from you.  It seems Izma wants to up the ante a little.\n\n', false );
		MainView.outputText( 'You decide to oblige her and start deepthroating her cock, all 15 inches sliding down your throat and stretching it out, earning some muffled moans from Izma.  You also start to rub and massage her meaty quad of balls, almost begging for her cum.  If the flavor of her salty pre from earlier was any indication, you\'re in for quite a taste when Izma finally blows her load.  Izma decides to match your efforts, rubbing and pinching at your clit with skilled hands.  Izma\'s no stranger to female lovers it would seem, but that\'s not surprising given what the normal shark girls are like.\n\n', false );
		MainView.outputText( 'Izma gives a muffled groan of pleasure, her cum blasting down your throat and filling your cheeks as you pull your mouth up.  It\'s not too long after that when you cry out in orgasm, your girlcum spattering onto the tigershark\'s face', false );
		if( CoC.player.hasCock() ) {
			MainView.outputText( ' and ' + Descriptors.sMultiCockDesc() + ' shooting a weak load across her chest', false );
		}
		MainView.outputText( '.  You roll off her and try to catch your breath, swallowing residual cum.  The taste is incredible, you have to admit... it\'s hard to define just what it is that makes it so good.  Something in the water Izma swims in?\n\n', false );
		CoC.player.slimeFeed();
	...
	IzmaScene.prototype.IzmaStayAtTheLakeBitch = function() {
		...
		MainView.outputText( 'You give her a small kiss on the lips and then leave for camp.', false );
	...
	IzmaScene.prototype.acceptIzmaAsYourBitch = function() {
		...
		if( CoC.flags[ kFLAGS.UNKNOWN_FLAG_NUMBER_00236 ] === 0 && CoC.flags[ kFLAGS.AMILY_FOLLOWER ] === 1 ) {
			...
			MainView.outputText( 'You can\'t help but laugh at how eager she is to live with you as you guide her to your camp, and she never seems to shut up talking about how fun it\'ll be and how much the two of you will be able to fuck.  However, she stops talking entirely and tilts her head to the side as she spots Amily scurrying around your camp.\n\n', false );
			MainView.outputText( 'The mouse-morph is currently eating something from your supplies when you arrive, and guiltily spins around and hides it behind her back when she realizes you\'ve returned.  "<i>Ah, ' + CoC.player.short + ', I\'m glad to see you back!</i>" she squeaks hurriedly; she\'s sincere, but obviously also a little embarrassed. Then she realizes you\'re not alone.  "<i>Ah... you do know you have a shark-girl of some sort following you, don\'t you?</i>"  She looks wary; ready to fight or flee if the situation warrants.\n\n', false );
			MainView.outputText( 'Izma tilts her head to the side and adjusts her spectacles to get a better look at Amily.  "<i>Well, I\'m a tigershark actually,</i>" she says flatly.  "<i>I\'m also ' + CoC.player.short + '\'s beta.  Who\'re you?  Oh!  You\'re one of those mouse people, right?</i>"\n\n', false );
			MainView.outputText( 'Amily just looks at her quizzically.  "<i>Yes, I am a mouse.</i>"  Her voice is ringing with a tone that just screams \'isn\'t it obvious?\'.  "<i>I\'m sorry, I\'ve seen some striped shark-girls before, but I didn\'t know your kind had a specific term... wait, what was that about being ' + CoC.player.short + '\'s beta?  What\'s a beta?</i>"\n\n', false );
			MainView.outputText( 'Izma gives a frown and scuffs the ground with her bare feet.  You give a nervous chuckle and try your best to explain the events of how you met Izma, your various sparring matches and how she eventually submitted fully to you after several victories, declaring you as her alpha.\n\n', false );
			MainView.outputText( 'After that you turn to Izma and explain your past with Amily, the tales of her ruined village, how you grew to love her, and how you fathered many children with her to kickstart the population of untainted mouse-morphs.  Izma takes a breath and looks enthralled by your story.  "<i>That\'s incredible; amazingly noble, both of you.</i>"\n\n', false );
			MainView.outputText( '"<i>I - you really think so?</i>" Amily asks, looking stunned and pleased all at once, blushing with embarrassment at the compliment.  Then she shakes her head.  "<i>Ah, well... I suppose this isn\'t unexpected. At least she seems to actually have a brain in her head, not like some goblin or cum-drinking fairy... still, you could have at least asked me before you went fooling around with another woman, you know?</i>" she complains.\n\n', false );
			MainView.outputText( 'Then she looks thoughtful.  "<i>Hey, come to think of it, if you\'re a shark-girl - sorry, tigershark, then how are you going to survive out here?  Don\'t you need to spend about two-thirds of the day underwater to live?</i>" Amily asks, puzzled.\n\n', false );
			MainView.outputText( '"<i>Ah, well... the lake isn\'t too far from here. And I think I saw a stream as we trekked over,</i>" she explains.  "<i>So long as I get some water on my body routinely, I\'ll be golden.  Plus it\'ll be nice to get access to some cleaner water.</i>"  She grumbles and adjusts the chest in her arms again.  "<i>Sorry, this thing is getting on my nerves, I gotta put it down.</i>"  She walks past to place her trunk down, but flashes a sincere grin as she does. "<i>It\'s been a pleasure to meet you, Amily; I do hope we get to know each other better,</i>" she says.\n\n', false );
			MainView.outputText( 'Amily watches as the tigershark goes to explore the camp, then, quick as lightning, zips over to you and hisses into your ear.  "<i>Don\'t think I\'m not pissed that you didn\'t talk about this with me beforehand!  I\'m just not stupid enough to challenge something that dangerous - I\'ve seen shark-girls take down and EAT minotaurs coming to the lake for a drink!</i>"  She pinches you sharply, to express her displeasure.\n\n', false );
			MainView.outputText( 'You apologize, but tell her that you won\'t just throw Izma out now.  She\'s here to stay, and the mouse-morph had better make her peace with that - fighting wouldn\'t work out well for anyone.\n\n', false );
			MainView.outputText( '"<i>I\'ll be polite to her, don\'t worry about that...  but are you absolutely sure we can trust her?  I\'d be very hesitant to accept anything or anyone coming out of that lake,</i>" Amily asks you, watching Izma as she curiously starts poking around at your mutual belongings.\n\n', false );
			MainView.outputText( 'You quietly point out that you met Amily in a ruined village by the lake, and ask her what she used to bathe in.  She glares at you, but you stand your ground and say that you trust Izma, pointing out that she\'s different from most of the creatures that have been tainted by the demons.  She could have attacked you and tried to rape you on sight - instead, she\'s been nothing but polite, conversational and self-controlled.  Even when the matter of sex came up, she talked with you about it first and made it clear that it was your choice and there would be no repercussions to refusing.  How many other beings in this world wouldn\'t have just raped first and asked questions never?\n\n', false );
			MainView.outputText( '"<i>You have a point there...</i>" Amily mumbles, staring at Izma with obvious curiosity.  "<i>Hmm... well, I should keep an eye on her, but I guess she\'s earned the right to the benefit of the doubt.  It might be nice to have somebody else to talk to here in the camp...</i>"  She trails off, mumbling, as Izma finally finishes setting up her spot and comes back to you.\n\n', false );
			...
			if( CoC.player.findPerk( PerkLib.MarblesMilk ) >= 0 ) {
				...
				MainView.outputText( 'Thankfully, though you were able to break her milk\'s hold, and you realized you love Marble despite all that transpired between you, letting her move in with you.', false );
			}
			MainView.outputText( '\n\n', false );
	...
	IzmaScene.prototype.newAmilyMeetsIzma = function() {
		...
		MainView.outputText( 'Amily just looks at her quizzically.  "<i>Yes, I am a mouse.</i>"  Her voice is ringing with a tone that just screams \'isn\'t it obvious?\'.  "<i>What was that about being ' + CoC.player.short + '\'s beta?  What\'s a beta?</i>"  You give a nervous chuckle and try your best to explain the past between you and Izma; what she is, your various sparring matches, and how she eventually submitted fully to you after several victories, declaring you as her alpha.\n\n', false );
		MainView.outputText( 'After that you turn to Izma and explain your past with Amily, the tales of her ruined village, how you grew to love her, and how you fathered many children with her to kickstart the population of untainted mouse-morphs.  Izma takes a breath and looks enthralled by your story.  "<i>That\'s incredible; amazingly noble, both of you.</i>"\n\n', false );
		...
		MainView.outputText( '"<i>Ah, well, the lake isn\'t too far from here,</i>" Izma counters.  "<i>And there is a stream up here.  So long as I get some water on my body routinely, I\'m golden.  Plus it\'s nice to get access to some cleaner water!  Well, I\'ve got some reading to catch up on, so I\'ll leave you be,</i>" the pretty tigershark says.\n\n', false );
		MainView.outputText( 'Amily watches as the tigershark returns to her bedroll, then, quick as lightning, zips over to you and hisses into your ear. "<i>Don\'t think I\'m not pissed that you didn\'t think to talk about this with me beforehand! I\'m just not stupid enough to challenge off something that dangerous - I\'ve seen shark-girls take down and EAT minotaurs coming to the lake for a drink!</i>"  She pinches you sharply, to express her displeasure.\n\n', false );
		MainView.outputText( 'You apologize, but tell her that you won\'t just throw Izma out now.  She\'s here to stay, and the mouse-morph had better make her peace with that - fighting wouldn\'t work out well for anyone.\n\n', false );
		MainView.outputText( '"<i>I\'ll be polite to her, don\'t worry about that... but are you absolutely sure we can trust her?  I\'d be very hesitant to accept anything or anyone coming out of that lake,</i>" Amily asks you, watching Izma as she curiously starts poking around at your mutual belongings.\n\n', false );
		MainView.outputText( 'You quietly point out that you met Amily in a ruined village by the lake, and ask her what she used to bathe in.  She glares at you, but you stand your ground and say that you trust Izma, pointing out that she\'s different from most of the creatures that have been tainted by the demons.  She could have attacked you and tried to rape you on sight - instead, she\'s been nothing but polite, conversational and self-controlled.  Even when the matter of sex came up, she talked with you about it first and made it clear that it was your choice and there would be no repercussions to refusing.  How many other beings in this world wouldn\'t have just raped first and asked questions never?\n\n', false );
	...
	IzmaScene.prototype.newMarbleMeetsIzma = function() {
		...
		MainView.outputText( 'Marble nods and seems to force a smile.  "<i>Just give us a moment,</i>" she tells Izma, before taking you by the hand and pulling you to another part of camp rather forcefully.\n\n', false );
		MainView.outputText( '"<i>Sweetie, what the hell?!</i>" she hisses once the two of you are out of earshot from Izma.  "<i>You could have at the very least warned me about all this, instead of bringing me home to some stranger into the camp! And she\'s one of those... corrupt monsters from the lake to boot!</i>" she says.  She looks far angrier than you\'ve seen her in the past, that\'s for sure.  You give a sigh and try to explain yourself, telling her that despite her appearance Izma is far nicer than any other creature that\'s come from that lake.  She\'s been kind, considerate, and most importantly she always gave you a choice when it came to sex.  That\'s far more than you could expect from some \'corrupt monster.\'\n\n', false );
	...
	IzmaScene.prototype.izmaLakeTurnedDownCampSex = function() {
		...
		EngineCore.choices( 'Equals', this, this.izmaLakeSexAsEquals, 'Dominate', this, this.izmaLakeDominate, 'Submit', this, this.submitToLakeIzma, '', null, null, 'Back', this, this.meetIzmaAtLake );
	};
	//[Equals];
	IzmaScene.prototype.izmaLakeSexAsEquals = function() {
		...
		if( CoC.player.gender === 0 ) {
			MainView.outputText( 'Izma looks you over, and then shakes her head sadly. "<i>I\'m sorry, ' + CoC.player.short + ', but... you still don\'t really have anything for me to play with.  If you want us to do it as equals, you\'ll need to grow a cock or a pussy.  How about you have one of us take charge, instead?</i>"\n\n', false );
			//[dom/sub]);
			EngineCore.doNext( this, this.meetIzmaAtLake );
		}
	...
	IzmaScene.prototype.izmaLakeDominate = function() {
		...
		if( CoC.player.hasCock() && (CoC.player.gender === 1 || Utils.rand( 2 ) === 0) ) {
			MainView.outputText( 'You remove your ' + CoC.player.armorName + ' and spread Izma\'s legs wide, ' + Descriptors.sMultiCockDesc() + ' almost painfully erect as you lift her quartet of balls up to look at her glistening womanhood.\n\n', false );
			MainView.outputText( 'Not wanting to waste any time on foreplay, you push your ' + Descriptors.cockDescript( x ) + ' into Izma\'s slit as far as you can manage, making Izma gasp sharply and writhe against you.  You snicker and start thrusting into her, the odd little tendrils inside her cunt teasing and massaging your cock.  The walls themselves are so tight and smooth that her pussy conforms to you like a glove.  It almost feels like Izma\'s snatch was made just for you.\n\n', false );
			MainView.outputText( 'You start to pick up speed as you mash your hips against Izma\'s own, earning moans from the pretty tigershark which only seem to get louder with every subsequent thrust.  Izma quickly starts to return the gesture, moving her hips up to meet your own thrusts every time.  It\'s while she\'s doing this that you notice her throbbingly erect cock wobbling around.\n\n', false );
			//NEW RADAR STUFF, GAO;
			MainView.outputText( 'Do you tend to her prick?' );
			EngineCore.doYesNo( this, this.izmaLakeDominateContinueVanilla, this, this.noWankingForIzmaRadarSaysSo );
			return;
		}
		//[Female];
		else if( CoC.player.hasVagina() ) {
			MainView.outputText( 'You strip off your ' + CoC.player.armorName + ' and spread Izma\'s legs wide, licking your lips at the sight of her throbbing erection and meaty quads.  You give Izma\'s massive cock a few test strokes, earning some pleasured groans from the tiger shark.\n\n', false );
			MainView.outputText( 'Deciding you\'ve had enough foreplay, you mount her and slide down her cock.', false );
			...
			if( CoC.player.isTaur() ) {
				...
				MainView.outputText( 'and pin her hands above her head to stop her from trying to change the position. Her heaving breasts rub against your ' + Descriptors.chestDesc() + ' as you ride her in this posture.  She needs to know who\'s in charge here, after all.', false );
			}
			//(non-taur and height <= 4');
			else {
				MainView.outputText( 'but small as you are, you can\'t stop her as she reaches up and grabs onto your ' + Descriptors.buttDescript() + ', then begins bouncing you like a goblin cocksleeve.', false );
			...
			MainView.outputText( '"<i>What about a goodbye kiss?</i>" she asks, trying to sound plaintive, but really sounding eager.  Happily, you allow her to embrace you, but in the midst of your passionate kiss, she suddenly pokes something from her mouth into yours, using her tongue to shove it down your throat and make you swallow.  You break away from her, coughing, and ask what that was.\n\n', false );
			MainView.outputText( '"<i>Birth control,</i>" she explains. You give her a half-hearted slap across the face and tell her not to be so audacious, but you can see by her smiling expression that she\'s pleased to have stolen a march on you.', false );
			CoC.player.slimeFeed();
		}
		//[Genderless];
		else {
			MainView.outputText( 'You push her onto her back and see her inhuman dong flop free from her skirt.  Seems the idea of domination turned the little shark on.  Well, \'little\' is hardly the right word to describe any aspect of her, especially when she has a 15-inch rock-hard erection waving over her.  It actually brings a dopey grin to your face.  Well, you earned a reward, so you might as well take it.\n\n', false );
			MainView.outputText( 'You lean down and start licking and suckling the tip of her monster dick, slurping up her hot pre and lubricating the tip of her raging boner.  She moans and jerks at your touch, writhing around and loving the sensation of submissiveness.  The feeling of having her under your power manages to bring a smile to your own face.\n\n', false );
			MainView.outputText( 'Gradually you start to suck more and more of her cock, inch after inch moving down your throat.  You gag lightly as you finally reach the base of her cock, before pulling it out.  She whines weakly and looks at you pitifully, wondering why you\'re teasing her.  You remove your ' + CoC.player.armorName + ' before turning to show her your ' + Descriptors.buttDescript() + ', and a small smile spreads over her angular face as she realizes what you have planned.  You plant your hands on your backside and pull your cheeks wide, before starting to slide onto her well-lubed pecker.\n\n', false );
			MainView.outputText( 'She grunts and huffs as you slide down, and you too feel a strain from her iron-hard dick despite the various fluids lubricating it.  But gradually pain turns to pleasure and you\'re both moaning loudly and calling each others\' names as you ride her.', false );
			...
			MainView.outputText( 'The two of you get dress after awhile, have some small talk, and then you make your way back to camp.', false );
			CoC.player.slimeFeed();
		}
		CoC.player.orgasm();
	...
	IzmaScene.prototype.izmaLakeDominateContinueVanilla = function( vanilla ) {
		...
		if( CoC.player.gender === 1 ) {
			...
			MainView.outputText( '  You sigh happily and push back from her, weakly getting to your ' + CoC.player.feet() + ' and redressing. Izma scrambles to her chest and takes out some sort of leaf, then eats it.', false );
		}
		//(Herm);
		else {
			MainView.outputText( 'After a lengthy fuck, you grunt loudly as your ' + Descriptors.cockDescript( cockIndex ) + ' swells, blasting streamers of jizz into Izma\'s womb', false );
	...
	IzmaScene.prototype.noWankingForIzmaRadarSaysSo = function() {
		...
		EngineCore.choices( 'Stop Her', this, this.noWankingForIzma, 'LetHerWank', this, this.letIzmaWankLikeABitch, '', null, null, '', null, null, '', null, null );
	};
	//[Let her masturbate];
	...
	IzmaScene.prototype.izmaCumsAfterRadarStuffHere = function( denied ) {
		...
		if( !denied ) {
			MainView.outputText( 'The double stimulation pushes Izma past her limit very quickly, and she starts shooting thick jets of spunk into the air, which begin to rain down on her face and breasts.  Her vaginal walls clamp down on your ' + Appearance.cockNoun( CoC.player.cocks[ cockIndex ].cockType ) + ' almost painfully as the orgasm wracks her female genitalia too.\n\n', false );
		}
		//[Remove her hands] ;
		else {
			MainView.outputText( 'Without another word, or another moment of tormenting impediment, Izma howls with unbridled fury, releasing her hot, sticky load into the air and onto her forehead.  Convulsing with utter euphoria as she finally blows her wad, the walls of her vagina clamp down hard in concert with her feelers, trying ever so valiantly to push you over the edge.  Unfortunately, (for Izma anyway), the unconscious efforts of her body fail to bring you to release. Remarking to Izma that she came so soon, you coo down to her that you are pleased with her ability to speedily heed your commands.\n\n' );
		}
	...
	IzmaScene.prototype.submitToLakeIzma = function() {
		...
		if( CoC.player.hasLongTail() > 0 ) {
			MainView.outputText( 'your tail waving enticingly, ', false );
		}
		MainView.outputText( 'before you give your ' + Descriptors.assDescript() + ' a seductive wiggle.  You tell her that you think it\'s her turn to play.\n\n', false );
		MainView.outputText( 'Izma\'s breath visibly catches in her throat, her cock painfully erect and pulsing with lust.  She doesn\'t even bother to remove her bikini, instead stalking towards you, her intention obvious with every movement.  Within seconds she is behind you, her hands firmly gripping your ' + Descriptors.buttDescript() + '.  You feel a sudden hot liquid sensation in between your buttocks, and you squeak in shock - it\'s almost like somebody has tipped hot lava onto your ass. Izma\'s cum is so hot you\'re surprised you don\'t see steam wafting back over you.\n\n', false );
		//(male/Unsexed);
		if( CoC.player.gender <= 1 ) {
			///[(If player has tight butthole:);
			if( CoC.player.analCapacity() < 26 ) {
				...
				CoC.player.buttChange( 30, true, true, false );
				MainView.outputText( '\n\n', false );
				MainView.outputText( '"<i>Holy-!  Think I better take it easy on this...</i>" you hear Izma proclaim.  "<i>For my own safety moreso than anything else!</i>"  Her efforts become more gentle.  She still forces her way into you, inch by painstaking inch, but she does so at a slower, steady pace, allowing your pucker time to adjust to the fierce stretching she is subjecting it to and using her hot pre-cum like lubricant.\n\n', false );
			}
			//(If player has middling anus:) ;
			else if( CoC.player.analCapacity() < 26 ) {
				MainView.outputText( 'You can feel every inch of her cock as it sinks steadily into your anus, swelling into your guts as inexorably as the flood tide.\n\n', false );
				MainView.outputText( '"<i>Ahhhh... now that\'s a nice little hole!  Did you lose on purpose?</i>" she asks, and you can hear the grin in her voice.\n\n', false );
			}
			//(If player has a loosey goosey:);
			else {
				MainView.outputText( 'Izma\'s cock may be fairly impressive, but you\'ve taken bigger in your time, and it shows; Izma\'s first experimental thrust sees her sink up to the hilt into your bowels, and you moan with the pleasure of being filled again even as her four balls slap against your ' + Descriptors.buttDescript() + '.\n\n', false );
				MainView.outputText( '"<i>The heck!?  What kind of monsters have you been running into?</i>" she wonders aloud.\n\n', false );
			}
			MainView.outputText( 'Fully buried, she tightly grips your ' + Descriptors.assDescript() + '  and then pulls out partway, before thrusting herself back in fiercely.  "<i>Thought you were clever, eh?  Wanted to try doing it like shark people do, did you?  Well, among the sharks, there\'re only two sorts - the strong and the weak.  And this is what the weak get.</i>"  She growls fiercely.\n\n', false );
			MainView.outputText( 'Harder and faster she thrusts, building up a rhythm that grows in pace, her balls slapping audibly against your ' + Descriptors.buttDescript() + ' as she bucks back and forth.  You can feel her huge male organ in your depths, rubbing against your prostrate, stretching your inner walls, her boiling erection against your burning heat.  You moan in pleasure; you can\'t help but enjoy this', false );
			if( CoC.player.hasCock() ) {
				MainView.outputText( ', and your own male organ is hard and throbbing from the stimulation', false );
			}
			...
			MainView.outputText( '  Your belly grows as the great wave of tigershark cum reaches your stomach and fills it to the brim, and then it begins to stretch further.  Your limbs fail you and you fall face-first onto the sand in your pleasure, too consumed by sensation to even notice your stomach puffing out firm and hard against the earth.\n\n', false );
			MainView.outputText( 'Finally, Izma stops, panting hard for breath; as her cock softens and pulls free from your stretched anus, a steady trickle of hot cum pours out in its wake.  As she recovers, so too do you, rolling over so that you can see her, your midriff swollen into a small but undeniable gut from all the cum she has poured into it.  She looks at you, undeniably pleased by what she sees. Leaning down, she gives you a small peck on the lips, then flops down beside you.  She reaches over and pulls you over, letting you rest your head against her pillow-like DD-cup breasts. When you are recovered, she helps you up.  "<i>You\'re too good to your inferior, ' + CoC.player.short + '... but that\'s what I love about you so much.</i>"  She smirks, giving you a decidedly unchaste kiss and a smack on the ass before you dress yourself and head back to camp.\n\n', false );
		}
		//(female);
		else if( CoC.player.gender === 2 ) {
			//[(If player has tight cunt:) ;
			...
			//(If player has ordinary, everyday cunt:);
				...
				MainView.outputText( 'You can feel every inch of her cock as it sinks steadily into your ' + Descriptors.vaginaDescript( 0 ) + ', filling your moist folds as inexorably as the rising tide.\n\n', false );
				MainView.outputText( '"<i>Ahhhh~  Now that\'s a nice little hole!  Did you lose on purpose?</i>" she asks, and you can hear the grin in her voice.  You find yourself wondering that as well...', false );
			}
			//(If player is loose:);
			else {
				MainView.outputText( 'Izma\'s cock may be fairly impressive, but you\'ve taken bigger in your time, and it shows; Izma\'s first experimental thrust sees her sink up to the hilt into your crotch, and you moan with the pleasure of being filled again even as her four balls slap against your taint.\n\n', false );
			...
			CoC.player.cuntChange( 30, true, true, false );
			MainView.outputText( '\n\n', false );
			MainView.outputText( 'Fully buried, she tightly grips your ' + Descriptors.buttDescript() + ' and then starts to pull out, before thrusting herself back in fiercely.  "<i>Thought you were clever, eh?  Wanted to try doing it like shark people do, did you?  Well, among the sharks, there\'re only two sorts - the strong and the weak.  And this is what the weak get.</i>"  She growls fiercely.\n\n', false );
			MainView.outputText( 'Harder and faster she thrusts, building up a rhythm that grows in pace, her balls slapping audibly against your butt as she bucks back and forth.  You can feel her huge male organ in your depths, rubbing against your womb\'s walls and stretching you out, her boiling erection pressed against your burning insides.  You moan; you can\'t help but enjoy this, your cunt drooling from the intense pleasure.\n\n', false );
			...
			MainView.outputText( '"<i>That\'s it, weakling, moan for me; make this sweeter!  I\'d be moaning if you had won, so the least you can do is give me the same courtesy - fair\'s fair!</i>" she mutters.  "<i>Oh, yes, yes, yes! Good little fuck, good!  I... I\'m... here... it... comes!</i>"  She roars, releasing her grip on your tormented breasts to bellow her exultation to the sky, the climax that has been churning and thrashing her mighty balls finally erupting from within her.\n\n', false );
			MainView.outputText( 'You groan as well, your own orgasm coating the sands beneath you with girly fluids as Izma\'s cum boils into your womb.  Hot and slick, it surges and flows into you, pumping and pumping into your depths. Your belly grows as the great wave of tigershark cum reaches your stomach and fills it to the brim, and then it begins to stretch further.  Your limbs fail you and you fall face-first onto the sand in your pleasure, too consumed by sensation to even notice your stomach puffing out firm and hard against the earth.\n\n', false );
			MainView.outputText( 'Finally, Izma stops, panting hard for breath; as her cock softens and pulls free from your stretched anus, a steady trickle of hot cum pours out in its wake.  As she recovers, so too do you, rolling over so that you can see her, your midriff swollen into a small but undeniable gut from all the cum she has poured into it.  She looks at you, undeniably pleased by what she sees. Leaning down, she gives you a small peck on the lips, then flops down beside you.  She reaches over and pulls you over, letting you rest your head against her pillow-like DD-cup breasts. When you are recovered, she helps you up.  "<i>You\'re too good to your inferior, ' + CoC.player.short + '... but that\'s what I love about you so much.</i>"  She smirks, giving you a decidedly unchaste kiss and a smack on the ass before opening her locker.\n\n', false );
			if( CoC.player.pregnancyIncubation === 0 ) {
				MainView.outputText( 'Hauling out a plant, she gingerly removes a leaf and offers it to you.  "<i>Could you take this please?  It\'s an anti-this.pregnancy herb.  I\'d be happy to have babies with you someday... but I want to earn your acknowledgment as a mate first.</i>"  Smiling a bit at how old-fashioned she seems, you take the leaf out of her hands and eat it.', false );
			}
		}
		//(herm);
		else {
			...
			//(20+ inches);
				...
				MainView.outputText( 'Izma gives a low whistle at the sight of your ' + Descriptors.cockDescript( 0 ) + '.  "<i>Now THAT\'S a cock.  Looks like you\'ve got a third leg down there!</i>', false );
			}
			MainView.outputText( '\n\n', false );
			MainView.outputText( 'Seemingly done appraising you, Izma roughly grabs your ' + CoC.player.feet() + ' and pulls your rear upwards, forcing your weight onto your spine and making you cry out from the uncomfortable position.  She doesn\'t waste time on foreplay, simply deciding to bury her cock into you slowly, inch by painstaking inch until she\'s pushing against the entrance to your womb.', false );
			CoC.player.cuntChange( 30, true, true, false );
			MainView.outputText( '\n\n', false );
			...
			MainView.outputText( ' toward your face, stroking you to your own climax.  Jets of your own cum splatter across your face and body as you writhe, protesting. "<i>Tch, you really thought I\'d let you cum on ME?  Maybe if you actually managed to beat me I\'d give you the honor,</i>" Izma says, pulling free with a loud *SCHLICK* sound.  She ', false );
			if( CoC.player.pregnancyIncubation === 0 ) {
				MainView.outputText( 'releases your ' + CoC.player.feet() + ', allowing your ' + Descriptors.buttDescript() + ' to hit the sand with a plop, and gets to work redressing while you lie still.  She returns with an anti-this.pregnancy herb in her hands, and then flips a leaf into her mouth. Before you can wonder why she did that, she bends down and kisses you fiercely, her tongue pushing it past your lips and down your throat.', false );
				MainView.outputText( '"<i>I\'d be happy to make some babies with you... but <b>after</b> you accept me as a mate."</i>  She smirks, giving you a second, decidedly unchaste kiss before she helps you up.  You dress yourself and head back to camp feeling very sated.', false );
			} else {
				MainView.outputText( 'gives you a decidedly unchaste kiss before she helps you up.  You dress yourself and head back to camp feeling very sated.', false );
			}
		}
		CoC.player.orgasm();
		EngineCore.dynStats( 'sen', 2 );
	...
	IzmaScene.prototype.izmaFollowerMenu = function() {
		...
		if( CoC.flags[ kFLAGS.FOLLOWER_AT_FARM_IZMA ] === 0 ) {
			...
			MainView.outputText( 'You call for Izma and she approaches, asking, "<i>What can I do for my Alpha?</i>"\n\n', false );
			//Izma Pregnancy Stages:;
			switch( this.pregnancy.event ) {
				case 2:
					MainView.outputText( 'You can\'t help noticing that Izma seems very nauseous this morning; she\'s literally green around the gills.  When you investigate, though, she waves you off, insisting that she\'s fine; she just has a bit of a stomach bug.', false );
					break;
				case 3:
					MainView.outputText( 'Izma comes up to you, looking concerned.  "<i>' + CoC.player.short + ', do you think I\'ve gained weight?</i>" she asks.  Looking at her, particularly at the stomach she\'s holding her hands over, you have to confess that it is starting to bulge out in a noticeable paunch.  At her crestfallen look, you suggest that maybe she\'s pregnant.  At that, she looks delighted.  "<i>You really think so?</i>" she asks, hopefully.  You assure her that you\'re certain of it; after all, she\'s very good at watching her weight.  Pleased, she kisses you and then heads off for a swim.', false );
					break;
				case 4:
					MainView.outputText( 'There is no doubt about it now; Izma\'s pregnant.  She\'s grown gravid more rapidly than any of the expecting mothers you remember seeing back in your village, but she seems to be having all of the same aches and pains.  She\'s grown lethargic and irritable, and complains about not being able to fit into her old clothes.  Still, despite that, she seems happy; she\'s always rubbing her belly with unmistakable pride.  You also think you\'ve noticed her casting you "<i>come hither</i>" looks more frequently than before.', false );
					break;
				case 5:
					MainView.outputText( 'Izma\'s started to go around completely naked now.  She insists that she\'s grown too big to fit into her clothes, but you\'re kind of skeptical about that; she\'s as big as the women in your village got when they were near the end, but they managed to fit into their clothes, and theirs were a lot more restrictive than a bikini and grass skirt combo.  Still, you\'re not objecting to the view it provides, and she definitely seems to enjoy that; you never knew a shark tail could be wiggled in an enticing manner over shapely buttocks until you came to this world...', false );
					break;
				case 6:
					MainView.outputText( 'Izma\'s certain the baby will come soon.  You\'re inclined to believe her; she\'s huge now.  She still wears no clothing, but there\'s definitely a practical reason for it' );
					if( CoC.flags[ kFLAGS.IZMA_NO_COCK ] === 0 ) {
						MainView.outputText( '- you don\'t think her skirt would be able to cope with how often she gets erect now, her huge cock rubbing along' );
					} else {
						MainView.outputText( ', her juices staining' );
					}
					MainView.outputText( ' the underside of her swollen belly...  Izma spends much of her time in the water, now; she says it\'s to soothe her skin.  Given you\'ve seen her explosively cum all over herself from ' );
					if( CoC.flags[ kFLAGS.IZMA_NO_COCK ] === 0 ) {
						MainView.outputText( 'the friction of her cock against her bulge, you think it has more to do with avoiding being splattered in sexual juices all day long.', false );
					} else {
						MainView.outputText( 'the friction of her thighs as she moves, you think it has more to do with avoiding being splattered in sexual juices all day long.', false );
					}
					break;
				default:
			}
		} else {
			MainView.outputText( 'Izma smiles and puts away her book at your approach.' );
		...
		EngineCore.choices( 'Appearance', this, this.izmaPearance, 'Books', this, this.IzmaCampBooks, 'Children', this, kids, 'Sex', this, sex, 'Talk', this, this.talkWivIzma,
			'Tooth', this, this.gatASharkTooth, '', null, null, '', null, null, deDickT, this, deDickB, 'Back', SceneLib.camp, SceneLib.camp.campLoversMenu );
		...
		if( CoC.flags[ kFLAGS.FOLLOWER_AT_FARM_IZMA ] === 0 && CoC.flags[ kFLAGS.FARM_CORRUPTION_STARTED ] === 1 && !this.pregnancy.isPregnant ) {
	...
	IzmaScene.prototype.sendToFarm = function() {
		MainView.clearOutput();
		this.izmaSprite();
		MainView.outputText( 'You tell your beta that she is to head towards the lake, find a farm, present herself to the lady who works there and do as she says. Izma’s brow furrows as she takes this in.' );
		...
		CoC.flags[ kFLAGS.FOLLOWER_AT_FARM_IZMA ] = 1;
		EngineCore.doNext( SceneLib.camp, SceneLib.camp.returnToCampUseOneHour );
	};
	IzmaScene.prototype.backToCamp = function() {
		MainView.clearOutput();
		this.izmaSprite();
		MainView.outputText( 'You tell her to head back to camp; she will be more use to her alpha there.' );
		...
		CoC.flags[ kFLAGS.FOLLOWER_AT_FARM_IZMA ] = 0;
	...
	IzmaScene.prototype.gatASharkTooth = function() {
		...
		if( CoC.flags[ kFLAGS.UNKNOWN_FLAG_NUMBER_00246 ] > 1 ) {
			...
			MainView.outputText( 'Izma smiles as she pulls a tooth from her chest.  She hands it to you with a pleased expression.  "<i>Anything for you, my Alpha.</i>"  ' );
	...
	IzmaScene.prototype.izmaSexMenu = function() {
		...
		//Vagoo - req Cock;
		if( CoC.player.hasCock() ) {
			if( CoC.player.cockThatFits( 65 ) >= 0 ) {
		...
		if( CoC.player.hasVagina() && CoC.flags[ kFLAGS.IZMA_NO_COCK ] === 0 ) {
		...
		var kids = '';
		if( CoC.flags[ kFLAGS.UNKNOWN_FLAG_NUMBER_00249 ] === 1 ) {
			kids = 'NoKidsPlease';
		} else {
			kids = 'Have Kids?';
		}
		...
		EngineCore.addButton( 3, 'Get Mounted', this, mount );
		EngineCore.addButton( 4, 'Izma\'s Vagina', this, vagoo );
		EngineCore.addButton( 5, 'RideIzmaCock', this, getVagooFucked );
		EngineCore.addButton( 6, 'Sixtynine', this, sixty );
		EngineCore.addButton( 7, 'Kids', this, this.childToggle );
		if( CoC.flags[ kFLAGS.TIMES_IZMA_DOMMED_LATEXY ] > 0 && CoC.flags[ kFLAGS.IZMA_NO_COCK ] === 0 && SceneLib.latexGirl.latexGooFollower() ) {
			EngineCore.addButton( 8, CoC.flags[ kFLAGS.GOO_NAME ], this, this.izmaLatexySubmenu );
		}
		EngineCore.addButton( 9, 'Back', this, this.izmaFollowerMenu );
	};
	//[Izma mounts the PC];
	IzmaScene.prototype.followerIzmaMountsPC = function( lastHalf ) {
		...
		if( !lastHalf ) {
			...
			MainView.outputText( 'With a smirk, you make a show of removing your ' + CoC.player.armorName + ' and settling yourself down on your back, ' + Descriptors.sMultiCockDesc() + ' pointing into the air excitedly.  You give Izma a coy look and tell her that you\'re thinking of letting her have control this time... if she thinks she can dominate with her pussy' );
			if( CoC.flags[ kFLAGS.IZMA_NO_COCK ] === 0 ) {
				MainView.outputText( ' instead of her cock' );
			}
			MainView.outputText( '.  Izma watches you eagerly and licks her lips.  "<i>I think that can be arranged,</i>" she purrs, straddling you and then slowly sliding down onto your erect member.  The tiny tendrils inside her cunt tickle and massage your cock all the while.\n\n', false );
			MainView.outputText( 'You groan, lie yourself back down, and give yourself over to your aquatic girlfriend\'s ministrations; you don\'t know why she has naughty little tentacles inside her pussy, but you\'re certainly not going to complain about them.  You can feel them caress and stroke your ' + Descriptors.cockDescript( x ) + ', eagerly pulling it deeper and deeper into her warm, wet, inviting depths.\n\n', false );
			MainView.outputText( 'Once you\'re fully inside her pussy she looks at you and smirks, a low, animalistic growl escaping her lips.  As her hips start to gain speed she leans down and bites your collar bone, thankfully with her human teeth.  You yelp in shock and cast a startled glance at her.  She hums in your ear as her hips start to twist and gyrate even faster.\n\n', false );
			MainView.outputText( 'It does feel pretty good, and so you settle back down, one hand cautiously lifting up to caress the mark of your lover\'s bite.  "<i>Hehe, don\'t worry; you\'re not bleeding or anything.  Just marking you as mine,</i>" she whispers, before giving a loud moan.  ' );
			if( CoC.flags[ kFLAGS.IZMA_NO_COCK ] === 0 ) {
				MainView.outputText( '  Your stomach starts to feel wet, and as you look down you realize her pre is starting to soak into your ' + CoC.player.skinFurScales() + '.\n\n', false );
			} else {
				MainView.outputText( '  Your stomach starts to feel wet, and as you look down you realize her feminine lubricant is starting to soak into your ' + CoC.player.skinFurScales() + '.\n\n', false );
			}

			MainView.outputText( 'You wonder if you should be more actively moving your hips to her thrusts, but then, this is supposed to be about letting her be in charge.' );
			if( CoC.flags[ kFLAGS.IZMA_NO_COCK ] === 0 ) {
				MainView.outputText( '  Still, the sight and sensation of her pre-cum-dribbling cock slapping against your belly gives you an idea.  ' );
				MainView.outputText( 'You could reach up, grab her meaty member and jerk it off... or you can just enjoy the sex as is.  What will you do?' );
				EngineCore.choices( 'Jerk It', null, EngineCore.createCallBackFunction( this, this.followerIzmaMountsPC, true ),
					'Nope', this.RadarIzmaLeaveHerWangUnWingWanged, '', null, '', null, '', null );
				return;
				//MainView.outputText('You remove your hand from her mark and instead place it squarely on her cock, wrapping your fingers around its two-inch-thick girth.\n\n', false);;
			} else {
				MainView.outputText( '  Still, the sight of her curvaceous cleavage bouncing gives you an idea.  You reach up to cup your strong lover\'s hard bosom, enjoying the sight of her slightly-upturned nipples pointing up at the sky.  You flick them gently as she rides you, sometimes squeezing and tugging encouragingly.\n\n' );
			}
		}
		if( CoC.flags[ kFLAGS.IZMA_NO_COCK ] === 0 ) {
			if( lastHalf ) {
		...
		MainView.outputText( 'Even if you hadn\'t found Izma\'s impromptu cum bath a bit kinky, your ' );
		if( CoC.flags[ kFLAGS.IZMA_NO_COCK ] === 0 ) {
			MainView.outputText( 'own ' );
		}
		MainView.outputText( 'cock has been just as teased and tormented - and as her inner walls grip down, her tentacles squeezing as hard as they can, it\'s too much. You let out a cry of your own as you flood her interior with your spooge', false );
		//[(if vagina);
		if( CoC.player.hasVagina() ) {
			MainView.outputText( ', your cunt ', false );
			if( CoC.player.vaginas[ 0 ].vaginalWetness <= AppearanceDefs.VAGINA_WETNESS_SLICK ) {
				...
				MainView.outputText( 'gushing', false );
			} else {
				MainView.outputText( 'cascading', false );
			}
			MainView.outputText( ' feminine fluids onto the sticky ground beneath you both', false );
		}
		MainView.outputText( '; you were just as eager to release as she was.\n\n', false );
		this.izmaPreg();
		//(Standard cum protozoan) ;
		if( CoC.player.cumQ() < 500 ) {
			MainView.outputText( 'You can feel Izma\'s womb fill with your cum, and she shudders from the sheer pleasure.', false );
		}//(High cum production) ;
		else {
			MainView.outputText( 'Izma squeals loudly as you cum inside her, almost having a second orgasm as her belly is bloated and distended by your inhuman amount of cum.', false );
		}
		MainView.outputText( '  Once you\'ve finished, Izma rolls off you and continues breathing heavily.  "<i>That was amazing... my Alpha.</i>"\n\n', false );
		MainView.outputText( 'You\'re too busy gasping for breath to reply, at first.  But then, with a smile, you pick yourself up and give her a quick kiss on the cheek.  To your surprise, the ever-horny shark-girl actually blushes with delight at the gesture.  The two of you leisurely dress yourselves and then go your separate ways; you back to your camp, Izma back to the stream to soak and recover.', false );
		CoC.player.orgasm();
		EngineCore.dynStats( 'sen', -2 );
		EngineCore.doNext( SceneLib.camp, SceneLib.camp.returnToCampUseOneHour );
	};
	IzmaScene.prototype.izmaPreg = function() {
		...
		//PREGGO CHANCES;
		if( CoC.flags[ kFLAGS.UNKNOWN_FLAG_NUMBER_00249 ] === 1 && !this.pregnancy.isPregnant && Utils.rand( 100 ) < (10 + Math.round( CoC.player.cumQ() / 100 )) ) {
	...
	IzmaScene.prototype.followerIzmaTakesItInPooper = function() {
		...
		MainView.outputText( 'You\'re about to reply when she grabs your wrists and, holding them behind your back, ', false );
		//[[if [CoC.player height>6' or player is centaur] ;
		if( CoC.player.tallness > 72 || CoC.player.isTaur() ) {
			MainView.outputText( 'pulls you down to kiss you fiercely', false );
		}
		//[else if player<4.5'] ;
		else if( CoC.player.tallness < 54 ) {
			MainView.outputText( 'pulls you up off the ground in a bear hug to kiss you fiercely', false );
		}
		//[else] ;
		else {
			MainView.outputText( 'pulls you in to her body and kisses you fiercely', false );
		}
		MainView.outputText( '. She lets her shark teeth graze your lips, and you taste blood.\n\n', false );
		MainView.outputText( 'You start to kiss her back, but she\'s still in charge, and seems intent on screwing your mouth with her tongue. You feel her stiffening tool ', false );
		//[[if player has legs] ;
		if( CoC.player.isBiped() || CoC.player.isTaur() ) {
			MainView.outputText( 'between your legs', false );
		}//[else] ;
		else {
			MainView.outputText( 'against your lower body', false );
		}
		MainView.outputText( ', and give up on fighting. Each time her tongue thrusts into your mouth, you try to suck it a little, or flick it with your own tongue.\n\n', false );
		MainView.outputText( 'Izma gives a happy moan as she feels you relax into her large breasts, and a satisfied chuckle when you start fellating her tongue.  Pulling back from your panting mouth, she pushes you down to the ground and presents you with her cock.\n\n', false );
		MainView.outputText( '"<i>Get it nice and slippery, then, if you\'re so eager.</i>"\n\n', false );
		MainView.outputText( 'You start kissing along her fifteen-inch length, but Izma\'s in more of a hurry than that, because she grabs your ' + Descriptors.hairDescript() + ' and pulls you back to the tip.  With her smooth glans resting at your lips, you look up at her. She grins, showing all her teeth, and starts pushing your head down.\n\n', false );
		MainView.outputText( 'As her cock slides past your lips and down your throat, it takes a lot of effort not to gag, but you feel proud and happy when she\'s the first one to look away, tilting her head back and grunting in pleasure as she bottoms out in your mouth, her balls tapping against your chin.\n\n', false );
		MainView.outputText( 'It\'s only a few seconds, but when she finally pulls out of your throat you splutter and cough.  "<i>Too much to swallow?</i>" she asks, half-mockingly, half-lovingly, then pulls your head back and fucks your throat in earnest, giving you at least a dozen thrusts without a chance to breathe.  When she\'s done she lets you fall onto your back, gasping, and Izma lowers herself onto you.\n\n', false );
		//[(if player has penis);
		if( CoC.player.hasCock() ) {
			MainView.outputText( 'You expect to feel her penetrate you when she thrusts forward, but instead she runs her cock along the surface of your asshole', false );
			//[(if player has balls);
			if( CoC.player.balls > 0 ) {
				MainView.outputText( ' and ' + Descriptors.sackDescript(), false );
			}
			MainView.outputText( ' until her dark-red cock is lined up with your ' + Descriptors.multiCockDescriptLight() + '.\n\n', false );
			MainView.outputText( 'She takes your ' + Descriptors.cockDescript( 0 ) + ' and presses it against her own, holding both of them together in one hand and rubbing slightly.  Her other hand reaches down below, to rub her double set of balls', false );
			//[(if player has balls);
			if( CoC.player.balls > 0 ) {
				MainView.outputText( ' against your own ' + Descriptors.ballsDescriptLight(), false );
			}
			//(if no balls and vag);
			else if( CoC.player.hasVagina() ) {
				MainView.outputText( ' against your already-dripping ' + Descriptors.vaginaDescript( 0 ), false );
			}//(else);
			else {
				MainView.outputText( ' against your perineum', false );
			}
			MainView.outputText( ', humiliating you more than she stimulates you.\n\n', false );
			//[if dick0 is <14"] ;
			if( CoC.player.cocks[ 0 ].cockLength < 14 ) {
				MainView.outputText( '"<i>Hmm...</i>" she sighs, as she looks at her glans sticking out past the tip of your dick.  "<i>It\'s nice to know who\'s in charge.</i>"', false );
			}
			//[dick0 >14 but <16] ;
			else if( CoC.player.cocks[ 0 ].cockLength < 16 ) {
				MainView.outputText( '"<i>It\'s nice that we keep things fair around here,</i>" murmurs Izma, smiling at your similarly-sized cocks.', false );
			}
			//[If dick0 >16];
			else {
				MainView.outputText( '"<i>Oh fuck,</i>" she says, her eyes filling with lust as she sees your cock extending well past her own.  She tilts forward and rubs the base of her cock hard against the base of your ' + Appearance.cockNoun( CoC.player.cocks[ 0 ].cockType ) + ', jerking the both of you off together.  You moan helplessly when she stops, and she sighs, "<i>It feels so good to be alpha over a powerful cock like yours.</i>"', false );
			}
			MainView.outputText( '\n\n', false );
		}
		MainView.outputText( 'She slowly moves her hips away and lifts your ass up off the ground, letting her head trail along your body until it drops into place at your anus.  ', false );
		//[[if player is anal virgin];
		if( CoC.player.ass.analLooseness === 0 ) {
			MainView.outputText( 'You gasp in pain as she starts pushing her giant cock against your tightly-puckered ass, whimper as your sphincter gives way and, with a pop, her cock head is resting inside of you.  Izma looks at you with a confused face, and then seems to realize what just happened.\n\n', false );
			MainView.outputText( '"<i>You... let me be the first to take you? You\'re sweeter than I thought!</i>"  She strokes your body with surprising gentleness as she eases herself the rest of the way into you.  Each inch is easier than the last, and by the fifteenth inch you\'re squirming and ready for more.', false );
		}
		//[else if player has tight anus];
		else if( CoC.player.analCapacity() <= 26 ) {
			MainView.outputText( 'You moan as Izma\'s cockhead pushes past your tight sphincter.  "<i>That\'s it, you beta slut,</i>" she says as she slides the rest of her cock into you.  "<i>Moan for your alpha.</i>"', false );
		}
		//[else if player has loose anus];
		else {
			MainView.outputText( 'Izma starts to push and, meeting no resistance from your well-trained ass, slams her hips against yours with a groan of satisfaction.\n\n', false );
		}
		CoC.player.buttChange( 30, true, true, false );
		MainView.outputText( '\n\n', false );
		MainView.outputText( 'With her hips securely pressed against yours, she leans over you to grab your wrists and hold them to the ground, her elbows hooked' );
		if( CoC.player.isBiped() ) {
			MainView.outputText( ' behind your knees to immobilize you' );
		} else {
			MainView.outputText( ' around your [legs] to immobilize you' );
		}
		MainView.outputText( ' with your ass in the air.  Her cock feels warm inside of you, and you could swear she\'s making it throb deliberately, just to feel you twitch in response.\n\n', false );
		MainView.outputText( 'She starts to screw you deliberately, pulling out just short of all the way before thrusting back in with practiced expertise.  You\'re lost in the pleasure of being used so roughly, and can\'t remotely keep track of how long she screws you.', false );
		//[if player has penis: ;
		if( CoC.player.hasCock() ) {
			MainView.outputText( '  You try to reach for your cock and get off, but her hands keep your wrists securely pinned to the ground.', false );
		}
		MainView.outputText( '\n\n', false );
		MainView.outputText( 'Her thrusts become shorter, faster, and wilder, and you see her panting and focusing.  Reaching forward with your mouth, you take one of her dangling nipples in your mouth and start suckling and nibbling.  Her half-closed eyes flash open and she slams into you with a shocked expression.\n\n', false );
		MainView.outputText( 'She yells as you bite down on her nipple, and you\'re rewarded with hot spurts of cum that fill your belly as Izma\'s quad balls empty into you.  ', false );
		//[if player has no penis);
		if( !CoC.player.hasCock() ) {
			MainView.outputText( 'The feeling of her cock throbbing finally puts you over the edge and you orgasm, your tight pucker helping milk the last of her cum into you.\n\n', false );
		}//(if player has penis);
		else {
			MainView.outputText( 'She collapses onto you, spent, and you close your eyes and relish the feeling of her hot cock pulsing in your ass and her warm belly lying against your ' + Descriptors.cockDescript( 0 ) + '.  When she sits back up, she gives you a stern look as she lets go of your wrists, making it clear that they should stay right where they are.  You look at her pleadingly as she trails her fingers along your ' + Appearance.cockNoun( CoC.player.cocks[ 0 ].cockType ) + '.\n\n', false );
			//[(if penis 0 length <14 inches);
			if( CoC.player.cocks[ 0 ].cockLength < 14 ) {
				MainView.outputText( 'Izma grabs your ' + Descriptors.cockDescript( 0 ), false );
				if( CoC.player.cockTotal() > 1 ) {
					MainView.outputText( ' first, then your other ' + Descriptors.cockDescript( 1 ) + ', synchronizing her movements', false );
				}
				MainView.outputText( ', and starts jerking you off.  It feels incredible, and when she says, "<i>You\'ve been a good beta for me, but now I want to see you come,</i>" you can\'t help but obey; you orgasm messily onto your own ' + Descriptors.chestDesc(), false );
				//(huge cum);
				if( CoC.player.cumQ() >= 1500 ) {
					MainView.outputText( ' over and over again until you\'re a sticky mess lying in a pool of your own semen.', false );
				}//[(big cum);
				else if( CoC.player.cumQ() >= 500 ) {
					MainView.outputText( ' until cum pours off of your body and pools on the ground.', false );
				} else {
					MainView.outputText( '.', false );
				}
				MainView.outputText( '\n\n', false );
	...
	IzmaScene.prototype.followerIzmaTakesItInVagoo = function() {
		...
		MainView.outputText( '', true );
		MainView.outputText( 'Admiring the view of the tigershark\'s ornamented crotch, you lower the bottoms of your ' + CoC.player.armorName + ' and reveal the base of your ' + Descriptors.multiCockDescriptLight() + ', something that instantly draws Izma\'s eyes.  You ask how she\'d like her alpha to tend to her oft-neglected pussy.  Izma smiles eagerly and spreads her legs' );
		if( CoC.flags[ kFLAGS.IZMA_NO_COCK ] === 0 ) {
			MainView.outputText( ', gently lifting her meaty quads up so' );
		} else {
			MainView.outputText( ', gently parting her muscled thighs so' );
		}
		MainView.outputText( ' you can better see her damp nether-lips.  "<i>Okay lover... if anyone knows how to make me feel good down there, it\'s you.</i>"\n\n', false );
		MainView.outputText( 'You give her a lecherous grin back and stalk towards her, watching as she slowly seats herself on her bedroll and lies back for you; one hand playing with her breasts, ' );
		if( CoC.flags[ kFLAGS.IZMA_NO_COCK ] === 0 ) {
			MainView.outputText( 'the other holding her maleness out of the way, teasing her cock with her thumb and flexing her fingers to roll her four balls around in the palm of her hand.' );
		} else {
			MainView.outputText( 'the other slowly spreading the folds of her vulva, teasing her clit with her thumb and flexing her interior muscles to make the pink opening wink at you.' );
		}
		MainView.outputText( '  You shed your own ' + CoC.player.armorName + ' and strike a pose for her. Izma watches you closely for a few moments, before growling, "<i>Oh stop toying around and fuck me already!</i>" She gives a gasp and covers her mouth. "<i>O-oh, sorry... I was out of line talking to my Alpha like that!</i>"\n\n', false );
		MainView.outputText( 'Sauntering over, you settle yourself on your elbows and knees before her.  Reaching out with one hand, you start to stroke her pussy, feeling its intense heat and letting her juices squelch and ooze between your fingers.  Casually, nonchalantly, you tell Izma that she was out of line for talking to you like that, and suggest that maybe you shouldn\'t put anything into her, if that\'s the mood she\'s in.\n\n', false );
		MainView.outputText( 'Izma moans and writhes slightly as you rub her cunt.  "<i>N-noooo,</i>" she whines, looking at you with puppy-dog eyes.  "<i>Please, I need you...</i>"  You enjoy her struggles for a little while, then give her your wickedest grin.  Well, if that\'s the way she feels about it...  You surge forward, rising up between her legs until your pelvises are positioned properly.  You position your ' + Descriptors.cockDescript( 0 ) + ' against her labia and then slide it home, enveloping it in her hot, wet depths.  She moans loudly and goes limp, gasping and panting from the pleasure.  The strange tendrils in her cunt waste no time massaging and teasing your cock' );
		if( CoC.flags[ kFLAGS.IZMA_NO_COCK ] === 0 ) {
			MainView.outputText( ', while Izma herself reaches around to jerk herself off.\n\n', false );
		} else {
			MainView.outputText( ', while Izma herself reaches up to massage her heavy breasts.\n\n' );
		}

		MainView.outputText( 'You wonder for a second if maybe it would be more dominant to stop her from pleasuring herself' );
		//RADAR XPACK FORK;
		if( CoC.flags[ kFLAGS.IZMA_NO_COCK ] === 0 ) {
			MainView.outputText( '.' );
			EngineCore.choices( 'Let Her', this, this.radarIzmaXPackLetHer, 'Deny Her', this, this.radarIzmaXpackDenyHer, '', null, null, '', null, null, '', null, null );
			return;
		}
		MainView.outputText( ', but decide it\'s probably better to let her have some \'hands on involvement\'.  Instead, you reach up to caress and fondle her breasts, gently tugging and rubbing her stiff nipples and giving them the occasional soft pinch.  The pretty tigershark responds well to your movements, moaning and gasping from pleasure.  She bites her lip, thankfully with her human teeth' );
		if( CoC.flags[ kFLAGS.IZMA_NO_COCK ] === 0 ) {
			MainView.outputText( ', and gains speed as she jerks her meat pole' );
		}
		MainView.outputText( '.\n\n', false );
		MainView.outputText( 'Seeing that she is speeding up, you accelerate your ' );
		if( CoC.flags[ kFLAGS.IZMA_NO_COCK ] === 0 ) {
			MainView.outputText( 'own ' );
		}
		MainView.outputText( 'thrusts, trying to match her pace.  The tendrils inside her vagina writhe and flex, an experience unlike anything you\'ve had before - you don\'t think any creature other than a succubus could give you this sort of pleasure!\n\n', false );
		MainView.outputText( 'Izma continues to moan and groan loudly, and starts to mash her own hips against yours, trying to work in as many inches of your ' + Appearance.cockNoun( CoC.player.cocks[ 0 ].cockType ) + ' as she can.  ' );
		if( CoC.flags[ kFLAGS.IZMA_NO_COCK ] === 0 ) {
		...
		if( CoC.flags[ kFLAGS.IZMA_NO_COCK ] === 0 ) {
			...
			MainView.outputText( ', a small explosion of fem-cum splattering your belly, and several subsequent squirts dripping down your thighs.  ' );
		}
		MainView.outputText( 'Her vagina clamps down on your ' + Descriptors.cockDescript( 0 ) + ', making you grunt as the feelers in her pussy milk you for all you\'ve got. You groan deep in your throat, the scent of Izma\'s hot ' );
		if( CoC.flags[ kFLAGS.IZMA_NO_COCK ] === 1 ) {
			MainView.outputText( 'girl-' );
		}
		MainView.outputText( 'cum filling your nostrils and the feeling of her milking, hungry feelers is too much.  You cum, blasting everything you have deep into Izma\'s cunt.  ', false );
		//[(Normal cum production);
		if( CoC.player.cumQ() < 750 ) {
			MainView.outputText( 'You pump straight into her womb, enough to make a trickle of your baby batter dribble from her freshly used cunt when you pull out.', false );
		}//(High cum production);
		else {
			MainView.outputText( 'Your load is so vast that it bloats and distends her belly, almost giving her a second orgasm from the sensations.', false );
		}
		MainView.outputText( '\n\n', false );
		MainView.outputText( 'The two of you roll apart, panting and gasping for breath.  "<i>Mmm, that was amazing,</i>" Izma says, giving you a long drawn-out kiss and ' );
		if( CoC.flags[ kFLAGS.IZMA_NO_COCK ] === 0 ) {
			MainView.outputText( 'licking some of her seed off of your face.  "<i>Come fill me whenever you need to.</i>"  You grin at Izma and order her to eat up every drop.\n\n', false );
		} else {
			MainView.outputText( 'licking you face affectionately.  "<i>Come fill me whenever you need to.</i>"  You grin back at Izma knowingly.\n\n', false );
		}

		if( CoC.flags[ kFLAGS.IZMA_NO_COCK ] === 0 ) {
			MainView.outputText( 'She giggles and runs her tongue over the mess she\'s made; her tongue lingers on your lips for a few moments before she gives you another long kiss and lets you go.', false );
		} else {
			MainView.outputText( 'She giggles and runs her tongue over your lips, her tongue lingering for a few moments before she gives you another long kiss and lets you go.', false );
		}
		//PREGGO CHANCES;
		this.izmaPreg();
		CoC.player.orgasm();
	...
	IzmaScene.prototype.wheresItGoing = function( denied ) {
		...
		if( !denied ) {
			...
			MainView.outputText( 'moans fiercely ' );
		}
		MainView.outputText( 'you can see long streams of pre dribble down her red cock, and know full well she\'s close to her limit.  Her cock stands at attention, ready to release its sticky load in your direction.' );
		MainView.outputText( '\n\nIt seems Izma cannot hold out much longer... where will you direct her orgasm?' );
		//[Your face]   [Your chest]   [Her face];
		EngineCore.choices( 'Your Face', this, this.facialWhereItGoesRadarIzmaXpack, 'Your Chest', this, this.RadarIzmaCumInYourChest, 'Her Face', this, this.IzmaSelfFacialWheeRadar, '', null, null, '', null, null );
	};
	...
	IzmaScene.prototype.RadarIzmaCumInYourChest = function() {
		...
		if( CoC.player.biggestTitSize() >= 1 ) {
			MainView.outputText( 'in between your ' + Descriptors.chestDesc() + ' and coats ' );
		}
		MainView.outputText( 'against your chest' );
		if( CoC.player.biggestTitSize() < 1 ) {
			MainView.outputText( ', coating it' );
		}
		MainView.outputText( ' liberally.  The aroma of your lover\'s spunk is too much, and with a great howl of undiminished, fulfilled satisfaction, you thrust one final time and plow deep into her, intent on burying your cock  firmly into her womb, unconsciously giving your seed the fighting chance it needs to fertilize your submissive partner.  With tremendous force, your spunk erupts forth and rushes deep inside of her pussy, ' );
		//[(Normal cum production);
		if( CoC.player.cumQ() < 750 ) {
			MainView.outputText( 'liberally lubricating her fuckhole with steamy cum and causing your beta to cry out in blissful pleasure.', false );
		}//(High cum production);
		else {
			MainView.outputText( 'flooding her love canal with so much sperm that a slew of wet, sloppy noises ring out from her pussy.  Izma\'s expression betrays a sense of utter disbelief as you stuff her full of your spooge; which begins to flow out of her at a steady rate as each contraction of your dick\'s muscles fires more and more into her.' );
		}
	...
	IzmaScene.prototype.IzmaSelfFacialWheeRadar = function() {
		...
		//[(Normal cum production);
		if( CoC.player.cumQ() < 750 ) {
			MainView.outputText( 'liberally lubricates her fuckhole with steamy cum and causes your luscious beta to cry out in blissful pleasure.', false );
		}//(High cum production);
		else {
			MainView.outputText( 'floods her love canal with so much sperm that a slew of wet, sloppy noises ring out from her pussy.  Izma\'s expression betrays a sense of utter disbelief as you stuff her full of your spunk, some of which begins to flow out of her at a steady rate, each contraction of your dick\'s muscles firing more and more into her.' );
		}
		...
		MainView.outputText( 'When she concludes with cleaning her Alpha, she takes a few moments to show you her appreciation for mating with her, kissing your chest and working her way up to your neck.' );
		//PREGGO CHANCES;
		this.izmaPreg();
		CoC.player.orgasm();
		EngineCore.dynStats( 'sen', -2 );
	...
	IzmaScene.prototype.followerIzmaTakesIt69 = function() {
		...
		//[(Male/herm);
		if( CoC.player.hasCock() ) {
			MainView.outputText( 'gorging herself on your ' + Descriptors.cockDescript( 0 ) + ', her tongue wrapping around it and caressing it like jewelry', false );
			//[(if herm);
			if( CoC.player.hasVagina() ) {
				MainView.outputText( ' while pushing two fingers into your ' + Descriptors.vaginaDescript( 0 ), false );
			}
		}
		//(Female);
		else if( CoC.player.hasVagina() ) {
			MainView.outputText( 'licking and eating you out, paying special attention to your ' + Descriptors.clitDescript(), false );
		}
		MainView.outputText( '.\n\n', false );
		if( CoC.flags[ kFLAGS.IZMA_NO_COCK ] === 0 ) {
			MainView.outputText( 'You wrap your lips around Izma\'s own massive erection, sucking and gagging on her almost-two-foot cock as she jerks and twists her hips around.  Her muffled moans seem to assure you that you\'re doing a great job, and Izma responds by increasing the speed of her head-bobbing.  Your vision is a little obscured by Izma\'s quartet of balls repeatedly bumping against your forehead and the bridge of your nose, but if anything this serves to arouse you further.\n\n', false );
		} else {
			MainView.outputText( 'You wrap your lips around Izma\'s puffy, inhuman lower lips, sucking and swallowing her fragrant fem-juices as she jerks and twists her hips around.  Her muffled moans seem to assure you that you\'re doing a great job, and Izma responds by increasing the speed of her head-bobbing.  Your vision is a little obscured by Izma\'s sinuous tail, but if anything this serves to arouse you further.\n\n', false );
		}
		...
		MainView.outputText( ' with her saliva, and as you\'re so eager for her magic tongue you start thrusting your hips up ', false );
		if( CoC.player.hasCock() ) {
			MainView.outputText( 'to reach ', false );
		} else {
			MainView.outputText( 'to push your ' + Descriptors.clitDescript(), false );
		}
		MainView.outputText( ' as far into her mouth as you can.\n\n', false );
		if( CoC.player.hasCock() ) {
			MainView.outputText( 'Eventually, the two of you manage to bring each other to a powerful simultaneous orgasm, Izma\'s hot cum shoots down your eager throat, and you ', false );
		} else {
			MainView.outputText( 'Eventually, the two of you manage to bring each other to a powerful simultaneous orgasm, Izma\'s slippery cum drenching your face, and you ' );
		}
		if( CoC.player.hasCock() ) {
			MainView.outputText( ' fire loads into Izma\'s cheeks', false );
			//[(multi);
			...
			MainView.outputText( 'drool a sticky mess over Izma\'s cheeks.', false );
		}
		MainView.outputText( '  The two of you roll away from each other, and while you catch your breath you\'re surprised at the strong taste of Izma\'s cum.  You don\'t think you\'d mind getting another load of that wonderful ' );
		if( CoC.flags[ kFLAGS.IZMA_NO_COCK ] === 1 ) {
			MainView.outputText( 'lady-' );
		}
		MainView.outputText( 'spunk in your stomach...\n\n', false );
	...
	IzmaScene.prototype.talkWivIzma = function() {
		...
		//[Talk option 2];
			...
			MainView.outputText( 'Curious, you ask if Izma has any personal encounters with either race.\n\n', false );
			MainView.outputText( 'She seems to blush slightly. "<i>Ah... I was with an anemone once.  I just sorta swam across her, the first one I saw, without knowing what she was.  I was kind of horny already, and when she started caressing me... well, let\'s just say I emptied my quad... I ended up beating her down.  Her tentacles wrapped around me, and then instincts took over and, uh, I tried to fight back and dominate her...</i>"\n\n', false );
			MainView.outputText( 'You try to picture it in your head... the image is surprisingly arousing. Shaking it away, you ask if there\'s actually anything normal still in the lake.  She frowns.  "<i>There are some normal fish, their meat has kind of a weird tang to it, but they\'re edible.  Sorry, it\'s a big lake and even I haven\'t explored everywhere. Who knows what else could be hiding out around there?</i>"\n\n', false );
			MainView.outputText( 'You thank Izma for being willing to talk to you, then you politely excuse yourself and leave her to her thoughts.', false );
			//(Slight lust gain);
			EngineCore.dynStats( 'lus', 5 );
			CoC.flags[ kFLAGS.UNKNOWN_FLAG_NUMBER_00239 ]++;
			EngineCore.doNext( SceneLib.camp, SceneLib.camp.returnToCampUseOneHour );
		...
		//[Talk topic 4.];
			...
			MainView.outputText( 'You thank her for telling you such personal things.  As you get ready to walk away, though, you stop and turn back to her. She mentioned wanting kids with \'someone special\'.  Out of curiosity, you ask what sort of family she wants for herself.\n\n', false );
			MainView.outputText( '"<i>Guess it depends what giving birth is like,</i>" she replies, winking.  "<i>Though I certainly don\'t plan on being some goblin breeder.</i>" Whereupon she sticks her tongue out at you.  You laugh, asking if she\'s saying she\'s not opposed to being the one to get pregnant.  She cocks her head as if the idea hadn\'t occurred to her to find anything strange about it.  You clarify that you were asking if Izma objects to having to carry children herself, since ' );
			if( CoC.flags[ kFLAGS.IZMA_NO_COCK ] === 1 ) {
				MainView.outputText( 'she used to have a ' );
			} else {
				MainView.outputText( 'she\'s got a ' );
			}
			MainView.outputText( 'perfectly functional set of male genitalia.\n\n', false );
			if( CoC.flags[ kFLAGS.IZMA_NO_COCK ] === 0 ) {
				MainView.outputText( '"<i>Oh, nah.  Pfft, as if that\'s a challenge,</i>" she says.  It\'s interesting to see how Izma, as a hermaphrodite, thinks of herself when it comes to the most basic of gender roles.  She scratches her chin in thought.  "<i>Well, sexually, I\'m more accustomed to my penis, since it\'s a bit easier to dominate with and the lake life seems to fixate on it.  But for you, I\'ll use whichever you want.</i>"\n\n', false );
			} else {
			...
			MainView.outputText( 'You could just leave it at this, or you could try flirting with Izma - you might get more than you bargained for if you did that, though.  Which will you do?', false );
			CoC.flags[ kFLAGS.UNKNOWN_FLAG_NUMBER_00239 ]++;
			//[Leave] [Flirt];
			EngineCore.choices( 'Flirt', this, this.chooseToFlirtWithIzma, '', null, null, '', null, null, '', null, null, 'Leave', this, this.chooseNotToFlirtWithIzma );
			return;
		}
		//[Talk option 5];
		else if( CoC.flags[ kFLAGS.UNKNOWN_FLAG_NUMBER_00239 ] === 4 ) {
			MainView.outputText( 'You can\'t help but notice that Izma has another book nearby.  In fact, she\'s the most avid reader you can recall meeting - you\'re not sure if anyone back in your village liked to read like she does, never mind anyone else in this sex-mad world.  It\'s such a stark contrast to the shark-girls you met before Izma... you wonder why she acts so different.  It can\'t be the fact she\'s a herm; she\'s proven she\'s just as amorous as they are when she\'s turned on, and if anything it makes her easier to turn on.  So why is it that she can control herself enough to be civil when her female kinsfolk can\'t?\n\n', false );
			MainView.outputText( 'When you realize Izma is staring at you, waiting patiently, you can\'t resist asking her why she is so... well, so sedate compared to the other shark-girls.\n\n', false );
			MainView.outputText( 'She scratches her chin in thought, "<i>I... well, honestly I don\'t know.  I remember that shortly after my change, I was fucking shark girls to take care of my lust... but I was always frustrated \'cause I knew I\'d be horny again in a short span of time,</i>" she explains.  "<i>But then, as I walked along, I found my trunk.  I\'d set it up before, outside my old village, as a place to store my books, a place where I could read in peace... and I just started to carry it around with me when I moved so I could read.</i>"\n\n', false );
			MainView.outputText( '"<i>The books just sort of... distracted me from my lust, helped me calm down.  I mean, now I read almost all the time so I can act at least semi-normal around people.  Still, the lust is always present, like a buzzing in my mind and groin,</i>" she explains.  You tell her that she\'s certainly much more fortunate; you\'ve seen the other shark-girls, and they don\'t seem to care about anything besides sex and violence.\n\n', false );
			MainView.outputText( 'She blushes bright red and hugs herself close to you.  "<i>You\'re so nice to me, my Alpha...</i>"  You wrap her back, enjoying her tender embrace.' );
			if( CoC.flags[ kFLAGS.IZMA_NO_COCK ] === 0 ) {
				MainView.outputText( '..  and patiently ignoring the fact you can feel her cock starting to stiffen against your thigh.' );
			}
			MainView.outputText( '  You release her, trying to avoid turning her on too much.  Thanking her for the talk, you leave as she buries herself back into her books.', false );
			CoC.flags[ kFLAGS.UNKNOWN_FLAG_NUMBER_00239 ]++;
			EngineCore.doNext( SceneLib.camp, SceneLib.camp.returnToCampUseOneHour );
			return;
		}
		//[Talk Option 6];
			...
			MainView.outputText( 'You tell Izma you\'re curious; you\'ve seen shark-girls before, but you\'ve never seen one quite like her before. Are there a lot other shark herms like her?\n\n', false );
			MainView.outputText( 'Izma tilts her head to the side, "<i>Oh, no... all shark herms are called tigersharks,</i>" she says.  "<i>A nickname on account of the stripes... though, from the way some of the locals giggle, I think there\'s an innuendo in the name somewhere.  We\'re a little sub-species among the sharks, a whole group of herms.  The ones who were closest to the chemical bloom when the pollution started underwent a change, just like I did.</i>"  Inquisitively, you ask if the change was in response to them originally being boys and men?  Or was it just a matter of sheer concentrated chemicals and so there were women who grew cocks as well as men who became half-women?\n\n', false );
			MainView.outputText( '"<i>Um...</i>" Izma says, rubbing her temples as she tries to remember exactly what happened.  "<i>When I was there... yeah, there were some men and some women who underwent the change.  We were all shocked but... well, the endowments were certainly pleasing.</i>"\n\n', false );
			MainView.outputText( 'So, both genders became herms.  The obvious question fills the space between you.  Was Izma originally a boy?  Or a girl?\n\n', false );
			MainView.outputText( 'She gives you a giggle and leans over.  "<i>Why?  Would it bother you either way?</i>"  You swat her on the nose lightly by way of response.  Still, you can\'t resist commenting how odd it is that only those men who were struck directly by the concentrated poisons kept something of their masculinity, with all the others turning completely into girls.  One would have thought it made more sense for the concentrated stuff to fully gender-bend them and the diluted stuff to only partially feminize them, leaving them as herms.\n\n', false );
			MainView.outputText( '"<i>I\'m not all that sure on the nature of the chemicals, but I think they\'re designed expressly to make people into herms,</i>" she replies.  "<i>The more dilute chemicals just affected peoples\' minds and genitalia.</i>"\n\n', false );
			MainView.outputText( 'Puzzled, you ask her; then why do herms seem to be so rare?  You haven\'t seen any hermaphroditic sharks other than Izma herself; all of the other shark people you\'ve met have been girls.  Doesn\'t that mean that most of the men were turned into shark-girls?\n\n', false );
			MainView.outputText( 'Izma bites her lip.  "<i>The males are mostly... chained up,</i>" she explains.  "<i>Nobody\'s sure why, but, when the taint hit, all the males became not only a lot bigger and stronger, but VERY aggressive, and consumed by a state of constant rut.  They\'re ultra-fertile, but they\'re certainly rough when they get going... they make the female sharks you\'ve met look like goblins with tummy-aches.</i>"\n\n', false );
			MainView.outputText( 'You shake your head in disbelief; she sighs and her voice cracks a little as she continues.  "<i>But... the worst thing is that all of the sharks are so far gone that none of them seem to really know who they\'re chaining up or who\'s chaining them... who those people USED to be.</i>"  She gives a sigh and removes her glasses, wiping at her eyes with the back of her hand.\n\n', false );
			MainView.outputText( 'A grim thought takes shape and you ask if Izma and her people are forced to chain up their male children alongside the former men of their village.  "<i>Shark-men don\'t seem to occur naturally,</i>" she replies, "<i>there hasn\'t been a boy shark born to a shark-girl or a tigershark ever since we were all transformed.  There are special shark tablets that can make people into shark-men but... well, it\'s a fate I wouldn\'t wish on anyone.</i>"\n\n', false );
			MainView.outputText( 'Hesitantly, you ask if tigersharks like Izma can breed - and if they can, is their condition inheritable? Or can they only sire or bear more shark-girls?  She nods.  "<i>Yeah, we can breed - both in the sense of bearing and siring offspring, and in the sense you\'re talking about.  We\'re not ultra-fertile like the shark-men, but we can - and do - get the job done, and we do both father and give birth to more tigersharks.  Honestly, there\'re more second and third generation tigersharks than there are first generation.  They\'re born less frequently than the normal girls are, but not exceptionally so - maybe about 4 in 10, not something like 1 in 10 or 1 in 100.</i>"\n\n', false );
			MainView.outputText( 'You thank Izma for talking to you, insisting that you didn\'t mean to hurt her by probing such painful memories.  She smiles warmly at you and hugs you tight.  "<i>It\'s okay. It... it feels nice to be able to share that information with someone,</i>" she says, giving you a small kiss as she slips her glasses back on.', false );
			CoC.flags[ kFLAGS.UNKNOWN_FLAG_NUMBER_00239 ] = 0;
			EngineCore.doNext( SceneLib.camp, SceneLib.camp.returnToCampUseOneHour );
			return;
		}
	};
	...
	IzmaScene.prototype.chooseToFlirtWithIzma = function() {
		...
		if( CoC.flags[ kFLAGS.IZMA_NO_COCK ] === 0 ) {
			MainView.outputText( 'her huge cock barely able to poke past her baby-filled belly, ' );
		}
		MainView.outputText( 'her DD-cups full of milk, watching as she waddles around the camp, is a very attractive one.  She smirks at you 0.  "<i> You\'re such a perv.</i>"' );
		if( CoC.flags[ kFLAGS.IZMA_NO_COCK ] === 0 ) {
			MainView.outputText( '  But she glances between her legs and sees her massive cock poking out of her skirt.' );
		} else {
			MainView.outputText( '  But she glances down to behold her rock-hard nipples jutting out.' );
		}

		MainView.outputText( '  "<i>Though, you do paint a rather vivid image with words...</i>"\n\n', false );
		if( CoC.flags[ kFLAGS.IZMA_NO_COCK ] === 0 ) {
			MainView.outputText( 'Smiling back, you ask about her mental image of you being pregnant with her babies.  "<i>Um...</i>"  She trails off.', false );
			//[(If player is male/genderless);
			if( CoC.player.gender <= 1 ) {
				MainView.outputText( '  "<i>That\'s kinda weird, man... I\'m not sure the god in charge of this world would allow something like that.  It seems too silly.</i>"', false );
				EngineCore.doNext( SceneLib.camp, SceneLib.camp.returnToCampUseOneHour );
				return;
			}
			///(Female/herm);
			else {
				MainView.outputText( '  "<i>Oh... you\'d be so big and curvy, so sexy,</i>" she purrs.  You advance towards her.  Leaning in, you mention you\'re willing to try and make a baby, right here and now.  "<i>I... oh, wow.  We could certainly try,</i>" she replies, grabbing your neck and pulling you in for a kiss.', false );
			}
		}
		this.izmaSexMenu();
	};
	...
	IzmaScene.prototype.childToggle = function() {
		...
		if( CoC.flags[ kFLAGS.UNKNOWN_FLAG_NUMBER_00248 ] === 0 ) {
			MainView.outputText( 'You ask Izma if she\'s ever thought about the two of you having children together.\n\n', false );
			MainView.outputText( 'Izma looks a little sheepish, but then her expression settles into a determined one.  "<i>Yes, I have.  I\'d like us to start a family, but if you don\'t think you\'re ready yet, I\'ll keep taking my herbs.</i>"\n\n', false );
			MainView.outputText( 'Do you tell her to stop taking her contraceptives?', false );
			//Yes - call this function again;
			EngineCore.doYesNo( this, this.childToggle, this, this.firstTimeDeclineIzmasKdiddlezlijfhdjkfhslkfbsjkhfbs );
			CoC.flags[ kFLAGS.UNKNOWN_FLAG_NUMBER_00248 ]++;
			return;
		}
		//Turn it off;
		else if( CoC.flags[ kFLAGS.UNKNOWN_FLAG_NUMBER_00249 ] === 1 ) {
			//Sex Menu Button: No Kids;
			MainView.outputText( 'You tell Izma that you\'ve been thinking, and that the two of you should put making children together on hold, at least for a while.  Izma looks a little upset, but she nods her head.  "<i>By your command, alpha,</i>"  she tells you.  She ambles slowly away from you, her hips and ass swaying side to side in a very enticing manner; you think maybe she\'s trying to tempt you into changing your mind.  When you don\'t speak up, though, she reaches into and rummages through her chest for one of her contraceptive herbs, turning towards you and making sure you can see her taking it.\n\n', false );
			///Return to Sex Menu options/;
			CoC.flags[ kFLAGS.UNKNOWN_FLAG_NUMBER_00249 ] = 0;
		}
		//[=Yes=] (TURN ON KID-MODE;
		else {
			CoC.flags[ kFLAGS.UNKNOWN_FLAG_NUMBER_00249 ] = 1;
			//Make kids and has said yes before.;
			if( CoC.flags[ kFLAGS.IZMA_CHILDREN_SHARKGIRLS ] + CoC.flags[ kFLAGS.IZMA_CHILDREN_TIGERSHARKS ] > 0 ) {
				MainView.outputText( 'You tell Izma that you\'re ready to start trying for children again.  She grins with delight and suddenly pounces at you, giving you a kiss that leaves you breathless.  Then, while you\'re recovering from that, she races off and drinks down a slug of that potion - you figure it must be some kind of \'antidote\' to the contraceptives already in her system.  From the gleam in her eye as she stalks back towards you, it looks like she intends to start making babies right now...\n\n', false );
			} else {
				MainView.outputText( 'You give Izma a knowing look and tell her that you\'re ready to start having children - if she is.\n\n', false );
				MainView.outputText( 'She stares at you, dumbfounded for a moment, then her eyes light up and she gives you the widest grin, displaying her shark teeth for an extra layer of formidability.  She practically skips over to her chest, flinging it open and all but diving inside, her happily-waving tail giving you an excellent look at her shapely rear.  She emerges with a triumphant cry, a small potion vial in her fingers.  She pops the cork and gulps it down, then crushes the bottle in her hand and spins to face you, a wickedly happy expression on her face as she saunters towards you.  "<i>Well then... let\'s get started, shall we?</i>" she croons.\n\n', false );
			}
		}
		EngineCore.doNext( this, this.izmaFollowerMenu );
	};
	...
	IzmaScene.prototype.IzmaPoopsBabies = function() {
		...
		MainView.outputText( 'You take a stand behind and slightly beside her. Looking to comfort her however it\'s possible, you start to massage her taut midriff; you can feel the muscles contracting as they work to expel the baby into the world outside, the child inside wriggling and thrashing like a fish on a hook... all right, bad simile.\n\n', false );
		MainView.outputText( '"<i>Fondle me,</i>" Izma suddenly says.  As you look at her in surprise, she nods vaguely in the direction of her crotch. "<i>Please, start ' );
		if( CoC.flags[ kFLAGS.IZMA_NO_COCK ] === 0 ) {
			MainView.outputText( 'jerking me off or ' );
		}
		MainView.outputText( 'playing with my cunt; we learned it helps with the pain of birth a long time ago.</i>"\n\n', false );
		MainView.outputText( 'Nodding your head, you reach around with one hand.  ' );
		if( CoC.flags[ kFLAGS.IZMA_NO_COCK ] === 0 ) {
			MainView.outputText( 'Divvying your time between her raging erection, quartet of sizable balls and dilating cunt while she strains under you is an awkward experience, but you persevere; when Izma stops hissing and gasping in pain and starts instead moaning lightly, it seems more worthwhile.\n\n', false );
		} else {
			MainView.outputText( 'Divvying your time between her dilating cunt and engorged clit while she strains under you is an awkward experience, but you persevere.  When Izma stops hissing and gasping in pain and starts instead moaning lightly, it seems more worthwhile.\n\n', false );
		}

		MainView.outputText( 'You\'re not sure how long you are there, working with her, before she lets out a particularly loud gasp and the water is clouded with blood and amniotic fluid.  As the current disperses it, you can see the webbed hands and exploratory head of your daughter protruding from her mother.  It\'s a shocking sight to see; grisly village midwife stories run through your head.  You manage to smile at Izma with what you think is reassurance, hoping quietly that it won\'t be long now.\n\n', false );
		MainView.outputText( 'Izma then screws her face up, pointing it skywards as she screams from the back of her throat, the sound clawing its way past grit teeth and her stoicism.  At last, the baby\'s lower torso is pushed free of her and, once loose, instincts kick in.  It swims for the surface, popping up above the water and taking its first breath of real air.\n\n', false );
		MainView.outputText( 'Quickly you take hold of its hand, then help Izma take it up into her arms once she\'s regained her strength.  You are now the proud parents of a baby ', false );
		if( Utils.rand( 100 ) <= 59 ) {
			MainView.outputText( 'shark-girl', false );
			CoC.flags[ kFLAGS.IZMA_CHILDREN_SHARKGIRLS ]++;
		} else {
			MainView.outputText( 'tigershark', false );
			CoC.flags[ kFLAGS.IZMA_CHILDREN_TIGERSHARKS ]++;
		}
		MainView.outputText( ', which nuzzles affectionately against its mother before latching onto her nipple and starting to drink.  As it drinks, it grows; by the time it empties Izma\'s first breast, it\'s easily the size of a five year old.  When it\'s finished its meal and belches loudly in satisfaction, it\'s the size of a pre-teen.  Izma takes its rapid development in stride, mother and daughter happily embracing each other.\n\n', false );
		MainView.outputText( 'You help Izma climb back onto shore with your new baby, then lay them both down to rest.  Once they\'re settled down comfortably, cuddling up against each other, you turn and head back to camp, looking to dry yourself off and catch a quick nap.', false );
		EngineCore.doNext( SceneLib.camp, SceneLib.camp.returnToCampUseOneHour );
	};
	...
	IzmaScene.prototype.pcPopsOutASharkTot = function() {
		...
		if( CoC.flags[ kFLAGS.UNKNOWN_FLAG_NUMBER_00238 ] !== 1 ) {
			if( CoC.player.vaginas.length === 0 ) {
				MainView.outputText( 'You feel a terrible pressure in your groin... then an incredible pain accompanied by the rending of flesh.  You look down and behold a vagina.  ', false );
				CoC.player.createVagina();
				CoC.player.genderCheck();
			}
			MainView.outputText( 'You crumple suddenly; strong pains and pressures pulverize the nerves in your gut.  As your eyes shoot wide open, you look down to see your belly absurdly full and distended.  You can feel movement underneath the skin, and watch as its bulges and shifts reflect another living being moving independently inside you.  Instinctively, you spread your legs as you feel the creature press outward, parting your cervix and allowing a gush of water to spill forth - far more water than you thought you were holding.\n\n', false );
			MainView.outputText( 'You cry out as the first wrenching labor pain begins in earnest, unthinkingly hoping for somebody to come and help you.  Much to your despair, no one does, leaving you alone to deliver the baby.  You double your focus, set on pushing in time with its own frantic attempts to escape.  Squeezing over and over, you try to force out the child before the pain robs you of consciousness; luckily it seems to oblige, sliding out of you legs-first after a few more pushes.  The shark-skin rasps your inflamed pussy, drawing gasps of shock from you as she squeezes past your lips in fits and starts.', false );
			CoC.player.cuntChange( 100, true, true, false );
			MainView.outputText( '\n\n', false );
			MainView.outputText( 'Finally, she\'s out; you quiver weakly as she crawls over to you and it takes all your effort to lift your ' + CoC.player.armorName + ' and expose your ' + Descriptors.nippleDescript( 0 ) + 's to her.  As she sucks greedily at them, the haze begins to clear from your vision.  For the first time, you can actually make out distinct features on your new daughter; she\'s a ', false );
			if( Utils.rand( 100 ) <= 59 ) {
				MainView.outputText( 'shark-girl', false );
				CoC.flags[ kFLAGS.UNKNOWN_FLAG_NUMBER_00412 ]++;
			} else {
				MainView.outputText( 'tigershark', false );
			}
			MainView.outputText( ', quickly growing and filling out as she takes in milk.  She finishes up, looking rather like a pre-teen already, and glances around nervously.  The amniotic fluid is evaporating rapidly, and she\'s scratching idly at her gills as more and more of her skin is exposed directly to the dry air.\n\n', false );
			...
			MainView.outputText( 'You can feel movement underneath the skin, and watch as it bulges and shifts as another living being moves independently inside you.  Instinctively, you spread your legs as you feel the creature press outward, parting your cervix and allowing a gush of water to spill forth - far more water than you thought you were holding.\n\n', false );
			MainView.outputText( 'You cry out as the first wrenching labor pain begins in earnest, unthinkingly hoping for somebody to come and help you.  To your relief, Izma comes running over to you from out of the gloom.  "<i>' + CoC.player.short + '!  You\'ve gone into labor?</i>" she asks; something of a stupid question, but she\'s evidently as off-guard as you are.\n\n', false );
			MainView.outputText( '"<i>Do you think you can walk?  Make it to the stream?</i>" she asks.\n\n', false );
			MainView.outputText( 'You throw her a dirty look, and make it quite emphatically clear that with how strong these contractions are, you don\'t think you could stand, never mind walk that way.\n\n', false );
			MainView.outputText( '"<i>Right, sorry.</i>" She has the courtesy to look chagrined, at least.\n\n', false );
			MainView.outputText( 'She unhesitatingly steps up and kneels before you, one hand reaching out to stroke your swollen orb of a belly, the other trailing around the edges of your ' + Descriptors.vaginaDescript( 0 ) + ' in a manner at once sensual and professional. "<i>Don\'t worry, ' + CoC.player.short + '; I\'m going to help you get through this.</i>" The tigershark promises you.\n\n', false );
			MainView.outputText( 'You point out it\'s the least she can do, seeing as how she\'s the one who put this thing in you in the first place, then turn your attention back fully to the task of bringing your offspring into the world.\n\n', false );
			MainView.outputText( 'Time slips away; you\'re too overwhelmed by the pain of your womb contracting and the pleasure as Izma ministers to your ' + Descriptors.vaginaDescript(), false );
			if( CoC.player.hasCock() ) {
				MainView.outputText( ' and ' + Descriptors.multiCockDescriptLight(), false );
			}
			MainView.outputText( ', which makes the birth pangs become less painful and more orgasmic. You lose yourself in the haze to the point you\'re barely aware when the birth finally comes to an end; you feel a great pressure welling up inside you, an overwhelming urge to push, and then, the next thing you know, relief washes over you as your stomach deflates.', false );
			CoC.player.cuntChange( 100, true, true, false );
			MainView.outputText( '\n\n' );
			MainView.outputText( '"<i>We\'ve got her, ' + CoC.player.short + '! Whoa- hold still, you slippery little girl! Stop wriggling so much, you\'re out now, it\'s me, your daddy!</i>" Izma cries out. As you regain your strength and your vision clears, you are presented with the sight of Izma trying desperately to wrangle a squirming baby shark-morph; from her ', false );
			var type = 0;
			if( Utils.rand( 100 ) <= 59 ) {
				MainView.outputText( 'grey', false );
				type = 0;
				CoC.flags[ kFLAGS.IZMA_CHILDREN_SHARKGIRLS ]++;
			} else {
				MainView.outputText( 'black-striped orange', false );
				type = 1;
				CoC.flags[ kFLAGS.IZMA_CHILDREN_TIGERSHARKS ]++;
			}
			MainView.outputText( ' skin, it\'s obvious she\'s a baby ', false );
			if( type === 0 ) {
				MainView.outputText( 'shark-girl', false );
			} else {
				MainView.outputText( 'tigershark', false );
			}
			MainView.outputText( '. Finally, she calms down in her "<i>daddy\'s</i>" arms, looking around with surprising aclarity for a newborn. She sees you and holds her arms out, making strange babbling noises; she has no teeth at all, from what you can see. Izma walks over to you, smiling proudly, and lets you hold your new baby girl, who nuzzles against you and then immediately turns her attention towards your milky breasts.\n\n', false );
			MainView.outputText( 'She latches onto the ' + Descriptors.nippleDescript( 0 ) + ' and starts to suckle for all she\'s worth, waves of pleasure both sexual and maternal filling you, overwhelming you with bliss. Oblivious to everything else, you hold her against your breast, allowing her to sate her incredible appetite. She drinks your breast dry, and then immediately latches onto the next one.', false );
			if( CoC.player.breastRows.length > 1 ) {
				MainView.outputText( '  She then starts on your third breast, and while she slows down at the fourth breast, she still finishes it off.', false );
			}
			//(If player has six breasts: ;
			if( CoC.player.breastRows.length > 2 ) {
				MainView.outputText( '  She seems to almost be struggling to finish off your third pair, but she manages to suck all six of your breasts dry.', false );
			}
			MainView.outputText( '  Once she is done, she lets go with a wet popping sound, then starts to gasp for breath before letting out a surprisingly loud, deep belch for such a little thing.\n\n', false );
			MainView.outputText( '...Okay, maybe not so little. Before, she was the size of a human baby. Now, you\'re holding a fairly grown young ', false );
			if( type === 0 ) {
				MainView.outputText( 'shark-girl', false );
			} else {
				MainView.outputText( 'tigershark', false );
			}
			MainView.outputText( '; physically, you\'d have to say she was anywhere from ten to thirteen years old. She grins at you, displaying both rows of teeth, and then kisses you on the lips. "<i>Mama.</i>" She states, clearly and contendly, then visibly relaxes, nuzzling into your arms and closing her eyes, clearly intent on drifting off to sleep.\n\n', false );
			MainView.outputText( 'You look up at the tigershark who fathered her for support, but she just smiles and flops down beside you as well. With a soft sigh, you simply lay back and enjoy your strange new family being there with you. When you wake in the morning, Izma will have taken your daughter to stay at the stream with her; it\'s important for young shark-folk to be moist, constantly.\n', false );
			CoC.player.orgasm();
	...
	IzmaScene.prototype.izmaKidsPlaytime = function() {
		...
		if( CoC.flags[ kFLAGS.IZMA_CHILDREN_TIGERSHARKS ] + CoC.flags[ kFLAGS.IZMA_CHILDREN_SHARKGIRLS ] >= 2 ) {
			choices.push(3);
		}
		choices.push(4);
		choices.push(5);
		...
		if( CoC.time.hours < 10 && CoC.flags[ kFLAGS.ANEMONE_KID ] > 0 && Utils.rand( 2 ) === 0 ) {
			SceneLib.anemoneScene.kidAWatchesSharks();
			return;
		}

		MainView.outputText( 'Izma shows you to an isolated bend in the stream; this is where your children have chosen to settle themselves.  Though they have the physiques and minds of pre-teens already, it will still be several years before they are fully grown and ready to leave you and Izma.  ', false );
		if( CoC.flags[ kFLAGS.IZMA_CHILDREN_SHARKGIRLS ] + CoC.flags[ kFLAGS.IZMA_CHILDREN_TIGERSHARKS ] === 1 ) {
			MainView.outputText( 'There is ', false );
		} else {
			MainView.outputText( 'There are ', false );
		}
		if( CoC.flags[ kFLAGS.IZMA_CHILDREN_SHARKGIRLS ] > 0 ) {
			if( CoC.flags[ kFLAGS.IZMA_CHILDREN_SHARKGIRLS ] === 1 ) {
				MainView.outputText( 'one shark-girl', false );
			} else {
				MainView.outputText( Utils.num2Text( CoC.flags[ kFLAGS.IZMA_CHILDREN_SHARKGIRLS ] ) + ' shark-girls', false );
			}
			if( CoC.flags[ kFLAGS.IZMA_CHILDREN_TIGERSHARKS ] > 0 ) {
				MainView.outputText( ' and ', false );
			}
		...
		if( CoC.flags[ kFLAGS.IZMA_CHILDREN_TIGERSHARKS ] > 0 ) {
			if( CoC.flags[ kFLAGS.IZMA_CHILDREN_TIGERSHARKS ] === 1 ) {
				MainView.outputText( 'one tigershark', false );
			} else {
				MainView.outputText( Utils.num2Text( CoC.flags[ kFLAGS.IZMA_CHILDREN_TIGERSHARKS ] ) + ' tigersharks', false );
			}
		}
		MainView.outputText( ' living here; the fruits of your love with Izma.\n\n', false );
		...
		if( choice === 1 ) {
			if( CoC.flags[ kFLAGS.IZMA_CHILDREN_TIGERSHARKS ] === 1 ) {
				MainView.outputText( 'Your lone tigershark daughter is off by herself, experimentally stroking and fondling her already-impressive cock.  It doesn\'t look like it\'ll be long before she cums; her face is already screwed up in an expression of curious pleasure, gasping softly at the sensations.', false );
			}
			//(Requires 2-3 Tigersharks: ;
			else if( CoC.flags[ kFLAGS.IZMA_CHILDREN_TIGERSHARKS ] < 4 && CoC.flags[ kFLAGS.IZMA_CHILDREN_TIGERSHARKS ] > 0 ) {
				MainView.outputText( 'Your tigershark daughters are seated together, each experimentally stroking and fondling her sizable erection.  It looks like they\'re competing to see who will cum first.', false );
			}
			//(Requires 4+ Tigersharks:;
			else if( CoC.flags[ kFLAGS.IZMA_CHILDREN_TIGERSHARKS ] > 0 ) {
				MainView.outputText( 'Your tigershark daughters are seated together, each experimentally jerking off either her own cock or one of her sisters.  Some look to be competing to see who can jerk themselves off first, others are evidently seeing who\'s better at handjobs.', false );
			}
			if( CoC.flags[ kFLAGS.IZMA_CHILDREN_TIGERSHARKS ] > 0 ) {
				MainView.outputText( '  Izma blushes and explains that your children have strong libidos, so it\'s natural for them to experiment like this.  She assures you that they won\'t do any real sexual penetration with a family member.\n\n', false );
			}
		}
		//#2: (Requires at least 1 Tigershark);
		//NOPE;
		else if( choice === 2 ) {
			MainView.outputText( 'You see your daughter has caught a goblin who managed to find her way to this nook.  It doesn\'t look like either of them mind, though; she\'s roughly but eagerly stuffing herself into the squealing green-skinned slut\'s pussy, much to the goblin\'s pleasure.  She sees you and gives you a lewd wink.  "<i>You\'ve got a fine-ass daughter here; don\'t worry, I\'ll give you plenty of grandkids,</i>" she jeers, then gives a lusty moan as your daughter finally reaches her limit and cums inside her, bloating the goblin\'s belly with spunk.', false );
			//Other children:;
			if( CoC.flags[ kFLAGS.IZMA_CHILDREN_TIGERSHARKS ] + CoC.flags[ kFLAGS.IZMA_CHILDREN_SHARKGIRLS ] > 2 ) {
				MainView.outputText( '  Your other kids are gathered around, watching with amusement and a little envy as one of your tigershark offspring plows an excited goblin.  "<i>Oh, yeah, baby, now you folks know how to live!</i>" she cheers.', false );
			}
			if( CoC.flags[ kFLAGS.IZMA_CHILDREN_TIGERSHARKS ] > 2 ) {
				MainView.outputText( '  "<i>Don\'t worry; you\'ll get a chance to use a beautiful big cock on me, too - just wait your turn!</i>" she laughs looking around the circle.  Your other daughters look like they can\'t wait.', false );
			}
		...
		if( choice === 5 ) {
			...
			if( CoC.flags[ kFLAGS.IZMA_CHILDREN_TIGERSHARKS ] + CoC.flags[ kFLAGS.IZMA_CHILDREN_SHARKGIRLS ] === 1 ) {
				MainView.outputText( 'child perks up to see Izma and comes running over to her, throwing herself into her arms', false );
			} else {
				MainView.outputText( 'children perk up to see Izma and come running over to her, throwing themselves into her arms', false );
			}
			MainView.outputText( '.  She laughs in delight and sits down on the bank, reaching for a book she has in a bag at her side.  Your offspring ', false );
			if( CoC.flags[ kFLAGS.IZMA_CHILDREN_TIGERSHARKS ] + CoC.flags[ kFLAGS.IZMA_CHILDREN_SHARKGIRLS ] === 1 ) {
				MainView.outputText( 'cries out in joy at the prospect of storytime and eagerly seats herself in front of her, listening as she starts to read.', false );
			} else {
				MainView.outputText( 'cry out in joy at the prospect of storytime and eagerly seat themselves in front of her, listening as she starts to read.', false );
			}
			MainView.outputText( '  You remain there for a while, listening, but eventually you think of your duties as champion and you have to take your leave of them.', false );
		}
		//#6: (Requires 2+ shark-girls);
		//NOPE;
		if( choice === 6 ) {
			MainView.outputText( 'You see that two of your shark-girls are hugging each other in a way that, at first glance, seems familial.  As you get closer, though, you can see it\'s somewhat less than sisterly; each is groping the other\'s breasts, experimentally playing with her sibling\'s boobs to see what makes her gasp and moan in pleasure.  Their faces are pressed together in a very unchaste kiss.  Izma blushes and hastily explains that your children have strong libidos, so it\'s natural for them to experiment like this.  She assures you that they won\'t do anything really sexual with each other - and, even if they did, it\'s not like anything can come of a little harmless girl-on-girl, right?', false );
		}
		EngineCore.doNext( SceneLib.camp, SceneLib.camp.returnToCampUseOneHour );
	};
	IzmaScene.prototype.inCampRideIzmasDickDongTheWitchIsDead = function() {
		...
		MainView.outputText( 'fuckhole meaningfully, telling her to lie down and let you give her fifteen inches and four balls a run.\n\n', false );
		MainView.outputText( 'Izma gives a happy squeal in response, before blushing and clearing her throat.  "<i>Ah ha... of course, my Alpha,</i>" she replies curtly.  She lies down on the ground and her giant dong stands straight to attention, waiting for your ' + Descriptors.vaginaDescript() + '.\n\n', false );
		MainView.outputText( 'Slowly and sensuously you remove your ' + CoC.player.armorName + ', exulting in the way Izma hungrily drinks in every inch of exposed ' + CoC.player.skinFurScales() + '.  Her eyes devour your ' + Descriptors.allBreastsDescript() + ', then slide eagerly down to your crotch to feast upon', false );
		if( CoC.player.hasCock() ) {
			MainView.outputText( ' ' + Descriptors.sMultiCockDesc(), false );
			if( CoC.player.balls > 0 ) {
				MainView.outputText( ' and ' + Descriptors.ballsDescript(), false );
			}
			MainView.outputText( ' before going to the main attraction:', false );
		}
		MainView.outputText( ' your pussy.  You sashay over to the prone tigershark, your ' + Descriptors.hipDescript() + ' swaying in a fashion that has her hypnotised.  By the time you reach her, her cock is visibly bubbling pre from the slit and drooling it down onto her four swollen balls, which sit in a steadily-growing puddle of feminine juices. Smiling hungrily, you gently stroke her long, crimson-hued cock, playfully asking what such a little girl is doing with such a big, hard thing.\n\n', false );
		MainView.outputText( 'Izma pants and giggles in response, licking her lips at the little show you\'re putting on for her.  "<i>Big?  Me?  Haha...</i>"  She gasps and moans as you rub at her head.  "<i>There are much bigger fish in those lake waters...</i>" she pants, winking at you.  You don\'t know if she\'s joking or not.\n\n', false );
		MainView.outputText( 'You purse your lips thoughtfully, and feign entertaining the idea that maybe you should throw this small fry back... then you shake your head and grin.  No, you declare, this is plenty big enough for you.\n\n', false );
		MainView.outputText( '"<i>Oh, thank you... I feel like I\'ll go crazy if I have to wait much longer,</i>" Izma purrs, placing her hands behind her head and thrusting her chest out at you to entice you.\n\n', false );
		MainView.outputText( 'You smile and bend over, hungrily kissing and suckling at her impressive breasts, squeezing them firmly to squeals of delight from the tigershark.', false );
		if( CoC.player.hasCock() ) {
			MainView.outputText( '  Your ' + Appearance.cockNoun( CoC.player.cocks[ 0 ].cockType ) + ' rubs against her shaft, sending delicious sparks surging through you.', false );
		}
		MainView.outputText( '  Tiring of the foreplay, you slither up her body and position yourself over her, slipping down onto her shark-sausage just enough that the head is poking teasingly into your ' + Descriptors.vaginaDescript( 0 ) + ', but not enough to really penetrate you.', false );
		if( CoC.player.wetness() >= 5 ) {
			MainView.outputText( '  Not that this stops your nether-lips from drooling your lubricant all over Izma\'s crotch.', false );
		}
		MainView.outputText( '\n\n', false );
		MainView.outputText( 'Izma seems to tense beneath you, her breath caught in her throat from anticipation.  She bites her lip as she awaits for you to slide onto her cock, but she doesn\'t dare move without your permission.\n\n', false );
		MainView.outputText( 'Finally deciding that ', false );
		if( CoC.player.cor < 66 ) {
			MainView.outputText( 'you\'ve teased her enough', false );
		} else {
			MainView.outputText( 'you\'ve delayed your pleasure long enough', false );
		}
		MainView.outputText( ', you sink down onto her, stifling a yelp as she fills your depths.', false );
		//(Tight/Virgin vagina);
		if( CoC.player.vaginalCapacity() < 20 || CoC.player.vaginas[ 0 ].virgin ) {
			MainView.outputText( '  Holy shit, that hurts like a motherfucker! It\'s as if you\'re trying to stuff a baguette into your vag!', false );
		}//(Loose);
		else if( CoC.player.vaginalCapacity() < 50 ) {
			MainView.outputText( '  You groan and shudder slightly as you slide down the generous 15 inches of dick, the slight pain being drowned out by the sensation of being filled as full as you could possibly hold.', false );
		}//(Gaping);
		else {
			MainView.outputText( '  You shudder and lick your lips. Izma may be big but you\'ve had bigger, and you fit her cock like a glove.', false );
		}
		CoC.player.cuntChange( 30, true, true, false );
		MainView.outputText( '  Once you have made it to the very base of Izma\'s cock you pause for a moment to help yourself adjust, then, clenching your vaginal muscles, you start to rock back and forth; your body is sliding up and then slamming down, picking up speed and force as you continue to thrust.  Your hands reach out to maul Izma\'s tits', false );
		if( CoC.player.hasCock() ) {
			MainView.outputText( ', your erect cock', false );
			if( CoC.player.cockTotal() > 1 ) {
				MainView.outputText( 's', false );
			}
			MainView.outputText( ' bouncing against her belly with audible slaps', false );
		}
		MainView.outputText( '.\n\n', false );
		MainView.outputText( 'Izma moans and shivers beneath you, giving a few growls as well as you continue to molest her tits. She grins and starts to rotate her hips in a clockwise fashion to try and please you further.  Your mouth hangs open with delight, and you breathily order her to pick up the pace, riding with renewed vigor to exert your dominance over the tigershark under you.\n\n', false );
		MainView.outputText( 'Izma\'s cock twitches and she places her hands on your hips.  "<i>Ah... I\'m gonna...</i>"  She grunts and bites her lip, trying to hang onto the moment.\n\n', false );
		MainView.outputText( 'You laugh in delight, complimenting Izma on what a good beta she is; the alpha gets to cum first, after all.  ', false );
		if( CoC.player.cor < 33 ) {
			MainView.outputText( 'Feeling merciful, you tell her that you\'re almost there... just a little more.  ', false );
		}
		MainView.outputText( 'Finally, the orgasm that\'s been hanging just out of reach, tantalizing you, flows free and you cry out in pleasure as femcum ', false );
		if( CoC.player.wetness() < 4 ) {
			MainView.outputText( 'spatters', false );
		} else if( CoC.player.wetness() < 5 ) {
			MainView.outputText( 'gushes', false );
		} else {
			MainView.outputText( 'fountains', false );
		}
		MainView.outputText( ' onto the tigershark under you', false );
		if( CoC.player.hasCock() ) {
			MainView.outputText( '; ' + Descriptors.sMultiCockDesc() + ' spraying all over her belly, breasts and face', false );
		}
		MainView.outputText( '.  Izma, feeling the twitching of your ' + Descriptors.vaginaDescript( 0 ) + ', finally gives a loud roar as she climaxes inside you, filling your womb up with sharky spunk to the point where it makes your stomach bloat out from the sheer volume of her deposit.\n\n', false );
		MainView.outputText( 'You sit there on top of Izma for a few minutes, basking in the afterglow, feeling her still semi-hard phallus inside you, patting your cum-inflated belly with one hand.  You compliment Izma on her load... then, giving a wicked grin, you playfully wonder aloud why she\'s still so hard inside you.  Is she really still horny?  Well, you\'re a good alpha, so you\'ll keep going until you\'ve milked her dry...\n\n', false );
		MainView.outputText( 'Izma moans weakly from beneath you, trying hard to keep her eyes open.  "<i>If, ah... if that\'s what you want.</i>"\n\n', false );
		MainView.outputText( 'You simply give her your wickedest grin, already starting to get into the rhythm of rising and falling...\n\n', false );
		CoC.player.orgasm();
		EngineCore.dynStats( 'sen', -2 );
		MainView.outputText( '<b>Some time later...</b>\n', false );
		MainView.outputText( 'Finally, you are tired and sexually sated enough that you tell Izma you\'re fulfilled. The tigershark merely groans and you have to help her get into the stream to restore her strength. Still, seven orgasms in only an hour is pretty impressive, and you give her a pat on her shapely derierre before you leave, calling over her shoulder that you\'ll be back again sometime.\n\n', false );
		MainView.outputText( 'Izma waves at you and smirks as you go to leave, and you have to wonder if Izma was only acting helpless in order to get off...', false );
		if( CoC.flags[ kFLAGS.UNKNOWN_FLAG_NUMBER_00249 ] > 0 ) {
			CoC.player.knockUp( PregnancyStore.PREGNANCY_IZMA, PregnancyStore.INCUBATION_IZMA );
		}
		CoC.player.slimeFeed();
		EngineCore.doNext( SceneLib.camp, SceneLib.camp.returnToCampUseOneHour );
	...
	IzmaScene.prototype.IzmaCampBooks = function() {
		...
		//MainView.outputText('Izma starts to lazily fish through her trunk for her reading material while she waits on you.  She looks up and says, "<i>Oh, I was just organizing my library.</i>"  You ask her if she\'d like some company.  "<i>Oh, that would be lovely... would you like to read something?</i>"\n\n', false);;
		MainView.outputText( 'You tell Izma you feel like doing some reading and she starts to lazily fish through her trunk for her reading material.  She looks up and says, "<i>I\'ll need to organize this later... So, what would you like to read with me?</i>"\n\n', false );
		//[C.Manual] [E.Guide] [Porn];
		EngineCore.choices( 'C.Manual', this, this.campCuntManual,
			'E.Guide', this, this.entropyGuideByStephenHawking,
			'Porn', this, this.stephenHawkingPorn, '', null, null, 'Back', this, this.izmaFollowerMenu );
	};
	//[C.Manual];
	IzmaScene.prototype.campCuntManual = function() {
		...
		MainView.outputText( '\n\nAfter about an hour you yawn and stretch, telling Izma that you\'re going off to do other business.  She nods lazily at your words but doesn\'t look up from her old book. "<i>Sure thing ' + CoC.player.short + ', I\'m just gonna read this for a little while longer,</i>" Izma says.  You nod at her, before moving off.', false );
		EngineCore.doNext( SceneLib.camp, SceneLib.camp.returnToCampUseOneHour );
	};
	//[E.Guide];
	IzmaScene.prototype.entropyGuideByStephenHawking = function() {
		...
		//(-2 Libido, -2 Corruption);
		EngineCore.dynStats( 'lib', -2, 'cor', -2 );
		MainView.outputText( 'As time passes you realize that you do have other things to do.  You thank Izma for her company and get up to leave.  "<i>All right, thanks for sitting with me ' + CoC.player.short + '.  You go on ahead, I\'m just going to read some more of this,</i>" she replies, not even looking up from the pages of her book.\n\n', false );
		EngineCore.doNext( SceneLib.camp, SceneLib.camp.returnToCampUseOneHour );
	};
	//[Porn];
	IzmaScene.prototype.stephenHawkingPorn = function() {
		...
		if( CoC.flags[ kFLAGS.IZMA_NO_COCK ] === 0 ) {
			MainView.outputText( 'continuously to keep the beast in her skirt pinned down.\n\n', false );
		} else {
			MainView.outputText( 'nervously in an effort to keep from moistening it.\n\n', false );
		}
		CoC.flags[ kFLAGS.IZMA_TIME_TILL_NEW_BOOK_AVAILABLE ] = 11;
		MainView.outputText( 'By the time you\'re done reading, Izma certainly seems turned on.  She tries to hide it and sit primly - ' );
		if( CoC.flags[ kFLAGS.IZMA_NO_COCK ] === 0 ) {
			MainView.outputText( 'but that\'s not exactly possible for someone who just had over a foot of dick slip from between her thighs and stick into the air.  You laugh openly and give Izma\'s silver hair a soft tug, before getting up and telling her you have business elsewhere.  Izma simply nods in taciturn response but keeps her gaze fixed on the lewd images before her.  Another laugh escapes your lips as soon as you think you\'re out of earshot.', false );
		} else {
			MainView.outputText( 'but that\'s not exactly possible for someone who keeps squirming, creating lewd squishes from below the waist.  You laugh openly and give Izma\'s silver hair a soft tug, before getting up and telling her you have business elsewhere.  Izma simply nods in taciturn response but keeps her gaze fixed on the lewd images before her.  Another laugh escapes your lips as soon as you think you\'re out of earshot.', false );
		}
	...
	IzmaScene.prototype.findLostIzmaKids = function() {
		MainView.outputText( '', true );
		MainView.outputText( 'While rowing the boat across the lake you spy a shark fin heading your way.  Worried it might damage the small boat, you hastily row back to shore, jumping out of the boat.  The shark shows no signs of slowing, and the fin disappears just before coming ashore.  A grey blur bursts from the water and lands on the ground a few feet away from you.\n\n', false );
		MainView.outputText( 'It\'s a young woman – a peculiarly corrupted woman, with shiny grey skin, silver hair, and a fin positioned between her shoulder blades.  She is much smaller and thinner than the average shark-girl.  She\'s wearing some rather revealing black swimwear.  The girl looks up at you and grins widely, showing rows of knife-like teeth.  "<i>Wanna play? Heads up though, I...</i>" Her grin wavers, and silence hangs in the air for a few moments.\n\n', false );
		MainView.outputText( '"<i>...Mom?</i>"', false );
		//(Next);
		EngineCore.doNext( this, this.findLostIzmaKidsII );
		CoC.flags[ kFLAGS.UNKNOWN_FLAG_NUMBER_00412 ]--;
	};
	IzmaScene.prototype.findLostIzmaKidsII = function() {
		MainView.outputText( '', true );
		MainView.outputText( 'You embrace your daughter, both of you half-laughing half-crying into each other\'s shoulders.  After a few moments of this, you pull away a little and blurt out a few urgent questions about her well-being and mental health.  She in turn inquires about you and her "father."\n\n', false );
		MainView.outputText( 'This sparks off a happy chain of thoughts in your mind, and you inform your wayward daughter that Izma is now living with you (and there\'s room for another).  She squeaks happily at the news, and tells you that she\'ll meet you at camp.  She pecks you on the cheek, then runs into the shallows and disappears.  You walk away, beaming at the thought of seeing a new face in camp.', false );
		//(+1 Izma children.);
		CoC.flags[ kFLAGS.IZMA_CHILDREN_SHARKGIRLS ]++;
		EngineCore.doNext( SceneLib.camp, SceneLib.camp.returnToCampUseOneHour );
	};
	...
	IzmaScene.prototype.removeIzmasPenis = function() {
		MainView.clearOutput();
		if( CoC.flags[ kFLAGS.ASKED_IZMA_ABOUT_WANG_REMOVAL ] === 0 ) {
			...
			MainView.outputText( 'You bring up the idea of removing her dick again, and Izma just sighs "<i>Why?  Why can\'t you just... be happy with me like I am?  I don\'t want to be just another shark-girl!</i>"' );
		...
		var count = 5;
		while( count > 0 ) {
			if( CoC.player.hasItem( ConsumableLib.SUCMILK, count ) ) {
				succMilk = count;
				break;
			}
			count--;
		...
		count = 5;
		while( count > 0 ) {
			if( CoC.player.hasItem( ConsumableLib.P_S_MLK, count ) ) {
				pMilk = count;
				break;
			}
			count--;
	...
	IzmaScene.prototype.izmaDickToggle = function() {
		...
		if( CoC.flags[ kFLAGS.IZMA_NO_COCK ] === 0 ) {
			...
			CoC.flags[ kFLAGS.IZMA_NO_COCK ] = 1;
			var count = 0;
			while( CoC.player.hasItem( ConsumableLib.P_S_MLK ) && count < 5 ) {
				CoC.player.consumeItem( ConsumableLib.P_S_MLK );
				count++;
			}
			while( CoC.player.hasItem( ConsumableLib.SUCMILK ) && count < 5 ) {
	...
	IzmaScene.prototype.fuckIzmasPussyDominate = function() {
		...
		var y = x + 1;
		MainView.outputText( 'Fixating on Izma\'s ' );
		if( CoC.flags[ kFLAGS.IZMA_NO_COCK ] === 0 ) {
			MainView.outputText( 'cock ' );
		} else {
			MainView.outputText( 'cunt ' );
		}
		MainView.outputText( 'like a moth to an open flame, you saunter over towards her, sporting a ridiculous grin as thoughts of impaling yourself in her tight pussy takes hold of your mind, driving you into a frenzied lust.  With her skirt now thrown indifferently to the ground, her bare sex' );
		if( CoC.flags[ kFLAGS.IZMA_NO_COCK ] === 0 ) {
			MainView.outputText( 'es' );
		}
		MainView.outputText( ' now stand' );
		if( CoC.flags[ kFLAGS.IZMA_NO_COCK ] === 1 ) {
			MainView.outputText( 's' );
		}
		MainView.outputText( ' exposed to the cool air, drooling ' );
		if( CoC.flags[ kFLAGS.IZMA_NO_COCK ] === 0 ) {
			MainView.outputText( 'their sexual lubricants' );
		} else {
			MainView.outputText( 'its sexual lubricant' );
		}
		MainView.outputText( ' in eager presentiment.  "<i>So, [name], how does my Alpha want to fuck me today?</i>"  Izma coos, attempting to bewitch you with the enticement of dominance over her; something that right now, is pitching a huge tent in your pants.  "<i>You read my mind, lover,</i>" you reply back, narrowing in on her moist clit as [eachCock] bobs with the need to fuck that love button of hers.  The tree trunk behind Izma catches your eye; the thought of slumping Izma over it and making her beg to be bred triggers a rush of giddiness throughout your body as you decide this is how you\'ll dominate Izma.' );
		...
		if( CoC.player.tentacleCocks() > 1 || (CoC.player.tentacleCocks() === 1 && CoC.player.cocks[ x ].cockType !== CockTypesEnum.TENTACLE) ) {
		...
		//(If PC has goo body: ;
		if( CoC.player.isGoo() && CoC.flags[ kFLAGS.IZMA_NO_COCK ] === 0 ) {
			...
			MainView.outputText( 'Will you tend to her dick?' );
			//[Goo job]    [Leave it, leads to [Spanking scene]);
			EngineCore.choices( 'Goo Job', this, this.gooJob, 'Leave It', this, this.radarIzmaSpanking, '', null, null, '', null, null, '', null, null );
		}
		MainView.outputText( '\n\n' );
		this.radarIzmaGasm();
	};
	...
	IzmaScene.prototype.gooJob = function() {
		MainView.clearOutput();
		MainView.outputText( 'Concentrating on moving your mass forward, you manage to envelop Izma\'s entire back side.  Slowly but surely, you are able to harden your goo around Izma\'s rock hard cock, and begin to pump her penile member with gusto. Now that she\'s been jerked off, and the fact that she\'s ' );
		this.radarIzmaSpanking( false );
		CoC.player.createStatusAffect( StatusAffects.Goojob, 0, 0, 0, 0 );
	};
	//[Spanking and orgasm];
	...
	IzmaScene.prototype.radarIzmaGasm = function() {
		...
		if( CoC.player.cumQ() <= 750 ) {
			MainView.outputText( 'shooting your hot load into Izma\'s fuckhole, enveloping the walls of her pussy with your seed.' );
		}//(Cum production High: ;
		else {
		...
		if( CoC.player.cumQ() > 750 ) {
			MainView.outputText( 'bloated ' );
		}
		MainView.outputText( 'belly, clamping her legs shut in ' );
		if( CoC.player.cumQ() <= 750 ) {
			MainView.outputText( 'a ' );
		} else {
			MainView.outputText( 'an ultimately ' );
		}
		MainView.outputText( 'vain attempt to contain all of your baby batter inside of her.  With a final sigh, you pull loose from her and dart past her shoulder for a sensual kiss on the lips.  Izma weakly kisses back, stopping after a few moments to whisper to you, "<i>Gods... that was... something else.  I didn\'t think I could... cum that hard.</i>"  With a small giggle, you tell Izma that your Beta will always cum hard if she fulfills her Alpha\'s desires, and that she should clean herself up.  Moaning in appreciation, she mutters something about maybe pleasuring her' );
		if( CoC.flags[ kFLAGS.IZMA_NO_COCK ] === 0 ) {
			MainView.outputText( ' cock' );
		} else {
			MainView.outputText( 'self' );
		}
		MainView.outputText( ' down at the river... but judging by how tired she looks, you doubt that will happen anytime soon.' );
		CoC.player.orgasm();
		EngineCore.dynStats( 'sen', -1 );
		this.izmaPreg();
		EngineCore.doNext( SceneLib.camp, SceneLib.camp.returnToCampUseOneHour );
	...
	IzmaScene.prototype.radarIzmaAnalDominant = function() {
		...
		if( CoC.player.gender > 0 ) {
			...
			//(If PC has vagina: ;
			if( CoC.player.hasVagina() ) {
				MainView.outputText( 'intent on burying your ' + Descriptors.clitDescript() + ' in her face and having her finish you off.  Izma tries her best to pleasure you, but she\'s still too wracked with bliss to be any help... still, you manage to find stimulation by grinding yourself against her spaced-out face, eventually orgasming and drenching her face in your lady fluids as she weakly strokes the remaining cum out of her cock.' );
			}//(If PC has cock(s): ;
			else if( CoC.player.hasCock() ) {
				MainView.outputText( 'stroking furiously along your ' + Descriptors.cockDescript( 0 ) + ' to bring an explosive end to this passionate act.  Izma is still off in another world of orgasmic fulfillment to note the impending facial coming her way.  It takes her a few moments to register it, but she coos lovingly as the scent of semen hits her nostrils, finally realizing that you have blown your steamy load all over her face.' );
			}
			//(genitalia end: ;
			MainView.outputText( '  Falling back on your ' + Descriptors.buttDescript() + ', you breathe a sigh of relief, both thanking and lamenting the fact that your orgasms have reached fruition.  Despite still being able to get up and walk around, Izma is another story.' );
			MainView.outputText( '\n\nYou could carry her back to her bedding and tuck her in... or you could just let her sleep it off.' );
			//[Tuck in]   [Leave her];
			EngineCore.choices( 'Tuck In', this, this.radarIzmaAnalDomResultTuckIn, 'Stay', this, this.radarIzmaLeaveHerInTheDirtAfterAnalDom, '', null, null, '', null, null, '', null, null );
		} else {
	...
	IzmaScene.prototype.radarIzmaAnalDomResultTuckIn = function() {
		...
		if( CoC.player.str < 70 ) {
			MainView.outputText( 'Despite your good intentions, you can\'t lift Izma off the ground for long before needing to set her back down.  Imza quietly remarks that you should just let her rest; causing you to tell her not to talk back.  Alternating between dragging her through the grass and "carrying" her over some rocks, ' );
			if( CoC.player.fatigue < 70 ) {
				MainView.outputText( 'you eventually get her back to her bedroll.  She smiles sheepishly as you lay her on the bedding to sleep off your passionate throes.  She\'s comfortable, but the effort is exhausting.' );
				EngineCore.dynStats( 'cor', -2 );
				EngineCore.fatigue( 30 );
			} else {
				MainView.outputText( 'you try and get her to her bedroll, but you are simply too exhausted.  Izma tells you not to worry about her and go get some rest; that she\'ll be okay in the grass.  You groggily agree as you set her down, telling her she better be ready for more sex if you want it; something she approves of as she hums and drifts off to sleep.' );
			}
		} else {
			MainView.outputText( 'With a great show of force, you take Izma under the legs and back, lifting her off the ground and starting toward her bedroll. In little time flat, you reach her bedding and lie her down gently. As you turn, you remark to Izma that she better rest up; you\'ll likely have another "itch" that will need scratching.  Her raspy words ring out behind you as you begin to walk away; "<i>Promise?</i>"  Turning your head slightly to catch her in your left eye, you grin mischievously at the shark-morph and continue on your way.' );
			EngineCore.dynStats( 'cor', -2 );
		}
		EngineCore.doNext( SceneLib.camp, SceneLib.camp.returnToCampUseOneHour );
	};
	...
	IzmaScene.prototype.radarFucksIzmasAss = function() {
		...
		if( CoC.player.cocks[ x ].cockType !== CockTypesEnum.TENTACLE ) {
			...
			if( y >= 0 ) {
				MainView.outputText( ' as you gently place your other dick against her labia' );
			}
			MainView.outputText( '.' );
			...
			if( y === -1 ) {
				MainView.outputText( 'her anus' );
			} else {
				MainView.outputText( 'both of her holes' );
			}
			MainView.outputText( '.  The sound of Izma\'s pained cry of agony rises as her head does, guided by your arm as you drag her so far back that she ends up howling up into the sky.  Like a tongue reaching down into a candy wrapper to lick up delicious chocolate, you twist and grind the end of your ' );
			if( y >= 0 ) {
				MainView.outputText( 'cocks against the unyielding ends of her anus and pussy, unleashing a weak whimper of bliss from under you.' );
			} else {
				MainView.outputText( 'cock against the unyielding end of her anus, unleashing a weak whimper of bliss from under you.' );
			}
			...
			MainView.outputText( '.  All too quickly though, your loins ache with the pained vice-grip of orgasm.  As much as you would like to continue dominating Izma, you cannot hold out.  The only choice you have now is where to direct your impending release.' );
			//[Internal, Global option for non-TD and TD scenes]    [External, Non-TD scenes];
			EngineCore.choices( 'Internal', null, null, 'External', null, null, '', null, null, '', null, null, '', null, null );
		}
		//!Tentacle dick scenes!;
			...
			if( CoC.player.tentacleCocks() >= 4 ) {
				...
				if( CoC.player.tentacleCocks() === 4 ) {
					MainView.outputText( 'a cock that needs' );
				} else {
					MainView.outputText( 'cocks that need' );
				}
				MainView.outputText( ' a little loving from her; something that visibly registers on her face as her expression goes wide in shock, her eyes seemingly asking you where THIS one is going next.' );
				//[Dick]    [Blowjob]   ;
				EngineCore.choices( 'Dick', null, null, 'Blowjob', null, null, '', null, null, '', null, null, '', null, null );
				return;
			}
			//Go to buttsex;
	...
	IzmaScene.prototype.internalIzmaAnalCumShot = function() {
		MainView.clearOutput();
		MainView.outputText( 'With a series of labored breaths, you excitedly tell your lover that you are going to cum inside her, and that she\'d better love every second of it.  The rushing warmth that resonates through your cock fills you with a relaxed euphoria as you groan and bottom out once more, releasing your seed deep into her eager depths.' );
		//(If PC fucked her vaginally: ;
		if( CoC.player.cockThatFits2( 65 ) >= 0 ) {
			MainView.outputText( '  The feelers in her pussy glide along the glans of your ' + Descriptors.cockDescript( CoC.player.cockThatFits2( 65 ) ) + ', driving your dick\'s unconscious efforts to inseminate her into overdrive as you feel each subsequent stream of semen increase in velocity.' );
		}
	};
	//[External, Non-TD scenes];
	IzmaScene.prototype.backJizzShot = function() {
		MainView.clearOutput();
		MainView.outputText( 'Pulling out of Izma, you begin to stroke [eachCock] furiously, bobbing your shaky hands up and down ' );
		if( CoC.player.cockTotal() === 1 ) {
			MainView.outputText( 'your shaft ' );
		} else if( CoC.player.cockTotal() === 2 ) {
			MainView.outputText( 'two shafts ' );
		} else {
			MainView.outputText( 'three shafts' );
		}
		...
		//(Cum volume normal: ;
		if( CoC.player.cumQ() < 500 ) {
			MainView.outputText( 'firing thin streams of semen from [eachCock], lathering Izma\'s luscious red body and making it glisten in the sun.' );
		}//(Cum volume high:;
		else if( CoC.player.cumQ() <= 1000 ) {
			MainView.outputText( 'streaming forth like fierce rain down a tree, repeatedly striking Izma across the face and breasts as your orgasm continues unabated for several moments.' );
		}//(Cum volume very high: ;
		else {
			MainView.outputText( 'creating a earthquake like seizure in [eachCock] as you painfully ejaculate a torrent of sperm all over Izma, drowning that bright red body out with a thick layer of clear white goop.  Your abundant release is so large that you, quite literally, cover Izma head to toe with sticky, sloppy cum.' );
	...
	IzmaScene.prototype.izmaDomsLatexy = function() {
		if( CoC.flags[ kFLAGS.TIMES_IZMA_DOMMED_LATEXY ] === 0 ) {
			//{First time};
		...
		//{Repeat};
			...
			MainView.outputText( '\n\n"<i>Go on, you need to make me want to use you!</i>" Izma says while slowly caressing her penis.  She\'s openly leering down at the reflective, ebon-skinned slut, and the poor, collared woman reluctantly parts her glossy folds, slowly feeding her fist into her capacitive nethers, one knuckle at a time.  Once her wrist disappears, it\'s only a short moment before she pulls it back out, gasping from unexpected pleasure.  Strings of inky lubricant dangle precariously between her digits and stretched snatch, just about to break until ' + CoC.flags[ kFLAGS.GOO_NAME ] + '\'s hand is plunged back into the inky honeypot.' );
	...
	IzmaScene.prototype.izmaDomsLatexyPartI = function() {
		...
		MainView.outputText( 'Izma growls while she pumps away at her erection, saying, "<i>Yeah, you like that, don\'t ya ink-slut?</i>"' );
		MainView.outputText( '\n\n' + CoC.flags[ kFLAGS.GOO_NAME ] + ' bites her lower lip and ' );
		if( SceneLib.latexGirl.gooObedience() > 50 ) {
			MainView.outputText( 'eagerly' );
		} else {
			MainView.outputText( 'sheepishly' );
		}
		MainView.outputText( ' nods, gushing a few fresh dribbles of moisture around her wrist at the admission.' );
		...
		MainView.outputText( ' with a toe, drawing a pleasured gasp from the submissive.' );
		MainView.outputText( '\n\n' + CoC.flags[ kFLAGS.GOO_NAME ] + ' shudders as she pushes her hand in and out of herself.  Her whole forearm is dripping with onyx moisture, and the noisy squelches are easy to hear from where you\'re watching.  "<i>Yes... I\'m a slutty, submissive girl...  Can I have your cum, mistress Izma?  Please?  I\'m putting on such a good show!</i>"' );
		if( SceneLib.latexGirl.gooObedience() < 50 ) {
			MainView.outputText( '  A look of annoyance flashes across her face as soon as she says it, like she didn\'t really want to say that so openly.' );
		} else if( SceneLib.latexGirl.gooObedience() <= 80 ) {
			MainView.outputText( '  A conflicted look flashes across her face as soon as the words slip out, but there\'s no taking them back.' );
		} else {
			MainView.outputText( '  A hungry look flashes in her eyes as soon as the words leave her mouth, and she licks her lips hungrily.' );
		}
		MainView.outputText( '  A particularly powerful thrust inside herself has ' + CoC.flags[ kFLAGS.GOO_NAME ] + ' whining, her eyelids fluttering closed as she cries, "<i>Oh, [name]!</i>"' );
		MainView.outputText( '\n\nYou smile in satisfaction as your beta and your submissive, former slime tend to their needs together, proud that in the face of fifteen inches of stripe-cock, ' + CoC.flags[ kFLAGS.GOO_NAME ] + ' still fantasizes about you.' );
		MainView.outputText( '\n\n"<i>Good enough, slut,</i>" Izma croons in between heavy pants.  She slaps her swollen shark-cock across the black-skinned woman\'s hungry face.  Gasping in surprise, ' + CoC.flags[ kFLAGS.GOO_NAME ] + '\'s\' shocked expression tells you all you need to know, right up until the red boner plunges into her unresisting lips.  Liquid, ' + CoC.flags[ kFLAGS.GOO_EYES ] + ' eyes look up in surprise before fluttering contently closed.  Izma\'s hand caresses a lock of slippery, latex hair and forces herself deeper into the wet, former goo\'s throat.  Droplets of inky moisture roll out around the edges of the shaft, painting her four-balled nutsack black before they cool and harden around it.' );
		MainView.outputText( '\n\nHands reaching out towards the slippery, sheathed quartette, ' + CoC.flags[ kFLAGS.GOO_NAME ] + ' hums around the throat-stretching bulge as she does her best to milk it, gently squeezing each cum factory in turn.  Izma hooks a leg over ' + CoC.flags[ kFLAGS.GOO_NAME ] + '\'s shoulder and begins to roughly fuck the onyx beauty.  She hammers her cock home with crude thrusts that pound all fifteen inches straight into the goo-girl\'s core, the only sounds half-strangled hums of pleasure and the heated squelches Izma\'s groin makes when it bottoms out on her partner\'s greedy lips.' );
		MainView.outputText( '\n\n"<i>Oooh, fuck, quit sucking so hard,</i>" Izma tries to command, but it winds up sounding more like begging.  ' );
		//OBEDIENCE FAIL;
		if( SceneLib.latexGirl.gooObedience() / 5 + SceneLib.latexGirl.gooFluid() / 5 + Utils.rand( 20 ) < 10 ) {
			MainView.outputText( '' + CoC.flags[ kFLAGS.GOO_NAME ] + ' grows and sucks harder, cheeks hollowed with suckling hunger.  You can see them stretch and go even more concave with rhythmic pulsations, vacuum-tight around the orange shaft.  Izma moans and tries to pull out, but she barely manages to extract an inch before her whole length is noisily pulled back in.  The shark-girl tries to pry the slutty, hungry little goo off of herself again and again, but each time, all she winds up doing is getting sensuously devoured again and again.  ' + CoC.flags[ kFLAGS.GOO_NAME ] + ' gives her four balls another appreciative squeeze, and Izma\'s eyes suddenly roll back, helpless again the hungry sluts impressive oral talents.' );
			MainView.outputText( '\n\n"<i>C-c-cumming!  Ohhhh by the gods, yes!  Ungh!</i>" Izma cries as her hips begin to weakly thrust against their onyx prison, smushing ' + CoC.flags[ kFLAGS.GOO_NAME ] + '\'s lips into her toned middle.  The smooth, latex sheath around her sack trembles, wrinkling as Izma\'s balls pull tight against her, and then, ' + CoC.flags[ kFLAGS.GOO_NAME ] + ' is gurgling noisily, massaging all four of those cum factories as they pour their cargo straight into her throat, feeding her the warm, soupy cum she craves.  They stay locked like that for upwards of a minute, Izma occassionally trying to talk but usually just babbling contently while she\'s milked for every drop.' );
			MainView.outputText( '\n\nAbruptly, the striped hermaphrodite slumps back against a rock, her drained dong sliding out of the constricting tightness of ' + CoC.flags[ kFLAGS.GOO_NAME ] + '\'s throat with a wet pop.  The crimson dick is encased in a hardening shell of latex, and you must admit, it\'s a good look on her.  Izma sighs, "<i>You disobedient slut...</i>" and staggers back up onto her feet.  Gesturing down at her glossy, black dick, she comments, "<i>I guess it is a nice look on me.</i>"' );
			MainView.outputText( '\n\n' + CoC.flags[ kFLAGS.GOO_NAME ] + ' grins happily and lays back, sunning herself as she starts to digest her \'meal\'.' );
		}
		//OBEDIENCE SUCCESS;
		else {
			MainView.outputText( '' + CoC.flags[ kFLAGS.GOO_NAME ] + ' obediently relaxes, allowing the herm to take more effective control of the situation.  "<i>Atta girl,</i>" Izma comments as she extracts herself from the hungry, sucking mouth-hole, her dick shining with a fresh, wet, latex sheath.  "<i>Ass up, slut.  You\'re getting fed via suppository today!</i>"' );
			MainView.outputText( '\n\n' + CoC.flags[ kFLAGS.GOO_NAME ] + ' assumes the position in a second and begins to wag her bottom back and forth.  The way the light reflects on those onyx orbs, you can understand why Izma immediately pistons herself straight into the latex rosebud - it\'s an entrancing, cock hypnotizing sight to be sure.  She grunts as soon as she bottoms out, and then straining, she yanks herself back out of the vacuum-tight, anal seal, gasping for breath.  "<i>You can suck there too?!</i>" Izma growls in wonder, but not before pushing herself back inside.  "<i>Suck it while I fuck you.  I\'m gonna blow a huge load in your ass before long, cock-slave.</i>"' );
			MainView.outputText( '\n\nAgain and again, Izma slaps her hips against ' + CoC.flags[ kFLAGS.GOO_NAME ] + '\'s tight backdoor.  Every time she pulls out, she\'s coated in even more liquid latex, some of it splattered on her hips and molded on her cock.  Even the inky wetness that girds her balls thickens into a more substantial coating.  Soon, she\'s grunting each time she bottoms out, and from the way her tongue is hanging out of her pleasure-opened mouth, the sensations her member is experiencing must be beyond imagining.  Izma suddenly gurgles and hilts herself, gasping, "<i>Ungh, here... here it comes!  TAKE IT!  TAKE IT, SLUT!</i>"' );
			MainView.outputText( '\n\nThe sheath around her balls wrinkles slightly as it contracts, pumping what can only be a deluge of salty shark-seed straight into the goo-gal\'s roomy backside.  Both girls moan in ecstatic bliss.  You belatedly realize that the whole time she\'s been ass up, ' + CoC.flags[ kFLAGS.GOO_NAME ] + ' has had her arm elbow-deep inside her snatch, getting herself off and potentially handing out a handjob inside of herself.  Obsidian drool runs unchecked down her elbow and onto the ground as the black woman cums.  Meanwhile, Izma keeps herself tight on her succulent asscheeks, eyes half-rolled back in their sockets as she gives herself completely over to the blissful ecstasy that\'s polishing her pole.' );
			MainView.outputText( '\n\nAbruptly, the striped hermaphrodite slumps back against a rock, her drained dong sliding out of the constricting tightness of ' + CoC.flags[ kFLAGS.GOO_NAME ] + '\'s ass with a wet pop.  The striped dick is encased in a hardening shell of latex, and you must admit, it\'s a good look on her.  Izma sighs, "<i>Good girl...</i>" and staggers back up onto her feet.  Gesturing down at her glossy, black dick, she comments, "<i>I guess it is a nice look on me.</i>"' );
			MainView.outputText( '\n\n' + CoC.flags[ kFLAGS.GOO_NAME ] + ' grins happily and lays back, sunning herself as she starts to digest her \'meal\'.' );
		}
		CoC.flags[ kFLAGS.TIMES_IZMA_DOMMED_LATEXY ]++;
		CoC.flags[ kFLAGS.GOO_FLUID_AMOUNT ] = 100;
	...
	IzmaScene.prototype.stopIzmaLatexy = function() {
		MainView.clearOutput();
		MainView.outputText( 'You step into the middle of it before it can progress any farther.  ' + CoC.flags[ kFLAGS.GOO_NAME ] + ' is yours, and Izma is not to play at being a mistress to YOUR pet.' );
		...
		CoC.flags[ kFLAGS.IZMA_X_LATEXY_DISABLED ] = 1;
		CoC.flags[ kFLAGS.TIMES_IZMA_DOMMED_LATEXY ]++;
		EngineCore.doNext( SceneLib.camp, SceneLib.camp.returnToCampUseOneHour );
	};
	...
	IzmaScene.prototype.izmaLatexySubmenu = function() {
		...
		if( CoC.flags[ kFLAGS.IZMA_X_LATEXY_DISABLED ] === 1 ) {
			...
			EngineCore.addButton( 0, 'No Feeding', this, this.izmaLatexyToggle );
			//[Watch];
			EngineCore.addButton( 1, 'Watch Them', this, this.izmaDomsLatexy );
		}
		EngineCore.addButton( 4, 'Back', this, this.izmaSexMenu );
	};
	//[No Feeding];
	IzmaScene.prototype.izmaLatexyToggle = function() {
		MainView.clearOutput();
		if( CoC.flags[ kFLAGS.IZMA_X_LATEXY_DISABLED ] === 0 ) {
			MainView.outputText( 'You tell Izma you don\'t want her feeding ' + CoC.flags[ kFLAGS.GOO_NAME ] + ' any more.' );
