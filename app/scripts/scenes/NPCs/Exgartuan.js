...
angular.module( 'cocjs' ).run( function( SceneLib, ArmorLib, $log, CockTypesEnum, Combat, PerkLib, $rootScope, Descriptors, AppearanceDefs, EventParser, CoC, kFLAGS, Utils, StatusAffects, EngineCore ) {
	...
	Exgartuan.prototype.exgartuanMasturbation = function() {
		...
		if( CoC.player.statusAffectv1( StatusAffects.Exgartuan ) === 1 ) {
			...
			if( CoC.player.cor >= 30 && CoC.player.cor < 60 ) {
				EngineCore.outputText( 'You happily remove your ' + CoC.player.armorName + ', eager to pleasure yourself.  Your possessed ' + Descriptors.cockDescript( 0 ) + ' throbbs happily.\n\n', false );
			}
			...
			//high corruption characters;
				...
				EngineCore.outputText( '"<i>That\'s the ticket, ' + CoC.player.short + ', you\'re sooo good at this.  Now go ahead and let it out.  I want to paint your face with seed and watch it drip off.  You\'ll let me do that right?  Who am I kidding, I feel so good you\'ll let me do whatever I want, won\'t you slut?</i>"\n\n', false );
	...
	Exgartuan.prototype.exgartuanBored = function() {
		...
		if( CoC.player.statusAffectv1( StatusAffects.Exgartuan ) === 1 && CoC.player.cockArea( 0 ) >= 100 ) {
			...
			if( select === 0 ) {
				...
				EngineCore.outputText( 'A tiny voice mutters, "<i>How can you live with so few orgasms?  We need some quality time, ' + CoC.player.short + '.  You\'ve got a LOT of tension building up...</i>"', false );
			} else if( select === 2 ) {
				EngineCore.outputText( 'You feel a stirring inside your ' + CoC.player.armorName + ' as it rubs against the material.  A muffled voice says, "<i>Hey!  Don\'t forget me!  I need some air!</i>"', false );
			} else if( select === 3 ) {
				...
				EngineCore.outputText( 'Your ' + CoC.player.armorName + ' suddenly bulges, a stifled voice picking up along with it, "<i>There has to be a hole out there for me to fuck.  A mouth, a cunt... stop slacking off and get on it!</i>"', false );
			} else if( select === 6 ) {
			...
			switch( select ) {
				case 0:
					EngineCore.outputText( 'You feel an ominous jiggling in your ' + Descriptors.breastDescript( 0 ) + ' as the demon inside you stirs back to wakefulness.  The sound of a yawn being muffled by your ' + CoC.player.armorName + ' confirms it.', false );
					break;
				case 1:
				...
				case 5:
					...
					break;
				case 6:
					EngineCore.outputText( 'The silent alone time you\'ve been enjoying is coming to an end as the demoness dwelling within your bosom shifts in your ' + CoC.player.armorName + '.  She wastes no time in stuffing you full of chest-focused temptations.', false );
					break;
				case 7:
	...
	Exgartuan.prototype.exgartuanCombatUpdate = function() {
		...
		if( CoC.player.statusAffectv1( StatusAffects.Exgartuan ) === 1 ) {
			...
			//[FETISH CULTISTS TURNED ON BY DEMON-COCK];
				...
				switch( select ) {
					case 0:
						...
						break;
					case 1:
						EngineCore.outputText( 'Openly touching herself, the fetish cultist\'s gaze never leaves your crotch, locked onto the outline of Exgartuan in your ' + CoC.player.armorName + '.  What a slut.', false );
						break;
					case 2:
			...
			//(+Lust in combat) for girls;
				...
				switch( select ) {
					case 0:
						EngineCore.outputText( 'Thoughts of ' + CoC.monster.a + CoC.monster.short + ', wrapping ' + CoC.monster.mf( 'him', 'her' ) + 'self around your throbbing demonic member consume you, flooding your body with lust.', false );
						if( CoC.player.cor < 50 ) {
							EngineCore.outputText( '  You glance down at the sensitive bulge in your ' + CoC.player.armorName + ' and sigh.  Damned demons.', false );
						}
						break;
					case 1:
						EngineCore.outputText( 'Desire courses through your veins, growing stronger as you watch ' + CoC.monster.a + CoC.monster.short + '\'s form.  You somehow realize the desire is artificial, but it doesn\'t make you want to mount ' + CoC.monster.mf( 'him', 'her' ) + ' any less...', false );
						break;
					case 2:
						EngineCore.outputText( 'Warmth spreads throughout your body as visions of yourself mounting ' + CoC.monster.a + CoC.monster.short + ' over and over flutter through your mind.  You might have to make them a reality...', false );
						if( CoC.player.cor < 50 ) {
							EngineCore.outputText( '  That\'s terrible!  It\'s all that demon\'s fault!', false );
						}
						break;
					case 3:
						EngineCore.outputText( 'You really want to end this fight and bend ' + CoC.monster.a + CoC.monster.short + ' over... Why is this taking so long, your ' + Descriptors.cockDescript( 0 ) + ' does NOT want to wait!', false );
						if( CoC.player.cor < 50 ) {
							EngineCore.outputText( '  You snap back to reality and curse yourself for falling to the demon\'s desires.', false );
						}
						break;
					case 4:
						EngineCore.outputText( 'This fight has gone on long enough; all you really want is to shove your ' + Descriptors.cockDescript( 0 ) + ' into the ' + CoC.monster.a + CoC.monster.short + '\'s... Wait, what? Your possessed pecker is getting the better of you.', false );
						break;
					case 5:
						EngineCore.outputText( 'For a moment, you find it hard to concentrate, visions of impaling the ' + CoC.monster.a + CoC.monster.short + ' with your ' + Descriptors.cockDescript( 0 ) + ' etching their way into your mind.  Curse this horny demon!', false );
						break;
					case 6:
						EngineCore.outputText( 'Pleasure begins to radiate through your being, suddenly.  You snap back to your senses in time to see your hands stroking the bulge in your ' + CoC.player.armorName + ', answering to the whims of an unholy force.', false );
						break;
					case 7:
						EngineCore.outputText( 'Maybe it would be best to just lay down your arms and strip off your ' + CoC.player.armorName + '. Just give yourself up to the ' + CoC.monster.a + CoC.monster.short + ' and let fate decide. Surely, ' + CoC.monster.pronoun1 + ' would return the gesture by embracing your ' + Descriptors.cockDescript( 0 ) + ' and... Augh!  The demon is again toying with your judgment.', false );
						break;
					case 8:
			...
			//(Taunts Male Foes -enemy lust);
				...
				switch( select ) {
					case 0:
						...
						break;
					case 1:
						EngineCore.outputText( 'Heedless of your orders, both hands undo your gear, displaying your possessed member to ' + CoC.monster.a + CoC.monster.short + '.  A disembodied voice taunts, "<i>You really can\'t compete with me.  Seriously.  Take a good long look.  I\'m the fucking business.  Why don\'t you tuck that pathetic excuse for a cock between your legs and chuck down some succubi milk until you\'re a girl?  You\'d be better off.</i>"', false );
						break;
					case 2:
						EngineCore.outputText( 'Your ' + Descriptors.cockDescript( 0 ) + ' squirms around, pushing your ' + CoC.player.armorName + ' out of the way.  Exgartuan barks, "<i>Why are you bothering my host, fool?  Can\'t you see my magnificence?  You\'re nothing compared to me.  Go wank in shame and get out of our way.  We have cunts to fill.</i>"', false );
						break;
					case 3:
						EngineCore.outputText( 'The waist of your ' + CoC.player.armorName + ' expands as your ' + Descriptors.cockDescript( 0 ) + ' flies skyward fully erect, "<i>Tremble in fear, peon! My ' + Utils.num2Text( CoC.player.cocks[ 0 ].cockLength ) + ' inches of might shame that feeble nub between your legs.  We\'ve no time for your slack-jawed awe; go home and be a family man.</i>"', false );
						break;
					case 4:
						EngineCore.outputText( 'Disobeying your will, your hands promptly undo your ' + CoC.player.armorName + ', your ' + Descriptors.cockDescript( 0 ) + ' springing forth and flaring its urethra menacingly at the ' + CoC.monster.a + CoC.monster.short + ', "<i>You have a dick not even a mother could love.  Has that thing ever graced another living being\'s flesh?  Run back to your lonely hovel full of unattainable fantasies, and leave the real action to the pros.</i>"', false );
						break;
					case 5:
						EngineCore.outputText( 'Suddenly, your ' + CoC.player.armorName + ' pitches an impossible tent, the colossal bulge pointing directly at the ' + CoC.monster.a + CoC.monster.short + '.  You can only wince in discomfort as the back of your outfit pushes against you while a muffled voice taunts, "<i>How can something so insignificant remain so ANNOYING?  Your mere presence dulls the obvious radiance before you. DROP DEAD!</i>"', false );
						break;
					case 6:
						EngineCore.outputText( 'Your ' + CoC.player.armorName + ' unexpectedly opens itself of its own accord, prompting your ' + Descriptors.cockDescript( 0 ) + ' to extend into the open air, "<i>All the chemicals, potions, and morsels in existence can\'t help that infinitesimal tool you possess.  The orifices of this world deserve better!  All you are accomplishing this day is their disappointment in delaying the inevitable.</i>"', false );
						break;
					case 7:
						EngineCore.outputText( 'All of a sudden, your ' + CoC.player.armorName + ' splays open, your ' + Descriptors.cockDescript( 0 ) + ' quickly slithering up and around your back, stopping uncomfortably close to your face while pointing at your opponent, "<i>Look at this pitiful cretin, ' + CoC.player.short + '.  We could be out spreading hot dickings to the wanting cunts of the land.  But, no!  This ' + CoC.monster.a + CoC.monster.short + ' desires eradication.  Well, champion...oblige him.</i>"', false );
						break;
				}
			...
			if( CoC.monster.totalCocks() > 0 ) {
				...
				switch( select ) {
					case 0:
						...
						break;
					case 1:
						EngineCore.outputText( 'Your breasts wobble of their own accord, and ' + CoC.monster.a + CoC.monster.short + ' watches spellbound as they do so.  You silently thank Exgartuan for the help – maybe this fight will be easy.', false );
						break;
					case 2:
						EngineCore.outputText( 'A girlish voice calls out to ' + CoC.monster.a + CoC.monster.short + ', "<i>Hey cutey pie!  Why not just give up and submit, and maybe we\'ll let you play with our wondrous breasts.  Wouldn\'t that be nice?</i>"', false );
						break;
					case 3:
						EngineCore.outputText( 'Your ' + Descriptors.chestDesc() + ' begin to playfully bounce up and down, making it difficult for you to focus on your fight.  You aren\'t too worried, however, as the ' + CoC.monster.a + CoC.monster.short + ' seems to be hypnotized by the movement.', false );
						break;
					case 4:
						EngineCore.outputText( 'A sultry woman\'s voice teases the ' + CoC.monster.a + CoC.monster.short + ', "<i>There\'s no need for hostilities, is there?  Merely lay down your arms and come help fondle these marvels of creation.</i>"  Your ' + Descriptors.chestDesc() + ' shimmy for emphasis.', false );
						break;
					case 5:
						...
						break;
					case 6:
						EngineCore.outputText( 'You feel a moistness forming on your chest as a womanly voice takes shape, "<i>Come now, ' + CoC.monster.short + '.  Surely this fight has made you thirsty.  I wouldn\'t want to let all of this delicious breastmilk go to waste after all...</i>"  Oh, gods...', false );
						break;
				}
				//+Enemy lust;
	...
	Exgartuan.prototype.exgartuanArmorShift = function() {
		...
		if( CoC.player.armor === ArmorLib.BEEARMR ) {
			...
			EngineCore.outputText( 'Your leather armor shifts, pressing tightly against your upper ' + CoC.player.legs() + ' and molding itself around your ' + Descriptors.cockDescript( 0 ) + ' to prominently display it.', false );
			...
			EngineCore.outputText( 'You begin to clench your fists as your steel platemail heats up around your ' + CoC.player.legs() + ' and crotch. Slowly it begins to press itself against your ' + Descriptors.cockDescript( 0 ) + ' and match its every feature.', false );
			...
			EngineCore.outputText( 'Your leather armor shifts, pressing tightly against your upper ' + CoC.player.legs() + ' and molding itself around your ' + Descriptors.cockDescript( 0 ) + ' to prominently display it through your robes.', false );
			...
			EngineCore.outputText( 'You begin to feel your rubber outfit compressing itself against your upper ' + CoC.player.legs() + ' and ' + Descriptors.cockDescript( 0 ) + ', eliminating any pockets of air or wrinkles that may have existed before.', false );
	...
	Exgartuan.prototype.exgartuanLactationAdjustment = function() {
		...
		if( CoC.player.biggestLactation() > 1 ) {
			...
			if( Utils.rand( 2 ) === 0 || CoC.player.findStatusAffect( StatusAffects.Feeder ) >= 0 ) {
				EngineCore.outputText( 'Your nipples grow warm and sensitive, then start dripping milk into your ' + CoC.player.armorName + '.  Exgartuan appears to be having some fun with you again...', false );
		...
		//(Not lactating);
			...
			//(START);
			if( Utils.rand( 2 ) === 0 ) {
				EngineCore.outputText( 'Your chest feels cold.  You touch your ' + CoC.player.armorName + ' experimentally and discover a few drops of milk have leaked from your ' + Descriptors.nippleDescript( 0 ) + 's!  The demon has made you start lactating!', false );
				CoC.player.boostLactation( CoC.player.breastRows.length );
			}
			//Nipple stuff;
			else {
				//(Bigger Nipples!);
				if( Utils.rand( 2 ) === 0 ) {
					EngineCore.outputText( 'The inner surface of your ' + CoC.player.armorName + ' arouses you as it rubs against your ' + Descriptors.nippleDescript( 0 ) + 's.  You think about it and realize they\'ve never been like this before.  A quick check reveals each nipple has grown about a half inch longer.  Damn demons.', false );
	...
	Exgartuan.prototype.exgartuanSleepSurprise = function() {
		...
		if( CoC.player.cor <= 20 && CoC.player.findPerk( PerkLib.BulgeArmor ) >= 0 ) {
			...
			if( CoC.player.armorName !== 'crotch-hugging slutty swimwear' && CoC.player.armorName !== 'crotch-hugging revealing chainmail bikini' ) {
				EngineCore.outputText( '  You remove your ' + CoC.player.armorName + ' piece by piece, leaving only the magically-altered centerpiece that your favorite demon ever so generously "<i>gifted</i>" to you.\n\n', false );
			}
			//[else];
			else {
				EngineCore.outputText( '  You glare at your ' + CoC.player.armorName + ', its altered state so graciously bestowed upon you by the ever-thoughtful demon that resides in your crotch.\n\n', false );
			}
			...
			if( CoC.player.cor < 33 ) {
				...
				EngineCore.outputText( '.  Moans of pleasure vibrate the ' + CoC.player.cockHead() + ' lodged in your throat while bubbles of wetness begin to slide down the lower half of your esophagus into your gullet.\n\n', false );
			} else {
				...
				//(MED+COR, DONE A LOT:;
					...
					EngineCore.outputText( 'You grab hold of the swollen flesh with both hands and start to stroke it, reveling at the feel of your palms sliding along the veiny, pre-cum slicked flesh.  You gurgle happily, your moans of pleasure vibrating the ' + CoC.player.cockHead() + ' in your esophagus.  The swollen cock-tip dumps globules of pre-cum down your stretched throat, directly into your hungry gullet.  With both eyes crossed and your hands absorbed in fondling your member, you quickly forget your irritation at being woken up in such a way.  You get to cum SO HARD when you\'re fucking yourself like this!', false );
					if( CoC.player.biggestTitSize() >= 2 ) {
	...
	Exgartuan.prototype.exgartuanBulgeTortureII = function() {
		...
		if( CoC.player.armorName !== 'crotch-hugging slutty swimwear' && CoC.player.armorName !== 'crotch-hugging revealing chainmail bikini' ) {
			EngineCore.outputText( 'your last remaining piece of ' + CoC.player.armorName, false );
		}//[else];
		else {
			EngineCore.outputText( 'your ' + CoC.player.armorName, false );
		}
		...
		if( CoC.player.armorName === 'crotch-hugging full platemail' || CoC.player.armorName === 'crotch-hugging scale-mail armor' ) {
			EngineCore.outputText( 'your ' + CoC.player.armorName + ' feels as if it\'s become incredibly stiff, refusing to neither budge your package or impart any sense of feeling or vibration to what lies underneath.', false );
		}
		...
		if( CoC.player.armorName === 'crotch-hugging practically indecent steel armor' || CoC.player.armorName === 'crotch-hugging full-body chainmail' || CoC.player.armorName === 'crotch-hugging revealing chainmail bikini' ) {
			EngineCore.outputText( 'your ' + CoC.player.armorName + ' feels as if it\'s become incredibly dense, refusing to neither budge your package or impart any sense of feeling or vibration to what lies underneath.  What\'s worse, the links that make up your armor have narrowed and sealed shut.', false );
		} else {
			EngineCore.outputText( 'your ' + CoC.player.armorName + ' feels as if it were made from 6</i>" thick steel, refusing to neither budge your package or impart any sense of feeling or vibration to what lies underneath.  You continue to run your hands across it, having trouble believing that the material has become so incredibly dense and rigid despite its appearance.', false );
		}
	...
	Exgartuan.prototype.exgartuanBulgeTortureIII = function() {
		...
		if( CoC.player.armorName === 'crotch-hugging full platemail' || CoC.player.armorName === 'crotch-hugging scale-mail' ) {
			EngineCore.outputText( '  As you stare in bewilderment, you can\'t even begin to fathom how it possibly seeped through the steel of your solid ' + CoC.player.armorName, false );
		}
		//[if armorname IS EQUAL TO "<i>crotch-hugging practically indecent steel armor</i>" OR "<i>crotch-hugging full-body chainmail</i>" OR "<i>crotch-hugging revealing chainmail bikini</i>"];
			...
			EngineCore.outputText( '  Your fixation on the drop draws to question just how it managed its way through the sealed chains of your ' + CoC.player.armorName, false );
		} else {
		...
		EngineCore.outputText( 'Your frantic breathing seems to be competing with your pounding heartbeat, acting as if it were emanating from within your skull.  Your hands cling to the dirt and scant pieces of grass below you, unable to stop shaking or heed any of your commands.  Your already obscured vision begins to darken, more and more of the vague blobs fading into darkness.  Your ' + CoC.player.legs() + ' continue their numb strike against you while helping your ' + CoC.player.feet() + ' dig helplessly into the ground.  0...You\'ve run out of ideas, left with an insatiable hunger for sex, a body that refuses to do little more than convulse, and a mound of misfortune where your crotch resides.\n\n', false );
		...
		//[if occurrence ≥10];
			...
			EngineCore.outputText( '"<i>I can keep this up much longer than you can, ' + CoC.player.armorName + '.  As much as I enjoy watching you struggle to maintain some form of morality and moderation, I would much rather be exploring the world and its many orifices.  Some day you\'ll leave that fantasy realm you keep running to and join me in the real world.</i>"', false );
		}
		//[if occurrence ≥12];
		else {
	...
	Exgartuan.prototype.exgartuanBulgeTortureIV = function() {
		...
		if( CoC.player.armorName !== 'crotch-hugging slutty swimwear' && CoC.player.armorName !== 'crotch-hugging revealing chainmail bikini' ) {
			...
			EngineCore.outputText( 'the single piece of your ' + CoC.player.armorName, false );
		}
		EngineCore.outputText( '.  As you rise to your feet, a few streams of cum run down your ' + CoC.player.legs() + '.', false );
		//[If any followers];
	...
	Exgartuan.prototype.boobGartuanSURPRISE = function() {
		...
		if( CoC.flags[ kFLAGS.BOOBGARTUAN_SURPRISE_COUNT ] === 0 ) {
			...
			EngineCore.outputText( '"<i>' + CoC.player.short + '!</i>" he shouts snidely, a sneer working its way across his face, "<i>How long has it been?</i>"\n\n', false );
	...
	Exgartuan.prototype.boobgartuanSurprise3 = function() {
		...
		//[if occurrence ≥1];
			...
			EngineCore.outputText( '"<i>Ready for your final, eh, ' + CoC.player.short + '?</i>" Exgartuan teases, a faint lustful waver in her voice contrasting against her dominating demeanor, "<i>Let\'s make this one to remember.</i>"', false );
		}
		//[if occurrence ≥4];
		else if( CoC.flags[ kFLAGS.BOOBGARTUAN_SURPRISE_COUNT ] < 8 ) {
		...
		//[if occurrence ≥8];
			...
			EngineCore.outputText( 'Well, this has been fun, ' + CoC.player.short + '.  I look forward to beating you senseless and enjoying the wonderful makeup massage should you forget to see to my means yet again.', false );
		}
		EngineCore.outputText( '</i>"\n\n', false );
	...
	Exgartuan.prototype.exgartuanNagaStoleMyMasturbation = function() {
		...
		//[if corruption ≥30 & <60];
			...
			EngineCore.outputText( 'You happily remove your ' + CoC.player.armorName + ', eager to pleasure yourself.  Your possessed cock pulses happily as you remove the last article.', false );
		}
		//[if corruption ≥60 & <80];
		...
		//[else];
			...
			EngineCore.outputText( '"<i>Isn\'t this great, ' + CoC.player.short + '? With both of our sexual expertise combined, we\'ll own this land in no time, and enjoy the fuck out of any downtime."', false );
		}
