...
angular.module( 'cocjs' ).run( function( PerkLib, Isabella, EventParser, Descriptors, AppearanceDefs, Appearance, CockTypesEnum, $rootScope, CoC, kFLAGS, Utils, StatusAffects, EngineCore, Combat ) {
	...
	IsabellaScene.prototype.timeChange = function() {
		...
		if( CoC.getInstance().flags[ kFLAGS.UNKNOWN_FLAG_NUMBER_00260 ] > 0 ) {
			{ //Isabella is angry at the player
			}
			CoC.getInstance().flags[ kFLAGS.UNKNOWN_FLAG_NUMBER_00260 ]--;
			if( CoC.getInstance().flags[ kFLAGS.UNKNOWN_FLAG_NUMBER_00260 ] > 300 ) {
				CoC.getInstance().flags[ kFLAGS.UNKNOWN_FLAG_NUMBER_00260 ] = 300;
			}
			if( CoC.getInstance().flags[ kFLAGS.UNKNOWN_FLAG_NUMBER_00260 ] < 0 ) {
				CoC.getInstance().flags[ kFLAGS.UNKNOWN_FLAG_NUMBER_00260 ] = 0;
			}
		}
		if( CoC.getInstance().flags[ kFLAGS.ISABELLA_MILK_COOLDOWN ] > 0 ) {
			CoC.getInstance().flags[ kFLAGS.ISABELLA_MILK_COOLDOWN ]--;
			if( CoC.getInstance().flags[ kFLAGS.ISABELLA_MILK_COOLDOWN ] < 0 ) {
				CoC.getInstance().flags[ kFLAGS.ISABELLA_MILK_COOLDOWN ] = 0;
			}
		}
		if( CoC.getInstance().flags[ kFLAGS.ISABELLA_ACCENT_TRAINING_COOLDOWN ] > 1 ) {
			CoC.getInstance().flags[ kFLAGS.ISABELLA_ACCENT_TRAINING_COOLDOWN ]--;
		}
		if( CoC.getInstance().time.hours > 23 ) {
			if( CoC.getInstance().flags[ kFLAGS.FOUND_ISABELLA_AT_FARM_TODAY ] === 1 ) {
				CoC.getInstance().flags[ kFLAGS.FOUND_ISABELLA_AT_FARM_TODAY ] = 0;
			}
			if( CoC.getInstance().scenes.isabellaFollowerScene.isabellaFollower() && CoC.getInstance().flags[ kFLAGS.ISABELLA_MILKED_YET ] >= 0 && CoC.getInstance().flags[ kFLAGS.FOLLOWER_AT_FARM_ISABELLA ] === 0 ) {
				CoC.getInstance().flags[ kFLAGS.ISABELLA_MILKED_YET ]++;
			}
		}
		return false;
	};
	IsabellaScene.prototype.timeChangeLarge = function() {
		if( this.checkedIsabella++ === 0 && CoC.getInstance().time.hours === 6 && CoC.getInstance().scenes.isabellaFollowerScene.isabellaFollower() && CoC.getInstance().flags[ kFLAGS.FOLLOWER_AT_FARM_ISABELLA ] === 0 && CoC.getInstance().flags[ kFLAGS.ISABELLA_BLOWJOBS_DISABLED ] === 0 && CoC.getInstance().player.hasCock() && (CoC.getInstance().time.days % 2 === 0 || CoC.getInstance().player.findPerk( PerkLib.MarblesMilk ) < 0) && CoC.getInstance().player.shortestCockLength() <= 9 ) {
			EngineCore.spriteSelect( 31 );
			CoC.getInstance().scenes.isabellaFollowerScene.isabellaMorningWakeupCall();
			return true;
		}
		return false;
	};
	...
	IsabellaScene.prototype.isabellaGreeting = function() {
		...
		if( CoC.getInstance().flags[ kFLAGS.UNKNOWN_FLAG_NUMBER_00256 ] === 0 ) {
			...
			EngineCore.choices( 'Approach', this.isabellaGreetingFirstTime, '', null, '', null, '', null, 'Leave', CoC.getInstance().scenes.camp.returnToCampUseOneHour );
			return;
		}
		...
		if( CoC.getInstance().flags[ kFLAGS.UNKNOWN_FLAG_NUMBER_00257 ] === 0 ) {
			CoC.getInstance().flags[ kFLAGS.UNKNOWN_FLAG_NUMBER_00257 ]++;
			...
			//(Shorter PC's) ;
				...
				if( CoC.getInstance().flags[ kFLAGS.UNKNOWN_FLAG_NUMBER_00259 ] < 0 ) {
					CoC.getInstance().flags[ kFLAGS.UNKNOWN_FLAG_NUMBER_00259 ]++;
				}
				...
				if( CoC.getInstance().player.hasCock() ) {
					...
					if( CoC.getInstance().player.cocks[ CoC.getInstance().player.shortestCockIndex() ].cockLength < 9 ) {
				...
				EngineCore.choices( 'Talk', this.talkWithIsabella, 'Drink', this.nomOnMommaIzzysTits, 'Get Licked', suck, 'Fight', this.fightIsabella, 'Leave', CoC.getInstance().scenes.camp.returnToCampUseOneHour );
			}
			return;
		}
		//Camp Meeting – Repeat Unwelcome;
		else if( CoC.getInstance().player.tallness > 78 && CoC.getInstance().flags[ kFLAGS.UNKNOWN_FLAG_NUMBER_00258 ] === 0 ) {
		...
		//Camp Meeting – Was welcome tall, but not short yet!;
		else if( CoC.getInstance().flags[ kFLAGS.UNKNOWN_FLAG_NUMBER_00258 ] > 0 && CoC.getInstance().flags[ kFLAGS.UNKNOWN_FLAG_NUMBER_00259 ] === 0 && CoC.getInstance().player.tallness <= 78 ) {
			CoC.getInstance().flags[ kFLAGS.UNKNOWN_FLAG_NUMBER_00259 ]++;
			...
			if( CoC.getInstance().player.hasCock() ) {
				...
				if( CoC.getInstance().player.cocks[ CoC.getInstance().player.shortestCockIndex() ].cockLength < 9 ) {
					...
					if( CoC.getInstance().player.cocks[ CoC.getInstance().player.shortestCockIndex() ].cockLength < 20 ) {
		...
		//Camp Meeting – Welcomed Short but Not Tall;
		else if( CoC.getInstance().flags[ kFLAGS.UNKNOWN_FLAG_NUMBER_00259 ] > 0 && CoC.getInstance().flags[ kFLAGS.UNKNOWN_FLAG_NUMBER_00258 ] === 0 && CoC.getInstance().player.tallness > 78 ) {
			...
			CoC.getInstance().flags[ kFLAGS.UNKNOWN_FLAG_NUMBER_00258 ]++;
			if( CoC.getInstance().player.hasCock() ) {
		...
		//Follower go!;
		else if( CoC.getInstance().flags[ kFLAGS.ISABELLA_CAMP_DISABLED ] === 0 && CoC.getInstance().flags[ kFLAGS.ISABELLA_FOLLOWER_ACCEPTED ] === 0 && CoC.getInstance().scenes.isabellaFollowerScene.isabellaAffection() >= (50 + CoC.getInstance().flags[ kFLAGS.ISABELLA_TIMES_OFFERED_FOLLOWER ] * 15) ) {
			CoC.getInstance().scenes.isabellaFollowerScene.isabellaMoovesInGreeting();
			return;
		}
		...
		//Camp Meeting – Standard Repeat;
			...
			if( CoC.getInstance().player.hasCock() ) {
				EngineCore.outputText( '  She takes a long sniff and glances between your ' + CoC.getInstance().player.legs() + ' at your groin', false );
				if( CoC.getInstance().player.cocks[ CoC.getInstance().player.shortestCockIndex() ].cockLength >= 9 ) {
	...
	IsabellaScene.prototype.isabellaGreetingFirstTime = function() {
		CoC.getInstance().flags[ kFLAGS.UNKNOWN_FLAG_NUMBER_00256 ] = 1;
	...
	IsabellaScene.prototype.unwelcomeFightCowGal = function() {
		EngineCore.outputText( '', true );
		EngineCore.outputText( 'You ready your ' + CoC.getInstance().player.weaponName + ' and adopt a fighting pose.  No cow is going to chase you away!', false );
		if( !CoC.getInstance().scenes.isabellaFollowerScene.isabellaFollower() ) {
			CoC.getInstance().scenes.isabellaFollowerScene.isabellaAffection( -5 );
		}
		Combat.startCombat( new Isabella() );
		CoC.getInstance().flags[ kFLAGS.UNKNOWN_FLAG_NUMBER_00260 ] += 72;
		EngineCore.spriteSelect( 31 );
	...
	IsabellaScene.prototype.fightIsabella = function() {
		...
		EngineCore.outputText( 'You smirk at Isabella, and ready your ' + CoC.getInstance().player.weaponName + ', telling her you intend to have you way with her.  She turns beet red and grabs her shield, announcing, "<i>You von\'t find me such easy prey, and I vill punish you for being so naughty!</b>"', false );
		Combat.startCombat( new Isabella() );
		CoC.getInstance().flags[ kFLAGS.UNKNOWN_FLAG_NUMBER_00260 ] += 72;
		EngineCore.spriteSelect( 31 );
		EngineCore.doNext( EventParser.playerMenu );
	...
	IsabellaScene.prototype.tryToTalkDownAngryCow = function() {
		...
		if( CoC.getInstance().player.inte < 25 ) {
			...
			Combat.startCombat( new Isabella() );
			if( !CoC.getInstance().scenes.isabellaFollowerScene.isabellaFollower() ) {
				CoC.getInstance().scenes.isabellaFollowerScene.isabellaAffection( -2 );
			}
			Combat.enemyAI();
		}
		//(int below 50);
		...
		//(Else) ;
			...
			if( CoC.getInstance().player.weaponName !== 'fists' ) {
				EngineCore.outputText( 'You toss aside your ' + CoC.getInstance().player.weaponName + ' and', false );
			} else {
	...
	IsabellaScene.prototype.nomOnMommaIzzysTits = function() {
		...
		if( CoC.getInstance().player.tallness > 78 || CoC.getInstance().player.isTaur() ) {
			...
			if( CoC.getInstance().player.hasCock() ) {
				EngineCore.outputText( 'Your ' + CoC.getInstance().player.armorName + ' tents ', false );
				if( CoC.getInstance().player.biggestCockArea() > 40 ) {
			...
			if( CoC.getInstance().player.horns > 0 && CoC.getInstance().player.hornType > AppearanceDefs.HORNS_NONE ) {
			...
			if( CoC.getInstance().player.wingType > AppearanceDefs.WING_TYPE_NONE && CoC.getInstance().player.wingType !== AppearanceDefs.WING_TYPE_SHARK_FIN ) {
			...
			if( CoC.getInstance().player.hasCock() && x >= 0 ) {
				...
				if( CoC.getInstance().flags[ kFLAGS.UNKNOWN_FLAG_NUMBER_00261 ] === 0 ) {
				...
				CoC.getInstance().flags[ kFLAGS.UNKNOWN_FLAG_NUMBER_00261 ]++;
			}
			//(Generic End)  ;
			else {
		...
		//Voluntary Nursing (Small Characters);
			...
			EngineCore.outputText( 'You stop and look at them, just look, leaving nothing in the air but a long, pregnant pause that seems to go on and on.  Isabella coughs, snapping you from your reverie – you\'re standing a foot away from those sweat-glazed orbs, and you jerk your head back.  If you leaned any further forward, her prominent, quad-tipped areola would be in your mouth.  The cow-girl laughs and scoops you up in her arms before you can hesitate further.  Your cheek is crushed against a white spot on the side of her left tit, and your ' + Descriptors.buttDescript() + ' comes to rest on the short fur that sprouts from her thick thighs.  Isabella coos, "<i>Relax, ' + CoC.getInstance().player.short + ', and let Izabella sate your thirst.  You vill love it.</i>"\n\n', false );
			...
			if( CoC.getInstance().player.hasCock() && x >= 0 ) {
				...
				if( CoC.getInstance().flags[ kFLAGS.UNKNOWN_FLAG_NUMBER_00261 ] === 0 ) {
					...
					EngineCore.outputText( 'She sleep-fucked you again!  You sigh and wipe your hand off on your ' + CoC.getInstance().player.leg() + ', bemused by the cow-girl who seems too shy to sleep with someone who\'s awake.  Still, you feel completely sated in every way.  It\'s going to be a good ', false );
					if( CoC.getInstance().time.hours < 12 ) {
						EngineCore.outputText( 'day', false );
					} else if( CoC.getInstance().time.hours < 4 ) {
		...
		else if( CoC.getInstance().flags[ kFLAGS.ISABELLA_MILKED_YET ] > 0 ) {
			CoC.getInstance().flags[ kFLAGS.ISABELLA_MILKED_YET ] = 0;
		}
		CoC.getInstance().player.slimeFeed();
		//(Chance of thickening body to 75, chance of softening body if PC has a vag);
		if( Utils.rand( 2 ) === 0 ) {
			EngineCore.outputText( CoC.getInstance().player.modThickness( 75, 4 ), false );
		}
		if( Utils.rand( 2 ) === 0 && CoC.getInstance().player.hasVagina() ) {
	...
	IsabellaScene.prototype.izzyGivesSmallWangsFreeOral = function() {
		...
		EngineCore.outputText( 'Isabella goes to work immediately, undoing the lower portions of your ' + CoC.getInstance().player.armorName + ' with strong, forceful motions that shake your ' + Descriptors.assDescript() + ' as she forcibly disrobes you.  Free at last, your ' + Descriptors.cockDescript( x ) + ' flops out', false );
		...
		EngineCore.outputText( 'The cow-girl pulls down on her neckline, giving you a tantalizing view of her cream and caramel cleavage.  She leans forwards and presses her milk-swollen tits against your ' + CoC.getInstance().player.legs() + ', rocking up and down so that you can feel each of the soft orbs squeezing around you.  Isabella\'s tongue slides out... and out... and out, until you see at least seven inches of tongue hovering over your ' + Descriptors.cockDescript( x ) + '.  Her warm spittle drips from the pulsing, smooth pink exterior of her tantalizing tongue while it lashes back and forth, less than an inch away from your ' + CoC.getInstance().player.cockHead( x ) + '.  Each drop of fallen cow-girl spit that lands on your ' + CoC.getInstance().player.cockHead( x ) + ' only turns you on more, until you\'re grunting and panting at her, begging like an animal with a needy expression on your face.\n\n', false );
		...
		EngineCore.outputText( '</i>"  To emphasize her point, the well-endowed cow-girl leans down and shows you just how flexible she can be.  The hot, wet slipperiness of her oral organ turns sideways, mashing against the side of your ' + CoC.getInstance().player.cockHead( x ) + '.  A split-second later, it slides down, and her tongue makes another loop around your ' + Descriptors.cockDescript( x ) + '.  The process continues on and on, girding your manhood in wide, spit-lubed cow-tongue until the entire thing is cocooned inside Isabella\'s velvet embrace.\n\n', false );
		...
		if( CoC.getInstance().player.sens < 50 ) {
			EngineCore.outputText( 'You moan happily, hips rocking instinctively against the cow-girl\'s vacuum-tight tongue-job as she cranks up her efforts to the maximum in an effort to make you blow already.  Panting lustily, you grab her horns and pull her face partway back, then slam it down while your ' + Descriptors.cockDescript( x ) + ' drips pre-cum onto the top of her tongue.  She flaps it back and forth, smearing your ' + CoC.getInstance().player.cockHead( x ) + ' with the slippery stuff and torturing you with exquisite sensations that would have lesser individuals spurting in seconds.\n\n', false );
			if( CoC.getInstance().scenes.isabellaFollowerScene.isabellaAccent() ) {
				EngineCore.outputText( 'Isabella grunts and pulls back, pulling her horns from your pleasure-weakened fingers and panting heavily.  She groans, "<i>Nein, I cannot believe it!  Such a small, hard little cock and I couldn\'t make it spurt, not even vith mein special techniques!</i>"  She looks up at you with her flushed, breathy face and coos, "<i>You are NOT a pervert after all.  Not a ' + CoC.getInstance().player.mf( 'boy', 'maid' ) + ', but a ' + CoC.getInstance().player.mf( 'man', 'woman' ) + ' with a beautiful, succulent little cock for Isabella to suck.  How lucky I am!</i>"\n\n', false );
			} else {
				EngineCore.outputText( 'Isabella grunts and pulls back, pulling her horns from your pleasure-weakened fingers and panting heavily.  She groans, "<i>No, I can\'t believe it!  Such a small, hard little cock and I couldn\'t make it spurt, not even with my special techniques!</i>"  She looks up at you with her flushed, breathy face and coos, "<i>You aren\'t a pervert after all.  Not a ' + CoC.getInstance().player.mf( 'boy', 'maid' ) + ', but a ' + CoC.getInstance().player.mf( 'man', 'woman' ) + ' with a beautiful, succulent little cock for Isabella to suck.  How lucky I am!</i>"\n\n', false );
			}
			...
			EngineCore.outputText( '\n\n', false );
			EngineCore.outputText( 'Isabella pulls back and licks her lips, leaving you to realize that your ' + CoC.getInstance().player.legs() + ' have been completely soaked with the cow-girl\'s own sweet cream.  ', false );
			...
			if( CoC.getInstance().scenes.isabellaFollowerScene.isabellaAccent() ) {
				...
				EngineCore.outputText( 'The feisty redhead happily helps you back into your ' + CoC.getInstance().player.armorName + ' and gives you an unceremonious smack on the ' + Descriptors.buttDescript() + ' before saying her goodbyes, "<i>Come back soon, ' + CoC.getInstance().player.short + '!  You are quite ze ' + CoC.getInstance().player.mf( 'man', 'woman' ) + ', even if your tasty penis is tiny.  Oh don\'t look like zat, it makes such tasty salt-milk!  I\'ll lick it up any time.  Now go, I\'m sure you have much to do!</i>"\n\n', false );
			} else {
				...
				EngineCore.outputText( 'The feisty redhead happily helps you back into your ' + CoC.getInstance().player.armorName + ' and gives you an unceremonious smack on the ' + Descriptors.buttDescript() + ' before saying her goodbyes, "<i>Come back soon, ' + CoC.getInstance().player.short + '!  You are quite the ' + CoC.getInstance().player.mf( 'man', 'woman' ) + ', even if your tasty penis is tiny.  Oh don\'t look like that, it makes such tasty salt-milk!  I\'ll lick it up any time.  Now go, I\'m sure you have much to do!</i>"\n\n', false );
			}
		}
	...
	IsabellaScene.prototype.volunteerToSlurpCowCunt = function() {
		...
		if( CoC.getInstance().player.cor < 33 ) {
			...
			EngineCore.outputText( 'Unabashedly, you dive right into the cow-girl\'s lust-slicked snatch.  Her greedy lips swallow your nose and lips with one wet squelch, but the cow-girl doesn\'t seem quite satisfied until her hand is on the back of your head, mashing your ' + CoC.getInstance().player.face() + ' roughly over her sex.', false );
		}
		...
		if( !CoC.getInstance().scenes.isabellaFollowerScene.isabellaAccent() ) {
			EngineCore.outputText( 'Isabella sighs contentedly and says, "<i>Thank you, ' + CoC.getInstance().player.short + '.  You\'re a vonderful licker of the pussy.  Perhaps one of zese times I vill keep you for myself, ja?  I kid, I kid.</i>"  She blushes heavily, as if realizing what she just said and turns to busy herself with cleaning up.  You get dressed, having some difficulty hiding the lust the act inspired in you.\n\n', false );
		} else {
			EngineCore.outputText( 'Isabella sighs contentedly and says, "<i>Thank you, ' + CoC.getInstance().player.short + '.  You\'re a wonderful pussy licker.  Perhaps one of these times I will keep you for myself, huh?  I kid, I kid.</i>"  She blushes heavily, as if realizing what she just said and turns to busy herself with cleaning up.  You get dressed, having some difficulty hiding the lust the act inspired in you.\n\n', false );
		}
		//(+lots of lust);
		...
		if( CoC.getInstance().player.hasCock() ) {
			...
			if( CoC.getInstance().player.cocks[ CoC.getInstance().player.shortestCockIndex() ].cockLength >= 9 ) {
				...
				EngineCore.doYesNo( this.izzyGivesSmallWangsFreeOral, CoC.getInstance().scenes.camp.returnToCampUseOneHour );
				return;
			}
		}
		CoC.getInstance().scenes.isabellaFollowerScene.isabellaAffection( 2 );
		if( !CoC.getInstance().scenes.isabellaFollowerScene.isabellaFollower() || !CoC.getInstance().player.hasVagina() || CoC.getInstance().player.biggestTitSize() < 1 ) {
			EngineCore.doNext( CoC.getInstance().scenes.camp.returnToCampUseOneHour );
		} else {
			...
			//[Leave] [Get Cowlicked];
			EngineCore.choices( 'Get Licked', CoC.getInstance().scenes.isabellaFollowerScene.receiveAllTheCowTOngues, 'Leave', CoC.getInstance().scenes.camp.returnToCampUseOneHour, '', null, '', null, '', null );
		}
	};
	IsabellaScene.prototype.IsabellaWinsAndSpanks = function() {
		...
		if( CoC.getInstance().player.tallness <= 78 ) {
			...
			EngineCore.outputText( '  A hand grabs hold of the back of your ' + CoC.getInstance().player.armorName + ' and lifts you up, placing you firmly over the cow-girl\'s fur-covered knee.  You can feel the transition from fur to skin underneath your belly, at the midpoint of her thigh.  ', false );
			...
			EngineCore.outputText( '"<i>Bad <SMACK> ' + CoC.getInstance().player.mf( 'boy', 'girl' ) + '! <CRACK> Learn <SLAP> your <SWAT> lesson!</i>"  Her sentence is punctuated with one bone-jarring blow that ', false );
			if( CoC.getInstance().player.findPerk( PerkLib.Masochist ) < 0 ) {
		...
		//[Lose And Get Spanked – Tall];
			...
			EngineCore.outputText( '  A hand grabs hold of the back of your ' + CoC.getInstance().player.armorName + ' and props you up, ass in the air.  ', false );
			if( CoC.getInstance().player.lust > 99 ) {
			...
			if( CoC.getInstance().scenes.isabellaFollowerScene.isabellaAccent() ) {
				EngineCore.outputText( '"<i>Zere zere big ' + CoC.getInstance().player.mf( 'boy', 'girl' ) + ', just lie zere and drink.  Ve\'ll forget about all that earlier nastiness.  I\'d feel bad leaving you out here all alone – you\'d probably turn into one of ze monsters!</i>"\n\n', false );
			} else {
				EngineCore.outputText( '"<i>There there big ' + CoC.getInstance().player.mf( 'boy', 'girl' ) + ', just lie there and drink.  we\'ll forget about all that earlier nastiness.  I\'d feel bad leaving you out here all alone – you\'d probably turn into one of the monsters!</i>"\n\n', false );
			}
	...
	IsabellaScene.prototype.isabellaRapesYouWithHerAss = function() {
		EngineCore.outputText( '', true );
		var x = CoC.getInstance().player.cockThatFits( 38 );
		if( x < 0 ) {
			x = 0;
		}
		...
		EngineCore.outputText( '  The cow-girl plants a hoof on your chest, pinning you into the dusty sod of her camp while she looks you up and down.  The victorious redhead leers at your groin while she begins to tear off your ' + CoC.getInstance().player.armorName + '.  It doesn\'t take her more than a few seconds to expose your ' + Descriptors.multiCockDescriptLight() + '.', false );
		if( CoC.getInstance().player.lust > 99 ) {
		...
		if( CoC.getInstance().player.cockThatFits( 38 ) >= 0 ) {
			EngineCore.outputText( ' little', false );
		} else {
		...
		//[TOOBIG];
			...
			EngineCore.outputText( ', pooling around your ' + CoC.getInstance().player.legs() + ' on the ground.', false );
			if( CoC.getInstance().player.cumQ() >= 1000 ) {
	...
	IsabellaScene.prototype.IsabellaPostSpankFeedSex = function() {
		...
		if( !CoC.getInstance().scenes.isabellaFollowerScene.isabellaFollower() ) {
			CoC.getInstance().scenes.isabellaFollowerScene.isabellaAffection( 3 );
		}
		CoC.getInstance().player.orgasm();
		Combat.cleanupAfterCombat();
	};
	...
	IsabellaScene.prototype.isabellaDefeats = function() {
		if( CoC.getInstance().monster.statusAffectv1( StatusAffects.Sparring ) <= 1 ) {
			if( CoC.getInstance().player.hasCock() && Utils.rand( 2 ) === 0 ) {
	...
	IsabellaScene.prototype.defeatIsabella = function() {
		...
		var vaginalSex = null;
		if( CoC.getInstance().player.hasCock() ) {
			if( CoC.getInstance().player.cockThatFits( CoC.getInstance().monster.analCapacity() ) !== -1 && CoC.getInstance().player.lust >= 33 ) {
			...
			if( CoC.getInstance().player.cockArea( CoC.getInstance().player.biggestCockIndex() ) > 70 && CoC.getInstance().player.lust >= 33 ) {
				bigTitFuck = this.tooBigVictoryTittyFuckingFuntimesWithMilk;
			}
			if( CoC.getInstance().player.cocks[ CoC.getInstance().player.shortestCockIndex() ].cockLength < 9 && CoC.getInstance().player.lust >= 33 ) {
	...
	IsabellaScene.prototype.victoryLactation69 = function() {
		...
		EngineCore.outputText( ' You nod as the blissed-out cow-girl closes her eyes, contented and cradling the slight paunch you\'ve given her.  A moment later you\'ve regained your strength, but you have trouble fitting back into your ' + CoC.getInstance().player.armorName + ' with all the milk in your system.', false );
		if( !CoC.getInstance().scenes.isabellaFollowerScene.isabellaFollower() ) {
			CoC.getInstance().scenes.isabellaFollowerScene.isabellaAffection( 8 );
		}
	...
	IsabellaScene.prototype.PCVictoryOnIsabellaButtsex = function() {
		...
		EngineCore.outputText( 'You shrug out of your ' + CoC.getInstance().player.armorName + ' and expose ' + Descriptors.sMultiCockDesc() + ' to the warm, breezy air', false );
		...
		EngineCore.outputText( 'Isabella\'s eyes widen with from the sudden pressure of your ' + CoC.getInstance().player.cockHead( x ), false );
		if( y >= 0 ) {
			EngineCore.outputText( ' and other ' + CoC.getInstance().player.cockHead( y ) + ' pressing against her holes', false );
		} else {
		...
		if( y >= 0 ) {
			...
			EngineCore.outputText( 'spews out a few strands of girl-juice that cling to your ' + CoC.getInstance().player.legs() + ', hanging and stretching with every sticky slap against her body.', false );
		}
	...
	IsabellaScene.prototype.victoryAgainstIzzzzzySixtyNine = function() {
		...
		EngineCore.outputText( '', true );
		EngineCore.outputText( 'You aren\'t interested in her milk though.  You came for a different sort of relief, and Isabella should be thankful you plan to share it.  The confused, beaten cow watches you with wide, helpless eyes as you disrobe, dropping your ' + CoC.getInstance().player.armorName + ' heavily on some of her rugs.  Her skirt shouldn\'t pose a problem; a quick push has it bunched up around Isabella\'s waistline.  With the offending garment moved, you can get a good look at a sight you plan to get <b>intimately</b> familiar with for the next fifteen minutes or so.\n\n', false );
		...
		} else if( CoC.getInstance().player.cockThatFits( 38 ) !== -1 ) {
		...
		if( CoC.getInstance().player.gender === 2 ) {
			...
			} else if( CoC.getInstance().player.clitLength >= 2 ) {
		...
		CoC.getInstance().player.orgasm();
		if( !CoC.getInstance().scenes.isabellaFollowerScene.isabellaFollower() ) {
			CoC.getInstance().scenes.isabellaFollowerScene.isabellaAffection( 9 );
		}
		CoC.getInstance().flags[ kFLAGS.UNKNOWN_FLAG_NUMBER_00260 ] = 0;
		CoC.getInstance().player.slimeFeed();
	...
	IsabellaScene.prototype.tooBigVictoryTittyFuckingFuntimesWithMilk = function() {
		...
		EngineCore.outputText( '', true );
		EngineCore.outputText( 'You toss aside your ' + CoC.getInstance().player.armorName + ' to reveal your ' + Descriptors.cockDescript( x ) + ' to the ', false );
		if( CoC.getInstance().monster.lust > 99 ) {
		...
		EngineCore.outputText( 'Your gaze is so intently focused on the quad-tipped areolae that you barely acknowledge her request.  A slight grunt escapes your lips while you fondle your shaft, squeezing it gently with both hands.  You take a half-step forward and aim your ' + CoC.getInstance().player.cockHead( x ) + ' between Isabella\'s breasts.  The first dollop of pre-cum oozes from the tip just in time to smear into the valley of cleavage, lubricating the sweaty skin even further.  Her body is hot from the recent combat, and the warm, wet embrace of the cow-girl\'s bosom feels absolutely heavenly as you slide home through the valley of chest.\n\n', false );
		EngineCore.outputText( 'Sighing blissfully, you grab hold of Isabella\'s breasts by the prominent nipples and pull them together, finishing the titillating encapsulation of your member.  She moans loudly at the forceful tug as she watches you violating her tits.  The ' + CoC.getInstance().player.cockHead( x ) + ' of your ' + Descriptors.cockDescript( x ) + ' bursts from between the pillowy mounds to leak on the cow-girl\'s chest, and the bovine beauty can only manage a dark blush in response.  You\'re already leaking a steady trickle of pre-cum from your crown from the hot tightness of Izzy\'s tits; orgasm isn\'t too far.\n\n', false );
		EngineCore.outputText( 'The cow-girl utters a pleasured moo in response to the tight nipple tension.  Holding tightly, you roll the four tips between your fingers as you slowly begin to fuck the cow-girl, ignoring the wetness that begins to squirt between them.  Isabella\'s hips seem to squirm of their own volation, and the cow-girl\'s legs spread wide to grind her skirt-girded loins against your ' + CoC.getInstance().player.legs() + '.  You respond by turning your gentle thrusts into rough, pistoning motions that shake the jiggling melons violently around your ' + Descriptors.cockDescript( x ) + ', but it only seems to please the milk-spurting cow.\n\n', false );
		EngineCore.outputText( 'Isabella grinds against you in a frenzy, thrashing wildly against your ' + CoC.getInstance().player.legs() + '.  Her motions only exacerbate the tightness of the tit-sleeve milking your ' + Descriptors.cockDescript( x ) + ', and as you look down at the convulsing cow-girl\'s blissful expression, you feel a telltale welling of pressure in your ' + Descriptors.ballsDescriptLight() + '.  You wait for her mouth to gape particularly wide before thrusting forward, ', false );
		...
		if( CoC.getInstance().player.cocks[ x ].cockLength < 50 ) {
			...
			EngineCore.outputText( 'leans back to swallow your ' + CoC.getInstance().player.cockHead( x ) + ' and lick it, just before', false );
		}
	...
	IsabellaScene.prototype.vaginalProdNPokeIsabella = function() {
		...
		if( CoC.getInstance().scenes.isabellaFollowerScene.isabellaAccent() ) {
			EngineCore.outputText( '"<i>Nein! I... I never vanted to have to fight you!  And I definitely didn\'t vant to vind up on my keister vith my legs spread while a handsome ' + CoC.getInstance().player.mf( 'man', 'woman' ) + ' ogles my vagina!</i>" exclaims the cow-girl.\n\n', false );
		} else {
			EngineCore.outputText( '"<i>No! I... I never wanted to have to fight you!  And I definitely didn\'t want to wind up on my butt with my legs spread while a handsome ' + CoC.getInstance().player.mf( 'man', 'woman' ) + ' ogles my vagina!</i>" exclaims the cow-girl.\n\n', false );
		}
		...
		if( CoC.getInstance().player.totalCocks() > 1 ) {
			...
			if( CoC.getInstance().player.totalCocks() > 2 ) {
				EngineCore.outputText( 'another ' + CoC.getInstance().player.oMultiCockDesc(), false );
			} else {
	...
	IsabellaScene.prototype.talkWithIsabella = function() {
		EngineCore.spriteSelect( 31 );
		EngineCore.outputText( '', true );
		CoC.getInstance().flags[ kFLAGS.UNKNOWN_FLAG_NUMBER_00262 ]++;
		if( CoC.getInstance().flags[ kFLAGS.UNKNOWN_FLAG_NUMBER_00262 ] === 1 ) {
	...
	CoC.getInstance().registerScene( 'isabellaScene', new IsabellaScene() );
} );