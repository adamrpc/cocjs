...
angular.module( 'cocjs' ).run( function( MainView, SceneLib, Kiha, SpiderMorphMob, ConsumableLib, PerkLib, Descriptors, AppearanceDefs, Appearance, CockTypesEnum, CoC, kFLAGS, Utils, StatusAffects, EngineCore, Combat ) {
	...
	KihaFollower.prototype.kihaSpiderEventIntro = function() {
		...
		MainView.outputText( 'You make your way to the swamp, and soon find yourself submerged waist-deep in a reeking marsh surrounded by tall, vine-covered trees, many of which support strands of thick gossamer webbing.  You wander the bog for what seems like an eternity before you finally stumble across a small island, in what may well be the heart of the swamp.  At this point, you\'re moments from saying to hell with it and going home, but... why not?\n\n', false );
		MainView.outputText( 'You drag yourself up onto the shore of the island and take a quick look around.  The small isle is completely cut off from the swamp around it, surrounded on all sides by the thick, murky water you\'ve been wading through.  A small glade stands in the center of the land here, surrounded by the trees of the shoreline.  In its center lies a coppice of tightly spaced trees.  Surprisingly, it\'s clear of vines and webbing, quite unlike most of the swamp.  This incongruity only reminds you that you\'ve seen neither hide nor hair of any of the swamp\'s denizens in quite some time.  The stillness and silence around the glade is unnerving, and for just a split second, you feel as if you\'re being watched.\n\n', false );
		MainView.outputText( 'Warily, you approach the trees in the center.  While you had guessed they were tightly packed by the darkness beyond them, you\'re surprised to see that the tall ones have grown so close together that their bark forms something of a solid, circular wall, and their canopies a thick roof.  You\'re forced to circle around the grove, unable to find another means of ingress - even the tiniest of cracks between tree-trunks has been filled in with thick layers of dried mud.\n\n', false );
		MainView.outputText( 'Intrigued, you\'re considering climbing the bark walls when you hear wings flapping above you.  You look up just in time to see Kiha the dragoness plummeting down from on high, her axe arcing towards you!\n\n', false );
		MainView.outputText( 'Evading it by a hair\'s breadth, you can yet feel the burning-hot metal of her weapon with the flesh of your shoulder.  You roll out of her reach, and a moment later Kiha exhales a white-hot plume of fire, creating a burning barrier between you.\n\n', false );
		MainView.outputText( 'Furious, she screams, "<i>I knew it!  You really ARE one of Lethice\'s spies, aren\'t you?  Why else would you keep harassing me?  What do you WANT!?</i>"\n\n', false );
		MainView.outputText( 'What the fuck?  ', false );
		if( CoC.player.cor < 66 ) {
			MainView.outputText( 'You try to calm the dragoness down, explaining that you aren\'t one of Lethice\'s minions, that what you told her the first time around was true - that you\'re here to end the demon threat.  Kiha doesn\'t seem to be buying it, though...\n\n', false );
		} else {
			MainView.outputText( 'Irate, you stare her down, and with a dangerous gentleness, remind her that you\'re here to crush the demons.  Your fist tightens as, not unexpectedly, the erratic woman appears to hear none of it.\n\n', false );
		}
	...
	KihaFollower.prototype.loseKihaPreSpiderFight = function() {
		MainView.outputText( '', true );
		MainView.spriteSelect( 72 );
		MainView.outputText( 'Before you can collapse, Kiha grabs you by the throat and hauls you off the ground.  She slams your back into the bark of a tree, crushing your windpipe with her powerful clawed hand.  She puts her face right up next to yours, so that you can feel her hot, searing breath on your face, nearly enough to blister your skin.\n\n', false );
		...
		MainView.outputText( 'You could warn Kiha of the approaching mob - or you could let them jump her and scamper away in the confusion, leaving Kiha to whatever horrible fate awaits her.  What do you do?', false );
	...
	KihaFollower.prototype.playerBeatsUpKihaPreSpiderFight = function() {
		MainView.outputText( '', true );
		MainView.spriteSelect( 72 );
		MainView.outputText( 'The dragoness slumps back against one of the trees, her limbs trembling weakly.\n\n', false );
		MainView.outputText( '"<i>I... I won\'t let you... take me...</i>" she groans, trying desperately to stand and continue the fight.  Before you can do anything about the situation, however, you hear waves breaking just behind you.  Turning, you see a horde of some two dozen spider-morphs approaching the little island.  It seems Kiha\'s made enemies of the swamp\'s denizens, and you\'ve finally taken the dragoness down hard enough that they\'re coming for their sweet revenge.\n\n', false );
		MainView.outputText( 'You look down upon your fallen foe, who is now watching wide-eyed as the first spider-folk pull themselves up onto dry land, brandishing claws and fangs and clubs.  For a moment, you\'re sure you can see raw terror in her eyes.\n\n', false );
		MainView.outputText( '"<i>Oh, Marae,</i>" she whimpers as a pair of driders come into view, both grinning wickedly as they take the lead of the horde.\n\n', false );
		MainView.outputText( 'To your surprise, Kiha hangs her head and whispers, "<i>Just go, ' + CoC.player.short + '.  You\'ve already beaten me, and they\'ll punish me for my weakness...  I deserve whatever\'s coming to me.  So JUST GO!</i>"\n\n', false );
		MainView.outputText( 'You could make like a baker and move your buns, but Gods knows what will happen to Kiha if you do.', false );
	...
	KihaFollower.prototype.letTheSpidersHaveTheirWayWithKiha = function() {
		...
		MainView.outputText( 'You say nothing to alert the savage dragoness to her impending doom.  Only when one of the driders stalks up behind her does Kiha seem to realize something is amiss, and by then it is far too late.  The drider picks her up by her weapon arm and slaps a wad of wet webbing into her mouth, holding the surprised Kiha for only a moment before throwing her to the mob who descend upon her in a frenzy of muffled screaming and erect penises.\n\n', false );
	...
	KihaFollower.prototype.helpKihaAgainstSpoidahs = function() {
		MainView.outputText( '', true );
		MainView.spriteSelect( 72 );
		MainView.outputText( 'Looking from the defeated dragoness to the horde of spider-folk about to, at best, gang-rape her, you lean down and offer Kiha a hand.\n\n', false );
		MainView.outputText( '"<i>W-what are... what do you think you\'re doing, ' + CoC.player.short + '?</i>" she snaps, recoiling away from you.  "<i>I told you to run!</i>"\n\n', false );
		MainView.outputText( 'Beckoning once again with your hand, you look at her with as much seriousness as you can manage and say, "<i>Join with me if you want to live.</i>"\n\n', false );
		MainView.outputText( '"<i>W-what!?</i>" she asks, utterly dumbfounded by your insistence.  Lacking the time to ', false );
		if( CoC.player.cor >= 66 ) {
			MainView.outputText( 'beat', false );
		} else {
			MainView.outputText( 'talk', false );
		}
	...
	KihaFollower.prototype.beatSpiderMob = function() {
		...
		MainView.outputText( '', true );
		MainView.spriteSelect( 72 );
		MainView.outputText( '"<i>Fall back!</i>" screams the largest of the two driders, clutching a nasty wound you\'ve left on her breast.  "<i>Let\'s get out of here!</i>"[pg]', false );
		MainView.outputText( 'The spiders retreat, skulking back into the swamp, licking their wounds and tucking their tails.  You and Kiha are left standing victorious, surrounded by splinters of chitin and bits of spider silk.  Panting heavily from two grueling consecutive battles, Kiha leans against her massive axe, looking nearly ready to collapse.  Gently, you put a hand on her shoulder - this time, she doesn\'t shrug it off.[pg]', false );
		MainView.outputText( '"<i>Why, ' + CoC.player.short + '?</i>" she asks, her voice barely more than a whisper.  "<i>Why... why did you help me?  I tried to hurt you, and you just... turned around and saved me.  I don\'t get it.</i>"[pg]', false );
		MainView.outputText( 'You explain again that you aren\'t a servant of Lethice - that it\'s Kiha\'s choice whether she\'s your enemy or not.  She listens, motionless, but you can see her gaze has softened considerably since the first time you tried talking sense to the powerful dragoness.[pg]', false );
		MainView.outputText( '"<i>', false );
		if( EngineCore.silly() ) {
			MainView.outputText( 'B-baka', false );
		} else {
			MainView.outputText( 'Dumbass', false );
		}
		MainView.outputText( ',</i>" she finally says as you finish talking.  "<i>You could have gotten yourself raped, or beaten, or killed!  But still... I...</i>" she suddenly flushes bright red, just like her scales.  "<i>Thanks, I guess.</i>"', false );
		MainView.outputText( '[pg]You ', false );
		if( CoC.player.cor < 50 ) {
			MainView.outputText( 'squeeze her shoulder and ', false );
		}
		MainView.outputText( 'tell her that maybe now, the two of you can be friends.', false );
		MainView.outputText( '[pg]"<i>Friends... yeah, maybe that wouldn\'t be terrible,</i>" Kiha says, giving you an arrogant smile.  "<i>Go on, get out of here.</i>"  You return her smile and start walking toward the water\'s edge.', false );
		MainView.outputText( '[pg]"<i>H-hey, ' + CoC.player.short + '!</i>"  Kiha suddenly shouts, causing you to turn at the shore.  "<i>D-don\'t forget... um, I mean... remember where this place is, all right?  Friends, uh, visit each other sometimes, I guess.</i>"', false );
	...
	KihaFollower.prototype.kihaFriendlyGreeting = function( output ) {
		...
		if( output && CoC.flags[ kFLAGS.KIHA_TALK_STAGE ] === 6 && CoC.player.cor <= 50 ) {
			...
			MainView.outputText( '[pg]To your initial great relief, you find Kiha sitting outside her swampy home, head hung low and held between her strong hands.  But as you approach, you notice her hair has been rustled, torn in places, and she\'s covered in small cuts and bruises.  Horrified, you can see dark white stains along her thighs and ever-damp crotch, or smeared between her big, bare breasts.  You can only imagine what has happened to her in your absence.', false );
			MainView.outputText( '[pg]"<i>Kiha... are you alright?</i>"', false );
			MainView.outputText( '[pg]Her fire-red eyes glance up at you, though she neither moves nor responds.  Without another word, you sit down beside her and wrap an arm around the dragoness\'s shoulders.  To your surprise, she doesn\'t push you away.  Indeed, you feel her tremble just a bit at your touch.', false );
			MainView.outputText( '[pg]"<i>I-I fucked up, alright?</i>"  she finally says after a long silence, picking her head up to look you in the eye.  "<i>That\'s... that\'s what you came here to hear, isn\'t it?  You want to hear me say it, don\'t you!?  Well fine were right, and I was wrong.  I can\'t just go kick down Lethice\'s door.  I-I couldn\'t even get close.</i>"  You try to comfort her, but Kiha just turns her face sharply away, refusing to let you see her as she lets out what could have been a growl... or a sob.', false );
			MainView.outputText( '[pg]"<i>Maybe you\'re right... maybe we can\'t win.  After all... Lethice already has.</i>"', false );
			MainView.outputText( '[pg]A part of you wants to slap her, to shake her violently and tell her that no, she\'s wrong.  Instead, you squeeze her tight against you and look up to the heavens.  The dragoness\'s islet has a clear line of sight to the open air, a perfect place for the airborne predator to take off and land.  But from here, you can clearly see the ', false );
			if( CoC.time.hours < 20 ) {
				MainView.outputText( 'clouds', false );
			} else {
				MainView.outputText( 'stars', false );
			}
			MainView.outputText( ' in the sky.  You point to them, telling Kiha to look.  The dragoness does as you ask, following your pointing finger up to the sky.  After a moment, though, she harrumphs and scowls at you.', false );
			MainView.outputText( '[pg]"<i>What the hell am I supposed to be looking at?  It\'s just the sky.  So what?</i>"', false );
			MainView.outputText( '[pg]God dammit Kiha.', false );
			MainView.outputText( '[pg]You shake your head and try to explain why the ', false );
			if( CoC.time.hours < 20 ) {
				MainView.outputText( 'clouds', false );
			} else {
				MainView.outputText( 'stars', false );
			}
			MainView.outputText( ' are beautiful.  You spend a few minutes pointing to a few shapes and patterns in the sky, a warrior with a shield here, a proud centaur there - you even spot a dragon.  Kiha listens with disinterest, rolling her eyes as you try to show her one of the last, immutable things of beauty left in the world.  Even the demons, you say, cannot destroy the heavens.', false );
			MainView.outputText( '[pg]"<i>Bah!  You just watch, ' + CoC.player.short + '.  The queen bitch isn\'t just sitting on her ass; she won\'t rest until the whole world\'s ruined!  The demons already ruined the seasons, caused an endless drought.  Who\'s to say they can\'t shoot a giant dick into the sky, or make it rain corrupted cum forever, until we\'re all slavering monsters?  What\'s to stop them, huh?</i>"', false );
			MainView.outputText( '[pg]You are.  She is.  All of you - anyone who hasn\'t given in to corruption.  Anyone with the will and the strength to fight back.  You tell her of everyone you\'ve met in your travels, the few stalwart souls that still resist Lethice\'s hordes.', false );
			MainView.outputText( '[pg]"<i>Then why... why haven\'t we done something, ' + CoC.player.short + '?  Why couldn\'t we just have gone... together?</i>"', false );
			MainView.outputText( '[pg]Because you aren\'t ready yet.  Neither is she.  But some day - soon - you will be.', false );
			MainView.outputText( '[pg]To your surprise, Kiha slips an arm of her own around your waist, returning your affection for the first time.  You smile, and stroke her cheek, happy as the dragoness rests her head on your shoulder.', false );
			...
			MainView.outputText( 'Deciding to pay the pretty dragoness a visit, you make your way into the swamp and to the island grove Kiha called her home.  To your delight, it seems Kiha has moved a fallen tree-trunk over the muck, creating a bridge from the bank to her island\'s shore.  ', false );
			if( CoC.flags[ kFLAGS.KIHA_NEED_SPIDER_TEXT ] === 1 ) {
				MainView.outputText( 'Though you can see a few spider-folk watching you as you make your way across, the thrashing you gave them last time seems to be keeping them at bay for now.  ', false );
				CoC.flags[ kFLAGS.KIHA_NEED_SPIDER_TEXT ] = 0;
			}
			MainView.outputText( 'You walk over to the ring of trees and call out for the dragoness.', false );
			MainView.outputText( '[pg]A moment later and she explodes from the treetops, landing in front of you with enough force to shake the ground.  She stands, fiery greataxe held at the ready, but when she recognizes you, however, she visibly relaxes.', false );
			MainView.outputText( '[pg]"<i>Oh, uh, hey, ' + CoC.player.short + ',</i>" she says leaning on her greataxe.  "<i>It\'s... good to see you again, I guess.  Did you, uh, want something?</i>"', false );
		}
		var talk = null;
	...
	KihaFollower.prototype.winSparWithKiha = function() {
		...
		if( !this.followerKiha() ) {
			MainView.outputText( 'Kiha sways back and forth for a moment, then drops her axe with numb hands.  As soon as she does, the hot glow of the weapon\'s cutting edge fades to silver, and the weapon lands with a heavy \'thunk\' in the dirt.  The dragoness drops to her knees and slumps back against a tree, her limbs trembling weakly as she tries to rise.  "<i>You... you... haven\'t... beaten me,</i>" she mutters, even though it\'s quite clear that you have.', false );
			MainView.outputText( '[pg]Even though it was just a mock match, you can clearly see the dragoness took the loss as a personal failure.  She flops back down, unable to rise again, and curses at herself.  "<i>If... if I can\'t defeat you, ' + CoC.player.short + ', how the hell am I supposed to beat Lethice?</i>"', false );
			MainView.outputText( '[pg]While you can\'t answer her question, you can give her a hand up.  She\'s surprisingly light for her size and build, though - when you pull her up, she tumbles forward into your arms.', false );
			MainView.outputText( '[pg]"<i>W-what are you doing!?</i>"  she starts, pushing away.  "<i>You - you dumbass!</i>"  Face as red as her scales, she launches into the air and flies off.', false );
			MainView.outputText( '[pg]You sigh and head back to camp.', false );
			...
			MainView.outputText( '[pg]Even though it was just a mock match, you can clearly see the dragoness took the loss as a personal failure.  She flops back down, unable to rise again, and curses at herself.  "<i>If... if I can\'t defeat you, ' + CoC.player.short + ', how the hell am I supposed to beat Lethice?</i>"', false );
			MainView.outputText( '[pg]While you can\'t answer her question, you can give her a hand up.  She\'s surprisingly light for her size and build, though - when you pull her up, she tumbles forward into your arms.', false );
			MainView.outputText( '[pg]"<i>W-what are you doing!?</i>"  she starts, pushing away.  "<i>You - you dumbass!</i>"  Face as red as her scales, she storms off to the other side of camp.', false );
	...
	KihaFollower.prototype.sparWithFriendlyKihaLose = function() {
		...
		MainView.spriteSelect( 72 );
		if( !this.followerKiha() ) {
			MainView.outputText( 'You can\'t take it anymore!  You stumble away from the dragoness, but only make it a few feet before toppling over, landing right on your ass.  Dazed, you can only sit there as Kiha casually walks over and presses the haft of her axe into your throat.', false );
			MainView.outputText( '[pg]"<i>Bam. You\'re dead!</i>" she laughs, giving you a little pop on the chin before slinging it back over her shoulder.  "<i>Come on, ' + CoC.player.short + '!</i>"  she jeers, "<i>How the hell do you think you\'re going to beat the Demon Queen if you can\'t even beat me, huh?</i>"', false );
			MainView.outputText( '[pg]Her words cut deeper than you expected, and you remain silent.  After a moment, Kiha huffs and looks away.  "<i>Look. If you really wanna get stronger, I guess we could... keep doing this.  Not that I\'m doing it for you!</i>"  she adds, crossing her arms.  "<i>You\'re good target practice.  That\'s all.</i>"', false );
			MainView.outputText( '[pg]Oh, Kiha.', false );
			MainView.outputText( '[pg]You dust yourself off and head back to camp under the watchful gaze of the dragoness.  You\'ll have to spend some time recovering.', false );
		} else {
			MainView.outputText( 'You can\'t take it anymore!  You stumble away from the dragoness, but only make it a few feet before toppling over, landing right on your ass.  Dazed, you can only sit there as Kiha casually walks over and presses the haft of her axe into your throat.', false );
			MainView.outputText( '[pg]"<i>Bam. You\'re dead!</i>" she laughs, giving you a little pop on the chin before slinging it back over her shoulder.  "<i>Come on, ' + CoC.player.short + '!</i>"  she jeers, "<i>How the hell do you think you\'re going to beat the Demon Queen if you can\'t even beat me, huh?</i>"', false );
			MainView.outputText( '[pg]Her words cut deeper than you expected, and you remain silent.  After a moment, Kiha huffs and looks away.  "<i>Look. If you really wanna get stronger, just keep trying.  That\'s how you won my heart, wasn\'t it?</i>"  she adds, crossing her arms and blushing.  "<i>C-come on, let\'s get you healed up.</i>"', false );
			MainView.outputText( '[pg]Oh, Kiha.', false );
	...
	KihaFollower.prototype.hugFriendWarmKiha = function() {
		MainView.clearOutput();
		MainView.spriteSelect( 72 );
		MainView.outputText( 'With a little grin, you grab Kiha in a tight surprise hug!', false );
		MainView.outputText( '[pg]"<i>What... what\'re you...</i>" she stammers, but soon goes quiet with a final mutter of "<i>Idiot.</i>"', false );
		MainView.outputText( '[pg]You\'re not surprised at her comforting warmth, but Kiha is amazingly soft once you get your arms around her.  Her smooth, partially-scaled skin yields easily as you press the dragoness against yourself.  What shocks you most, however, is that after a long moment, Kiha sighs and slips her muscular arms around you, too.', false );
		MainView.outputText( '[pg]The peaceful, companionable embrace only lasts for a few seconds before Kiha suddenly and violently pushes you away.  "<i>What do you think you\'re doing, idiot!</i>"  she shouts, and launches off into the air before you can respond.', false );
		MainView.outputText( '[pg]You shake your head and head on back to camp.', false );
	...
	KihaFollower.prototype.talkToFriendlyKiha = function() {
		...
		if( CoC.flags[ kFLAGS.KIHA_TALK_STAGE ] <= 3 ) {
			...
			MainView.outputText( 'You ask the dragoness if she wouldn\'t mind talking for a few minutes.', false );
			MainView.outputText( '[pg]Kiha crosses her arms contemptuously.  "<i>Oh, you\'re still all talk!  Talking doesn\'t get anybody anywhere, dammit!  Have you ever tried talking to a demon?  All it does is give them more time to find a way to fuck you.</i>"  You sigh and ask her to just humor you.  She rolls her eyes, but doesn\'t refuse you.  That\'s a start, at least.', false );
			MainView.outputText( '[pg]Reclining near the dragoness, you ask her a little bit about herself.  Innocent questions, really - where she was born, about her parents, anything she can tell you.  The dragon huffs, breathing out a little cloud of smoke.  "<i>Fucking idiot.  I told you that I don\'t remember, okay?  Just a few... images before the demons took me.</i>"', false );
			MainView.outputText( '[pg]You ask her about those bits and pieces, but she cuts you off with a sweep of her arm, her claws flying so near your face you can feel the air moving.  "<i>Just shut up, damn it!  I don\'t want to talk about it!</i>"  You shrug and ask her what she wants to talk about.  She sneers. "<i>Fine, if you\'re so keen on talking, let\'s talk about YOU!</i>"', false );
			MainView.outputText( '[pg]Wait, didn\'t you do this already?  But, you decide to humor the dragoness, and start to tell her a little bit about the village you grew up in, training to be champion, and your eventual arrival in the land of Mareth.  The dragoness listens silently, motionlessly, simply eyeing you as you speak.  When you finish, culminating your story in first meeting her, Kiha only nods slightly.', false );
			MainView.outputText( '[pg]You venture to ask her if she has anything to say, but she turns her nose up at the idea.  "<i>You think we\'re the same, don\'t you?  That we both had it SO tough?  Well, you\'re wrong!  Just because you helped me out ONCE doesn\'t mean we\'re all buddy-buddy, and it sure as hell doesn\'t mean we\'re the same.  So... so just fuck off, alright!?</i>"  she screams before thrusting into the air and flying off.', false );
			MainView.outputText( '[pg]God dammit, Kiha.', false );
		} else if( CoC.flags[ kFLAGS.KIHA_TALK_STAGE ] === 4 ) {
			//Talk to Friendly Kiha - Second Time (Z);
			MainView.outputText( 'You try to talk to Kiha again, but she starts speaking a moment before you do done listening to you ramble on about yourself,</i>"  she snaps, glowering at you.  "<i>I feel like talking about ME, and you\'re going to shut up and listen.  Got it?</i>"', false );
			MainView.outputText( '[pg]You suppress a grin and agree.  She gives you a surprisingly approving nod, and begins to speak was born a lizan, destined to be a warrior - a great warrior.  I\'d have fought in countless battles, slain my tribe\'s enemies by the thousands... and I would never have been defeated.</i>"', false );
			MainView.outputText( '[pg]You communicate your understanding, though a quick glance from the dragoness forestalls speech.  "<i>When the demons came, I would have tried to fight.  We all would have. But somehow... somehow they won.  We must have been fools.  If we had trained harder, fought better... I could... could still remember who I was...</i>"', false );
			MainView.outputText( '[pg]She trails off for a moment.  You\'re about to speak, but she suddenly blows a great cone of fire into the air, illuminating the dark swamp with a pillar of fire.', false );
			MainView.outputText( '[pg]"<i>But look at what they made me,</i>" she says, grinning.  "<i>The demons wanted the perfect warrior - the next generation of demon soldiers.  Well, they got the first part right,</i>" she says, baring her fangs and claws menacingly.  "<i>Now that I\'m free, I just need to find that bitch Lethice and shove a claw right up her ass... for my people.</i>"', false );
			MainView.outputText( '[pg]Before you can answer her claim, the dragoness inclines her head to you and leaps into the air, disappearing into the dense foliage.', false );
			MainView.outputText( '[pg]Maybe... just maybe... this is progress?', false );
		}
		//Talk to Friendly Kiha - Third Time (Z);
		else if( CoC.flags[ kFLAGS.KIHA_TALK_STAGE ] === 5 ) {
			MainView.outputText( 'You sit the dragoness down once again, and gently try to coax a little more out of her.  Surely she\'s got more to tell, after all.  Before you\'ve even finished your request, however, the dragoness snarls and lets out a little gout of flame, ending just before your nose.', false );
			MainView.outputText( '[pg]"<i>Dammit, ' + CoC.player.short + '!</i>"  she hisses, waving away the smoke.  "<i>I\'m fucking done talking!  Why the hell do you keep this shit up, huh?  All this talk and talk and talk!  You keep coming here, talking your precious morals and acting like you ACTUALLY give a shit about me.  Well, fucking stop!</i>"', false );
			MainView.outputText( '[pg]She waves a clawed hand your way, making you stumble back or else lose your face.  "<i>You keep saying you\'re some high and mighty champion out to stop the demons!  Well where\'s the fucking proof, huh?  It\'s all talk with you!  Why the hell aren\'t we out there FIGHTING!?  We should be kicking in Lethice\'s front door, not pussy-footing around here TALKING about our fucking FEELINGS or some shit!  Come on, if you\'re so strong you can knock me on my ass, you and I together ought to be able to do SOMETHING about this fucking bitch!  Right?</i>"', false );
			MainView.outputText( '[pg]You\'re utterly taken aback by the dragoness\'s sudden outburst.  Before, it seemed like she was more interested in defending herself - hiding, really - than fighting.  What\'s brought this change on?', false );
			MainView.outputText( '[pg]She snarls animalistically.  "<i>Oh, I fucking knew it!  I say, \'hey, let\'s take on the demons\', and all you want to do is fucking analyze my feelings.  Of course you do! What good are you, anyway? What use is a champion who just sits around talking, huh?  How is that going to fuck up Lethice, topple the demons?  Huh?</i>"', false );
			MainView.outputText( '[pg]You try to calm her, telling her you just aren\'t ready to take down the demon queen.  She laughs maniacally, so hard that a bit of red-hot fire blows out her mouth.  "<i>Oh, of course not!  You wouldn\'t be ready - you haven\'t sat on your ass enough yet, have you!  Well let me tell you a little bit about my feelings then, since you\'re so god-damn eager!  I\'m done waiting around! Those demons ruined my life, and I\'m fucking done waiting.  I want vengeance, and I want it RIGHT FUCKING NOW!</i>"', false );
			MainView.outputText( '[pg]Before you can answer the dragoness, she blasts off the ground and flies off, hurtling over the treetops with her axe firmly in hand.', false );
			MainView.outputText( '[pg]You hope she doesn\'t get herself in trouble, but there\'s not much you can really do about it right now...', false );
		}
		CoC.flags[ kFLAGS.KIHA_TALK_STAGE ]++;
		//lose some corruption;
		EngineCore.dynStats( 'cor', -1 );
	...
	KihaFollower.prototype.kihaXSalamander = function() {
		...
		//Introduction Scene:;
		MainView.outputText( 'You make your way to the murky swamp.  The going is rough, your progress impeded by the thick vines and webs that hang between the trees.  Despite - or perhaps because of - your slow pace, you\'re surprised that nearly an hour goes by without you encountering anything of note.  By now, you\'d expect to have found a bit of usable silk, or a spider-girl, or anything.', false );
		MainView.outputText( '[pg]Suddenly, your quiet trek is interrupted by Kiha the dragoness plummeting out of the air, slamming into the ground with earth-shaking force, spraying loam and moss everywhere as she comes to a stop.', false );
		MainView.outputText( '[pg]She rises to her feet, leaning heavily on her greataxe.  "<i>Well, well,</i>"  she sneers, a thin grin on her lips.  "<i>Coming to visit me, ' + CoC.player.short + '?  How thoughtful.</i>"', false );
		MainView.outputText( '[pg]You attempt to explain that you were just exploring, but before you can finish half a sentence, Kiha swings her axe up into a fighting pose.  "<i>Fuck that,</i>"  the dragoness growls.  "<i>I\'m in the mood for a fight, so come on, ' + CoC.player.short + '!  Put \'em up!</i>"', false );
		MainView.outputText( '[pg]You quickly prepare for combat, readying your [weaponName] against the inevitable assault, and have only just done so when Kiha launches herself at you, swinging wildly with her greataxe.  You narrowly parry one blow, then another, forced back by the dragoness\'s relentless assault.', false );
		MainView.outputText( '[pg]She pushes you back under a hail of axe blows, seemingly unconcerned for your safety as you only just avoid cuts from all directions.  As she continues her attack, she begins laughing riotously, almost cruelly as she comes closer and closer to beheading you.', false );
		MainView.outputText( '[pg]Suddenly your back\'s to a tree, and you know you aren\'t going anywhere - you\'re afraid you\'re going to have to hurt the murderous dragoness to save yourself when you catch sight of a dark, shadow-wreathed form moving behind Kiha, a curved sword raised.', false );
		MainView.outputText( '[pg]You consider warning the dragoness, but too late!  The mysterious figure leaps from the brush and shoulder-slams into Kiha, throwing her right off you and into the mud.  Before you can even say a word to your new friend, she grabs you by the scruff of your neck and throws you to the ground behind her, putting herself between you and Kiha.', false );
		MainView.outputText( '[pg]You could just lie there, but you\'re not sure how well you\'d fare against two powerful warriors at once - you could end up dominated, at the very least.  You could instead try and get the jump on the fighters before they jump you... Or, you suppose you could get the fuck out while you have the chance.', false );
	...
	KihaFollower.prototype.GTFO = function() {
		...
		MainView.outputText( 'While Kiha and the mysterious swordsman are distracted, you pick yourself up out of the mud and high-tail it out and head back to camp.  Over your shoulder, you hear the sounds of battle raging.', false );
		//to what penalty?;
		EngineCore.doNext( SceneLib.camp, SceneLib.camp.returnToCampUseOneHour );
	};
	//Lie There;
	KihaFollower.prototype.lieThere = function() {
		...
		MainView.outputText( '', true );
		MainView.spriteSelect( 72 );
		MainView.outputText( 'You decide to let things take their course.  You look up to the swordsman standing over you...', false );
		MainView.outputText( '[pg]Wait, you recognize that tail - and that taut ass!  You grin as you watch Helia the salamander\'s fiery tail swish over you, her scimitar gripped firmly in both hands.', false );
		MainView.outputText( '[pg]"<i>OH HELL NO, you scaly bitch,</i>"  Hel growls, leering down at Kiha as the dragoness leaps to her feet, axe raised.  "<i>You do NOT fucking touch my ' + CoC.player.short + ' and get away with it.  You hear me?</i>"', false );
		MainView.outputText( '[pg]"<i>You BITCH!</i>"  Kiha screams, flicking mud off her nude body.  "<i>How dare you?  How DARE YOU throw ME in the MUD!?  I\'ll fucking teach you!</i>"', false );
		MainView.outputText( '[pg]OHSHIT.  You duck down as a great gout of flame shoots over you, utterly consuming Hel in the blast and nearly baking you into the mud.  Laughing, Kiha roars in triumph as Hel vanishes in the smoke cloud left over from the dragon-flame blast.', false );
		MainView.outputText( '[pg]You cough violently as the smoke settles.  You wave your hand in front of your face, desperately looking in the baked mud for some sign of a surely-incinerated Hel... yet she still stands!  Though you can see her scale bikini and thong have been incinerated, leaving her as nude as Kiha with her big breasts hanging free, she has survived seemingly unscathed.', false );
		MainView.outputText( '[pg]Scowling, the salamander simply crosses her arms over her ample bosom.  "<i>Seriously. Seriously, you cunt!?</i>"  Hel snaps, grabbing her fiery tail.  "<i>Do you even fucking SEE THIS!? That weak shit does nothing to me, you moron.</i>"', false );
		MainView.outputText( '[pg]Kiha stands dumbfounded for a moment, surprised her potent fire-breath didn\'t simply melt the flesh from Hel\'s bones.  She recovers quickly, though, and yells, "<i>Get out of here!  This is MY swamp, and that ', false );
		if( !CoC.player.isGoo() ) {
			MainView.outputText( 'meatsack', false );
		} else {
			MainView.outputText( 'goosack', false );
		}
		MainView.outputText( ' behind you belongs to ME, you got it?</i>"', false );
		MainView.outputText( '[pg]"<i>Oh, ' + CoC.player.mf( 'he', 'she' ) + ' belongs to you, is that it?</i>"', false );
		MainView.outputText( '[pg]"<i>That\'s right, you bitch.  So get your fat scaly ass out of the way!</i>"', false );
		MainView.outputText( '[pg]"<i>FAT!?</i>"  Hel fumes, her tail swaying dangerously behind her.  "<i>You\'re just jealous you don\'t have an ass as fine as this one!</i>"', false );
		MainView.outputText( '[pg]Kiha scowls, turning a half-circle so her muscular ass is clearly visible.  "<i>Ha! Like I have ANYTHING to be jealous of!  You\'re the one that ought to be jealous!</i>"', false );
		MainView.outputText( '[pg]Hel stomps her foot in outrage.  "<i>Oh, fuck you! My ass is LEAGUES better than that mound of shitter-muscle.</i>"', false );
		MainView.outputText( '[pg]"<i>SHITTER MUSCLE!?!</i>"', false );
		MainView.outputText( '[pg]"<i>Shitter muscle,</i>" Hel says with a sneer.  "<i>And to top it all off... You\'ve got small tits.  Why the hell would ' + CoC.player.short + ' want those little things over THESE,</i>" she laughs, cupping her big E-cups for emphasis.', false );
		MainView.outputText( '[pg]"<i>Oh, like ' + CoC.player.short + ' would even look twice at those floppy things!</i>" Kiha growls, grabbing her own D-cups defensively.  "<i>' + CoC.player.mf( 'He', 'She' ) + ' OBVIOUSLY prefers smaller, perkier boobs.  Don\'t you, ' + CoC.player.short + '?</i>"', false );
		MainView.outputText( '[pg]You start to stammer an answer, but before you know it, Hel\'s put a foot on your chest, pushing you just a little deeper into the still-hot mud.  "<i>How the hell would YOU know what ' + CoC.player.short + ' likes, huh?  <i>I</i> know exactly what makes ' + CoC.player.mf( 'him', 'her' ) + ' tick!</i>"', false );
		MainView.outputText( '[pg]Before you can say a word in your own defense, Hel uses her clawed foot to rip off the bottom of your [armorName].  Grinning at you, she puts the heel of her foot on the bottom of [cock one].  She gives it a short, forceful rub, pushing your stiffening cock into your belly as she runs her heel across it.  She gives your cock a few playful strokes, but the tell-tale hardening of your cock soon turns it into a full-blown footjob, with Hel hooking her heel\'s claw around one side of your shaft and wrapping the rest of her foot around the other side.  She shamelessly jerks you off, pumping your stiffy as Kiha stares, wide-eyed.', false );
		MainView.outputText( '[pg]Kiha yells in feral outrage.  "<i>HOW THE FUCK DARE YOU!?</i>"  she screams, storming over.  "<i>Get your filthy feet off ' + CoC.player.short + '!</i>"', false );
		MainView.outputText( '[pg]Kiha gives Hel a forceful shove, causing her to stumble back as the dragoness looms over you.  "<i>Why the hell would you like a whore like her, huh?</i>" she asks, "<i>The kind of girl who, on a damn whim, just starts handing out favors.  What, do you LIKE sluts?  Huh?  Is that it?</i>"', false );
		MainView.outputText( '[pg]Dammit, these girls aren\'t letting you get a word in edgewise.  You\'re about to start shouting, but to your utter shock, Kiha plants her foot right on your cock.  "<i>Well, if you like wanton sluts so much, what do you think about this!?</i>"  She runs her foot along the length of your cock, making a slow, sensuous stroke along the entire length, coming to rest her surprisingly dainty toes on your now-engorged tip.  "<i>That\'s what you like, isn\'t it?  I had you figured for something other than a sex-crazed freak, but maybe that bitch is right - you\'re just in it for this, aren\'t you?</i>"', false );
		MainView.outputText( '[pg]You look on tensely as Kiha runs the length of her own heel-claw along your cock\'s underside, making a slow, gentle path from tip to base [if (hasBalls) "giving your sack a little pat with the flat of her claw, making you cringe with pleasure and fear"].', false );
		MainView.outputText( '[pg]Suddenly, Hel rises from the dirt beside you, her tail flaming dangerously.  "<i>Oh, FUCK YOU!</i>"  Hel cries, stamping back to stand beside Kiha.  "<i>How the FUCK would you know ANYTHING about what ' + CoC.player.mf( 'he', 'she' ) + ' likes?  You think you know?  I\'ll fucking SHOW YOU!</i>"', false );
		MainView.outputText( '[pg]As Kiha\'s foot comes to rest along the base of your cock, Hel rubs her foot along your cockhead, making you gasp and shudder with ecstasy as she begins to foot-fuck you.  Kiha growls and makes a quick jab up your shaft, using the hook of her claw like half a hand to jerk you off as Hel slides the flat of her foot along your shaft.', false );
		MainView.outputText( '[pg]Growling at each other like animals, Kiha and Hel continue to foot-fuck you.  Now they\'re not even paying attention to you, instead staring each other down in a death glare that would wither even a demon\'s will.  You gasp and moan under the double-foot-assault, squirming as they viciously bring you closer and closer to orgasm.', false );
		MainView.outputText( '[pg]You roll your head back in a silent cry as Hel and Kiha rape you, scowling and mumbling curses, waiting to see whose footjob will bring you to orgasm fastest - a sort of test of sexual expertise between the fiery scaled girls.  You aren\'t going to last much longer under this kind of pressure, and you desperately buck your hips into their feet.  But they refuse to let up, and so with a soul-baring moan, you cum.  You shudder and squirm as a white-hot streak of cum shoots out of your dick, smearing all over the sole of Hel\'s foot.  She gasps happily, but her ecstatic reaction lets your pecker flop free, spurting another load right up Kiha\'s thigh, staining her dark red scales white near her loose cunt.  The dragoness laughs triumphantly, but your dick gets away again, squirting a last shot of jizz right onto Hel\'s taut ass, leaving a trickle of sperm running down her ass cheeks.' );
		MainView.outputText( '[pg]"<i>See?</i>"  Kiha shouts, grabbing at the stain you\'ve left on her thighs, "<i>' + CoC.player.short + ' obviously likes me better - ' + CoC.player.mf( 'he', 'she' ) + ' dropped ' + CoC.player.mf( 'his', 'her' ) + ' cum RIGHT next to my vag.  ' + CoC.player.mf( 'He', 'She' ) + ' probably wants to knock me up even, don\'t you, ' + CoC.player.short + '?</i>"', false );
		MainView.outputText( '[pg]"<i>Oh, is that right?</i>"  Hel laughs, giving her ample hips a shake forceful enough to dislodge your spooge, hitting Kiha full on the face.  "<i>' + CoC.player.short + ' put a load right in my asscheeks - ' + CoC.player.mf( 'he', 'she' ) + ' gave me the last AND the dirtiest load.  What do you get? Oh, that\'s right, a vag shot.  How unique!</i>"', false );
		MainView.outputText( '[pg]"<i>What would you even know about it, slut?</i>"  Kiha roars, breathing fire right in Hel\'s face.  The salamander just waves it off indignantly.', false );
		MainView.outputText( '[pg]"<i>Hey, hey dragon bitch.  You\'ve got a little SOMETHING ON YOUR <i>FACE!</i>"  She shouts, whipping her tail around and swatting Kiha right in the cheek.  The dragoness recoils, clasping her now beat-red cheek before lashing out, punching Hel right in the tit.', false );
		MainView.outputText( '[pg]Okay, fuck this, you think to yourself, trying to grab your torn clothing as the two fire-girls start to go at it all-out.  You grab your shit and try to stumble out of the line of fire as you redress, watching the two girls throw each other into the mud and start beating the shit out of each other.', false );
		MainView.outputText( '[pg]When you\'re finally dressed and ready, you shout "<i>BREAK IT UP!</i>"  as loud as you can, hopefully trying to break through the sounds of their wet wrestling and flying punches.  It takes a moment, but the girls finally stop their fighting, rolling up to sit in the mud.', false );
		MainView.outputText( '[pg]For the life of you, you can\'t tell them apart - Kiha\'s wings and horns are invisible in the thick cake of half-baked mud coating whichever one she is, and Hel\'s more ample endowments are out of sight under two pairs of sitting butts and crossed arms.', false );
		MainView.outputText( '[pg]"<i>Well fine!</i>"  one of them yells.  For the first time, you notice their voices are damn similar.  "<i>Tell that bitch you like me better, and maybe she\'ll get the goddamn point already!</i>"', false );
		MainView.outputText( '[pg]"<i>Like her better!  Ha!  Come on, ' + CoC.player.short + ', you and I both know you like ME better.  AND that I give the best footsies.</i>"', false );
		MainView.outputText( '[pg]Well, shit. This isn\'t good.  You can\'t tell the girls apart, and now they\'re asking who you like better.  You sigh heavily, and as evenly as possible, try to explain that you like BOTH of them.', false );
		MainView.outputText( '[pg]"<i>WHAT!?</i>"  they cry in unison, then turn and glare angrily at each other.  "<i>You-you can\'t like HER TOO!</i>"  they say, again in perfect concert.', false );
		MainView.outputText( '[pg]Yes, you damn well can!', false );
		MainView.outputText( '[pg]Happily, Kiha finally wipes the mud off her dark face, glaring at Hel, who quickly does the same.  The dragoness huffs indignantly.  "<i>I guess if ' + CoC.player.short + ' is all right with you...</i>"' );
		MainView.outputText( '[pg]"<i>Yeah, yeah,</i>"  Hel says, rolling her eyes.  "<i>And you do give damn good footjobs.</i>"', false );
		MainView.outputText( '[pg]"<i>Yeah.  Yeah, I do.</i>"', false );
		MainView.outputText( '[pg]Hel scowls at the haughty dragoness... Then they both break out laughing at once.  You try to keep a straight face, but soon you\'re laughing with them.', false );
		MainView.outputText( '[pg]"<i>Fine,</i>"  Kiha says, putting up a cocky grin.  "<i>If ' + CoC.player.short + ' can tolerate you, then I guess... you\'re welcome in my swamp, I guess.</i>"', false );
		MainView.outputText( '[pg]"<i>And hey... if you ever go to the plains...</i>"', false );
		MainView.outputText( '[pg]"<i>Not on your life, bitch!</i>"  Kiha yells, laughing, and shoots up into the air, raining mud and loam behind her.', false );
		MainView.outputText( '[pg]"<i>FUCK YOU ANYWAY!</i>"  Hel yells after her, fist clenched.', false );
		MainView.outputText( '[pg]And here we almost had a beautiful moment going.  You sigh, wipe the mud off Hel\'s face enough to give her a little kiss, and head on back to camp.', false );
		MainView.outputText( '[pg]Your [armorName] squelches wetly all the way, full of your cum as it is.', false );
		CoC.player.orgasm();
		EngineCore.doNext( SceneLib.camp, SceneLib.camp.returnToCampUseOneHour );
	};
	//Jump Them;
	...
	KihaFollower.prototype.kihaAdmitsSheLikesYourWang = function() {
		...
		if( CoC.flags[ kFLAGS.KIHA_ADMITTED_WARM_FEELINZ ] === 0 ) {
			...
			MainView.outputText( 'While exploring the swamp, you find yourself in your dragoness friend\'s familiar territory.  Kiha, always one for a flashy entrance, glides down from the treetops, her wings casting a fearsome shadow over the clearing.  She lands with a light touch, just a few feet away from you and leaning casually on her axe.  The dragoness harrumphs, "<i>Back to visit already?  Well, I guess you\'re better than some of the other beasties that could be calling on me.</i>"  As always, she\'s trying to wrong-foot you, and before you can answer her insinuations, she keeps right on going, "<i>Why do you keep coming around?  Don\'t you have any real friends?  It\'d be kind of pathetic if I\'m the only one you have to talk to.</i>"' );
			MainView.outputText( '[pg]Kiha\'s scaly tail curls up beside you and gives you a playful swat on the rump.  You jump in surprise.  Wait a second... is she blushing?  Is that affection she has buried under her tough, mean demeanor?  A show of tenderness might widen the cracks in the wall around her heart...' );
			MainView.outputText( '[pg]Do you hug her, and potentially take things to the next level, or would you rather do something else, and keep things as they are?' );
		}
		//Warm Kiha Admittance Repeat;
		else {
			MainView.outputText( 'Kiha lightly drops out of the trees in front of you, kicking up a small splash of fetid water as she comes to rest a few feet away.  She rests her axe over her shoulder nonchalantly and smiles as she says, "<i>Did you come back to get your ass kicked?  You wouldn\'t be the first to throw fights so you could check me out while you\'re lying on the ground.</i>"  Her tail swings around to playfully catch you on the ' + Descriptors.buttDescript() + ', a hint of crimson spreading on her dark skin, matching the ruby hue of her shimmering scales.  Kiha strikes a battle-ready pose that looks a bit more lewd than normal as she asks, "<i>So, you here to fight, or waste more time talking?</i>"' );
			MainView.outputText( '[pg]Do you hug her, and potentially take things to the next level, or would you rather do something else?' );
		}
	...
	KihaFollower.prototype.lovinHugKiha = function() {
		...
		MainView.outputText( 'You close in with Kiha before she can react and wrap your arms around her, squeezing her tightly while you admit, "<i>I came here because I like you.</i>"', false );
		MainView.outputText( '[pg]Kiha looks ', false );
		if( CoC.player.tallness >= 95 ) {
			MainView.outputText( 'up ' );
		} else if( CoC.player.tallness <= 60 ) {
			MainView.outputText( 'down ' );
		}
		MainView.outputText( 'at you with moisture glittering in her reptilian eyes.  Her voice quivers uncertainly as she stutters, "<i>W-what do you mean?</i>"', false );
		MainView.outputText( '[pg]You tell her how you enjoy her company, how she reminds you what you\'re here for, and how beautiful she is (when she isn\'t screaming at you).  Kiha shivers in your arms, though nothing about the steamy embrace feels the slightest bit cold.  She blinks hard and whimpers, "<i>I... I n-never thought... I don\'t...</i>"  The feisty redhead trails off and returns the hug, squeezing so hard that you worry she might break one of your ribs.  She certainly crushes most of the breath from your lungs.', false );
		MainView.outputText( '[pg]It takes a few moments for Kiha to sense your discomfort, and when she does, she twists out of the hug, nervously fidgeting.  You grab her and pull her back over, this time taking her chin in your hand and ', false );
		if( CoC.player.tallness >= 95 ) {
			MainView.outputText( 'pulling it down', false );
		} else if( CoC.player.tallness <= 60 ) {
			MainView.outputText( 'tilting it up', false );
		} else {
			MainView.outputText( 'tilting it slightly', false );
		}
		MainView.outputText( ' to plant a kiss on her dusky, parted lips.  She melts into you, the heat of her body making you sweat, but this once, you don\'t mind at all.  Kiha\'s tail wags happily, splashing through water as the eager dragoness leans against you, pushing the two of you back towards one of the nearby trees.  She hooks a leg around your thigh, pulling you so tightly into her that you can\'t help but be aware of her supple breasts crushing against you, the hard points of her nipples digging into you and your ' + CoC.player.armorName + '.', false );
		MainView.outputText( '[pg]The warrioress\'s axe stands a few feet back, like a silent sentinel.  It\'s been forgotten in the heat of moment.  Kiha\'s prodigious, normally suppressed libido reveals itself when she forces a long tongue into your mouth, tying up your own oral organ while her mischievous, clawed fingers gently remove your ' + CoC.player.armorName + ', one piece at a time.', false );
		if( CoC.player.hasCock() ) {
			MainView.outputText( '[pg][EachCock] springs free, smacking into Kiha\'s thigh as it fully engorges.  She gives it a gentle pump before commenting, "<i>Acceptable, I suppose.</i>"', false );
		} else if( CoC.player.hasVagina() ) {
			MainView.outputText( '[pg]Your [vag] tingles as it\'s exposed to the air.  The lusty dragon-maid dips a digit inside your depths before commenting, "<i>Not bad, I guess.</i>"', false );
		} else {
			MainView.outputText( '[pg]Your smooth groin and [asshole] tingle as they\'re exposed to the open air.  Kiha gently caresses your smooth skin all the way down your taint before commenting, "<i>Not ideal, but I can make do.</i>"', false );
		}
		MainView.outputText( '[pg]You pant, still breathless from the kiss, a slight frown covering your features from her less-than-enthusiastic appraisal of your body.  The chocolate-colored cutie grabs you by the [butt] and pulls you back against her.  This time, you ', false );
		if( CoC.player.tallness >= 95 ) {
			MainView.outputText( 'lean down' );
		} else if( CoC.player.tallness <= 60 ) {
			MainView.outputText( 'reach up' );
		} else {
			MainView.outputText( 'reach' );
		}
		MainView.outputText( ' towards her shining, sweat-slicked breasts.  Her dark nipple seems to beckon you, and you give it a gentle lick before devouring the sensitive bud.  Kiha swoons and arches her tail up, letting it curl up your back to massage you.  The smooth, scaly back massage is almost as intriguing as the soft feminine flesh you\'re suckling upon, but ultimately, it is her nipple that holds your attention.  You only suck it for a few moments, but once you pull back, Kiha is panting and blushing heavily.' );
		MainView.outputText( '[pg]"<i>Is... is that all you\'ve got?  It\'ll take m-more than that,</i>" Kiha moans once you start sucking on her other nipple. You reach down to her sex, fairly dripping with molten need, and you begin to caress it, teasing her vulva while staying locked on her pert tit.  Muscular thighs quiver once, then go nerveless, nearly tumbling both of you into the water before you shift to hold Kiha\'s trembling, nerveless body aloft.  Her wings flap weakly as she soaks your hand, tiny dribbles of femspunk spurting down into the swamp water from her quick orgasm.  The exhausted reptilian lady slowly wraps her arms, legs, and even wings around you, holding you tightly as she tries to recover her strength.  Moisture drips down the back of your shoulder - is Kiha crying?' );
		MainView.outputText( '[pg]Reaching up, you run your hand through Kiha\'s hair, comforting the weakened, vulnerable girl.  She sniffles and whispers, "<i>You idiot... what if... if a demon had found us?</i>"  Her body slowly uncoils from around you, the last part to break contact her tail as it unwinds from your [leg].  The dragoness wipes her face off on her forearm picking up her axe and muttering, "<i>idiot.</i>"', false );
		MainView.outputText( '[pg]Still naked and too turned on to think properly, you kiss her again.  Kiha sighs when you pull back and smiles, whispering, "<i>My idiot.</i>"', false );
		MainView.outputText( '[pg]Kiha\'s wings scatter leaves and detritus everywhere as she beats them, flapping hard enough to lift both of you off the ground.  ', false );
		if( CoC.player.canFly() ) {
			MainView.outputText( 'You could fly yourself, but you hang on for now, enjoying the embrace.', false );
		} else {
			MainView.outputText( 'You\'ve no choice but to hang on to her for dear life as she lifts off.', false );
		}
		MainView.outputText( '[pg]Finding a gap in the foliage, the temperamental dragon-woman takes you up and out into the sky.  The gnarled swamp-trees beneath you look far less imposing from up here, and soon, they\'re flying past in a blur.  Without warning, Kiha twists and dives, taking you down to a small island in the swamp - her home.  She swoops through a gap in the roof with you in tow, confidently catching herself on the far wall of her abode and setting you down on the hard-packed floor.  You stumble, woozy from the abrupt flight.' );
		MainView.outputText( '[pg]"<i>Does getting dragons off really make you that light-headed?</i>" Kiha asks.  She tackles you into her bed before you can answer.  Her attitude, while still fierce, reminds you more of a playful kitten than a threat.', false );
	...
	KihaFollower.prototype.lovingHugDickings = function() {
		...
		MainView.outputText( 'Kiha laughs, "<i>', false );
		if( CoC.player.biggestCockArea() > 100 ) {
			MainView.outputText( 'How do you walk with this thing swinging around everywhere, bludgeoning into everyone you meet?', false );
		} else if( CoC.player.biggestCockArea() > 9 ) {
			MainView.outputText( 'How do you walk with this thing sticking out all the time, or was that just for me?' );
		} else {
			MainView.outputText( 'How can you enjoy sex with something that small?  I don\'t know if I\'ll even feel it.' );
		}
		MainView.outputText( '</i>"  She goes right on to squeeze ' + CoC.player.oMultiCockDesc() + ' in her hand, letting you feel the strength of her grip for the barest moment before stroking you slowly and sensually.  You moan, so pent up from all the foreplay that you happily hump away at Kiha\'s fingers.  Her handjob feels divine after being so close with so little stimulation for oh so very long.  Pre-cum quickly coats the dragoness\'s hand, making the air fill with lewd wet \'schlicks\' from each stroke.', false );
		MainView.outputText( '[pg]"<i>You\'re so pathetic,</i>" Kiha taunts as she begins to pump you faster, edging you closer to an irresistible orgasm.  "<i>You used to be so tough, Champion.  What happened?  A few tugs on your ', false );
		if( CoC.player.biggestCockArea() <= 9 ) {
			MainView.outputText( 'little ', false );
		}
		MainView.outputText( 'tool and you\'re putty in my hands.</i>"  Tiring of her tirade, you summon up your strength and pull her down next to you, climbing atop her torso to rest your ' + Descriptors.cockDescript( x ) + ' squarely between her tits.  You grab her nipples and roughly pull them inward, drawing a gasp of mixed pain and pleasure from your lover.  The gasp turns into a lurid moan once you begin sliding your dribbling dick through the brown-hued valley that is her cleavage', false );
		if( CoC.player.cocks[ CoC.player.biggestCockIndex() ].cockLength >= 36 ) {
			MainView.outputText( ', even though you bump her repeatedly in the nose with your moist tip' );
		}
		MainView.outputText( '.  Kiha\'s soft breasts envelop as much of your dick as possible in cushiony chest-flesh, and though she isn\'t as well-endowed up there as many of the women in this land, her extra-warm body-heat suffuses your member with more than enough pleasure to let you blow your load.' );
		MainView.outputText( '[pg]' );
		if( CoC.player.horseScore() > 4 || CoC.player.dogScore() > 4 || CoC.player.catScore() > 4 ) {
			MainView.outputText( 'Growling' );
		} else {
			MainView.outputText( 'Grunting' );
		}
		MainView.outputText( ', you clench for a moment as climax works through your body, expelling ', false );
		if( CoC.player.cumQ() > 400 ) {
			MainView.outputText( 'thick ' );
		}
		MainView.outputText( 'jets of cum over Kiha\'s face, neck, ' );
		if( CoC.player.cumQ() >= 400 ) {
			MainView.outputText( 'hair, ' );
			if( CoC.player.cumQ() >= 800 ) {
				MainView.outputText( 'floor, ' );
			}
			if( CoC.player.cumQ() >= 1200 ) {
				MainView.outputText( 'walls, ' );
			}
		}
		MainView.outputText( 'and chest.  Kiha shivers and turns crimson (well, more crimson than usual) from the submissive position she finds herself in.  Using her tongue, she laps the creamy spooge from tip of her nose.  "<i>Mmm... nice job, Hero.  Didn\'t anyone ever tell you the woman\'s supposed to get off first?</i>" asks Kiha.', false );
		MainView.outputText( '[pg]You pointedly remind her that she already did.  She gets even redder, her tail lashing back and forth behind her from embarrassment. Kiha scowls and retorts, "<i>Well, I\'m not satisfied yet, so you better keep it up.</i>"  She gives your ' + Descriptors.cockDescript( x ) + ' a far gentler slap than you\'d expect from her expression.  The dragoness\'s scowl melts into a sultry \'come-hither\' expression as she slowly spreads her well-defined thighs, exposing the dark, hairless entrance to her nethers.  Moisture drips from it, staining her bed with lady-spunk, but Kiha just diddles her clit and purrs at you, beckoning you to come fuck her with every motion of her body.', false );
		MainView.outputText( '[pg]The sight stirs your loins back to a full, throbbing hardness, even though [eachCock] is still leaking strings of ejaculate from its cum-slit.  You look into her eyes and plant a long, slow kiss on her lips before sliding into her velvety-soft depths.  Kiha moans into your mouth, wrapping her arms and legs around as she yields to your manhood, her hips already rocking in needy, aching pleasure.  A single string of saliva hangs between your lips as you break the kiss and gaze into her oddly-slit, fiery red eyes.  She murmurs, "<i>I... I think I lo-oooh right there...</i>"', false );
		MainView.outputText( '[pg]You slowly thrust your ' + Descriptors.cockDescript( x ) + ' inside her and little half-kisses, half-bites at the nape of her neck', false );
		if( CoC.player.cockTotal() > 1 ) {
			MainView.outputText( ', letting ', false );
			if( CoC.player.cockTotal() === 2 ) {
				MainView.outputText( 'your other' );
			} else {
				MainView.outputText( 'the rest of your' );
			}
			MainView.outputText( ' maleness drip on her belly' );
		}
		...
		MainView.outputText( '[pg]Hips thrusting, you fuck Kiha as if your life depended on it, and with the way she\'s clawing at your back, it just might!  Her tight, hot little pussy squirts small rivulets of dragon-jizz each time your ' + Descriptors.cockDescript( x ) + ' batters its way back inside.  Her clawed feet cross behind your back after a particularly forceful push and trap you there, ' );
		if( CoC.player.cockArea( x ) < 50 ) {
			MainView.outputText( 'hilted inside her soaked love-tunnel,' );
		} else {
			MainView.outputText( 'as far in as your prodigious size with allow,' );
		}
		MainView.outputText( ' your ' + CoC.player.cockHead( x ) + ' butting up against the entrance of her womb. Kiha turns and bites your shoulder while her tail spirals around the two of you, forcing you into the most intimate of embraces.  Her whole body quakes once, twice, and then goes into tiny, rhythmic convulsions.  A low, pleasured moan hisses out Kiha\'s mouth as her mouth disengages from your flesh, and you\'re able to see her eyes roll part-way back from the intensity of it all.' );
		MainView.outputText( '[pg]The dragoness\'s slippery cunt caresses your ' + Descriptors.cockDescript( x ) + ' from root to crown over and over, begging you to release your seed.  You arch your back as much as you\'re able and happily comply.  Cum erupts from ' + Descriptors.sMultiCockDesc() + ' to claim its prize - your blissed-out mate\'s jizz-hungry uterus.' );
		if( CoC.player.cockTotal() > 1 ) {
			MainView.outputText( '  Thanks to your ' );
			if( CoC.player.cockTotal() === 2 ) {
				MainView.outputText( 'dual ' );
			} else {
				MainView.outputText( 'multiple ' );
			}
			MainView.outputText( 'manhoods, the twitching woman\'s front gets coated just as well as her insides.' );
		}
		if( CoC.player.cumQ() >= 500 ) {
			MainView.outputText( '  Jet after jet of your creamy batter soaks the reptilian womb in spunk, the proof of your virility.' );
		}
		if( CoC.player.cumQ() >= 1000 ) {
			MainView.outputText( '  It doesn\'t take long for you to flood the poor cum-receptacle and drizzle out onto the bed.  Feeling way too good to care, you just keep moaning while you ' );
			if( CoC.player.cumQ() <= 2000 ) {
				MainView.outputText( 'fill Kiha\'s bed' );
			} else {
				MainView.outputText( 'turn Kiha\'s abode into your spermy swimming pool' );
			}
			MainView.outputText( '.' );
		}
		MainView.outputText( '  Even after as you wind down, the feisty woman\'s pussy seems to suck on your cock, still lost in its own pleasure.' );
		MainView.outputText( '[pg]Kiha continues to cum for some time, but eventually, she does come down from her orgasmic high.  Her distant, irritable demeanor seems gone (for now), and all you can see in her unusual eyes is love.  The dragoness holds you tight and whispers, "<i>Acceptable...</i>"' );
		MainView.outputText( '[pg]It figures.  You sigh and catch a quick nap next to her.' );
		MainView.outputText( '[pg]<b>A little later...</b>' );
	...
	KihaFollower.prototype.lovingHugsGirlFuckSex = function() {
		...
		if( CoC.player.wetness() < 3 ) {
			...
			MainView.outputText( 'exploding ' );
		}
		MainView.outputText( 'out from you [vag] on her face.  Your hard nipples dig into Kiha\'s taut belly as you writhe atop her.  The dragon\'s sweat-slicked, undulating form is the perfect companion for your orgasm-addled mind, and each time you manage to control your seizing muscles, you make sure to take another few licks of the reptile\'s honey.  Delicious.' );
		MainView.outputText( '[pg]Kiha slowly drags herself off of you to lie beside you, smooth-yet-scaly body dragging up beside you until she\'s looking you eye to eye, her hot breath smelling strongly of your juices.  You kiss her, sucking her bottom lip into your mouth for a moment before she pulls back, looking at you with open eyes filled with love.  She pulls you tight and whispers, "<i>That was a... acceptable...</i>"  Kiha smirks and closes her eyes.  You sigh and catch a quick nap next to her.' );
		MainView.outputText( '[pg]<b>A little later...</b>' );
		MainView.outputText( '\nKiha flies you back to get your armor.  The search takes a little while, but you eventually recover it.  She looks at you hesitantly before giving you a goodbye kiss.  "<i>Don\'t get yourself killed out there.  I\'d get bored without you messing everything up all the time.</i>"', false );
		CoC.player.orgasm();
		EngineCore.dynStats( 'sen', -2 );
	...
	KihaFollower.prototype.hangOutWithKiha = function() {
		...
		if( select === 0 ) {
			MainView.outputText( 'With a smile, you offer the dragoness your arm and ask if she\'d like to take a walkabout.  She seems rather surprised at the suggestion, adding it\'s rather tame all things considered; but, with a little urging, you\'re soon walking arm in arm ' );
			if( !this.followerKiha() ) {
				MainView.outputText( 'through the dense overgrowth of the swamp' );
			} else {
				MainView.outputText( 'back to her old haunt in the swamp' );
			}
			MainView.outputText( '.' );
			MainView.outputText( '[pg]You tease and toy with each other as you walk, occasionally venturing to brush Kiha\'s thigh or cheek, or tensing as she pops your [butt] with her tail after a particularly vitriolic pun. Both of you laugh constantly, though - Kiha\'s endlessly amused by your idealism or inexplicable adventures, and you can\'t help but roll your eyes and chuckle at her long-since faltered facade of cruelty and power.' );
			MainView.outputText( '[pg]After perhaps twenty minutes of companionable walking, though, your peaceful stroll is interrupted by a sudden ghostly cackling from above as a drider descends from the treetops.  The spider-bitch leers at you, a demonic cock and ovipositor already erect and ready to impregnate some easy prey.  You ready your [weaponName] for battle, but before you can act Kiha lunges off the ground.  With a roar, your dragon lover lets out a gout of fire that incinerates the webbing supporting the drider; the monster lets out a helpless cry as she tumbles to the ground, knocked unconscious by the impact.' );
			MainView.outputText( '[pg]Kiha lands beside you, leaning heavily on her fiery greataxe.  "<i>Don\'t you worry, doofus,</i>" she says, reaching over to run a hand playfully through your hair.  "<i>You don\'t have to worry about a thing while Kiha\'s around.</i>"  Suddenly, she turns to the forest at large and roars hear that, monsters - this one is mine!  MINE!  So hands off or you\'ll have ME to deal with, got it?</i>"' );
			MainView.outputText( '[pg]You can\'t help but grin as she boasts of protecting her mate from the vile monsters of the realm. You know you could easily have beaten the drider, but you let Kiha have the moment - she\'s quite cute when she\'s being protective of you.  Before she can launch into a full-blown tirade, though, you grab the dragon-girl and pull her into a tight hug.  She lets out a short little gasp, but utterly melts in your arms when you plant your lips on hers.' );
			MainView.outputText( '[pg]"<i>You... ' );
			if( CoC.player.tallness >= 72 ) {
				MainView.outputText( 'big' );
			} else {
				MainView.outputText( 'little' );
			}
			MainView.outputText( ' idiot,</i>" she whimpers when you finally break the kiss.  Gently, you stroke her cheek and thank her for "<i>protecting</i>" you.  A few minutes later and ' );
			if( !this.followerKiha() ) {
				MainView.outputText( 'you\'re back at Kiha\'s little islet, waving to the dragoness as she flies back home and you head to camp' );
			} else {
				MainView.outputText( 'you\'re walking arm in arm again, heading home' );
			}
			MainView.outputText( '.' );
		}
		//Hang Out 2;
		else if( select === 1 ) {
			MainView.outputText( 'You fish around in your mind for something you and Kiha can do together, but the dragoness herself surprises you by saying, "<i>So, uh, ' + CoC.player.short + '. I was just about to eat... I-I\'ve got enough for two, if you want.</i>"  You smile and tell her that would be lovely, thank you.  Awkwardly, she returns your grin, obviously unused to eating with others.', false );
			if( !CoC.player.canFly() ) {
				MainView.outputText( '  She slips her arms around you and takes off, flying through the roof-entrance to her lair' );
			} else {
				MainView.outputText( '  Extending a hand to you, the two of you fly up to and through the roof entrance to her lair', false );
			}
			MainView.outputText( '.' );
			MainView.outputText( '[pg]Kiha\'s small nest is spartan, to say the least - walls made from living tree trunks, a hard-packed dirt floor, and a circle of what looks like tall grass from the plains making up her bed.  She has a single, small plank of wood balanced on a quartet of rocks serving as a table, with a slab of uncooked meat (perhaps a wild boar\'s thigh?) sitting openly on it.  She tells you to sit and, brandishing her sharp talons, begins to cut up the meat for you to make up for her lack of silverware.' );
			MainView.outputText( '[pg]You start to question if she expects you to eat raw... whatever it is... but the dragoness cuts you off mid-sentence by rearing back and belching up a burst of flame onto the mystery meat, roasting it instantly and singeing the hairs on your face.  She lets out a boisterous laugh as you shake off the rather explosive effects of her fiery breath, but you have to admit it was effective meal is now a pile of medium-well cooked strips fit to be eaten.' );
			MainView.outputText( '[pg]Satisfied with her handiwork, Kiha sits down across from you.  She stares at you for a long moment, glancing quickly from you to the smoking meat in front of you.  Apparently, she wants you to take the first bite.  Gingerly, you pick up a strip of the greasy meat and, looking into Kiha\'s waiting eyes, pop it into your mouth.' );
			MainView.outputText( '[pg]"<i>W-well?  It\'s good... right?</i>"' );
			MainView.outputText( '[pg]You give the stringy, yet juicy, meat a few experimental chews before giving your answer:' );
			//[It's Good] [Blech];
		...
		//Hang Out 3;
			...
			//[if @ swamp: ;
			if( !this.followerKiha() ) {
				MainView.outputText( 'Looking up from the dragoness to the treetops, you notice that Kiha\'s little islet has a surprisingly spacious clearing above it - probably why the dragoness chose this spot to make her home in the first place, since it\'s easier to take off and land without branches crashing into you every time.  You notice the ' );
				if( CoC.time.hours < 21 ) {
					MainView.outputText( 'particularly cloudy day above you, with great pink and purple clouds drifting across the demonically-tainted horizon' );
				} else {
					MainView.outputText( 'stars are out, a thousand little pin-pricks in the heavens', false );
				}
				MainView.outputText( '.' );
			} else {
				MainView.outputText( 'Looking up from your dragoness lover, you note the particularly clear ' );
				if( CoC.time.hours < 21 ) {
					MainView.outputText( 'day around your camp - thick pink and purple clouds are rolling lazily over the wasteland, shimmering behind the great maw of the portal' );
				} else {
					MainView.outputText( 'night in the wastelands.  The stars are out, as they always are at night in your part of Mareth, a thousand thousand little pin-pricks in the heavens' );
				}
				MainView.outputText( '.' );
			}
			MainView.outputText( '[pg]With your dragoness friend close at hand, what might have been an average ' );
			if( CoC.time.hours < 21 ) {
				MainView.outputText( 'day' );
			} else {
				MainView.outputText( 'night' );
			}
			MainView.outputText( ' seems suddenly romantic.  With a playful grin, you wrap an arm around Kiha\'s supple waist, point up to the heavens and bid her look at the ' );
			if( CoC.time.hours < 21 ) {
				MainView.outputText( 'clouds' );
			} else {
				MainView.outputText( 'stars' );
			}
			MainView.outputText( '.  The dragoness does as you ask, following your pointing finger up to the sky.' );
			MainView.outputText( '[pg]"<i>Hey,</i>" she says, snuggling close in your arms.  "<i>I remember what you said a while ago, after I... when you and I first looked up at the sky.  I\'ve been thinking about what you said, doofus.  You\'re stupid sometimes... but you\'re not wrong.</i>"' );
			MainView.outputText( '[pg]Kiha grins at you - before you know it, you\'re on the ground, wrapped tight in the dragoness\'s powerful arms, face pressed between her soft, dusky mounds.  You shift a moment in her grasp before settling in, cuddling up to your lover and staring with her into the heavens.  Kiha holds you close, resting her chin on the crown of your head, occasionally running her scaly fingers through your [hair] or brushing your thighs with her long, flexible tail.  You bask in her warmth, a soft glow that spreads throughout your body; you nuzzle your cheek into her pillowy bosom, looking for a moment from the sky to the beautiful woman holding you.' );
			MainView.outputText( '[pg]Kiha\'s been staring at you for a long time, it seems.  She smiles at you as your gazes meet, her hand running through your hair one last time.  "<i>Oh, you ' );
			if( CoC.player.tallness >= 72 ) {
				MainView.outputText( 'big' );
			} else {
				MainView.outputText( 'little' );
			}
			MainView.outputText( ' idiot.  Don\'t just lie there,</i>" she laughs.  Before you can move, through, Kiha leans up and presses her lips to yours, drawing you into a long, loving kiss.  Gently, her long, reptilian tongue presses against your lips, slithering in to entwine with your own tongue.  You lay together for a long while, cuddling and kissing and playing with each other.' );
			MainView.outputText( '[pg]Time seems meaningless in your draconic lover\'s embrace, yet eventually you know you must part - for the moment.  Giving her another long kiss, you pick yourself up from between Kiha\'s hefty bosom and, say your goodbyes.' );
			MainView.outputText( '[pg]Kiha gives you a wry smirk as you extricate yourself from your arms.  "<i>I\'ll see you soon... Doofus.</i>"' );
		}
		EngineCore.doNext( SceneLib.camp, SceneLib.camp.returnToCampUseOneHour );
		this.kihaAffection( 5 );
	};
	...
	KihaFollower.prototype.blechKihaYourCooking = function() {
		MainView.outputText( '', true );
		MainView.spriteSelect( 72 );
		MainView.outputText( 'You gag and spit, choking up the disgusting, burning chunk of "<i>meat</i>" you just tried to eat.  Kiha gapes at you, aghast, until you ' );
		if( CoC.player.canFly() ) {
			MainView.outputText( 'fly off.  Scowling, Kiha takes to the air too, landing behind you outside' );
		} else {
			MainView.outputText( 'demand to be taken outside.  Grudgingly, Kiha walks over, grabs you by the waist, and hauls you outside' );
		}
		MainView.outputText( '.  Once you\'re back on the ground, you grab the dragoness\'s hefty greataxe out of her hands and stalk into the woods.' );
		MainView.outputText( '[pg]Confused, your lover follows you through the densely-packed trees of the swamp, until you see a boar rooting around in the brush.  Sighting in on the creature, your let out a powerful roar and fling the axe at it.  The boar looks up, OINKs loudly, and tries to scamper off - but Kiha\'s spinning axe lops its head neatly off.' );
		MainView.outputText( '[pg]You drag the carcass back to Kiha\'s hovel, and spend the next hour skinning it, getting a new slab of meat ready, and carefully explaining how to cook decently.  Though visibly annoyed you didn\'t like her "<i>home cooking,</i>" Kiha sits and listens as you explain the finer details of the feeding of yourself and others.  When you\'re done, and the boar is nicely cooked on your hastily-constructed spit, you hand a leg to Kiha and tell her to try it.' );
		MainView.outputText( '[pg]Frowning, she snatches the meat out of your hand and takes a big bite out of it.  You grin as her eyes water at the overwhelming juiciness and sweetness of the meat as you\'ve prepared it.  You think you might just be the first person to ever cook just for her.  Still, though, when you ask her what she thinks, Kiha huffs and answers, "<i>Well, it\'s alright... I guess.</i>"' );
		MainView.outputText( '[pg]You roll your eyes and spend the next few minutes enjoying a delicious, quiet meal with your dragon lover.  When you\'ve finished, you ruffle Kiha\'s hair, tell her to try and take better care of herself - or at least make herself a proper meal sometime - and head off back to camp.  You can almost hear her fuming behind you as you walk.' );
		this.kihaAffection( -10 );
		EngineCore.doNext( SceneLib.camp, SceneLib.camp.returnToCampUseOneHour );
	};
	...
	KihaFollower.prototype.boneTheShitOutofKihaHolesWithHorsecock = function() {
		...
		var y = x + 1;
		MainView.outputText( 'You remove your [armor] as you close in with Kiha, happy to let the ', false );
		if( CoC.player.minLust() < 50 ) {
			MainView.outputText( 'half-turgid' );
		} else {
			MainView.outputText( 'always semi-hard' );
		}
		MainView.outputText( ' length of your ' );
		if( CoC.player.cocks[ x ].cockType === CockTypesEnum.HORSE ) {
			MainView.outputText( 'fat horse-cock' );
		} else {
			MainView.outputText( Descriptors.cockDescript( x ) );
		}
		MainView.outputText( ' flop free in the breeze.  The haughty dragoness\'s eyes zero in on [eachCock], a knowing smirk gracing her proud features as she takes in the sight of your swelling manhood', false );
		if( CoC.player.cockTotal() > 1 ) {
			MainView.outputText( 's' );
		}
		if( CoC.player.isTaur() ) {
			MainView.outputText( ' beneath your equine body' );
		}
		MainView.outputText( '.  "<i>Idiot, you\'re gonna get raped pulling stunts like this, you know that, right?</i>" Kiha asks, gazing you up and down with a hungry look in her eyes.  You shrug and get closer, doing your best to ignore the puff of flame that shoots from her nostril as she snorts in disdain, "<i>Fine, I\'ll help ya with this, but it\'s only because I wanna bring Lethice down.  I don\'t normally like this sort of thing.</i>"' );
		MainView.outputText( '[pg]Kiha drops down to her knees' );
		if( CoC.player.isTaur() ) {
			MainView.outputText( ', crawling under your horse body' );
		}
		MainView.outputText( ', the better to examine your ' );
		if( CoC.player.cocks[ x ].cockType === CockTypesEnum.HORSE ) {
			MainView.outputText( 'bestial equine dong' );
		} else {
			MainView.outputText( '[cock ' + y + ']' );
		}
		MainView.outputText( ' and its slowly-filling ' );
		if( CoC.player.cocks[ x ].cockType === CockTypesEnum.HORSE ) {
			MainView.outputText( 'flared ' );
		}
		MainView.outputText( 'tip.  A single dollop of creamy ooze drips from the wide, semi-dilated cum-slit in the center to plop on the floor, a strong reminder of your unquenched lust and potent virility.  The powerful warrioress sniffs experimentally, taking in the musky, aromatic odor of your thick maleness.  She licks her lips as she cradles the heavy shaft in her hands.  It pulses hotly from her touches, thrumming with each hammering beat of your heart.  She seems distracted by something, but shakes her head to clear it.' );
		MainView.outputText( '[pg]You part your lips to speak, ready to inquire about Kiha\'s distraction, at least, until Kiha\'s dark, spit-glossed lips press against your urethra, slowly spreading across the top of your ' );
		if( CoC.player.cocks[ x ].cockType === CockTypesEnum.HORSE ) {
			MainView.outputText( 'flare\'s mesa' );
		} else {
			MainView.outputText( CoC.player.cockHead( x ) );
		}
		MainView.outputText( ' as she opens wide.  ' );
		if( CoC.player.hasSheath() ) {
			MainView.outputText( 'She pumps you just above the sheath' );
		} else {
			MainView.outputText( 'She pumps your shaft' );
		}
		MainView.outputText( ' with one hand, using slow, even strokes that tickle every sensitive area.  ' );
		if( CoC.player.cocks[ x ].cockType === CockTypesEnum.HORSE ) {
			MainView.outputText( 'Her other caresses the skin of your sheath, fingers slipping in between the folded outer skin and your dick\'s concealed, untouched flesh.  ' );
		} else if( CoC.player.balls > 0 ) {
			MainView.outputText( 'Her other fondles your [balls], steadily increasing your desire for release.  ' );
		} else {
			MainView.outputText( 'Her other fondles your taint, steadily increasing your desire for release.  ' );
		}
		MainView.outputText( 'It feels almost supernaturally sensitive.' );
		if( CoC.player.inte < 20 ) {
			MainView.outputText( '  An unthinking, ' );
			if( CoC.player.cocks[ x ].cockType === CockTypesEnum.HORSE ) {
				MainView.outputText( 'bestial whinny ' );
			} else {
				MainView.outputText( 'groan ' );
			}
			MainView.outputText( 'of pleasure bursts from your lips, ' );
			if( CoC.player.isTaur() ) {
				MainView.outputText( 'hooves stamping as ' );
			}
			MainView.outputText( 'your concern for the dragon evaporating thanks to the pleasure coursing through your ' );
			if( CoC.player.cocks[ x ].cockType === CockTypesEnum.HORSE ) {
				MainView.outputText( 'animal' );
			} else {
				MainView.outputText( 'well' );
			}
			MainView.outputText( '-endowed form.' );
		} else {
			MainView.outputText( '  A ' );
		}
		if( CoC.player.cocks[ x ].cockType === CockTypesEnum.HORSE || CoC.player.isTaur() ) {
			MainView.outputText( 'whinny ' );
		} else {
			MainView.outputText( 'groan ' );
		}
		var horse = false;
		...
		MainView.outputText( 'starts in your throat, but ' );
		if( horse ) {
			MainView.outputText( 'you catch yourself before you start braying like an animal' );
		} else {
			MainView.outputText( 'you catch yourself before it manages to escape your lips' );
		}
		MainView.outputText( '.  Between your inner embarrassment and the pleasure shooting through your ' );
		if( horse ) {
			MainView.outputText( 'animal' );
		} else {
			MainView.outputText( 'well' );
		}
		MainView.outputText( '-endowed form, you forget all about your concern for the dragon.' );
		MainView.outputText( '[pg]Filled with mirth, the fiery orbs of Kiha\'s eyes watch your every reaction.  Her lips slowly stretch into a wide, obscene \'O\' in order to accommodate the entire circumference of your mouth-wrecking ' );
		if( CoC.player.cocks[ x ].cockType === CockTypesEnum.HORSE ) {
			MainView.outputText( 'beast-' );
		}
		MainView.outputText( 'prick.  The ' );
		if( CoC.player.cocks[ x ].cockType === CockTypesEnum.HORSE ) {
			MainView.outputText( 'thick flare' );
		} else {
			MainView.outputText( CoC.player.cockHead( x ) );
		}
		MainView.outputText( ' proves a satisfying challenge for your partner.  Working slowly, her jaw spreads wider and wider, the puffy softness of her lips squeezing and struggling waves of sensation up the root of your cock.  The blissful agony is soon over, as Kiha works the turgid ' );
		if( horse ) {
			MainView.outputText( 'animal ' );
		}
		MainView.outputText( 'endowment into the interior of her mouth, the dragon-like tongue coiling your member as easily as a snake encircles its prey.' );
		MainView.outputText( '[pg]Your reptilian lover bobs haltingly on your shaft.  Even with her efforts, she\'s struggling to slide more than a half-inch at a time through the lip-lined gateway to her mouth.  Consternated, she begins to pump you faster, ' );
		if( CoC.player.cocks[ x ].cockType === CockTypesEnum.HORSE ) {
			MainView.outputText( 'her free hand eagerly caressing you inside your own sheath with inhuman warmth' );
		} else {
			if( CoC.player.balls > 0 ) {
				MainView.outputText( 'her tongue working as much of your shaft as possible with inhuman warmth.' );
			} else {
				MainView.outputText( 'her free hand eagerly caressing your [balls] with inhuman warmth.' );
			}
		}
		MainView.outputText( '.  Her eyes seem a trifle irritated, but the fire of arousal is far more visible in her gaze than that lesser, blighted emotion.  She works your dick like a woman possessed, rubbing, stroking, licking, and squeezing, every motion designed to please your ' );
		if( CoC.player.cocks[ x ].cockType === CockTypesEnum.HORSE ) {
			MainView.outputText( 'big, pony-like prick.' );
		} else {
			MainView.outputText( '[cock ' + y + '].' );
		}
		if( CoC.player.balls > 0 ) {
			MainView.outputText( '  Your [balls] smear and shudder against her chin, so tight, hot, and ready to explode.' );
		}
		MainView.outputText( '[pg]Kiha ' );
		if( CoC.player.balls > 0 ) {
			MainView.outputText( 'squeezes your [sack]' );
		} else if( CoC.player.hasVagina() ) {
			MainView.outputText( 'fondles your [vag]' );
		} else {
			MainView.outputText( 'gives her tongue an encouraging twist' );
		}
		MainView.outputText( ', and you can endure it no longer.  It\'s so hot, so tight, and so... right to have her like this, half-impaled on your shaft just as you start to cum.  Your [sack] tightens from the effort of expelling your seed, flooding your senses with the familiar, tight clench of orgasmic pleasure.  Kiha\'s mouth is stretched wider for the briefest moment by your swelling ' );
		if( CoC.player.cocks[ x ].cockType === CockTypesEnum.HORSE ) {
			MainView.outputText( 'flare' );
		} else {
			MainView.outputText( CoC.player.cockHead( x ) );
		}
		MainView.outputText( ', an incredulous yet hungry look plastered on her somewhat confused face.  The next second, she\'s gurgling and gulping, her mouth flooding with seed as you pump it out like a firehose.  ' );
		if( c <= 250 ) {
			MainView.outputText( 'She manages to guzzle it all down without too much difficulty.' );
		} else if( c <= 1000 ) {
			MainView.outputText( 'Her eyes water, and trickles of cum run from her nose, but she still manages to gulp most of it down.' );
		} else {
			MainView.outputText( 'Her eyes water copiously as semen back-floods out her nostrils.  Her throat works to swallow it all, guzzling it noisily, but it just isn\'t enough.  Jizz squirts from the corners of her mouth and makes a mess of her heaving breasts before it finally winds down to a manageable level.  Her belly even looks a bit pudgy from all the ' );
			if( CoC.player.cocks[ x ].cockType.Index > 0 && CoC.player.cocks[ x ].cockType.Index < 10 ) {
				MainView.outputText( 'animal ' );
			}
			MainView.outputText( 'sperm she\'s been forced to swallow.' );
		}
		MainView.outputText( '[pg]Kiha pulls back and releases your tip from her sore, semen-drenched puckers.  She coughs and gasps for a moment, inadvertently smearing the salty sludge all over herself.  When she recovers, she sighs, "<i>You got it everywhere, idiot.  Now I\'ll have to go get a bath, but first, you had better return the favor.</i>"' );
		//{Variant: Low Lib/Minlust + Fuck/Lust draft} ;
		if( CoC.player.minLust() < 50 && CoC.player.lib < 80 ) {
			MainView.outputText( '[pg]"<i>No problem,</i>" you think, reaching for a handy potion to spike your lagging libido back into the stratosphere.  The potion goes down smooth, with barely any effects at first.  However, after a few moments [eachCock] stiffens and tingles, hungry for more.  You can even faintly detect some new, odd scents in the air.' );
			CoC.player.consumeItem( ConsumableLib.L_DRAFT );
		}
		MainView.outputText( '[pg]Kiha ' );
		if( horse ) {
			if( CoC.player.isTaur() ) {
				MainView.outputText( 'clambers out from beneath you, pulling herself onto a nearby rock, putting herself into position for your horse-body to mount her. She spreads her legs wide, her slick vagina releasing a tantalizing musk that begs for a cock to fill it' );
			}
		} else {
			MainView.outputText( 'leans back against a rock and spreads her legs, exposing you to a tantalizing, cock-filling scent' );
		}
		MainView.outputText( '.  Pre-cum trails from your tip in thick ropes, swaying beneath your bobbing, blood-filled ' );
		if( CoC.player.cocks[ x ].cockType === CockTypesEnum.HORSE ) {
			MainView.outputText( 'horse-' );
		}
		MainView.outputText( 'cock.  That aroma... that wondrous odor.  It fills your nostrils, and as your hormone-flooded consciousness slowly turns it over, you recognize it for what it is - breeding scent.  You\'re smelling a female... no, a fertile female - a bitch, a ' );
		if( horse ) {
			MainView.outputText( 'mare' );
		} else {
			MainView.outputText( 'slut' );
		}
		MainView.outputText( '... a tight cock-sleeve already marked with your seed, just waiting to be mounted and impregnated with your young. You zero in on her cunt - her breeding hole - and step forward, ' );
		if( CoC.player.cocks[ x ].cockType.Index > 0 ) {
			if( CoC.player.isTaur() ) {
				MainView.outputText( 'throwing your hooves onto the rock, looming over Kiha' );
			} else {
				MainView.outputText( 'fondling your bestial tool with one hand' );
			}
		} else {
			MainView.outputText( '[if (isTaur = true) "throwing your hooves onto the rock, looming over Kiha" else "fondling your ' + Descriptors.cockDescript( x ) + ' with one hand"]' );
		}
		MainView.outputText( ', the bobbing motions flinging ropes of pre-cum from your ' + Descriptors.cockDescript( x ) + ' every which way.  ' );
		if( horse ) {
			MainView.outputText( '"<i>Fuck, am I... rutting?!</i>"  ' );
		} else {
			MainView.outputText( '"<i>Fuck, why am I... ?!</i>"  ' );
		}
		MainView.outputText( 'you manage to wonder, instantly sidetracking yourself, "<i>Mmmm... yes... fucking...</i>"' );
		MainView.outputText( '[pg]Kiha gives you an odd look when you roughly spread her legs and batter your ' );
		if( CoC.player.cocks[ x ].cockType === CockTypesEnum.HORSE ) {
			MainView.outputText( 'flat ' );
		}
		MainView.outputText( 'cockhead against her unprepared cunt.  A frightened squeak slips through her lips as you push harder and harder, eventually popping in with little care for your partners feelings - you\'re far too focused on plugging her womb full of your ' );
		if( horse ) {
			MainView.outputText( 'horse-' );
		}
		MainView.outputText( 'spunk to worry about such trivialities.  The dragoness ' );
		if( CoC.player.isTaur() ) {
			MainView.outputText( 'punches your underside' );
		} else {
			MainView.outputText( 'tries to push you back' );
		}
		MainView.outputText( ', shouting, "<i>What are you doing, [name]? HEY?! ARE YOU FUCKING LISTENING TO ME?</i>"' );
		MainView.outputText( '[pg]Growling in irritation, you pop out of the breed-ready ' );
		if( horse ) {
			MainView.outputText( 'mare' );
		} else {
			MainView.outputText( 'slut' );
		}
		MainView.outputText( '\'s cunt, and slap her across the face with your cum-dripping, pussy-wetted member.  Her eyes go wide in absolute, complete shock.  She didn\'t expect that.  Nevertheless, you press on, smearing your ' );
		if( horse ) {
			MainView.outputText( 'savage shaft' );
		} else {
			MainView.outputText( Descriptors.cockDescript( x ) );
		}
		MainView.outputText( ' over her face and forcing her to get a good whiff of your potent cock-scent.  Her eyes gradually lose their focus, gravitating down the thick cylinder of ' );
		if( CoC.player.cocks[ x ].cockType === CockTypesEnum.HORSE ) {
			MainView.outputText( 'horse-' );
		}
		MainView.outputText( 'meat slapping at her cheeks.  Soon, she is licking it in a daze.  Her breeding-scent is now much stronger in the air, perhaps double what it was before.  Judging her ready, you give her jaw a gentle smack and return to your previous task: insemination.' );
		MainView.outputText( '[pg]Kiha babbles, "<i>Wh-what\'s g-going onnn... mmm... smells nice... fuck me?</i>"  Happily, you oblige.  After battering her lips open the first time, the repeat insertion goes much more smoothly, allowing the ' );
		if( CoC.player.cocks[ x ].cockType === CockTypesEnum.HORSE ) {
			MainView.outputText( 'wide head of your stallion-shaft' );
		} else {
			MainView.outputText( CoC.player.cockHead( x ) + ' of your ' + Descriptors.cockDescript( x ) );
		}
		MainView.outputText( ' to spear through Kiha\'s entrance and into her womanly canal.  She groans appreciably, and the wordless exultations of your mate are all the encouragement you need to push deeper, shoving inch after inch of ' );
		if( CoC.player.cocks[ x ].cockType === CockTypesEnum.HORSE ) {
			MainView.outputText( 'well-lubed horse-dick' );
		} else {
			MainView.outputText( Descriptors.cockDescript( x ) );
		}
		MainView.outputText( ' into Kiha\'s fully-dilated pussy.  The dragon-cunt is nice and tight around your large' );
		if( CoC.player.cocks[ x ].cockType === CockTypesEnum.HORSE ) {
			MainView.outputText( ', mammalian' );
		}
		MainView.outputText( ' member.  It slurps up inch after inch of pulsating cock, devouring your dick with a hunger born of the female\'s instinctive drives and desires.' );
		//{UPCOMING HENTAI LOGIC} ;
		MainView.outputText( '[pg]Pussy-juice dribbles onto the ground and immediately disappears into the parched earth as you butt up against her cervix.  You draw back and thrust, smashing your ' );
		if( CoC.player.cocks[ x ].cockType === CockTypesEnum.HORSE ) {
			MainView.outputText( 'flat-tipped horsecock' );
		} else {
			MainView.outputText( Descriptors.cockDescript( x ) );
		}
		MainView.outputText( ' up against her inner entrance, pre-cum slipping through the tiny opening to baste her womb.  Each time you butt up against it, you feel Kiha\'s cervix give a little bit more, open up just a little wider.  Sweat runs down your body as you pump Kiha\'s cunt mercilessly, fucking her hard, just like the little ' );
		if( horse ) {
			MainView.outputText( 'mare ' );
		} else {
			MainView.outputText( 'slut ' );
		}
		MainView.outputText( 'deserves.  She\'s so very hot, practically burning up.  Her body even seems to steam from it as she writhes beneath you, but her hips begin to rise and fall to your tempo, obedient to your dominance and pliantly acquiescing  to your unspoken desire to mate.' );
		MainView.outputText( '[pg]You growl savagely and thrust particularly hard, easily popping your swollen cock-tip through her dilated cervix' );
		if( CoC.flags[ kFLAGS.KIHA_CERVIXGINITY_TAKEN ] === 0 ) {
			MainView.outputText( ' to steal her womb cherry' );
			CoC.flags[ kFLAGS.KIHA_CERVIXGINITY_TAKEN ]++;
		} else {
			MainView.outputText( ' to plow your favorite dragon-hole' );
		}
		MainView.outputText( '.  Kiha winces and shakes her head, rousing from her sexual stupor to question, "<i>W-what, oh shit you\'re... you\'re breaking meeee!</i>"  She shudders and shakes as her eyes roll back from the raw sensation.  Panting and moaning, Kiha idly licks your cock-sludge from her lips and babbles, "<i>W-why is it so goooood?</i>"' );
		if( CoC.player.balls ) {
			MainView.outputText( '  You slap your [balls] into in her ass hard as you thrust, smearing them all over her sweaty ass and tail.' );
		} else {
			MainView.outputText( '  You slap into her hard as you thrust, feeling her tail thrashing beneath your [butt].' );
		}
		MainView.outputText( '  The lust-lost warrior violently thrashes and begins to scream, not in pain, but bliss.  Her snatch clenches like a vice, wringing your ' );
		if( CoC.player.cocks[ x ].cockType === CockTypesEnum.HORSE ) {
			MainView.outputText( 'equine ' );
		} else {
			MainView.outputText( 'thick ' );
		}
		MainView.outputText( 'inseminator in achingly tight hotness.  You bellow and bury yourself fully inside of her, clenching heat surging out from your [balls], dick-tip ' );
		if( CoC.player.cocks[ x ].cockType === CockTypesEnum.HORSE ) {
			MainView.outputText( 'flaring ' );
		} else {
			MainView.outputText( 'engorging ' );
		}
		MainView.outputText( 'to seal itself inside your fuck-broken lover\'s baby-hole.  What feels like a gallon of seed lurches out from your cock.  Kiha\'s innards turn white from the creamy deluge' );
		if( c <= 250 ) {
			MainView.outputText( ', stuffed up with hot cum' );
		} else if( c <= 1500 ) {
			MainView.outputText( ', her belly inflating to pregnant proportions' );
		} else if( c <= 3000 ) {
			MainView.outputText( ', her belly inflating to pregnant equine proportions' );
		} else {
			MainView.outputText( ', her belly distending hugely, grossly even, utterly filled with cum until it\'s squirting from her pussy in a river of white' );
		}
		MainView.outputText( '.' );
		MainView.outputText( '[pg]Sighing, you pull out of the twitching dragoness.  Her violated twat runs white with cum, dripping out in the messiest creampie you\'ve made in some time.  Kiha shivers and reaches down, scooping your musky ' );
		if( CoC.player.cocks[ x ].cockType.Index > 0 ) {
			MainView.outputText( 'animal-' );
		}
		MainView.outputText( 'cum from herself to sample its unique flavor.  The sight invigorates your flagging cock, raising it back to towering, horse-like proportions' );
		if( CoC.player.isTaur() ) {
			MainView.outputText( ' until the shaft bumps your belly' );
		}
		MainView.outputText( '.  You\'ve just started to breed this bitch!' );
		MainView.outputText( '[pg]Kiha\'s ' );
		if( c > 250 ) {
			MainView.outputText( 'cum-gravid ' );
		} else {
			MainView.outputText( 'spunk-stuffed ' );
		}
		MainView.outputText( 'form proves easy to move.  She barely seems conscious of you - too busy sighing and rubbing at her pussy to really care how she\'s moved.  You wipe her cunt-stink from your shaft on the inside of her butt-cheeks, thankful that the scales fade to skin that close to her puckered tailhole.  Pulling her tail aside to give you a better view, ' );
		if( CoC.player.isTaur() ) {
			MainView.outputText( 'you push her onto her hands and knees atop the rock and re-mount her, and ' );
		}
		MainView.outputText( 'you slide your cock between Kiha\'s sweat-soaked asscheeks.  Some small part of you is aware that there\'s no sense mating this hole, but with the air so heavily laden in fuck-scent, you don\'t really care.' );
		MainView.outputText( '[pg]You shove your ' );
		if( CoC.player.cocks[ x ].cockType === CockTypesEnum.HORSE ) {
			MainView.outputText( 'flare' );
		} else {
			MainView.outputText( CoC.player.cockHead( x ) );
		}
		MainView.outputText( ' against Kiha\'s tight anal opening, eliciting a squeal of surprise from your breeding bitch at the unexpected thrust.  Unfortunately, it\'s so tightly closed that you can\'t quite get in, even with all the juices soaking your cock.  Regretfully, you dip your dick into the river of slime that trails from your ' );
		if( horse ) {
			MainView.outputText( 'mare' );
		} else {
			MainView.outputText( 'slut' );
		}
		MainView.outputText( '\'s cunny and try again.  Still, you cannot quite force your way in.  ' );
		if( CoC.player.cocks[ x ].cockType === CockTypesEnum.HORSE ) {
			MainView.outputText( 'The unique shape of your cockhead makes such penetration difficult, but with animalistic stubbornness, you keep at it.' );
		} else {
			MainView.outputText( 'The sheer size of your cockhead makes such penetration difficult, but with animalistic stubbornness, you keep at it.' );
		}
		MainView.outputText( '  Battering against her pucker, relaxing, and circling the tight hole with your ' );
		if( CoC.player.cocks[ x ].cockType === CockTypesEnum.HORSE ) {
			MainView.outputText( 'flare' );
		} else {
			MainView.outputText( CoC.player.cockHead( x ) );
		}
		MainView.outputText( ', you work her asshole until it begins to give.  It won\'t be long now.' );
		if( CoC.player.isTaur() ) {
			MainView.outputText( '[pg]You reach down and grab Kiha\'s tail, providing ' );
		} else {
			MainView.outputText( '[pg]The dragon\'s limp tail provides ' );
		}
		MainView.outputText( 'a suitable handhold to help level your tool into her dark, rear cavern.  Pulling hard on it, you ram forward, and at last, your slime-slicked ' );
		if( CoC.player.cocks[ x ].cockType === CockTypesEnum.HORSE ) {
			MainView.outputText( 'horse-' );
		}
		MainView.outputText( 'cock pops through Kiha\'s sphincter to nestle in her gut.  She\'s blessedly hot, and her back-door feels twice as tight as her well-fucked pussy.  It will be more than suitable for breeding.  ' );
		if( !CoC.player.isTaur() ) {
			MainView.outputText( 'You run a hand over her rump, stopping only to give it familiar slaps as y' );
		} else {
			MainView.outputText( 'Y' );
		}
		MainView.outputText( 'ou force the rest of your thick ' );
		if( CoC.player.cocks[ x ].cockType === CockTypesEnum.HORSE ) {
			MainView.outputText( 'animal-' );
		}
		MainView.outputText( 'cock into the dragon\'s butthole.  Her tight, anal ring acts like a cock-ring for your immense member, keeping it ultra-hard inside her even as it kisses up ' );
		if( CoC.player.hasSheath() ) {
			MainView.outputText( 'to your sensitive sheath' );
		} else {
			MainView.outputText( 'to your sensitive loins' );
		}
		MainView.outputText( '.  You realize you\'re too big for this to be comfortable for her, but you begin to fuck her ass anyway, knowing that as a female, she\'ll enjoy your dominance as much as she\'ll love being bred, even in the ass.' );
		MainView.outputText( '[pg]"<i>F-fuck, you\'re so goddamn BIG!</i>" Kiha cries as she pants in the dirt.  You can feel her stuffed womb sloshing against you through the thin walls of her guts' );
		if( c < 250 ) {
			MainView.outputText( ', and see the unique equine shape buried in her tight tummy' );
		}
		MainView.outputText( '.  Of course you\'re big, you think, you\'re the alpha, the ' + CoC.player.mf( 'stud', 'breeder' ) + ', the one in charge.  You ' );
		if( CoC.player.isTaur() ) {
			MainView.outputText( 'lean down to ' );
		}
		MainView.outputText( 'smack her rear in appreciation of your bitch\'s loyal service and jackhammer against her bouncy butt, holding tight to her tail lest it go wild from her pleasure.' );
		MainView.outputText( '[pg]Kiha begins moaning, and you occasionally feel her semen-soaked fingertips bumping against your ' );
		if( CoC.player.balls > 0 ) {
			MainView.outputText( '[balls]' );
		} else {
			MainView.outputText( 'sheath' );
		}
		MainView.outputText( '.  She gives you encouraging squeezes while you destroy her anus, egging you on to utterly ravish her.  Those tender fingertips soon disappear back into the dragoness\'s hungry twat, masturbating her quim with your heavy spunk as lube.  You sneer and slap the bitch\'s cum-hungry ass, watching it jiggle slightly as the light reflects off the scaled portion.  Not satisfied with fucking every one of her body\'s holes in turn, you grab her ruby tresses and pull back, forcing your ' );
		if( horse ) {
			MainView.outputText( 'mare ' );
		} else {
			MainView.outputText( 'slut ' );
		}
		MainView.outputText( 'to arch her back into a serpentine curve.  The view nearly sets you off, but your body isn\'t quite ready to blow yet.  You need a little more.' );
		MainView.outputText( '[pg]You command, "<i>beg,</i>" with ' );
		if( horse ) {
			MainView.outputText( 'the unquestionable authority of a herd alpha.' );
		} else {
			MainView.outputText( 'an unquestionable air of authority.' );
		}
		MainView.outputText( '  Kiha twists her head slightly, wincing as it pulls her hair.  She can only get far enough to let you see one of her reptilian eyes, but you can see drool hanging from her dusky lips as she speaks, "<i>G-give it to me.  F-fill my ass.  Mount me!  CLAIM ME!</i>"  You grunt and bottom out in her gut, your ' );
		if( CoC.player.cocks[ x ].cockType === CockTypesEnum.HORSE ) {
			MainView.outputText( 'flare ' );
		} else {
			MainView.outputText( CoC.player.cockHead( x ) + ' ' );
		}
		MainView.outputText( 'spreading wide as you reach your absolute apex.  Cum surges through your body, stretching your urethra, opening the tip of your sensitive cumslit as it launches into your slut\'s rear.  She groans happily, her eyes rolling back and tongue lolling from her mouth.  Kiha\'s vocalizations aren\'t even words at this point, just animal grunts of pleasure, much like your own.  You flood her rectum with seed, pumping her rump with jism.  You hold her immobile against you until you finish inseminating her, and then, with a quick smack on her reddening cheek, you slide out and release her hair.' );
		if( c >= 3000 ) {
			MainView.outputText( '[pg]A torrent of cum runs from her overfilled butthole and cunt.  It seems there just isn\'t enough room inside her to hold it all, and with two plus-sized loads in her bottom holes, most of it has to escape.  Even with that, she still looks heavily pregnant, a perfect tribute to your unholy virility.' );
		} else if( c >= 1000 ) {
			MainView.outputText( '[pg]A wash of cum runs from her overfilled butthole and cunt.  Even with that, she still looks heavily pregnant, a perfect tribute to your potent virility.' );
		} else {
			MainView.outputText( '[pg]Trickles of cum run from her butthole and well-ravished cunt, a potent reminder of your virility and the dominance you have over your females.' );
		}
		MainView.outputText( '  Kiha rolls onto her side, cradling her belly, both holes gaping and marked by your spunk.  She mewls, "<i>So... good,</i>" and dips a finger back into her pussy, gathering up more of your seed to taste.' );
		MainView.outputText( '[pg]You circle and lower yourself in front of her face, the perfect height, and you rest your cum-soaked shaft on her face, the ' + CoC.player.cockHead( x ) + ' drooping into her hair to leak seed into the reddish tresses.  Kiha sniffs your ' );
		if( CoC.player.balls > 0 ) {
			MainView.outputText( '[balls]' );
		...
		MainView.outputText( ' and sighs happily.  She reaches up to touch it, her hands reverently smearing her pussy-juices and your leftover cum all over your cock and her face.  She still seems to be quite out of it, but at least she\'s enthusiastic in her cocklust.  You wipe as much of the sexual slime from your dick off on her nose as possible, and then dry yourself with her hair.  Kiha purrs and scoops some into her mouth as you rise, barely noting your departure as she begins to masturbate.' );
		//(FIRST TIME ONLY:  ;
		if( CoC.flags[ kFLAGS.KIHA_HORSECOCK_FUCKED ] === 0 ) {
			MainView.outputText( '[pg]Once you get away from her intoxicating scent, you realize what you just did.  You clap a hand over your mouth' );
			if( CoC.player.cor <= 33 ) {
				MainView.outputText( ' and wince' );
			}
			MainView.outputText( ', wondering just what caused you to go so lust-crazy.  ' );
			if( CoC.player.lib < 80 && CoC.player.minLust() < 50 ) {
				MainView.outputText( 'Was it the lust draft?  Or' );
			} else {
				MainView.outputText( 'Was it' );
			}
			MainView.outputText( ' something Kiha\'s body - or yours - did?  You shake your head and hope she won\'t hold the incident against you.' );
			if( CoC.player.statusAffectv1( StatusAffects.Exgartuan ) === 1 ) {
				MainView.outputText( '  Exgartuan suggests, "<i>She probably loved it if she had as much fun as I did.</i>"' );
			}
			CoC.flags[ kFLAGS.KIHA_NEEDS_TO_REACT_TO_HORSECOCKING ] = 1;
		}
		//(REPEAT:  ;
		else {
			MainView.outputText( '[pg]It happened again!  You shudder and stroke yourself, the unmistakable desire to do it again already cementing itself in your brain.  Well, at least Kiha doesn\'t mind too much.' );
		}
		if( CoC.player.minLust() < 50 && CoC.player.lib < 80 ) {
			MainView.outputText( '[pg]<b>(You used up one lust draft!)</b>' );
		}
	...
	KihaFollower.prototype.kihaPlaysWithBigassCocksFemDomAhoy = function() {
		...
		MainView.outputText( 'You playfully approach the fiery cutey and pull her into a tight hug, your bodies molding together as one.  Kiha looks ' );
		if( CoC.player.tallness >= 84 ) {
			MainView.outputText( 'up ' );
		} else if( CoC.player.tallness <= 60 ) {
			MainView.outputText( 'down ' );
		}
		MainView.outputText( 'at you with feigned indifference, but her vertically slit eyes seem a tad more moist than normal.  Her warm, soft body heat suffuses you, rousing your loins to wakefulness.  Like a long-dormant beast, your ' + Descriptors.cockDescript( x ) + ' rises from its slumber.  It snakes between your bodies, easily escaping from your [armor] to smush past Kiha\'s soft cleavage.  The [cockHead biggest] peaks out to nuzzle your scaly lover\'s cheek, pulsing hotly against the smattering of tiny, freckle-like scales that dot her visage' );
		if( CoC.player.cocks[ x ].cockLength > 48 ) {
			MainView.outputText( ' for a moment before climbing higher.  It quickly blocks your view of your lover.' );
		} else {
			MainView.outputText( ' for a moment before thickening and twitching against her.' );
		}
		MainView.outputText( '  Elephant in the room indeed.' );
		MainView.outputText( '[pg]Kiha nips at it with her teeth, pulling on your thick cock-skin to get your attention.  "<i>A little over-eager, huh?  You\'re hopeless, doofus.  What\'d you do, use Gro+ as lube?</i>" she wonders, even as she peels you out of your [armor].  "<i>You know, if you don\'t learn to control yourself, you\'re going to wind up strapped into a demon fucking machine for the rest of your life.  Though, with a dick like this, maybe that\'s what you\'ve been getting ready for.</i>"  Kiha sighs, "<i>Pathetic,</i>" and circles your [cockHead biggest] with delicate touches of her fingertips and feather-light caresses from her claws.' );
		MainView.outputText( '[pg]Smiling, you inform your domineering partner that you only got that way because of her.  Because her lovely, sculpted form was so very close to you.  She turns crimson (well, more crimson than normal), and slaps your [cock biggest] with her palm.  "<i>R-really... I did... THIS?</i>" she stammers.  You nod, as sagely as you can with an erection ' );
		if( CoC.player.cocks[ x ].cockLength > 48 ) {
			MainView.outputText( 'bigger than' );
		} else {
			MainView.outputText( 'the size of' );
		}
		MainView.outputText( ' your torso.  Kiha actually giggles, a sound you never would have expected her to make when you first met, and she playfully begins to jack off your [cock biggest], humming happily when it gets slightly larger and harder in her hands.' );
		MainView.outputText( '[pg]You lean back against a ' );
		if( this.followerKiha() ) {
			MainView.outputText( 'rock' );
		} else {
			MainView.outputText( 'tree' );
		}
		MainView.outputText( ' and sigh in contentment, happy to let Kiha tend to the omnipresent beast that hangs down with your [legs].  The heavy, sensitive burden that is your [cock biggest] is always making it hard to move, and worse, it practically immobilizes you when it gets hard.  But in moments like this, you\'re glad you have so much sensitive dick for Kiha\'s hands to explore' );
		if( CoC.player.cocks[ x ].cockType === CockTypesEnum.HUMAN ) {
			MainView.outputText( ', particularly your medial ring and the sensitive edge of your flare.' );
		} else if( CoC.player.hasKnot( x ) ) {
			MainView.outputText( ', particularly your massive, bulging canid knot.' );
		} else if( CoC.player.cocks[ x ].cockType === CockTypesEnum.DEMON ) {
			MainView.outputText( ', particularly the hundreds of demonic nodules that ring your shaft.' );
		} else if( CoC.player.cocks[ x ].cockType === CockTypesEnum.ANEMONE ) {
			MainView.outputText( ', particularly the groups of aphrodisiac laced tentacles under your crown.' );
		} else if( CoC.player.cocks[ x ].cockType === CockTypesEnum.TENTACLE ) {
			MainView.outputText( ', particularly the underside of your tentacle\'s mushroom-like tip.' );
		} else if( CoC.player.cocks[ x ].cockType === CockTypesEnum.CAT ) {
			MainView.outputText( ', particularly the hundreds of rubbery spines covering your feline maleness.' );
		} else {
			MainView.outputText( '.' );
		}
		MainView.outputText( '  The whole world seems to spin as Kiha\'s attentions bring you to ever-higher levels of pleasure, and you grab hold of her hips to steady yourself when you nearly slide off your resting place.  She ' );
		if( CoC.player.cocks[ x ].cockLength > 48 ) {
			MainView.outputText( 'pulls your cockhead down and ' );
		}
		MainView.outputText( 'sticks out a remarkably long, reptilian tongue.  It encircles your tip like a snake, though instead of crushing the life from its prey, it appears content to try and squeeze the cum out of you.' );
		MainView.outputText( '[pg]The onslaught of affection batters the strength from your [legs], leaving you to slump down to the ground.  Kiha gets down on her knees to maintain her position.  Her tongue untwists from around your [cock biggest] quickly, feeling so good it almost hurts and nearly unleashing your load at the same time.  She kisses the moist cum-slit at your tip and looks around your shaft, her lips coated in pre as she teases, "<i>Such a big, virile ' + CoC.player.mf( 'male', 'specimen' ) + ', and yet... this thing makes you so easy to defeat.</i>"' );
		MainView.outputText( '[pg]Kiha twists her tail ' );
		if( CoC.player.hasKnot( x ) ) {
			MainView.outputText( 'beneath your knot ' );
		} else {
			MainView.outputText( 'around your base' );
			if( CoC.player.hasSheath() ) {
				MainView.outputText( ', just above the sheath, ' );
			} else {
				MainView.outputText( ' ' );
			}
		}
		MainView.outputText( 'into an impromptu cock-ring.  The hot, scaly appendage pulls just tough enough to make your [cock biggest] even harder, but not quite painfully so.  You whine from the pent-up pressure in your [balls], a high-pitched, keening sound of pleasure.  Your dragoness trails a claw-tip down the bulge of your urethra as she replies, "<i>Not long now, doofus... not long now.  I-I\'ve got to... uh... train you to control this... this... thing.  Maybe if you cum hard enough, you won\'t lose like a chump to some low-level demonic toadling, will you?</i>"' );
		MainView.outputText( '[pg]You nod, too overwhelmed by the symphony of touches up on your shaft.  Kiha shuffles closer, then spins around to sit half in your lap, half on her tail.  Her steamy box grinds on you while her ruby tresses tickle your nose and cascade in waves over your [chest].  The movement wraps another half-coil of tail around your [cock biggest], the bottom ring pulling even tighter, in turn making you even harder.  Kiha wraps her arms around your maleness for support and lifts her legs, placing the hot, supple soles of her feet on either side of your mammoth urethral bulge.  A huge dollop of pre-cum beads at your [cockHead biggest], but Kiha slurps it down before it can escape.  "<i>Can\'t have you running around covered in your own sex-stink can we?  Goblins would be all over you before you know it, and an idiot like you would probably make them all pregnant with this... this... mmm... uh, gross thing.</i>"' );
		MainView.outputText( '[pg]Kiha interlocks her fingers and begins pumping you fast and hard.  Her feet rub along either side of your [cock biggest] in circular motions to the same tempo.  She leans back over her shoulder to kiss you, the dragon\'s extra-warm body temperature making you sweat and drip.  It\'s so hot... so very hot.  You can feel the warmth building in your core.  ' );
		if( CoC.player.balls > 0 ) {
			MainView.outputText( 'Your balls clench and relax in time with the waves of pleasure, and y' );
		} else {
			MainView.outputText( 'Y' );
		}
		MainView.outputText( 'our dick feels ready to burst.  Kiha is shaken by your massive prick\'s twitching, and frenches you more aggressively before whispering, "<i>Go on, cum.  Cum for me, my toy.  Let your dick rejoice just this once, and cum for me.</i>"  Kiha circles your [cockHead biggest] with her tongue, lashing the saliva-soaked appendage back and forth across the summit of your bloated organ.  You groan loudly and clench, feeling the cum start to pump from your [balls], up through your bulging, flooding urethra.' );
		MainView.outputText( '[pg]Kiha comments, "<i>That\'s it, that\'s a good ' + CoC.player.mf( 'boy', 'girl' ) + ',</i>" just in time to watch the first globules of semen blast into the air.  You clench and unload another geyser of sperm into the air before the first rains down over Kiha, splattering over her hair and face' );
		if( CoC.player.cumQ() >= 1000 ) {
			MainView.outputText( ', effectively bukkaking her from the sheer volume of your ejaculate' );
		}
		MainView.outputText( '.  Some of it even hits you, but you\'re too busy clenching rhythmically, expelling every drop of your creamy white juicy into the air for Kiha\'s still-pumping soles.  ' );
		if( CoC.player.cumQ() >= 2000 ) {
			MainView.outputText( 'Wave after wave of spunk rains down over you, forming a gratuitous puddle and utterly, completely sliming you both.  ' );
		}
		MainView.outputText( 'Kiha shivers slightly and brushes a few ropes of jism away from her eyes as she says, "<i>Idiot!  You got me wet!</i>"' );
		MainView.outputText( '[pg]You slump down with a dopey smile, dragging the spooge-spattered dragoness with you, back into a hug.  Kiha snorts a puff of fire in irritation, but admits, "<i>You know, if I do that to you... I wouldn\'t mind you getting all hot and bothered for me more often.  J-just keep it out of my hair next time, doofus!</i>"  She stands, uncoiling her tail from your slowly-softening shaft and stretching, forcing you to look at the absolutely soaked wetness of her pussy.  The lips are tinged reddish and enflamed with lust, though Kiha seems to manage it well as she saunters away towards a stream.' );
		if( CoC.flags[ kFLAGS.IZMA_CHILDREN_TIGERSHARKS ] > 0 ) {
			if( CoC.player.cor < 50 ) {
				MainView.outputText( '  You hope she doesn\'t get jumped upby your tiger-shark children.' );
			} else {
				MainView.outputText( '  You wonder what would happen if she got jumped by your tiger-shark children.' );
			}
		}
		...
		if( CoC.monk >= 5 && CoC.player.findStatusAffect( StatusAffects.NoJojo ) < 0 && CoC.flags[ kFLAGS.JOJO_DEAD_OR_GONE ] === 0 ) {
			if( !SceneLib.jojoScene.tentacleJojo() ) {
				...
				MainView.outputText( ', ignoring the sound of Jojo vigorously fucking himself with all his tentacles in the trees' );
			}
		}
		MainView.outputText( '.' );
		if( SceneLib.sophieBimbo.bimboSophie() ) {
			MainView.outputText( '  Sophie greets you when you return, though she seems crestfallen once she smells the sex on you and realizes how thoroughly you\'ve been sated.' );
		}
		if( SceneLib.amilyScene.amilyCorrupt() ) {
			MainView.outputText( '  Amily begs, "<i>May I help to service you next time, ' + CoC.player.mf( 'master', 'mistress' ) + '?</i>"' );
		}
		CoC.player.orgasm();
	...
	KihaFollower.prototype.savinTheAnalForKiha = function() {
		...
		MainView.outputText( 'Giving the dragoness a little grin, you slip around her half-furled wings and grab her big, soft butt. Kiha lets out a little gasp, then turns to glower at you, though you duck behind her massive wings and give her cheeks a little squeeze.  "<i>W-what do you think you\'re doing back there, doofus?</i>" Giving her a playful swat, you turn around, pressing your [chest] against ' );
		if( CoC.player.tallness >= 60 ) {
			MainView.outputText( 'her shoulders ' );
		} else {
			MainView.outputText( 'the small of her back ' );
		}
		MainView.outputText( 'and grabbing both of her lush, soft buttcheeks in your hands.  Kiha makes a show of growling and squirming in your grasp, but does not resist as you tease, eventually even swishing her tail over to rub your thighs and your own [butt].' );
		MainView.outputText( '[pg]"<i>Gah!</i>"  the dragoness gasps as she feels your hardening ' + Descriptors.cockDescript( x ) + ' pressing into her butt, barely restrained by your [armorName].  "<i>Oh, of all the things to obsess over!</i>"  she groans, but to your delight Kiha wiggles her hips in your grip, grinding her soft butt against your prick.  You give her a sharp little spank, and laugh as Kiha draws a sharp breath and clenches her derriere - just in time for you to free the beast, your ' + Descriptors.cockDescript( x ) + ' flopping down between her butt cheeks.' );
		MainView.outputText( '[pg]"<i>Oh, I get it,</i>" Kiha jeers, suddenly pushing back until your cock is pinned between your ' );
		//(depending on length: ;
	...
	KihaFollower.prototype.fuckKihasVagInCamp = function() {
		MainView.outputText( '', true );
		MainView.spriteSelect( 72 );
		MainView.outputText( 'You grab Kiha by the hand, running your fingers across the scaly texture on the outside of her claw while you pull her in close.  She blushes cutely and smirks, "<i>Couldn\'t stay away, huh, [name]?</i>"  Smiling knowingly, you pull her hand down towards your loins.  A look of confusion clouds the dragoness\'s usual, stormy gaze as you pull her hand inside the bottom of your [armor].  The feel of [oneCock] pulsing hotly against her fingers is all it takes to shatter your lover\'s haughty demeanor.  ' );
		if( EngineCore.silly() ) {
			MainView.outputText( 'She asks in a high-pitched whine, "<i>Did I do thaaat?</i>"  Steve Urkel has nothing on her!' );
		} else {
			MainView.outputText( 'She nervously stutters, "<i>Is that... because of me?</i>"' );
		}
		MainView.outputText( '[pg]Nodding a little eagerly, you pull the warrioress closer to pin her hand in place, utilizing the familiar, constricting pressure of two bodies tightly entwined.  Kiha\'s ruby eyes widen, the black slits dilating as emotion surges through her powerful frame.  Her tail slides up behind your [legs] to wrap around them affectionately.  It pulls just tight enough to spread its warmth through you without restricting or unbalancing your movements.  You confidently kiss her, delighted to discover her hand moving on its own as soon as the embrace loosens.' );
		MainView.outputText( '[pg]"<i>S-so you want to... umm... fuck?</i>" Kiha asks.  You brush a lock of copper hair away from her face and solemnly answer that you want to \'make love\'.  Back home, they would joke about making a dark girl blush.  With Kiha, it seems almost preternaturally easy, particularly when she\'s blushing as hard as she is now.  Her eyelids lower, and her entire dusky visage takes on a smoky, seductive cast as your words sink in.  Kiha\'s hand shimmies out of your [armor] to hold your [hips], but only for a brief moment.' );
		MainView.outputText( '[pg]With a smooth, confident motion, Kiha easily peels you out of your [armor] to expose you as completely as herself.  You let her toss your gear aside before you take charge again, groping one of her squeezable, soft breasts in your hand as you lower her to the ground.  She allows herself to be handled, her actions surprisingly meek for one so often focused on physical dominance, and you take advantage of it while you can.  The dragoness lies on the ground, her legs lewdly splayed to reveal the glimmering delta of her ever-wet womanhood, flush with the arousal you\'ve kindled within her.' );
		MainView.outputText( '[pg]You close the intervening distance and climb atop your lover, meeting her heavy, lidded gaze with one of mirth and wonder, always amazed to have such unfettered access to Kiha\'s long closed-off heart.  She\'s beautiful, a sparkling ruby jewel you\'re fortunate enough to take for your own.  Kiha purrs, "<i>Come on then, </i>lover<i>... show me this... love-making of yours.</i>"' );
		MainView.outputText( '[pg]You need no further encouragement.  Taking your [cockFit 67] in hand, you rub it against Kiha\'s outer lips, the hot moisture from her furnace-like twat seeming to bubble over your crown.  The dragoness happily hums, "<i>Mmmm, I could get used to this, if this is what \'love\' is...</i>" as you gradually increase the pleasure.  Her slit, while muscular, is as yielding and pliant as the rest of her right now, a moist fruit that is yours for the plucking. You slip right on inside her.  That cunt... that juicy, hot cunt... squeezes your [cockFit 67] with just enough pressure to make you twitch, spikes of pleasure firing nonstop through your rod until it seems to be flexing inside her, as hungry for the eventual release as you.' );
		MainView.outputText( '[pg]Kiha wraps her hands around your neck to pull you down for a wet, draconic kiss.  You respond by reaching back to give the dragon\'s booty a familiar squeeze, encouraging her to keep it up. She runs one hand\'s claws down your back, hard enough for the dagger-sharp tips to ' );
		if( CoC.player.skinType !== AppearanceDefs.SKIN_TYPE_SCALES ) {
			MainView.outputText( 'leave long, red scratches on your back.' );
		} else {
			MainView.outputText( 'dislodge the occasional old scale from your hide.' );
		}
		MainView.outputText( '  The other stays in place, helping to hold you steadily in lip-lock, even while you impale her folds with your hard-as-adamantium dragonlance.  You thrust hard, pulling back from the dragon\'s dusky, pouting lips as you watch her facial expression gradually become even more lewd, forced into lasciviousness by your assault on her nethers.' );
		MainView.outputText( '[pg]Kiha whines, "<i>Mine... harder, please... give me... mine.</i>"  Her breathy exhalations are colored so thickly with unspoken desire you can practically see it in the air.' );
		MainView.outputText( ' You nibble at her ear and whisper, "<i>Yes, and you\'re mine.  Lie back and take it.  All you have to do is enjoy it.</i>"' );
		MainView.outputText( ' The usually-serious dragon-girl nods into your shoulder as you begin to jackhammer at her cunt.  Juices soak your loins, small spatters spraying out from Kiha\'s pussy with each hip-jarring impact of groin to loin.  Faster and faster, you drive your [cockFit 67] into her sodden snatch.  It\'s perfect - a welcoming, hot little hole to snuggle your penis with pleasure until you can take it no longer.  The familiar upwelling of pleasure starts in your [balls], surging up through your waist until [eachCock] is spasming and unloading sticky white jets of love.' );
		if( CoC.player.cockTotal() > 1 ) {
			MainView.outputText( '[pg]Kiha\'s belly is quickly glazed white with goo, and her ' );
		} else {
			MainView.outputText( '[pg]Kiha\'s ' );
		}
		MainView.outputText( 'pussy is soon filled up with the stuff.  She squeals in pleasure, wriggling slowly under you as she digs her claws into your arms involuntarily.  Rivulets of spooge trickle from her pussy down the crack of her ass, mixed in with her clear girl-honey.' );
		if( CoC.player.cumQ() >= 500 ) {
			MainView.outputText( '  Such a meager display is only the start.  You fire rope after rope of cum, enough to slightly distend the dragoness\'s belly with your seed.' );
		}
		if( CoC.player.cumQ() >= 1500 ) {
			MainView.outputText( '  Jizz pumps and pumps, squirting from her filled pussy almost as fast as you inject, yet you still manage to make her look nearly pregnant by the time you finish.' );
		}
		if( CoC.player.cumQ() >= 1000 ) {
			MainView.outputText( '  The drippings form a nice big puddle under Kiha.' );
		}
		MainView.outputText( '[pg]After some languid snuggling, Kiha beams up at you radiantly.  "<i>That was... okay,</i>" she declares, a quaver of uncertainty in her voice as her emotional defenses come back up.  You stand and slowly stretch the kinks from your muscles.  Teasingly, you remind her that it seemed a little better than \'okay\'.  A tail sweeps your [legs] out from under you, a moment before Kiha pounces you with cat-like agility.  She hisses, "<i>It was better than okay, alright?  It was great.  You\'ve made me happy, [name]!</i>"' );
		MainView.outputText( '[pg]Kiha punches you in the chest before climbing off you.  "<i>I don\'t have time for those emotions, doofus... not while Lethice lives.</i>"  Well, it was a nice moment.' );
		CoC.player.orgasm();
		EngineCore.dynStats( 'lib', -1, 'sen', -1 );
		EngineCore.doNext( SceneLib.camp, SceneLib.camp.returnToCampUseOneHour );
	};
	...
	KihaFollower.prototype.kihaOffersToMoveIn = function() {
		...
		MainView.outputText( '[pg]You smile at her nervous query and nod.  She can be a real bitch sometimes, but you know, deep down inside, she well and truly likes you.  Kiha beams and slugs your shoulder, saying, "<i>I knew it, you wimp!</i>"' );
		MainView.outputText( '[pg]You punch her back just as hard and retort, "<i>Whatever, I\'m not anywhere near your territory this time!  Who was missing who?</i>"' );
		MainView.outputText( '[pg]Kiha digs her claws into the moist, swampy ground and wrings her hands, lost in thought.  You wait expectantly until she realizes you saw her, and then, she sighs heavily, "<i>Okay, okay... I missed you, [name].</i>"  She stabs a clawed fingertip against your [chest] as she concludes, "<i>There!  I said it!  I guess I might even lo... like you!  Maybe, if you feel the same way, we could... spend more time together?</i>"' );
		MainView.outputText( '[pg]You grin and hug her, comforting the nervous dragoness until she recovers and gives you a surprise slap on the ass with her tail.  Same old Kiha...' );
		MainView.outputText( '[pg]It sounds like she might be wanting to move in with you, if you were to ask.' );
	...
	KihaFollower.prototype.inviteKihaForDickings = function() {
		MainView.clearOutput();
		MainView.spriteSelect( 72 );
		MainView.outputText( 'You lean back against a tree and ask the haughty dragoness if she would like to come to your camp... maybe even stay a while.  She stops for a moment to consider, her hands clenching nervously as she digests the delicious news.  Looking back your way, her eyes brighten, her face lifts, and she cheers, "<i>REALLY!?</i>"' );
		MainView.outputText( '[pg]Nodding, you take her hands and assure her, "<i>Really.  Move in with me, Kiha.</i>"' );
		MainView.outputText( '[pg]The reptilian woman coughs nervously and attempts to salvage what little is left of her haughty exterior, saying, "<i>I... uh, mean, I guess, if you haven\'t totally fucked it up.</i>"  Her vertically slit pupils seem to twinkle with amusement as she says so, and though you can tell she doesn\'t mean it, you aren\'t particularly inclined to take the insult after making such an important offer.' );
		MainView.outputText( '[pg]You keep your retort light-hearted, but with an edge of seriousness that ought to keep her off-balance and get you a clear, truthful answer.  "<i>You don\'t have to come if you don\'t want to, you know?</i>"' );
		MainView.outputText( '[pg]Kiha stops, dark-skin paling until she looks like a shadow of her former self.  Moisture puddles at the corner of her eyes while she tries to hold back tears, the cracks in her hard facade widening from within and without.  She looks back at you with a touch of anger and defiance in her eyes, but she\'s unable to ignore, or to hide, what\'s in her heart.  Kiha\'s face comes alive as she breaks through her emotion mask, tears running down her cheeks unchecked.  She embraces you in a crushing bear hug, holding onto you like a drowning man would cling to driftwood.  Her words are as unexpected as they are heartfelt.' );
		MainView.outputText( '[pg]"<i>No...[name], I... I\'m sorry.  I would love to see your camp,</i>" she says as she snuggles her tears away on your shoulder.  She pauses and whispers to you, still holding you tight, "<i>Don\'t leave me alone, please... I-I... I love you.</i>"  You tenderly stroke her ruby locks as she confesses her feelings, "<i>I sh-should\'ve told you sooner - I almost did.  It\'s so hard to trust anyone out here, so very hard.  I mean... I\'m fucked up... the demons broke me in so many ways.  I still don\'t even know who I am, and you... you put up with my shit.  You fought me tooth and nail, but you didn\'t hold it against me.  You kept coming back, and never let me despair alone.  I love you, [name], and don\'t you forget it.</i>"' );
		MainView.outputText( '[pg]Kiha sniffles softly and continues, "<i>I almost feel bad for Lethice to have you as an enemy.  Do me a favor and kick her in the twat for me when you find her, okay?</i>"  You both share a nervous laugh at that and slowly end the hug.  Dabbing at one of her tears, you suggest, "<i>Come on, let\'s carry your stuff over and get you moved in.</i>"  Kiha\'s tail wags happily, and the two of you begin gathering her things.' );
		MainView.outputText( '[pg]<b>(Kiha has joined your camp as a lover!)</b>' );
	...
	KihaFollower.prototype.kihaBitchesOutCorruptPCs = function() {
		...
		MainView.spriteSelect( 72 );
		if( !this.followerKiha() ) {
			MainView.outputText( 'You make your way through the murky swamp, your mind turning to thoughts of your dragoness ' );
			if( CoC.flags[ kFLAGS.KIHA_AFFECTION_LEVEL ] === 1 ) {
				MainView.outputText( 'friend' );
			} else {
				MainView.outputText( 'lover' );
			}
			MainView.outputText( ' as you enter her territory.  Your lusty, twisted mind wanders to Kiha\'s dark, voluptuous body, her big, soft breasts, her cunt, lewdly displayed to the world and always leaking lubricant like a well-oiled fuck machine... You grin wickedly to yourself, your ' );
			if( CoC.player.hasCock() ) {
				MainView.outputText( '[cock]' );
			} else if( CoC.player.hasVagina() ) {
				MainView.outputText( '[vag]' );
			} else {
				MainView.outputText( 'lust' );
			}
			MainView.outputText( ' stirring powerfully at the thought of spreading her scaly legs and fucking her raw, until she begs for release, again and again until you\'ve wrung her out and throw her away.  How wonderful that would be!' );
			MainView.outputText( '[pg]As if your thoughts had summoned her, Kiha slips out from behind a tree, her wide hips swaying slightly with each of her powerful, predatory movements...  Her battleaxe flares in her hands, a fiery haze surrounding its brutal curve.  Well, shit.' );
			MainView.outputText( '[pg]"<i>[name].</i>"  She says flatly, planting the haft of her axe in the ground, leaning heavily upon it.' );
			MainView.outputText( '[pg]You say hello, looking nervously around.  Something isn\'t right here, and your hand drifts toward your [weaponName].' );
			MainView.outputText( '[pg]"<i>Listen, [name],</i>" Kiha says, eyeing you from behind her axe.  "<i>Maybe we\'ve gotten to be friends lately, but... something\'s changed about you.  I can SMELL the corruption on you, the lust... I-I can\'t do it, [name].  I can\'t be around someone that could turn into someTHING at any moment, someone who\'s just letting themselves go like... like you are. Please j-just go, [name].</i>"  You try to protest, to reason with the fiery warrior, but she only lifts up her axe and levels it at you...  "<i>J-JUST GO!</i>"' );
			...
			MainView.outputText( 'Kiha approaches you, her belongings gathered in her hands.  The sexy dragoness seems visibly upset, and before you can say a word, she interrupts, "<i>Don\'t say a word, [name].  You\'re corrupt.  I can smell the corruption rolling off you from over here.  I won\'t be here when you turn into a demon, and I don\'t want to fight you... but if you come after me, I won\'t hesitate to defend myself!</i>"' );
			MainView.outputText( '[pg]Kiha closes her eyes and launches herself into the air, only leaving a few tears for the parched wasteland to claim.' );
			EngineCore.doNext( MainView, MainView.playerMenu );
		}
	...
	KihaFollower.prototype.kihaCampAppearance = function() {
		MainView.clearOutput();
		MainView.spriteSelect( 72 );
		MainView.outputText( 'Kiha is a 6 foot tall dragoness, with dark skin and blood-red scales covering much of her body.  She is naked, shameless of her nudity, and carries a tremendous enchanted greataxe, the head of which blazes with heat.  She has a sharp, predatory face with dark red eyes bearing black, reptilian slits.  Long red hair grows from her scalp, reaching down past her shoulders.  She has strong, child-bearing hips and a squishy bubble-butt.  She has two reptilian legs adorned with scales and claws, ending in soft, leathery soles.' );
		MainView.outputText( '[pg]She has a pair of dusky, soft D-cup tits, with a single 0.5 inch nipple on each breast.' );
		MainView.outputText( '[pg]Kiha has a loose twat between her legs which constantly drips a warm, wet lubricant that stains her thighs.' );
		MainView.outputText( '[pg]Between her gropable butt-cheeks, Kiha has a single tight asshole, right where it belongs.' );
	...
	KihaFollower.prototype.beABitchDumbass = function() {
		...
		MainView.outputText( '[pg]"<i>Maybe once you grow some balls,</i>" the dragoness taunts, giving you a wink.' );
		EngineCore.doNext( SceneLib.camp, SceneLib.camp.returnToCampUseOneHour );
	};
	//[Fight for position];
	...
	KihaFollower.prototype.pcWinsDomFight = function() {
		...
		MainView.outputText( 'Defeated, the Dragon-morph falls to the ground, her arm reaching out to the cool, dirty ground to soften her descent.  "<i>Hah... you win.  I guess I do have to be the bottom, then,</i>"  she says, with a wry smile. She whimpers, tossing her axe to the side as she weakly splays her legs, giving you ready access to do as you will with her.  Smirking, you remove your [armor] and ' );
		if( CoC.player.hasCock() ) {
			MainView.outputText( 'pull your quickly hardening ' + Descriptors.multiCockDescriptLight() );
		} else if( CoC.player.hasVagina() ) {
			MainView.outputText( 'release your lathered up ' + Descriptors.vaginaDescript( 0 ) );
		}
		MainView.outputText( ' from your drawers.  Chuckling, you tease Kiha about how she had to make something so easy into something so difficult, as you work yourself between her legs.  You\'re almost about to penetrate her lubed and drooling pussy when you feel her scaly muscles tense up.  Before you can react, your throat is tightly compressed and constricted by what appears to be Kiha\'s tail.' );
		if( CoC.flags[ kFLAGS.KIHA_CHOKED_OUT_PC ] > 0 ) {
			MainView.outputText( '  Not again!' );
		}
		MainView.outputText( '[pg]"<i>Like a moth to an open flame!  If all some demon has to do is fake their defeat and spread their legs to get you into </i>this<i> position, then you will be easy prey indeed.  The real world doesn\'t arbitrarily roll over and concede defeat after a friendly spar!  The fight\'s not over till it\'s over, and right now it looks like you\'ve lost.  Submit, and let me do what I do best,</i>" Kiha coos confidently.  You\'re in for it now.' );
		MainView.outputText( '[pg]Wrapping her attractive thighs around your ' );
		if( CoC.player.hasCock() ) {
			MainView.outputText( Descriptors.hipDescript() );
		} else {
			MainView.outputText( 'face' );
		}
		MainView.outputText( ', the dragoness draws ' );
		if( CoC.player.hasCock() ) {
			MainView.outputText( 'you ' );
		} else {
			MainView.outputText( 'your tongue ' );
		}
		MainView.outputText( 'past her love button and into her eager pussy.  Moaning out in callous pleasure, Kiha pumps you against her twat and takes the time to mock you while you grunt from the sensation of soft pussy against your ' );
		if( CoC.player.hasCock() ) {
			MainView.outputText( Descriptors.cockDescript( x ) );
		} else {
			MainView.outputText( 'mouth muscle' );
		}
		...
		MainView.outputText( '[pg]Working your hands quickly into the fleeting gaps in her stranglehold, you capitalize on her distraction and wiggle out of her grip.  "<i>W-wha-?</i>" she tries to blather out, but her expression of dismay and confusion is cut off as you roughly flip her body over with your hands.  The air is filled briefly with a loud "<i>umph</i>" from your dragoness lover, and then a wail of surprise as you' );
		var choices = [];
		if( CoC.player.hasCock() ) {
			choices.push(0);
		}
		...
		if( select === 0 || !CoC.player.hasVagina() ) {
			MainView.outputText( ' plow back into her cunt.  With your brute strength and form, you pin her body down to the ground and fuck her from behind.' );
			//Kiha response one (requires vagina): ;
			if( Utils.rand( 2 ) === 0 ) {
				MainView.outputText( '[pg]"<i>Ha!  The Champion still has some fight in ' + CoC.player.mf( 'him', 'her' ) + '!  Keep me here if you can, wimp!  I WILL pin you down and cum all over your face!  You\'ll lap it all up like a good little ' + CoC.player.mf( 'boy', 'girl' ) + ' to bo- UGH!</i>"' );
			}
			//Kiha response one (requires cock): ;
			else {
				MainView.outputText( '[pg]"<i>Ha!  The Champion still has some fight in ' + CoC.player.mf( 'him', 'her' ) + '!  Keep me here if you can, wimp!  I WILL pin you down and make you beg to plant your seed in my womb!  Just wa-OOhhOhhh...</i>"' );
			}
		}
		//PC's vagina is chosen/ has vagina only: ;
		else {
			MainView.outputText( ' work your way between her legs and joined your clits together in a gyrating dance of pleasure.  Locked in a scissoring position, Kiha can only giggle in blissful delight as you grind your pussies together.' );
			//Kiha response one (requires cock): ;
		...
		MainView.outputText( '[pg]Subdued for the time being, you push onward with coitus and brutalize Kiha\'s ever moistening pussy, the female dragon morph crying out in sheer delight at the "<i>punishment</i>" being inflicted upon her ' );
		if( select === 0 || !CoC.player.hasVagina() ) {
			MainView.outputText( 'love canal' );
		} else {
			MainView.outputText( 'clit' );
		}
		MainView.outputText( '.  "<i>Come on, idiot!  Give me all you\'ve got, if you have the balls!</i>"' );
		//PC is male or herm, nutless: ;
		if( CoC.player.gender !== 2 && CoC.player.balls === 0 ) {
			MainView.outputText( '[pg]You\'re not sure if that\'s an insult or a challenge to step it up.' );
		}
		MainView.outputText( '[pg]She wants it rough?  Fine by me, you think to yourself.  Taking hold of her scarlet hair, you give her a forceful' );
		//PC is fucking Kiha with a cock:  ;
		if( select === 0 || !CoC.player.hasVagina() ) {
			MainView.outputText( ' tug along her lengths and pull her head back towards you, soliciting a pained scream from Kiha as her roots convey the agony of the act to her.  "<i>Is that all you\'ve GOT?! Give me a break!</i>"' );
		}//PC is fucking Kiha via scissoring: ;
		else {
			MainView.outputText( ' twist of your fingers along her clitoral hood, causing Kiha to screech in surprised pain and pleasure.  "<i>Is that all you\'ve GOT?! Give me a break!</i>"' );
		}
		MainView.outputText( ' she mockingly yells back at you.  In a flash, her right leg sweeps against your shoulder and pushes you towards the ground; her other leg and body twisting to assist in knocking you over.  As fast as you can, you try and work your limbs and body to fend off Kiha\'s attempts to force you against the ground, but it\'s no use.  The dragoness... ' );
		//Kiha decides to ride the PC's cock (requires cock): ;
		if( select === 0 ) {
			MainView.outputText( 'works her way on top of your pelvis and impales herself on your ' + Descriptors.cockDescript( x ) + ', grinning like a mad fool as she does so.  "<i>Told you!</i>"  She remarks. "<i>Was that really the best you could do?  With the hair pulling?</i>"  She sighs.  "<i>I guess I have to teach you a thing or two...</i>"  Lowering herself down in between savage slams of her rump against your pelvis, the cool and arrogant woman takes the ' + CoC.player.skin() + ' of your neck and pierces it with her canines, causing you to cry out as the sting of her bite flows through you.  Humming her approval, she carries on with the coarse treatment of your entrapped cock, mashing and working forth a crescendo of skin on skin slapping noises.' );
		}
		//Kiha ensnares the PC between her legs for cunnilingus (universal):;
		else if( select === 1 ) {
			MainView.outputText( 'quickly wraps her legs around your head and rolls your body into a belly down prone.  "<i>Eat it ' + CoC.player.mf( 'big boy', 'you delectable slut' ) + '!  I\'ve got you in a hold you can\'t possibly escape from!  Lap it up bitch!</i>"  For the time being you comply, if only to give you time to find a way out of this as you probe her cunt with your tongue.  "<i>Yeeeaahhhah, just like that.  Good ' + CoC.player.mf( 'boy', 'girl' ) + ', lick your mistress\'s pussy!</i>"  She coos authoritatively, her thigh tensing up with every stroke.  The dragon woman even has the nerve to play with your hair as she keeps you within her tight embrace.' );
		}
		//Kiha traps the player in a submissive 69 (universal): ;
		else {
			MainView.outputText( 'settles on top of you and seizes your [legs], pulling up with determined strength as she brings your [feet] up to her ears.  When the flurry of motion settles you find yourself staring up at Kiha\'s well toned asscheeks, the sensation of wet lady fluids drooling down your face as Kiha takes your ' );
			if( CoC.player.hasCock() ) {
				MainView.outputText( Descriptors.cockDescript( x ) );
			} else {
				MainView.outputText( Descriptors.clitDescript() );
			}
			MainView.outputText( ' in her mouth.  "<i>Get used to that angle [name]; it\'s your new favorite position.</i>"  She taunts, before ' );
			if( !CoC.player.hasCock() ) {
				MainView.outputText( 'lapping viciously at your cunt.' );
			} else {
				MainView.outputText( 'ramming your cock down her craw.' );
			}
		}
		MainView.outputText( '[pg]This won\'t do at all!  You\'re going to dominate her, whether she likes it or not!  Mustering your strength, you wait for the best moment to break free and ' );
		if( select <= 1 ) {
			MainView.outputText( 'not have your neck\'s flesh ripped up in the process' );
		} else {
			MainView.outputText( 'not have a mishap with your genitalia' );
		}
		MainView.outputText( '.  Finally, your chance for freedom arrives and you take it, raising your arms up and twisting against her body with all your might.  The move works and Kiha is flung from your lap and down the incline you both were rutting against.  Unfortunately... or fortunately, you find yourself rolling down the same hill as her; the world spinning around violently as you slip and tumble towards even ground.  After what feels like a dizzying eternity, you feel the evenness of earth under your spinning body, and come to rest against an old wooden stump of a dead tree.' );
		MainView.outputText( '[pg]Groaning, you survey the immediate area for the less than cooperative dragon woman.' );
		//repick scene;
		choices = [];
		if( CoC.player.hasCock() ) {
			choices.push(0);
