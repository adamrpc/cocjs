...
angular.module( 'cocjs' ).run( function( SceneLib, $rootScope, WeaponLib, PerkLib, Descriptors, AppearanceDefs, ArmorLib, EventParser, CoC, kFLAGS, StatusAffects, EngineCore ) {
	...
	Raphael.prototype.meetRaphael = function() {
		...
		EngineCore.outputText( 'You stir in your sleep, bothered by a noise. It\'s the familiar creaking of your camp\'s storage chest, as if you\'ve just opened it up to fill it with freshly found loot. Groaning, you hog your blankets and twist. Nothing to worry about then. You soon drift back into a pleasant dream about all the spoils you\'ve accumulated over the time here. Life is good.\n\n', false );
		EngineCore.outputText( 'Suddenly, you sit up straight and something occurs to you. If you\'re sleeping, then who\'s opening the chest?\n\n', false );
		EngineCore.outputText( 'You rush out of bed and into camp, concerned for your stash.\n\n', false );
		EngineCore.outputText( '"<i>Hey!</i>" you call out sleepy as, indeed, a strange red being is rummaging through your belongings. It has its front body in your storage chest, throwing junk about in search of valuables while its bright red tail wags in the air. The moment it notices you, it jumps up and runs off so fast it turns into a red blur. Only at the outskirts of your camp, on top of a small crumbled wall, does it take the time to introduce itself.\n\n', false );
	...
	Raphael.prototype.meetRaphaelPtII = function() {
		EngineCore.outputText( '', true );
		EngineCore.outputText( 'Suddenly, Raphael\'s features grow soft and surprised as he looks down upon you. You get the feeling he\'s eyeing you up and catching a peek at your cleavage, but you can\'t be sure.\n\n', false );
		EngineCore.outputText( '"<i>Marae must have cursed me for my audacity, for I am growing blind even at my young age.</i>" The fox puts his hand to his forehead and pretends to faint. He rights himself just before he hits the ground, however and lands in a kneel before your feet.\n\n', false );
		EngineCore.outputText( 'You can\'t help but smile a little at the amount of theatrical flourish.\n\n', false );
	...
	Raphael.prototype.RaphaelFirstMeetingSLAP = function() {
		EngineCore.outputText( '', true );
		EngineCore.outputText( 'With an offended scowl you throw a flat palm across his face. You make sure to catch his nose and sharp snout, sending him a clear message.\n\n', false );
		EngineCore.outputText( 'It takes Raphael completely by surprise. The fox keeps his head in the wake of the blow for a good five seconds in disbelief, but tries once more when he recovers.\n\n', false );
		EngineCore.outputText( '"<i>I can assure you señorita, that I had no intention of tainting your honor.</i>" He pats your hand.\n\n', false );
		EngineCore.outputText( 'This time you wrestle your hand from Raphael\'s hold and throw him the heavier back of your hand, sending him to fall on his back. You\'re actually getting angry at him. How dare he sneak into your camp, try to rob you and then seduce you! By the time it occurs to you to actually apprehend him, Raphael has already beaten a hasty retreat by hopping back up on the wall.\n\n', false );
		...
		EngineCore.outputText( 'Raphael curtsies and tips his hat before making his escape. "<i>You have my condolences.</i>"\n\n', false );
	...
	Raphael.prototype.RaphaelFirstMeetingTALK = function() {
		EngineCore.outputText( '', true );
		EngineCore.outputText( 'You squint your eyes at him, pulling on your arm to wrestle it from his hold. When you remark he stole from you and ask him to return your goods, Raphael simply throws you a vulpine smirk.\n\n', false );
		EngineCore.outputText( '"<i>Mere souvenirs fair blossom, to remind me of your beauty!</i>" He schmoozes and strides into camp with the kind of confidence that makes him own the place. He pops open the tightly locked trunk with the mere kick of a boot and places his ill-gotten gains back into your belongings. From within the large sack, he pinches a small pouch of your gems and quickly spirits it away. With his lightning quick fingers, you see him place it between his shoulders.\n\n', false );
		EngineCore.outputText( 'You insist he return all of it, but the Russet Rogue merely smiles as he walks back towards you. "<i>My, whatever do you mean, pretty señorita? Are you accusing me of being less than forthright?</i>" He raises his shoulders.\n\n', false );
		EngineCore.outputText( 'Tiring of his charades, you reach behind his neck to retrieve the pilfered pouch, but when you do, there is none to be found. It\'s the only place he could have put it, but it\'s gone and he isn\'t using his arms! You frown. It\'s clear that the fox is as good as his reputation. He\'s hiding the pouch with the skill of a pickpocket. You begin to consider how he does it, but before you do, the fox comments on your body posture.\n\n', false );
		EngineCore.outputText( '"<i>My, aren\'t we frisky. What happened to foreplay? Shouldn\'t you be buying me dinner before you ravish me? Breakfast perhaps?</i>" Raphael clucks. You jump away as you realize you\'ve had your hands all over his body.\n\n', false );
	...
	Raphael.prototype.RaphaelDress = function() {
		EngineCore.outputText( '', true );
		EngineCore.outputText( 'A small pebble hits the ground near you, waking you up. When a second one hits, you\'re sure someone is trying to draw your attention.\n\n', false );
		EngineCore.outputText( 'Rubbing your eyes, you pull yourself out of bed, wondering what\'s going on. Sticking your head through the front wall of your tent, you take a curious peek outside, but find no one around.\n\n', false );
		EngineCore.outputText( 'The first thing you do is open your storage chest, to see if the Russet Rogue has robbed you again. This doesn\'t appear to be the case, and instantly, your eye is drawn to an addition instead of a subtraction from its contents. You seem to have gained a new outfit! Upon a carefully folded fabric of rose red color, a note is left below a gorgeous ruby pendant upon a golden setting and carried by a filigree chain. Curiously, you open the note and read it.\n\n', false );
		EngineCore.outputText( '"<i>I happened across this beautiful ensemble and was instantly reminded of the one thing in Mareth that makes its splendor pale in comparison. Fair trappings, to fit around a beautiful body.\n\n', false );
		EngineCore.outputText( 'Yours faithfully,\n  - The Russet Rogue\n\n', false );
		EngineCore.outputText( 'P.S. The clothes are my gift to you. I would delight to see you wear it whenever you desire to meet. Ownership of the ruby however, remains to be seen.</i>"\n\n', false );
	...
	Raphael.prototype.RaphaelEncounterIIDressFollowup = function() {
		...
		EngineCore.outputText( 'Curious, you amble towards the Russet Rogue. Raphael, this time armed with a picnic basket and a bottle of fine wine, makes a nonchalant impression as he lies leisurely on top of the wall. His tail flicks about playfully, while he swirls a small amount of wine within a crystal glass. At first he looks at the fluid casually and takes a sip, before rolling his head sideways to look down upon you.\n\n', false );
		//({If player still meets the first encounter requirements:} ;
		if( this.RaphaelLikes() ) {
			EngineCore.outputText( '"<i>How long ago was it, that you had a decent breakfast, hhhmmm?</i>" He smirks. "<i>One that didn\'t include imp gut and hellhound testicles. A worn out camp like this one is no place for a lady. Let me at least endeavor to give a woman of your caliber a taste of the good life.</i>"\n\n', false );
		...
		//({If player does not meet the first encounter requirements:};
			...
			EngineCore.outputText( 'When he catches sight of you, he spurts out the sip.\n\n', false );
	...
	Raphael.prototype.RaphaelSelectDate = function() {
		EngineCore.outputText( '', true );
		EngineCore.outputText( 'You smile bashfully, not expecting this sort of gesture from anyone in Mareth. You hardly care about the pendant and you nod at him.\n\n', false );
	...
	Raphael.prototype.RaphaelChooseReject = function() {
		EngineCore.outputText( '', true );
		EngineCore.outputText( 'You sigh at the fox and shake your head. You\'re not interested in him or his advances.\n\n', false );
		EngineCore.outputText( 'He flicks his tail past his body again and within the blink of an aye, the glass of wine is exchanged for the stolen pendant.\n\n', false );
		EngineCore.outputText( '"<i>The Russet Rogue is no thief, señora.</i>" He states seriously and tosses the bauble back at your feet. You drop your frown.\n\n', false );
	...
	Raphael.prototype.RaphaelChooseFrisk = function() {
		...
		//({Int or Spe between 24-36 and Cor is not higher than that};
			...
			//{If player corruption is at or higher than 15} ;
				...
				EngineCore.outputText( 'With no intention to relent, you grab him by the oddly enlarged bulge in his tight leather pants and squeeze softly, discovering how several of his jewels are harder than others. He hid your gem amongst his own!\n\n', false );
			}
		...
		//{If player's corruption is higher than 19 and higher than Intelligence.};
			...
			EngineCore.outputText( '"<i>My, such an eager little thing.</i>" He comments, pleased.\n\n', false );
	...
	Raphael.prototype.friskRejectChoice = function() {
		EngineCore.outputText( '', true );
		EngineCore.outputText( 'You scoff, cross your arms and reject the offer by telling Raph your answer from across your shoulder, with your back still turned to him aloofly. Pleased with yourself, you add that he\'s nothing more than a carnie with an accent and that you won\'t be needing his help.\n\n', false );
		EngineCore.outputText( '"<i>As you say, my desert rose. It is clear that I have no more to teach you then.</i>"\n\n', false );
		EngineCore.outputText( 'You startle when you hear the fox bang against your chest. When you turn around, he\'s once again stealing from you!\n\n', false );
		EngineCore.outputText( '"<i>There\'s no teaching those of lesser stock a sense of grace and refinement. Those are still decidedly my domain!</i>" He guffaws with a bag of goods across his back and runs off.\n\n', false );
		EngineCore.outputText( '"<i>Even without a belt on?</i>" You ask him, holding up the leather strap he wore across his waist a mere minute ago. You took the time to swipe it along with the pendant.\n\n', false );
		EngineCore.outputText( 'As Raphael bolts, he has a look of surprise on his face. He doesn\'t last long before his pants drop to his ankles and he falls flat on his face.\n\n', false );
		EngineCore.outputText( 'He yelps when he loses hold of the bag, which drops to the ground. The fox uses both hands to protect his modesty by holding up his pantaloons, slipping over the spilt gems a few good times and flailing about, before finally making it to the wall with nothing to show for it.\n\n', false );
	...
	Raphael.prototype.friskFondleChoice = function() {
		EngineCore.outputText( '', true );
		EngineCore.outputText( 'You gently massage the leathery package. It increases in size until a distinct shape of some length forms above it. When Raphael moves his hips forward appreciatively, you look up, throw him a smile and slip your hand into his pants. He\'s not wearing any underwear, you notice as you rummage about. Struggling to restrain yourself, you slip past the throbbing meat of his naked cock and dig around his jewels instead, removing the ruby from behind them.\n\n', false );
		EngineCore.outputText( '"<i>Such a good girl you are.</i>" He smirks lewdly. "<i>You have a lot of talent in those fingers. A distinct gift. There\'s a lot I could show a feisty little minx such as you.</i>"\n\n', false );
		EngineCore.outputText( 'You deftly remove the sweat stained, fogged up stones and tug them away between your breasts.\n\n', false );
		EngineCore.outputText( '"<i>And I in turn, will have to retrieve those.</i>" He growls low.\n\n', false );
	...
	Raphael.prototype.RaphaelPicnicSkill = function() {
		...
		if( CoC.flags[ kFLAGS.RAPHAEL_RAPIER_TRANING ] === 0 ) {
			...
			EngineCore.outputText( 'There\'s a moment of awkward silence as you realize the young man places more pride in his sword than you thought. However, Raphael recollects himself with a smile and chuckles at himself like he\'s been had by someone who just doesn\'t understand.\n\n', false );
			EngineCore.outputText( '"<i>No, my lady. This is a man\'s weapon in every definition of the word.</i>" He beams and picks it up, pulling the blade from the sheath with a cold iron swish. "<i>Notice how its long hard length stands tall and fierce upon a sturdy hilt designed for deep thrusts.</i>"\n\n', false );
			EngineCore.outputText( 'Holding it up, it indeed gleams sensually in the sun. However, Raphael then points it downwards and directly at you, carefully tracing the point across your outfit. You can feel the cool edge glide across. "<i>Notice the roving tip, how she searches for an opening upon a quivering body\'s wavering guard.</i>"\n\n', false );
			EngineCore.outputText( 'When Raphael places the point between your breasts, you cannot help but stare at the steely needle with fascination. Driven by long steel, the sharp tip feels heavy enough to slide into your flesh in a single thrust. The feeling is only stronger for wearing an outfit such as yours, leaving your body so acutely vulnerable against the outside world. You stand corrected; there is something very intimidating about it.\n\n', false );
			EngineCore.outputText( '"<i>Could I learn to use it?</i>" You ask Raphael, who then begins to snicker into his fist and snorts unseemly.\n\n', false );
			EngineCore.outputText( 'When you don\'t flinch and just stare at him in earnest, the fox looks up with surprise. "<i>Oh, you are serious about that?</i>" He remarks and snaps out of it by adopting the coy frown typical of the wileful fox.\n\n', false );
			EngineCore.outputText( 'When you ask him if he thinks that\'s weird, the vulpine rogue shakes his head. "<i>Not at all mademoiselle. In fact, I am of the opinion that every woman of your remarkable beauty should know how to defend herself. Perish the thought of having to relinquish your womanhood to anything other than a true gentleman, or having it ravished by beasts instead. And if you must fight, I cannot think of a weapon more suited for a woman than the rapier. I would be honored to teach you.</i>"\n\n', false );
			EngineCore.outputText( '"<i>Shall we?</i>" He jumps to his feet and extends you an arm.\n\n', false );
			EngineCore.outputText( 'When you ask him if you shouldn\'t be wearing armor instead of wafer-thin silk bodystockings, he laughs. "<i>I assure you. For the Rapier, you are dressed perfectly.</i>"\n\n', false );
		...
		if( CoC.player.spe < 30 || CoC.flags[ kFLAGS.RAPHAEL_RAPIER_TRANING ] === 0 ) {
			...
			EngineCore.outputText( '"<i>Join me my fine fae, and I will teach you to dance.</i>" He states while discarding the blade.\n\n', false );
			EngineCore.outputText( '"<i>Dance?</i>" You mumble with a smile, walking up to him and taking him by his hand.\n\n', false );
			EngineCore.outputText( '"<i>Dance!</i>" He snarls certain, wrapping his paw around your waist and pulling you close to him.\n\n', false );
			EngineCore.outputText( 'Raphael tries to lead you off into a slow tango, but obviously overestimates the amount of nimbleness you own feet possess. You quickly rectify this by tripping over his boots and stepping on his toes. Each time provokes a little yelp from the fox, who soon realizes he has his work cut out for him. Whatever Raphael is, he does not give up easy, and you soon dance the morning away on top of his tortured toes.\n\n', false );
			EngineCore.outputText( 'In the end, you\'re forced to stop practice at Raphael\'s urging, barely even developing a sense for rhythm. You\'re simply not fast enough to keep up with the fox... yet. Meanwhile the poor fox has taken off his boots and has seated himself upon a nearby boulder, where he tries to rub the feeling back into his sensitive feet. You can\'t help but smile a little at your own bungling and feel sorry for the daunting amount of time and effort Raphael needed to put into you with so little to show for it. With you in hand, the otherwise delicate dancer is slowed down into a broken mess. You are determined to try and get better at it though.\n\n', false );
			EngineCore.outputText( '"<i>I was very impressed by your earlier show.</i>" You walk over and reassure him. Raphael looks somewhat discouraged.\n\n', false );
			EngineCore.outputText( '"<i>That was the most beautiful thing I ever saw. Do you really think I could ever master that much elegance and refinement, mister fox?</i>" You chime appreciatively, running a teasing finger down his neck.\n\n', false );
		...
		//{Warning when you have 50 speed, played through all 3 variables and choose {Skill} at the opening picnic};
			...
			EngineCore.outputText( 'Regardless of the picnic\'s splendor, you are quickly drawn to Raphael\'s rapier again, having gained real feelings for the weapons during your previous sessions with it.  The fox chuckles.  <i>"My fair fae; she is a woman of taste.  She knows what she wants."</i>\n\n', false );
			EngineCore.outputText( 'The weapon is lying between you.  You stare at it, Raphael stares at you.\n\n', false );
			EngineCore.outputText( '<i>"Would you like to own it?"</i> he suddenly asks you.\n\n', false );
	...
	Raphael.prototype.fenceRaphaelSexilyPtII = function() {
		EngineCore.outputText( '', true );
		EngineCore.outputText( 'You\'re a little embarrassed at how easily the fox outdid you.  When you look up and stare him in the eyes however, Raphael is possessing of fantastic sportsmanship.\n\n', false );
		EngineCore.outputText( '<i>"My lady,"</i> the fox states delicately, <i>"that was truly magnificent.  You are a natural, I can tell."</i>\n\n', false );
		EngineCore.outputText( 'You stammer and are not so sure of that yourself, but the confidence carried in his voice quiets all self-doubt.  Maybe you were good.  Perhaps you could have beaten him in any other way, but just not yet with his weapon of choice.\n\n', false );
		EngineCore.outputText( '<i>"If your opponent had been any other person than me, then surely they would have succumbed to the sheer ferocity and fidelity of your offence."</i>  He nods reassuringly and smiles at you.  <i>"In fact, I think this might be the last of our lessons; you are now good enough to develop your style without me.  There are no more I can think of..."</i> He pauses, then the fox turns the leather tip towards you and brushes up against you.  <i>"...with the exception of perhaps one."</i>\n\n', false );
		EngineCore.outputText( 'You ask him anxiously what that lesson could be.\n\n', false );
		...
		if( CoC.player.inte > 49 ) {
			...
			EngineCore.outputText( '<i>"Some games are meant to be lost."</i>  He nuzzles you, putting his snout to your ear.  <i>"It will be... exquisite. Lose yourself, in my capable hands."</i>', false );
			EngineCore.outputText( 'Do you let him?', false );
			//[Yes] [No]);
			//yes to sex;
	...
	Raphael.prototype.declinePuttingOutForRogues = function() {
		EngineCore.outputText( '', true );
		EngineCore.outputText( '<i>"No."</i> You shake your head, dropping the atonal monosyllable as if it were the last note in a musical play.\n\n', false );
		EngineCore.outputText( 'The horny fox frowns.  It\'s like raising an invincible shield between you.  He reaches out towards your face and body, but he cannot touch anymore.\n\n', false );
		EngineCore.outputText( 'Some of the magic of the moment is still there in the fine young man leaning over your aroused body.  He could still take you right there and right now and you know you\'d probably enjoy it too.  However, it would be unseemly.  It would be to rape an equal and to Raphael, that would deprive him too of the dignity he tries so hard to maintain.  You can tell it from his face; the agonized quandary.\n\n', false );
		EngineCore.outputText( 'When he gets off your body, you\'ve won.  You\'ve caught Raphael in his own game.  You\'ve led him around.  He\'d probably do anything for it, but cannot obtain it.\n\n', false );
		EngineCore.outputText( '<i>"Fine,"</i> he mumbles.  He rolls off and sits sulking a few paces away from you.  It\'s the first time the young man fails to keep a cheerful attitude.\n\n', false );
		EngineCore.outputText( 'You smile, a bit sorry for the way you broke him, but you try to convince him that he shouldn\'t mope.  The two of you had fun.  It\'s getting late and you occupy yourself with cleaning up the picnic.\n\n', false );
	...
	Raphael.prototype.thieveryEnding = function() {
		...
		EngineCore.outputText( 'When he moves his lips forward you struggle to not meet them and instead, fall gently on your back.  Lying down below him, he concerns himself with the rest of your body first and slides in over you.  You keep a close eye on the fox as he does, letting him know he won\'t be getting away with any untoward behavior.\n\n', false );
		...
		//({When player has also reached the apex of fencing lessons;
			...
			EngineCore.outputText( 'You reach and fondle the magnificent ornament hanging off his hips. With a few nimble flicks of your fingers, you manage to get it off.\n\n', false );
		}

		EngineCore.outputText( 'Realizing you\'ve allowed yourself to be distracted, you refocus.  Raphael has his paws on your breasts and is about to kiss the top of them.  Throwing him off, you sigh, brush his hands away while raising your own towards your head.  Like this, you stretch out your upper body across the moss, and cross your hands to signify helplessness.  It presents your ' + Descriptors.breastDescript( 0 ) + ' even more invitingly, but you\'ve elegantly dispersed his efforts.  To touch them again on such short notice would be to flaw his otherwise refined lovemaking.  Instead, the fox crawls in over you completely on hands and knees and looks you in the eyes.  He realizes you\'re still very much in the game and to take you roughly on the moss instead of sweeping you off your feet would be a thing unbecoming of the refined fox.  He needs your consent to win the game.\n\n', false );
		EngineCore.outputText( 'You\'re enjoying yourself and so is Raphael, for as long as you keep the illusion up he might manage to woo his way into your pants.  He\'s so fragile right now.  You\'re almost literally holding the horny fox\'s desires and pride in the palm of your hand.  You are in complete control.\n\n', false );
		EngineCore.outputText( '<i>"I have never before met a woman of your breathtaking insight.  Of such deep beauty."</i>  He sighs at you.  <i>"My lady, I must have you,"</i> he burrs.\n\n', false );
		EngineCore.outputText( '<i>"Oh my, are you soliciting me, mister fox? Right here in the wilds, crudely upon the moss?"</i> you answer coyly.  <i>"Wouldn\'t that mean I lose the game?"</i>\n\n', false );
		EngineCore.outputText( '<i>"Some games are meant to be lost."</i>  He nuzzles you, putting his snout to your ear.  <i>"It will be... exquisite.  Lose yourself, in my capable hands."</i>\n\n', false );
	...
	Raphael.prototype.RaphaelThieverySmex = function() {
		EngineCore.outputText( '', true );
		EngineCore.outputText( 'You need no words.  You place your hand on the back of Raphael\'s neck and pull his lisping tongue closer to your ears.  After that, you lose yourself to the weight of a man atop you as the fox starts tending to your quivering body.\n\n', false );
	...
	Raphael.prototype.quiksilverFawkesEndGame = function() {
		EngineCore.outputText( '', true );
		EngineCore.outputText( 'You wake up to the sound of an ominous cry in the distance, like that of a howling wolf.  It can only mean trouble and you jump out of bed.\n\n', false );
		...
		EngineCore.outputText( 'You don\'t have the chance to respond before the sounds of snapping branches and rustling leaves near camp.  Raphael jumps up and dives into the barrel you keep in camp for the storage of water, hiding himself and leaving you to face the oncoming threats by yourself.\n\n', false );
		EngineCore.outputText( 'In the hazy distance, you spot a massive shadow rushing through the mist and it dissapears before you get a good look.  An eerie silence follows and you sharpen your eyes and hearing to the danger.  When you look up, your heart sinks as the massive shape has jumped up and now descends on you from above.  It happens so fast that you barely realize what\'s going on.  Before you know it, you\'re sent sliding across the floor with the dark shape on top of you, pinning you down to the ground with its weight.\n\n', false );
		EngineCore.outputText( '<i>"Smelled of elderberries, huh?"</i> it snarls.  <i>"And what was that about my mother?"</i> When you open your eyes again, you\'re greeted by a row of razor-sharp white teeth, set in a pitch-black face. Above them, two smoldering yellow eyes stare down on you, infuriated.\n\n', false );
		EngineCore.outputText( '<i>"Hati!"</i> an identical voice calls out from elsewhere.\n\n', false );
	...
	Raphael.prototype.coverForRaphael = function() {
		...
		EngineCore.outputText( '<i>"Cute answer,"</i> his partner remarks, taking a break from staring at the water barrel.\n\n', false );
		...
		EngineCore.outputText( '\n\n', false );
		EngineCore.outputText( '<i>"The trail is strongest over towards the meadows.  He might have gone there."</i> Hati remarks after circling your camp one more time.\n\n', false );
	...
	Raphael.prototype.coverForRaphaelII = function() {
		EngineCore.outputText( '', true );
		EngineCore.outputText( 'It doesn\'t take more than a minute for Raphael to make use of the wolves\' departure.  Not even bothering to climb out with dignity, he tips the barrel over as he rushes out of the water.  Like a drowned cat, he climbs out coughing and gasping for air on all fours.\n\n', false );
		EngineCore.outputText( 'He hasn\'t lost his ways however.  The first words out of him are as suave and composed as ever.\n\n', false );
		EngineCore.outputText( '<i>"Merci, mademoiselle,"</i> he wheezes softly.  <i>"You have whisked me away from the snatches of great injustice, as well as a fair share of humiliation.  Normally I am capable of outrunning them myself, but it seems that faith has blessed me with a guardian angel on the day I find myself less capable."</i>\n\n', false );
		EngineCore.outputText( 'You\'re upset towards him for asking you to lie to law enforcement, but Raphael\'s current state keeps you from being too furious.  He\'s not so bushy anymore.  His soaked hair falls flat against his body and causes him to lose quite a bit of his imposing physique. Strands of it run across his face. You spend a little time yelling at him, though.\n\n', false );
		EngineCore.outputText( '<i>"No.  It is nothing like that,"</i> he splutters, in response to one of your rants.  <i>"We go way back.  The wolves and Urta, they carry out a personal vendatta against me that has no bearing on the law."</i>\n\n', false );
		EngineCore.outputText( 'You spend some time considering the dubiosity of this revelation.\n\n', false );
		EngineCore.outputText( '<i>"Please, señorita."</i>  He manages to rise to one knee.  <i>"Is this the face of a hardened criminal?"</i>  He looks up and into your eyes with his own brilliant green ones.  He\'s still a mess, hair disheveled and his features weather-beaten, but he\'ll dry up again eventually, to be dashing once again.  <i>"Since when have I treated you anything less than courteously?  A handful of gems, certainly, yes, but do I deserve such police brutality because of that?  Do I deserve to be hunted down in the forests and carried through the streets in chains?  Just because my antics leave the world with a smile?"</i>\n\n', false );
		EngineCore.outputText( 'Before you manage to answer him, Raphael rushes back to his usual spot on the small crumbled wall on the outskirts of the camp proper.  Not as quick as previously, tired and weary perhaps, but still quite fast.  He doesn\'t seem so intimidating without his clothes on.  Knowing shame, unlike the wolves, the young man even covers his privates with a leg bent sideways.\n\n', false );
