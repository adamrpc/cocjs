...
angular.module( 'cocjs' ).run( function( MainView, SceneLib, Ceraph, ConsumableLib, Appearance, ArmorLib, PregnancyStore, CockTypesEnum, Descriptors, AppearanceDefs, CoC, kFLAGS, Utils, StatusAffects, EngineCore ) {
	...
	CeraphScene.prototype.maleFuckCeraphsPussy = function() {
		...
		if( CoC.player.cockArea( 0 ) <= CoC.monster.vaginalCapacity() ) {
			...
			if( CoC.monster.lust > 99 ) {
				MainView.outputText( 'Ignoring her squeals of pleasure, you force Ceraph onto her back, oogling her perky breasts, indecent cock, and soaked cunt.  She looks up at you hungrily, and you have the feeling that on some level you\'re still giving her what she wants.  Mindful of her demonic wiles, you pull her hands together and use a few tattered strips of cloth to bind them over her head.  Moaning with helpless desire, the demon grinds her crotch against your ' + CoC.player.leg() + ', spreading her thighs apart into a near split and giving you a world-class view of her juicy purple cunt.\n\n', false );
			}
			//[hp];
			else {
				MainView.outputText( 'Ignoring her grunts of pain, you force Ceraph onto her back, oogling her perky breasts, limp cock, and hairless cunt.  She looks up at you with disdain, growling at you from the back of her throat.  Wary of the demon\'s abilities, you tie up her hands with a few tattered strips of cloth.  She seems to like it, judging by her tenting erection and now-glistening gash.  The slut even goes so far as to begin grinding her crotch against you, spreading her thighs wider and wider as she gets off on being restrained.  You\'re given a perfect view of her enticing purple cunt.\n\n', false );
			}
			MainView.outputText( 'Ceraph licks her lips and gazes up at you, begging with a voice that drips with seductive intent, "<i>Please don\'t rape me, champion!  Don\'t tie me down and rape me like a helpless village-girl!</i>"\n\n', false );
			if( CoC.player.cor < 33 ) {
				MainView.outputText( 'Her words shame you.  Have you really sunk this low?  You wonder just how much this world has already corrupted you as you ready yourself to rape a sex-demon.', false );
			} else if( CoC.player.cor < 66 ) {
				MainView.outputText( 'Her words confuse you.  You never would\'ve done this when you first came here, but you\'re horny and you know demons don\'t really mind.', false );
			} else {
				MainView.outputText( 'Her dishonest words anger you, and you slap her in the face.  Both of you know that she wants this almost as much as she wanted to rape you, and any pretense at disliking this act is a deceitful sham.', false );
			}
			MainView.outputText( '  It\'s too late for her to have any hope of swaying you anyway.  You strip off your ' + CoC.player.armorName + ' ', false );
			if( CoC.flags[ kFLAGS.PC_FETISH ] >= 1 ) {
				MainView.outputText( 'getting an exhibitionist thrill ', false );
			}
			MainView.outputText( 'and begin stroking ', false );
			if( CoC.player.totalCocks() > 1 ) {
				MainView.outputText( 'each of ', false );
			}
			MainView.outputText( 'your stiff ' + Descriptors.multiCockDescriptLight() + ', preparing to penetrate her.\n\n', false );
			MainView.outputText( 'Ceraph squirms in the dirt as you bring your ' + Descriptors.cockDescript( 0 ) + ' closer and closer to her female hole, her cock twitching with need like some kind of perverse, mutant clit.  Her hips twitch at you, as if eager to devour your maleness.  You don\'t keep her waiting, ', false );
			if( CoC.player.cockArea( 0 ) < 40 ) {
				MainView.outputText( 'and with a forceful thrust, you sheath yourself inside the demon\'s unholy pussy', false );
			} else {
				MainView.outputText( 'and with a mighty effort, you force your over-sized cock inside her.  For a moment all you can do is stare in awe as it distorts her body – the fact that such a thing is possible puzzles you', false );
			}
			MainView.outputText( '.  Her interior is inhumanly hot and covered with thousands of slippery protrusions, each rubbing against your dick\'s flesh.  The orgy of sensation is incredible, and you immediately begin fucking your bound, demonic captive as the need to orgasm rises within you.\n\n', false );
			MainView.outputText( 'The defeated omnibus mewls in mock protest, "<i>Oh, don\'t cum in my demonic twat, dear champion!  If you do, you\'ll never want any other pussy ever again!</i>"\n\n', false );
			MainView.outputText( 'You grunt, pounding her harder and faster than before, knowing you couldn\'t pull out of her vise-like pleasure-hole if you wanted to.  It feels too good to hold out or resist, and you drop down, adjusting your angle as you rape the beautiful omnibus.  You\'re grunting like an animal, humping her as fast as your body will let you, but she lies under you with a serene and enticing expression, as if she\'s greatly enjoying the situation and awaiting your orgasm.  You pinch her nipple roughly, irritated by her superior air, but it only makes her wriggling pussy get even wetter.  It clamps down on you, wringing your ' + Descriptors.cockDescript( 0 ) + ' dry as it erupts in a powerful orgasm.\n\n', false );
			MainView.outputText( 'Ceraph squeals happily, her sultry visage fracturing into an uninhibited expression of pleasure as she cries, "<i>Fill me with your seed, champion!  Dominate the demon with your mighty spear!</i>"\n\n', false );
			MainView.outputText( 'Her purple-hued pussy spasms around you, its oddly textured interior rippling and sucking in time with your ejaculations, drinking down your cum.  Ceraph squirms happily while her body absorbs your jizz with her impossibly pleasurable hole.', false );
			if( CoC.player.cumQ() >= 500 && CoC.player.cumQ() < 1000 ) {
				MainView.outputText( '  Her belly begins to rise with the volume of cum she\'s absorbed, and you finish your orgasm with a mildly pregnant demon underneath you.', false );
			} else if( CoC.player.cumQ() >= 1000 ) {
				MainView.outputText( '  Her belly rises quickly from the volume of cum you\'re pumping into her, swelling up until she looks ready to give birth, but her taut purple body seems to handle the strain quite well, save for her belly-button turning into an outtie with an abrupt \'pop\'.', false );
			}
			MainView.outputText( '  The omnibus\' nubby shaft twitches happily and squirts out tiny dribbles of demon-semen, too left out by the sex to achieve a truly enjoyable orgasm, but more than willing to leak cum.\n\n', false );
			MainView.outputText( 'Ceraph exhales with exhaustion and rubs her hands over her belly, cooing, "<i>So, you really did give up all your semen to me.  I guess I\'ll have to name the first imp I birth from this after you, won\'t I?</i>"\n\n', false );
			if( CoC.player.cor < 33 ) {
				MainView.outputText( 'You groan, just wishing she would stop reminding you of the consequences of this little tryst.  In a hurry to leave the demon behind, you get dressed and take off for camp.\n\n', false );
			} else if( CoC.player.cor < 66 ) {
				MainView.outputText( 'You groan, wondering why she just won\'t get over her little act.  Even though this wasn\'t your best idea, it isn\'t nearly as bad as she makes it out to be.  You get dressed and leave, eager to be rid of her.\n\n', false );
			} else {
				MainView.outputText( 'You bend over, rub her belly softly and whisper into her ear, "<i>I\'ll be sure to spit him on my cock first chance I get, dear.</i>"\n\n', false );
			}
			MainView.outputText( 'As you leave, you don\'t bother to spare a glance at the confused omnibus.  She isn\'t worth your time.', false );
		} else {
			...
			MainView.outputText( 'your stiff ' + Descriptors.multiCockDescriptLight() + ', preparing to penetrate her.\n\n', false );
			MainView.outputText( 'The ' + CoC.player.cockHead() + ' of your ' + Descriptors.cockDescript( 0 ) + ' squishes flat against her twat, too big for her prodigious demon-cunt to swallow.  Spurred by frustrated desires, you lift her legs and wrap her girlcum-slicked thighs about your ', false );
			if( CoC.player.cockTotal() > 1 ) {
				MainView.outputText( 'primary ', false );
			}
			MainView.outputText( Descriptors.cockDescript( 0 ) + '. Ceraph\'s smooth skin and soft thigh-flesh form a comfortably tight masturbation tube.  Starting slowly, you begin rocking back and forth, sawing your prodigious cock-flesh over her body.  The demoness swivels her hips underneath your ' + Descriptors.cockDescript( 0 ) + ', her slippery gash and near-crushed member feverishly rubbing into you.  Though you didn\'t get to truly violate her, her thighs and unblemished skin are more than good enough to bring you to the brink of orgasm.\n\n', false );
			MainView.outputText( 'The defeated omnibus wraps her arms around your ' + Descriptors.cockDescript( 0 ) + ' and whines lustily, "<i>No, please!  You\'ll cover me in seed and despoil my face!  Please don\'t glaze me in that awful stuff!</i>"\n\n', false );
			MainView.outputText( 'You grunt, hold the captive by her ankles, and use her like a disposable sex-toy.  The slap of your ' + Descriptors.hipDescript() + ' slapping into her thighs echoes loudly, nearly drowning out the wet squishing of your ' + Descriptors.cockDescript( 0 ) + ' with each violent brush against her cuntlips.  ', false );
			if( CoC.player.cocks[ 0 ].cockLength < 18 ) {
				MainView.outputText( 'Your ' + CoC.player.cockHead() + ' crests between her breasts with every stroke, bumping against her chin.  It grows larger as the pleasure of the act intensifies to orgasmic levels.\n\n', false );
			} else if( CoC.player.cocks[ 0 ].cockLength < 24 ) {
				MainView.outputText( 'Your ' + CoC.player.cockHead() + ' slides over her cheek with every stroke, leaving a trail of pre-cum on her face.  The smudges of glistening pre grow larger and larger as the pleasure of the act nears orgasmic levels.\n\n', false );
			} else {
				MainView.outputText( 'Your ' + Descriptors.cockDescript( 0 ) + ' slides over her face with every stroke, smearing the demon\'s hair with your thick pre-seed before you pull back and dribble it on her face.  The pleasure of the act is incredible, and you feel yourself getting harder as the sensation nears orgasmic levels.\n\n', false );
			}

			MainView.outputText( 'Ceraph squeals and blubbers incoherently for a moment as she cums, eventually managing to scream out, "<i>Yes, splatter me with seed!  Punish this lowly demon with your powerful spunk.  Dominaaaaate meeee~</i>"\n\n', false );
			MainView.outputText( 'Underneath your own mammoth erection, you can feel Ceraph\'s smaller cock twisting and squirming, unloading its own hot fluids onto her sweat-slicked belly.  She wriggles and twitches under you, her thigh muscles clenching and releasing in time with her spurts as they push you beyond your limit.  You watch your ' + Descriptors.cockDescript( 0 ) + ' as it strains and squirts, dumping your thick load into the demon\'s ', false );
			if( CoC.player.cocks[ 0 ].cockLength < 18 ) {
				MainView.outputText( 'tits', false );
			} else if( CoC.player.cocks[ 0 ].cockLength < 24 ) {
				MainView.outputText( 'face', false );
			} else {
				MainView.outputText( 'long hair', false );
			}
			MainView.outputText( '.  The orgasming demonette continues to squirt underneath you, drenching and smearing herself with even more cum and her entire mid-section looks glazed in thick whitish goo.', false );
			if( CoC.player.cumQ() >= 1000 ) {
				MainView.outputText( '  Your prodigious fertility quickly forms a puddle around her, leaving the deceptive seductress practically submerged in cum.', false );
			}
			MainView.outputText( '\n\n', false );
			MainView.outputText( 'You sigh, feeling immense relief, and remove your softening bulk from atop her form.  Ceraph exhales in exhaustion and smears the mixture of cum over her belly, cooing, "<i>So you really did give me a huge load.  I\'ll be sure to scoop a few batches of it into my womb so we can have lots of imps together.</i>"\n\n', false );
			if( CoC.player.cor < 33 ) {
				MainView.outputText( 'You groan, just wishing she would stop reminding you of the consequences of this little tryst.  In a hurry to leave the demon behind, you get dressed and take off for camp.\n\n', false );
			} else if( CoC.player.cor < 66 ) {
				MainView.outputText( 'You groan, wondering why she just won\'t get over her little act.  Even though this wasn\'t your best idea, it isn\'t nearly as bad as she makes it out to be.  You get dressed and leave, eager to be rid of her.\n\n', false );
			} else {
				MainView.outputText( 'You bend over, rub her belly softly and whisper into her ear, "<i>I\'ll be sure to spit them on my cock first chance I get, dear.</i>"\n\n', false );
			}
	...
	CeraphScene.prototype.rideCeraphsCockLikeaBAWSSexclamation11eleven = function() {
		...
		MainView.outputText( 'Ceraph licks her lips and gazes up at you, begging with a voice that drips with seductive intent, "<i>Please don\'t rape me!  I took a vow of chastity!</i>"\n\n', false );
		if( CoC.player.cor < 33 ) {
			MainView.outputText( 'Her words shame you.  Have you really sunk this low?  You wonder just how much this world has already corrupted you as you ready yourself to get off on a sex-demon\'s tool.', false );
		} else if( CoC.player.cor < 66 ) {
			MainView.outputText( 'Her words confuse you.  You never would\'ve done this when you first came here, but you\'re horny and you know demons don\'t really mind.', false );
		} else {
			MainView.outputText( 'Her dishonest words anger you, and you slap her in the face.  Both of you know that she wants this almost as much as she wanted to rape you, and any pretense at disliking this act is a deceitful sham.', false );
		...
		MainView.outputText( 'and begin touching your ' + Descriptors.vaginaDescript( 0 ) + ', getting yourself ready for what is to come.\n\n', false );
		MainView.outputText( 'You sink down, feeling yourself part around the hot demon-tool, its ring of crown-nubs stroking your walls as you slide down, and the bumpy texture of its shaft makes your ' + CoC.player.legs() + ' feel weak.  You drop the rest of the way down in one smooth, wet slide, ' );
		if( CoC.player.vaginalCapacity() < 12 ) {
			MainView.outputText( 'unable to take the entire exquisite cock inside you.  The nubs squirm and wiggle, practically vibrating and massaging your internal muscles, and you\'re unable to stop yourself from bouncing on top of her, spearing yourself repeatedly upon the thick rod.\n\n', false );
		} else {
			MainView.outputText( 'able to take the entire exquisite cock inside you.  The nubs squirm and wiggle, practically vibrating and massaging your internal muscles, and you\'re unable to stop yourself from bouncing on top of her, spearing yourself repeatedly upon the thick rod.\n\n', false );
		}

		MainView.outputText( 'Ceraph cries in mock protest, "<i>No, don\'t make me cum inside you!  Please Champion, I swore not to spill my seed, lest I father a bastard child!</i>"\n\n', false );
		...
		MainView.outputText( 'squish against hers, squeezing a gout of milk from her nipples.  Both pairs of ', false );
		if( CoC.player.biggestTitSize() < 1 ) {
			MainView.outputText( 'nipples', false );
		} else {
			MainView.outputText( 'jiggling mounds', false );
		}
		MainView.outputText( ' feel wonderful as they\'re pressed between you, sliding back and forth in time with your body\'s urgent grinding.\n\n', false );
		MainView.outputText( 'The omnibus\' facade of feigned innocence drops under the force of the hot, wet fuck.  Her mouth opens into an \'o\' of pleasure, and you feel her rod thicken as it begins pumping the proof of her ecstasy inside you.  The nodules that cover Ceraph\'s demonic erection wildly vibrate as she orgasms, throwing you over the edge and into the midst of a body-shaking orgasm.  Demon-seed floods your womb, squeezed inside it by your body\'s orgasmic contractions.  You shudder with the demon as you both begin calming down.\n\n', false );
		MainView.outputText( 'She groans, "<i>Ooooh... Champion why did you make me despoil your womb?  ', false );
		if( CoC.player.pregnancyIncubation === 0 ) {
			MainView.outputText( 'You\'re only feeding the swarms of imps that are despoiling this land.', false );
		} else {
			MainView.outputText( 'I\'m sure whatever baby you have in there won\'t enjoy being so soaked in corruption.', false );
		}
		...
		if( CoC.player.cor < 33 ) {
			...
			MainView.outputText( 'You bend over and rub your belly while whispering in her ear, "<i>Like mother, like child.</i>"\n\n', false );
		}
		MainView.outputText( 'As you leave, you don\'t bother to spare a glance at the confused omnibus; she isn\'t worth your time.\n\n', false );
	...
	CeraphScene.prototype.loseToCeraphAndGetPiercingsInEarsOrSomethingSomehow = function() {
		...
		if( CoC.player.HP < 1 ) {
			...
			MainView.outputText( 'lust-consumed ', false );
		}
		MainView.outputText( 'form, whispering calmly as she pulls a pair of gleaming, green piercings from a pouch, "<i>Oh, don\'t worry baby, you\'re going to love this so much.  These piercings are special, and they\'ll help you learn to enjoy the things I\'m going to teach you.</i>"\n\n', false );
		if( CoC.player.earsPierced > 0 ) {
			MainView.outputText( 'With a dismissive gesture, Ceraph murmurs words of dark magic and the piercings in your ears drop to the ground, leaving behind smooth, unbroken flesh.  ', false );
		}
		//(BUSINESS AS USUAL GENTLEMEN);
		MainView.outputText( 'The demon places a hand on your forehead and rubs your temples.  Strength drains from your body with every touch, until you\'re left helpless and paralyzed.  She snaps an earring into your left ear, and dizziness washes over you.  A moment later she\'s piercing the other side, and the now-familiar vertigo that accompanies it seems to come and go quicker than before.  You hope she doesn\'t take your ' + CoC.player.armorName + ' while you\'re paralyzed, leaving you to roam the realm totally exposed.  Confusion and waves of new desire battle in your mind as you try to come to grips with the odd thought.\n\n', false );
		...
		MainView.outputText( 'Judging by how hot the idea is getting you, Ceraph is right – <b>whether you like it or not, you\'re an exhibitionist now.</b>', false );
	...
	CeraphScene.prototype.loseToCeraphAnGetPierced2 = function() {
		...
		MainView.outputText( '-nipples and you tell me all about your fetishes and which one makes you the hottest.  OK?</i>"\n\n', false );
		//If already pierced;
		if( CoC.player.nipplesPierced > 0 ) {
			MainView.outputText( 'With a dismissive gesture, Ceraph murmurs words of dark magic, and the piercings in your nipples drop to the ground, leaving behind smooth, unbroken flesh.  ', false );
		}
		//Business as usual!;
		MainView.outputText( 'The demon doesn\'t give you a chance to reply, instead she focuses on aligning the business ends of the piercings with your sensitive nipple-flesh.  Your right ' + Descriptors.nippleDescript( 0 ) + ' is pierced in one smooth motion, nearly making you scream in pain.  As she fastens it on, you feel goosebumps spread over your body in a wave.  The second piercing doesn\'t seem to hurt as bad, but the sensation of spreading goosebumps is far more noticeable.  Your eyes dart wildly, afraid at what new kind of fetish Ceraph has forced upon you.\n\n', false );
		MainView.outputText( 'She smiles down at you and teases, "<i>Still haven\'t figured it out?  I\'ll give you a hint being paralyzed nearly the same as being tied down?</i>"\n\n', false );
		MainView.outputText( 'Your body goes beet-red as it suddenly tries to struggle against her invisible restraints.  It really is!  You nearly cry as the restraint turns you on more and more.  Ceraph\'s cursed piercings have given you a fetish for being restrained.  You nearly faint when you think of the tentacle monsters, and you know you have no hope of resisting if they ever bind you up.  <b>Somehow you\'ll have to get used to being a bondage fetishist...</b>', false );
		EngineCore.dynStats( 'lus', 25, 'cor', 5 );
	...
	CeraphScene.prototype.agreeToBecomeCeraphsFuckpetBondageToyBitchSlut = function() {
		...
		if( CoC.player.hasVagina() ) {
			...
			MainView.outputText( '  Your ' + Descriptors.cockDescript( 0 ) + ' grows rock hard as you wonder if she\'ll give you a Jacob\'s ladder full of new fetishes and thoughts.', false );
		} else {
			MainView.outputText( '  Your body hums with arousal as you wonder if she\'ll give you a cock and cunt, pierce them both, and fill you with new fetishes and sexy submissive thoughts.', false );
		}
	...
	CeraphScene.prototype.yesOHGODYESPIERCELEVEL3 = function() {
		...
		if( CoC.player.cockTotal() > 0 ) {
			...
			MainView.outputText( ' and snaps the diamond stud through your sensitive flesh, making your vision haze red in pain.', false );
			CoC.player.cocks[ 0 ].pierced = 1;
		...
		//[cunts];
			...
			MainView.outputText( ' and gets ahold of the flesh around the base of your ' + Descriptors.clitDescript() + '.  With practiced ease, she snaps the piercing closed, attaching the diamond stud to you while the pain fuzzes your vision red.', false );
			CoC.player.vaginas[ 0 ].clitPierced = 1;
			CoC.player.vaginas[ 0 ].clitPShort = 'seamless, diamond clit-stud';
			CoC.player.vaginas[ 0 ].clitPLong = 'seamless, diamond clit-stud';
		} else {
			MainView.outputText( 'gives you a mildly annoyed look before she snaps the diamond stud into your eye-brow, piercing it.  ', false );
			if( CoC.player.eyebrowPierced > 0 ) {
				MainView.outputText( 'She discards your old jewelry like a piece of garbage.  ', false );
			}
			MainView.outputText( 'It hurts more than it ought to, fuzzing your vision red.', false );
			CoC.player.eyebrowPierced = 1;
		...
		MainView.outputText( '"<i>So, I take it you like it?  You\'ll never be able to raise a hand in anger again.  I guess if you want to win fights you\'ll have to tease your foes into submission with that luscious body.  I suppose that might be hard to do when you\'re getting off on exposing yourself and cumming from the thought of being tied down,</i>" she laughs.\n\n', false );
		MainView.outputText( 'You tremble with barely restrained lust as the demoness flounces away.  You\'d pursue her, but between her ideas and exposing your crotch to the entire area, you need to cum more than anything in the world.  You scurry back to camp, too horny to think straight and your new piercing aching just enough to keep you from forgetting about it.', false );
		CoC.flags[ kFLAGS.PC_FETISH ] = 3;
		EngineCore.doNext( SceneLib.camp, SceneLib.camp.returnToCampUseOneHour );
	};
	...
	CeraphScene.prototype.encounterCeraph = function() {
		...
		//If fetished level 1;
		if( CoC.flags[ kFLAGS.PC_FETISH ] === 1 ) {
			MainView.outputText( 'Though you spend an hour exploring, you don\'t find anything of note.', true );
			return;
		}
		//fetished level 2;
	...
	CeraphScene.prototype.winRapeChoices = function() {
		...
		if( CoC.monster.HP < 1 ) {
			...
			MainView.outputText( 'Ceraph masturbates futilely, too driven by desire to fight.', false );
		}
		if( CoC.player.lust >= 33 && CoC.player.gender > 0 ) {
			MainView.outputText( '  Do you have your way with her? (And if so, which of your body parts do you do it with?)', false );
			var dicking = null;
	...
	CeraphScene.prototype.ceraphRapesYouBADDAWGYODIGGITY = function() {
		...
		if( CoC.player.totalCocks() > 0 ) {
			...
			MainView.outputText( 'our ' + Descriptors.multiCockDescript() + ' is twitching and dripping pre-cum, on the edge of orgasm.  ', false );
		}
		if( CoC.player.hasVagina() ) {
			MainView.outputText( 'Your ' + Descriptors.vaginaDescript( 0 ) + ' twitches, aching with the desire to be touched or filled, and your hips twitch lewdly, desperate for sensation.  ', false );
		}
		MainView.outputText( 'The perverse sexuality fills you with need, but Ceraph only smirks and puts her foot against your cheek, shoving your face into the sex-fluid-filled mud.  She mutters, "<i>It looks like you managed to save a few brain-cells this time slut.  Because you\'ve been so disobedient you don\'t get to cum with me.  You can lay here and ache for sex for a few hours I think.</i>"\n\n', false );
	...
	CeraphScene.prototype.hugeCorruptionForceFuckCeraph = function() {
		...
		if( CoC.monster.HP < 1 ) {
			MainView.outputText( 'beaten, prone', false );
		} else {
			MainView.outputText( 'prone, masturbating', false );
		}
		MainView.outputText( ' form, "<i>You fucking demons are all the same.  That smug superiority complex makes you forget that being a demon doesn\'t come with an invincibility clause.</i>"\n\n', false );
		MainView.outputText( 'The hermaphrodite dominatrix frigs her dripping slit, getting off on the dominance in your words, but she still manages to snarl defiantly, "<i>F-uuuck off.  Just... rape me or whatever and get it over with.</i>"\n\n', false );
		MainView.outputText( 'She\'s quite the sore loser!  You drop your ' + CoC.player.armorName + ' on the ground and stroke your ', false );
		if( CoC.player.cockTotal() > 1 ) {
			MainView.outputText( 'largest ', false );
		}
		MainView.outputText( Descriptors.cockDescript( x ) + ', feeling the blood pump into it.  The thick, penile flesh inflates to the ludicrous size it adopts every time you get hard.  Ceraph\'s eyes widen into dinner plate-sized saucers of shock as she beholds the behemoth that sprouts from your loins.  She actually tries to scrabble away in the dirt, but she fails miserably.  ', false );
		if( CoC.monster.HP < 1 ) {
			MainView.outputText( 'Her hands are too busy starting to pump away at her nodule-covered demon-dick to help her crawl away.', false );
		} else {
			MainView.outputText( 'Both her hands are too busy at her groin to help her escape.', false );
		}
		MainView.outputText( '\n\n', false );
		MainView.outputText( 'You drop the swollen mass of dick-flesh on top her, pinning her under the weight of your lust.  Ceraph gasps in shock and pain, but her hard nipples are pressing tightly into your ' + Descriptors.cockDescript( x ) + '\'s underside.  The slut is loving it – could she secretly be a submissive?  It doesn\'t matter one way or the other; this demon is going to pay.  You shimmy back, dragging the elephantine fuck-stick over the defeated demon\'s body until the bloated tip is resting on her purplish demon-snatch.  She screams, "<i>OH FUCK NO!  That would kill me!  Please, don\'t!</i>"\n\n', false );
		MainView.outputText( 'Please?  She said the magic words.  ', false );
		if( CoC.player.statusAffectv1( StatusAffects.Exgartuan ) === 1 ) {
			MainView.outputText( 'You pat your ' + Descriptors.cockDescript( x ) + ' and say, "<i>A little help please, Exgartuan?</i>"  ', false );
		} else {
			MainView.outputText( 'You blink your eyes closed and focus your corruptive powers in your crotch.  ', false );
		}
		MainView.outputText( 'Pleasure blooms in your midsection, spreading through your over-sized prick until it begins to dribble from the tip in the form of black ooze.  The viscous, dark substance splashes into Ceraph\'s demonic cunt, wicking into her drippy hole in an instant.  She moans, probably getting off on the influx of perverse magic.  The effect is immediate and gravity is able to pull your tip into her unassisted.  The demon\'s corrupted cunt starts to stretch around you, and you haven\'t even started to push!\n\n', false );
		MainView.outputText( 'The flawless skin of her thighs slips through your fingers before you get a grip on her legs, just below the knees.  Ceraph is alternatively moaning and begging, "<i>Wha-what are you doing to meeee?  Stop... please... don\'t... push it in!  Oh by the Queen, it\'s good... it shouldn\'t feel goooooood...</i>"\n\n', false );
		MainView.outputText( 'She doesn\'t seem to mind receiving it at all.  You push forwards into the clenching tightness of a demon\'s pussy and groan with delight at the feeling of her tight walls clamping down on you.  The once-dominatrix\'s belly visibly distorts, mirroring the shape of your member as her cunt expands to handle you.  Her curvy hips visibly shift, spreading apart as Ceraph\'s body bends to your will.  Your ' + CoC.player.cockHead( x ) + ' hits a token block of resistance, but a quick spurt of black, transformative cum dilates her cervix to allows you to pass through. The demonic love canal continues to widen in order to accept the gift of your ' + Descriptors.cockDescript( x ) + ' and you have an easy time pushing the distortion past her belly button to just below her large, firm breasts.\n\n', false );
		MainView.outputText( 'Even with your dark magic twisting her body, it doesn\'t look like Ceraph\'s body can take any more.  Her mind sure as hell can\'t; her eyes are rolled most of the way back and she\'s panting pornographic nonsense, "<i>Fuck.. ahh... pussy-cock... oooh... so... big... more... cum-sleeve...</i>"  You\'re a bit disappointed that you\'ve broken her already, but it quickly fades when you feel her body sucking more of you inside her.  It might be her inherent magic falling under your influence, or maybe her fractured personality has decided to assist you in fully penetrating her.  Whatever the case, a cylindrical bulge forms between her tits, mirroring every vein of your ' + Descriptors.cockDescript( x ) + ' through her skin.\n\n', false );
		MainView.outputText( 'Ceraph\'s throat balloons out to handle your girth, just in time for her to suck you further inside.  You aren\'t even pushing forwards at this point; her entire body feels like the inside of a succubus\' cunt, entirely focused on pleasing male organs.  Her babbles cut off into pleased gurgles, and then die down entirely.  You aren\'t sure how she\'s breathing, but her jaw unhinges and stretches obscenely.  You can actually see your tainted pre-cum spilling out from between her lips to run down her face, and then your cunt-slicked tip is tasting the air.', false );
		if( CoC.player.cocks[ x ].cockLength < 68 ) {
			MainView.outputText( '  It\'s impossible!  You aren\'t long enough for that.  Her body must have shrunk itself to a more appropriate length...', false );
		}
		MainView.outputText( '\n\n', false );
		MainView.outputText( 'As you\'re squeezed and massaged by ', false );
		if( CoC.player.cocks[ x ].cockLength < 68 ) {
			MainView.outputText( Utils.num2Text( Math.ceil( CoC.player.cocks[ x ].cockLength / 12 ) ), false );
		} else {
			MainView.outputText( 'six', false );
		}
		MainView.outputText( ' feet of love-tunnel, you struggle not to blow your load.  ', false );
		if( CoC.player.cocks[ x ].cockLength > 84 ) {
			MainView.outputText( 'You\'ve still got a lot more dick to get wet, and you start pushing the rest through her, using her like a plus-sized, organic onahole.  ', false );
		} else {
			MainView.outputText( 'You sigh happily, rubbing your ', false );
			if( !CoC.player.hasSheath() ) {
				MainView.outputText( 'groin', false );
			} else {
				MainView.outputText( 'sheath', false );
			}
			MainView.outputText( ' against her slippery, split slit, before you pull back and start fucking her like a plus-sized, organic onahole.  ', false );
		}
		MainView.outputText( 'The once-formidable demon sighs happily each time you pull back out of her throat, and the obscene \'schlick\' her cunt makes as you penetrate it is auditory heaven.  You slap her tits and watch them jiggle, but the absurd eroticism of it all overwhelms even your perverse standards.  Ceraph slides down, bottoming out on you while her full-body cunt convulses with orgasm.  ', false );
		if( CoC.player.cumQ() < 100 ) {
			MainView.outputText( 'You squirt your load into the dirt, but some rolls back along the underside of your urethra, catches on Ceraph\'s upper lip, and drips up her cheek into her tangled hair.', false );
		} else if( CoC.player.cumQ() < 1000 ) {
			MainView.outputText( 'You squirt your copious cum everywhere, splattering the dirt and dripping white goo onto Ceraph\'s face, forehead, and hair.  By the time you finish she\'s got a nice glaze going on.', false );
		} else {
			MainView.outputText( 'You expel huge waves of seed in what can only be described as eruptions.  They splatter into the dirt, forming thick puddles that are joined together with each successful splash of goo.  In between blasts, a steady stream leaks from the tip, travels down the underside, and catches on Ceraph\'s lip.  The spunk-flow is pulled over her face and into her hair by gravity.  She\'s glazed white and dripping into a puddle by the time you finish.', false );
		}
		MainView.outputText( '\n\n', false );
		MainView.outputText( 'You push the used fuck-toy off your ' + Descriptors.cockDescript( 0 ), false );
		if( CoC.player.cockTotal() === 2 ) {
			MainView.outputText( ' and marvel at the cum your other cock dumped into the puddle', false );
		} else if( CoC.player.cockTotal() > 2 ) {
			MainView.outputText( ' and marvel at the cum your other cocks dumped into the puddle', false );
		}
		MainView.outputText( '.  Ceraph\'s pussy gapes at least ' + Utils.num2Text( Math.ceil( CoC.player.cocks[ x ].cockThickness + 1 ) ) + ' inches wide, pushing her hips so far apart as to make it difficult to walk.  She shudders, drooling spit, pussy-juice, and sperm as her mouth, neck, and chest tighten up.  Her lower body doesn\'t change one iota; your magics are still overpowering her natural abilities below the waist.  The abused dom twitches a few more times before her eyes reappear and she pulls her tongue back into her mouth.\n\n', false );
		MainView.outputText( 'Ceraph gasps, "<i>Ohhhhkay.  That felt goooooooood.</i>"  She gathers some of your sperm from her space and swallows it with a smile before she offers, "<i>You\'ve shown me a good time, mortal.', false );
		if( !CoC.isInCombat() ) {
		...
		MainView.outputText( '  That\'s rarer than you know, so I\'m feeling a little generous.  ', false );
		if( CoC.flags[ kFLAGS.PC_FETISH ] > 0 ) {
			MainView.outputText( 'I\'ll remove some of my magic from you if you want, and I\'ll even let you keep the piercing.  Would you like that?', false );
		} else {
			MainView.outputText( 'I\'d be willing to give you a few extra gems to keep you motivated to do something like this again.  I LIKE surprises. How about it?', false );
		}
		MainView.outputText( '</i>"\n\n', false );
		if( CoC.player.statusAffectv1( StatusAffects.Exgartuan ) === 1 ) {
			MainView.outputText( 'Exgartuan mumbles, "<i>Yeah I love me too.  Now while you two bitches kiss and make up, I\'m gonna take a nap.</i>"\n\n', false );
	...
	CeraphScene.prototype.ceraphsNiceOffer = function() {
		...
		if( CoC.flags[ kFLAGS.PC_FETISH ] > 0 ) {
			...
			if( CoC.flags[ kFLAGS.PC_FETISH ] === 1 ) {
				MainView.outputText( 'your exhibitionism is gone!', false );
			} else if( CoC.flags[ kFLAGS.PC_FETISH ] === 2 ) {
				MainView.outputText( 'your bondage fetish is gone!', false );
			} else {
				MainView.outputText( 'your pacifism is gone!', false );
			}
			CoC.flags[ kFLAGS.PC_FETISH ]--;
		} else {
			MainView.outputText( 'Ceraph shakes some of the jism out of her hair and reaches under the tangled mass.  Her hand comes out with a small pouch of gems, and she tosses them to you.  You open it up and are surprised to find 10 gems inside.', false );
			CoC.player.gems += 10;
		}
	...
	CeraphScene.prototype.friendlyNeighborhoodSpiderManCeraph = function() {
		...
		if( CoC.player.cor > 66 ) {
			...
			MainView.outputText( 'and you squirm and writhe within your ' + CoC.player.armorName + ', the material itching on your skin.  Ultimately, you manage to resist.', false );
		} else {
			MainView.outputText( 'and you stifle a laugh at the ridiculous thought, ignoring your fingers while they scratch at the itch under your gear.', false );
		}
		MainView.outputText( '  Your ', false );
		if( CoC.player.skinType <= AppearanceDefs.SKIN_TYPE_FUR ) {
			MainView.outputText( 'skin burns', false );
		} else if( CoC.player.skinType === AppearanceDefs.SKIN_TYPE_SCALES ) {
			MainView.outputText( 'scales burn', false );
		} else {
			MainView.outputText( CoC.player.skinDesc + ' burns', false );
		}
		MainView.outputText( ' hot, raging from fetish-enhanced lust and daydreams, but you shake your head in time to see a pair of inky black orbs rising from behind a nearby boulder.\n\n', false );
		MainView.outputText( 'You wrench your gaze from the treacherous, alien eyes and glance lower, but it doesn\'t help.  There\'s nothing but flawless, sweat-moistened demon-skin, jutting purple breasts, and a crotch that combines the finest attributes of both genders.  It\'s the demon, Ceraph!\n\n', false );
		MainView.outputText( '"<i>Oh my, does someone like what they see?  ', false );
		if( CoC.player.cor > 66 ) {
			MainView.outputText( 'I can see just how hot I\'m making you, I\'m so glad you gave in and got undressed for me', false );
		} else {
			MainView.outputText( 'You can\'t take your eyes off me.  It\'s a shame you didn\'t get undressed.  Didn\'t anyone tell you this mountain has a dress code?  Or should I say, an undress code', false );
		}
		MainView.outputText( ',</i>" she says.\n\n', false );
		MainView.outputText( 'You ready your ' + CoC.player.weaponName + ', but Ceraph just throws her head back and laughs in your face.  "<i>', false );
		if( CoC.player.cor > 66 ) {
			MainView.outputText( 'Are you going to try to fight me in the buff?  If you\'re going to do that then you can go ahead and get dressed, I wouldn\'t want to accidentally leave a scar in the wrong place.', false );
		} else {
			MainView.outputText( 'Are you going to try to fight me?  If you\'re going to do that, I suppose we can.  You do seem to need some practice at indulging your fetishes.', false );
		}
		MainView.outputText( '</i>"\n\n', false );
		MainView.outputText( 'The demoness lifts one heeled foot high onto a boulder and winks at you, letting her whip rub up and down her hard, nodule-studded shaft.  Her tail rises languidly between her perfect, lissomelegs, rubbing the glistening wet delta of her sex enticingly.  The demon coos, "<i>Oh, I do love putting on a show for my future pets.  Tell me, did you really come up here to fight?  I\'d rather lie back in the sunlight, rubbing my fingers over my glistening skin and showing everyone just how wondrous sex with me would be.  You can even go if you want, or maybe you\'d have something worth trading with me?</i>"', false );
	...
	CeraphScene.prototype.runFromCeraphsNiceDeal = function() {
		...
		MainView.outputText( 'beat a hasty retreat from the trickster of fetishes.  Her masturbatory moans chase you down the mountainside back towards your camp, spiking the already-burning furnace of your lust.', false );
	...
	CeraphScene.prototype.tradeCeraphSomething = function() {
		...
		var endowment = null;
		var armor = null;
		MainView.outputText( 'Ceraph looks you up and down like an appraiser examining an antique, never stopping her languid masturbation.  You stand there, hands on your hips, waiting for her to finish while you try not to stare too long at her beading pre-cum or dripping twat-juice.\n\n', false );
		//(BIMBO LIQUER) ;
		if( CoC.player.hasItem( ConsumableLib.BIMBOLQ ) ) {
			MainView.outputText( 'She finishes and smiles widely.  "<i>Is that bimbo liqueur?  That stuff is so hard to find, even for a demon like me.  I tell you what, I\'ll release you from ', false );
			if( CoC.flags[ kFLAGS.PC_FETISH ] > 1 ) {
				MainView.outputText( 'all the fetishes', false );
			} else {
				MainView.outputText( 'the fetish', false );
			}
			MainView.outputText( ' I\'ve placed upon you if you\'ll trade me that stuff.  There\'s a naughty boy in my harem whose quick wit I\'ve begun to tire of.', false );
			if( CoC.player.gender > 0 || CoC.player.biggestTitSize() > 2 ) {
				MainView.outputText( '  Or if you\'d rather keep it, I could take one of your endowments for my own use and remove a single fetish.  It\'s always fun giving one of my old pets a new part to play with.', false );
			}
			MainView.outputText( '  Maybe you just need some better equipment though?  I have this sexy armor I\'d love to loan you, pet.</i>"\n\n', false );
		...
		//(No Bimbo Liquer) ;
			...
			MainView.outputText( 'She finishes and perks up, leering lewdly at you.  "<i>I tell you what.  Let me take one of your endowments to use on my pets and I\'ll get rid of ', false );
			if( CoC.flags[ kFLAGS.PC_FETISH ] === 1 ) {
				MainView.outputText( 'your fetish for you.</i>"\n\n', false );
			} else {
				MainView.outputText( 'one of your fetishes for you.</i>"\n\n', false );
			}
			endowment = this.tradeCeraphCrotchityBits;
		}
		//(NO TRADE);
		else {
			MainView.outputText( 'She finishes and frowns.  "<i>I don\'t think you\'ve got a single thing worth trading.', false );
			if( CoC.flags[ kFLAGS.PC_FETISH ] < 2 ) {
				armor = this.getCeraphsArmor;
				MainView.outputText( 'Don\'t fret your ' + CoC.player.mf( 'pretty little head', 'charming little head' ) + ', Mistress Ceraph is nothing if not generous to her pets.  I can give you some beautiful armor to entice your foes with, wouldn\'t that be lovely?', false );
			}
			MainView.outputText( '</i>"\n\n', false );
		}
	...
	CeraphScene.prototype.tradeCeraphCrotchityBits = function() {
		...
		if( CoC.player.statusAffectv1( StatusAffects.Exgartuan ) === 1 ) {
			...
			MainView.outputText( 'Ceraph seems perturbed but doesn\'t bother to pursue you.', false );
			EngineCore.dynStats( 'lus', -20 );
			EngineCore.doNext( SceneLib.camp, SceneLib.camp.returnToCampUseOneHour );
			return;
		}
		...
		//Think about it...;
		MainView.outputText( 'Ceraph grins lecherously and pulls her tail from her drooling snatch.  "<i>Really?  Well this should be fun.  Let me just figure out what I want...</i>"  Her gaze is quite piercing.\n\n', false );
		//Pick a winner!;
		choice = choices[ Utils.rand( choices.length ) ];
		if( choice === 0 ) {
			MainView.outputText( 'FUCK AN ERROR HAPPENED GET FENOXO ON THE HORN!', false );
		}
		//(DICKS);
		else if( choice === 1 ) {
			temp2 = Utils.rand( CoC.player.cockTotal() );
			MainView.outputText( 'She pipes up, "<i>', false );
			if( CoC.player.cocks[ temp2 ].cockType === CockTypesEnum.HORSE ) {
				MainView.outputText( 'Oooh, is that a horse-cock?  Those are quite nice.  I love the feel of a flare inside me, or even better, plunging one deep into a slut\'s poor, abused asshole.', false );
			} else if( CoC.player.cocks[ temp2 ].cockType === CockTypesEnum.DOG ) {
				MainView.outputText( 'Oooh, is that a dog-cock?  Those are quite nice.  It\'s oh-so-fun to enhance the knots on those and then watch them puff up enough to distend some poor slave\'s gut.', false );
			} else if( CoC.player.cocks[ temp2 ].cockType === CockTypesEnum.DEMON ) {
				MainView.outputText( 'Oooh, is that a demon-cock?  As you can see I\'m QUITE familiar with those, but it might be fun to replace one of my girl\'s tongues with it.', false );
			} else if( CoC.player.cocks[ temp2 ].cockType === CockTypesEnum.CAT ) {
				MainView.outputText( 'Oooh, is that a kitty-dick?  The spines on those feel so good while they rub down all your walls or catch your prostate.  Meow.', false );
			} else if( CoC.player.cocks[ temp2 ].cockType === CockTypesEnum.LIZARD ) {
				MainView.outputText( 'Wow, you\'ve got a snake-dick?  I haven\'t seen one of those in a while.  I love the bulbous, knot-like texture.  Maybe I\'ll graft it onto a chair and make one of my boys sit on it for a few days.', false );
			} else if( CoC.player.cocks[ temp2 ].cockType === CockTypesEnum.TENTACLE ) {
				MainView.outputText( 'Oooh, a tentacle cock?  How lucky to find one of those on you!  I\'ve been meaning to add another poor tentacle-slave.', false );
			} else if( CoC.player.cocks[ temp2 ].cockType === CockTypesEnum.ANEMONE ) {
				MainView.outputText( 'Oooh, an anemone-cock?  Simply marvelous!  I might have to crank up the strength of the venom and use it myself!', false );
			} else {
				MainView.outputText( 'Oooh, a normal, uncorrupted cock.  How utterly droll!  You\'d think these would be more common, but it\'s quite a treat to come across one.', false );
			}
			if( CoC.player.cockTotal() > 1 ) {
				MainView.outputText( '  Of course that\'s not the only prick you\'re packing, hrmmm?  Maybe I should take ', false );
				if( CoC.player.cockTotal() === 2 ) {
					MainView.outputText( 'the other one', false );
				} else {
					MainView.outputText( 'one of the others', false );
				}
			}
		...
		//(Cunts) ;
			...
			MainView.outputText( 'The demon\'s gaze drops down between your ' + CoC.player.legs() + ', and she remarks, "<i>', false );
			if( CoC.player.wetness() >= 5 ) {
				MainView.outputText( 'My my, what a juicy box you have there.  Tell me, doesn\'t it bother you to be soaking in your own lubricants all the time?  Perhaps I\'ll put it on one of my slaves and mount her on the wall.  Then I can simply slip in and lube up before giving one of my other pets a proper lesson.', false );
			} else if( CoC.player.wetness() >= 3 ) {
				MainView.outputText( 'My my, what a nice wet pussy you have there.  I really feel that you have a perfect blend of moisture and practicality down there.  I might have to snatch that snatch and give it to one of my drier pets.', false );
			} else if( CoC.player.vaginalCapacity() >= 150 ) {
				MainView.outputText( 'My my, what a terrifically gaped hole you have there.  Do minotaurs even feel anything while they rail you?  Perhaps I could use that when I\'m playing with Shenandoah.  She\'s had a few too many incubi drafts and can be a little difficult to handle.', false );
			} else {
				MainView.outputText( 'My my, such a pretty pussy.  I bet it would be fun to replace one of my noisier pet\'s mouth with.  She never did learn not to bite.', false );
			}
			MainView.outputText( '</i>"\n\n', false );
		}
		//(Tits) ;
		else {
			MainView.outputText( 'Ceraph\'s hands reach up to cup the swell of your ' + Appearance.biggestBreastSizeDescript() + ' as she asks, "<i>', false );
			if( CoC.player.biggestTitSize() > 14 ) {
				MainView.outputText( 'Oh wow... just wow.  How do you walk?  With melons like this you could tit-fuck three or four people at once!  Absolutely exquisite.', false );
			} else if( CoC.player.biggestTitSize() > 6 ) {
				MainView.outputText( 'Tell me dear, are they real?  I mean, were they always this size, or did you have to get a little bit of work done?', false );
			} else {
				MainView.outputText( 'Well, these are a bit small.  Have you ever considered trying some Gro Plus?  I hear it\'s all the rage with Lethice\'s lackeys nowadays.', false );
			}
			MainView.outputText( '</i>"\n\n', false );
		}
		MainView.outputText( 'A long, silent moment passes before Ceraph makes up her mind.  She points at your ', false );
		if( choice === 1 ) {
			MainView.outputText( 'manhood', false );
			if( CoC.player.cockTotal() > 1 ) {
		...
		MainView.outputText( 'and declares, "<i>I think I\'ll have ', false );
		if( choice <= 2 ) {
			MainView.outputText( 'one ', false );
		} else {
			MainView.outputText( 'two ', false );
		}
		MainView.outputText( 'of those.  Now just hold still.</i>"\n\n', false );
		MainView.outputText( 'Do you let her take it?', false );
	...
	CeraphScene.prototype.giveUpYourBallsOrWhateverForLessFetishes = function() {
		...
		if( CoC.flags[ kFLAGS.UNKNOWN_FLAG_NUMBER_00217 ] === 1 ) {
			...
			MainView.outputText( 'Ceraph\'s fingers feel unexpectedly hot as they brush your ' + Descriptors.cockDescript( x ) + ', as if she had just come out of a heated tub.  You don\'t have long to ponder that little detail as they pinch into a tight ring', false );
			...
			MainView.outputText( ' in her hand!  At the base there\'s smooth flesh and an arcane mark, somehow keeping the disembodied dick alive to pulse and squirm in her grasp.  The place on your groin is left completely smooth and featureless, as if it had never been there at all.\n\n', false );
			MainView.outputText( 'Ceraph runs a finger up and down the length, setting off fireworks in your brain – you can still feel it!  The demoness laughs and says, "<i>Don\'t worry, you won\'t feel the sensations constantly once I bond it elsewhere, though you may get a hint of feeling when unconscious.  For now, enjoy the pleasure!  Oh, I packed that tasty fetish into the cock for later.  Ta-ta, my pet!  Now go find me some more delicious dicks!</i>"\n\n', false );
			MainView.outputText( 'She pirouettes away, practically dancing through the mountains while she strokes and teases the cock you just lost.  Thankfully she was true to her word – your mind feels significantly clearer, at least when a burning hot demon-tongue isn\'t enveloping Ceraph\'s new toy.', false );
			//PYOING!;
		...
		//(Tits) ;
			...
			MainView.outputText( 'Ceraph turns and prances off through the rocks, tweaking your nipples HARD every time you start to make a move to follow her.  It\'s no use.  She vanishes before long, leaving you to deal with the slowly dwindling sensation of her cock in your tits.\n\n', false );
	...
	CeraphScene.prototype.ceraphBodyPartDreams = function() {
		...
		if( choice === 2 ) {
			...
			//PUSSY FLESHLIGHT;
				...
				MainView.outputText( 'A sudden prodding at your vagina\'s entrance nearly rouses you from your sleep.  ', false );
				if( !CoC.player.hasVagina() ) {
					MainView.outputText( 'Wait... you don\'t have a pussy anymore.  ', false );
				} else {
					MainView.outputText( 'Wait... your pussy doesn\'t feel like that!  ', false );
				}
				MainView.outputText( 'You must be picking up on feelings from the cunt Ceraph took away from you!  Warm demonic cum bubbles at your entrance, slicking the engorging vulva with demonic taint.  You swoon from the heat of it, and the demoness wastes no time, quickly inserting her entire length.\n\n', false );
				MainView.outputText( 'The nubby nodules that line her shape press on your walls, stroking the innermost folds of your long-lost nethers.  Somehow you get a visual of the scene – Ceraph, lying back in bed, your pussy-flesh clutched in her hand like a perverse sex-toy.  She starts pumping it on herself, using a part of your body like a simple masturbation tool.  The room is empty, and she wastes no time in vocalizing her pleasure, "<i>Ohhh fuck you\'ve got a nice pussy ' + CoC.player.short + '.  By Lethice\'s lewd tits, I hope you can feel how good your cooch is at devouring a demon\'s dick.  Next time we meet you should... Ah.. ahhh... ohhhh umm... submit to... ahhh AHHH!</i>"\n\n', false );
				MainView.outputText( 'Throughout Ceraph\'s speech she continually increased her pace, jackhammering your pussy up and down on her bulging dick.  The nodules start to enlarge, puffing up around her base and then rippling, wave-like towards the slowly thickening head.  A squirt of hot cum shoots into your depths, sliming them with the demoness\' corrupt cream, but it feels so good... so very good.  Your pussy clamps down on the invader, imprinting the swollen nodules against its soft inner walls, and you cum as hard as if you were riding her yourself.\n\n', false );
				MainView.outputText( 'The vision and feelings slowly fade, letting you out of their grip and leaving faint after-images of Ceraph cleaning you with her tongue.', false );
				//(-100 lust, +2 sens, +1 cor);
				CoC.player.orgasm();
				EngineCore.dynStats( 'sen', 2, 'cor', 1 );
			} else {
				//Vagina Wall-Cubby;
				MainView.outputText( 'MMMmmm, something is filling you just - ahhhh... right.  You shift position in your blankets, but it doesn\'t seem to move the insistent hardness lodged up your twat.  Gods, it feels so good to be so full.  It\'s like having three or four hard dicks inside you all at once, keeping you stretched and open, the cunt-honey dripping toward the floor.  The only time they move is when a wave of contractions pulses through your female flesh, squeezing about the invaders.  Languidly, you work your muscles faster, wanting to feel greater pleasures.  You secretly wish that whatever it is would fuck you.' );
			...
			//Tit Volleyball;
				...
				MainView.outputText( 'You see Ceraph, the conniving omnibus, standing in a hazy pink void, dressed in a tiny purple bikini.  She smiles to herself as she holds out a fleshy orb.  It looks soft, jiggly... and alarmingly familiar.  As you spy a rounded areola, you realize the demon is holding one of your old breasts! She tosses the plump tit ponderously for a moment, before raising it to her mouth and... blowing?' );
				...
				if( EngineCore.silly() ) {
					MainView.outputText( 'horsecocks ' );
				} else {
					MainView.outputText( 'demonic cocks ' );
				}
				MainView.outputText( 'rise from the sand, forming makeshift poles for the twisted volleyball net.' );
				...
				if( EngineCore.silly() ) {
					MainView.outputText( ' and what possible ramifications it has for your mental health' );
				}
				MainView.outputText( ', until you dismiss it as corruption and toss over, entering a peaceful, dreamless sleep.' );
				EngineCore.dynStats( 'lus', 5 + CoC.player.lib / 5 );
			}
		}
		//COCKUUUU;
		else {
			subChoice = Utils.rand( 10 );
			//WAX DRIPPU;
			if( subChoice <= 2 ) {
			...
			//Cock Sandwich;
				...
				MainView.outputText( '\n\nCunts.' );
				MainView.outputText( '\n\nTheir bodies writhe faster against you, and Ceraph whispers in your ear, "<i>Would you like to cum too?  0...to empty that nice, hard cock I gave you all over that oiled-up female flesh?</i>"' );
	...
	CeraphScene.prototype.buttRapeCeraph = function() {
		...
		MainView.outputText( '', true );
		MainView.outputText( 'Completely defeated, the haughty demoness lies face down in the dirt, ', false );
		if( CoC.monster.HP < 1 ) {
			MainView.outputText( 'her tail hanging limp between her legs.  She spits a wad of bloody saliva and says, "<i>What\'s the matter?  Beat a girl senseless and lose your nerve?  I thought you were going to rape me.</i>"', false );
		} else {
			MainView.outputText( 'her rump up in the air while her tail plunges violently into her cunt over and over again.  She moans up to you, "<i>What\'s the matter?  Are you nervous about putting it inside me?  Come on... rape me already!  Punish my gushing-wet cunt with your divine rod!</i>"', false );
		}
		MainView.outputText( '\n\nYou reach down and slap her ass hard, ', false );
		if( CoC.player.str < 75 ) {
			MainView.outputText( 'making her whole body jiggle', false );
		} else {
			MainView.outputText( 'making her jiggle and slide a few inches in the dirt', false );
		}
		MainView.outputText( ' and shutting her up while you tear off your ' + CoC.player.armorName + '.\n\n', false );
		MainView.outputText( 'Now naked, you waste no time in grabbing her by her toned thighs and lifting her up, rubbing her face in the dirt while you get a nice look at her tightly-clenched asshole and ', false );
		if( CoC.monster.HP < 1 ) {
			MainView.outputText( 'wet ', false );
		} else {
			MainView.outputText( 'achingly wet ', false );
		}
		MainView.outputText( 'demon-twat.  Her vulva flares out, massively engorging and unfolding like a flower, practically begging you to plunge into the dripping tunnel.\n\n', false );
		MainView.outputText( '"<i>Nooooo... don\'t stick it in my pussy!  You\'ll get me pregnant!  Or is that what you\'re after?  Are you gonna keep cumming in my naughty hole until I\'m too pregnant to move?  Is that your plan, champion? Are you going to keep all the demons too pregnant to resist you?  Look at how wet you\'ve made my pussy... I\'m a high class demon, y-you can\'t make me pregnant!  Nooooo,</i>" groans Ceraph while her tail wraps around your ' + Descriptors.cockDescript( x ) + ', clearly trying to entice you, but you\'ve got a surprise in store for her.\n\n', false );
		MainView.outputText( 'You rub your ' + CoC.player.cockHead( x ) + ' against the demonic juice-fountain, letting Ceraph slather you with corrupted lubricants while you tease her whorishly-ready fuck-lips.  In seconds you\'re soaked from tip to hips, and before Ceraph can con you into filling her full of demonic children, you drop her low and ram your ' + Descriptors.hipDescript() + ' forward.  Her pucker, though tight, yields before your onslaught, gradually dilating to accept your ' + CoC.player.cockHead( x ) + ' and the first few inches of your ' + Descriptors.cockDescript( x ) + '.', false );
		if( CoC.player.cockTotal() === 2 ) {
			MainView.outputText( '  The other ' + Descriptors.cockDescript( x ) + ' rubs against her butt-cheeks, sliding through them with ease thanks to her copious secretions.', false );
		} else if( CoC.player.cockTotal() > 2 ) {
			MainView.outputText( '  The rest of your male genitals slide between the demoness\' pert butt-cheeks in one huge, femcum-slicked bundle.', false );
		}
		MainView.outputText( '  Ceraph squeaks in distress, taken completely by surprise and for once, completely lacking a witty retort.\n\n', false );
		MainView.outputText( 'The demon grunts like a wounded animal underneath you, her long, demonic tongue hanging out to flop in the dirt while you rock her half-comatose form closer to your crotch.  Inside, your ' + CoC.player.cockHead( x ) + ' squeezes past the tightness of her anal ring to the unusual warmth of a demon\'s innermost depths.  More and more of your ' + Descriptors.cockDescript( x ) + ' slips into the wonderfully tight, hot little hole, the penetration growing ever easier as the defeated demon relaxes into her role as a cum-dump unworthy of your children.', false );
		if( CoC.monster.HP < 1 ) {
			MainView.outputText( '  Cunt-juice splatters over your ' + CoC.player.legs() + ' as Ceraph\'s now-energetic tail plunges into her sodden box, pumping into it in time with the penetration of her asshole.', false );
		} else {
			MainView.outputText( '  Cunt-juice dribbles over your ' + CoC.player.legs() + ' as Ceraph\'s tail slowly and purposefully plows her box, mimicking the penetration of her asshole.', false );
		}
		MainView.outputText( '\n\n', false );
		MainView.outputText( 'Ceraph whimpers and begs, "<i>Noooo... you\'re raping my ass... g-get it out of there!  Aren\'t you supposed to be p-pure?  Untainted?  You\'re – unf – fucking a demon\'s butt like some kind of pervy animal!  Please... f-fuck my pussy.  I don\'t even mind if you don\'t wash it off... just stick it in my cunt.</i>"\n\n', false );
		MainView.outputText( 'Like hell!  You pull harder, splitting her asscheeks until they\'re squished into your body, her cock-gaped asshole ', false );
		if( !CoC.player.hasSheath() ) {
			MainView.outputText( 'barely touching your groin', false );
		} else {
			MainView.outputText( 'rubbing your sheath', false );
		}
		MainView.outputText( '.  The demon\'s ass is warm enough to make you feel you could melt like an icicle in an oven, the blissful sensations spurring you to play with her supple ass-cheeks while you enjoy the complete penetration of a demon\'s backdoor.  You give those cheeks a hard slap and pull back, enjoying the feel of her gloriously tight ring as it slides over the pussy-slicked length of your ' + Descriptors.cockDescript( x ) + '.\n\n', false );
		MainView.outputText( 'Without waiting, you slam it back home, burying it in the swelteringly hot backside.  Ceraph grunts, her tail locked in time with you and clearly bringing her great pleasure.  You take the time to reach down and pull it out – if she\'s going to cum, she\'s going to cum to the feel of you packing her bowels full of wasted seed.  She cries in distress, "<i>Noooooo... fuck you!  Please... at least let me cum from this.  You\'re fucking me so dominantly... so hard... by Lethice it\'s making me so soaking wet.  Please!  Let me cum, let me cum... letmecumletmecumletmecum!</i>"\n\n', false );
		...
		MainView.outputText( 'Ropes of jism splatter into the demon\'s rectum, and while it turns her tight back-door into a drooling wet fuck-hole, it actually lowers the temperature to a saner threshold.  ', false );
		if( CoC.player.cumQ() >= 500 && CoC.player.cumQ() < 1500 ) {
			MainView.outputText( 'Her belly bulges slightly from the cummy deposit, marking her even more obviously as a cum-bucket for your cock.  ', false );
		} else if( CoC.player.cumQ() >= 1500 ) {
			MainView.outputText( 'Her belly burbles and swells, bulging out to look positively pregnant, though you know she\'s packed from the other end.  ', false );
		}
		MainView.outputText( 'You pull out, and Ceraph\'s ', false );
		if( CoC.player.cocks[ x ].cockThickness < 3 ) {
			MainView.outputText( 'slightly-gaped', false );
		} else if( CoC.player.cocks[ x ].cockThickness < 5 ) {
			MainView.outputText( 'gaped', false );
		} else {
			MainView.outputText( 'gaping-wide', false );
		}
		MainView.outputText( ' asshole leaks spunk everywhere. Disgusted with her', false );
		if( CoC.player.cor < 33 ) {
			MainView.outputText( ' and a little bit by yourself', false );
		}
