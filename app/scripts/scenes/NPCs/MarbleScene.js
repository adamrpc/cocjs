...
angular.module( 'cocjs' ).run( function( $rootScope, $log, PerkLib, OnLoadVariables, Marble, Appearance, Descriptors, AppearanceDefs, ArmorLib, EventParser, CoC, kFLAGS, Utils, StatusAffects, PregnancyStore, EngineCore, Combat, ConsumableLib ) {
	...
	MarbleScene.prototype.timeChange = function() {
		...
		$log.debug( '\nMarble time change: Time is ' + CoC.getInstance().time.hours + ', incubation: ' + this.pregnancy.incubation + ', event: ' + this.pregnancy.event );
		if( CoC.getInstance().player.findStatusAffect( StatusAffects.CampMarble ) >= 0 ) {
			//Marble stuff pt I;
			if( CoC.getInstance().flags[ kFLAGS.MARBLE_RATHAZUL_COUNTER_1 ] > 0 ) {
				CoC.getInstance().flags[ kFLAGS.MARBLE_RATHAZUL_COUNTER_1 ]--;
				//Stick it at 1 so I can trigger it off the camp screen.;
				if( CoC.getInstance().flags[ kFLAGS.MARBLE_RATHAZUL_COUNTER_1 ] <= 1 ) {
					CoC.getInstance().flags[ kFLAGS.MARBLE_RATHAZUL_COUNTER_1 ] = 1;
				}
			}
			//Counting down to purity!;
			if( CoC.getInstance().flags[ kFLAGS.MARBLE_PURIFICATION_STAGE ] === 0 ) {
				if( CoC.getInstance().flags[ kFLAGS.MARBLE_COUNTUP_TO_PURIFYING ] < 200 ) {
					CoC.getInstance().flags[ kFLAGS.MARBLE_COUNTUP_TO_PURIFYING ]++;
				}
			}
			//Counter 2!;
			if( CoC.getInstance().flags[ kFLAGS.MARBLE_RATHAZUL_COUNTER_2 ] > 0 ) {
				CoC.getInstance().flags[ kFLAGS.MARBLE_RATHAZUL_COUNTER_2 ]--;
				//Stick it at 1 so I can trigger it off the camp screen.;
				if( CoC.getInstance().flags[ kFLAGS.MARBLE_RATHAZUL_COUNTER_2 ] <= 1 ) {
					CoC.getInstance().flags[ kFLAGS.MARBLE_RATHAZUL_COUNTER_2 ] = 1;
				}
			}
			//Post purification nursitude;
			if( CoC.getInstance().flags[ kFLAGS.MARBLE_PURIFICATION_STAGE ] >= 5 ) {
				CoC.getInstance().flags[ kFLAGS.MARBLE_TIME_SINCE_NURSED_IN_HOURS ]++;
				if( CoC.getInstance().flags[ kFLAGS.MARBLE_TIME_SINCE_NURSED_IN_HOURS ] > 1000 ) {
					CoC.getInstance().flags[ kFLAGS.MARBLE_TIME_SINCE_NURSED_IN_HOURS ] = 1000;
				}
			}
			//Reset Marble corruption warning;
			if( CoC.getInstance().flags[ kFLAGS.MARBLE_WARNED_ABOUT_CORRUPTION ] === 1 && CoC.getInstance().player.cor < 50 ) {
				CoC.getInstance().flags[ kFLAGS.MARBLE_WARNED_ABOUT_CORRUPTION ] = 0;
			}
			//Lactation whoopie!;
			if( CoC.getInstance().flags[ kFLAGS.MARBLE_TIME_SINCE_NURSED_IN_HOURS ] < 100 ) {
				CoC.getInstance().flags[ kFLAGS.MARBLE_TIME_SINCE_NURSED_IN_HOURS ]++;
			}
			...
			if( Utils.rand( 2 ) === 0 ) {
				CoC.getInstance().flags[ kFLAGS.MARBLE_LUST ] += 1;
			}
			if( CoC.getInstance().player.statusAffectv4( StatusAffects.Marble ) > 50 ) {
				CoC.getInstance().flags[ kFLAGS.MARBLE_LUST ] += 0.3;
			}
			if( CoC.getInstance().player.statusAffectv4( StatusAffects.Marble ) > 70 ) {
				CoC.getInstance().flags[ kFLAGS.MARBLE_LUST ] += 0.3;
			}
			...
			if( CoC.getInstance().flags[ kFLAGS.MARBLE_NURSERY_CONSTRUCTION ] > 0 && CoC.getInstance().flags[ kFLAGS.MARBLE_NURSERY_CONSTRUCTION ] < 100 && CoC.getInstance().scenes.marbleScene.marbleAtCamp() ) {
				...
				if( CoC.getInstance().flags[ kFLAGS.MARBLE_NURSERY_CONSTRUCTION ] >= 100 ) {
					...
					needNext = true;
					CoC.getInstance().flags[ kFLAGS.MARBLE_NURSERY_CONSTRUCTION ] = 100;
				}
			}
			//Marble find items check;
				...
				if( CoC.getInstance().player.findStatusAffect( StatusAffects.MarbleItemCooldown ) < 0 ) {
					if( Utils.rand( 10 ) === 0 ) {
						...
						CoC.getInstance().player.createStatusAffect( StatusAffects.MarbleItemCooldown, (24 + Utils.rand( 24 )), 0, 0, 0 );
						CoC.getInstance().player.createStatusAffect( StatusAffects.MarbleHasItem, Utils.rand( 10 ), 0, 0, 0 );
						needNext = true;
					}
				}
			}
		...
		if( CoC.getInstance().player.findStatusAffect( StatusAffects.MarbleItemCooldown ) >= 0 ) {
			CoC.getInstance().player.addStatusValue( StatusAffects.MarbleItemCooldown, 1, -1 );
			if( CoC.getInstance().player.statusAffectv1( StatusAffects.MarbleItemCooldown ) < 1 ) {
				CoC.getInstance().player.removeStatusAffect( StatusAffects.MarbleItemCooldown );
			}
		}
		if( CoC.getInstance().player.findStatusAffect( StatusAffects.Infested ) < 0 ) {
			CoC.getInstance().flags[ kFLAGS.MARBLE_GROSSED_OUT_BECAUSE_WORM_INFESTATION ] = 0;
		}
		if( CoC.getInstance().player.findStatusAffect( StatusAffects.MarblesMilk ) >= 0 && CoC.getInstance().player.findPerk( PerkLib.MarblesMilk ) < 0 ) {
			//Decrement time remaining by 1		;
			CoC.getInstance().player.addStatusValue( StatusAffects.MarblesMilk, 1, -1 );
			//Remove the status and stat boosts when time runs out on the milk;
			if( CoC.getInstance().player.statusAffectv1( StatusAffects.MarblesMilk ) <= 0 ) {
				needNext = true;
				EngineCore.dynStats( 'str', (-1 * CoC.getInstance().player.statusAffectv2( StatusAffects.MarblesMilk )), 'tou', (-1 * CoC.getInstance().player.statusAffectv3( StatusAffects.MarblesMilk )) );
				CoC.getInstance().player.removeStatusAffect( StatusAffects.MarblesMilk );
				//Text for when Marble's Milk effect wears off:;
				//[addiction is 10 or less] ;
				if( CoC.getInstance().player.statusAffectv2( StatusAffects.Marble ) <= 10 ) {
				...
				else if( CoC.getInstance().player.statusAffectv2( StatusAffects.Marble ) <= 30 ) {
				...
				}//[addiction is 31-50, CoC.getInstance().player is not addicted];
				else if( CoC.getInstance().player.statusAffectv2( StatusAffects.Marble ) <= 50 ) {
				...
				if( CoC.getInstance().player.statusAffectv3( StatusAffects.Marble ) > 0 ) {
					...
					if( CoC.getInstance().player.findStatusAffect( StatusAffects.BottledMilk ) >= 0 ) {
						...
						//[addiction is <90, CoC.getInstance().player is addicted];
						if( CoC.getInstance().player.statusAffectv2( StatusAffects.Marble ) <= 90 ) {
						...
						CoC.getInstance().player.createStatusAffect( StatusAffects.MarbleWithdrawl, 0, 0, 0, 0 );
		...
		if( CoC.getInstance().player.statusAffectv3( StatusAffects.Marble ) > 0 && CoC.getInstance().player.findPerk( PerkLib.MarbleResistant ) < 0 && CoC.getInstance().player.findPerk( PerkLib.MarblesMilk ) < 0 && CoC.getInstance().player.statusAffectv2( StatusAffects.Marble ) > 25 ) {
			//If player does not have marble's milk or bottled milk, go into withdrawl;
			if( CoC.getInstance().player.findStatusAffect( StatusAffects.MarblesMilk ) < 0 && CoC.getInstance().player.findStatusAffect( StatusAffects.BottledMilk ) < 0 ) {
		...
		if( CoC.getInstance().player.statusAffectv3( StatusAffects.Marble ) <= 0 ) {
			if( CoC.getInstance().player.statusAffectv2( StatusAffects.Marble ) > 60 ) {
				CoC.getInstance().player.changeStatusValue( StatusAffects.Marble, 2, 60 );
			}
		}
		//Withdrawl removal if you get unaddicted.;
		if( CoC.getInstance().player.findStatusAffect( StatusAffects.MarbleWithdrawl ) >= 0 ) {
			if( CoC.getInstance().player.statusAffectv2( StatusAffects.Marble ) <= 25 ) {
				CoC.getInstance().player.removeStatusAffect( StatusAffects.MarbleWithdrawl );
				EngineCore.dynStats( 'tou', 5, 'int', 5 );
				EngineCore.outputText( '\nYou no longer feel the symptoms of withdrawal.\n', false );
				needNext = true;
			}
			//Remove withdrawl if you have bottled milk affect;
			else if( CoC.getInstance().player.findStatusAffect( StatusAffects.BottledMilk ) >= 0 ) {
				EngineCore.outputText( '\nYou no longer feel the symptoms of withdrawal.\n', false );
				needNext = true;
				CoC.getInstance().player.removeStatusAffect( StatusAffects.MarbleWithdrawl );
				EngineCore.dynStats( 'tou', 5, 'int', 5 );
		...
		if( CoC.getInstance().player.findStatusAffect( StatusAffects.BottledMilk ) >= 0 ) {
			CoC.getInstance().player.addStatusValue( StatusAffects.BottledMilk, 1, -1 );
			if( CoC.getInstance().player.statusAffectv1( StatusAffects.BottledMilk ) <= 0 ) {
				CoC.getInstance().player.removeStatusAffect( StatusAffects.BottledMilk );
			}
		}
		if( CoC.getInstance().time.hours > 23 ) {
			CoC.getInstance().flags[ kFLAGS.MARBLE_PLAYED_WITH_KIDS_TODAY ] = 0;
			if( CoC.getInstance().player.findStatusAffect( StatusAffects.Marble ) >= 0 && CoC.getInstance().player.statusAffectv2( StatusAffects.Marble ) > 0 ) {
	...
	MarbleScene.prototype.timeChangeLarge = function() {
		...
		if( CoC.getInstance().player.statusAffectv3( StatusAffects.Marble ) > 0 && CoC.getInstance().player.statusAffectv2( StatusAffects.Marble ) < 25 && CoC.getInstance().player.findPerk( PerkLib.MarblesMilk ) < 0 && CoC.getInstance().player.findPerk( PerkLib.MarbleResistant ) < 0 && CoC.getInstance().time.hours === 6 ) {
			EngineCore.spriteSelect( 41 );
			...
			CoC.getInstance().player.createPerk( PerkLib.MarbleResistant, 0, 0, 0, 0 );
			...
			if( CoC.getInstance().player.statusAffectv3( StatusAffects.Marble ) === 1 ) {
				...
				if( CoC.getInstance().player.statusAffectv1( StatusAffects.Marble ) >= 30 && CoC.getInstance().player.statusAffectv1( StatusAffects.Marble ) < 90 ) {
				...
				if( CoC.getInstance().player.statusAffectv1( StatusAffects.Marble ) >= 90 ) {
					...
					if( CoC.getInstance().flags[ kFLAGS.AMILY_FOLLOWER ] > 0 && CoC.getInstance().flags[ kFLAGS.FOLLOWER_AT_FARM_AMILY ] === 0 ) {
			...
			//Ashamed Marble;
				...
				if( CoC.getInstance().player.statusAffectv1( StatusAffects.Marble ) >= 30 && CoC.getInstance().player.statusAffectv1( StatusAffects.Marble ) < 70 ) {
				...
				if( CoC.getInstance().player.statusAffectv1( StatusAffects.Marble ) >= 70 ) {
		...
		if( CoC.getInstance().player.statusAffectv3( StatusAffects.Marble ) > 0 && CoC.getInstance().player.statusAffectv2( StatusAffects.Marble ) >= 100 && CoC.getInstance().player.findPerk( PerkLib.MarblesMilk ) < 0 && CoC.getInstance().player.findPerk( PerkLib.MarbleResistant ) < 0 && CoC.getInstance().time.hours === 6 ) {
			EngineCore.spriteSelect( 41 );
			...
			CoC.getInstance().player.createPerk( PerkLib.MarblesMilk, 0, 0, 0, 0 );
			//Clear withdrawl;
			if( CoC.getInstance().player.findStatusAffect( StatusAffects.MarbleWithdrawl ) >= 0 ) {
				CoC.getInstance().player.removeStatusAffect( StatusAffects.MarbleWithdrawl );
				EngineCore.dynStats( 'tou', 5, 'int', 5 );
			...
			if( CoC.getInstance().player.findStatusAffect( StatusAffects.MarblesMilk ) >= 0 ) {
				CoC.getInstance().player.removeStatusAffect( StatusAffects.MarblesMilk );
			}
			...
			if( CoC.getInstance().player.statusAffectv3( StatusAffects.Marble ) === 1 ) {
				...
				if( CoC.getInstance().player.statusAffectv1( StatusAffects.Marble ) < 49 ) {
					...
					EngineCore.doNext( this.marbleBadEndFollowup );
					return true;
				}
				//Affection 50-79, type 1:;
				if( CoC.getInstance().player.statusAffectv1( StatusAffects.Marble ) >= 50 && CoC.getInstance().player.statusAffectv1( StatusAffects.Marble ) < 79 ) {
				...
				//High affection;
				if( CoC.getInstance().player.statusAffectv1( StatusAffects.Marble ) >= 80 ) {
					...
					//(CoC.getInstance().player chose yes) do after addiction sex event;
					this.marbleAddictionSex( false );
					EngineCore.outputText( '\n', false );
					//(Marble now appears at the camp);
					CoC.getInstance().player.createStatusAffect( StatusAffects.CampMarble, 0, 0, 0, 0 );
			...
			//Marble didn't like you addicted;
				...
				//Affection < 80, type 2:;
				else if( CoC.getInstance().player.statusAffectv1( StatusAffects.Marble ) < 80 ) {
		...
		if( this.checkedMarbleMilk++ === 0 && CoC.getInstance().time.hours === 6 && CoC.getInstance().player.findPerk( PerkLib.MarblesMilk ) >= 0 ) {
			//Marble is at camp;
			if( CoC.getInstance().player.findStatusAffect( StatusAffects.CampMarble ) >= 0 ) {
	...
	MarbleScene.prototype.marbleFollower = function() {
		return CoC.getInstance().player.findStatusAffect( StatusAffects.CampMarble ) >= 0;
	};
	...
	MarbleScene.prototype.marbleBreastSize = function() {
		if( CoC.getInstance().flags[ kFLAGS.MARBLE_PURIFIED ] > 0 ) {
			...
			if( CoC.getInstance().player.statusAffectv4( StatusAffects.Marble ) > 30 ) {
				return 'HH cup';
			} else {
				return 'G cup';
			}
	...
	MarbleScene.prototype.encounterMarbleInitially = function() {
		EngineCore.spriteSelect( 41 );
		CoC.getInstance().player.createStatusAffect( StatusAffects.Marble, 0, 0, 0, 40 );
		...
		if( CoC.getInstance().player.tallness < 60 ) {
			...
			//- CoC.getInstance().player chooses resist or don't resist;
			EngineCore.choices( 'Let Her', this.marblePicksYouUpInitially, 'Don\'t', this.resistMarbleInitially, '', null, '', null, '', null );
			return;
		}
		...
		//- CoC.getInstance().player chooses caress, suckle, or rape;
		EngineCore.choices( 'Caress', this.caressMarble, 'Suckle', this.suckleMarble, 'Rape', this.rapeDAHMARBLEZ, '', null, 'Leave', this.turnOffMarbleForever );
	};
	...
	MarbleScene.prototype.marbleWarningStateMeeting = function() {
		...
		EngineCore.choices( 'Apologize', this.apologizetoWalkingTitsIMEANMARBLE, 'Pick Fight', this.pickAFight, 'Leave4Ever', this.pickAFight, '', null, 'Leave', this.leaveNonFriendsMarble );
	};
	//Leave (Z);
	...
	MarbleScene.prototype.leaveNonFriendsMarble4EVERRRR = function() {
		...
		EngineCore.spriteSelect( 41 );
		CoC.getInstance().player.createStatusAffect( StatusAffects.NoMoreMarble, 0, 0, 0, 0 );
		CoC.getInstance().flags[ kFLAGS.MARBLE_WARNING ] = 2;
	...
	MarbleScene.prototype.apologizetoWalkingTitsIMEANMARBLE = function() {
		...
		if( CoC.getInstance().player.inte < 15 ) {
		...
		} else if( CoC.getInstance().player.inte < 40 ) {
			...
			EngineCore.outputText( 'It isn\'t too hard to figure out that Marble isn\'t really trying, and you easily catch her off guard on one of her double backs.  She doesn\'t even notice you until you peek out from between the stalks next to her, reaching out and getting a handful of her backside.  "<i>Clever ' + CoC.getInstance().player.mf( 'boy', 'girl' ) + '...</i>" she says.' );
		}
		...
		CoC.getInstance().flags[ kFLAGS.MARBLE_WARNING ] = 0;
		//(apply the stat effect 'Marble's Milk' to the player);
		this.applyMarblesMilk();
		EngineCore.dynStats( 'lib', 0.2, 'lus', (5 + CoC.getInstance().player.lib / 10) );
	...
	MarbleScene.prototype.pickAFight = function() {
		...
		//[Stay][Fuck That];
		EngineCore.choices( 'Stay', this.stayForFights, 'Fuck That', this.getOutOfDodge, '', null, '', null, '', null );
	};
	//[Stay];
	...
	MarbleScene.prototype.marbleFightWin = function() {
		...
		var feed = null;
		if( CoC.getInstance().player.findPerk( PerkLib.Feeder ) >= 0 || CoC.getInstance().player.lactationQ() > 200 ) {
			feed = this.forceFeedMarble;
		}
		EngineCore.choices( 'Feed Her', feed, 'RapeInRoom', this.rapeMarbleInHerRoom, '', null, '', null, 'Leave', Combat.cleanupAfterCombat );
	};
	...
	MarbleScene.prototype.rapeMarbleInHerRoom = function() {
		...
		if( CoC.getInstance().player.cocks.length > 0 ) {
			EngineCore.outputText( 'Chuckling to yourself, you free your ' + Descriptors.multiCockDescriptLight() + ' from your ' + CoC.getInstance().player.armorName + '.  You spend a moment to ask the helpless cow-girl if she is ready, her only response being a whimper, before ', false );
		...
		CoC.getInstance().flags[ kFLAGS.FARM_DISABLED ] = 1;
		//End event;
		Combat.cleanupAfterCombat();
	};
	//Force-feed (by Spy) (Z);
	...
	MarbleScene.prototype.resistMarbleInitially = function() {
		EngineCore.spriteSelect( 41 );
		//(CoC.getInstance().player chose resist);
		EngineCore.outputText( '', true );
		EngineCore.outputText( 'Surprised by your resistance, she pulls back and apologizes for being presumptuous.  ', false );
		//- continue to the next part;
		EngineCore.outputText( '"<i>My name\'s Marble, what\'s yours?</i>" she asks you.  You introduce yourself and exchange a few pleasantries before she asks how she can help you.  You tell her that you actually came to help her, explaining that Whitney said she could use a gentle touch.  "<i>Oh that would be nice</i>", she says "<i>Spending the night connected to the milking machine was a mistake, and now I need something gentle.</i>"  How will you help her?', false );
		//- CoC.getInstance().player chooses caress, suckle, or rape;
		EngineCore.choices( 'Caress', this.caressMarble, 'Suckle', this.suckleMarble, 'Rape', this.rapeDAHMARBLEZ, '', null, '', null );
	};
	MarbleScene.prototype.marblePicksYouUpInitially = function() {
		EngineCore.spriteSelect( 41 );
		//(CoC.getInstance().player chose don't resist);
		EngineCore.outputText( '', true );
	...
	MarbleScene.prototype.encounterMarbleExploring = function() {
		...
		//[CoC.getInstance().player height < 5 feet];
		if( CoC.getInstance().player.tallness < 60 ) {
		...
		//[CoC.getInstance().player hight >= 5 feet];
		else {
		...
		//[affection >=30];
			...
			if( CoC.getInstance().player.statusAffectv2( StatusAffects.Marble ) < 40 ) {
				EngineCore.outputText( '\n\nDo you drink her milk?' );
				EngineCore.doYesNo( this.drinkMarbleMilk, this.playerRefusesMarbleMilk );
				//CoC.getInstance().player chooses yes/no;
			}
			//[if addiction is 40 or over] ;
			else {
				EngineCore.outputText( '\n\nYou really want some of that milk and eagerly agree.\n\n', false );
				EngineCore.doNext( this.drinkMarbleMilk );
			}
		}
	};
	//(CoC.getInstance().player chooses yes);
	MarbleScene.prototype.drinkMarbleMilk = function() {
		...
		//[CoC.getInstance().player has animal ears];
		if( CoC.getInstance().player.earType > AppearanceDefs.EARS_HUMAN ) {
		...
		if( CoC.getInstance().player.statusAffectv2( StatusAffects.Marble ) >= 50 ) {
	...
	MarbleScene.prototype.encounterMarbleExploring2 = function() {
		...
		//[CoC.getInstance().player height <5];
		if( CoC.getInstance().player.tallness < 60 ) {
		...
		//[addiction >30];
		if( CoC.getInstance().player.statusAffectv2( StatusAffects.Marble ) > 30 ) {
		...
		//[affection <60];
		if( CoC.getInstance().player.statusAffectv1( StatusAffects.Marble ) < 60 ) {
			...
			if( CoC.getInstance().player.findStatusAffect( StatusAffects.FuckedMarble ) < 0 ) {
				...
				EngineCore.dynStats( 'lus', 10 );
				EngineCore.doYesNo( this.AcceptMarblesSexualAdvances, this.turnDownMarbleSexFirstTime );
			}
			//[affection >=60, CoC.getInstance().player has had sex with Marble];
			else {
				...
				//CoC.getInstance().player chooses yes/no;
				EngineCore.dynStats( 'lus', 10 );
				EngineCore.doYesNo( this.AcceptMarblesSexualAdvances, this.turnDownMarbleSexRepeat );
			}
		}
	};
	//(CoC.getInstance().player chose no, CoC.getInstance().player has not had sex with Marble);
	...
	MarbleScene.prototype.AcceptMarblesSexualAdvances = function() {
		...
		if( CoC.getInstance().player.findStatusAffect( StatusAffects.FuckedMarble ) < 0 ) {
			CoC.getInstance().player.createStatusAffect( StatusAffects.FuckedMarble, 0, 0, 0, 0 );
		}
	...
	MarbleScene.prototype.helpMarble1 = function() {
		...
		if( CoC.getInstance().player.str < 20 ) {
		...
		//[CoC.getInstance().player str >=20, <50];
		if( CoC.getInstance().player.str >= 20 && CoC.getInstance().player.str < 50 ) {
		...
		//[CoC.getInstance().player str >=50, <80];
		if( CoC.getInstance().player.str >= 50 && CoC.getInstance().player.str < 80 ) {
		...
		this.marbleStatusChange( Math.ceil( CoC.getInstance().player.str / 10 ), 0 );
	...
	MarbleScene.prototype.helpMarble2 = function() {
		...
		//[CoC.getInstance().player spd <20] ;
		if( CoC.getInstance().player.spe < 20 ) {
		...
		//[CoC.getInstance().player spd >=20, <50];
		if( CoC.getInstance().player.spe >= 20 && CoC.getInstance().player.spe < 50 ) {
		...
		//[CoC.getInstance().player spd >=50, <80];
		if( CoC.getInstance().player.spe >= 50 && CoC.getInstance().player.spe < 80 ) {
		...
		//[CoC.getInstance().player spd >=80] ;
		if( CoC.getInstance().player.spe >= 80 ) {
		...
		this.marbleStatusChange( Math.ceil( CoC.getInstance().player.spe / 10 ), 0 );
		//(increase player lust);
		EngineCore.dynStats( 'lus', 10 );
		if( this.afterMarbleHelp() ) {
			return;
	...
	MarbleScene.prototype.afterMarbleHelp = function() {
		...
		if( CoC.getInstance().player.statusAffectv2( StatusAffects.Marble ) >= 40 ) {
			...
			if( CoC.getInstance().player.inte < 40 && Utils.rand( 2 ) === 0 ) {
			...
			//[CoC.getInstance().player succeeds the int check] ;
			else {
	...
	MarbleScene.prototype.marbleAddiction = function( newPage ) {
		...
		EngineCore.doYesNo( this.wantMarbleAddiction, this.doNotWantMarbleAddiction );
	};
	//(CoC.getInstance().player chose want);
	...
	//[CoC.getInstance().player goes to the farm while suffering from withdrawal];
	...
	MarbleScene.prototype.addictedEncounterHappy = function( clearS ) {
		...
		if( CoC.getInstance().player.findStatusAffect( StatusAffects.MalonVisitedPostAddiction ) < 0 ) {
			...
			//- CoC.getInstance().player chooses yes/no;
			EngineCore.doYesNo( this.playerAgreesToDrinkMarbleMilkBottled, this.playerRefusesToDrinkBottledMilk );
			CoC.getInstance().player.createStatusAffect( StatusAffects.MalonVisitedPostAddiction, 0, 0, 0, 0 );
		}
		//Return visits;
		else {
			...
			if( Utils.rand( 2 ) === 0 ) {
				...
				if( CoC.getInstance().player.inte >= 40 ) {
					...
					//- CoC.getInstance().player chooses yes/no;
					EngineCore.doYesNo( this.playerDrinksMarbleMilk, this.playerDeclinesToDrinkMarbleMilk );
				} else {
					//DRINK MILK;
			...
			//Addiction event version 2:;
				...
				//CoC.getInstance().player chooses milk / Marble / refuse;
				EngineCore.choices( 'Marble', this.marbleChoreHelpChooseMarble, 'Milk', this.marbleChoreHelpChooseMilk, '', null, '', null, 'Refuse', this.marbleChoreRefusal );
			}
		}
	};
	//(CoC.getInstance().player chose yes to drink bottled milk);
	MarbleScene.prototype.playerAgreesToDrinkMarbleMilkBottled = function() {
		...
		if( CoC.getInstance().player.findStatusAffect( StatusAffects.BottledMilk ) >= 0 ) {
			CoC.getInstance().player.addStatusValue( StatusAffects.BottledMilk, 1, (3 + Utils.rand( 6 )) );
		} else {
	...
	//(CoC.getInstance().player chose Marble);
	...
	MarbleScene.prototype.encounterMarbleAshamedAddiction = function( clearS ) {
		...
		if( CoC.getInstance().player.findStatusAffect( StatusAffects.MalonVisitedPostAddiction ) < 0 ) {
			...
			//- CoC.getInstance().player chooses blame her or comfort her;
			EngineCore.choices( 'Comfort', this.AshamedAddictionComfort, 'Blame', this.AshamedAddictionBlame, '', null, '', null, '', null );
			CoC.getInstance().player.createStatusAffect( StatusAffects.MalonVisitedPostAddiction, 0, 0, 0, 0 );
			return;
		}
		//REPEAT;
		...
		if( Utils.rand( 2 ) === 0 ) {
			...
			//- CoC.getInstance().player chooses fight / give in;
			EngineCore.choices( 'Resist', this.resistAddiction, 'Give In', this.addictionGiveIn, '', null, '', null, '', null );
		}
		//Addiction event version 2:;
		else {
			...
			//- CoC.getInstance().player chooses dump it / refuse / beg;
			EngineCore.choices( 'Dump It', this.dumpMarblesMilk, 'Refuse', this.refuseMarblesMilkAddiction, 'Beg For It', this.ashamedAddictionBegForIt, '', null, '', null );
		}
	};
	//(CoC.getInstance().player chose to blame her);
	...
	MarbleScene.prototype.AshamedAddictionComfort = function() {
		...
		//[CoC.getInstance().player height less than 5 feet];
		if( CoC.getInstance().player.tallness < 60 ) {
		...
		//[CoC.getInstance().player height greater than or equal to 5 feet];
		else {
	...
	MarbleScene.prototype.resistAddiction = function() {
		EngineCore.spriteSelect( 41 );
		//(CoC.getInstance().player fight it);
		EngineCore.outputText( '', true );
	...
	MarbleScene.prototype.postAddictionFarmExplorings = function() {
		...
		//[CoC.getInstance().player is no longer addicted];
	...
	MarbleScene.prototype.extendedMurbelFarmTalkz = function() {
		//--- First Conversation ---;
		switch( CoC.getInstance().flags[ kFLAGS.MURBLE_FARM_TALK_LEVELS ] ) {
			case 0:
				...
				else if( CoC.getInstance().player.race() === 'cow-morph' || CoC.getInstance().player.race() === 'cow-boy' ) {
				...
				//[if PC is a dogmorph] ;
				else if( CoC.getInstance().player.race() === 'dog-morph' ) {
					...
					EngineCore.outputText( '  "<i>It\'s very rare that we get a ' + CoC.getInstance().player.race() + ' here.  Are you from around these parts?</i>"' );
				}
			...
			case 4:
				...
				if( CoC.getInstance().player.statusAffectv3( StatusAffects.Marble ) === 2 || CoC.getInstance().player.findPerk( PerkLib.MarbleResistant ) >= 0 ) {
				...
				else if( CoC.getInstance().player.statusAffectv3( StatusAffects.Marble ) === 1 || CoC.getInstance().player.findPerk( PerkLib.MarblesMilk ) >= 0 ) {
			...
			case 5:
				...
				if( CoC.getInstance().player.findPerk( PerkLib.HistorySlut ) >= 0 || CoC.getInstance().player.findPerk( PerkLib.HistoryWhore ) >= 0 ) {
			...
			default:
				...
				if( CoC.getInstance().player.findStatusAffect( StatusAffects.CampMarble ) < 0 ) {
					...
					if( CoC.getInstance().player.statusAffectv3( StatusAffects.Marble ) === 2 ) {
					...
					else if( CoC.getInstance().player.statusAffectv3( StatusAffects.Marble ) === 1 ) {
		...
		CoC.getInstance().flags[ kFLAGS.MURBLE_FARM_TALK_LEVELS ]++;
	};
	...
	MarbleScene.prototype.postAddictionCampMornings = function( extra ) {
		...
		if( !CoC.getInstance().player.hasItem( ConsumableLib.M__MILK, 5 ) ) {
	...
	MarbleScene.prototype.standardSex = function( newpage ) {
		...
		//OH GOD MISSIONARIES?;
		//(Standard sex, CoC.getInstance().player has genitals, position: player lies on top of Marble);
		...
		if( CoC.getInstance().player.gender > 0 ) {
			...
			//(CoC.getInstance().player is wearing fetish gear)		;
			if( CoC.getInstance().player.armorName === 'bondage patient clothes' ||
				CoC.getInstance().player.armorName === 'crotch-revealing clothes' || CoC.getInstance().player.armorName === 'cute servant\'s clothes' ||
				CoC.getInstance().player.armorName === 'maid\'s clothes' || CoC.getInstance().player.armorName === 'servant\'s clothes' ) {
				EngineCore.outputText( 'You smirk at her and demonstrate just how easy it is to get at your genitals while wearing this outfit.  But you decide to not disappoint her, making a show of removing your ' + CoC.getInstance().player.armorName + ' and pretending to have some modestly when you show off your ', false );
				//[CoC.getInstance().player has at least one dick];
				if( CoC.getInstance().player.totalCocks() > 0 ) {
					EngineCore.outputText( Descriptors.multiCockDescriptLight(), false );
					//CoC.getInstance().player has at least one dick and a vagina];
					if( CoC.getInstance().player.vaginas.length > 0 ) {
						EngineCore.outputText( ' and your ', false );
					}
				}
				//[CoC.getInstance().player has a vagina];
				if( CoC.getInstance().player.vaginas.length > 0 ) {
			...
			//(CoC.getInstance().player is not wearing fetish gear);
			else {
				EngineCore.outputText( 'You smile in return and begin removing your ' + CoC.getInstance().player.armorName + ' from your body.  You start by slowly slipping off your top to reveal your ' + Descriptors.allBreastsDescript() + ', ', false );
				//[player's breasts are at least B cup];
				if( CoC.getInstance().player.biggestTitSize() >= 2 ) {
					EngineCore.outputText( 'running one of your hands down them before continuing.', false );
				}//[CoC.getInstance().player has small or no breasts];
				else {
			...
			//(CoC.getInstance().player is a herm);
			if( CoC.getInstance().player.gender === 3 ) {
				...
				EngineCore.menu();
				EngineCore.addButton( 0, 'Maleness', this.marbleSex2Continued, -1 );
				EngineCore.addButton( 1, 'Female', this.marbleSex2Continued, -2 );
				return;
			}
			//male;
	...
	MarbleScene.prototype.marbleSex2Continued = function( genders ) {
		...
		//(CoC.getInstance().player is male);
		if( genders === 1 ) {
			...
			//[CoC.getInstance().player is between 4 and 5 feet in height];
			if( CoC.getInstance().player.tallness < 60 && CoC.getInstance().player.tallness >= 48 ) {
				EngineCore.outputText( 'keeping your head tightly locked between her breasts.  ', false );
			}
			//[CoC.getInstance().player is not between 4 and 5 feet in height] ;
			else {
			...
			//[CoC.getInstance().player has a knot and is not more than 8 inches long];
			if( CoC.getInstance().player.cocks[ 0 ].cockLength < 8 && CoC.getInstance().player.hasKnot( 0 ) ) {
		...
		//(CoC.getInstance().player is female, I hope I did this right, I'm not familiar with the exact mechanics of female/female toys);
		else {
			...
			CoC.getInstance().player.cuntChange( 8, true );
		}
		//(first time sex);
		if( CoC.getInstance().player.findStatusAffect( StatusAffects.FuckedMarble ) < 0 ) {
	...
	//(Milk sex, CoC.getInstance().player has genitals, position: Marble sits on the player);
	...
	MarbleScene.prototype.marbleMilkSex = function( newpage ) {
		...
		//[CoC.getInstance().player is not wearing fetish gear];
			...
			EngineCore.outputText( 'She moves first and pulls open your ' + CoC.getInstance().player.armorName + ' to get a view of your equipment.  ', false );
		}
		//(CoC.getInstance().player is male, or a herm);
		if( CoC.getInstance().player.cockTotal() > 0 ) {
			//[CoC.getInstance().player has only human or animal dicks];
			if( CoC.getInstance().player.cockTotal() === CoC.getInstance().player.horseCocks() + CoC.getInstance().player.dogCocks() + CoC.getInstance().player.normalCocks() ) {
			...
			//[CoC.getInstance().player has at least one of a different kind of dick];
			else {
				EngineCore.outputText( 'Marble gives a long hard look before pointing at your ', false );
				_.forEach( [ _.find( CoC.getInstance().player.cocks, function( cock ) {
			...
			//[after either];
			//[CoC.getInstance().player has more than one dick];
		...
		//(CoC.getInstance().player is female);
		else if( CoC.getInstance().player.vaginas.length > 0 ) {
			//[CoC.getInstance().player has sizable breast, C or bigger];
			if( CoC.getInstance().player.biggestTitSize() > 2 ) {
			...
			//[CoC.getInstance().player has smaller then C breasts];
			else {
			...
			if( CoC.getInstance().player.hasFuckableNipples() ) {
				...
				//[CoC.getInstance().player is lactating];
			...
			//[CoC.getInstance().player is neither lactating or has nipplecunts];
			if( CoC.getInstance().player.biggestLactation() <= 1 && !CoC.getInstance().player.hasFuckableNipples() ) {
	...
	MarbleScene.prototype.marbleAddictionSex = function( newpage ) {
		...
		//[CoC.getInstance().player is under 5.5 feet in height];
		...
		//[CoC.getInstance().player is between 5.5 feet and 6.5 feet in height];
		else if( CoC.getInstance().player.tallness < 78 ) {
		...
		//[CoC.getInstance().player is over 6.5 feet in height];
		else {
		...
		if( CoC.getInstance().player.totalCocks() > 0 ) {
			...
			//[CoC.getInstance().player height is between 4 feet and 5 feet];
			if( CoC.getInstance().player.tallness >= 48 && CoC.getInstance().player.tallness <= 60 ) {
		...
		//[CoC.getInstance().player only has a vagina];
		else if( CoC.getInstance().player.vaginas.length > 0 ) {
		...
		//[CoC.getInstance().player height is under 5.5 feet];
		if( CoC.getInstance().player.tallness < 66 ) {
	...
	MarbleScene.prototype.marbleStatusChange = function( affection, addiction, isAddicted ) {
		...
		if( CoC.getInstance().player.findPerk( PerkLib.MarblesMilk ) < 0 && CoC.getInstance().player.findPerk( PerkLib.MarbleResistant ) < 0 ) {
			CoC.getInstance().player.addStatusValue( StatusAffects.Marble, 1, affection );
			CoC.getInstance().player.addStatusValue( StatusAffects.Marble, 2, addiction );
		}
		if( isAddicted !== undefined && isAddicted !== -1 ) {
			CoC.getInstance().player.changeStatusValue( StatusAffects.Marble, 3, isAddicted );
		}

		$log.debug( 'Marble Affection: ' + CoC.getInstance().player.statusAffectv1( StatusAffects.Marble ) );
		$log.debug( 'Marble Addiction: ' + CoC.getInstance().player.statusAffectv2( StatusAffects.Marble ) );
	};
	MarbleScene.prototype.applyMarblesMilk = function() {
		...
		if( CoC.getInstance().player.findStatusAffect( StatusAffects.MarblesMilk ) < 0 ) {
			CoC.getInstance().player.createStatusAffect( StatusAffects.MarblesMilk, 12, 0, 0, 0 );
			if( CoC.getInstance().player.str + 5 > 100 ) {
				str = 100 - CoC.getInstance().player.str;
				if( str < 0 ) {
					str = 0;
				}
			}
			if( CoC.getInstance().player.tou + 10 > 100 ) {
				tou = 100 - CoC.getInstance().player.tou;
				if( tou < 0 ) {
					tou = 0;
				}
			}
			EngineCore.dynStats( 'str', str, 'tou', tou );
			CoC.getInstance().player.changeStatusValue( StatusAffects.MarblesMilk, 2, str );
			CoC.getInstance().player.changeStatusValue( StatusAffects.MarblesMilk, 3, tou );
		} else {
			CoC.getInstance().player.addStatusValue( StatusAffects.MarblesMilk, 1, 12 );
		}
		//Prevent duration from going to high.;
		if( CoC.getInstance().player.statusAffectv1( StatusAffects.MarblesMilk ) > 36 ) {
			CoC.getInstance().player.changeStatusValue( StatusAffects.MarblesMilk, 1, 36 );
		}
	...
	MarbleScene.prototype.interactWithMarbleAtCamp = function() {
		...
		EngineCore.clearOutput();
		if( CoC.getInstance().flags[ kFLAGS.MARBLE_PURIFICATION_STAGE ] !== 2 ) {
		...
		if( CoC.getInstance().player.itemCount( ConsumableLib.M__MILK ) < 5 ) {
			milkEvent = this.gotMilk;
		}
		//Determine if marble has an item for the player;
		if( CoC.getInstance().player.findStatusAffect( StatusAffects.MarbleHasItem ) >= 0 ) {
		...
		EngineCore.choices( 'Appearance', this.marbleAppearance,
			'Talk', this.marbleTalkOverhaul,
			'Present', gatherEvent,
			'Give Item', (this.canGiveItem() ? this.giveItem : null),
			'Get Milk', milkEvent,
			'Release', sexEvent,
			'Playtime', playtime,
	...
	MarbleScene.prototype.marbleTalkOverhaul = function() {
		...
		EngineCore.menu();
		EngineCore.addButton( 0, 'Info', this.marbleInfo );
		if( (CoC.getInstance().flags[ kFLAGS.MARBLE_PURIFICATION_STAGE ] < 5 && CoC.getInstance().flags[ kFLAGS.MARBLE_LUST ] >= 20) || (CoC.getInstance().flags[ kFLAGS.MARBLE_PURIFICATION_STAGE ] >= 5 && CoC.getInstance().flags[ kFLAGS.MARBLE_TIME_SINCE_NURSED_IN_HOURS ] >= 4) ) {
			EngineCore.outputText( '[pg]<b>Marble is fidgeting around uncomfortably, perhaps she needs to be milked?</b>' );
			EngineCore.addButton( 2, 'Milking', this.milkMarble );
		}
		if( CoC.getInstance().player.cor < 50 && CoC.getInstance().player.statusAffectv4( StatusAffects.Marble ) < 60 ) {
			EngineCore.addButton( 1, 'Just Talk', this.talkWithMarbleAtCamp );
		}
		EngineCore.addButton( 9, 'Back', this.interactWithMarbleAtCamp );
		if( CoC.getInstance().flags[ kFLAGS.SLEEP_WITH ] !== 'Marble' ) {
			EngineCore.addButton( 4, 'Sleep With', this.marbleSleepToggle );
		} else {
			EngineCore.addButton( 4, 'Sleep Alone', this.marbleSleepToggle );
		}
	};
	MarbleScene.prototype.marbleSleepToggle = function() {
		...
		if( CoC.getInstance().flags[ kFLAGS.SLEEP_WITH ] !== 'Marble' ) {
			...
			CoC.getInstance().flags[ kFLAGS.SLEEP_WITH ] = 'Marble';
		} else {
		...
		EngineCore.menu();
		EngineCore.addButton( 0, 'Next', this.marbleTalkOverhaul );
	};
	MarbleScene.prototype.sleepWith = function( arg ) {
		CoC.getInstance().flags[ kFLAGS.SLEEP_WITH ] = arg === undefined ? '' : arg;
	};
	//Kid playtime;
	MarbleScene.prototype.marbleKidsPlaytime = function() {
		...
		if( select === 1 ) {
			if( CoC.getInstance().flags[ kFLAGS.MARBLE_KIDS ] === 1 && CoC.getInstance().flags[ kFLAGS.MARBLE_BOYS ] === 1 ) {
				...
				EngineCore.outputText( 'Your daughter immediately clops up to you and jumps into your arms.  "<i>' + CoC.getInstance().player.mf( 'Daddy, daddy', 'Mommy, mommy' ) + '!  Play with me!</i>"  You laugh at the girl in your arms, so young and yet full of energy.  She proceeds to rope you into a grand adventure, where you play the parts of the one who searches for a hero to save their camp, and the monster that has to be stopped, and also the monster\'s hostage that needs to be saved, while she is the great bovine saviour that carries out this grand quest.' );
				EngineCore.outputText( '\n\nThe game finally ends with the bovine saviour victorious over the horde of ravenous monsters  - somewhere along the line it was decided that hostages were no fun and single combat wasn\'t impressive enough, and you exhausted your theatrical skills to provide a bevy of satisfyingly scary faces and growls - and the people of the land (you) rejoicing.  You\'re left a bit tired afterwards, but you certainly don\'t regret having played with your child.' );
			}
		...
		if( select === 4 ) {
			...
			if( CoC.getInstance().flags[ kFLAGS.MARBLE_KIDS ] === 2 ) {
		...
		if( select === 5 ) {
			...
			EngineCore.outputText( '\n\n"<i>' + CoC.getInstance().player.mf( 'Daddy', 'Mommy' ) + '!  Is this it?  Is this it?</i>"' );
			...
			} else if( CoC.getInstance().player.inte < 70 ) {
			...
			EngineCore.outputText( '\n\nYour kids are just a little bit tired from all the work and it doesn\'t seem they\'ll pester Marble much more today.  One of them even grabs you, complaining, "<i>' + CoC.getInstance().player.mf( 'Daddy', 'Mommy' ) + ', I\'m sleepy!</i>"  You pat her head and smile, telling her that you\'ll be home soon enough.' );
	...
	MarbleScene.prototype.breakUpWithMarble = function() {
		...
		//CoC.getInstance().player chooses yes or no, no simply returns to the last menu;
		EngineCore.doYesNo( this.definitelyBreakUpWithWithMarble, this.interactWithMarbleAtCamp );
	};
	//[Yes];
	MarbleScene.prototype.definitelyBreakUpWithWithMarble = function() {
		...
		EngineCore.doNext( EventParser.playerMenu );
		CoC.getInstance().flags[ kFLAGS.BROKE_UP_WITH_MARBLE ] = 1;
	...
	MarbleScene.prototype.talkWithMarbleAtCamp = function() {
		EngineCore.spriteSelect( 41 );
		if( CoC.getInstance().player.findStatusAffect( StatusAffects.MarbleSpecials ) < 0 ) {
			CoC.getInstance().player.createStatusAffect( StatusAffects.MarbleSpecials, 0, 0, 0, 0 );
		}
		EngineCore.doNext( EventParser.playerMenu );
		...
		if( CoC.getInstance().player.findStatusAffect( StatusAffects.MetMarae ) >= 0 && CoC.getInstance().flags[ kFLAGS.MARBLE_CAMPTALK_LEVEL ] < 1 ) {
			...
			//Level up!;
			CoC.getInstance().flags[ kFLAGS.MARBLE_CAMPTALK_LEVEL ] = 1;
		}
		//The player has discovered the factory;
		else if( CoC.getInstance().player.findStatusAffect( StatusAffects.FoundFactory ) >= 0 && CoC.getInstance().flags[ kFLAGS.MARBLE_CAMPTALK_LEVEL ] < 2 ) {
			...
			CoC.getInstance().flags[ kFLAGS.MARBLE_CAMPTALK_LEVEL ] = 2;
		}
		//The player has cleared the factory and shut it down;
		else if( CoC.getInstance().player.findStatusAffect( StatusAffects.DungeonShutDown ) >= 0 && CoC.getInstance().flags[ kFLAGS.MARBLE_CAMPTALK_LEVEL ] < 3 ) {
			...
			CoC.getInstance().flags[ kFLAGS.MARBLE_CAMPTALK_LEVEL ] = 3;
		}
		//The player has met Marae after doing a shutdown of the factory and smashing the controls;
		else if( CoC.getInstance().player.findStatusAffect( StatusAffects.MaraeComplete ) >= 0 && CoC.getInstance().player.findStatusAffect( StatusAffects.FactoryOverload ) < 0 && CoC.getInstance().flags[ kFLAGS.MARBLE_CAMPTALK_LEVEL ] < 4 ) {
			...
			CoC.getInstance().flags[ kFLAGS.MARBLE_CAMPTALK_LEVEL ] = 4;
		}
		//The player has met the corrupted Marae after blowing the storage tanks;
			...
			else if( CoC.getInstance().player.findPerk( PerkLib.MaraesGiftStud ) >= 0 ) {
			...
			if( CoC.getInstance().player.findPerk( PerkLib.MaraesGiftFertility ) < 0 &&
				CoC.getInstance().player.findPerk( PerkLib.MaraesGiftStud ) < 0 ) {
		...
		//(story) Talk about Zetaz's unexplored lair(Z);
		else if( CoC.getInstance().flags[ kFLAGS.DISCOVERED_DUNGEON_2_ZETAZ ] > 0 && CoC.getInstance().flags[ kFLAGS.MARBLE_CAMPTALK_LEVEL ] < 5 ) {
			...
			CoC.getInstance().flags[ kFLAGS.MARBLE_CAMPTALK_LEVEL ] = 5;
		}
		//story) Talk about Tel'Adre(Z);
		else if( CoC.getInstance().player.statusAffectv1( StatusAffects.TelAdre ) >= 1 && CoC.getInstance().flags[ kFLAGS.MARBLE_TELADRE_STORY ] === 0 ) {
			...
			CoC.getInstance().flags[ kFLAGS.MARBLE_TELADRE_STORY ] = 1;
		}
		//(story) Talk about defeating Zetaz(Z);
		else if( CoC.getInstance().flags[ kFLAGS.DEFEATED_ZETAZ ] > 0 && CoC.getInstance().flags[ kFLAGS.MARBLE_CAMPTALK_LEVEL ] < 6 ) {
			...
			CoC.getInstance().flags[ kFLAGS.MARBLE_CAMPTALK_LEVEL ] = 6;
		}
		...
		//If (CoC.getInstance().player has not yet met Marae);
		...
		} else if( CoC.getInstance().player.findStatusAffect( StatusAffects.MetMarae ) >= 0 && CoC.getInstance().player.findStatusAffect( StatusAffects.FoundFactory ) < 0 ) {
			//check if the player is far too weak to go to the factory;
			if( CoC.getInstance().player.level < 3 ) {
		...
		else if( CoC.getInstance().player.findStatusAffect( StatusAffects.FoundFactory ) >= 0 && CoC.getInstance().player.findStatusAffect( StatusAffects.DungeonShutDown ) < 0 ) {
		...
		}//(CoC.getInstance().player has completed the factory but has not returned to Marae);
		else if( CoC.getInstance().player.findStatusAffect( StatusAffects.DungeonShutDown ) >= 0 && CoC.getInstance().player.findStatusAffect( StatusAffects.MaraeComplete ) < 0 && CoC.getInstance().player.findStatusAffect( StatusAffects.MetCorruptMarae ) < 0 ) {
		...
		else if( CoC.getInstance().flags[ kFLAGS.DISCOVERED_DUNGEON_2_ZETAZ ] === 0 || CoC.getInstance().player.statusAffectv1( StatusAffects.TelAdre ) === 0 ) {
		...
		else if( CoC.getInstance().flags[ kFLAGS.DISCOVERED_DUNGEON_2_ZETAZ ] === 0 && CoC.getInstance().player.statusAffectv1( StatusAffects.TelAdre ) >= 1 ) {
		...
		else if( CoC.getInstance().flags[ kFLAGS.DISCOVERED_DUNGEON_2_ZETAZ ] > 0 && CoC.getInstance().flags[ kFLAGS.DEFEATED_ZETAZ ] === 0 ) {
		...
		EngineCore.doNext( this.interactWithMarbleAtCamp );
	};
	...
	MarbleScene.prototype.canGiveItem = function() {
		if( CoC.getInstance().player.hasItem( ConsumableLib.OVIELIX, 1 ) ) {
			return true;
		}
		if( CoC.getInstance().flags[ kFLAGS.MARBLE_DICK_TYPE ] === 0 ) {
			if( CoC.getInstance().player.hasItem( ConsumableLib.P_DRAFT, 1 ) ) {
				return true;
			} else if( CoC.getInstance().flags[ kFLAGS.MARBLE_DICK_TYPE ] > 0 ) {
				if( CoC.getInstance().player.hasItem( ConsumableLib.PINKEGG, 1 ) ) {
					return true;
				}
				if( CoC.getInstance().player.hasItem( ConsumableLib.L_PNKEG, 1 ) ) {
					return true;
				}
			}
		}
		if( CoC.getInstance().player.hasItem( ConsumableLib.PROBOVA, 1 ) && CoC.getInstance().flags[ kFLAGS.MARBLE_BOVA_LEVEL ] < 2 ) {
			return true;
		}
	...
	MarbleScene.prototype.giveItem = function() {
		...
		EngineCore.menu();
		if( CoC.getInstance().player.hasItem( ConsumableLib.OVIELIX, 1 ) ) {
			EngineCore.addButton( 1, 'OviElixir', this.marbleOvulatesLikeMadDawg );
		}
		if( CoC.getInstance().flags[ kFLAGS.MARBLE_DICK_TYPE ] === 0 ) {
			if( CoC.getInstance().player.hasItem( ConsumableLib.P_DRAFT, 1 ) ) {
				EngineCore.addButton( 2, 'P.Incub Dr', this.MarbleDigsDraftsYo );
			} else if( CoC.getInstance().flags[ kFLAGS.MARBLE_DICK_TYPE ] > 0 ) {
				if( CoC.getInstance().player.hasItem( ConsumableLib.PINKEGG, 1 ) ) {
					EngineCore.addButton( 3, 'Pink Egg', this.MarblepinkEgg );
				}
				if( CoC.getInstance().player.hasItem( ConsumableLib.L_PNKEG, 1 ) ) {
					EngineCore.addButton( 4, 'L.Pink Egg', this.MarbleLPinkEgg );
				}
			}
		}
		if( CoC.getInstance().player.hasItem( ConsumableLib.PROBOVA, 1 ) && CoC.getInstance().flags[ kFLAGS.MARBLE_BOVA_LEVEL ] < 2 ) {
	...
	MarbleScene.prototype.marbleCampSexNew = function() {
		...
		if( !CoC.getInstance().player.isNaga() ) {
			//Feeding;
			if( CoC.getInstance().player.findPerk( PerkLib.MarblesMilk ) >= 0 && CoC.getInstance().player.gender > 0 && Utils.rand( 2 ) === 0 ) {
				...
				if( CoC.getInstance().player.hasCock() ) {
					...
					//( [Female Marble];
					if( CoC.getInstance().flags[ kFLAGS.MARBLE_DICK_LENGTH ] === 0 ) {
			...
			//ORAL;
			else if( Utils.rand( 2 ) === 0 && CoC.getInstance().player.gender > 0 ) {
				EngineCore.clearOutput();
				...
				if( CoC.getInstance().player.hasCock() ) {
					EngineCore.outputText( 'a tent growing in your ' + CoC.getInstance().player.armorName );
				} else if( CoC.getInstance().player.hasVagina() ) {
					EngineCore.outputText( 'a moistness growing under your ' + CoC.getInstance().player.armorName );
				}
				...
				if( CoC.getInstance().player.cor + CoC.getInstance().player.statusAffectv4( StatusAffects.Marble ) < 66 ) {
					EngineCore.outputText( 'The two of you find a secluded place in the camp and slip off your clothes.\n\n', false );
				} else if( CoC.getInstance().player.cor + CoC.getInstance().player.statusAffectv4( StatusAffects.Marble ) < 132 ) {
				...
				if( CoC.getInstance().player.vaginas.length > 0 ) {
					...
					} else if( CoC.getInstance().player.vaginas[ 0 ].vaginalWetness < 5 ) {
		...
		//NAGAS;
			...
			EngineCore.outputText( '.  "<i>Why, you shameless ' + CoC.getInstance().player.mf( 'pervert', 'hussy' ) + '!</i>" the cow-girl says in mock-offense, winking at you.' );
	...
	MarbleScene.prototype.marbleNips = function() {
		if( CoC.getInstance().player.findStatusAffect( StatusAffects.MarbleSpecials ) < 0 ) {
			CoC.getInstance().player.createStatusAffect( StatusAffects.MarbleSpecials, 0, 1, 0, 0 );
		}
		//Set nipples to 1 if uninitialized;
		if( CoC.getInstance().player.statusAffectv2( StatusAffects.MarbleSpecials ) === 0 ) {
			CoC.getInstance().player.changeStatusValue( StatusAffects.MarbleSpecials, 2, 1 );
		}
		if( CoC.getInstance().player.statusAffectv2( StatusAffects.MarbleSpecials ) === 1 ) {
			return 'nipples';
		}
	...
	MarbleScene.prototype.marbleCock = function() {
		...
		if( Math.ceil( Math.random() * 3 ) === 0 ) {
			if( CoC.getInstance().flags[ kFLAGS.MARBLE_DICK_LENGTH ] < 3 ) {
				descript = 'squat ';
			}
			if( CoC.getInstance().flags[ kFLAGS.MARBLE_DICK_LENGTH ] >= 3 && CoC.getInstance().flags[ kFLAGS.MARBLE_DICK_LENGTH ] < 5 ) {
				descript = 'short ';
			}
			if( CoC.getInstance().flags[ kFLAGS.MARBLE_DICK_LENGTH ] >= 5 && CoC.getInstance().flags[ kFLAGS.MARBLE_DICK_LENGTH ] < 7 ) {
				descript = 'average ';
			}
			if( CoC.getInstance().flags[ kFLAGS.MARBLE_DICK_LENGTH ] >= 7 && CoC.getInstance().flags[ kFLAGS.MARBLE_DICK_LENGTH ] < 9 ) {
				descript = 'long ';
			}
			if( CoC.getInstance().flags[ kFLAGS.MARBLE_DICK_LENGTH ] >= 10 && CoC.getInstance().flags[ kFLAGS.MARBLE_DICK_LENGTH ] < 13 ) {
				descript = 'huge ';
			}
			if( CoC.getInstance().flags[ kFLAGS.MARBLE_DICK_LENGTH ] >= 13 && CoC.getInstance().flags[ kFLAGS.MARBLE_DICK_LENGTH ] < 18 ) {
				descript = 'massive ';
			}
			if( CoC.getInstance().flags[ kFLAGS.MARBLE_DICK_LENGTH ] >= 18 && CoC.getInstance().flags[ kFLAGS.MARBLE_DICK_LENGTH ] < 30 ) {
				descript = 'enormous ';
			}
			if( CoC.getInstance().flags[ kFLAGS.MARBLE_DICK_LENGTH ] >= 30 ) {
				descript = 'towering ';
			}
		}
		...
		if( Math.ceil( Math.random() * 3 ) === 0 ) {
			...
			if( CoC.getInstance().flags[ kFLAGS.MARBLE_DICK_THICKNESS ] <= 0.75 ) {
				descript += 'narrow ';
			}
			if( CoC.getInstance().flags[ kFLAGS.MARBLE_DICK_THICKNESS ] > 1 && CoC.getInstance().flags[ kFLAGS.MARBLE_DICK_THICKNESS ] <= 1.4 ) {
				descript += 'ample ';
			}
			if( CoC.getInstance().flags[ kFLAGS.MARBLE_DICK_THICKNESS ] > 1.4 && CoC.getInstance().flags[ kFLAGS.MARBLE_DICK_THICKNESS ] <= 2 ) {
				descript += 'broad ';
			}
			if( CoC.getInstance().flags[ kFLAGS.MARBLE_DICK_THICKNESS ] > 2 && CoC.getInstance().flags[ kFLAGS.MARBLE_DICK_THICKNESS ] <= 3.5 ) {
				descript += 'fat ';
			}
			if( CoC.getInstance().flags[ kFLAGS.MARBLE_DICK_THICKNESS ] > 3.5 ) {
				descript += 'distended ';
			}
		}
	...
	MarbleScene.prototype.rapeDAHMARBLEZ = function() {
		...
		if( raped ) {
			...
			CoC.getInstance().player.takeDamage( 9001 );
	...
	//Follow up fight;
	//CoC.getInstance().player spots Marble while exploring the farm;
	MarbleScene.prototype.marbleAfterRapeBattle = function() {
		...
		//CoC.getInstance().player decides if they want to confront her or not;
		//Choose yes/no;
		EngineCore.doYesNo( this.marbleAfterRapeYes, this.marbleAfterRapeNo );
	};
	...
	MarbleScene.prototype.marbleAfterRapeYes = function() {
		...
		//Choose yes/no;
		EngineCore.doYesNo( this.marbleAfterRapeStartFight, this.marbleAfterRapeNo );
	};
	...
	MarbleScene.prototype.marbleBadEndFollowup = function() {
		...
		if( CoC.getInstance().player.horseScore() >= 3 ) {
			if( CoC.getInstance().player.lowerBody === AppearanceDefs.LOWER_BODY_TYPE_CENTAUR ) {
				morph = 'centaur-morph';
			} else {
				morph = 'equine-morph';
		...
		if( CoC.getInstance().player.mutantScore() >= 5 ) {
			morph = 'corrupted mutant';
		}
		if( CoC.getInstance().player.minoScore() >= 4 ) {
		...
		if( CoC.getInstance().player.beeScore() >= 4 ) {
			morph = 'bee-morph';
		}
		if( CoC.getInstance().player.goblinScore() >= 5 ) {
			morph = 'goblin';
		}
		if( CoC.getInstance().player.humanScore() >= 5 && morph === 'corrupted mutant' ) {
		...
		var approxHeight = '';
		if( CoC.getInstance().player.tallness < 54 ) {
			approxHeight = 'very short';
		} else if( CoC.getInstance().player.tallness < 66 ) {
			approxHeight = 'short';
		} else if( CoC.getInstance().player.tallness < 72 ) {
		...
		if( morph === 'human' ) {
			...
			EngineCore.outputText( CoC.getInstance().player.maleFemale() + ' human leaning against one of the barn doors in a farm hand outfit.  It looks like ' + CoC.getInstance().player.heShe() + '\'s taking a break from something.  With a big smile on his face, the young champion strides up to ' + CoC.getInstance().player.himHer() + ' and says, "<i>Hello there, it\'s rare to see a human in this world.</i>"  The other looks up at him for a few moments before smiling in recognition and saying "<i>So they picked you to go after me, huh?</i>"  The young champion stared at the ' + CoC.getInstance().player.manWoman() + ' for a few moments, unable to answer, this was better than he could have ever hoped for!  He was looking at last year\'s champion, ' + CoC.getInstance().player.short + '!\n\n', false );
			EngineCore.outputText( '"<i>I\'m so glad to have found a friend like you in this world, ' + CoC.getInstance().player.short + '. ', false );
		}
		//that's no human!;
		else {
			EngineCore.outputText( 'However, he is rather surprised to see a ' + CoC.getInstance().player.maleFemale() + ' ' + morph + ' leaning against the barn wall next to the entrance.  The young champion approaches the ' + morph + ' with a little trepidation and calls out to them <i>"Hello there, uh, Whitney said I might know you.</i>"  The ' + morph + ' looks up at him for a few moments before smiling in recognition and saying "<i>So they picked you next, huh?</i>"  The young champion starts at this declaration.  "<i>How do you know who I am?</i>" he demands indignantly, "<i>What do you know about my home?</i>" the other chuckles and says, "<i>I\'m ' + CoC.getInstance().player.short + ', despite my form, I\'m still the same person.  Being able to change is one of the joys of this messed up world.</i>"  The young champion looks uncertainly at them for a few moments before realizing that the ' + morph + ' is telling the truth!\n\n', false );
			EngineCore.outputText( '"<i>You really are ' + CoC.getInstance().player.short + '!  I can\'t believe you left your humanity behind, but I\'m glad to have found a friend in this world.  ', false );
		}
		...
		if( CoC.getInstance().player.gender === 1 || CoC.getInstance().player.gender === 3 ) {
			...
			//mysterious baby?;
			if( CoC.getInstance().player.gender === 3 && CoC.getInstance().player.biggestTitSize() >= 2 && CoC.getInstance().player.biggestCockArea() < 15 ) {
	...
	//if(CoC.getInstance().flags[kFLAGS.MARBLE_PREGNACY_INCUBATION] === 1);
	MarbleScene.prototype.marblePoopsBaybees = function() {
		...
		if( this.pregnancy.type === PregnancyStore.PREGNANCY_PLAYER ) {
			...
			if( CoC.getInstance().flags[ kFLAGS.MARBLE_PURIFIED ] > 0 && Utils.rand( 2 ) === 0 ) {
				...
				if( CoC.getInstance().flags[ kFLAGS.MARBLE_BOYS ] === 0 ) {
				...
				CoC.getInstance().flags[ kFLAGS.MARBLE_BOYS ]++;  //again, n is the flag for the number of male kids Marble has had
			} else {
			...
			CoC.getInstance().flags[ kFLAGS.MARBLE_KIDS ]++;
			EngineCore.doNext( EventParser.playerMenu );
		}
		//Eggs;
	...
	MarbleScene.prototype.marbleNightSleepFlavor = function() {
		...
		if( CoC.getInstance().flags[ kFLAGS.MARBLE_NURSERY_CONSTRUCTION ] === 0 && CoC.getInstance().player.pregnancyType === PregnancyStore.PREGNANCY_MARBLE && (CoC.getInstance().player.pregnancyIncubation <= 128) ) {
		...
		switch( this.pregnancy.eventTriggered() ) {
			...
			case 4:
				...
				if( CoC.getInstance().flags[ kFLAGS.MARBLE_NURSERY_CONSTRUCTION ] === 0 && this.pregnancy.type !== PregnancyStore.PREGNANCY_OVIELIXIR_EGGS ) {
					CoC.getInstance().flags[ kFLAGS.MARBLE_NURSERY_CONSTRUCTION ]++;
		...
		//Marble 60+ & CoC.getInstance().player 20+ - service;
		//boring;
		//PC has worms kills everything.;
		if( CoC.getInstance().player.findStatusAffect( StatusAffects.Infested ) >= 0 ) {
			if( CoC.getInstance().flags[ kFLAGS.MARBLE_GROSSED_OUT_BECAUSE_WORM_INFESTATION ] !== 1 ) {
				EngineCore.outputText( 'As you go to lie down for the night, you find that Marble has gotten there before you.  You lie down next to her, but you can\'t help wishing that the two of you could have sex.  Suddenly, you feel Marble\'s hand grab ahold of your ' + Descriptors.cockDescript( 0 ) + '.  She gives a bit of a squeal as one of the worms starts to move around inside the shaft.  She pulls open the blankets and looks closely at your dick for a few moments before picking up her bedroll and moving to a different part of the camp saying, "<i>' + CoC.getInstance().player.short + ', you get rid of those or I\'m not going to sleep next to you or with you.</i>"\n\n', false );
				CoC.getInstance().flags[ kFLAGS.MARBLE_GROSSED_OUT_BECAUSE_WORM_INFESTATION ] = 1;
			}
			return false;
		}
		...
		if( CoC.getInstance().player.gender === 0 ) {
			...
			return false;
		} else if( CoC.getInstance().flags[ kFLAGS.MARBLE_LUST ] < 50 || CoC.getInstance().player.gender === 0 ) {
			...
			if( CoC.getInstance().player.lust < 33 && CoC.getInstance().flags[ kFLAGS.MARBLE_LUST ] < 20 ) {
		...
		//Replaces laying down texts when Marble is at or over 50 lust;
			...
			if( CoC.getInstance().player.lust < 33 ) {
				...
				if( CoC.getInstance().player.isNaga() && CoC.getInstance().flags[ kFLAGS.MARBLE_DICK_LENGTH ] > 0 ) {
	...
	MarbleScene.prototype.pcPregWithMarblesKids = function() {
		return CoC.getInstance().player.pregnancyType === PregnancyStore.PREGNANCY_MARBLE && CoC.getInstance().player.pregnancyIncubation <= 280;
	};
	...
	MarbleScene.prototype.marbleNightSexIntro = function( clear ) {
		...
		var x = CoC.getInstance().player.cockThatFits( this.marbleCuntCapacity() );
		if( x < 0 ) {
			x = 0;
		}
		//No sex if dude and too big!;
		else if( CoC.getInstance().player.gender === 1 && CoC.getInstance().player.cockArea( x ) > this.marbleCuntCapacity() ) {
		...
		//If (CoC.getInstance().player is a herm, and their dick can fit inside Marble);
		if( CoC.getInstance().player.gender === 3 ) {
			if( CoC.getInstance().player.cockArea( x ) <= this.marbleCuntCapacity() ) {
				...
				EngineCore.choices( 'Dick', this.marbleNightSexDudes, 'Vagina', this.marbleNightSexChicks, '', null, '', null, '', null );
			} else {
				...
				EngineCore.doNext( this.marbleNightSexChicks );
			}
		} else {
			//Go to next scene based on the PC's and Marble's attributes;
			//DUDEZ;
			if( CoC.getInstance().player.gender === 1 ) {
				EngineCore.doNext( this.marbleNightSexDudes );
			}
			//CHICKZ;
			else {
				EngineCore.doNext( this.marbleNightSexChicks );
	...
	MarbleScene.prototype.marbleNightSexDudes = function() {
		...
		if( CoC.getInstance().player.cocks[ x ].cockLength > 8 ) {
		...
		if( CoC.getInstance().player.cor + CoC.getInstance().player.lib < CoC.getInstance().player.statusAffectv4( StatusAffects.Marble ) + 10 ) {
	...
	MarbleScene.prototype.marbleNightSexChicks = function() {
		...
		if( CoC.getInstance().flags[ kFLAGS.MARBLE_DICK_TYPE ] === 0 ) {
			...
			CoC.getInstance().player.cuntChange( 14, true );
		...
		//PC is female, Marble is a herm;
			...
			//is she satisfied?;
			//If (CoC.getInstance().player can fit all of her cock and PC is not a virgin) {;
			if( CoC.getInstance().player.vaginalCapacity() > CoC.getInstance().flags[ kFLAGS.MARBLE_DICK_LENGTH ] * CoC.getInstance().flags[ kFLAGS.MARBLE_DICK_THICKNESS ] ) {
			...
			CoC.getInstance().player.cuntChange( CoC.getInstance().flags[ kFLAGS.MARBLE_DICK_THICKNESS ] * CoC.getInstance().flags[ kFLAGS.MARBLE_DICK_LENGTH ], true );
		}
		this.marbleSexFinish();
	};
	MarbleScene.prototype.marblePreggoChance = function( preggerMult ) {
		...
		var preggerOdds = 10;
		//Count cum quantity;
		preggerOdds += CoC.getInstance().player.cumQ() / 100;
		//Capped at 20;
		if( preggerOdds > 20 ) {
			preggerOdds = 20;
		}
		//Fertility+ perk bumps odds to 25.;
		if( CoC.getInstance().player.findPerk( PerkLib.FertilityPlus ) >= 0 ) {
			preggerOdds += 5;
		}
		...
		if( Utils.rand( 100 ) < preggerOdds && (CoC.getInstance().player.findPerk( PerkLib.MarblesMilk ) >= 0 || CoC.getInstance().flags[ kFLAGS.MARBLE_PURIFICATION_STAGE ] >= 5) ) {
	...
	MarbleScene.prototype.marbleNomNoms = function() {
		...
		if( CoC.getInstance().flags[ kFLAGS.MARBLE_DICK_TYPE ] > 0 ) {
			...
			if( CoC.getInstance().player.findStatusAffect( StatusAffects.SlimeCraving ) >= 0 || CoC.getInstance().player.lib + CoC.getInstance().player.cor - CoC.getInstance().player.inte > 35 ) {
		...
		EngineCore.dynStats( 'lus', Utils.rand( 10 ) + CoC.getInstance().player.lib / 10 );
		EngineCore.doNext( EventParser.playerMenu );
	};
	...
	MarbleScene.prototype.MarbleDigsDraftsYo = function() {
		...
		if( CoC.getInstance().player.statusAffectv4( StatusAffects.Marble ) > 60 ) {
	...
	MarbleScene.prototype.marbleCuntCapacity = function() {
		...
		if( CoC.getInstance().flags[ kFLAGS.MARBLE_BOVA_LEVEL ] >= 2 ) {
			size += 20;
		}
		if( CoC.getInstance().flags[ kFLAGS.MARBLE_KIDS ] > 0 ) {
			size += 14;
	...
	MarbleScene.prototype.giveMurbleProBova = function() {
		...
		if( CoC.getInstance().flags[ kFLAGS.MARBLE_BOVA_LEVEL ] === 0 ) {
			...
			//CoC.getInstance().player chooses yes/no;
			EngineCore.doYesNo( this.giveMarbleTheProBovas4Sho, this.giveItem );
		} else {
	...
	MarbleScene.prototype.giveMarbleTheProBovas4Sho = function() {
		EngineCore.clearOutput();
		EngineCore.spriteSelect( 41 );
		CoC.getInstance().player.consumeItem( ConsumableLib.PROBOVA );
		if( CoC.getInstance().flags[ kFLAGS.MARBLE_BOVA_LEVEL ] === 0 ) {
			...
			CoC.getInstance().flags[ kFLAGS.MARBLE_BOVA_LEVEL ] = 1;
	...
	MarbleScene.prototype.marbleAppearance = function() {
		...
		} else if( CoC.getInstance().flags[ kFLAGS.MARBLE_BOVA_LEVEL ] === 1 ) {
		...
		if( CoC.getInstance().player.statusAffectv4( StatusAffects.Marble ) <= 20 ) {
		...
		} else if( CoC.getInstance().player.statusAffectv4( StatusAffects.Marble ) <= 50 ) {
		...
		if( CoC.getInstance().player.statusAffectv4( StatusAffects.Marble ) <= 15 ) {
		...
		} else if( CoC.getInstance().player.statusAffectv4( StatusAffects.Marble ) <= 25 ) {
		...
		} else if( CoC.getInstance().player.statusAffectv4( StatusAffects.Marble ) <= 35 ) {
		...
		if( CoC.getInstance().flags[ kFLAGS.MARBLE_DICK_TYPE ] > 0 ) {
			EngineCore.outputText( 'She has grown a ' + this.marbleCock() + ' since you brought her to camp. It is ' + Utils.num2Text( Math.ceil( CoC.getInstance().flags[ kFLAGS.MARBLE_DICK_LENGTH ] ) ) + ' inches long and ' + Utils.num2Text( Math.ceil( CoC.getInstance().flags[ kFLAGS.MARBLE_DICK_THICKNESS ] ) ) + ' inches thick.\n\n', false );
		}

		if( CoC.getInstance().player.statusAffectv4( StatusAffects.Marble ) <= 50 ) {
			EngineCore.outputText( 'She has a pussy, with a 0.5 inch clit.\n\n', false );
		} else if( CoC.getInstance().player.statusAffectv4( StatusAffects.Marble ) <= 75 ) {
		...
		if( CoC.getInstance().player.statusAffectv1( StatusAffects.MarbleSpecials ) === 0 ) {
	...
	MarbleScene.prototype.milkMarble = function() {
		EngineCore.clearOutput();
		if( CoC.getInstance().flags[ kFLAGS.MARBLE_MILKED_BEFORE ] < 1 ) {
			...
			CoC.getInstance().flags[ kFLAGS.MARBLE_MILKED_BEFORE ] = 1;
		} else {
		...
		EngineCore.menu();
		EngineCore.addButton( 0, 'Cunnilingus', this.milkMarbleCunnilingling );
		if( CoC.getInstance().player.cockThatFits( this.marbleCuntCapacity() ) >= 0 && (CoC.getInstance().player.isBiped() || CoC.getInstance().player.isNaga() || CoC.getInstance().player.isGoo()) ) {
			EngineCore.addButton( 1, 'Fuck Her', this.milkMarbleFuckDatCowPussy );
		}
		if( CoC.getInstance().player.hasVagina() && CoC.getInstance().flags[ kFLAGS.MARBLE_DICK_TYPE ] > 0 && (CoC.getInstance().player.isBiped() || CoC.getInstance().player.isGoo()) ) {
			EngineCore.addButton( 2, 'Take Her', this.milkMarbleTakeHerDick );
		}
		EngineCore.addButton( 3, 'Her on Bar', this.milkMarbleOnTheBar );
		EngineCore.addButton( 4, 'Leave', this.milkMarbleNoMilking );
	};
	...
	MarbleScene.prototype.milkMarbleFuckDatCowPussy = function() {
		...
		if( (CoC.getInstance().player.findPerk( PerkLib.BulgeArmor ) >= 0 || CoC.getInstance().player.modArmorName === 'backless female teacher\'s clothes' || CoC.getInstance().player.modArmorName === 'bridle bit and saddle set' || CoC.getInstance().player.modArmorName === 'headdress, necklaces, and many body-chains' || CoC.getInstance().player.modArmorName === 'bondage patient clothes' || CoC.getInstance().player.modArmorName === 'crotch-revealing clothes' || CoC.getInstance().player.modArmorName === 'cute servant\'s clothes' || CoC.getInstance().player.modArmorName === 'maid\'s clothes' || CoC.getInstance().player.modArmorName === 'servant\'s clothes') && CoC.getInstance().player.hasCock() ) {
		...
		if( CoC.getInstance().player.tallness < 68 ) {
		...
		if( CoC.getInstance().player.findPerk( PerkLib.MarblesMilk ) >= 0 ) {
			...
			if( CoC.getInstance().player.cor < CoC.getInstance().player.statusAffectv4( StatusAffects.Marble ) ) {
				EngineCore.dynStats( 'cor', 1 );
			}
			...
			this.marblePreggoChance( 1 );
		} else if( CoC.getInstance().player.statusAffectv4( StatusAffects.Marble ) > 30 ) {
	...
	MarbleScene.prototype.milkMarbleTakeHerDick = function() {
		...
		if( CoC.getInstance().player.tallness < 56 ) {
		...
		if( CoC.getInstance().player.buttRating <= 4 && !CoC.getInstance().player.isGoo() ) {
			EngineCore.outputText( 'taut' );
		} else {
			EngineCore.outputText( 'jiggling' );
		}
		EngineCore.outputText( ' flesh while her ' + Utils.num2Text( Math.round( CoC.getInstance().flags[ kFLAGS.MARBLE_DICK_LENGTH ] ) ) + ' inch length continues to push and pull into your womanhood.  Egged on by her enthusiasm, you start putting in some effort into the sex yourself by pushing your backside tight against her with each push forward and shaking it back and forth with each pull out of your interior.' );
	...
	MarbleScene.prototype.milkMarbleOnTheBar = function() {
		...
		if( CoC.getInstance().player.cockThatFits( this.marbleCuntCapacity() ) > 0 ) {
		...
		EngineCore.menu();
		EngineCore.addButton( 0, 'Follow Tail', this.milkMarbleBarFollowTail );
		EngineCore.addButton( 1, 'Cunnilingus', this.milkMarbleBarCunnilingling );
		if( CoC.getInstance().player.cockThatFits( this.marbleCuntCapacity() ) >= 0 ) {
			EngineCore.addButton( 2, 'Pull Tail', this.milkMarbleBarPullTail );
		}
		EngineCore.addButton( 3, 'Leave', this.milkMarbleLeaveAfterBar );
	};

	MarbleScene.prototype.milkMarbleBarFollowTail = function() {
		var x = CoC.getInstance().player.cockThatFits( this.marbleCuntCapacity() );
		var y = CoC.getInstance().player.cockThatFits2( this.marbleCuntCapacity() );
		EngineCore.clearOutput();
	...
	MarbleScene.prototype.milkMarbleBarPullTail = function() {
		...
		if( CoC.getInstance().flags[ kFLAGS.MARBLE_DICK_TYPE ] === 0 ) {
			...
			EngineCore.outputText( '[pg]She forces your mouth open and pushes her hips forward, roughly shoving her ' + Utils.num2Text( Math.round( CoC.getInstance().flags[ kFLAGS.MARBLE_DICK_LENGTH ] ) ) + '-inch cock into your hapless mouth and down your throat.  You choke and sputter in surprise at the sudden suffocation, but it only lasts a few seconds before she pulls back out.' );
			EngineCore.outputText( '[pg]"<i>Aww, was that too rough?  Don\'t worry, I\'ll be a bit more gentle.</i>"' );
