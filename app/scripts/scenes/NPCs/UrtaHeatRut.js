...
angular.module( 'cocjs' ).run( function( SceneLib, MainView, PregnancyStore, AppearanceDefs, Descriptors, CoC, kFLAGS, EngineCore ) {
	...
	UrtaHeatRut.prototype.sateRutWithSoberUrta = function() {
		...
		if( this.urtaQuestDone() ) {
			...
			if( !SceneLib.urta.urtaLove() ) {
				EngineCore.outputText( '"<i>And you had better learn to control yourself, ' + CoC.player.mf( 'mister', 'missy' ) + '.' );
			} else {
				EngineCore.outputText( '"<i>But you should learn to control yourself lover-' + CoC.player.mf( 'boy', 'girl' ) + '.' );
			}
	...
	UrtaHeatRut.prototype.drunkUrtaRidesARutPCsCock = function() {
		...
		if( !SceneLib.urta.urtaLove() ) {
			EngineCore.outputText( 'Show me you\'re ' + CoC.player.mf( 'the man', 'the breeder' ) + ' here!' );
		} else {
		...
		if( !SceneLib.urta.urtaLove() ) {
			...
			EngineCore.outputText( '  "<i>You\'re mine, right?  Right now, you\'re mine and mine alone.  My wonderful virile breeder, all ' + CoC.player.mf( 'his', 'her' ) + ' seed just for me.</i>"' );
		}
