...
angular.module( 'cocjs' ).run( function( SceneLib, MainView, $rootScope, $log, ImageManager, Appearance, CockTypesEnum, PregnancyStore, CoC_Settings, PerkLib, Descriptors, AppearanceDefs, EventParser, CoC, kFLAGS, Utils, StatusAffects, EngineCore ) {
	...
	Urta.prototype.drinkUrtasBoozePtTwo = function() {
		...
		EngineCore.outputText( 'open up your ' + CoC.player.armorName + ', releasing the pressure onto a patch of grass.  It takes forever to stop, but when it does you feel like a million bucks.  You turn and start to close up your kit when you realize you aren\'t alone.  Urta is watching you, her lips parted hungrily.  She\'s still peeing, but what\'s truly shocking is the mammoth package she\'s got hanging between her legs.  It\'s a massive horse-shaft, patterned black and pink, slung down from between a pair of apple-sized balls.  Before your eyes the equine beast begins hardening, forcing the distracted fox to empty the last of her urine against a building\'s wall.  She blushes furiously, but the drunken fox doesn\'t seem to care about her shame...\n\n', false );
	...
	Urta.prototype.drinkUrtasBoozeLetHer = function() {
		...
		EngineCore.outputText( '.  She pulls at your ' + CoC.player.armorName + ' until your crotch is completely exposed and vulnerable, revealing your ' + CoC.player.assholeOrPussy(), false );
		if( CoC.player.cockTotal() > 0 ) {
			EngineCore.outputText( ' and ' + Descriptors.multiCockDescript(), false );
		}
		EngineCore.outputText( '.  Urta snuggles close, brushing her nose along your thighs before plunging her tongue deep into your ' + CoC.player.assholeOrPussy() + ' in one powerful, drunken lick.  She slurps and licks, humming away until you\'re ', false );
		...
		EngineCore.outputText( '\n\n', false );
		EngineCore.outputText( '"<i>Mmmm I shhoulda ushed a condom, you\'re gonna be a messssss!</i>" she cries as she climbs atop her sexual peak, mounting it just like she\'s mounting your ' + CoC.player.assholeOrPussy() + '.  You\'re spread wide, the equine member rammed tightly ', false );
		if( CoC.player.hasVagina() ) {
	...
	Urta.prototype.dualUrtaMasturbation = function() {
		...
		EngineCore.outputText( 'You come out of the shadows, shedding your ' + CoC.player.armorName + '.  ', false );
		...
		if( CoC.player.totalCocks() > 0 ) {
			if( CoC.player.cumQ() < 250 ) {
				...
				EngineCore.outputText( 'your ' + Descriptors.multiCockDescriptLight() + ', blasting into the air before splattering onto the ground between you and Urta.  It forms a massive puddle, spreading as you pump gob after gob of cum into it until the sticky spooge is soaking your ' + CoC.player.legs() + ' and Urta too.', false );
			} else {
	...
	Urta.prototype.urtaFuckHer = function( afterBefriending ) {
		...
		if( CoC.player.totalCocks() === 0 ) {
			...
			EngineCore.outputText( '.  Eventually the blunted tip of Urta\'s horse-cock presses against your ' + CoC.player.assholeOrPussy() + '.  Agonizingly, you force yourself to relax and lower yourself down on the mottled pink and black shaft.\n\n', false );
	...
	Urta.prototype.takeUrtaInTheButtPublically = function() {
		...
		if( CoC.player.cor < 60 && CoC.flags[ kFLAGS.PC_FETISH ] === 0 ) {
			EngineCore.outputText( 'You can\'t believe you\'re doing it, but you undo the lower half of your ' + CoC.player.armorName + '.  ', false );
		} else {
			EngineCore.outputText( 'You happily remove the lower half of your ' + CoC.player.armorName + ', more than a little excited at the prospect of putting on a show for the crowd.  ', false );
		}
		...
		//(NIPPLES:;
		EngineCore.outputText( 'Your ' + Descriptors.nippleDescript( 0 ) + 's tent up under your ' + CoC.player.armorName, false );
		if( CoC.player.hasFuckableNipples() && CoC.player.biggestLactation() >= 1 ) {
			...
			EngineCore.outputText( ', spurting thick streams of milk that soak your ' + CoC.player.armorName + ' and are visible to everyone in the bar.', false );
		} else {
			EngineCore.outputText( '.', false );
		}
		EngineCore.outputText( '\n\n', false );
		...
		if( tooBig ) {
			...
			EngineCore.outputText( 'you find yourself sliding your hands under your ' + CoC.player.armorName + ' and pinching your ' + Descriptors.nippleDescript( 0 ) + 's, putting on a show for the crowd.', false );
		}
		...
		if( CoC.player.biggestTitSize() >= 1 ) {
			...
			if( CoC.player.hasFuckableNipples() ) {
				...
				EngineCore.outputText( 'rubbing your tight nipples against your ' + CoC.player.armorName, false );
			}
			EngineCore.outputText( '.', false );
		}
		if( CoC.player.cockTotal() > 0 ) {
	...
	Urta.prototype.optionalUrtaBukkake = function() {
		...
		EngineCore.outputText( 'You pause to tear off your ' + CoC.player.armorName + ' and expose the rest of your body, and you reach out into the crowd, grabbing the nearest cock and caressing it as you beg, "<i>Come on and cum, she missed most of me!</i>"\n\n', false );
	...
	Urta.prototype.rideUrtaTenderFemale = function() {
		...
		EngineCore.outputText( '  Climbing atop the bed with her, you swivel your ' + Descriptors.hipDescript() + ' about, positioning her at your entrance and straddling your ' + CoC.player.legs() + ' around her.\n\n', false );
		...
		if( CoC.flags[ kFLAGS.TIMES_FUCKED_URTA ] <= 10 || CoC.flags[ kFLAGS.URTA_COMFORTABLE_WITH_OWN_BODY ] < 11 ) {
			...
			EngineCore.outputText( '</i>"<i>You\'re so good to me ' + CoC.player.short + '.  I wish my little pony here was fertile enough for me to put a bun in your oven, if you wanted of course.</i>"', false );
		}
	...
	Urta.prototype.dudeFuckingUrtasCooch = function() {
		...
		EngineCore.outputText( 'Obligingly, you ease your hips forward, reeling at the heat of her cunt-lips as they welcome your ' + Descriptors.cockDescript( 0 ) + '\'s ' + CoC.player.cockHead() + ' with slippery moisture.  ', false );
		if( cocks > 1 && y >= 0 ) {
			EngineCore.outputText( 'Your second ' + Appearance.cockNoun( CoC.player.cocks[ y ].cockType ) + ' soon bumps against her pucker and strains against it, pushing ever-so-slowly into her tight hole as she gradually relaxes before you.  ', false );
		}
	...
	Urta.prototype.tenderTakeItUpTheAssFromUrta = function() {
		...
		if( CoC.player.cumQ() > 750 ) {
			EngineCore.outputText( '  You really are a messy, ' + CoC.player.mf( 'boy', 'girl' ) + ' aren\'t you?', false );
		}
		EngineCore.outputText( '</i>"\n\n', false );
	...
	Urta.prototype.lietoUrtaAboutMarble = function() {
		...
		EngineCore.outputText( '"<i>I misjudged you, ' + CoC.player.short + '.  I didn\'t think you\'d lie to me, and you did.  The scouts talked to her', false );
	...
	Urta.prototype.rideUrtaInButtAtHomeLove = function() {
		...
		//(GENDERLESS ORGAZM);
		if( CoC.player.gender === 0 ) {
			EngineCore.outputText( 'You cry out with pleasure, feeling the closest thing you can to an orgasm.  Your muscles clench around the invading rod, milking it while the rest of your body trembles.  The strength drains from your ' + CoC.player.legs() + ' and arms and you twitch there, completely impaled on your lover\'s thick cock, happily and completely penetrated.\n\n', false );
		}
		//(EVERYBODY ELSE);
		else {
			EngineCore.outputText( 'You cry out with pleasure, feeling your body cum from the invading warmth in your ' + Descriptors.assholeDescript() + '.  Shivering as the strength drains from your arms and ' + CoC.player.legs() + ', you let the intruding and still cumming cock support your body.', false );
			if( CoC.player.hasVagina() ) {
	...
	Urta.prototype.oralFiestyUberExplosionUrta = function() {
		...
		if( CoC.player.gender === 2 || (CoC.player.gender === 3 && Utils.rand( 2 ) === 0) ) {
			...
			EngineCore.outputText( 'The musky scent of Urta\'s forearm-sized horse-prick wafts into your nostrils as it wobbles just below your ' + CoC.player.face() + ', visibly twitching and throbbing from all the extra blood.  She whines plaintively, nuzzling her moist nose against your ', false );
			if( CoC.player.vaginas[ 0 ].vaginalWetness < AppearanceDefs.VAGINA_WETNESS_DROOLING ) {
			...
			EngineCore.outputText( ', clamping your ' + CoC.player.legs() + ' onto Urta\'s head as you orgasm.  ', false );
			if( CoC.player.vaginas[ 0 ].vaginalWetness > AppearanceDefs.VAGINA_WETNESS_DROOLING ) {
		...
		//(DUDEZILLAZ);
		EngineCore.outputText( 'Urta sits up and practically screams, "<i>Really,</i>" and squeals excitedly.  She claps and lies back as you climb into the bed, stopping only to yank off her cock-sheath and toss it into a nearby waste-bin.  You swing your ' + CoC.player.legs() + ' over her and get into position, aligning ', false );
		if( CoC.player.balls > 0 ) {
	...
	Urta.prototype.urtasCoochiNeedsFuckedLove = function() {
		...
		EngineCore.outputText( 'You nod eagerly and advance, dropping your ' + CoC.player.armorName + ' by the wayside as you jump into bed.  She reaches around her male endowments, stroking along her lips to her puffy black clit.  Urta shivers in pleasure, spreading her legs as far as she possibly can, watching you with a hungry look as she licks her lips.  A few long strands of cunny-juice leak from her waiting hole onto the bed, practically begging you to slide inside and feel her nether-lips\' velvet embrace.  You sidle up to your lover, pressing your ', false );
		if( CoC.player.cockTotal() > 1 ) {
	...
	Urta.prototype.scyllaAndUrtaSittingInATree = function() {
		...
		if( CoC.flags[ kFLAGS.UNKNOWN_FLAG_NUMBER_00147 ] === 0 && CoC.flags[ kFLAGS.UNKNOWN_FLAG_NUMBER_00145 ] > 0 ) {
			...
			EngineCore.outputText( 'The fox is giving you a lewd look as she cradles Scylla\'s head in her hands and pushes down.  She slurs, "<i>Oooooh YEAH!  Mmmmm, you made it ' + CoC.player.short + '!  It seems like each time Scylla does... does... oooh... this I cum bigger and harder.  MMmmmm so good... wanna watch?</i>"\n\n', false );
			...
			if( this.urtaLove() ) {
				...
				EngineCore.outputText( 'H-hi ' + CoC.player.short + '... I didn\'t think I\'d get to see you to- Oh yeah, like that!  Mmmm... OH!  I guess since we\'ve been intimate before you can watch...', false );
			}
			EngineCore.outputText( '</i>"\n\n', false );
	...
	Urta.prototype.watchTwoHotBitchesAndJerkIt = function() {
		...
		EngineCore.outputText( 'You open your ' + CoC.player.armorName + ' and sit down on a crate no more than a few feet away from the orally fixated couple, fishing out ' + Descriptors.sMultiCockDesc(), false );
		if( CoC.player.hasVagina() ) {
		...
		if( CoC.flags[ kFLAGS.UNKNOWN_FLAG_NUMBER_00143 ] === 1 ) {
			...
			EngineCore.outputText( '"<i>You\'re the besht ' + CoC.player.mf( 'man', 'woman' ) + ' a girl could ashk for.</i>"', false );
		}
		...
		EngineCore.outputText( 'You smile happily and pick up your ' + CoC.player.armorName + '.  It\'s past time you checked up on your camp.', false );
		if( this.urtaLove() ) {
	...
	Urta.prototype.makeUrtaSitOnYourLapWithScylla = function() {
		...
		if( CoC.player.lowerBody === AppearanceDefs.LOWER_BODY_TYPE_NAGA ) {
			...
			EngineCore.outputText( ', straddling your ' + CoC.player.legs() + ' around her hips', false );
		}
		...
		if( x !== -1 && y !== -1 ) {
			EngineCore.outputText( 'Oooh, and in both holes?  You naughty ' + CoC.player.mf( 'boy', 'girl' ) + ', you!', false );
		...
		if( y > -1 ) {
			EngineCore.outputText( '  Meanwhile, your other ' + Appearance.cockNoun( CoC.player.cocks[ y ].cockType ) + ' utterly fills her womb, stuffing it so completely that the fox\'s belly rounds out.', false );
		}
		if( (CoC.player.cockTotal() > 1 && y === -1) || CoC.player.cockTotal() > 2 ) {
		...
		EngineCore.outputText( 'You grab a rag and wipe up before donning your ' + CoC.player.armorName + '.  Urta saunters over, looking like she\'s sobered up quite a bit.  She\'s got ', false );
		if( this.urtaLove() ) {
	...
	Urta.prototype.chastityBeltFun = function( cameFromSexMenu ) {
		...
		EngineCore.outputText( 'You take the mug and tip on your mouth, purposely letting some spill, forming rivulets of water across your ' + CoC.player.skin( true, false ) + ', ' + (CoC.player.hasBreasts() ? 'past your breasts and down' : 'down your chest and over ') + ' your belly.  With a look of mock disappointment, you tell Urta you seem to have spilled some water, maybe she should take care of it?  Urta nods her head and immediately starts to head for a closet to fetch you a towel.  But you quickly stop her, by telling her that you want her to lick you clean.\n\n' );
	...
	Urta.prototype.friendsTalkExpack = function() {
		MainView.clearOutput();
		this.urtaSprite();
		EngineCore.outputText( 'You approack Urta\'s table and she motions for you to take a seat.  She finishes writing something on one of the pieces of paperwork scattered over the table, takes a sip of her drink and leans back in her chair.  “<i>Nice to see you again ' + CoC.player.short + '.  What can I do for you?</i>”' );
		this.urtaDialogueMenu();
	};
	...
	Urta.prototype.flirtWithUrta = function() {
		...
		if( CoC.flags[ kFLAGS.URTA_PC_LOVE_COUNTER ] === -1 ) {
			...
			EngineCore.outputText( 'You tell her that in your world you never felt a deep urge to strip off all your clothes and ' + (CoC.player.cor < 75 ? 'make sweet love to' : 'slake your lust on') + ' the nearest person.\n\n' );
		} else {
		...
		EngineCore.outputText( 'You quietly slide your ' + (CoC.player.isNaga() ? 'tail' : 'foot') + ' across under the table and rub it against the inside of her leg.  Urta practically jumps out of her seat, then tries to pretend nothing happened.\n\n' );
		...
		EngineCore.outputText( 'You never find out exactly what she was going to say.  When you start to rub your ' + (CoC.player.isNaga() ? 'tail' : 'foot') + ' in little circles against the root of her huge cock Urta loses her train of thought and just leans back in her chair, trying to keep from spraying her pent up cum across the floor.\n\n' );
	...
	Urta.prototype.urtaKathSexEncourage = function() {
		...
		EngineCore.outputText( '“<i>Are you sure ' + CoC.player.short + '?  I mean I love the idea, I’m sure Kath will love it too, but you know what my appetite’s like.</i>”\n\n' );
	...
	Urta.prototype.pegUrtasAssMessy = function() {
		...
		EngineCore.outputText( '  Scooting forward, you edge your ' + CoC.player.cockHead( x ) + ' up to her anus.  Her body heat washes over you as you enjoy the feel of her pucker\'s folded flesh pressing down on your most sensitive point, lubricated by the copious female fluid that drains from the sodden gash above.' );
		...
		EngineCore.outputText( ', kissing your ' + CoC.player.cockHead( x ) + ' every time it peeks past her tits, relishing the taste of her own lust all over it.' );
	...
	//if(CoC.flags[kFLAGS.URTA_PETPLAY_DONE] === 0 && this.urtaLove()) EngineCore.outputText('  <b>A new, shiny leather collar lies half-concealed under a cushion, as though its owner haphazardly tried to bury it in a rush.</b>');;
	...
	Urta.prototype.doggyStyle = function() {
		...
		EngineCore.outputText( '"<i>Hmm,</i>" Urta wonders aloud, bringing a finger up to her mouth in mock-thoughtfulness.  "<i>What should I do with my little pet now that ' + CoC.player.mf( 'he', 'she' ) + '\'s all collared up?</i>"  Your Owner walks around you slowly, assessing your body.' );
