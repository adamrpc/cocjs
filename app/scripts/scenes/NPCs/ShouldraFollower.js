...
angular.module( 'cocjs' ).run( function( ConsumableLib, $log, Combat, PerkLib, CockTypesEnum, Descriptors, AppearanceDefs, EventParser, CoC, kFLAGS, Utils, StatusAffects, EngineCore ) {
	...
	ShouldraFollower.prototype.pureMacroValaCont = function() {
		...
		//Female:;
			...
			EngineCore.outputText( 'Her finger starts pressing firmly against your chest.  You try to push it away, but the size difference makes the effort futile.  The ghost girl starts grinding against your chest with her fingertip, the friction against your breasts causing a small gasp to escape your lips, and your nips to become slightly firmer.  She runs her pinky up your leg, stopping at your vagina, and you reflexively clench your legs together. Unfazed, Shouldra forces them back open with her fingers, exposing you to the open air.  A small breeze blows through, tickling your cunt and causing you to bite your lip.' );
	...
	ShouldraFollower.prototype.sandWitchGetsGhostly = function() {
		...
		if( CoC.getInstance().player.hasCock() && (!CoC.getInstance().player.hasVagina() || Utils.rand( 2 ) === 0) ) {
			...
			EngineCore.outputText( 'Shouldra pokes her head out from your torso, rubbing her hands together menacingly.  "<i>So, we\'re going to have some fun with this little gal, aren\'t we, Champ?</i>"  The sand witch is paralyzed with fright, able only to gaze at the bizarre spectacle before her.  Looking down at the shade sticking out of you, you see her hands now poised against your chest.  The ghost girl is ready to fly out at a moment\'s notice.  You decide not to keep her waiting and give her the go ahead; the force of her excited exit about throws you to the sandy ground.  The eager spirit quickly hammers into the witch, digging her sitting body into the sand.  There\'s a little struggling, but it isn\'t long until the ghost subdues her prey.' );
	...
	ShouldraFollower.prototype.maleMasturbationProper = function() {
		EngineCore.clearOutput();
		EngineCore.spriteSelect( 67 );
		EngineCore.outputText( 'You are nearly overwhelmed by Shouldra\'s delight when you allow her to focus on your [cock].  She instantly takes the lead, steering you behind a good-sized boulder and flinging your [armor] piece-by-piece as you go.' );
	...
	ShouldraFollower.prototype.girlyMasturbationWithGhosts = function() {
		...
		EngineCore.outputText( '"<i>Tsk!  Saying those kinds of things aloud!  Still... if you want to let it out so badly, I might let you if you beg a little more...</i>"' );
	...
	ShouldraFollower.prototype.shouldraTongueLicksPCs = function() {
		...
		if( CoC.getInstance().player.findPerk( PerkLib.Flexibility ) >= 0 ) {
			...
			EngineCore.outputText( ' sliding fingers along the wet appendage, humming a little tune over your tongue until more than a foot of it droops from your mouth.  "<i>Now we\'re getting somewhere,</i>" you hear her thinking as she works her magic.  There doesn\'t seem to be a limit to how much she can pull out of your mouth, and soon she has more than three feet of pure tongue coiled in your lap.  Furrowing your brow in concentration, she tries to move your tongue about, but can\'t manage to wiggle more than the tip.  "<i>Too thin,</i>" she mutters, "<i>much too weak. Doesn\'t feel right...</i>"' );
		...
		//if demon tongue;
			...
			EngineCore.outputText( 'sliding fingers along the wet appendage, humming a little tune over your tongue until more than an additional foot of it droops from your mouth.  "<i>Now we\'re getting somewhere,</i>" you hear her thinking as she works her magic.  There doesn\'t seem to be a limit to how much she can pull out of your mouth, and soon she has more than three feet of pure tongue coiled in your lap.  Furrowing your brow in concentration, she tries to move your tongue about, but can\'t manage to wiggle more than the tip.  "<i>Too thin,</i>" she mutters, "<i>much too weak. Doesn\'t feel right...</i>"' );
			EngineCore.outputText( '\n\nTaking the midsection of your tongue in your hand, she slowly starts to rub her hand along some of its length.  It feels... odd, somehow, but not entirely unpleasant.  Though you shudder at the first rub, they start to feel more natural as she pushes you on.  Actually, it feels sort of good.  Her strokes remain constant, though some part of you wishes she\'d go faster.  It doesn\'t even register as odd in your addled mind that your tongue is swelling in your hand with every stroke.  Shouldra starts to make wider movements along your smooth stretch of muscle.  Its girth plumps up to fill your palm nicely wherever she brings your hand, and the strange sensations of your flesh on its nerves wrack your body with shudders of pleasure even through Shouldra\'s grip.' );
	...
	ShouldraFollower.prototype.shouldraYappin = function() {
		...
		if( CoC.getInstance().flags[ kFLAGS.SHOULDRA_TALK_NEEDED ] === 1 ) {
			...
			//Talk 3 - 'Recent' Goblin Possession Discussion;
				...
				EngineCore.outputText( '"<i>Oh,</i>" she says, stepping out of you and sitting herself across from you.  "<i>You saw that.</i>"' );
		...
		//Generic Oni Discussion!;
			...
			EngineCore.outputText( 'On a whim, you decide to have a chat with your spectral companion, who obligingly pops free of your torso to spare you the awkward sensation of conversing with one of your own body parts.' );
	...
	ShouldraFollower.prototype.shouldraFollowerScreen = function() {
		...
		if( !this.shouldraSleeping() ) {
			EngineCore.outputText( 'You pulse a desire for interaction with Shouldra, summoning her head to form from your shoulder. "<i>What\'s on your mind, Champ? I could\'ve found out on my own, but I was... preoccupied.</i>"' );
		...
		EngineCore.choices( 'Talk', this.shouldraTalkMenu, 'Sex', sex, '', null, 'Go Away', this.kickFollowerShouldraOut, 'Back', CoC.getInstance().scenes.camp.campFollowers );
	};
	...
	ShouldraFollower.prototype.shouldraGroPlus = function() {
		EngineCore.clearOutput();
		EngineCore.spriteSelect( 67 );
		EngineCore.outputText( 'You decide to take up Shouldra\'s offer on natural body enhancement.  Before you tell her as much, the eager spectre quickly assumes control of your body.  "<i>Alright, Champ, now we\'re in business.  So, what did you have in mind?</i>"' );
	...
	ShouldraFollower.prototype.shouldraMakesCocksDisappear = function() {
		...
		if( CoC.getInstance().player.cocks.length === 1 ) {
			...
			if( choice === 0 ) {
				EngineCore.outputText( 'murderer' );
			} else if( choice === 1 ) {
				EngineCore.outputText( 'bastard' );
			} else if( choice === 2 ) {
				EngineCore.outputText( 'jerk' );
			} else if( choice === 3 ) {
				EngineCore.outputText( 'monster' );
			} else if( choice === 4 ) {
				EngineCore.outputText( 'cretin' );
			} else if( choice === 5 ) {
				EngineCore.outputText( 'fiend' );
			} else if( choice === 6 ) {
				EngineCore.outputText( 'asshole' );
			} else if( choice === 7 ) {
				EngineCore.outputText( 'villain' );
			} else {
				EngineCore.outputText( 'dick' );
			}
	...
	ShouldraFollower.prototype.shouldraWakesUpOrPokesPCsForShitsAndGigglesIdunnoHowLongCanIMakeThisFunctionNameQuestionMark = function() {
		...
		switch( select ) {
			...
			case 3:
				subSelect = Utils.rand( 5 );
				if( subSelect === 0 ) {
					EngineCore.outputText( 'Your [balls] are getting warm.  They\'re getting... really hot.  "<i>Don\'t mind me, Champ. Just... checking something out.</i>"  You decide the best course of action would probably be not to pry any further into whatever machination the ghost girl is working on.' );
				} else if( subSelect === 1 ) {
			...
			case 5:
				...
				if( subSelect === 0 ) {
					...
					EngineCore.outputText( 'You almost don\'t realize your hand creeping its way into your [armor], trying to sneak a quick fingering. Looks like Shouldra is getting antsy.' );
				} else if( subSelect === 3 ) {
					EngineCore.outputText( 'What the... ?  Your [vagina] has started gushing fluids everywhere, absolutely soaking your [legs]!  "<i>Don\'t mind me, Champ.  I\'m just testing to see how far I can push this. Part of something I have in mind for later...</i>"  No good can come of this...' );
				} else {
					EngineCore.outputText( 'You can sense Shouldra laughing to herself over something.  Though its usually a poor idea, you decide to ask and see what\'s on her mind.  "<i>I was just scheming.  Would you get too upset if I spooked your next fuck?</i>"  As she asks, you feel your [vagina] clenching hard, giving you a clear idea of what the trickster has in mind.  There\'s no way that-  On second thought, maybe it could be kind of fun?' );
				}
				break;
			...
			case 6:
				...
				if( subSelect === 0 ) {
					EngineCore.outputText( 'While minding your business, you realize faint whispering is coming from your [cock].  Shouldra and Exgartuan are scheming something, probably something you wouldn\'t be a fan of.  Every so often your wang lets out a chuckle.  Maybe getting these two together wasn\'t in your best interest.' );
				} else if( subSelect === 1 ) {
					EngineCore.outputText( 'Your [cock] is wiggling around inside your [armor], making you incredibly uncomfortable.  You go to undo your outfit when the demonic dong plows its way out anyway, scaring you half to death.  Shouldra and Exgartuan just laugh, too content with one another to pay you much mind.  You never expected them to get along THIS well.' );
				} else if( subSelect === 2 ) {
					EngineCore.outputText( '"<i>So what other sorts of things can you concoct?</i>" Exgartuan asks, shuffling around in your armor.  You\'re incredibly confused by the sudden question.\n\n"<i>Honestly, that put me in the mood to make all of mother nature our bitch,</i>" you respond... Shouldra responds.  The spirit is gabbing through your mouth to your possessed pecker.  The two prattle on like this for some time.' );
				} else if( subSelect === 3 ) {
					EngineCore.outputText( 'Your hands slip inside your [armor], exploring your [cock].  Your fingers caress each little nub and nodule they come across.  "<i>That\'s the ticket,</i>" Exgartuan gleefully responds, getting rigid in the tight confines of your outfit.  Looks like your ghostly partner is out to make everyone happy.' );
				} else if( subSelect === 4 ) {
					EngineCore.outputText( '"<i>Why don\'t you help out during battles, babe?</i>" Exgartuan asks rather bluntly.\n\n"<i>Hey, I\'ve offered to help out with Champ\'s more seductive poses like you do...</i>"\n\nIt isn\'t like you have much choice in the matter as far as Exgartuan is concerned!  The two continue their discussion, belittling your apparently meager combat performance.  Maybe your possessors could actually help deal some real damage for a change!' );
				} else {
					EngineCore.outputText( 'Your [armor] has vanished!  You\'re butt naked!  It\'s pretty obvious who\'s at fau-\n\n"<i>Really, [name], you don\'t even need it,</i>" Exgartuan says, surprising you.\n\nShouldra laughs, "<i>Right, Champ?  Two sexually-charged tyrants dwelling within you and you insist on sneaking around like common rabble?  Why not let it all hang out?</i>"\n\nYour hands caress your [cock], exciting the demonic member into attention.  You remind the couple that your outfit isn\'t <b>just</b> for protection, citing many other-  Oh, your [armor] is back.  Guess they don\'t want to hear you prattle.' );
				}
				break;
			//General flavor text;
			case 7:
				subSelect = Utils.rand( 6 );
				if( subSelect === 0 ) {
					EngineCore.outputText( '"<i>Yoooo, Champ, are we gonna fuck something, or am I just gonna stagnate here?</i>" Shouldra moans, managing to steal control of an arm long enough to give your [butt] a honk.  You sigh.' );
				} else if( subSelect === 1 ) {
					EngineCore.outputText( 'Out of nowhere, a colossal yawn bursts forth from your craw.  "<i>Come on, Champ. I\'m dying to try out some new stuff I\'ve cooked up.</i>" What is this sense of dread consuming your being?' );
				} else if( subSelect === 2 ) {
					EngineCore.outputText( 'It\'s been pretty quiet recently.  No doubt Shouldra is up to something -- she always is.  Honestly, you\'ve forgotten what it\'s like to not having your body passing for a bloated something or other.' );
				} else if( subSelect === 3 ) {
					EngineCore.outputText( 'As you are going about your business, you swear you make out muttering emanating from somewhere on your person. It sounds like the ghost girl is reciting some magic, but you don\'t feel any different. This only worries you even more.' );
				} else if( subSelect === 4 ) {
					EngineCore.outputText( '"<i>Do foot fetishes still apply if it\'s your own foot?</i>" Shouldra asks.  For a moment you wonder how such a feat would even be possible.  But only for a brief, forgetful moment...' );
				} else if( subSelect === 5 ) {
					EngineCore.outputText( 'A familiar voice works its way from the back of your mind, "<i>Hey, Champ.  You think there\'s any way to make armpits sexy?  What about knees or noses?</i>"  This line of questioning could lead to some very troubling consequences...' );
				} else {
					EngineCore.outputText( '"<i>I like what you did with those racks,</i>" Shouldra says unexpectedly, her voice losing its mischievous edge for a moment.  "<i>I\'m glad you kept them.</i>"  You both sit in silence for several moments as you consider her mood shift to tenderness, but the moment passes.  Shouldra chuckles softly.  "<i>Just thought I\'d mention.</i>"' );
				}
				break;
			//Special Flavor Texts (misc. prereqs);
			//(Tel'Adre unlocked);
			case 8:
				EngineCore.outputText( 'Somehow, someway, you can feel Shouldra sifting through your memories.  "<i>I\'d love to visit the bakery in that desert town.  It\'s been at least a century since I tasted a decent sweet of some sort.</i>"' );
				break;
			//Preggo;
			case 9:
				EngineCore.outputText( 'Your hands circle your bulging belly unbidden.  Shouldra seems to be enjoying your pregnancy.  "<i>A good deal of the goblins I got a hold of were pregnant, but they don\'t really treat the event with anything other than their usual \'decorum.\'</i>"  The ghost girl lets out a deep sigh.  "<i>There isn\'t anything wrong with enjoying it while you can, is there?</i>"  Do the dead normally have this much interest in the birth of the living?' );
				break;
			//(is preggers2);
			case 10:
				EngineCore.outputText( '"<i>Looks like the thing you\'re pregnant with is doing all right there, Champ,</i>" Shouldra comments, your belly wiggling around a bit.  You ask that the ghost not go messing around with pregnancy, fearful of the consequences.  "<i>Oh, please.  I wouldn\'t do anything crazy like that...</i>" You can\'t see her, but you can picture the expression the ghost made as she trailed off.  And it worries you.' );
				break;
			//(is butt pregnant);
			case 11:
				EngineCore.outputText( '"<i>I must admit, Champ, haven\'t run into too many instances of rear-ended pregnancies!</i>"  Shouldra laughs, smacking your hand on your [butt].  "<i>Just make sure that doesn\'t have to contend with all the other things that go in and out of your ass!</i>"  You try not to dignify the crass remark with any sort of response.' );
				break;
			//(can fly);
			case 12:
				EngineCore.outputText( 'You\'re taken by surprise when your wings act all on their own, lifting you off the ground with strong flaps.  "<i>I\'m trying to think of ways to use your own flight in some kinky shit, Champ,</i>" Shouldra comments, "<i>Nothing\'s coming to mind that\'s any better than me just floating your carcass instead.</i>"  Well, we aren\'t all "blessed" enough to be deceased spirits!' );
				break;
			//(is Naga);
			case 13:
				EngineCore.outputText( 'Your tail wiggles around on its own suddenly.  Catching on to how it appears to be sneaking to play around with something on your body, you calmly ask its spiritual captor to knock it off.  An otherworldly snicker emanates from it before it goes limp.' );
				break;
			//(Amily is a follower);
			case 14:
				EngineCore.outputText( 'Your fingers move around a little, signaling Shouldra\'s stirring.  "<i>It would seem that that mouse follows me everywhere I go,</i>" she complains.  You figure she\'s talking about Amily.  You ask what her beef is.  "<i>Too much baggage.  Don\'t want to deal with it.  I scared her a few times back at the town, but it wasn\'t all that satisfying.</i>"  Looks as though Shouldra wasn\'t always the warmest of neighbors.' );
				break;
			//(Pure Jojo is a follower);
			case 15:
				EngineCore.outputText( 'The silence bothers you a bit, so you decide to see if Shouldra is awake and ask her what she thinks about Jojo.  "<i>You\'re talking about that holy mouse morph back at camp, right?  Not a fan,</i>" she replies, shrugging your shoulders.  "<i>Other than just not really being into people that remind me of rodents, I don\'t think he\'d get along well with \'a spirit that has yet to abandon these mortal bonds.\'</i>"  she mocks.' );
				break;
			//(has any of Marae's gift perks);
			case 16:
				EngineCore.outputText( '"<i>Man, Marae really did a number on you, Champ,</i>" Shouldra comments, referring to your corrupted blessings.  "<i>I\'ll have to hand it to you; you really get around.  Much more than I would have been willing to give you credit for.  Not everyone gets to fuck around with a goddess.</i>"  You aren\'t sure if this is a compliment.' );
				break;
	...
	ShouldraFollower.prototype.shouldraAndExgartumonFightGottaCatchEmAll = function() {
		...
		EngineCore.outputText( '.  Just when you\'re [armor] and about to tuck in for the night, however, your [cock] goes fully erect!  The throbbing demonic mass is flailing about, knocking into your shit and making a mess.  You clutch onto the bucking bronco in an attempt to prevent any further damage when Exgartuan begins to shout, "<i>Don\'t FUCKING touch me, you goddamn cunt!</i>"' );
	...
	ShouldraFollower.prototype.exgartuMonAndShouldraShowdown = function() {
		...
		if( EngineCore.silly() ) {
			EngineCore.outputText( '  It\'s a man\'s right to choose what\'s done with his body.  Not anyone else\'s!' );
		}
	...
	ShouldraFollower.prototype.keepShouldraAndKickOutExgartuan = function() {
		EngineCore.clearOutput();
		EngineCore.spriteSelect( 67 );
		EngineCore.outputText( 'You decide to jump to Shouldra\'s side on this one, explaining to your demonic cock your desire to go your separate ways.  Exgartuan heartily laughs at you, your [cock] wiggling in the air with each mighty heave.' );
	...
	ShouldraFollower.prototype.keepShouldraPartIIExgartumonsUndeatH = function() {
		...
		EngineCore.outputText( 'While slipping into your bedroll to enjoy a peaceful night\'s sleep, a chill runs down your spine.  You look around to-' );
	...
	CoC.getInstance().registerScene( 'shouldraFollower', new ShouldraFollower() );
} );