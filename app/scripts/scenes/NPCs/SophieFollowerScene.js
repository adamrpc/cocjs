...
angular.module( 'cocjs' ).run( function( MainView, SceneLib, AppearanceDefs, CockTypesEnum, Sophie, ConsumableLib, Combat, Descriptors, CoC, kFLAGS, Utils, StatusAffects, EngineCore ) {
	...
	SophieFollowerScene.prototype.followerSophieMainScreen = function() {
		...
		if( SceneLib.sophieBimbo.sophieIsInSeason() && CoC.player.hasCock() && CoC.flags[ kFLAGS.FOLLOWER_AT_FARM_SOPHIE ] === 0 ) {
			...
			EngineCore.outputText( '.  "<i>Ohhh, come on, [name]!  Just give it to me like a good ' + CoC.player.mf( 'boy', 'girl' ) + ', would you?  I could even give you a special treat.  <b>Just give. It. To. Me.</b></i>"' );
	...
	SophieFollowerScene.prototype.sophieSmallDongTeases = function() {
		...
		if( CoC.player.breastRows[ 0 ].breastRating >= 1 ) {
			EngineCore.outputText( ' and squeezes your ' + CoC.player.breastCup( 0 ) + ' breast roughy.' );
		} else {
			EngineCore.outputText( ' and lets the talons dig into your ' + CoC.player.skinFurScales() + ' just enough to hurt a little.' );
		}
	...
	SophieFollowerScene.prototype.sophieIncestInHerCooterOrSomethingIDunno = function() {
		...
		if( CoC.flags[ kFLAGS.SOPHIE_ADULT_KID_COUNT ] > 1 ) {
			EngineCore.outputText( 'The prospect of their ' + CoC.player.mf( 'father', 'mother' ) + '\'s attention causes a small scuffle to break out between your feathery daughters. Thankfully, the small fight is soon ended and one of your daughters flies down and stands before you.  ' );
		} else {
		...
		if( daughterCap === 0 ) {
			...
			if( CoC.flags[ kFLAGS.DAUGHTER_ONE_BIMBO ] > 0 && CoC.flags[ kFLAGS.SOPHIES_DAUGHTERS_DEBIMBOED ] === 0 ) {
				EngineCore.outputText( '"<i>Like, how do I look, ' + CoC.player.mf( 'Daddy', 'Mommy' ) + '?  Aren\'t my breasts so totally soft?  Don\'t you just want to suck and squeeze them?  Ooohhh!  ' + CoC.player.mf( 'Daddy', 'Mommy' ) + ', can you please touch me?  I want you so bad!  My pussy gets sooo wet when I, like, think about you pounding my cunny!</i>"' );
			}
			//normal speech:;
			else {
		...
		//second daughter: ;
			...
			if( CoC.flags[ kFLAGS.DAUGHTER_TWO_BIMBO ] > 0 && CoC.flags[ kFLAGS.SOPHIES_DAUGHTERS_DEBIMBOED ] === 0 ) {
				EngineCore.outputText( '"<i>Mmmm... doncha want to just like, pound my sexy ass, ' + CoC.player.mf( 'Daddy', 'Mommy' ) + '?  It\'s so big, it\'s just begging to be spanked and squeezed till it\'s totally red and sensitive</i>"' );
			} else {
				EngineCore.outputText( '"<i>Come on, ' + CoC.player.mf( 'Daddy', 'Mommy' ) + ', touch me, spank me like the bad girl I am, lusting after my ' + CoC.player.mf( 'Daddy', 'Mommy' ) + ' like this.  Give it to me hard, spank my big round ass and pound my hot tight cunt like I know you want</i>"' );
			}
		...
		//third daughter:;
			...
			if( CoC.flags[ kFLAGS.DAUGHTER_THREE_BIMBO ] > 0 && CoC.flags[ kFLAGS.SOPHIES_DAUGHTERS_DEBIMBOED ] === 0 ) {
				EngineCore.outputText( '"<i>L-like, did I do a good job, ' + CoC.player.mf( 'Daddy', 'Mommy' ) + '?  I so totally did my best for you.  I know I\'m not super sexy like Mom and my sisters... but, ' + CoC.player.mf( 'Daddy', 'Mommy' ) + '.. I will like, still please you, like, totally the best that I can!</i>"' );
			} else {
				EngineCore.outputText( '"<i>W-well, what did you think, ' + CoC.player.mf( 'Dad', 'Mommy' ) + '?  Did I do a good job?  I know I\'m not as hot as Mom, but I promise I\'ll please you as best I can!</i>"' );
			}
			...
			if( CoC.flags[ kFLAGS.DAUGHTER_FOUR_BIMBO ] > 0 && CoC.flags[ kFLAGS.SOPHIES_DAUGHTERS_DEBIMBOED ] === 0 ) {
				EngineCore.outputText( '"<i>Come on ' + CoC.player.mf( 'Daddy', 'Mommy' ) + ', can\'t you see how totally hot I am?  Don\'t you just want to let loose and like, just fuck me till I scream.</i>"' );
			} else {
				EngineCore.outputText( '"<i>Just look at me, ' + CoC.player.mf( 'Daddy', 'Mommy' ) + ', so curvy, so ready, so hot and wet for you.  Just let loose and show me your love, show me how much you love me, ' + CoC.player.mf( 'Daddy', 'Mommy' ) + ', fuck me hard, make me scream and claim me as yours.</i>"' );
			}
			...
			//bimbo speech;
			if( CoC.flags[ kFLAGS.DAUGHTER_FOUR_BIMBO ] > 0 && CoC.flags[ kFLAGS.SOPHIES_DAUGHTERS_DEBIMBOED ] === 0 ) {
				EngineCore.outputText( '  "<i>Ahh... ohhh... oh, ' + CoC.player.mf( 'Daddy', 'Mommy' ) + '!  You like my butt, don\'t you; isn\'t it nice?  It\'s so good to grab and squeeze.  I bet it would be fun to, like, spank it too....</i>"' );
			}
			//[normal speech:];
			else {
				EngineCore.outputText( '  "<i>Mmmm... Oh, ' + CoC.player.mf( 'Daddy', 'Mommy' ) + ', yessss...  That\'s it, touch me, touch me and play with me, do whatever you want with me.</i>"' );
			}
	...
	SophieFollowerScene.prototype.phaseTwoOfIncest = function( daughter ) {
		...
		if( bimbo ) {
			EngineCore.outputText( '  "<i>Oh, ' + CoC.player.mf( 'Daddy', 'Mommy' ) + ', oh, ' + CoC.player.mf( 'Daddy', 'Mommy' ) + '...  So good!  My ' + CoC.player.mf( 'Daddy', 'Mommy' ) + '\'s such a hot, sexy ' + CoC.player.mf( 'stud', 'herm' ) + '.  I so totally thought I was going to like, lose my mind for a second.  I love you, ' + CoC.player.mf( 'Daddy', 'Mommy' ) + '.</i>"' );
		} else {
			EngineCore.outputText( '  "<i>Oh, ' + CoC.player.mf( 'Daddy', 'Mommy' ) + ', oh, ' + CoC.player.mf( 'Daddy', 'Mommy' ) + '... so good, you\'re such a fucking ' + CoC.player.mf( 'stud', 'perfect breeder' ) + '!  I could just get addicted to you.  I love you, ' + CoC.player.mf( 'Daddy', 'Mommy' ) + ',</i>"' );
		}
