...
angular.module( 'cocjs' ).run( function( PregnancyStore, ConsumableLib, Combat, PerkLib, Descriptors, EventParser, CoC, kFLAGS, Utils, StatusAffects, EngineCore ) {
	...
	/*Sophie TF Notes tits become F, impairing flight to gliding at best.
	...
	SophieBimbo.prototype.bimboSophie = function() {
		return (CoC.getInstance().flags[ kFLAGS.UNKNOWN_FLAG_NUMBER_00282 ] > 0 && CoC.getInstance().flags[ kFLAGS.UNKNOWN_FLAG_NUMBER_00283 ] === 0 && CoC.getInstance().flags[ kFLAGS.SOPHIE_DEBIMBOED ] === 0);
	};
	SophieBimbo.prototype.sophieIsInSeason = function() {
		return (CoC.getInstance().flags[ kFLAGS.SOPHIE_HEAT_COUNTER ] > 551 && !CoC.getInstance().scenes.sophieScene.pregnancy.isPregnant);
	};
	SophieBimbo.prototype.sophiePregChance = function() {
		...
		if( Utils.rand( 4 ) === 0 || CoC.getInstance().player.cumQ() > Utils.rand( 1000 ) ) {
			CoC.getInstance().scenes.sophieScene.pregnancy.knockUpForce( PregnancyStore.PREGNANCY_PLAYER, PregnancyStore.INCUBATION_HARPY );
		}
	};
	SophieBimbo.prototype.sophieCapacity = function() {
		return 179;
	};

	//*Summary:  Sophie is defeated, give draft.;
	SophieBimbo.prototype.bimbotizeMeCaptainSophie = function() {
		this.sophieSprite();
		EngineCore.outputText( '', true );
		CoC.getInstance().player.consumeItem( ConsumableLib.BIMBOLQ );
		EngineCore.outputText( 'A wicked idea takes hold of you while you watch the harpy ', false );
		if( CoC.getInstance().monster.lust > 99 ) {
			EngineCore.outputText( 'touch herself', false );
		} else {
			EngineCore.outputText( 'squirm in the dirt around her nest', false );
		}
		EngineCore.outputText( '.  Releasing the ties on one of your pouches, you reach inside to claim the contents.  You produce the bottle of bimbo liqueur with a flourish, swirling the potent fluid inside its prison as you approach the downed harpy matron; she looks up at you with dumb, ', false );
		if( CoC.getInstance().monster.lust > 99 ) {
			EngineCore.outputText( 'lust', false );
		} else {
			EngineCore.outputText( 'pain', false );
		}
		EngineCore.outputText( '-glazed eyes, her beautiful but uncomprehending visage slack-jawed and empty.  It\'s a good look for her.\n\n', false );
		EngineCore.outputText( 'The cork pops from the bottle\'s top with an easy tug, releasing a fine pink mist that reeks of alcohol, potent spices, and sweetness.  You hold Sophie\'s jaw in your hand and pull her mouth open, placing the bottle\'s lip upon the defeated slut\'s slack mouth.  Like this, she\'s almost perfect... almost.  You lift the back edge of the bottle higher, dribbling a flow of bimbolicious alcohol into Sophie\'s pliant, unresisting mouth.  She gulps as it hits her tongue, swaying back and forth dangerously while the magic starts to take effect.  You hold her fast and upend the rest of the liqueur directly into her throat.  The busty harpy shudders and shakes, sputtering a little bit with her eyes crossed.  Her convulsions grow so forceful that she wrenches out of your grip to flop about on the floor of her nest.\n\n', false );
		EngineCore.outputText( 'Starting at her head, her flamingo-pink plumage brightens to an even more neon coloration.  It continually lightens until the blush utterly vanishes, a light, barely-blond hue fading into place in her feathery hair.  The same scene is repeated over her wings, legs, and feathery backside, girding her body in platinum pinions.  Fluffing softly, the changed feathers ruffle while Sophie\'s involuntary shudders slow to a stop.  She shakes her head and mutters, "<i>OOooh, wha... what did you give me?  So... hard to... think.</i>"\n\n', false );
		EngineCore.outputText( 'You display the bottle\'s warning label to the harpy, waiting for her response.  She squints in confusion and pulls back, her heaving breasts jiggling and bouncing about.  "<i>What\'s that?  Some like, weird language or something?  I can\'t read it.</i>"  Sophie\'s brow knits in confusion - you can practically see the gears trying to turn behind her open, clueless eyes.  She taps at her chin, her arm brushing her suddenly-larger assets, once again setting her swelling bust to shaking.  "<i>Omigosh!  Are my titties getting bigger?</i>" she asks with a giggle.  "<i>They\'re so... jiggly and shaky!</i>"\n\n', false );
		EngineCore.outputText( 'Looking down confirms her claims.  While the twin melons were definitely double-D\'s before, they\'ve swollen up to an E-cup by now, and the blooming bosom shows no signs of stopping.  Before your eyes, Sophie\'s tits grow into a truly magnificent pair of breasts, shaking and rippling like bowls of jello.  Her nipples puff up and engorge, the nubs easily doubling in size and stretching out to nearly a full inch in their aroused state.  They redden as Sophie\'s creamy skin blushes pink, her flesh coloring from the pleasure of her chest\'s obscene growth.  Widening in panic and lust, Sophie\'s eyes glitter with half-formed tears as she wails, "<i>I can\'t fly like thiiiis!</i>"\n\n', false );
		EngineCore.outputText( 'You chuckle and heft one of the harpy\'s weighty globes, marveling at the smooth softness of her heavy tit.\n\n', false );
		EngineCore.outputText( 'Sophie squeals, "<i>S-stop it!  It\'s s-s-sensitiiiive!</i>"\n\n', false );
		EngineCore.outputText( 'Sighing, you rub your thumb across her areola, circling around the huge nipple before you give the long protrusion a hard flick.  The avian matron shivers and moans at that, arching her back to press the mammoth mounds further into your hands, forcing you back against the mountainside with their weight.  Protruding even more, her unyielding nips slide between your fingers.  Thankfully, they don\'t seem to be getting any bigger; while you\'re no tailor, you appraise them as at least F-cups now.  You idly massage the more-than-motherly melons, setting off a chorus of moans from the harpy\'s gold-glossed lips.  Her wide hips wiggle with sensuous need, the scent of horny harpy filling the air.  You must be doing something right.\n\n', false );
		EngineCore.outputText( 'Sophie gasps and pulls back, turning about to place her hefty rump in front of your face.  The long tail-feathers tickle at you, but you brush the blond fluff aside with an irritated snort.  "<i>Y-you like, did this to me!  Whatever it is making me all... horny and slurpy and yummy and dumb and... mmmm... can we fuck?</i>" she accuses, losing her train of thought part way through her diatribe as juices begin to drip from her inflamed cunt-lips.\n\n', false );
		EngineCore.outputText( 'You run a finger from the top of Sophie\'s box to the bottom, even stopping to slide the lubricated digit across her taint to circle her sensitive asshole.  She moans and bounces in place, her hips nearly blocking the light from your view when she presses back.  Did they get bigger too?  You pause to watch her hand-devouring ass-cheeks and confirm that they are, in fact, growing larger - just like her tits.  The plush pillow-butt rounds out, swelling larger.  You look down and note that her legs are moving apart as well, shifted wider by Sophie\'s changing body and expanding hips.\n\n', false );
		EngineCore.outputText( 'Sophie giggles, "<i>Like, do you love my drippy pussy that much?  Gosh that\'s cute!  But why am I so horny and silly?</i>"  She giggles.  "<i>I don\'t get it.  My head\'s all light and floaty!  Not like before.</i>"  Her voice drops slightly as she struggles with herself.  "<i>So hard... hard to think.  Gotta... gotta... like, find someone to fuck!  Mmm, would you give me a lick?  Can\'t you feel how hot Momma Sophie\'s box is?  It like, needs a tongue to cool it down or something.</i>"\n\n', false );
		EngineCore.outputText( 'The harpy\'s frothing gash smears over your nose and lips, trailing a fragrant smear of girl-honey across your face.  For one glorious moment, you\'re utterly deprived of light and left with the newly-minted bimbo\'s twat on your lips.  Her thighs muffle the sounds of the high mountains to near nothing, and you find yourself licking without meaning to, lapping  experimentally to see which parts of her slutted-up anatomy will release the strongest gushes of fluids.  Once you prod her clit with your tongue, she cums, drenching your face with harpy-lube.  The blond\'s thighs lock around you, holding you tight in the bimbo-bitch\'s snatch to receive her musky baptism.\n\n', false );
		EngineCore.outputText( 'After a few moments of torrential, slimy output, Sophie\'s quivering cunt spasms and her legs give out.  She slumps over, ass in the air and utterly exposed as she giggles, "<i>Like, wow!  You made me cum so hard, ' + CoC.getInstance().player.mf( 'mister', 'miss' ) + '!  Can I, like, come home with you?  I don\'t really want to compete with these bitches and you\'re super ' + CoC.getInstance().player.mf( 'handsome', 'hot' ) + '!  We can have lots of like, sex and stuff!</i>"\n\n', false );
		EngineCore.outputText( 'You\'re a bit taken aback by her reaction, but it makes sense.  The dumb broad is too fucked up to survive without becoming someone\'s fuck-pet.  She may as well be yours.  She looks back with glossy, hopeful eyes and a pleading, pouty look on her thick lips.  Did they get bigger too?  (She probably gives great head...)\n\n', false );
		EngineCore.outputText( 'Saying no seems silly... she\'s so fucking hot now, and you\'ve no doubt she\'ll be like your personal masturbation toy.  Sophie titters, "<i>Please please please!  Mmmm, I\'ll kiss and, like, lick you with my tongue all the time.  Don\'t say no... I totally need to fuck you!</i>"\n\n', false );
		EngineCore.outputText( 'You shake your head, feeling the compulsion picking at your mind.  Damn, she can still try to compel you with her words.  Do you take her home to be your live-in bimbo of choice?', false );
		EngineCore.dynStats( 'cor', 5 );
		EngineCore.doYesNo( this.acceptBimboSophie, this.declineBimboSophie );
	};
	SophieBimbo.prototype.declineBimboSophie = function() {
		this.sophieSprite();
		CoC.getInstance().flags[ kFLAGS.UNKNOWN_FLAG_NUMBER_00283 ] = 1;
		EngineCore.outputText( '', true );
		EngineCore.outputText( 'You turn and flee the mountain, before she can compel you to take her to camp and fuck like bunnies.  Who knows when you\'d have time to explore with a lust-crazed bird-woman like that around.  She\'ll find a mate soon enough, you\'re sure of that.\n\n', false );
	...
	SophieBimbo.prototype.acceptBimboSophie = function() {
		...
		//If she's already pregnant then convert the incubation from her wild 48 + Utils.rand(48) [95 to 0] to her follower incubation [168 to 0]. Your first daughter may already be on the way.;
		if( CoC.getInstance().scenes.sophieScene.pregnancy.isPregnant ) {
			CoC.getInstance().scenes.sophieScene.pregnancy.knockUpForce( CoC.getInstance().scenes.sophieScene.pregnancy.type, Math.ceil( CoC.getInstance().scenes.sophieScene.pregnancy.incubation * 1.75 ) );
		}
		EngineCore.outputText( 'You nod, and Sophie springs forward on her powerful legs, the strength undiminished by the effects of her bimbo transformation.  She tackles you in a bear-hug, kissing your ' + Descriptors.chestDesc() + ' over and over as her momentum carries you both off the side of the mountain.  You tumble in the air, screaming as you fall', false );
		if( CoC.getInstance().player.canFly() ) {
			EngineCore.outputText( ' and unable to bring your wings to bear with arms pinning them to your back', false );
		}
		EngineCore.outputText( '.\n\n', false );
		EngineCore.outputText( 'Sophie looks up and gasps, "<i>Oh no!</i>"  Thankfully, the ditz remembers her own wings and spreads them, slowing the descent to a rapid, controlled glide.  You sigh with relief, supported by her arms and legs thousands of feet in the air.  Sophie titters, "<i>Like, which way should we go, ' + CoC.getInstance().player.short + '?  Everything is all funny up here, and I dunno where you live.  We need a place to fuck!</i>"\n\n', false );
		EngineCore.outputText( 'You grudgingly direct her glide towards your campsite, and the two of you make good time.  Of course, Sophie\'s wet, drooling cunny makes an absolute mess of your ' + CoC.getInstance().player.armorName + ' and ' + CoC.getInstance().player.legs() + ' during the trip, soaking them with her copious pussy-cream.  She\'s exhausted and randy once you get to camp, and the landing is quite rough as a result.  You take a nasty tumble in the dirt, but it doesn\'t damage you significantly.  Sophie appears just as lucky - she\'s sitting on her plump rump with her legs spread wide, cluelessly scratching at her downy blond feathers.\n\n', false );
		EngineCore.outputText( 'After a few seconds, the bimbo\'s dull eyes seem to light up with delight.  "<i>Oh, is this where you live?  It\'s wonderful!  Oh, do you, like, sleep over there?  Can I share it with you?  Can we fuck every night?  Oh I\'ve got, like, so many questions!  Umm... which ones did I ask already?  I forget!</i>"\n\n', false );
		EngineCore.outputText( 'You sigh and show the bimbo around.  She seems extremely pleased by the arrangements, and once the tour is complete, she prances off to touch up her make-up, though you see her masturbating the whole time.', false );
		if( CoC.getInstance().player.findStatusAffect( StatusAffects.CampRathazul ) >= 0 ) {
			EngineCore.outputText( '  Afterwards, she offers to suck Rathazul\'s cock.  The old rat looked about ready to have a heart attack, but he managed to decline her offer with some amount of dignity, after a few moments of stammering.', false );
		} else if( CoC.getInstance().flags[ kFLAGS.UNKNOWN_FLAG_NUMBER_00238 ] === 1 ) {
			EngineCore.outputText( '  Afterwards, she offers to suck Izma\'s cock.  Izma looks at you for a moment before shaking her head, no.  Her skirt rises visibly in spite of her negative response.  Maybe she\'ll like having someone lower on the food chain to boss around?', false );
		} else if( CoC.getInstance().flags[ kFLAGS.AMILY_FOLLOWER ] > 0 && CoC.getInstance().flags[ kFLAGS.AMILY_BLOCK_COUNTDOWN_BECAUSE_CORRUPTED_JOJO ] === 0 ) {
			EngineCore.outputText( '  Afterwards, she offers to lick Amily\'s twat, if Amily will do the same to her.  Amily ', false );
			if( CoC.getInstance().flags[ kFLAGS.AMILY_FOLLOWER ] === 1 ) {
				EngineCore.outputText( 'flushes hotly and denies the bimbo\'s request with a terse \'no\'.', false );
			} else {
				EngineCore.outputText( 'flushes hotly and wiggles her hips Sophie\'s way.  The slutty, corrupted mouse and Sophie will clearly be helping to sate each other\'s needs in your absence.', false );
			}
		} else if( CoC.getInstance().scenes.jojoScene.monk >= 5 && CoC.getInstance().player.findStatusAffect( StatusAffects.NoJojo ) < 0 && CoC.getInstance().flags[ kFLAGS.JOJO_DEAD_OR_GONE ] === 0 ) {
			EngineCore.outputText( '  Afterwards, she offers to suck Jojo\'s cock.  The corrupted slut-mouse nods and stiffens in delight, though he keeps glancing back your way.  Those two will probably spend a lot of time together...', false );
		} else if( CoC.getInstance().player.findStatusAffect( StatusAffects.PureCampJojo ) >= 0 ) {
			EngineCore.outputText( '  Afterwards, she offers to suck Jojo\'s cock.  The chaste mouse\'s jaw drops, but when he picks it up, he answers, "<i>Never.  My body is as pure as my soul!</i>"', false );
		} else if( CoC.getInstance().scenes.isabellaFollowerScene.isabellaFollower() ) {
			EngineCore.outputText( '  Afterwards, she offers to lick Isabella\'s cunt.  Isabella answers sternly, ' );
			if( CoC.getInstance().scenes.isabellaFollowerScene.isabellaAccent() ) {
				EngineCore.outputText( '"<i> Nein!  But you can drink mein milk from time to time.</i>"' );
			} else {
				EngineCore.outputText( '“<i>No! But you can still drink my milk from time to time.</i>”' );
			}
			EngineCore.outputText( '  The cow-girl is blushing hotly.  You\'ve no doubt after a few nipple-licks she\'ll be spreading her thick thighs for the bimbo harpy.', false );
		}
		EngineCore.outputText( '\n\n', false );
		EngineCore.outputText( 'Well, you know where to find her any time you want to fuck the motherly bimbo.\n<b>(Bimbo Sophie has been added to your slaves!)</b>', false );
		Combat.cleanupAfterCombat();
	};
	...
	SophieBimbo.prototype.sophieCampLines = function() {
		...
		if( choice === 0 ) {
			EngineCore.outputText( 'Sophie is sitting by herself, applying yet another layer of glittering lip gloss to her puffy bimbo lips.', false );
		} else if( choice === 1 ) {
			EngineCore.outputText( 'Sophie is sitting by herself, idly diddling her twat and noisily moaning.  She keeps looking your way, hoping you\'ll approach.', false );
		} else if( choice === 2 ) {
			EngineCore.outputText( 'The beach-blond harpy is preening herself with a vapid, brainless look plastered on her face.  Her puffy, bee-stung lips are slightly parted and lacquered with a heavy layer of golden gloss.', false );
		} else {
			EngineCore.outputText( 'Your personal bimbo, Sophie, is playing with her breasts, touching and caressing the heavy orbs in between sighs of pleasure.  She keeps glancing your way, hoping you\'ll join her.  She\'s insatiable!', false );
		}
		EngineCore.outputText( '\n\n', false );
	};
	//Approach Texts;
	SophieBimbo.prototype.approachBimboSophieInCamp = function( output ) {
		if( output === undefined ) {
			output = true;
		}
		this.sophieSprite();
		if( CoC.getInstance().flags[ kFLAGS.FOLLOWER_AT_FARM_SOPHIE ] === 0 ) {
			if( output ) {
				...
				} else if( CoC.getInstance().scenes.sophieScene.pregnancy.isPregnant ) {
					switch( CoC.getInstance().scenes.sophieScene.pregnancy.event ) {
						case 3: //Medium Bump*
			...
			if( output ) {
				...
				this.sophieSprite();
				EngineCore.outputText( 'Sophie emerges from the hen coop and wiggles her way over to you when you call her name.' );
		...
		if( CoC.getInstance().player.lust < 33 && output ) {
			...
			EngineCore.addButton( 0, 'Sex', this.bimboSophieSexMenu );
		}
		if( CoC.getInstance().player.hasItem( ConsumableLib.DEBIMBO ) ) {
			EngineCore.addButton( 4, 'Debimbo', CoC.getInstance().scenes.sophieFollowerScene.unbimboSophie );
			if( output ) {
				EngineCore.outputText( '\n\n<b>You could use the bottle of debimbo to return Sophie\'s intellect...</b>' );
			}
		}
		if( CoC.getInstance().flags[ kFLAGS.SOPHIE_CAMP_EGG_COUNTDOWN ] > 0 && output ) {
			EngineCore.outputText( '\n\n<b>Sophie\'s egg is sitting nearby.</b>' );
		}
		if( CoC.getInstance().flags[ kFLAGS.SOPHIE_DAUGHTER_MATURITY_COUNTER ] > 0 ) {
			EngineCore.addButton( 5, 'Daughter', this.daughterCheckup );
		}
		if( CoC.getInstance().flags[ kFLAGS.SOPHIE_BROACHED_SLEEP_WITH ] === 1 && CoC.getInstance().flags[ kFLAGS.FOLLOWER_AT_FARM_SOPHIE ] === 0 ) {
			if( CoC.getInstance().flags[ kFLAGS.SLEEP_WITH ] !== 'Sophie' ) {
				if( output ) {
					EngineCore.outputText( '\n\nYou could invite her to share the bed with you at night.' );
				}
				EngineCore.addButton( 6, 'SleepWith', this.moveSophieInRepeat );
			} else {
				if( output ) {
					EngineCore.outputText( '\n\nYou\'re currently sharing your bed with Sophie at night.  You could kick her out.' );
				}
				EngineCore.addButton( 6, 'NoSnuggles', this.noSophieSleepWith );
			}
		}
		//EngineCore.choices('Nice Fuck',vag2,'Mean Fuck',vag,'FuckHerAss',anal,'Get Licked',getLicked,'Ovi Elixer',ovi,'Titty-Fuck',titFuck,'',0,'',0,'',0,'Leave',campSlavesMenu);;
		if( CoC.getInstance().flags[ kFLAGS.FOLLOWER_AT_FARM_SOPHIE ] === 0 && !CoC.getInstance().scenes.sophieScene.pregnancy.isPregnant && CoC.getInstance().flags[ kFLAGS.FARM_CORRUPTION_STARTED ] === 1 ) {
			EngineCore.addButton( 1, 'Farm Work', this.sendToFarm );
		}
		if( CoC.getInstance().flags[ kFLAGS.FOLLOWER_AT_FARM_SOPHIE ] !== 0 ) {
			EngineCore.addButton( 1, 'Go Camp', this.backToCamp );
		}

		if( CoC.getInstance().flags[ kFLAGS.FOLLOWER_AT_FARM_SOPHIE ] !== 0 && CoC.getInstance().flags[ kFLAGS.FOLLOWER_PRODUCTION_SOPHIE ] === 0 ) {
			EngineCore.addButton( 2, 'Harvest Eggs', this.harvestEggs );
		}
		if( CoC.getInstance().flags[ kFLAGS.FOLLOWER_AT_FARM_SOPHIE ] !== 0 && CoC.getInstance().flags[ kFLAGS.FOLLOWER_PRODUCTION_SOPHIE ] === 1 ) {
			EngineCore.addButton( 2, 'Change Eggs', this.changeEggs );
		}

		if( CoC.getInstance().flags[ kFLAGS.FOLLOWER_AT_FARM_SOPHIE ] !== 0 && CoC.getInstance().flags[ kFLAGS.FOLLOWER_PRODUCTION_SOPHIE ] === 1 ) {
			EngineCore.addButton( 3, 'Stop Harvest', this.stopHarvest );
		}

		EngineCore.addButton( 7, 'Appearance', this.sophieBimboAppearance );
		if( CoC.getInstance().flags[ kFLAGS.FOLLOWER_AT_FARM_SOPHIE ] === 0 ) {
			EngineCore.addButton( 9, 'Leave', CoC.getInstance().scenes.camp.campSlavesMenu );
		}
		if( CoC.getInstance().flags[ kFLAGS.FOLLOWER_AT_FARM_SOPHIE ] !== 0 ) {
	...
	//Appearance:;
	SophieBimbo.prototype.sophieBimboAppearance = function() {
		EngineCore.clearOutput();
		EngineCore.outputText( 'Sophie is a big, buxom harpy, no two ways about her.  She has ' );
		if( CoC.getInstance().flags[ kFLAGS.UNKNOWN_FLAG_NUMBER_00282 ] > 0 ) {
			EngineCore.outputText( 'very ' );
		}
		EngineCore.outputText( 'long ' );
		if( CoC.getInstance().flags[ kFLAGS.UNKNOWN_FLAG_NUMBER_00282 ] > 0 ) {
			EngineCore.outputText( 'platinum-blond' );
		} else {
			EngineCore.outputText( 'pink' );
		}
		EngineCore.outputText( ' \'hair\' that dangles off her shoulders, like a bird\'s plumage.  She wears a thick layer of golden lipstick over her plump' );
		if( CoC.getInstance().flags[ kFLAGS.UNKNOWN_FLAG_NUMBER_00282 ] > 0 ) {
			EngineCore.outputText( ', super-sized' );
		}
		EngineCore.outputText( ' lips at all times, like most of her kind, the gloss capable of giving her voice a compelling quality or inducing arousal on contact with males or herms.  Her face lacks the youthful quality found among many of her sisters, though you don\'t see any of the lines that would indicate age.' );
		EngineCore.outputText( '\n\nSophie\'s breasts are ' );
		if( CoC.getInstance().flags[ kFLAGS.UNKNOWN_FLAG_NUMBER_00282 ] > 0 ) {
			EngineCore.outputText( 'so immense they would drag her to the ground if she tried to fly, a sexy, lingering aftereffect of the draft you gave her.  The wobbly bimbo-tits look to be about F-cups.' );
		} else {
			EngineCore.outputText( 'unusually large.  The buxom harpy does seem slightly encumbered by them, but still capable of flight.  Her breasts look to be about DD-cups, nice and big enough for a soft squeeze or rough tit-fuck.' );
		}
		...
		if( CoC.getInstance().scenes.farmCorruption.hasTattoo( 'sophie' ) ) {
			...
			if( CoC.getInstance().scenes.farmCorruption.sophieFullTribalTats() ) {
				...
				if( CoC.getInstance().flags[ kFLAGS.SOPHIE_TATTOO_COLLARBONE ] !== 0 ) {
					EngineCore.outputText( CoC.getInstance().flags[ kFLAGS.SOPHIE_TATTOO_COLLARBONE ] + '\n' );
				}
				if( CoC.getInstance().flags[ kFLAGS.SOPHIE_TATTOO_SHOULDERS ] !== 0 ) {
					EngineCore.outputText( CoC.getInstance().flags[ kFLAGS.SOPHIE_TATTOO_SHOULDERS ] + '\n' );
				}
				if( CoC.getInstance().flags[ kFLAGS.SOPHIE_TATTOO_LOWERBACK ] !== 0 ) {
					EngineCore.outputText( CoC.getInstance().flags[ kFLAGS.SOPHIE_TATTOO_LOWERBACK ] + '\n' );
				}
				if( CoC.getInstance().flags[ kFLAGS.SOPHIE_TATTOO_BUTT ] !== 0 ) {
					EngineCore.outputText( CoC.getInstance().flags[ kFLAGS.SOPHIE_TATTOO_BUTT ] + '\n' );
				}
			}
		}
		EngineCore.menu();
		EngineCore.addButton( 0, 'Back', this.approachBimboSophieInCamp, false );
	};
	SophieBimbo.prototype.harvestEggs = function() {
		EngineCore.clearOutput();
		this.sophieSprite();
		EngineCore.outputText( 'You ask Sophie if it’s possible for her to produce eggs of a certain color whilst she’s here.' );
	...
	SophieBimbo.prototype.changeEggs = function() {
		EngineCore.clearOutput();
		this.sophieSprite();
		EngineCore.outputText( 'You ask Sophie to change the type of eggs that she is producing for you.' );
	...
	SophieBimbo.prototype.eggSelector = function() {
		for( var i = 0; i < this.eggColors.length; i++ ) {
			EngineCore.addButton( i, this.eggColors[ i ], this.postEggSelector, this.eggColors[ i ] );
		}
	};
	SophieBimbo.prototype.postEggSelector = function( selected ) {
		EngineCore.clearOutput();
		this.sophieSprite();
		EngineCore.outputText( '“<i>I’ll make some nice ' + selected.toLowerCase() + ' eggs just for you then, good looking,</i>” she says. “<i>I can only make, like, one once a week, though. All the rest gotta be sold. I’ll put it with the weekly earnings, ok?</i>”' );
		CoC.getInstance().flags[ kFLAGS.FOLLOWER_PRODUCTION_SOPHIE ] = 1;
		if( CoC.getInstance().flags[ kFLAGS.FOLLOWER_PRODUCTION_SOPHIE_COLORCHOICE ] !== selected ) {
			CoC.getInstance().flags[ kFLAGS.FOLLOWER_PRODUCTION_SOPHIE_COLORCHOICE ] = selected;
	...
	SophieBimbo.prototype.stopHarvest = function() {
		EngineCore.clearOutput();
		this.sophieSprite();
		EngineCore.outputText( 'You tell Sophie to stop giving you eggs; you’d rather she’d put them towards making the farm money.' );
		if( EngineCore.silly() ) {
			...
			EngineCore.outputText( '“<i>I only wish I was good with numbers and things,</i>” Sophie sighs wistfully, picking at her bellybutton. “<i>Then I’d know when to give you my eggs and, and when to give them to the doggie. Whatever you say anyways, babe!</i>”' );
		}

		CoC.getInstance().flags[ kFLAGS.FOLLOWER_PRODUCTION_SOPHIE ] = 0;
		EngineCore.doNext( CoC.getInstance().scenes.farmCorruption.rootScene );
	};
	SophieBimbo.prototype.sendToFarm = function() {
		EngineCore.clearOutput();
		this.sophieSprite();
		EngineCore.outputText( '“<i>I want you to head towards the lake,</i>” you say to your pet bimbo, “<i>and find a farm. You’re to present yourself to th...</i>“ you stop. Sophie is staring at you in complete incomprehension, fingering herself impulsively.' );
	...
	SophieBimbo.prototype.backToCamp = function() {
		EngineCore.clearOutput();
		this.sophieSprite();
		EngineCore.outputText( 'You tell her to head back to camp; there are things you need to do to her you can’t do whilst she’s here. Repeatedly. Sophie’s face falls a bit.' );
	...
	SophieBimbo.prototype.bimboSophieSexMenu = function() {
		EngineCore.clearOutput();
		EngineCore.outputText( 'How will you have sex with your feather-brained slut?' );
		EngineCore.menu();
		if( CoC.getInstance().player.hasCock() ) {
			//BUTT FUCKS;
			if( CoC.getInstance().player.cockThatFits( this.sophieCapacity() ) >= 0 && CoC.getInstance().player.lust >= 33 ) {
				EngineCore.addButton( 2, 'Anal', this.buttFuckBimboSophie );
			} else {
				EngineCore.outputText( '\n\n<b>You\'re too big to butt-fuck her.</b>', false );
			}
			//TIT FUCKS!;
			if( CoC.getInstance().scenes.sophieScene.pregnancy.event >= 2 ) {
				EngineCore.addButton( 5, 'Titty-Fuck', this.sophiePreggoTitJobs );
			} else {
				EngineCore.addButton( 5, 'Titty-Fuck', this.fuckBimboSophiesTits );
			}

			//VAG FUCKS!;
			if( CoC.getInstance().player.cockThatFits( this.sophieCapacity() ) >= 0 ) {
				if( this.sophieIsInSeason() ) {
					EngineCore.addButton( 0, 'Impregnate', this.sophieImpregnationSex );
				} else {
					EngineCore.addButton( 0, 'Nice Fuck', this.sophieFenCraftedSex );
				}
				EngineCore.addButton( 1, 'Rough Fuck', this.rideDatSophieVag );
			} else {
				EngineCore.outputText( '\n\n<b>You\'re too big to give her cunt a working over.</b>' );
			}
			if( CoC.getInstance().player.biggestCockArea() > this.sophieCapacity() && this.sophieIsInSeason() ) {
				EngineCore.outputText( '\n\nYou can always try to impregnate her with your biggest member...' );
				EngineCore.addButton( 6, 'Big Impreg', this.giantCocksImpregnateSophie );
			}
		}
		if( CoC.getInstance().player.hasVagina() ) {
			EngineCore.addButton( 3, 'Get Licked', this.bimboSophieLicksRugs );
		}
		if( CoC.getInstance().flags[ kFLAGS.TIMES_SOPHIE_HAS_DRUNK_OVI_ELIXIR ] > 0 && (CoC.getInstance().player.gender > 0) && !CoC.getInstance().scenes.sophieScene.pregnancy.isPregnant ) {
			if( CoC.getInstance().player.hasItem( ConsumableLib.OVIELIX ) || CoC.getInstance().scenes.inventory.hasItemInStorage( ConsumableLib.OVIELIX ) ) {
				EngineCore.addButton( 4, 'Ovi Elixir', this.sophieEggApocalypse );
			} else {
				EngineCore.outputText( '\n\n<b>If you had an Oviposition Elixir in your inventory or camp storage, Sophie could have some fun with it...</b>', false );
			}
		}
		if( CoC.getInstance().flags[ kFLAGS.TOLD_SOPHIE_TO_IZMA ] === 0 && CoC.getInstance().flags[ kFLAGS.TIMES_SOPHIE_AND_IZMA_FUCKED ] > 0 && CoC.getInstance().flags[ kFLAGS.IZMA_NO_COCK ] === 0 ) {
			EngineCore.outputText( '\n\nYou could tell Sophie to visit Izma again.  She\'d probably wind up tied AGAIN.' );
			EngineCore.addButton( 7, 'Visit Izma', this.tellSophieToVisitIzma );
		}
		if( CoC.getInstance().flags[ kFLAGS.SOPHIE_ADULT_KID_COUNT ] > 0 && CoC.getInstance().flags[ kFLAGS.SOPHIE_FAMILY_INCEST ] > 0 && CoC.getInstance().player.cockThatFits( this.sophieCapacity() ) >= 0 && CoC.getInstance().player.hasCock() ) {
			EngineCore.addButton( 8, 'DaughterFuck', CoC.getInstance().scenes.sophieFollowerScene.sophieIncestInHerCooterOrSomethingIDunno );
		}
		EngineCore.addButton( 9, 'Leave', this.approachBimboSophieInCamp );
	};
	SophieBimbo.prototype.tellSophieToVisitIzma = function() {
		EngineCore.clearOutput();
		EngineCore.outputText( 'You suggest she visit Izma again.  Maybe this time she won\'t get tied up again?' );
		EngineCore.outputText( '\n\nSophie squeals, "<i>REAAALLY?</i>" before taking off towards the other side of camp.  This should be good.' );
		CoC.getInstance().flags[ kFLAGS.TOLD_SOPHIE_TO_IZMA ] = 1;
		EngineCore.doNext( CoC.getInstance().scenes.camp.returnToCampUseOneHour );
	};

	//Lipstick Resistance Building;
	SophieBimbo.prototype.bimboSophieLustStickSurprise = function() {
		EngineCore.outputText( '\n', false );
		...
		var select = Utils.rand( 4 );
		if( select === 0 ) {
			this.sophieSprite();
			EngineCore.outputText( 'Sophie flounces into your arms and kisses you on the lips before you can react.  ', false );
			if( !CoC.getInstance().player.hasCock() ) {
				EngineCore.outputText( 'You smirk and pry the enthusiastic bimbo out of your arms, for now.', false );
				EngineCore.dynStats( 'lus', 1 );
			} else {
				EngineCore.outputText( 'You shiver, ' + Descriptors.sMultiCockDesc() + ' growing hard and ready to submit to the feathery blond\'s love.  Perhaps you\'ll take care of that soon...', false );
				EngineCore.dynStats( 'lus', 15 );
			}
			CoC.getInstance().scenes.sophieScene.luststickApplication( 5 );
		} else if( select === 1 ) {
			this.sophieSprite();
			EngineCore.outputText( 'During an idle moment, you feel heavy breasts squeezing against your back.  Sophie caresses your ' + Descriptors.chestDesc() + ' and nibbles at your ear.  She asks, "<i>Can we like, fuck soon, babe?  I\'ve been so wet here all by myself, just stroking my pussy and dreaming of you.</i>"  You can\'t help but turn and smile at her, but as soon as you do, she plants a kiss full on your lips.  ', false );
			if( !CoC.getInstance().player.hasCock() ) {
				EngineCore.outputText( 'Pushing her back, you give her ass a slap and mouth, \'Soon\'.', false );
				EngineCore.dynStats( 'lus', 1 );
			} else {
				EngineCore.outputText( 'Pushing her back, you try not to make contact against her with ' + CoC.getInstance().player.oMultiCockDesc() + '.  Your lips tingle dangerously, and you know you\'ll be lusting after harpies for at least a few hours.', false );
				EngineCore.dynStats( 'lus', 15 );
			}
			CoC.getInstance().scenes.sophieScene.luststickApplication( 5 );
		} else if( select === 2 ) {
			this.sophieSprite();
			if( CoC.getInstance().player.hasCock() ) {
				EngineCore.outputText( 'While standing there, drinking a sip of water, strong hands pull down your ' + CoC.getInstance().player.armorName + '.  Plump lips wrap around ' + CoC.getInstance().player.oMultiCockDesc() + ' and smother it in plush, warm slipperiness.  You look down at your bimbo harpy and sigh while ' + CoC.getInstance().player.oMultiCockDesc() + ' grows harder in her lips.  She pops off and asks, "<i>Like, wanna fuck?</i>"  You sigh and try to resist the images of yourself mounting the harpy that flood your mind.  It might be time to fuck her soon...', false );
				EngineCore.dynStats( 'lus', 15 );
			} else {
				EngineCore.dynStats( 'lus', 10 );
				EngineCore.outputText( 'While standing there, drinking a sip of water, strong hands pull down your ' + CoC.getInstance().player.armorName + '.  Plump lips slide over your ' );
				if( CoC.getInstance().player.hasVagina() ) {
					EngineCore.outputText( 'vulva, sucking at your clitoral hood.  Those gold, slobbery pussy-lickers look good on your groin, and you find yourself releasing your wetness from her oral attentions.  It might be time to fuck her soon...', false );
				} else {
					EngineCore.outputText( 'smooth groin, eventually licking at your [asshole].  Those gold, slobbery lickers look good pressed against you.  It might be time to fuck her soon...', false );
				}
			}
			CoC.getInstance().scenes.sophieScene.luststickApplication( 5 );
		} else {
			this.sophieSprite();
			EngineCore.outputText( 'Sophie glides down from atop a rock, landing roughly atop you.  She plants a wet, smacking kiss on you and asks, "<i>Didja miss me?  I totally missed you!</i>"  ', false );
			if( CoC.getInstance().player.hasCock() ) {
				EngineCore.dynStats( 'lus', 15 );
				EngineCore.outputText( Descriptors.SMultiCockDesc() + ' seems to wiggle inside your ' + CoC.getInstance().player.armorName + '.  Damn, she feels really good on you!  Maybe you should screw the slutty bimbo soon?  ', false );
			}
			EngineCore.outputText( 'You nod and Sophie gets up, beaming a radiant smile as she prances away, her booty swaying enticingly behind her.', false );
			EngineCore.dynStats( 'lus', 2 );
			CoC.getInstance().scenes.sophieScene.luststickApplication( 5 );
		}
		EngineCore.outputText( '\n', false );
	};
	SophieBimbo.prototype.daughterCheckup = function() {
		EngineCore.clearOutput();
		if( CoC.getInstance().flags[ kFLAGS.SOPHIE_DAUGHTER_MATURITY_COUNTER ] > 200 ) {
		...
		} else if( CoC.getInstance().flags[ kFLAGS.SOPHIE_DAUGHTER_MATURITY_COUNTER ] > 100 ) {
		...
		} else if( CoC.getInstance().flags[ kFLAGS.SOPHIE_DAUGHTER_MATURITY_COUNTER ] > 0 ) {
			EngineCore.outputText( 'Looking around for your developing daughter, you find that she and your ' );
			if( this.bimboSophie() ) {
				EngineCore.outputText( 'boisterous bimbo ' );
			} else {
				EngineCore.outputText( 'matronly harpy ' );
			}
			...
			if( this.bimboSophie() ) {
				EngineCore.outputText( 'live-in bimbo ' );
			} else {
				EngineCore.outputText( 'favorite bird-woman ' );
			}
			EngineCore.outputText( 'moves on to her hair and nails, all the while gabbing on and on about you, and about all the daughters she plans to have.' );
		...
		EngineCore.menu();
		if( this.bimboSophie() ) {
			EngineCore.addButton( 4, 'Back', this.approachBimboSophieInCamp );
		} else {
			EngineCore.addButton( 4, 'Back', CoC.getInstance().scenes.sophieFollowerScene.followerSophieMainScreen );
		}
	};
	//Unlock resistance:;
	SophieBimbo.prototype.unlockResistance = function() {
		if( CoC.getInstance().player.hasCock() ) {
		...
		EngineCore.outputText( '<b>(Perk Unlocked: Luststick Adapted - your minimum lust is permanently raised, but you are 20% more lust resistant.  In combat, you\'re immune to it, though it still gives you a rush during sex.  You\'re also comfortable enough with it to use it like a harpy if you find any.)</b>\n', false );
		CoC.getInstance().player.createPerk( PerkLib.LuststickAdapted, 0, 0, 0, 0 );
	};
	//Get oral as female.  ;
	SophieBimbo.prototype.bimboSophieLicksRugs = function() {
		this.sophieSprite();
		EngineCore.outputText( '', true );
		//*Summary - lean back on a rock and spread your legs.  She licks you off with chance of compelling you to sixtynine her. ;
		EngineCore.outputText( 'You sit back on a nearby rock and spread your ' + CoC.getInstance().player.legs(), false );
		if( CoC.getInstance().player.balls > 0 ) {
			EngineCore.outputText( ', lifting your heavy sack out of the way', false );
		}
		EngineCore.outputText( ' to give Sophie a perfect view of your ' + Descriptors.vaginaDescript() + '.  Sophie\'s dull, somewhat glazed eyes brighten at the sight of your box, and she leans forward intently, dipping a digit into herself as she asks, "<i>Ooh, can I, like, lick it for you?  It looks soooo yummy!</i>"\n\n', false );
		if( CoC.getInstance().player.cor < 33 ) {
			EngineCore.outputText( 'You nod nervously, blushing hotly at the thought of your bimbo-slut\'s fat lips kissing and lapping at your slit.', false );
		} else if( CoC.getInstance().player.cor < 66 ) {
			EngineCore.outputText( 'You nod and smile, blushing a bit in anticipation of feeling your bimbo-slut\'s fat, pussy-licking lips against your slit.', false );
		} else {
			EngineCore.outputText( 'You confidently smile and scoot your ' + Descriptors.hipDescript() + ' forward, anticipating the feeling of your bimbo-bitch\'s fat, pussy-licking lips on your slit.', false );
		}
		EngineCore.outputText( '  Sophie just looks at you, her wide-eyed gaze never leaving your engorged labia.  After what feels like a full minute of her watching you, she finally remembers that a nod means \'yes\', and she bounces up and down in excitement, clapping and cheering while her tits jiggle ludicrously.  She leans in close, nearly brushing her nose into your ', false );
		...
		//(ginormous clitties);
			...
			EngineCore.outputText( '"<i>It\'s... like, well... big!  Gosh, you\'re a big girl!  Mmm, you\'ll cum hard for Momma Sophie while I, like, suck on this fat pole, won\'t you?</i>" teases the thick-bootied bird-bitch.\n\n', false );
			EngineCore.outputText( 'You shudder as the harpy resumes her oral onslaught, slurping your ' + Descriptors.clitDescript() + ' deep into her throat in one smooth plunge.  She hums in delight, licking over the feminine fuck-stick\'s lower portions while she tries to get her fat, soft puss-pillows closer to your juicy snatch.  You rock your hips forward to thrust your ' + Descriptors.clitDescript() + ' further inside your bimbo\'s neckhole.  She gurgles happily and lashes at your ' + Descriptors.vaginaDescript() + ', her tongue tracing trails of hot, sexual pleasure through your depths as her molten-hot throat milks you like no tomorrow.\n\n', false );
		}
		EngineCore.outputText( 'Sophie purrs with desire, and when you hear a distinctive wet squelching coming from something other than your pussy, you realize she\'s vigorously masturbating.  You crane your head over to get a view of the harpy\'s frenzied, pumping fingers, watching them disappear into her puffy, lust-reddened lips, as if by magic.  Sophie ', false );
		if( CoC.getInstance().player.clitLength < 3 ) {
			EngineCore.outputText( 'hums on your clit and doubles the speed of her licking while you watch her finger-fucking her sloppy cunt.', false );
		} else {
			EngineCore.outputText( 'pumps on your clit with her hand and doubles the speed of her lashing tongue while you watch her finger-fucking her sloppy cunt.', false );
		}
		EngineCore.outputText( '  The sight pushes you over the edge in a climax of body-shaking, muscle-locking proportions.  You seize up and ', false );
		if( CoC.getInstance().player.wetness() >= 5 ) {
			...
			EngineCore.outputText( 'leak', false );
		} else if( CoC.getInstance().player.wetness() >= 2 ) {
			EngineCore.outputText( 'dribble', false );
		} else {
			EngineCore.outputText( 'drool', false );
		}
		EngineCore.outputText( ' fem-spunk all over Sophie\'s face, marking the bimbo with your love.  The horny harpy seems to be getting off on it as well, as she\'s moaning luridly into your labia, letting the fluid bubble up and muffle her outbursts.\n\n', false );
		EngineCore.outputText( 'You both fall back, winded, gasping, and a little delirious from the encounter.  The entirely of your groin is covered in a gold coating, shining with the harpy\'s lipstick and your own feminine moisture.  In a way, the sight is oddly entrancing.  Your ' + Descriptors.vaginaDescript() + ' glitters in the light while the harpy\'s overly-thick lipstick sinks into your skin, filling your body with drugs designed to stimulate males.  ', false );
		if( !CoC.getInstance().player.hasCock() ) {
			EngineCore.outputText( '  It\'s a good thing you don\'t have a penis!', false );
		} else {
			EngineCore.outputText( 'You groan as your groin burns with desire, filling your ' + Descriptors.multiCockDescriptLight() + ' with blood.  Images of yourself relentlessly fucking your bimbo bride pregnant over and over again fill your mind.  You shudder and blush, trying to resist the artificial needs pounding through your body, but you realize your body is ready.', false );
		}
		EngineCore.outputText( '\n\n', false );
		EngineCore.outputText( 'The ditzy blond giggles and tweaks her hefty nipples, cooing, "<i>That was absolutely yummy!  Your puss is like, totally tasty.  Let\'s go again!</i>"  You feel a little fucked out after the fantastic oral, and you decline.\n\n', false );
		EngineCore.outputText( 'Sophie retorts, "<i>But I wanna fuck nooooooowwww!</i>"  She pouts, sticking out her lower lip and saying, "<i>Come on... look at my pussy... just look at it.  Can\'t you, like, see how fucking wet you\'ve gotten me?  You know you wanna lick me... your tongue TOOOTALLY wants to taste my sweet honey-pot!</i>"  The harpy spreads her legs so wide she\'s nearly doing a split, pulling her pussy-lips apart to show you just how wet you\'ve made the puffy, pink entrance.  You\'ve got to admit... it does look really nice.  Her words seem... heavy somehow, like they have an extra weight behind them.  You have a hard time finding fault with her logic - she sure would taste good right about now...\n\n', false );
		EngineCore.outputText( '"<i>Please?  I\'ll make you feel just as good as last time, maybe more.  Look at me, at my lips, would they lie to you?  I bet they\'d feel soooo good back on your hot, wet cunny', false );
		if( CoC.getInstance().player.hasCock() ) {
			EngineCore.outputText( ', or thick, juicy dick', false );
		}
		EngineCore.outputText( '.  Come over here and sixty-nine me, baby!</i>" cheers Sophie with a wiggle of her considerable hips.  Damn, her lips are sooo plump and sexy, and that ass - gods she\'s getting you wet ', false );
		if( CoC.getInstance().player.hasCock() ) {
			EngineCore.outputText( 'and hard ', false );
		}
		EngineCore.outputText( 'again!  You want to tackle her onto the ground and smash your crotch into her face!  Fuck, is she trying to use her compulsion on you? It\'s working!\n\n', false );
		CoC.getInstance().player.orgasm();
		EngineCore.dynStats( 'sen', -1 );
		CoC.getInstance().scenes.sophieScene.luststickApplication( 4 );
		if( CoC.getInstance().player.inte * 2 < CoC.getInstance().player.cor + CoC.getInstance().player.lib ) {
			EngineCore.outputText( 'There\'s no way you could ever turn her down at this point... just look at her lips... they\'d never lie to you.  It\'ll feel so good...', false );
			EngineCore.doNext( this.bimboSophieSixtyNineAfterCunnilingus );
		} else {
			EngineCore.outputText( 'What do you do?', false );
			EngineCore.choices( 'Sixtynine', this.bimboSophieSixtyNineAfterCunnilingus, '', null, '', null, '', null, 'Leave', CoC.getInstance().scenes.camp.returnToCampUseOneHour );
		}
	};
	//SixtyNine Continuation - GOILS you're a wreckin' machine;
	SophieBimbo.prototype.bimboSophieSixtyNineAfterCunnilingus = function() {
		this.sophieSprite();
		EngineCore.outputText( '', true );
		//NON WANG;
		if( !CoC.getInstance().player.hasCock() || CoC.getInstance().player.cockThatFits( this.sophieCapacity() ) === -1 ) {
			EngineCore.outputText( 'You throw yourself at Sophie, compelled by thoughts of pleasure and her delicious-looking pussy, wanting nothing more than to place your lips on her cunt and slurp with reckless abandon.  She takes the hit like a champ, tumbling with you through the dirt and dust until you land on your ' + Descriptors.buttDescript() + ', bouncing to a stop with the harpy\'s feathery thighs clenching around your head.  ' );
			if( CoC.getInstance().scenes.sophieScene.pregnancy.event >= 2 ) {
				EngineCore.outputText( 'Her pregnant belly rests against your middle, untouched by the rough fall.  ' );
			}
			EngineCore.outputText( 'How did she do that?  Your questions fade away as you look up and spot your target - the cum-slicked delta of Sophie\'s cunt, so moist it seems to fog the air, beckoning you to plunge your tongue inside and taste it.\n\n', false );
			EngineCore.outputText( 'With rapacious desire, you grab the harpy\'s down-coated ass-cheeks and squeeze her plump rump, pulling her dripping cooch straight onto your face.  You shiver at the potent, womanly smell as it oozes over your ' + CoC.getInstance().player.face() + ', and dribbles down your chin.  Without a moment\'s hesitation, you take the first long lick of Sophie\'s tasty juices.  They have a tangy flavor that seems to sizzle on your tongue before fading into a soft, sweet, peach-like taste.  You hum in pleasure - the harpy was right; your tongue REALLY wants to taste her.\n\n', false );
			EngineCore.outputText( '"<i>Wow! You\'re so good at pussy-licking, babe,</i>" declares Sophie, pursing her lips slowly and deliberately as she enunciates the rest of her statement, "<i>Your tongue just can\'t get enough harpy pussy!  Ooooh yeah, you\'re totally the best cunny-licker I\'ve like, ever had munch on my box!  Mmm, you love Momma Sophie\'s girl-cum, dontcha?  Yea-ah... lick lick lick!</i>"  She giggles inarticulately after that, swiveling her hips to smear her leaking vagina all over your face.  You cram your ' + CoC.getInstance().player.face() + ' further up Sophie\'s creamy quim and lick over and over, curling your tongue into every delicious nook and fold.\n\n', false );
			EngineCore.outputText( 'Sophie drops down onto her elbows, her ass-length blond plumage tickling at your ' + CoC.getInstance().player.legs() + ' as she examines your groin.  The slutty harpy leans over your gold-smeared crotch and gives your ' + Descriptors.clitDescript() + ' a kiss, her plush lips smothering the ', false );
			if( CoC.getInstance().player.clitLength < 1 ) {
				EngineCore.outputText( 'tiny ', false );
			}
			EngineCore.outputText( 'organ in warm, oral bliss.  You moan into her sumptuous pussy and giggle when the vibrations set off a cascade of harpy cum.  Inspired, you begin to hum with every lick, the sound carrying up from your voice-box to turn your tongue into the bimbo\'s new vibrator.\n\n', false );
			EngineCore.outputText( 'The two of you attack each other\'s pussies in a frenzy of wanton need, slurping and moaning so loudly that the noise is likely carried a hundred yards away.  Sophie\'s pussy seems to grow even more delectable with every touch to your taste buds, if such a thing is possible.  Your moronic mate seems equally infatuated with your pussy, and she sucks your clit', false );
			if( CoC.getInstance().player.clitLength >= 3 ) {
				EngineCore.outputText( ', even pausing to jack it off like a penis', false );
			}
			EngineCore.outputText( ' with hasty, need-filled strokes.  Eyes crossing, you suck and lick, swallowing great mouthfuls of bimbo-jizz in your haste to bring off the harpy.\n\n', false );
			EngineCore.outputText( 'Sophie parts her silken lips from your gold-glazed groin with a moist *pop*.  "<i>You\'re totally great at licking pussy, babe!  Mmmmhmmm, just, like, keep doing it like that.  You\'ll mmm-make Momma Sophie cum in no time!  Make me cum, baby!  Oooh, does trying to make cum make you hot for my pussy?  You\'re gonna cum... I know it... you\'ll cum with me,</i>" utters the bimbo bitch while she stirs your pussy with a finger, stroking around it and dragging her long nails over the sensitive flesh of your loins.  Her words hit you like a wave, and with renewed vigor, you thrust your entire tongue deep inside the harpy and rub your lower lip back and forth across her pleasure-bud.  Pulling hard on her hips, you orally ravage her cunt with no regard for anything around yourself, your body burning hot from how good it feels to get your pet off.\n\n', false );
			EngineCore.outputText( 'At long last, the bimbo\'s bald cunt climaxes from your work, splattering you with a flood of musky girl-spunk.  You still need her pussy so bad that you can\'t stop.  You lick, lap, and swallow with inhuman eagerness until the box atop you is emptied of everything save your saliva.  Then, and only then, do you finally feel release.  Your ' + Descriptors.vaginaDescript() + ' climaxes for Sophie, soaking her fingers and wringing them as if your life depended on it.  She giggles, coming down from her own orgasm and feeling quite pleased with the effects her words have had on you.\n\n', false );
			EngineCore.outputText( 'The harpy gets up, but only long enough to turn around and lay atop you, face to face' );
			if( CoC.getInstance().scenes.sophieScene.pregnancy.event >= 2 ) {
				EngineCore.outputText( ', egg-swollen belly smushing between you' );
			}
			EngineCore.outputText( '.  "<i>That was sooo fun!  Like, we\'ll totally do this sometime soon, but I need a drink, and you smell like pussy.  Mmmm, I like that smell.  It means fun stuff!</i>"  Sophie kisses you full on the mouth, her puffy, quim-stained lips coloring your own with her amber lipstick.  "<i>You\'re like, the best pussy-licker ever, ya know?</i>"\n\n', false );
			EngineCore.outputText( 'Sophie struts off, touching a finger to her cunt before licking it, tasting the remnants of your saliva.', false );
			CoC.getInstance().scenes.sophieScene.luststickApplication( 5 );
			CoC.getInstance().player.orgasm();
			EngineCore.dynStats( 'sen', -1 );
		}
		//SixtyNine Continuation - DUDES;
			...
			var x = CoC.getInstance().player.cockThatFits( this.sophieCapacity() );
			if( x < 0 ) {
				x = CoC.getInstance().player.smallestCockIndex();
			}
			EngineCore.outputText( 'You throw yourself at Sophie, compelled by thoughts of pleasure and her delicious-looking pussy.  Imagining yourself placing your lips on her cunt and slurping with reckless abandon, you tackle her, hard.  She takes the hit like a champ, tumbling with you through the dirt and dust until you land on your ' + Descriptors.buttDescript() + ', bouncing to a stop with the harpy\'s feathery thighs clenching around your head.  ' );
			if( CoC.getInstance().scenes.sophieScene.pregnancy.event >= 2 ) {
				EngineCore.outputText( 'Her gravid belly bumps up against your own, somehow untouched by the rough-and-tumble fall.  ' );
			}
			EngineCore.outputText( 'How did she do that?  Your questions fade away as you look up and spot your target - the cum-slicked delta of Sophie\'s cunt, so moist it seems to fog the air, beckoning you to plunge your tongue inside and taste it.\n\n', false );
			EngineCore.outputText( 'With rapacious desire, you grab the harpy\'s down-coated ass-cheeks and squeeze her plump rump, pulling her dripping cooch straight onto your face.  You shiver at the potent, womanly smell as it oozes over your ' + CoC.getInstance().player.face() + ' and dribbles down your chin.  Without a moment\'s hesitation, you take the first, long lick of Sophie\'s tasty juices.  They have a tangy flavor that seems to sizzle on your tongue before fading into a soft, sweet peach-like taste.  You hum in pleasure - the harpy was right: your tongue really wants to taste her.\n\n', false );
			...
			EngineCore.outputText( 'Sophie drops down onto her elbows, her ass-length blond plumage tickling at your ' + CoC.getInstance().player.legs() + ' as she examines your groin.  The slutty harpy leans down over ' + CoC.getInstance().player.oMultiCockDesc() + ' and gives it a gentle squeeze, staring down at the pulsating penis with a rapt, attentive gaze.  "<i>Mmmm, such a yummy dick!  Did it, like, get this super-hard for lil\' ol me?  Oh, that\'s so cute babe!  Just lie back and lick while Momma Sophie gets all the sticky, stinky ol\' cum out of you!</i>"\n\n', false );
			EngineCore.outputText( 'The air-headed harpy rubs one of her long, manicured-looking nails over your urethra, teasing your poor ' + Descriptors.cockDescript( x ) + ' with persistent touches.  You cry out in bliss, your straining voice muffled by the heavenly coochie oozing over your face, though the cries of passion lend your tongue a vibrating quality that seems to please her compelling cunt greatly.  It releases a wash of juice onto your tongue and mouth, giving you more of the peaches-and-tang taste that you\'ve come to crave.  Sophie\'s cunt tastes so good, you\'ve got to get more!\n\n', false );
			EngineCore.outputText( 'You squeeze her jiggly, bimbo-sized ass-cheeks and cram her cunt harder against your lips.  MORE!  You\'ve got to taste her more!  You lash at her pink pussy wildly, throwing your tongue around in a frenzy of whip-like licks.  Meanwhile, Sophie moans and bends down to curl her thick lips around your pre-cum-pulsing prick.  She\'s so warm that it feels like your cock is melting between those plush, painted pillows.  The bimbo circles her tongue over your slick dick-tip, firing constant bolts of hellish pleasure up your shaft.  Slurping noisily, she begins to suck as well, and her cheeks hollow from the effort of trying to vacuum the cum straight from your ' + Descriptors.cockDescript( x ) + '.\n\n', false );
			EngineCore.outputText( 'The bimbo\'s mouth is like your own personal heaven.  As she continues to fellate you, you can feel your ' + CoC.getInstance().player.skin() + ' blushing and your heart hammering from the influx of chemicals.  Sophie\'s smothering your ' + Descriptors.cockDescript( x ) + ' in caramel-hued drugs, but you\'re already too far gone to care.  Her mouth feels so good, her pussy tastes even better, and you couldn\'t stop licking even if you wanted to.  Your tongue... it just can\'t get enough of that wonderful duff.  It\'s so good... so tasty.  You keep licking as hard you as can, your oral organ aching to stay buried in the sloppy wet box, even though it\'s already pushed as far inside as you can manage.\n\n', false );
			EngineCore.outputText( 'Sophie pops your ' + Descriptors.cockDescript( x ) + ' out with a lurid moan, ignoring the strands of gold saliva connecting her to your crotch.  "<i>So yummy!  Did I ever tell you that your dick is, like, the best tasting thing?  It dripped some of your icing all over my tongue and it was soooo good.  Hurry up and give me more - squirt it all over my lips and tongue!  Cover me in your love babe, and like, don\'t stop licking!</i>" she commands.\n\n', false );
			EngineCore.outputText( 'As her imperatives roll through you, you shudder and shake.  ' + CoC.getInstance().player.OMultiCockDesc() + ' immediately releases a dollop of pre-cum, and Sophie dives down on it like an addict seeking her fix.  The return of her drugged suction is nearly too much for you, and you feel your ' + Descriptors.cockDescript( x ) + ' swelling in her mouth, the ' + CoC.getInstance().player.cockHead( x ) + ' thickening against her hungry tongue.  She shakes on top of you and releases another wave of syrupy fluids.  You swallow a mouthful, compulsively drinking her prodigious pussy\'s copious lady-spunk.  Your back arches, your ' + CoC.getInstance().player.legs() + ' clench, and you erupt inside your bimbo\'s puckered, sucking mouth-hole, giving her tonsils a bath of your creamy semen.  Rivulets of semen run over her juicy lips as you cum too fast for her to keep up with.', false );
			if( CoC.getInstance().player.cumQ() >= 500 ) {
				EngineCore.outputText( '  She gulps and swallows as fast as possible, but cum starts oozing from her nose, dripping from the corners of her mouth, and spurting back out around your ' + Descriptors.cockDescript( x ) + ' to spatter your groin.', false );
				if( CoC.getInstance().player.cumQ() >= 1000 ) {
					EngineCore.outputText( '  After a moment of this, the full-bellied harpy pulls back and lets you paint the remainder over her face, hair, and mountainous breasts.', false );
				}
			}
			EngineCore.outputText( '\n\n', false );
			EngineCore.outputText( 'Sophie gives an airheaded giggle and jumps up, ignoring the slosh of your sexual fluids in her belly' );
			if( CoC.getInstance().scenes.sophieScene.pregnancy.event >= 2 ) {
				EngineCore.outputText( ' and the way her egg-stuffed womb jiggles' );
			}
			EngineCore.outputText( '.  Shining in the light, a web of harpy-lube stretches between her groin and your soaked face.  You try to sit up and get your tongue back where it belongs, inside her, but she steps one of her clawed feet down on your chest to playfully pin you to the ground.\n\n', false );
			EngineCore.outputText( 'The blond bombshell titters, "<i>Like, you don\'t need to lick my cunny any more, babe. You were totally awesome and got me off super hard.  And you did such a good job cumming for me too!  Just relax there a moment, I\'m gonna get a drink or something.  Let\'s do this again soon!</i>"\n\n', false );
			EngineCore.outputText( 'Sophie leans down to kiss you on the lips, smearing more of her lust-enhancing lipstick over your mouth.  ' + Descriptors.SMultiCockDesc() + ' stays hard as a rock, but the need to service her pussy with your tongue slowly fades.  You feel oddly sated in spite of your erection, yet you know that a peek at your vapid harpy mistress will likely throw you into a rutting frenzy all over again thanks to the properties of her lipstick.', false );
			CoC.getInstance().player.orgasm();
	...
	SophieBimbo.prototype.buttFuckBimboSophie = function() {
		this.sophieSprite();
		EngineCore.outputText( '', true );
		var x = CoC.getInstance().player.cockThatFits( this.sophieCapacity() );
		if( x < 0 ) {
		...
		EngineCore.outputText( 'You instruct your bimbo bitch to bend over and show you that rounded rump that you keep her around for.  She leans away from you, her ass high in the air with tail feathers fluffing, and she cluelessly asks, "<i>Ummm, like this, babe? Or this?</i>"\n\n', false );
		EngineCore.outputText( 'The bimbo bounces her backside back and forth, making her heavy cheeks jiggle a few inches away from you.  Winking between them, Sophie\'s puckered anal star and juicy, dripping pussy seem to beckon for your ' + Descriptors.multiCockDescriptLight() + ', but you just watch for now, enjoying the sight of such a gorgeous ass jiggling and shaking for you.  After a moment she asks, "<i>Or did you mean like this?</i>"  The harpie flexes her thighs and begins to bounce her ass up and down to a vigorous, butt-shaking rhythm no one but your slut can seem to hear.  Your eyes sway up and down, following the glorious, heart-shaped mass on its ballistic trajectory while ' + Descriptors.sMultiCockDesc() + ' becomes hard and completely ready to claim that bouncy butt.\n\n', false );
		EngineCore.outputText( 'Stepping closer, you toss off your ' + CoC.getInstance().player.armorName + ' and reply, "<i>Yes, just like that.</i>"\n\n', false );
		EngineCore.outputText( 'Sophie claps her hands and gives a girlish squeal of happiness. "<i>Really?  C-can I like, do this a little closer?  ', false );
		if( CoC.getInstance().player.cockTotal() > 1 ) {
			EngineCore.outputText( 'Those cocks look', false );
		} else {
			EngineCore.outputText( 'That cock looks', false );
		}
		EngineCore.outputText( ' delic... de... yummy!</i>"  You slap her ass, grab her tail feathers, and pull the harpy\'s winking asshole down onto your ' + Descriptors.cockDescript( x ) + '. Her voices rises, not in anger, but in delight, and your ' + CoC.getInstance().player.cockHead( x ) + ' pulses pleasantly in the first few inches of the harpy\'s rectum.  The bimbo relaxes and sinks down, giggling and asking, "<i>Is-ooh-is my butt, like, good for you?  It\'s soooo tight, and it\'s making my cunny all wet and stuff!</i>"\n\n', false );
		EngineCore.outputText( 'You squeeze her shuddering rump hard enough to feel her flesh bulging out around your fingers, the soft cheeks nearly subsuming your hands, and then you pull her hard, dragging your ' + Descriptors.cockDescript( x ) + ' the rest of the way inside her, all the way to the ', false );
		if( !CoC.getInstance().player.hasSheath() ) {
			EngineCore.outputText( 'hilt', false );
		} else {
			EngineCore.outputText( 'sheath', false );
		}
		EngineCore.outputText( '.  Sophie\'s breasts sway underneath her, the pendulous globes occasionally dipping low enough to drag her thumb-sized nipples through the rough dirt.' );
		if( CoC.getInstance().scenes.sophieScene.pregnancy.event >= 2 ) {
			EngineCore.outputText( '  Just like her breasts, her gravid tummy sways a little as well, plush with the weight of the egg you\'ve given her.' );
		}
		EngineCore.outputText( '  The bimbo moans harder every time it happens and sounds more whorish and lurid with each passing second - a true anal slut.  She looks back at you with lust in her eyes and a gleeful grin on her face.  Suddenly, one of the ditz\'s fingernails is dragging ', false );
		if( CoC.getInstance().player.balls > 0 ) {
			EngineCore.outputText( 'over your ' + Descriptors.ballsDescriptLight(), false );
		} else {
			EngineCore.outputText( 'across your taint', false );
		}
		EngineCore.outputText( '.  It works its way down, crosses the joining of your bodies, and reaches its owner\'s pussy, circling the puffy lips until a long strand of girl-goo is dangling down towards the ground.\n\n', false );
		EngineCore.outputText( '"<i>So... good.  Why didn\'t anyone tell me that butt-sex is like, super-duper fun?</i>"  The breathless bimbo rocks her ass back and forth, and you let her have her \'fun\'.  She\'s wiggling and squirming, impaled on a cock and loving it.  You simply relax and let her go to town, the bimbo\'s fingers running through her sodden box in time with the butt-jiggling contortions of her body.  Her anus milks your ' + Descriptors.cockDescript( x ) + ' like a machine, drawing out thick streamers of pre-cum to make her ass almost as sloppy as her pussy.  It\'s hard to stand still with her working you so efficiently, and after a few moments of allowing your bimbo to pleasure you with her plump rump, you tire of waiting.\n\n', false );
		EngineCore.outputText( 'Pushing her away, you unsheath most of your ' + Utils.num2Text( Math.round( CoC.getInstance().player.cocks[ x ].cockLength ) ) + ' inches from Sophie\'s stretched asshole, leaving just your ' + CoC.getInstance().player.cockHead( x ) + ' to hold the rectal portal open.  She whines in disappointment until you lunge forward and stuff her full of dick so suddenly that she squirts dribbles of lube.  You grab her hair with one hand and ride her ass hard and fast, each thrust punctuated by happy squeals of submissive pleasure from your airheaded anal toy.  Sophie cheers, "<i>Fuck me ' + CoC.getInstance().player.mf( 'stud', 'babe' ) + ', fuck my ass!  Unh, y-yeah like that.  Mmmm, yeah, pull my hair and tell me what a bad girl I\'ve been!</i>"\n\n', false );
		EngineCore.outputText( 'Gods, she\'s such a naughty little bird bitch!  You yank her hair back and lean over her shoulder, whispering, "<i>You like that, you brain-dead bimbo?  Look down at all the juices raining from your cunt.  Would anyone but a horny slut get off so hard from having her ass reamed?  I don\'t think so.</i>"\n\n', false );
		EngineCore.outputText( 'You keep butt-fucking her hard and fast, ignoring the sprinkles of sticky, maternal harpy-juice that splatter on your ' + CoC.getInstance().player.legs() + ' as you fuck her.  In between throaty moans and screams, she bellows out "<i>YES!</i>" as loudly as possible, then lapses into quiet, exhausted grunts.  Yet, her vagina does not stop its prodigious leaking; if anything it\'s dripping and squirting out even heavier flows of submissive girl-spooge.  The harpie\'s anal ring is convulsing around you, reduced to pointless trembling from the hard fucking you\'re giving her.  Looking back with lidded eyes, she begs, "<i>C-cum... cum in my ass... it\'ll... it\'ll feel soo good, babe.  Please?  Like, gimme your spooge!</i>"\n\n', false );
		if( CoC.getInstance().player.balls > 0 ) {
			EngineCore.outputText( 'Your balls seize up at Sophie\'s request, and you swear you can actually hear the fluid churning and sloshing of your cum before it burns a path of warmth through your body.', false );
		} else {
			EngineCore.outputText( 'Your insides seem to seize up at Sophie\'s request, and you swear you can actually feel the fluid churning a path of warmth through your body.', false );
		}
		EngineCore.outputText( '  Seed spews from your ' + Descriptors.cockDescript( x ) + ' into your bimbo\'s blubbery bottom with an audible gurgle that brings a blush to her cheek.  You pull her hair harder and bounce your ' + Descriptors.hipDescript() + ' off her bottom a few times, injecting the rest of your cum inside her while you rut at her now-sloppy anus.', false );
		if( CoC.getInstance().player.cumQ() >= 500 ) {
			EngineCore.outputText( '  Even though your semen is frothing and spurting from between her cheeks with each push, you keep at it', false );
			if( CoC.getInstance().player.cumQ() >= 1000 ) {
				EngineCore.outputText( ', filling her belly with spooge', false );
			}
			EngineCore.outputText( '.', false );
		}
		EngineCore.outputText( '  With a few final clenches of pleasure, your dick\'s flow of cum trickles down to a dribble.  You sigh and muse that you must\'ve completely emptied your ' + Descriptors.ballsDescriptLight() + ' by now, and you slump back against a rock to watch your jizz flood out of Sophie\'s ass.  She pushes some inside her pink nether-lips with a triumphant smile, clearly pleased with herself.\n\n', false );
		EngineCore.outputText( 'Still full of energy, the big-tittied ditz bounces around and catches the cum as it drains from her gaped ass, shoving more and more into her soaked quim.  She even licks her fingers once she bores of that and says, "<i>Thanks for making my asshole so creamy!  You even left me enough to like, stuff up my twat so I can have an egg!  Yay!</i>"\n\n', false );
		if( CoC.getInstance().scenes.sophieScene.pregnancy.event >= 2 ) {
			EngineCore.outputText( 'Sophie giggles again, rubbing her already well-filled belly and winking at you, like you\'re sharing in some absurd joke.  You roll your eyes - bimbos!' );
		}
		if( this.sophieIsInSeason() ) {
	...
	//TitFuck;
	SophieBimbo.prototype.fuckBimboSophiesTits = function() {
		this.sophieSprite();
		EngineCore.outputText( '', true );
		var x = CoC.getInstance().player.cockThatFits( this.sophieCapacity() );
		if( x < 0 ) {
		...
		EngineCore.outputText( 'You grab Sophie\'s tits in a squeezing grip and pull her towards you, flicking your thumbs across the bimbo\'s nipples.  She stumbles toward you and purrs, "<i>Who\'s being forward now, huh?  If you wanted to play with Momma Sophie\'s tits, all you had to do was, like, ask!</i>"\n\n', false );
		EngineCore.outputText( 'The harpy grabs at your ' + CoC.getInstance().player.armorName + ' and removes it, leaving your hands free to continue the fondling of her breasts.  Once you\'re as a nude as your salacious slut, you finally release the huge, watermelon-like breasts and admire your handiwork.  Sophie\'s ditzy, empty eyes are dilated, her mouth is open and drooling, and her nipples are easily as big as your thumbs.  She\'s panting softly and just staring at you with her eyes glazed.  You can only assume that her simple mind has slipped into some kind of erotic trance, but if anything it only makes the idea of releasing yourself with her big, soft mammaries that much more appealing.\n\n', false );
		EngineCore.outputText( 'You grab hold of her nipples and sit down on a nearby rock; the dazed harpy is pulled onto her knees.  ' );
		if( CoC.getInstance().scenes.sophieScene.pregnancy.event >= 2 ) {
			EngineCore.outputText( 'Her swollen tummy pushes against your [legs] as she assumes the position, the weighty egg-distorted lump pressing against you.  ' );
		}
		EngineCore.outputText( 'She wobbles forward and her massive mounds easily slide to either side of ' + CoC.getInstance().player.oMultiCockDesc() + ', completely engulfing it.  Still holding on to her nipples, you pull them together and ', false );
		if( CoC.getInstance().player.cocks[ x ].cockThickness < 8 ) {
			EngineCore.outputText( 'completely surround yourself', false );
		} else {
			EngineCore.outputText( 'surround as much of yourself as possible', false );
		}
		EngineCore.outputText( ' in warm, smooth skin.  The smell of your ' + Descriptors.cockDescript( x ) + ' mere inches from her nose seems to startle Sophie from her trance, and she breaks into a smile so big you\'ll worry it\'ll break her face.\n\n', false );
		EngineCore.outputText( '"<i>Wh-what\'s going o-mmmmmm, that looks nice!  Oooh, and it\'s already in Momma Sophie\'s big ol\' titties!  Yay!  Like, do you mind if I give it a kiss?</i>" asks the bimbo with a cross-eyed, dick-addicted look on her face.  You nod your assent and lean back, feeling quite pleased with how this is working out.\n\n', false );
		EngineCore.outputText( 'Suddenly, Sophie\'s puckered lips are on your ' + CoC.getInstance().player.cockHead( x ) + ', sucking it softly while her tongue tickles the sensitive slit of your urethra.  She pops off for a breath with a lusty look in her eyes and spit drooling from the corner of her puffy lips to lubricate her tits.  A golden lip print sits around the circumference of your ' + Descriptors.cockDescript( x ) + ', marking just how much she\'s managed to smother in oral pleasure.  Pulling her hands up, she presses her palms into the heavy weight of her breasts, nearly vanishing from view as she drags them up your ' + Utils.num2Text( Math.round( CoC.getInstance().player.cocks[ x ].cockLength ) ) + '-inch length.  Her drugged lipstick makes your ' + CoC.getInstance().player.cockHead( x ) + ' tingle deliciously, and you sigh, happy to have such glorious udders growing from your bleach-blonde bitch.\n\n', false );
		EngineCore.outputText( 'Full, slippery lips slide back around you again, further staining your ' + Descriptors.cockDescript( x ) + ' in their amber gloss.  It\'s enough to make you swoon and flare, growing thicker inside her smothering mounds while she pumps at you with her tits.  Sophie croons in between sucking on your dick-tip, saying, "<i>Mmm, such a yummy cock!  Let my tits like, milk out all that yummy cum from your cock, okay babe?</i>"\n\n', false );
		EngineCore.outputText( 'You demur and start pumping your hips.  The bimbo shakes her platinum-blonde feathers in irritation, but she doesn\'t dare stop you now.  You grab her tits as well, lifting them out of her grip as you begin to fuck them in earnest, your cock cresting through the massive cleavage with each stroke.  Sophie smiles dopily, rapidly forgetting her unhappiness at being so thoroughly manhandled, and she returns to worshipping your ' + CoC.getInstance().player.cockHead( x ) + ' each time it comes anywhere near her mouth.  Spit and golden lipstick drool down her cleavage, and soon your rod looks like a golden spear of lust, trembling in the pale valleys of your bimbo slut\'s mountainous peaks.\n\n', false );
		...
		EngineCore.outputText( 'One of the dumb blonde\'s hands circles under her bouncing, jiggling chest to stroke your ' + Descriptors.cockDescript( x ) + ', jacking you off with the spit, sweat, and drugged gloss as lubricants.  She jerks you hard and fast, smearing it ', false );
		if( CoC.getInstance().player.balls > 0 ) {
			EngineCore.outputText( 'all over your balls whenever she needs a break, and you feel your ' + Descriptors.ballsDescriptLight() + ' growing heavier by the moment.', false );
		} else {
			EngineCore.outputText( 'all over your taint and asshole, and you feel your body churning, building up more seed for your moronic mate.', false );
		}
		EngineCore.outputText( '  ' + Descriptors.SMultiCockDesc() + ' thickens and bloats, a rush of warmth rushing up the base as your internal muscles clench tight, squeezing out a globby rope of jism.  It explodes from your cum-slit, taking Sophie full on the face.\n\n', false );
		EngineCore.outputText( 'You\'re just getting started.  Sophie smirks and opens her mouth, letting her tongue slide out to taste your jizm as you launch the next rope, so long it trails from her hair to her chin and so thick it rolls in drops from the side of her face.  She hums in delight and squeezes her breasts tight around your ' + Descriptors.cockDescript( x ) + ', the next blast backing up inside you from the pressure.  A moment of buildup later, and your seed germinates and blooms over the harpy\'s tits, soaking them with spunk.  Droplets of the stuff splatter onto the ground around the both of you, but you just keep coming.  In your mind you have visions of yourself knocking up harpy after harpy, the slutty bird-girls mounting your fountaining fuck-stick long enough for their bellies to bloat with seed before moving on.  Like this, you could inseminate a whole tribe...\n\n', false );
		EngineCore.outputText( 'Once the thought passes, you sag back, utterly spent and more than a little parched.  Blinking the haze from your eyes, you look over at Sophie.  She\'s on her back, frigging herself non-stop and utterly lost to the world.  Her pretty blonde hair is plastered against her, her boobs are covered in a thick layer of white, ' );
		if( CoC.getInstance().scenes.sophieScene.pregnancy.event >= 2 ) {
			EngineCore.outputText( 'her swollen midriff is glazed, ' );
		}
		EngineCore.outputText( 'and her eyes are closed, held shut by a thick layer of your sperm.  She\'s been well and truly bukkaked, drenched in ejaculate, and judging by how furiously she\'s schlicking away at her pussy, she couldn\'t be happier.  As for you, ' + Descriptors.sMultiCockDesc() + ' is still erect, even though you feel like you don\'t have a drop left in you.  Of course, the drugs soaking into your gold-tinted cock will probably keep you hard and ready to breed for hours.\n\n', false );
		CoC.getInstance().scenes.sophieScene.luststickApplication( 5 );
		CoC.getInstance().player.orgasm();
		EngineCore.dynStats( 'sen', -1 );
		EngineCore.doNext( CoC.getInstance().scenes.camp.returnToCampUseOneHour );
	...
	SophieBimbo.prototype.beBimboSophiesSugarDaddy = function() {
		...
		EngineCore.outputText( 'Basking in the afterglow for a moment longer, she begins preening herself, pride plastered on her face thicker than her golden makeup. "<i>Momma Sophie\'s so good at birthing eggs,</i>" she brags, wrapping her arms around your shoulders. "<i>But you were so great too, Daddy,</i>" the older woman remarks, affectionately slathering your face with kisses.  Some birds cannot change.  You sigh as the aphrodisiac sinks into your skin and ' + Descriptors.sMultiCockDesc() + ' hardens to tender stiffness again.  For the rest of the hour, the two of you fuck like newlyweds, only bothering to take stock of the inert eggs once you\'re both sore and exhausted.\n\n', false );
		CoC.getInstance().player.orgasm();
		EngineCore.dynStats( 'sen', -1 );
		CoC.getInstance().scenes.sophieScene.luststickApplication( 2 );
		//[CoC.getInstance().player gains random large egg];
		CoC.getInstance().scenes.inventory.takeItem( ConsumableLib.LARGE_EGGS[ Utils.rand( ConsumableLib.LARGE_EGGS.length ) ], CoC.getInstance().scenes.camp.returnToCampUseOneHour );
	};
	//[Mommy];
	SophieBimbo.prototype.beBimboSophiesSugarMommy = function() {
		this.sophieSprite();
		EngineCore.outputText( '', true );
		if( CoC.getInstance().player.hasItem( ConsumableLib.OVIELIX ) ) {
			CoC.getInstance().player.consumeItem( ConsumableLib.OVIELIX );
	...
	//Butts McGee;
	//=====================================================;
	SophieBimbo.prototype.rideDatSophieVag = function( nice ) {
		EngineCore.clearOutput();
		this.sophieSprite();
		var x = CoC.getInstance().player.cockThatFits( this.sophieCapacity() );
		if( x < 0 ) {
		...
		var y = -1;
		if( CoC.getInstance().player.cockTotal() > 1 ) {
			y = CoC.getInstance().player.cockThatFits2( this.sophieCapacity() );
			if( y < 0 ) {
				y = CoC.getInstance().player.biggestCockIndex();
				if( y === x ) {
					y = CoC.getInstance().player.smallestCockIndex();
				}
			}
		}
		...
		if( nice ) {
			EngineCore.outputText( 'Before you can decide what, exactly, you\'re going to do with your harpy slut, Sophie jiggles her way over to you, the insides of her thighs dripping with every step.  You watch as the plump bird wobbles, too aroused and too damn big to walk straight, but eventually she does manage to make it to you.' );
			if( CoC.getInstance().scenes.sophieScene.pregnancy.event >= 2 ) {
				EngineCore.outputText( '  Her pregnancy-imbued middle doesn\'t really help, either.' );
			}
			...
			EngineCore.outputText( ' in your [armor] - and starts to finger herself as she watches to see what you\'ll do, her wet folds easily parting for her randy, exploring fingers.' );
			...
			EngineCore.outputText( '\n\n"<i>So then,</i>" you coo, reaching down and grabbing your ' + Descriptors.cockDescript( x ) + '.  You give it a few strokes, enjoying the feeling of your cock between your fingers, and then angle it so the tip is rubbing directly against Sophie\'s gushing cunt, the bird herself begging you with her eyes.  You let go of her other breast to rub a downy-feathered thigh, and she bites her lip as you chuckle.' );
			EngineCore.outputText( '\n\n"<i>Ready?</i>" you ask her, prodding your tip against her entrance.  She opens her mouth to answer - and you shove in all at once, enjoying the way her voice hikes up a couple of octaves as she moans in sheer pleasure.  Her soppy cunt squeezes down on your ' + Descriptors.cockDescript( x ) + ', the internal muscles desperately trying to work you, but you give them little room to do so; you instead pull right back out, watching as Sophie\'s arms - freed from your grip - reach out to try and tug you back in.' );
			...
			EngineCore.outputText( '\n\nYour hips turn into a staccato of smacks and slaps as you help Sophie thrust against your constant pounding, her walls trying their very damnedest to milk your ' + Descriptors.cockDescript( x ) + ' of its seed, and her feathery arms run across your back as she lets out another squawky moan - and then her body seizes up.' );
			...
			if( CoC.getInstance().player.balls > 0 ) {
				EngineCore.outputText( 'your [balls] bouncing and slapping against what parts of Sophie\'s bubble butt they can reach, ' );
			}
			EngineCore.outputText( 'and you start to grunt and moan with each movement of your hips as you get close.  Sophie picks up on it as well, her eyes lighting up as she drools, and her back-rubbing arms pull you against her.' );
		...
		if( CoC.getInstance().player.cockTotal() === 1 ) {
			if( CoC.getInstance().player.cumQ() < 250 ) {
				...
				if( CoC.getInstance().scenes.sophieScene.pregnancy.event >= 2 ) {
					EngineCore.outputText( ' (or at least all over her channel, since her womb is bound up with your egg)' );
				}
			...
			if( CoC.getInstance().player.cumQ() < 250 ) {
				...
				if( CoC.getInstance().player.cockTotal() === 3 ) {
					EngineCore.outputText( ', along with your third length, spittling and spraying onto her belly.' );
				} else if( CoC.getInstance().player.cockTotal() > 3 ) {
					EngineCore.outputText( ', along with the rest of your cocks, your entire mass of lengths getting your seed all over her.' );
				}
				if( CoC.getInstance().player.cockTotal() === 2 ) {
					EngineCore.outputText( '.' );
				}
				EngineCore.outputText( '  Sophie shudders and sighs, rubbing your [hair] with her hand, and you hear her breathe a "<i>Thank you...</i>"' );
			}
		...
		if( CoC.getInstance().player.hasVagina() ) {
			...
			if( CoC.getInstance().player.wetness() >= 4 ) {
				...
				EngineCore.outputText( 'dripping and drooling ' );
			}
			EngineCore.outputText( 'with its own juices; you barely notice it over the orgasm from your male half, but, as you readjust your position, the slickness dripping down your thighs is unmistakable.' );
		}
		...
		if( CoC.getInstance().scenes.sophieScene.pregnancy.event >= 2 ) {
			EngineCore.outputText( 'resting your head on her gravid tummy and smiling to yourself.' );
		} else {
			EngineCore.outputText( 'hugging her tight as she tries her best to show her appreciation.' );
		}
		if( this.sophieIsInSeason() ) {
			this.sophiePregChance();
		}
		CoC.getInstance().player.orgasm();
		EngineCore.dynStats( 'lib', 0.5, 'sen', -4 );
		if( !nice && CoC.getInstance().player.cor < 50 ) {
	...
	SophieBimbo.prototype.sophieGoesIntoSeason = function() {
		this.sophieSprite();
	...
	SophieBimbo.prototype.sophieSeasonExpiration = function() {
		this.sophieSprite();
	...
	SophieBimbo.prototype.sophieGotKnockedUp = function() {
		this.sophieSprite();
	...
	SophieBimbo.prototype.sophieImpregnationSex = function() {
		var x = CoC.getInstance().player.cockThatFits( this.sophieCapacity() );
		var y = CoC.getInstance().player.cockThatFits2( this.sophieCapacity() );
		if( x < 0 ) {
			x = CoC.getInstance().player.smallestCockIndex();
		}
		EngineCore.clearOutput();
		this.sophieSprite();
		EngineCore.outputText( 'Hurriedly undressing, you realize she\'s right- you really do want to slide [oneCock] through that gilded entrance and cum until she\'s completely and utterly impregnated.  Deliciously, your [armor] tugs [eachCock] down, then in a moment of pure, unadulterated release, your tip' );
		if( CoC.getInstance().player.cockTotal() > 1 ) {
			EngineCore.outputText( 's come' );
		} else {
			EngineCore.outputText( ' comes' );
		}
		EngineCore.outputText( ' free of the offending garment\'s edge and snap' );
		if( CoC.getInstance().player.cockTotal() === 1 ) {
			EngineCore.outputText( 's' );
		}
		EngineCore.outputText( ' up, proud and erect.  ' );
		if( CoC.getInstance().player.cockTotal() === 1 ) {
			EngineCore.outputText( 'It wobbles' );
		} else {
			EngineCore.outputText( 'They wobble' );
		}
		EngineCore.outputText( ', ' );
		if( CoC.getInstance().player.cockTotal() > 1 ) {
			EngineCore.outputText( 'each ' );
		}
		EngineCore.outputText( 'bouncing up and down.  Sophie\'s eyes never leave the bobbing erection' );
		if( CoC.getInstance().player.cockTotal() > 1 ) {
			EngineCore.outputText( 's' );
		}
		EngineCore.outputText( '.  She seems in a complete cock-trance, licking her glossy make-up soaked lips without meaning to.  You grab hold of ' );
		if( CoC.getInstance().player.cockTotal() > 1 ) {
			EngineCore.outputText( 'one of your lengths' );
		} else {
			EngineCore.outputText( 'your length' );
		}
		EngineCore.outputText( ' and shake ' );
		if( CoC.getInstance().player.cockTotal() === 1 ) {
			EngineCore.outputText( 'it' );
		} else {
			EngineCore.outputText( 'them' );
		}
		EngineCore.outputText( ', startling the dazed bimbo from her vacuous stare.' );
		...
		EngineCore.outputText( '\n\nYour hands find their way to just above the flare of the bird-brained girl\'s waist and begin to pull her down with each piston forward you make, forcing her to meet you halfway.  You pound Sophie\'s twat like a jackhammer, fluids squirting out with each booty-shaking cunt-stuffing thrust you dish out.  Your ' + Descriptors.cockDescript( x ) + ' feels so sensitive, so hard that her slit feels like a molten pleasure-sleeve' );
		if( CoC.getInstance().player.cockTotal() > 1 ) {
			EngineCore.outputText( ', and the extra' );
			if( CoC.getInstance().player.cockTotal() > 2 ) {
				EngineCore.outputText( 's between her thighs are' );
			} else {
				EngineCore.outputText( ' between her thighs is' );
			}
			EngineCore.outputText( ' likewise in heaven, slowly gathering more of the drug as some of it drips down with the tide of her vaginal juices' );
		}
		EngineCore.outputText( '.  Sophie cums repeatedly around you, wiggling her butt in circular motions in between each orgasm to spur you on.  It works.  Her cunt is like a cock-vacuum - no matter how you move, it sucks you back inside, to a heaven of pleasure that you can no longer resist, or care to.' );
		EngineCore.outputText( '\n\nEvery ounce of strength in your body diverts to stuffing your ' + Descriptors.cockDescript( x ) + ' as far into Sophie\'s sodden, drug-inducing pussy as possible, ramming so hard into her that she gives a chirp of half-pleasure, half-pain.  Your dick' );
		if( CoC.getInstance().player.cockTotal() > 1 ) {
			EngineCore.outputText( 's swell' );
		} else {
			EngineCore.outputText( ' swells' );
		}
		EngineCore.outputText( ' with the onset of your release' );
		if( CoC.getInstance().player.balls > 0 ) {
			EngineCore.outputText( ', and your [balls] begin to rhythmically pulse in your [sack]' );
		} else {
			EngineCore.outputText( ', something inside you begins to clench rhythmically' );
		}
		EngineCore.outputText( '.  Sophie\'s pussy stretches around your increasing thickness, dripping its amber honey' );
		if( CoC.getInstance().player.cockTotal() > 1 ) {
			EngineCore.outputText( ' over your extra, thigh slapping cock' );
		}
		if( CoC.getInstance().player.cockTotal() > 2 ) {
			EngineCore.outputText( 's' );
		}
		EngineCore.outputText( '.  Responding, the warm ecstasy inside you rushes out in a tremendous spurt, squirting globs of thick white cum into the harpy\'s receptive cunt again and again.' );
		if( CoC.getInstance().player.cockTotal() > 1 ) {
			EngineCore.outputText( '  Ropes of creamy spunk drizzle over the ground and the underside of Sophie\'s tits, but the lust-drunk harpy doesn\'t seem to mind any more than you do.' );
		}
		EngineCore.outputText( '  Her hungry twat drinks down the seed with gusto, drawing it out of you even as it milks you for more.' );
		if( CoC.getInstance().player.cumQ() >= 500 ) {
			EngineCore.outputText( '  You give her exactly what she wants, drowning her pussy with jism.' );
		}
		if( CoC.getInstance().player.cumQ() >= 1000 ) {
			EngineCore.outputText( '  Alabaster spooge oozes out of her lips after you stuff her womb full, dripping down your [legs] and her own feathery thighs.' );
		}
		if( CoC.getInstance().player.cumQ() >= 2000 ) {
			EngineCore.outputText( '  The ground quickly becomes a salty quagmire that Sophie\'s hands are sinking into.' );
		}
		if( CoC.getInstance().player.cumQ() >= 5000 ) {
			EngineCore.outputText( '  Soon, those droplets become thick gouts, as your immense virility asserts itself.  You hold her there, letting her belly balloon underneath you as you forcefully inseminate her, flooding her with hot seed.' );
		}
		...
		if( CoC.getInstance().player.cockTotal() > 1 ) {
			EngineCore.outputText( '  Her thighs seem almost sad to let your extra manhood' );
			if( CoC.getInstance().player.cockTotal() > 2 ) {
				EngineCore.outputText( 's' );
			}
			EngineCore.outputText( ' escape as well.' );
		}
		if( CoC.getInstance().player.hasKnot( x ) ) {
			EngineCore.outputText( '  The thickness of your swollen, canine knot makes pulling out harder than you thought, and you wind up rocking back and forth while you keep drizzling into her, letting the engorged mass deflate slowly as you fill her womb further with canine seed.  Eventually, with a wet \'POP\', you\'re freed, leaving Sophie nice and gaped, like a good, well-bred bitch.' );
		} else {
			EngineCore.outputText( '  You slip out with a lurid \'schluuuuck\', leaving Sophie a nice messy, well-fucked wreck of a harpy.' );
		}
		EngineCore.outputText( '  Sophie shudders, confused eyes looking back at you.  She whimpers, "<i>Noooo, fuck me again!</i>"' );
		EngineCore.outputText( '\n\nYou shift position slightly, grabbing a fistful of her expansive ass for leverage, that bouncy bimbo-butt allowing your fingers to sink into its supple flesh, giving in to your fingers perfectly as you pull them apart - giving your cum-slick dick a perfect path to her unadulterated pucker!  You push your ' + Descriptors.cockDescript( x ) + ' against her backdoor immediately.  There\'s a moment of resistance, then Sophie relaxes, and all the spunk, girl-lube, and slippery aphrodisiac covering your cock helps you to slide into her yielding ass chasm with ease.' );
		if( y >= 0 ) {
			EngineCore.outputText( '  A sinful tightness clenches your ' + Descriptors.cockDescript( y ) + ' at the same time.  You accidently started double penetrating her!  The sloppy vaginal heat around your second member is enough to make you forget that it was even an accident.' );
		}
		EngineCore.outputText( '  You push on, reveling in the tight clenching of her anal ring as it passes over every inch of cock, squeezing you like a slippery cock-ring as you nestle deeper into the harpy\'s plump bottom' );
		if( CoC.getInstance().player.cumQ() >= 1000 ) {
			EngineCore.outputText( ' and sperm-oozing pussy' );
		}
		EngineCore.outputText( '.' );
		//NO DP:;
		if( y < 0 ) {
		...
		EngineCore.outputText( ' with confident, sure strokes.  Your answer, never spoken aloud, becomes evident by your actions: she got you this horny, and you\'re going to impregnate every hole, no matter how long it takes.  Her asshole is tight, almost <i>too tight</i> after having experienced her pussy, and you can feel the next batch of cum already beginning to churn in your [balls], a heavy, warm weight growing larger and larger.' );
		...
		EngineCore.outputText( ' revealed briefly to the cold air before ' );
		if( y < 0 ) {
			EngineCore.outputText( 'it\'s ' );
		} else {
			EngineCore.outputText( 'they\'re ' );
		}
		EngineCore.outputText( 'devoured by the hot, enveloping anal entrance ' );
		if( y >= 0 ) {
			EngineCore.outputText( 'and squeezing pussy ' );
		}
		EngineCore.outputText( 'all over again.' );
		...
		if( CoC.getInstance().player.tallness >= 74 ) {
			EngineCore.outputText( 'nipping her ear' );
		} else if( CoC.getInstance().player.tallness >= 60 ) {
			EngineCore.outputText( 'nipping at her shoulder' );
		} else {
			EngineCore.outputText( 'nipping at her side' );
		}
		EngineCore.outputText( ' as you answer, "<i>Yes.</i>"  Her breasts feel softer than her pillowy buttcheeks, which even now are squishingly running over your hips and [legs], smothering you in soft warmth while her innards milk your member' );
		if( y >= 0 ) {
			EngineCore.outputText( 's' );
		}
		EngineCore.outputText( '.  You roughly squeeze her breasts, too focused on the climax slowly building within your compressed crotches to be gentle.  Her breasts bounce and jiggle around your ministrations.  Her nipples, hard as lead bullets, are like magnets for your exploratory fingertips, and soon you lock onto them, squeezing and tugging, kneading them with each bounce for encouragement.  Sophie screeches as she bottoms out, pushing herself back against you, noisily cumming, her juices ' );
		if( y < 0 ) {
			EngineCore.outputText( 'spraying across your [legs]' );
		} else {
			EngineCore.outputText( 'running down your ' + Descriptors.cockDescript( y ) + ' in miniature rivers' );
		}
		EngineCore.outputText( ' messily.  The explosion of sloppy lady-spunk accompanies convulsive anal clenching, and with a hard pinch on her nipples, you give yourself over to the unnatural lusts coursing through your bloodstream again.' );
		...
		EngineCore.outputText( '.  She wraps her arms behind herself to hold onto you affectionately.  Again and again, you blast rope after rope of spunk into her plush heiny.  ' );
		if( y >= 0 ) {
			EngineCore.outputText( 'At the same time, you make her cunt even creamier' );
			if( CoC.getInstance().player.cumQ() >= 1000 ) {
				EngineCore.outputText( ' and her belly even more distended' );
			}
			EngineCore.outputText( '.  ' );
		}
		EngineCore.outputText( 'There\'s no stopping your orgasm - it may even be more potent, more virile than the one before!  Sophie simply rides it out, gushing her girlspunk out all over you.' );
		if( CoC.getInstance().player.cumQ() >= 500 ) {
			EngineCore.outputText( '  Her gut rumbles as you fill more and more of her intestines, eventually ' );
			if( CoC.getInstance().player.cumQ() < 1000 ) {
				EngineCore.outputText( 'giving her a' );
			} else {
				EngineCore.outputText( 'adding to her visible' );
			}
			EngineCore.outputText( ' cum-paunch.' );
			if( CoC.getInstance().player.cumQ() >= 1500 ) {
				EngineCore.outputText( '  Soon, the cum is squirting out around you' );
				if( CoC.getInstance().player.hasKnot( x ) ) {
					EngineCore.outputText( 'r knot' );
				}
				EngineCore.outputText( '.  You\'ve filled every inch of her intestines with cum, and there\'s simply nowhere for your fresh, virile squirts to go but out!' );
			}
		}
		EngineCore.outputText( '  The harpy goes limp in your arms, still dribbling from her cunt as you continue to sate yourself on her rump and nipples.' );
		...
		EngineCore.outputText( '\n\nLicking her lips, Sophie chants, "<i>Just one more, in my pussy, please?  Please, cum in my pussy again!</i>"  She goes on like this, asking, begging, and even pleading as she pivots to place her plump, cum-soaked mound back on your ' + Descriptors.cockDescript( x ) + '.  The silken vice fits you as snugly as a tailor-made glove.  She immediately begins to bounce it up and down, looking over her shoulder to watch your face as the waves of sensation overpower your resistance, breaking down your conscious thoughts.  You cum promptly, squirting a long rope of pleasure in on top of all the sperm you\'ve already deposited.  She bounces, forcing more of that ecstasy through your ' + Descriptors.cockDescript( x ) + ', laboring messily atop you in a display lascivious enough to make a whore blush.  Every upstroke of her velvet walls along your shaft earns her all the cum your accelerated reproductive system can offer up since the last downstroke, weak spurts of little bearing, but still an extra dose of cream for her twat.' );
		EngineCore.outputText( '\n\nYou fall back, eyes rolling wildly, moaning uncontrollably.  Consciousness for you becomes little more than the feelings tingling through your ' + Descriptors.cockDescript( x ) + ' and the ensuing orgasms.  At some point, you lose track of time and pass out.' );
		this.sophiePregChance();
		CoC.getInstance().player.orgasm();
		EngineCore.dynStats( 'lib', 1 );
		if( CoC.getInstance().player.cumQ() < 5000 ) {
			CoC.getInstance().player.cumMultiplier += 3;
		}
		CoC.getInstance().scenes.sophieScene.luststickApplication( 8 );
		EngineCore.menu();
		EngineCore.addButton( 0, 'Next', this.postSophieImpreg );
	};
	SophieBimbo.prototype.postSophieImpreg = function() {
		EngineCore.clearOutput();
		this.sophieSprite();
		EngineCore.outputText( 'When you wake, Sophie is snuggled up next to you, her arms and legs wrapped around you affectionately.  A cup full of water, along with several strips of dried meat sit nearby... apparently she got them while you were out, knowing how thirsty and hungry you\'d be.  You run your fingers through her platinum, down-soft hair.  Having a live-in bimbo isn\'t really all that bad.' );
	...
	SophieBimbo.prototype.giantCocksImpregnateSophie = function() {
		...
		if( CoC.getInstance().player.balls > 0 ) {
			EngineCore.outputText( 'in those plump balls of yours' );
		} else {
			EngineCore.outputText( 'inside you' );
		}
		EngineCore.outputText( ', just waiting to squirt out!</i>"  She says it as more a statement of fact than anything else, using that oddly hypnotic, sing-songish voice that seems to reach right inside you.  The cum really <b>does</b> seem to be sloshing around inside you, and as your heart beats faster in your chest, your ardor for the well-endowed harpy grows.  Sophie rubs her soft palm along the underside, right on the meatus your urethra makes as she continues in that strange tone, "<i>You\'re <b>soooo</b> hard, and full.  It\'s making your cock more...</i>" She plants another wet kiss on you, this time on your ' + CoC.getInstance().player.cockHead( x ) + '.  "<i>...and more sensitive.  <b>So</b> sensitive, like just me rubbing my finger on you is as good as fucking a cunt, right?</i>"' );
		...
		EngineCore.outputText( '\n\nAbruptly, Sophie leans away, flat onto her back.  Your ' + Descriptors.cockDescript( x ) + ' drops squarely between her tits, the tip just inches from her puckered lips.  Sophie licks them, eyeballing your tremendous dong as you lower yourself.  You can feel your immense penis pleasantly tingling atop the slutty girl\'s curvy frame, every curve, bit of feathery fluff, and beautiful, flawless patch of skin.  Sophie slurps an over-sized drop of pre-cum up as it rolls out of your urethra and swallows it noisily.  She opens her lips as wide as she can and kisses you right around your spunk-hole.  A surge of lust immediately rockets through you, centered on your sensitive ' + CoC.getInstance().player.cockHead( x ) + '.  Syrupy pre splatters onto her face, and she wiggles back, her whole body stroking you off right up until your ' + CoC.getInstance().player.cockHead( x ) + ' is nestled snugly against her gold-glittered nether-lips, absorbing more of her lust-inducing chemicals.' );
		...
		if( CoC.getInstance().player.cumQ() >= 500 ) {
			EngineCore.outputText( '  In no time, Sophie\'s belly begins to form into a bump, and the pressure leaves more and more of your seed to be wasted on the bimbo\'s thighs.' );
		}
		if( CoC.getInstance().player.cumQ() >= 1000 ) {
			EngineCore.outputText( '  Your intense ejaculations quickly balloon that petite bump into a rounded dome.  Torrents of spunk run out of her around your tip, fountaining slightly with each fresh dose.  You simply can\'t pack any more cum into her, and the excess puddles around her plush bottom.' );
		}
	...
	SophieBimbo.prototype.sophieMoveInAttempt = function() {
		...
		EngineCore.menu();
		EngineCore.addButton( 0, 'Yes', this.yesSophieSleepWith );
		EngineCore.addButton( 1, 'Nah', this.noSophieSleepWith );
	};
	//Yes*;
	SophieBimbo.prototype.yesSophieSleepWith = function() {
		EngineCore.clearOutput();
		this.sophieSprite();
		EngineCore.outputText( 'Sophie claps her hands excitedly when you give your assent, immediately launching into a hug that presses her ' );
		switch( CoC.getInstance().scenes.sophieScene.pregnancy.event ) {
			case 1:
				EngineCore.outputText( 'burgeoning' );
				break;
			case 2:
			...
			case 3:
			case 4:
				EngineCore.outputText( 'huge, gravid' );
				break;
			default:
				EngineCore.outputText( 'taut' );
		}
		EngineCore.outputText( ' midriff and cushiony tits against you.  "<i>You\'re awesome, [name], you know that?  You\'re totally ' + CoC.getInstance().player.mf( 'hunky', 'cute' ) + ' AND awesome!</i>"  She spins about, dancing happily and shaking her voluptuous backside in your direction as she goes.' );
		CoC.getInstance().flags[ kFLAGS.SLEEP_WITH ] = 'Sophie';
		EngineCore.doNext( CoC.getInstance().scenes.camp.returnToCampUseOneHour );
	};
	//No (Also Used To Kick Her Out Of Bed)*;
	SophieBimbo.prototype.noSophieSleepWith = function() {
		EngineCore.clearOutput();
		this.sophieSprite();
		EngineCore.outputText( 'Sophie casts her eyes down and says, "<i>I get it...  I\'ll just... sleep over in my nest then.  Alone...</i>"  She shambles away, her tail feathers limp against her big, bouncing butt as she goes, clearly unhappy with the decision.  You can hear her sniffling even after she vanishes around a rock, trying not to cry.' );
		if( CoC.getInstance().flags[ kFLAGS.SLEEP_WITH ] === 'Sophie' ) {
	...
	SophieBimbo.prototype.moveSophieInRepeat = function() {
		EngineCore.clearOutput();
		this.sophieSprite();
		EngineCore.outputText( 'You go up to the feathery bimbo and idly question if she still wants to share your bed with you' );
		if( !CoC.getInstance().scenes.sophieScene.pregnancy.isPregnant ) {
			EngineCore.outputText( ' even though she\'s not pregnant any more' );
		}
		EngineCore.outputText( '.  Sophie\'s voluminous, painted lips curl into a radiant smile, an effect enhanced even more by the gold gloss she coats them with.' );
	...
	SophieBimbo.prototype.sophieFenCraftedSex = function( morning ) {
		var x = CoC.getInstance().player.cockThatFits( this.sophieCapacity() );
		if( x < 0 ) {
			x = CoC.getInstance().player.smallestCockIndex();
		}
		...
		//{Morning Sex};
		if( morning ) {
			EngineCore.outputText( '\nOoooh, that feels good.  There\'s a slippery, warm snugness wrapping around your ' + Descriptors.cockDescript( x ) + ', accompanied by a quick, \'schluck-schluck-schluck\' in steady beat.  Your heart beats faster as your ardor rises, matched lock step with your rising erection' );
			if( CoC.getInstance().player.cockTotal() > 1 ) {
				EngineCore.outputText( 's' );
			}
			EngineCore.outputText( '.  The haze of sleep is still firm in your mind, but you become aware of other sensations as well.  There\'s the ticklish softness of feathers on your [legs], sliding up and down, and warm, smooth skin that squishes down on your [hips] again and again.  The velvety tunnel around [oneCock] squeezes pleasantly as it fully envelops you, eliciting a moan of pleasure in response.  The sound of your own audible enjoyment rouses you enough to make you open your eyes, whereupon you\'re treated to a view of Sophie riding you cowgirl style.' );
			EngineCore.outputText( '\n\nSophie shakes her tits at you as you wake and chirps, "<i>Good morning, [name].  I got you some sex!</i>"  She giggles at her own terrible joke before resuming her riding, rolling her hips in short circles that press her walls tightly against each part of your ' + Descriptors.cockDescript( x ) + ' with delicious pressure.  "<i>It is just so... hard, not to fuck someone as cute as you are when you\'re sleeping!  I almost didn\'t ma... aahhhhh... didn\'t, like, make it.</i>"  Sophie shudders with excitement, continuing, "<i>You\'re going to, like, have momma Sophie creaming herself <b>real</b> soon!</i>"' );
		}
		//{Regular Sex};
		else {
			EngineCore.clearOutput();
			this.sophieSprite();
			EngineCore.outputText( 'You hastily remove your armor and lie back on your blankets, beckoning Sophie forward with your hand.  The slutty, sex-hungry bimbo prances up on her tiptoes, supporting herself with flapping wings as her flared hips roll hypnotically, ever closer.  In no time, she\'s straddling your supine form; dripping sex positioned a foot above.  The moisture her puffy, aroused cleft exudes patters off your ' );
		...
		EngineCore.outputText( '\n\n"<i>Fuck!  Yes!  Tug my nipple!  You\'re making me feel like, <b>so</b> fucking good!</i>" Sophie squeals, tossing her blond hair back.  Her eyes roll back slightly as she moves, beginning to bounce faster and faster.  Her clingy pussy-lips drag over every sensitive ridge and vein, even your ' + CoC.getInstance().player.cockHead( x ) + ' before devouring you again in that sumptuous heat once more.' );
		if( CoC.getInstance().player.balls > 0 ) {
			EngineCore.outputText( '  Sophie\'s immense backside slides over your [balls] each time she bottoms out, her tail feathers tickling at the bottom of your [sack].' );
		}
		EngineCore.outputText( '  You pull on her nipple, earning yourself a squawk of surprised excitement from Sophie.  She writhes in your grip, twisting this way and that, pulling harder on her poor abused nipple as her pussy goes wild around you.' );
		EngineCore.outputText( '\n\nYou feel her juices drip out over your length and across your middle as she hits climax, one hand holding on to your shoulder for support.  Her velvety interior spasms wonderfully, convulsing around your ' + Descriptors.cockDescript( x ) + ' in what can only be the throes of orgasm.  Sophie folds double, dropping her tits onto your ' );
		if( CoC.getInstance().player.biggestTitSize() >= 1 ) {
			EngineCore.outputText( 'own' );
		} else {
			EngineCore.outputText( 'chest' );
		}
		EngineCore.outputText( ', as she kisses you passionately, moaning into your mouth.  The effects of her potent lip-gloss hit you immediately, fortifying your pleasure into a tsunami wave of excitement, one that\'s cresting whether you want it to or not.  You cry out into Sophie\'s tongue, hips lifting her off the ground, as you cum, hard.  Your ejaculate fires out in long, thick ropes of white, painting the harpy\'s sodden innards white.  With her folds coated in spunk, your spasming ' + Descriptors.cockDescript( x ) + ' pours the rest of your lusts into her, emptying your [balls] completely.' );
		if( CoC.getInstance().scenes.sophieScene.pregnancy.isPregnant ) {
			EngineCore.outputText( '  The thorough seeding fills her up completely - her womb is too full of egg for there to be any room for spunk, and it all drips out with each fresh injection.' );
			if( CoC.getInstance().player.cumQ() >= 500 ) {
				EngineCore.outputText( '  You cum so hard that torrents of spooge wash out of her slit, her womb obstructed by the egg you made with her.' );
			}
		}
		if( CoC.getInstance().player.cumQ() >= 2000 ) {
			EngineCore.outputText( '  The oozing spunk soaks you thoroughly, and Sophie\'s thighs become matted with the gallons of gunk that squirts out of her lips.' );
		}
	...
	SophieBimbo.prototype.fuckYoPregnantHarpyWaifu = function( morning ) {
		...
		if( morning ) {
			...
			EngineCore.outputText( ' fuck.  Her skin is silky smooth, and if you push a little, you can actually feel the solid curve of the growth inside her.  That egg sure is getting big!' );
		}
		//REGULAR FUCK;
		else {
			EngineCore.clearOutput();
			this.sophieSprite();
			EngineCore.outputText( 'You go ahead and take off your [armor], letting Sophie take in the view of [eachCock].  She immediately flounces over and drops to her knees in front of you.  Her hands wraps around ' + Descriptors.cockDescript( x ) + ', ' );
			if( CoC.getInstance().player.lust > 50 ) {
				EngineCore.outputText( 'feeling its firmness.  "<i>Wow, you\'re so hard already, [name]!</i>" she comments.' );
			} else {
				EngineCore.outputText( 'slowly stroking it until it begins to pulse to life, thickening in her hand.' );
			}
			EngineCore.outputText( '  Your rigid tool is soon tingling pleasantly from her handjob, the pregnant bimbo licking her lips hungrily.  She asks "<i>Could you lie back and let me be on top?  It\'ll be easier on me, since I\'m all big and stuff.</i>"  She runs a hand over her gravid midriff, obviously enjoying herself as she waits.' );
			EngineCore.outputText( '\n\nLeaning back on your blankets, you do as she asks, since sex with a pregnant woman does require a little bit of give and take.  Sophie waddles up, her curvy hips still managing to wiggle seductively as she climbs on to you.  Her heavy breasts, normally perky enough to support themselves, rest on top of her swollen gut as she settles into place, jiggling slightly.  You take your ' + Descriptors.cockDescript( x ) + ' in your hand and lift it up against her pussy lips, just in time for her to lower herself, absorbing you into the cock-squeezing haven that is her pussy.  She moans as she takes you.  "<i>Ooohh, you remind me why I got this egg in the first place!</i>" You rub her belly alongside her, simply admiring her smooth, super-curvy, pregnant frame.  That egg sure is big!' );
		}
		//BOTH FUCKS;
		EngineCore.outputText( '\n\nSophie swivels her hips around in slow, circular strokes, riding your ' + Descriptors.cockDescript( x ) + ' confidently.' );
		...
		if( CoC.getInstance().player.balls > 0 ) {
			EngineCore.outputText( '[balls], where they hang in thick drops before falling to the ground,' );
		} else {
			EngineCore.outputText( 'taint and [legs]' );
		}
		EngineCore.outputText( ' proving the veracity of her statements many times over.  You can\'t SEE the wetness, but your ' + Descriptors.cockDescript( x ) + ' certainly feels it, twitching inside Sophie\'s silky slit when the waves of wetness roll over it.' );
		...
		EngineCore.outputText( '\n\nYou release your pressure, and her pussy relaxes.  Then, you inhale around her tight bud again.  Her sodden snatch obliges your ploy with another supple squeeze.  In no time flat you\'re using the bimbo\'s big nipple like a control-rod for her pussy, suckling and releasing it again and again to make her milk your ' + Descriptors.cockDescript( x ) + ' for all she\'s worth.  Sophie doesn\'t offer any complaints - just blissful exhalations of pleasure intermingled with lurid moans.  Even as a pregnant harpy matron, her body is absolutely, ridiculously designed for sex.  The air is virtually saturated with her fruity scent - a smell that only gets stronger each time you make her squeeze your dick and release a fresh drizzle of lady-cum.' );
		EngineCore.outputText( '\n\nSophie shudders and shakes, her nipple getting puffier in your mouth.  After a while, you note the other seems equally engorged and yet untaken, so you pop the well-used tit-tip out of your mouth and hungrily latch on to the other, starting the cycle anew.  Sophie\'s gash explodes at that first suckle, undulating around you and clenching you wildly.  Her eyes roll up, half-hidden under her fluttering lashes as she releases a long, low moan, her whole body shaking with the excitement of it all.  Your ' + Descriptors.cockDescript( x ) + ' is tingling all over, smothered in lubricant, sensuous pleasure, and a mountain of plump, harpy ass.  You shift your hands down there to squeeze the bouncing buttcheeks, holding on for dear life as the harpy\'s pussy assaults you with ecstasy.' );
		EngineCore.outputText( '\n\nSophie pleads, "<i>Oooooh, cum in me baby, I wanna feel it agaaaiiiin!</i>"  Before you can even think to answer, [eachCock] is complying with the expectant mother\'s wishes.  All the pent-up pressure, excitement, and lust bubbles out of you in a rush, the liquid wave draining out of your well-milked ' + Descriptors.cockDescript( x ) + ' and directly into the harpy\'s channel.' );
		if( CoC.getInstance().player.cockTotal() > 1 ) {
			EngineCore.outputText( '  The underside of her tremendous, pregnant belly suddenly slides along you slickly, lubricated by the wasted spooge that\'s spurting from your unused member' );
			if( CoC.getInstance().player.cockTotal() > 1 ) {
				EngineCore.outputText( 's' );
			}
			EngineCore.outputText( '.  The inadvertent tummyfuck redoubles the pleasure, forcing you to deal with a true, multi-cocked orgasm.' );
		}
		EngineCore.outputText( '  Immediately, the cum you\'re squirting into her begins to be squeezed right back out.  Her womb is blocked thanks to the massive egg inside, and your lower body turns into a fruity, salty mess from all the cum and girl-jizz Sophie forces out.' );
		if( CoC.getInstance().player.cumQ() >= 500 ) {
			EngineCore.outputText( '  There\'s enough there to ' );
			if( CoC.getInstance().player.cumQ() < 1000 ) {
				EngineCore.outputText( 'soak your blankets' );
			} else if( CoC.getInstance().player.cumQ() < 2000 ) {
				EngineCore.outputText( 'soak your blankets and the ground below' );
			} else if( CoC.getInstance().player.cumQ() < 5000 ) {
				EngineCore.outputText( 'soak your blankets and form a giant puddle below, leaving you feeling like you\'re on a waterbed made of spunk.' );
			} else {
				EngineCore.outputText( 'soak your blankets and create a lake the two of you sink partway into, surrounded by muddy, cum-flavored mud.' );
			}
		}
		EngineCore.outputText( '\n\nYou sag back as the last few drops leak out around you.  Sophie rolls off to the side, panting heavily.  She titters, "<i>' );
		if( morning ) {
			EngineCore.outputText( 'What... a... way to... start a... morning!' );
		} else {
			EngineCore.outputText( 'Ooohh... you\'re... gonna be... a great... daddy...' );
		}
		EngineCore.outputText( '</i>" in between panting gasps for breath.' );
		EngineCore.outputText( '\n\nSophie leaves you there' );
		if( CoC.getInstance().player.cumQ() >= 1000 ) {
			EngineCore.outputText( ' in the hardening mud' );
		}
		EngineCore.outputText( ', swaying her hips sensually as seed runs from her cunt in thick little rivers.  You\'re wet, sticky, and sated' );
		if( morning ) {
			EngineCore.outputText( ' when you go wash up to get dressed.  It\'s going to be a good day.' );
		} else {
			EngineCore.outputText( ' when you go to get dressed.  You\'ll have to make sure to wash clean at some point, but for now you enjoy the sweet scent of your pet bimbo\'s cum.' );
		}
		CoC.getInstance().player.orgasm();
		EngineCore.dynStats( 'sen', -2 );
		if( morning ) {
	...
	SophieBimbo.prototype.sophiePreggoTitJobs = function() {
		...
		EngineCore.outputText( '\n\nSuddenly, the amber nubs are withdrawn, and you stagger dizzily for a moment, realizing you hadn\'t been breathing this whole time.  Sophie drops to her knees in front of you, supporting you by your [butt].  Her hands squeeze you affectionately as she kisses against your ' + CoC.getInstance().player.cockHead( x ) + '.' );
		if( CoC.getInstance().player.cockTotal() > 1 ) {
			EngineCore.outputText( '  Then, she fishes the ' );
			if( CoC.getInstance().player.cockTotal() === 2 ) {
				EngineCore.outputText( 'other one' );
			} else {
				EngineCore.outputText( 'rest' );
			}
			EngineCore.outputText( ' out of your [armor], giving ' );
			if( CoC.getInstance().player.cockTotal() === 2 ) {
				EngineCore.outputText( 'it' );
			} else {
				EngineCore.outputText( 'each' );
			}
			EngineCore.outputText( ' a slow, affectionate stroke before she returns to her target.' );
		}
		EngineCore.outputText( '  The sensitive tip swells in her mouth, responding to the combination of sloppy, plump lip-kisses and the drugs now coursing through you.' );
		EngineCore.outputText( '\n\nYour curvy cock-craving queen leans back, letting you slip free, connected to her by a golden strand of saliva as she arches her back and brings her immense melons into play.  She spreads them wide as your unrestrained erection lurches forward, dipping into the glossy valley she\'s made for you.  Her lipstick is extremely slick and the entire underside of your ' + Descriptors.cockDescript( x ) + ' is immediately gilt with reflective aphrodisiac.  The buxom harpy presses her breasts in from each side, the change in tightness immediately noticeable to your sensitive cockflesh.  A delicious, warm friction envelops your maleness from all sides.  Smooth, gloss-lubed skin seems to caress you from every angle, compressing tightly about your girth as Sophie\'s hands finish bringing the pleasant power of her breasts to full erotic effect.  Your [legs] tremble, and your head is pounding from just how badly you desire a fuck, a cum- anything to bring you to orgasm.' );
		...
		if( CoC.getInstance().player.cocks[ x ].cockLength > 30 ) {
			EngineCore.outputText( 'the underside of your immense erection' );
		} else {
			EngineCore.outputText( 'your ' + CoC.getInstance().player.cockHead( x ) + '' );
		}
		EngineCore.outputText( ' with her lips, already pursed into a plump, cock-sucking doughnut hole of pleasure.  The noise she makes when your ' + Descriptors.cockDescript( x ) + ' ' );
		if( CoC.getInstance().player.cocks[ x ].cockLength > 30 ) {
			EngineCore.outputText( 'presses against' );
		} else {
			EngineCore.outputText( 'slips into' );
		}
		EngineCore.outputText( ' her puffy, puckered orifice is indescribably moist, a sloppy sucking sound that would make you dribble pre-cum if her tits and mouth weren\'t already milking a steady flow out.' );
		if( CoC.getInstance().player.cocks[ x ].cockLength > 30 ) {
			EngineCore.outputText( '  Sophie pulls back long enough to gasp, "<i>You\'re so long, I can\'t even take the tip!</i>"' );
		}
		...
		//[Let Her] [Hog Wild];
		EngineCore.menu();
		EngineCore.addButton( 0, 'Let Her', this.letSophieMilkYoDick );
		EngineCore.addButton( 1, 'Hog Wild', this.goHogWildOnSophieBewbs );
	};
	//Hog Wild*;
	SophieBimbo.prototype.goHogWildOnSophieBewbs = function() {
		EngineCore.clearOutput();
		this.sophieSprite();
		var x = CoC.getInstance().player.biggestCockIndex();
		EngineCore.outputText( 'You don\'t care about her promises- there\'s a pair of soft tits right there just waiting for a dick to fuck them, and nothing is going to stop you from spooging all over them however you want!  Sophie barely has a chance to react before you\'re tossing her on her back and mounting her chest.  Your [butt] rubs on the top of her pregnant belly as you settle your ' + Descriptors.cockDescript( x ) + ' into the perfect position.' );
		if( CoC.getInstance().player.cockTotal() > 1 ) {
			EngineCore.outputText( '  Your other cock' );
			if( CoC.getInstance().player.cockTotal() > 2 ) {
				EngineCore.outputText( 's splay' );
			} else {
				EngineCore.outputText( ' splays' );
			}
			EngineCore.outputText( ' out to the side, lamely brushing against the outsides of her tit.' );
		}
		EngineCore.outputText( '  Sophie blubbers in surprise, stopping only when your ' );
		if( CoC.getInstance().player.cocks[ x ].cockLength <= 30 ) {
			EngineCore.outputText( CoC.getInstance().player.cockHead( x ) + ' pushes into through her startled cock-pillows, muffling her more effectively than any gag.  She immediately sucks on it, a happy look in her eyes.  The bimbo seems to want nothing more than to lie there and polish your rod.' );
		} else {
			EngineCore.outputText( ' immense rod smacks across her face, too long to try to jam down her throat.  It completely covers her face, smothering her features with rigid, veiny dickflesh.  She immediately begins to lavish the underside with licks and long wet kisses, aided by her plus-sized bimbo lips.  When her eyes peek out from under your ' + Descriptors.cockDescript( x ) + ', they seem placid and happy.  It seems the slut wants nothing more than to lie there and service your cock.' );
		}
		EngineCore.outputText( '\n\nGrabbing hold of Sophie\'s plump nipples, you immediately use them for leverage, tugging them together above your dick.  The tiny, pebbly joysticks are almost rock-hard already!  With your yanks merging her tits together around your ' + Descriptors.cockDescript( x ) + ' and shooting explosions of sensation through her brain, Sophie struggles to stay coherent enough to keep orally attending to your maleness.  Her tongue\'s licks quickly begin to devolve into spastic, instinctive strokes, lashing around your underside with lusty fury.  They still feel good, so you don\'t really mind.  The space under Sophie\'s ass sloshes around muddily, proof of just how much the harpy is enjoying this tryst, even if you\'ve turned the tables on her.' );
		EngineCore.outputText( '\n\nSophie\'s tits bounce off your crotch, hard.  Your [hips] have begun their march back and forth, bouncing off your pregnant tart\'s immense belly and back into her voluptuous tits.  The jiggling udders feel so good pressed around your ' + Descriptors.cockDescript( x ) + ' that you can\'t even comprehend why anyone would want to wait for such pleasure.  You fuck her tits hard, so violently that Sophie begins to give up short gasps of pain, stopping her fellatio as the pain and pleasure mix confusingly in her head.  She grabs her jugs from the side, pressing them into you to take some of the tension from her abused nipples.' );
		EngineCore.outputText( '\n\nThe effects of her honeyed lipgloss are becoming more and more apparent to you, visible to the extreme in the thick, exceedingly quick pulsations that are running through your ' + Descriptors.cockDescript( x ) + '.  It\'s twitching happily, bouncing in the harpy\'s fat tits.  Her soft breasts have the perfect amount of give, and the golden fluid that slicks them makes them easily as slippery as a wet pussy, perhaps even more so.  Pre-cum is dribbling from your tip' );
		if( CoC.getInstance().player.cocks[ x ].cockLength <= 30 ) {
			EngineCore.outputText( ' right into Sophie\'s mouth' );
		} else {
			EngineCore.outputText( ' above Sophie\'s head' );
		}
		EngineCore.outputText( '.  The bird slut stops her frenzied fellatio to beg, "<i>Please cum on me, [name]!  Cum all over Momma\'s Sophie\'s face and tits!  I fucking love, like, being covered in jizz!</i>"' );
		...
		if( CoC.getInstance().player.balls > 0 ) {
			EngineCore.outputText( ', cupping your [balls] with a hand and massaging them to aid your ejaculation' );
		}
		EngineCore.outputText( '.  Your [butt] is squished up against her belly, both of you sweating and slipping all over each other.  Bulging in her breasty embrace, your ' + Descriptors.cockDescript( x ) + ' flexes, and your ' + CoC.getInstance().player.cockHead( x ) + ' thickens.' );
		if( CoC.getInstance().player.hasKnot( x ) ) {
			EngineCore.outputText( '  Your knot inflates to a ludicrous degree, squeezed down on from all sides by slick, gold-painted tits, happy to be engulfed by warm flesh.' );
		}
		EngineCore.outputText( '  Cum fountains from you, splattering over Sophie\'s face, some of it catching on her tits along the way.  A ribbon of the white goo dangles between her mountainous chest and her chin, breaking only when you spurt another set of alabaster cream all over her breasts, most trapped inside the snug cleavage with you.  You slip yourself forwards and continue to cum, lacing hot, sticky jets onto her face.' );
		if( CoC.getInstance().player.cumQ() > 1000 ) {
			EngineCore.outputText( '  Again and again, you continue to paint her white.  Your orgasm seems almost without end as you ejaculate.  Sophie\'s face is soaked with it, and her breasts have become glazed mountain-peaks.' );
		}
		if( CoC.getInstance().player.cumQ() > 2500 ) {
			EngineCore.outputText( '  By the time you finish, the stuff is puddled under her.  The best your harpy pet can manage is a spermy smile as she languishes in your seed.' );
		}
		EngineCore.outputText( '  You push your ' + CoC.getInstance().player.cockHead( x ) + ' and get a kiss from her as you finish cumming, oozing one last dollop onto her fat lips.  She whimpers in the most exciting way as you withdraw, wiping your cock off on her swollen belly, marking her as yours once more.' );
	...
	//Let Her*;
	SophieBimbo.prototype.letSophieMilkYoDick = function() {
		EngineCore.clearOutput();
		this.sophieSprite();
		var x = CoC.getInstance().player.biggestCockIndex();
		EngineCore.outputText( 'You nod at Sophie and hold yourself still.  She rewards you by wrapping her breasts back around you, enveloping you in tight pleasure again.  ' );
		if( CoC.getInstance().player.balls > 0 ) {
			EngineCore.outputText( 'Your [balls] drag across her pregnant belly as she goes to work, but you don\'t mind in the slightest.  There\'s something erotic about having them bumping up against the fruit of your union.  ' );
		}
		EngineCore.outputText( 'Her breasts begin to bounce without warning, up and down in perfect sync.  The tight titty-embrace is almost too much.  You can feel your dick flexing in that smothering, lube-soaked chest.  Sophie extends her tongue to lick at you, and her tongue sends shockwaves of excitement through your already raging boner.' );
		EngineCore.outputText( '\n\nGroaning out loud, you struggle mightily to restrain your instincts.  Sophie smiles, saying, "<i>Mmm, does my special ' + CoC.getInstance().player.mf( 'boy', 'girl' ) + ' like having ' + CoC.getInstance().player.mf( 'his', 'her' ) + ' cock rubbed while ' + CoC.getInstance().player.mf( 'he', 'she' ) + ' has to stand there all anxious and stuff?</i>"  She pecks your cock affectionately, another tingling kiss added onto the immense, chemical pleasure that\'s making your [balls] clench.  "<i>I know you like it babe.  Momma Sophie\'s gonna like, squeeze out all that thick, nasty cum onto her face for you.  Do you want to blow soon?  I can like, get you to cum whenever I want!</i>"' );
		EngineCore.outputText( '\n\nYou nod, biting your lip.  Sophie tilts her head to the side, as if she doesn\'t understand it.  "<i>YES!  I want to cum!  Please!</i>"' );
		EngineCore.outputText( '\n\nSophie rolls her eyes exaggeratedly and pops her mouth back off your dick.  "<i>Why didn\'t you just, like, say that, sexy?</i>"  She giggles cutely and returns to polishing your gold-gilt rod.  Her eyes flick back up at you, the corners of her mouth curling up as she begins to hum on your ' + Descriptors.cockDescript( x ) + '.  Sophie suddenly switches tempo, bouncing her left tit down while she takes her right titty up.  With the creamy tits on either side to moving to different tempos, sliding their slick druggy payload across you with delicious, alternating friction your ' + Descriptors.cockDescript( x ) + ' immediately begins to twitch and pulse fitfully.  It\'s like you have your cock fucking two different pussies at once, all while getting a blowjob from a pair of puffy, bee-stung bimbo-lips.' );
		EngineCore.outputText( '\n\nSophie breaks away from fellatio long enough to mouth, "<i>Cum.  Now,</i>" and immediately pops her mouth back in place' );
		if( CoC.getInstance().player.cocks[ x ].cockLength <= 30 ) {
			EngineCore.outputText( ', ready to catch the cum' );
		} else {
			EngineCore.outputText( ', assisting the cum' );
		}
		EngineCore.outputText( ' that\'s already bubbling out of your [balls] with searing heat.  She presses harder on each side, crushing your ' + Descriptors.cockDescript( x ) + ' with her slippery tits as your urethra bulges with the heavy load. With an audible squishing noise, you unload what feels like every drop of cum your body contains in one huge lance.' );
		//{Fork between mouth and bukkake};
		//Mouth;
		if( CoC.getInstance().player.cocks[ x ].cockLength <= 30 ) {
			EngineCore.outputText( '  Sophie' );
			if( CoC.getInstance().player.cumQ() < 250 ) {
				EngineCore.outputText( ' swallows it without complaint, her eyes twinkling mirthfully as she suckles down your small load.  Surprisingly, you dump a few more pulses into her, each weaker than the last.  The bird-woman drinks it with ease, never looking away from you.' );
			} else if( CoC.getInstance().player.cumQ() < 500 ) {
				EngineCore.outputText( '\'s cheeks bulge from the size of your load, but she manages to get it down with a big gulp.  Surprisingly, you dump a few more jets of thick cream into her waiting gullet, each weaker than the last but big enough to make it hard for her to swallow.  She never looks away from you as she takes it.' );
			} else if( CoC.getInstance().player.cumQ() < 1000 ) {
				EngineCore.outputText( '\'s cheeks bulge cartoonishly at your immense deposit, cream escaping from the corners of her mouth as her poor mouth floods.  Her throat bobs ludicrously, trying to keep up with the flow, but when you follow up that virile blast with several smaller, still potent deposits, she gives up and lets the jizz run down her lip and face, dripping onto her tits.  Through it all, her eyes never leaves yours.' );
			} else {
				EngineCore.outputText( '\'s cheeks bulge ridiculously for a split second before the pleasure sends cum fountaining out her nose and jetting out the corners of her mouth.  She <b>tries</b> to swallow it, but her meager throat simply can\'t ' );
				if( EngineCore.silly() ) {
					EngineCore.outputText( 'repel cum of that magnitude' );
				} else {
					EngineCore.outputText( 'handle that much cum' );
				}
				EngineCore.outputText( '.  Again and again, you spunk the hell out of her face, until Sophie pulls back gagging.  She gets a mask of jizz for her efforts, even after she\'s swallowed a bellyful of cum.  She WAS watching your face, until your cum obscured her eyes, and even then, she keeps her head facing you, letting you watch your jism dripping down her gorgeous features.' );
			}
			EngineCore.outputText( '  The bird-girl withdraws ' );
			if( CoC.getInstance().player.cumQ() < 1000 ) {
				EngineCore.outputText( 'with a happy smile' );
			} else {
				EngineCore.outputText( 'coughing and sputtering' );
			}
			EngineCore.outputText( ' once you\'re dumped out every drop.  She touches your ' + Descriptors.cockDescript( x ) + ' affectionately, tickling at its underside, and her flushed face seems extraordinairily pleased to have made you cum so hard.  Sophie\'s hands stroke her belly slowly as she looks up at you, whispering, "<i>You\'re like, so good to Momma Sophie.  Just be sure and cum for my twat again soon, okay?  It misses you.</i>"' );
		}
		//On top of her.;
		else {
			EngineCore.outputText( '  Sophie' );
			if( CoC.getInstance().player.cumQ() < 250 ) {
				EngineCore.outputText( ' giggles happily when the cum jets into the air and down atop her head, moaning against your dick while it seeps through her platinum feathers.  Throughout it all, she licks and sucks on your shaft, milking out every drop and never looking away.' );
			} else if( CoC.getInstance().player.cumQ() < 800 ) {
				EngineCore.outputText( ' moans when your heavy deposits splatter into her hair, dripping through the downy blond feathers in a messy web.  Throughout it all, she sucks and licks at you, polishing your ' + Descriptors.cockDescript( x ) + ' until she\'s sure every single drop of jizz has been expelled onto her curvy frame.' );
			} else {
				EngineCore.outputText( ' moans whorishly as your gigantic cum-wad splatters over her, running down her hair in thick waves, soaking her shoulders and even dropping over her face in a slippery mask.  She keeps kissing and sucking to make sure you give up every drop, not stopping until she feels your urethra stop its orgasmic pulsating.  Even then, her face stays angled up at you, allowing you to watch as your jizz runs unimpeded across her voluptuous body, dripping from every curve.' );
				if( CoC.getInstance().player.cumQ() >= 2000 ) {
					EngineCore.outputText( '  She\'s completely soaked, head to toe' );
					if( CoC.getInstance().player.cumQ() >= 3000 ) {
						...
						} else if( CoC.getInstance().player.cumQ() < 6000 ) {
							EngineCore.outputText( 'big puddle' );
						} else if( CoC.getInstance().player.cumQ() < 10000 ) {
							EngineCore.outputText( 'small lake' );
						} else {
							EngineCore.outputText( 'obscene lake' );
						}
						EngineCore.outputText( ' has formed around the pair of you' );
					}
					EngineCore.outputText( '.' );
				}
			}
			EngineCore.outputText( '  She gathers up some of your spunk and rubs it over her breasts and belly as you slump back, reveling in the feel on her skin and how wonderful her big, pregnant boobs are feeling.' );
	...
	//Sophie Births Egg*;
	SophieBimbo.prototype.sophieBirthsEgg = function() {
		this.sophieSprite();
		...
		if( this.bimboSophie() ) {
			EngineCore.outputText( 'Come here, [name]!  I... whooooaaaa... I wanna like, hold your hand when the egg comes out!' );
		} else {
			EngineCore.outputText( 'Come here, [name]!  I... whoooaaaa...  I need something to hold on to while this comes out!' );
		}
		EngineCore.outputText( '</i>"' );
		if( CoC.getInstance().player.cor < 33 ) {
			EngineCore.outputText( '  You sit down next to her, and figuring this must be normal for her, you hold her hand with one arm and grope at her free breast with the other.' );
		} else if( CoC.getInstance().player.cor < 66 ) {
			EngineCore.outputText( '  You sit down next to her with a sigh.  Well, at least you can grope her tit with your other hand!' );
		} else {
			EngineCore.outputText( '  You plop down next to her, but ignore her proffered hand for one of those juicy melons on her chest.  Grinning, you can\'t help but think that this is a far more tender thing to hold anyway.' );
		}
		...
		EngineCore.outputText( '.  A rounded white rim peeks out through her spasming pussy-lips, glistening with lubricants that drop from its bottom so fast it\'s almost a steady stream.' );
		...
		if( CoC.getInstance().flags[ kFLAGS.SOPHIE_ADULT_KID_COUNT ] === 0 ) {
			EngineCore.outputText( '  Can you handle having another harpy living in your camp?\n' );
		} else {
			EngineCore.outputText( '  Just how many harpies can your camp hold?\n' );
		}
		EngineCore.dynStats( 'lus', (10 + CoC.getInstance().player.lib / 10) );
	};
	//Egg Hatched Notification;
	SophieBimbo.prototype.sophiesEggHatches = function() {
		CoC.getInstance().flags[ kFLAGS.SOPHIE_CAMP_EGG_COUNTDOWN ] = 0;
		this.sophieSprite();
		...
		if( this.bimboSophie() ) {
			...
			EngineCore.outputText( 'woman ' );
		}
		EngineCore.outputText( 'is raising such a fuss.  Upon spotting Sophie, you can\'t help but notice the flapping of wings and a number of feathers strewn about.  The ' );
		if( this.bimboSophie() ) {
			EngineCore.outputText( 'silly ' );
		}
		EngineCore.outputText( 'harpy is once again fussing over her newly birthed egg, though this time she seems even more flustered about it.  Catching sight of you, her face instantly lights up, a bright' );
		if( this.bimboSophie() ) {
			EngineCore.outputText( ', happy' );
		}
		EngineCore.outputText( ' smile spreading across her plump, golden lips as she bounds over to you and grabs your hand.' );
		if( this.bimboSophie() ) {
		...
		if( CoC.getInstance().flags[ kFLAGS.SOPHIE_ADULT_KID_COUNT ] < 4 ) {
			//First Harpy:;
			...
			if( CoC.getInstance().flags[ kFLAGS.SOPHIE_ADULT_KID_COUNT ] === 0 ) {
				...
				if( CoC.getInstance().flags[ kFLAGS.UNKNOWN_FLAG_NUMBER_00282 ] > 0 ) {
					EngineCore.outputText( ', though her lips are a little larger than you\'d think was normal - maybe she inherited it from her mom?' );
				} else {
					EngineCore.outputText( '.' );
				}
				EngineCore.outputText( '  The harpy chick is actually about as big as a four or five year old, and she looks up at Sophie curiously.' );
				if( CoC.getInstance().flags[ kFLAGS.UNKNOWN_FLAG_NUMBER_00282 ] > 0 ) {
					CoC.getInstance().flags[ kFLAGS.DAUGHTER_ONE_BIMBO ] = 1;
				}
			}
			//Second daughter;
			//Second Harpy:;
			//-Badonkadonk to 9000.  Blond feathers that grow very long. (violet eyes);
			else if( CoC.getInstance().flags[ kFLAGS.SOPHIE_ADULT_KID_COUNT ] === 1 ) {
				...
				if( CoC.getInstance().player.cor > 66 ) {
					EngineCore.outputText( ' a little bit' );
				}
				EngineCore.outputText( '.  The newly hatched chick looks about as old as the other - four or five years old.  Unlike the first one, her face is fairly normal, though you think with her features she\'s sure to be a beauty when she matures.  She\'s a bit bigger in the butt and hips than her elder sister, and her eyes are violet while her plumage matches her mothers - ' );
				if( CoC.getInstance().flags[ kFLAGS.UNKNOWN_FLAG_NUMBER_00282 ] > 0 ) {
					EngineCore.outputText( 'platinum blonde' );
					CoC.getInstance().flags[ kFLAGS.DAUGHTER_TWO_BIMBO ] = 1;
				} else {
					EngineCore.outputText( 'pure pink' );
				}
				EngineCore.outputText( '.  Her feathers definitely seems longer as well, even though it\'s still just fuzzy down.' );
			}
			//Third Harpy:;
			//-Not that curvy, but has human feet and purple feathers. (violet eyes);
			else if( CoC.getInstance().flags[ kFLAGS.SOPHIE_ADULT_KID_COUNT ] === 2 ) {
				...
				if( CoC.getInstance().flags[ kFLAGS.UNKNOWN_FLAG_NUMBER_00282 ] > 0 ) {
					CoC.getInstance().flags[ kFLAGS.DAUGHTER_THREE_BIMBO ] = 1;
				}
			}
			//Fourth Harpy:;
			//-Curvy like Sophie, but with well-developed wings and extra-soft feathers (WINGJOBS).  Pink plumage.  (blue eyes);
				...
				if( CoC.getInstance().flags[ kFLAGS.UNKNOWN_FLAG_NUMBER_00282 ] > 0 ) {
					EngineCore.outputText( ' like her mother used to have before her bimbofication' );
				}
				EngineCore.outputText( ', and a shape that seems to indicate that maturity will be VERY generous to her.  She looks around in wonder, already flapping wings that seem a touch more developed than her sisters were at that age.  You\'ve got to wonder just how big they\'ll get with age.' );
				if( CoC.getInstance().flags[ kFLAGS.UNKNOWN_FLAG_NUMBER_00282 ] > 0 ) {
					CoC.getInstance().flags[ kFLAGS.DAUGHTER_FOUR_BIMBO ] = 1;
				}
			}
			//ALL FIRST FOUR END WITH THIS: ;
			if( this.bimboSophie() ) {
				EngineCore.outputText( '  Before the girl can try to stand she is swept up off her feet by her ecstatic mother.  "<i>Oohhhhh, just look at you!  My baby girl is sooo cute!  Soooo totally fluffy and like, suuuuper soft!</i>"' );
			} else {
				EngineCore.outputText( '  Before the girl can try to stand she is swept up off her feet by her ecstatic mother.  "<i>Oohhhhh, you\'re so cute!  My baby girl is sooo cute!  Oh, the boys will be all over you when you grow up, I just know it!</i>"' );
			}
		}
		//Every Other daughter*;
			...
			EngineCore.outputText( ' girl coos as she shields her ' );
			if( Utils.rand( 2 ) === 0 ) {
				EngineCore.outputText( 'violet' );
			} else {
				EngineCore.outputText( 'blue' );
			}
			EngineCore.outputText( ' eyes from the sun.  The little bird-girl is soon out of her egg, but already looks to be four or five years old.  As always, the sweet little thing is as fluffy as a newborn chick, feathers sticking out every which way and making her look more like a puffball with skin showing than a little baby harpy.  Before the girl can try to stand she is swept up off her feet by her ecstatic mother.  ' );
			if( this.bimboSophie() ) {
				EngineCore.outputText( '"<i>Oohhhhh, just look at you!  My baby girl is sooo cute!  Soooo totally fluffy and like, suuuuper soft!</i>"' );
			} else {
				EngineCore.outputText( '"<i>Oohhhhh, you\'re so cute!  My baby girl is sooo cute! Oh, the boys will be all over you when you grow up, I just know it!</i>"' );
			}
		}
		...
		if( this.bimboSophie() ) {
			EngineCore.outputText( '"<i>Oh dearie, there there, like, calm down, sweetie.  Don\'t worry, Momma Sophie\'s here.</i>"  The matronly harpy gently hugs the squirming fluff-ball into her big, soft breasts, her hands gently stroking her fussy daughter\'s feathery hair.' );
		} else {
			EngineCore.outputText( '"<i>There there, calm down, baby.  Momma Sophie\'s here...  I\'m here.</i>"  The matronly harpy gently hugs the squirming fluff-ball into her big, soft breasts, her hands gently stroking her fussy daughter\'s feathery hair.' );
		}
	...
	SophieBimbo.prototype.sophieKidMaturation = function() {
		...
		//Second daughter;
			...
			//Second Harpy:;
			//-Badonkadonk to 9000.  Blond feathers that grow very long. (violet eyes);
			if( CoC.getInstance().flags[ kFLAGS.DAUGHTER_TWO_BIMBO ] === 1 ) {
		...
		//Third daughter;
			...
			//Third Harpy:;
			//-Not that curvy, but has human feet and purple feathers. (violet eyes);
			if( CoC.getInstance().flags[ kFLAGS.DAUGHTER_THREE_BIMBO ] === 1 ) {
		...
		//Fourth daughter;
			...
			//Fourth Harpy:;
			//-Curvy like Sophie, but with well-developed wings and extra-soft feathers (WINGJOBS).  Pink plumage.  (blue eyes);
			if( CoC.getInstance().flags[ kFLAGS.DAUGHTER_FOUR_BIMBO ] === 1 ) {
		...
		//Fifth+ daughter;
			...
			EngineCore.outputText( 'breasts - just as high, round and perky, yet big and yielding to the touch, like the softest pillow.' );
		}
		//ALL CONTINUE HERE;
		EngineCore.outputText( '  The newly embodied harpy lets out a sigh of relief now that the changes have stopped, clearly surprised by what happened and glad it\'s over. Moving to get a better view of your daughter, you take in the sight of her new body. Your once petite harpy girl looks more like a stacked ' );
		if( CoC.getInstance().flags[ kFLAGS.UNKNOWN_FLAG_NUMBER_00282 ] > 0 ) {
			EngineCore.outputText( 'bimbo' );
		} else {
			EngineCore.outputText( 'bombshell' );
		}
		EngineCore.outputText( ', just like her mother.' );
		if( this.bimboSophie() ) {
			EngineCore.outputText( '  From the inquisitive look on her face and spark of intelligence in her eyes, it seems that she hasn\'t lost her mind to her inner bimbo.' );
		}
		if( this.bimboSophie() ) {
		...
		if( this.bimboSophie() ) {
			EngineCore.outputText( '\n\n"<i>Sweetie! Just look at you!  You grew up into one hot piece of ass!  Momma\'s so proud of you!  Baby, isn\'t our little girl like, suuuper sexy?!</i>" Sophie says as she pushes her newly matured daughter at you.  Your happy, curvy daughter wraps her arms around you tightly, smooching you on the cheek as she presses her new body against you.  Her kiss leaves a big, golden lipstick mark on your ' + CoC.getInstance().player.skinFurScales() + '  "<i>What do you think, daddy? Aren\'t I super-duper sexy?</i>" she asks before leaning in, pushing her big, perky tits against you and making a pouty face at you, showing off her plump kissable lips.' );
		} else {
			EngineCore.outputText( '\n\n"<i>Wow, you grew up into a fine looking harpy!  Momma Sophie\'s so proud of you!  [name], isn\'t our little girl a hottie?!</i>" Sophie says as she pushes her newly matured daughter at you.  Your happy, curvy daughter wraps her arms around you tightly, smooching you on the cheek as she presses her new body against you.  Her kiss leaves a big, golden lipstick mark on your ' + CoC.getInstance().player.skinFurScales() + '  "<i>What do you think, daddy?  Aren\'t I cute?</i>" she asks before leaning in, pushing her big, perky tits against you and making a pouty face at you, showing off her plump kissable lips.' );
		}
		//REPEATS:;
		if( CoC.getInstance().flags[ kFLAGS.SOPHIE_ADULT_KID_COUNT ] > 0 ) {
			//If Yes Incest;
			if( CoC.getInstance().flags[ kFLAGS.SOPHIE_FAMILY_INCEST ] === 1 ) {
				...
				EngineCore.outputText( '.  She beams a radiant smile at you and turns around, shaking her rump at you enticingly, "<i>So, when do you want to try me out, ' + CoC.getInstance().player.mf( 'Daddy', '\'Mom\'' ) + '?</i>"' );
	...
	SophieBimbo.prototype.watchIzmaSophie = function() {
		...
		if( CoC.getInstance().player.hasCock() ) {
			EngineCore.outputText( ', from me OR my Alpha' );
		}
		EngineCore.outputText( '.  If I had MY way, you\'d be tied up on the lake-side so my sisters could play with these ridiculous jugs while they pound your fat ass full of spunk and your belly full of shark-babies.</i>"' );
		...
		if( CoC.getInstance().player.hasCock() ) {
			EngineCore.outputText( 'stroke yourself through bliss' );
		} else {
			EngineCore.outputText( 'finger yourself through bliss' );
		}
		EngineCore.outputText( '.  Izma\'s quartette of sperm-filled balls abruptly rise in her suddenly taut prison and begin to pulsate in time with her cock.  At first, there\'s no visible change, but before long, semen begins to bubble out around the twitching shark-shaft, spattering onto the ground below.  Your own climax winds down as well' );
		if( CoC.getInstance().player.hasCock() ) {
			if( CoC.getInstance().player.cumQ() >= 1000 ) {
				EngineCore.outputText( ', leaving you in a puddle of your own slimy mess' );
			}
		}
		EngineCore.outputText( '.  Izma keeps futilely pumping a bit longer, and you see Sophie\'s belly curve slightly with the hefty seed-deposit.' );
	...
	CoC.getInstance().registerScene( 'sophieBimbo', new SophieBimbo() );
} );