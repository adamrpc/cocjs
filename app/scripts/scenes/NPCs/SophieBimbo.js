...
angular.module( 'cocjs' ).run( function( MainView, SceneLib, PregnancyStore, ConsumableLib, Combat, PerkLib, Descriptors, CoC, kFLAGS, Utils, StatusAffects, EngineCore ) {
	...
	SophieBimbo.prototype.bimbotizeMeCaptainSophie = function() {
		...
		MainView.outputText( 'A wicked idea takes hold of you while you watch the harpy ', false );
		if( CoC.monster.lust > 99 ) {
			MainView.outputText( 'touch herself', false );
		} else {
			MainView.outputText( 'squirm in the dirt around her nest', false );
		}
		MainView.outputText( '.  Releasing the ties on one of your pouches, you reach inside to claim the contents.  You produce the bottle of bimbo liqueur with a flourish, swirling the potent fluid inside its prison as you approach the downed harpy matron; she looks up at you with dumb, ', false );
		if( CoC.monster.lust > 99 ) {
			MainView.outputText( 'lust', false );
		} else {
			MainView.outputText( 'pain', false );
		}
		MainView.outputText( '-glazed eyes, her beautiful but uncomprehending visage slack-jawed and empty.  It\'s a good look for her.\n\n', false );
		MainView.outputText( 'The cork pops from the bottle\'s top with an easy tug, releasing a fine pink mist that reeks of alcohol, potent spices, and sweetness.  You hold Sophie\'s jaw in your hand and pull her mouth open, placing the bottle\'s lip upon the defeated slut\'s slack mouth.  Like this, she\'s almost perfect... almost.  You lift the back edge of the bottle higher, dribbling a flow of bimbolicious alcohol into Sophie\'s pliant, unresisting mouth.  She gulps as it hits her tongue, swaying back and forth dangerously while the magic starts to take effect.  You hold her fast and upend the rest of the liqueur directly into her throat.  The busty harpy shudders and shakes, sputtering a little bit with her eyes crossed.  Her convulsions grow so forceful that she wrenches out of your grip to flop about on the floor of her nest.\n\n', false );
		MainView.outputText( 'Starting at her head, her flamingo-pink plumage brightens to an even more neon coloration.  It continually lightens until the blush utterly vanishes, a light, barely-blond hue fading into place in her feathery hair.  The same scene is repeated over her wings, legs, and feathery backside, girding her body in platinum pinions.  Fluffing softly, the changed feathers ruffle while Sophie\'s involuntary shudders slow to a stop.  She shakes her head and mutters, "<i>OOooh, wha... what did you give me?  So... hard to... think.</i>"\n\n', false );
		MainView.outputText( 'You display the bottle\'s warning label to the harpy, waiting for her response.  She squints in confusion and pulls back, her heaving breasts jiggling and bouncing about.  "<i>What\'s that?  Some like, weird language or something?  I can\'t read it.</i>"  Sophie\'s brow knits in confusion - you can practically see the gears trying to turn behind her open, clueless eyes.  She taps at her chin, her arm brushing her suddenly-larger assets, once again setting her swelling bust to shaking.  "<i>Omigosh!  Are my titties getting bigger?</i>" she asks with a giggle.  "<i>They\'re so... jiggly and shaky!</i>"\n\n', false );
		MainView.outputText( 'Looking down confirms her claims.  While the twin melons were definitely double-D\'s before, they\'ve swollen up to an E-cup by now, and the blooming bosom shows no signs of stopping.  Before your eyes, Sophie\'s tits grow into a truly magnificent pair of breasts, shaking and rippling like bowls of jello.  Her nipples puff up and engorge, the nubs easily doubling in size and stretching out to nearly a full inch in their aroused state.  They redden as Sophie\'s creamy skin blushes pink, her flesh coloring from the pleasure of her chest\'s obscene growth.  Widening in panic and lust, Sophie\'s eyes glitter with half-formed tears as she wails, "<i>I can\'t fly like thiiiis!</i>"\n\n', false );
		MainView.outputText( 'You chuckle and heft one of the harpy\'s weighty globes, marveling at the smooth softness of her heavy tit.\n\n', false );
		MainView.outputText( 'Sophie squeals, "<i>S-stop it!  It\'s s-s-sensitiiiive!</i>"\n\n', false );
		MainView.outputText( 'Sighing, you rub your thumb across her areola, circling around the huge nipple before you give the long protrusion a hard flick.  The avian matron shivers and moans at that, arching her back to press the mammoth mounds further into your hands, forcing you back against the mountainside with their weight.  Protruding even more, her unyielding nips slide between your fingers.  Thankfully, they don\'t seem to be getting any bigger; while you\'re no tailor, you appraise them as at least F-cups now.  You idly massage the more-than-motherly melons, setting off a chorus of moans from the harpy\'s gold-glossed lips.  Her wide hips wiggle with sensuous need, the scent of horny harpy filling the air.  You must be doing something right.\n\n', false );
		MainView.outputText( 'Sophie gasps and pulls back, turning about to place her hefty rump in front of your face.  The long tail-feathers tickle at you, but you brush the blond fluff aside with an irritated snort.  "<i>Y-you like, did this to me!  Whatever it is making me all... horny and slurpy and yummy and dumb and... mmmm... can we fuck?</i>" she accuses, losing her train of thought part way through her diatribe as juices begin to drip from her inflamed cunt-lips.\n\n', false );
		MainView.outputText( 'You run a finger from the top of Sophie\'s box to the bottom, even stopping to slide the lubricated digit across her taint to circle her sensitive asshole.  She moans and bounces in place, her hips nearly blocking the light from your view when she presses back.  Did they get bigger too?  You pause to watch her hand-devouring ass-cheeks and confirm that they are, in fact, growing larger - just like her tits.  The plush pillow-butt rounds out, swelling larger.  You look down and note that her legs are moving apart as well, shifted wider by Sophie\'s changing body and expanding hips.\n\n', false );
		MainView.outputText( 'Sophie giggles, "<i>Like, do you love my drippy pussy that much?  Gosh that\'s cute!  But why am I so horny and silly?</i>"  She giggles.  "<i>I don\'t get it.  My head\'s all light and floaty!  Not like before.</i>"  Her voice drops slightly as she struggles with herself.  "<i>So hard... hard to think.  Gotta... gotta... like, find someone to fuck!  Mmm, would you give me a lick?  Can\'t you feel how hot Momma Sophie\'s box is?  It like, needs a tongue to cool it down or something.</i>"\n\n', false );
		MainView.outputText( 'The harpy\'s frothing gash smears over your nose and lips, trailing a fragrant smear of girl-honey across your face.  For one glorious moment, you\'re utterly deprived of light and left with the newly-minted bimbo\'s twat on your lips.  Her thighs muffle the sounds of the high mountains to near nothing, and you find yourself licking without meaning to, lapping  experimentally to see which parts of her slutted-up anatomy will release the strongest gushes of fluids.  Once you prod her clit with your tongue, she cums, drenching your face with harpy-lube.  The blond\'s thighs lock around you, holding you tight in the bimbo-bitch\'s snatch to receive her musky baptism.\n\n', false );
		MainView.outputText( 'After a few moments of torrential, slimy output, Sophie\'s quivering cunt spasms and her legs give out.  She slumps over, ass in the air and utterly exposed as she giggles, "<i>Like, wow!  You made me cum so hard, ' + CoC.player.mf( 'mister', 'miss' ) + '!  Can I, like, come home with you?  I don\'t really want to compete with these bitches and you\'re super ' + CoC.player.mf( 'handsome', 'hot' ) + '!  We can have lots of like, sex and stuff!</i>"\n\n', false );
		MainView.outputText( 'You\'re a bit taken aback by her reaction, but it makes sense.  The dumb broad is too fucked up to survive without becoming someone\'s fuck-pet.  She may as well be yours.  She looks back with glossy, hopeful eyes and a pleading, pouty look on her thick lips.  Did they get bigger too?  (She probably gives great head...)\n\n', false );
		MainView.outputText( 'Saying no seems silly... she\'s so fucking hot now, and you\'ve no doubt she\'ll be like your personal masturbation toy.  Sophie titters, "<i>Please please please!  Mmmm, I\'ll kiss and, like, lick you with my tongue all the time.  Don\'t say no... I totally need to fuck you!</i>"\n\n', false );
		MainView.outputText( 'You shake your head, feeling the compulsion picking at your mind.  Damn, she can still try to compel you with her words.  Do you take her home to be your live-in bimbo of choice?', false );
	...
	SophieBimbo.prototype.acceptBimboSophie = function() {
		...
		if( CoC.player.findStatusAffect( StatusAffects.CampRathazul ) >= 0 ) {
			...
			MainView.outputText( '  Afterwards, she offers to lick Amily\'s twat, if Amily will do the same to her.  Amily ', false );
			if( CoC.flags[ kFLAGS.AMILY_FOLLOWER ] === 1 ) {
				MainView.outputText( 'flushes hotly and denies the bimbo\'s request with a terse \'no\'.', false );
			} else {
			...
			if( SceneLib.isabellaFollowerScene.isabellaAccent() ) {
				MainView.outputText( '"<i> Nein!  But you can drink mein milk from time to time.</i>"' );
			} else {
				MainView.outputText( '“<i>No! But you can still drink my milk from time to time.</i>”' );
			}
			MainView.outputText( '  The cow-girl is blushing hotly.  You\'ve no doubt after a few nipple-licks she\'ll be spreading her thick thighs for the bimbo harpy.', false );
		}
		MainView.outputText( '\n\n', false );
	...
	SophieBimbo.prototype.sophieCampLines = function() {
		...
		if( choice === 0 ) {
			MainView.outputText( 'Sophie is sitting by herself, applying yet another layer of glittering lip gloss to her puffy bimbo lips.', false );
		} else if( choice === 1 ) {
			MainView.outputText( 'Sophie is sitting by herself, idly diddling her twat and noisily moaning.  She keeps looking your way, hoping you\'ll approach.', false );
		} else if( choice === 2 ) {
			MainView.outputText( 'The beach-blond harpy is preening herself with a vapid, brainless look plastered on her face.  Her puffy, bee-stung lips are slightly parted and lacquered with a heavy layer of golden gloss.', false );
		} else {
			MainView.outputText( 'Your personal bimbo, Sophie, is playing with her breasts, touching and caressing the heavy orbs in between sighs of pleasure.  She keeps glancing your way, hoping you\'ll join her.  She\'s insatiable!', false );
		}
		MainView.outputText( '\n\n', false );
	};
	//Approach Texts;
	SophieBimbo.prototype.approachBimboSophieInCamp = function( output ) {
		...
		if( CoC.flags[ kFLAGS.FOLLOWER_AT_FARM_SOPHIE ] === 0 ) {
			...
			if( output ) {
				...
				this.sophieSprite();
				MainView.outputText( 'Sophie emerges from the hen coop and wiggles her way over to you when you call her name.' );
	...
	SophieBimbo.prototype.sophieBimboAppearance = function() {
		MainView.clearOutput();
		MainView.outputText( 'Sophie is a big, buxom harpy, no two ways about her.  She has ' );
		if( CoC.flags[ kFLAGS.UNKNOWN_FLAG_NUMBER_00282 ] > 0 ) {
			MainView.outputText( 'very ' );
		}
		MainView.outputText( 'long ' );
		if( CoC.flags[ kFLAGS.UNKNOWN_FLAG_NUMBER_00282 ] > 0 ) {
			MainView.outputText( 'platinum-blond' );
		} else {
			MainView.outputText( 'pink' );
		}
		MainView.outputText( ' \'hair\' that dangles off her shoulders, like a bird\'s plumage.  She wears a thick layer of golden lipstick over her plump' );
		if( CoC.flags[ kFLAGS.UNKNOWN_FLAG_NUMBER_00282 ] > 0 ) {
			MainView.outputText( ', super-sized' );
		}
		MainView.outputText( ' lips at all times, like most of her kind, the gloss capable of giving her voice a compelling quality or inducing arousal on contact with males or herms.  Her face lacks the youthful quality found among many of her sisters, though you don\'t see any of the lines that would indicate age.' );
		MainView.outputText( '\n\nSophie\'s breasts are ' );
		if( CoC.flags[ kFLAGS.UNKNOWN_FLAG_NUMBER_00282 ] > 0 ) {
			MainView.outputText( 'so immense they would drag her to the ground if she tried to fly, a sexy, lingering aftereffect of the draft you gave her.  The wobbly bimbo-tits look to be about F-cups.' );
		} else {
			MainView.outputText( 'unusually large.  The buxom harpy does seem slightly encumbered by them, but still capable of flight.  Her breasts look to be about DD-cups, nice and big enough for a soft squeeze or rough tit-fuck.' );
		}
		...
		if( SceneLib.farmCorruption.hasTattoo( 'sophie' ) ) {
			...
			if( SceneLib.farmCorruption.sophieFullTribalTats() ) {
				...
				if( SceneLib.farmCorruption.numTattoos( 'sophie' ) > 1 ) {
					...
					MainView.outputText( 'She has ' );
				}

				if( CoC.flags[ kFLAGS.SOPHIE_TATTOO_COLLARBONE ] !== 0 ) {
					MainView.outputText( CoC.flags[ kFLAGS.SOPHIE_TATTOO_COLLARBONE ] + '\n' );
				}
				if( CoC.flags[ kFLAGS.SOPHIE_TATTOO_SHOULDERS ] !== 0 ) {
					MainView.outputText( CoC.flags[ kFLAGS.SOPHIE_TATTOO_SHOULDERS ] + '\n' );
				}
				if( CoC.flags[ kFLAGS.SOPHIE_TATTOO_LOWERBACK ] !== 0 ) {
					MainView.outputText( CoC.flags[ kFLAGS.SOPHIE_TATTOO_LOWERBACK ] + '\n' );
				}
				if( CoC.flags[ kFLAGS.SOPHIE_TATTOO_BUTT ] !== 0 ) {
					MainView.outputText( CoC.flags[ kFLAGS.SOPHIE_TATTOO_BUTT ] + '\n' );
				}
			}
		}
		EngineCore.menu();
	...
	SophieBimbo.prototype.changeEggs = function() {
		MainView.clearOutput();
		this.sophieSprite();
		MainView.outputText( 'You ask Sophie to change the type of eggs that she is producing for you.' );
	...
	SophieBimbo.prototype.postEggSelector = function( selected ) {
		MainView.clearOutput();
		this.sophieSprite();
		MainView.outputText( '“<i>I’ll make some nice ' + selected.toLowerCase() + ' eggs just for you then, good looking,</i>” she says. “<i>I can only make, like, one once a week, though. All the rest gotta be sold. I’ll put it with the weekly earnings, ok?</i>”' );
	...
	SophieBimbo.prototype.stopHarvest = function() {
		MainView.clearOutput();
		this.sophieSprite();
		MainView.outputText( 'You tell Sophie to stop giving you eggs; you’d rather she’d put them towards making the farm money.' );
		if( EngineCore.silly() ) {
			...
			MainView.outputText( '“<i>I only wish I was good with numbers and things,</i>” Sophie sighs wistfully, picking at her bellybutton. “<i>Then I’d know when to give you my eggs and, and when to give them to the doggie. Whatever you say anyways, babe!</i>”' );
		}
	...
	SophieBimbo.prototype.sendToFarm = function() {
		MainView.clearOutput();
		this.sophieSprite();
		MainView.outputText( '“<i>I want you to head towards the lake,</i>” you say to your pet bimbo, “<i>and find a farm. You’re to present yourself to th...</i>“ you stop. Sophie is staring at you in complete incomprehension, fingering herself impulsively.' );
	...
	SophieBimbo.prototype.backToCamp = function() {
		MainView.clearOutput();
		this.sophieSprite();
		MainView.outputText( 'You tell her to head back to camp; there are things you need to do to her you can’t do whilst she’s here. Repeatedly. Sophie’s face falls a bit.' );
	...
	SophieBimbo.prototype.tellSophieToVisitIzma = function() {
		MainView.clearOutput();
		MainView.outputText( 'You suggest she visit Izma again.  Maybe this time she won\'t get tied up again?' );
	...
	SophieBimbo.prototype.bimboSophieLustStickSurprise = function() {
		...
		if( select === 0 ) {
			this.sophieSprite();
			MainView.outputText( 'Sophie flounces into your arms and kisses you on the lips before you can react.  ', false );
			if( !CoC.player.hasCock() ) {
				MainView.outputText( 'You smirk and pry the enthusiastic bimbo out of your arms, for now.', false );
				EngineCore.dynStats( 'lus', 1 );
			} else {
				MainView.outputText( 'You shiver, ' + Descriptors.sMultiCockDesc() + ' growing hard and ready to submit to the feathery blond\'s love.  Perhaps you\'ll take care of that soon...', false );
				EngineCore.dynStats( 'lus', 15 );
			}
			...
			if( !CoC.player.hasCock() ) {
				MainView.outputText( 'Pushing her back, you give her ass a slap and mouth, \'Soon\'.', false );
				EngineCore.dynStats( 'lus', 1 );
			} else {
				MainView.outputText( 'Pushing her back, you try not to make contact against her with ' + CoC.player.oMultiCockDesc() + '.  Your lips tingle dangerously, and you know you\'ll be lusting after harpies for at least a few hours.', false );
				EngineCore.dynStats( 'lus', 15 );
			}
			SceneLib.sophieScene.luststickApplication( 5 );
		} else if( select === 2 ) {
			this.sophieSprite();
			if( CoC.player.hasCock() ) {
				MainView.outputText( 'While standing there, drinking a sip of water, strong hands pull down your ' + CoC.player.armorName + '.  Plump lips wrap around ' + CoC.player.oMultiCockDesc() + ' and smother it in plush, warm slipperiness.  You look down at your bimbo harpy and sigh while ' + CoC.player.oMultiCockDesc() + ' grows harder in her lips.  She pops off and asks, "<i>Like, wanna fuck?</i>"  You sigh and try to resist the images of yourself mounting the harpy that flood your mind.  It might be time to fuck her soon...', false );
				EngineCore.dynStats( 'lus', 15 );
			} else {
				EngineCore.dynStats( 'lus', 10 );
				MainView.outputText( 'While standing there, drinking a sip of water, strong hands pull down your ' + CoC.player.armorName + '.  Plump lips slide over your ' );
				if( CoC.player.hasVagina() ) {
					MainView.outputText( 'vulva, sucking at your clitoral hood.  Those gold, slobbery pussy-lickers look good on your groin, and you find yourself releasing your wetness from her oral attentions.  It might be time to fuck her soon...', false );
				} else {
					MainView.outputText( 'smooth groin, eventually licking at your [asshole].  Those gold, slobbery lickers look good pressed against you.  It might be time to fuck her soon...', false );
				}
			}
			SceneLib.sophieScene.luststickApplication( 5 );
		} else {
			this.sophieSprite();
			MainView.outputText( 'Sophie glides down from atop a rock, landing roughly atop you.  She plants a wet, smacking kiss on you and asks, "<i>Didja miss me?  I totally missed you!</i>"  ', false );
			if( CoC.player.hasCock() ) {
				EngineCore.dynStats( 'lus', 15 );
				MainView.outputText( Descriptors.SMultiCockDesc() + ' seems to wiggle inside your ' + CoC.player.armorName + '.  Damn, she feels really good on you!  Maybe you should screw the slutty bimbo soon?  ', false );
			}
			MainView.outputText( 'You nod and Sophie gets up, beaming a radiant smile as she prances away, her booty swaying enticingly behind her.', false );
	...
	SophieBimbo.prototype.daughterCheckup = function() {
		...
		if( CoC.flags[ kFLAGS.SOPHIE_DAUGHTER_MATURITY_COUNTER ] > 200 ) {
			...
			MainView.outputText( 'Looking around for your developing daughter, you find that she and your ' );
			if( this.bimboSophie() ) {
				MainView.outputText( 'boisterous bimbo ' );
			} else {
				MainView.outputText( 'matronly harpy ' );
			}
			MainView.outputText( 'are spending some quality mother-daughter time together.  Sophie is helping the young girl with her make up, showing her how to use that golden luststick that her people are so fond of.  You\'re not too sure how appropriate that is for your daughter, but then again, this is what harpies do, right? Aside from the lusty lipstick, your ' );
			if( this.bimboSophie() ) {
				MainView.outputText( 'live-in bimbo ' );
			} else {
				MainView.outputText( 'favorite bird-woman ' );
			}
	...
	SophieBimbo.prototype.unlockResistance = function() {
		...
		MainView.outputText( '<b>(Perk Unlocked: Luststick Adapted - your minimum lust is permanently raised, but you are 20% more lust resistant.  In combat, you\'re immune to it, though it still gives you a rush during sex.  You\'re also comfortable enough with it to use it like a harpy if you find any.)</b>\n', false );
	...
	SophieBimbo.prototype.bimboSophieLicksRugs = function() {
		...
		MainView.outputText( 'You sit back on a nearby rock and spread your ' + CoC.player.legs(), false );
		if( CoC.player.balls > 0 ) {
			MainView.outputText( ', lifting your heavy sack out of the way', false );
		}
		MainView.outputText( ' to give Sophie a perfect view of your ' + Descriptors.vaginaDescript() + '.  Sophie\'s dull, somewhat glazed eyes brighten at the sight of your box, and she leans forward intently, dipping a digit into herself as she asks, "<i>Ooh, can I, like, lick it for you?  It looks soooo yummy!</i>"\n\n', false );
		if( CoC.player.cor < 33 ) {
			MainView.outputText( 'You nod nervously, blushing hotly at the thought of your bimbo-slut\'s fat lips kissing and lapping at your slit.', false );
		} else if( CoC.player.cor < 66 ) {
			MainView.outputText( 'You nod and smile, blushing a bit in anticipation of feeling your bimbo-slut\'s fat, pussy-licking lips against your slit.', false );
		} else {
			MainView.outputText( 'You confidently smile and scoot your ' + Descriptors.hipDescript() + ' forward, anticipating the feeling of your bimbo-bitch\'s fat, pussy-licking lips on your slit.', false );
		}
		MainView.outputText( '  Sophie just looks at you, her wide-eyed gaze never leaving your engorged labia.  After what feels like a full minute of her watching you, she finally remembers that a nod means \'yes\', and she bounces up and down in excitement, clapping and cheering while her tits jiggle ludicrously.  She leans in close, nearly brushing her nose into your ', false );
		...
		//(ginormous clitties);
			...
			MainView.outputText( '"<i>It\'s... like, well... big!  Gosh, you\'re a big girl!  Mmm, you\'ll cum hard for Momma Sophie while I, like, suck on this fat pole, won\'t you?</i>" teases the thick-bootied bird-bitch.\n\n', false );
			MainView.outputText( 'You shudder as the harpy resumes her oral onslaught, slurping your ' + Descriptors.clitDescript() + ' deep into her throat in one smooth plunge.  She hums in delight, licking over the feminine fuck-stick\'s lower portions while she tries to get her fat, soft puss-pillows closer to your juicy snatch.  You rock your hips forward to thrust your ' + Descriptors.clitDescript() + ' further inside your bimbo\'s neckhole.  She gurgles happily and lashes at your ' + Descriptors.vaginaDescript() + ', her tongue tracing trails of hot, sexual pleasure through your depths as her molten-hot throat milks you like no tomorrow.\n\n', false );
		}
		MainView.outputText( 'Sophie purrs with desire, and when you hear a distinctive wet squelching coming from something other than your pussy, you realize she\'s vigorously masturbating.  You crane your head over to get a view of the harpy\'s frenzied, pumping fingers, watching them disappear into her puffy, lust-reddened lips, as if by magic.  Sophie ', false );
		if( CoC.player.clitLength < 3 ) {
			MainView.outputText( 'hums on your clit and doubles the speed of her licking while you watch her finger-fucking her sloppy cunt.', false );
		} else {
			MainView.outputText( 'pumps on your clit with her hand and doubles the speed of her lashing tongue while you watch her finger-fucking her sloppy cunt.', false );
		}
		MainView.outputText( '  The sight pushes you over the edge in a climax of body-shaking, muscle-locking proportions.  You seize up and ', false );
		if( CoC.player.wetness() >= 5 ) {
			MainView.outputText( 'squirt', false );
		} else if( CoC.player.wetness() >= 4 ) {
			MainView.outputText( 'gush', false );
		} else if( CoC.player.wetness() >= 3 ) {
			MainView.outputText( 'leak', false );
		} else if( CoC.player.wetness() >= 2 ) {
			MainView.outputText( 'dribble', false );
		} else {
			MainView.outputText( 'drool', false );
		}
		MainView.outputText( ' fem-spunk all over Sophie\'s face, marking the bimbo with your love.  The horny harpy seems to be getting off on it as well, as she\'s moaning luridly into your labia, letting the fluid bubble up and muffle her outbursts.\n\n', false );
		MainView.outputText( 'You both fall back, winded, gasping, and a little delirious from the encounter.  The entirely of your groin is covered in a gold coating, shining with the harpy\'s lipstick and your own feminine moisture.  In a way, the sight is oddly entrancing.  Your ' + Descriptors.vaginaDescript() + ' glitters in the light while the harpy\'s overly-thick lipstick sinks into your skin, filling your body with drugs designed to stimulate males.  ', false );
		if( !CoC.player.hasCock() ) {
			MainView.outputText( '  It\'s a good thing you don\'t have a penis!', false );
		} else {
			MainView.outputText( 'You groan as your groin burns with desire, filling your ' + Descriptors.multiCockDescriptLight() + ' with blood.  Images of yourself relentlessly fucking your bimbo bride pregnant over and over again fill your mind.  You shudder and blush, trying to resist the artificial needs pounding through your body, but you realize your body is ready.', false );
		}
		MainView.outputText( '\n\n', false );
		MainView.outputText( 'The ditzy blond giggles and tweaks her hefty nipples, cooing, "<i>That was absolutely yummy!  Your puss is like, totally tasty.  Let\'s go again!</i>"  You feel a little fucked out after the fantastic oral, and you decline.\n\n', false );
		MainView.outputText( 'Sophie retorts, "<i>But I wanna fuck nooooooowwww!</i>"  She pouts, sticking out her lower lip and saying, "<i>Come on... look at my pussy... just look at it.  Can\'t you, like, see how fucking wet you\'ve gotten me?  You know you wanna lick me... your tongue TOOOTALLY wants to taste my sweet honey-pot!</i>"  The harpy spreads her legs so wide she\'s nearly doing a split, pulling her pussy-lips apart to show you just how wet you\'ve made the puffy, pink entrance.  You\'ve got to admit... it does look really nice.  Her words seem... heavy somehow, like they have an extra weight behind them.  You have a hard time finding fault with her logic - she sure would taste good right about now...\n\n', false );
		MainView.outputText( '"<i>Please?  I\'ll make you feel just as good as last time, maybe more.  Look at me, at my lips, would they lie to you?  I bet they\'d feel soooo good back on your hot, wet cunny', false );
		if( CoC.player.hasCock() ) {
			MainView.outputText( ', or thick, juicy dick', false );
		}
		MainView.outputText( '.  Come over here and sixty-nine me, baby!</i>" cheers Sophie with a wiggle of her considerable hips.  Damn, her lips are sooo plump and sexy, and that ass - gods she\'s getting you wet ', false );
		if( CoC.player.hasCock() ) {
			MainView.outputText( 'and hard ', false );
		}
		MainView.outputText( 'again!  You want to tackle her onto the ground and smash your crotch into her face!  Fuck, is she trying to use her compulsion on you? It\'s working!\n\n', false );
		CoC.player.orgasm();
		EngineCore.dynStats( 'sen', -1 );
		SceneLib.sophieScene.luststickApplication( 4 );
		if( CoC.player.inte * 2 < CoC.player.cor + CoC.player.lib ) {
			MainView.outputText( 'There\'s no way you could ever turn her down at this point... just look at her lips... they\'d never lie to you.  It\'ll feel so good...', false );
	...
	SophieBimbo.prototype.bimboSophieSixtyNineAfterCunnilingus = function() {
		...
		if( !CoC.player.hasCock() || CoC.player.cockThatFits( this.sophieCapacity() ) === -1 ) {
			MainView.outputText( 'You throw yourself at Sophie, compelled by thoughts of pleasure and her delicious-looking pussy, wanting nothing more than to place your lips on her cunt and slurp with reckless abandon.  She takes the hit like a champ, tumbling with you through the dirt and dust until you land on your ' + Descriptors.buttDescript() + ', bouncing to a stop with the harpy\'s feathery thighs clenching around your head.  ' );
			if( SceneLib.sophieScene.pregnancy.event >= 2 ) {
				MainView.outputText( 'Her pregnant belly rests against your middle, untouched by the rough fall.  ' );
			}
			MainView.outputText( 'How did she do that?  Your questions fade away as you look up and spot your target - the cum-slicked delta of Sophie\'s cunt, so moist it seems to fog the air, beckoning you to plunge your tongue inside and taste it.\n\n', false );
			MainView.outputText( 'With rapacious desire, you grab the harpy\'s down-coated ass-cheeks and squeeze her plump rump, pulling her dripping cooch straight onto your face.  You shiver at the potent, womanly smell as it oozes over your ' + CoC.player.face() + ', and dribbles down your chin.  Without a moment\'s hesitation, you take the first long lick of Sophie\'s tasty juices.  They have a tangy flavor that seems to sizzle on your tongue before fading into a soft, sweet, peach-like taste.  You hum in pleasure - the harpy was right; your tongue REALLY wants to taste her.\n\n', false );
			MainView.outputText( '"<i>Wow! You\'re so good at pussy-licking, babe,</i>" declares Sophie, pursing her lips slowly and deliberately as she enunciates the rest of her statement, "<i>Your tongue just can\'t get enough harpy pussy!  Ooooh yeah, you\'re totally the best cunny-licker I\'ve like, ever had munch on my box!  Mmm, you love Momma Sophie\'s girl-cum, dontcha?  Yea-ah... lick lick lick!</i>"  She giggles inarticulately after that, swiveling her hips to smear her leaking vagina all over your face.  You cram your ' + CoC.player.face() + ' further up Sophie\'s creamy quim and lick over and over, curling your tongue into every delicious nook and fold.\n\n', false );
			MainView.outputText( 'Sophie drops down onto her elbows, her ass-length blond plumage tickling at your ' + CoC.player.legs() + ' as she examines your groin.  The slutty harpy leans over your gold-smeared crotch and gives your ' + Descriptors.clitDescript() + ' a kiss, her plush lips smothering the ', false );
			if( CoC.player.clitLength < 1 ) {
				MainView.outputText( 'tiny ', false );
			}
			MainView.outputText( 'organ in warm, oral bliss.  You moan into her sumptuous pussy and giggle when the vibrations set off a cascade of harpy cum.  Inspired, you begin to hum with every lick, the sound carrying up from your voice-box to turn your tongue into the bimbo\'s new vibrator.\n\n', false );
			MainView.outputText( 'The two of you attack each other\'s pussies in a frenzy of wanton need, slurping and moaning so loudly that the noise is likely carried a hundred yards away.  Sophie\'s pussy seems to grow even more delectable with every touch to your taste buds, if such a thing is possible.  Your moronic mate seems equally infatuated with your pussy, and she sucks your clit', false );
			if( CoC.player.clitLength >= 3 ) {
				MainView.outputText( ', even pausing to jack it off like a penis', false );
			}
			MainView.outputText( ' with hasty, need-filled strokes.  Eyes crossing, you suck and lick, swallowing great mouthfuls of bimbo-jizz in your haste to bring off the harpy.\n\n', false );
			MainView.outputText( 'Sophie parts her silken lips from your gold-glazed groin with a moist *pop*.  "<i>You\'re totally great at licking pussy, babe!  Mmmmhmmm, just, like, keep doing it like that.  You\'ll mmm-make Momma Sophie cum in no time!  Make me cum, baby!  Oooh, does trying to make cum make you hot for my pussy?  You\'re gonna cum... I know it... you\'ll cum with me,</i>" utters the bimbo bitch while she stirs your pussy with a finger, stroking around it and dragging her long nails over the sensitive flesh of your loins.  Her words hit you like a wave, and with renewed vigor, you thrust your entire tongue deep inside the harpy and rub your lower lip back and forth across her pleasure-bud.  Pulling hard on her hips, you orally ravage her cunt with no regard for anything around yourself, your body burning hot from how good it feels to get your pet off.\n\n', false );
			MainView.outputText( 'At long last, the bimbo\'s bald cunt climaxes from your work, splattering you with a flood of musky girl-spunk.  You still need her pussy so bad that you can\'t stop.  You lick, lap, and swallow with inhuman eagerness until the box atop you is emptied of everything save your saliva.  Then, and only then, do you finally feel release.  Your ' + Descriptors.vaginaDescript() + ' climaxes for Sophie, soaking her fingers and wringing them as if your life depended on it.  She giggles, coming down from her own orgasm and feeling quite pleased with the effects her words have had on you.\n\n', false );
			MainView.outputText( 'The harpy gets up, but only long enough to turn around and lay atop you, face to face' );
			if( SceneLib.sophieScene.pregnancy.event >= 2 ) {
				MainView.outputText( ', egg-swollen belly smushing between you' );
			}
			MainView.outputText( '.  "<i>That was sooo fun!  Like, we\'ll totally do this sometime soon, but I need a drink, and you smell like pussy.  Mmmm, I like that smell.  It means fun stuff!</i>"  Sophie kisses you full on the mouth, her puffy, quim-stained lips coloring your own with her amber lipstick.  "<i>You\'re like, the best pussy-licker ever, ya know?</i>"\n\n', false );
			MainView.outputText( 'Sophie struts off, touching a finger to her cunt before licking it, tasting the remnants of your saliva.', false );
			SceneLib.sophieScene.luststickApplication( 5 );
			CoC.player.orgasm();
			EngineCore.dynStats( 'sen', -1 );
		}
		//SixtyNine Continuation - DUDES;
			...
			if( SceneLib.sophieScene.pregnancy.event >= 2 ) {
				MainView.outputText( 'Her gravid belly bumps up against your own, somehow untouched by the rough-and-tumble fall.  ' );
			}
			MainView.outputText( 'How did she do that?  Your questions fade away as you look up and spot your target - the cum-slicked delta of Sophie\'s cunt, so moist it seems to fog the air, beckoning you to plunge your tongue inside and taste it.\n\n', false );
			MainView.outputText( 'With rapacious desire, you grab the harpy\'s down-coated ass-cheeks and squeeze her plump rump, pulling her dripping cooch straight onto your face.  You shiver at the potent, womanly smell as it oozes over your ' + CoC.player.face() + ' and dribbles down your chin.  Without a moment\'s hesitation, you take the first, long lick of Sophie\'s tasty juices.  They have a tangy flavor that seems to sizzle on your tongue before fading into a soft, sweet peach-like taste.  You hum in pleasure - the harpy was right: your tongue really wants to taste her.\n\n', false );
			...
			if( CoC.player.cumQ() >= 500 ) {
				MainView.outputText( '  She gulps and swallows as fast as possible, but cum starts oozing from her nose, dripping from the corners of her mouth, and spurting back out around your ' + Descriptors.cockDescript( x ) + ' to spatter your groin.', false );
				if( CoC.player.cumQ() >= 1000 ) {
					MainView.outputText( '  After a moment of this, the full-bellied harpy pulls back and lets you paint the remainder over her face, hair, and mountainous breasts.', false );
				}
			}
			MainView.outputText( '\n\n', false );
			MainView.outputText( 'Sophie gives an airheaded giggle and jumps up, ignoring the slosh of your sexual fluids in her belly' );
			if( SceneLib.sophieScene.pregnancy.event >= 2 ) {
				MainView.outputText( ' and the way her egg-stuffed womb jiggles' );
			}
			MainView.outputText( '.  Shining in the light, a web of harpy-lube stretches between her groin and your soaked face.  You try to sit up and get your tongue back where it belongs, inside her, but she steps one of her clawed feet down on your chest to playfully pin you to the ground.\n\n', false );
			MainView.outputText( 'The blond bombshell titters, "<i>Like, you don\'t need to lick my cunny any more, babe. You were totally awesome and got me off super hard.  And you did such a good job cumming for me too!  Just relax there a moment, I\'m gonna get a drink or something.  Let\'s do this again soon!</i>"\n\n', false );
			MainView.outputText( 'Sophie leans down to kiss you on the lips, smearing more of her lust-enhancing lipstick over your mouth.  ' + Descriptors.SMultiCockDesc() + ' stays hard as a rock, but the need to service her pussy with your tongue slowly fades.  You feel oddly sated in spite of your erection, yet you know that a peek at your vapid harpy mistress will likely throw you into a rutting frenzy all over again thanks to the properties of her lipstick.', false );
			CoC.player.orgasm();
	...
	SophieBimbo.prototype.buttFuckBimboSophie = function() {
		...
		MainView.outputText( 'You instruct your bimbo bitch to bend over and show you that rounded rump that you keep her around for.  She leans away from you, her ass high in the air with tail feathers fluffing, and she cluelessly asks, "<i>Ummm, like this, babe? Or this?</i>"\n\n', false );
		MainView.outputText( 'The bimbo bounces her backside back and forth, making her heavy cheeks jiggle a few inches away from you.  Winking between them, Sophie\'s puckered anal star and juicy, dripping pussy seem to beckon for your ' + Descriptors.multiCockDescriptLight() + ', but you just watch for now, enjoying the sight of such a gorgeous ass jiggling and shaking for you.  After a moment she asks, "<i>Or did you mean like this?</i>"  The harpie flexes her thighs and begins to bounce her ass up and down to a vigorous, butt-shaking rhythm no one but your slut can seem to hear.  Your eyes sway up and down, following the glorious, heart-shaped mass on its ballistic trajectory while ' + Descriptors.sMultiCockDesc() + ' becomes hard and completely ready to claim that bouncy butt.\n\n', false );
		MainView.outputText( 'Stepping closer, you toss off your ' + CoC.player.armorName + ' and reply, "<i>Yes, just like that.</i>"\n\n', false );
		MainView.outputText( 'Sophie claps her hands and gives a girlish squeal of happiness. "<i>Really?  C-can I like, do this a little closer?  ', false );
		if( CoC.player.cockTotal() > 1 ) {
			MainView.outputText( 'Those cocks look', false );
		} else {
			MainView.outputText( 'That cock looks', false );
		}
		MainView.outputText( ' delic... de... yummy!</i>"  You slap her ass, grab her tail feathers, and pull the harpy\'s winking asshole down onto your ' + Descriptors.cockDescript( x ) + '. Her voices rises, not in anger, but in delight, and your ' + CoC.player.cockHead( x ) + ' pulses pleasantly in the first few inches of the harpy\'s rectum.  The bimbo relaxes and sinks down, giggling and asking, "<i>Is-ooh-is my butt, like, good for you?  It\'s soooo tight, and it\'s making my cunny all wet and stuff!</i>"\n\n', false );
		MainView.outputText( 'You squeeze her shuddering rump hard enough to feel her flesh bulging out around your fingers, the soft cheeks nearly subsuming your hands, and then you pull her hard, dragging your ' + Descriptors.cockDescript( x ) + ' the rest of the way inside her, all the way to the ', false );
		if( !CoC.player.hasSheath() ) {
			MainView.outputText( 'hilt', false );
		} else {
			MainView.outputText( 'sheath', false );
		}
		MainView.outputText( '.  Sophie\'s breasts sway underneath her, the pendulous globes occasionally dipping low enough to drag her thumb-sized nipples through the rough dirt.' );
		if( SceneLib.sophieScene.pregnancy.event >= 2 ) {
			MainView.outputText( '  Just like her breasts, her gravid tummy sways a little as well, plush with the weight of the egg you\'ve given her.' );
		}
		MainView.outputText( '  The bimbo moans harder every time it happens and sounds more whorish and lurid with each passing second - a true anal slut.  She looks back at you with lust in her eyes and a gleeful grin on her face.  Suddenly, one of the ditz\'s fingernails is dragging ', false );
		if( CoC.player.balls > 0 ) {
			MainView.outputText( 'over your ' + Descriptors.ballsDescriptLight(), false );
		} else {
			MainView.outputText( 'across your taint', false );
		}
		MainView.outputText( '.  It works its way down, crosses the joining of your bodies, and reaches its owner\'s pussy, circling the puffy lips until a long strand of girl-goo is dangling down towards the ground.\n\n', false );
		MainView.outputText( '"<i>So... good.  Why didn\'t anyone tell me that butt-sex is like, super-duper fun?</i>"  The breathless bimbo rocks her ass back and forth, and you let her have her \'fun\'.  She\'s wiggling and squirming, impaled on a cock and loving it.  You simply relax and let her go to town, the bimbo\'s fingers running through her sodden box in time with the butt-jiggling contortions of her body.  Her anus milks your ' + Descriptors.cockDescript( x ) + ' like a machine, drawing out thick streamers of pre-cum to make her ass almost as sloppy as her pussy.  It\'s hard to stand still with her working you so efficiently, and after a few moments of allowing your bimbo to pleasure you with her plump rump, you tire of waiting.\n\n', false );
		MainView.outputText( 'Pushing her away, you unsheath most of your ' + Utils.num2Text( Math.round( CoC.player.cocks[ x ].cockLength ) ) + ' inches from Sophie\'s stretched asshole, leaving just your ' + CoC.player.cockHead( x ) + ' to hold the rectal portal open.  She whines in disappointment until you lunge forward and stuff her full of dick so suddenly that she squirts dribbles of lube.  You grab her hair with one hand and ride her ass hard and fast, each thrust punctuated by happy squeals of submissive pleasure from your airheaded anal toy.  Sophie cheers, "<i>Fuck me ' + CoC.player.mf( 'stud', 'babe' ) + ', fuck my ass!  Unh, y-yeah like that.  Mmmm, yeah, pull my hair and tell me what a bad girl I\'ve been!</i>"\n\n', false );
		MainView.outputText( 'Gods, she\'s such a naughty little bird bitch!  You yank her hair back and lean over her shoulder, whispering, "<i>You like that, you brain-dead bimbo?  Look down at all the juices raining from your cunt.  Would anyone but a horny slut get off so hard from having her ass reamed?  I don\'t think so.</i>"\n\n', false );
		MainView.outputText( 'You keep butt-fucking her hard and fast, ignoring the sprinkles of sticky, maternal harpy-juice that splatter on your ' + CoC.player.legs() + ' as you fuck her.  In between throaty moans and screams, she bellows out "<i>YES!</i>" as loudly as possible, then lapses into quiet, exhausted grunts.  Yet, her vagina does not stop its prodigious leaking; if anything it\'s dripping and squirting out even heavier flows of submissive girl-spooge.  The harpie\'s anal ring is convulsing around you, reduced to pointless trembling from the hard fucking you\'re giving her.  Looking back with lidded eyes, she begs, "<i>C-cum... cum in my ass... it\'ll... it\'ll feel soo good, babe.  Please?  Like, gimme your spooge!</i>"\n\n', false );
		if( CoC.player.balls > 0 ) {
			MainView.outputText( 'Your balls seize up at Sophie\'s request, and you swear you can actually hear the fluid churning and sloshing of your cum before it burns a path of warmth through your body.', false );
		} else {
			MainView.outputText( 'Your insides seem to seize up at Sophie\'s request, and you swear you can actually feel the fluid churning a path of warmth through your body.', false );
		}
		...
		if( CoC.player.cumQ() >= 500 ) {
			MainView.outputText( '  Even though your semen is frothing and spurting from between her cheeks with each push, you keep at it', false );
			if( CoC.player.cumQ() >= 1000 ) {
				MainView.outputText( ', filling her belly with spooge', false );
			}
			MainView.outputText( '.', false );
		}
		MainView.outputText( '  With a few final clenches of pleasure, your dick\'s flow of cum trickles down to a dribble.  You sigh and muse that you must\'ve completely emptied your ' + Descriptors.ballsDescriptLight() + ' by now, and you slump back against a rock to watch your jizz flood out of Sophie\'s ass.  She pushes some inside her pink nether-lips with a triumphant smile, clearly pleased with herself.\n\n', false );
		MainView.outputText( 'Still full of energy, the big-tittied ditz bounces around and catches the cum as it drains from her gaped ass, shoving more and more into her soaked quim.  She even licks her fingers once she bores of that and says, "<i>Thanks for making my asshole so creamy!  You even left me enough to like, stuff up my twat so I can have an egg!  Yay!</i>"\n\n', false );
		if( SceneLib.sophieScene.pregnancy.event >= 2 ) {
			MainView.outputText( 'Sophie giggles again, rubbing her already well-filled belly and winking at you, like you\'re sharing in some absurd joke.  You roll your eyes - bimbos!' );
		}
		if( this.sophieIsInSeason() ) {
	...
	SophieBimbo.prototype.fuckBimboSophiesTits = function() {
		...
		MainView.outputText( 'One of the dumb blonde\'s hands circles under her bouncing, jiggling chest to stroke your ' + Descriptors.cockDescript( x ) + ', jacking you off with the spit, sweat, and drugged gloss as lubricants.  She jerks you hard and fast, smearing it ', false );
		if( CoC.player.balls > 0 ) {
			MainView.outputText( 'all over your balls whenever she needs a break, and you feel your ' + Descriptors.ballsDescriptLight() + ' growing heavier by the moment.', false );
		} else {
			MainView.outputText( 'all over your taint and asshole, and you feel your body churning, building up more seed for your moronic mate.', false );
		}
		MainView.outputText( '  ' + Descriptors.SMultiCockDesc() + ' thickens and bloats, a rush of warmth rushing up the base as your internal muscles clench tight, squeezing out a globby rope of jism.  It explodes from your cum-slit, taking Sophie full on the face.\n\n', false );
		MainView.outputText( 'You\'re just getting started.  Sophie smirks and opens her mouth, letting her tongue slide out to taste your jizm as you launch the next rope, so long it trails from her hair to her chin and so thick it rolls in drops from the side of her face.  She hums in delight and squeezes her breasts tight around your ' + Descriptors.cockDescript( x ) + ', the next blast backing up inside you from the pressure.  A moment of buildup later, and your seed germinates and blooms over the harpy\'s tits, soaking them with spunk.  Droplets of the stuff splatter onto the ground around the both of you, but you just keep coming.  In your mind you have visions of yourself knocking up harpy after harpy, the slutty bird-girls mounting your fountaining fuck-stick long enough for their bellies to bloat with seed before moving on.  Like this, you could inseminate a whole tribe...\n\n', false );
		MainView.outputText( 'Once the thought passes, you sag back, utterly spent and more than a little parched.  Blinking the haze from your eyes, you look over at Sophie.  She\'s on her back, frigging herself non-stop and utterly lost to the world.  Her pretty blonde hair is plastered against her, her boobs are covered in a thick layer of white, ' );
		if( SceneLib.sophieScene.pregnancy.event >= 2 ) {
			MainView.outputText( 'her swollen midriff is glazed, ' );
		}
		MainView.outputText( 'and her eyes are closed, held shut by a thick layer of your sperm.  She\'s been well and truly bukkaked, drenched in ejaculate, and judging by how furiously she\'s schlicking away at her pussy, she couldn\'t be happier.  As for you, ' + Descriptors.sMultiCockDesc() + ' is still erect, even though you feel like you don\'t have a drop left in you.  Of course, the drugs soaking into your gold-tinted cock will probably keep you hard and ready to breed for hours.\n\n', false );
		SceneLib.sophieScene.luststickApplication( 5 );
		CoC.player.orgasm();
		EngineCore.dynStats( 'sen', -1 );
		EngineCore.doNext( SceneLib.camp, SceneLib.camp.returnToCampUseOneHour );
	...
	SophieBimbo.prototype.rideDatSophieVag = function( nice ) {
		...
		if( nice ) {
			MainView.outputText( 'Before you can decide what, exactly, you\'re going to do with your harpy slut, Sophie jiggles her way over to you, the insides of her thighs dripping with every step.  You watch as the plump bird wobbles, too aroused and too damn big to walk straight, but eventually she does manage to make it to you.' );
			if( SceneLib.sophieScene.pregnancy.event >= 2 ) {
				MainView.outputText( '  Her pregnancy-imbued middle doesn\'t really help, either.' );
			}
			...
			MainView.outputText( ' in your [armor] - and starts to finger herself as she watches to see what you\'ll do, her wet folds easily parting for her randy, exploring fingers.' );
			...
			if( CoC.player.balls > 0 ) {
				MainView.outputText( 'your [balls] bouncing and slapping against what parts of Sophie\'s bubble butt they can reach, ' );
			}
			MainView.outputText( 'and you start to grunt and moan with each movement of your hips as you get close.  Sophie picks up on it as well, her eyes lighting up as she drools, and her back-rubbing arms pull you against her.' );
		...
		if( CoC.player.cockTotal() === 1 ) {
			if( CoC.player.cumQ() < 250 ) {
				...
				if( SceneLib.sophieScene.pregnancy.event >= 2 ) {
					MainView.outputText( ' (or at least all over her channel, since her womb is bound up with your egg)' );
				}
			...
			if( CoC.player.cumQ() < 250 ) {
				...
				if( CoC.player.cockTotal() === 3 ) {
					MainView.outputText( ', along with your third length, spittling and spraying onto her belly.' );
				} else if( CoC.player.cockTotal() > 3 ) {
					MainView.outputText( ', along with the rest of your cocks, your entire mass of lengths getting your seed all over her.' );
				}
				if( CoC.player.cockTotal() === 2 ) {
					MainView.outputText( '.' );
				}
				MainView.outputText( '  Sophie shudders and sighs, rubbing your [hair] with her hand, and you hear her breathe a "<i>Thank you...</i>"' );
			}
		...
		if( CoC.player.hasVagina() ) {
			...
			if( CoC.player.wetness() >= 4 ) {
				...
				MainView.outputText( 'dripping and drooling ' );
			}
			MainView.outputText( 'with its own juices; you barely notice it over the orgasm from your male half, but, as you readjust your position, the slickness dripping down your thighs is unmistakable.' );
		}
		...
		if( SceneLib.sophieScene.pregnancy.event >= 2 ) {
			MainView.outputText( 'resting your head on her gravid tummy and smiling to yourself.' );
		} else {
			MainView.outputText( 'hugging her tight as she tries her best to show her appreciation.' );
		}
		if( this.sophieIsInSeason() ) {
			this.sophiePregChance();
		}
	...
	SophieBimbo.prototype.sophieImpregnationSex = function() {
		...
		MainView.clearOutput();
		this.sophieSprite();
		MainView.outputText( 'Hurriedly undressing, you realize she\'s right- you really do want to slide [oneCock] through that gilded entrance and cum until she\'s completely and utterly impregnated.  Deliciously, your [armor] tugs [eachCock] down, then in a moment of pure, unadulterated release, your tip' );
		if( CoC.player.cockTotal() > 1 ) {
			MainView.outputText( 's come' );
		} else {
			MainView.outputText( ' comes' );
		}
		MainView.outputText( ' free of the offending garment\'s edge and snap' );
		if( CoC.player.cockTotal() === 1 ) {
			MainView.outputText( 's' );
		}
		MainView.outputText( ' up, proud and erect.  ' );
		if( CoC.player.cockTotal() === 1 ) {
			MainView.outputText( 'It wobbles' );
		} else {
			MainView.outputText( 'They wobble' );
		}
		MainView.outputText( ', ' );
		if( CoC.player.cockTotal() > 1 ) {
			MainView.outputText( 'each ' );
		}
		MainView.outputText( 'bouncing up and down.  Sophie\'s eyes never leave the bobbing erection' );
		if( CoC.player.cockTotal() > 1 ) {
			MainView.outputText( 's' );
		}
		MainView.outputText( '.  She seems in a complete cock-trance, licking her glossy make-up soaked lips without meaning to.  You grab hold of ' );
		if( CoC.player.cockTotal() > 1 ) {
			MainView.outputText( 'one of your lengths' );
		} else {
			MainView.outputText( 'your length' );
		}
		MainView.outputText( ' and shake ' );
		if( CoC.player.cockTotal() === 1 ) {
			MainView.outputText( 'it' );
		} else {
			MainView.outputText( 'them' );
		}
		MainView.outputText( ', startling the dazed bimbo from her vacuous stare.' );
		...
		if( CoC.player.cockTotal() > 1 ) {
			MainView.outputText( ', and the extra' );
			if( CoC.player.cockTotal() > 2 ) {
				MainView.outputText( 's between her thighs are' );
			} else {
				MainView.outputText( ' between her thighs is' );
			}
			MainView.outputText( ' likewise in heaven, slowly gathering more of the drug as some of it drips down with the tide of her vaginal juices' );
		}
		MainView.outputText( '.  Sophie cums repeatedly around you, wiggling her butt in circular motions in between each orgasm to spur you on.  It works.  Her cunt is like a cock-vacuum - no matter how you move, it sucks you back inside, to a heaven of pleasure that you can no longer resist, or care to.' );
		...
		MainView.outputText( ' with the onset of your release' );
		if( CoC.player.balls > 0 ) {
			MainView.outputText( ', and your [balls] begin to rhythmically pulse in your [sack]' );
		} else {
			MainView.outputText( ', something inside you begins to clench rhythmically' );
		}
		MainView.outputText( '.  Sophie\'s pussy stretches around your increasing thickness, dripping its amber honey' );
		if( CoC.player.cockTotal() > 1 ) {
			MainView.outputText( ' over your extra, thigh slapping cock' );
		}
		if( CoC.player.cockTotal() > 2 ) {
			MainView.outputText( 's' );
		}
		MainView.outputText( '.  Responding, the warm ecstasy inside you rushes out in a tremendous spurt, squirting globs of thick white cum into the harpy\'s receptive cunt again and again.' );
		if( CoC.player.cockTotal() > 1 ) {
			MainView.outputText( '  Ropes of creamy spunk drizzle over the ground and the underside of Sophie\'s tits, but the lust-drunk harpy doesn\'t seem to mind any more than you do.' );
		}
		MainView.outputText( '  Her hungry twat drinks down the seed with gusto, drawing it out of you even as it milks you for more.' );
		if( CoC.player.cumQ() >= 500 ) {
			MainView.outputText( '  You give her exactly what she wants, drowning her pussy with jism.' );
		}
		if( CoC.player.cumQ() >= 1000 ) {
			MainView.outputText( '  Alabaster spooge oozes out of her lips after you stuff her womb full, dripping down your [legs] and her own feathery thighs.' );
		}
		if( CoC.player.cumQ() >= 2000 ) {
			MainView.outputText( '  The ground quickly becomes a salty quagmire that Sophie\'s hands are sinking into.' );
		}
		if( CoC.player.cumQ() >= 5000 ) {
			MainView.outputText( '  Soon, those droplets become thick gouts, as your immense virility asserts itself.  You hold her there, letting her belly balloon underneath you as you forcefully inseminate her, flooding her with hot seed.' );
		}
		...
		if( CoC.player.cockTotal() > 1 ) {
			MainView.outputText( '  Her thighs seem almost sad to let your extra manhood' );
			if( CoC.player.cockTotal() > 2 ) {
				MainView.outputText( 's' );
			}
			MainView.outputText( ' escape as well.' );
		}
		if( CoC.player.hasKnot( x ) ) {
			MainView.outputText( '  The thickness of your swollen, canine knot makes pulling out harder than you thought, and you wind up rocking back and forth while you keep drizzling into her, letting the engorged mass deflate slowly as you fill her womb further with canine seed.  Eventually, with a wet \'POP\', you\'re freed, leaving Sophie nice and gaped, like a good, well-bred bitch.' );
		} else {
			MainView.outputText( '  You slip out with a lurid \'schluuuuck\', leaving Sophie a nice messy, well-fucked wreck of a harpy.' );
		}
		MainView.outputText( '  Sophie shudders, confused eyes looking back at you.  She whimpers, "<i>Noooo, fuck me again!</i>"' );
		...
		if( y >= 0 ) {
			MainView.outputText( '  A sinful tightness clenches your ' + Descriptors.cockDescript( y ) + ' at the same time.  You accidently started double penetrating her!  The sloppy vaginal heat around your second member is enough to make you forget that it was even an accident.' );
		}
		MainView.outputText( '  You push on, reveling in the tight clenching of her anal ring as it passes over every inch of cock, squeezing you like a slippery cock-ring as you nestle deeper into the harpy\'s plump bottom' );
		if( CoC.player.cumQ() >= 1000 ) {
			MainView.outputText( ' and sperm-oozing pussy' );
		}
		MainView.outputText( '.' );
		//NO DP:;
		if( y < 0 ) {
		...
		if( y >= 0 ) {
			MainView.outputText( ' and pussy' );
		}
		MainView.outputText( ' with confident, sure strokes.  Your answer, never spoken aloud, becomes evident by your actions: she got you this horny, and you\'re going to impregnate every hole, no matter how long it takes.  Her asshole is tight, almost <i>too tight</i> after having experienced her pussy, and you can feel the next batch of cum already beginning to churn in your [balls], a heavy, warm weight growing larger and larger.' );
		...
		MainView.outputText( ' revealed briefly to the cold air before ' );
		if( y < 0 ) {
			MainView.outputText( 'it\'s ' );
		} else {
			MainView.outputText( 'they\'re ' );
		}
		MainView.outputText( 'devoured by the hot, enveloping anal entrance ' );
		if( y >= 0 ) {
			MainView.outputText( 'and squeezing pussy ' );
		}
		MainView.outputText( 'all over again.' );
		...
		if( CoC.player.tallness >= 74 ) {
			MainView.outputText( 'nipping her ear' );
		} else if( CoC.player.tallness >= 60 ) {
			MainView.outputText( 'nipping at her shoulder' );
		} else {
			MainView.outputText( 'nipping at her side' );
		}
		MainView.outputText( ' as you answer, "<i>Yes.</i>"  Her breasts feel softer than her pillowy buttcheeks, which even now are squishingly running over your hips and [legs], smothering you in soft warmth while her innards milk your member' );
		if( y >= 0 ) {
			MainView.outputText( 's' );
		}
		MainView.outputText( '.  You roughly squeeze her breasts, too focused on the climax slowly building within your compressed crotches to be gentle.  Her breasts bounce and jiggle around your ministrations.  Her nipples, hard as lead bullets, are like magnets for your exploratory fingertips, and soon you lock onto them, squeezing and tugging, kneading them with each bounce for encouragement.  Sophie screeches as she bottoms out, pushing herself back against you, noisily cumming, her juices ' );
		if( y < 0 ) {
			MainView.outputText( 'spraying across your [legs]' );
		} else {
			MainView.outputText( 'running down your ' + Descriptors.cockDescript( y ) + ' in miniature rivers' );
		}
		MainView.outputText( ' messily.  The explosion of sloppy lady-spunk accompanies convulsive anal clenching, and with a hard pinch on her nipples, you give yourself over to the unnatural lusts coursing through your bloodstream again.' );
		...
		MainView.outputText( '.  She wraps her arms behind herself to hold onto you affectionately.  Again and again, you blast rope after rope of spunk into her plush heiny.  ' );
		if( y >= 0 ) {
			MainView.outputText( 'At the same time, you make her cunt even creamier' );
			if( CoC.player.cumQ() >= 1000 ) {
				MainView.outputText( ' and her belly even more distended' );
			}
			MainView.outputText( '.  ' );
		}
		MainView.outputText( 'There\'s no stopping your orgasm - it may even be more potent, more virile than the one before!  Sophie simply rides it out, gushing her girlspunk out all over you.' );
		if( CoC.player.cumQ() >= 500 ) {
			MainView.outputText( '  Her gut rumbles as you fill more and more of her intestines, eventually ' );
			if( CoC.player.cumQ() < 1000 ) {
				MainView.outputText( 'giving her a' );
			} else {
				MainView.outputText( 'adding to her visible' );
			}
			MainView.outputText( ' cum-paunch.' );
			if( CoC.player.cumQ() >= 1500 ) {
				MainView.outputText( '  Soon, the cum is squirting out around you' );
				if( CoC.player.hasKnot( x ) ) {
					MainView.outputText( 'r knot' );
				}
				MainView.outputText( '.  You\'ve filled every inch of her intestines with cum, and there\'s simply nowhere for your fresh, virile squirts to go but out!' );
			}
		}
		MainView.outputText( '  The harpy goes limp in your arms, still dribbling from her cunt as you continue to sate yourself on her rump and nipples.' );
	...
	SophieBimbo.prototype.giantCocksImpregnateSophie = function() {
		...
		if( CoC.player.balls > 0 ) {
			MainView.outputText( 'in those plump balls of yours' );
		} else {
			MainView.outputText( 'inside you' );
		}
		MainView.outputText( ', just waiting to squirt out!</i>"  She says it as more a statement of fact than anything else, using that oddly hypnotic, sing-songish voice that seems to reach right inside you.  The cum really <b>does</b> seem to be sloshing around inside you, and as your heart beats faster in your chest, your ardor for the well-endowed harpy grows.  Sophie rubs her soft palm along the underside, right on the meatus your urethra makes as she continues in that strange tone, "<i>You\'re <b>soooo</b> hard, and full.  It\'s making your cock more...</i>" She plants another wet kiss on you, this time on your ' + CoC.player.cockHead( x ) + '.  "<i>...and more sensitive.  <b>So</b> sensitive, like just me rubbing my finger on you is as good as fucking a cunt, right?</i>"' );
		...
		if( CoC.player.cumQ() >= 500 ) {
			MainView.outputText( '  In no time, Sophie\'s belly begins to form into a bump, and the pressure leaves more and more of your seed to be wasted on the bimbo\'s thighs.' );
		}
		if( CoC.player.cumQ() >= 1000 ) {
			MainView.outputText( '  Your intense ejaculations quickly balloon that petite bump into a rounded dome.  Torrents of spunk run out of her around your tip, fountaining slightly with each fresh dose.  You simply can\'t pack any more cum into her, and the excess puddles around her plush bottom.' );
		}
	...
	SophieBimbo.prototype.yesSophieSleepWith = function() {
		MainView.clearOutput();
		this.sophieSprite();
		MainView.outputText( 'Sophie claps her hands excitedly when you give your assent, immediately launching into a hug that presses her ' );
		switch( SceneLib.sophieScene.pregnancy.event ) {
			case 1:
				MainView.outputText( 'burgeoning' );
				break;
			case 2:
			...
			case 3:
			case 4:
				MainView.outputText( 'huge, gravid' );
				break;
			default:
				MainView.outputText( 'taut' );
		}
		MainView.outputText( ' midriff and cushiony tits against you.  "<i>You\'re awesome, [name], you know that?  You\'re totally ' + CoC.player.mf( 'hunky', 'cute' ) + ' AND awesome!</i>"  She spins about, dancing happily and shaking her voluptuous backside in your direction as she goes.' );
	...
	SophieBimbo.prototype.moveSophieInRepeat = function() {
		MainView.clearOutput();
		this.sophieSprite();
		MainView.outputText( 'You go up to the feathery bimbo and idly question if she still wants to share your bed with you' );
		if( !SceneLib.sophieScene.pregnancy.isPregnant ) {
			MainView.outputText( ' even though she\'s not pregnant any more' );
		}
		MainView.outputText( '.  Sophie\'s voluminous, painted lips curl into a radiant smile, an effect enhanced even more by the gold gloss she coats them with.' );
	...
	SophieBimbo.prototype.sophieFenCraftedSex = function( morning ) {
		...
		//{Regular Sex};
			...
			MainView.clearOutput();
			this.sophieSprite();
			MainView.outputText( 'You hastily remove your armor and lie back on your blankets, beckoning Sophie forward with your hand.  The slutty, sex-hungry bimbo prances up on her tiptoes, supporting herself with flapping wings as her flared hips roll hypnotically, ever closer.  In no time, she\'s straddling your supine form; dripping sex positioned a foot above.  The moisture her puffy, aroused cleft exudes patters off your ' );
			if( CoC.player.pregnancyIncubation > 0 && CoC.player.pregnancyIncubation < 150 ) {
				MainView.outputText( 'pregnant ' );
			}
			MainView.outputText( 'midsection from time to time, hot droplets that shimmer with the proof of Sophie\'s ever-burning arousal for dick.  Above, her titanic cleavage casts a gloriously large shadow across you.  Each of the heaving globes is capped with a jutting nipple.  Her areolae look nearly as hard as your ' + Descriptors.multiCockDescriptLight() + ', and you lick your lips at the sight of them.' );
		...
		if( CoC.player.balls > 0 ) {
			MainView.outputText( '  Sophie\'s immense backside slides over your [balls] each time she bottoms out, her tail feathers tickling at the bottom of your [sack].' );
		}
		MainView.outputText( '  You pull on her nipple, earning yourself a squawk of surprised excitement from Sophie.  She writhes in your grip, twisting this way and that, pulling harder on her poor abused nipple as her pussy goes wild around you.' );
		...
		if( SceneLib.sophieScene.pregnancy.isPregnant ) {
			MainView.outputText( '  The thorough seeding fills her up completely - her womb is too full of egg for there to be any room for spunk, and it all drips out with each fresh injection.' );
			if( CoC.player.cumQ() >= 500 ) {
				MainView.outputText( '  You cum so hard that torrents of spooge wash out of her slit, her womb obstructed by the egg you made with her.' );
			}
		}
		if( CoC.player.cumQ() >= 2000 ) {
			MainView.outputText( '  The oozing spunk soaks you thoroughly, and Sophie\'s thighs become matted with the gallons of gunk that squirts out of her lips.' );
		}
	...
	SophieBimbo.prototype.fuckYoPregnantHarpyWaifu = function( morning ) {
		...
		if( morning ) {
			...
			if( morning ) {
				MainView.outputText( ', morning' );
			}
			MainView.outputText( ' fuck.  Her skin is silky smooth, and if you push a little, you can actually feel the solid curve of the growth inside her.  That egg sure is getting big!' );
		}
		//REGULAR FUCK;
		else {
			MainView.clearOutput();
			this.sophieSprite();
			MainView.outputText( 'You go ahead and take off your [armor], letting Sophie take in the view of [eachCock].  She immediately flounces over and drops to her knees in front of you.  Her hands wraps around ' + Descriptors.cockDescript( x ) + ', ' );
			if( CoC.player.lust > 50 ) {
				MainView.outputText( 'feeling its firmness.  "<i>Wow, you\'re so hard already, [name]!</i>" she comments.' );
			} else {
				MainView.outputText( 'slowly stroking it until it begins to pulse to life, thickening in her hand.' );
			}
			MainView.outputText( '  Your rigid tool is soon tingling pleasantly from her handjob, the pregnant bimbo licking her lips hungrily.  She asks "<i>Could you lie back and let me be on top?  It\'ll be easier on me, since I\'m all big and stuff.</i>"  She runs a hand over her gravid midriff, obviously enjoying herself as she waits.' );
		...
		if( CoC.player.balls > 0 ) {
			MainView.outputText( '[balls], where they hang in thick drops before falling to the ground,' );
		} else {
			MainView.outputText( 'taint and [legs]' );
		}
		MainView.outputText( ' proving the veracity of her statements many times over.  You can\'t SEE the wetness, but your ' + Descriptors.cockDescript( x ) + ' certainly feels it, twitching inside Sophie\'s silky slit when the waves of wetness roll over it.' );
		...
		if( CoC.player.cockTotal() > 1 ) {
			MainView.outputText( '  The underside of her tremendous, pregnant belly suddenly slides along you slickly, lubricated by the wasted spooge that\'s spurting from your unused member' );
			if( CoC.player.cockTotal() > 1 ) {
				MainView.outputText( 's' );
			}
			MainView.outputText( '.  The inadvertent tummyfuck redoubles the pleasure, forcing you to deal with a true, multi-cocked orgasm.' );
		}
		MainView.outputText( '  Immediately, the cum you\'re squirting into her begins to be squeezed right back out.  Her womb is blocked thanks to the massive egg inside, and your lower body turns into a fruity, salty mess from all the cum and girl-jizz Sophie forces out.' );
		if( CoC.player.cumQ() >= 500 ) {
			MainView.outputText( '  There\'s enough there to ' );
			if( CoC.player.cumQ() < 1000 ) {
				MainView.outputText( 'soak your blankets' );
			} else if( CoC.player.cumQ() < 2000 ) {
				MainView.outputText( 'soak your blankets and the ground below' );
			} else if( CoC.player.cumQ() < 5000 ) {
				MainView.outputText( 'soak your blankets and form a giant puddle below, leaving you feeling like you\'re on a waterbed made of spunk.' );
			} else {
				MainView.outputText( 'soak your blankets and create a lake the two of you sink partway into, surrounded by muddy, cum-flavored mud.' );
			}
		}
		MainView.outputText( '\n\nYou sag back as the last few drops leak out around you.  Sophie rolls off to the side, panting heavily.  She titters, "<i>' );
		if( morning ) {
			MainView.outputText( 'What... a... way to... start a... morning!' );
		} else {
			MainView.outputText( 'Ooohh... you\'re... gonna be... a great... daddy...' );
		}
		MainView.outputText( '</i>" in between panting gasps for breath.' );
		MainView.outputText( '\n\nSophie leaves you there' );
		if( CoC.player.cumQ() >= 1000 ) {
			MainView.outputText( ' in the hardening mud' );
		}
		MainView.outputText( ', swaying her hips sensually as seed runs from her cunt in thick little rivers.  You\'re wet, sticky, and sated' );
		if( morning ) {
			MainView.outputText( ' when you go wash up to get dressed.  It\'s going to be a good day.' );
		} else {
			MainView.outputText( ' when you go to get dressed.  You\'ll have to make sure to wash clean at some point, but for now you enjoy the sweet scent of your pet bimbo\'s cum.' );
		}
		CoC.player.orgasm();
		EngineCore.dynStats( 'sen', -2 );
		if( morning ) {
	...
	SophieBimbo.prototype.sophiePreggoTitJobs = function() {
		...
		if( CoC.player.cockTotal() > 1 ) {
			MainView.outputText( '  Then, she fishes the ' );
			if( CoC.player.cockTotal() === 2 ) {
				MainView.outputText( 'other one' );
			} else {
				MainView.outputText( 'rest' );
			}
			MainView.outputText( ' out of your [armor], giving ' );
			if( CoC.player.cockTotal() === 2 ) {
				MainView.outputText( 'it' );
			} else {
				MainView.outputText( 'each' );
			}
			MainView.outputText( ' a slow, affectionate stroke before she returns to her target.' );
		}
		MainView.outputText( '  The sensitive tip swells in her mouth, responding to the combination of sloppy, plump lip-kisses and the drugs now coursing through you.' );
		...
		if( CoC.player.cocks[ x ].cockLength > 30 ) {
			MainView.outputText( 'the underside of your immense erection' );
		} else {
			MainView.outputText( 'your ' + CoC.player.cockHead( x ) + '' );
		}
		MainView.outputText( ' with her lips, already pursed into a plump, cock-sucking doughnut hole of pleasure.  The noise she makes when your ' + Descriptors.cockDescript( x ) + ' ' );
		if( CoC.player.cocks[ x ].cockLength > 30 ) {
			MainView.outputText( 'presses against' );
		} else {
			MainView.outputText( 'slips into' );
		}
		MainView.outputText( ' her puffy, puckered orifice is indescribably moist, a sloppy sucking sound that would make you dribble pre-cum if her tits and mouth weren\'t already milking a steady flow out.' );
		if( CoC.player.cocks[ x ].cockLength > 30 ) {
			MainView.outputText( '  Sophie pulls back long enough to gasp, "<i>You\'re so long, I can\'t even take the tip!</i>"' );
		}
	...
	SophieBimbo.prototype.goHogWildOnSophieBewbs = function() {
		...
		if( CoC.player.cockTotal() > 1 ) {
			...
			if( CoC.player.cockTotal() > 2 ) {
				MainView.outputText( 's splay' );
			} else {
				MainView.outputText( ' splays' );
			}
			MainView.outputText( ' out to the side, lamely brushing against the outsides of her tit.' );
		}
		MainView.outputText( '  Sophie blubbers in surprise, stopping only when your ' );
		if( CoC.player.cocks[ x ].cockLength <= 30 ) {
			MainView.outputText( CoC.player.cockHead( x ) + ' pushes into through her startled cock-pillows, muffling her more effectively than any gag.  She immediately sucks on it, a happy look in her eyes.  The bimbo seems to want nothing more than to lie there and polish your rod.' );
		} else {
			MainView.outputText( ' immense rod smacks across her face, too long to try to jam down her throat.  It completely covers her face, smothering her features with rigid, veiny dickflesh.  She immediately begins to lavish the underside with licks and long wet kisses, aided by her plus-sized bimbo lips.  When her eyes peek out from under your ' + Descriptors.cockDescript( x ) + ', they seem placid and happy.  It seems the slut wants nothing more than to lie there and service your cock.' );
		}
		...
		if( CoC.player.cocks[ x ].cockLength <= 30 ) {
			MainView.outputText( ' right into Sophie\'s mouth' );
		} else {
			MainView.outputText( ' above Sophie\'s head' );
		}
		MainView.outputText( '.  The bird slut stops her frenzied fellatio to beg, "<i>Please cum on me, [name]!  Cum all over Momma\'s Sophie\'s face and tits!  I fucking love, like, being covered in jizz!</i>"' );
		...
		if( CoC.player.balls > 0 ) {
			MainView.outputText( ', cupping your [balls] with a hand and massaging them to aid your ejaculation' );
		}
		MainView.outputText( '.  Your [butt] is squished up against her belly, both of you sweating and slipping all over each other.  Bulging in her breasty embrace, your ' + Descriptors.cockDescript( x ) + ' flexes, and your ' + CoC.player.cockHead( x ) + ' thickens.' );
		if( CoC.player.hasKnot( x ) ) {
			MainView.outputText( '  Your knot inflates to a ludicrous degree, squeezed down on from all sides by slick, gold-painted tits, happy to be engulfed by warm flesh.' );
		}
		MainView.outputText( '  Cum fountains from you, splattering over Sophie\'s face, some of it catching on her tits along the way.  A ribbon of the white goo dangles between her mountainous chest and her chin, breaking only when you spurt another set of alabaster cream all over her breasts, most trapped inside the snug cleavage with you.  You slip yourself forwards and continue to cum, lacing hot, sticky jets onto her face.' );
		if( CoC.player.cumQ() > 1000 ) {
			MainView.outputText( '  Again and again, you continue to paint her white.  Your orgasm seems almost without end as you ejaculate.  Sophie\'s face is soaked with it, and her breasts have become glazed mountain-peaks.' );
		}
		if( CoC.player.cumQ() > 2500 ) {
			MainView.outputText( '  By the time you finish, the stuff is puddled under her.  The best your harpy pet can manage is a spermy smile as she languishes in your seed.' );
		}
		MainView.outputText( '  You push your ' + CoC.player.cockHead( x ) + ' and get a kiss from her as you finish cumming, oozing one last dollop onto her fat lips.  She whimpers in the most exciting way as you withdraw, wiping your cock off on her swollen belly, marking her as yours once more.' );
	...
	SophieBimbo.prototype.letSophieMilkYoDick = function() {
		...
		this.sophieSprite();
		var x = CoC.player.biggestCockIndex();
		MainView.outputText( 'You nod at Sophie and hold yourself still.  She rewards you by wrapping her breasts back around you, enveloping you in tight pleasure again.  ' );
		if( CoC.player.balls > 0 ) {
			MainView.outputText( 'Your [balls] drag across her pregnant belly as she goes to work, but you don\'t mind in the slightest.  There\'s something erotic about having them bumping up against the fruit of your union.  ' );
		}
		MainView.outputText( 'Her breasts begin to bounce without warning, up and down in perfect sync.  The tight titty-embrace is almost too much.  You can feel your dick flexing in that smothering, lube-soaked chest.  Sophie extends her tongue to lick at you, and her tongue sends shockwaves of excitement through your already raging boner.' );
		...
		if( CoC.player.cocks[ x ].cockLength <= 30 ) {
			MainView.outputText( ', ready to catch the cum' );
		} else {
			MainView.outputText( ', assisting the cum' );
		}
		MainView.outputText( ' that\'s already bubbling out of your [balls] with searing heat.  She presses harder on each side, crushing your ' + Descriptors.cockDescript( x ) + ' with her slippery tits as your urethra bulges with the heavy load. With an audible squishing noise, you unload what feels like every drop of cum your body contains in one huge lance.' );
		//{Fork between mouth and bukkake};
		//Mouth;
		if( CoC.player.cocks[ x ].cockLength <= 30 ) {
			MainView.outputText( '  Sophie' );
			if( CoC.player.cumQ() < 250 ) {
				MainView.outputText( ' swallows it without complaint, her eyes twinkling mirthfully as she suckles down your small load.  Surprisingly, you dump a few more pulses into her, each weaker than the last.  The bird-woman drinks it with ease, never looking away from you.' );
			} else if( CoC.player.cumQ() < 500 ) {
				MainView.outputText( '\'s cheeks bulge from the size of your load, but she manages to get it down with a big gulp.  Surprisingly, you dump a few more jets of thick cream into her waiting gullet, each weaker than the last but big enough to make it hard for her to swallow.  She never looks away from you as she takes it.' );
			} else if( CoC.player.cumQ() < 1000 ) {
				MainView.outputText( '\'s cheeks bulge cartoonishly at your immense deposit, cream escaping from the corners of her mouth as her poor mouth floods.  Her throat bobs ludicrously, trying to keep up with the flow, but when you follow up that virile blast with several smaller, still potent deposits, she gives up and lets the jizz run down her lip and face, dripping onto her tits.  Through it all, her eyes never leaves yours.' );
			} else {
				MainView.outputText( '\'s cheeks bulge ridiculously for a split second before the pleasure sends cum fountaining out her nose and jetting out the corners of her mouth.  She <b>tries</b> to swallow it, but her meager throat simply can\'t ' );
				if( EngineCore.silly() ) {
					MainView.outputText( 'repel cum of that magnitude' );
				} else {
					MainView.outputText( 'handle that much cum' );
				}
				MainView.outputText( '.  Again and again, you spunk the hell out of her face, until Sophie pulls back gagging.  She gets a mask of jizz for her efforts, even after she\'s swallowed a bellyful of cum.  She WAS watching your face, until your cum obscured her eyes, and even then, she keeps her head facing you, letting you watch your jism dripping down her gorgeous features.' );
			}
			MainView.outputText( '  The bird-girl withdraws ' );
			if( CoC.player.cumQ() < 1000 ) {
				MainView.outputText( 'with a happy smile' );
			} else {
				MainView.outputText( 'coughing and sputtering' );
			}
			MainView.outputText( ' once you\'re dumped out every drop.  She touches your ' + Descriptors.cockDescript( x ) + ' affectionately, tickling at its underside, and her flushed face seems extraordinairily pleased to have made you cum so hard.  Sophie\'s hands stroke her belly slowly as she looks up at you, whispering, "<i>You\'re like, so good to Momma Sophie.  Just be sure and cum for my twat again soon, okay?  It misses you.</i>"' );
		}
		//On top of her.;
		else {
			MainView.outputText( '  Sophie' );
			if( CoC.player.cumQ() < 250 ) {
				MainView.outputText( ' giggles happily when the cum jets into the air and down atop her head, moaning against your dick while it seeps through her platinum feathers.  Throughout it all, she licks and sucks on your shaft, milking out every drop and never looking away.' );
			} else if( CoC.player.cumQ() < 800 ) {
				MainView.outputText( ' moans when your heavy deposits splatter into her hair, dripping through the downy blond feathers in a messy web.  Throughout it all, she sucks and licks at you, polishing your ' + Descriptors.cockDescript( x ) + ' until she\'s sure every single drop of jizz has been expelled onto her curvy frame.' );
			} else {
				MainView.outputText( ' moans whorishly as your gigantic cum-wad splatters over her, running down her hair in thick waves, soaking her shoulders and even dropping over her face in a slippery mask.  She keeps kissing and sucking to make sure you give up every drop, not stopping until she feels your urethra stop its orgasmic pulsating.  Even then, her face stays angled up at you, allowing you to watch as your jizz runs unimpeded across her voluptuous body, dripping from every curve.' );
				if( CoC.player.cumQ() >= 2000 ) {
					MainView.outputText( '  She\'s completely soaked, head to toe' );
					if( CoC.player.cumQ() >= 3000 ) {
						MainView.outputText( ' and a ' );
						if( CoC.player.cumQ() < 4000 ) {
							MainView.outputText( 'puddle' );
						} else if( CoC.player.cumQ() < 6000 ) {
							MainView.outputText( 'big puddle' );
						} else if( CoC.player.cumQ() < 10000 ) {
							MainView.outputText( 'small lake' );
						} else {
							MainView.outputText( 'obscene lake' );
						}
						MainView.outputText( ' has formed around the pair of you' );
					}
					MainView.outputText( '.' );
				}
			}
			MainView.outputText( '  She gathers up some of your spunk and rubs it over her breasts and belly as you slump back, reveling in the feel on her skin and how wonderful her big, pregnant boobs are feeling.' );
	...
	SophieBimbo.prototype.sophieBirthsEgg = function() {
		...
		if( this.bimboSophie() ) {
			MainView.outputText( 'Come here, [name]!  I... whooooaaaa... I wanna like, hold your hand when the egg comes out!' );
		} else {
			MainView.outputText( 'Come here, [name]!  I... whoooaaaa...  I need something to hold on to while this comes out!' );
		}
		MainView.outputText( '</i>"' );
		if( CoC.player.cor < 33 ) {
			MainView.outputText( '  You sit down next to her, and figuring this must be normal for her, you hold her hand with one arm and grope at her free breast with the other.' );
		} else if( CoC.player.cor < 66 ) {
			MainView.outputText( '  You sit down next to her with a sigh.  Well, at least you can grope her tit with your other hand!' );
		} else {
			MainView.outputText( '  You plop down next to her, but ignore her proffered hand for one of those juicy melons on her chest.  Grinning, you can\'t help but think that this is a far more tender thing to hold anyway.' );
		}
		...
		if( CoC.player.isBiped() ) {
			MainView.outputText( 'rs' );
		}
		MainView.outputText( '.  A rounded white rim peeks out through her spasming pussy-lips, glistening with lubricants that drop from its bottom so fast it\'s almost a steady stream.' );
		...
		if( CoC.flags[ kFLAGS.SOPHIE_ADULT_KID_COUNT ] === 0 ) {
			MainView.outputText( '  Can you handle having another harpy living in your camp?\n' );
		} else {
			MainView.outputText( '  Just how many harpies can your camp hold?\n' );
		}
	...
	SophieBimbo.prototype.sophiesEggHatches = function() {
		...
		if( this.bimboSophie() ) {
			MainView.outputText( 'bimbo ' );
		} else {
			MainView.outputText( 'woman ' );
		}
		MainView.outputText( 'is raising such a fuss.  Upon spotting Sophie, you can\'t help but notice the flapping of wings and a number of feathers strewn about.  The ' );
		if( this.bimboSophie() ) {
			MainView.outputText( 'silly ' );
		}
		MainView.outputText( 'harpy is once again fussing over her newly birthed egg, though this time she seems even more flustered about it.  Catching sight of you, her face instantly lights up, a bright' );
		if( this.bimboSophie() ) {
			MainView.outputText( ', happy' );
		}
		MainView.outputText( ' smile spreading across her plump, golden lips as she bounds over to you and grabs your hand.' );
		if( this.bimboSophie() ) {
		...
		if( CoC.flags[ kFLAGS.SOPHIE_ADULT_KID_COUNT ] < 4 ) {
			...
			if( CoC.flags[ kFLAGS.SOPHIE_ADULT_KID_COUNT ] === 0 ) {
				...
				if( CoC.flags[ kFLAGS.UNKNOWN_FLAG_NUMBER_00282 ] > 0 ) {
					MainView.outputText( ', though her lips are a little larger than you\'d think was normal - maybe she inherited it from her mom?' );
				} else {
					MainView.outputText( '.' );
				}
				MainView.outputText( '  The harpy chick is actually about as big as a four or five year old, and she looks up at Sophie curiously.' );
				if( CoC.flags[ kFLAGS.UNKNOWN_FLAG_NUMBER_00282 ] > 0 ) {
			...
			//-Curvy like Sophie, but with well-developed wings and extra-soft feathers (WINGJOBS).  Pink plumage.  (blue eyes);
				...
				if( CoC.flags[ kFLAGS.UNKNOWN_FLAG_NUMBER_00282 ] > 0 ) {
					MainView.outputText( ' like her mother used to have before her bimbofication' );
				}
				MainView.outputText( ', and a shape that seems to indicate that maturity will be VERY generous to her.  She looks around in wonder, already flapping wings that seem a touch more developed than her sisters were at that age.  You\'ve got to wonder just how big they\'ll get with age.' );
				if( CoC.flags[ kFLAGS.UNKNOWN_FLAG_NUMBER_00282 ] > 0 ) {
			...
			if( this.bimboSophie() ) {
				MainView.outputText( '  Before the girl can try to stand she is swept up off her feet by her ecstatic mother.  "<i>Oohhhhh, just look at you!  My baby girl is sooo cute!  Soooo totally fluffy and like, suuuuper soft!</i>"' );
			} else {
				MainView.outputText( '  Before the girl can try to stand she is swept up off her feet by her ecstatic mother.  "<i>Oohhhhh, you\'re so cute!  My baby girl is sooo cute!  Oh, the boys will be all over you when you grow up, I just know it!</i>"' );
			}
		}
		//Every Other daughter*;
			...
			if( Utils.rand( 2 ) === 0 ) {
				...
				if( CoC.flags[ kFLAGS.UNKNOWN_FLAG_NUMBER_00282 ] > 0 ) {
					MainView.outputText( 'blonde' );
				} else {
					MainView.outputText( 'white' );
				}
			}
			MainView.outputText( ' girl coos as she shields her ' );
			if( Utils.rand( 2 ) === 0 ) {
				MainView.outputText( 'violet' );
			} else {
				MainView.outputText( 'blue' );
			}
			MainView.outputText( ' eyes from the sun.  The little bird-girl is soon out of her egg, but already looks to be four or five years old.  As always, the sweet little thing is as fluffy as a newborn chick, feathers sticking out every which way and making her look more like a puffball with skin showing than a little baby harpy.  Before the girl can try to stand she is swept up off her feet by her ecstatic mother.  ' );
			if( this.bimboSophie() ) {
				MainView.outputText( '"<i>Oohhhhh, just look at you!  My baby girl is sooo cute!  Soooo totally fluffy and like, suuuuper soft!</i>"' );
			} else {
				MainView.outputText( '"<i>Oohhhhh, you\'re so cute!  My baby girl is sooo cute! Oh, the boys will be all over you when you grow up, I just know it!</i>"' );
			}
		}
		...
		if( this.bimboSophie() ) {
			MainView.outputText( '"<i>Oh dearie, there there, like, calm down, sweetie.  Don\'t worry, Momma Sophie\'s here.</i>"  The matronly harpy gently hugs the squirming fluff-ball into her big, soft breasts, her hands gently stroking her fussy daughter\'s feathery hair.' );
		} else {
			MainView.outputText( '"<i>There there, calm down, baby.  Momma Sophie\'s here...  I\'m here.</i>"  The matronly harpy gently hugs the squirming fluff-ball into her big, soft breasts, her hands gently stroking her fussy daughter\'s feathery hair.' );
		}
	...
	SophieBimbo.prototype.sophieKidMaturation = function() {
		...
		//Fifth+ daughter;
			...
			MainView.outputText( 'breasts - just as high, round and perky, yet big and yielding to the touch, like the softest pillow.' );
		}
		//ALL CONTINUE HERE;
		MainView.outputText( '  The newly embodied harpy lets out a sigh of relief now that the changes have stopped, clearly surprised by what happened and glad it\'s over. Moving to get a better view of your daughter, you take in the sight of her new body. Your once petite harpy girl looks more like a stacked ' );
		if( CoC.flags[ kFLAGS.UNKNOWN_FLAG_NUMBER_00282 ] > 0 ) {
			MainView.outputText( 'bimbo' );
		} else {
			MainView.outputText( 'bombshell' );
		}
		MainView.outputText( ', just like her mother.' );
		if( this.bimboSophie() ) {
			MainView.outputText( '  From the inquisitive look on her face and spark of intelligence in her eyes, it seems that she hasn\'t lost her mind to her inner bimbo.' );
		}
		if( this.bimboSophie() ) {
		...
		if( CoC.flags[ kFLAGS.SOPHIE_ADULT_KID_COUNT ] > 0 ) {
			...
			if( CoC.flags[ kFLAGS.SOPHIE_FAMILY_INCEST ] === 1 ) {
				...
				MainView.outputText( '.  She beams a radiant smile at you and turns around, shaking her rump at you enticingly, "<i>So, when do you want to try me out, ' + CoC.player.mf( 'Daddy', '\'Mom\'' ) + '?</i>"' );
	...
	SophieBimbo.prototype.sophieAndIzmaPlay = function() {
		...
		MainView.outputText( '<b>Something odd happens that ' );
		if( CoC.time.hours < 6 || CoC.time.hours > 20 ) {
			MainView.outputText( 'night' );
		} else if( CoC.time.hours < 12 ) {
			MainView.outputText( 'morning' );
		} else if( CoC.time.hours === 12 ) {
			MainView.outputText( 'noon' );
		} else if( CoC.time.hours < 5 ) {
			MainView.outputText( 'afternoon' );
		} else {
			MainView.outputText( 'evening' );
		}
	...
	SophieBimbo.prototype.watchIzmaSophie = function() {
		...
		if( CoC.player.hasCock() ) {
			MainView.outputText( ', from me OR my Alpha' );
		}
		MainView.outputText( '.  If I had MY way, you\'d be tied up on the lake-side so my sisters could play with these ridiculous jugs while they pound your fat ass full of spunk and your belly full of shark-babies.</i>"' );
		...
		if( CoC.player.hasCock() ) {
			MainView.outputText( 'stroke yourself through bliss' );
		} else {
			MainView.outputText( 'finger yourself through bliss' );
		}
		MainView.outputText( '.  Izma\'s quartette of sperm-filled balls abruptly rise in her suddenly taut prison and begin to pulsate in time with her cock.  At first, there\'s no visible change, but before long, semen begins to bubble out around the twitching shark-shaft, spattering onto the ground below.  Your own climax winds down as well' );
		if( CoC.player.hasCock() ) {
			if( CoC.player.cumQ() >= 1000 ) {
				MainView.outputText( ', leaving you in a puddle of your own slimy mess' );
			}
		}
		MainView.outputText( '.  Izma keeps futilely pumping a bit longer, and you see Sophie\'s belly curve slightly with the hefty seed-deposit.' );
