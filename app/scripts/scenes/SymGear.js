...
angular.module( 'cocjs' ).run( function( SceneLib, MainView, ArmorLib, WeaponLib, AppearanceDefs, kFLAGS, CoC, EngineCore ) {
	...
	//[INTRO];
	SymGear.prototype.inquisitorRobesDiscovery = function() {
		MainView.outputText( '', true );
		MainView.outputText( 'Cutting your way through the swamps in the hopes of finding something that isn\'t a spider, you are pleasantly surprised when you actually succeed.  You discover what seems to be a mossy stone door in a low hillside, adorned with some sort of complex puzzle lock composed of multiple stone circles decorated with animal symbols.  You don\'t know what lurks beyond the door, but if adventuring has taught you nothing else it is that something cool is always behind a puzzle.\n\n', false );
		//[Intelligence less than 60];
		if( CoC.player.inte < 60 ) {
			MainView.outputText( 'Unfortunately, try as you might, you cannot seem to figure the lock out.  You spin the stone circles around multiple times to try and discern the pattern to them, but find yourself continually disappointed.  Eventually you resort to trying to listen for the sound of tumblers behind the door indicating a shifting lock.  It is not as successful as you hope.  Disappointed but not undeterred, you resolve to return to the mysterious lock at a later point, when you are more capable of handling its clever riddle.', false );
			//[Player leaves, room can be re-encountered];
			EngineCore.doNext( SceneLib.camp, SceneLib.camp.returnToCampUseOneHour );
			return;
		}
		//[Intelligence greater than 60] ;
		MainView.outputText( 'While spinning the puzzle locks to try and determine the solution, you notice something curious about the repeated symbols adorning them.  Though initially you thought them to mean something in regards to where the locks were meant to sit, you begin to suspect that there is another trick to them.  Slowly working your way through the possibilities, your suspicions are confirmed symbols are a cipher, hiding the true answer to getting through the door.  Their rotation is a red herring, meant to obscure their nature.  If your translation is correct, the door is in fact magically sealed, and waiting for a spoken command to open: one that would never be casually spoken in its presence.\n\n', false );
		MainView.outputText( '"<i>Chastity,</i>" you say.\n\n', false );
		MainView.outputText( 'The tumblers of the door spin, locking into a meaningless position.  Stone hinges scrape and rumble across the ground as the sealed entrance opens.  Stale air rushes out of the cavern.  Before you stone steps descend into the ground, and torches along the wall blaze into life.  This room may not have been touched in decades.\n\n', false );
		MainView.outputText( 'You descend, alert.  Dust along the floor makes it difficult to discern if there are traps within the room, but the caution is possibly unwarranted, for you reach the bottom of the stairs without incident.  A single table and a chest are the only adornments of the interior.  Upon the table a rolled piece of parchment sits.  Though you are curious about the chest, the question of what this place is remains in your mind.  You unroll the parchment and read.\n\n', false );
		MainView.outputText( '<i>I have failed.\n\nI could have prevented all of the tragedy that will befall this land, if I were less arrogant.  It was my duty to root out corruption in the kingdom, and to ensure that no force could sully our name, or blaspheme against our queen.  But I was too certain of myself, too certain of what I thought to be true.  I believed that it was my duty to protect my queen from the dangerous and reckless thoughts of impure commoners and power-hungry mages.\n\n', false );
		MainView.outputText( 'Instead, I should have protected them from my queen.\n\n', false );
		MainView.outputText( 'When at last I reckoned the truth of Lethice\'s doings, the wheels turned too quickly to stop them.  The corruption spread through the kingdom like a famished beast.  Commoner and mage alike were swallowed by its depravity, and remade.  The demons were born, and had I possessed the foresight to watch my queen more carefully I could have stopped it.\n\n', false );
		MainView.outputText( 'Do not mistake me for a coward, merely a fool.  I stood against my queen when at last I opened my eyes.  I dared to raise arms against her, and call upon the brightest of white fires, blazing with the desperation of a man determined to save his nation.  I failed.  She had feasted on so many souls, gained so much disgraceful power.  Before I could even gain a foothold I had already expended my energy.\n\n', false );
		MainView.outputText( 'She mocked me.  Perhaps she was right to do so.  An infernal mark was seared into my body as punishment for my hubris.  "<i>The Inedible Soul,</i>" she declared me.  Stripped naked I was made to crawl through the city, spat and ejaculated upon, jeered at by the hedonists that now populated it.  None dared to try and change me, not with Lethice\'s mark upon me.  Such was my punishment.  Powerless, I watched as the land fell to the taint that it was once my duty to keep in check.\n\n', false );
		MainView.outputText( 'I failed to stop the demons, and Lethice.  But I am one man, and there are many more who will come after me.  Many - too many - will fall, their souls and very nature devoured by the land, and for them I will suffer.  It is not their fault that my inaction created a force greater than they.\n\n', false );
		MainView.outputText( 'But the demons - my former queen - are greedy.  They will expand, and conquer, and one day they will extend themselves too far.  One day a champion will challenge them.  Perhaps from another land, a stronger tribe, standing tall against the force that threatens it.  Perhaps from within our own kingdom, a hold-out, a child raised in hiding.  I do not know.\n\n', false );
		MainView.outputText( 'If you have found this chamber, then you are wise.  Wiser and cleverer than most.  Perhaps you have the ability to be that champion.  Though I have failed, I have taken steps to ensure that my mistakes will not be repeated.  My magic found itself limited.  Yours will not.\n\n', false );
		MainView.outputText( 'I have spent the last of my abilities to fashion attire suitable for a champion.  It is locked within the chest.  I am no fool - I know that it may be necessary to adapt this armor for  a body warped by corrupt powers.  It may also be necessary to deprave it, somewhat, to draw less attention to oneself in a society similarly changed.\n\n', false );
		MainView.outputText( 'Stand before the chest, and ask for \'Retribution\' or \'Carnality\'.  The last of my magic, imbued therein, will do the rest.\n\n', false );
		MainView.outputText( 'I dearly, sincerely hope with all my being that you are successful.  I name you the last Inquisitor of a defeated kingdom, and shed my power here.  If I am fortunate, I will live to see this land restored.  If not, it is worthy punishment for my hubris.\n\n', false );
		MainView.outputText( 'Marae bless.\n\n', false );
		MainView.outputText( '-Inquisitor Zathul</i>\n\n', false );
		MainView.outputText( 'You replace the scroll and look to the chest.   Will you say one of the key words?\n\n', false );
	...
	SymGear.prototype.dominikaSpellblade = function() {
		...
		if( (CoC.player.minoScore() >= 3 && CoC.player.faceType === AppearanceDefs.FACE_COW_MINOTAUR && CoC.player.gender === 1) || !CoC.player.isBiped() ) {
			MainView.outputText( 'You greet Dominika and make small talk, but as usual she seems distracted and the conversation is strained at best.  Drumming her fingers on the table and glancing outside her attention is constantly drawn away from you, and eventually she outright cuts the conversation off.  "<i>I need to go, I\'m afraid,</i>" she says quickly, and half-heartedly adds, "<i>It was nice talking to you.</i>"\n\n', false );
			MainView.outputText( 'She exits, leaving you at the table alone.  You shrug a little and finish your drink, before noticing that she left something behind.  It looks like a wrapped sword and, while you don\'t know why she\'d have such a thing, you figure you might as well give it back to her.  Hell, maybe she\'ll actually be worth a goddamn conversation afterwards.\n\n', false );
			MainView.outputText( 'You take the blade and head back out into the streets.  Off in the distance you can see her walking, and it takes a while to catch up with her.  Tapping her on the shoulder, you\'re preparing an explanation for yourself when she interrupts you with a surprisingly harsh "<i>What?</i>"\n\n', false );
			MainView.outputText( 'Holding up the sword, you mention that she left it behind and offer it back to her.  She glances at it before telling you to keep it and turning away.  Surprised, you offer again to be sure.\n\n', false );
			MainView.outputText( '"<i>I said fucking KEEP IT!</i>" she snaps suddenly, turning again.  "<i>Isn\'t it fucking CLEAR that I don\'t want to talk to you right now?</i>" She draws breath sharply from the sudden outburst, then closes her eyes, rubbing the bridge of her nose.  After a few seconds she more calmly states, "<i>While I apologize for snapping at you I am under a great deal of stress right now and would firmly prefer not to be bothered.  Thank you and good day.</i>"\n\n', false );
			MainView.outputText( 'She turns back around. You\'re not entirely certain, but you think you hear her speak again as she leaves.  "<i>And I don\'t want any help from you.</i>"\n\n', false );
			MainView.outputText( 'Well, whatever.  You unwrap the sword to look at it.  It\'s inscribed with strange symbols and patterns which you don\'t entirely recognize, but which seem to be familiar.  Something in the design suggests they are magical in nature.\n\n', false );
			MainView.outputText( 'You wrap it again.  A free sword is a free sword.  Or a free coin, as the case may be.', false );
			//(Player receives Spellblade);
		} else {
			MainView.outputText( '"<i>Ah, lovely.</i>"  The way Dominika\'s eyes curve makes it clear she\'s smiling as you approach.  "<i>I was hoping you\'d be here today.</i>"\n\n', false );
			MainView.outputText( 'She gestures to the bartender as you sit.  She\'s happy to see you and she\'s buying you alcohol? Today is a good day.  "<i>Been well, I trust?</i>" she opens casually.  "<i>Protecting your camp and your bottom?</i>"  You\'re fairly confident she\'s smirking at that line.  "<i>I wanted to thank you for your company of late,</i>" the occultist says, once your drink arrives and the small talk concludes.  "<i>It\'s been refreshing to talk with someone who\'s been interested in some degree of intellectualism.  And of course, it helps that you\'re able to... supply me with my unfortunate needs.</i>"  A light chuckle comes from behind her veil.\n\n', false );
