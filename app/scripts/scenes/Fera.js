...
angular.module( 'cocjs' ).run( function( SceneLib, PerkLib, OnLoadVariables, AppearanceDefs, kFLAGS, CoC, EngineCore ) {
	...
	Fera.prototype.fuckDemCorruptFlowerLips = function() {
		...
		if( CoC.player.balls > 0 ) {
			...
			EngineCore.outputText( 'loins against the cushy, sap-slicked lips, compressing their hot, smooth surfaces against your ' + CoC.player.skin() + '.  You\'re not really sure if sap is the appropriate name for such a substance, but you\'re far beyond caring at this point.' );
		}
	...
	Fera.prototype.dickBoostingFuntimes = function() {
		...
		EngineCore.outputText( ' as you do, whispering, "<i>Good ' + CoC.player.mf( 'boy', 'girl' ) + ',</i>" into your ears as dark energies flow into you, refilling your fast-emptying reservoirs faster than they can empty.  "<i>Don\'t stop yet, [name].  You\'re going to be doing this a lot, so I\'m giving you lots of practice.</i>"' );
	...
	Fera.prototype.tightLikeAToigar = function() {
		...
		if( CoC.player.skinAdj === 'latex' || CoC.player.skinAdj === 'rubber' ) {
			EngineCore.outputText( ', not that a ' + CoC.player.skinAdj + ' honey like you would notice' );
		}
