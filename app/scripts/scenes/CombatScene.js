...
angular.module('cocjs').run( function (Combat, SceneLib, $log, CoC, StatusAffects, kFLAGS, Utils, EngineCore, ItemType, MainView, PerkLib, Descriptors, ConsumableLib, WeaponLib, ArmorLib, OnLoadVariables, AppearanceDefs, ImageManager) {
	function CombatScene() {}
	CombatScene.prototype.endHpVictory = function() {
		CoC.monster.defeated_(true);
	};
	CombatScene.prototype.endLustVictory = function() {
		CoC.monster.defeated_(false);
	};
	CombatScene.prototype.endHpLoss = function() {
		CoC.monster.won_(true, false);
	};
	CombatScene.prototype.endLustLoss = function() {
	...
	CombatScene.prototype.cleanupAfterCombat = function(nextObj, nextFunc) {
		if(nextObj && (!nextFunc || !_.isFunction(nextFunc))) {
			$log.error('cleanupAfterCombat called with invalid parameters', nextObj, nextFunc);
			return;
		}
		if (!nextFunc) {
	...
	CombatScene.prototype.approachAfterKnockback = function() {
	...
	CombatScene.prototype.combatMenu = function(newRound) { //If returning from a sub menu set newRound to false
		...
		if (newRound) {
			this.combatStatusesUpdate(); //Update Combat Statuses
		}
		this.display();
		MainView.statsView.show();
		...
		var magic = (Combat.canUseMagic() ? this.magicMenu : null);
		...
		if (CoC.player.findStatusAffect(StatusAffects.KnockedBack)) {
			...
			EngineCore.addButton(0, "Approach", this, this.approachAfterKnockback);
			EngineCore.addButtonWithTooltip(1, "Tease", 'Attempt to make an enemy more aroused by striking a seductive pose and exposing parts of your body.', this, this.teaseAttack);
			EngineCore.addButtonWithTooltip(2, "Spells", 'Opens your spells menu, where you can cast any spells you have learned.  Beware, casting spells increases your fatigue, and if you become exhausted you will be easier to defeat.', this, magic);
			EngineCore.addButtonWithTooltip(3, "Items", SceneLib.inventory, SceneLib.inventory.inventoryMenu);
			EngineCore.addButton(4, "Run", 'Choosing to run will let you try to escape from your enemy. However, it will be hard to escape enemies that are faster than you and if you fail, your enemy will get a free attack.', this, this.runAway);
			if (CoC.player.hasKeyItem("Bow") >= 0) {
				EngineCore.addButton(5, "Bow", this, this.fireBow);
			}
			EngineCore.addButtonWithTooltip(6, "M. Specials", 'Mental and supernatural special attack menu.', this, this.magicalSpecials);
			EngineCore.addButtonWithTooltip(7, "Wait", 'Take no action for this round.  Why would you do this?  This is a terrible idea.', this, this.wait);
			EngineCore.addButtonWithTooltip(8, "Fantasize", 'Fantasize about your opponent in a sexual way.  It\'s probably a pretty bad idea to do this unless you want to end up getting raped.', this, this.fantasize);
			...
			EngineCore.addButton(0, "Recover", this, this.wait);
			...
			EngineCore.addButton(0, "Struggle", this, this.struggle);
			EngineCore.addButtonWithTooltip(5, "Wait", 'Take no action for this round.  Why would you do this?  This is a terrible idea.', this, this.wait);
			...
			EngineCore.addButtonWithTooltip(0, "Attack", 'Attempt to attack the enemy with your ' + CoC.player.weaponName + '.  Damage done is determined by your strength and weapon.', this, attacks);
			EngineCore.addButtonWithTooltip(1, "Tease", 'Attempt to make an enemy more aroused by striking a seductive pose and exposing parts of your body.', this, this.teaseAttack);
			EngineCore.addButtonWithTooltip(2, "Spells", 'Opens your spells menu, where you can cast any spells you have learned.  Beware, casting spells increases your fatigue, and if you become exhausted you will be easier to defeat.', this, magic);
			EngineCore.addButton(3, "Items", SceneLib.inventory, SceneLib.inventory.inventoryMenu);
			EngineCore.addButtonWithTooltip(4, "Run", 'Choosing to run will let you try to escape from your enemy. However, it will be hard to escape enemies that are faster than you and if you fail, your enemy will get a free attack.', this, this.runAway);
			EngineCore.addButtonWithTooltip(5, "P. Specials", 'Physical special attack menu.', this, pSpecials);
			EngineCore.addButtonWithTooltip(6, "M. Specials", 'Mental and supernatural special attack menu.', this, this.magicalSpecials);
			EngineCore.addButtonWithTooltip(7, (CoC.monster.findStatusAffect(StatusAffects.Level) ? "Climb" : "Wait"), CoC.monster.findStatusAffect(StatusAffects.Level) ?'':'Take no action for this round.  Why would you do this?  This is a terrible idea.', this, this.wait);
			EngineCore.addButtonWithTooltip(8, "Fantasize", 'Fantasize about your opponent in a sexual way.  It\'s probably a pretty bad idea to do this unless you want to end up getting raped.', this, this.fantasize);
		}
	};
	CombatScene.prototype.teaseAttack = function() {
	...
	CombatScene.prototype.normalAttack = function() {
		MainView.clearOutput();
		this.attack();
	};
	CombatScene.prototype.packAttack = function() {
		if ( Combat.combatMiss() ) { //Determine if dodged!
		...
		} else if (Combat.combatEvade()) { //Determine if evaded
	...
	CombatScene.prototype.lustAttack = function() {
	...
	//Private
	CombatScene.prototype.wait = function() {
		...
		if (CoC.monster.findStatusAffect(StatusAffects.PCTailTangle)) {
			...
			damage = CoC.player.takeDamage(0.35 * CoC.player.maxHP());
	...
	//Private
	CombatScene.prototype.struggle = function() {
		if (CoC.monster.findStatusAffect(StatusAffects.MinotaurEntangled)) {
			...
			if (Utils.rand(3) === 0 || Utils.rand(80) < CoC.player.str) {
				...
				MainView.outputText("You writhe uselessly, trapped inside the goo girl's warm, seething body. Darkness creeps at the edge of your vision as you are lulled into surrendering by the rippling vibrations of the girl's pulsing body around yours.");
				MainView.outputText(" (" + CoC.player.takeDamage(0.15 * CoC.player.maxHP()) + ")", false);
			}
			this.combatRoundOver();
		} else if (CoC.player.findStatusAffect(StatusAffects.HarpyBind)) {
			...
			if (Utils.rand(3) === 0 || Utils.rand(80) < CoC.player.str / 1.5) {
				...
				CoC.player.takeDamage(7 + Utils.rand(5));
			}
			this.combatRoundOver();
		} else {
			MainView.clearOutput();
	...
	CombatScene.prototype.fireBow = function() {
		...
		if (CoC.monster.HP <= 0) {
			EngineCore.doNext( this, this.endHpVictory);
		}
		CoC.monster.lust -= 20;
	...
	//Unused?
	CombatScene.prototype.fireBreathMenu = function() {
		MainView.clearOutput();
		MainView.outputText("Which of your special fire-breath attacks would you like to use?");
		EngineCore.choices("Akbal's", this, this.fireballuuuuu, "Hellfire", this, this.hellFire, "Dragonfire", this, this.dragonBreath, "", null, null, "Back", null, MainView.playerMenu);
	};
	//Private
	CombatScene.prototype.fantasize = function() {
		var temp2 = 0;
		EngineCore.doNext( this, this.combatMenu);
		...
		if(CoC.player.lust > 99) {
			if(CoC.monster.short === "pod") {
				...
				EngineCore.doNext( this, this.endLustLoss);
				return;
			}
		}
		CoC.monster.doAI();
	...
	//Private
	CombatScene.prototype.bite = function() {
		if(CoC.player.fatigue + EngineCore.physicalCost(25) > 100) {
		...
		if(CoC.monster.HP > 0 && CoC.monster.lust < 100) {
			...
			if(CoC.monster.HP <= 0) {
				...
				EngineCore.doNext( this, this.endLustVictory);
			}
		}
	};
	//ATTACK
	...
	//Private
	CombatScene.prototype.goreAttack = function() {
		MainView.clearOutput();
		if (CoC.monster.short === "worms") {
	...
	CombatScene.prototype.finishCombat = function() {
	...
	//Private
	CombatScene.prototype.dropItem = function(monster) {
	...
	CombatScene.prototype.awardPlayer = function() {
	...
	//Private
	CombatScene.prototype.combatStatusesUpdate = function() {
		//Reset menuloc
		EngineCore.hideUpDown();
		...
		if(CoC.player.findStatusAffect(StatusAffects.IzmaBleed)) {
			if(CoC.player.statusAffectv1(StatusAffects.IzmaBleed) <= 0) {
				...
				bleed *= CoC.player.HP;
				bleed = CoC.player.takeDamage(bleed);
		...
		if(CoC.player.findStatusAffect(StatusAffects.Poison)) {
			...
			if(CoC.player.findPerk(PerkLib.Medicine) && Utils.rand(100) <= 14) {
				...
				CoC.player.takeDamage( 8 + Utils.rand(CoC.player.maxHP()/20));
			}
		}
		...
		if(CoC.player.lust >= 100) {
			...
			EngineCore.doNext( this, this.endHpLoss);
		}
	};
	CombatScene.prototype.startCombat = function(monster,plotFight) {
	...
	//Private
	CombatScene.prototype.display = function() {
	...
	//Private
	CombatScene.prototype.showMonsterLust = function() {
		//Entrapped
	...
	CombatScene.prototype.teaseText = function() {
		this.tease(true);
		return "";
	};
	...
	CombatScene.prototype.tease = function(justText) {
		if (!justText) {
			MainView.outputText("", true);
		}
	...
	CombatScene.prototype.teaseXP = function(XP) {
		if(XP === undefined) {
			XP = 0;
		}
		while(XP > 0) {
	...
	//VICTORY OR DEATH?
	CombatScene.prototype.combatRoundOver = function() { //Called after the monster's action
		MainView.statsView.show();
		if (!CoC.isInCombat()) {
			return false;
		}
	...
	CombatScene.prototype.magicMenu = function() {
		...
		if (CoC.player.lust >= whiteLustCap) {
			...
			if (CoC.player.findStatusAffect(StatusAffects.KnowsCharge)) {
				if (!CoC.player.findStatusAffect(StatusAffects.ChargeWeapon)) {
					EngineCore.addButtonWithTooltip(0, "Charge W.", 'The Charge Weapon spell will surround your weapon in electrical energy, causing it to do even more damage.  The effect lasts for the entire combat.  (Fatigue Cost: ' + EngineCore.spellCost( 15 ) + ')', this, this.spellChargeWeapon);
				} else {
			...
			if (CoC.player.findStatusAffect(StatusAffects.KnowsBlind)) {
				if (!CoC.monster.findStatusAffect(StatusAffects.Blind)) {
					EngineCore.addButtonWithTooltip(1, "Blind", 'Blind is a fairly self-explanatory spell.  It will create a bright flash just in front of the victim\'s eyes, blinding them for a time.  However if they blink it will be wasted.  (Fatigue Cost: ' + EngineCore.spellCost( 20 ) + ')', this, this.spellBlind);
				} else {
			...
			if (CoC.player.findStatusAffect(StatusAffects.KnowsWhitefire)) {
				EngineCore.addButtonWithTooltip(2, "Whitefire", 'Whitefire is a potent fire based attack that will burn your foe with flickering white flames, ignoring their physical toughness and most armors.  (Fatigue Cost: ' + EngineCore.spellCost( 30 ) + ')', this, this.spellWhitefire);
			}
		}
		//BLACK MAGICSKS
		if (CoC.player.lust < 50) {
			...
			if (CoC.player.findStatusAffect(StatusAffects.KnowsArouse)) {
				EngineCore.addButtonWithTooltip(5, "Arouse", 'The arouse spell draws on your own inner lust in order to enflame the enemy\'s passions.  (Fatigue Cost: ' + EngineCore.spellCost( 15 ) + ')', this, this.spellArouse);
			}
			if (CoC.player.findStatusAffect(StatusAffects.KnowsHeal)) {
				EngineCore.addButtonWithTooltip(6, "Heal", 'Heal will attempt to use black magic to close your wounds and restore your body, however like all black magic used on yourself, it has a chance of backfiring and greatly arousing you.  (Fatigue Cost: ' + EngineCore.spellCost( 20 ) + ')', this, this.spellHeal);
			}
			if (CoC.player.findStatusAffect(StatusAffects.KnowsMight)) {
				if (!CoC.player.findStatusAffect(StatusAffects.Might)) {
					EngineCore.addButtonWithTooltip(7, "Might", 'The Might spell draws upon your lust and uses it to fuel a temporary increase in muscle size and power.  It does carry the risk of backfiring and raising lust, like all black magic used on oneself.  (Fatigue Cost: ' + EngineCore.spellCost( 25 ) + ')', this, this.spellMight);
				} else {
		...
		if (CoC.player.findPerk(PerkLib.CleansingPalm) && CoC.player.cor < 10) {
			EngineCore.addButton(3, "C.Palm", this, this.spellCleansingPalm);
		}
		EngineCore.addButton(9, "Back", this, this.combatMenu, false);
	};
	CombatScene.prototype.spellArouse = function() {
		if(!CoC.player.findPerk(PerkLib.BloodMage) && CoC.player.fatigue + EngineCore.spellCost(15) > 100) {
			...
			EngineCore.doNext( this, this.magicMenu);
			return;
		}
		EngineCore.doNext( this, this.combatMenu);
	...
	CombatScene.prototype.spellHeal = function() {
	...
	CombatScene.prototype.spellMight = function() {
	...
	CombatScene.prototype.spellChargeWeapon = function() {
		if(!CoC.player.findPerk(PerkLib.BloodMage) && CoC.player.fatigue + EngineCore.spellCost(15) > 100) {
			MainView.outputText("You are too tired to cast this spell.", true);
			EngineCore.doNext( this, this.magicMenu);
			return;
	...
	CombatScene.prototype.spellBlind = function() {
		MainView.outputText("", true);
		if(!CoC.player.findPerk(PerkLib.BloodMage) && CoC.player.fatigue + EngineCore.spellCost(20) > 100) {
			MainView.outputText("You are too tired to cast this spell.", true);
			EngineCore.doNext( this, this.magicMenu);
	...
	CombatScene.prototype.spellWhitefire = function() {
		MainView.outputText("", true);
	...
	CombatScene.prototype.spellCleansingPalm = function() {
		MainView.clearOutput();
		if (!CoC.player.findPerk(PerkLib.BloodMage) && CoC.player.fatigue + EngineCore.spellCost(30) > 100) {
			MainView.outputText("You are too tired to cast this spell.", true);
			EngineCore.doNext( this, this.magicMenu);
	...
	CombatScene.prototype.spellPerkUnlock = function() {
	...
	CombatScene.prototype.hellFire = function() {
		MainView.outputText("", true);
		if (!CoC.player.findPerk(PerkLib.BloodMage) && CoC.player.fatigue + EngineCore.spellCost(20) > 100) {
	...
	CombatScene.prototype.kick = function() {
		MainView.outputText("", true);
		if(CoC.player.fatigue + EngineCore.physicalCost(15) > 100) {
	...
	CombatScene.prototype.PCWebAttack = function() {
		MainView.outputText("", true);
		//Keep logic sane if this attack brings victory
		if(CoC.player.tailVenom < 33) {
	...
	CombatScene.prototype.nagaBiteAttack = function() {
		MainView.outputText("", true);
		//FATIIIIGUE
	...
	CombatScene.prototype.spiderBiteAttack = function() {
		MainView.outputText("", true);
		//FATIIIIGUE
		if(CoC.player.fatigue + EngineCore.physicalCost(10) > 100) {
			MainView.outputText("You just don't have the energy to bite something right now...", true);
	...
	//[Abilities]
	//Whisper 
	CombatScene.prototype.superWhisperAttack = function() {
		MainView.outputText("", true);
	...
	CombatScene.prototype.dragonBreath = function() {
		MainView.clearOutput();
		if (!CoC.player.findPerk(PerkLib.BloodMage) && CoC.player.fatigue + EngineCore.spellCost(20) > 100) {
	...
	//* Terrestrial Fire
	CombatScene.prototype.fireballuuuuu = function() {
		MainView.outputText("", true);
		...
		if( Utils.rand(5) === 0 || CoC.player.findStatusAffect(StatusAffects.WebSilence)) {
			...
			EngineCore.fatigue(10);
			CoC.player.takeDamage(10 + Utils.rand(20));
			CoC.monster.doAI();
			return;
		}
		if (CoC.monster.handleSpellResistance) {
	...
	CombatScene.prototype.kissAttack = function() {
		if(CoC.player.findStatusAffect(StatusAffects.Blind)) {
	...
	CombatScene.prototype.possess = function() {
		MainView.outputText("", true);
	...
	CombatScene.prototype.runAway = function(callHook) {
	...
	CombatScene.prototype.anemoneSting = function() {
		MainView.outputText("", true);
	...
	CombatScene.prototype.magicalSpecials = function() {
		...
		if(CoC.player.findPerk(PerkLib.Berzerker)) {
			EngineCore.addButtonWithTooltip(0, "Berzerk", 'Throw yourself into a rage!  Greatly increases the strength of your weapon and increases lust resistance, but your armor defense is reduced to zero!', this, this.berzerk);
		}
		if(CoC.player.findPerk(PerkLib.Dragonfire)) {
			EngineCore.addButton(1,"DragonFire", this, this.dragonBreath);
		}
		if(CoC.player.findPerk(PerkLib.FireLord)) {
			EngineCore.addButton(2,"Fire Breath", this, this.fireballuuuuu);
		}
		if(CoC.player.findPerk(PerkLib.Hellfire)) {
			EngineCore.addButton(3,"Hellfire", this, this.hellFire);
		}
		//Possess ability.
		if(CoC.player.findPerk(PerkLib.Incorporeality)) {
			EngineCore.addButtonWithTooltip(4,"Possess", 'Attempt to temporarily possess a foe and force them to raise their own lusts.', this, this.possess);
		}
		if(CoC.player.findPerk(PerkLib.Whispered)) {
			EngineCore.addButton(5,"Whisper", this, this.superWhisperAttack);
		}
		if(CoC.player.findPerk(PerkLib.CorruptedNinetails)) {
			EngineCore.addButton(6,"C.FoxFire", this, this.corruptedFoxFire);
			EngineCore.addButton(7,"Terror", this, this.kitsuneTerror);
		}
		if(CoC.player.findPerk(PerkLib.EnlightenedNinetails)) {
			EngineCore.addButton(6,"FoxFire", this, this.foxFire);
			EngineCore.addButton(7,"Illusion", this, this.kitsuneIllusion);
		}
		if(CoC.player.findStatusAffect(StatusAffects.ShieldingSpell)) {
			EngineCore.addButton(8,"Shielding", this, this.shieldingSpell);
		}
		if(CoC.player.findStatusAffect(StatusAffects.ImmolationSpell)) {
			EngineCore.addButton(8,"Immolation", this, this.immolationSpell);
		}
		EngineCore.addButton(9, "Back", this, this.combatMenu, false);
	};
	CombatScene.prototype.physicalSpecials = function() {
		if(SceneLib.urtaQuest.isUrta()) {
	...
	//Pass false to combatMenu instead:	menuLoc = 3;
		...
		if (CoC.player.hairType === 4) {
			EngineCore.addButtonWithTooltip(0, "AnemoneSting", 'Attempt to strike an opponent with the stinging tentacles growing from your scalp.  Reduces enemy speed and increases enemy lust.', this, this.anemoneSting);
		}
		//Bitez
		if (CoC.player.faceType === AppearanceDefs.FACE_SHARK_TEETH) {
			EngineCore.addButton(1, "Bite", this, this.bite);
		}
		else if (CoC.player.faceType === AppearanceDefs.FACE_SNAKE_FANGS) {
			EngineCore.addButton(1, "Bite", this, this.nagaBiteAttack);
		}
		else if (CoC.player.faceType === AppearanceDefs.FACE_SPIDER_FANGS) {
			EngineCore.addButton(1, "Bite", this, this.spiderBiteAttack);
		}
		//Bow attack
		if (CoC.player.hasKeyItem("Bow") >= 0) {
			EngineCore.addButton(2, "Bow", this, this.fireBow);
		}
		//Constrict
		...
		//Kick attackuuuu
			...
			EngineCore.addButtonWithTooltip(3, "Kick", 'Attempt to kick an enemy using your powerful lower body.', this, this.kick);
		}
		//Gore if mino horns
		if (CoC.player.hornType === AppearanceDefs.HORNS_COW_MINOTAUR && CoC.player.horns >= 6) {
			EngineCore.addButtonWithTooltip(4, "Gore", 'Lower your head and charge your opponent, attempting to gore them on your horns.  This attack is stronger and easier to land with large horns.', this, this.goreAttack);
		}
		//Infest if infested
		if (CoC.player.findStatusAffect(StatusAffects.Infested) && CoC.player.statusAffectv1(StatusAffects.Infested) === 5 && CoC.player.hasCock()) {
			EngineCore.addButtonWithTooltip(5, "Infest", 'The infest attack allows you to cum at will, launching a stream of semen and worms at your opponent in order to infest them.  Unless your foe is very aroused they are likely to simply avoid it.  Only works on males or herms.', SceneLib.worms, SceneLib.worms.playerInfest);
		}
		//Kiss supercedes bite.
		if (CoC.player.findStatusAffect(StatusAffects.LustStickApplied)) {
			EngineCore.addButtonWithTooltip(6, "Kiss", 'Attempt to kiss your foe on the lips with drugged lipstick.  It has no effect on those without a penis.', this, this.kissAttack);
		}
		switch (CoC.player.tailType) {
			case AppearanceDefs.TAIL_TYPE_BEE_ABDOMEN:
				EngineCore.addButtonWithTooltip(7, "Sting", 'Attempt to use your venomous bee stinger on an enemy.  Be aware it takes quite a while for your venom to build up, so depending on your abdomen\'s refractory period, you may have to wait quite a while between stings.  Venom: ' + Math.floor( CoC.player.tailVenom ) + '/100', this, this.playerStinger);
				break;
			case AppearanceDefs.TAIL_TYPE_SPIDER_ADBOMEN:
				EngineCore.addButtonWithTooltip(7, "Web", 'Attempt to use your abdomen to spray sticky webs at an enemy and greatly slow them down.  Be aware it takes a while for your webbing to build up.  Web Amount: ' + Math.floor( CoC.player.tailVenom ) + '/100', this, this.PCWebAttack);
				break;
			...
			case AppearanceDefs.TAIL_TYPE_RACCOON:
				EngineCore.addButtonWithTooltip(7, 'Tail Whip', 'Whip your foe with your tail to enrage them and lower their defense!', this, this.tailWhipAttack);
		}
		EngineCore.addButton(9, "Back", this, this.combatMenu, false);
	};
	CombatScene.prototype.berzerk = function() {
		MainView.clearOutput();
		if(CoC.player.findStatusAffect(StatusAffects.Berzerking)) {
			MainView.outputText("You're already pretty goddamn mad!", true);
			EngineCore.doNext( this, this.magicalSpecials);
			return;
		}
	...
	//Corrupted Fox Fire
	CombatScene.prototype.corruptedFoxFire = function() {
		MainView.clearOutput();
	...
	//Fox Fire
	CombatScene.prototype.foxFire = function() {
		MainView.clearOutput();
		if(!CoC.player.findPerk(PerkLib.BloodMage) && CoC.player.fatigue + EngineCore.spellCost(35) > 100) {
			MainView.outputText("You are too tired to use this ability.", true);
			EngineCore.doNext( this, this.magicalSpecials);
	...
	//Terror
	CombatScene.prototype.kitsuneTerror = function() {
		MainView.clearOutput();
		//Fatigue Cost: 25
		if(!CoC.player.findPerk(PerkLib.BloodMage) && CoC.player.fatigue + EngineCore.spellCost(20) > 100) {
			MainView.outputText("You are too tired to use this ability.", true);
	...
	//Illusion
	CombatScene.prototype.kitsuneIllusion = function() {
		MainView.clearOutput();
		//Fatigue Cost: 25
		if(!CoC.player.findPerk(PerkLib.BloodMage) && CoC.player.fatigue + EngineCore.spellCost(25) > 100) {
			MainView.outputText("You are too tired to use this ability.", true);
	...
	//hit
	CombatScene.prototype.tailWhipAttack = function() {
		MainView.clearOutput();
		//miss
		if((CoC.player.findStatusAffect(StatusAffects.Blind) && Utils.rand(2) === 0) || (CoC.monster.spe - CoC.player.spe > 0 && Utils.rand(((CoC.monster.spe-CoC.player.spe)/4)+80) > 80)) {
	...
	CombatScene.prototype.immolationSpell = function() {
		MainView.clearOutput();
	...
	CombatScene.prototype.shieldingSpell = function() {
		MainView.clearOutput();
	...
	SceneLib.registerScene('combatScene', new CombatScene());
	MainView.registerCombatMenu( SceneLib.combatScene.combatMenu );
});
