...
angular.module( 'cocjs' ).run( function( OnLoadVariables, ConsumableLib, AppearanceDefs, ArmorLib, StatusAffects, EventParser, Descriptors, kFLAGS, Utils, PerkLib, CoC, EngineCore ) {
	function XmasBitch() {
	}
	...
	XmasBitch.prototype.xmasBitchEncounter = function() {
		...
		if( CoC.getInstance().flags[ kFLAGS.PC_ENCOUNTERED_CHRISTMAS_ELF_BEFORE ] > 0 ) {
			...
			EngineCore.outputText( 'She giggles, "<i>Oh silly, that would spoil the surprise, wouldn\'t it?  We\'ve got EVERYONE on our list, even ' );
			if( CoC.getInstance().flags[ kFLAGS.KELT_BREAK_LEVEL ] < 4 ) {
				EngineCore.outputText( 'Kelt, though he\'s getting coal AGAIN' );
			} else {
				EngineCore.outputText( 'Kelly, though I think she\'s getting another big fat dildo' );
			}
	...
	XmasBitch.prototype.openXmasPresent = function() {
		EngineCore.spriteSelect( 9 );
		EngineCore.outputText( '', true );
		EngineCore.outputText( 'You easily rip through the ribbons holding the box together and pull off the top.   You gasp in ', false );
		if( CoC.getInstance().player.cor >= 90 || CoC.getInstance().scenes.jojoScene.monk >= 5 || CoC.getInstance().player.findStatusAffect( StatusAffects.Exgartuan ) >= 0 || CoC.getInstance().scenes.amilyScene.amilyCorrupt() || CoC.getInstance().flags[ kFLAGS.UNKNOWN_FLAG_NUMBER_00283 ] > 0 || CoC.getInstance().flags[ kFLAGS.UNKNOWN_FLAG_NUMBER_00282 ] > 0 || CoC.getInstance().flags[ kFLAGS.NIAMH_STATUS ] > 0 ) {
			//[Bad Present];
	...
	XmasBitch.prototype.unwrapElfyPresent = function() {
		EngineCore.spriteSelect( 9 );
		EngineCore.outputText( '', true );
		EngineCore.outputText( 'The elf tosses the present to the side and saunters up to you, her hips swaying sensually.  She ', false );
		if( CoC.getInstance().player.tallness > 60 ) {
			EngineCore.outputText( 'reaches up and presses herself against you seductively, caressing your body.', false );
		} else {
			EngineCore.outputText( 'cuddles up alongside, happy to have someone of similar stature to seduce.', false );
		}
		...
		if( CoC.getInstance().player.spe < 25 ) {
			EngineCore.outputText( 'clumsily ', false );
		} else {
	...
	XmasBitch.prototype.dickXmasElfGo = function() {
		//(Dickfuck);
		if( CoC.getInstance().player.cockArea( 0 ) < 80 ) {
			EngineCore.outputText( 'She pushes you down onto your bedroll and whispers, "<i>Time to enjoy your present.</i>"\n\n', false );
			EngineCore.outputText( 'She mounts you without pretense, straddling and inserting your ' + Descriptors.cockDescript( 0 ) + ' in one smooth motion.  The sudden change from cool, night air to hot, tight pussy sends shockwaves of pleasure into your skull.  You master yourself before your eyes roll the whole way back and close your mouth before you start drooling.   Her vise-like tightness is inhuman, but somehow not so tight as to be uncomfortable.   The internal muscles clench and squeeze around you with an uncommon degree of control.  She\'s so hot, wet, and tight that you shiver.  You start rocking underneath her, giving in completely to the pleasure of her hole.\n\n', false );
			EngineCore.outputText( 'You grunt, pistoning into her over and over.  She clears her throat as she\'s bouncing atop of you, and you look back up, suddenly reminded that there\'s more to the world than the cunt milking your ' + Descriptors.cockDescript( 0 ) + '.  The elf explains, "<i>Don\'t be ashamed.  We elves have magical cunts.  Once something is inside it\'ll feel so good that it never wants to leave.  Judging from the look on your face I don\'t think you ever want to leave, do you?  I\'m the best present you\'ve ever had, aren\'t I?  Go ahead, cum for me, show me what a great gift I am.</i>"\n\n', false );
			EngineCore.outputText( 'She\'s absolutely right – there\'s some indescribably pleasurable thing about the heat radiating into your dick that makes it feel like it\'s about to melt and pass into heaven.  The elf giggles and the vibrations of her laugh somehow radiate into you, and it\'s just too much.  You cum for your present, submitting to her pleasure as your spooge boils up into her.   It squelches wetly as it pumps into her, sounding absolutely perverse.', false );
			if( CoC.getInstance().player.cumQ() >= 250 ) {
				EngineCore.outputText( '  The spunk quickly fills her womb and flows back out her entrance, frothing and bubbling as it drips over your ' + Descriptors.hipDescript() + '.  ', false );
			}
			if( CoC.getInstance().player.cumQ() >= 1000 ) {
				EngineCore.outputText( '  It begins to splatter everywhere as you pour out more and more, the elf looking on with amusement as her cunt turns into a cum-spraying fountain.  ', false );
			}
			EngineCore.outputText( '\n\n', false );
			EngineCore.outputText( 'Once your orgasm ends the elf begins gyrating her hips again, her pussy frothing and dripping a mixed batch of creamy cum.   You don\'t go soft.  If anything you get even harder and more sensitive.  Brain blasting pressure squeezes up your rod from the elf\'s cunt as she starts bouncing again, fucking you in earnest, "<i>I told you my cunt was magical.  You\'ll never go soft inside me – your cum fuels my magic and makes you feel even better.</i>"\n\n', false );
			EngineCore.outputText( 'Aside from your ' + Descriptors.cockDescript( 0 ) + ', your body has gone completely numb from the waist down.  You glance down and see your ' + CoC.getInstance().player.legs() + ' twitching and convulsing under the elf\'s assault.   She\'s so hot inside, it\'s like her pussy\'s candy-coated in liquid pleasure.   You fuck her harder and harder, squeezing her hips tightly and roughly fucking her magical pussy.   Somehow you\'re on the edge again, about to unload.  You start counting in your head, trying to resist another orgasm.  You know if you do you\'ll never be able stop.  You doubt you\'ll even be able to think.\n\n', false );
			EngineCore.outputText( 'Your effort at holding out totally fails – you start counting in time with each thrust, tying the numbers into the feel of the velvet cock-sleeve as it massages your ' + Descriptors.cockDescript( 0 ) + '.   The elf smiles condescendingly and taunts, "<i>I can see you\'ve already lost the ability to resist the pleasure.  Just give in, and enjoy the night.  I\'ll be riding you \'til morning.</i>"\n\n', false );
			EngineCore.outputText( 'It\'s too hot, oh gods it\'s too hot.  You cum again, splattering her womb with more seed.  The elf\'s skin flushes as you pump more into her, squirting more and more into her overfull entrance.  Miraculously, you cum just as much as before, ', false );
			if( CoC.getInstance().player.cumQ() >= 250 ) {
				EngineCore.outputText( 'dumping out more and more waves of jizm until you\'re lying in a deep puddle of it, ', false );
			}
			...
			EngineCore.outputText( 'The elf looks over her shoulder and laughs, "<i>Someone is feeling a bit naughty.  Well, I guess I\'ll have to help you drain out all that naughty energy.</i>"\n\n', false );
			EngineCore.outputText( 'Before you can puzzle out her meaning, she takes a big gulp of air, grabs your ' + CoC.getInstance().player.cockHead() + ' with both hands, and presses her lips into your urethra.  She blows into it with a look of intense concentration.  You can feel your urethra filling, expanding with something, but it feels more like liquid than air, tingling as it slides deep into your shaft towards your ', false );
			...
			EngineCore.outputText( 'The magic-using elf pulls back with a knowing grin and resumes stroking you, ignoring a dribble of pink fluid that squirts from your tip.   The warmth inside builds higher and you start sweating, even in the cool night air. The uncomfortable heat churns inside you', false );
			if( CoC.getInstance().player.balls > 0 ) {
				EngineCore.outputText( 'r ' + Descriptors.ballsDescriptLight(), false );
			}
			EngineCore.outputText( ', a gentle pressure that builds higher and higher until you feel about to explode.  You need to cum, and you squirm in the elf\'s grasp, trembling and shuddering as one of her hands slips over a particularly sensitive spot. A bead of pre-cum rolls out of your ' + CoC.getInstance().player.cockHead() + ' and starts sliding down the shaft, followed by another, and another, and another.\n\n', false );
			EngineCore.outputText( 'Your \'present\' asks with gradually rising authority, "<i>Do you feel the naughtyness leaking out?  It feels good doesn\'t it?  Yes it does, but that\'s just the start.  You\'ve got a lot of pent up naughty that needs to come out so you\'ll be good and see me next year.  So be a good boy and cum out all those bad thoughts for me please.</i>"\n\n', false );
			EngineCore.outputText( 'She flips around to the far side of your dick and hugs it tightly, squeezing it from base to tip in a fluid motion makes your abdominals clench with unexpected orgasm.   The first \'squirt\' of cum is more like a geyser going off.  ', false );
			if( CoC.getInstance().player.cumQ() < 500 ) {
				EngineCore.outputText( 'You recoil from shooting out so much – it\'s far and away more than you\'re normally capable of.  ', false );
			}
			EngineCore.outputText( 'The elf hugs it and squeezes tightly while whispering, "<i>Naughty naughty.</i>"\n\n', false );
			EngineCore.outputText( 'Thick ropes of your orgasmic goop splatter into her hair, and each successive blast comes out with less and less force, until you\'re leaking a steady stream of cum that rolls down your ' + Descriptors.cockDescript( 0 ) + ' and soaks the pointy-eared woman completely.   As you release your prodigious load the scent of cinnamon fills the air, and you dumbly wonder if it\'s some side effect of the magic she used on you.  Regardless, cum keeps leaking out over the elf and onto you, and you eventually lose consciousness from perpetual orgasm.', false );
		}
	...
	XmasBitch.prototype.xmasFuckFollowup = function() {
		...
		EngineCore.outputText( '', true );
		EngineCore.outputText( 'You awaken in the morning, sore and exhausted, but more satisfied than you\'ve ever felt before.  Your body feels INCREDIBLY sensitive from head to toe, but particularly on your well-used ' + Descriptors.cockDescript( 0 ) + '.  In spite of the traumatic lovemaking, you feel remarkably clear-headed.\n\n', false );
		EngineCore.outputText( 'Did you enjoy being able to cum so much' );
		if( CoC.getInstance().player.findPerk( PerkLib.ElvenBounty ) >= 0 ) {
			EngineCore.outputText( ' <b>again</b>' );
		}
		...
		if( CoC.getInstance().player.sens + 20 > 80 ) {
	...
	XmasBitch.prototype.xmasPerkM = function() {
		if( CoC.getInstance().player.findPerk( PerkLib.ElvenBounty ) < 0 ) {
			if( XMAS_BITCH_STATUS === 1001 ) {
				CoC.getInstance().player.createPerk( PerkLib.ElvenBounty, 250, 0, 0, 0 );
			} else {
			...
			if( XMAS_BITCH_STATUS === 1001 ) {
				CoC.getInstance().player.addPerkValue( PerkLib.ElvenBounty, 1, 250 );
				EngineCore.outputText( '<b> - +250mL cum production!</b>' );
			} else {
				CoC.getInstance().player.addPerkValue( PerkLib.ElvenBounty, 2, 15 );
	...
	CoC.getInstance().registerScene( 'xmasBitch', new XmasBitch() );
} );