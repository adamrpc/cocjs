...
angular.module( 'cocjs' ).run( function( SceneLib, OnLoadVariables, ConsumableLib, AppearanceDefs, ArmorLib, StatusAffects, EventParser, Descriptors, kFLAGS, Utils, PerkLib, CoC, EngineCore ) {
	...
	XmasBitch.prototype.xmasBitchEncounter = function() {
		...
		EngineCore.outputText( 'The elf says, "<i>Hiya ' + CoC.player.short + '!  I brought you a' );
		if( CoC.flags[ kFLAGS.PC_ENCOUNTERED_CHRISTMAS_ELF_BEFORE ] > 0 ) {
	...
	XmasBitch.prototype.dickXmasElfGo = function() {
		...
		if( CoC.player.cockArea( 0 ) < 80 ) {
			...
			EngineCore.outputText( 'Aside from your ' + Descriptors.cockDescript( 0 ) + ', your body has gone completely numb from the waist down.  You glance down and see your ' + CoC.player.legs() + ' twitching and convulsing under the elf\'s assault.   She\'s so hot inside, it\'s like her pussy\'s candy-coated in liquid pleasure.   You fuck her harder and harder, squeezing her hips tightly and roughly fucking her magical pussy.   Somehow you\'re on the edge again, about to unload.  You start counting in your head, trying to resist another orgasm.  You know if you do you\'ll never be able stop.  You doubt you\'ll even be able to think.\n\n', false );
			...
			EngineCore.outputText( 'Before you can puzzle out her meaning, she takes a big gulp of air, grabs your ' + CoC.player.cockHead() + ' with both hands, and presses her lips into your urethra.  She blows into it with a look of intense concentration.  You can feel your urethra filling, expanding with something, but it feels more like liquid than air, tingling as it slides deep into your shaft towards your ', false );
