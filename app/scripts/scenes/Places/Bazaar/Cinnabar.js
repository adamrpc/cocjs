...
angular.module( 'cocjs' ).run( function( SceneLib, MainView, Descriptors, CoC, kFLAGS, Utils, EngineCore ) {
	...
	Cinnabar.prototype.cinnabarGreeting = function() {
		...
		if( CoC.flags[ kFLAGS.CINNABAR_NUMBER_ENCOUNTERS ] === 0 ) {
			...
			//(Big enough Cock) ;
				...
				if( CoC.player.cockTotal() > 1 && CoC.player.biggestCockArea2() >= 75 ) {
					MainView.outputText( 'those things', false );
				} else {
					MainView.outputText( 'that thing', false );
				}
				MainView.outputText( ' inside me... the name\'s Cinnabar, but I\'d rather you plug me and call me whatever you want.</i>"  Her voice trails off into a husky, barely heard vibration as she awaits your response.', false );
				//[Fuck] [Leave];
		...
		//Not first time;
			...
			//(Big enough Cock) ;
				...
				MainView.outputText( ' inside me... We could sit here and talk, but I\'d rather you plug me and call me your slut.</i>"  Her voice trails off into a husky, barely heard vibration as she awaits your response.', false );
				//[Fuck] [Leave];
				if( CoC.player.cockTotal() > 2 && CoC.player.biggestCockArea2() >= 75 ) {
					EngineCore.choices( 'Fuck Her', this, this.cinnabarGetsFUKKKKED, 'Multi-Fuck', this, this.cinnabarMultiCockPortalFuckFest, '', null, null, '', null, null, 'Leave', SceneLib.bazaar, SceneLib.bazaar.enterTheBazaar );
				} else {
	...
	Cinnabar.prototype.cinnabarNonHugeDickings = function() {
		...
		MainView.outputText( 'Once you give your assent, Cinnabar\'s paws dive into your ' + CoC.player.armorName + ', gliding over your ' + CoC.player.skinDesc + ' before re-emerging above your gem-pouch.  She deftly grabs her payment and snakes back through, tickling your belly with her soft, well-groomed fur.  You look at her, then yourself, then her again.  How the hell was she flexible enough to do that?  Cinnabar giggles and curls her tail around your ' + CoC.player.legs() + ', looping it like a long, flexible rope.  She hugs you and murmurs, "<i>Where will my ' + CoC.player.mf( 'master', 'mistress' ) + ' take ' + CoC.player.mf( 'his', 'her' ) + ' slutty, fuck-hungry companion?</i>"  Her tongue flicks your ear like a snake tasting its prey, and though her attitude sounds submissive and weak, your horny \'companion\' is clearly hiding a fiery, aggressive streak.\n\n', false );
		MainView.outputText( 'Before you can make an answer, Cinnabar\'s hands are back inside your ' + CoC.player.armorName + ', tugging your ' + Descriptors.nippleDescript( 0 ) + ' towards an unmarked wagon that\'s clearly her home.  You smirk and rub her between her legs, feeling the moistness of her sloppy cunt through her now-dampened dress.  Before she can tease you any more, you hook a finger up, pushing her dress into her hungry snatch.  It\'s easy to lead the giggling rat-whore like this, and when you reach the door she slides her tail into the lock, clicking it open with ease.\n\n', false );
		MainView.outputText( 'With surprising strength, she drags you inside, kicking the door shut.   She hurredly strips, struggling a little with the tight dress, and you take the cue to disrobe as well.  You get done first, just in time to notice she\'s stopped with the wet patch on her nose.  She\'s sniffing and tweaking a nipple, masturbating herself as if she\'s completely forgotten about you.  A crimson eye peeks through the upraised dress-slit, and you realize she\'s imploring you to take advantage.\n\n', false );
		MainView.outputText( 'You give the whore what she wants and pull the sodden dress from her, tweaking her nipple hard.  She moans and pulls you into her bed, which groans from the sudden onslaught of added weight.  As you lie atop her prone, exposed body, you realize the walls around her bed are plastered with dozens of spherical mirrors, all reflecting the nude flesh of your entwined bodies.  Your slut-for-an-hour grabs you by the hair and kisses you hard, her velvety-soft lips raping your mouth and burning with the heat of her lust.  She pulls you back and moans, "<i>' + CoC.player.mf( 'Master', 'Mistress' ) + ' has chosen well.  Now please, pinch this slut\'s nipples while she puts on a show for you.</i>"\n\n', false );
		MainView.outputText( 'Obligingly, you grab both her black, puffy nipples and twist them.  Her heart hammers in her chest, pumping hard enough for you to feel it beat through her abused, puffed-up teats.  She twists her body, writhing out from under you while somehow keeping her nipples in your fingers the entire time.  With an annoyed squeeze, you turn the tender nubs harder, smiling when they yield under the pressure and begin to corkscrew.  Cinnabar groans lustily, now on all fours, and smears her dripping gash against the wall behind her, her tits swaying lewdly in your grasp.\n\n', false );
		MainView.outputText( 'Cinnabar coos happily, in spite of the pain, and she begs, "<i>Please ' + CoC.player.mf( 'master', 'mistress' ) + ', look at the mirrors.  Your slut is trying to be good, but she needs to be filled so badly.</i>"  You turn to look, but hold on to her tortured tits, just in case.  Amazingly, a pair of the mirrors have changed.  They no longer reflect your own image back – they show her gaping, girlcum-dripping gash and twitching, black-skinned anus.  You can even smell her feral musk and feel the heat pouring from her horny genitalia hitting you in a wave.\n\n', false );
		MainView.outputText( 'Too shocked to keep your grip, you listen dumbly as Cinnabar groans, "<i>' + CoC.player.mf( 'Master', 'Mistress' ) + ' is pleased?  This one knows how to use portals for their intended purpose.  Watch slut make more sexy portals.</i>"  True to her words, many of the other mirrors change, showing both sets of nipples', false );
		if( !CoC.player.hasVagina() ) {
			MainView.outputText( ' and your ' + Descriptors.assholeDescript(), false );
		} else {
			MainView.outputText( ', your ' + Descriptors.vaginaDescript() + ', and your ' + Descriptors.assholeDescript(), false );
		}
		MainView.outputText( ' just inches away.  Without any prompting, you reach through to touch her arousal engorged lips, slipping fingertips through the needy gash and marveling at how large it feels.  You push forward, burying one, two, three, and finally four fingers inside her hungry nethers.\n\n', false );
		MainView.outputText( 'Cinnabar pants, "<i>Ungh... more.  Stuff this whore\'s cunt,</i>" all while she wiggles her backside against the mirror, clearly enjoying the attention.  You pull back to tease her, but the horny whore groans and reaches through another portal to ', false );
		if( CoC.player.hasVagina() ) {
			MainView.outputText( 'grab your ' + Descriptors.clitDescript() + ', rolling it between her thumb-pads with a hair too much pressure', false );
		} else {
			MainView.outputText( 'slip two digits into your ' + Descriptors.assholeDescript() + ', pulling it apart far enough to cause you discomfort', false );
		}
		MainView.outputText( '.  She wants to be penetrated?  Fine.  You ball your fingers and push forward.  Amazingly, you push through a gossamer curtain of femcum and bury your whole hand inside her cunt with ease.  Her silky-smooth walls tremble and squeeze, caressing your hand like a long-lost lover.\n\n', false );
		MainView.outputText( 'Satisfied with your display of power, her fingers ', false );
		if( CoC.player.hasVagina() ) {
			MainView.outputText( 'release their squeeze', false );
		} else {
			MainView.outputText( 'release the butt-stretching pressure', false );
		}
		MainView.outputText( ' and settle to the business of sliding back and forth, caressing you from the inside out.', false );
		//Finger poke;
		if( CoC.player.hasVagina() ) {
		...
		if( CoC.player.hasCock() && !CoC.player.hasVagina() ) {
			MainView.outputText( '  Unbidden, ' + Descriptors.sMultiCockDesc() + ' begins to harden, stiffening with every brush against your prostate.', false );
		} else if( CoC.player.hasVagina() ) {
			MainView.outputText( '  Femcum begins to soak the rat\'s practiced fingers, drenching her finger-pads with liquid lust.', false );
		}
		MainView.outputText( '  You rock back, slamming your ' + Descriptors.buttDescript() + ' against the wall and moaning with need.  She\'s quite skilled, and ', false );
		if( CoC.player.hasVagina() ) {
			MainView.outputText( 'caresses your passage in ways that ', false );
		} else {
			MainView.outputText( 'works your body in ways that ', false );
		}
		MainView.outputText( 'leave you panting like a bitch in heat.  She urges you on, practically begging, "<i>Yes!  Stuff my hole!  Fist me, ' + CoC.player.mf( 'master', 'mistress' ) + '; stretch me with your hand until I\'m too loose for a minotaur!  Please... please... fist my ass too.  Ruin my holes, ' + CoC.player.mf( 'master', 'mistress' ) + '!  Break fuck-toy\'s body!</i>"\n\n', false );
		MainView.outputText( 'You shrug and pull yourself up by the fist in her cunt, eliciting an agonized moan from your whore while you plunge your other hand into her clenching, squeezing asshole.  Her knees dig deep into the cushions, now supporting her own weight as well as yours, but the quickening pace of Cinnabar\'s ', false );
		if( CoC.player.vaginalCapacity() < 30 ) {
			MainView.outputText( 'fingers', false );
		} else {
			MainView.outputText( 'fingers - no, fist', false );
		}
		MainView.outputText( ' tells you just how much she likes it.  ', false );
		//CUNTZ;
		if( CoC.player.hasVagina() ) {
			MainView.outputText( 'She even works ', false );
			if( CoC.player.analCapacity() < 30 ) {
				MainView.outputText( 'her fingers', false );
			} else {
				MainView.outputText( 'her fist', false );
			}
			MainView.outputText( ' into your asshole, leaning on you in the same way and locking your bodies together through the portals.  ', false );
		}
		if( CoC.player.hasCock() && !CoC.player.hasVagina() ) {
			MainView.outputText( 'You gasp and moan when you feel her other hand wrap around your ' + Descriptors.cockDescript( 0 ) + ', pulling and tugging on it until it starts to leak a trail of squeezed-out man-slime on the mattress.  ', false );
		}
		MainView.outputText( 'Growing more and more aroused, hotter and hotter, you pick up the pace, pistoning your forearms in and out of Cinnabar\'s lewdly squelching holes.\n\n', false );
		MainView.outputText( 'She squeaks, the first rodent-like sound she\'s made all evening, and you take that as your cue to work her even more brutally, pounding her now-gaped holes with hard, fast strokes.  Each time it seems like she swallows more of your arm, and after a few particularly violent poundings, you\'ve sunk inside the rat up to the elbow.  From where you\'re kneeling, you can see her belly, and it isn\'t distended in the slightest.  Just how much can she handle?\n\n', false );
		...
		MainView.outputText( 'The rat\'s ', false );
		if( CoC.player.hasVagina() ) {
			if( CoC.player.vaginalCapacity() < 30 && CoC.player.analCapacity() < 30 ) {
				...
				MainView.outputText( 'fists', false );
			} else {
				MainView.outputText( 'fingers and fist', false );
			}
		} else {
			if( CoC.player.analCapacity() < 30 ) {
				MainView.outputText( 'fingers', false );
			} else {
				MainView.outputText( 'tightly-clenched fingers', false );
			}
		}
		MainView.outputText( ' plunge further inside you, violating you far more gently, but still hard enough to get you off.', false );
		if( CoC.player.hasCock() && !CoC.player.hasVagina() ) {
			MainView.outputText( '  Her soft pads grip your ' + Descriptors.cockDescript( 0 ) + ' tightly while she  presses on your prostate, milking your cum from you with professional skill.  Rather than coming in its usual spurts, it drips in a long, liquid chain of white-goo that drops into a submissive puddle on the bed.', false );
			if( CoC.player.cumQ() >= 250 ) {
				MainView.outputText( '  Not content with that, your body keeps going, thickening the stream into a torrent that soaks the sheets', false );
				if( CoC.player.cumQ() >= 1000 ) {
					MainView.outputText( ' and puddles on the floor', false );
				}
				MainView.outputText( '.', false );
			}
		}
		if( CoC.player.hasVagina() ) {
			MainView.outputText( '  She licks your ' + Descriptors.clitDescript() + ', and your ' + Descriptors.vaginaDescript( 0 ) + ' convulses around the intruding digits, making you shiver and moan.  Not wanting to be left out, your ' + Descriptors.assholeDescript() + ' clamps and puckers with it, wringing the rat\'s ', false );
			if( CoC.player.vaginalCapacity() < 30 ) {
				MainView.outputText( 'fingers', false );
			} else {
				MainView.outputText( 'hand', false );
			}
			MainView.outputText( ' in its hungry embrace.', false );
		}
		//(No dick/cunt:;
		if( CoC.player.gender === 0 ) {
			MainView.outputText( '  Her soft pads rub your ' + Descriptors.assholeDescript() + ' just right, setting off your climax with professional skill.  You grunt and squeeze, wringing her fingers inside your hungry hole as if you could milk cum from them.', false );
		}
		MainView.outputText( '  The orgasm is intense, and as you both succumb to exhaustion, two sets of limbs slip from abused orifices.  Cinnabar and you fall into each other, collapsing in a puddle of sexual juices and sweaty limbs.', false );
		if( CoC.player.wetness() < 3 ) {
		} else if( CoC.player.wetness() < 5 ) {
			MainView.outputText( '  Her arm seems quite soaked with your leavings.', false );
		} else {
			MainView.outputText( '  Her arm and chest are left splattered from your explosive, squirting orgasm.', false );
		}
		MainView.outputText( '\n\n', false );
		MainView.outputText( 'Cinnabar rolls over to give you a kiss on the cheek once she\'s recovered.  Her voice is still rough from the volume of her pleasure-squeaks, but she manages to whisper, "<i>That was nice for someone who didn\'t have a cock worth fucking.  Feel free to catch your breath, but I\'m a working girl so don\'t take too long.  I\'ve got to get the sheets cleaned', false );
		if( CoC.player.cumQ() >= 1000 ) {
			MainView.outputText( ' and the floor mopped', false );
		}
		MainView.outputText( ' before I can get my next customer.</i>"\n\n', false );
		CoC.player.orgasm();
	...
	Cinnabar.prototype.fuckCinnabarHugerAndCorruptedEr = function() {
		...
		MainView.outputText( '\n\n', false );
		MainView.outputText( 'That one push sent nearly two feet of cock into the violated vermin, and you don\'t intend to stop until you\'ve buried all ' + Utils.num2Text( Math.ceil( CoC.player.cocks[ x ].cockLength / 12 ) ) + ' turgid feet inside her.  Cinnabar feels so light in comparison to your ' + Descriptors.cockDescript( x ) + ', barely dragging it down at all.  You get a wicked idea and lean back, letting your iron-hard member shift with you, pulling the rust-red rat completely off the bed and into the air.  With nothing to grab on to and no way to reach the ground, her entire weight is supported entirely by the friction of her over-burdened walls, and with how juicy this bitch is, she\'s already sliding down, accelerating her gravity-fed violation with her unintentionally well-lubricated fuck-hole.\n\n', false );
		MainView.outputText( '"<i>T-too fast... ' + CoC.player.mf( 'Master', 'Mistress' ) + ', too fast!  Please go slower... please... ungghhAAAHHH... Godda-ah-aH-AH-AMNIT!</i>" she protests.\n\n', false );
		MainView.outputText( 'She probably should\'ve thought of the repercussions before she dragged you into the sack.  Cinnabar\'s hips are spread impossibly wide, her legs reduced to useless, vestigial limbs that a cum-sleeve like her won\'t need, and they get farther apart the further she\'s impaled upon you.  Even her ass-cheeks have adjusted to her new position; they\'ve spread so far apart that her clenching pucker will always be on display.  Maybe you can give it the same treatment once you\'ve finished destroying her gaped twat.\n\n', false );
		MainView.outputText( 'The rat – no, cum-sleeve – gets even tighter, and as you watch, her breasts bulge and jiggle, shifted from the rock-hard post that\'s pushing through her body.  They look almost tiny in compared to the cylindrical, veiny bulge, like cum-filled bubbles hanging from a moaning furry condom.  Impatient, you snag her ankles and give a hard tug, adding your strength to gravity\'s inexorable pull.  Warm, pulsating cunt-flesh hugs your ', false );
		if( !CoC.player.hasSheath() ) {
			MainView.outputText( 'crotch', false );
		} else {
			MainView.outputText( 'sheath', false );
		}
		MainView.outputText( ', squirting juices from the callous, cunt-piercing thrust.  The ' + CoC.player.cockHead( x ) + ' of your ' + Descriptors.cockDescript( x ) + ' can be seen just below her neck', false );
		if( CoC.player.cocks[ x ].cockLength >= 60 ) {
			MainView.outputText( ', and only now do you realize that you\'re long enough that you should\'ve gone the whole way through her.  Just what kinds of magics is she capable of!?', false );
		} else {
			MainView.outputText( ', and only now do you realize you blew past her cervix long ago, the tight ring hugging your ' + Descriptors.cockDescript( x ) + ' in a clutching embrace.', false );
		}
		MainView.outputText( '\n\n', false );
		MainView.outputText( 'Cinnabar\'s head looks absurdly tiny, perched as it is above her bloated belly.  She moans, "<i>F-fucking asshole!  You went t-too f-ah-ahhh-st...</i>"  Her voice trails off as her eyes narrow.  Somehow, even with her broken body, she\'s managed to get it together enough to yell at you.\n\n', false );
		MainView.outputText( '"<i>Fuck you!  You can\'t wait to get inside and then you sit there smirking?  Fuck that.  If you won\'t fill me right, I\'ll make you!</i>" screams the red rat.  Her already-crimson eyes glow with eldritch light and her hand lifts, radiating with the same unholy power.  Cinnabar\'s hand punches through one of the mirrors on the wall, disappearing for the tiniest fraction of a second before punching through the ring of your ' + Descriptors.assholeDescript() + ', HARD.  You scream, completely and utterly violated, just like Cinnabar.', false );
		CoC.player.buttChange( 30, true, true, false );
		MainView.outputText( '\n\n', false );
		MainView.outputText( 'She twists her fist inside you and reaches up to palm the tender lump of your prostate as she says, "<i>Payback\'s a bitch.</i>"  Her eyes flare, the magic exploding inside you, worming through your prostate and into your mind.  ', false );
		if( CoC.player.inte >= 50 ) {
			MainView.outputText( 'You dimly register it as an arousal spell, but you were already on edge, and your poor prostate is practically wringing itself dry in an effort to cum.', false );
		} else {
			MainView.outputText( 'It\'s too much for your utterly encapsulated member and violated anus, and your poor prostate practically wrings itself dry as it tries to unload.', false );
		}
		MainView.outputText( '  A half-second later your ' + Descriptors.cockDescript( x ) + ' joins it, your internal muscles clenching and convulsing, heaving the jizz from your body in one huge, gooey blast.\n\n', false );
		MainView.outputText( 'Cinnabar pulls her dirty paw out and grins like a mouse with a chunk of cheese, massaging her distorting neck while you empty every ounce of cum from your ' + Descriptors.ballsDescriptLight() + ' into her over-stretched womb-filled body.  She squeaks, "<i>No-ohhhh-ormally I LIKE being a mewling slut for ' + CoC.player.mf( 'studs', 'bitches' ) + ' like you, but if you won\'t treat a cum-sleeve like me with respect, then I\'m going to teach it to you.</i>"  You nod dumbly, still locked in an climax that ', false );
		if( CoC.player.cumQ() < 250 ) {
			MainView.outputText( 'makes your body churn well after you\'re empty.', false );
		} else if( CoC.player.cumQ() < 500 ) {
			MainView.outputText( 'causes her hugely-stretched lips to glaze white.', false );
		} else if( CoC.player.cumQ() < 1000 ) {
			MainView.outputText( 'causes her lips to glaze and her belly to bloat.', false );
		} else if( CoC.player.cumQ() < 1500 ) {
			MainView.outputText( 'makes her look pregnant and vents a puddle of syrupy-spooge on top of you.', false );
		} else {
			MainView.outputText( 'makes her look like a hugely-pregnant fuck-beast and dumps cum everywhere.', false );
		}
		MainView.outputText( '\n\n', false );
		MainView.outputText( 'The now-dominant, living onahole squeals with pleasure, yammering incessant, half-thought pleasure-words as she gets off.  "<i>Fu-fu... cum... somuchcum... ohhh gods yes... stuff my broken cunt! More!  Gimme more!  I want to feel it – no, I want to bubble with it, be it.  I want to be so full of cum... YES! OoooooooooooooOOOO – sssqeeEAAAAAAAAAAAK!</i>"\n\n', false );
		MainView.outputText( 'You collapse under her, still twitching weakly while her magic courses through your veins.  Somehow your ' + Descriptors.ballsDescriptLight() + ' are still twitching, but it\'s a painful, empty feeling, and you just want it to end.  You groan, nearly crying while your abused shaft is milked by orgasm-fueled rat-cunt contractions.  It makes you delirious and light-headed, and after a seeming eternity of torture, your brain shuts down, unable to cope with it anymore.\n\n', false );
		MainView.outputText( '<b>Some time later...</b>\n', false );
		MainView.outputText( 'Cinnabar slaps you hard, stirring you from your unnatural slumber.  You look up at her, blinking dumbly for a moment.  Her lips press against yours, crushing them with the force of her passion.  The rodent\'s soft, padded hands continue hitting you, slapping your face, boxing your ears, and smacking lamely into your chest.  Yet throughout the beating she\'s tonguing your mouth, groaning into your lips and smearing herself over your still-huge cock.  At last the rat seems satisfied, and she pulls of you with a panting, confused-looking smirk on her face.\n\n', false );
		MainView.outputText( 'You sit up, completely and totally awake thanks to your abusive lover, who\'s just smirking at you.  "<i>Goddamn you, you huge-cocked ' + CoC.player.mf( 'stud', 'fucker' ) + '.  I\'m STILL sore, but Marae\'s tits, did you ever get me off!  Don\'t get the wrong impression, it hurt like a BITCH.  I pity the girls you meet who can\'t stretch themselves like I can.  I truly do.  If you try that shit with me again, I\'ll give you another lesson in empathy – I hope you don\'t forget this one.</i>"\n\n', false );
		MainView.outputText( 'Cinnabar tosses your ' + CoC.player.armorName + ' and you realize the nude rat doesn\'t show any signs of your tryst', false );
		if( CoC.player.cumQ() >= 500 ) {
			MainView.outputText( ', save for her pregnant belly and ', false );
		} else {
			MainView.outputText( ', save for her ', false );
		}
		MainView.outputText( 'huge, slightly parted pussy-lips.  Chances are she\'ll have those back to normal before long anyway.  You get dressed and turn to leave, but before you do a tail taps your shoulder, the length curling to squeeze your neck.  It stops you cold while the hooker\'s voice whispers, "<i>Don\'t wait too long to come back.</i>"\n\n', false );
		MainView.outputText( 'Once she lets you go, you leave, and you find yourself mulling over her statement about empathy for some time.', false );
		//(-2 corruption!);
		CoC.player.orgasm();
	...
	Cinnabar.prototype.cinnabarHuger = function() {
		...
		MainView.outputText( ' to prod at your ' + Descriptors.assholeDescript() + ', sliding in to push your prostate.  She hits it hard enough to make you pump cum with enough force to distort her already-ballooned body, and you go into an orgasmic frenzy, dragging your ' + Descriptors.cockDescript( x ) + ' back to her entrance before jamming in all ', false );
		if( CoC.player.cocks[ x ].cockLength < 24 ) {
			MainView.outputText( Utils.num2Text( Math.round( CoC.player.cocks[ x ].cockLength ) ) + ' inches', false );
		} else {
			MainView.outputText( Utils.num2Text( Math.round( CoC.player.cocks[ x ].cockLength / 12 ) ) + ' feet', false );
		}
		MainView.outputText( ' all over again.', false );
		if( CoC.player.cocks[ x ].cockLength >= 60 ) {
			MainView.outputText( '  There\'s no way this should be possible, but it\'s happening and you couldn\'t be happier.', false );
		}
		MainView.outputText( '\n\n', false );
		MainView.outputText( 'Her body is squirming, writhing from the complete and total dick-domination.  You push her hands off your ' + Descriptors.cockDescript( x ) + ', and jack yourself off while you cum inside her, watching with fascination as each blast bulges her belly before it vanishes inside her with a wet slosh.  Her huge, stretched lips leak like a sieve, splattering girlcum everywhere while your ' + Descriptors.ballsDescriptLight() + ' pack', false );
		if( CoC.player.balls === 0 ) {
			MainView.outputText( 's', false );
		}
		MainView.outputText( ' her with goo, claiming her ruined body.  Cinnabar pants and screams in between pleasure-squeaks, "<i>F-fuck... fuck your fuck-toy!  Stuff her cunt... YES!  S-slut is so fucked... Cum, ' + CoC.player.mf( 'master', 'mistress' ) + ', then toss slut aside l-l-like a discarded, broken toy.  YOU\'VE RUINED ME ' + CoC.player.mf( 'MASTER', 'MISTRESS' ) + '!</i>"\n\n', false );
		MainView.outputText( 'Those wonderful, perverse words milk your ' + Descriptors.ballsDescriptLight() + ' dry as effectively as her massively-gaped cunt and broken body, but you keep pumping until you\'re sore and completely emptied.  ', false );
		if( CoC.player.cumQ() >= 500 ) {
			MainView.outputText( 'The rat-girl has gained a nice ', false );
			if( CoC.player.cumQ() < 1000 ) {
				MainView.outputText( 'spooge-paunch from all the cum.', false );
			} else if( CoC.player.cumQ() < 1500 ) {
				MainView.outputText( 'spooge-packed belly from all the cum.', false );
			} else {
				MainView.outputText( 'spooge-pregnancy from all the cum.  It swings underneath her, making her look ready to birth.', false );
			}
			MainView.outputText( '  ', false );
		}
		MainView.outputText( 'Cinnabar goes limp, but speared as she is, her near-unconscious body just hangs on you like a sock for your cock.  You shift position, and gently slide her off, shivering from how tightly her interior grips you as she\'s peeled off.\n\n', false );
		MainView.outputText( 'At last, your ' + CoC.player.cockHead( x ) + ' pops from her pussy, showing just how completely you\'ve worked over her body.  Her hips are stretched damn near a foot apart, and you can see deep enough inside her ', false );
		if( CoC.player.cocks[ x ].cockLength >= 60 ) {
			MainView.outputText( 'that it should be sticking up past her head, yet somehow isn\'t.', false );
		} else {
			MainView.outputText( 'to know that she must be some kind of magical to take a fucking like that without damage.', false );
		}
		MainView.outputText( '  Starting from her abused cervix, Cinnabar\'s pussy slowly begins to change, narrowing until it closes off your view of her womb.  The whole canal draws closed in one long motion that squeezes fuck-juices all over the bed, and then you hear her hips pop back into place.\n\n', false );
		MainView.outputText( '"<i>What, you think I\'d hunt down ' + CoC.player.mf( 'studs', 'breeders' ) + ' like you to fuck if I couldn\'t handle a little stretching every now and again?  Oh don\'t look at me like that – I\'m going to be sore for hours, but I fucking loved it.  Your cock... it\'s fucking special, and if you EVER want to feel another full-body fuck, come back and see me,</i>" says Cinnabar as she smiles up at you from her bed.\n\n', false );
		MainView.outputText( 'You smile back and go get dressed; it\'s way past time you checked on your campsite.  As you open the door, you can hear Cinnabar humming happily and trying to clean all the mess from her sheets', false );
		if( CoC.player.cumQ() >= 1000 ) {
			MainView.outputText( ', the sloshing in her belly still quite audible', false );
		}
		MainView.outputText( '.', false );
		CoC.player.orgasm();
	...
	Cinnabar.prototype.cinnabarHuge = function() {
		...
		MainView.outputText( '.\n\n', false );
		MainView.outputText( 'The kiss is broken abruptly, the suddenly invigorated rat-girl\'s lips pressing close to your ear as she murmurs, "<i>Oh yes... feel how tight my poor, abused cunt is... so very tight, clutching you like a swimsuit two sizes too small... Mmm, I can feel you twitching; are you going to cum in this slut\'s womb?  You\'ve fucked me so hard, gaped me and ruined me... will you finish me off?  Do it ' + CoC.player.mf( 'stud', 'bitch' ) + ', fuck this horny slut\'s womb full, mark her as your bitch - no, your fucking property!</i>"\n\n', false );
		MainView.outputText( 'Gods, she\'s so fucking perverse, and she\'s squeezing you so tight; fuck, even her tail is working you.  It twists around your ', false );
		if( CoC.player.balls > 0 ) {
			MainView.outputText( Descriptors.ballsDescriptLight(), false );
		} else if( CoC.player.hasSheath() ) {
			MainView.outputText( 'sheath', false );
		...
		MainView.outputText( ' to prod at your ' + Descriptors.assholeDescript() + ', sliding in to push your prostate, pressing on it hard enough to make you pump a jet of cum past the rat\'s relaxing cervix and into her womb.  You go into an orgasmic frenzy, utterly, completely dominating the size-queen with your massive, cum-bloated fuck-stick.  Her ass shakes and wobbles as you pull back roughly, dragging your cock through that over-tightened velvet cunt-sleeve, but before you can slip out, you push back in, fucking her hard enough to make a loud slap from your hips slamming into one another.\n\n', false );
		MainView.outputText( 'Her juices fall like rain, soaking the sheets, ', false );
		if( CoC.player.balls > 0 ) {
			MainView.outputText( 'your balls, ', false );
		}
		MainView.outputText( 'your ' + CoC.player.legs() + ', and ', false );
		if( !CoC.player.hasSheath() ) {
			MainView.outputText( 'the base of your twitching cock', false );
		} else {
			MainView.outputText( 'your twitching cock-sheath', false );
		}
		MainView.outputText( '.  You rub your hand over her belly, feeling your ' + CoC.player.cockHead( x ) + ' through her distended, dick-dominated fur.  Each fiery, pumping load of cum boils underneath the rat\'s fur, bubbling between your fingers as it sloshes into her womb.  Cinnabar is thrashing, squeaking and crying, though it\'s quite clear her tears are tears of joy.  She gasps, "<i>So big', false );
		if( CoC.player.cumQ() >= 1000 ) {
			MainView.outputText( ' and so much', false );
		}
		MainView.outputText( '... YES!  CLAIM ME!  I\'m yours... your cock-addicted, stretched-out fucktoy!  More... more!</i>"\n\n', false );
		MainView.outputText( 'You don\'t hold back, and you fuck her raw, jerking yourself off through her stretched hide until your ', false );
		if( CoC.player.balls === 0 ) {
			MainView.outputText( 'prostate has been squeezed dry.', false );
		} else {
			MainView.outputText( Descriptors.ballsDescriptLight() + ' feel sore and empty, completely drained.', false );
		}
		if( CoC.player.cumQ() > 500 ) {
			MainView.outputText( '  The rat-girl has gained a nice, ', false );
			if( CoC.player.cumQ() < 1000 ) {
				MainView.outputText( 'jiggling spooge-paunch from all the cum.', false );
			} else if( CoC.player.cumQ() < 1500 ) {
				MainView.outputText( 'spooge-packed belly from all the cum.', false );
			} else {
				MainView.outputText( 'spooge-pregnancy from all the cum.  It swings underneath her, making her look ready to birth.', false );
	...
	Cinnabar.prototype.cinnabarMultiCockPortalFuckFest = function() {
		...
		MainView.outputText( 'Cinnabar\'s hands fly through your ' + CoC.player.armorName + ', diving through your undergarments to squeeze ' + Descriptors.sMultiCockDesc() + '.  ', false );
		if( CoC.player.lust >= 70 ) {
			MainView.outputText( 'She groans when she feels the full, turgid masses in her fingers, shivering as her padded finger-tips become slippery with your dripping pre-cum.', false );
		} else {
			MainView.outputText( 'She sighs blissfully when she feels the size and number of your half-hard members, squeezing them with gentle pressure until they start to expand, engulfing her hand.', false );
		}
		MainView.outputText( '  Your ' + CoC.player.legs() + ' go wobbly from the delicate touches dancing through your ' + Descriptors.multiCockDescriptLight() + ', making it hard to stand.  Cinnabar slides ', false );
		if( CoC.player.tallness >= 72 ) {
			MainView.outputText( 'under your arm', false );
		} else {
			MainView.outputText( 'up against you', false );
		}
		MainView.outputText( ', supporting you while she asks, "<i>Do we need to get inside and get these taken care of, big ' + CoC.player.mf( 'boy', 'girl' ) + '?  Ohhh, that\'s just too bad.  I think I\'ll just play with you in the street until you\'re ready to pop, and then leave you like that until you go soft.  Then we can start over.</i>"\n\n', false );
		MainView.outputText( 'Red, mirthful eyes watch your reaction, the cruel, toothy smile growing broader as she teases you.   You grunt and push back, pulling yourself up straight and inadvertently displaying the huge, many-pronged bulge', false );
		if( CoC.player.lust >= 70 ) {
			MainView.outputText( ' you have', false );
		} else {
			MainView.outputText( ' she\'s given you', false );
		}
		MainView.outputText( '.  She\'s teasing you, but it\'s clear she\'s no dominatrix.  No, she wants you to take charge, and if you\'re going to get off, you\'ll need to.  You hook your hand in between her cleavage, feeling the tight, silky embrace of her fur and the gentle, pounding beat of her heart.  It beats faster as soon as you start tugging her, dragging her towards the wagons.  ', false );
		if( CoC.flags[ kFLAGS.CINNABAR_HOUSE_VISITED ] === 0 ) {
			MainView.outputText( 'She leans, guiding you towards her home even as she lets herself be led.', false );
		} else {
			MainView.outputText( 'She blushes hard, her thighs darkening from the fluid racing down them as you pull her towards her house.', false );
		}
		MainView.outputText( '\n\n', false );
		MainView.outputText( 'You pull her to the door, discovering the solid oak portal to be quite securely locked.  Cinnabar starts to slide around you, but before she can complete her first step, you push her against the door and reach under her dress, fingering her sloppy slit while you growl in her ear, "<i>Unlock it, bitch.</i>"\n\n', false );
		...
		MainView.outputText( 'Cinnabar moans, utterly and completely delighted, but you muffle those moans by spearing her throat on your ' + Descriptors.cockDescript( z ) + ', filling her oral orifice completely.  You reach through a pair of portals at arm height to squeeze her spread ass-cheeks, holding tight while you push forwards to completely bury your three lucky members in furry fuck-sleeves.', false );
		if( CoC.player.cockTotal() === 4 ) {
			MainView.outputText( '  The extra dick dives into the pillowy mounds, smearing a streamer of pre-cum over the tit\'s surface before it slides into that warm, welcoming cleavage.', false );
		} else if( CoC.player.cockTotal() > 4 ) {
			MainView.outputText( '  The extra dicks dive into the pillowy mounds, smearing streamers of pre-cum all over the tits\' surfaces before they slide home into that warm, welcoming cleavage.', false );
		}
		MainView.outputText( '\n\n', false );
		MainView.outputText( 'The sensation is absolutely divine, but primal need takes over.  You begin to rock your ' + Descriptors.hipDescript() + ' in and out, triple-penetrating the whore', false );
		if( CoC.player.cockTotal() >= 4 ) {
			MainView.outputText( ' while you tit-fuck her swollen breasts', false );
		}
		MainView.outputText( '.  Slippery-soft warmth wreathes your ' + Descriptors.cockDescript( x ) + ', the plush black love-tunnel contracting slightly to happily squeeze you every few seconds.  The darker, sinfully tight star of Cinnabar\'s anus glazes with your pre-cum, her ass-cheeks wobbling perfectly in your hands with each rhythmic penetration.', false );
		if( CoC.player.cockTotal() >= 4 ) {
			MainView.outputText( '  Meanwhile, the soft, downy fur on the rat\'s chest is starting to mat against her skin, coated with the slick leavings from your ', false );
			if( CoC.player.cockTotal() === 4 ) {
				MainView.outputText( 'extra dick', false );
			} else {
				MainView.outputText( 'remaining dicks', false );
			}
			MainView.outputText( '.', false );
		}
		MainView.outputText( '  The ' + Descriptors.cockDescript( z ) + ' in her mouth feels so good it nearly makes you jump, the long pink tongue licking around it while a wet muzzle buries itself in your crotch.  Gods, it\'s too much!\n\n', false );
		MainView.outputText( 'You feel yourself cumming, that tell-tale warmth in your gut mixing with a few involuntary muscle-contractions that bounce your ' + Descriptors.multiCockDescriptLight() + ' inside Cinnabar.  You turn your head to watch her, ' + Utils.num2Text( CoC.player.cockTotal() ) + ' penises pumping from holes in the wall to ravage her body completely and totally, her eyes rolled back in complete bliss.   Heat blooms in your ' + Descriptors.multiCockDescriptLight() + ', the pumping gouts of seed deep into all of the slut\'s holes simultaneously.  She screams into your ' + Descriptors.cockDescript( z ) + ', vibrations making your orgasm that much stronger.  It drags on and on, the spit-roasted rat shaking while she\'s completely taken in every way', false );
		if( CoC.player.cockTotal() >= 4 ) {
			MainView.outputText( ', her tits shining white from all the spooge you dump on to them', false );
		}
		MainView.outputText( '.\n\n', false );
		//(Medium-high cum production);
		if( CoC.player.cumQ() >= 500 && CoC.player.cumQ() < 1000 ) {
			MainView.outputText( 'Cinnabar\'s belly gurgles, her gut and womb packing with enough spunk to make her belly wobble slightly while you empty inside her.  Semen froths on her lips while she works to swallow it all.  It just adds to her already-impressive paunch.', false );
			if( CoC.player.cockTotal() >= 4 ) {
				MainView.outputText( '  The rat\'s tits are completely white, spooge leaking off her nipples like some kind of thick, sticky milk.', false );
			}
			MainView.outputText( '  You finish filling her with cream and hold your place long enough to admire your work from across the room.\n\n', false );
		}
		//(High cum production);
		else if( CoC.player.cumQ() >= 1000 ) {
			MainView.outputText( 'Cinnabar\'s belly gurgles, the skin pulling tight from all the seed you\'re pumping into her womb, gut, and belly.  She looks positively pregnant, and she even begins to slosh from each fresh deposit that you leave inside her.  The rat\'s eyes look up at you through a portal.  They\'re lidded with a mix of lust and pleasure, but your gaze goes lower to watch spooge bubble from her nose while her overtaxed throat fails to keep up with your heavy spunk-streams.', false );
			if( CoC.player.cumQ() >= 1500 ) {
				MainView.outputText( '  Best of all, her bed is completely soaked in the stuff, and she wallows in it like a pig in mud, her cleavage absolutely drenched with cum.', false );
			}
			MainView.outputText( '\n\n', false );
		}
		MainView.outputText( 'The slut-rat gargles in irritation around your sensitive, cummed-out cock, clearly displeased that you\'re still inside her.  You step back from the wall, your ' + CoC.player.legs() + ' giving out from the sensory overload of unsheathing your ' + Descriptors.multiCockDescriptLight() + ' simultaneously to drop you flat on your ' + Descriptors.assDescript() + '.  At the same time, Cinnabar starts coughing and groaning, clearly exhausted from the one-' + CoC.player.mf( 'man', 'woman' ) + ' gangbang.  You understand how that feels; just touching ' + Descriptors.sMultiCockDesc() + ' makes your head swoon.\n\n', false );
		MainView.outputText( 'An incessant licking reaches your ears, getting your attention.  You stand up, careful about your ' + Descriptors.multiCockDescriptLight() + ' while you look towards the bed.  The portals are closed down, and Cinnabar is bent double, folded in half like a contortionist', false );
		if( CoC.player.cumQ() >= 1000 ) {
			MainView.outputText( ' while her huge, cum-filled belly bulges out to the sides', false );
		}
		MainView.outputText( '.  Her long, pink tongue is lashing over her swollen, black cunt-lips, hungrily cleaning the dirty twat and even licking at her asshole.  It\'s almost enough to get you hard again, but she eventually breaks from her auto-cunnilingus long enough to glance your way.\n\n', false );
		MainView.outputText( '"<i>You\'re still here?  Go on, I\'ve got a lot of cleaning up to do before my next customer!</i>" grunts Cinnabar before returning to her task.  You run your hand through your ' + Descriptors.hairDescript() + ', exasperated, but quite satisfied.  You\'ll definitely have to visit her again sometime.\n\n', false );
		MainView.outputText( 'While you\'re getting dressed, the repeated slurps and moans pause enough for Cinnabar to say, "<i>I didn\'t mean to be rude... those dicks... those wonderful, plump cocks... they\'re a gift.  Come back soon ' + CoC.player.mf( 'stud', 'baby' ) + ', your cream filling tastes gooood.</i>"  She goes back to licking herself, and you can\'t help but have a huge grin as you walk out.', false );
		CoC.player.orgasm();
