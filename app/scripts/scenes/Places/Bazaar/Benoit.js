	...
	Benoit.prototype.benoitIntro = function() {
		...
		if( CoC.flags[ kFLAGS.TIMES_IN_BENOITS ] === 0 ) {
			...
			if( CoC.flags[ kFLAGS.FEMOIT_INCUBATION ] < -168 ) {
				EngineCore.outputText( 'When you enter the stall, you notice that Benoite\'s stomach is flat again. She gives you a toothy grin when you enter her stall. "<i>I have good newz [name]! You are a fazer! ' + String( CoC.flags[ kFLAGS.FEMOIT_EGGS ] ) + ' timez over in fact! Oh I wish zat you could have helped; but I was ztrong, ztrong enough get through it on my own.</i>" she gushes, speaking at a mile-a-minute. She\'s clearly pleased with herself; and your virility.' );
			...
			if( this.benoitAffection() <= 10 ) {
				...
				EngineCore.outputText( 'Once again, you carefully enter the gloom of Benoit\'s salvage shop.  The proprietor sniffs the air as you enter, and then relaxes in his seat.  "<i>Allo again, ' + CoC.player.short + '.  What brings you \'ere?</i>"' );
