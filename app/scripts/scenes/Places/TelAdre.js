...
angular.module( 'cocjs' ).run( function( SceneLib, MainView, $log, ArmorLib, OnLoadVariables, WeaponLib, PregnancyStore, Descriptors, ConsumableLib, PerkLib, StatusAffects, Utils, CoC, kFLAGS, EngineCore ) {
	function TelAdre() {
		/**
