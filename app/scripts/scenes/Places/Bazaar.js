...
angular.module( 'cocjs' ).run( function( SceneLib, MainView, Utils, PerkLib, ArmorLib, ConsumableLib, AppearanceDefs, Descriptors, CoC, kFLAGS, EngineCore ) {
	...
	Bazaar.prototype.joeyAndrogyny = function() {
		...
		EngineCore.outputText( 'You ask for a mirror, but Joey just titters with a knowing smile on his succulent lips as he replies, "<i>Oh, you haven\'t changed at all ' + CoC.player.mf( 'handsome', 'dear' ) + '.  This will let you change it to whatever extreme you like, but those kinds of facials aren\'t a service we currently offer.  I do hear that there\'s a goblin salon in the mountains that might be able to help you finish up your look though!</i>"\n\n', false );
	...
	Bazaar.prototype.joeysMassageWifNoExtraJizz = function() {
		...
		EngineCore.outputText( 'The bed cradles you as you close your eyes and lie back, noting the slight change in darkness beyond your eyelids from Joey\'s new position.  Spunk begins to rain over your ' + CoC.player.face() + ', puddling seed around your eyes and forehead before it drips down your cheeks and bubbles on your lips.  You\'re quickly distracted from the salty, cummy facial when your personal leporid lotion-dispenser ', false );
		//(fork to male or genderless, no new PG);
		//(MALE);
		if( CoC.player.hasCock() ) {
			EngineCore.outputText( 'slides his warm, ruby lips over your ' + Descriptors.cockDescript( 0 ) + ', licking and slurping the ' + CoC.player.cockHead() + ' like a treasured candy.  That hot, breathy embrace hugs tight to your urethral bulge, slobbering up the cock-tip.  The flexible, thin rabbit tongue swirls over your cum-slit to lap at the bubbling pre-cum, even as his quaking balls continue to bury your face in bunny-semen.', false );
		...
		//(Dickgasms;
			...
			if( CoC.player.cumQ() >= 700 ) {
				EngineCore.outputText( '  A smile widens your ' + CoC.player.face() + ' when you see the ', false );
	...
	Bazaar.prototype.joeysMassageWithEXTRASpooge = function() {
		...
		EngineCore.outputText( ', expertly running his fingertip around the sensitive ' + CoC.player.cockHead() + ' before tracing down along your rapidly filling urethra.  It feels good – better than it should, and the warmth inside you begins to leak into the bunny-boy\'s waiting hand in moments.\n\n', false );
		...
		if( CoC.player.skinType !== AppearanceDefs.SKIN_TYPE_FUR ) {
			EngineCore.outputText( 'over your ' + CoC.player.skinDesc, false );
		} else {
		...
		EngineCore.outputText( '  Come back ANY time, ' + CoC.player.short + '.  I\'d love to help you release again.</i>"\n\n', false );
	...
	Bazaar.prototype.collectSomeButtSmex = function() {
		...
		if( CoC.player.hasCock() ) {
			EngineCore.outputText( ' while [eachCock] twitches and leaks generously over your ' + CoC.player.skinFurScales() );
		}
		EngineCore.outputText( '.' );
