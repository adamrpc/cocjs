...
angular.module( 'cocjs' ).run( function( MainView, SceneLib, StatusAffects, Combat, SharkGirl, Appearance, Utils, Descriptors, CoC, kFLAGS, EngineCore ) {
	...
	/*Codex: Shark girls and tiger shark girls
	 ...
	 Skin tone Light orange with stripes for tiger sharks.
	 Hair color and in rare cases, Black.
	 Eye color for both species.
	 Typical dress skimpy swimwear, which they use to entice victims. Some tiger shark girls will wear grass hula skirts when on land to hide their endowments.
	 Weaponry: Fangs, tail and their bare hands.
	 Notable features shark teeth, a large fin between their shoulders and a shark tail dangling off of their backsides.
	 Sexual characteristics their slutty nature, shark girls have rather modest endowments in comparison to other such creatures; the majority of them are C-cups, D-cups at most. Though, their hips and buttocks are nice and curvy. Tiger shark girls possess wildly varying bustlines that are larger than their 'sisters', and usually are hyper-endowed with male genitalia.
	 Loot:
	 Shark Tooth
	 ...
	 Social Structure shark girls travel in small groups, ruled over by one tiger shark girl. However, there are larger communities that can be found in the lake. Males are generally kept chained up, being abnormally aggressive even for sharks. But as they are more virile and fertile than tiger sharks girls, every once in a while they are unchained to help with reproduction. The Shark people spend most of their time either hunting for food or hunting for sex.
	 Sex Life shark girls treat sex like a game or a sport, constantly battling for dominance against their opponents and using them as sex toys if they win. As they're horny most of the time, shark girls often look for 'playmates', regardless if their victims want to 'play' or not!
	 ----------------------------------
	 */
	//[Explore Lake];
	SharkGirlScene.prototype.sharkGirlEncounter = function( exploreLoc ) {
		if( exploreLoc === undefined ) {
			exploreLoc = 0;
		}
		...
		//Lake;
			...
			MainView.outputText( 'You wander around the sandy shores of the lake before raising your eyebrow at a strange sight: A solitary fin, circling around in the water. You take a step back in surprise when the fin suddenly starts barrelling toward the shore at inhuman speeds.  ', false );
		}
	...
	SharkGirlScene.prototype.sharkWinChoices = function() {
		...
		//Lust win;
			...
			MainView.outputText( 'The shark-girl begins masturbating, giving up on dominating you.  The sight is truly entrancing.', true );
	...
	/*-------------------------
	 ...
	 Attack descript open your mouth wide, your shark teeth extending out. Snarling with hunger, you lunge at your opponent, set to bite into right them! (Similar to the bow attack, high damage but it raises your fatigue).
	 +
	 ...
	 --------------------------
	 Stat effects strength 1-2 points (Up to 50)
	 ...
	 ---------------------------
	 Slutty Swimwear
	 Item description impossibly skimpy black bikini. You feel dirty just looking at it... and a little aroused, actually.
	 armorDef: 0
	 armorPerk: Greatly increases effectiveness of 'Tease' ability.
	 armorValue: 25 gems
	 Putting it on increases)
	...
	SharkGirlScene.prototype.sharkLossRape = function() {
		...
		if( CoC.player.gender === 0 ) {
			...
			if( CoC.player.HP < 1 ) {
				MainView.outputText( 'hurt ', false );
			} else {
		...
		if( CoC.player.hasVagina() && (CoC.player.totalCocks() === 0 || Utils.rand( 2 ) === 0) ) {
			...
			MainView.outputText( 'to fight on.\n\n', false );
			MainView.outputText( 'The shark girl giggles and moves over to you, tugging at your ' + CoC.player.armorName + '  impatiently. Her tail swishes around and smacks your ' + Descriptors.assDescript() + '. "<i>You\'re gonna make me very happy, you hear? Otherwise...</i>" she opens her mouth wide and you see her fangs glinting menacingly in the light. You gulp hard and nod, bringing a smile from the shark girl.\n\n', false );
			MainView.outputText( 'Wasting no time, she removes her skimpy swimwear and your own gear.  ', false );
			//[if herm];
			if( CoC.player.gender === 3 ) {
				MainView.outputText( 'Seeing your ' + Descriptors.cockDescript( 0 ) + ' puts a smile on the shark girl\'s face as she takes a firm grip on your erection. "<i>Well, you\'re just full of surprises, aren\'t you? Maybe I\'ll give this bad boy a whirl sometime. For now though...</i>"  ', false );
			}
			MainView.outputText( 'Her gaze drifts over to your ' + Descriptors.vaginaDescript( 0 ) + ' and she licks her lips in delight. "<i>Now that\'s what I\'m looking for! Tell you what dear, you get me wet and I might just give you some pleasure too.</i>"\n\n', false );
			MainView.outputText( 'She roughly grabs you by the hair and pulls your face into her drooling cunt, your tongue instinctively probing into her. "<i>Mmm... don\'t you dare stop licking you dumb bitch, if you know what\'s good for you,</i>" she orders. You reply by speeding up your tongue work. You\'re a little ashamed to admit it, but her dominant command makes you feel rather hot and bothered.\n\n', false );
			MainView.outputText( 'The shark girl eventually sighs happily and relaxes her grip on your hair, pulling your head away a few inches. "<i>Not bad bitch, not bad. Now get on your back.</i>" You obey your mistress\'s command and flop onto your back. A sense of joy fills you as she positions her crotch in front of your face and moves her own head between your legs. You quickly resume eating her out, and this time she joins in the feast. It\'s not too long before the two of you orgasm, spraying girl-cum onto each other\'s faces.\n\n', false );
			MainView.outputText( 'The shark girl stands to leave and winks at you before diving back into the water. You eventually pass out from the exertion.', false );
