...
angular.module( 'cocjs' ).run( function( MainView, SceneLib, StatusAffects, Combat, SharkGirl, Appearance, Utils, Descriptors, CoC, kFLAGS, EngineCore ) {
	...
	SharkGirlScene.prototype.sharkGirlEncounter = function( exploreLoc ) {
		...
		//Rowboat;
		if( exploreLoc === 1 ) {
			EngineCore.outputText( 'While rowing the boat across the lake you spy a shark fin heading your way.  Worried it might damage the small boat, you hastily row back to shore, jumping out of the boat.  The shark shows no signs of slowing, and the fin disappears just before coming ashore.  ', false );
		}
		//Lake;
		else {
			EngineCore.outputText( 'You wander around the sandy shores of the lake before raising your eyebrow at a strange sight: A solitary fin, circling around in the water. You take a step back in surprise when the fin suddenly starts barrelling toward the shore at inhuman speeds.  ', false );
		}
		EngineCore.outputText( 'A grey blur bursts from the water and lands on the ground a few feet away from you.\n\n', false );
		EngineCore.outputText( 'It\'s a woman – a peculiarly corrupted woman, with shiny grey skin, silver hair, and a fin positioned between her shoulder blades. She\'s wearing some rather revealing black swimwear. The girl looks up at you and grins widely, showing rows of knife-like teeth. "<i>Wanna play? Heads up though, I play \'rough\'!</i>"\n\n', false );
		EngineCore.outputText( 'You\'re fighting a shark girl!', false );
	...
	SharkGirlScene.prototype.sharkgirlSixtyNine = function() {
		...
		if( CoC.player.isNaga() ) {
			...
			//[if herm]  ;
				...
				EngineCore.outputText( ' and stand up, gripping your ' + Descriptors.cockDescript( 0 ) + ' and splattering thick jets of cum onto her face.', false );
			}
			EngineCore.outputText( '  The shark slut licks up your fluids hungrily.\n\n', false );
	...
	SharkGirlScene.prototype.sharkLossRape = function() {
		...
		//Male:;
			...
			EngineCore.outputText( 'to fight on.\n\n', false );
			EngineCore.outputText( 'You feel the shark girl\'s bare foot press against your chest and she roughly pushes you onto your back. "<i>Oh man, I can\'t even remember the last time I had an actual man...</i>" the shark girl says, pulling your pants down to your ankles. Seeing your stiff erection, your opponent smirks and wets her lips before taking your entire ' + Descriptors.cockDescript( 0 ) + ' into her mouth. The feeling is heavenly, her long tongue slithering around your shaft.\n\n', false );
