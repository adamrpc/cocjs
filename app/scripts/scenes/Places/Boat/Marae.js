...
angular.module( 'cocjs' ).run( function( MainView, SceneLib, Appearance, ConsumableLib, CockTypesEnum, ImageManager, $rootScope, PerkLib, Descriptors, AppearanceDefs, CoC, kFLAGS, Utils, StatusAffects, EngineCore ) {
	...
	Marae.prototype.encounterMarae = function() {
		...
		if( !CoC.player.findStatusAffect( StatusAffects.DungeonShutDown ) ) {
			...
			if( !CoC.player.findStatusAffect( StatusAffects.MetMarae ) ) {
				...
				if( CoC.player.cor > 66 ) {
					MainView.outputText( 'The woman bellows, "<i>Begone demon.  You tread on the precipice of damnation.</i>"  The tree\'s eyes flash, and you find yourself rowing back to camp.  The compulsion wears off in time, making you wonder just what that tree-woman was!', false );
				}
				//Explain the dungeon scenario;
				else {
					CoC.player.createStatusAffect( StatusAffects.MaraesQuestStart, 0, 0, 0, 0 );
					MainView.outputText( '"<i>You seem so surprised by me, Champion.   I suppose that is inevitable.  Your origin is not of Mareth, our land, and few save for the demons remember me,</i>" says the tree.\n\n', false );
					MainView.outputText( 'You take a step back, amazed to find such a creature, apparently uncorrupted.  ', false );
					if( CoC.player.lib + CoC.player.cor > 80 ) {
						MainView.outputText( 'Your eyes can\'t help but take note of the tree-woman\'s shapely breasts, and wonder if they feel like tits or wood.  ', false );
					}
					MainView.outputText( 'Feeling a bit confused, you introduce yourself and ask her who she is.\n\n', false );
					MainView.outputText( '"<i>Me?</i>" she asks, "<i>I am the life-goddess Marae.  I am Mareth, for my roots touch every part of it.   Or I was.  Before THEY came.</i>"\n\n', false );
					MainView.outputText( 'You suggest, "<i>The demons?</i>"\n\n', false );
					MainView.outputText( 'She nods and continues, "<i>The demons were once a tribe of magic-blessed humans, living in the mountains.  They had everything they could ever want:  peace, love, and the power to change reality.  But they grew dissatisfied, as men often do, and craved more.  They began using their magics to alter their bodies, seeking greater pleasure than ever before.  In time they became obsessed with it.  I let them be, believing their folly to be limited to their own village.   I was wrong.  While I focused on preventing famines and ensuring peace between the other villages, the humans twisted themselves into something else, something demonic.  They gave up their souls, crystallizing it into a magical energy source.    Of course they could not be satisfied with consuming the power of their own souls.  They wanted more.  They always want more.</i>"\n\n', false );
					MainView.outputText( 'You nod in understanding, paying close attention to the tree-goddess as she explains just how this realm has fallen so far, "<i>They came pouring out of the mountains in a wave, picking off villages left and right.  I lent many villages my power, but none had the strength to stand alone, and none would band together, resentful of their racial differences as they were.   All were consumed, enslaved, or filled with corruption.   My people were cut off from me, either by their new tainted outlook or by the demons\' own machinations.  I was able to hide a few places from the enemy\'s sight, but I do not know how long it will last.</i>"\n\n', false );
					...
					MainView.outputText( 'She practically begs, "<i>Please champion, you must help me.  The demons have a factory at the foot of the mountains.  It produces much of the fluid they use to taint me.  If you could find a way to shut it down, I... all of Mareth, might stand a chance.</i>"\n\n', false );
					MainView.outputText( 'You nod, understanding.  She commands, "<i>Now go, there is nothing to be gained by your presence here.  Return if you manage to close that vile place.</i>"\n\n', false );
					if( CoC.player.lib + CoC.player.cor > 80 ) {
						MainView.outputText( 'You could leave, but the desire to feel her breast will not go away.  What do you do?', false );
			...
			//Second meeting;
				...
				MainView.outputText( 'You approach Marae\'s tree, watching the goddess flow out of the tree\'s bark as if it was made of liquid.   Just as before, she appears as the top half of a woman, naked from the waist up, with her back merging into the tree\'s trunk.\n\n', false );
				if( CoC.player.cor > 66 ) {
					MainView.outputText( 'She bellows in rage, "<i>I told you, begone!</i>"\n\nYou turn tail and head back to your boat, knowing you cannot compete with her power directly.', false );
					EngineCore.doNext( SceneLib.camp, SceneLib.camp.returnToCampUseOneHour );
				} else {
					...
					//If not;
						...
						MainView.outputText( 'You nod in understanding, paying close attention to the tree-god as she explains just how this realm has fallen so far, "<i>They came pouring out of the mountains in a wave, picking off villages left and right.  I lent many villages my power, but none had the strength to stand alone, and none would band together, resentful of their racial differences as they were.   All were consumed, enslaved, or filled with corruption.   My people were cut off from me, either by their new tainted outlook, or by the demon\'s own machinations.  I was able to hide a few places from the enemy\'s sight, but I do not know how long it will last.</i>"\n\n', false );
						...
						MainView.outputText( 'She practically begs, "<i>Please champion, you must help me.  The demons have a factory at the foot of the mountains.  It produces much of the fluids they use to taint me.  If you could find a way to shut it down, I... all of Mareth, might stand a chance.</i>"\n\n', false );
						MainView.outputText( 'You nod, understanding.  She commands, "<i>Now go, there is nothing to be gained by your presence here.  Return if you manage to close that vile place.</i>"\n\n', false );
						if( CoC.player.lib + CoC.player.cor > 80 ) {
							MainView.outputText( 'You could leave, but the desire to feel her breast will not go away.  What do you do?', false );
							EngineCore.choices( 'Boob', this, this.grabHerBoob, '', null, null, '', null, null, '', null, null, 'Leave', SceneLib.camp, SceneLib.camp.returnToCampUseOneHour );
		...
		//Dungeon inoperable;
			...
			if( !CoC.player.findStatusAffect( StatusAffects.FactoryOverload ) ) {
				...
				MainView.outputText( 'Marae pushes the pearl into your hand, and closes your fingers over it gently.  "<i>Go now, there is still much to be done.  With luck we will not need each other again,</i>" commands the goddess as she slips back into her tree.  ', false );
	...
	Marae.prototype.grabHerBoob = function() {
		...
		MainView.outputText( 'You reach forward to cop a feel.  The goddess\' eyes go wide with fury as a massive branch swings down, catching you in the sternum.  It hits you hard enough that you land in your boat and float back a few feet into the water.  Nothing to do but leave and hope for another chance at her breasts...' );
		CoC.player.takeDamage( CoC.player.HP - 1 );
		EngineCore.doNext( SceneLib.camp, SceneLib.camp.returnToCampUseOneHour );
	};
	Marae.prototype.runFromPervertedGoddess = function() {
		MainView.clearOutput();
		MainView.outputText( 'You turn and run for the boat, leaving the corrupt goddess behind.  High pitched laugher seems to chase you as you row away from the island.' );
		EngineCore.doNext( SceneLib.camp, SceneLib.camp.returnToCampUseOneHour );
	};
	...
	Marae.prototype.maraeStealLethicite = function() {
		...
		//(FAIL);
			...
			MainView.outputText( 'You dart to the side, diving into a roll that brings you up behind the tree.  You try to slip by the gauntlet of grabbing tentacles, but fail, getting tripped and ensnared in them like a fly in a spider\'s web.  You are pulled up and lifted to the other side of the tree, where you are slammed against it.  The tentacles pull your arms and legs wide, exposing you totally and locking you into a spread-eagle position.  You cringe as Marae strides around, free from the confines of her tree.\n\n', false );
			MainView.outputText( '"<i>Awwww, what a nasty deceitful little ', false );
			if( CoC.player.gender <= 1 ) {
				MainView.outputText( 'boy ', false );
			} else {
				MainView.outputText( 'girl ', false );
			}
			MainView.outputText( 'you are.  You turn me into a steaming hot sex-pot, then have the nerve to come here and try to walk off with my lethicite, all WITHOUT fucking me?  Tsk tsk tsk,</i>" she scolds, "<i>I appreciate your ambition, but I can\'t just let a mortal walk all over me like that.  I\'ll be taking that,</i>" she says as she grabs the crystal, and lugs it to the tree underneath you.  She strokes the wood surface lovingly, and a knot dilates until it forms a hole large enough to contain the lethicite.  Marae shoves it inside, and strokes the wood like a pet creature, humming while the bark flows closed, totally concealing the crystal.\n\n', false );
			MainView.outputText( '"<i>Now, that should keep it safe from swift little play-toys like yourself.  What you tried was a bold move, and I respect that; initiative is to be rewarded.   So I\'ll let you go, just like that,</i>" she says, snapping her fingers for emphasis.\n\n', false );
			MainView.outputText( 'The tentacles lower you to the ground, but do not release you from their tight embrace.\n\n', false );
			MainView.outputText( 'Marae steps closer, playing her fingers softly up your thigh, "<i>BUT, you\'ll leave with a little something extra.  A gift from the new goddess of fertile unions...</i>"\n\n', false );
			//DICK;
			if( CoC.player.gender === 1 || (CoC.player.gender === 3 && Utils.rand( 2 ) === 1) ) {
				MainView.outputText( 'She extends a hand expectantly, watching with detached concentration while a tentacle lowers from the tree into her palm.   Hips swaying sexually, she advances, peeling back the tentacle\'s outer layer.  It opens up to reveal a wet, gummy mouth.  She giggles and bumps the opening against your ', false );
				if( CoC.player.cocks.length > 1 ) {
					MainView.outputText( 'largest ', false );
				}
				MainView.outputText( Descriptors.cockDescript( 0 ), false );
				MainView.outputText( '\'s tip.  Immediately a powerful suction draws your ' + Descriptors.cockDescript( 0 ) + ' inside the tentacle-maw, burying you up to the base in squirming pleasure.   Marae watches the plant go to work, squeezing teasingly until you orgasm.  It takes mere moments for the gifted tentacle to achieve its goal.  Your cum makes a tasty treat for the plant-beast, and it sucks and sucks until your body feels empty and drained.\n\n', false );
				MainView.outputText( '"<i>Oh that simply won\'t do,</i>" Marae whispers, cupping your ', false );
				...
				MainView.outputText( ', "<i>You\'ll be my prized breeder.</i>"  The sharp point of a fingernail presses against your taint, scratching the skin.  "<i>Just one tiny change to make,</i>" exhales the goddess.  Pain explodes at the base of your crotch as it feels like her fingernail impales you, penetrating inches into your flesh.  You thrash in agony as it reaches something sensitive inside you.  You black out from pain and the shock of watching your blood flow down her arm.\n\n', false );
				MainView.outputText( 'You feel warm, enclosed in comfort and pleasure.  Is this heaven?  No, your head is throbbing and your eyes are closed... you open them and discover you\'re still lying at the base of the tree.  That greedy tentacle is still locked around your ' + Descriptors.cockDescript( 0 ) + ' pinning it in the throes of orgasm.  You watch thick bulges of cum pump up the tentacle, evidence of a truly garguantuan fluid output.  It goes on and on, and you realize the pleasure ought to drive you mad.\n\n', false );
				MainView.outputText( 'Marae steps into your field of view, and pulls the tentacle free.  Your ' + Descriptors.cockDescript( 0 ) + ' twitches pitifully, blasting a few massive loads onto your belly as your orgasm withers and dies from lack of stimulation.\n\n', false );
			...
			//FEM);
				...
				MainView.outputText( 'She extends a hand expectantly, watching with detached concentration while a tentacle lowers from the tree into her palm.  A swift slash of her free hand cuts your ' + CoC.player.armorName + ' free, exposing your ', false );
				if( CoC.player.gender === 0 ) {
					MainView.outputText( 'hairless crotch.  She holds the tentacle back a moment and raises her free hand.  It begins to glow and shimmer as she points to your groin.  Warmth explodes in your crotch as a wriggling wet gash opens up - <b>your new vagina</b>.  ', false );
					CoC.player.createVagina();
					CoC.player.genderCheck();
				} else {
					MainView.outputText( Descriptors.vaginaDescript( 0 ) + '.  ', false );
				}
				MainView.outputText( 'She guides the tentacle forwards, letting it brush your nether-lips.  Without any guidance from its mistress, the bulbous plant-member buries itself inside you, sliding in easily until it\'s pushing hard against your womb.  A quick blast of fluid sends cramps spasming up your gut, forcing your cervix to dilate.  It wastes no time, flowing into your unprotected womb.  As soon as it reaches the back of your womb, thick bulges begin sliding down the exposed portion of the tentacle.  It stretches you wide, almost painfully so, as they pass through your lips and work up your passage.  They begin exploding in your cunt, one after the other, cum-bombs bursting in your womb, filling you to the brink.  Your belly swells out, giving you the appearance of a pregnant woman.  Finished with its nasty work, the plant-prick pulls free leaving your puffy pussy lips slightly agape.  A small runner of a thick green substance slowly slides out.', false );
				CoC.player.cuntChange( 20, true, true, false );
				MainView.outputText( '\n\n', false );
				MainView.outputText( 'Marae winks, "<i>Sorry about making you look so pregnant my dear, it\'s a necessary part of the process.  All that sloshing seed is going to flow right into your tender little mortal ovaries, and remake them.  You\'ll be so fertile just looking at a hard cock could knock you up!</i>"\n\n', false );
				MainView.outputText( 'She giggles at your expression of horror, "<i>No, not literally, but it won\'t take much to make you a mommy, and you\'ll find the gestation to be quite a bit... shorter.  Now get out of here before I change my mind and lock in an orgasm for the rest of your life.</i>"\n\n', false );
				MainView.outputText( 'You are dropped from the tree, and with little choice, you waddle to your boat, doing your best to cover up your violated ' + Descriptors.vaginaDescript( 0 ) + '.', false );
	...
	Marae.prototype.level2MaraeEncounter = function() {
		...
		MainView.outputText( 'While rowing about the lake', false );
		if( CoC.player.str > 70 ) {
			MainView.outputText( ' with ease', false );
		}
		MainView.outputText( ', a familiar island resolves itself in the center of the lake.  There\'s a familiar tree perched atop it, though the wriggling tentacles\' silhouette against the sky are a cruel reminder that this island will no longer be the peaceful haven it once was.  ', false );
		if( CoC.player.cor < 33 ) {
			MainView.outputText( 'Knowing all too well what kinds of horrors await', false );
		} else if( CoC.player.cor < 66 ) {
			MainView.outputText( 'Knowing all too well what kinds of sexual escapades lurk ahead', false );
		} else {
			MainView.outputText( 'Worried about enjoying the pleasures of the island overmuch', false );
		}
		MainView.outputText( ', you dip your oars into the water and yank the boat around.  Something "thunk"s off the bottom of the boat, making the wood shiver and spurring you to row with renewed vigor.  You churn the water with your frenzied rowing, but the island never seems to get any further away.   Frustrated by the definitive lack of progress, you fearfully peer over the edge of the old boat\'s hull.  "<i>Well, that explains it,</i>" you muse.\n\n', false );
		MainView.outputText( 'Squirming roots are crawling over the boat\'s underside.  They dig into every crease and crevice, binding the vessel tightly in place.  Just as you start to ponder swimming for the shore, the boat shifts, ', false );
		if( CoC.player.spe < 50 ) {
			MainView.outputText( 'dropping you flat on your ass', false );
		} else {
			MainView.outputText( 'nearly dropping you flat on your ass before you catch yourself and sit down', false );
		}
		MainView.outputText( '.  The old dinghy\'s cutting through the water with amazing speed, leaving foot-high waves in its wake.  Marae\'s island grows larger with each passing second, almost taunting you with your inability to get away.   By now the root-like vines have crept over the gunwales, and they wriggle at you, seemingly in warning.  Getting in the water is definitely not a good idea right now.	The bone-chilling scrape of sand on wood grates at your ears.  You\'ve arrived.  There\'s no point in putting off the inevitable.  You straighten up your ' + CoC.player.armorName, false );
		if( CoC.player.weaponName !== 'fists' ) {
			MainView.outputText( ', adjust your ' + CoC.player.weaponName + ',', false );
		}
		MainView.outputText( ' and step out of the boat onto the small, sandy beach that rings the island.  The tentacles that dragged your boat ashore are gone, leaving the well-used vessel in pristine condition, or as close as any such water-craft can be.  Looking up, you behold the monstrous, demonic-tree that sprouts from the island\'s apex.   It has no leaves, only small, teat-like protrusions that sprout from some of the \'branches\', which in truth have more in common with tentacles than plant-life.  The squirming mass of sexual shrubbery stays in constant motion, and its intertwined tentacles occasionally bulge and flex as they spurt thick, jism-like sap over one-another.\n\n', false );
		MainView.outputText( 'You advance on the twisted, arboreal orgy with reluctant determination.  Marae wants you here, and there\'s no way back without dealing with the sex-intoxicated goddess.  Her long, languid moans make it easy to find her.  The delirious deity\'s arms are entwined through the roots of her trees while a green-patterned tentacle goes diving into the petal-lined entrance of her sloppy sex.  She cranes her neck back at the sound of your footfalls and asks, "<i>', false );
		...
		//(Left Like a Bitch);
			...
			MainView.outputText( 'Well, look who came back!  I thought you were too afraid of a good time to come up here and fuck around with little ol\' Marae.   I was actually going to let you row away if you were too scared to come here.  No, don\'t even glance back now, I\'ve changed my mind.</i>', false );
		}
		MainView.outputText( '"\n\n', false );
		...
		if( !CoC.player.canFly() ) {
			MainView.outputText( 'You don\'t see any escape!', false );
			EngineCore.doNext( this, this.MaraeIIStageII );
		}
		//Can fly?  Choice to run;
		else {
			MainView.outputText( 'You don\'t think she\'s counted on your wings.  If you tried to fly you could probably get out of the reach of her tentacles in short order.', false );
	...
	Marae.prototype.MaraeIIStageII = function() {
		...
		//Marae uses a tree-tentacle to 'milk' male PC's.  Oral or Vajayjay? Not sure.;
			...
			MainView.outputText( 'You watch, standing stock-still and paralyzed with ', false );
			if( CoC.player.lust > 80 ) {
				MainView.outputText( 'lust', false );
			} else if( CoC.player.cor > 50 ) {
				MainView.outputText( 'indecision', false );
			...
			MainView.outputText( '.  Marae\'s advance seems like an inexorable march to your eyes, and before you have a chance to react, she\'s crushed against you in a full-body hug.  Her tongue digs into your mouth, rooting out your tongue and melting your resistance in an overwhelming, lust-powered assault.  You vision swims for a moment when she releases you and pulls back.  It\'s hard to focus with the busty, nude image of fertility beckoning you.  It makes ' + Descriptors.sMultiCockDesc() + ' strain to reach her, but she dances back with a knowing smile and says, "<i>Not yet my eager little subject.  Let me undress you, THEN you can worship me.</i>"\n\n', false );
			MainView.outputText( 'Vines whip out, sliding under your ' + CoC.player.armorName + ', undoing clasps, and removing it until you stand naked and exposed to Marae.  She smirks and crooks her finger at you in a \'come hither\' gesture.  You lurch forward, as if pulled on an invisible string until you\'re standing inches away from her, your ' + Descriptors.cockDescript( 0 ) + ' rubbing her belly', false );
			if( CoC.player.cockTotal() === 2 ) {
				MainView.outputText( ' while your other dangles against her thigh', false );
			} else if( CoC.player.cockTotal() > 2 ) {
				MainView.outputText( ' while your others dangle against her thighs', false );
			}
			MainView.outputText( '.  The goddess gives you a cruel smile, as if she knows something you don\'t, and she commands, "<i>Worship me with your cum, champion.  Submit to your goddess and spend your fertile seed for her.</i>"\n\n', false );
			MainView.outputText( 'Marae extends her arms, and the twin tentacles crawl forward like snakes as they wriggle down her appendages.  You thrust your crotch forwards, presenting it to the goddess, and only wonder why for a brief second before you toss away the nagging, useless thought.  Why would anything but pleasuring the living goddess before you matter?  Her corruptive aura floats in the air, filling you with the desire to submit to your queen and obey her every whim.  ' + Descriptors.SMultiCockDesc() + ' twitches and starts to drip pre-cum, itching to fulfill your deity\'s desires.\n\n', false );
			MainView.outputText( 'The tentacle on her right arm convulses, then splits open along four joints.  The tip folds open to reveal a pink, wriggling interior that promises pleasures mortal minds weren\'t meant to comprehend.  Meanwhile, while you\'re distracted by the eager plant-hole, the other tentacle slips behind you and climbs up your ' + CoC.player.leg() + ', leaving a trail of slime in its wake.   It slides between your cheeks and prods at your ' + Descriptors.assholeDescript() + '.  You jerk forwards in surprise, but Marae pushes your ' + Descriptors.hipDescript() + ' back, allowing it to work its way inside.', false );
			CoC.player.buttChange( 12, true, true, false );
			MainView.outputText( '  The open plant-hole dives for your groin while you\'re distracted, hits your ' + Descriptors.cockDescript( 0 ) + ' and devours it with a greedy sluuuuurp.', false );
			if( CoC.player.cockTotal() === 2 ) {
				MainView.outputText( '  Another vine that may as well be the first\'s twin snakes from between the goddess\' legs and jumps onto your ' + Descriptors.cockDescript( 1 ) + '.', false );
			} else if( CoC.player.cockTotal() > 2 ) {
				MainView.outputText( '  More \'open\' vines shimmy forth from between Marae\'s legs and jump up onto your ' + Appearance.cockNoun( CockTypesEnum.HUMAN ) + 's.', false );
			}
			MainView.outputText( 'You grunt and pump your hips, shameless as you give in to the squeezing, textured tentacle', false );
			if( CoC.player.cockTotal() > 1 ) {
				MainView.outputText( 's', false );
			}
			MainView.outputText( '.  Cum boils out from your ', false );
			if( CoC.player.balls === 0 ) {
				MainView.outputText( 'body', false );
			} else {
				MainView.outputText( 'balls', false );
			}
			MainView.outputText( ', but it\'s quickly devoured by Marae\'s tree-based tentacle-beast without a sound.  ', false );
			if( CoC.player.cumQ() > 500 ) {
				MainView.outputText( 'The thick bulges of spooge actually distort the vines', false );
				if( CoC.player.cockTotal() > 1 ) {
					MainView.outputText( 's', false );
				}
				MainView.outputText( ', letting you get the barest glimpse of white through the over-stretched tentacle-tube', false );
				if( CoC.player.cockTotal() > 1 ) {
					MainView.outputText( 's', false );
				}
				MainView.outputText( '.  ', false );
			}
			MainView.outputText( 'A hot, slippery pressure touches something inside your ' + Descriptors.assholeDescript() + ' and makes you squirt even harder.  Marae\'s minions have found your prostate!  You grunt and groan, but the orgasm doesn\'t seem to stop.  The goddess teases, "<i>What?  You didn\'t think I\'d actually let you cum on me did you?</i>"\n\n', false );
			MainView.outputText( 'It doesn\'t matter, you\'re giving her what she wants.  You cum until your ' + CoC.player.legs() + ' give out and you\'re sprawled on your back, ' + Descriptors.sMultiCockDesc() + ' being milked of its seed by the slurping, cunt-tentacles.  Every time you start to come down, the one in your backdoor rubs you just right and forces out another load.  Marae steps over your ' + CoC.player.face() + ' and drops down, allowing you to lick the nectar that drips from her sensitive, flower-like folds while you cum.  It\'s sweet, potent, and refreshing.  It makes it easy to keep cumming but hard to stay awake, and your eyes roll back as you pass out from an overload of pleasure.', false );
		}
		//[Hermz]  Marae grows vinecawks for DP under her flowercunt and sexes.;
			...
			MainView.outputText( 'The goddess closes with deliberately slow, hip-swaying steps that make your ' + Descriptors.cockDescript( 0 ) + ' tremble and leave no doubt that she\'s the goddess of fertility.  Marae giggles and wraps her arms around you, planting a firm, wet kiss on your lips while she undoes your ' + CoC.player.armorName + '.  Your gear hits the ground with a dull thump, and then her taut green nipples are pressed against your own', false );
			if( CoC.player.hasFuckableNipples() ) {
				MainView.outputText( ', slipping inside your cunt-like nipples with ease.  You moan into her ear at the unexpected penetration and shiver from the tingling shocks of pleasure in your ' + Descriptors.breastDescript( 0 ) + '.', false );
			} else {
				MainView.outputText( '.', false );
			}
			MainView.outputText( '  Hammering in your chest, your heart beats fast enough to flush your whole body when your ' + Descriptors.cockDescript( 0 ) + ' manages to slip between Marae\'s legs.  It doesn\'t penetrate, merely trapping itself between her fluid-lubed thighs', false );
			if( CoC.player.cockTotal() === 2 ) {
				MainView.outputText( ' while your other cock rubs over her surface', false );
			} else if( CoC.player.cockTotal() > 2 ) {
				MainView.outputText( ' while your other cocks rubs over her surface', false );
			}
			MainView.outputText( '.\n\n', false );
			MainView.outputText( 'You swoon, your head buzzing with desire for more of this buzzing goddess\' embrace.  The urge to kneel before her and worship her cunt rocks you to the core, blasting away the last of your feeble resistance, but before you can do so, Marae grabs you by the chin and commands, "<i>No my child.  You can serve me better by breeding.</i>"  Her fingers pull apart the petals of her flowery fuck-hole while she continues, "<i>Go ahead, put it inside.  I\'ll show you how to practice the new faith of Marae.</i>"\n\n', false );
			MainView.outputText( 'She\'s easy to push down into the soft grasses of the island, and her legs part to allow you better access.  Your ' + Descriptors.cockDescript( 0 ) + ' doesn\'t need to be told what to do, and it slips into her waiting wetness as if it was made for her.  ', false );
			if( CoC.player.cocks[ 0 ].cockThickness > 5 || CoC.player.cockArea( 0 ) > 100 ) {
				MainView.outputText( 'With how big you are, there\'s no way it should be able to fit, but her body isn\'t even distorted by your girth.  Perhaps she changed you to fit her?  You pull back and your thickness seems unchanged.  You shake your head to clear the unwelcome thoughts and ram yourself back into her.  Fucking is what\'s important.  ', false );
			} else {
				MainView.outputText( 'She feels perfect.  A velvet vice of hot, slippery wetness clutches tightly around your ' + Descriptors.cockDescript( 0 ) + '.  It almost feels like it\'s actually gripping you, cradling your cock in her ambrosia-slicked box.', false );
			}
			if( CoC.player.cockTotal() > 1 ) {
				if( CoC.player.cockTotal() > 2 ) {
				...
				MainView.outputText( Appearance.cockNoun( CockTypesEnum.HUMAN ) + ' prods at her tight pucker, and with a slight adjustment, you\'re able to line it up.  It\'s wet!  Inch after inch slides in with incredible ease, violating her slippery butthole until you\'ve completely double-penetrated her.', false );
			}
			MainView.outputText( '\n\n', false );
			if( CoC.player.vaginas[ 0 ].vaginalWetness < AppearanceDefs.VAGINA_WETNESS_WET ) {
				MainView.outputText( 'Sticky wetness glistens between your thighs', false );
			} else if( CoC.player.vaginas[ 0 ].vaginalWetness < AppearanceDefs.VAGINA_WETNESS_DROOLING ) {
				MainView.outputText( 'Drops of feminine arousal run down your thighs', false );
			} else {
				MainView.outputText( 'Trails of viscous feminine fluid leak from your ' + Descriptors.vaginaDescript( 0 ), false );
			}
			MainView.outputText( ', reminding you of your unused femsex.  Marae grunts underneath you, and while at first you assume it\'s from the penetration, the prodding of two cock-like protrusions at your lusty holes corrects your misguided assumptions.  You pull back and begin to fuck her in earnest, and with each long rock back, you can see she\'s grown tentacles from underneath her ass, like two prehensile tails.  They push forwards and spear you, arresting your movement while you try to cope with the sudden stretching of two of your orifices.  Warmth radiates from the twin intruders along with a slippery fullness.  They\'re pumping something inside you that tingles and makes ' + Descriptors.sMultiCockDesc() + ' bounce and drip.', false );
			CoC.player.cuntChange( 12, true, true, false );
			CoC.player.buttChange( 12, true, true, false );
			MainView.outputText( '\n\n', false );
			MainView.outputText( 'Marae laughs and teases, "<i>If this is how you fuck it\'s no wonder I haven\'t met your children yet.  If you\'re going to be my disciple you need to fuck your partners hard until you\'re stuffing them with cum.  Then you need to do it again.  Alternatively you should be bouncing on their cock and milking it with your ' + Descriptors.vaginaDescript( 0 ) + ' until your womb is packed so full you can\'t walk.  Now show me how you\'ll do it, or I might keep you here until you\'re properly trained!</i>"\n\n', false );
			MainView.outputText( 'You happily thrust forwards, ramming your ' + Descriptors.cockDescript( 0 ) + ' into her cunt with such force that a wet slap echoes over the lake and her fluids splatter your abdomen.  ', false );
			if( CoC.player.cockTotal() > 1 ) {
				MainView.outputText( 'Her asshole is squelching and dripping from your ' + Descriptors.cockDescript( 1 ) + ', actually squirting more lubricant than her pussy from the violent fucking!  ', false );
			}
			MainView.outputText( 'In spite of the obscene amount of pleasure ' + Descriptors.sMultiCockDesc() + ' is getting, you focus on obeying your goddess, and you work the muscles in your ' + Descriptors.vaginaDescript( 0 ) + ' and ' + Descriptors.assholeDescript() + ' to pleasure her tentacles.  Muffled sloshes and spurts reach your ears, and you realize just how successful your efforts are.  Marae\'s pinching her nipples and arching her back, and a moment later a wave of pleasure hits you upside the head with the force of a hammer-blow.\n\n', false );
			MainView.outputText( 'Cum boils out of your ', false );
			if( CoC.player.balls > 0 ) {
				MainView.outputText( 'rapidly contracting balls', false );
			} else {
				MainView.outputText( 'tentacle-squeezed prostate', false );
			}
			MainView.outputText( ' and erupts into Marae\'s womb.  Your hips rock forward, grazing her cervix with your ' + CoC.player.cockHead() + ' to better fill her uterus.  ', false );
			if( CoC.player.cockTotal() > 1 ) {
				MainView.outputText( 'The ' + Descriptors.cockDescript( 1 ) + ' in her ass spasms and explodes with its brother, glazing her slippery colon with a coating of syrupy spunk.  ', false );
			}
			if( CoC.player.cockTotal() > 2 ) {
				MainView.outputText( 'Neglected but orgasming, ', false );
				if( CoC.player.cockTotal() > 3 ) {
					MainView.outputText( 'the remainder of ', false );
				}
				...
				MainView.outputText( ' does its best to coat Marae\'s thighs with whiteness.  ', false );
			}
			MainView.outputText( 'The goop from inside you never seems to end, and you pump Marae\'s belly up with it until she looks a little pregnant.  ', false );
			if( CoC.player.cumQ() < 500 ) {
				MainView.outputText( 'The orgasm is so much more massive than normal, and you wonder if her magic enhanced it.  ', false );
			}
			if( CoC.player.cumQ() > 1000 ) {
				MainView.outputText( 'She\'s actually surprised when you keep fountaining more seed into her.  Her nipples start to squirt out the excess seed, but you keep cumming until she\'s squirted enough to soak herself with your jism.  ', false );
			}
			MainView.outputText( 'The goddess\' tentacles never let up during it all, and you have a belly that matches Marae\'s perfectly.\n\n', false );
			MainView.outputText( 'You slide out and slump over, utterly exhausted by the breeding session.  The goddess pulls her tentacles from your abused openings, marveling at the outflow of plant-spunk while you relax and pass out.  You feel her fold your hands around your belly to cradle the pregnant bulge, and then you\'re snoring contentedly.\n\n', false );
		}
		//ONWARD TO NUMBER 3;
	...
	Marae.prototype.MaraePt2RoundIIIPrizes = function() {
		...
		if( CoC.player.gender === 1 ) {
			...
			if( CoC.player.findPerk( PerkLib.MaraesGiftStud ) ) {
				...
				MainView.outputText( 'You might be a little sore.  I did some work to make sure you\'ll be a perfect breeding stud for me.  No tiny cum-shots for you!  You\'ll squirt out enough to knock up anyone, and I even touched up your seed so it\'ll get through most contraceptives.  Aren\'t I the nicest?</i>"  ', false );
			}
			//(CONTINUED);
		...
		//[HERMS];
			...
			//(HAZ STUD);
				...
				MainView.outputText( 'I can\'t believe I didn\'t think of this last time!  I made you such a great stud that I didn\'t think to make you just as good at popping out your own kids!  Well I went ahead and fixed that while you were sleeping.  Your womb is nice and fertile, and you\'ll pop out kids a LOT quicker than before.  We\'ll be repopulating everything in Mareth in no time!  Just be sure to knock up the girls and let the boys fuck your pussy, okay?</i>"  ', false );
				MainView.outputText( 'The entire time she was speaking, you were trapped in orgasm, milked by her tree with unthinking intensity.\n\n', false );
