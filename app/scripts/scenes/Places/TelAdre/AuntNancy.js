...
angular.module( 'cocjs' ).run( function( SceneLib, MainView, kFLAGS, AppearanceDefs, Utils, Descriptors, CoC, EngineCore ) {
		...
		if( CoC.time.hours >= 6 && CoC.time.hours <= 14 ) {
			if( display === undefined || display ) {
				...
				if( CoC.flags[ kFLAGS.UNKNOWN_FLAG_NUMBER_00263 ] === 0 ) {
					...
					MainView.outputText( '  Aunt Nancy', false );
				}
				MainView.outputText( ' glances up at you and smiles as you enter', false );
				//[(if unmet);
				if( CoC.flags[ kFLAGS.UNKNOWN_FLAG_NUMBER_00263 ] === 0 ) {
					MainView.outputText( ', and you see that she has additional red eyes spread across her forehead', false );
				}
	...
	AuntNancy.prototype.interactWithAuntNancy = function() {
		...
		//If Relationship with Nancy < 30;
			...
			MainView.outputText( 'You decide to talk with the bartender, and walk right up to the bar.  She sees you coming, and folds her towel up with her first pair of hands, while putting the glass she was polishing away with the other.\n\n', false );
			MainView.outputText( '"<i>Welcome to the Wet Bitch.  My name\'s Aunt Nancy, and I\'ll be your server this morning.</i>"  She smiles.  "<i>Well, what\'ll it be, friend?</i>" the bartender asks, her voice rich and velvety rather than cute as she leans on the bar, giving you a good look at her cleavage.  "<i>Bit early in the day for the strong stuff, I reckon.</i>"\n\n', false );
	...
	AuntNancy.prototype.strongStuff = function() {
		...
		if( CoC.player.gems < 5 ) {
			MainView.outputText( 'You start to ask for a strong drink and then remember you can\'t afford it.', false );
			//Do next;
		...
		MainView.outputText( 'You ask for a strong drink anyway, and Aunt Nancy nods.  Easily, she picks up a glass with one hand, reaches out with another two, and fills it with something greenish.\n\n', false );
		MainView.outputText( 'The bartender sees your gaze and smiles.  "<i>Heavy mead,</i>" she explains, hefting it.  "<i>We make it from honeybee honey.  Have a taste, friend.</i>"\n\n', false );
		MainView.outputText( 'You pay a few gems and take a sip.  The alcohol burns a bit, but it tastes deliciously, achingly sweet, and before you know it the glass is empty.\n\n', false );
		//[(If Toughness is >= 30)];
		if( CoC.player.tou >= 30 ) {
			MainView.outputText( 'It was good, but it seems to have gone straight to your head with surprising speed, giving you a pleasant buzz after only one glass. It might be a prudent idea to walk it off before you get another.  You thank Aunt Nancy for the drink, before climbing to your ' + CoC.player.feet() + ' and leaving.  She eyes you respectfully as you go.', false );
			//[+10 Relationship with Aunt Nancy];
			CoC.flags[ kFLAGS.UNKNOWN_FLAG_NUMBER_00264 ] += 10;
		}
		//[Else];
		else {
			MainView.outputText( 'Wow, that one took it out of you.  You\'re pretty sure you don\'t want to try to have another.  Feeling a little wobbly, you thank the bartender for the drink, and unsteadily stagger out of the shop.  As you leave, you hear Aunt Nancy giggling, and out of the corner of your eye, you see her bunched up, one hand over her mouth as she chuckles, amused at your inability to hold your liquor.', false );
	...
	AuntNancy.prototype.lightStuff = function() {
		...
		//[Lose 5 Gems.];
		if( CoC.player.gems < 5 ) {
			MainView.outputText( 'You start to ask for a light drink and then remember you can\'t afford it.', false );
			//Do next;
			EngineCore.doNext( this, this.interactWithAuntNancy );
			return;
		}
		...
		if( CoC.player.inte >= 20 ) {
			MainView.outputText( '  You realize that what look like almost-shoulder-length gloves over her hands must actually be shell-like portions of this exoskeleton.', false );
		}
		MainView.outputText( '\n\n', false );
		MainView.outputText( 'Once she gives you the drink, you take a tentative sip, and find it very sweet and refreshing, without seeming very strong or alcoholic.  It\'s very good, and you quickly have another.', false );
		//[If FirstTalkNancy = 0];
		if( CoC.flags[ kFLAGS.UNKNOWN_FLAG_NUMBER_00265 ] === 0 ) {
			CoC.flags[ kFLAGS.UNKNOWN_FLAG_NUMBER_00265 ]++;
			MainView.outputText( '"<i>So,</i>" she says, settling one set of arms on the bar and supporting her head with the other, "<i>what\'s your story, friend?  You have a certain...</i>" Aunt Nancy waves with a hand. "<i>look about you.  Like my late husband, Marae send him to his reward.  You\'re an... adventurer, I take it?  You live off the land, fighting monsters for gems, scavenging all your equipment off what you can find or put together yourself?</i>"\n\n', false );
			MainView.outputText( 'You nod, hesitantly, remembering that here, at least, you\'re in no danger from demons.\n\n', false );
			MainView.outputText( '"<i>Wonderful!</i>" she says enthusiastically, spreading her upper set of arms. "<i>I reckon that means that you\'ve got quite a few stories on you, friend. Feel like sharing?</i>" The drink, despite its low alcohol content, has still left you feeling a little chatty, and you eagerly tell her about your adventures.\n\n', false );
			/*[If Corruption < 30]
			 ...
			 */
			MainView.outputText( 'You tell her of some of your recent exploits in the demon realm.  Like most stories in this strange land, it ends up focusing on the strange, perverted sexuality of the monsters that dwell here, but she doesn\'t seem to mind.\n\n', false );
			MainView.outputText( 'The bartender listens, entranced, and reacts on all the right beats, her bosom bouncing on the particularly shocking ones.  When you\'re done, she smiles at you, and says, "<i>Well, that was quite a tale.  Let me tell you one...</i>"\n\n', false );
			MainView.outputText( 'Aunt Nancy pours herself a glass of the same drink you\'re having, and gulps down a long pull.\n\n', false );
			...
			if( CoC.player.humanScore() >= 4 ) {
				MainView.outputText( 'like you,', false );
			} else {
				MainView.outputText( 'like poor little Yara at the earring shop,', false );
			}
			MainView.outputText( ' and, well, one thing led to another, and I ended up chasing him out into the wider world.</i>"\n\n', false );
			MainView.outputText( 'Aunt Nancy sighs, dreamily.  "<i>Oh, the adventures we had together, friend!  We\'d wrestle over ancient treasures, fight midst old ruins, argue over who actually finished off that omnibus, fuck like rabbits and then insist that the other one came first.</i>"  She seems to be staring off into midair, a wistful smile on her face.  "<i>Marae on earth, how I miss him.  It\'s been almost a decade now, since I last saw him.  Somedays, I still think he\'ll just... walk in here, with that cocky smile on his face and that shiny old magic sword over his shoulder and make a pun.</i>"\n\n', false );
			MainView.outputText( 'She takes another drink, melancholically, before shaking her head to clear it.  "<i>Well, thank you for sharing some time with an old widow like me.</i>"  She flutters her still-beautiful eyelashes at you once or twice, then chuckles.  "<i>Come back some time.</i>"\n\n', false );
		...
		//[Else:];
			...
			MainView.outputText( 'As you sip your drink, you and Nancy swap adventuring stories for a while, enjoying one another\'s company in the fairly quiet bar.  The older spider-lady is a good conversationalist, and you feel a little closer for having shared some time with her.', false );
	...
	AuntNancy.prototype.declineAuntNancyMassage = function() {
		MainView.outputText( '', true );
		MainView.outputText( 'Aunt Nancy listens as you politely turn her down, and nods her head, the hungry look fading from her eyes.  "<i>I understand completely.  Sorry to have bothered you.</i>"  She starts to walk out of the bar, stops, and turns back to size you up again.  "<i>Of course,</i>" she says, "<i>if you ever change your mind... just come by whenever my shift\'s over.</i>"\n\n', false );
		MainView.outputText( 'Aunt Nancy raises one of her black-covered hands in front of her mouth, and blows you a kiss before scuttling away.', false );
		//[Gain 20 Lust.];
		EngineCore.doNext( SceneLib.camp, SceneLib.camp.returnToCampUseOneHour );
	};
	//[If Agree];
	AuntNancy.prototype.timeForAuntNancySpiderCooch = function() {
		MainView.outputText( '', true );
		MainView.outputText( 'You look the still-beautiful spider-lady in the eye, and, half-mesmerized, nod in agreement.  She smiles broadly (and, you can\'t help but notice, quite lewdly) and puts one of her lower arms through one of yours, while putting the upper one on your shoulder.  "<i>Well then,</i>" Aunt Nancy says, "<i>I suppose we should be off.</i>"\n\n', false );
		MainView.outputText( 'She leads you through the streets of Tel\'Adre, weaving through crowds and back alleys, before you finally end up just outside a modest little adobe building tucked away in a side street.  Slowly, she wraps all four of her arms around you, giving you a gentle hug', false );
		if( CoC.player.biggestTitSize() >= 1 ) {
			MainView.outputText( ' and taking the opportunity to grope your ' + CoC.player.allBreastsDescript() + ' right through your ' + CoC.player.armorName, false );
		}
		MainView.outputText( '.\n\n', false );
		MainView.outputText( '"<i>Come into my parlor,</i>" she whispers into your ear, licking it gently before sticking the tip of her long tongue into the hole before pressing her soft lips against the lobe of it.\n\n', false );
		MainView.outputText( 'Then, she lets go of you and skitters easily up to her door, opening it and slipping inside.', false );
	...
	AuntNancy.prototype.auntNancyPoonPartII = function() {
		MainView.outputText( '', true );
		MainView.outputText( 'Slowly, you follow Aunt Nancy into her home. Inside, the building is fairly dark and gloomy, even in the middle of the day, with thick curtains of unidentifiable white matter keeping most of the sun outside. Blinded, your vision still attuned to the bright desert, you can discern little of the house\'s insides before you hear a sudden skittering sound behind you and, as you turn to face it, are pushed further into the gloom. Your heel is caught by a thick strand of what feels like rope, and you fall flat onto your back, arms and legs splayed out to either side of you, as you land on some sort of taut net.\n\n', false );
		MainView.outputText( 'You try to climb back up, only to find that your flesh and ' + CoC.player.armorName + ' alike are caught fast against the adhesive matter of the net, which, you suddenly realize, is actually a thick web, spread across the house\'s floor. You feel a surge of panic and begin to pull and struggle, when suddenly you feel a smooth, cool hand on your face. Your night vision is beginning to recover, and you make out Aunt Nancy\'s face, her pale skin seeming to glow in the gloom, as she leans over you, staring into your eyes with hers, one finger trailing across your face before covering your lips in a gesture for quiet.\n\n', false );
		MainView.outputText( 'With her other three hands, the spider-lady lights a match and ignites a little lantern, which she raises to hang from the wall.  In the little area it illuminates, you can see that Aunt Nancy has removed her neck-less black dress, letting her impressive bosom bounce modestly as she works, and catch a glimpse of her unusual genitals before she turns to face you again.\n\n', false );
		//[If PillowTalk = 0];
		if( CoC.flags[ kFLAGS.UNKNOWN_FLAG_NUMBER_00266 ] === 0 ) {
			...
			MainView.outputText( '"<i>Are you ready for me, friend?</i>" murmurs Aunt Nancy, her throaty voice washing over you, as two of her hands rest on your ' + Descriptors.chestDesc() + ' and the other two wrap carefully around your neck and shoulders, gently rubbing you in the promised massage. She\'s crawling along the web, her many feet easily avoiding the sticky parts, and her face is mere inches from yours. You can smell her sweet, slightly alcohol-scented breath as her many eyes look down at you.  "<i>I certainly am, little fly.</i>"\n\n', false );
		}

		MainView.outputText( 'Quietly, mesmerized by her needy red eyes, you nod.  Aunt Nancy smiles demurely.  "<i>Good,</i>" she purrs, and lowers her lips to yours.  You weren\'t quite sure what to expect, but her lips are soft and gentle as she presses them on you.  Her tongue gently snakes into your mouth, wrapping around yours with ease, and her sweet-tasting saliva is soon sliding down your throat.  Instantly, you feel your body loosening up, and ', false );
		//[Intelligence > 40];
		if( CoC.player.inte > 40 ) {
			MainView.outputText( 'realize that the spit must contain some kind of chemical originally meant to still prey', false );
		} else {
			MainView.outputText( 'question whether or not the spider-lady\'s kiss is responsible', false );
		}
		MainView.outputText( '.\n\n', false );
		MainView.outputText( 'As you unwind at her touch, her many arms are working to strip away your ' + CoC.player.armorName + ', gently peeling them away with care until you are naked and needy in the spider-lady\'s web.\n\n', false );
		MainView.outputText( 'You are soon hanging in utter relaxation, idly wondering whether the ongoing massage Aunt Nancy\'s many hands are still performing all over your ' + Descriptors.chestDesc() + ', ' + Descriptors.buttDescript() + ', back, and neck, or the loving, strange kiss of her lips and long, curling tongue is more responsible.  Ultimately, however, she pulls her white-haired head away from yours, and removes her many hands from your trunk.  Smiling at your sudden unhappy look, Aunt Nancy begins to kiss her way down your body, first along the curve of your neck, sliding her long, moist tongue against your chest as you shiver in pleasure at the sensation and pressing her soft lips against your ' + Descriptors.nippleDescript( 0 ) + 's and nibbling gently on them to enjoy your moans of delight, before moving her head down your belly', false );
		if( CoC.player.tailType > AppearanceDefs.TAIL_TYPE_NONE ) {
			MainView.outputText( ' to the top of your tail', false );
		}
		MainView.outputText( '.\n\n', false );
		//[If a naga];
		if( CoC.player.isNaga() ) {
			MainView.outputText( 'Gently, she peels away the fold of skin that disguises your genitals, now moist-and-dripping with anticipation.  ', false );
		}
		MainView.outputText( 'Aunt Nancy licks her lips, a hungry look in her many eyes as she look down at you, clearly quite pleased by what she sees.\n\n', false );
		//[If you have balls:] ;
		if( CoC.player.balls > 0 ) {
			MainView.outputText( 'She smiles at the sight of your ' + Descriptors.ballsDescriptLight() + ', gently raising two of her hands to fondle and squeeze them as her soft lips press against them, ', false );
			//[If BallSize allows];
			if( CoC.player.ballSize < 15 ) {
				if( CoC.player.ballSize > 5 && CoC.player.ballSize < 15 ) {
					MainView.outputText( 'taking one', false );
				} else {
					MainView.outputText( 'both of them', false );
				}
				MainView.outputText( ' into her mouth to soak in her saliva as she wraps and caresses ', false );
				if( CoC.player.ballSize <= 5 ) {
					MainView.outputText( 'them', false );
				} else {
					MainView.outputText( 'it', false );
				}
				MainView.outputText( ' with her long, dextrous tongue.\n\n', false );
			} else {
				MainView.outputText( 'kissing and licking at them with those moist, relaxing lips.\n\n', false );
			}
		}
		//[If you have a vagina:];
		if( CoC.player.hasVagina() ) {
			MainView.outputText( 'The spider lady ', false );
			if( CoC.player.balls > 0 && CoC.player.hasCock() ) {
				MainView.outputText( 'lifts away your other "<i>equipment</i>" and ', false );
			}
			MainView.outputText( 'examines the folds of your ' + Descriptors.vaginaDescript( 0 ) + '.  You shiver at the sensation of one of her smooth, cold hands rubbing against your folds, the tips of her fingers sliding into you.  Aunt Nancy smiles up at you, enjoying your reaction.  "<i>Did you like that?</i>" she asks with her deliciously throaty voice, and you nod enthusiastically.  "<i>Good...</i>" she purrs, before slipping her long, slippery tongue inside of you.  You cry out in sudden surprise at the sudden feeling of it moving inside of you, exploring your shape, before she pulls it out as you squirm.  "<i>Mmmmmm...</i>" Aunt Nancy murmurs.  "<i>You taste goood, friend.</i>"\n\n', false );
		}
		//[If you have a penis:] ;
		if( CoC.player.hasCock() ) {
			MainView.outputText( 'Aunt Nancy gently caresses your ' + Descriptors.multiCockDescriptLight() + ' with her smooth black hands, enjoying your moans of delight, before lowering her head to kiss the head of your ' + Descriptors.cockDescript( 0 ) + '.  Her tongue snakes around it, and the spider-lady sucks a little, drinking up the little stream of pre-cum now leaking out, before raising her head up to look at you, a gentle smile on her face as her many hands continue to rub and explore your ' + Descriptors.multiCockDescriptLight() + '.  "<i>Not as good as my husband\'s,</i>" she whispers, "<i>but quite a piece, certainly.</i>"\n\n', false );
		}
		//[If you have no genitals at all:];
		if( CoC.player.gender === 0 ) {
			MainView.outputText( '"<i>Well, well, well,</i>" murmurs Aunt Nancy, intrigued by what she sees.  "<i>Very unorthodox, but we\'ll see what we can do.</i>"  She pauses to lick the fleshy expanse where your genitals used to be.\n\n', false );
		}

		//[All:] ;
		MainView.outputText( 'Two of her hands suddenly wrap themselves around the cheeks of your ' + Descriptors.buttDescript() + ', and squeeze gently.  "<i>Very nice,</i>" the spider-lady whispers, and then her long tongue spools out to slide over the surface of your ' + Descriptors.buttDescript() + '.  The tip of it even slips inside, gently, and you feel her saliva coating the inside of your bum.  It feels sensitive, and much more relaxed now than a minute ago.\n\n', false );
		if( CoC.player.hasCock() ) {
			MainView.outputText( 'Aunt Nancy rises up above you, still smiling with gentle sensuality, and reaches out.  ', false );
		}
		...
		if( CoC.player.hasCock() ) {
			...
			if( CoC.player.cockTotal() >= 2 ) {
				if( CoC.player.cocks[ y ].cockLength >= 22 ) {
					titFucked = true;
					MainView.outputText( 'As Aunt Nancy rides you enthusiastically, the spider-lady lifts ', false );
					if( CoC.player.totalCocks() > 2 ) {
						MainView.outputText( 'another one of ', false );
					}
					MainView.outputText( 'your ', false );
					if( CoC.player.cockTotal() === 2 ) {
						MainView.outputText( 'other cock ', false );
					} else {
						MainView.outputText( 'cocks ', false );
					}
					MainView.outputText( 'up to her heaving bosom, and slips it between her soft, lovely breasts.  "<i>Want something else nice?</i>" asks the spider-lady, eyes twinkling.\n\n', false );
					MainView.outputText( 'Still rising and falling atop your body as she rides you, Aunt Nancy grips her breasts with two of her black-shelled hands and begins to slide them up and down on either side of your tall, dripping ' + Descriptors.cockDescript( y ) + ', ', false );
					if( CoC.player.cocks[ y ].cockLength >= 30 ) {
						MainView.outputText( 'letting its head slip into her mouth, where she sucks and licks at it hungrily, ', false );
					} else {
						MainView.outputText( 'letting her long, dexterous tongue dangle down from her mouth to wrap around the head of her dick, occasionally licking at her own impressive bosom as well, ', false );
					}
					MainView.outputText( 'all the while staring down into your eyes.\n\n', false );
					MainView.outputText( 'The sensation, both of her soft, pillowy bosom wrapped around your ' + Descriptors.cockDescript( y ) + ' and of her skillful tongue', false );
					//[If CockDescript (Longest Cock) is long enough for auto-fellatio];
					if( CoC.player.cocks[ y ].cockLength >= 30 ) {
						MainView.outputText( ' and mouth', false );
					}
					MainView.outputText( ', is incredible.  Aunt Nancy coos happily, clearly enjoying the taste.\n\n', false );
				}
				//[If there are still dicks left over:];
				if( CoC.player.cockTotal() > 2 ) {
					if( CoC.player.cockTotal() === 3 ) {
						MainView.outputText( 'Another of her hands wraps itself around your other cock', false );
					} else {
						MainView.outputText( 'Her other hands wrap themselves around more of your cocks', false );
					}
					MainView.outputText( ', milking and stroking the ', false );
					MainView.outputText( 'pulsating prick', false );
					if( CoC.player.cockTotal() > 3 ) {
						MainView.outputText( 's', false );
					}
					MainView.outputText( ' for all ', false );
					if( CoC.player.cockTotal() === 3 ) {
						MainView.outputText( 'it\'s', false );
					} else {
						MainView.outputText( 'they\'re', false );
					}
					MainView.outputText( ' worth.\n\n', false );
				}
			}
			...
			if( !titFucked || (titFucked && CoC.player.cockTotal() <= 2) ) {
				MainView.outputText( 'Her remaining hands gently work their way across your body, alternating between rubbing and squeezing your ' + Descriptors.buttDescript() + ', even sometimes slipping fingers inside to probe the insides, ', false );
				//[If the player has balls];
				if( CoC.player.balls > 0 ) {
					MainView.outputText( 'gently kneading and caressing your ' + Descriptors.ballsDescriptLight() + ' as the cum inside churns and boils and ', false );
				}
				//[If the player has a vagina];
				else if( CoC.player.hasVagina() ) {
					MainView.outputText( 'exploring the folds and creases of your ' + Descriptors.vaginaDescript( 0 ) + ' and ', false );
				}
				MainView.outputText( 'massaging your ' + Descriptors.chestDesc() + '.  Occasionally, they stroke through your ' + Descriptors.hairDescript() + '.\n\n', false );
			}
		}
		//[If player has vagina but no dicks: (Nancy prefers dicks and will always choose them over lesbian sex)];
		else if( CoC.player.hasVagina() ) {
			MainView.outputText( 'Gently, Aunt Nancy leans down to stroke your face as two of her other hands reach out and begin caressing your chest, while a fourth explores the outer folds of your ' + Descriptors.vaginaDescript( 0 ) + '.  "<i>Such a pretty little fly,</i>" the spider-lady whispers as she stares at your face, her bright red eyes full of longing.   She presses her face against the side of your head, and you gently turn it to allow her access to your ear, which she quickly slips her tongue into again, enjoying the feeling as you quiver and yelp beneath her.\n\n', false );
			MainView.outputText( 'With your face turned, you suddenly spot a once-well-made dildo lying on the floor beneath the web.  You see that it has been worn down as smooth as an apple rind and probably much thinner than it was before, and you suddenly wonder just how pent up the widow\'s sexual desires really are.\n\n', false );
			MainView.outputText( 'Such thoughts are interrupted when you suddenly feel Aunt Nancy\'s fingers on the lower half of your body again, caressing your ', false );
			if( CoC.player.tailType > AppearanceDefs.TAIL_TYPE_NONE ) {
				MainView.outputText( 'tail before rising to your ', false );
			}
			MainView.outputText( Descriptors.vaginaDescript( 0 ) + ' and ' + Descriptors.buttDescript() + '.  Aunt Nancy turns your head to face hers, and rises up onto her legs again as her fingers begin to sink deep into your ' + Descriptors.vaginaDescript( 0 ) + ' and your ' + Descriptors.assholeDescript() + '.  You moan, loudly and long at the sensation, and Aunt Nancy smiles lewdly, her other hands still exploring and squeezing your ' + Descriptors.chestDesc() + ', rubbing and kneading them softly and occasionally pinching and pulling at your ' + Descriptors.nippleDescript( 0 ) + 's.\n\n', false );
			MainView.outputText( 'Suddenly, you realize that your left hand is now free, courtesy of one of Aunt Nancy\'s smooth, gentle arms.  She whispers, quietly, "<i>A little for me too, please.</i>"  Realizing exactly what she means, you press the ' + CoC.player.skinFurScales() + ' of your hand against her pussy.  Its entrance, two parted shell-plates dripping wet fluid, would almost be scary if you weren\'t so very relaxed.  Gently, your press your fingers into her body, and hear her moan, loudly, feel her own hands scrabbling inside of your ' + Descriptors.vaginaDescript( 0 ) + ' and ' + Descriptors.assholeDescript() + ', pawing your chest and ' + Descriptors.buttDescript() + ', trailing through your ' + Descriptors.hairDescript() + '.\n\n', false );
			MainView.outputText( 'It feels wonderful.  You lie back and moan, enjoying the smooth, silky insides of her pussy, feeling tiny feelers occasionally caress and pull at your fingers inside of her.\n\n', false );
			//[If PC is lactating:];
		...
		//[If the PC has no genitals at all:];
			...
			MainView.outputText( 'Gently, Aunt Nancy leans down to stroke your face as two of her other hands reach out and begin stroking your ' + Descriptors.chestDesc() + ' while a fourth explores the smooth, fleshless expanse where your genitals once were.  "<i>Such a pretty little fly,</i>" the spider-lady whispers as she stares at your face, her bright red eyes full of longing.  She presses her face against the side of your head, and you gently turn it to allow her access to your ear, which she quickly slips her tongue into again, enjoying the feeling as you quiver and yelp beneath her.\n\n', false );
			MainView.outputText( 'With your face turned, you suddenly spot a once-well-made dildo lying on the floor beneath the web.  You see that it has been worn down as smooth as an apple rind and probably much thinner than it was before, and you suddenly wonder just how pent up the widow\'s sexual desires really are.\n\n', false );
			MainView.outputText( 'Such thoughts are interrupted when you suddenly feel Aunt Nancy\'s fingers on the lower half of your body, caressing your ' + Descriptors.buttDescript() + ' before rising again to your lack of genitals.\n\n', false );
			MainView.outputText( 'Smiling at the puzzle before her, Aunt Nancy gently runs her hands over your ' + Descriptors.nippleDescript( 0 ) + 's and ' + Descriptors.hairDescript() + ' as she thinks over how best to make love to you.  Gently, her white-haired head returns to your ' + Descriptors.buttDescript() + ', and her long tongue snakes out again, sliding between its lobes.  As you relax, it slips inside of you, just far enough for you to moan at the nigh-sexual pleasure of total relaxation.  The spider-lady removes her tongue from your anus, much to your dissatisfaction, and carefully wipes it off on a nearby bit of cloth before returning it to her mouth, then, smiling up at your petulant expression, slips a few of her fingers into your now-loose and sensitive ' + Descriptors.assholeDescript() + '.\n\n', false );
			MainView.outputText( 'Aunt Nancy climbs back atop you as you moan at the welcome new sensation, licking at your chest as she does.  "<i>Bet you didn\'t think I could do it,</i>" she purrs to you, as you enjoy the many, many sensations working at you.\n\n', false );
			MainView.outputText( 'Suddenly, you realize that your left hand is now free, courtesy of one of Aunt Nancy\'s smooth, gentle arm.  She whispers, quietly, "<i>A little for me too, please.</i>"  Realizing exactly what she means, you press the ' + CoC.player.skinFurScales() + ' of your hand against her pussy.  Its entrance, two parted shell-plates dripping wet fluid, would almost be scary if you weren\'t so very relaxed.  Gently, your press your ingers into her body, and hear her moan, loudly, feel her own hands scrabbling inside of your ' + Descriptors.assholeDescript() + ', pawing your chest and ' + Descriptors.buttDescript() + ', trailing through your ' + Descriptors.hairDescript() + '.\n\n', false );
			MainView.outputText( 'It feels wonderful.  You lie back and moan, enjoying the smooth, silky insides of her pussy, feeling tiny feelers occasionally caress and pull at your fingers inside of her.\n\n', false );
			//[If PC is lactating:];
			if( CoC.player.biggestLactation() >= 1 ) {
				MainView.outputText( 'As milk leaks slowly from your ' + Descriptors.nippleDescript( 0 ) + 's, the spider-lady notices. She lowers her head and wraps her soft, lovely lips around the tip of one of your ' + CoC.player.allBreastsDescript() + ', sucking gently and frantically flicking her tongue against your ' + Descriptors.nippleDescript( 0 ) + '.  You moan and lie back into the web, the multitude of sexual pleasures assaulting your senses almost more than you can bear as Aunt Nancy begins swallowing up your milk.\n\n', false );
			...
			if( CoC.player.cockTotal() > 2 ) {
				...
				if( CoC.player.cockTotal() > 1 ) {
					if( (CoC.player.cocks[ y ].cockLength < 22 && CoC.player.cockTotal() === 2) || (CoC.player.cocks[ y ].cockLength >= 22 && CoC.player.cockTotal() === 2) ) {
						MainView.outputText( 'Your other dick fires off too, her smooth, shell-covered hands still wrapped around it, and it makes even more of a mess, splattering over both of you.\n\n', false );
					}//[Else] ;
					else if( (CoC.player.cocks[ y ].cockLength < 22 && CoC.player.cockTotal() > 2) || (CoC.player.cocks[ y ].cockLength >= 22 && CoC.player.cockTotal() > 2) ) {
						MainView.outputText( 'The rest of your ' + Descriptors.multiCockDescriptLight() + ' fire off too, her smooth, shell-covered hands still wrapped around them, and they make even more of a mess, splattering over both of you.\n\n', false );
					}
				}
			}
			//[If you also have a vagina:];
			if( CoC.player.hasVagina() ) {
				MainView.outputText( 'Your ' + Descriptors.vaginaDescript( 0 ) + ' clenches, tightly, ', false );
				if( CoC.player.balls === 0 && (CoC.player.cocks[ y ].cockLength < 22 || (CoC.player.cocks[ y ].cockLength >= 22 && CoC.player.cockTotal() <= 2)) ) {
					MainView.outputText( 'squeezing the fingers on Aunt Nancy\'s hand still tickling your insides', false );
				} else {
					MainView.outputText( 'making you long for something inside of it', false );
				}
				MainView.outputText( ', as ' + Descriptors.sMultiCockDesc() + ' spasms in ecstacy.\n\n', false );
			}
			//[All w/ penis:];
			MainView.outputText( 'Eventually, both your orgasms end.  You feel worn out, like you just ran a long mile, even though Aunt Nancy was doing most of the work.  However, she seems fine, smiling down at you with a big, happy grin.', false );
			//[If the PC has multiple dicks or a cum multiplier of at least 2];
			if( CoC.player.cockTotal() >= 2 && CoC.player.cumQ() >= 700 ) {
				MainView.outputText( '  Her lower body\'s a mess of smeary dollops of cum, right up to the bottom halves of her impressive boobs, and her face and upper body haven\'t fared much better. Behind her you can see where stray shots that sprayed over her have painted streaks of her abdomen white.', false );
			}
			MainView.outputText( '\n\n', false );
			//[If the PC has multiple dicks or a cum multiplier of at least 2] ;
			if( CoC.player.cockTotal() >= 2 && CoC.player.cumQ() >= 700 ) {
				MainView.outputText( 'Aunt Nancy runs one hand up her milky-pale body, digging a wide furrow in the thick layer of gooey cum as it moves up her belly and up the curve of her breast, before she peels it away and lifts it in front of her mouth.', false );
			} else {
				MainView.outputText( 'Aunt Nancy puts one hand beneath her dripping pussy and squeezes some powerful internal muscle.  A thick dollop of gooey cum falls onto it from inside of her, and she lifts it in front of her mouth.', false );
			}
			MainView.outputText( '  Snaking her long tongue around her fluid-smeared hand, the spider-lady licks up a thick load of the contents of your ', false );
			if( CoC.player.balls > 0 ) {
				MainView.outputText( Descriptors.ballsDescriptLight(), false );
			} else {
				MainView.outputText( 'body', false );
			}
			MainView.outputText( ', and throws back her head to let it slide into her mouth.\n\n', false );
			MainView.outputText( '"<i>Mmmmm...</i>" she purrs.  Aunt Nancy notices the look on your face and smiles sexily.  "<i>What? A lady needs her protein, friend.  Do you think I can spin my webs out of nothing?</i>"\n\n', false );
		}
		//[Else:];
		else {
			...
			//[If PC has a vagina:];
			if( CoC.player.hasVagina() ) {
				MainView.outputText( Descriptors.vaginaDescript( 0 ) + ' and ', false );
			}
			MainView.outputText( Descriptors.assholeDescript() + '.\n\n', false );
			MainView.outputText( 'You howl in pleasure, feeling the orgasm coursing through you like hot metal up and down your spine.  You let out a exclamation of pleasure of your own, as you feel her hands tighten on your ' + Descriptors.chestDesc() + ', and soon you too are luxuriating in the feeling of her body against yours, inside of you, pressing all your most vulnerable places.', false );
			//[If PC has a vagina and is a squirter and/or is lactating:] ;
			if( CoC.player.wetness() >= 5 || CoC.player.biggestLactation() >= 1 ) {
				MainView.outputText( '  Her hands are soon drenched in your body\'s wonderful secretions, just as your', false );
			} else {
				MainView.outputText( '  Your', false );
			}
			MainView.outputText( ' fingers are soon soaked in the lovely, sweet-smelling juices of her pussy.\n\n', false );
			MainView.outputText( 'Eventually, the sensation subsides, and she gently slides her fingers from your ', false );
			//[If PC has a vagina:] ;
			if( CoC.player.hasVagina() ) {
				MainView.outputText( Descriptors.vaginaDescript( 0 ) + ' and ', false );
			}
			MainView.outputText( Descriptors.assholeDescript() + '.  You feel worn out, like you just ran a long mile, even though Aunt Nancy was doing most of the work, and you let your arm fall back down against the sticky surface of her web.  However, she seems fine, smiling down at you with a big, happy grin.', false );
			//[If PC has a vagina:] ;
			if( CoC.player.hasVagina() ) {
				MainView.outputText( '  Lifting the smooth, soaked hand that has only just been soaked in the juices of your ' + Descriptors.vaginaDescript( 0 ) + ' in front of her mouth, Aunt Nancy smiles at you.  Snaking her long tongue around her fluid-smeared hand, the spider-lady licks up the fluid with every sign of enjoyment.  "<i>Mmmmm...</i>" she purrs.  "<i>You DO taste good.</i>"\n\n', false );
			}
		}
		//[All];
		MainView.outputText( 'Aunt Nancy leans down and presses her soft lips against yours again, wrapping your web-bound body up in a hug with all four of her arms, and again you feel much more relaxed and (now that you think of it) aroused than you had a minute ago.  However, this particular sex session has taken an awful lot out of you, and you look longingly at the door over her shoulder as the kiss ends.  Unfortunately, the spider-lady sees you doing so and smiles wickedly.\n\n', false );
		MainView.outputText( '"<i>Not a chance on Marae\'s green earth, friend,</i>" she purrs, her voice like hoarse velvet as she rubs the surface of her still-needy pussy against your belly.  "<i>I haven\'t had a lover in my bed in more than ten years, and you\'re not going anywhere until I say you can.</i>"  That last part was punctuated with a wicked squeeze of your ' + Descriptors.buttDescript() + ', and Aunt Nancy presses her lips to yours again, much less gently and more passionately this time.  You moan into her mouth, feeling her aphrodisiacal bodily fluids seeping in, and, as she soon frees your upper body and presses your head into her soft, silky pussy, you know she\'s right.\n\n', false );
		MainView.outputText( '"<i>And I\'ll be damned if I do all the work this time,</i>" Aunt Nancy adds, before letting out a satisfied groan at the touch of your lips.', false );
		//[Next Page, Time += 200];
		EngineCore.doNext( this, this.auntNancyPoonPartIV );
	};
	AuntNancy.prototype.auntNancyPoonPartIV = function() {
		MainView.outputText( '', true );
		MainView.outputText( '<b>Two passionate, sticky hours pass...</b>\n\n', false );
