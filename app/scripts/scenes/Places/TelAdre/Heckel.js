...
angular.module( 'cocjs' ).run( function( SceneLib, MainView, Appearance, CockTypesEnum, kFLAGS, Descriptors, CoC, EngineCore ) {
	...
	Heckel.prototype.greetHeckel = function() {
		...
		if( CoC.flags[ kFLAGS.MET_HECKEL ] === 0 ) {
			...
			MainView.outputText( 'When she draws up to you, she slows down long enough to have a conversation.  She smiles at you with a grin that manages to show every single fang, and you realize she caught you staring.  "<i>Fresh meat, huh? I\'m Heckel, the alpha dog around here.</i>"  She extends a large paw toward you as she wipes her face.  You ignore the sweat as you shake hands and introduce yourself.\n\n', false );
			MainView.outputText( '"<i>So, ' + CoC.player.short + ', what can I do for you?  The person working the desk can give you a tour if that\'s what you need... or maybe you were looking for a training partner?  If you can keep up with me, of course.</i>"\n\n', false );
	...
	Heckel.prototype.heckelTraining = function() {
		...
		if( CoC.flags[ kFLAGS.TIMES_FUCKED_HECKEL_BLOWJOB ] + CoC.flags[ kFLAGS.TIMES_FUCKED_HECKEL_ANAL ] === 0 ) {
			...
			//ORAL or LEAVE;
			EngineCore.choices( 'Oral', this, this.heckelOrallyFixated, 'Anal', null, null, 'Be Top Dog', this, dom, '', null, null, 'Leave', SceneLib.camp, SceneLib.camp.returnToCampUseOneHour );
		}
		//FOLLOWUP SECKZ;
		else {
			if( CoC.flags[ kFLAGS.LIFETIME_GYM_MEMBER ] === 0 ) {
			...
			MainView.outputText( 'You know the drill as you follow Heckel into the locker room. You watch her undress before she walks into the shower room, admiring the way her toned ass moves in counterpoint to her tail. She shoots you a fang-filled grin as she disappears around the corner, and you use the opportunity to shed your own clothes.\n\n', false );
			MainView.outputText( 'By the time she comes back into the locker room, you\'re completely naked. She doesn\'t bother to cover herself as she towels her fur off, making the coarse hair stand on end in more than a few places. She tosses the towel aside as she passes you, her black cock already bobbing between her legs. She sits down on one of the simple wooden benches and pats the spot next to her, beckoning you over.\n\n', false );
			MainView.outputText( '"<i>I\'m not gonna mince words,</i>" she says with a snicker. "<i>I need a good fuck and I need it right now. I promise, this is going to be as much of a workout as hitting the track.</i>" As you sit down next to her, she runs a paw up your back and along your neck, eventually draping it over your shoulders. "<i>Now then partner, how are you gonna take this?</i>"\n\n', false );
			if( CoC.player.str > 50 && CoC.player.hasCock() ) {
				MainView.outputText( 'You feel pretty strong yourself, and you realize you could probably arm wrestle this hyena-bitch down to size.' );
				dom = this.dominateHeckel;
			}
			//ORAL or LEAVE;
			EngineCore.choices( 'Oral', this, this.heckelOrallyFixated, 'Anal', this, this.heckelLovesDaAnal, 'Be Top Dog', this, dom, '', null, null, 'Leave', SceneLib.camp, SceneLib.camp.returnToCampUseOneHour );
		}
	};
	//oral;
	Heckel.prototype.heckelOrallyFixated = function() {
		...
		//Repeat;
			...
			MainView.outputText( 'She grunts above you and you feel one of her paws around the back of your head, pushing you lightly with each of your bobs. Her hips begin thrusting lightly against your lips, and you\'re pretty sure you can feel the tip of her cock pushing against the entrance to your stomach. It isn\'t long before you can feel her balls against your chin, your throat distended and stiff with the length of her member.\n\n', false );
			//[<PC IS MALE OR HERM> ;
			if( CoC.player.hasCock() ) {
				MainView.outputText( 'You use one hand to fondle her balls, letting them roll over your fingers and pinching the skin lightly. Your other hand finds its way to your crotch, where you begin stroking your ' + Descriptors.cockDescript( 0 ) + ' in time with her weak thrusts. Within moments you\'ve brought yourself to a stiffening arousal, the cold air making your exposed ' + Descriptors.cockDescript( 0 ) + ' twitch slightly.\n\n', false );
			}//[<PC IS FEMALE>;
	...
	Heckel.prototype.heckelLovesDaAnal = function( loss ) {
		...
		if( CoC.player.analCapacity() <= 20 && !loss ) {
			MainView.outputText( 'Heckel lets out a barking laugh when you suggest using your ' + Descriptors.assDescript() + ', ruffling your hair playfully. "<i>Know your limits, ' + CoC.player.short + ', I\'d tear you apart down there. I\'m sure there are plenty of others in this realm who can help you out with that.</i>"\n\n', false );
			EngineCore.doNext( SceneLib.camp, SceneLib.camp.returnToCampUseOneHour );
			return;
		}
		//success - requires ass to be 'a little loose';
		MainView.outputText( 'Heckel\'s eyes flash as her grin splits her face, and for just a moment you wonder if this might have been a bad idea. Before you can object, however, she\'s pushing you down onto your stomach, your arms and ' + CoC.player.legs() + ' draped over either side of the wooden bench.\n\n', false );
		MainView.outputText( 'You half expect her to just shove herself in right there, but she thankfully holds off. Instead, you feel her rough paws grab and knead either side of your ' + Descriptors.buttDescript() + ' as she lets out a low growl.', false );
		//[<IF TONE OVER 80>;
		if( CoC.player.tone >= 80 ) {
			MainView.outputText( '  "<i>Damn ' + CoC.player.short + ', you\'ve got one hell of an ass. I bet it\'s gonna feel even better than it looks.</i>"', false );
		}
		//[<IF TONE BETWEEN 60-79>;
		else if( CoC.player.tone >= 60 ) {
			MainView.outputText( '  "<i>Mmm, not bad ' + CoC.player.short + ', not perfect, but not bad.</i>"', false );
		}
		MainView.outputText( '\n\n', false );
		MainView.outputText( 'One hand releases your ' + Descriptors.buttDescript() + ' and you can hear the sound of her stroking herself. You start to turn your head around to watch, but she firmly presses you back down against the bench. "<i>Now now partner, I told you to stay there. When you\'re the alpha dog around here, then you can make the rules.</i>" Deciding this treatment isn\'t so bad anyway, you relax and let her hand continue to knead your ' + Descriptors.buttDescript() + '.\n\n', false );
		MainView.outputText( 'The sound of her stroking stops, and you bite your lower lip. You feel the bench shift beneath you as she changes position, and a moment later she pulls both of your asscheeks apart to expose your ' + Descriptors.assholeDescript() + '. You tense for the inevitable penetration, but instead of a hard cockhead poking at your backdoor you feel something warm and wet. Heckel is licking you!\n\n', false );
		MainView.outputText( 'Her large tongue feels like sandpaper as it licks up and down your anus, your spread cheeks exposing you to the world. You can feel her wet nose on your sensitive skin, and the contrast with her warm tongue makes you shiver. Her tongue pokes and prods at your ' + Descriptors.assholeDescript() + ' before slipping painlessly in, swirling expertly around before pulling out and licking some more.\n\n', false );
		//[<IF PC HAS PENIS AND VAGOO> ;
		if( CoC.player.hasCock() && CoC.player.hasVagina() ) {
			MainView.outputText( Descriptors.SMultiCockDesc() + ' is trapped between you and the wooden bench, and you know Heckel won\'t let you shift position to free it. Your ' + Descriptors.vaginaDescript( 0 ) + ' is also being ignored, and having so much pleasure with so little stimulation is driving you crazy. You hump weakly up and down, trying to draw some pleasure out of the bench beneath you while simultaneously pushing her rolling and massaging tongue closer to your aching slit, but she ignores you and only licks deeper. She buries her face in your ass entirely, her cold nose and teeth rubbing up against your sensitive skin as her tongue pushes as far inside of you as she can get it.\n\n', false );
		}//[<IF PC HAS PENIS>;
		else if( CoC.player.hasCock() ) {
			MainView.outputText( Descriptors.SMultiCockDesc() + ' is trapped between you and the wooden bench, and you know Heckel won\'t let you shift position to free it. You hump weakly at the bench in a desperate attempt to get some stimulation, and you can feel the vibrations of Heckel\'s laugh as she buries her snout in your ass. She doesn\'t stop you, but the polished wood barely gives any pleasure anyway.\n\n', false );
		}//[<IF PC HAS VAGOO>;
		else if( CoC.player.hasVagina() ) {
			MainView.outputText( 'Your snatch starts to ache while moisture runs down your groin, and you groan at the lack of attention it\'s receiving. If Heckel notices, she doesn\'t react and keeps swirling her tongue around your hole. You push weakly backwards, hoping to make her drop her tongue down a few inches, but she instead takes this as an opportunity to bury her snout fully between your ass cheecks, her tongue slipping inside you deeper than before.\n\n', false );
		}
		MainView.outputText( 'Even with only a few inches inside your ass, her tongue makes you moan almost immediately. She rolls in back and forth, then side to side, then pushes it in and out before starting the cycle over. The teasing becomes more and more unbearable until you\'re ready to abandon caution and begin masturbating, but just as you tense to change position she stops and pulls her tongue out suddenly.\n\n', false );
		//NEXT;
		EngineCore.doNext( this, this.heckelLovesAnal2 );
		//Increment Anal count;
		CoC.flags[ kFLAGS.TIMES_FUCKED_HECKEL_ANAL ]++;
	};
	Heckel.prototype.heckelLovesAnal2 = function() {
		MainView.outputText( '', true );
		MainView.outputText( 'Her legs bump against yours as she pulls herself up, the contact sending shivers through your sensitive body. "<i>Even better than I thought,</i>" she mumbles as you hear the sound of her stroking herself. Before the wetness around your ass can dry up, you feel something hard and slightly pointed poking the entrance of your ' + Descriptors.assholeDescript() + '.\n\n', false );
		MainView.outputText( 'You open your mouth to gasp as she slides into you, but no sounds come out. You can feel inch after inch penetrate you, your asshole slowly stretching to accommodate her increasing thickness. She pushes as much as she can into you before pulling back slightly, then humping lightly as she works the rest in little by little.', false );
		...
		//[<IF PC IS FEMALE>;
		if( CoC.player.gender === 2 ) {
			MainView.outputText( '  "<i>I\'m going to fuck your ass like you wish I\'d fuck your cunt,</i>"', false );
		}
		//[<IF PC IS MALE OR HERM >;
		else {
			MainView.outputText( '  "<i>I\'m going to ride your ass like you wish you could ride me,</i>"', false );
		}
		MainView.outputText( ' she whispers into your ear. You can\'t help but shiver as she adjusts herself before resuming her pounding, drawing small gasps from you with every thrust.\n\n', false );
		MainView.outputText( 'Her thrusts become faster and shorter as she leaves more of her cock buried inside of you, jackhammering your hole with her last few inches. Something even bigger begins to press against your ' + Descriptors.assholeDescript() + ' as you hear her breathing become faster, her tongue lolling out of her mouth. You forgot about her knot! She doesn\'t let up her speed as she pushes it a little further with every thrust, and you don\'t want to think of how big it must be by now if it grew along with her dick size. She doesn\'t seem deterred however, and all you can do is grunt in pain as it pushes itself further and further.\n\n', false );
		MainView.outputText( 'Heckel suddenly freezes up and bites down on your shoulder, throwing her hips forward. Her knot pushes against your backdoor as she tries to force it in, but your ass just won\'t expand that much. She growls and pushes again, making you yelp as it spreads you even further. It feels like she\'s shoving a melon up there! She growls even louder and bites down harder, and you can feel her dick flare inside you as her knot pushes you further and further apart. You cry out as it passes the midway point, your ass sucking the knot up greedily and contracting around the other side.', false );
		//<ASS BECOMES VERY LOOSE>;
		CoC.player.buttChange( 45, true, true, false );
		MainView.outputText( '\n\n', false );
		//[<HERM PC>;
		if( CoC.player.gender === 3 ) {
			MainView.outputText( 'Heckel wastes no time before going back to her brutal fucking, though her thrusts are limited to short bursts now. She makes up for this in speed as you lie helplessly below her, the pain of taking her knot slowly turning into intense pleasure. The heat and pleasure spreads from your ass to your entire groin, and the knot pushes against the walls of your vagina hard enough to make them rub against each other. Heckel cries out above you and slams her hips into you as much as she can, and you immediately feel a burning heat shooting up your gut. She pumps again as she seeds your insides with another spurt, and this time you orgasm along with her. Your ' + Descriptors.vaginaDescript( 0 ) + ' spasms and gushes over your soaked ' + CoC.player.legs() + ', your asshole spasming around her cock just as much. Your ' + Descriptors.multiCockDescriptLight() + ' soon follows, shooting your own seed up between your ' + Descriptors.chestDesc() + ' and coating your stomach. Even as your orgasm begins to taper off, you can do little more than lie panting in a pool of your own spunk. Your legs quiver beneath hers as the warmth spreads further up your gut, leading you into a warm and hazy afterglow.\n\n', false );
		}
		//[<MALE PC>;
		else if( CoC.player.hasCock() ) {
			MainView.outputText( 'Heckel wastes no time before going back to her brutal fucking, though her thrusts are limited to short bursts now. She makes up for this in speed as you lie helplessly below her, the pain of taking her knot slowly turning into intense pleasure. The heat and pleasure spreads from your ass to your ' + Descriptors.ballsDescriptLight() + ' and cock, making it twitch at your impending orgasm. Heckel cries out above you and slams her hips into you as much as she can, and you immediately feel a burning heat shooting up your gut. She pumps again as she seeds your insides with another spurt, and this time you orgasm along with her.  Your ' + Descriptors.ballsDescriptLight() + ' get tight as your trapped ' + Appearance.cockNoun( CockTypesEnum.HUMAN ) + ' twitches, shooting your cum up between your stomach and chest. Your legs quiver beneath hers as the warmth spread further up your gut, leading you into a warm and hazy afterglow.\n\n', false );
		}//[<FEMALE PC>;
		else if( CoC.player.hasVagina() ) {
			MainView.outputText( 'Heckel wastes no time before going back to her brutal fucking, though her thrusts are limited to short bursts now. She makes up for this in speed as you lie helplessly below her, the pain of taking her knot slowly turning into intense pleasure. The heat and pleasure spreads from your ass to your entire groin, and the knot pushes against the walls of your ' + Descriptors.vaginaDescript() + ' hard enough to make them rub against each other. Heckel cries out above you and slams her hips into you as much as she can, and you immediately feel a burning heat shooting up your gut. She pumps again as she seeds your insides with another spurt, and this time you orgasm along with her. Your ' + Descriptors.vaginaDescript( 0 ) + ' spasms and gushes over your soaked thighs, your asshole spasming around her cock just as much. Your legs quiver beneath hers as the warmth spread further up your gut, leading you into a warm and hazy afterglow.\n\n', false );
		}
		...
		MainView.outputText( 'You lay on the bench for a few moments as Heckel ruffles your hair again. "<i>Not bad, partner. You\'re the best fuck I\'ve had in years, you know that? Not to mention the best workout!</i>"\n\n', false );
		MainView.outputText( 'She laughs as she stands and heads for the shower, letting you clean yourself up and head back to camp.', false );
		CoC.player.orgasm();
		EngineCore.dynStats( 'sen', 4 );
	...
	Heckel.prototype.dominateHeckel = function() {
		MainView.clearOutput();
		MainView.outputText( 'Smirking, you fold your arms and tell her to bend over - ' );
		if( CoC.flags[ kFLAGS.TIMES_DOMMED_HECKEL ] === 0 ) {
			MainView.outputText( 'there\'s a new top dog just waiting to claim the town bitch' );
		} else {
			MainView.outputText( 'you\'re back for a taste of your favorite bitch' );
		}
		MainView.outputText( '.  Heckel snorts, "<i>Nice try, fuck-meat, but ' );
		if( CoC.flags[ kFLAGS.TIMES_DOMMED_HECKEL ] > 0 ) {
			MainView.outputText( 'last time was a fluke' );
		} else {
			MainView.outputText( 'I\'m always on top' );
		}
		MainView.outputText( '.  If you want a squealing submissive to ride, the Wet Bitch is that way,</i>" pointing towards the exit.  Her flaccid dog-dong twitches a little but remains defiantly soft.' );
		...
		MainView.outputText( '?</i>"  Her tough finger-tip slams into your solar plexus for emphasis' );
		if( CoC.player.tou < 60 ) {
			MainView.outputText( ', pushing you back a bit' );
		}
		MainView.outputText( '.' );
	...
	Heckel.prototype.dominateHeckelConclusion = function() {
		...
		if( CoC.flags[ kFLAGS.PC_FETISH ] > 0 ) {
			MainView.outputText( 'You grin and blush hotly, imagining the whole of the gym watching you fuck this hyena, their watchful eyes exciting you further.' );
		} else if( CoC.player.cor < 33 ) {
			MainView.outputText( 'You blush a bit at that, uncomfortable at your sex being so public but unwilling to stop.' );
		} else if( CoC.player.cor < 66 ) {
			MainView.outputText( 'You smirk a little at that while barely acknowledge the worry of being caught nagging at your consciousness.' );
		} else {
			MainView.outputText( 'You grin widely at that and secretly hope that the whole gym will come in to see their \'alpha\' laid low.' );
		}
		MainView.outputText( '  Never stopping their probing motions, your fingertips dance through the hyena\'s sopping passageway, caressing the underswell of her virile nutsack, and occasionally brush the sensitive fur along her inner thighs.  Heckel is squirming and writhing atop the table, dominated by the mere twitches of your digits, a panting bitch in heat just begging for rough impalement on [oneCock].' );
		...
		if( CoC.player.cockTotal() > 2 ) {
			MainView.outputText( ', fanning the others across her neck and forehead, burying her in penis.' );
		} else if( CoC.player.cockTotal() === 2 ) {
			MainView.outputText( ', dropping your [cock smallest] alongside it over her eyes, burying her in penis.' );
		} else {
			MainView.outputText( ', draping her in hard penis.' );
		}
		MainView.outputText( '  She whimpers as you rub your sensitive underside across her nose and pouting lips, looking up at you with what you imagine was supposed to be hatred.  It looks like lust instead.  Slowly stroking yourself while you diddle her, your manhood' );
		if( CoC.player.cockTotal() > 1 ) {
			MainView.outputText( 's throb and thicken' );
		} else {
			MainView.outputText( ' throbs and thickens' );
		}
		MainView.outputText( ' further, too turned on to stop even if you wanted to.  You command her to open with a terse word.  She does, and you slide inside.' );
		...
		if( CoC.player.cumQ() < 250 ) {
			MainView.outputText( 'single drop' );
		} else if( CoC.player.cumQ() < 1000 ) {
			MainView.outputText( 'steady drip' );
		} else {
			MainView.outputText( 'never-ending flow' );
		}
		MainView.outputText( ' of pre-cum onto the muscle-girl\'s tongue.  Her body wriggles happily in acceptance, twitching around your knuckles.  A nice, sticky puddle of her own pre has formed on her well-defined abdominals, still connected to its spigot by a web of glittering, translucent love-juice.  Whimpering, Heckel fairly hums with need, the vibrations of her hungry protests bouncing through your [cock biggest] pleasantly.' );
		...
		if( CoC.player.biggestCockArea() > 40 ) {
			MainView.outputText( 'as much of it as possible' );
		} else {
			MainView.outputText( 'it' );
		}
		MainView.outputText( ' down her throat.  Heckel\'s eyes bulge in disbelief, wildly looking left and right.  Her teeth come down, just barely pricking the skin of your [cock biggest] in warning.  You twist her nipple in a retaliatory strike, opening her throat up with a moaning shriek.' );
		...
		if( CoC.player.balls > 0 ) {
			MainView.outputText( ', basting your [balls] with her steaming warmth' );
		} else if( CoC.player.hasVagina() ) {
			MainView.outputText( ', basting your [vagina] with her steaming warmth' );
		} else {
			MainView.outputText( ', basting your ' + CoC.player.skin() + ' with her steaming warmth' );
		}
		MainView.outputText( '.  You give her a knowing smile, ' + CoC.player.mf( 'man', '\'woman\'' ) + ' to woman, and rock forward, sliding through her puffy labia and into her silky canal.  Those wet hyena-lips cling to every vein and rigid nook of your ' + Descriptors.cockDescript( x ) + ', slurping your penis down the slick tunnel with hungry undulations.' );
		...
		if( CoC.player.cumQ() > 500 ) {
			MainView.outputText( '  Your potent virility does a superb job of seeding Heckel\'s womb, stuffing it nice and full while streamers of white escape around your girth.' );
			if( CoC.player.cumQ() >= 1000 ) {
				MainView.outputText( '  Still, you keep blasting wad after wad of spunk inside her, and her belly rounds nicely, puffed up with virile sperm.' );
			}
			if( CoC.player.cumQ() >= 2000 ) {
				MainView.outputText( '  Your spooge is seemingly without end, pouring out endlessly long after she\'s spunk-gravid and nearly immobile.  The rivers that run from her abused cunt-lips quickly turn the table into a puddle.' );
			}
			if( CoC.player.cumQ() >= 3000 ) {
				MainView.outputText( '  That puddle then drips to the floor to make an alabaster lake' );
				if( CoC.player.cumQ() >= 4000 ) {
					MainView.outputText( ' at least ' );
					if( CoC.player.cumQ() < 10000 ) {
						MainView.outputText( 'a foot deep' );
					} else if( CoC.player.cumQ() < 15000 ) {
						MainView.outputText( 'knee high by most measurements' );
					} else if( CoC.player.cumQ() < 20000 ) {
						MainView.outputText( 'waist high' );
					} else {
						MainView.outputText( 'as high as the table' );
					}
				}
				MainView.outputText( '.  Thank the gods for drains.' );
			}
		}
		if( CoC.player.cockTotal() > 1 ) {
			...
			MainView.outputText( ' as well, turning her hips and thighs into a wonderland of ivory-soaked fur.' );
		}
		...
		if( EngineCore.silly() ) {
			MainView.outputText( '  You grab a bacon shake from the shake-cart on your way out' );
			if( CoC.flags[ kFLAGS.UNKNOWN_FLAG_NUMBER_00281 ] > 0 ) {
				MainView.outputText( ', then give Lottie a high five' );
			}
			MainView.outputText( '.  You really love bacon.' );
		}
		CoC.player.orgasm();
