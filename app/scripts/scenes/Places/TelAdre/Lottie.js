...
angular.module( 'cocjs' ).run( function( SceneLib, Appearance, ConsumableLib, CockTypesEnum, StatusAffects, ImageManager, Descriptors, Utils, kFLAGS, CoC, EngineCore ) {
	...
	Lottie.prototype.encounterLottie = function( charge ) {
		...
		//[REPEAT ENCOUNTER];
			...
			//[Encouragement moved from 31 to 30, regular];
				...
				EngineCore.outputText( '"<i>H-hi ' + CoC.player.short + '... I noticed that you\'re... y-you\'re acting like you do when I do something wrong. Did I do something? P-please, I really don\'t like seeing you so m-mean. Please don\'t be like this.</i>" She forces a smile at her last sentence, though you can tell she\'s incredibly nervous. You raise an eyebrow, but decide not to push the issue further.', false );
				CoC.flags[ kFLAGS.UNKNOWN_FLAG_NUMBER_00300 ] = CoC.flags[ kFLAGS.UNKNOWN_FLAG_NUMBER_00280 ];
			}
			...
			//[Normal Encounter, Encouragement 60 - 100];
				...
				if( CoC.flags[ kFLAGS.UNKNOWN_FLAG_NUMBER_00279 ] <= 20 && CoC.flags[ kFLAGS.UNKNOWN_FLAG_NUMBER_00297 ] === 0 ) {
					EngineCore.outputText( '"<i>Oh, ' + CoC.player.short + '! Let\'s do our best today, I really wanna lose those pounds! I know I can do my best when I\'m with you!</i>" Lottie beams, her massive tits pushed against the table. She seems to be excited for what you\'ve got in store today.', false );
				}
				//[Figure 0 - 20, convinced her to accept body];
				else if( CoC.flags[ kFLAGS.UNKNOWN_FLAG_NUMBER_00279 ] <= 20 ) {
					EngineCore.outputText( '"<i>Hey, ' + CoC.player.mf( 'stud', 'cutie' ) + '! You shouldn\'t keep a big girl like me waiting; unless you wanna get crushed by these!</i>" Lottie grins and grabs her luscious breasts firmly, giggling when she notices you\'re at full attention now. She seems to be excited for what you\'ve got in store today.', false );
				}
				//Figure 20 - 40, haven't convinced her to accept body];
					...
					EngineCore.outputText( '"<i>Ah, ' + CoC.player.short + '! We should probably get started soon; I\'m gonna push myself to the limit today!</i>" Lottie\'s arms are folded over her chest, subconsciously trying to hide her nervousness, though squishing her pillowy tits in the process. She seems to be excited for what you\'ve got in store today.', false );
				}
				//[Figure 20 - 40, convinced her to accept body];
				else if( CoC.flags[ kFLAGS.UNKNOWN_FLAG_NUMBER_00279 ] <= 40 ) {
					EngineCore.outputText( '"<i>Hey, ' + CoC.player.mf( 'stud', 'cutie' ) + '! You shouldn\'t keep me waiting; the only thing I\'m losing right now is my patience!</i>" Lottie grins and punches your arm playfully, squealing when you try to get her back. She seems to be excited for what you\'ve got in store today.', false );
				}
				//[Figure 40 - 60];
				...
				//[Figure 60 - 80];
					...
					EngineCore.outputText( '"<i>Yo, ' + CoC.player.mf( 'big guy', 'babe' ) + '! I\'ve been waiting for you, so you better be pumped! Ready to get started?</i>" Lottie leans over, her creamy tits pushed against the table. She seems to be excited for what you\'ve got in store today.', false );
				}
				//[Figure 80 - 100];
				else {
					EngineCore.outputText( '"<i>Hey, ' + CoC.player.mf( 'stud', 'cutie' ) + '! You shouldn\'t keep me waiting, or I\'ll put you through the burn twice as hard! You ready?</i>" Lottie winks at you and punches your arm playfully. She seems to be excited for what you\'ve got in store today.', false );
				}
			}
			//[Normal Encounter, Encouragement 30 - 60];
				...
				if( CoC.flags[ kFLAGS.UNKNOWN_FLAG_NUMBER_00279 ] <= 20 ) {
					EngineCore.outputText( '"<i>Oh, ' + CoC.player.short + ', hey. I think we should try and get into it today. I don\'t think I tried hard enough last time, y\'know?</i>" Lottie leans over to grab her beverage, her massive tits pushed against the table. She seems to be intent on trying her best today.', false );
				}
				//[Figure 20 - 40];
				else if( CoC.flags[ kFLAGS.UNKNOWN_FLAG_NUMBER_00279 ] <= 40 ) {
					EngineCore.outputText( '"<i>A-ah, ' + CoC.player.short + '! We should probably get started soon; I... I want to push myself to the limit today!</i>" Lottie\'s arms are folded over her chest, subconsciously trying to hide her nervousness, though squishing her pillowy tits in the process. She seems curious as to what you both plan to do today.', false );
				}
				//[Figure 40 - 60];
				else if( CoC.flags[ kFLAGS.UNKNOWN_FLAG_NUMBER_00279 ] <= 60 ) {
				...
				//[Figure 60 - 80];
					...
					EngineCore.outputText( '"<i>Hello ' + CoC.player.short + '! I\'ve... I\'ve been waiting for you, so you better be ready, hey! Don\'t hold back!</i>" Lottie leans over, her creamy tits pushed against the table. She seems to be excited for what you\'ve got in store today.', false );
				}
			}
	...
	Lottie.prototype.analLottieMilkshake = function() {
		...
		EngineCore.outputText( 'You brush her grip off of ' + CoC.player.oMultiCockDesc() + ', only to turn her around and fit your girth between her large cheeks', false );
	...
	Lottie.prototype.getSuckedOffByAHamSandwich = function() {
		...
		EngineCore.outputText( 'You grab Lottie\'s shoulders and firmly move her down towards your crotch. She kneels down, face to face with your ' + Descriptors.cockDescript( x ) + '.  Feeling her hot breath against your ' + CoC.player.skinFurScales() + ', you tell her to suck it.\n\n', false );
		...
		//[If the player has a cock between 5' – 12'];
			...
			if( CoC.player.cockTotal() > 1 ) {
				EngineCore.outputText( ', jerking off your ' + Descriptors.cockDescript( CoC.player.biggestCockIndex2() ) + ' with both hands', false );
			}
		...
		//[If the player has a cock equal to or over 13'];
			...
			EngineCore.outputText( 'She gasps as you lift your ' + Descriptors.cockDescript( x ) + ' and slap her face. "<i>It\'s... wow, ' + CoC.player.short + '!</i>" You grin before poking her pudgy cheek with the tip of your ', false );
			if( CoC.player.cockTotal() > 1 ) {
			...
			if( CoC.player.cockTotal() > 1 ) {
				EngineCore.outputText( ' - using her hands to massage your leftover ' + Descriptors.cockDescript( CoC.player.biggestCockIndex2() ), false );
			}
		...
		EngineCore.outputText( 'cum you\'ve painted on her flesh and gulping it all down. "<i>Thanks for the load, ' + CoC.player.mf( 'big guy', 'babe' ) + ',</i>" she remarks, sucking gently on her fingers. "<i>I\'ll... I\'ll see you again, hey!</i>" You pat her on the head and begin to make your way out of the gym, making sure to grab a ', false );
		if( EngineCore.silly() ) {
			EngineCore.outputText( 'bacon ', false );
		}
		EngineCore.outputText( 'shake on the way out.', false );
	...
	Lottie.prototype.lottieHighMoraleFatYoullGetThereOneTimeEvent = function() {
		...
		EngineCore.outputText( 'The nude pig-girl stands in front of you, turning red at your hungry gaze. "<i>I\'m not comfortable with my body, but... if self confidence is the key to getting what I want, then... will you fuck me, ' + CoC.player.short + '?</i>"\n\n', false );
	...
	Lottie.prototype.lottieYogaAlone = function() {
		...
		EngineCore.outputText( CoC.player.modThickness( 30, 1 ), false );
	...
	Lottie.prototype.jumpInPoolBeforeLottieSeesYourWingWang = function() {
		...
		EngineCore.outputText( CoC.player.modTone( 100, 2 ), false );
	...
	Lottie.prototype.lottieFuck = function() {
		...
		//[If Encouragement 30 – 60];
			...
			EngineCore.outputText( 'You ask Lottie if she\'s keen for a little \'extracurricular workout\', earning a giggle and a tilt of the head from the pig-girl. "<i>What do you mean, ' + CoC.player.mf( 'big guy', 'babe' ) + '?</i>" she asks. You sigh and stand up, revealing your hardening member', false );
			if( CoC.player.cockTotal() > 1 ) {
				EngineCore.outputText( 's', false );
			}
	...
	Lottie.prototype.lottieRepeatQuickie = function() {
		...
		EngineCore.outputText( 'You follow Lottie out into the pool area, waiting as she walks into the dressing room to get changed. When she comes out however, you\'re surprised to find that she hasn\'t changed into anything – in fact, she\'s removed all her clothes entirely!\n\n', false );
		EngineCore.outputText( 'The nude pig-girl stands in front of you, turning red at your hungry gaze. "<i>Will you f-fuck my pussy, ' + CoC.player.short + '?</i>"\n\n', false );
