...
angular.module( 'cocjs' ).run( function( $log, CockTypesEnum, ImageManager, BreastStore, Appearance, ArmorLib, PerkLib, ConsumableLib, Descriptors, Utils, kFLAGS, CoC, EngineCore ) {
	function Rubi() {
	}

	Rubi.prototype.rubiSprite = function() {
		if( CoC.getInstance().flags[ kFLAGS.RUBI_HORNTYPE ] > 0 ) {
	...
	Rubi.prototype.initializeRubi = function() {
		if( CoC.getInstance().flags[ kFLAGS.RUBI_BIMBO ] === 0 ) {
			CoC.getInstance().flags[ kFLAGS.RUBI_BREAST_SIZE ] = 0;
			CoC.getInstance().flags[ kFLAGS.RUBI_COCK_SIZE ] = 5;
			CoC.getInstance().flags[ kFLAGS.RUBI_NO_CUNT ] = 1;
		} else {
			CoC.getInstance().flags[ kFLAGS.RUBI_BREAST_SIZE ] = 7;
			CoC.getInstance().flags[ kFLAGS.RUBI_NO_CUNT ] = 0;
			CoC.getInstance().flags[ kFLAGS.RUBI_COCK_SIZE ] = 0;
			CoC.getInstance().flags[ kFLAGS.RUBI_SHE ] = 1;
			CoC.getInstance().flags[ kFLAGS.RUBI_HAIR ] = 1;
		}
		CoC.getInstance().flags[ kFLAGS.RUBI_SETUP ] = 1;
	};
	Rubi.prototype.rubiBalls = function() {
		return 'normal';
	};
	Rubi.prototype.rubiBimbo = function() {
		return (CoC.getInstance().flags[ kFLAGS.RUBI_BIMBO ] > 0);
	};
	Rubi.prototype.rubiIncubus = function() {
		return (CoC.getInstance().flags[ kFLAGS.RUBI_INCUBUS_PROGRESS ] === 3);
	};
	Rubi.prototype.rubiAffection = function( delt ) {
		if( delt === undefined || delt === 0 ) {
			return CoC.getInstance().flags[ kFLAGS.RUBI_AFFECTION ];
		}
		CoC.getInstance().flags[ kFLAGS.RUBI_AFFECTION ] += delt;
		if( CoC.getInstance().flags[ kFLAGS.RUBI_AFFECTION ] > 100 ) {
			CoC.getInstance().flags[ kFLAGS.RUBI_AFFECTION ] = 100;
		} else if( CoC.getInstance().flags[ kFLAGS.RUBI_AFFECTION ] < 0 ) {
			CoC.getInstance().flags[ kFLAGS.RUBI_AFFECTION ] = 0;
		}
		return CoC.getInstance().flags[ kFLAGS.RUBI_AFFECTION ];
	};
	Rubi.prototype.rubiCock = function( lust ) {
		var cumQ = 300;
		if( CoC.getInstance().flags[ kFLAGS.RUBI_BLU_BALLS ] < 4 ) {
			cumQ = 10;
		} else if( CoC.getInstance().flags[ kFLAGS.RUBI_BLU_BALLS ] <= 6 ) {
			cumQ = 150;
		}
		return Appearance.cockDescription( this.rubiGetCockType(), CoC.getInstance().flags[ kFLAGS.RUBI_COCK_SIZE ], CoC.getInstance().flags[ kFLAGS.RUBI_COCK_SIZE ] / 6, lust === undefined ? 50 : lust, cumQ );
	};
	Rubi.prototype.rubiGetCockType = function() {
		return CockTypesEnum.ParseConstantByIndex( CoC.getInstance().flags[ kFLAGS.RUBI_COCK_TYPE ] );
	};
	Rubi.prototype.rubiBreasts = function() {
		var ret = 'pair of ';

		if( CoC.getInstance().flags[ kFLAGS.RUBI_BREAST_SIZE ] < 1 ) {
			ret = 'chest';
		} else {
			ret += Appearance.breastCup( CoC.getInstance().flags[ kFLAGS.RUBI_BREAST_SIZE ] );
			ret += ' ';
			ret += BreastStore.breastDescript( CoC.getInstance().flags[ kFLAGS.RUBI_BREAST_SIZE ] );
		}
		return ret;
	};
	...
	Rubi.prototype.rubiCapacity = function() {
		var bonus = CoC.getInstance().flags[ kFLAGS.RUBI_TIMES_ANALLY_TRAINED ] * 10;
		if( bonus > 76 ) {
			bonus = 76;
		}
	...
	Rubi.prototype.rubiMF = function( man, woman ) {
		if( CoC.getInstance().flags[ kFLAGS.RUBI_ADMITTED_GENDER ] < 1 ) {
			return woman;
		} else {
			if( CoC.getInstance().flags[ kFLAGS.RUBI_SHE ] === 1 ) {
				return woman;
			} else {
				return man;
			}
	...
	Rubi.prototype.specialRelationship20scene = function() {
		...
		CoC.getInstance().flags[ kFLAGS.RUBI_ADMITTED_GENDER ] = 1;
		//(Accept) or (Reject);
	...
	Rubi.prototype.rejectRubi = function() {
		...
		CoC.getInstance().flags[ kFLAGS.RUBI_DISABLED ] = 1;
		EngineCore.doNext( CoC.getInstance().scenes.camp.returnToCampUseOneHour );
	};

	//Bakery Intro scenes;
	Rubi.prototype.rubiIntros = function() {
		if( CoC.getInstance().flags[ kFLAGS.RUBI_SETUP ] === 0 ) {
			this.initializeRubi();
		}
		if( CoC.getInstance().flags[ kFLAGS.RUBI_DISABLED ] > 0 || CoC.getInstance().flags[ kFLAGS.RUBI_PROSTITUTION ] === -2 ) {
			return null;
		}
		EngineCore.outputText( '\n' );
		//(Haven't met yet);
		...
		else if( this.rubiBimbo() && CoC.getInstance().flags[ kFLAGS.RUBI_PROSTITUTION ] === 0 && Utils.rand( 9 ) === 0 ) {
		...
		} else if( this.rubiBimbo() && CoC.getInstance().flags[ kFLAGS.RUBI_DEBIMBO ] === 0 ) {
	...
	Rubi.prototype.approachRubiScenes = function() {
		...
		if( CoC.getInstance().flags[ kFLAGS.RUBI_INTRODUCED ] === 0 ) {
			...
			CoC.getInstance().flags[ kFLAGS.RUBI_INTRODUCED ]++;
		}
		...
		//(Approach repeat, relationship 20+.  At this stage, randomly select an outfit from what the PC has given him, plus his waitress outfit.  Variants included for Bimbo /Incubus Rubi.);
			...
			var choices = [ 1 ];
			if( CoC.getInstance().flags[ kFLAGS.RUBI_SUITCLOTHES ] === 1 ) {
				choices[ choices.length ] = 2;
			}
			if( CoC.getInstance().flags[ kFLAGS.RUBI_FETISH_CLOTHES ] === 1 ) {
			...
			if( CoC.getInstance().flags[ kFLAGS.RUBI_GREEN_ADVENTURER ] === 1 ) {
				choices[ choices.length ] = 4;
			}
			//(Tube Top (Normal));
			if( CoC.getInstance().flags[ kFLAGS.RUBI_TUBE_TOP ] === 1 ) {
				choices[ choices.length ] = 5;
			}
			//(Bodysuit (Normal));
			if( CoC.getInstance().flags[ kFLAGS.RUBI_BODYSUIT ] === 1 ) {
				choices[ choices.length ] = 6;
			}
			//(Long Dress (Normal));
			if( CoC.getInstance().flags[ kFLAGS.RUBI_LONGDRESS ] === 1 ) {
				choices[ choices.length ] = 7;
			}
			//(Tight Leather Pants (Normal));
			if( CoC.getInstance().flags[ kFLAGS.RUBI_TIGHT_PANTS ] === 1 ) {
				choices[ choices.length ] = 8;
			}
			//(Nurse Clothes (Normal));
			if( CoC.getInstance().flags[ kFLAGS.RUBI_NURSE_CLOTHES ] === 1 ) {
				choices[ choices.length ] = 9;
			}
			//(Slutty Swimwear (Normal));
			if( CoC.getInstance().flags[ kFLAGS.RUBI_SWIMWEAR ] === 1 ) {
				choices[ choices.length ] = 10;
			}
			if( CoC.getInstance().flags[ kFLAGS.RUBI_BIMBO_MINIDRESS ] === 1 ) {
				choices[ choices.length ] = 11;
			}
			if( CoC.getInstance().flags[ kFLAGS.RUBI_BONDAGE_STRAPS ] === 1 ) {
				choices[ choices.length ] = 12;
			}
			if( CoC.getInstance().flags[ kFLAGS.RUBI_INQUISITORS_CORSET ] === 1 ) {
			...
			//(Suit Clothes (Normal));
				...
				if( CoC.getInstance().flags[ kFLAGS.RUBI_NIPPLE_TYPE ] > 0 ) {
				...
				//(dick 9" or higher);
				if( CoC.getInstance().flags[ kFLAGS.RUBI_COCK_SIZE ] >= 4 ) {
				...
				} else if( CoC.getInstance().flags[ kFLAGS.RUBI_COCK_SIZE ] > 0 ) {
			...
			//(Slutty Swimwear (Normal));
				...
				} else if( CoC.getInstance().flags[ kFLAGS.RUBI_BREAST_SIZE ] <= 1 ) {
			...
			//(Minidress Outfit (Bimbo));
				...
				if( CoC.getInstance().flags[ kFLAGS.RUBI_COCK_SIZE ] > 0 ) {
			...
			//(Risque Waitress Uniform);
				...
				if( CoC.getInstance().flags[ kFLAGS.RUBI_NO_CUNT ] === 0 && CoC.getInstance().flags[ kFLAGS.RUBI_COCK_SIZE ] > 0 ) {
					EngineCore.outputText( ' and ' );
				}
				if( CoC.getInstance().flags[ kFLAGS.RUBI_NO_CUNT ] === 0 ) {
					EngineCore.outputText( 'feminine mound trapped beneath a pair of pink panties' );
					//(if Bimbo Brain);
					if( this.rubiBimbo() && CoC.getInstance().flags[ kFLAGS.RUBI_DEBIMBO ] === 0 ) {
			...
			if( select === 1 ) {
				...
				if( this.rubiBimbo() && CoC.getInstance().flags[ kFLAGS.RUBI_DEBIMBO ] === 0 ) {
					...
					} else if( CoC.getInstance().flags[ kFLAGS.RUBI_NO_CUNT ] > 0 && CoC.getInstance().flags[ kFLAGS.RUBI_COCK_SIZE ] > 0 ) {
		...
		var tea = null;
		var milk = null;
		if( CoC.getInstance().player.gems >= 6 ) {
			tea = this.getTeaFromRubi;
		} else {
			EngineCore.outputText( '\n<b>You cannot afford tea.</b>' );
		}
		if( CoC.getInstance().player.gems >= 3 ) {
		...
		EngineCore.choices( 'Milk', milk, 'Tea', tea, 'Chat', this.chatWithRubi, 'Rubi\'s Place', place, 'Leave', CoC.getInstance().scenes.telAdre.bakeryScene.bakeryuuuuuu );
	};
	//Choose Milk?;
	Rubi.prototype.buyRubiMilk = function() {
		...
		CoC.getInstance().player.gems -= 3;
		this.rubiAffection( 3 );
		CoC.getInstance().player.modThickness( 100, 1 );
		if( this.rubiAffection() >= 30 && CoC.getInstance().flags[ kFLAGS.RUBI_ADMITTED_GENDER ] === 0 ) {
	...
	Rubi.prototype.rubisFuckingHouseYouPervert = function() {
		...
		//(First Time?);
		if( CoC.getInstance().flags[ kFLAGS.RUBIS_HOUSE_FIRST_TIME ] === 0 ) {
			...
			CoC.getInstance().flags[ kFLAGS.RUBIS_HOUSE_FIRST_TIME ]++;
		}
		//Bimbo Shopping!;
		else if( this.rubiBimbo() && (CoC.getInstance().player.findPerk( PerkLib.BimboBrains ) >= 0 || CoC.getInstance().player.findPerk( PerkLib.FutaFaculties ) >= 0) && Utils.rand( 7 ) === 0 ) {
			CoC.getInstance().flags[ kFLAGS.RUBI_BIMBO_MINIDRESS ] = 1;
			...
			if( CoC.getInstance().flags[ kFLAGS.RUBI_GOT_BIMBO_SKIRT ] === 0 ) {
		...
		//(Repeat, Bimbo Rubi);
			...
			if( CoC.getInstance().flags[ kFLAGS.RUBI_PROSTITUTION ] === 2 && CoC.getInstance().flags[ kFLAGS.RUBI_PROFIT ] > 0 ) {
				...
				CoC.getInstance().player.gems += CoC.getInstance().flags[ kFLAGS.RUBI_PROFIT ];
				CoC.getInstance().flags[ kFLAGS.RUBI_PROFIT ] = 0;
		...
		if( this.rubiAffection() >= 50 && !this.rubiBimbo() && CoC.getInstance().flags[ kFLAGS.RUBI_COCK_SIZE ] > 0 && (!this.rubiBimbo() || CoC.getInstance().flags[ kFLAGS.RUBI_DEBIMBO ] > 0) ) {
			//First Time:;
			if( CoC.getInstance().flags[ kFLAGS.TIMES_RUBI_MASSAGED ] === 0 ) {
		...
		if( CoC.getInstance().player.isNaga() && CoC.getInstance().flags[ kFLAGS.RUBI_BIMBO ] === 0 && CoC.getInstance().flags[ kFLAGS.RUBI_COCK_SIZE ] < CoC.getInstance().player.biggestCockLength() && CoC.getInstance().player.hasCock() && CoC.getInstance().flags[ kFLAGS.RUBI_SHE ] === 0 && CoC.getInstance().player.cor >= 85 && CoC.getInstance().flags[ kFLAGS.RUBI_BREAST_SIZE ] <= 2 ) {
	...
	Rubi.prototype.rubiSexMenu = function() {
		...
		if( CoC.getInstance().player.lust >= 33 ) {
			if( CoC.getInstance().player.hasCock() || (CoC.getInstance().player.hasVagina() && CoC.getInstance().player.clitLength >= 4) ) {
		...
		if( CoC.getInstance().flags[ kFLAGS.RUBI_BLU_BALLS ] > 0 && CoC.getInstance().flags[ kFLAGS.RUBI_ORGASM_DENIAL ] > 0 && !this.rubiBimbo() && CoC.getInstance().flags[ kFLAGS.RUBI_COCK_SIZE ] > 0 ) {
			EngineCore.addButton( 3, 'Release', this.releaseRubi );
		}
		if( CoC.getInstance().flags[ kFLAGS.RUBI_AFFECTION ] >= 75 && this.rubiCapacity() < CoC.getInstance().player.biggestCockArea() && CoC.getInstance().player.hasCock() ) {
		...
		if( CoC.getInstance().flags[ kFLAGS.RUBI_AFFECTION ] >= 75 && CoC.getInstance().flags[ kFLAGS.RUBI_COCK_SIZE ] >= 5 ) {
	...
	Rubi.prototype.rubiIdentity = function() {
		...
		this.rubiSprite();
		//Identity;
		if( CoC.getInstance().flags[ kFLAGS.TIMES_DISCUSSED_RUBIS_IDENTITY ] === 0 ) {
			EngineCore.outputText( 'You\'ve noticed Rubi always refers to himself as a "he", despite ' );
			if( CoC.getInstance().flags[ kFLAGS.RUBI_NO_CUNT ] === 1 ) {
		...
		CoC.getInstance().flags[ kFLAGS.TIMES_DISCUSSED_RUBIS_IDENTITY ]++;
		//[He] [She];
		EngineCore.menu();
	...
	Rubi.prototype.rubiIsAHe = function() {
		EngineCore.clearOutput();
		this.rubiSprite();
		CoC.getInstance().flags[ kFLAGS.RUBI_SHE ] = 0;
	...
	Rubi.prototype.fuckRubi = function() {
		...
		var x;
		x = CoC.getInstance().player.cockThatFits( this.rubiCapacity() );
		if( x < 0 ) {
		...
		if( CoC.getInstance().player.hasCock() ) {
			if( CoC.getInstance().player.cocks[ x ].cockLength <= 4 ) {
				size = 0;
			} else if( CoC.getInstance().player.cockThatFits( this.rubiCapacity() ) >= 0 ) {
				size = 1;
			} else {
				size = 2;
			}
			...
			if( CoC.getInstance().player.clitLength <= 4 ) {
				size = 0;
			} else if( CoC.getInstance().player.clitLength <= 12 || CoC.getInstance().flags[ kFLAGS.HYPER_HAPPY ] ) {
				size = 1;
			} else {
				size = 2;
			}
		...
		if( size === 0 ) {
			...
			if( CoC.getInstance().flags[ kFLAGS.RUBI_COCK_SIZE ] <= 5 ) {
		...
		if( CoC.getInstance().flags[ kFLAGS.RUBI_ORGASM_DENIAL ] > 0 && !this.rubiBimbo() ) {
		...
		if( CoC.getInstance().player.hasCock() && CoC.getInstance().player.cockArea( x ) <= this.rubiCapacity() ) {
		...
		if( CoC.getInstance().flags[ kFLAGS.RUBI_ORGASM_DENIAL ] > 0 ) {
			CoC.getInstance().flags[ kFLAGS.RUBI_BLU_BALLS ]++;
		}
	};
	//Dildo Fuck;
	...
	Rubi.prototype.dildoFuckRubi = function() {
		...
		//(Orgasm Denial on?);
		if( CoC.getInstance().flags[ kFLAGS.RUBI_ORGASM_DENIAL ] > 0 ) {
			EngineCore.outputText( '\n\nIn a sudden moment of clarity, you raise your head and look straight at Rubi, shouting that [rubi ey]\'d better not cum during all this, or else you\'ll be quite upset.  [rubi Eir] eyes go wide, "<i>W—What?  I need to cum, ' + CoC.getInstance().player.mf( 'sir', 'miss' ) + '!  My body, it\'s so hot!</i>"  You growl that it\'s expressly forbidden, and that [rubi ey]\'d better learn to control [rubi em]self, or else.' );
		}
		...
		this.rubiAffection( 1 );
		if( CoC.getInstance().flags[ kFLAGS.RUBI_ORGASM_DENIAL ] > 0 ) {
			CoC.getInstance().flags[ kFLAGS.RUBI_BLU_BALLS ] += 2;
		}
		EngineCore.doNext( CoC.getInstance().scenes.camp.returnToCampUseOneHour );
	};
	//Tease;
	Rubi.prototype.teaseRubi = function() {
		...
		CoC.getInstance().flags[ kFLAGS.RUBI_ORGASM_DENIAL ] = 1;
		if( CoC.getInstance().flags[ kFLAGS.RUBI_COCK_SIZE ] > 0 ) {
			...
			if( CoC.getInstance().flags[ kFLAGS.RUBI_SKIN ] === 0 ) {
				EngineCore.outputText( 'pale' );
			} else if( CoC.getInstance().flags[ kFLAGS.RUBI_SKIN ] === 2 ) {
			...
			EngineCore.outputText( '\n\n"<i>Nnng,</i>" Rubi grunts, gripping the couch cushions.  You make sure to remind [rubi em] [rubi ey] can\'t cum under any circumstances.  [rubi Ey] nods, and says, "<i>Y—Yes ' + CoC.getInstance().player.mf( 'sir', 'miss' ) + '.</i>"' );
			...
			EngineCore.outputText( '\n\n"<i>Aah, ' + CoC.getInstance().player.mf( 'sir', 'miss' ) + ', I can\'t take much more of this,</i>" [rubi ey] says, half way between a whisper and a moan.' );
		...
		//Girl Rubi!;
			...
			if( CoC.getInstance().flags[ kFLAGS.RUBI_SKIN ] === 0 ) {
				EngineCore.outputText( 'pale' );
			} else if( CoC.getInstance().flags[ kFLAGS.RUBI_SKIN ] === 1 ) {
	...
	Rubi.prototype.releaseRubi = function() {
		...
		CoC.getInstance().flags[ kFLAGS.RUBI_ORGASM_DENIAL ] = 0;
		...
		//(If Blueballs 1-3);
		if( CoC.getInstance().flags[ kFLAGS.RUBI_BLU_BALLS ] <= 3 ) {
			EngineCore.outputText( '  Not to mention [rubi eir] tiny balls' );
			if( CoC.getInstance().flags[ kFLAGS.RUBI_BALLS_TYPE ] === 1 ) {
		...
		//(if Blueballs 4-9);
		else if( CoC.getInstance().flags[ kFLAGS.RUBI_BLU_BALLS ] <= 9 ) {
		...
		//(Blueballs 4-5);
		else if( CoC.getInstance().flags[ kFLAGS.RUBI_BLU_BALLS ] <= 5 ) {
		...
		//(Blueballs 6-7);
		else if( CoC.getInstance().flags[ kFLAGS.RUBI_BLU_BALLS ] <= 7 ) {
		...
		//(Blueballs 1-5);
		if( CoC.getInstance().flags[ kFLAGS.RUBI_BLU_BALLS ] <= 5 ) {
		...
		this.rubiAffection( CoC.getInstance().flags[ kFLAGS.RUBI_BLU_BALLS ] );
		CoC.getInstance().flags[ kFLAGS.RUBI_BLU_BALLS ] = 0;
		CoC.getInstance().flags[ kFLAGS.RUBI_ORGASM_DENIAL ] = 0;
		EngineCore.doNext( CoC.getInstance().scenes.camp.returnToCampUseOneHour );
	};
	//Cheating Rubi;
	...
	Rubi.prototype.interruptTheNTRsYouCrazyFool = function() {
		...
		if( CoC.getInstance().player.str >= 61 ) {
			...
			if( CoC.getInstance().player.spe < 61 ) {
	...
	Rubi.prototype.noBimboNTR = function() {
		...
		CoC.getInstance().flags[ kFLAGS.RUBI_PROSTITUTION ] = -1;
		EngineCore.doNext( CoC.getInstance().scenes.camp.returnToCampUseOneHour );
	};
	//(Yes);
	...
	Rubi.prototype.breakUpWithRubi = function() {
		...
		CoC.getInstance().flags[ kFLAGS.RUBI_PROSTITUTION ] = -2;
		CoC.getInstance().flags[ kFLAGS.RUBI_DISABLED ] = 1;
		EngineCore.doNext( CoC.getInstance().scenes.camp.returnToCampUseOneHour );
	};
	//(Pimp);
	...
	Rubi.prototype.chocoRubiMassage = function() {
		...
		} else if( CoC.getInstance().flags[ kFLAGS.RUBI_BLU_BALLS ] < 8 ) {
		...
		CoC.getInstance().flags[ kFLAGS.TIMES_RUBI_MASSAGED ]++;
		//[Release] [Nope];
	...
	Rubi.prototype.rubiAppearance = function() {
		...
		if( CoC.getInstance().flags[ kFLAGS.RUBI_WHISKERS ] > 0 ) {
		...
		//(normal/furry skin);
		if( CoC.getInstance().flags[ kFLAGS.RUBI_SKIN ] === 0 || CoC.getInstance().flags[ kFLAGS.RUBI_SKIN ] === 2 ) {
		...
		//if(CoC.getInstance().flags[kFLAGS.RUBI_EYE_TYPE] === 1) EngineCore.outputText('slitted ');;
		if( CoC.getInstance().flags[ kFLAGS.RUBI_EYE_TYPE ] === 0 || this.rubiBimbo() ) {
			EngineCore.outputText( 'green' );
		} else if( CoC.getInstance().flags[ kFLAGS.RUBI_EYE_TYPE ] === 1 ) {
		...
		if( CoC.getInstance().flags[ kFLAGS.RUBI_EAR_TYPE ] === 0 ) {
		...
		} else if( CoC.getInstance().flags[ kFLAGS.RUBI_EAR_TYPE ] === 1 ) {
		...
		} else if( CoC.getInstance().flags[ kFLAGS.RUBI_EAR_TYPE ] === 2 ) {
		...
		if( CoC.getInstance().flags[ kFLAGS.RUBI_NIPPLE_TYPE ] === 1 ) {
			EngineCore.outputText( 'black ' );
		}
		EngineCore.outputText( 'nipples.' );
		EngineCore.outputText( '\n\nBetween [rubi eir] legs is a ' );
		if( CoC.getInstance().flags[ kFLAGS.RUBI_COCK_SIZE ] > 0 ) {
			EngineCore.outputText( this.rubiCock() + ', which starts to perk up under your scrutiny. From experience, you know it can reach a impressive ' + CoC.getInstance().flags[ kFLAGS.RUBI_COCK_SIZE ] + ' inches when erect.  ' );
			EngineCore.outputText( 'Under [rubi eir] cock swings a set of ' );
			if( CoC.getInstance().flags[ kFLAGS.RUBI_BLU_BALLS ] >= 4 && CoC.getInstance().flags[ kFLAGS.RUBI_BLU_BALLS ] < 9 ) {
		...
		if( CoC.getInstance().flags[ kFLAGS.RUBI_COCK_SIZE ] > 0 && CoC.getInstance().flags[ kFLAGS.RUBI_NO_CUNT ] === 0 ) {
			EngineCore.outputText( ' and a ' );
		}
		if( CoC.getInstance().flags[ kFLAGS.RUBI_NO_CUNT ] === 0 ) {
			EngineCore.outputText( 'cute ' );
			if( CoC.getInstance().flags[ kFLAGS.RUBI_CUNTTYPE ] > 0 ) {
				EngineCore.outputText( 'black ' );
			}
		...
		if( CoC.getInstance().flags[ kFLAGS.RUBI_FEET ] === 1 ) {
	...
	Rubi.prototype.goOnAnAnalAdventureRubiNotReallyJustAnAdventurersOutfit = function() {
		...
		if( CoC.getInstance().flags[ kFLAGS.RUBI_EAR_TYPE ] === 1 ) {
	...
	Rubi.prototype.giveRubiALongDressToHideHerHideousBody = function() {
		...
		if( CoC.getInstance().flags[ kFLAGS.RUBI_SKIN ] === 1 || CoC.getInstance().flags[ kFLAGS.RUBI_SKIN ] === 3 ) {
	...
	Rubi.prototype.rubiPutsOnNursesClothesSoSheCanCheckYourTemperature = function() {
		...
		if( CoC.getInstance().flags[ kFLAGS.RUBI_FEET ] > 0 ) {
	...
	Rubi.prototype.putOnATubeTopYouWhore = function() {
		...
		if( CoC.getInstance().flags[ kFLAGS.RUBI_BREAST_SIZE ] > 2 ) {
	...
	Rubi.prototype.putOnSluttySwimwearYouSkank = function() {
		...
		if( CoC.getInstance().flags[ kFLAGS.RUBI_BREAST_SIZE ] < 3 ) {
	...
	Rubi.prototype.dateIntro = function( date ) {
		...
		this.rubiSprite();
		//(First Time);
		if( CoC.getInstance().flags[ kFLAGS.TIMES_RUBI_DATED ] === 0 ) {
		...
		CoC.getInstance().flags[ kFLAGS.TIMES_RUBI_DATED ]++;
	...
	Rubi.prototype.iceCreamDate = function() {
		...
		if( CoC.getInstance().flags[ kFLAGS.RUBI_AFFECTION ] >= 100 && CoC.getInstance().flags[ kFLAGS.RUBI_ICECREAM_CONFESSION ] === 0 ) {
			...
			CoC.getInstance().flags[ kFLAGS.RUBI_ICECREAM_CONFESSION ]++;
		}
	...
	Rubi.prototype.fancyDate = function() {
		...
		if( CoC.getInstance().player.gems >= 10 ) {
			...
			if( CoC.getInstance().flags[ kFLAGS.RUBI_AFFECTION ] >= 100 && CoC.getInstance().flags[ kFLAGS.RUBI_FANCY_CONFESSION ] === 0 ) {
				...
				CoC.getInstance().flags[ kFLAGS.RUBI_FANCY_CONFESSION ]++;
			}
			...
			//(if PC has met Callu);
			if( CoC.getInstance().flags[ kFLAGS.MET_OTTERGIRL ] === 1 ) {
	...
	Rubi.prototype.barDate = function() {
		...
		//(If Relationship 100, happens once);
		if( CoC.getInstance().flags[ kFLAGS.RUBI_AFFECTION ] >= 100 && CoC.getInstance().flags[ kFLAGS.RUBI_BAR_CONFESSION ] === 0 ) {
			...
			CoC.getInstance().flags[ kFLAGS.RUBI_BAR_CONFESSION ]++;
		}
	...
	Rubi.prototype.anallyTrainYourBitchBoySlutHowToBeAnalForDCL = function() {
		EngineCore.clearOutput();
		this.rubiSprite();
		CoC.getInstance().flags[ kFLAGS.RUBI_TIMES_ANALLY_TRAINED ]++;
		//First Time;
		if( CoC.getInstance().flags[ kFLAGS.RUBI_TIMES_ANALLY_TRAINED ] === 1 ) {
			...
			EngineCore.dynStats( 'lus', 20 + CoC.getInstance().player.lib / 5, 'resisted', false );
		}
		//Repeatable;
		//Must have a cock greater than Rubi's capacity.;
		//Rubi's capacity won't go larger than 100.;
			...
			} else if( CoC.getInstance().flags[ kFLAGS.RUBI_SKIN ] === 1 || CoC.getInstance().flags[ kFLAGS.RUBI_SKIN ] === 3 ) {
	...
	Rubi.prototype.getFuckedByRubi = function() {
		...
		if( CoC.getInstance().flags[ kFLAGS.RUBI_EYE_TYPE ] > 0 ) {
		...
		if( !CoC.getInstance().player.hasVagina() ) {
			CoC.getInstance().player.buttChange( CoC.getInstance().flags[ kFLAGS.RUBI_COCK_SIZE ] * CoC.getInstance().flags[ kFLAGS.RUBI_COCK_SIZE ] / 6, true, true, false );
		} else {
			CoC.getInstance().player.cuntChange( CoC.getInstance().flags[ kFLAGS.RUBI_COCK_SIZE ] * CoC.getInstance().flags[ kFLAGS.RUBI_COCK_SIZE ] / 6, true, true, false );
		}
	...
	Rubi.prototype.popButtjobs = function() {
		...
		EngineCore.outputText( '\n\n"<i>No, babe, I\'m lucky to have found you,</i>" [rubi ey] says, snuggling [rubi eir] naked body up against yours as the two of you drift off into a lazy, sex-induced nap.' );
		CoC.getInstance().player.orgasm();
		CoC.getInstance().flags[ kFLAGS.RUBI_BLU_BALLS ] = 0; //Since he just came so he should be cured of blue balls
		EngineCore.doNext( CoC.getInstance().scenes.camp.returnToCampUseOneHour );
	};
	//Give Item;
	...
	Rubi.prototype.giveRubiATFItem = function( itype ) {
		...
		if( CoC.getInstance().flags[ kFLAGS.RUBI_TIMES_GIVEN_AN_ITEM ] === 0 ) {
		...
		CoC.getInstance().flags[ kFLAGS.RUBI_TIMES_GIVEN_AN_ITEM ]++;
		//[go to TF scene];
		//Succubus Milk;
		if( itype === ConsumableLib.SUCMILK || itype === ConsumableLib.P_S_MLK ) {
			...
			if( CoC.getInstance().flags[ kFLAGS.RUBI_BREAST_SIZE ] < 7 || (CoC.getInstance().flags[ kFLAGS.RUBI_BREAST_SIZE ] < 30 && CoC.getInstance().flags[ kFLAGS.HYPER_HAPPY ]) ) {
				...
				CoC.getInstance().flags[ kFLAGS.RUBI_BREAST_SIZE ]++;
			}
			//(If Penis size decreases);
			if( (CoC.getInstance().flags[ kFLAGS.RUBI_COCK_SIZE ] > 4) && (!CoC.getInstance().flags[ kFLAGS.HYPER_HAPPY ]) ) {
				...
				CoC.getInstance().flags[ kFLAGS.RUBI_COCK_SIZE ]--;
				EngineCore.outputText( Math.round( CoC.getInstance().flags[ kFLAGS.RUBI_COCK_SIZE ] * 10 ) / 10 + '-inch penis.' );
			}
			//(If Penis is removed);
			else if( CoC.getInstance().flags[ kFLAGS.RUBI_COCK_SIZE ] <= 4 && CoC.getInstance().flags[ kFLAGS.RUBI_COCK_SIZE ] > 0 ) {
				...
				if( CoC.getInstance().flags[ kFLAGS.RUBI_NO_CUNT ] === 1 ) {
					...
					CoC.getInstance().flags[ kFLAGS.RUBI_NO_CUNT ] = 0;
					CoC.getInstance().flags[ kFLAGS.RUBI_SHE ] = 1;
					CoC.getInstance().flags[ kFLAGS.RUBI_CUNTTYPE ] = 0;
				}
			}
			//(If Rubi randomly gets vagina);
			if( Utils.rand( 3 ) === 0 && CoC.getInstance().flags[ kFLAGS.RUBI_NO_CUNT ] > 0 ) {
			...
			if( CoC.getInstance().flags[ kFLAGS.RUBI_FEET ] === 0 && Utils.rand( 3 ) === 0 && itype === ConsumableLib.SUCMILK ) {
				...
				CoC.getInstance().flags[ kFLAGS.RUBI_FEET ] = 1;
			}
			//(If Rubi gets horns);
			if( Utils.rand( 3 ) === 0 && CoC.getInstance().flags[ kFLAGS.RUBI_HORNTYPE ] === 0 && itype === ConsumableLib.SUCMILK ) {
				...
				CoC.getInstance().flags[ kFLAGS.RUBI_HORNTYPE ] = 1;
			}
			//(If Rubi gets red skin);
			if( Utils.rand( 3 ) === 0 && CoC.getInstance().flags[ kFLAGS.RUBI_SKIN ] !== 1 && itype === ConsumableLib.SUCMILK ) {
				...
				CoC.getInstance().flags[ kFLAGS.RUBI_SKIN ] = 1;
			}
			...
			if( (CoC.getInstance().flags[ kFLAGS.RUBI_BREAST_SIZE ] > 0) && (!CoC.getInstance().flags[ kFLAGS.HYPER_HAPPY ]) ) {
				...
				CoC.getInstance().flags[ kFLAGS.RUBI_BREAST_SIZE ]--;
				if( CoC.getInstance().flags[ kFLAGS.RUBI_BREAST_SIZE ] < 0 ) {
					CoC.getInstance().flags[ kFLAGS.RUBI_BREAST_SIZE ] = 0;
				}
			}
			//(If Penis size increases);
			if( CoC.getInstance().flags[ kFLAGS.RUBI_COCK_SIZE ] > 0 && ((CoC.getInstance().flags[ kFLAGS.RUBI_COCK_SIZE ] < 12 || (this.rubiGetCockType() === CockTypesEnum.HORSE && CoC.getInstance().flags[ kFLAGS.RUBI_COCK_SIZE ] < 20)) ||
				(CoC.getInstance().flags[ kFLAGS.RUBI_COCK_SIZE ] < 30 && CoC.getInstance().flags[ kFLAGS.HYPER_HAPPY ]) ) ) {
			...
			//(If Vagina removed);
			if( CoC.getInstance().flags[ kFLAGS.RUBI_NO_CUNT ] === 0 && Utils.rand( 3 ) === 0 ) {
			...
			//(If Rubi gets red skin);
			if( Utils.rand( 3 ) === 0 && CoC.getInstance().flags[ kFLAGS.RUBI_SKIN ] !== 1 && itype === ConsumableLib.INCUBID ) {
				EngineCore.outputText( '\n\nRubi clutches [rubi eir] stomach suddenly as you notice red spots appearing on [rubi eir] ' );
				if( CoC.getInstance().flags[ kFLAGS.RUBI_SKIN ] !== 2 ) {
					EngineCore.outputText( 'skin' );
				} else {
			...
			//(If Rubi gets horns);
			if( Utils.rand( 3 ) === 0 && CoC.getInstance().flags[ kFLAGS.RUBI_HORNTYPE ] === 0 && itype === ConsumableLib.INCUBID ) {
				EngineCore.outputText( '\n\nRubi\'s hands suddenly dart up, clutching [rubi eir] head as though [rubi ey] has a massive headache.  [rubi Ey] feels around blindly, trying to locate the source of the pain, and then you see it.  Two small bulges appear on [rubi eir] forehead, just at the hairline.  They grow larger and larger until the skin splits cleanly open revealing shiny black bone.  Horns.  They grow up and backwards, forming light ridges.  They don\'t quite grow completely past [rubi eir] head, however, before the growth stops.  Rubi calms and stands.  [rubi Eir] hands roam over every inch of [rubi eir] new addition as glances in the mirror, marveling at [rubi eir] demonic appearance.' );
				CoC.getInstance().flags[ kFLAGS.RUBI_HORNTYPE ] = 1;
			}
		}
		...
		//Bimbo Liqueur (Modified for variant genders);
			...
			CoC.getInstance().flags[ kFLAGS.RUBI_HAIR_LENGTH ] = 2;
			//(If Rubi has a Penis);
			if( CoC.getInstance().flags[ kFLAGS.RUBI_COCK_SIZE ] > 0 ) {
			...
			//(if boobs <E);
			if( CoC.getInstance().flags[ kFLAGS.RUBI_BREAST_SIZE ] < 7 ) {
			...
			CoC.getInstance().flags[ kFLAGS.RUBI_SHE ] = 1;
			CoC.getInstance().flags[ kFLAGS.RUBI_BIMBO ] = 1;
			CoC.getInstance().flags[ kFLAGS.RUBI_HAIR ] = 1;
			this.rubiSexMenu();
			EngineCore.addButton( 9, 'Leave', CoC.getInstance().scenes.camp.returnToCampUseOneHour );
			return;
		...
		//Grows cock. (As Incubus Draft above);
			...
			if( this.rubiGetCockType() !== CockTypesEnum.HORSE ) {
				...
				CoC.getInstance().flags[ kFLAGS.RUBI_COCK_TYPE ] = CockTypesEnum.HORSE;
				...
				CoC.getInstance().flags[ kFLAGS.RUBI_COCK_SIZE ] += 3 + Utils.rand( 5 );
			}
		}
		//Trap Oil;
			...
			//(If Bust size decreases);
			if( (CoC.getInstance().flags[ kFLAGS.RUBI_BREAST_SIZE ] > 1) && (!CoC.getInstance().flags[ kFLAGS.HYPER_HAPPY ]) ) {
				EngineCore.outputText( '\n\nRubi gasps a little and [rubi eir] hands immediately dart to [rubi eir] chest.  Before your eyes, Rubi\'s breasts begin to dwindle, shrinking down an entire cup size.  Rubi cups [rubi eir] breasts experimentally, getting used to their new, reduced, weight.' );
				CoC.getInstance().flags[ kFLAGS.RUBI_BREAST_SIZE ]--;
				if( CoC.getInstance().flags[ kFLAGS.RUBI_BREAST_SIZE ] < 1 ) {
					CoC.getInstance().flags[ kFLAGS.RUBI_BREAST_SIZE ] = 1;
				}
			}
			//(If Bust size increases);
			else if( CoC.getInstance().flags[ kFLAGS.RUBI_BREAST_SIZE ] < 1 ) {
			...
			//(If Penis size decreases);
			else if( (CoC.getInstance().flags[ kFLAGS.RUBI_COCK_SIZE ] > 3) && (!CoC.getInstance().flags[ kFLAGS.HYPER_HAPPY ]) ) {
				EngineCore.outputText( '\n\nRubi\'s [rubi cock] swells up suddenly, growing painfully hard.  [rubi Ey] grasps it and moans suddenly as it begins to dwindle in size, shrinking down by at least an inch, leaving [rubi em] with a ' );
				CoC.getInstance().flags[ kFLAGS.RUBI_COCK_SIZE ]--;
				if( CoC.getInstance().flags[ kFLAGS.RUBI_COCK_SIZE ] < 3 ) {
					CoC.getInstance().flags[ kFLAGS.RUBI_COCK_SIZE ] = 3;
				}
				EngineCore.outputText( Math.round( CoC.getInstance().flags[ kFLAGS.RUBI_COCK_SIZE ] * 10 ) / 10 + '-inch penis.' );
			}
			//(Trappy ballsack);
			else if( CoC.getInstance().flags[ kFLAGS.RUBI_BALLS_TYPE ] > 0 ) {
				...
				CoC.getInstance().flags[ kFLAGS.RUBI_BALLS_TYPE ] = 1;
			}
			//(Black Nipples);
			else if( CoC.getInstance().flags[ kFLAGS.RUBI_NIPPLE_TYPE ] !== 1 ) {
				...
				CoC.getInstance().flags[ kFLAGS.RUBI_NIPPLE_TYPE ] = 1;
			}
			//(Black Eyes);
			else if( CoC.getInstance().flags[ kFLAGS.RUBI_EYE_TYPE ] !== 1 ) {
				...
				CoC.getInstance().flags[ kFLAGS.RUBI_EYE_TYPE ] = 1;
			} else {
		...
		//Progression of furriness: cat ears, then whiskers and paws, then cat penis, then furry body.;
			...
			if( CoC.getInstance().flags[ kFLAGS.RUBI_EAR_TYPE ] !== 1 ) {
				...
				CoC.getInstance().flags[ kFLAGS.RUBI_EAR_TYPE ] = 1;
			}
			//(Gaining Whiskers and Paws);
			else if( CoC.getInstance().flags[ kFLAGS.RUBI_WHISKERS ] !== 1 || CoC.getInstance().flags[ kFLAGS.RUBI_HANDS ] !== 1 ) {
				...
				CoC.getInstance().flags[ kFLAGS.RUBI_WHISKERS ] = 1;
				CoC.getInstance().flags[ kFLAGS.RUBI_HANDS ] = 1;
			} else if( CoC.getInstance().flags[ kFLAGS.RUBI_LOWERBODY ] !== 1 ) {
				...
				CoC.getInstance().flags[ kFLAGS.RUBI_LOWERBODY ] = 1;
			}
			//(Gaining Cat Penis);
			else if( this.rubiGetCockType() !== CockTypesEnum.CAT && CoC.getInstance().flags[ kFLAGS.RUBI_COCK_SIZE ] > 0 ) {
				...
				CoC.getInstance().flags[ kFLAGS.RUBI_COCK_TYPE ] = CockTypesEnum.CAT;
			}
			//(Gaining Fur);
			else if( CoC.getInstance().flags[ kFLAGS.RUBI_SKIN ] !== 2 ) {
				...
				CoC.getInstance().flags[ kFLAGS.RUBI_SKIN ] = 2;
			}
		}
		//Purity Peach;
		if( itype === ConsumableLib.PURPEAC ) {
			...
			//(Any changes? Yes);
			if( CoC.getInstance().flags[ kFLAGS.RUBI_EAR_TYPE ] !== 2 || CoC.getInstance().flags[ kFLAGS.RUBI_SKIN ] !== 3 || (CoC.getInstance().flags[ kFLAGS.RUBI_COCK_SIZE ] > 0 && this.rubiGetCockType() !== CockTypesEnum.TENTACLE) ) {
				EngineCore.outputText( '\n\nRubi\'s eyes suddenly dart open and [rubi ey] clutches [rubi eir] stomach.  "<i>Oh gods...  My belly feels so warm all of a sudden.</i>"' );
				//(Feathery ears);
				if( CoC.getInstance().flags[ kFLAGS.RUBI_EAR_TYPE ] !== 2 ) {
					...
					CoC.getInstance().flags[ kFLAGS.RUBI_EAR_TYPE ] = 2;
				}
				//(Shark Skin);
				else if( CoC.getInstance().flags[ kFLAGS.RUBI_SKIN ] !== 3 ) {
					...
					CoC.getInstance().flags[ kFLAGS.RUBI_SKIN ] = 3;
				}
				//(Anemone Penis, must have a penis);
				else if( CoC.getInstance().flags[ kFLAGS.RUBI_COCK_SIZE ] > 0 && this.rubiGetCockType() !== CockTypesEnum.ANEMONE ) {
				...
				CoC.getInstance().flags[ kFLAGS.RUBI_COCK_TYPE ] = CockTypesEnum.ANEMONE;
			}
			//(No);
			else {
	...
	Rubi.prototype.rubiGrowPlusBreasts = function() {
		...
		if( CoC.getInstance().flags[ kFLAGS.RUBI_BREAST_SIZE ] < 7 || (CoC.getInstance().flags[ kFLAGS.RUBI_BREAST_SIZE ] < 30 && CoC.getInstance().flags[ kFLAGS.HYPER_HAPPY ]) ) {
			...
			CoC.getInstance().flags[ kFLAGS.RUBI_BREAST_SIZE ] += 2 + Utils.rand( 2 );
			if( CoC.getInstance().flags[ kFLAGS.HYPER_HAPPY ] ) {
				// trace('Hyper happy grow');;
				if( CoC.getInstance().flags[ kFLAGS.RUBI_BREAST_SIZE ] > 30 ) {
					CoC.getInstance().flags[ kFLAGS.RUBI_BREAST_SIZE ] = 30;
				}
			} else {
				// trace('Normal grow');;
				if( CoC.getInstance().flags[ kFLAGS.RUBI_BREAST_SIZE ] > 7 ) {
	...
	Rubi.prototype.rubiPenisGroPlus = function() {
		...
		//(If Penis increase);
		if( CoC.getInstance().flags[ kFLAGS.RUBI_COCK_SIZE ] < 12 || (this.rubiGetCockType() === CockTypesEnum.HORSE && CoC.getInstance().flags[ kFLAGS.RUBI_COCK_SIZE ] < 20) || (CoC.getInstance().flags[ kFLAGS.RUBI_COCK_SIZE ] < 30 && CoC.getInstance().flags[ kFLAGS.HYPER_HAPPY ]) ) {
			...
			CoC.getInstance().flags[ kFLAGS.RUBI_COCK_SIZE ] += 2 + Utils.rand( 2 );
			if( CoC.getInstance().flags[ kFLAGS.HYPER_HAPPY ] ) {
				if( CoC.getInstance().flags[ kFLAGS.RUBI_COCK_SIZE ] > 30 ) {
					// trace('Limiting Rubi\'s Cock-Size');;
					CoC.getInstance().flags[ kFLAGS.RUBI_COCK_SIZE ] = 30;
				}
			} else {
				if( this.rubiGetCockType() !== CockTypesEnum.HORSE ) {
					if( CoC.getInstance().flags[ kFLAGS.RUBI_COCK_SIZE ] > 12 ) {
						CoC.getInstance().flags[ kFLAGS.RUBI_COCK_SIZE ] = 12;
					}
				} else {
					if( CoC.getInstance().flags[ kFLAGS.RUBI_COCK_SIZE ] > 20 ) {
						CoC.getInstance().flags[ kFLAGS.RUBI_COCK_SIZE ] = 20;
					}
				}
			}
		} else {
	...
	Rubi.prototype.pickAnItemToFeedRubi = function() {
		...
		if( CoC.getInstance().flags[ kFLAGS.RUBI_SUITCLOTHES ] === 1 ) {
			...
			if( CoC.getInstance().player.hasItem( ArmorLib.CLSSYCL ) ) {
		...
		if( CoC.getInstance().flags[ kFLAGS.RUBI_FETISH_CLOTHES ] === 1 ) {
			...
			if( CoC.getInstance().player.hasItem( ArmorLib.RBBRCLT ) ) {
		...
		if( CoC.getInstance().flags[ kFLAGS.RUBI_GREEN_ADVENTURER ] === 1 ) {
			...
			if( CoC.getInstance().player.hasItem( ArmorLib.ADVCLTH ) ) {
		...
		if( CoC.getInstance().flags[ kFLAGS.RUBI_TUBE_TOP ] === 1 ) {
			...
			if( CoC.getInstance().player.hasItem( ArmorLib.TUBETOP ) ) {
		...
		if( CoC.getInstance().flags[ kFLAGS.RUBI_BODYSUIT ] === 1 ) {
			...
			if( CoC.getInstance().player.hasItem( ArmorLib.T_BSUIT ) ) {
		...
		if( CoC.getInstance().flags[ kFLAGS.RUBI_LONGDRESS ] === 1 ) {
			...
			if( CoC.getInstance().player.hasItem( ArmorLib.B_DRESS ) ) {
		...
		if( CoC.getInstance().flags[ kFLAGS.RUBI_TIGHT_PANTS ] === 1 ) {
			...
			if( CoC.getInstance().player.hasItem( ArmorLib.LTHRPNT ) ) {
		...
		if( CoC.getInstance().flags[ kFLAGS.RUBI_NURSE_CLOTHES ] === 1 ) {
			...
			if( CoC.getInstance().player.hasItem( ArmorLib.NURSECL ) ) {
		...
		if( CoC.getInstance().flags[ kFLAGS.RUBI_SWIMWEAR ] === 1 ) {
			...
			if( CoC.getInstance().player.hasItem( ArmorLib.S_SWMWR ) ) {
		...
		if( CoC.getInstance().flags[ kFLAGS.RUBI_BONDAGE_STRAPS ] === 1 ) {
			...
			if( CoC.getInstance().player.hasItem( ArmorLib.BONSTRP ) ) {
		...
		if( CoC.getInstance().flags[ kFLAGS.RUBI_INQUISITORS_CORSET ] === 1 ) {
			...
			if( CoC.getInstance().player.hasItem( ArmorLib.I_CORST ) ) {
		...
		if( CoC.getInstance().player.hasItem( ConsumableLib.BIMBOLQ ) && !this.rubiBimbo() ) {
		...
		if( CoC.getInstance().player.hasItem( ConsumableLib.PURPEAC, 5 ) ) {
		...
		if( CoC.getInstance().player.hasItem( ConsumableLib.W_FRUIT ) ) {
		...
		if( CoC.getInstance().player.hasItem( ConsumableLib.TRAPOIL ) ) {
	...
	Rubi.prototype.giveRubiClothes = function( itype ) {
		...
		if( itype === ArmorLib.CLSSYCL ) {
			CoC.getInstance().flags[ kFLAGS.RUBI_SUITCLOTHES ] = 1;
		} else if( itype === ArmorLib.RBBRCLT ) {
			CoC.getInstance().flags[ kFLAGS.RUBI_FETISH_CLOTHES ] = 1;
		} else if( itype === ArmorLib.ADVCLTH ) {
			CoC.getInstance().flags[ kFLAGS.RUBI_GREEN_ADVENTURER ] = 1;
		} else if( itype === ArmorLib.TUBETOP ) {
			CoC.getInstance().flags[ kFLAGS.RUBI_TUBE_TOP ] = 1;
		} else if( itype === ArmorLib.T_BSUIT ) {
			CoC.getInstance().flags[ kFLAGS.RUBI_BODYSUIT ] = 1;
		} else if( itype === ArmorLib.B_DRESS ) {
			CoC.getInstance().flags[ kFLAGS.RUBI_LONGDRESS ] = 1;
		} else if( itype === ArmorLib.LTHRPNT ) {
			CoC.getInstance().flags[ kFLAGS.RUBI_TIGHT_PANTS ] = 1;
		} else if( itype === ArmorLib.NURSECL ) {
			CoC.getInstance().flags[ kFLAGS.RUBI_NURSE_CLOTHES ] = 1;
		} else if( itype === ArmorLib.S_SWMWR ) {
			CoC.getInstance().flags[ kFLAGS.RUBI_SWIMWEAR ] = 1;
		} else if( itype === ArmorLib.I_CORST ) {
			CoC.getInstance().flags[ kFLAGS.RUBI_INQUISITORS_CORSET ] = 1;
		} else if( itype === ArmorLib.BONSTRP ) {
			CoC.getInstance().flags[ kFLAGS.RUBI_BONDAGE_STRAPS ] = 1;
		}
	...
	Rubi.prototype.hypnoBimboficationForRubiSloots = function() {
		...
		} else if( CoC.getInstance().flags[ kFLAGS.RUBI_NO_CUNT ] > 0 ) {
		...
		CoC.getInstance().flags[ kFLAGS.RUBI_BIMBO ] = 1;
		CoC.getInstance().flags[ kFLAGS.RUBI_SHE ] = 1;
		CoC.getInstance().flags[ kFLAGS.RUBI_BREAST_SIZE ] = 5;
		//Sex menu;
		EngineCore.dynStats( 'lus', 1000, 'cor', 10 );
		this.rubiSexMenu();
		this.rubiAffection( 100 );
	};
	CoC.getInstance().registerScene( 'rubi', new Rubi() );
} );