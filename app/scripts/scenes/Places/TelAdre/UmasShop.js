...
angular.module( 'cocjs' ).run( function( StatusAffects, PerkLib, Descriptors, Utils, kFLAGS, CoC, EngineCore ) {
	...
	UmasShop.prototype.applyMassageBonus = function( selectedMassage ) {
		if( selectedMassage < 0 || selectedMassage > 4 ) {
			...
			if( selectedMassage === UmasShop.MASSAGE_RELIEF ) {
				...
				EngineCore.outputText( '<b>You feel so... wired! Your skin tingles with the slightest breeze, your heart races in your chest, and you lick your lips with eager nervousness.  You wanna fuck something so badly!</b> ' + MASSAGE_LUST_BONUS_TEXT );
				bonusValue = UmasShop.MASSAGE_LUST_BONUS;
			} else if( selectedMassage === UmasShop.MASSAGE_MODELLING ) {
				EngineCore.outputText( '<b>You feel sexier; you don\'t know if the massage has actually affected your looks, but you definitely have the confidence to strut your stuff!</b> ' + MASSAGE_MODELLING_BONUS_TEXT );
				bonusValue = UmasShop.MASSAGE_MODELLING_BONUS;
			} else if( selectedMassage === UmasShop.MASSAGE_RELAXATION ) {
				EngineCore.outputText( '<b>Your aches and pains have vanished, and you feel so relaxed and rested.  That really did the trick in curing what ails you.</b> ' + MASSAGE_RELAXATION_BONUS_TEXT );
				bonusValue = UmasShop.MASSAGE_RELAXATION_BONUS;
			} else if( selectedMassage === UmasShop.MASSAGE_POWER ) {
				EngineCore.outputText( '<b>Your muscles tingle and burn with energy; you feel like you could knock out a minotaur in one punch!</b> ' + MASSAGE_POWER_BONUS_TEXT );
	...
	UmasShop.prototype.talkLoppesFirstBoyfriend = function() {
		...
		EngineCore.outputText( '"<i>No, EngineCore.silly.  He asked her out.</i>"\n\n' );
