...
angular.module( 'cocjs' ).run( function( SceneLib, MainView, ImageManager, StatusAffects, kFLAGS, Descriptors, CoC, EngineCore ) {
	...
	Brooke.prototype.tribadism = function() {
		...
		if( CoC.player.gender === 3 ) {
			...
			EngineCore.outputText( ' your ' + CoC.player.skinFurScales() + '.  The tone of her ass almost makes you wish you had a dick to fuck her with, but you\'re sure she\'ll give you a hell of a ride all the same.' );
		}
		...
		EngineCore.outputText( '.  You start to fuck against her in earnest, pressing and pumping, sliding and bucking against her, loving and living for the sounds and expressions she makes as you love her the way only another ' + CoC.player.mf( 'woman', '\'woman\'' ) + ' can.' );
