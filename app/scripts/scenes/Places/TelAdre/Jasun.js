...
angular.module( 'cocjs' ).run( function( SceneLib, kFLAGS, CoC, EngineCore ) {
	...
	Jasun.prototype.meetJasun = function() {
		...
		if( CoC.getInstance().flags[ kFLAGS.UNKNOWN_FLAG_NUMBER_00179 ] === 0 ) {
			CoC.getInstance().flags[ kFLAGS.UNKNOWN_FLAG_NUMBER_00179 ]++;
			...
			//IF FEMALE;
				...
				if( CoC.getInstance().player.armorName !== 'slutty swimwear' ) {
		...
		//Met Jasun but not boned!;
		else if( CoC.getInstance().flags[ kFLAGS.UNKNOWN_FLAG_NUMBER_00179 ] > 0 && CoC.getInstance().flags[ kFLAGS.UNKNOWN_FLAG_NUMBER_00180 ] === 0 ) {
			if( CoC.getInstance().flags[ kFLAGS.UNKNOWN_FLAG_NUMBER_00181 ] === 0 ) {
				...
				CoC.getInstance().flags[ kFLAGS.UNKNOWN_FLAG_NUMBER_00181 ]++;
			}
			//If you're a dude.;
			if( CoC.getInstance().player.gender <= 1 ) {
			...
			if( CoC.getInstance().player.tone < 75 || CoC.getInstance().player.armorName !== 'slutty swimwear' ) {
				...
				EngineCore.outputText( '"<i>' + CoC.getInstance().player.short + ', you know, I still don\'t think you\'re quite ready to swim with me. That\'s fine, and it\'s entirely up to you, but I think today I should probably swim alone. You can come and visit me anytime, of course, maybe when you\'re ', false );
				if( CoC.getInstance().player.tone < 75 ) {
					EngineCore.outputText( 'fit enough', false );
				} else if( CoC.getInstance().player.armorName !== 'slutty swimwear' ) {
	...
	Jasun.prototype.meetJasun2 = function() {
		...
		EngineCore.outputText( '"<i>My name is Jasun, ' + CoC.getInstance().player.short + '. My people love the water, but most of them are ferocious and have lost their way. Seeing as I could no longer stay with them without risking my own life constantly, I came to Tel\'Adre and set about working with the gym here to set up this wondrous pool. I spend most of my time here. Not many people get to use it, but I think you are ready.</i>" He smiles at you without baring his teeth and you\'re flattered, knowing how difficult that must be for something with his jaw structure. "<i>Come, let\'s swim.</i>" He puts out his hand, palm up, literally asking for your hand for him to take you into the water.\n\n', false );
		CoC.getInstance().flags[ kFLAGS.UNKNOWN_FLAG_NUMBER_00181 ] = 1;
		//[Accept] [Turn Away];
	...
	Jasun.prototype.jasunSecks = function() {
		...
		if( CoC.getInstance().flags[ kFLAGS.UNKNOWN_FLAG_NUMBER_00180 ] === 0 ) {
