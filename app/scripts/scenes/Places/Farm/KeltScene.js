...
angular.module( 'cocjs' ).run( function( SceneLib, $log, AppearanceDefs, CockTypesEnum, ImageManager, PregnancyStore, StatusAffects, Utils, Descriptors, CoC, EngineCore ) {
	...
	KeltScene.prototype.keltFirstTime = function() {
		...
		EngineCore.outputText( 'As you get closer, however, the figure comes into view.  The rider is not Whitney, but rather a muscular man.  And the horse has no head... where its head should be is... with a start, you realize that this is no horse and rider.  The figure is a large, male centaur!\r\r', false );
		EngineCore.outputText( 'Wariness growing, you slow down.  But it is too late... the centaur has seen you.  With a snort, he gallops closer, imposingly tall.  You drop into a fighting stance, ready if he should attack you, and the centaur draws to a halt a few feet away.\r\rHe looks scornfully at you, and laughs, ', false );
		EngineCore.outputText( '"<i>Don\'t be stupid.  You\'d never even get close to me.  If I wanted to kill you, you would have been dead a long time ago.  My name is Kelt.</i>"\r\r', false );
	...
	KeltScene.prototype.keltRequiresNakedness = function() {
		EngineCore.outputText( 'Once more, you encounter Kelt the centaur at Whitney\'s farm.  You approach him to ask for another archery lesson, but Kelt is already scowling at you as you draw near.\r\r', false );
		EngineCore.outputText( '"<i>I can\'t teach you like this,</i>" he sneers.  "<i>Your balance is all fucked up.  I know colts who can shoot better than you.  You really want to learn the skill?  Then you\'re gonna have to practice like a centaur.  You\'d never see me wearing armor!</i>"\r\r', false );
	...
	KeltScene.prototype.keltEagerlyGetNaked = function() {
		...
		if( CoC.player.gender === 1 && CoC.player.biggestTitSize() < 1 ) {
			...
			if( CoC.player.biggestTitSize() === 0 ) {
				...
				EngineCore.outputText( '"<i>Oooh, doesn\'t that look yummy?  Be honest... you wanna learn to shoot?  You\'ll be slapping yourself in the tits with every shot!  Heh... I bet that\'s the way you like it too!  Time to change your profession, slut.  Wet nurse and milk cow... they\'re just about all you\'re suited for!</i>"\r\r', false );
			}
		}
		...
		//(Big, Voluminous and beyond:;
			...
			EngineCore.outputText( '"<i>Now there\'s a rear end I could get behind!  For someone who claims to be a hero, you sure are built like a fucktoy!  With an ass like that, you remind me of my last lay... of course, she was a horse!</i>"\r\r', false );
		}
		...
		if( CoC.player.totalCocks() === 0 ) {
			...
			//(Big Size, 21 inches and beyond:;
				...
				EngineCore.outputText( '"Now if only they could find a way to get you to stop stepping on your own cock every other step, maybe you\'d be a real man!  Can you even get it up, at this point?  Or would that tip you over?  Ha!</i>"\r\r', false );
			}
		}
	...
	KeltScene.prototype.keltRequiresBlowjobs = function() {
		...
		EngineCore.outputText( 'You blink, startled.  While you were thinking, Kelt approached you, and you were staring directly at his crotch.  He leers down at you with an arrogant grin.  Flushed, you stammer out that you\'re here for more archery lessons.  He snorts, clearly amused.\r\r', false );
		EngineCore.outputText( '"<i>Yeah, I\'ll bet.  When they talk about firing shafts, whore, they\'re talking about arrows.  Bet you would prefer the other kind though, huh?</i>"\r\r', false );
		EngineCore.outputText( 'He paces around you, in an almost predatory fashion.  His thick flanks brush up against you, and the smell of him is so potent you feel a little dizzy.  Heady and musky, the scent is like a keen aphrodisiac, cutting straight to your core.  You whimper a little, and Kelt raises an eyebrow.  Is it you, or does he almost look satisfied?\r\r', false );
	...
	KeltScene.prototype.keltBlowjobRequirementNever = function( newl ) {
		...
		EngineCore.outputText( 'You struggle, trying to hold onto your fragmented thoughts. Something about Kelt\'s scent, or presence, is overwhelming.  The temptation to give in is almost overpowering, but you set your teeth, close your eyes, and furiously try to ignore your hammering heart.\r\r', false );
		EngineCore.outputText( 'Kelt\'s feet move almost uncertainly, hooves pawing at the ground and resetting themselves.  He almost seems confused for a moment, hips bucking forward experimentally.  When there is no further sensation, his confusion begins to be replaced by anger.\r\r', false );
		EngineCore.outputText( 'He spends a few moments cursing you, swollen cock still sometimes pumping forward as though expecting you to latch on at any moment. The centaur is obviously unused to rejection.  The temptation bites harder than ever as his cruel words shame you.  Wouldn\'t it be easier to just give in?  To give this powerful male what he wants, so he\'ll like you again?  The cock hovers teasingly within reach, just waiting to give you a glorious taste... but you fight the alien urge, and keep your mouth shut.\r\r', false );
		EngineCore.outputText( 'You have just a moment to react, as the tone suddenly shifts.  Kelt, who has been stomping and cussing angrily, has decided on a new target.  Training remembered, you roll to the side just as Kelt rears and brings his front two hooves down where your head was moments earlier.\r\r', false );
		EngineCore.outputText( 'Kelt moves towards you, eyes blazing, and you drop into a crouched stance automatically.  Even so, you are overwhelmed by another blow to the face as Kelt furiously lashes out at you.  You scramble to defend yourself, but the attack, such as it was, is over as soon as it began.  The abusive centaur is already moving away, frustration clear with every step.\r\r', false );
		EngineCore.outputText( '"<i>Stupid slut.  Refuse me, huh?  ME?  Well FUCK you and the [legs] you walked in on!  You wanna shoot arrows, go learn how to do it yourself!  Better idea... go to the fucking desert, find a demon, and fucking BEG him to make you his ass slave.  Go on!  Fuck off, slut!</i>"\r\r', false );
	...
	KeltScene.prototype.keltBlowjobRequirementShamefully = function( newl ) {
		...
		EngineCore.outputText( 'Leaning forward, you lap meekly at the head, tasting his precum on the tip of your tongue.  The salty, gooey ooze sets your senses on fire with need... have you ever tasted something so wonderful?  A second taste begets a third, and a fourth, and soon enough, you have stretched your lips wide to suck in that swollen head, intent on slurping every little drop you can.\r\r', false );
		EngineCore.outputText( 'The head of the massive cock barely fits between your lips, but the creaking of your jaws is worth it as your mouth is filled with the taste of Kelt\'s seed.  You nurse at it, almost hungrily, and wince as you feel a splurt of it plaster your throat.  The crude thought of what you are doing is painful, but you cannot help taking pleasure in the hot taste of centaur cum.  It is like a reward for giving up every ounce of pride you had.\r\r', false );
		EngineCore.outputText( 'Kelt does not give you long to mourn your loss.  One of his hooves paws restlessly at the ground, animalistic, as he pushes his hips forward once again.  You gag slightly as the flared head rams into the back of your throat insistently.  Hoping to give some relief to your impatient abuser, you begin masturbating the length of his cock with your hands, even while suckling on the tip.  His underside shivers a little with pleasure, and you feel a shaming little burst of pleasure for pleasing him.\r\r', false );
		EngineCore.outputText( '"<i>Mmm...I knew it from the moment I saw you.  Quite the talented little cocksucker you are.  Deeper, bitch.  I want you to choke on my spunk.</i>"\r\r', false );
	...
	KeltScene.prototype.keltMainEncounter = function() {
		...
		if( CoC.player.statusAffectv2( StatusAffects.Kelt ) <= 30 ) {
			...
			EngineCore.outputText( 'You nod enthusiastically, almost begging him to teach you.  ', false );
		}
		...
		//(Naked Off);
			...
			//(Otherwise: ;
				...
				//(Otherwise: ;
					...
					EngineCore.outputText( 'You ignore his barbed comments as best as you can, and soon enough, he leaves the matter alone, instead critiquing your archery skills.\r\r', false );
				}
			}
		}
		this.keltMainEncounter2();
	...
	KeltScene.prototype.keltMainEncounter2 = function() {
		...
		//(Bow equipped);
			...
			EngineCore.outputText( 'Kelt sneers as he looks at your bow, "<i>You\'re still using that rotten old thing?  Well, it will do.  We\'ll just have to shoot for the close targets.</i>"\r\r', false );
	...
	KeltScene.prototype.keltMainEncounter3 = function() {
		...
		if( CoC.player.findStatusAffect( StatusAffects.NakedOn ) < 0 ) {
			...
			//(25% Chance: ;
			if( temp === 0 ) {
				EngineCore.outputText( '"<i>Oh, yes.  Looks like you\'re shaping up to be a pretty accurate archer.  Just make sure you only fight blind giants.  You know, massive targets that have no chance to dodge.  You\'ll do fine.</i>"\r\r', false );
			}
			//(25% Chance: ;
			if( temp === 1 ) {
				EngineCore.outputText( '"<i>Ha!  You want to become an archer?  Here\'s a hint... stop thinking about sucking cock for two seconds and AIM.</i>"\r\r', false );
			}
			//(25% Chance: ;
			if( temp === 2 ) {
				EngineCore.outputText( '"<i>See the red dot, in the middle of the target?  Imagine that\'s your ass, and the arrow is a big, fat, minotaur cock.  That should help you hit the target.</i>"\r\r', false );
			}
			//(25% Chance: ;
			if( temp === 3 ) {
		...
		//NAKERS;
			...
			if( CoC.player.inHeat && CoC.player.gender > 1 ) {
				...
				EngineCore.outputText( 'You lean over to pluck the arrow from the haystack, and feel a sharp blow to the back of your head, knocking you over and sending your consciousness spinning.  Dizzily, you realize Kelt is standing over you, tossing aside the bow he just used to crack you in the head.  Between his horse legs, a massive manhood is dropping from his sheath, flanked by testes the size of softballs.  A lewd grin is on his face.\r\r', false );
				...
				if( CoC.player.statusAffectv2( StatusAffects.Kelt ) <= 30 ) {
					...
					EngineCore.outputText( 'The masculine scent of him is overpowering, desperate.  Your body wants nothing more than to submit to Kelt\'s ferocious desires, and your mind agrees.  Eagerly, you thrust your hips up, reaching back with one hand to guide his cock to your wet pussy.  Kelt snorts his approval, and you feel a shivering tremor of lust run through you.\r\r', false );
				}
			...
			if( temporary === 3 ) {
				...
				if( CoC.player.biggestTitSize() <= 5 ) {
					...
					EngineCore.outputText( '"<i>Look at you! You\'re a miracle of science, you are... any other creature would break their back, trying to haul these milk bags around!  Tell the truth, now... which one of your parents was actually a cow?</i>"\r\r', false );
				}
	...
	KeltScene.prototype.keltMainEncounterPostBlowjob = function() {
		...
		if( CoC.player.findStatusAffect( StatusAffects.BlowjobOn ) >= 0 ) {
			...
			if( CoC.player.lust >= 75 || CoC.player.statusAffectv2( StatusAffects.Kelt ) >= 90 && Utils.rand( 2 ) === 0 ) {
				...
				EngineCore.outputText( '"<i>Bitch!  I said get in there.  Do I need to repeat myself, you stupid whore?"</i>\r\r', false );
		...
		//(Blowjob Requirement Off, 40% Chance);
			...
			EngineCore.outputText( 'You move towards the practice field, trying to ignore the way Kelt openly and hungrily eyes your naked body.  He has become more and more open about his lust for you.  Despite yourself, you can\'t help but enjoy his attentions.\r\r', false );
			EngineCore.outputText( 'Once at the field, you move to draw an arrow and begin practice, when Kelt roughly pushes you down to your knees.\r\r', false );
			...
			//Otherwise);
				...
				EngineCore.outputText( 'Despite the need, despite the desire, you are still in control of yourself enough to make a choice.  Do you submit to the centaur\'s will, and your own hunger?  Or will you somehow find the strength to walk away?', false );
				//Submit				Resist!;
	...
	KeltScene.prototype.keltResistGivingBJ = function() {
		EngineCore.spriteSelect( 35 );
		EngineCore.outputText( '', true );
		EngineCore.outputText( 'Summoning what remains of your fragmented willpower, you resist the need, apologizing to Kelt and turning to walk away.  It hurts to do so, aching within your chest with an almost physical need to go back; to apologize and kneel before him worshipfully.\r\r', false );
	...
	KeltScene.prototype.continueAfterBJ = function() {
		EngineCore.spriteSelect( 35 );
		EngineCore.outputText( 'After a brief rest, you manage to get back to practicing archery.  ', true );
		this.keltMainEncounter3();
	};
	//(Reluctant Blowjob);
	...
	KeltScene.prototype.keltCentaurBadEnd = function() {
		...
		if( CoC.player.gender === 1 ) {
			...
			EngineCore.outputText( 'His legs rear suddenly, wrapping around the barrel of your body. You let out a startled protestation, but do not move... your body won\'t let you.  In fact, if anything, you push back against him, eager and ready.  Part of you is joyous, in fact.  What you wanted wasn\'t to fuck Kelt!  ', false );
			EngineCore.outputText( '<b>... It was for him to fuck you!</b>\r\r', false );
	...
	KeltScene.prototype.keltBadEndEpilogue = function() {
		EngineCore.spriteSelect( 35 );
		EngineCore.outputText( '', true );
		EngineCore.outputText( 'The next year, after a few suggested mutations from your master...\r\rThe heroine hesitatingly moved forward, crossing the field with the sort of practiced caution that had so far kept her safe in this strange land.  The farm should be somewhere nearby, if she had figured things correctly.  Of course, who could tell with this ever-shifting landscape?\r\r', false );
		EngineCore.outputText( 'A sudden sound caught her attention.  A lewd, squishing noise, the sound of horses crying out.  A monster?  Whatever it was, it was coming from behind the barn.  Readying her sword, the heroine moved forward cautiously, ready to confront danger.\r\r', false );
		EngineCore.outputText( 'What she found was not what she expected.  Two centaurs, wrapped in carnal bliss.  Well, the female, at least, seemed wrapped in carnal bliss.  She groaned worshipfully beneath her mate, whimpering and kneading her own watermelon sized breasts as the powerful male pumped her again and again with his oversized, equine cock.  Even as the heroine watched, fascinated, the female centaur orgasmed explosively, shouting her satisfaction to the high heavens.  If the thick puddle of juices below them was any judge, this must have been her last orgasm among many.  She was almost half the size of her mate, and clearly savoring every thrust of his oversized cock into her distended equine cunt, lewdly thrusting back and begging him to cum inside her again.\r\r', false );
		EngineCore.outputText( 'In time, the male obliged, pulling cruelly on the centauress\' hair as he let out a low roar and came forcefully.  The heroine stared in wonder as his massive balls convulsed again and again, pumping his mare full of seed.  If she listened, she could actually hear the lewd squish of every blast of semen as it filled her, pumping steady gouts of babycream into her womb.\r\r', false );
		EngineCore.outputText( 'The centaur dismounted as soon as he was satisfied, ignoring the abused mare after his needs were met.  He was obviously the dominant one, and his mate looked after him with hungry eyes, wanting more.  Two more centaurs... young females, by the look of it, emerged from the barn, hurrying over towards their mother and happily latching onto her breasts.  The mother cooed happily, letting them nurse from her full breasts, even while looking after their retreating father hopefully.  The heroine could see, looking closely, how distended the mare\'s stomach was... she was probably pregnant with yet another foal.  Somehow, the image seemed terribly erotic to the heroine, who bit her lip anxiously.\r\r', false );
		EngineCore.outputText( '"<i>Enjoying the show, fucker?  She\'s not bad, for a quick fuck now and then.  A little clingy, but makes for a good cumdump.  What... you jealous?</i>"\r\r', false );
		EngineCore.outputText( 'The heroine paled, and turned around to face the male, berating herself for letting him sneak up on her.  Brandishing her sword, she tried to step backwards, wary of an attack.  The centaur eyed her sword amusedly, then broke out into a nasty laugh, ', false );
		EngineCore.outputText( '"<i>Ha!  Little bitch human, who thinks she knows how to use a sword.  You use that little stick to ward off the big bad monsters when they come for your little pussy?  Give me a break.  This is a real man\'s weapon.</i>"\r\r', false );
		EngineCore.outputText( 'He touched the bow strung across his broad chest arrogantly.  The heroine hesitated, looking at the weapon.  They had bows like that in her home town, but she didn\'t have one.  It could be a useful tool... and the centaur seemed to know what he was doing with it.  He didn\'t seem threatening... maybe a little arrogant, and more than a little rude.  Maybe...\r\r', false );
		EngineCore.outputText( 'The centaur noticed her looking, and grinned.  "<i>You like what you see?  Maybe I could teach you a few things.  If you\'re not as stupid as that slut, of course.</i>"\r\r', false );
		EngineCore.outputText( 'He waved confidently at the mare, still nursing her young with a rapturous look on her face.  Cum slowly oozed out of her pussy, pooling on the ground beneath her, and the heroine felt a little envious for a moment.  Most horses had harems, the virile male satisfying many women at once.  How many times a day was this mare fucked?\r\r', false );
		EngineCore.outputText( 'The centaur grinned, knowingly.  His musk was heavy on the air, a thick, animalistic scent of masculinity.  "<i>Well, I could do with a little distraction anyway.  Stupid whore may be a good fuck, but a man needs to... spread out a little.  Come back tomorrow, and maybe I can knock some fucking sense into that empty head of yours.  My name\'s Kelt.</i>"\r\r', false );
		EngineCore.gameOver();
	};
	...
	KeltScene.prototype.keltResistance = function() {
		...
		EngineCore.outputText( ' as Kelt\'s insults go too far.  You\'ve had just about enough of his disingenuous assertions!\r\r', false );
		EngineCore.outputText( 'An idea on how to put him in his place slowly forms in the back of your mind, though you\'re sure pulling it off would humiliate the puffed-up centaur into never his showing his face around the farm again.  Do you do it?', false );
	...
	KeltScene.prototype.fuckKeltsShitUp = function() {
		...
		if( CoC.player.faceType === AppearanceDefs.FACE_SNAKE_FANGS && CoC.player.tongueType === AppearanceDefs.TONUGE_SNAKE && CoC.player.lowerBody === AppearanceDefs.LOWER_BODY_TYPE_NAGA ) {
			...
			if( CoC.player.hasCock() ) {
				...
				//If >10 inches: ;
					...
					EngineCore.outputText( 'Slowly but surely you feed more of your formidable member into his mouth until you feel the back of his throat, with most of your ' + Descriptors.cockDescript( 0 ) + ' still outside his lips.  The centaur is now entirely engaged with your length, moving his head back and forth as his tongue slathers it with attention, perhaps in the hope that the sooner he gets you off the sooner this nightmare will end.  You smirk and grip his hair, moving his head in rhythm with your own movements.\r\r', false );
					EngineCore.outputText( 'You feel a mighty groan around your ' + Descriptors.cockDescript( 0 ) + ' and your snake tip feels Kelt\'s cock begin to pulse urgently.  Quickly and expertly, you wrap the end of your tail around the centaur\'s penis tightly, denying him release and rewarding yourself with another pained, muffled squeal reverberating through your cock.\r\r', false );
			...
			//If Female: ;
				...
				EngineCore.outputText( 'You feel a mighty groan and Kelt\'s cock begin to pulse urgently against your tail.  Quickly and expertly, you wrap the end around the centaur\'s penis tightly, denying him release and rewarding yourself with another pained, muffled squeal reverberating through your cunt.\r\r', false );
		...
		//Standard anti-kelt scene;
			...
			EngineCore.outputText( ImageManager.showImage( 'kelt-farm-subkelt' ) );
			...
			if( CoC.player.gender === 0 ) {
				...
				EngineCore.outputText( 'an explosive orgasm.  You deposit your cream directly into his belly, making him burp when you pull out, dripping on the centaur\'s abused lips.\r\r', false );
			}
