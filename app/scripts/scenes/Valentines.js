...
angular.module( 'cocjs' ).run( function( SceneLib, MainView, Descriptors, ItemType, OnLoadVariables, kFLAGS, Utils, PerkLib, ConsumableLib, AppearanceDefs, CoC, EngineCore ) {
	...
	Valentines.prototype.pleasureAbbyVDay = function() {
		...
		//([Human tongue];
			...
			EngineCore.outputText( '  Hooking your fingers at the front and back of her cunny, you plunge your tongue in and wiggle it eagerly.  Abby clamps down on all three invaders and loudly moans out, screaming to her content at last, as your face is flooded with pussy juice.' );
		}
	...
	Valentines.prototype.valentineDrinkPastie = function( itype ) {
		...
		//[Corruption 76-100];
			...
			EngineCore.outputText( '  As long as she\'s in the mood to drink more than just the alcohol afterwards, you don\'t really care.' );
		}
	...
	Valentines.prototype.rubPastieOnYourWangDawg = function() {
		...
		if( CoC.player.cumQ() < 250 ) {
			...
			EngineCore.outputText( ' almost blasting her right out of your hand in the torrent of white that spills forth from your mighty member.' );
		}
