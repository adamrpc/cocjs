...
angular.module( 'cocjs' ).run( function( SceneLib, MainView, Descriptors, ItemType, OnLoadVariables, kFLAGS, Utils, PerkLib, ConsumableLib, AppearanceDefs, CoC, EngineCore ) {
	function Valentines() {
	}

	Valentines.prototype.isValentine = function() {
		return OnLoadVariables.date.date >= 13 && OnLoadVariables.date.date <= 15 && OnLoadVariables.date.month === 1;
	};

	/*First of all, a few notes The scene should probably trigger automatically for people who have met Scylla enough times or been on her addiction meeting at least once, depending on which flags would make it easier for you, and should proc sometime from sometime before the normal hours for the addiction meeting to sometime after; let's say 16-20, upon entering the Wet Bitch or Tel'Adre at all, depending on what you think is better here. Probably the Wet Bitch.
	 ...
	 Possible Perks to Gain One Track Mind gains additional cum production or multiplier and their capacities increase.
	 - Sensual Lover the effectiveness of teasing and gives a small Lust Resistance boost.
	 - Pure and Loving corruption resistance and lust resistance more than Sensual Lover, and/or maybe improves affection gains for NPCs if possible.
	 Perk Descriptions Track Mind] You're a dirty person. The highest you'd think of another is that they make you horny, and maybe "<i>I'd tap that like there's no tomorrow.</i>" There are no higher feelings for you in intimacy or sexual relations; you dabble in these purely to get off and not really caring about your partners. Even on a special days where love is celebrated, you can't muster affection other than in the form of an orgasm.
	...
	Valentines.prototype.crazyVDayShenanigansByVenithil = function() {
		...
		MainView.outputText( 'Moving through the streets of Tel\'Adre, you turn your steps towards the Wet Bitch, only to find that there\'s some odd event going on nearby.  Deciding the town is a safe enough place to let yourself be led astray by curiosity, you decide to investigate a bit closer.' );
	...
	Valentines.prototype.helpValentinesDayIII = function() {
		MainView.clearOutput();
		MainView.outputText( 'You spend the rest of the evening participating in holiday games and showing people around the stall, listening to Scylla giving a talk or two about love and the celebration of it.  All in all, the little popularization of the holiday turned out to be a moderate success, but a success after all thanks to the joint effort of the four of you.' );
	...
	Valentines.prototype.cuddleWithScyllaVDay = function() {
		...
		if( CoC.player.hasVagina() ) {
			MainView.outputText( '  Your [vagina] is starting to get moist, making a small mess in your underclothes.' );
		}
		//[if (hasCock = true)];
		if( CoC.player.hasCock() ) {
			MainView.outputText( '  You realize it\'d probably be a done deal if you didn\'t resist the pull of your hardening cock towards one of Scylla\'s orifices, but you decide to spare her any temptations and endure yourself.' );
		}
		MainView.outputText( '  In time, your ignited lust slowly changes to constant arousal, and Scylla just sitting there, watching the sun with a beautiful smile on her face, clearly content to just have someone in her arms on this evening is helping you control yourself a lot better.' );
	...
	Valentines.prototype.makeOutWithScyllaVDay = function() {
		...
		if( CoC.player.cockTotal() === 1 ) {
			MainView.outputText( 'your [cock] is completely hard and stiff, forming a bulge in your clothing' );
		} else if( CoC.player.cockTotal() > 1 ) {
			MainView.outputText( '[eachCock] is by now completely hard, eager to be touched and wanting to be caressed by the nun you\'re kissing' );
		}
		MainView.outputText( '.' );
	...
	Valentines.prototype.feedScyllaVDay = function() {
		...
		MainView.outputText( 'You feed Scylla what feels like a gallon of jizz!' );
		CoC.player.orgasm();
	...
	//([Abby] ;
	Valentines.prototype.goVisitAbbyVday = function() {
		MainView.clearOutput();
	...
	Valentines.prototype.goVisitAbby = function() {
		MainView.clearOutput();
		MainView.outputText( '"<i>You... you\'re kidding, right?  That fatty\'s words messing with yah head?  I always figured you were somewhat less... messed up in the head than Suck-a-Lot and Always-Drunk.  Was I wrong?</i>"' );
		...
		//[if (hasVagina = false);
			...
			MainView.outputText( '"<i>Well, that\'s unexpected. I have certain doubts about you showing me such a good time,</i>" she says.  You tell her you don\'t actually require a cock at all to do this, and she seems surprised.' );
		}
	...
	Valentines.prototype.fuckAbbyVDay = function() {
		...
		MainView.outputText( 'Figuring that the goblin girl\'s felt so out of place amid a celebration of love, you might as well show her a little affection the only way she\'s likely to understand.  Pulling aside your [armor] enough to let [eachCock] spring free, you step up behind the bent-over girl and rest your hands on her thick thighs.  The emerald girl\'s breath quickens as the heat of your manhood presses between the jiggling globes of her ass cheeks and a whimper escapes her throat before she realizes it.  Coughing, in an attempt to cover the moment of weakness, she turns her head to the side to give you a disapproving eye.  “What is this, romance?  Just jam it in, already!” she commands, gruffly.  Her face is flushed a deeper forest hue, pink irises twinkling in the dim light of her spartan home.' );
	...
	Valentines.prototype.pleasureAbbyVDay = function() {
		...
		if( CoC.player.tongueType === AppearanceDefs.TONUGE_SNAKE ) {
			MainView.outputText( '  Your fingers make it into her pussy alongside your tongue, and the prehensile thing, longer and more flexible than a human\'s, ravages the insides of her pussy, tasting everywhere as Abby shakes in her orgasm.  Her pussy eagerly tries to milk both your fingers and your tongue, clenching and gripping at them as it drips her pussy juices all over your face.  Abby screams out in a loud, uninhibited orgasm at last, expressing her ecstasy.' );
		}
		//([Demon/Dragon Tongue];
		else if( CoC.player.tongueType === AppearanceDefs.TONUGE_DEMONIC ) {
			MainView.outputText( '  Abylon shakes in excitement, pleasure, and fear as you extend your inhuman tongue to reach deep into the recesses of her pussy.  She cannot hold out a moment longer, her cunt gripping your inhuman muscle tightly, the hole and muscles inside quivering as you can taster her orgasmic juices with every single point of your tongue.  She screams, shudders and moans, tongue lolling out from the intense pleasure as you force your own tongue to roll around inside her and stretch her in multiple ways. Only you holding her stops Abylon from slumping forward, it seems...' );
		}
		//([Human tongue];
		else {
			MainView.outputText( '  Hooking your fingers at the front and back of her cunny, you plunge your tongue in and wiggle it eagerly.  Abby clamps down on all three invaders and loudly moans out, screaming to her content at last, as your face is flooded with pussy juice.' );
		}
	...
	Valentines.prototype.goVisitPastyVDay = function() {
		MainView.clearOutput();
		MainView.outputText( 'You lean over the table Pastie is no longer dancing, but rather laying, on, and, conspiratorially, ask her if she\'d like to go and get something to drink.' );
	...
	//PASTIE EVENT;
	Valentines.prototype.valentineDrinkPastie = function( itype ) {
		MainView.clearOutput();
		MainView.outputText( 'One you\'re away from any prying eyes, Pastie turns to you and rubs her little fairy hands together, apparently barely able to hold her enthusiasm to finally get a bit drunk.  You\'re afraid it may not end at one drink, either, and for a moment, wonder about whether this is all right or not...' );
		//Corruption 0-20] ;
		if( CoC.player.cor < 33 ) {
			MainView.outputText( '  It probably isn\'t.' );
		}
		//[Corruption 21-75];
		else if( CoC.player.cor < 75 ) {
			MainView.outputText( '  You guess as long as she\'s fine afterwards, it should be okay.' );
		}
		//[Corruption 76-100];
		else {
			MainView.outputText( '  As long as she\'s in the mood to drink more than just the alcohol afterwards, you don\'t really care.' );
		}
	...
	Valentines.prototype.valentineDayGetPastieDrink = function( itype ) {
		//{Black Cat Beer};
	...
	Valentines.prototype.rubPastieOnYourWangDawg = function() {
		...
		if( CoC.player.balls > 0 ) {
			MainView.outputText( '  Your [balls] lurch, ' + CoC.player.skin() + ' contracting as liquid passion rises within you.' );
		}
		MainView.outputText( '  Your [ass] clenches in anticipation, heralding your climax, so you slide the fairy up your shaft, pulling free from the grip of her arms and legs, holding the confused girl directly in front of your ' + CoC.player.multiCockDescriptLight() + ' while loosing your grasp to bear her entire, curvaceous form to the open air.  With a shuddering gasp, you erupt your intoxicating cream directly into the fey girl, your orgasm' );
		//low cum production:;
		if( CoC.player.cumQ() < 250 ) {
			MainView.outputText( ' easily drenching the tiny fairy, in plump pearls up and down her naked flesh.' );
		} else if( CoC.player.cumQ() < 750 ) {
			MainView.outputText( ' leaving her and the arm you\'re holding her in dripping with a sticky alabaster lacquer.' );
		}//high cum production:;
		else {
			MainView.outputText( ' almost blasting her right out of your hand in the torrent of white that spills forth from your mighty member.' );
		}
		MainView.outputText( '  The spunk-plastered pixie shudders in your palm, overwhelmed by the spoo drenching her.  She masturbates, feverishly, climaxing in seconds and then again a moment later.  You watch her for a few minutes, the batter-basted bimbo jilling herself silly from the heightened sensitivity your spoo shower has given her.' );
	...
	Valentines.prototype.goForAPushayDivePasty = function() {
		...
		//[if (hascock = true);
		if( CoC.player.hasCock() ) {
			MainView.outputText( '  All the while, you continue to jerk off [eachCock], preparing yourself for an orgasm on both sides.' );
		}
		MainView.outputText( '  She finally takes a full dive inside, and you moan out in pleasure, feeling her little body roll and explore in there, her tongue tasting every bit of fluid she can from what\'s moisturizing your inner passage.' );
		...
		//[if (hascock = true)];
		if( CoC.player.hasCock() ) {
			MainView.outputText( '  At the same time, your cock deposits its own load onto the ground as your hermaphrodite genitals achieve a simultaneous orgasm.' );
		}
		//[if (isSquirter = true);
		if( CoC.player.wetness() >= 4 ) {
			MainView.outputText( '  She doesn\'t have much to say in the matter when your female ejaculation truly shoots in, though, sending her rolling out of your [vagina] and onto the ground.' );
		}
	...
	/*END!
	 ...
	 G1) The player staying with Scylla can choose to Cuddle and watch, leads to next day or loss of a few hours. Gives the Pure and Loving perk, plus stat modifications (lowers Corruption and Libido, raises Lust)
